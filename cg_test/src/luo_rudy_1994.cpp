...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellluo_rudy_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_channel_f_Ca_gate__f_Ca = 1.0 / (pow((var_ionic_concentrations__Cai / var_L_type_Ca_channel_f_Ca_gate__Km_Ca), 2.0) + 1.0); // dimensionless
        ...
        const double var_calcium_background_current__E_CaN = var_membrane__R * var_membrane__T * log(var_ionic_concentrations__Cao / var_ionic_concentrations__Cai) / (2.0 * var_membrane__F); // mV
        ...
        const double var_non_specific_calcium_activated_current__i_ns_K = 1.0 * var_non_specific_calcium_activated_current__I_ns_K / (pow((var_non_specific_calcium_activated_current__K_m_ns_Ca / var_ionic_concentrations__Cai), 3.0) + 1.0); // uA_per_mm2
        const double var_non_specific_calcium_activated_current__i_ns_Na = 1.0 * var_non_specific_calcium_activated_current__I_ns_Na / (pow((var_non_specific_calcium_activated_current__K_m_ns_Ca / var_ionic_concentrations__Cai), 3.0) + 1.0); // uA_per_mm2
