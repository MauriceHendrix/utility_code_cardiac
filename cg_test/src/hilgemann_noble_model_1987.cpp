...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellhilgemann_noble_model_1987FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_membrane__C_m = 0.006; // microF
        const double var_chaste_interface__membrane__stim_amplitude = 0.001 * var_-200.0 / var_membrane__C_m * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    double Cellhilgemann_noble_model_1987FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_calcium_background_current__g_b_Ca = 0.005; // microS
        ...
        const double var_potassium_background_current__g_b_K = 0.17; // microS
        ...
        const double var_second_inward_calcium_current_f_Ca_gate__CaChon = (-var_second_inward_calcium_current_f_Ca_gate__CaChoff + 1.0) * (-var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 1.0); // dimensionless
        const double var_second_inward_calcium_current__i_siCa = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(100.0 / var_membrane__RTONF) - var_chaste_interface__extracellular_calcium_concentration__Ca_o * exp(-(-50.0 + var_chaste_interface__membrane__V) * 2.0 / var_membrane__RTONF)) * 4.0 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 * 2.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
        const double var_second_inward_calcium_current__i_siK = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(50.0 / var_membrane__RTONF) - var_extracellular_potassium_concentration__K_c * exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF)) * 0.002 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
        const double var_second_inward_calcium_current__i_siNa = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(50.0 / var_membrane__RTONF) - var_extracellular_sodium_concentration__Na_o * exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF)) * 0.01 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
    ...
    void Cellhilgemann_noble_model_1987FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        ...
        const double var_extracellular_calcium_concentration__K_diff = 0.0005; // per_second
        const double var_extracellular_potassium_concentration__K_c = 4.0; // millimolar
        const double var_extracellular_sodium_concentration__Na_o = 140.0; // millimolar
        const double var_fast_sodium_current__g_Na = 50.0; // microS
        ...
        const double d_dt_chaste_interface_var_calcium_release__ProdFrac = 0.001 * var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate - 0.001 * 0.6 * var_chaste_interface__calcium_release__ProdFrac; // 1 / millisecond
        ...
        const double var_intracellular_calcium_concentration__radius = 0.08; // micrometre
        ...
        const double var_calcium_release__ActRate = 500.0 * var_calcium_release__RegBindSite + 600.0 * var_calcium_release__VoltDep; // per_second
        ...
        const double var_second_inward_calcium_current__P_si = 5.0; // nanoA_per_millimolar
        const double var_second_inward_calcium_current_d_gate__E0_d = -5.0 + 24.0 + var_chaste_interface__membrane__V; // millivolt
        const double var_second_inward_calcium_current_d_gate__delta_d = 0.0001; // millivolt
        const double var_second_inward_calcium_current_d_gate__alpha_d = ((var_second_inward_calcium_current_d_gate__delta_d > fabs(var_second_inward_calcium_current_d_gate__E0_d)) ? (120.0) : (30.0 * var_second_inward_calcium_current_d_gate__E0_d / (-exp(-1.0 * var_second_inward_calcium_current_d_gate__E0_d / 4.0) + 1.0))); // per_second
        const double var_second_inward_calcium_current_d_gate__beta_d = ((var_second_inward_calcium_current_d_gate__delta_d > fabs(var_second_inward_calcium_current_d_gate__E0_d)) ? (120.0) : (12.0 * var_second_inward_calcium_current_d_gate__E0_d / (-1.0 + exp(var_second_inward_calcium_current_d_gate__E0_d / 10.0)))); // per_second
        const double d_dt_chaste_interface_var_second_inward_calcium_current_d_gate__d = 0.001 * (-var_chaste_interface__second_inward_calcium_current_d_gate__d + 1.0) * var_second_inward_calcium_current_d_gate__alpha_d - 0.001 * var_second_inward_calcium_current_d_gate__beta_d * var_chaste_interface__second_inward_calcium_current_d_gate__d; // 1 / millisecond
        const double var_second_inward_calcium_current_f_Ca_gate__CaChoff = var_chaste_interface__intracellular_calcium_concentration__Ca_i / (0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i); // dimensionless
        ...
        const double var_second_inward_calcium_current_f_Ca_gate__alpha_f_Ca = ((var_second_inward_calcium_current_f_Ca_gate__delta_f > fabs(var_second_inward_calcium_current_f_Ca_gate__E0_f)) ? (25.0) : (6.25 * var_second_inward_calcium_current_f_Ca_gate__E0_f / (-1.0 + exp(var_second_inward_calcium_current_f_Ca_gate__E0_f / 4.0)))); // per_second
        const double d_dt_chaste_interface_var_second_inward_calcium_current_f_Ca_gate__f_Ca = 0.001 * ((-var_second_inward_calcium_current_f_Ca_gate__CaChoff + 1.0) * (-var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 1.0) + (-var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 1.0) * 120.0 * var_second_inward_calcium_current_f_Ca_gate__CaChoff) * var_second_inward_calcium_current_f_Ca_gate__beta_f_Ca - 0.001 * var_second_inward_calcium_current_f_Ca_gate__alpha_f_Ca * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca; // 1 / millisecond
        const double var_second_inward_calcium_current_f_Ca_gate__CaChon = (-var_second_inward_calcium_current_f_Ca_gate__CaChoff + 1.0) * (-var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 1.0); // dimensionless
        const double var_second_inward_calcium_current__i_siCa = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(100.0 / var_membrane__RTONF) - var_chaste_interface__extracellular_calcium_concentration__Ca_o * exp(-(-50.0 + var_chaste_interface__membrane__V) * 2.0 / var_membrane__RTONF)) * 4.0 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 * 2.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
        const double d_dt_chaste_interface_var_extracellular_calcium_concentration__Ca_o = 0.001 * ((-var_chaste_interface__extracellular_calcium_concentration__Ca_o + var_extracellular_calcium_concentration__Cab) * var_extracellular_calcium_concentration__K_diff - (var_Na_Ca_exchanger__i_NaCa + var_calcium_background_current__i_b_Ca + var_second_inward_calcium_current__i_siCa) * 1.0 / (1.0 * 2.0 * var_intracellular_calcium_concentration__Ve * var_membrane__F)) * var_intracellular_sodium_concentration__conc_clamp; // millimolar / millisecond
        const double d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_i = -1.0 * d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_Calmod - 1.0 * d_dt_chaste_interface_var_intracellular_calcium_concentration__Ca_Trop - 0.001 * var_sarcoplasmic_reticulum_calcium_pump__i_up + 0.001 * var_calcium_release__i_rel * var_intracellular_calcium_concentration__V_rel_ratio / var_intracellular_calcium_concentration__V_i_ratio - 0.001 * (-2.0 * var_Na_Ca_exchanger__i_NaCa + var_calcium_background_current__i_b_Ca + var_second_inward_calcium_current__i_siCa) * 1.0 / (1.0 * 2.0 * var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / millisecond
        const double var_second_inward_calcium_current__i_siK = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_potassium_concentration__K_i * exp(50.0 / var_membrane__RTONF) - var_extracellular_potassium_concentration__K_c * exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF)) * 0.002 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
        const double var_second_inward_calcium_current__i_siNa = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_sodium_concentration__Na_i * exp(50.0 / var_membrane__RTONF) - var_extracellular_sodium_concentration__Na_o * exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF)) * 0.01 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
        const double var_sodium_background_current__E_Na = var_membrane__RTONF * log(var_extracellular_sodium_concentration__Na_o / var_chaste_interface__intracellular_sodium_concentration__Na_i); // millivolt
        const double var_sodium_background_current__g_b_Na = 0.012; // microS
