...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_calcium_release__ProdFrac_orig_deriv = var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate - 0.6 * var_chaste_interface__calcium_release__ProdFrac; // 1 / second
        ...
        const double var_second_inward_calcium_current_d_gate__d_orig_deriv = (-var_chaste_interface__second_inward_calcium_current_d_gate__d + 1.0) * var_second_inward_calcium_current_d_gate__alpha_d - var_second_inward_calcium_current_d_gate__beta_d * var_chaste_interface__second_inward_calcium_current_d_gate__d; // 1 / second
        ...
        const double var_second_inward_calcium_current_f_Ca_gate__CaChon = (-var_second_inward_calcium_current_f_Ca_gate__CaChoff + 1.0) * (-var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 1.0); // dimensionless
        const double var_second_inward_calcium_current__i_siCa = (-50.0 + var_chaste_interface__membrane__V) * (var_chaste_interface__intracellular_calcium_concentration__Ca_i * exp(100.0 / var_membrane__RTONF) - var_chaste_interface__extracellular_calcium_concentration__Ca_o * exp(-(-50.0 + var_chaste_interface__membrane__V) * 2.0 / var_membrane__RTONF)) * 4.0 * var_second_inward_calcium_current__P_si * var_chaste_interface__second_inward_calcium_current_d_gate__d * var_second_inward_calcium_current_f_Ca_gate__CaChon / ((-exp(-(-50.0 + var_chaste_interface__membrane__V) * 1.0 * 2.0 / var_membrane__RTONF) + 1.0) * var_membrane__RTONF); // nanoA
        const double var_extracellular_calcium_concentration__Ca_o_orig_deriv = ((-var_chaste_interface__extracellular_calcium_concentration__Ca_o + var_extracellular_calcium_concentration__Cab) * var_extracellular_calcium_concentration__K_diff - (var_Na_Ca_exchanger__i_NaCa + var_calcium_background_current__i_b_Ca + var_second_inward_calcium_current__i_siCa) * 1.0 / (1.0 * 2.0 * var_intracellular_calcium_concentration__Ve * var_membrane__F)) * var_intracellular_sodium_concentration__conc_clamp; // millimolar / second
        ...
        const double var_intracellular_calcium_concentration__Ca_i_orig_deriv = -var_intracellular_calcium_concentration__Ca_Calmod_orig_deriv - var_intracellular_calcium_concentration__Ca_Trop_orig_deriv - var_sarcoplasmic_reticulum_calcium_pump__i_up + var_calcium_release__i_rel * var_intracellular_calcium_concentration__V_rel_ratio / var_intracellular_calcium_concentration__V_i_ratio - (-2.0 * var_Na_Ca_exchanger__i_NaCa + var_calcium_background_current__i_b_Ca + var_second_inward_calcium_current__i_siCa) * 1.0 / (1.0 * 2.0 * var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / second
        ...
        const double var_sodium_potassium_pump__i_NaK_max = 14.0; // nanoA
        const double var_sodium_potassium_pump__i_NaK = var_extracellular_potassium_concentration__K_c * var_chaste_interface__intracellular_sodium_concentration__Na_i * var_sodium_potassium_pump__i_NaK_max / ((var_extracellular_potassium_concentration__K_c + var_sodium_potassium_pump__K_mK) * (var_chaste_interface__intracellular_sodium_concentration__Na_i + var_sodium_potassium_pump__K_mNa)); // nanoA
        const double var_intracellular_sodium_concentration__Na_i_orig_deriv = -(3.0 * var_sodium_potassium_pump__i_NaK + 3.0 * var_Na_Ca_exchanger__i_NaCa + var_fast_sodium_current__i_Na + var_second_inward_calcium_current__i_siNa + var_sodium_background_current__i_b_Na) * 1.0 * var_intracellular_sodium_concentration__conc_clamp / (1.0 * var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / second
