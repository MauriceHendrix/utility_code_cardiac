...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellpandit_model_2001_epiFromCellMLGRL1::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude_converted = -0.00059999999999999995 / var_membrane__Cm_converted; // uA_per_cm2
    ...
    void Cellpandit_model_2001_epiFromCellMLGRL1::UpdateTransmembranePotential(double var_chaste_interface__environment__time_converted)
    {
        ...
        const double var_membrane__i_Stim = 1000.0 * var_membrane__Cm_converted * var_membrane__i_Stim_converted; // nanoA
        const double var_sarcolemmal_calcium_pump_current__i_Ca_P_max = 0.0040000000000000001; // nanoA
        const double var_sarcolemmal_calcium_pump_current__i_Ca_P = var_chaste_interface__intracellular_ion_concentrations__Ca_i * var_sarcolemmal_calcium_pump_current__i_Ca_P_max / (0.00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i); // nanoA
        const double var_sodium_current__g_Na = 0.80000000000000004; // microS
        const double var_sodium_potassium_pump__K_m_K = 1.5; // millimolar
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.0098900000000000012 * var_x146 - 0.004516 * var_x145;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative20(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 1.5856796826686865e-16 * var_x63 - 2.2560474246135324e-6 * var_x34 - 1.193943225512245e-7 * var_x64 - 0.022518252522655345 * var_x66 - 8.1628665394625614e-6 * var_x59 - 9.8651233004461501e-6 * var_x65;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative22(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 4.286481532120841e-5 * var_x77 - 3.2651466157850246e-5 * var_x72 - 3.8843985601580465e-6 * var_x8 - 0.00019703470957323427 * var_x74 - 0.00067554757567966038 * var_x75 - 1.6557538619599519e-7 * var_x76 + var_x187 * var_x73;
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative23(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x192 * (-29213.483146067414 - var_x197 - var_x198) + 2.3800000000000004e-7 * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x199 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x51 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / (pow(var_x189, 3) * pow(var_x190, 2));
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative24(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = var_x203 * (-1740.0382808421784 - var_x205 - var_x206) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x199 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x200, 3) * pow((0.083333333333333329 + var_x201), 2));
        }
        else
        {
    ...
    double Cellpandit_model_2001_epiFromCellMLGRL1::EvaluatePartialDerivative25(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.19333758676024207 - 4.9248350664764349e-13 * var_x184 - 0.00050803300043421621 * var_x180;
        }
        else
        {
