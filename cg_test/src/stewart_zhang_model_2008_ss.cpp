...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellstewart_zhang_model_2008_ssFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_inward_rectifier_potassium_current__xK1_inf = 1.0 / (1.0 + exp((75.44 + var_chaste_interface__membrane__V) * 0.1)); // dimensionless
        ...
        const double var_sustained_outward_current__a = 1.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 5.0) / 17.0)); // dimensionless
    ...
    void Cellstewart_zhang_model_2008_ssFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_fast_sodium_current_h_gate__alpha_h = ((40.0 < -var_chaste_interface__membrane__V) ? (0.057 * exp((-80.0 - var_chaste_interface__membrane__V + var_fast_sodium_current__shift_INa_inact) / 6.8)) : (0.0)); // per_millisecond
        const double var_fast_sodium_current_h_gate__beta_h = ((40.0 < -var_chaste_interface__membrane__V) ? (2.7 * exp((-var_fast_sodium_current__shift_INa_inact + var_chaste_interface__membrane__V) * 0.079) + 310000.0 * exp((-var_fast_sodium_current__shift_INa_inact + var_chaste_interface__membrane__V) * 0.3485)) : (0.77 / ((1.0 + exp(-(-var_fast_sodium_current__shift_INa_inact + 10.66 + var_chaste_interface__membrane__V) / 11.1)) * 0.13))); // per_millisecond
        const double var_fast_sodium_current_h_gate__h_inf = var_fast_sodium_current__perc_reduced_inact_for_IpNa / 100.0 + pow((1.0 + exp((-var_fast_sodium_current__shift_INa_inact + 71.55 + var_chaste_interface__membrane__V) / 7.43)), (-2.0)) * (-var_fast_sodium_current__perc_reduced_inact_for_IpNa / 100.0 + 1.0) * 1.0; // dimensionless
        ...
        const double var_fast_sodium_current_j_gate__alpha_j = ((40.0 < -var_chaste_interface__membrane__V) ? ((-25428.0 * exp((-var_fast_sodium_current__shift_INa_inact + var_chaste_interface__membrane__V) * 0.2444) - 6.948e-06 * exp(-(-var_fast_sodium_current__shift_INa_inact + var_chaste_interface__membrane__V) * 0.04391)) * (37.78 + var_chaste_interface__membrane__V) / ((1.0 + exp((-var_fast_sodium_current__shift_INa_inact + 79.23 + var_chaste_interface__membrane__V) * 0.311)) * 1.0)) : (0.0)); // per_millisecond
        const double var_fast_sodium_current_j_gate__beta_j = ((40.0 < -var_chaste_interface__membrane__V) ? (0.02424 * exp(-(-var_fast_sodium_current__shift_INa_inact + var_chaste_interface__membrane__V) * 0.01052) / (1.0 + exp(-(-var_fast_sodium_current__shift_INa_inact + 40.14 + var_chaste_interface__membrane__V) * 0.1378))) : (0.6 * exp((-var_fast_sodium_current__shift_INa_inact + var_chaste_interface__membrane__V) * 0.057) / (1.0 + exp(-(-var_fast_sodium_current__shift_INa_inact + 32.0 + var_chaste_interface__membrane__V) * 0.1)))); // per_millisecond
        const double var_fast_sodium_current_j_gate__j_inf = var_fast_sodium_current__perc_reduced_inact_for_IpNa / 100.0 + pow((1.0 + exp((-var_fast_sodium_current__shift_INa_inact + 71.55 + var_chaste_interface__membrane__V) / 7.43)), (-2.0)) * (-var_fast_sodium_current__perc_reduced_inact_for_IpNa / 100.0 + 1.0) * 1.0; // dimensionless
        ...
        const double var_hyperpolarization_activated_current_y_gate__alpha_y = 1.0 * exp(-2.9 - 0.04 * var_chaste_interface__membrane__V); // per_millisecond
        const double var_hyperpolarization_activated_current_y_gate__beta_y = 1.0 * exp(0.11 * var_chaste_interface__membrane__V + 3.6); // per_millisecond
        ...
        const double var_hyperpolarization_activated_current_y_gate__y_inf = 1.0 / (1.0 + exp((80.6 + var_chaste_interface__membrane__V) / 6.8)); // dimensionless
        ...
        const double var_sodium_potassium_pump_current__P_NaK = 2.724; // picoA_per_picoF
        const double var_sodium_potassium_pump_current__i_NaK = var_potassium_dynamics__K_o * var_chaste_interface__sodium_dynamics__Na_i * var_sodium_potassium_pump_current__P_NaK / ((var_potassium_dynamics__K_o + var_sodium_potassium_pump_current__K_mk) * (var_chaste_interface__sodium_dynamics__Na_i + var_sodium_potassium_pump_current__K_mNa) * (0.0353 * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 0.1245 * exp(-0.1 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 1.0)); // picoA_per_picoF
        const double d_dt_chaste_interface_var_sodium_dynamics__Na_i = -(3.0 * var_sodium_potassium_pump_current__i_NaK + 3.0 * var_sodium_calcium_exchanger_current__i_NaCa + var_fast_sodium_current__i_Na + var_hyperpolarization_activated_current__i_f_Na + var_sodium_background_current__i_b_Na) * 1.0 * var_membrane__Cm / (1.0 * var_membrane__F * var_membrane__V_c); // millimolar / millisecond
        const double var_sustained_outward_current__a = 1.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 5.0) / 17.0)); // dimensionless
        const double var_sustained_outward_current__g_sus = 0.0227; // nanoS_per_picoF
        const double var_sustained_outward_current__i_sus = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_sustained_outward_current__a * var_sustained_outward_current__g_sus; // picoA_per_picoF
        const double var_transient_outward_current__g_to = 0.08184; // nanoS_per_picoF
        const double var_transient_outward_current_r_gate__r_inf = 1.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 20.0) / 13.0)); // dimensionless
        const double var_transient_outward_current_r_gate__tau_r = 10.45 * exp(-pow((40.0 + var_chaste_interface__membrane__V), 2.0) / 1800.0) + 7.3; // millisecond
        ...
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * var_transient_outward_current__g_to * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
        const double d_dt_chaste_interface_var_potassium_dynamics__K_i = -(-2.0 * var_sodium_potassium_pump_current__i_NaK + var_hyperpolarization_activated_current__i_f_K + var_inward_rectifier_potassium_current__i_K1 + var_potassium_pump_current__i_p_K + var_rapid_time_dependent_potassium_current__i_Kr + var_slow_time_dependent_potassium_current__i_Ks + var_sustained_outward_current__i_sus + var_transient_outward_current__i_to) * 1.0 * var_membrane__Cm / (1.0 * var_membrane__F * var_membrane__V_c); // millimolar / millisecond
        const double var_transient_outward_current_s_gate__s_inf = 1.0 / (1.0 + exp((27.0 + var_chaste_interface__membrane__V) / 13.0)); // dimensionless
        const double var_transient_outward_current_s_gate__tau_s = 5.0 / (1.0 + exp((-40.0 + var_chaste_interface__membrane__V) / 5.0)) + 85.0 * exp(-pow((25.0 + var_chaste_interface__membrane__V), 2.0) / 320.0) + 42.0; // millisecond
...
void OdeSystemInformation<Cellstewart_zhang_model_2008_ssFromCellML>::Initialise(void)
{
    ...
    // rY[2]:
    this->mVariableNames.push_back("var_hyperpolarization_activated_current_y_gate__y");
