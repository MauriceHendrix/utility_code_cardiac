...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliribe_model_2006_without_otherwise_sectionFromCellMLRushLarsen::UseCellMLDefaultStimulus()
    {
        ...
        const double var_cell_parameters__Cm_converted = mParameters[1] / HeartConfig::Instance()->GetCapacitance(); // uA / uA_per_cm2
        const double var_chaste_interface__membrane_potential__stim_amplitude_converted = -0.0040000000000000001 / var_cell_parameters__Cm_converted; // uA_per_cm2
    ...
    double Celliribe_model_2006_without_otherwise_sectionFromCellMLRushLarsen::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__i_Na = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (-26.713760659695652 * log(140.47999999999999 / (0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i)) + var_chaste_interface__membrane_potential__V) * mParameters[3] * var_chaste_interface__fast_sodium_current_h_gate__h; // nanoA
    ...
    std::vector<double> Celliribe_model_2006_without_otherwise_sectionFromCellMLRushLarsen::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const std::vector<double> & rY)
    {
        ...
        dqs[2] = var_cell_parameters__Cm_converted;
        dqs[3] = var_time_dependent_rectifier_potassium_current__i_K;
        dqs[4] = var_fast_sodium_current__i_Na;
        dqs[5] = var_sodium_calcium_exchanger__i_NaCa;
...
void OdeSystemInformation<Celliribe_model_2006_without_otherwise_sectionFromCellMLRushLarsen>::Initialise(void)
{
    ...
    // mParameters[1]:
    this->mParameterNames.push_back("cell_parameters__Cm");
