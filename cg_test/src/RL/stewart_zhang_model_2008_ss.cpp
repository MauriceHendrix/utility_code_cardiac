...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLRushLarsen::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        ...
        const double var_hyperpolarization_activated_current_y_gate__tau_y = 4000.0 / (1.0 * exp(3.6000000000000001 + 0.11 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.8999999999999999 - 0.040000000000000001 * var_chaste_interface__membrane__V)); // millisecond
