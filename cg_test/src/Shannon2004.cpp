...
void OdeSystemInformation<CellShannon2004FromCellML>::Initialise(void)
{
    ...
    // rY[7]:
    this->mVariableNames.push_back("ar_Itos_X_gate__X_tos");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.004051574);
    
    // rY[8]:
    this->mVariableNames.push_back("ar_Itos_Y_gate__Y_tos");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.9945511);
    
    // rY[9]:
    this->mVariableNames.push_back("ar_Itos_R_gate__R_tos");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.9946);
    
    // rY[10]:
    this->mVariableNames.push_back("ar_Itof_X_gate__X_tof");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.004051574);
    
    // rY[11]:
    this->mVariableNames.push_back("ar_Itof_Y_gate__Y_tof");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.9945511);
    ...
    // rY[14]:
    this->mVariableNames.push_back("ar_ICaL_fCa_gate__fCaB_SL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.01452605);
    
    // rY[15]:
    this->mVariableNames.push_back("ar_ICaL_fCa_gate__fCaB_jct");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.02421991);
    
    // rY[16]:
    this->mVariableNames.push_back("ar_Jrel_SR__R");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.8884332);
    
    // rY[17]:
    this->mVariableNames.push_back("ar_Jrel_SR__I");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(1.024274e-07);
    
    // rY[18]:
    this->mVariableNames.push_back("ar_Jrel_SR__O");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(8.156628e-07);
    
    // rY[19]:
    this->mVariableNames.push_back("ar_Na_buffer__Na_SL");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(8.80733);
    
    // rY[20]:
    this->mVariableNames.push_back("ar_Na_buffer__Na_jct");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(8.80329);
    
    // rY[21]:
    this->mVariableNames.push_back("ar_Na_buffer__Na_SL_buf");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.7720854);
    
    // rY[22]:
    this->mVariableNames.push_back("ar_Na_buffer__Na_jct_buf");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(3.539892);
    
    // rY[23]:
    this->mVariableNames.push_back("ar_Na_buffer__Nai");
    this->mVariableUnits.push_back("millimolar");
    ...
    // rY[25]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_SL");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.0001031812);
    
    // rY[26]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_jct");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.0001737475);
    
    // rY[27]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_SLB_SL");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.1110363);
    
    // rY[28]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_SLB_jct");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.009566355);
    
    // rY[29]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_SLHigh_SL");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.07297378);
    
    // rY[30]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_SLHigh_jct");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.007347888);
    
    // rY[31]:
    this->mVariableNames.push_back("ar_Ca_buffer__Ca_Calsequestrin");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(1.242988);
    
    // rY[32]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Ca_TroponinC");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.008773191);
    
    // rY[33]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.1078283);
    
    // rY[34]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.01524002);
    
    // rY[35]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Ca_Calmodulin");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.0002911916);
    
    // rY[36]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Ca_Myosin");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.001298754);
    
    // rY[37]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Mg_Myosin");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.1381982);
    
    // rY[38]:
    this->mVariableNames.push_back("ar_cytosolic_Ca_buffer__Ca_SRB");
    this->mVariableUnits.push_back("millimolar");
