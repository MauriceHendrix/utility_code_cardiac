...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellShannon2004FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__cell__stim_amplitude = 9.5 * HeartConfig::Instance()->GetCapacitance(); // uA_per_uF
    ...
    double CellShannon2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IKs__pCa_SL = 3.0 - log(1.0 * var_chaste_interface__Ca_buffer__Ca_SL) / log(10); // dimensionless
        const double var_IKs__G_Ks_SL = (0.057 + 0.19 / (1.0 + 6.14421235332821e-06 * exp(1.6666666666666667 * var_IKs__pCa_SL))) * var_IKs__G_Ks_Max; // milliS_per_microF
        const double var_IKs__pCa_jct = 3.0 - log(1.0 * var_chaste_interface__Ca_buffer__Ca_jct) / log(10); // dimensionless
        const double var_IKs__G_Ks_jct = (0.057 + 0.19 / (1.0 + 6.14421235332821e-06 * exp(1.6666666666666667 * var_IKs__pCa_jct))) * var_IKs__G_Ks_Max; // milliS_per_microF
        ...
        const double var_IKr_Rr_gate__Rr = 1.0 / (1.0 + 4.363237316886145 * exp(0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_IK1__G_K1 = 0.38729833462074165 * sqrt(var_model_parameters__Ko); // milliS_per_microF
        const double var_IKr__G_IKr = 0.4303314829119352 * sqrt(var_model_parameters__Ko) * var_IKr__G_IKr_const; // milliS_per_microF
        ...
        const double var_ICaL__Q_CaL = pow(var_ICaL__Q10_CaL, (-31.0 + 0.1 * var_model_parameters__T)); // dimensionless
        const double var_ICaL__temp = 0.45 * pow(var_model_parameters__F, 2.0) * var_ICaL__Q_CaL * var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V / (var_model_parameters__R * var_model_parameters__T); // coulomb_per_mole
        ...
        const double var_ICap__Q_SLCaP = pow(var_ICap__Q10_SLCaP, (-31.0 + 0.1 * var_model_parameters__T)); // dimensionless
        ...
        const double var_INaCa__Q_NCX = pow(var_INaCa__Q10_NCX, (-31.0 + 0.1 * var_model_parameters__T)); // dimensionless
        ...
        const double var_INaK__f_NaK = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_chaste_interface__cell__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) + 0.0365 * var_INaK__sigma * exp(-var_chaste_interface__cell__V * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))); // dimensionless
        ...
        const double var_IK1_K1_gate__alpha_K1 = 1.02 / (1.0 + 7.35454251046446e-07 * exp(0.2385 * var_chaste_interface__cell__V - 0.2385 * var_reversal_potentials__E_K)); // per_millisecond
        const double var_IK1_K1_gate__beta_K1 = (0.7626240065063081 * exp(0.08032 * var_chaste_interface__cell__V - 0.08032 * var_reversal_potentials__E_K) + 1.1534056351865558e-16 * exp(0.06175 * var_chaste_interface__cell__V - 0.06175 * var_reversal_potentials__E_K)) / (1.0 + 0.08677229415769332 * exp(0.5143 * var_reversal_potentials__E_K - 0.5143 * var_chaste_interface__cell__V)); // per_millisecond
        ...
        const double var_IKp__i_Kp = (-var_reversal_potentials__E_K + var_chaste_interface__cell__V) * var_IKp__g_Kp / (1.0 + 1786.4755653786237 * exp(-0.16722408026755853 * var_chaste_interface__cell__V)); // microA_per_microF
    ...
    void CellShannon2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_ICaL__gamma_Nai = 0.75; // dimensionless
        const double var_ICaL__gamma_Nao = 0.75; // dimensionless
        const double d_dt_chaste_interface__ICaL_fCa_gate__fCaB_SL = -0.0119 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL + 1.7 * (1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL) * var_chaste_interface__Ca_buffer__Ca_SL; // 1 / millisecond
        const double d_dt_chaste_interface__ICaL_fCa_gate__fCaB_jct = -0.0119 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct + 1.7 * (1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct) * var_chaste_interface__Ca_buffer__Ca_jct; // 1 / millisecond
        const double var_ICaL_fCa_gate__fCa_SL = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL; // dimensionless
        const double var_ICaL_fCa_gate__fCa_jct = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct; // dimensionless
        const double var_ICab__Fx_CaBk_SL = 0.89; // dimensionless
        const double var_ICab__Fx_CaBk_jct = 0.11; // dimensionless
        ...
        const double d_dt_chaste_interface__Na_buffer__Na_SL_buf = var_Na_buffer__dNa_SL_buf; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__Na_buffer__Na_jct_buf = var_Na_buffer__dNa_jct_buf; // millimolar / millisecond
        const double var_ICaL_d_gate__d_infinity = 1.0 / (1.0 + 0.08921851740926011 * exp(-0.16666666666666666 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL_d_gate__tau_d = 28.57142857142857 * (1.0 - 0.08921851740926011 * exp(-0.16666666666666666 * var_chaste_interface__cell__V)) * var_ICaL_d_gate__d_infinity / (14.5 + var_chaste_interface__cell__V); // millisecond
        const double d_dt_chaste_interface__ICaL_d_gate__d = (-var_chaste_interface__ICaL_d_gate__d + var_ICaL_d_gate__d_infinity) / var_ICaL_d_gate__tau_d; // 1 / millisecond
        const double var_ICaL_f_gate__f_infinity = 1.0 / (1.0 + 16964.68125898537 * exp(0.2777777777777778 * var_chaste_interface__cell__V)) + 0.6 / (1.0 + 12.182493960703473 * exp(-0.05 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL_f_gate__tau_f = 1.0 / (0.02 + 0.0197 * exp(-pow((0.48865000000000003 + 0.0337 * var_chaste_interface__cell__V), 2.0))); // millisecond
        const double d_dt_chaste_interface__ICaL_f_gate__f = (-var_chaste_interface__ICaL_f_gate__f + var_ICaL_f_gate__f_infinity) / var_ICaL_f_gate__tau_f; // 1 / millisecond
        const double var_IKr_Xr_gate__Xr_infinity = 1.0 / (1.0 + 0.0012726338013398079 * exp(-0.13333333333333333 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr_Xr_gate__tau_Xr = 1.0 / (0.00061 * (10.0 + var_chaste_interface__cell__V) / (-1.0 + 4.263114515168817 * exp(0.145 * var_chaste_interface__cell__V)) + 0.00138 * (7.0 + var_chaste_interface__cell__V) / (1.0 - 0.42273913174596284 * exp(-0.123 * var_chaste_interface__cell__V))); // millisecond
        const double d_dt_chaste_interface__IKr_Xr_gate__Xr = (-var_chaste_interface__IKr_Xr_gate__Xr + var_IKr_Xr_gate__Xr_infinity) / var_IKr_Xr_gate__tau_Xr; // 1 / millisecond
        const double var_IKs_Xs_gate__Xs_infinity = 1.0 / (1.0 + 1.0939777431045283 * exp(-0.059880239520958084 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKs_Xs_gate__tau_Xs = 1.0 / (0.000131 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + 7.85381970442166 * exp(0.0687 * var_chaste_interface__cell__V)) + 7.19e-05 * (30.0 + var_chaste_interface__cell__V) / (1.0 - 0.011795938519751572 * exp(-0.148 * var_chaste_interface__cell__V))); // millisecond
        const double d_dt_chaste_interface__IKs_Xs_gate__Xs = (-var_chaste_interface__IKs_Xs_gate__Xs + var_IKs_Xs_gate__Xs_infinity) / var_IKs_Xs_gate__tau_Xs; // 1 / millisecond
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40.0) ? (1.0495108254269642e-06 * exp(-0.14705882352941177 * var_chaste_interface__cell__V)) : (0.0)); // per_millisecond
        const double var_INa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40.0) ? (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V)) : (7.692307692307692 / (1.0 + 0.382754931414913 * exp(-0.0900900900900901 * var_chaste_interface__cell__V)))); // per_millisecond
        const double d_dt_chaste_interface__INa_h_gate__h = (1.0 - var_chaste_interface__INa_h_gate__h) * var_INa_h_gate__alpha_h - var_INa_h_gate__beta_h * var_chaste_interface__INa_h_gate__h; // 1 / millisecond
        const double var_INa_j_gate__alpha_j = ((var_chaste_interface__cell__V < -40.0) ? (1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + 50262745825.95399 * exp(0.311 * var_chaste_interface__cell__V))) : (0.0)); // per_millisecond
        const double var_INa_j_gate__beta_j = ((var_chaste_interface__cell__V < -40.0) ? (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + 0.003960868339904256 * exp(-0.1378 * var_chaste_interface__cell__V))) : (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + 0.040762203978366204 * exp(-0.1 * var_chaste_interface__cell__V)))); // per_millisecond
        const double d_dt_chaste_interface__INa_j_gate__j = (1.0 - var_chaste_interface__INa_j_gate__j) * var_INa_j_gate__alpha_j - var_INa_j_gate__beta_j * var_chaste_interface__INa_j_gate__j; // 1 / millisecond
        const double var_INa_m_gate__alpha_m = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - 0.008977803730697244 * exp(-0.1 * var_chaste_interface__cell__V)); // per_millisecond
        const double var_INa_m_gate__beta_m = 0.08 * exp(-0.09090909090909091 * var_chaste_interface__cell__V); // per_millisecond
        const double d_dt_chaste_interface__INa_m_gate__m = (1.0 - var_chaste_interface__INa_m_gate__m) * var_INa_m_gate__alpha_m - var_INa_m_gate__beta_m * var_chaste_interface__INa_m_gate__m; // 1 / millisecond
        const double var_Itof_X_gate__X_tof_infinity = 1.0 / (1.0 + 0.8187307530779818 * exp(-0.06666666666666667 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double d_dt_chaste_interface__Itof_X_gate__X_tof = (-var_chaste_interface__Itof_X_gate__X_tof + var_Itof_X_gate__X_tof_infinity) / var_Itof_X_gate__tau_X_tof; // 1 / millisecond
        const double var_Itof_Y_gate__Y_tof_infinity = 1.0 / (1.0 + 28.502733643767282 * exp(0.1 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itof_Y_gate__tau_Y_tof = 20.0 + 20.0 / (1.0 + 28.502733643767282 * exp(0.1 * var_chaste_interface__cell__V)); // millisecond
        const double d_dt_chaste_interface__Itof_Y_gate__Y_tof = (-var_chaste_interface__Itof_Y_gate__Y_tof + var_Itof_Y_gate__Y_tof_infinity) / var_Itof_Y_gate__tau_Y_tof; // 1 / millisecond
        const double var_Itos_R_gate__R_tos_infinity = 1.0 / (1.0 + 28.502733643767282 * exp(0.1 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_R_gate__tau_R_tos = 220.0 + 2800.0 / (1.0 + 403.4287934927351 * exp(0.1 * var_chaste_interface__cell__V)); // millisecond
        const double d_dt_chaste_interface__Itos_R_gate__R_tos = (-var_chaste_interface__Itos_R_gate__R_tos + var_Itos_R_gate__R_tos_infinity) / var_Itos_R_gate__tau_R_tos; // 1 / millisecond
        const double var_Itos_X_gate__X_tos_infinity = 1.0 / (1.0 + 0.8187307530779818 * exp(-0.06666666666666667 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_X_gate__tau_X_tos = 0.5 + 9.0 / (1.0 + 1.2214027581601699 * exp(0.06666666666666667 * var_chaste_interface__cell__V)); // millisecond
        const double d_dt_chaste_interface__Itos_X_gate__X_tos = (-var_chaste_interface__Itos_X_gate__X_tos + var_Itos_X_gate__X_tos_infinity) / var_Itos_X_gate__tau_X_tos; // 1 / millisecond
        const double var_Itos_Y_gate__Y_tos_infinity = 1.0 / (1.0 + 28.502733643767282 * exp(0.1 * var_chaste_interface__cell__V)); // dimensionless
        const double var_Itos_Y_gate__tau_Y_tos = 30.0 + 3000.0 / (1.0 + 403.4287934927351 * exp(0.1 * var_chaste_interface__cell__V)); // millisecond
        const double d_dt_chaste_interface__Itos_Y_gate__Y_tos = (-var_chaste_interface__Itos_Y_gate__Y_tos + var_Itos_Y_gate__Y_tos_infinity) / var_Itos_Y_gate__tau_Y_tos; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin = var_cytosolic_Ca_buffer__dCa_Calmodulin; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin = var_cytosolic_Ca_buffer__dCa_Myosin; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Ca_SRB = var_cytosolic_Ca_buffer__dCa_SRB; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC = var_cytosolic_Ca_buffer__dCa_TroponinC; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg = var_cytosolic_Ca_buffer__dCa_TroponinC_Ca_Mg; // millimolar / millisecond
        const double var_cytosolic_Ca_buffer__kon_TroponinC_Ca_Mg_Mg = 0.003; // per_millimolar_per_millisecond
        const double var_ion_diffusion__J_Ca_SL_myo = 3.7243e-12 * var_chaste_interface__Ca_buffer__Ca_SL - 3.7243e-12 * var_chaste_interface__Ca_buffer__Cai; // millimole_per_millisecond
        const double var_ion_diffusion__J_Ca_jct_SL = 8.2413e-13 * var_chaste_interface__Ca_buffer__Ca_jct - 8.2413e-13 * var_chaste_interface__Ca_buffer__Ca_SL; // millimole_per_millisecond
        const double var_ion_diffusion__J_Na_SL_myo = 1.6386e-12 * var_chaste_interface__Na_buffer__Na_SL - 1.6386e-12 * var_chaste_interface__Na_buffer__Nai; // millimole_per_millisecond
        const double var_ion_diffusion__J_Na_jct_SL = 1.8313e-14 * var_chaste_interface__Na_buffer__Na_jct - 1.8313e-14 * var_chaste_interface__Na_buffer__Na_SL; // millimole_per_millisecond
        const double var_model_parameters__Cao = 1.8; // millimolar
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin = var_cytosolic_Ca_buffer__dMg_Myosin; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg = var_cytosolic_Ca_buffer__dMg_TroponinC_Ca_Mg; // millimolar / millisecond
        ...
        const double var_INaK__i_NaK_SL = var_INaK__Fx_NaK_SL * var_INaK__I_NaK_max * var_INaK__f_NaK * var_model_parameters__Ko / ((1.0 + pow((var_INaK__Km_Nai / var_chaste_interface__Na_buffer__Na_SL), var_INaK__H_NaK)) * (var_INaK__Km_Ko + var_model_parameters__Ko)); // microA_per_microF
        const double var_INaK__i_NaK_jct = var_INaK__Fx_NaK_jct * var_INaK__I_NaK_max * var_INaK__f_NaK * var_model_parameters__Ko / ((1.0 + pow((var_INaK__Km_Nai / var_chaste_interface__Na_buffer__Na_jct), var_INaK__H_NaK)) * (var_INaK__Km_Ko + var_model_parameters__Ko)); // microA_per_microF
        const double var_Jpump_SR__Q_SRCaP = pow(var_Jpump_SR__Q10_SRCaP, (-31.0 + 0.1 * var_model_parameters__T)); // dimensionless
        ...
        const double var_model_parameters__Vol_jct = 0.0005390000000000001 * var_model_parameters__Vol_Cell; // liter
        ...
        const double d_dt_chaste_interface__Ca_buffer__Ca_Calsequestrin = var_Ca_buffer__dCalsequestrin; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca_buffer__Ca_SLB_SL = var_Ca_buffer__dCa_SLB_SL; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca_buffer__Ca_SLB_jct = var_Ca_buffer__dCa_SLB_jct; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca_buffer__Ca_SLHigh_SL = var_Ca_buffer__dCa_SLHigh_SL; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca_buffer__Ca_SLHigh_jct = var_Ca_buffer__dCa_SLHigh_jct; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca_buffer__Ca_SR = -var_Ca_buffer__dCalsequestrin - var_Jrel_SR__j_rel_SR - var_Jleak_SR__j_leak_SR * var_model_parameters__Vol_myo / var_model_parameters__Vol_SR + var_Jpump_SR__j_pump_SR; // millimolar / millisecond
        const double d_dt_chaste_interface__Ca_buffer__Cai = -1.0 * var_cytosolic_Ca_buffer__dCa_cytosol_tot_bound + var_ion_diffusion__J_Ca_SL_myo / var_model_parameters__Vol_myo - var_Jpump_SR__j_pump_SR * var_model_parameters__Vol_SR / var_model_parameters__Vol_myo; // millimolar / millisecond
        const double d_dt_chaste_interface__Na_buffer__Nai = var_ion_diffusion__J_Na_SL_myo / var_model_parameters__Vol_myo; // millimolar / millisecond
        const double var_reversal_potentials__E_Ca_SL = 0.5 * var_model_parameters__R * var_model_parameters__T * log(var_model_parameters__Cao / var_chaste_interface__Ca_buffer__Ca_SL) / var_model_parameters__F; // millivolt
        const double var_ICab__i_Cab_SL = (-var_reversal_potentials__E_Ca_SL + var_chaste_interface__cell__V) * var_ICab__Fx_CaBk_SL * var_ICab__G_CaBk; // microA_per_microF
        ...
        else
        {
            ...
            const double var_Itos__G_tos = 0.06; // milliS_per_microF
            const double var_IKr_Rr_gate__Rr = 1.0 / (1.0 + 4.363237316886145 * exp(0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
            const double var_cell__i_Stim = GetIntracellularAreaStimulus(var_chaste_interface__environment__time)/ HeartConfig::Instance()->GetCapacitance(); // microA_per_microF
            const double var_model_parameters__Cli = 15.0; // millimolar
            const double var_model_parameters__Clo = 150.0; // millimolar
            const double var_model_parameters__Ki = 135.0; // millimolar
            const double var_IK1__G_K1 = 0.38729833462074165 * sqrt(var_model_parameters__Ko); // milliS_per_microF
