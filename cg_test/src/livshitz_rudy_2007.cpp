...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_INa__aH = 1.0495108254269642e-06 * var_INa__a * exp(-0.14705882352941177 * var_chaste_interface__cell__V); // per_ms
        const double var_INa__aj = 1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) * var_INa__a / (1.0 + 50262745825.95399 * exp(0.311 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_INa__bH = (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V)) * var_INa__a + 7.692307692307692 * (1.0 - var_INa__a) / (1.0 + 0.382754931414913 * exp(-0.0900900900900901 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__INa__H = (1.0 - var_chaste_interface__INa__H) * var_INa__aH - var_chaste_interface__INa__H * var_INa__bH; // 1 / millisecond
        const double var_INa__bj = 0.1212 * var_INa__a * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + 0.003960868339904256 * exp(-0.1378 * var_chaste_interface__cell__V)) + 0.3 * (1.0 - var_INa__a) * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + 0.040762203978366204 * exp(-0.1 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__INa__J = (1.0 - var_chaste_interface__INa__J) * var_INa__aj - var_chaste_interface__INa__J * var_INa__bj; // 1 / millisecond
        ...
        const double var_INab__inab = (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * var_INab__GNab; // uA_per_uF
        const double var_cell__naiont = 3.0 * var_INaCa__inaca + 3.0 * var_INaK__inak + var_ICaL__ilcana + var_INa__ina + var_INab__inab; // uA_per_uF
        const double d_dt_chaste_interface__Na__Na_i = -var_cell__AF * var_cell__naiont / var_cell__vmyo; // mM / millisecond
        const double var_reversal_potentials__prnak = 0.01833; // dimensionless
        const double var_reversal_potentials__EKs = log((var_Environment__Na_o * var_reversal_potentials__prnak + var_Environment__K_o) / (var_chaste_interface__Na__Na_i * var_reversal_potentials__prnak + var_chaste_interface__K__K_i)) / var_Environment__FonRT; // mV
        const double var_IKs__iks = (-var_reversal_potentials__EKs + var_chaste_interface__cell__V) * var_IKs__gks * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2; // uA_per_uF
        const double var_cell__kiont = -2.0 * var_INaK__inak + var_ICaL__ilcak + var_IK1__IK1 + var_IKp__ikp + var_IKr__ikr + var_IKs__iks + var_cell__i_Stim; // uA_per_uF
        const double d_dt_chaste_interface__K__K_i = -var_cell__AF * var_cell__kiont / var_cell__vmyo; // mM / millisecond
