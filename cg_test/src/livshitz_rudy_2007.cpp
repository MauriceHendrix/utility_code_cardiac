...
#include "MathsCustomFunctions.hpp"
    ...
    double Celllivshitz_rudy_2007FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Ca__Ca_i = -0.3333333333333333 * var_Ca__bmyo + 0.6666666666666666 * sqrt(pow(var_Ca__bmyo, 2) - 3.0 * var_Ca__cmyo) * cos(0.3333333333333333 * acos(0.5 * pow((pow(var_Ca__bmyo, 2) - 3.0 * var_Ca__cmyo), (-1.5)) * (-2.0 * pow(var_Ca__bmyo, 3) - 27.0 * var_Ca__dmyo + 9.0 * var_Ca__bmyo * var_Ca__cmyo))); // mM
        ...
        const double var_IK1__GK1_ = 0.4303314829119352 * sqrt(var_Environment__K_o) * var_IK1__GK1max; // mS_per_uF
        ...
        const double var_IKs__gks = (1.0 + 0.6 / (1.0 + 6.481821026062645e-07 * pow(1 / var_Ca__Ca_i, 1.4))) * var_IKs__GKsmax; // mS_per_uF
        ...
        const double var_IKr__r = 1.0 / (1.0 + 1.4944910502790945 * exp(0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_IKp__ikp = (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_IKp__GKpmax / (1.0 + 3.4979389130252434 * exp(-0.16722408026755853 * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_IKr__ikr = 0.4303314829119352 * sqrt(var_Environment__K_o) * (-var_reversal_potentials__EK + var_chaste_interface__cell__V) * var_IKr__gkrmax * var_IKr__r * var_chaste_interface__IKr__xr; // uA_per_uF
    ...
    void Celllivshitz_rudy_2007FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca__cmyo = var_Ca__cmdnbar * var_Ca__kmtrpn + var_Ca__kmcmdn * var_Ca__kmtrpn + var_Ca__kmcmdn * var_Ca__trpnbar - (var_Ca__kmcmdn + var_Ca__kmtrpn) * var_chaste_interface__Ca__Ca_T; // mM2
        const double var_Ca__Ca_i = -0.3333333333333333 * var_Ca__bmyo + 0.6666666666666666 * sqrt(pow(var_Ca__bmyo, 2) - 3.0 * var_Ca__cmyo) * cos(0.3333333333333333 * acos(0.5 * pow((pow(var_Ca__bmyo, 2) - 3.0 * var_Ca__cmyo), (-1.5)) * (-2.0 * pow(var_Ca__bmyo, 3) - 27.0 * var_Ca__dmyo + 9.0 * var_Ca__bmyo * var_Ca__cmyo))); // mM
        const double d_dt_chaste_interface__Ca__Over = 0.0; // 1 / millisecond
        const double var_Environment__Ca_o = 1.8; // mM
        const double var_Environment__F = 96485.0; // C_per_mole
        const double var_Environment__K_o = 4.5; // mM
        const double var_Environment__Na_o = 140.0; // mM
        ...
        const double var_Irel__Ca_JSR_free = 0.5 * sqrt(pow(var_Irel__bbb, 2.0) + 4.0 * var_Irel__c) - 0.5 * var_Irel__bbb; // mM
        ...
        const double d_dt_chaste_interface__Ca__Ca_JSR_T = -var_chaste_interface__Irel__Rel + var_Itr__itr; // mM / millisecond
        ...
        const double var_ICaL__dss0 = 1.0 / (1.0 + 0.20137949774492367 * exp(-0.16025641025641024 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__dss1 = 1.0 / (1.0 + 0.0 * exp(-41.666666666666664 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__dss = var_ICaL__dss0 * var_ICaL__dss1; // dimensionless
        const double var_ICaL__fss = 1.0 / (1.0 + 54.598150033144236 * exp(0.125 * var_chaste_interface__cell__V)) + 0.6 / (1.0 + 12.182493960703473 * exp(-0.05 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaL__ibarca = 4.0 * (-var_Environment__Ca_o * var_ICaL__gacao + var_Ca__Ca_i * var_ICaL__gacai * exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_ICaL__pca * var_chaste_interface__cell__V / (-1.0 + exp(2.0 * var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ibark = (-var_Environment__K_o * var_ICaL__gako + var_ICaL__gaki * var_chaste_interface__K__K_i * exp(var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_ICaL__pk * var_chaste_interface__cell__V / (-1.0 + exp(var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ibarna = (-var_Environment__Na_o * var_ICaL__ganao + var_ICaL__ganai * var_chaste_interface__Na__Na_i * exp(var_Environment__FonRT * var_chaste_interface__cell__V)) * var_Environment__F * var_Environment__FonRT * var_ICaL__pna * var_chaste_interface__cell__V / (-1.0 + exp(var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_ICaL__ilca = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibarca; // uA_per_uF
        const double var_ICaL__ilcak = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibark; // uA_per_uF
        const double var_ICaL__ilcana = var_chaste_interface__ICaL__d * var_chaste_interface__ICaL__f * var_ICaL__fca * var_ICaL__ibarna; // uA_per_uF
        const double var_ICaL__taud = 28.57142857142857 * (1.0 - 0.20137949774492367 * exp(-0.16025641025641024 * var_chaste_interface__cell__V)) * var_ICaL__dss0 / (10.0 + var_chaste_interface__cell__V); // ms
        const double d_dt_chaste_interface__ICaL__d = (-var_chaste_interface__ICaL__d + var_ICaL__dss) / var_ICaL__taud; // 1 / millisecond
        const double var_ICaL__tauf = 1.0 / (0.02 + 0.0197 * exp(-pow((0.337 + 0.0337 * var_chaste_interface__cell__V), 2.0))); // ms
        const double d_dt_chaste_interface__ICaL__f = (-var_chaste_interface__ICaL__f + var_ICaL__fss) / var_ICaL__tauf; // 1 / millisecond
        const double var_ICaT__aa = 1.0 - 1.0 / (1.0 + exp(-416.6666666666667 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaT__bss = 1.0 / (1.0 + 0.2735430415717504 * exp(-0.09259259259259259 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaT__gss = 1.0 / (1.0 + 44994.05794134296 * exp(0.17857142857142858 * var_chaste_interface__cell__V)); // dimensionless
        const double var_ICaT__taub = 3.7 + 6.1 / (1.0 + 258.6706305154998 * exp(0.2222222222222222 * var_chaste_interface__cell__V)); // ms
        const double d_dt_chaste_interface__ICaT__b = (-var_chaste_interface__ICaT__b + var_ICaT__bss) / var_ICaT__taub; // 1 / millisecond
        const double var_ICaT__taug = 12.0 - 12.0 * var_ICaT__aa + 1.0 * (12.0 - 0.875 * var_chaste_interface__cell__V) * var_ICaT__aa; // ms
        const double d_dt_chaste_interface__ICaT__g = (-var_chaste_interface__ICaT__g + var_ICaT__gss) / var_ICaT__taug; // 1 / millisecond
        const double var_ICab__icab = (-0.5 * log(var_Environment__Ca_o / var_Ca__Ca_i) / var_Environment__FonRT + var_chaste_interface__cell__V) * var_ICab__gcab; // uA_per_uF
        const double var_IKr__r = 1.0 / (1.0 + 1.4944910502790945 * exp(0.044642857142857144 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr__tauxr = 1.0 / (0.00061 * (38.9 + var_chaste_interface__cell__V) / (-1.0 + 281.60348502322194 * exp(0.145 * var_chaste_interface__cell__V)) + 0.00138 * (14.2 + var_chaste_interface__cell__V) / (1.0 - 0.17436578041087322 * exp(-0.123 * var_chaste_interface__cell__V))); // ms
        const double var_IKr__xrss = 1.0 / (1.0 + 0.0932061868977677 * exp(-0.23529411764705882 * var_chaste_interface__cell__V)); // dimensionless
        const double d_dt_chaste_interface__IKr__xr = (-var_chaste_interface__IKr__xr + var_IKr__xrss) / var_IKr__tauxr; // 1 / millisecond
        const double var_IKs__tauxs = 1.0 / (0.000131 * (30.0 + var_chaste_interface__cell__V) / (-1.0 + 7.85381970442166 * exp(0.0687 * var_chaste_interface__cell__V)) + 7.19e-05 * (30.0 + var_chaste_interface__cell__V) / (1.0 - 0.011795938519751572 * exp(-0.148 * var_chaste_interface__cell__V))); // ms
        const double var_IKs__xss = 1.0 / (1.0 + 1.0939777431045283 * exp(-0.059880239520958084 * var_chaste_interface__cell__V)); // dimensionless
        const double d_dt_chaste_interface__IKs__xs1 = (-var_chaste_interface__IKs__xs1 + var_IKs__xss) / var_IKs__tauxs; // 1 / millisecond
        const double d_dt_chaste_interface__IKs__xs2 = 0.25 * (-var_chaste_interface__IKs__xs2 + var_IKs__xss) / var_IKs__tauxs; // 1 / millisecond
        const double var_INa__a = 1.0 - 1.0 / (1.0 + 0.0 * exp(-41.666666666666664 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__aH = 1.0495108254269642e-06 * var_INa__a * exp(0.14705882352941177 * var_INa__shift_h - 0.14705882352941177 * var_chaste_interface__cell__V); // per_ms
        const double var_INa__aj = 1.0 * (37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.2444 * var_chaste_interface__cell__V - 0.2444 * var_INa__shift_h) - 3.474e-05 * exp(0.04391 * var_INa__shift_h - 0.04391 * var_chaste_interface__cell__V)) * var_INa__a / (1.0 + 50262745825.95399 * exp(0.311 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__am = 0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - 0.008977803730697244 * exp(-0.1 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__bH = (310000.0 * exp(0.35 * var_chaste_interface__cell__V - 0.35 * var_INa__shift_h) + 3.56 * exp(0.079 * var_chaste_interface__cell__V - 0.079 * var_INa__shift_h)) * var_INa__a + 7.692307692307692 * (1.0 - var_INa__a) / (1.0 + 0.382754931414913 * exp(-0.0900900900900901 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_INa__bj = 0.1212 * var_INa__a * exp(0.01052 * var_INa__shift_h - 0.01052 * var_chaste_interface__cell__V) / (1.0 + 0.003960868339904256 * exp(-0.1378 * var_chaste_interface__cell__V)) + 0.3 * (1.0 - var_INa__a) * exp(2.535e-07 * var_INa__shift_h - 2.535e-07 * var_chaste_interface__cell__V) / (1.0 + 0.040762203978366204 * exp(-0.1 * var_chaste_interface__cell__V)); // per_ms
        const double var_INa__bm = 0.08 * exp(-0.09090909090909091 * var_chaste_interface__cell__V); // per_ms
        const double d_dt_chaste_interface__INa__m = (1.0 - var_chaste_interface__INa__m) * var_INa__am - var_INa__bm * var_chaste_interface__INa__m; // 1 / millisecond
        ...
        const double d_dt_chaste_interface__INa__H = (-var_chaste_interface__INa__H + var_INa__H_inf) / var_INa__tau_H; // 1 / millisecond
        const double var_INa__tau_j = 1.0 / (var_INa__aj + var_INa__bj); // ms
        const double d_dt_chaste_interface__INa__J = (-var_chaste_interface__INa__J + var_INa__j_inf) / var_INa__tau_j; // 1 / millisecond
        const double var_INaCa__inaca = (-pow(var_Environment__Na_o, 3.0) * var_Ca__Ca_i + pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o * exp(var_Environment__FonRT * var_chaste_interface__cell__V)) * var_INaCa__c1 * exp((-1.0 + var_INaCa__gammas) * var_Environment__FonRT * var_chaste_interface__cell__V) / (1.0 + (pow(var_Environment__Na_o, 3.0) * var_Ca__Ca_i + pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o * exp(var_Environment__FonRT * var_chaste_interface__cell__V)) * var_INaCa__c2 * exp((-1.0 + var_INaCa__gammas) * var_Environment__FonRT * var_chaste_interface__cell__V)); // uA_per_uF
        const double var_INaK__fnak = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_Environment__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_Environment__FonRT * var_chaste_interface__cell__V)); // dimensionless
        const double var_INaK__inak = var_INaK__fnak * var_INaK__ibarnak / ((1.0 + pow((var_INaK__kmnai / var_chaste_interface__Na__Na_i), 2.0)) * (1.0 + var_INaK__kmko / var_Environment__K_o)); // uA_per_uF
        ...
        const double d_dt_chaste_interface__Irel__Rel = (-var_chaste_interface__Irel__Rel - var_Irel__Rel_ss) / var_Irel__tau_Rel; // mM_per_ms / millisecond
        ...
        const double d_dt_chaste_interface__Ca__Ca_NSR = -var_Iup_Ileak__ileak - var_Itr__itr * var_cell__vjsr / var_cell__vnsr + var_Iup_Ileak__iup; // mM / millisecond
        const double var_reversal_potentials__ECa = 0.5 * log(var_Environment__Ca_o / var_Ca__Ca_i) / var_Environment__FonRT; // mV
        const double var_ICaT__icat = pow(var_chaste_interface__ICaT__b, 2) * (-var_reversal_potentials__ECa + var_chaste_interface__cell__V) * var_chaste_interface__ICaT__g * var_ICaT__gcat; // uA_per_uF
        const double var_cell__caiont = -2.0 * var_INaCa__inaca + var_ICaL__ilca + var_ICaT__icat + var_ICab__icab + var_IpCa__ipca; // uA_per_uF
        const double d_dt_chaste_interface__Ca__Ca_T = (-var_Iup_Ileak__iup + var_Iup_Ileak__ileak) * var_cell__vnsr / var_cell__vmyo + var_chaste_interface__Irel__Rel * var_cell__vjsr / var_cell__vmyo - 0.5 * var_cell__AF * var_cell__caiont / var_cell__vmyo; // mM / millisecond
        const double var_reversal_potentials__EK = log(var_Environment__K_o / var_chaste_interface__K__K_i) / var_Environment__FonRT; // mV
        const double var_IK1__ak1 = 1.02 / (1.0 + 7.35454251046446e-07 * exp(0.2385 * var_chaste_interface__cell__V - 0.2385 * var_reversal_potentials__EK)); // per_ms
        const double var_IK1__bk1 = (0.7626240065063081 * exp(0.08032 * var_chaste_interface__cell__V - 0.08032 * var_reversal_potentials__EK) + 1.1534056351865558e-16 * exp(0.06175 * var_chaste_interface__cell__V - 0.06175 * var_reversal_potentials__EK)) / (1.0 + 0.08677229415769332 * exp(0.5143 * var_reversal_potentials__EK - 0.5143 * var_chaste_interface__cell__V)); // per_ms
        const double var_IK1__gK1 = var_IK1__GK1_ * var_IK1__ak1 / (var_IK1__ak1 + var_IK1__bk1); // mS_per_uF
        ...
        const double var_INab__inab = (-var_reversal_potentials__ENa + var_chaste_interface__cell__V) * var_INab__GNab; // uA_per_uF
        const double var_cell__naiont = 3.0 * var_INaCa__inaca + 3.0 * var_INaK__inak + var_ICaL__ilcana + var_INa__ina + var_INab__inab; // uA_per_uF
        const double d_dt_chaste_interface__Na__Na_i = -var_Na__conc_clamp * var_cell__AF * var_cell__naiont / var_cell__vmyo; // mM / millisecond
        const double var_reversal_potentials__prnak = 0.01833; // dimensionless
        const double var_reversal_potentials__EKs = log((var_Environment__Na_o * var_reversal_potentials__prnak + var_Environment__K_o) / (var_chaste_interface__Na__Na_i * var_reversal_potentials__prnak + var_chaste_interface__K__K_i)) / var_Environment__FonRT; // mV
        const double var_IKs__iks = (-var_reversal_potentials__EKs + var_chaste_interface__cell__V) * var_IKs__gks * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2; // uA_per_uF
        const double var_cell__kiont = -2.0 * var_INaK__inak + var_ICaL__ilcak + var_IK1__IK1 + var_IKp__ikp + var_IKr__ikr + var_IKs__iks + var_cell__i_Stim; // uA_per_uF
        const double d_dt_chaste_interface__K__K_i = -var_Na__conc_clamp * var_cell__AF * var_cell__kiont / var_cell__vmyo; // mM / millisecond
        ...
        {
            d_dt_chaste_interface__cell__V = -var_cell__caiont - var_cell__kiont - var_cell__naiont; // millivolt / millisecond
        }
