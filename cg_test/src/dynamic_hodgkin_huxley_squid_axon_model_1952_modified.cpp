...
#include "dynamic_hodgkin_huxley_squid_axon_model_1952_modified.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    double Dynamichodgkin_huxley_squid_axon_model_1952_modifiedFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_membrane__E_R = var_-75.0; // millivolt
...
void OdeSystemInformation<Dynamichodgkin_huxley_squid_axon_model_1952_modifiedFromCellML>::Initialise(void)
{
    ...
    // rY[1]:
    this->mVariableNames.push_back("ar_sodium_channel_m_gate__m");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.05);
    
    // rY[2]:
    this->mVariableNames.push_back("ar_sodium_channel_h_gate__h");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.6);
    
    // rY[3]:
    this->mVariableNames.push_back("ar_potassium_channel_n_gate__n");
    this->mVariableUnits.push_back("dimensionless");
