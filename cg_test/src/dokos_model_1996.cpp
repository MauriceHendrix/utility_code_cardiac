...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldokos_model_1996FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_calcium_current_f2_gate__fL2_orig_deriv = (-var_chaste_interface__L_type_calcium_current_f2_gate__fL2 + 1.0) * var_L_type_calcium_current_f2_gate__alpha_fL2 - var_L_type_calcium_current_f2_gate__beta_fL2 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2 * var_chaste_interface__ion_concentrations__Cai; // 1 / second
        ...
        const double var_ion_concentrations__Carel_orig_deriv = (-var_sarcoplasmic_reticulum_kinetics__i_rel + var_sarcoplasmic_reticulum_kinetics__i_tr) * 1.0 / (1.0 * 2.0 * var_constants__F * var_sarcoplasmic_reticulum_kinetics__V_rel); // millimolar / second
        ...
        const double var_ion_concentrations__Caup_orig_deriv = (-var_sarcoplasmic_reticulum_kinetics__i_tr + var_sarcoplasmic_reticulum_kinetics__i_up) * 1.0 / (1.0 * 2.0 * var_constants__F * var_sarcoplasmic_reticulum_kinetics__V_up); // millimolar / second
        ...
        const double var_sodium_potassium_pump__i_pmax = 0.226; // picoA
        const double var_sodium_potassium_pump__i_p = (-pow(((-40.0 + var_chaste_interface__membrane__E) / 211.0), 2.0) + 1.0) * var_chaste_interface__ion_concentrations__Ko * var_chaste_interface__ion_concentrations__Nai * var_sodium_potassium_pump__i_pmax / ((var_chaste_interface__ion_concentrations__Ko + var_sodium_potassium_pump__KmK) * (var_chaste_interface__ion_concentrations__Nai + var_sodium_potassium_pump__KmNa)); // picoA
        const double var_ion_concentrations__Ki_orig_deriv = -(-2.0 * var_sodium_potassium_pump__i_p + var_background_potassium_current__i_bK + var_delayed_rectifying_potassium_current__i_KK + var_hyperpolarising_activated_current__i_fK) * 1.0 / (1.0 * var_constants__F * var_ion_concentrations__V_i); // millimolar / second
...
void OdeSystemInformation<Celldokos_model_1996FromCellML>::Initialise(void)
{
    ...
    // rY[2]:
    this->mVariableNames.push_back("var_L_type_calcium_current_d_gate__dL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.0001);
    
    // rY[3]:
    this->mVariableNames.push_back("var_L_type_calcium_current_f_gate__fL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.1505);
    
    // rY[4]:
    this->mVariableNames.push_back("var_L_type_calcium_current_f2_gate__fL2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.219);
    
    // rY[5]:
    this->mVariableNames.push_back("var_T_type_calcium_current_d_gate__dT");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.001);
    
    // rY[6]:
    this->mVariableNames.push_back("var_T_type_calcium_current_f_gate__fT");
    this->mVariableUnits.push_back("dimensionless");
    ...
    // rY[9]:
    this->mVariableNames.push_back("var_delayed_rectifying_potassium_current_x_gate__x");
    this->mVariableUnits.push_back("dimensionless");
    ...
    // rY[12]:
    this->mVariableNames.push_back("var_ion_concentrations__Caup");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(0.5832);
    
    // rY[13]:
    this->mVariableNames.push_back("var_ion_concentrations__Carel");
    this->mVariableUnits.push_back("millimolar");
