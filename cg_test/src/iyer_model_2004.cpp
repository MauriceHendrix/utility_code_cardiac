...
#include "MathsCustomFunctions.hpp"
    ...
    double Celliyer_model_2004FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_COMPUTE_ICa_ICaK__ICahalf = var_-0.265; // uA_per_uF
    ...
    void Celliyer_model_2004FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_IKr__B1_HERG = var_-0.0430605416398; // per_mV
        const double var_IKr__B2_HERG = 0.02617412715118; // per_mV
        const double var_IKr__B3_HERG = var_-0.02691385498399; // per_mV
        const double var_IKr__B4_HERG = 0.00568908859717; // per_mV
        const double var_IKr__B5_HERG = var_-0.04536642959543; // per_mV
