...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca_handling_by_the_SR__O_Calse_orig_deriv = -400.0 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse + (-var_chaste_interface__Ca_handling_by_the_SR__O_Calse + 1.0) * 480.0 * var_chaste_interface__Ca_handling_by_the_SR__Ca_rel; // 1 / second
        ...
        const double var_intracellular_Ca_buffering__O_TMgMg_orig_deriv = -666.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + (-var_chaste_interface__intracellular_Ca_buffering__O_TMgC - var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 1.0) * 2000.0 * var_intracellular_Ca_buffering__Mg_i; // 1 / second
        ...
        const double var_Ca_handling_by_the_SR__F1_orig_deriv = (-var_chaste_interface__Ca_handling_by_the_SR__F1 - var_chaste_interface__Ca_handling_by_the_SR__F2 + 1.0) * var_Ca_handling_by_the_SR__r_recov - var_chaste_interface__Ca_handling_by_the_SR__F1 * var_Ca_handling_by_the_SR__r_act; // 1 / second
        ...
        const double var_intracellular_Ca_buffering__O_C_orig_deriv = -476.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + (-var_chaste_interface__intracellular_Ca_buffering__O_C + 1.0) * 200000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i; // 1 / second
        ...
        const double var_intracellular_Ca_buffering__O_TC_orig_deriv = -392.0 * var_chaste_interface__intracellular_Ca_buffering__O_TC + (-var_chaste_interface__intracellular_Ca_buffering__O_TC + 1.0) * 78400.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i; // 1 / second
        ...
        const double var_Ca_handling_by_the_SR__Ca_rel_orig_deriv = -31.0 * var_Ca_handling_by_the_SR__O_Calse_orig_deriv + (-var_Ca_handling_by_the_SR__i_rel + var_Ca_handling_by_the_SR__i_tr) / (2.0 * var_Ca_handling_by_the_SR__Vol_rel * var_membrane__F); // millimolar / second
        const double var_Ca_handling_by_the_SR__Ca_up_orig_deriv = (-var_Ca_handling_by_the_SR__i_tr + var_Ca_handling_by_the_SR__i_up) / (2.0 * var_Ca_handling_by_the_SR__Vol_up * var_membrane__F); // millimolar / second
        ...
        const double var_delayed_rectifier_K_currents_pi_gate__p_i = 1.0 / (1.0 + exp((55.0 + var_chaste_interface__membrane__V) / 24.0)); // dimensionless
        const double var_delayed_rectifier_K_currents__i_Kr = (-var_Ca_independent_transient_outward_K_current__E_K + var_chaste_interface__membrane__V) * var_delayed_rectifier_K_currents__g_Kr * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a * var_delayed_rectifier_K_currents_pi_gate__p_i; // picoA
        const double var_intracellular_ion_concentrations__Ca_d_orig_deriv = (-var_L_type_Ca_channel__i_Ca_L - var_intracellular_ion_concentrations__i_di) / (2.0 * var_intracellular_ion_concentrations__Vol_d * var_membrane__F); // millimolar / second
        ...
        const double var_intracellular_ion_concentrations__Ca_i_orig_deriv = -0.045 * var_intracellular_Ca_buffering__dOCdt - 0.08 * var_intracellular_Ca_buffering__dOTCdt - 0.16 * var_intracellular_Ca_buffering__dOTMgCdt + (-var_Ca_handling_by_the_SR__i_up - var_background_currents__i_B_Ca - var_sarcolemmal_calcium_pump_current__i_CaP + 2.0 * var_Na_Ca_ion_exchanger_current__i_NaCa + var_Ca_handling_by_the_SR__i_rel + var_intracellular_ion_concentrations__i_di) / (2.0 * var_intracellular_ion_concentrations__Vol_i * var_membrane__F); // millimolar / second
