...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Dynamicten_tusscher_model_2004_epiFromCellMLCvode::UseCellMLDefaultStimulus()
    {
    ...
    double Dynamicten_tusscher_model_2004_epiFromCellMLCvode::GetIntracellularCalciumConcentration()
    {
        return NV_Ith_S(mStateVariables, 1);
    }
    
    Dynamicten_tusscher_model_2004_epiFromCellMLCvode::Dynamicten_tusscher_model_2004_epiFromCellMLCvode(boost::shared_ptr<AbstractIvpOdeSolver> pOdeSolver /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCvodeCell(
                pOdeSolver,
                17,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellMLCvode>::Instance();
        Init();
    ...
    Dynamicten_tusscher_model_2004_epiFromCellMLCvode::~Dynamicten_tusscher_model_2004_epiFromCellMLCvode()
    {
    }
    
    double Dynamicten_tusscher_model_2004_epiFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        // Units: millimolar; Initial value: 6.62009903012691e-5
        ...
        // Units: dimensionless; Initial value: 1.95497279546125e-5
        ...
        // Units: dimensionless; Initial value: 2.01549207399881e-8
        ...
        const double var_inward_rectifier_potassium_current__beta_K1 = ((3.0 * exp(0.00020000000000000001 * ((var_inward_rectifier_potassium_current__V - var_inward_rectifier_potassium_current__E_K) + 100.0))) + (1.0 * exp(0.10000000000000001 * ((var_inward_rectifier_potassium_current__V - var_inward_rectifier_potassium_current__E_K) - 10.0)))) / (1.0 + exp((-0.5) * (var_inward_rectifier_potassium_current__V - var_inward_rectifier_potassium_current__E_K))); // per_millisecond
        const double var_inward_rectifier_potassium_current__alpha_K1 = 0.10000000000000001 / (1.0 + exp(0.059999999999999998 * ((var_inward_rectifier_potassium_current__V - var_inward_rectifier_potassium_current__E_K) - 200.0))); // per_millisecond
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        ...
        const double var_sodium_dynamics__d_Na_i_d_environment__time = ((-1.0) * (var_sodium_dynamics__i_Na + var_sodium_dynamics__i_b_Na + (3.0 * var_sodium_dynamics__i_NaK) + (3.0 * var_sodium_dynamics__i_NaCa)) * var_sodium_dynamics__Cm) / (1.0 * var_sodium_dynamics__V_c * var_sodium_dynamics__F); // 'millimole per litre per millisecond'
        ...
        const double var_potassium_dynamics__d_K_i_d_environment__time = ((-1.0) * ((var_potassium_dynamics__i_K1 + var_potassium_dynamics__i_to + var_potassium_dynamics__i_Kr + var_potassium_dynamics__i_Ks + var_potassium_dynamics__i_p_K + var_potassium_dynamics__i_Stim) - (2.0 * var_potassium_dynamics__i_NaK)) * var_potassium_dynamics__Cm) / (1.0 * var_potassium_dynamics__V_c * var_potassium_dynamics__F); // 'millimole per litre per millisecond'
    ...
    void Dynamicten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -86.3189802410563
        double var_chaste_interface__calcium_dynamics__Ca_i = NV_Ith_S(rY, 1);
        ...
        const double var_t839 = var_t838 * var_t3; // dimensionless
        const double var_t840 = var_t839 * var_membrane__Cm; // dimensionless
        ...
        const double var_t1015 = (var_t236 * var_membrane__Cm) * var_t839; // dimensionless
        const double var_t1040 = (var_t39 * var_membrane__Cm) * var_t839; // dimensionless
        ...
        IJth(rJacobian, 15, 0) = var_chaste_interface__environment__fake_dt * (((-((((var_t146 + var_sodium_background_current__g_bna) - (3.0 * var_t141)) + (3.0 * var_t184)) - (3.0 * var_t197))) * var_membrane__Cm) * var_t839);
        IJth(rJacobian, 16, 0) = var_chaste_interface__environment__fake_dt * (((-(((((((((-var_t43) - var_t62) + var_t65) + var_t67) + var_t71) + var_t73) + var_t203) + var_t209) + (2.0 * var_t141))) * var_membrane__Cm) * var_t839);
        ...
        IJth(rJacobian, 15, 15) = var_chaste_interface__environment__fake_dt * (((-((((var_t299 + var_t302) + (3.0 * var_t291)) - (3.0 * var_t296)) + (9.0 * var_t307))) * var_membrane__Cm) * var_t839);
        IJth(rJacobian, 16, 15) = var_chaste_interface__environment__fake_dt * (((-((var_t287 - (2.0 * var_t291)) + (2.0 * var_t296))) * var_membrane__Cm) * var_t839);
        IJth(rJacobian, 0, 16) = var_chaste_interface__environment__fake_dt * (mSetVoltageDerivativeToZero ? 0.0 : var_t350);
        IJth(rJacobian, 16, 16) = var_chaste_interface__environment__fake_dt * ((var_t350 * var_membrane__Cm) * var_t839);
    }
    
template<>
void OdeSystemInformation<Dynamicten_tusscher_model_2004_epiFromCellMLCvode>::Initialise(void)
{
    ...
    this->mInitialConditions.push_back(6.62009903012691e-5);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(1.95497279546125e-5);
    ...
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(2.01549207399881e-8);
...
CHASTE_CLASS_EXPORT(Dynamicten_tusscher_model_2004_epiFromCellMLCvode)
