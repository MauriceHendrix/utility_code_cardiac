...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_time_dependent_rectifier_potassium_current__i_K = (-var_cell_parameters__K_o * exp(-var_cell_parameters__F * var_chaste_interface__membrane_potential__V / (var_cell_parameters__R * var_cell_parameters__T)) + var_chaste_interface__intracellular_potassium_concentration__K_i) * var_time_dependent_rectifier_potassium_current__i_Kmax * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x / 140.0; // nanoA
        const double var_time_dependent_rectifier_potassium_current_x_gate__x_orig_deriv = (-var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x + 1.0) * var_time_dependent_rectifier_potassium_current_x_gate__alpha_x - var_time_dependent_rectifier_potassium_current_x_gate__beta_x * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x; // 1 / second
        ...
        const double var_time_independent_potassium_current__i_K1 = (-var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * var_cell_parameters__K_o * var_time_independent_potassium_current__g_K1 / ((1.0 + exp((-10.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane_potential__V) * 2.0 * var_cell_parameters__F / (var_cell_parameters__R * var_cell_parameters__T))) * (var_cell_parameters__K_o + var_time_independent_potassium_current__K_mk1)); // nanoA
        const double var_transient_outward_current__g_to = 0.005; // microS
        const double var_transient_outward_current_r_gate__r_orig_deriv = (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / (1.0 + exp((-4.0 - var_chaste_interface__membrane_potential__V) / 5.0))) * 333.0; // 1 / second
        ...
        const double var_transient_outward_current_s_gate__s_orig_deriv = (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0) * var_transient_outward_current_s_gate__alpha_s - var_transient_outward_current_s_gate__beta_s * var_chaste_interface__transient_outward_current_s_gate__s; // 1 / second
        ...
        const double var_troponin__Trpn_Ca_orig_deriv = (-var_chaste_interface__troponin__Trpn_Ca + var_troponin__Trpn_tot) * var_chaste_interface__intracellular_calcium_concentration__Ca_i * var_troponin__alpha_trpn - ((-var_Force__Force_norm + 1.0) * 2.0 + 1.0) * var_chaste_interface__troponin__Trpn_Ca * var_troponin__beta_trpn / 3.0; // millimolar / second
        ...
        const double var_intracellular_calcium_concentration__Ca_i_orig_deriv = -var_SERCA__j_up - var_calmodulin__dCmdn_Ca_dtime - var_troponin__dTrpn_Ca_dtime + var_RyR__j_rel * var_cell_parameters__v_SR / var_cell_parameters__v_i + (-var_L_type_Ca_channel__i_Ca_L_Ca - var_calcium_background_current__i_b_Ca + 2.0 * var_sodium_calcium_exchanger__i_NaCa) / (2.0 * var_cell_parameters__F * var_cell_parameters__v_i); // millimolar / second
