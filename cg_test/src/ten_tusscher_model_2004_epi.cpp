...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellten_tusscher_model_2004_epiFromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__i_Stim_Amplitude = var_-52.0 * HeartConfig::Instance()->GetCapacitance(); // uA_per_uF
    ...
    double Cellten_tusscher_model_2004_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_L_type_Ca_current__i_CaL = pow(var_membrane__F, 2.0) * (var_chaste_interface__calcium_dynamics__Ca_i * exp(2.0 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) - 0.341 * var_calcium_dynamics__Ca_o) * 4.0 * var_L_type_Ca_current__g_CaL * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa * var_chaste_interface__L_type_Ca_current_f_gate__f * var_chaste_interface__membrane__V / ((-1.0 + exp(2.0 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // picoA_per_picoF
        ...
        const double var_inward_rectifier_potassium_current__alpha_K1 = 0.1 / (1.0 + exp((-200.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * 0.06)); // per_millisecond
        const double var_inward_rectifier_potassium_current__beta_K1 = (1.0 * exp((-10.0 - var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * 0.1) + 3.0 * exp((-var_reversal_potentials__E_K + 100.0 + var_chaste_interface__membrane__V) * 0.0002)) / (1.0 + exp(-(-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * 0.5)); // per_millisecond
    ...
    void Cellten_tusscher_model_2004_epiFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_Ca_current_fCa_gate__alpha_fCa = 1.0 / (pow((var_chaste_interface__calcium_dynamics__Ca_i / 0.000325), 8.0) + 1.0); // dimensionless
        const double var_L_type_Ca_current_fCa_gate__beta_fCa = 0.1 / (1.0 + exp((-0.0005 + var_chaste_interface__calcium_dynamics__Ca_i) / 0.0001)); // dimensionless
        const double var_L_type_Ca_current_fCa_gate__gama_fCa = 0.2 / (1.0 + exp((-0.00075 + var_chaste_interface__calcium_dynamics__Ca_i) / 0.0008)); // dimensionless
        const double var_L_type_Ca_current_fCa_gate__fCa_inf = (0.23 + var_L_type_Ca_current_fCa_gate__alpha_fCa + var_L_type_Ca_current_fCa_gate__beta_fCa + var_L_type_Ca_current_fCa_gate__gama_fCa) / 1.46; // dimensionless
        ...
        const double var_calcium_dynamics__g_inf = ((0.00035 > var_chaste_interface__calcium_dynamics__Ca_i) ? (1.0 / (pow((var_chaste_interface__calcium_dynamics__Ca_i / 0.00035), 6.0) + 1.0)) : (1.0 / (pow((var_chaste_interface__calcium_dynamics__Ca_i / 0.00035), 16.0) + 1.0))); // dimensionless
        ...
        const double var_membrane__R = 8314.472; // joule_per_mole_kelvin
        const double var_membrane__T = 310.0; // kelvin
        const double d_dt_chaste_interface_var_L_type_Ca_current_fCa_gate__fCa = (((var_chaste_interface__L_type_Ca_current_fCa_gate__fCa < var_L_type_Ca_current_fCa_gate__fCa_inf) && (60.0 > -var_chaste_interface__membrane__V)) ? (0.0) : (var_L_type_Ca_current_fCa_gate__d_fCa)); // 1 / millisecond
        const double d_dt_chaste_interface_var_calcium_dynamics__g = (((var_chaste_interface__calcium_dynamics__g < var_calcium_dynamics__g_inf) && (60.0 > -var_chaste_interface__membrane__V)) ? (0.0) : (var_calcium_dynamics__d_g)); // 1 / millisecond
        const double var_L_type_Ca_current__i_CaL = pow(var_membrane__F, 2.0) * (var_chaste_interface__calcium_dynamics__Ca_i * exp(2.0 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) - 0.341 * var_calcium_dynamics__Ca_o) * 4.0 * var_L_type_Ca_current__g_CaL * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa * var_chaste_interface__L_type_Ca_current_f_gate__f * var_chaste_interface__membrane__V / ((-1.0 + exp(2.0 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // picoA_per_picoF
        ...
        const double var_L_type_Ca_current_d_gate__d_inf = 1.0 / (1.0 + exp((-5.0 - var_chaste_interface__membrane__V) / 7.5)); // dimensionless
        ...
        const double var_L_type_Ca_current_f_gate__tau_f = 165.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 25.0) / 10.0)) + 1125.0 * exp(-pow((27.0 + var_chaste_interface__membrane__V), 2.0) / 240.0) + 80.0; // millisecond
        ...
        const double var_reversal_potentials__P_kna = 0.03; // dimensionless
        const double var_slow_time_dependent_potassium_current__g_Ks = 0.245; // nanoS_per_picoF
        const double var_slow_time_dependent_potassium_current_Xs_gate__alpha_xs = 1100.0 / sqrt(1.0 + exp((-10.0 - var_chaste_interface__membrane__V) / 6.0)); // dimensionless
        const double var_slow_time_dependent_potassium_current_Xs_gate__beta_xs = 1.0 / (1.0 + exp((-60.0 + var_chaste_interface__membrane__V) / 20.0)); // dimensionless
        ...
        const double var_sodium_background_current__i_b_Na = (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_sodium_background_current__g_bna; // picoA_per_picoF
        const double var_sodium_calcium_exchanger_current__i_NaCa = (pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0) * var_calcium_dynamics__Ca_o * exp(var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchanger_current__gamma / (var_membrane__R * var_membrane__T)) - pow(var_sodium_dynamics__Na_o, 3.0) * var_chaste_interface__calcium_dynamics__Ca_i * var_sodium_calcium_exchanger_current__alpha * exp((-1.0 + var_sodium_calcium_exchanger_current__gamma) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_sodium_calcium_exchanger_current__K_NaCa / ((pow(var_sodium_calcium_exchanger_current__Km_Nai, 3.0) + pow(var_sodium_dynamics__Na_o, 3.0)) * (var_sodium_calcium_exchanger_current__K_sat * exp((-1.0 + var_sodium_calcium_exchanger_current__gamma) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 1.0) * (var_calcium_dynamics__Ca_o + var_sodium_calcium_exchanger_current__Km_Ca)); // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_i = (-var_calcium_dynamics__i_up - (-2.0 * var_sodium_calcium_exchanger_current__i_NaCa + var_L_type_Ca_current__i_CaL + var_calcium_background_current__i_b_Ca + var_calcium_pump_current__i_p_Ca) * 1.0 * var_membrane__Cm / (1.0 * 2.0 * var_membrane__F * var_membrane__V_c) + var_calcium_dynamics__i_leak + var_calcium_dynamics__i_rel) * var_calcium_dynamics__Ca_i_bufc; // millimolar / millisecond
        const double var_sodium_potassium_pump_current__K_mNa = 40.0; // millimolar
        const double var_sodium_potassium_pump_current__K_mk = 1.0; // millimolar
        const double var_sodium_potassium_pump_current__P_NaK = 1.362; // picoA_per_picoF
        const double var_sodium_potassium_pump_current__i_NaK = var_potassium_dynamics__K_o * var_chaste_interface__sodium_dynamics__Na_i * var_sodium_potassium_pump_current__P_NaK / ((var_potassium_dynamics__K_o + var_sodium_potassium_pump_current__K_mk) * (var_chaste_interface__sodium_dynamics__Na_i + var_sodium_potassium_pump_current__K_mNa) * (0.0353 * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 0.1245 * exp(-0.1 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 1.0)); // picoA_per_picoF
...
void OdeSystemInformation<Cellten_tusscher_model_2004_epiFromCellML>::Initialise(void)
{
    ...
    // rY[10]:
    this->mVariableNames.push_back("ar_L_type_Ca_current_fCa_gate__fCa");
    this->mVariableUnits.push_back("dimensionless");
    ...
    // rY[14]:
    this->mVariableNames.push_back("ar_calcium_dynamics__g");
    this->mVariableUnits.push_back("dimensionless");
