...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_Irel__CaMKtrap = -0.00068 * var_chaste_interface__Irel__CaMKtrap + (-var_chaste_interface__Irel__CaMKtrap + var_Irel__CaMKactive) * 0.05 * var_Irel__CaMKactive; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_Ito2__AA = (-var_chaste_interface__Ito2__AA + var_Ito2__AAss) / 1.0; // 1 / ms
        const double var_Ito2__PCl = 4e-07; // L_per_F_ms
        ...
        const double d_dt_chaste_interface_var_ICaL__dp = (-var_chaste_interface__ICaL__dp + var_ICaL__dpss) / 10.0; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_IKs__xs2 = (-var_chaste_interface__IKs__xs2 + var_IKs__xss) / (2.0 * var_IKs__tauxs); // 1 / ms
        ...
        const double d_dt_chaste_interface_var_INa__H = (-var_chaste_interface__INa__H + 1.0) * var_INa__ah - var_chaste_interface__INa__H * var_INa__bh; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_INa__J = (-var_chaste_interface__INa__J + 1.0) * var_INa__aj - var_chaste_interface__INa__J * var_INa__bj; // 1 / ms
        const double var_INa__bm = 0.08 * exp(-var_chaste_interface__cell__V / 11.0); // per_ms
        const double d_dt_chaste_interface_var_INa__m = (-var_chaste_interface__INa__m + 1.0) * var_INa__am - var_INa__bm * var_chaste_interface__INa__m; // 1 / ms
        const double var_INaCa__denom1 = var_INaCa__ksat * exp((-1.0 + var_INaCa__eta) * var_Environment__FonRT * var_chaste_interface__cell__V) + 1.0; // dimensionless
        const double var_INaCa__num = pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o * exp(var_Environment__FonRT * var_INaCa__eta * var_chaste_interface__cell__V) - pow(var_Environment__Na_o, 3.0) * var_INaCa__ca_i_NaCa * exp((-1.0 + var_INaCa__eta) * var_Environment__FonRT * var_chaste_interface__cell__V); // mM4
        const double var_INaCa__INaCa = var_INaCa__NCXmax * var_INaCa__allo * var_INaCa__num / ((var_INaCa__denom2 + var_INaCa__denom3) * var_INaCa__denom1); // uA_per_uF
        const double var_INaK__fnak = 1.0 / (0.1245 * exp(-0.1 * var_Environment__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_Environment__FonRT * var_chaste_interface__cell__V) + 1.0); // dimensionless
        ...
        const double d_dt_chaste_interface_var_INal__mL = (-var_chaste_interface__INal__mL + 1.0) * var_INal__amL - var_INal__bmL * var_chaste_interface__INal__mL; // 1 / ms
        const double var_INal__hLss = 1.0 / (1.0 + exp((91.0 + var_chaste_interface__cell__V) / 6.1)); // dimensionless
        const double d_dt_chaste_interface_var_INal__hL = (-var_chaste_interface__INal__hL + var_INal__hLss) / 600.0; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_Irel__ro = (-var_chaste_interface__Irel__ro + var_Irel__ross) / 3.0; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_Ito__ydv = (-var_chaste_interface__Ito__ydv + 1.0) * var_Ito__ay - var_Ito__by * var_chaste_interface__Ito__ydv; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_Ito__ydv2 = (-var_chaste_interface__Ito__ydv2 + 1.0) * var_Ito__ay2 - var_Ito__by2 * var_chaste_interface__Ito__ydv2; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_Ito__zdv = (-var_chaste_interface__Ito__zdv + 1.0) * var_Ito__ay3 - var_Ito__by3 * var_chaste_interface__Ito__zdv; // 1 / ms
        const double var_Ito__rv = exp(var_chaste_interface__cell__V / 300.0); // dimensionless
        const double var_Ito2__Ito2_max = (-var_Environment__Cl_o * exp(var_Environment__FonRT * var_chaste_interface__cell__V) + var_chaste_interface__Cl__Cl_i) * var_Environment__F * var_Environment__FonRT * var_Ito2__PCl * var_chaste_interface__cell__V / (-exp(var_Environment__FonRT * var_chaste_interface__cell__V) + 1.0); // uA_per_uF
        const double var_Ito2__Ito2 = var_chaste_interface__Ito2__AA * var_Ito2__Ito2_max; // uA_per_uF
        ...
        const double d_dt_chaste_interface_var_Ca__Ca_i = ((-var_Iup_Ileak__iup + var_Iup_Ileak__ileak) * var_cell__vnsr / var_cell__vmyo + var_Idiff_Itr__idiff * var_cell__vss / var_cell__vmyo + (-var_ICab__ICab - var_IpCa__IpCa + 2.0 * var_INaCa__INaCa) * var_cell__AF / (2.0 * var_cell__vmyo)) * var_Ca__bmyo; // mM / ms
        const double d_dt_chaste_interface_var_Ca__Ca_ss = (-var_Idiff_Itr__idiff + var_Irel__irelcicr * var_cell__vjsr / var_cell__vss - var_ICaL__ICaL * var_cell__AF / (2.0 * var_cell__vss)) * var_Ca__bss; // mM / ms
        const double var_reversal_potentials__ECl = -log(var_Environment__Cl_o / var_chaste_interface__Cl__Cl_i) / var_Environment__FonRT; // mV
        const double var_IClb__IClb = (-var_reversal_potentials__ECl + var_chaste_interface__cell__V) * var_IClb__GClb; // uA_per_uF
        const double var_cell__clont = 0.5 * var_cell__i_Stim + var_IClb__IClb + var_Ito2__Ito2; // uA_per_uF
        const double var_reversal_potentials__EK = log(var_Environment__K_o / var_chaste_interface__K__K_i) / var_Environment__FonRT; // mV
...
void OdeSystemInformation<Cellhund_rudy_2004_aFromCellML>::Initialise(void)
{
    ...
    // rY[14]:
    this->mVariableNames.push_back("var_Ito__ydv");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.013970786703);
    
    // rY[15]:
    this->mVariableNames.push_back("var_Ito__ydv2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.99996472752);
    
    // rY[16]:
    this->mVariableNames.push_back("var_Ito__zdv");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.829206149767);
    
    // rY[17]:
    this->mVariableNames.push_back("var_Ito2__AA");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.000816605172);
    
    // rY[18]:
    this->mVariableNames.push_back("var_INal__mL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.001356538159);
    
    // rY[19]:
    this->mVariableNames.push_back("var_INal__hL");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.26130711759);
    
    // rY[20]:
    this->mVariableNames.push_back("var_Irel__CaMKtrap");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.021123704774);
    
    // rY[21]:
    this->mVariableNames.push_back("var_Irel__ro");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.0);
    
    // rY[22]:
    this->mVariableNames.push_back("var_Irel__ri");
    this->mVariableUnits.push_back("dimensionless");
