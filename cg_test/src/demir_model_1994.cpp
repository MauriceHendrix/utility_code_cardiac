...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldemir_model_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_delayed_rectifying_potassium_current__g_K_max = 0.0069300000000000004; // microS
        const double var_delayed_rectifying_potassium_current__g_K = 1.0 * pow(var_cleft_space_equations__K_b, 0.58999999999999997) * var_delayed_rectifying_potassium_current__g_K_max; // microS
