...
#include "MathsCustomFunctions.hpp"
    ...
    double Celldemir_model_1994FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_delayed_rectifying_potassium_current__g_K = pow((var_cleft_space_equations__K_b / 1.0), 0.59) * var_delayed_rectifying_potassium_current__g_K_max; // microS
        ...
        const double var_L_type_Ca_channel_d_gate__d_L_infinity = 1.0 / (1.0 + exp(-(14.1 + var_chaste_interface__membrane__V) / 6.0)); // dimensionless
        ...
        const double var_sodium_potassium_pump__i_NaK = pow((var_chaste_interface__cleft_space_equations__K_c / (var_chaste_interface__cleft_space_equations__K_c + var_sodium_potassium_pump__K_m_K)), 2.0) * pow((var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i / (var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i + var_sodium_potassium_pump__K_m_Na)), 3.0) * 1.6 * var_sodium_potassium_pump__i_NaK_max / (1.5 + exp(-(60.0 + var_chaste_interface__membrane__V) / 40.0)); // nanoA
    ...
    void Celldemir_model_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_SR_Ca_uptake_and_release__phi_Calse = -641.0 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse + (-var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse + 1.0) * 770.0 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel; // per_second
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__Ca_Calse = 0.001 * var_SR_Ca_uptake_and_release__phi_Calse; // 1 / second
        const double var_T_type_Ca_channel__E_Ca_T = 45.0; // millivolt
        const double var_T_type_Ca_channel__g_Ca_T = 0.02521; // microS
        const double var_calcium_pump_current__i_Ca_P_max = 0.02869; // nanoA
        ...
        const double var_SR_Ca_uptake_and_release__r_inact = pow((var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / (var_SR_Ca_uptake_and_release__k_rel + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i)), 4.0) * 240.0 + 40.0; // per_second
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__F3 = 0.001 * var_chaste_interface__SR_Ca_uptake_and_release__F2 * var_SR_Ca_uptake_and_release__r_inact - 0.001 * 0.96 * var_chaste_interface__SR_Ca_uptake_and_release__F3; // 1 / second
        const double var_calcium_pump_current__i_Ca_P = var_calcium_pump_current__i_Ca_P_max * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / (0.0004 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i); // nanoA
        ...
        const double var_intracellular_concentrations_and_buffer_equations__phi_C = -307.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + (-var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + 1.0) * 129000.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i; // per_second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_Calmod = 0.001 * var_intracellular_concentrations_and_buffer_equations__phi_C; // 1 / second
        ...
        const double var_intracellular_concentrations_and_buffer_equations__phi_TC = -252.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop + (-var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop + 1.0) * 50500.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i; // per_second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_Trop = 0.001 * var_intracellular_concentrations_and_buffer_equations__phi_TC; // 1 / second
        ...
        const double var_intracellular_concentrations_and_buffer_equations__phi_TMgC = -4.25 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop + (-var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop - var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + 1.0) * 129000.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i; // per_second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop = 0.001 * var_intracellular_concentrations_and_buffer_equations__phi_TMgC; // 1 / second
        ...
        const double var_intracellular_concentrations_and_buffer_equations__phi_TMgM = -429.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + (-var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop - var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + 1.0) * 1290.0 * var_intracellular_concentrations_and_buffer_equations__Mg_i; // per_second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop = 0.001 * var_intracellular_concentrations_and_buffer_equations__phi_TMgM; // 1 / second
        const double var_linear_background_current__g_B_Ca = 3.64e-05; // microS
        const double var_linear_background_current__g_B_K = 6.94e-05; // microS
        const double var_linear_background_current__g_B_Na = 0.00016; // microS
        const double var_membrane__F = 96485.3415; // coulomb_per_mole
        const double var_SR_Ca_uptake_and_release__i_tr = (-var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel + var_chaste_interface__SR_Ca_uptake_and_release__Ca_up) * 2.0 * var_SR_Ca_uptake_and_release__V_up * var_membrane__F / 0.06418; // nanoA
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__Ca_rel = -0.001 * 11.48 * var_SR_Ca_uptake_and_release__phi_Calse + 0.001 * (-var_SR_Ca_uptake_and_release__i_rel + var_SR_Ca_uptake_and_release__i_tr) / (2.0 * var_SR_Ca_uptake_and_release__V_rel * var_membrane__F); // millimolar / second
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__Ca_up = 0.001 * (-var_SR_Ca_uptake_and_release__i_tr + var_SR_Ca_uptake_and_release__i_up) / (2.0 * var_SR_Ca_uptake_and_release__V_up * var_membrane__F); // millimolar / second
        const double var_membrane__R = 8314.472; // joule_per_kilomole_kelvin
        const double var_membrane__T = 310.0; // kelvin
        const double var_L_type_Ca_channel_d_gate__alpha_d_L = -(35.0 + var_chaste_interface__membrane__V) * 28.39 / (-1.0 + exp(-(35.0 + var_chaste_interface__membrane__V) / 2.5)) - 84.9 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.208 * var_chaste_interface__membrane__V)); // per_second
        const double var_L_type_Ca_channel_d_gate__beta_d_L = (-5.0 + var_chaste_interface__membrane__V) * 11.43 / (-1.0 + exp((-5.0 + var_chaste_interface__membrane__V) * 0.4)); // per_second
        const double var_L_type_Ca_channel_d_gate__d_L_infinity = 1.0 / (1.0 + exp(-(14.1 + var_chaste_interface__membrane__V) / 6.0)); // dimensionless
        const double var_L_type_Ca_channel__i_Ca_L = (-var_L_type_Ca_channel__E_Ca_L + var_chaste_interface__membrane__V) * (0.095 * var_L_type_Ca_channel_d_gate__d_L_infinity + var_chaste_interface__L_type_Ca_channel_d_gate__d_L * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * var_L_type_Ca_channel__g_Ca_L; // nanoA
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_d_gate__d_L = 0.001 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d_L + var_L_type_Ca_channel_d_gate__d_L_infinity) / var_L_type_Ca_channel_d_gate__tau_d_L; // 1 / second
        const double var_L_type_Ca_channel_f_gate__alpha_f_L = (28.0 + var_chaste_interface__membrane__V) * 3.75 / (-1.0 + exp((28.0 + var_chaste_interface__membrane__V) / 4.0)); // per_second
        const double var_L_type_Ca_channel_f_gate__beta_f_L = 30.0 / (1.0 + exp(-(28.0 + var_chaste_interface__membrane__V) / 4.0)); // per_second
        const double var_L_type_Ca_channel_f_gate__f_L_infinity = 1.0 / (1.0 + exp((30.0 + var_chaste_interface__membrane__V) / 5.0)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_L_type_Ca_channel_f_gate__f_L = 0.001 * (-var_chaste_interface__L_type_Ca_channel_f_gate__f_L + var_L_type_Ca_channel_f_gate__f_L_infinity) / var_L_type_Ca_channel_f_gate__tau_f_L; // 1 / second
        const double var_SR_Ca_uptake_and_release__r_act = pow((var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / (var_SR_Ca_uptake_and_release__k_rel + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i)), 4.0) * 240.0 + 240.0 * exp((-40.0 + var_chaste_interface__membrane__V) * 0.08); // per_second
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__F1 = 0.001 * 0.96 * var_chaste_interface__SR_Ca_uptake_and_release__F3 - 0.001 * var_chaste_interface__SR_Ca_uptake_and_release__F1 * var_SR_Ca_uptake_and_release__r_act; // 1 / second
        const double d_dt_chaste_interface_var_SR_Ca_uptake_and_release__F2 = 0.001 * var_chaste_interface__SR_Ca_uptake_and_release__F1 * var_SR_Ca_uptake_and_release__r_act - 0.001 * var_chaste_interface__SR_Ca_uptake_and_release__F2 * var_SR_Ca_uptake_and_release__r_inact; // 1 / second
        const double var_T_type_Ca_channel__i_Ca_T = (-var_T_type_Ca_channel__E_Ca_T + var_chaste_interface__membrane__V) * var_T_type_Ca_channel__g_Ca_T * var_chaste_interface__T_type_Ca_channel_d_gate__d_T * var_chaste_interface__T_type_Ca_channel_f_gate__f_T; // nanoA
        ...
        const double var_T_type_Ca_channel_d_gate__d_T_infinity = 1.0 / (1.0 + exp(-(26.3 + var_chaste_interface__membrane__V) / 6.0)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_T_type_Ca_channel_d_gate__d_T = 0.001 * (-var_chaste_interface__T_type_Ca_channel_d_gate__d_T + var_T_type_Ca_channel_d_gate__d_T_infinity) / var_T_type_Ca_channel_d_gate__tau_d_T; // 1 / second
        const double var_T_type_Ca_channel_f_gate__alpha_f_T = 15.3 * exp(-(61.7 + var_chaste_interface__membrane__V) / 83.3); // per_second
        const double var_T_type_Ca_channel_f_gate__beta_f_T = 15.0 * exp((61.7 + var_chaste_interface__membrane__V) / 15.38); // per_second
        const double var_T_type_Ca_channel_f_gate__f_T_infinity = 1.0 / (1.0 + exp((61.7 + var_chaste_interface__membrane__V) / 5.6)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_T_type_Ca_channel_f_gate__f_T = 0.001 * (-var_chaste_interface__T_type_Ca_channel_f_gate__f_T + var_T_type_Ca_channel_f_gate__f_T_infinity) / var_T_type_Ca_channel_f_gate__tau_f_T; // 1 / second
        const double var_delayed_rectifying_potassium_current_P_a_gate__P_a_infinity = 1.0 / (1.0 + exp(-(5.1 + var_chaste_interface__membrane__V) / 7.4)); // dimensionless
        ...
        const double d_dt_chaste_interface_var_delayed_rectifying_potassium_current_P_a_gate__P_a = 0.001 * (-var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a + var_delayed_rectifying_potassium_current_P_a_gate__P_a_infinity) / var_delayed_rectifying_potassium_current_P_a_gate__tau_P_a; // 1 / second
        ...
        const double d_dt_chaste_interface_var_delayed_rectifying_potassium_current_P_i_gate__P_i = 0.001 * (-var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i + 1.0) * var_delayed_rectifying_potassium_current_P_i_gate__alpha_P_i - 0.001 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i * var_delayed_rectifying_potassium_current_P_i_gate__beta_P_i; // 1 / second
        const double var_hyperpolarisation_activated_current__i_f_K = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2.0) * (85.0 + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_K; // nanoA
        const double var_hyperpolarisation_activated_current__i_f_Na = pow(var_chaste_interface__hyperpolarisation_activated_current_y_gate__y, 2.0) * (-75.0 + var_chaste_interface__membrane__V) * var_hyperpolarisation_activated_current__g_f_Na; // nanoA
        const double var_hyperpolarisation_activated_current_y_gate__tau_y = 1.0 / (14.01055 / (0.7 + exp(-(60.0 + var_chaste_interface__membrane__V) / 5.5)) + 1.6483 * exp(-(54.06 + var_chaste_interface__membrane__V) / 24.33)); // second
        const double var_hyperpolarisation_activated_current_y_gate__y_infinity = 1.0 / (1.0 + exp((72.2 + var_chaste_interface__membrane__V) / 9.0)); // dimensionless
        ...
        const double var_sodium_calcium_pump__gamma = 0.5; // dimensionless
        const double var_sodium_calcium_pump__i_NaCa = (pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 3.0) * var_chaste_interface__cleft_space_equations__Ca_c * exp(0.03743 * var_chaste_interface__membrane__V * var_sodium_calcium_pump__gamma) - pow(var_chaste_interface__cleft_space_equations__Na_c, 3.0) * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i * exp((-1.0 + var_sodium_calcium_pump__gamma) * 0.03743 * var_chaste_interface__membrane__V)) * var_sodium_calcium_pump__K_NaCa / ((pow(var_chaste_interface__cleft_space_equations__Na_c, 3.0) * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i + pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 3.0) * var_chaste_interface__cleft_space_equations__Ca_c) * var_sodium_calcium_pump__d_NaCa + 1.0); // nanoA
        const double d_dt_chaste_interface_var_cleft_space_equations__Ca_c = 0.001 * (-var_chaste_interface__cleft_space_equations__Ca_c + var_cleft_space_equations__Ca_b) / var_cleft_space_equations__tau_p + 0.001 * (-2.0 * var_sodium_calcium_pump__i_NaCa + var_L_type_Ca_channel__i_Ca_L + var_T_type_Ca_channel__i_Ca_T + var_calcium_pump_current__i_Ca_P + var_linear_background_current__i_B_Ca) / (2.0 * var_cleft_space_equations__V_c * var_membrane__F); // millimolar / second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Ca_i = -0.001 * var_intracellular_concentrations_and_buffer_equations__phi_B + 0.001 * (-var_L_type_Ca_channel__i_Ca_L - var_SR_Ca_uptake_and_release__i_up - var_T_type_Ca_channel__i_Ca_T - var_calcium_pump_current__i_Ca_P - var_linear_background_current__i_B_Ca + 2.0 * var_sodium_calcium_pump__i_NaCa + var_SR_Ca_uptake_and_release__i_rel) / (2.0 * var_intracellular_concentrations_and_buffer_equations__V_i * var_membrane__F); // millimolar / second
        const double var_sodium_current__P_Na = 0.00344; // mul_per_second
        const double var_sodium_current_h_gate__alpha_h1 = 165.0 * exp(-(101.3 + var_chaste_interface__membrane__V) / 12.6); // per_second
        const double var_sodium_current_h_gate__beta_h1 = 12360.0 / (320.0 * exp(-(101.3 + var_chaste_interface__membrane__V) / 12.6) + 1.0); // per_second
        ...
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h1 = 0.001 * (-var_chaste_interface__sodium_current_h_gate__h1 + var_sodium_current_h_gate__h1_infinity) / var_sodium_current_h_gate__tau_h1; // 1 / second
        const double var_sodium_current_h_gate__tau_h2 = 20.0 * var_sodium_current_h_gate__tau_h1; // second
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h2 = 0.001 * (-var_chaste_interface__sodium_current_h_gate__h2 + var_sodium_current_h_gate__h2_infinity) / var_sodium_current_h_gate__tau_h2; // 1 / second
        const double var_sodium_current_m_gate__alpha_m = -(51.9 + var_chaste_interface__membrane__V) * 824.0 / (-1.0 + exp(-(51.9 + var_chaste_interface__membrane__V) / 8.9)); // per_second
        const double var_sodium_current_m_gate__beta_m = 32960.0 * exp(-(51.9 + var_chaste_interface__membrane__V) / 8.9); // per_second
        const double var_sodium_current__i_Na = pow(var_membrane__F, 2.0) * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * (-1.0 + exp((-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_membrane__F / (var_membrane__R * var_membrane__T))) * var_chaste_interface__cleft_space_equations__Na_c * var_chaste_interface__membrane__V * var_sodium_current__P_Na * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2 / ((-1.0 + exp(var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_membrane__R * var_membrane__T); // nanoA
        ...
        const double var_sodium_potassium_pump__i_NaK_max = 0.2192; // nanoA
        const double var_sodium_potassium_pump__i_NaK = pow((var_chaste_interface__cleft_space_equations__K_c / (var_chaste_interface__cleft_space_equations__K_c + var_sodium_potassium_pump__K_m_K)), 2.0) * pow((var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i / (var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i + var_sodium_potassium_pump__K_m_Na)), 3.0) * 1.6 * var_sodium_potassium_pump__i_NaK_max / (1.5 + exp(-(60.0 + var_chaste_interface__membrane__V) / 40.0)); // nanoA
        const double d_dt_chaste_interface_var_cleft_space_equations__K_c = 0.001 * (-var_chaste_interface__cleft_space_equations__K_c + var_cleft_space_equations__K_b) / var_cleft_space_equations__tau_p + 0.001 * (-2.0 * var_sodium_potassium_pump__i_NaK + var_delayed_rectifying_potassium_current__i_K + var_hyperpolarisation_activated_current__i_f_K + var_linear_background_current__i_B_K) / (var_cleft_space_equations__V_c * var_membrane__F); // millimolar / second
        const double d_dt_chaste_interface_var_cleft_space_equations__Na_c = 0.001 * (-var_chaste_interface__cleft_space_equations__Na_c + var_cleft_space_equations__Na_b) / var_cleft_space_equations__tau_p + 0.001 * (3.0 * var_sodium_calcium_pump__i_NaCa + 3.0 * var_sodium_potassium_pump__i_NaK + var_hyperpolarisation_activated_current__i_f_Na + var_linear_background_current__i_B_Na + var_sodium_current__i_Na) / (var_cleft_space_equations__V_c * var_membrane__F); // millimolar / second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__K_i = 0.001 * (-var_delayed_rectifying_potassium_current__i_K - var_hyperpolarisation_activated_current__i_f_K - var_linear_background_current__i_B_K + 2.0 * var_sodium_potassium_pump__i_NaK) / (var_intracellular_concentrations_and_buffer_equations__V_i * var_membrane__F); // millimolar / second
        const double d_dt_chaste_interface_var_intracellular_concentrations_and_buffer_equations__Na_i = 0.001 * (-var_hyperpolarisation_activated_current__i_f_Na - var_linear_background_current__i_B_Na - var_sodium_current__i_Na - 3.0 * var_sodium_potassium_pump__i_NaK - 3.0 * var_sodium_calcium_pump__i_NaCa) / (var_intracellular_concentrations_and_buffer_equations__V_i * var_membrane__F); // millimolar / second
...
void OdeSystemInformation<Celldemir_model_1994FromCellML>::Initialise(void)
{
    ...
    // rY[3]:
    this->mVariableNames.push_back("ar_sodium_current_h_gate__h1");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.001386897);
    
    // rY[4]:
    this->mVariableNames.push_back("ar_sodium_current_h_gate__h2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.002065463);
    
    // rY[5]:
    this->mVariableNames.push_back("ar_L_type_Ca_channel_d_gate__d_L");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.002572773);
    
    // rY[6]:
    this->mVariableNames.push_back("ar_L_type_Ca_channel_f_gate__f_L");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.98651);
    
    // rY[7]:
    this->mVariableNames.push_back("ar_T_type_Ca_channel_d_gate__d_T");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.02012114);
    
    // rY[8]:
    this->mVariableNames.push_back("ar_T_type_Ca_channel_f_gate__f_T");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.1945111);
    
    // rY[9]:
    this->mVariableNames.push_back("ar_delayed_rectifying_potassium_current_P_a_gate__P_a");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.02302278);
    
    // rY[10]:
    this->mVariableNames.push_back("ar_delayed_rectifying_potassium_current_P_i_gate__P_i");
    this->mVariableUnits.push_back("dimensionless");
    ...
    // rY[14]:
    this->mVariableNames.push_back("ar_intracellular_concentrations_and_buffer_equations__Ca_Calmod");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.1411678);
    
    // rY[15]:
    this->mVariableNames.push_back("ar_intracellular_concentrations_and_buffer_equations__Ca_Trop");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.07331396);
    
    // rY[16]:
    this->mVariableNames.push_back("ar_intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.7618549);
    
    // rY[17]:
    this->mVariableNames.push_back("ar_intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop");
    this->mVariableUnits.push_back("dimensionless");
    ...
    // rY[21]:
    this->mVariableNames.push_back("ar_SR_Ca_uptake_and_release__Ca_up");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(16.95311);
    
    // rY[22]:
    this->mVariableNames.push_back("ar_SR_Ca_uptake_and_release__Ca_rel");
    this->mVariableUnits.push_back("millimolar");
    this->mInitialConditions.push_back(16.85024);
    
    // rY[23]:
    this->mVariableNames.push_back("ar_SR_Ca_uptake_and_release__Ca_Calse");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.9528726);
    
    // rY[24]:
    this->mVariableNames.push_back("ar_SR_Ca_uptake_and_release__F1");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.1133251);
    
    // rY[25]:
    this->mVariableNames.push_back("ar_SR_Ca_uptake_and_release__F2");
    this->mVariableUnits.push_back("dimensionless");
    this->mInitialConditions.push_back(0.0007594214);
    
    // rY[26]:
    this->mVariableNames.push_back("ar_SR_Ca_uptake_and_release__F3");
    this->mVariableUnits.push_back("dimensionless");
