...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_SR_Ca_uptake_and_release__F3_orig_deriv = var_chaste_interface__SR_Ca_uptake_and_release__F2 * var_SR_Ca_uptake_and_release__r_inact - 0.96 * var_chaste_interface__SR_Ca_uptake_and_release__F3; // 1 / second
        ...
        const double var_SR_Ca_uptake_and_release__Ca_rel_orig_deriv = -11.48 * var_SR_Ca_uptake_and_release__phi_Calse + (-var_SR_Ca_uptake_and_release__i_rel + var_SR_Ca_uptake_and_release__i_tr) / (2.0 * var_SR_Ca_uptake_and_release__V_rel * var_membrane__F); // millimolar / second
        ...
        const double var_SR_Ca_uptake_and_release__Ca_up_orig_deriv = (-var_SR_Ca_uptake_and_release__i_tr + var_SR_Ca_uptake_and_release__i_up) / (2.0 * var_SR_Ca_uptake_and_release__V_up * var_membrane__F); // millimolar / second
        ...
        const double var_SR_Ca_uptake_and_release__F1_orig_deriv = 0.96 * var_chaste_interface__SR_Ca_uptake_and_release__F3 - var_chaste_interface__SR_Ca_uptake_and_release__F1 * var_SR_Ca_uptake_and_release__r_act; // 1 / second
        ...
        const double var_intracellular_concentrations_and_buffer_equations__Na_i_orig_deriv = (-var_hyperpolarisation_activated_current__i_f_Na - var_linear_background_current__i_B_Na - var_sodium_current__i_Na - 3.0 * var_sodium_potassium_pump__i_NaK - 3.0 * var_sodium_calcium_pump__i_NaCa) / (var_intracellular_concentrations_and_buffer_equations__V_i * var_membrane__F); // millimolar / second
