...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellnoble_model_1991FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = -0.006 / var_membrane__Cm * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    double Cellnoble_model_1991FromCellML::GetIntracellularCalciumConcentration()
    {
    ...
    void Cellnoble_model_1991FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__calcium_release__ProdFrac = -0.001 * var_chaste_interface__calcium_release__ProdFrac + 0.001 * var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate; // 1 / millisecond
        ...
        const double var_L_type_Ca_channel_f_gate__beta_f = 50.0 / (1.0 + 0.00020346836901064417 * exp(-0.25 * var_chaste_interface__membrane__V)); // per_second
        ...
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * ((1.0 - var_transient_outward_current__g_tos) * var_chaste_interface__transient_outward_current_s_gate__s + var_transient_outward_current__g_tos) * var_transient_outward_current__g_to * var_chaste_interface__transient_outward_current_r_gate__r; // nanoA
        const double d_dt_chaste_interface__intracellular_potassium_concentration__K_i = -0.001 * (-2.0 * var_sodium_potassium_pump__i_NaK + var_L_type_Ca_channel__i_Ca_L_K + var_potassium_background_current__i_b_K + var_time_dependent_potassium_current__i_K + var_time_independent_potassium_current__i_K1 + var_transient_outward_current__i_to) * var_intracellular_sodium_concentration__conc_clamp / (var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / millisecond
        ...
        rDY[7] = d_dt_chaste_interface__transient_outward_current_s_gate__s;
        rDY[8] = d_dt_chaste_interface__transient_outward_current_r_gate__r;
        rDY[9] = d_dt_chaste_interface__calcium_release__ActFrac;
        rDY[10] = d_dt_chaste_interface__calcium_release__ProdFrac;
        rDY[11] = d_dt_chaste_interface__intracellular_sodium_concentration__Na_i;
        rDY[12] = d_dt_chaste_interface__intracellular_potassium_concentration__K_i;
