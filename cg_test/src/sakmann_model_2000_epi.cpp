...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellsakmann_model_2000_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr_max = 7.7000000000000002; // microS_per_microF
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr = 0.43033148291193518 * sqrt(var_extracellular_potassium_concentration__K_o) * var_membrane__Cm * var_rapid_delayed_rectifier_potassium_current__g_Kr_max; // microS
        ...
        const double var_slow_delayed_rectifier_potassium_current__g_Ks_max = 26.600000000000001; // microS_per_microF
