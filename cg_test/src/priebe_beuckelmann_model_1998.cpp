...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IK1_K1_gate__alpha_K1 = 0.1 / (1.0 + 6.14421235332821e-06 * exp(0.06 * var_chaste_interface__cell__V - 0.06 * var_IK1__E_K1)); // per_ms
        const double var_IK1_K1_gate__beta_K1 = (0.36787944117144233 * exp(0.1 * var_chaste_interface__cell__V - 0.1 * var_IK1__E_K1) + 3.0606040200802673 * exp(0.0002 * var_chaste_interface__cell__V - 0.0002 * var_IK1__E_K1)) / (1.0 + exp(0.5 * var_IK1__E_K1 - 0.5 * var_chaste_interface__cell__V)); // per_ms
        ...
        const double var_IKr__rik = 1.0 / (1.0 + 3.097002730371003 * exp(0.043478260869565216 * var_chaste_interface__cell__V)); // dimensionless
        ...
        const double var_INaK__f_NaK = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_cell__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_cell__FonRT * var_chaste_interface__cell__V)); // dimensionless
        const double var_cell__failing = 0.0; // dimensionless
        const double var_ICab__g_b_Ca_max = ((var_cell__failing == 0.0) ? (0.00085) : (0.0013)); // mS_per_uF
        ...
        const double var_Ito__g_to_max = ((var_cell__failing == 0.0) ? (0.3) : (0.191)); // mS_per_uF
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface__Irel__OVRLDtrack = 0; // 1 / millisecond
        const double d_dt_chaste_interface__Irel__OVRLDtrack2 = 0; // 1 / millisecond
        const double d_dt_chaste_interface__Irel__OVRLDtrack3 = 0; // 1 / millisecond
        const double var_ICa__g_Ca_max = 0.064; // mS_per_uF
        const double var_ICa_f_Ca_gate__Km_Ca = 0.0006; // mM
        const double var_IKr__g_Kr_max = 0.015; // mS_per_uF
        const double var_IKs__g_Ks_max = 0.02; // mS_per_uF
        ...
        const double d_dt_chaste_interface__Irel__APtrack2 = (((var_chaste_interface__Irel__APtrack > 0.18) && (var_chaste_interface__Irel__APtrack < 0.2)) ? (100.0 - 100.5 * var_chaste_interface__Irel__APtrack2) : (-0.5 * var_chaste_interface__Irel__APtrack2)); // 1 / millisecond
        const double d_dt_chaste_interface__Irel__APtrack3 = (((var_chaste_interface__Irel__APtrack > 0.18) && (var_chaste_interface__Irel__APtrack < 0.2)) ? (100.0 - 100.5 * var_chaste_interface__Irel__APtrack3) : (-0.01 * var_chaste_interface__Irel__APtrack3)); // 1 / millisecond
        ...
        const double d_dt_chaste_interface__Ionic_concentrations__Ca_JSR = (-var_Irel__i_rel + var_Itr__i_tr) * var_calcium_buffers_in_the_JSR__Ca_JSR_bufc; // mM / millisecond
        ...
        const double var_Ito__E_to = log((0.043 * var_Ionic_concentrations__Nao + var_Ionic_concentrations__Ko) / (0.043 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki)) / var_cell__FonRT; // mV
        const double var_ICa__i_Ca = (-var_ICa__E_Ca + var_chaste_interface__cell__V) * var_ICa__g_Ca_max * var_chaste_interface__ICa_d_gate__d * var_ICa_f_Ca_gate__f_Ca * var_chaste_interface__ICa_f_gate__f; // uA_per_uF
        const double var_ICa_d_gate__alpha_d = 0.6352401498794149 * exp(-0.5 * pow((-1.3404231085107277 + 0.05994736621246546 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI); // per_ms
        const double var_ICa_d_gate__beta_d = 0.1471 - 0.25101580310038196 * exp(-0.5 * pow((-0.4202545210984595 + 0.06697923643670463 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI); // per_ms
        const double d_dt_chaste_interface__ICa_d_gate__d = (1.0 - var_chaste_interface__ICa_d_gate__d) * var_ICa_d_gate__alpha_d - var_ICa_d_gate__beta_d * var_chaste_interface__ICa_d_gate__d; // 1 / millisecond
        const double var_ICa_f_gate__alpha_f = 0.006872 / (1.0 + 0.36594369542765665 * exp(0.1633373078744916 * var_chaste_interface__cell__V)); // per_ms
        const double var_ICa_f_gate__beta_f = 0.0005474 + (0.0112 + 0.023750715331029154 * exp(-0.1081 * var_chaste_interface__cell__V)) / (1.0 + 0.06518626772156337 * exp(-0.2779 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__ICa_f_gate__f = (1.0 - var_chaste_interface__ICa_f_gate__f) * var_ICa_f_gate__alpha_f - var_ICa_f_gate__beta_f * var_chaste_interface__ICa_f_gate__f; // 1 / millisecond
        const double var_IK1_K1_gate__alpha_K1 = 0.1 / (1.0 + 6.14421235332821e-06 * exp(0.06 * var_chaste_interface__cell__V - 0.06 * var_IK1__E_K1)); // per_ms
        const double var_IK1_K1_gate__beta_K1 = (0.36787944117144233 * exp(0.1 * var_chaste_interface__cell__V - 0.1 * var_IK1__E_K1) + 3.0606040200802673 * exp(0.0002 * var_chaste_interface__cell__V - 0.0002 * var_IK1__E_K1)) / (1.0 + exp(0.5 * var_IK1__E_K1 - 0.5 * var_chaste_interface__cell__V)); // per_ms
        const double var_IK1_K1_gate__K1_infinity = var_IK1_K1_gate__alpha_K1 / (var_IK1_K1_gate__alpha_K1 + var_IK1_K1_gate__beta_K1); // dimensionless
        const double var_IKr__rik = 1.0 / (1.0 + 3.097002730371003 * exp(0.043478260869565216 * var_chaste_interface__cell__V)); // dimensionless
        const double var_IKr__i_Kr = (-var_IKr__E_K + var_chaste_interface__cell__V) * var_IKr__g_Kr_max * var_IKr__rik * var_chaste_interface__IKr_Xr_gate__Xr; // uA_per_uF
        const double var_IKr_Xr_gate__alpha_Xr = 0.005010719886197228 * exp(0.0005266 * var_chaste_interface__cell__V) / (1.0 + 0.5985439039697352 * exp(-0.1262 * var_chaste_interface__cell__V)); // per_ms
        const double var_IKr_Xr_gate__beta_Xr = 0.01777236499026419 * exp(0.0016 * var_chaste_interface__cell__V) / (1.0 + 170.91698999270034 * exp(0.0783 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__IKr_Xr_gate__Xr = (1.0 - var_chaste_interface__IKr_Xr_gate__Xr) * var_IKr_Xr_gate__alpha_Xr - var_chaste_interface__IKr_Xr_gate__Xr * var_IKr_Xr_gate__beta_Xr; // 1 / millisecond
        const double var_IKs__i_Ks = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (-var_IKs__E_Ks + var_chaste_interface__cell__V) * var_IKs__g_Ks_max; // uA_per_uF
        const double var_IKs_Xs_gate__alpha_Xs = 0.003013 / (1.0 + 0.836582624551064 * exp(-0.06984654713594234 * var_chaste_interface__cell__V)); // per_ms
        const double var_IKs_Xs_gate__beta_Xs = 0.00587 / (1.0 + 2.7407111931678685 * exp(0.0632111251580278 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__IKs_Xs_gate__Xs = (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) * var_IKs_Xs_gate__alpha_Xs - var_chaste_interface__IKs_Xs_gate__Xs * var_IKs_Xs_gate__beta_Xs; // 1 / millisecond
        const double var_INa__i_Na = pow(var_chaste_interface__INa_m_gate__m, 3.0) * (-var_INa__E_Na + var_chaste_interface__cell__V) * var_INa__g_Na * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // uA_per_uF
        const double var_INaK__f_NaK = 1.0 / (1.0 + 0.1245 * exp(-0.1 * var_cell__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_cell__FonRT * var_chaste_interface__cell__V)); // dimensionless
        const double var_INa_h_gate__alpha_h = ((var_chaste_interface__cell__V < -40.0) ? (1.0495108254269642e-06 * exp(-0.14705882352941177 * var_chaste_interface__cell__V)) : (0.0)); // per_ms
        const double var_INa_h_gate__beta_h = ((var_chaste_interface__cell__V < -40.0) ? (310000.0 * exp(0.35 * var_chaste_interface__cell__V) + 3.56 * exp(0.079 * var_chaste_interface__cell__V)) : (7.692307692307692 / (1.0 + 0.382754931414913 * exp(-0.0900900900900901 * var_chaste_interface__cell__V)))); // per_ms
        ...
        const double var_INa_j_gate__alpha_j = ((var_chaste_interface__cell__V < -40.0) ? ((37.78 + var_chaste_interface__cell__V) * (-127140.0 * exp(0.244 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) / (1.0 + 50262745825.95399 * exp(0.311 * var_chaste_interface__cell__V))) : (0.0)); // per_ms
        ...
        const double var_INa_m_gate__alpha_m = ((fabs(47.13 + var_chaste_interface__cell__V) > 0.001) ? (0.32 * (47.13 + var_chaste_interface__cell__V) / (1.0 - 0.008977803730697244 * exp(-0.1 * var_chaste_interface__cell__V))) : (3.2)); // per_ms
        const double var_INa_m_gate__beta_m = 0.08 * exp(-0.09090909090909091 * var_chaste_interface__cell__V); // per_ms
        ...
        const double var_Ito_r_gate__alpha_r = 1.0626012252267125 * exp(-0.0166 * var_chaste_interface__cell__V) / (1.0 + 53.95013316472581 * exp(-0.0943 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito_r_gate__beta_r = (1.0086172244222662 * exp(-0.1344 * var_chaste_interface__cell__V) + 5.186e-05 * var_chaste_interface__cell__V) / (1.0 + 1.0000069907524352 * exp(-0.1348 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__Ito_r_gate__r = (1.0 - var_chaste_interface__Ito_r_gate__r) * var_Ito_r_gate__alpha_r - var_Ito_r_gate__beta_r * var_chaste_interface__Ito_r_gate__r; // 1 / millisecond
        const double var_Ito_t_gate__alpha_t = (5.612e-05 * var_chaste_interface__cell__V + 0.00019248592290218978 * exp(-0.173 * var_chaste_interface__cell__V)) / (1.0 + 0.002651481019005806 * exp(-0.1732 * var_chaste_interface__cell__V)); // per_ms
        const double var_Ito_t_gate__beta_t = (0.0001215 * var_chaste_interface__cell__V + 0.07669999566806006 * exp(-1.66e-09 * var_chaste_interface__cell__V)) / (1.0 + 0.004264759878893891 * exp(-0.1604 * var_chaste_interface__cell__V)); // per_ms
        const double d_dt_chaste_interface__Ito_t_gate__t = (1.0 - var_chaste_interface__Ito_t_gate__t) * var_Ito_t_gate__alpha_t - var_Ito_t_gate__beta_t * var_chaste_interface__Ito_t_gate__t; // 1 / millisecond
        const double var_cell__failing = 0.0; // dimensionless
        const double var_ICab__g_b_Ca_max = ((var_cell__failing == 0.0) ? (0.00085) : (0.0013)); // mS_per_uF
        const double var_ICab__i_b_Ca = (-var_ICa__E_Ca + var_chaste_interface__cell__V) * var_ICab__g_b_Ca_max; // uA_per_uF
        const double var_IK1__g_K1_max = ((var_cell__failing == 0.0) ? (2.5) : (2.0)); // mS_per_uF
        ...
        const double var_INaCa__K_NaCa = ((var_cell__failing == 0.0) ? (1000.0) : (1650.0)); // uA_per_uF
        const double var_INaCa__i_NaCa = 1.0 * (pow(var_chaste_interface__Ionic_concentrations__Nai, 3.0) * var_Ionic_concentrations__Cao * exp(var_INaCa__eta * var_cell__FonRT * var_chaste_interface__cell__V) - pow(var_Ionic_concentrations__Nao, 3.0) * var_chaste_interface__Ionic_concentrations__Cai * exp((-1.0 + var_INaCa__eta) * var_cell__FonRT * var_chaste_interface__cell__V)) * var_INaCa__K_NaCa / ((1.0 + var_INaCa__K_sat * exp((-1.0 + var_INaCa__eta) * var_cell__FonRT * var_chaste_interface__cell__V)) * (pow(var_INaCa__K_mNa, 3.0) + pow(var_Ionic_concentrations__Nao, 3.0)) * (var_INaCa__K_mCa + var_Ionic_concentrations__Cao)); // uA_per_uF
        const double d_dt_chaste_interface__Irel__Cainfluxtrack = ((var_chaste_interface__Irel__APtrack > 0.2) ? (-0.5 * (-var_INaCa__i_NaCa + var_ICa__i_Ca + var_ICab__i_b_Ca) * var_cell__Cm / (var_Ionic_concentrations__V_myo * var_cell__F)) : ((var_chaste_interface__Irel__APtrack2 > 0.01) ? (0.0) : (-0.5 * var_chaste_interface__Irel__Cainfluxtrack))); // mM / millisecond
        const double var_INaK__I_NaK_max = ((var_cell__failing == 0.0) ? (1.3) : (0.75)); // uA_per_uF
        const double var_INaK__i_NaK = 1.0 * var_INaK__I_NaK_max * var_INaK__f_NaK * var_Ionic_concentrations__Ko / ((1.0 + pow((var_INaK__K_mNai / var_chaste_interface__Ionic_concentrations__Nai), 1.5)) * (var_INaK__K_mKo + var_Ionic_concentrations__Ko)); // uA_per_uF
        const double var_INab__g_b_Na_max = ((var_cell__failing == 0.0) ? (0.001) : (0.0)); // mS_per_uF
        const double var_INab__i_b_Na = (-var_INa__E_Na + var_chaste_interface__cell__V) * var_INab__g_b_Na_max; // uA_per_uF
        const double d_dt_chaste_interface__Ionic_concentrations__Nai = -1.0 * (3.0 * var_INaCa__i_NaCa + 3.0 * var_INaK__i_NaK + var_INa__i_Na + var_INab__i_b_Na) * var_cell__Cm / (var_Ionic_concentrations__V_myo * var_cell__F); // mM / millisecond
        const double var_Ileak__K_leak = ((var_cell__failing == 0.0) ? (0.00026) : (0.00017)); // per_ms
        const double var_Ileak__i_leak = var_Ileak__K_leak * var_chaste_interface__Ionic_concentrations__Ca_NSR; // mM_per_ms
        const double var_Ito__g_to_max = ((var_cell__failing == 0.0) ? (0.3) : (0.191)); // mS_per_uF
        const double var_Ito__i_to = (-var_Ito__E_to + var_chaste_interface__cell__V) * var_Ito__g_to_max * var_chaste_interface__Ito_r_gate__r * var_chaste_interface__Ito_t_gate__t; // uA_per_uF
        const double var_Iup__I_up_max = ((var_cell__failing == 0.0) ? (0.0045) : (0.0015)); // mM_per_ms
        ...
        const double d_dt_chaste_interface__Ionic_concentrations__Ca_NSR = 1.0 * var_Iup__i_up - 1.0 * var_Ileak__i_leak - 1.0 * var_Ionic_concentrations__V_JSR * var_Itr__i_tr / var_Ionic_concentrations__V_NSR; // mM / millisecond
        const double d_dt_chaste_interface__Ionic_concentrations__Cai = ((-var_Iup__i_up + var_Ileak__i_leak) * var_Ionic_concentrations__V_NSR / var_Ionic_concentrations__V_myo + var_Ionic_concentrations__V_JSR * var_Irel__i_rel / var_Ionic_concentrations__V_myo - 0.5 * (-2.0 * var_INaCa__i_NaCa + var_ICa__i_Ca + var_ICab__i_b_Ca) * var_cell__Cm / (var_Ionic_concentrations__V_myo * var_cell__F)) * var_calcium_buffers_in_the_myoplasm__Cai_bufc; // millimolar / millisecond
        ...
        const double d_dt_chaste_interface__Ionic_concentrations__Ki = -1.0 * (-2.0 * var_INaK__i_NaK + var_IK1__i_K1 + var_IKr__i_Kr + var_IKs__i_Ks + var_Ito__i_to + var_cell__i_Stim) * var_cell__Cm / (var_Ionic_concentrations__V_myo * var_cell__F); // mM / millisecond
        const double var_cell__I_tot = var_ICa__i_Ca + var_ICab__i_b_Ca + var_IK1__i_K1 + var_IKr__i_Kr + var_IKs__i_Ks + var_INa__i_Na + var_INaCa__i_NaCa + var_INaK__i_NaK + var_INab__i_b_Na + var_Ito__i_to + var_cell__i_Stim; // uA_per_uF
        const double var_cell__dVdt = -1.0 * var_cell__I_tot; // mV_per_ms
        const double d_dt_chaste_interface__Irel__APtrack = ((var_cell__dVdt > 150.0) ? (100.0 - 100.5 * var_chaste_interface__Irel__APtrack) : (-0.5 * var_chaste_interface__Irel__APtrack)); // 1 / millisecond
        ...
        {
            d_dt_chaste_interface__cell__V = var_cell__dVdt; // millivolt / millisecond
        }
