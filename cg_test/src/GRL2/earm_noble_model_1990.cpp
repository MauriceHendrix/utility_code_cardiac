...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative1(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -17.0 + var_x87 + var_x88 + 0.0030000000000000001 * var_x92 - 0.0030000000000000001 * var_x90 - 2.8102681769358871e-7 * var_x55 - 5.8069998209165779e-10 * var_x59 - 3.0670341725380159e-10 * var_x57 - 3.1504144536796187e-6 * var_x65 - 0.23093344215355205 * var_x58 - 5.5200000000000005e-8 * var_x93 - var_x63 * var_x86;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative2(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = -0.001 * ((var_x103) ? (2000.0) : (var_x102 * var_x107)) - 8.0 * var_x108;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 1.7673477715833067e-7 * var_x77 + 2.0119028828602145e-15 * var_x81 - 1.5148695184999769e-6 * var_x79 - 1.5752072268398093e-8 * var_x82 - 0.00028277564345332906 * var_x76 - 2.6978574498584515e-6 * var_x75 - 1.5791458939838137 * var_x80;
        }
        else
        {
    ...
    double Cellearm_noble_model_1990FromCellMLGRL2::EvaluatePartialDerivative11(double var_chaste_interface__environment__time_converted, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 8.1754862903173357e-6 * var_x85 - 3.1504144536796189e-9 * var_x82 - 0.00022482145415487099 * var_x84 - 0.0001091989920180802 * var_x83 - 3.8219647206328062e-5 * var_x1;
        }
        else
        {
