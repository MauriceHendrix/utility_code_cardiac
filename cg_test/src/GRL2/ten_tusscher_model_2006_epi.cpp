...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative6(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x148 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
            const double var_x149 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
            const double var_x150 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
            const double var_x151 = 310000.0 * var_x148;
            const double var_x152 = 2.7000000000000002 * var_x149;
            const double var_x153 = 0.057000000000000002 * var_x150;
            const double var_x156 = var_chaste_interface__membrane__V < -40.0;
            const double var_x157 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
            const double var_x158 = 1.0 + var_x157;
            const double var_x159 = 1 / var_x158;
            
            partialF = ((var_x156) ? (-var_x151 - var_x152 - var_x153) : (-5.9230769230769234 * var_x159));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative7(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x21 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x156 = var_chaste_interface__membrane__V < -40.0;
            const double var_x161 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
            const double var_x162 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
            const double var_x163 = -25428.0 * var_x161 - 6.9480000000000002e-6 * var_x162;
            const double var_x164 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
            const double var_x165 = 1.0 + var_x164;
            const double var_x166 = 1.0 / var_x165;
            const double var_x167 = var_x163 * var_x166;
            const double var_x168 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
            const double var_x169 = 1.0 + var_x168;
            const double var_x170 = exp(-0.01052 * var_chaste_interface__membrane__V);
            const double var_x171 = var_x170 / var_x169;
            const double var_x172 = 37.780000000000001 + var_chaste_interface__membrane__V;
            const double var_x173 = 0.024240000000000001 * var_x171;
            const double var_x174 = var_x167 * var_x172;
            const double var_x175 = exp(-3.2000000000000002 - var_x21);
            ...
            partialF = ((var_x156) ? (-var_x173 - var_x174) : (-0.59999999999999998 * var_x178));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative8(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x110 = -var_x109;
            const double var_x130 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x179 = exp(2.5 + var_x110);
            const double var_x180 = 1.0 + var_x179;
            const double var_x181 = 1 / var_x180;
            const double var_x182 = exp(1.0 + var_x130);
            const double var_x183 = 1.0 + var_x182;
            const double var_x184 = 1 / var_x183;
            const double var_x185 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
            ...
            const double var_x191 = 1 / (1.0 * var_x181 + 1.3999999999999999 * var_x188);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative9(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x98 = 0.10000000000000001 * var_chaste_interface__membrane__V;
            const double var_x99 = -var_x98;
            const double var_x192 = exp(3.0 + var_x98);
            const double var_x193 = 1.0 + var_x192;
            const double var_x194 = 1 / var_x193;
            const double var_x195 = exp(1.3 + var_x99);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative10(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x194 = 1 / var_x193;
            const double var_x198 = pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2);
            const double var_x205 = exp(2.5 + var_x99);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative12(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x130 = 0.20000000000000001 * var_chaste_interface__membrane__V;
            const double var_x217 = exp(-4.0 + var_x130);
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative15(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x251 = 0.010081409587705739 * var_x52;
            const double var_x252 = var_x251 * var_x50;
            ...
            partialF = var_x256 * (-1.1399999999999999 - var_x260 + 0.61222384784198969 * var_x249 - 0.65303877103145569 * var_x248 - 0.0025203523969264349 * var_x76) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x242 * var_x260 - var_x252 * var_x54) / (pow(var_x253, 3) * pow(var_x254, 2));
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative17(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            partialF = 5.0371257222730904e-7 * var_x79 - 1.823319832565245e-7 * var_x80 - 9.0551084895961074e-7 * var_x66 - 0.046330930954698972 * var_x82 - 0.00080594011556369446 * var_x78;
        }
        else
        {
    ...
    double Cellten_tusscher_model_2006_epiFromCellMLGRL2::EvaluatePartialDerivative18(double var_chaste_interface__environment__time, std::vector<double>& rY, double delta, bool forceNumerical)
    {
        ...
        if (!forceNumerical && this->mUseAnalyticJacobian)
        {
            ...
            const double var_x263 = 6.3176611368492499e-5 * var_x40;
            
            partialF = 0.00010126109252331096 * var_x89 - 0.00091800065377284671 * var_x86 - 0.0016876848753885161 * var_x84 - 0.00047773503410627734 * var_x85 - 4.5587787568311439e-5 * var_x83 - 0.011750408368292439 * var_x81 - var_x263 * var_x88;
        }
        else
        {
