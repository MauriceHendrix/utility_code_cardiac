...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellkurata_model_2002FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr_max = 0.025000000000000001; // nanoS
        const double var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr = 1.0 * pow(var_intracellular_ion_concentrations__Ko, 0.58999999999999997) * var_rapidly_activating_delayed_rectifier_potassium_current__g_Kr_max; // nanoS
