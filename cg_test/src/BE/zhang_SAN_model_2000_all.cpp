...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellzhang_SAN_model_2000_allFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[4] = (var_chaste_interface__L_type_Ca_channel_d_gate__d_L + ((-0.49682500000000002 / (-1.0 + 1.0 * exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V)) - 0.028575 / (-1.0 + 1.0 * exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) * exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.0057149999999999996 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) * exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) - 0.014195000000000001 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V)) - 0.042450000000000002 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-0.20799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-0.20799999999999999 * var_chaste_interface__membrane__V) * exp(-3.7166666666666668 - 0.16666666666666666 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((0.49682500000000002 / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.028575 / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.014195000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.042450000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20799999999999999 * var_chaste_interface__membrane__V)) - 0.0057149999999999996 * var_chaste_interface__membrane__V / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V))) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_f_gate__f_L + ((0.087500000000000008 / (-1.0 + 1.0 * exp(7.0 + 0.25 * var_chaste_interface__membrane__V) - 1.0 * exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + exp(7.0 + 0.25 * var_chaste_interface__membrane__V) * exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.025000000000000001 / (1.0 + 1.0 * exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-7.0 - 0.25 * var_chaste_interface__membrane__V) + exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-7.0 - 0.25 * var_chaste_interface__membrane__V)) + 0.0031250000000000002 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(7.0 + 0.25 * var_chaste_interface__membrane__V) - 1.0 * exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + exp(7.0 + 0.25 * var_chaste_interface__membrane__V) * exp(9.0 + 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.087500000000000008 / (-1.0 + exp(7.0 + 0.25 * var_chaste_interface__membrane__V)) - 0.025000000000000001 / (1.0 + exp(-7.0 - 0.25 * var_chaste_interface__membrane__V)) - 0.0031250000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(7.0 + 0.25 * var_chaste_interface__membrane__V))) * mDt));
        rY[6] = (var_chaste_interface__T_type_Ca_channel_d_gate__d_T + ((1.0680000000000001 * exp(0.87666666666666671 + 0.033333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.4411764705882355 - 0.14705882352941177 * var_chaste_interface__membrane__V)) + 1.0680000000000001 * exp(-0.87666666666666671 - 0.033333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.4411764705882355 - 0.14705882352941177 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1.0680000000000001 * exp(0.87666666666666671 + 0.033333333333333333 * var_chaste_interface__membrane__V) - 1.0680000000000001 * exp(-0.87666666666666671 - 0.033333333333333333 * var_chaste_interface__membrane__V)) * mDt));
        rY[7] = (var_chaste_interface__T_type_Ca_channel_f_gate__f_T + ((0.014999999999999999 * exp(4.6163849154746419 + 0.065019505851755519 * var_chaste_interface__membrane__V) / (1.0 + exp(7.8888888888888893 + 0.1111111111111111 * var_chaste_interface__membrane__V)) + 0.015300000000000001 * exp(-0.85234093637454988 - 0.012004801920768308 * var_chaste_interface__membrane__V) / (1.0 + exp(7.8888888888888893 + 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.014999999999999999 * exp(4.6163849154746419 + 0.065019505851755519 * var_chaste_interface__membrane__V) - 0.015300000000000001 * exp(-0.85234093637454988 - 0.012004801920768308 * var_chaste_interface__membrane__V)) * mDt));
        rY[8] = (var_chaste_interface__four_AP_sensitive_currents_q_gate__q + ((0.001 / (0.010103333333333334 + 0.065166666666666664 / (0.56859999999999999 * exp(-3.1827900000000002 - 0.081610000000000002 * var_chaste_interface__membrane__V) + 0.71740000000000004 * exp(11.128867 + 0.27189999999999998 * var_chaste_interface__membrane__V)) + 0.010103333333333334 * exp(4.5320610687022898 + 0.076335877862595422 * var_chaste_interface__membrane__V) + 0.065166666666666664 * exp(4.5320610687022898 + 0.076335877862595422 * var_chaste_interface__membrane__V) / (0.56859999999999999 * exp(-3.1827900000000002 - 0.081610000000000002 * var_chaste_interface__membrane__V) + 0.71740000000000004 * exp(11.128867 + 0.27189999999999998 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.010103333333333334 + 0.065166666666666664 / (0.56859999999999999 * exp(-3.1827900000000002 - 0.081610000000000002 * var_chaste_interface__membrane__V) + 0.71740000000000004 * exp(11.128867 + 0.27189999999999998 * var_chaste_interface__membrane__V)))) * mDt));
        rY[9] = (var_chaste_interface__four_AP_sensitive_currents_r_gate__r + ((0.001 / (0.0029775000000000001 + 0.019595000000000001 / (1.0369999999999999 * exp(2.7585732000000003 + 0.090120000000000006 * var_chaste_interface__membrane__V) + 0.36899999999999999 * exp(-2.8369599999999999 - 0.11899999999999999 * var_chaste_interface__membrane__V)) + 0.0029775000000000001 * exp(0.5548223350253807 - 0.050761421319796954 * var_chaste_interface__membrane__V) + 0.019595000000000001 * exp(0.5548223350253807 - 0.050761421319796954 * var_chaste_interface__membrane__V) / (1.0369999999999999 * exp(2.7585732000000003 + 0.090120000000000006 * var_chaste_interface__membrane__V) + 0.36899999999999999 * exp(-2.8369599999999999 - 0.11899999999999999 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.0029775000000000001 + 0.019595000000000001 / (1.0369999999999999 * exp(2.7585732000000003 + 0.090120000000000006 * var_chaste_interface__membrane__V) + 0.36899999999999999 * exp(-2.8369599999999999 - 0.11899999999999999 * var_chaste_interface__membrane__V)))) * mDt));
        rY[14] = (var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + ((0.001 * exp(-2.9631993991738641 - 0.037551633496057078 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.001 * exp(3.5355294117647058 + 0.047058823529411764 * var_chaste_interface__membrane__V) - 0.001 * exp(-2.9631993991738641 - 0.037551633496057078 * var_chaste_interface__membrane__V)) * mDt));
        rY[10] = (var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_af_gate__P_af + ((0.037200000000000004 * exp(-0.56603773584905659 + 0.062893081761006289 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.3396226415094339 - 0.094339622641509441 * var_chaste_interface__membrane__V)) + 0.00096000000000000002 * exp(0.40000000000000002 - 0.044444444444444446 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.3396226415094339 - 0.094339622641509441 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.037200000000000004 * exp(-0.56603773584905659 + 0.062893081761006289 * var_chaste_interface__membrane__V) - 0.00096000000000000002 * exp(0.40000000000000002 - 0.044444444444444446 * var_chaste_interface__membrane__V)) * mDt));
        rY[11] = (var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_as_gate__P_as + ((0.0042000000000000006 * exp(-0.52941176470588236 + 0.058823529411764705 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.3396226415094339 - 0.094339622641509441 * var_chaste_interface__membrane__V)) + 0.00014999999999999999 * exp(0.41666666666666663 - 0.046296296296296294 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.3396226415094339 - 0.094339622641509441 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0042000000000000006 * exp(-0.52941176470588236 + 0.058823529411764705 * var_chaste_interface__membrane__V) - 0.00014999999999999999 * exp(0.41666666666666663 - 0.046296296296296294 * var_chaste_interface__membrane__V)) * mDt));
        rY[12] = (var_chaste_interface__rapid_delayed_rectifying_potassium_current_P_i_gate__P_i + ((0.5 / (1.0 + exp(1.8415841584158419 + 0.099009900990099015 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.5) * mDt));
        rY[13] = (var_chaste_interface__slow_delayed_rectifying_potassium_current_xs_gate__xs + ((0.014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 * exp(-0.022222222222222223 * var_chaste_interface__membrane__V) - 0.014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_h_gate__h1 + ((0.001 / (0.00059770000000000005 + 0.00059770000000000005 * exp(10.328124999999998 + 0.15625 * var_chaste_interface__membrane__V) + 3.7170000000000002e-6 * exp(-4.8164649999999991 - 0.28149999999999997 * var_chaste_interface__membrane__V) / (1.0 + 0.0037320000000000001 * exp(-12.936576000000001 - 0.34260000000000002 * var_chaste_interface__membrane__V)) + 3.7170000000000002e-6 * exp(10.328124999999998 + 0.15625 * var_chaste_interface__membrane__V) * exp(-4.8164649999999991 - 0.28149999999999997 * var_chaste_interface__membrane__V) / (1.0 + 0.0037320000000000001 * exp(-12.936576000000001 - 0.34260000000000002 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.00059770000000000005 + 3.7170000000000002e-6 * exp(-4.8164649999999991 - 0.28149999999999997 * var_chaste_interface__membrane__V) / (1.0 + 0.0037320000000000001 * exp(-12.936576000000001 - 0.34260000000000002 * var_chaste_interface__membrane__V)))) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_h_gate__h2 + ((0.001 / (0.0035560000000000001 + 0.0035560000000000001 * exp(10.328124999999998 + 0.15625 * var_chaste_interface__membrane__V) + 3.1860000000000002e-8 * exp(-11.69172 - 0.62190000000000001 * var_chaste_interface__membrane__V) / (1.0 + 7.1890000000000005e-5 * exp(-22.768981 - 0.66830000000000001 * var_chaste_interface__membrane__V)) + 3.1860000000000002e-8 * exp(10.328124999999998 + 0.15625 * var_chaste_interface__membrane__V) * exp(-11.69172 - 0.62190000000000001 * var_chaste_interface__membrane__V) / (1.0 + 7.1890000000000005e-5 * exp(-22.768981 - 0.66830000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.0035560000000000001 + 3.1860000000000002e-8 * exp(-11.69172 - 0.62190000000000001 * var_chaste_interface__membrane__V) / (1.0 + 7.1890000000000005e-5 * exp(-22.768981 - 0.66830000000000001 * var_chaste_interface__membrane__V)))) * mDt));
        rY[1] = (var_chaste_interface__sodium_current_m_gate__m + ((0.001 * pow(1 / (1.0 + exp(-5.5531135531135529 - 0.18315018315018314 * var_chaste_interface__membrane__V)), 0.33333333333333331) / (4.5689999999999998e-5 + 0.00062469999999999995 / (0.62739999999999996 * exp(5.3505781299999997 + 0.082299999999999998 * var_chaste_interface__membrane__V) + 0.83221659999999997 * exp(-19.034003092000003 - 0.33566000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (4.5689999999999998e-5 + 0.00062469999999999995 / (0.62739999999999996 * exp(5.3505781299999997 + 0.082299999999999998 * var_chaste_interface__membrane__V) + 0.83221659999999997 * exp(-19.034003092000003 - 0.33566000000000001 * var_chaste_interface__membrane__V)))) * mDt));

        double _guess[0] = {};
        CardiacNewtonSolver<0,Cellzhang_SAN_model_2000_allFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<0,Cellzhang_SAN_model_2000_allFromCellMLBackwardEuler>::Instance();
