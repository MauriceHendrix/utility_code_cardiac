...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[3] = (var_chaste_interface__potassium_channel_n_gate__n + ((-0.65000000000000002 / (-1.0 + exp(-6.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.01 * var_chaste_interface__membrane__V / (-1.0 + exp(-6.5 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((0.65000000000000002 / (-1.0 + exp(-6.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.125 * exp(0.9375 + 0.012500000000000001 * var_chaste_interface__membrane__V) + 0.01 * var_chaste_interface__membrane__V / (-1.0 + exp(-6.5 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        rY[2] = (var_chaste_interface__sodium_channel_h_gate__h + ((0.070000000000000007 * exp(-3.75 - 0.050000000000000003 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-1.0 / (1.0 + exp(-4.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.070000000000000007 * exp(-3.75 - 0.050000000000000003 * var_chaste_interface__membrane__V)) * mDt));
        rY[1] = (var_chaste_interface__sodium_channel_m_gate__m + ((-5.0 / (-1.0 + exp(-5.0 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.10000000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.0 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((5.0 / (-1.0 + exp(-5.0 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 4.0 * exp(-4.166666666666667 - 0.055555555555555552 * var_chaste_interface__membrane__V) + 0.10000000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.0 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));

        double _guess[0] = {};
        CardiacNewtonSolver<0,Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLBackwardEuler>* _p_solver = CardiacNewtonSolver<0,Cellhodgkin_huxley_squid_axon_model_1952_modifiedFromCellMLBackwardEuler>::Instance();
