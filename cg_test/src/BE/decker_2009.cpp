...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[37], double rJacobian[37][37])
    {
        ...
        double var_chaste_interface__Ito2_i2f_gate__i2f = rY[36];
        // Units: dimensionless; Initial value: 0.9960352
        double var_chaste_interface__CaMK_active__CaMK_trap = rCurrentGuess[0];double var_chaste_interface__Ca__Ca_JSR = rCurrentGuess[1];double var_chaste_interface__Ca__Ca_NSR = rCurrentGuess[2];double var_chaste_interface__Ca__Ca_i = rCurrentGuess[3];double var_chaste_interface__Ca__Ca_ss_CaL = rCurrentGuess[4];double var_chaste_interface__Ca__Ca_ss_sr = rCurrentGuess[5];double var_chaste_interface__Cl__Cl_i = rCurrentGuess[6];double var_chaste_interface__ICaL__C = rCurrentGuess[8];double var_chaste_interface__ICaL__CI = rCurrentGuess[9];double var_chaste_interface__ICaL__CI_star = rCurrentGuess[10];double var_chaste_interface__ICaL__C_star = rCurrentGuess[11];double var_chaste_interface__ICaL__O = rCurrentGuess[12];double var_chaste_interface__ICaL__OI = rCurrentGuess[13];double var_chaste_interface__ICaL__OI_star = rCurrentGuess[14];double var_chaste_interface__ICaL__O_star = rCurrentGuess[15];double var_chaste_interface__IKs__O1 = rCurrentGuess[31];double var_chaste_interface__IKs__O2 = rCurrentGuess[32];double var_chaste_interface__Irel__Irel = rCurrentGuess[33];double var_chaste_interface__K__K_i = rCurrentGuess[34];double var_chaste_interface__Na__Na_i = rCurrentGuess[35];double var_chaste_interface__Na__Na_ss_sr = rCurrentGuess[36];

        const double var_x0 = 1.0 - var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x1 = 1 / var_chaste_interface__Ca__Ca_ss_sr;
        ...
        const double var_x6 = var_x5 + var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x7 = 0.0025000000000000005 * var_x3;
        const double var_x8 = 1 - var_x4;
        const double var_x9 = pow(var_chaste_interface__Ca__Ca_ss_sr, (-2));
        const double var_x10 = var_x0 * var_x9 / pow(var_x2, 2);
        const double var_x11 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_JSR;
        const double var_x12 = pow(var_x11, (-2.0));
        const double var_x13 = 1 / (1.0 + 8.0 * var_x12);
        const double var_x14 = 0.040000000000000001 * var_x13;
        const double var_x15 = -var_chaste_interface__Irel__Irel;
        const double var_x16 = 0.14999999999999999 + var_x5 + 1.0 * var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x17 = 1 / var_x16;
        const double var_x18 = var_x17 * var_x8;
        const double var_x19 = var_x6 / pow(var_x16, 2);
        const double var_x20 = var_x19 * (-1.0 + var_x4);
        const double var_x21 = 0.75 * var_x18 + 0.75 * var_x20;
        const double var_x22 = var_x17 * var_x6;
        const double var_x23 = 0.00092000000000000003 - 0.00017000000000000001 * var_x22 + var_chaste_interface__Ca__Ca_i;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x26 = var_x24 * var_x25;
        const double var_x27 = 0.00017000000000000001 * var_x18 + 0.00017000000000000001 * var_x20;
        const double var_x28 = 1.0 + 0.75 * var_x22;
        const double var_x29 = var_x28 / pow(var_x23, 2);
        const double var_x30 = var_x25 * var_x29;
        const double var_x31 = var_x24 * var_x28;
        const double var_x32 = var_x10 * var_x17;
        const double var_x33 = var_x10 * var_x19;
        const double var_x34 = 5.6250000000000005e-5 * var_x32 - 5.6250000000000005e-5 * var_x33;
        const double var_x35 = 1.2750000000000002e-8 * var_x32 - 1.2750000000000002e-8 * var_x33;
        const double var_x36 = 1 / (0.58999999999999997 + 0.80000000000000004 * exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm)));
        const double var_x37 = 1.0 / (1.0 + exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm));
        const double var_x38 = var_x36 * var_x37;
        const double var_x39 = -var_x38;
        const double var_x40 = 1 / var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x41 = pow(var_x40, 4.0);
        const double var_x42 = 1.0 + 8.1000000000000005e-11 * var_x41;
        const double var_x43 = 1 / var_x42;
        const double var_x44 = 3.0 * var_x43;
        const double var_x45 = 1 / (1.0 + exp(5.833333333333333 + 0.33333333333333331 * var_chaste_interface__membrane__Vm));
        const double var_x46 = 0.80000000000000004 * var_x45;
        const double var_x47 = 0.80000000000000004 - var_x46;
        const double var_x48 = 0.040277106492669565 / (1.0 + exp(4.7444197507005512 + 0.096627693496956227 * var_chaste_interface__membrane__Vm));
        const double var_x49 = 1 / (1.0 + exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm));
        const double var_x50 = var_x48 + 0.032730010146303147 * var_x49;
        const double var_x51 = var_x47 * var_x50;
        const double var_x52 = -var_x44 - var_x51;
        const double var_x53 = var_x36 * (1.0 - var_x37);
        const double var_x54 = 0.20000000000000001 + var_x46;
        const double var_x55 = var_x50 * var_x54;
        const double var_x56 = var_x40 * var_x41 / pow(var_x42, 2);
        const double var_x57 = 9.7200000000000016e-10 * var_x56;
        const double var_x58 = var_x57 * var_chaste_interface__ICaL__C;
        const double var_x59 = -var_x53;
        const double var_x60 = var_x57 * var_chaste_interface__ICaL__O;
        const double var_x61 = 0.99990000999900008 * var_x45;
        const double var_x62 = -var_x61;
        const double var_x63 = 0.99990000999900008 + var_x62;
        const double var_x64 = var_x48 + 1.0 * var_x49 / (25.0 - 17.5 * var_x43);
        const double var_x65 = var_x63 * var_x64;
        const double var_x66 = -1.0 - var_x65;
        const double var_x67 = 9.9990000999900015e-5 + var_x61;
        const double var_x68 = var_x64 * var_x67;
        const double var_x69 = 9.0720000000000001e-12 * var_x49 * var_x56 / pow((1 - 0.69999999999999996 * var_x43), 2);
        const double var_x70 = var_x67 * var_x69;
        const double var_x71 = var_x69 * (-0.99990000999900008 + var_x61);
        const double var_x72 = var_x54 * var_x63 / (var_x47 * var_x67);
        const double var_x73 = 3.0000000000000001e-6 * var_x43 * var_x72;
        const double var_x74 = -var_x55 - var_x73;
        const double var_x75 = 9.7200000000000002e-16 * var_x56 * var_x72;
        const double var_x76 = var_x75 * var_chaste_interface__ICaL__CI;
        const double var_x77 = -9.9999999999999995e-7 - var_x68;
        const double var_x78 = var_x63 * var_x69;
        const double var_x79 = var_x69 * (-9.9990000999900015e-5 + var_x62);
        const double var_x80 = var_x75 * var_chaste_interface__ICaL__OI;
        const double var_x81 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x82 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x83 = 1.0 + 0.0097788000000000007 * pow(var_x81, (-2.0)) + 4.0890000000000003e-5 * pow(var_x82, (-2.0));
        const double var_x84 = 1 / var_x83;
        const double var_x85 = exp(0.074873319003313496 * var_chaste_interface__membrane__Vm);
        const double var_x86 = 1.0 * var_x85;
        const double var_x87 = -0.61380000000000001 + var_x86 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x88 = var_chaste_interface__membrane__Vm / (-1.0 + var_x85);
        const double var_x89 = 0.023500311662270543 * var_x88;
        const double var_x90 = var_x87 * var_x89;
        const double var_x91 = -var_x84 * var_x90;
        const double var_x92 = var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star;
        const double var_x93 = var_x85 * var_x92;
        const double var_x94 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
        const double var_x95 = 0.059456000000000002 * var_x94;
        const double var_x96 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
        const double var_x97 = 0.083986000000000005 * var_x96;
        const double var_x98 = exp(-0.01595737611258119 * var_chaste_interface__membrane__Vm);
        const double var_x99 = 0.0062345999999999999 * var_x98;
        const double var_x100 = -var_x99;
        const double var_x101 = 0.029728000000000001 * var_x94;
        const double var_x102 = -var_x101;
        const double var_x103 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
        const double var_x104 = 0.014600999999999999 * var_x103;
        const double var_x105 = 0.014864 * var_x94;
        const double var_x106 = -var_x105;
        const double var_x107 = -var_x104 - var_x97;
        const double var_x108 = 0.16797200000000001 * var_x96;
        const double var_x109 = 0.0093518999999999998 * var_x98;
        const double var_x110 = 0.029201999999999999 * var_x103;
        const double var_x111 = -var_x108 - var_x110;
        const double var_x112 = 0.043802999999999995 * var_x103;
        const double var_x113 = -var_x109;
        const double var_x114 = 0.0124692 * var_x98;
        const double var_x115 = 0.07732 * exp(-0.0024231252229042349 * var_chaste_interface__membrane__Vm);
        const double var_x116 = 0.044592 * var_x94;
        const double var_x117 = -var_x116;
        const double var_x118 = 0.0031172999999999999 * var_x98;
        const double var_x119 = 0.25195800000000002 * var_x96;
        const double var_x120 = -var_x112 - var_x119;
        const double var_x121 = 0.33594400000000002 * var_x96;
        const double var_x122 = 0.058403999999999998 * var_x103;
        const double var_x123 = -var_x118;
        const double var_x124 = 0.58638000000000001 * exp(0.0105593841790373 * var_chaste_interface__membrane__Vm);
        const double var_x125 = 0.79405000000000003 * exp(-0.003001446738885828 * var_chaste_interface__membrane__Vm);
        const double var_x126 = 0.00035619469026548675 * var_chaste_interface__Ca__Ca_i;
        const double var_x127 = var_x126 * var_x24;
        const double var_x128 = var_x126 * var_x29;
        const double var_x129 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x130 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x131 = 1.0 + 0.00011900000000000002 * pow(var_x129, (-2.0)) + 3.5000000000000004e-5 * pow(var_x130, (-2.0));
        const double var_x132 = 1 / var_x131;
        const double var_x133 = 1.0 * var_x132;
        const double var_x134 = 1.7739020544754105e-6 / var_x130;
        const double var_x135 = 0.00035619469026548675 * var_x31;
        const double var_x136 = 8.8930116629204303e-8 * var_x88;
        const double var_x137 = exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm);
        const double var_x138 = pow(var_chaste_interface__Na__Na_i, 3.0);
        const double var_x139 = 1 / (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_i + 8.4084932990912282 * var_x138);
        const double var_x140 = 1 / (1.0 + 0.32000000000000001 * var_x137);
        const double var_x141 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x142 = pow(var_x141, 2.0);
        const double var_x143 = 1.0 + 1.5624999999999999e-8 * var_x142;
        const double var_x144 = var_x140 / var_x143;
        const double var_x145 = var_x139 * var_x144;
        const double var_x146 = var_x137 * var_x145;
        const double var_x147 = exp(0.010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x148 = 6.4800000000000004 * var_x138 * var_x147 - 9878400.0 * var_x137 * var_chaste_interface__Ca__Ca_i;
        const double var_x149 = var_x144 * var_x148 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x138 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x150 = var_x139 * var_x140 * var_x141 * var_x142 * var_x148 / pow(var_x143, 2);
        const double var_x151 = pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x152 = var_x145 * var_x147 * var_x151;
        const double var_x153 = var_x149 * var_x151;
        const double var_x154 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x155 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x156 = 1.0 + 0.0097788000000000007 * pow(var_x154, (-2.0)) + 4.0890000000000003e-5 * pow(var_x155, (-2.0));
        const double var_x157 = 1 / var_x156;
        const double var_x158 = pow(var_chaste_interface__Na__Na_ss_sr, 3.0);
        const double var_x159 = 1.6200000000000001 * var_x147 * var_x158 - 2469600.0 * var_x137 * var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x160 = pow(var_x1, 2.0);
        const double var_x161 = 1.0 + 1.5624999999999999e-8 * var_x160;
        const double var_x162 = var_x140 / var_x161;
        const double var_x163 = var_x159 * var_x162;
        const double var_x164 = var_x163 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x158 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        const double var_x165 = 1 / (13227.9606 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr + 8.4084932990912282 * var_x158);
        const double var_x166 = var_x162 * var_x165;
        const double var_x167 = var_x137 * var_x166;
        const double var_x168 = var_x1 * var_x140 * var_x159 * var_x160 * var_x165 / pow(var_x161, 2);
        const double var_x169 = 1.0 * var_x157;
        const double var_x170 = pow(var_chaste_interface__Na__Na_ss_sr, 2.0);
        const double var_x171 = var_x147 * var_x166 * var_x170;
        const double var_x172 = var_x164 * var_x170;
        const double var_x173 = 1 / var_x6;
        const double var_x174 = pow(var_x173, 10.0);
        const double var_x175 = 1.0 + 2.9619676669542428e-6 * var_x174;
        const double var_x176 = var_x173 * var_x174 / pow(var_x175, 2);
        const double var_x177 = var_x176 * (-1 + var_x4);
        const double var_x178 = 1 / var_chaste_interface__Ca__Ca_JSR;
        const double var_x179 = 1.0 + 0.0123 * var_x178;
        const double var_x180 = pow(var_x178, 8.0);
        const double var_x181 = 1.0 + 1.0 * var_x180;
        const double var_x182 = 1 / var_x181;
        const double var_x183 = 1 / var_x175;
        const double var_x184 = 0.53437500000000004 + 0.53437500000000004 * var_x183;
        const double var_x185 = 2.2470468725164396 * var_x182 * var_x184 * var_x88;
        const double var_x186 = var_x87 * var_x92;
        const double var_x187 = var_x15 - var_x185 * var_x186;
        const double var_x188 = var_x179 * var_x187 / pow((1 + var_x183), 2);
        const double var_x189 = 1 / (4.75 + 4.75 * var_x183);
        const double var_x190 = var_x179 * var_x189;
        const double var_x191 = var_x186 * var_x190 * var_x88;
        const double var_x192 = var_x182 * var_x191;
        const double var_x193 = var_x185 * var_x190;
        const double var_x194 = -var_x193 * var_x87;
        const double var_x195 = var_x10 * var_x176;
        const double var_x196 = pow(var_chaste_interface__Irel__Irel, 2.0);
        const double var_x197 = 0.037436659501656748 * var_chaste_interface__membrane__Vm;
        const double var_x198 = exp(var_x197);
        const double var_x199 = var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / (1.0 - var_x198);
        const double var_x200 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x201 = log(100.0 * var_x200);
        const double var_x202 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x203 = var_x201 + log(140.0 * var_x202);
        const double var_x204 = pow(var_x203, 4.0);
        const double var_x205 = 7.2087469970547496e-9 * pow(var_x203, 7.0) / pow((1 + 0.0085573053764671191 * var_x204), 2);
        const double var_x206 = 50.118419258935766 * pow(var_x203, 3.0) / (59494197.640692554 + 509110.01733929582 * var_x204);
        const double var_x207 = var_x200 * var_x205 - var_x200 * var_x206;
        const double var_x208 = 1 / var_chaste_interface__K__K_i;
        const double var_x209 = log(5.4000000000000004 * var_x208);
        const double var_x210 = 26.711785007306684 * var_x209;
        const double var_x211 = var_x210 + 26.711785007306684 * var_x201;
        const double var_x212 = 0.00047279859462932828 / (87.825100000000006 + var_x211);
        const double var_x213 = 6.1296950776416711e-8 * var_x211 / pow((1 + 0.30414750461208334 * var_x201 + 0.30414750461208334 * var_x209), 2);
        const double var_x214 = var_x200 * var_x213 - var_x200 * var_x212;
        const double var_x215 = var_x202 * var_x205 - var_x202 * var_x206;
        const double var_x216 = var_x208 * var_x213 - var_x208 * var_x212;
        const double var_x217 = 2.6000000000000001 + var_chaste_interface__Na__Na_i;
        const double var_x218 = 1 / var_x217;
        const double var_x219 = var_x202 * var_x217 * pow((var_x218 * var_chaste_interface__Na__Na_i), 3.0) * (3.0 * var_x218 - 0.4437869822485207 * var_chaste_interface__Na__Na_i / pow((1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i), 2)) / (1.0 + exp(-3.4441726741524206 - var_x197));
        const double var_x220 = pow(var_x141, 1.3999999999999999);
        const double var_x221 = 1.0 + 6.4818210260626455e-7 * var_x220;
        const double var_x222 = -5.0964977286841363e-6 - 3.0578986372104813e-6 / var_x221;
        const double var_x223 = 0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
        const double var_x224 = -26.711785007306684 * log(7.9662000000000006 / var_x223) + var_chaste_interface__membrane__Vm;
        const double var_x225 = var_x222 * var_x224;
        const double var_x226 = var_chaste_interface__IKs__O1 + var_chaste_interface__IKs__O2;
        const double var_x227 = var_x222 * var_x226 * (0.12553036579548593 * var_chaste_interface__K__K_i + 0.002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x223, 2);
        const double var_x228 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * var_x209);
        const double var_x229 = 1.0 + var_x228;
        const double var_x230 = 1 / var_x229;
        const double var_x231 = exp(-2.4444678999999998 + 13.737871029257827 * var_x209 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x232 = 1.0 + var_x231;
        const double var_x233 = 1 / var_x232;
        const double var_x234 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * var_x209);
        const double var_x235 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * var_x209);
        const double var_x236 = var_x235 + 0.49124000000000001 * var_x234;
        const double var_x237 = var_x233 * var_x236;
        const double var_x238 = var_x208 / (var_x237 + 1.02 * var_x230);
        const double var_x239 = -var_x210 + var_chaste_interface__membrane__Vm;
        const double var_x240 = var_x228 / pow(var_x229, 2);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.00068000000000000005 - var_x6 * var_x7 + var_x0 * var_x7 * var_x8));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        ...
        rJacobian[0][30] = -(mDt * (3.7500000000000005e-6 * var_x10 * var_x6 + 1.8750000000000003e-7 * var_x9 * pow(var_x0, 2) / pow(var_x2, 3)));
        ...
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-var_x14 + 0.25 * pow(var_x11, (-3.0)) * (var_x15 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / pow((0.125 + var_x12), 2)));
        rJacobian[1][2] = -(mDt * (var_x14));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (0));
        ...
        rJacobian[2][29] = -(mDt * (-var_x30 + 0.0043750000000000004 * var_x31));
        rJacobian[2][30] = -(mDt * (var_x26 * var_x34 + var_x30 * var_x35));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (var_x39 + var_x52));
        rJacobian[3][4] = -(mDt * (var_x53));
        rJacobian[3][5] = -(mDt * (1.0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (var_x55));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (0));
        rJacobian[3][10] = -(mDt * (0));
        rJacobian[3][11] = -(mDt * (-var_x58));
        ...
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (var_x38));
        rJacobian[4][4] = 1.0 -(mDt * (var_x52 + var_x59));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (1.0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (var_x55));
        rJacobian[4][10] = -(mDt * (0));
        rJacobian[4][11] = -(mDt * (-var_x60));
        ...
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (var_x44));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (var_x39 + var_x66));
        rJacobian[5][6] = -(mDt * (var_x53));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (var_x68));
        rJacobian[5][9] = -(mDt * (0));
        rJacobian[5][10] = -(mDt * (0));
        rJacobian[5][11] = -(mDt * (var_x58 + var_x70 * var_chaste_interface__ICaL__CI_star + var_x71 * var_chaste_interface__ICaL__C_star));
        ...
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (var_x44));
        rJacobian[6][5] = -(mDt * (var_x38));
        rJacobian[6][6] = 1.0 -(mDt * (var_x59 + var_x66));
        rJacobian[6][7] = -(mDt * (0));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        rJacobian[6][10] = -(mDt * (var_x68));
        rJacobian[6][11] = -(mDt * (var_x60 + var_x70 * var_chaste_interface__ICaL__OI_star + var_x71 * var_chaste_interface__ICaL__O_star));
        ...
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (var_x51));
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (var_x39 + var_x74));
        rJacobian[7][8] = -(mDt * (9.9999999999999995e-7));
        rJacobian[7][9] = -(mDt * (var_x53));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (-var_x76));
        ...
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (0));
        rJacobian[8][5] = -(mDt * (var_x65));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (var_x73));
        rJacobian[8][8] = 1.0 -(mDt * (var_x39 + var_x77));
        rJacobian[8][9] = -(mDt * (0));
        rJacobian[8][10] = -(mDt * (var_x53));
        rJacobian[8][11] = -(mDt * (var_x76 + var_x78 * var_chaste_interface__ICaL__C_star + var_x79 * var_chaste_interface__ICaL__CI_star));
        ...
        rJacobian[9][2] = -(mDt * (0));
        rJacobian[9][3] = -(mDt * (0));
        rJacobian[9][4] = -(mDt * (var_x51));
        rJacobian[9][5] = -(mDt * (0));
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (var_x38));
        rJacobian[9][8] = -(mDt * (0));
        rJacobian[9][9] = 1.0 -(mDt * (var_x59 + var_x74));
        rJacobian[9][10] = -(mDt * (9.9999999999999995e-7));
        rJacobian[9][11] = -(mDt * (-var_x80));
        ...
        rJacobian[10][6] = -(mDt * (var_x65));
        rJacobian[10][7] = -(mDt * (0));
        rJacobian[10][8] = -(mDt * (var_x38));
        rJacobian[10][9] = -(mDt * (var_x73));
        rJacobian[10][10] = 1.0 -(mDt * (var_x59 + var_x77));
        rJacobian[10][11] = -(mDt * (var_x80 + var_x78 * var_chaste_interface__ICaL__O_star + var_x79 * var_chaste_interface__ICaL__OI_star));
        ...
        rJacobian[11][4] = -(mDt * (var_x91));
        rJacobian[11][5] = -(mDt * (0));
        rJacobian[11][6] = -(mDt * (var_x91));
        rJacobian[11][7] = -(mDt * (0));
        rJacobian[11][8] = -(mDt * (0));
        rJacobian[11][9] = -(mDt * (0));
        rJacobian[11][10] = -(mDt * (0));
        rJacobian[11][11] = 1.0 -(mDt * (1.0 * var_x84 * (-5.0 - var_x89 * var_x93) + 1.0 * (0.019557600000000001 * pow(var_x81, (-3.0)) + 8.1780000000000006e-5 * pow(var_x82, (-3.0))) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x90 * var_x92) / pow(var_x83, 2)));
        ...
        rJacobian[11][30] = -(mDt * (5.0 * var_x84));
        ...
        rJacobian[12][12] = 1.0 -(mDt * (-var_x95));
        ...
        rJacobian[13][13] = 1.0 -(mDt * (var_x100 + var_x102));
        rJacobian[13][14] = -(mDt * (var_x97));
        ...
        rJacobian[14][13] = -(mDt * (var_x101));
        rJacobian[14][14] = 1.0 -(mDt * (var_x100 + var_x106 + var_x107));
        rJacobian[14][15] = -(mDt * (var_x108));
        rJacobian[14][16] = -(mDt * (var_x109));
        ...
        rJacobian[15][14] = -(mDt * (var_x105));
        rJacobian[15][15] = 1.0 -(mDt * (var_x100 + var_x111));
        rJacobian[15][16] = -(mDt * (0));
        rJacobian[15][17] = -(mDt * (var_x109));
        ...
        rJacobian[16][14] = -(mDt * (var_x104));
        rJacobian[16][15] = -(mDt * (0));
        rJacobian[16][16] = 1.0 -(mDt * (var_x106 + var_x113));
        rJacobian[16][17] = -(mDt * (var_x97));
        ...
        rJacobian[17][15] = -(mDt * (var_x110));
        rJacobian[17][16] = -(mDt * (var_x105));
        rJacobian[17][17] = 1.0 -(mDt * (var_x107 + var_x113));
        rJacobian[17][18] = -(mDt * (var_x114));
        ...
        rJacobian[18][17] = -(mDt * (var_x104));
        rJacobian[18][18] = 1.0 -(mDt * (-0.089538000000000006 - var_x114));
        ...
        rJacobian[19][19] = 1.0 -(mDt * (var_x107 + var_x117));
        rJacobian[19][20] = -(mDt * (var_x108));
        rJacobian[19][21] = -(mDt * (0));
        rJacobian[19][22] = -(mDt * (0));
        rJacobian[19][23] = -(mDt * (var_x118));
        ...
        rJacobian[20][19] = -(mDt * (var_x116));
        rJacobian[20][20] = 1.0 -(mDt * (var_x102 + var_x111));
        rJacobian[20][21] = -(mDt * (var_x119));
        rJacobian[20][22] = -(mDt * (0));
        rJacobian[20][23] = -(mDt * (0));
        rJacobian[20][24] = -(mDt * (var_x118));
        ...
        rJacobian[21][20] = -(mDt * (var_x101));
        rJacobian[21][21] = 1.0 -(mDt * (var_x106 + var_x120));
        rJacobian[21][22] = -(mDt * (var_x121));
        rJacobian[21][23] = -(mDt * (0));
        rJacobian[21][24] = -(mDt * (0));
        rJacobian[21][25] = -(mDt * (var_x118));
        ...
        rJacobian[22][21] = -(mDt * (var_x105));
        rJacobian[22][22] = 1.0 -(mDt * (-var_x121 - var_x122));
        rJacobian[22][23] = -(mDt * (0));
        rJacobian[22][24] = -(mDt * (0));
        rJacobian[22][25] = -(mDt * (0));
        rJacobian[22][26] = -(mDt * (var_x118));
        ...
        rJacobian[23][19] = -(mDt * (var_x104));
        rJacobian[23][20] = -(mDt * (0));
        rJacobian[23][21] = -(mDt * (0));
        rJacobian[23][22] = -(mDt * (0));
        rJacobian[23][23] = 1.0 -(mDt * (var_x117 + var_x123));
        rJacobian[23][24] = -(mDt * (var_x97));
        ...
        rJacobian[24][20] = -(mDt * (var_x110));
        rJacobian[24][21] = -(mDt * (0));
        rJacobian[24][22] = -(mDt * (0));
        rJacobian[24][23] = -(mDt * (var_x116));
        rJacobian[24][24] = 1.0 -(mDt * (var_x102 + var_x107 + var_x123));
        rJacobian[24][25] = -(mDt * (var_x108));
        ...
        rJacobian[25][21] = -(mDt * (var_x112));
        rJacobian[25][22] = -(mDt * (0));
        rJacobian[25][23] = -(mDt * (0));
        rJacobian[25][24] = -(mDt * (var_x101));
        rJacobian[25][25] = 1.0 -(mDt * (var_x106 + var_x111 + var_x123));
        rJacobian[25][26] = -(mDt * (var_x119));
        ...
        rJacobian[26][22] = -(mDt * (var_x122));
        rJacobian[26][23] = -(mDt * (0));
        rJacobian[26][24] = -(mDt * (0));
        rJacobian[26][25] = -(mDt * (var_x105));
        rJacobian[26][26] = 1.0 -(mDt * (var_x120 + var_x123));
        ...
        rJacobian[27][18] = -(mDt * (0.089538000000000006));
        ...
        rJacobian[27][27] = 1.0 -(mDt * (-var_x115 - var_x124));
        rJacobian[27][28] = -(mDt * (var_x125));
        ...
        rJacobian[28][27] = -(mDt * (var_x124));
        rJacobian[28][28] = 1.0 -(mDt * (-var_x125));
        ...
        rJacobian[29][0] = -(mDt * (var_x133 * (-var_x127 * var_x21 - var_x128 * var_x27)));
        rJacobian[29][1] = -(mDt * (0));
        rJacobian[29][2] = -(mDt * (2.3746312684365782e-5 * var_x132));
        ...
        rJacobian[29][29] = 1.0 -(mDt * (var_x133 * (-0.014749262536873154 + var_x128 - var_x134 - var_x135 + 1.9281544070384897e-12 * var_x150 - 609.50657582364852 * var_x146 - 1.4202553819674954e-11 * var_x149 - var_x136 * var_x85 + 1.7739020544754105e-6 * var_chaste_interface__Ca__Ca_i / pow(var_x130, 2)) + 1.0 * (0.00023800000000000004 * pow(var_x129, (-3.0)) + 7.0000000000000007e-5 * pow(var_x130, (-3.0))) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i - var_x134 * var_chaste_interface__Ca__Ca_i - var_x135 * var_chaste_interface__Ca__Ca_i - var_x136 * (-0.61380000000000001 + var_x86 * var_chaste_interface__Ca__Ca_i) + 6.1700941025231664e-5 * var_x145 * var_x148) / pow(var_x131, 2)));
        rJacobian[29][30] = -(mDt * (var_x133 * (0.014749262536873154 - var_x127 * var_x34 - var_x128 * var_x35)));
        rJacobian[29][31] = -(mDt * (0));
        rJacobian[29][32] = -(mDt * (0));
        rJacobian[29][33] = -(mDt * (0));
        rJacobian[29][34] = -(mDt * (0));
        rJacobian[29][35] = -(mDt * (var_x133 * (0.0011994662935305037 * var_x152 - 8.2467064718009662e-17 * var_x153)));
        ...
        rJacobian[30][11] = -(mDt * (0.5 * var_x157));
        ...
        rJacobian[30][29] = -(mDt * (5.0 * var_x157));
        rJacobian[30][30] = 1.0 -(mDt * (var_x169 * (-5.5 + 6.53644343986048e-11 * var_x168 - 4.8146657448698097e-10 * var_x164 - 5165.5682301054212 * var_x167) + 1.0 * (0.019557600000000001 * pow(var_x154, (-3.0)) + 8.1780000000000006e-5 * pow(var_x155, (-3.0))) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + 0.0020916619007553534 * var_x163 * var_x165) / pow(var_x156, 2)));
        rJacobian[30][31] = -(mDt * (var_x169 * (0.010165476837671019 * var_x171 - 2.7956334939405277e-15 * var_x172)));
        rJacobian[30][32] = -(mDt * (0.23999999999999996 * var_x157));
        ...
        rJacobian[31][30] = -(mDt * (15496.704690316265 * var_x167 + 1.4443997234609428e-9 * var_x164 - 1.960933031958144e-10 * var_x168));
        rJacobian[31][31] = 1.0 -(mDt * (-5.0 + 8.386900481821583e-15 * var_x172 - 0.030496430513013057 * var_x171));
        rJacobian[31][32] = -(mDt * (0));
        rJacobian[31][33] = -(mDt * (0));
        rJacobian[31][34] = -(mDt * (0));
        rJacobian[31][35] = -(mDt * (5.0));
        rJacobian[31][36] = -(mDt * (0));
        rJacobian[32][0] = -(mDt * (3.5566290975364474e-5 * var_x177 * var_x192 + 6.2357214041141957e-6 * var_x177 * var_x188));
        rJacobian[32][1] = -(mDt * (-0.0123 * var_x187 * var_x189 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 17.976374980131517 * var_x178 * var_x180 * var_x184 * var_x191 / pow(var_x181, 2)));
        rJacobian[32][2] = -(mDt * (0));
        rJacobian[32][3] = -(mDt * (0));
        rJacobian[32][4] = -(mDt * (var_x194));
        rJacobian[32][5] = -(mDt * (0));
        rJacobian[32][6] = -(mDt * (var_x194));
        rJacobian[32][7] = -(mDt * (0));
        rJacobian[32][8] = -(mDt * (0));
        rJacobian[32][9] = -(mDt * (0));
        rJacobian[32][10] = -(mDt * (0));
        rJacobian[32][11] = -(mDt * (-var_x193 * var_x93));
        ...
        rJacobian[32][30] = -(mDt * (-4.6767910530856466e-10 * var_x188 * var_x195 - 2.667471823152336e-9 * var_x192 * var_x195));
        ...
        rJacobian[33][32] = -(mDt * (2.175954783543569e-6 * var_x199 * pow(var_chaste_interface__Irel__Irel, 1.0) * (-100.0 * var_x198 + var_chaste_interface__Cl__Cl_i) / pow((0.16000000000000003 + var_x196), 2)));
        rJacobian[33][33] = 1.0 -(mDt * (-5.0));
        rJacobian[33][34] = -(mDt * (5.0 + 6.799858698573652e-6 * var_x199 * (1.0 - 1.0 / (1.0 + 6.2499999999999991 * var_x196))));
        ...
        rJacobian[34][33] = -(mDt * (0.14749262536873156));
        rJacobian[34][34] = 1.0 -(mDt * (-0.14749262536873156 + var_x207 + var_x214 - 3.7083201106826184e-7 * var_x200));
        rJacobian[34][35] = -(mDt * (var_x215));
        rJacobian[34][36] = -(mDt * (var_x216));
        ...
        rJacobian[35][29] = -(mDt * (4.2607661459024858e-11 * var_x149 + 1828.5197274709456 * var_x146 - 5.784463221115469e-12 * var_x150));
        rJacobian[35][30] = -(mDt * (0));
        rJacobian[35][31] = -(mDt * (0.14749262536873156));
        rJacobian[35][32] = -(mDt * (0));
        rJacobian[35][33] = -(mDt * (0));
        rJacobian[35][34] = -(mDt * (var_x207));
        rJacobian[35][35] = 1.0 -(mDt * (-0.14749262536873156 + var_x215 + 2.4740119415402899e-16 * var_x153 - 0.00020280831050032669 * var_x219 - 0.0035983988805915112 * var_x152 - 7.1319396379664657e-10 * var_x198 * var_chaste_interface__membrane__Vm / (-1.0 + var_x198) - 1.0712924764194231e-5 * var_x202 * pow(var_chaste_interface__INaL_mL_gate__mL, 3.0) * var_chaste_interface__INaL_hL_gate__hL - 0.014956891113086561 * var_x202 * pow(var_chaste_interface__INa_m_gate__m, 3.0) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j));
        ...
        rJacobian[36][27] = -(mDt * (var_x225));
        rJacobian[36][28] = -(mDt * (var_x225));
        rJacobian[36][29] = -(mDt * (-2.774905235513489e-12 * var_x141 * var_x220 * var_x224 * var_x226 / pow(var_x221, 2)));
        rJacobian[36][30] = -(mDt * (0));
        rJacobian[36][31] = -(mDt * (0));
        rJacobian[36][32] = -(mDt * (0));
        rJacobian[36][33] = -(mDt * (0));
        rJacobian[36][34] = -(mDt * (var_x214));
        rJacobian[36][35] = -(mDt * (0.00013520554033355113 * var_x219 + 3.900466760223035 * var_x227));
        rJacobian[36][36] = 1.0 -(mDt * (var_x216 + 212.7914217252065 * var_x227 - 4.5488726691040119e-6 * var_x208 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) - 0.0008405525584213936 * var_x230 * var_x238 + 0.00020047178518350236 * var_x238 * var_x239 * var_x240 - 2.2833692656630728e-5 * var_x208 * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm)) - 3.0245559326093954e-5 * var_x230 * var_x239 * (-var_x233 * (1.0539507884845836 * var_x208 * var_x234 + 1.6494527242011876 * var_x208 * var_x235) + 6.4981759387274964 * var_x208 * var_x240 - 13.737871029257827 * var_x208 * var_x231 * var_x236 / pow(var_x232, 2)) / pow((var_x230 + 0.98039215686274506 * var_x237), 2) - 0.00081995078002871237 * var_x208 * pow(var_chaste_interface__Ito1_a_gate__a, 3.0) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm)));
    }
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[32] = (var_chaste_interface__IKr_xr_gate__xr + ((0.0010430399999999999 / (-1.0 + 1.0 * exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm) - 1.0 * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm) + exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm) * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm)) + 0.011508239999999998 / (-1.0 + 1.0 * exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm) - 1.0 * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm) + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm) * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm)) + 0.00029999999999999997 * var_chaste_interface__membrane__Vm / (-1.0 + 1.0 * exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm) - 1.0 * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm) + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm) * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm)) - 0.00059999999999999995 * var_chaste_interface__membrane__Vm / (-1.0 + 1.0 * exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm) - 1.0 * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm) + exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm) * exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((0.0010430399999999999 / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm)) - 0.011508239999999998 / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)) - 0.00029999999999999997 * var_chaste_interface__membrane__Vm / (-1.0 + exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm)) - 0.00059999999999999995 * var_chaste_interface__membrane__Vm / (1.0 - exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm))) * mDt));
        rY[31] = (var_chaste_interface__INaL_hL_gate__hL + ((0.0016666666666666668 / (1.0 + exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((-0.0016666666666666668) * mDt));
        rY[30] = (var_chaste_interface__INaL_mL_gate__mL + ((-15.081600000000002 / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm)) - 0.32000000000000001 * var_chaste_interface__membrane__Vm / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((-0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__membrane__Vm) - 15.081600000000002 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm)) - 0.32000000000000001 * var_chaste_interface__membrane__Vm / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))) * mDt));
        rY[28] = (var_chaste_interface__INa_h_gate__h + ((((var_chaste_interface__membrane__Vm >= -40.0) ? (0) : (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm)))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__Vm >= -40.0) ? (-7.6923076923076916 / (1.0 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__Vm))) : (-310000.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__Vm) - 0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm) - 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__Vm)))) * mDt));
        rY[29] = (var_chaste_interface__INa_j_gate__j + ((((var_chaste_interface__membrane__Vm >= -40.0) ? (0) : (-4803349.2000000002 * exp(0.24440000000000001 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)) - 0.0026249544000000002 * exp(-0.043909999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)) - 127140.0 * var_chaste_interface__membrane__Vm * exp(0.24440000000000001 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)) - 6.9480000000000006e-5 * var_chaste_interface__membrane__Vm * exp(-0.043909999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__Vm >= -40.0) ? (-0.29999999999999999 * exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__Vm) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))) : (4803349.2000000002 * exp(0.24440000000000001 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)) + 0.0026249544000000002 * exp(-0.043909999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)) - 0.1212 * exp(-0.01052 * var_chaste_interface__membrane__Vm) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__Vm)) + 127140.0 * var_chaste_interface__membrane__Vm * exp(0.24440000000000001 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm)) + 6.9480000000000006e-5 * var_chaste_interface__membrane__Vm * exp(-0.043909999999999998 * var_chaste_interface__membrane__Vm) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm))))) * mDt));
        rY[27] = (var_chaste_interface__INa_m_gate__m + ((-15.081600000000002 / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm)) - 0.32000000000000001 * var_chaste_interface__membrane__Vm / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((-0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__membrane__Vm) - 15.081600000000002 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm)) - 0.32000000000000001 * var_chaste_interface__membrane__Vm / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__Vm))) * mDt));
        rY[33] = (var_chaste_interface__Ito1_a_gate__a + ((3.5 / (1.0 + 1.0 * exp(3.403513787634354 + 0.034035137876343539 * var_chaste_interface__membrane__Vm) + 1.0 * exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm) + exp(3.403513787634354 + 0.034035137876343539 * var_chaste_interface__membrane__Vm) * exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm)) + 0.82719827942757873 / (1.0 + 1.0 * exp(0.62658348478969694 - 0.034035137876343539 * var_chaste_interface__membrane__Vm) + 1.0 * exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm) + exp(0.62658348478969694 - 0.034035137876343539 * var_chaste_interface__membrane__Vm) * exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((-3.5 / (1.0 + exp(3.403513787634354 + 0.034035137876343539 * var_chaste_interface__membrane__Vm)) - 0.82719827942757873 / (1.0 + exp(0.62658348478969694 - 0.034035137876343539 * var_chaste_interface__membrane__Vm))) * mDt));
        rY[34] = (var_chaste_interface__Ito1_i1f_gate__i1f + ((0.025000000000000001 / (1.0 + exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((-0.025000000000000001 / (1.0 + exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm)) - 0.10208977775055385 / (1.0 + exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm))) * mDt));
        rY[35] = (var_chaste_interface__Ito1_i1s_gate__i1s + ((0.0040000000000000001 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__Vm))) * mDt)) / (1.0 - ((-0.0040000000000000001 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__Vm)) - 0.10208977775055385 / (1.0 + exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm))) * mDt));
        rY[36] = (var_chaste_interface__Ito2_i2f_gate__i2f + ((0.0031250000000000002 / (0.025000000000000001 / (1.0 + exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm)) + 0.20000000000000001 / (1.0 + exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm)) + 0.025000000000000001 * exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm) / (1.0 + exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm)) + 0.20000000000000001 * exp(11.6 + 0.20000000000000001 * var_chaste_interface__membrane__Vm) / (1.0 + exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm)))) * mDt)) / (1.0 - ((-0.125) * mDt));
