...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[37], double rJacobian[37][37])
    {
        ...
        const double var_x89 = 1.0 * var_x78;
        ...
        const double var_x119 = 1.0 / (1.0 + exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x148 = var_x127 + 1.0 * var_x128 / (25.0 - 17.5 * var_x122);
        ...
        const double var_x202 = 1.0 + 1.0 * var_x201;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (1.0 * var_x68 * (-5.0 - var_x46 * var_x72) + 1.0 * (0.019557600000000001 / pow(var_x65, 3) + 8.1780000000000006e-5 / pow(var_x66, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x72 * var_x73) / pow(var_x67, 2)));
