...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldecker_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[37], double rJacobian[37][37])
    {
        ...
        const double var_x4 = var_x0 * var_x3 + var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x5 = 0.0025000000000000005 * var_x2;
        const double var_x6 = 1 - var_x3;
        const double var_x7 = pow(var_chaste_interface__Ca__Ca_ss_sr, (-2));
        const double var_x8 = var_x0 * var_x7 / pow(var_x1, 2);
        const double var_x9 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_JSR;
        const double var_x10 = pow(var_x9, (-2));
        const double var_x11 = 1 / (1.0 + 8.0 * var_x10);
        const double var_x12 = 0.040000000000000001 * var_x11;
        const double var_x13 = -var_chaste_interface__Irel__Irel;
        const double var_x14 = 0.14999999999999999 + var_x4;
        const double var_x15 = 1 / var_x14;
        const double var_x16 = var_x15 * var_x6;
        const double var_x17 = -1 + var_x3;
        const double var_x18 = var_x4 / pow(var_x14, 2);
        const double var_x19 = var_x17 * var_x18;
        const double var_x20 = 0.75 * var_x16 + 0.75 * var_x19;
        const double var_x21 = var_x15 * var_x4;
        ...
        const double var_x26 = 0.00017000000000000001 * var_x16 + 0.00017000000000000001 * var_x19;
        ...
        const double var_x31 = var_x15 * var_x8;
        const double var_x32 = var_x18 * var_x8;
        ...
        const double var_x36 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x37 = pow(var_x36, (-2));
        const double var_x38 = 1.0 + 0.00011900000000000002 / pow(var_x35, 2) + 3.5000000000000004e-5 * var_x37;
        const double var_x39 = 1 / var_x38;
        const double var_x40 = 0.00035619469026548675 * var_chaste_interface__Ca__Ca_i;
        const double var_x41 = var_x23 * var_x40;
        const double var_x42 = var_x28 * var_x40;
        const double var_x43 = 1.7739020544754105e-6 / var_x36;
        const double var_x44 = 0.00035619469026548675 * var_x30;
        const double var_x45 = exp(0.074873319003313496 * var_chaste_interface__membrane__Vm);
        const double var_x46 = var_chaste_interface__membrane__Vm / (-1.0 + var_x45);
        const double var_x47 = 8.8930116629204303e-8 * var_x46;
        const double var_x48 = exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm);
        const double var_x49 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x50 = 1 / (13227.9606 + 8.4084932990912282 * var_x49 + 4344355.375 * var_chaste_interface__Ca__Ca_i);
        const double var_x51 = 1 / (1.0 + 0.32000000000000001 * var_x48);
        const double var_x52 = 1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x53 = var_x51 / var_x52;
        const double var_x54 = var_x50 * var_x53;
        const double var_x55 = var_x48 * var_x54;
        const double var_x56 = exp(0.010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x57 = 6.4800000000000004 * var_x49 * var_x56 - 9878400.0 * var_x48 * var_chaste_interface__Ca__Ca_i;
        const double var_x58 = var_x53 * var_x57 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x49 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x59 = var_x50 * var_x51 * var_x57 / (pow(var_x52, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x60 = 1.0 * var_x45;
        const double var_x61 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x62 = var_x54 * var_x56 * var_x61;
        const double var_x63 = var_x58 * var_x61;
        const double var_x64 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x65 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x66 = 1.0 + 0.0097788000000000007 / pow(var_x64, 2) + 4.0890000000000003e-5 / pow(var_x65, 2);
        const double var_x67 = 1 / var_x66;
        const double var_x68 = var_chaste_interface__ICaL__O + var_chaste_interface__ICaL__O_star;
        const double var_x69 = var_x46 * mParameters[0];
        const double var_x70 = 151.10797107941448 * var_x69;
        const double var_x71 = var_x68 * var_x70;
        const double var_x72 = -0.61380000000000001 + var_x60 * var_chaste_interface__Ca__Ca_ss_CaL;
        ...
        const double var_x79 = 1.6200000000000001 * var_x56 * var_x78 - 2469600.0 * var_x48 * var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x80 = 1.0 + 1.5624999999999999e-8 * var_x7;
        const double var_x81 = var_x51 / var_x80;
        ...
        const double var_x86 = var_x48 * var_x85;
        const double var_x87 = var_x51 * var_x79 * var_x84 / (pow(var_x80, 2) * pow(var_chaste_interface__Ca__Ca_ss_sr, 3));
        const double var_x88 = pow(var_chaste_interface__Na__Na_ss_sr, 2);
        const double var_x89 = var_x56 * var_x85 * var_x88;
        const double var_x90 = var_x83 * var_x88;
        const double var_x91 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x92 = log(100.0 * var_x91);
        const double var_x93 = 1 / var_chaste_interface__K__K_i;
        const double var_x94 = log(5.4000000000000004 * var_x93);
        const double var_x95 = 26.711785007306684 * var_x94;
        const double var_x96 = var_x95 + 26.711785007306684 * var_x92;
        const double var_x97 = 0.00047279859462932828 / (87.825100000000006 + var_x96);
        const double var_x98 = 6.1296950776416711e-8 * var_x96 / pow((1 + 0.30414750461208334 * var_x92 + 0.30414750461208334 * var_x94), 2);
        const double var_x99 = var_x91 * var_x98 - var_x91 * var_x97;
        const double var_x100 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x101 = var_x92 + log(140.0 * var_x100);
        const double var_x102 = pow(var_x101, 4);
        const double var_x103 = 7.2087469970547496e-9 * pow(var_x101, 7) / pow((1 + 0.0085573053764671191 * var_x102), 2);
        const double var_x104 = 50.118419258935766 * pow(var_x101, 3) / (59494197.640692554 + 509110.01733929582 * var_x102);
        const double var_x105 = var_x103 * var_x91 - var_x104 * var_x91;
        const double var_x106 = var_x93 * var_x98 - var_x93 * var_x97;
        const double var_x107 = var_x100 * var_x103 - var_x100 * var_x104;
        const double var_x108 = pow(var_chaste_interface__Irel__Irel, 2);
        const double var_x109 = 0.037436659501656748 * var_chaste_interface__membrane__Vm;
        const double var_x110 = exp(var_x109);
        const double var_x111 = var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / (1.0 - var_x110);
        const double var_x112 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
        const double var_x113 = 1 / (pow(var_x112, 2) * pow(var_chaste_interface__Ca__Ca_ss_CaL, 5));
        const double var_x114 = 9.7200000000000016e-10 * var_x113;
        const double var_x115 = var_x114 * var_chaste_interface__ICaL__C;
        const double var_x116 = 1 / (1.0 + exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm));
        ...
        const double var_x120 = 1 / var_x112;
        const double var_x121 = 3.0 * var_x120;
        const double var_x122 = 1 / (1.0 + exp(5.833333333333333 + 0.33333333333333331 * var_chaste_interface__membrane__Vm));
        const double var_x123 = 0.80000000000000004 * var_x122;
        const double var_x124 = 0.80000000000000004 - var_x123;
        const double var_x125 = 0.040277106492669565 / (1.0 + exp(4.7444197507005512 + 0.096627693496956227 * var_chaste_interface__membrane__Vm));
        const double var_x126 = 1 / (1.0 + exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm));
        const double var_x127 = var_x125 + 0.032730010146303147 * var_x126;
        const double var_x128 = var_x124 * var_x127;
        const double var_x129 = -var_x121 - var_x128;
        const double var_x130 = 0.20000000000000001 + var_x123;
        const double var_x131 = var_x127 * var_x130;
        const double var_x132 = var_x117 * (1.0 - var_x116);
        const double var_x133 = 0.99990000999900008 * var_x122;
        const double var_x134 = -var_x133;
        const double var_x135 = 0.99990000999900008 + var_x134;
        const double var_x136 = 9.9990000999900015e-5 + var_x133;
        const double var_x137 = var_x130 * var_x135 / (var_x124 * var_x136);
        const double var_x138 = 9.7200000000000002e-16 * var_x113 * var_x137;
        const double var_x139 = var_x138 * var_chaste_interface__ICaL__CI;
        const double var_x140 = 3.0000000000000001e-6 * var_x120 * var_x137;
        const double var_x141 = -var_x131 - var_x140;
        const double var_x142 = 9.0720000000000001e-12 * var_x113 * var_x126 / pow((1 - 0.69999999999999996 * var_x120), 2);
        const double var_x143 = var_x142 * var_chaste_interface__ICaL__C_star;
        const double var_x144 = -9.9990000999900015e-5 + var_x134;
        const double var_x145 = var_x142 * var_chaste_interface__ICaL__CI_star;
        const double var_x146 = var_x125 + var_x126 / (25.0 - 17.5 * var_x120);
        const double var_x147 = var_x136 * var_x146;
        const double var_x148 = -9.9999999999999995e-7 - var_x147;
        const double var_x149 = var_x135 * var_x146;
        const double var_x150 = -0.99990000999900008 + var_x133;
        const double var_x151 = -1.0 - var_x149;
        const double var_x152 = var_x114 * var_chaste_interface__ICaL__O;
        const double var_x153 = -var_x132;
        const double var_x154 = var_x138 * var_chaste_interface__ICaL__OI;
        const double var_x155 = var_x142 * var_chaste_interface__ICaL__O_star;
        const double var_x156 = var_x142 * var_chaste_interface__ICaL__OI_star;
        const double var_x157 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
        const double var_x158 = 0.059456000000000002 * var_x157;
        const double var_x159 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
        const double var_x160 = 0.083986000000000005 * var_x159;
        const double var_x161 = exp(-0.01595737611258119 * var_chaste_interface__membrane__Vm);
        const double var_x162 = 0.0062345999999999999 * var_x161;
        const double var_x163 = -var_x162;
        const double var_x164 = 0.029728000000000001 * var_x157;
        const double var_x165 = -var_x164;
        const double var_x166 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
        const double var_x167 = 0.014600999999999999 * var_x166;
        const double var_x168 = 0.014864 * var_x157;
        const double var_x169 = -var_x168;
        const double var_x170 = -var_x160 - var_x167;
        const double var_x171 = 0.16797200000000001 * var_x159;
        const double var_x172 = 0.0093518999999999998 * var_x161;
        const double var_x173 = 0.029201999999999999 * var_x166;
        const double var_x174 = -var_x171 - var_x173;
        const double var_x175 = 0.043802999999999995 * var_x166;
        const double var_x176 = -var_x172;
        const double var_x177 = 0.0124692 * var_x161;
        const double var_x178 = 0.07732 * exp(-0.0024231252229042349 * var_chaste_interface__membrane__Vm);
        const double var_x179 = 0.044592 * var_x157;
        const double var_x180 = -var_x179;
        const double var_x181 = 0.0031172999999999999 * var_x161;
        const double var_x182 = 0.25195800000000002 * var_x159;
        const double var_x183 = -var_x175 - var_x182;
        const double var_x184 = 0.33594400000000002 * var_x159;
        const double var_x185 = 0.058403999999999998 * var_x166;
        const double var_x186 = -var_x181;
        const double var_x187 = 0.58638000000000001 * exp(0.0105593841790373 * var_chaste_interface__membrane__Vm);
        const double var_x188 = 0.79405000000000003 * exp(-0.003001446738885828 * var_chaste_interface__membrane__Vm);
        const double var_x189 = 1 / var_x4;
        const double var_x190 = pow(var_x189, 10.0);
        const double var_x191 = 1.0 + 2.9619676669542428e-6 * var_x190;
        const double var_x192 = var_x189 * var_x190 / pow(var_x191, 2);
        const double var_x193 = var_x17 * var_x192;
        const double var_x194 = 1 / var_chaste_interface__Ca__Ca_JSR;
        const double var_x195 = 1.0 + 0.0123 * var_x194;
        const double var_x196 = 1 / var_x191;
        const double var_x197 = 0.53437500000000004 + 0.53437500000000004 * var_x196;
        const double var_x198 = var_x197 * var_x68 * var_x69 * var_x72;
        const double var_x199 = pow(var_x194, 8.0);
        const double var_x200 = 1.0 + 1.0 * var_x199;
        const double var_x201 = 1 / var_x200;
        const double var_x202 = 14448.603861345418 * var_x201;
        const double var_x203 = var_x13 - var_x198 * var_x202;
        const double var_x204 = var_x195 * var_x203 / pow((1 + var_x196), 2);
        const double var_x205 = 1 / (4.75 + 4.75 * var_x196);
        const double var_x206 = var_x195 * var_x205;
        const double var_x207 = var_x206 * var_x69 * var_x72;
        const double var_x208 = var_x201 * var_x207 * var_x68;
        const double var_x209 = var_x197 * var_x202;
        const double var_x210 = var_x192 * var_x8;
        const double var_x211 = -var_x207 * var_x209;
        const double var_x212 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x213 = pow(var_x212, 1.3999999999999999);
        const double var_x214 = 1.0 + 6.4818210260626455e-7 * var_x213;
        const double var_x215 = 0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
        const double var_x216 = -26.711785007306684 * log(7.9662000000000006 / var_x215) + var_chaste_interface__membrane__Vm;
        const double var_x217 = var_chaste_interface__IKs__O1 + var_chaste_interface__IKs__O2;
        const double var_x218 = -5.0964977286841363e-6 - 3.0578986372104813e-6 / var_x214;
        const double var_x219 = var_x216 * var_x218;
        const double var_x220 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__Vm - 6.3707607242426434 * var_x94);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = 1 / var_x221;
        const double var_x223 = exp(-2.4444678999999998 + 13.737871029257827 * var_x94 - 0.51429999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x224 = 1.0 + var_x223;
        const double var_x225 = 1 / var_x224;
        const double var_x226 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__Vm - 2.1454905717868731 * var_x94);
        const double var_x227 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__Vm - 1.6494527242011876 * var_x94);
        const double var_x228 = var_x227 + 0.49124000000000001 * var_x226;
        const double var_x229 = var_x225 * var_x228;
        const double var_x230 = var_x93 / (var_x229 + 1.02 * var_x222);
        const double var_x231 = var_x217 * var_x218 * (0.12553036579548593 * var_chaste_interface__K__K_i + 0.002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x215, 2);
        const double var_x232 = -var_x95 + var_chaste_interface__membrane__Vm;
        const double var_x233 = var_x220 / pow(var_x221, 2);
        const double var_x234 = 1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i;
        const double var_x235 = 1 / (1.0 + exp(-3.4441726741524206 - var_x109));
        const double var_x236 = var_x235 * var_x61 / pow(var_x234, 3);
        const double var_x237 = var_x235 * var_x49 / pow(var_x234, 4);
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-0.00068000000000000005 - var_x4 * var_x5 + var_x0 * var_x5 * var_x6));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = -(mDt * (3.7500000000000005e-6 * var_x4 * var_x8 + 1.8750000000000003e-7 * var_x7 * pow(var_x0, 2) / pow(var_x1, 3)));
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = 0.0;
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        ...
        rJacobian[0][36] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-var_x12 + 0.25 * (var_x13 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x9, 3) * pow((0.125 + var_x10), 2))));
        rJacobian[1][2] = -(mDt * (var_x12));
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        ...
        rJacobian[2][35] = 0.0;
        rJacobian[2][36] = 0.0;
        rJacobian[3][0] = -(mDt * (var_x39 * (-var_x20 * var_x41 - var_x26 * var_x42)));
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (2.3746312684365782e-5 * var_x39));
        rJacobian[3][3] = 1.0 - (mDt * (var_x39 * (-0.014749262536873154 + var_x42 - var_x43 - var_x44 + 1.9281544070384897e-12 * var_x59 - 609.50657582364852 * var_x55 - 1.4202553819674954e-11 * var_x58 - var_x45 * var_x47 + 1.7739020544754105e-6 * var_x37 * var_chaste_interface__Ca__Ca_i) + (0.00023800000000000004 / pow(var_x35, 3) + 7.0000000000000007e-5 / pow(var_x36, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i - var_x43 * var_chaste_interface__Ca__Ca_i - var_x44 * var_chaste_interface__Ca__Ca_i - var_x47 * (-0.61380000000000001 + var_x60 * var_chaste_interface__Ca__Ca_i) + 6.1700941025231664e-5 * var_x54 * var_x57) / pow(var_x38, 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x39 * (0.014749262536873154 - var_x33 * var_x41 - var_x34 * var_x42)));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        ...
        rJacobian[3][33] = 0.0;
        rJacobian[3][34] = 0.0;
        rJacobian[3][35] = -(mDt * (var_x39 * (0.0011994662935305037 * var_x62 - 8.2467064718009662e-17 * var_x63)));
        rJacobian[3][36] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (var_x67 * (-5.0 - var_x45 * var_x71) + (0.019557600000000001 / pow(var_x64, 3) + 8.1780000000000006e-5 / pow(var_x65, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x71 * var_x72) / pow(var_x66, 2)));
        rJacobian[4][5] = -(mDt * (5.0 * var_x67));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[5][5] = 1.0 - (mDt * (var_x77 * (-5.5 + 6.53644343986048e-11 * var_x87 - 4.8146657448698097e-10 * var_x83 - 5165.5682301054212 * var_x86) + (0.019557600000000001 / pow(var_x74, 3) + 8.1780000000000006e-5 / pow(var_x75, 3)) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + 0.0020916619007553534 * var_x82 * var_x84) / pow(var_x76, 2)));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[5][34] = 0.0;
        rJacobian[5][35] = 0.0;
        rJacobian[5][36] = -(mDt * (var_x77 * (0.010165476837671019 * var_x89 - 2.7956334939405277e-15 * var_x90)));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.14749262536873156 + var_x105 + var_x99 - 3.7083201106826184e-7 * var_x91));
        ...
        rJacobian[6][32] = 0.0;
        rJacobian[6][33] = 0.0;
        rJacobian[6][34] = -(mDt * (var_x106));
        rJacobian[6][35] = -(mDt * (var_x107));
        rJacobian[6][36] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        ...
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (5.0 + 6.799858698573652e-6 * var_x111 * (1.0 - 1.0 / (1.0 + 6.2499999999999991 * var_x108))));
        ...
        rJacobian[7][31] = 0.0;
        rJacobian[7][32] = 0.0;
        rJacobian[7][33] = -(mDt * (2.175954783543569e-6 * var_x111 * (-100.0 * var_x110 + var_chaste_interface__Cl__Cl_i) * var_chaste_interface__Irel__Irel / pow((0.16000000000000003 + var_x108), 2)));
        rJacobian[7][34] = 0.0;
        rJacobian[7][35] = 0.0;
        rJacobian[7][36] = 0.0;
        rJacobian[8][0] = 0.0;
        ...
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = -(mDt * (-var_x115));
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (var_x119 + var_x129));
        rJacobian[8][9] = -(mDt * (var_x131));
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = -(mDt * (1.0));
        rJacobian[8][12] = -(mDt * (var_x132));
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[8][15] = 0.0;
        rJacobian[8][16] = 0.0;
        ...
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = -(mDt * (-var_x139));
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = -(mDt * (var_x128));
        rJacobian[9][9] = 1.0 - (mDt * (var_x119 + var_x141));
        rJacobian[9][10] = -(mDt * (9.9999999999999995e-7));
        rJacobian[9][11] = 0.0;
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = -(mDt * (var_x132));
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = 0.0;
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        ...
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = -(mDt * (var_x139 + var_x135 * var_x143 + var_x144 * var_x145));
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = -(mDt * (var_x140));
        rJacobian[10][10] = 1.0 - (mDt * (var_x119 + var_x148));
        rJacobian[10][11] = -(mDt * (var_x149));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = -(mDt * (var_x132));
        rJacobian[10][15] = 0.0;
        rJacobian[10][16] = 0.0;
        rJacobian[10][17] = 0.0;
        rJacobian[10][18] = 0.0;
        ...
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = -(mDt * (var_x115 + var_x136 * var_x145 + var_x143 * var_x150));
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = -(mDt * (var_x121));
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (var_x147));
        rJacobian[11][11] = 1.0 - (mDt * (var_x119 + var_x151));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = -(mDt * (var_x132));
        rJacobian[11][16] = 0.0;
        rJacobian[11][17] = 0.0;
        rJacobian[11][18] = 0.0;
        rJacobian[11][19] = 0.0;
        ...
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (-var_x152));
        rJacobian[12][5] = 0.0;
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = 0.0;
        rJacobian[12][8] = -(mDt * (var_x118));
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x129 + var_x153));
        rJacobian[12][13] = -(mDt * (var_x131));
        rJacobian[12][14] = 0.0;
        ...
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = -(mDt * (-var_x154));
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = 0.0;
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = -(mDt * (var_x118));
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = -(mDt * (var_x128));
        rJacobian[13][13] = 1.0 - (mDt * (var_x141 + var_x153));
        ...
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = -(mDt * (var_x154 + var_x135 * var_x155 + var_x144 * var_x156));
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = 0.0;
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = -(mDt * (var_x118));
        rJacobian[14][11] = 0.0;
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = -(mDt * (var_x140));
        rJacobian[14][14] = 1.0 - (mDt * (var_x148 + var_x153));
        rJacobian[14][15] = -(mDt * (var_x149));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        ...
        rJacobian[15][2] = 0.0;
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = -(mDt * (var_x152 + var_x136 * var_x156 + var_x150 * var_x155));
        rJacobian[15][5] = 0.0;
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = 0.0;
        rJacobian[15][8] = 0.0;
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = -(mDt * (var_x118));
        rJacobian[15][12] = -(mDt * (var_x121));
        rJacobian[15][13] = 0.0;
        rJacobian[15][14] = -(mDt * (var_x147));
        rJacobian[15][15] = 1.0 - (mDt * (var_x151 + var_x153));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = 0.0;
        rJacobian[16][16] = 1.0 - (mDt * (-var_x158));
        rJacobian[16][17] = 0.0;
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        ...
        rJacobian[17][15] = 0.0;
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (var_x163 + var_x165));
        rJacobian[17][18] = -(mDt * (var_x160));
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        rJacobian[17][22] = 0.0;
        ...
        rJacobian[18][15] = 0.0;
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = -(mDt * (var_x164));
        rJacobian[18][18] = 1.0 - (mDt * (var_x163 + var_x169 + var_x170));
        rJacobian[18][19] = -(mDt * (var_x171));
        rJacobian[18][20] = -(mDt * (var_x172));
        rJacobian[18][21] = 0.0;
        rJacobian[18][22] = 0.0;
        rJacobian[18][23] = 0.0;
        rJacobian[18][24] = 0.0;
        ...
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = 0.0;
        rJacobian[19][18] = -(mDt * (var_x168));
        rJacobian[19][19] = 1.0 - (mDt * (var_x163 + var_x174));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = -(mDt * (var_x172));
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        rJacobian[19][24] = 0.0;
        rJacobian[19][25] = 0.0;
        ...
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x167));
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (var_x169 + var_x176));
        rJacobian[20][21] = -(mDt * (var_x160));
        rJacobian[20][22] = 0.0;
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[20][25] = 0.0;
        ...
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = -(mDt * (var_x173));
        rJacobian[21][20] = -(mDt * (var_x168));
        rJacobian[21][21] = 1.0 - (mDt * (var_x170 + var_x176));
        rJacobian[21][22] = -(mDt * (var_x177));
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[21][25] = 0.0;
        rJacobian[21][26] = 0.0;
        ...
        rJacobian[22][19] = 0.0;
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = -(mDt * (var_x167));
        rJacobian[22][22] = 1.0 - (mDt * (-0.089538000000000006 - var_x177));
        rJacobian[22][23] = 0.0;
        rJacobian[22][24] = 0.0;
        rJacobian[22][25] = 0.0;
        rJacobian[22][26] = 0.0;
        ...
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = 0.0;
        rJacobian[23][23] = 1.0 - (mDt * (var_x170 + var_x180));
        rJacobian[23][24] = -(mDt * (var_x171));
        rJacobian[23][25] = 0.0;
        rJacobian[23][26] = 0.0;
        rJacobian[23][27] = -(mDt * (var_x181));
        rJacobian[23][28] = 0.0;
        rJacobian[23][29] = 0.0;
        rJacobian[23][30] = 0.0;
        rJacobian[23][31] = 0.0;
        ...
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = -(mDt * (var_x179));
        rJacobian[24][24] = 1.0 - (mDt * (var_x165 + var_x174));
        rJacobian[24][25] = -(mDt * (var_x182));
        rJacobian[24][26] = 0.0;
        rJacobian[24][27] = 0.0;
        rJacobian[24][28] = -(mDt * (var_x181));
        rJacobian[24][29] = 0.0;
        rJacobian[24][30] = 0.0;
        rJacobian[24][31] = 0.0;
        rJacobian[24][32] = 0.0;
        ...
        rJacobian[25][22] = 0.0;
        rJacobian[25][23] = 0.0;
        rJacobian[25][24] = -(mDt * (var_x164));
        rJacobian[25][25] = 1.0 - (mDt * (var_x169 + var_x183));
        rJacobian[25][26] = -(mDt * (var_x184));
        rJacobian[25][27] = 0.0;
        rJacobian[25][28] = 0.0;
        rJacobian[25][29] = -(mDt * (var_x181));
        rJacobian[25][30] = 0.0;
        rJacobian[25][31] = 0.0;
        rJacobian[25][32] = 0.0;
        rJacobian[25][33] = 0.0;
        ...
        rJacobian[26][23] = 0.0;
        rJacobian[26][24] = 0.0;
        rJacobian[26][25] = -(mDt * (var_x168));
        rJacobian[26][26] = 1.0 - (mDt * (-var_x184 - var_x185));
        rJacobian[26][27] = 0.0;
        rJacobian[26][28] = 0.0;
        rJacobian[26][29] = 0.0;
        rJacobian[26][30] = -(mDt * (var_x181));
        rJacobian[26][31] = 0.0;
        rJacobian[26][32] = 0.0;
        rJacobian[26][33] = 0.0;
        rJacobian[26][34] = 0.0;
        ...
        rJacobian[27][21] = 0.0;
        rJacobian[27][22] = 0.0;
        rJacobian[27][23] = -(mDt * (var_x167));
        rJacobian[27][24] = 0.0;
        rJacobian[27][25] = 0.0;
        rJacobian[27][26] = 0.0;
        rJacobian[27][27] = 1.0 - (mDt * (var_x180 + var_x186));
        ...
        rJacobian[28][22] = 0.0;
        rJacobian[28][23] = 0.0;
        rJacobian[28][24] = -(mDt * (var_x173));
        rJacobian[28][25] = 0.0;
        rJacobian[28][26] = 0.0;
        rJacobian[28][27] = -(mDt * (var_x179));
        rJacobian[28][28] = 1.0 - (mDt * (var_x165 + var_x170 + var_x186));
        rJacobian[28][29] = -(mDt * (var_x171));
        rJacobian[28][30] = 0.0;
        rJacobian[28][31] = 0.0;
        rJacobian[28][32] = 0.0;
        rJacobian[28][33] = 0.0;
        ...
        rJacobian[29][23] = 0.0;
        rJacobian[29][24] = 0.0;
        rJacobian[29][25] = -(mDt * (var_x175));
        rJacobian[29][26] = 0.0;
        rJacobian[29][27] = 0.0;
        rJacobian[29][28] = -(mDt * (var_x164));
        rJacobian[29][29] = 1.0 - (mDt * (var_x169 + var_x174 + var_x186));
        rJacobian[29][30] = -(mDt * (var_x182));
        rJacobian[29][31] = 0.0;
        rJacobian[29][32] = 0.0;
        rJacobian[29][33] = 0.0;
        rJacobian[29][34] = 0.0;
        ...
        rJacobian[30][24] = 0.0;
        rJacobian[30][25] = 0.0;
        rJacobian[30][26] = -(mDt * (var_x185));
        rJacobian[30][27] = 0.0;
        rJacobian[30][28] = 0.0;
        rJacobian[30][29] = -(mDt * (var_x168));
        rJacobian[30][30] = 1.0 - (mDt * (var_x183 + var_x186));
        rJacobian[30][31] = 0.0;
        rJacobian[30][32] = 0.0;
        rJacobian[30][33] = 0.0;
        rJacobian[30][34] = 0.0;
        ...
        rJacobian[31][29] = 0.0;
        rJacobian[31][30] = 0.0;
        rJacobian[31][31] = 1.0 - (mDt * (-var_x178 - var_x187));
        rJacobian[31][32] = -(mDt * (var_x188));
        rJacobian[31][33] = 0.0;
        rJacobian[31][34] = 0.0;
        rJacobian[31][35] = 0.0;
        rJacobian[31][36] = 0.0;
        ...
        rJacobian[32][29] = 0.0;
        rJacobian[32][30] = 0.0;
        rJacobian[32][31] = -(mDt * (var_x187));
        rJacobian[32][32] = 1.0 - (mDt * (-var_x188));
        rJacobian[32][33] = 0.0;
        rJacobian[32][34] = 0.0;
        rJacobian[32][35] = 0.0;
        rJacobian[32][36] = 0.0;
        rJacobian[33][0] = -(mDt * (0.22869271460496704 * var_x193 * var_x208 + 6.2357214041141957e-6 * var_x193 * var_x204));
        rJacobian[33][1] = -(mDt * (-0.0123 * var_x203 * var_x205 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 115588.83089076335 * var_x194 * var_x198 * var_x199 * var_x206 / pow(var_x200, 2)));
        rJacobian[33][2] = 0.0;
        rJacobian[33][3] = 0.0;
        rJacobian[33][4] = -(mDt * (-var_x206 * var_x209 * var_x45 * var_x68 * var_x69));
        rJacobian[33][5] = -(mDt * (-4.6767910530856466e-10 * var_x204 * var_x210 - 1.7151953595372529e-5 * var_x208 * var_x210));
        rJacobian[33][6] = 0.0;
        rJacobian[33][7] = 0.0;
        rJacobian[33][8] = 0.0;
        rJacobian[33][9] = 0.0;
        rJacobian[33][10] = 0.0;
        rJacobian[33][11] = 0.0;
        rJacobian[33][12] = -(mDt * (var_x211));
        rJacobian[33][13] = 0.0;
        rJacobian[33][14] = 0.0;
        rJacobian[33][15] = -(mDt * (var_x211));
        rJacobian[33][16] = 0.0;
        rJacobian[33][17] = 0.0;
        rJacobian[33][18] = 0.0;
        rJacobian[33][19] = 0.0;
        ...
        rJacobian[33][31] = 0.0;
        rJacobian[33][32] = 0.0;
        rJacobian[33][33] = 1.0 - (mDt * (-var_x206));
        rJacobian[33][34] = 0.0;
        rJacobian[33][35] = 0.0;
        rJacobian[33][36] = 0.0;
        rJacobian[34][0] = 0.0;
        rJacobian[34][1] = 0.0;
        rJacobian[34][2] = 0.0;
        rJacobian[34][3] = -(mDt * (-2.774905235513489e-12 * var_x212 * var_x213 * var_x216 * var_x217 / pow(var_x214, 2)));
        rJacobian[34][4] = 0.0;
        rJacobian[34][5] = 0.0;
        rJacobian[34][6] = -(mDt * (var_x99));
        rJacobian[34][7] = 0.0;
        rJacobian[34][8] = 0.0;
        rJacobian[34][9] = 0.0;
        rJacobian[34][10] = 0.0;
        ...
        rJacobian[34][29] = 0.0;
        rJacobian[34][30] = 0.0;
        rJacobian[34][31] = -(mDt * (var_x219));
        rJacobian[34][32] = -(mDt * (var_x219));
        rJacobian[34][33] = 0.0;
        rJacobian[34][34] = 1.0 - (mDt * (var_x106 + 212.7914217252065 * var_x231 - 4.5488726691040119e-6 * var_x93 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__Vm)) - 0.0008405525584213936 * var_x222 * var_x230 + 0.00020047178518350236 * var_x230 * var_x232 * var_x233 - 3.0245559326093954e-5 * var_x222 * var_x232 * (-var_x225 * (1.0539507884845836 * var_x226 * var_x93 + 1.6494527242011876 * var_x227 * var_x93) + 6.4981759387274964 * var_x233 * var_x93 - 13.737871029257827 * var_x223 * var_x228 * var_x93 / pow(var_x224, 2)) / pow((var_x222 + 0.98039215686274506 * var_x229), 2) - 0.0016481422714144972 * var_x93 * mParameters[2] * var_chaste_interface__IKr_xr_gate__xr / (1.0 + exp(0.64935064935064934 + 0.064935064935064929 * var_chaste_interface__membrane__Vm)) - 0.00081995078002871237 * var_x93 * pow(var_chaste_interface__Ito1_a_gate__a, 3) * var_chaste_interface__Ito1_i1f_gate__i1f * var_chaste_interface__Ito1_i1s_gate__i1s * exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm)));
        rJacobian[34][35] = -(mDt * (2.3077868741502807e-5 * var_x236 + 3.900466760223035 * var_x231 - 8.8761033621164642e-6 * var_x237));
        rJacobian[34][36] = 0.0;
        rJacobian[35][0] = 0.0;
        rJacobian[35][1] = 0.0;
        rJacobian[35][2] = 0.0;
        rJacobian[35][3] = -(mDt * (4.2607661459024858e-11 * var_x58 + 1828.5197274709456 * var_x55 - 5.784463221115469e-12 * var_x59));
        rJacobian[35][4] = 0.0;
        rJacobian[35][5] = 0.0;
        rJacobian[35][6] = -(mDt * (var_x105));
        rJacobian[35][7] = 0.0;
        rJacobian[35][8] = 0.0;
        rJacobian[35][9] = 0.0;
        rJacobian[35][10] = 0.0;
        ...
        rJacobian[35][33] = 0.0;
        rJacobian[35][34] = 0.0;
        rJacobian[35][35] = 1.0 - (mDt * (-0.14749262536873156 + var_x107 + 2.4740119415402899e-16 * var_x63 + 1.3314155043174696e-5 * var_x237 - 3.4616803112254212e-5 * var_x236 - 0.0035983988805915112 * var_x62 - 7.1319396379664657e-10 * var_x110 * var_chaste_interface__membrane__Vm / (-1.0 + var_x110) - 1.0712924764194231e-5 * var_x100 * pow(var_chaste_interface__INaL_mL_gate__mL, 3) * var_chaste_interface__INaL_hL_gate__hL - 0.0016481422714144972 * var_x100 * pow(var_chaste_interface__INa_m_gate__m, 3) * mParameters[1] * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j));
        ...
        rJacobian[36][36] = 1.0 - (mDt * (-5.0 + 8.386900481821583e-15 * var_x90 - 0.030496430513013057 * var_x89));
    }
