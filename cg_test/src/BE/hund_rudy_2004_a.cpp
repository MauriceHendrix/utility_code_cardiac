...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        const double var_x0 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x1 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x2 = pow(var_x1, (-2));
        const double var_x3 = 1.0 + 0.00011900000000000002 / pow(var_x0, 2) + 3.5000000000000004e-5 * var_x2;
        const double var_x4 = 1 / var_x3;
        const double var_x5 = 1.768721357868101e-6 / var_x1;
        const double var_x6 = 1.0 - var_chaste_interface__Irel__CaMKtrap;
        const double var_x7 = 1 / var_chaste_interface__Ca__Ca_ss;
        const double var_x8 = 1.0 + 0.0015 * var_x7;
        const double var_x9 = 1 / var_x8;
        const double var_x10 = 0.050000000000000003 * var_x9;
        const double var_x11 = var_x10 * var_x6 + var_chaste_interface__Irel__CaMKtrap;
        const double var_x12 = 0.14999999999999999 + var_x11;
        const double var_x13 = 1 / var_x12;
        const double var_x14 = var_x11 * var_x13;
        const double var_x15 = 0.00092000000000000003 - 0.00017000000000000001 * var_x14 + var_chaste_interface__Ca__Ca_i;
        const double var_x16 = 1 / var_x15;
        const double var_x17 = 1.0 + 0.75 * var_x14;
        const double var_x18 = var_x16 * var_x17;
        const double var_x19 = 0.00035514705882352943 * var_x18;
        const double var_x20 = 0.00035514705882352943 * var_chaste_interface__Ca__Ca_i;
        const double var_x21 = var_x17 / pow(var_x15, 2);
        const double var_x22 = var_x20 * var_x21;
        const double var_x23 = 0.074871767015599999 * var_chaste_interface__cell__V;
        const double var_x24 = exp(var_x23);
        const double var_x25 = 8.8666719524733664e-8 * var_chaste_interface__cell__V / (-1.0 + var_x24);
        const double var_x26 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x27 = exp(0.01310255922773 * var_chaste_interface__cell__V);
        const double var_x28 = exp(-0.024333324280070002 * var_chaste_interface__cell__V);
        const double var_x29 = 1.8 * var_x26 * var_x27 - 4116000.0 * var_x28 * var_chaste_interface__Ca__Ca_i;
        const double var_x30 = 1 / (1.0 + 0.27000000000000002 * var_x28);
        const double var_x31 = 1.0 + 6.9444444444444451e-9 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x32 = var_x30 / var_x31;
        const double var_x33 = var_x29 * var_x32;
        const double var_x34 = var_x33 / pow((0.0020299076937277489 + 1.2903323313862536e-6 * var_x26 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x35 = 1 / (13227.9606 + 8.4084932990912282 * var_x26 + 6516533.0625 * var_chaste_interface__Ca__Ca_i);
        const double var_x36 = var_x32 * var_x35;
        const double var_x37 = var_x28 * var_x36;
        const double var_x38 = var_x29 * var_x30 * var_x35 / (pow(var_x31, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x39 = pow(var_chaste_interface__Ca__Ca_ss, (-2));
        const double var_x40 = var_x39 * var_x6 / pow(var_x8, 2);
        const double var_x41 = var_x13 * var_x40;
        const double var_x42 = var_x11 / pow(var_x12, 2);
        const double var_x43 = var_x40 * var_x42;
        const double var_x44 = 5.6250000000000005e-5 * var_x41 - 5.6250000000000005e-5 * var_x43;
        const double var_x45 = var_x16 * var_x20;
        const double var_x46 = 1.2750000000000002e-8 * var_x41 - 1.2750000000000002e-8 * var_x43;
        const double var_x47 = 1 - var_x10;
        const double var_x48 = var_x13 * var_x47;
        const double var_x49 = var_x42 * (-1 + var_x10);
        ...
        const double var_x53 = var_x27 * var_x36 * var_x52;
        const double var_x54 = var_x34 * var_x52;
        const double var_x55 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_jsr;
        const double var_x56 = pow(var_x55, (-2));
        const double var_x57 = 1 / (1.0 + 8.0 * var_x56);
        const double var_x58 = exp(-1.1230765052339999 + var_x23);
        const double var_x59 = -0.61380000000000001 + 1.0 * var_x58 * var_chaste_interface__Ca__Ca_ss;
        const double var_x60 = -1.0 + var_x58;
        const double var_x61 = 1 / var_x60;
        const double var_x62 = -15.0 + var_chaste_interface__cell__V;
        const double var_x63 = var_x61 * var_x62 * mParameters[0];
        const double var_x64 = var_x59 * var_x63;
        const double var_x65 = exp(2.6000000000000001 + 0.70217303721661617 * var_x64);
        const double var_x66 = 1.0 + var_x65;
        const double var_x67 = 1 / var_x66;
        const double var_x68 = var_x67 * var_chaste_interface__Irel__ro;
        const double var_x69 = var_x68 * var_chaste_interface__Irel__ri;
        const double var_x70 = 3000.0 * var_x69;
        ...
        const double var_x73 = var_x58 * var_x63;
        const double var_x74 = var_x65 * var_x72 * var_x73 * var_chaste_interface__Irel__ro / pow(var_x66, 2);
        const double var_x75 = var_x68 * var_x71;
        const double var_x76 = 3000.0 * var_x57;
        const double var_x77 = var_x67 * var_x72;
        const double var_x78 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x79 = var_x21 * var_x78;
        const double var_x80 = var_x16 * var_x78;
        ...
        const double var_x85 = 719.99999999999989 * var_x69;
        ...
        const double var_x89 = var_x64 * var_x87;
        const double var_x90 = var_x64 * var_x86 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2;
        ...
        const double var_x116 = 10.0 * var_x14;
        const double var_x117 = 1 / (0.5 + var_x115 + var_x116);
        ...
        const double var_x121 = 0.00075000000000000002 * var_x43 - 0.00075000000000000002 * var_x41;
        const double var_x122 = 0.01 * (0.14999999999999999 - var_chaste_interface__ICaL__fca + 0.55000000000000004 * var_x115 + 0.29999999999999999 / (1.0 - 70.217303721661608 * var_x89)) / pow((0.050000000000000003 + var_x14 + 0.10000000000000001 * var_x115), 2);
        const double var_x123 = -10.0 * var_x48 - 10.0 * var_x49;
        ...
        const double var_x128 = pow((0.0028483007663294996 + var_x119), (-2));
        const double var_x129 = 0.0028483007663294996 * var_x127 * var_x128;
        const double var_x130 = 0.2925720988402567 * var_x124 * (1 / (1.0 - 351.08651860830804 * var_x89) - var_chaste_interface__ICaL__fca2) / (pow(var_x125, 2) * pow((0.41666666666666669 + var_x126), 2));
        const double var_x131 = 0.0025000000000000005 * var_x9;
        ...
        const double var_x145 = (1 / var_x144 - var_chaste_interface__Irel__ri) / pow((0.29999999999999999 + var_x14 + 0.10000000000000001 * var_x142), 2);
        ...
        const double var_x155 = pow(var_x60, 2);
        const double var_x156 = pow(var_x59, (-2));
        ...
        const double var_x185 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x101);
        const double var_x186 = var_x185 + 0.49124000000000001 * var_x184;
        ...
        const double var_x192 = 1 / (var_x26 * pow((0.01 + 1 / var_x52), 2) * (1.0 + 0.1245 * exp(-0.00374358835078 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x96)));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (var_x4 * (-0.14705882352941174 + var_x22 - var_x19 - var_x5 + 3.8450464301480458e-12 * var_x38 - 4.2483225407660435e-11 * var_x34 - 1139.4871996672337 * var_x37 - var_x24 * var_x25 + 1.768721357868101e-6 * var_x2 * var_chaste_interface__Ca__Ca_i) + (0.00023800000000000004 / pow(var_x0, 3) + 7.0000000000000007e-5 / pow(var_x1, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x19 * var_chaste_interface__Ca__Ca_i - var_x25 * (-0.61380000000000001 + var_x24 * var_chaste_interface__Ca__Ca_i) - var_x5 * var_chaste_interface__Ca__Ca_i + 0.00027684334297065928 * var_x33 * var_x35) / pow(var_x3, 2)));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (2.3676470588235295e-5 * var_x4));
        rJacobian[0][3] = -(mDt * (var_x4 * (0.14705882352941174 - var_x22 * var_x46 - var_x44 * var_x45)));
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        rJacobian[0][7] = -(mDt * (var_x4 * (-var_x22 * var_x51 - var_x45 * var_x50)));
        rJacobian[0][8] = 0.0;
        rJacobian[0][9] = 0.0;
        rJacobian[0][10] = 0.0;
        rJacobian[0][11] = 0.0;
        rJacobian[0][12] = -(mDt * (var_x4 * (0.0014949540520415602 * var_x53 - 1.6445243785522266e-16 * var_x54)));
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x57 * (-0.0083333333333333332 - var_x70) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x70 * var_x71) / (pow(var_x55, 3) * pow((0.125 + var_x56), 2))));
        rJacobian[1][2] = -(mDt * (0.0083333333333333332 * var_x57));
        rJacobian[1][3] = -(mDt * (var_x57 * (var_x70 + 2106.5191116498486 * var_x74)));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[1][7] = 0.0;
        ...
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[2][0] = -(mDt * (-var_x79 + 0.0043750000000000004 * var_x18));
        rJacobian[2][1] = -(mDt * (0.00072463768115942019));
        rJacobian[2][2] = 1.0 - (mDt * (-0.0010163043478260869));
        rJacobian[2][3] = -(mDt * (var_x44 * var_x80 + var_x46 * var_x79));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = -(mDt * (var_x50 * var_x80 + var_x51 * var_x79));
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        ...
        rJacobian[6][6] = 1.0 - (mDt * (var_x127 * (-1 + 0.0028483007663294996 * var_x128 * var_x59 * var_x61 * var_x62 * var_x86 * mParameters[0] * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca) - var_x130 * var_x93));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = -(mDt * (3.7500000000000005e-6 * var_x11 * var_x40 + 1.8750000000000003e-7 * var_x39 * pow(var_x6, 2) / pow(var_x8, 3)));
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * (-0.00068000000000000005 - var_x11 * var_x131 + var_x131 * var_x47 * var_x6));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = -(mDt * (var_x161 * var_x172 * var_x58 / pow(var_x59, 3) - 0.00020267697647483301 * var_x165 * var_x166 * var_x168 * var_x170 * var_x7 * (1.8999999999999999 * var_x167 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x166, 2))));
        rJacobian[9][4] = 0.0;
        ...
        rJacobian[10][1] = 0.0;
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = -(mDt * (0.1502 * var_x39 / pow((1.0 + 0.1502 * var_x7), 2)));
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x114 + 4.9335731356566794e-16 * var_x54 - 1.7874450622236046e-6 * var_x192 - 0.0044848621561246801 * var_x53 - 1.068185898837083e-5 * var_x107 * pow(var_chaste_interface__INal__mL, 3) * var_chaste_interface__INal__hL - 0.013557744100624516 * var_x107 * pow(var_chaste_interface__INa__m, 3) * mParameters[1] * var_chaste_interface__INa__H * var_chaste_interface__INa__J));
    }
