...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        rJacobian[5][5] = 1.0 -(mDt * (5.0371257222730904e-7 * var_x53 - 9.0551084895961074e-7 * var_x50 - 1.823319832565245e-7 * var_x49 - 0.00080594011556369446 * var_x52 - 4.5479750756676942e-5 * var_x50 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.40771219240135098 * var_x50 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0.00053729341037579627 * var_x52 - 3.3580838148487267e-7 * var_x53 - 0.00021150735062926387 * var_x54));
        rJacobian[6][6] = 1.0 -(mDt * (-0.0070502450209754628 * var_x54 - 7.3173394969065143e-5 * var_x55 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 7.0879642315114355e-5 * var_x55 / (1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V)) - 4.5587787568311439e-5 * var_x55 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 0.00020295932821508516 * var_x55 / (1.0 + exp(7.5440000000000005 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.00025554140647880875 * var_x55 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.00028664102046376645 * var_x55 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2));
    }
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[5] = (var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + ((1.0 / (80.0 + 80.0 * exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V) + 1400.0 / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V)) + 1400.0 * exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V) / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-1 / (80.0 + 1400.0 / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V)))) * mDt));
        rY[14] = (var_chaste_interface__transient_outward_current_r_gate__r + ((1.0 / (7.2999999999999998 + 10.449999999999999 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) + 7.2999999999999998 * exp(1.5384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V) + 10.449999999999999 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) * exp(1.5384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (7.2999999999999998 + 10.449999999999999 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[13] = (var_chaste_interface__transient_outward_current_s_gate__s + ((1.0 / (42.0 + 5.0 / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 42.0 * exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__V) + 85.0 * exp(-1.953125 * pow((1 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2.0)) + 5.0 * exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__V) / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 * pow((1 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2.0)) * exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (42.0 + 5.0 / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 * pow((1 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
