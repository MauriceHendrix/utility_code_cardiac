...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x35 = mParameters[5] / (1.0 + 0.10000000000000001 * var_x34);
        ...
        const double var_x48 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (0.0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        const double var_x49 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x50 = var_x49 / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x51 = var_x49 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.0070502450209754628 * var_x48 - 7.3173394969065143e-5 * var_x47 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 7.0879642315114355e-5 * var_x47 / (1.0 + exp(0.29411764705882354 - 0.058823529411764705 * var_chaste_interface__membrane__V)) - 4.5587787568311439e-5 * var_x47 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) - 0.00020295932821508516 * var_x47 / (1.0 + exp(7.5440000000000005 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.00025554140647880875 * var_x47 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.0031224512033090025 * var_x47 * mParameters[4] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2));
        rJacobian[5][6] = -(mDt * (0.00053729341037579627 * var_x50 - 3.3580838148487267e-7 * var_x51 - 0.00021150735062926387 * var_x48));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = -(mDt * (0.00020846623418995967 * var_x36));
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (5.0371257222730904e-7 * var_x51 - 1.823319832565245e-10 * var_x38 - 9.0551084895961074e-7 * var_x52 - 0.00080594011556369446 * var_x50 - 4.5479750756676942e-5 * var_x52 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 0.0031224512033090025 * var_x52 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    std::vector<double> Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        ...
        dqs[1] = var_L_type_Ca_current__i_CaL;
        dqs[2] = var_fast_sodium_current__i_Na;
        dqs[3] = var_rapid_time_dependent_potassium_current__i_Kr;
        dqs[4] = var_sodium_calcium_exchanger_current__i_NaCa;
        return dqs;
    }
