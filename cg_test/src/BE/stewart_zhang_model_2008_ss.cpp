...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[14] = (var_chaste_interface__transient_outward_current_r_gate__r + ((1.0 / (7.2999999999999998 + 10.449999999999999 * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V) + 7.2999999999999998 * exp(1.5384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V) + 10.449999999999999 * exp(1.5384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V) * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (7.2999999999999998 + 10.449999999999999 * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V))) * mDt));
        rY[13] = (var_chaste_interface__transient_outward_current_s_gate__s + ((1.0 / (42.0 + 5.0 / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 42.0 * exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__V) + 85.0 * exp(-1.953125 - 0.15625 * var_chaste_interface__membrane__V - 0.0031250000000000002 * pow(var_chaste_interface__membrane__V, 2)) + 5.0 * exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__V) / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(2.0769230769230771 + 0.076923076923076927 * var_chaste_interface__membrane__V) * exp(-1.953125 - 0.15625 * var_chaste_interface__membrane__V - 0.0031250000000000002 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-1 / (42.0 + 5.0 / (1.0 + exp(-8.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-1.953125 - 0.15625 * var_chaste_interface__membrane__V - 0.0031250000000000002 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
