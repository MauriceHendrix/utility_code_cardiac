...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x10 = -0.026190000000000001 + 0.5 * var_x9 + 0.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x11 = 1 / var_x10;
        const double var_x12 = 1.0 + 0.00080000000000000004 * var_x11;
        const double var_x13 = 1 / var_x12;
        const double var_x14 = 1.0 - var_chaste_interface__SR_calcium_pump_y_gate__y;
        const double var_x15 = 1.0 + 0.10000000000000001 * var_x4;
        const double var_x16 = var_x13 * var_x14 * var_x7 / pow(var_x15, 2);
        const double var_x17 = 1.0 + 0.080000000000000002 / var_chaste_interface__Ca_concentrations_in_SR__Caup;
        const double var_x18 = var_chaste_interface__SR_calcium_pump_y_gate__y / (pow(var_x17, 2) * pow(var_chaste_interface__Ca_concentrations_in_SR__Caup, 2));
        const double var_x19 = 1 / var_x17;
        const double var_x20 = 1 / var_x15;
        const double var_x21 = var_x13 * var_x20;
        const double var_x22 = -0.052380000000000003 + var_x9 + var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x23 = pow(var_x22, 2);
        const double var_x24 = (-0.047620000000000003 + var_chaste_interface__internal_ion_concentrations__Ca_Total) / var_x9;
        const double var_x25 = 0.5 * var_x24;
        const double var_x26 = (-0.5 - var_x25) / var_x23;
        const double var_x27 = var_x26 / pow(var_x12, 2);
        const double var_x28 = var_x20 * var_x27;
        const double var_x29 = var_x14 * var_x28;
        const double var_x30 = 1 / var_x5;
        const double var_x31 = var_x30 / pow((0.22703754152993499 + var_x2), 2);
        const double var_x32 = var_x1 * var_x31 * pow(var_chaste_interface__internal_ion_concentrations__Ki, 0.12000000000000011);
        const double var_x33 = var_x32 * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        const double var_x34 = var_x0 * var_x2 * var_x31;
        const double var_x35 = var_x34 * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        const double var_x36 = exp(-0.030696857687474322 * var_chaste_interface__membrane__Vm);
        const double var_x37 = 1 / (1.0 + 14.894617648090152 * pow(1 / var_x36, 1.0600000000000001));
        const double var_x38 = var_x3 * var_x30;
        const double var_x39 = 0.092592592592592587 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total;
        const double var_x40 = sqrt(pow((1 - var_x39), 2) + 0.027434842249657067 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total);
        const double var_x41 = (-0.078875171467764058 + 0.0085733882030178329 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total) / var_x40;
        const double var_x42 = var_chaste_interface__membrane__Vm == 0.0;
        const double var_x43 = 0.074870384603595908 * var_chaste_interface__membrane__Vm;
        const double var_x44 = exp(-var_x43);
        const double var_x45 = var_x43 / (1.0 - var_x44);
        const double var_x46 = ((var_x42) ? (-1.8) : (var_x45 * (var_x10 - 1.8 * var_x44)));
        const double var_x47 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x48 = var_x47 * (var_x10 - 0.020279999999999996 * var_x46);
        const double var_x49 = -var_x48;
        const double var_x50 = 0.14102711999999998 * var_x46;
        const double var_x51 = 0.5 + var_x25;
        const double var_x52 = ((var_x42) ? (0) : (var_x45 * var_x51));
        const double var_x53 = (3.4769999999999999 + 3.4769999999999999 * var_x24 - 0.14102711999999998 * var_x52) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x54 = 6.9539999999999997 * var_x10 * (1.0 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL);
        const double var_x55 = var_x50 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x56 = var_x51 * (6.9539999999999997 - var_x47);
        const double var_x57 = 0.01 * var_chaste_interface__membrane__Vm;
        const double var_x58 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
        const double var_x59 = 1 / (2.0 * exp(-var_x57) + 0.0018 * exp(-var_x58));
        const double var_x60 = -1.0 * var_x59;
        const double var_x61 = 11.0 * exp(var_x57) + 2200000.0 * exp(var_x58);
        const double var_x62 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
        const double var_x63 = 1 / (480.0 * exp(0.14285714285714285 * var_chaste_interface__membrane__Vm) + 2.2000000000000002 * exp(var_x62));
        const double var_x64 = 1.0 * var_x63;
        const double var_x65 = 1.5 * exp(-var_x62) + 0.27000000000000002 * exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
        const double var_x66 = 1.0 / var_x65;
        const double var_x67 = -0.040000000000000001 + 0.040000000000000001 / (1.0 + 0.25 * var_x59 * var_x61 * var_x63 * var_x65);
        const double var_x68 = 780.0 * var_x9;
        const double var_x69 = 780.0 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x70 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
        const double var_x71 = -0.038879999999999998 * var_x70;
        const double var_x72 = 780.0 * var_x24;
        const double var_x73 = -19.5 * var_x9 - 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x74 = 0.0038999999999999998 * exp(-0.86212130841993795);
        const double var_x75 = 1.0 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB;
        const double var_x76 = var_x46 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x77 = var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa;
        const double var_x78 = pow(var_chaste_interface__ATP_production__ATPi, (-3));
        const double var_x79 = var_x77 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL / (pow((0.36443148688046656 + var_x78), 2) * pow(var_chaste_interface__ATP_production__ATPi, 4));
        const double var_x80 = 11.08600583090379 * var_x76 * var_x79;
        const double var_x81 = -1 + var_x39 + var_x40;
        const double var_x82 = var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / (1.0 + 2.7439999999999993 * var_x78);
        const double var_x83 = var_x82 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x84 = 10.139999999999999 * var_x83;
        const double var_x85 = var_x76 * var_x84;
        const double var_x86 = var_x77 * var_x82;
        const double var_x87 = 10.139999999999999 * var_x76 * var_x86;
        const double var_x88 = 70000.0 * var_x23;
        const double var_x89 = pow(var_x81, 2);
        const double var_x90 = -0.010993320000000001 * var_x89;
        const double var_x91 = var_x77 * var_x84;
        const double var_x92 = var_x46 * var_x91;
        const double var_x93 = 70000.0 * var_x22 * (2 + 2 * var_x24);
        const double var_x94 = var_x52 * var_x91;
        const double var_x95 = 1.0 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x40);
        const double var_x96 = -var_x85;
        const double var_x97 = 0.0056432648230274225 * var_x46;
        const double var_x98 = -var_x83 * var_x97;
        const double var_x99 = -0.069398700000000008 + 1.3650000000000002 * var_x9 + 1.3650000000000002 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x100 = var_x77 * var_x83;
        const double var_x101 = pow(var_chaste_interface__internal_ion_concentrations__Nai, 3);
        const double var_x102 = 1 / var_x101;
        const double var_x103 = exp(0.011979261536575346 * var_chaste_interface__membrane__Vm);
        const double var_x104 = -17.978260869565219 + 362.31884057971018 * var_x9 + 362.31884057971018 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x105 = var_x102 * var_x104;
        const double var_x106 = var_x103 / pow((0.0014927113702623907 + var_x105), 2);
        const double var_x107 = var_x102 * var_x106 * (362.31884057971018 + 362.31884057971018 * var_x24);
        const double var_x108 = var_x107 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        const double var_x109 = var_x104 * var_x106 / pow(var_chaste_interface__internal_ion_concentrations__Nai, 4);
        const double var_x110 = var_x109 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        const double var_x111 = exp(-0.025455930765222609 * var_chaste_interface__membrane__Vm);
        const double var_x112 = var_x103 / (1.0 + 669.921875 * var_x105);
        const double var_x113 = 1 / var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x114 = log(5.4000000000000004 * var_x113);
        const double var_x115 = 0.037435192301797954 * var_chaste_interface__membrane__Vm;
        const double var_x116 = exp(-var_x115);
        const double var_x117 = 1 / (1.0 - var_x116);
        const double var_x118 = var_x115 * var_x117;
        const double var_x119 = ((var_x42) ? (var_chaste_interface__internal_ion_concentrations__Ki) : (var_x118 * (-5.4000000000000004 * var_x116 + var_chaste_interface__internal_ion_concentrations__Ki)));
        const double var_x120 = 4.1195833208100184e-6 * var_x119;
        const double var_x121 = -var_x120 * var_x83;
        const double var_x122 = 1.0 + 1.3823999999999997e-8 / pow(var_x22, 3);
        const double var_x123 = 1.9700124473113906e-15 * (-3 - 3 * var_x24) / (pow(var_x122, 2) * pow(var_x22, 4));
        const double var_x124 = var_x117 * var_chaste_interface__membrane__Vm;
        const double var_x125 = (3.0 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-0.23076923076923078 - 0.076923076923076927 * var_chaste_interface__membrane__Vm));
        const double var_x126 = ((var_x42) ? (1) : (var_x118));
        const double var_x127 = 1.4250668745018745e-7 / var_x122;
        const double var_x128 = 0.005235052487551543 * var_x114 - 0.00019597519658149775 * var_chaste_interface__membrane__Vm;
        const double var_x129 = exp(-2.1000000000000001 + 0.029999999999999999 * var_chaste_interface__membrane__Vm - 0.80138495771956131 * var_x114);
        const double var_x130 = 1.0 + var_x129;
        const double var_x131 = pow(var_x130, (-4));
        const double var_x132 = exp(0.47999999999999998 + 1.282215932351298 * var_x114 - 0.048000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x133 = pow(var_x132, 4);
        const double var_x134 = exp(-2.4319999999999999 + 0.064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350641 * var_x114);
        const double var_x135 = 1.0 + var_x134;
        const double var_x136 = pow(var_x135, 4);
        const double var_x137 = 1.0 * var_x136;
        const double var_x138 = exp(-2.1000000000000001 + 0.014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978065 * var_x114);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = exp(-0.35000000000000003 + 0.035000000000000003 * var_chaste_interface__membrane__Vm - 0.93494911733948827 * var_x114);
        const double var_x141 = var_x140 / var_x139;
        const double var_x142 = var_x132 / var_x130;
        const double var_x143 = var_x135 * var_x142;
        const double var_x144 = var_x143 + 0.25 * var_x141;
        const double var_x145 = pow(var_x144, (-5));
        const double var_x146 = var_x113 * var_x141;
        const double var_x147 = pow(var_x139, (-2));
        const double var_x148 = var_x113 * var_x147;
        const double var_x149 = var_x138 * var_x140 * var_x148;
        const double var_x150 = var_x113 * var_x143;
        const double var_x151 = 6.8384849725402566 * var_x134;
        const double var_x152 = var_x113 * var_x142;
        const double var_x153 = 3.2055398308782452 * var_x129;
        const double var_x154 = var_x113 * var_x153;
        const double var_x155 = pow(var_x130, (-2));
        const double var_x156 = var_x135 * var_x155;
        const double var_x157 = var_x132 * var_x156;
        const double var_x158 = var_x145 * (0.40069247885978065 * var_x149 + 5.1288637294051922 * var_x150 - 0.93494911733948827 * var_x146 + var_x154 * var_x157 - var_x151 * var_x152);
        const double var_x159 = var_x131 * var_x133 * var_x137 * var_x158;
        const double var_x160 = pow(var_x144, (-4));
        const double var_x161 = var_x131 * var_x133 * var_x160;
        const double var_x162 = var_x113 * var_x161;
        const double var_x163 = 5.1288637294051922 * var_x136;
        const double var_x164 = pow(var_x135, 3);
        const double var_x165 = var_x151 * var_x164;
        const double var_x166 = var_x133 * var_x136 * var_x160 / pow(var_x130, 5);
        const double var_x167 = pow(var_x135, 2);
        const double var_x168 = pow(var_x132, 2);
        const double var_x169 = pow(var_x140, 2);
        const double var_x170 = 0.125 * var_x147;
        const double var_x171 = pow(var_x130, (-3));
        const double var_x172 = pow(var_x132, 3);
        const double var_x173 = var_x171 * var_x172;
        const double var_x174 = var_x164 * var_x173;
        const double var_x175 = var_x141 * var_x174;
        const double var_x176 = var_x175 * (0.30051935914483546 * var_x149 + 3.8466477970538944 * var_x150 - 0.70121183800461617 * var_x146 - 5.1288637294051922 * var_x134 * var_x152 + 2.4041548731586837 * var_x113 * var_x129 * var_x157);
        const double var_x177 = var_x160 * var_x168 * var_x169;
        const double var_x178 = var_x167 * var_x177;
        const double var_x179 = var_x155 * var_x178;
        const double var_x180 = 1 / (0.75 * var_x141 + 3.0 * var_x143);
        const double var_x181 = 2.0 * var_x180;
        const double var_x182 = pow(var_x144, (-3));
        const double var_x183 = var_x146 * var_x180 * var_x182;
        const double var_x184 = 0.00037051738737048736 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x185 = pow(var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1, 2);
        const double var_x186 = var_x185 * (0.10000000000000001 + 0.90000000000000002 * var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2);
        const double var_x187 = var_x137 * var_x161;
        const double var_x188 = var_x187 + var_x170 * var_x179 + var_x175 * var_x181 * var_x182;
        const double var_x189 = var_x113 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x190 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 3) * var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x191 = ((var_x42) ? (-140.0) : (var_x118 * (-140.0 * var_x116 + var_chaste_interface__internal_ion_concentrations__Nai)));
        const double var_x192 = 2.0880079845201463e-7 * var_x191;
        const double var_x193 = -var_x192 * var_x83;
        const double var_x194 = ((var_x42) ? (0) : (var_x118));
        const double var_x195 = 0.0037051738737048732 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x196 = 1.0 + 0.0014927113702623907 * var_x101;
        const double var_x197 = 1.0 + 0.0013799999999999999 * var_x11 * var_x196;
        const double var_x198 = pow(var_x197, (-2));
        const double var_x199 = exp(-0.0025000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x200 = exp(-0.125 * var_chaste_interface__membrane__Vm);
        const double var_x201 = 1 / (5.0 * var_x199 + 0.0001027 * var_x200);
        const double var_x202 = -1.0 * var_x201;
        const double var_x203 = exp(0.00125 * var_chaste_interface__membrane__Vm);
        const double var_x204 = 1300.0 * exp(0.050000000000000003 * var_chaste_interface__membrane__Vm) + 0.040000000000000001 * var_x203;
        const double var_x205 = 1.25 / var_x199;
        const double var_x206 = 1 / (26.0 * exp(0.058823529411764705 * var_chaste_interface__membrane__Vm) + 0.02 * var_x203);
        const double var_x207 = 1.0 * var_x206;
        const double var_x208 = 0.25 * exp(-0.02 * var_chaste_interface__membrane__Vm) + 0.1027 * var_x200;
        const double var_x209 = 1.0 / var_x208;
        const double var_x210 = -0.01 + 0.01 / (1.0 + 7.0000000000000007e-5 * var_x199 * var_x201 * var_x204 * var_x206 * var_x208);
        const double var_x211 = pow(var_x113, 1.1200000000000001);
        const double var_x212 = var_x211 * (1.0 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001));
        const double var_x213 = pow((0.020000293738509214 + var_x212), (-2));
        const double var_x214 = exp(-0.32333333333333331 + 0.0033333333333333335 * var_chaste_interface__membrane__Vm - 0.08904277307995126 * var_x114);
        const double var_x215 = exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 3.142686108704162 * var_x114);
        const double var_x216 = exp(10.659340659340661 + 2.9354760356027887 * var_x114 - 0.10989010989010989 * var_chaste_interface__membrane__Vm);
        const double var_x217 = exp(0.19400000000000001 + 0.053425663847970754 * var_x114 - 0.002 * var_chaste_interface__membrane__Vm);
        const double var_x218 = 1 / (0.00013999999999999999 * var_x216 + 0.20000000000000001 * var_x217);
        const double var_x219 = var_x189 * var_x218;
        const double var_x220 = var_x161 * var_x219;
        
        
        rJacobian[0][0] = 1.0 - (mDt * (-0.0030000000000000001 - 0.00012490084125584149 * var_x8 - 0.005263031070603514 * var_x16));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = -(mDt * (4.2104248564828106e-5 * var_x18));
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        rJacobian[0][5] = 0.0;
        rJacobian[0][6] = 0.0;
        ...
        rJacobian[0][12] = 0.0;
        rJacobian[0][13] = 0.0;
        rJacobian[0][14] = -(mDt * (0.00052630310706035135 * var_x19 + 0.052630310706035133 * var_x21));
        rJacobian[0][15] = -(mDt * (0.00016841699425931242 * var_x29));
        rJacobian[0][16] = -(mDt * (6.7575548900338474e-6 * var_x33));
        rJacobian[0][17] = -(mDt * (-0.00031977245457203985 * var_x35));
        rJacobian[0][18] = 0.0;
        rJacobian[0][19] = 0.0;
        rJacobian[0][20] = 0.0;
        rJacobian[0][21] = 0.0;
        rJacobian[0][22] = 0.0;
        rJacobian[0][23] = -(mDt * (-0.00014364674094978895 * var_x37 - 0.0013287323537855477 * var_x38));
        rJacobian[0][24] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (-0.0062508615177014034 - 0.067509304391175154 * var_x41 + (-1.0040243888535934 - 10.843463399618807 * var_x41) * var_chaste_interface__RyR_channel__p_open_RyR));
        ...
        rJacobian[1][11] = 0.0;
        rJacobian[1][12] = 0.0;
        rJacobian[1][13] = -(mDt * (10.790872602130657 + 1.0040243888535934 * var_x9 + 1.0040243888535934 * var_chaste_interface__internal_ion_concentrations__Ca_Total - 1.0040243888535934 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total - 10.843463399618807 * var_x40));
        rJacobian[1][14] = 0.0;
        rJacobian[1][15] = -(mDt * ((1.0040243888535934 + 1.0040243888535934 * var_x24) * var_chaste_interface__RyR_channel__p_open_RyR));
        rJacobian[1][16] = 0.0;
        rJacobian[1][17] = 0.0;
        rJacobian[1][18] = 0.0;
        rJacobian[1][19] = 0.0;
        ...
        rJacobian[1][23] = 0.0;
        rJacobian[1][24] = 0.0;
        rJacobian[2][0] = -(mDt * (0.21052124282414053 * var_x16));
        rJacobian[2][1] = -(mDt * (0.0025003446070805614 + 0.027003721756470062 * var_x41));
        rJacobian[2][2] = 1.0 - (mDt * (-0.010947104626855308 - 0.0016841699425931243 * var_x18));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][12] = 0.0;
        rJacobian[2][13] = 0.0;
        rJacobian[2][14] = -(mDt * (-0.021052124282414052 * var_x19 - 2.1052124282414053 * var_x21));
        rJacobian[2][15] = -(mDt * (0.0029732077063470926 + 0.0029732077063470926 * var_x24 - 0.0067366797703724973 * var_x29));
        rJacobian[2][16] = 0.0;
        rJacobian[2][17] = 0.0;
        rJacobian[2][18] = 0.0;
        rJacobian[2][19] = 0.0;
        ...
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (-0.1472 + var_x49));
        rJacobian[3][4] = -(mDt * (0.3458));
        rJacobian[3][5] = -(mDt * (-0.0041999999999999997));
        rJacobian[3][6] = 0.0;
        rJacobian[3][7] = -(mDt * ((0.18212526000000001 + var_x50 - 3.4769999999999999 * var_x9 - 3.4769999999999999 * var_chaste_interface__internal_ion_concentrations__Ca_Total) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C));
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        ...
        rJacobian[3][13] = 0.0;
        rJacobian[3][14] = 0.0;
        rJacobian[3][15] = -(mDt * (-var_x53 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C));
        rJacobian[3][16] = 0.0;
        rJacobian[3][17] = 0.0;
        rJacobian[3][18] = 0.0;
        rJacobian[3][19] = 0.0;
        ...
        rJacobian[4][4] = 1.0 - (mDt * (-0.34999999999999998 + var_x49 - var_x54));
        rJacobian[4][5] = -(mDt * (2.0019999999999998));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = -(mDt * (var_x55));
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        ...
        rJacobian[4][13] = 0.0;
        rJacobian[4][14] = 0.0;
        rJacobian[4][15] = -(mDt * ((-var_x53 - var_x56) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U));
        rJacobian[4][16] = 0.0;
        rJacobian[4][17] = 0.0;
        rJacobian[4][18] = 0.0;
        rJacobian[4][19] = 0.0;
        ...
        rJacobian[5][4] = -(mDt * (-0.00029999999999999997 + var_x48 + var_x54));
        rJacobian[5][5] = 1.0 - (mDt * (-2.3523000000000001));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = -(mDt * (-var_x55));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        ...
        rJacobian[5][13] = 0.0;
        rJacobian[5][14] = 0.0;
        rJacobian[5][15] = -(mDt * ((var_x53 + var_x56) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U));
        rJacobian[5][16] = 0.0;
        rJacobian[5][17] = 0.0;
        rJacobian[5][18] = 0.0;
        rJacobian[5][19] = 0.0;
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.001 + var_x60 - 1.0 / var_x61));
        rJacobian[6][7] = -(mDt * (0.0040000000000000001 + var_x60));
        rJacobian[6][8] = -(mDt * (var_x60));
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[6][12] = 0.0;
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-0.0040000000000000001 - var_x64));
        rJacobian[7][8] = -(mDt * (var_x66));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = -(mDt * (var_x67));
        rJacobian[8][7] = -(mDt * (var_x64 + var_x67));
        rJacobian[8][8] = 1.0 - (mDt * (-0.040000000000000001 - var_x66));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (40.736400000000003 + var_x71 - var_x68 - var_x69));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = -(mDt * (0.029999999999999999));
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = 0.0;
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = -(mDt * ((-780.0 - var_x72) * var_chaste_interface__NL_model__pCB));
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        rJacobian[9][18] = 0.0;
        rJacobian[9][19] = 0.0;
        ...
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = -(mDt * (1.0214100000000002 + var_x73));
        rJacobian[10][10] = 1.0 - (mDt * (0.99141000000000001 + var_x73 - var_x74));
        rJacobian[10][11] = -(mDt * (1.0253100000000002 + var_x73));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[10][15] = -(mDt * (var_x75 * (19.5 + 19.5 * var_x24)));
        rJacobian[10][16] = 0.0;
        rJacobian[10][17] = 0.0;
        rJacobian[10][18] = 0.0;
        rJacobian[10][19] = 0.0;
        ...
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = -(mDt * (-40.856400000000001 + var_x68 + var_x69));
        rJacobian[11][10] = -(mDt * (var_x74));
        rJacobian[11][11] = 1.0 - (mDt * (-0.0339 + var_x71));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = -(mDt * ((780.0 + var_x72) * var_chaste_interface__NL_model__pCB));
        rJacobian[11][16] = 0.0;
        rJacobian[11][17] = 0.0;
        rJacobian[11][18] = 0.0;
        rJacobian[11][19] = 0.0;
        ...
        rJacobian[11][23] = 0.0;
        rJacobian[11][24] = 0.0;
        rJacobian[12][0] = -(mDt * (var_x80));
        rJacobian[12][1] = -(mDt * (0.010993320000000001 * var_x81 * (0.18518518518518517 + 2 * var_x41) * (1.0 - var_chaste_interface__RyR_channel__p_close_RyR - var_chaste_interface__RyR_channel__p_open_RyR)));
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x85));
        rJacobian[12][5] = -(mDt * (var_x85));
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = -(mDt * (var_x87));
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.00084900000000000004 + var_x90 + var_x92 - var_x88));
        rJacobian[12][13] = -(mDt * (var_x90));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = -(mDt * ((var_x94 - var_x93) * var_chaste_interface__RyR_channel__p_close_RyR));
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        rJacobian[12][18] = 0.0;
        rJacobian[12][19] = 0.0;
        ...
        rJacobian[12][23] = 0.0;
        rJacobian[12][24] = 0.0;
        rJacobian[13][0] = -(mDt * (-var_x80));
        rJacobian[13][1] = -(mDt * (0.00098765432098765434 * (-0.5 - 5.4000000000000004 * var_x41) * var_chaste_interface__RyR_channel__p_open_RyR / (var_x89 * pow(var_x95, 2))));
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = -(mDt * (var_x96));
        rJacobian[13][5] = -(mDt * (var_x96));
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (-var_x87));
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = -(mDt * (var_x88 - var_x92));
        rJacobian[13][13] = 1.0 - (mDt * (-0.080000000000000002 / var_x95));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = -(mDt * ((var_x93 - var_x94) * var_chaste_interface__RyR_channel__p_close_RyR));
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        rJacobian[13][19] = 0.0;
        ...
        rJacobian[13][23] = 0.0;
        rJacobian[13][24] = 0.0;
        rJacobian[14][0] = -(mDt * (0.10000000000000001 * var_x16));
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = -(mDt * (0.079200000000000007 * var_x18));
        rJacobian[14][3] = 0.0;
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-1.01 + 0.01 * var_x13 + 0.98999999999999999 * var_x19 - 1.0 * var_x21));
        rJacobian[14][15] = -(mDt * (var_x14 * (3.2000000000000005e-5 * var_x27 - 0.0032000000000000002 * var_x28)));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        ...
        rJacobian[14][23] = 0.0;
        rJacobian[14][24] = 0.0;
        rJacobian[15][0] = -(mDt * (-0.010526062141207028 * var_x16 - 0.0061697501709483491 * var_x46 * var_x79));
        rJacobian[15][1] = -(mDt * ((0.020080487777071866 + 0.21686926799237616 * var_x41) * var_chaste_interface__RyR_channel__p_open_RyR));
        rJacobian[15][2] = -(mDt * (0.00029732077063470926 + 8.4208497129656211e-5 * var_x18));
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = -(mDt * (var_x98));
        rJacobian[15][5] = -(mDt * (var_x98));
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = -(mDt * (-var_x86 * var_x97));
        rJacobian[15][8] = 0.0;
        ...
        rJacobian[15][10] = -(mDt * (var_x99));
        rJacobian[15][11] = -(mDt * (var_x99 + 0.0027216000000000002 * var_x70));
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = -(mDt * (-0.21581745204261313 + 0.020080487777071866 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 0.21686926799237616 * var_x40 - 0.020080487777071866 * var_x9 - 0.020080487777071866 * var_chaste_interface__internal_ion_concentrations__Ca_Total));
        rJacobian[15][14] = -(mDt * (0.0010526062141207027 * var_x19 + 0.10526062141207027 * var_x21));
        rJacobian[15][15] = 1.0 - (mDt * (-0.00014866038531735463 + 0.00033683398851862484 * var_x29 - 0.00014866038531735463 * var_x24 - 1.7383588942261838e-6 * var_x108 - 2.591030680912499e-8 * var_x52 + var_x75 * (-1.3650000000000002 - 1.3650000000000002 * var_x24) + (-54.600000000000009 - 54.600000000000009 * var_x24) * var_chaste_interface__NL_model__pCB + (-0.020080487777071866 - 0.020080487777071866 * var_x24) * var_chaste_interface__RyR_channel__p_open_RyR - 0.0056432648230274225 * var_x100 * var_x52 - 0.00039642769417961232 * var_x52 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = -(mDt * (5.2150766826785515e-6 * var_x110));
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = -(mDt * (0.0007452808715042858 * var_x111 + 0.0011645646498429317 * var_x112));
        rJacobian[15][20] = 0.0;
        rJacobian[15][21] = 0.0;
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = 0.0;
        rJacobian[16][0] = -(mDt * (0.00024980168251168298 * var_x8 - 4.5039176247922949e-6 * var_x119 * var_x79 + 1.710660339589889e-6 * (-26.712831923985377 * var_x114 + var_chaste_interface__membrane__Vm) * var_chaste_interface__ATP_production__ATPi / pow((0.010000000000000002 + var_x6), 2)));
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = 0.0;
        rJacobian[16][4] = -(mDt * (var_x121));
        rJacobian[16][5] = -(mDt * (var_x121));
        rJacobian[16][6] = 0.0;
        rJacobian[16][7] = -(mDt * (-var_x120 * var_x86));
        rJacobian[16][8] = 0.0;
        rJacobian[16][9] = 0.0;
        rJacobian[16][10] = 0.0;
        rJacobian[16][11] = 0.0;
        ...
        rJacobian[16][13] = 0.0;
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = -(mDt * (var_x119 * var_x123));
        rJacobian[16][16] = 1.0 - (mDt * (-1.2955153404562495e-6 * ((var_chaste_interface__membrane__Vm == (-3.0)) ? (5.3564032599450697e-5 * var_x124) : ((var_x42) ? (0.00011 * var_x125) : (4.1178711531977753e-6 * var_x124 * var_x125))) - 1.9950936243026244e-7 * var_x126 - 1.3515109780067695e-5 * var_x33 - var_x126 * var_x127 - 4.1195833208100184e-6 * var_x100 * var_x126 - 6.5293973158994975e-6 * var_x126 * var_x186 - 0.005235052487551543 * var_x188 * var_x189 - 0.0022848291065246224 * var_x113 / (1.0 + 99.999999999999986 * var_x6) - 4.2752006235056235e-8 * var_x126 * var_x190 + var_x128 * (var_x159 + var_x162 * var_x165 - var_x154 * var_x166 - var_x162 * var_x163 + 0.22222222222222221 * var_x145 * var_x176 - 0.086816703752952459 * var_x148 * var_x179 - 5.823397359428812 * var_x174 * var_x183 + var_x160 * var_x176 * var_x181 + 10.257727458810384 * var_x134 * var_x167 * var_x173 * var_x183 + 0.42740531078376603 * var_x134 * var_x148 * var_x156 * var_x177 - 0.10017311971494516 * var_x113 * var_x138 * var_x179 / pow(var_x139, 3) - 0.20034623942989033 * var_x129 * var_x148 * var_x171 * var_x178 - 0.80138495771956131 * var_x149 * var_x174 * var_x180 * var_x182 - 4.8083097463173674 * var_x129 * var_x131 * var_x164 * var_x172 * var_x183 + var_x155 * var_x158 * var_x167 * var_x168 * var_x169 * var_x170) * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x126 * var_x184 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + 26.712831923985377 * var_x113 * (-5.9100373419341736e-7 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 - 8.8650560129012604e-7 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3));
        rJacobian[16][17] = -(mDt * (0.00063954490914407971 * var_x35));
        rJacobian[16][18] = -(mDt * (-5.8764575843095472e-6 * var_x119 * var_x185));
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        rJacobian[16][21] = -(mDt * (-var_x119 * var_x184));
        rJacobian[16][22] = 0.0;
        rJacobian[16][23] = -(mDt * (0.0002872934818995779 * var_x37 + 0.0026574647075710955 * var_x38));
        rJacobian[16][24] = -(mDt * (var_x128 * var_x188));
        rJacobian[17][0] = -(mDt * (-0.00037470252376752445 * var_x8 - 2.2828075632508891e-7 * var_x191 * var_x79));
        rJacobian[17][1] = 0.0;
        rJacobian[17][2] = 0.0;
        rJacobian[17][3] = 0.0;
        rJacobian[17][4] = -(mDt * (var_x193));
        rJacobian[17][5] = -(mDt * (var_x193));
        rJacobian[17][6] = 0.0;
        rJacobian[17][7] = -(mDt * (-var_x192 * var_x86));
        rJacobian[17][8] = 0.0;
        rJacobian[17][9] = 0.0;
        rJacobian[17][10] = 0.0;
        rJacobian[17][11] = 0.0;
        ...
        rJacobian[17][13] = 0.0;
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = -(mDt * (5.2150766826785515e-6 * var_x108 + var_x123 * var_x191));
        rJacobian[17][16] = -(mDt * (2.0272664670101542e-5 * var_x33));
        rJacobian[17][17] = 1.0 - (mDt * (-1.5645230048035654e-5 * var_x110 - 0.00095931736371611951 * var_x35 - 4.9877340607565601e-7 * var_x194 - var_x127 * var_x194 - 3.8476805611550606e-9 * var_x190 * var_x194 - 2.0880079845201463e-7 * var_x100 * var_x194 - 2.6117589263597991e-7 * var_x186 * var_x194 - var_x194 * var_x195 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na));
        rJacobian[17][18] = -(mDt * (-2.3505830337238192e-7 * var_x185 * var_x191));
        rJacobian[17][19] = -(mDt * (-0.0022358426145128573 * var_x111 - 0.003493693949528795 * var_x112));
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = -(mDt * (-var_x191 * var_x195));
        rJacobian[17][22] = 0.0;
        rJacobian[17][23] = -(mDt * (-0.0039861970613566432 * var_x38 - 0.00043094022284936683 * var_x37));
        rJacobian[17][24] = 0.0;
        rJacobian[18][0] = 0.0;
        rJacobian[18][1] = 0.0;
        rJacobian[18][2] = 0.0;
        ...
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = 0.0;
        rJacobian[18][15] = -(mDt * ((1.0 - var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2) * (1.8500000000000001 + 1.8500000000000001 * var_x24)));
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        ...
        rJacobian[19][13] = 0.0;
        rJacobian[19][14] = 0.0;
        rJacobian[19][15] = -(mDt * ((0.0014927113702623907 * var_x107 + 0.0055199999999999997 * var_x196 * var_x198 * var_x26) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = -(mDt * ((-0.0044781341107871719 * var_x109 + 6.1798250728862972e-6 * var_x11 * var_x198 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 2)) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-0.20379327210477693 - 1.0 * var_x112 - 1.0 / var_x197 - 0.6399652192815608 * var_x111));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = 0.0;
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        ...
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-8.7499999999999999e-5 + var_x202 - 1.0 / var_x204));
        rJacobian[20][21] = -(mDt * (var_x202 + var_x205));
        rJacobian[20][22] = -(mDt * (var_x202));
        rJacobian[20][23] = 0.0;
        rJacobian[20][24] = 0.0;
        rJacobian[21][0] = 0.0;
        rJacobian[21][1] = 0.0;
        ...
        rJacobian[21][21] = 1.0 - (mDt * (-var_x205 - var_x207));
        rJacobian[21][22] = -(mDt * (var_x209));
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[22][0] = 0.0;
        rJacobian[22][1] = 0.0;
        ...
        rJacobian[22][18] = 0.0;
        rJacobian[22][19] = 0.0;
        rJacobian[22][20] = -(mDt * (var_x210));
        rJacobian[22][21] = -(mDt * (var_x207 + var_x210));
        rJacobian[22][22] = 1.0 - (mDt * (-0.01 - var_x209));
        rJacobian[22][23] = 0.0;
        rJacobian[22][24] = 0.0;
        ...
        rJacobian[23][14] = 0.0;
        rJacobian[23][15] = 0.0;
        rJacobian[23][16] = -(mDt * ((0.0018817147803989289 * var_x32 - 0.00022400328987130325 * var_x113 * var_x212 * var_x213) * var_chaste_interface__sodium_potassium_pump_y_gate__y));
        rJacobian[23][17] = -(mDt * ((-0.089044123788040511 * var_x34 + 4.8132665714837462e-5 * var_x211 * var_x213 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 0.060000000000000053)) * var_chaste_interface__sodium_potassium_pump_y_gate__y));
        rJacobian[23][18] = 0.0;
        rJacobian[23][19] = 0.0;
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = 0.0;
        rJacobian[23][23] = 1.0 - (mDt * (-0.37 * var_x38 - 0.01 / (1.0 + 49.999265664512095 * var_x212) - 0.040000000000000001 * var_x37 - 0.16500000000000001 / (1.0331690520373935 + 0.069365261764196454 * pow(var_x36, 1.0600000000000001))));
        rJacobian[23][24] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        ...
        rJacobian[24][14] = 0.0;
        rJacobian[24][15] = 0.0;
        rJacobian[24][16] = -(mDt * (var_x163 * var_x220 - var_x165 * var_x220 + var_x153 * var_x166 * var_x219 - var_x159 * var_x218 * var_chaste_interface__time_independent_potassium_current_y_gate__y + 1.5624999999999999e-8 * (1.0 - var_chaste_interface__time_independent_potassium_current_y_gate__y) * (-0.62329941155965873 * var_x113 * var_x214 - 25141.488869633296 * var_x113 * var_x215) / pow((var_x215 + 0.00087500000000000002 * var_x214), 2) - 24.999999999999996 * var_x136 * var_x161 * (0.010685132769594151 * var_x113 * var_x217 + 0.00041096664498439041 * var_x113 * var_x216) * var_chaste_interface__time_independent_potassium_current_y_gate__y / pow((var_x217 + 0.00069999999999999988 * var_x216), 2)));
        rJacobian[24][17] = 0.0;
        rJacobian[24][18] = 0.0;
        rJacobian[24][19] = 0.0;
        rJacobian[24][20] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-1.0 / (7.0 * var_x214 + 8000.0 * var_x215) - var_x187 * var_x218));
    }
