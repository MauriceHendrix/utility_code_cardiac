...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x66 = 1.5 * exp(-var_x64) + 0.27000000000000002 * exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
        const double var_x67 = 1 / var_x66;
        const double var_x68 = -0.040000000000000001 + 0.040000000000000001 / (1.0 + 0.25 * var_x61 * var_x63 * var_x65 * var_x66);
        const double var_x69 = 780.0 * var_x0;
        const double var_x70 = 780.0 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x71 = pow((0.95737999754118841 - var_chaste_interface__NL_model__X), 2);
        const double var_x72 = -0.038879999999999998 * var_x71;
        const double var_x73 = 780.0 * var_x25;
        const double var_x74 = -19.5 * var_x0 - 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x75 = 0.0038999999999999998 * exp(-0.86212130841993795);
        const double var_x76 = 1.0 - var_chaste_interface__NL_model__pCB - var_chaste_interface__NL_model__pCa - var_chaste_interface__NL_model__pCaCB;
        const double var_x77 = var_x48 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x78 = var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U + var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_UCa;
        const double var_x79 = pow(var_chaste_interface__ATP_production__ATPi, (-3));
        const double var_x80 = var_x78 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL / (pow((0.36443148688046656 + var_x79), 2) * pow(var_chaste_interface__ATP_production__ATPi, 4));
        const double var_x81 = 11.08600583090379 * var_x77 * var_x80;
        const double var_x82 = -1 + var_x41 + var_x42;
        const double var_x83 = var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / (1.0 + 2.7439999999999993 * var_x79);
        const double var_x84 = var_x83 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x85 = 10.139999999999999 * var_x84;
        const double var_x86 = var_x77 * var_x85;
        const double var_x87 = var_x78 * var_x83;
        const double var_x88 = 10.139999999999999 * var_x77 * var_x87;
        const double var_x89 = 70000.0 * var_x24;
        const double var_x90 = pow(var_x82, 2);
        const double var_x91 = -0.010993320000000001 * var_x90;
        const double var_x92 = var_x78 * var_x85;
        const double var_x93 = var_x48 * var_x92;
        const double var_x94 = 70000.0 * var_x23 * (2 + 2 * var_x25);
        const double var_x95 = var_x54 * var_x92;
        const double var_x96 = 1.0 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x42);
        const double var_x97 = -var_x86;
        const double var_x98 = 0.0056432648230274225 * var_x48;
        const double var_x99 = -var_x84 * var_x98;
        const double var_x100 = -0.069398700000000008 + 1.3650000000000002 * var_x0 + 1.3650000000000002 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x101 = var_x78 * var_x84;
        const double var_x102 = pow(var_chaste_interface__internal_ion_concentrations__Nai, 3);
        const double var_x103 = 1 / var_x102;
        const double var_x104 = exp(0.011979261536575346 * var_chaste_interface__membrane__Vm);
        const double var_x105 = -17.978260869565219 + 362.31884057971018 * var_x0 + 362.31884057971018 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x106 = var_x103 * var_x105;
        const double var_x107 = var_x104 / pow((0.0014927113702623907 + var_x106), 2);
        const double var_x108 = var_x103 * var_x107 * (362.31884057971018 + 362.31884057971018 * var_x25);
        const double var_x109 = mParameters[0] * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        const double var_x110 = var_x108 * var_x109;
        const double var_x111 = var_x105 * var_x107 / pow(var_chaste_interface__internal_ion_concentrations__Nai, 4);
        const double var_x112 = var_x109 * var_x111;
        const double var_x113 = exp(-0.025455930765222609 * var_chaste_interface__membrane__Vm);
        const double var_x114 = var_x104 / (1.0 + 669.921875 * var_x106);
        const double var_x115 = 1 / var_chaste_interface__internal_ion_concentrations__Ki;
        const double var_x116 = log(5.4000000000000004 * var_x115);
        const double var_x117 = 0.037435192301797954 * var_chaste_interface__membrane__Vm;
        const double var_x118 = exp(-var_x117);
        const double var_x119 = 1 / (1.0 - var_x118);
        const double var_x120 = var_x117 * var_x119;
        const double var_x121 = ((var_x44) ? (var_chaste_interface__internal_ion_concentrations__Ki) : (var_x120 * (-5.4000000000000004 * var_x118 + var_chaste_interface__internal_ion_concentrations__Ki)));
        const double var_x122 = 4.1195833208100184e-6 * var_x121;
        const double var_x123 = -var_x122 * var_x84;
        const double var_x124 = 1.0 + 1.3823999999999997e-8 / pow(var_x23, 3);
        const double var_x125 = 1.9700124473113906e-15 * (-3 - 3 * var_x25) / (pow(var_x124, 2) * pow(var_x23, 4));
        const double var_x126 = var_x119 * var_chaste_interface__membrane__Vm;
        const double var_x127 = (3.0 + var_chaste_interface__membrane__Vm) / (1.0 - exp(-0.23076923076923078 - 0.076923076923076927 * var_chaste_interface__membrane__Vm));
        const double var_x128 = ((var_x44) ? (1) : (var_x120));
        const double var_x129 = 1.4250668745018745e-7 / var_x124;
        const double var_x130 = 0.00037051738737048736 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x131 = pow(var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1, 2);
        const double var_x132 = var_x131 * (0.10000000000000001 + 0.90000000000000002 * var_chaste_interface__slow_time_dependent_potassium_current_y2_gate__y2);
        const double var_x133 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 3) * var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x134 = exp(-2.1000000000000001 + 0.029999999999999999 * var_chaste_interface__membrane__Vm - 0.80138495771956131 * var_x116);
        const double var_x135 = 1.0 + var_x134;
        const double var_x136 = pow(var_x135, (-4));
        const double var_x137 = exp(0.47999999999999998 + 1.282215932351298 * var_x116 - 0.048000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x138 = pow(var_x137, 4);
        const double var_x139 = exp(-2.4319999999999999 + 0.064000000000000001 * var_chaste_interface__membrane__Vm - 1.7096212431350641 * var_x116);
        const double var_x140 = 1.0 + var_x139;
        const double var_x141 = pow(var_x140, 4);
        const double var_x142 = 1.0 * var_x141;
        const double var_x143 = exp(-2.1000000000000001 + 0.014999999999999999 * var_chaste_interface__membrane__Vm - 0.40069247885978065 * var_x116);
        const double var_x144 = 1.0 + var_x143;
        const double var_x145 = exp(-0.35000000000000003 + 0.035000000000000003 * var_chaste_interface__membrane__Vm - 0.93494911733948827 * var_x116);
        const double var_x146 = var_x145 / var_x144;
        const double var_x147 = var_x137 / var_x135;
        const double var_x148 = var_x140 * var_x147;
        const double var_x149 = var_x148 + 0.25 * var_x146;
        const double var_x150 = pow(var_x149, (-5));
        const double var_x151 = var_x115 * var_x146;
        const double var_x152 = pow(var_x144, (-2));
        const double var_x153 = var_x115 * var_x152;
        const double var_x154 = var_x143 * var_x145 * var_x153;
        const double var_x155 = var_x115 * var_x148;
        const double var_x156 = var_x115 * var_x139 * var_x147;
        const double var_x157 = 3.2055398308782452 * var_x115 * var_x134;
        const double var_x158 = pow(var_x135, (-2));
        const double var_x159 = var_x140 * var_x158;
        const double var_x160 = var_x137 * var_x159;
        const double var_x161 = var_x150 * (0.40069247885978065 * var_x154 + 5.1288637294051922 * var_x155 - 6.8384849725402566 * var_x156 - 0.93494911733948827 * var_x151 + var_x157 * var_x160);
        const double var_x162 = var_x136 * var_x138 * var_x142 * var_x161;
        const double var_x163 = pow(var_x149, (-4));
        const double var_x164 = var_x136 * var_x138 * var_x163;
        const double var_x165 = var_x115 * var_x164;
        const double var_x166 = 5.1288637294051922 * var_x141 * var_x165;
        const double var_x167 = pow(var_x140, 3);
        const double var_x168 = 6.8384849725402566 * var_x139 * var_x165 * var_x167;
        const double var_x169 = var_x138 * var_x141 * var_x157 * var_x163 / pow(var_x135, 5);
        const double var_x170 = pow(var_x140, 2);
        const double var_x171 = pow(var_x137, 2);
        const double var_x172 = pow(var_x145, 2);
        const double var_x173 = 0.125 * var_x152;
        const double var_x174 = pow(var_x135, (-3));
        const double var_x175 = pow(var_x137, 3);
        const double var_x176 = var_x174 * var_x175;
        const double var_x177 = var_x167 * var_x176;
        const double var_x178 = var_x146 * var_x177;
        const double var_x179 = var_x178 * (0.30051935914483546 * var_x154 + 3.8466477970538944 * var_x155 - 5.1288637294051922 * var_x156 - 0.70121183800461617 * var_x151 + 2.4041548731586837 * var_x115 * var_x134 * var_x160);
        const double var_x180 = var_x163 * var_x171 * var_x172;
        const double var_x181 = var_x170 * var_x180;
        const double var_x182 = var_x158 * var_x181;
        const double var_x183 = 1 / (0.75 * var_x146 + 3.0 * var_x148);
        const double var_x184 = 2.0 * var_x183;
        const double var_x185 = pow(var_x149, (-3));
        const double var_x186 = var_x151 * var_x183 * var_x185;
        const double var_x187 = (3.9659488542057145e-5 * var_x116 - 1.4846605801628617e-6 * var_chaste_interface__membrane__Vm) * mParameters[0];
        const double var_x188 = var_x115 * mParameters[0];
        const double var_x189 = var_x142 * var_x164;
        const double var_x190 = var_x189 + var_x173 * var_x182 + var_x178 * var_x184 * var_x185;
        const double var_x191 = ((var_x44) ? (-140.0) : (var_x120 * (-140.0 * var_x118 + var_chaste_interface__internal_ion_concentrations__Nai)));
        const double var_x192 = 2.0880079845201463e-7 * var_x191;
        const double var_x193 = -var_x192 * var_x84;
        const double var_x194 = ((var_x44) ? (0) : (var_x120));
        const double var_x195 = 0.0037051738737048732 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        const double var_x196 = 1.0 + 0.0014927113702623907 * var_x102;
        const double var_x197 = 1.0 + 0.0013799999999999999 * var_x196 * var_x2;
        ...
        const double var_x207 = 0.25 * exp(-0.02 * var_chaste_interface__membrane__Vm) + 0.1027 * var_x200;
        const double var_x208 = 1 / var_x207;
        const double var_x209 = -0.01 + 0.01 / (1.0 + 7.0000000000000007e-5 * var_x199 * var_x201 * var_x204 * var_x206 * var_x207);
        const double var_x210 = pow(var_x115, 1.1200000000000001);
        const double var_x211 = var_x210 * (1.0 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001));
        const double var_x212 = pow((0.020000293738509214 + var_x211), (-2));
        const double var_x213 = exp(-0.32333333333333331 + 0.0033333333333333335 * var_chaste_interface__membrane__Vm - 0.08904277307995126 * var_x116);
        const double var_x214 = exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 3.142686108704162 * var_x116);
        const double var_x215 = exp(10.659340659340661 + 2.9354760356027887 * var_x116 - 0.10989010989010989 * var_chaste_interface__membrane__Vm);
        const double var_x216 = exp(0.19400000000000001 + 0.053425663847970754 * var_x116 - 0.002 * var_chaste_interface__membrane__Vm);
        const double var_x217 = 1 / (0.00013999999999999999 * var_x215 + 0.20000000000000001 * var_x216);
        const double var_x218 = var_x217 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        ...
        rJacobian[7][7] = 1.0 - (mDt * (-0.0040000000000000001 - var_x65));
        rJacobian[7][8] = -(mDt * (var_x67));
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        ...
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = -(mDt * (var_x68));
        rJacobian[8][7] = -(mDt * (var_x65 + var_x68));
        rJacobian[8][8] = 1.0 - (mDt * (-0.040000000000000001 - var_x67));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * (40.736400000000003 + var_x72 - var_x69 - var_x70));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = -(mDt * (0.029999999999999999));
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = 0.0;
        rJacobian[9][14] = 0.0;
        rJacobian[9][15] = -(mDt * ((-780.0 - var_x73) * var_chaste_interface__NL_model__pCB));
        rJacobian[9][16] = 0.0;
        rJacobian[9][17] = 0.0;
        rJacobian[9][18] = 0.0;
        rJacobian[9][19] = 0.0;
        ...
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = -(mDt * (1.0214100000000002 + var_x74));
        rJacobian[10][10] = 1.0 - (mDt * (0.99141000000000001 + var_x74 - var_x75));
        rJacobian[10][11] = -(mDt * (1.0253100000000002 + var_x74));
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[10][15] = -(mDt * (var_x76 * (19.5 + 19.5 * var_x25)));
        rJacobian[10][16] = 0.0;
        rJacobian[10][17] = 0.0;
        rJacobian[10][18] = 0.0;
        rJacobian[10][19] = 0.0;
        ...
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = -(mDt * (-40.856400000000001 + var_x69 + var_x70));
        rJacobian[11][10] = -(mDt * (var_x75));
        rJacobian[11][11] = 1.0 - (mDt * (-0.0339 + var_x72));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        rJacobian[11][15] = -(mDt * ((780.0 + var_x73) * var_chaste_interface__NL_model__pCB));
        rJacobian[11][16] = 0.0;
        rJacobian[11][17] = 0.0;
        rJacobian[11][18] = 0.0;
        rJacobian[11][19] = 0.0;
        ...
        rJacobian[11][23] = 0.0;
        rJacobian[11][24] = 0.0;
        rJacobian[12][0] = -(mDt * (var_x81));
        rJacobian[12][1] = -(mDt * (0.010993320000000001 * var_x82 * (0.18518518518518517 + 2 * var_x43) * (1.0 - var_chaste_interface__RyR_channel__p_close_RyR - var_chaste_interface__RyR_channel__p_open_RyR)));
        rJacobian[12][2] = 0.0;
        rJacobian[12][3] = 0.0;
        rJacobian[12][4] = -(mDt * (var_x86));
        rJacobian[12][5] = -(mDt * (var_x86));
        rJacobian[12][6] = 0.0;
        rJacobian[12][7] = -(mDt * (var_x88));
        rJacobian[12][8] = 0.0;
        rJacobian[12][9] = 0.0;
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.00084900000000000004 + var_x91 + var_x93 - var_x89));
        rJacobian[12][13] = -(mDt * (var_x91));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = -(mDt * ((var_x95 - var_x94) * var_chaste_interface__RyR_channel__p_close_RyR));
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        rJacobian[12][18] = 0.0;
        rJacobian[12][19] = 0.0;
        ...
        rJacobian[12][23] = 0.0;
        rJacobian[12][24] = 0.0;
        rJacobian[13][0] = -(mDt * (-var_x81));
        rJacobian[13][1] = -(mDt * (0.00098765432098765434 * (-0.5 - 5.4000000000000004 * var_x43) * var_chaste_interface__RyR_channel__p_open_RyR / (var_x90 * pow(var_x96, 2))));
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = 0.0;
        rJacobian[13][4] = -(mDt * (var_x97));
        rJacobian[13][5] = -(mDt * (var_x97));
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (-var_x88));
        rJacobian[13][8] = 0.0;
        rJacobian[13][9] = 0.0;
        rJacobian[13][10] = 0.0;
        rJacobian[13][11] = 0.0;
        rJacobian[13][12] = -(mDt * (var_x89 - var_x93));
        rJacobian[13][13] = 1.0 - (mDt * (-0.080000000000000002 / var_x96));
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = -(mDt * ((var_x94 - var_x95) * var_chaste_interface__RyR_channel__p_close_RyR));
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        rJacobian[13][19] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (-1.01 - var_x22 + 0.01 * var_x4 + 0.98999999999999999 * var_x20));
        ...
        rJacobian[14][23] = 0.0;
        rJacobian[14][24] = 0.0;
        rJacobian[15][0] = -(mDt * (-0.010526062141207028 * var_x10 - 0.0061697501709483491 * var_x48 * var_x80));
        ...
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = -(mDt * (var_x99));
        rJacobian[15][5] = -(mDt * (var_x99));
        rJacobian[15][6] = 0.0;
        rJacobian[15][7] = -(mDt * (-var_x87 * var_x98));
        rJacobian[15][8] = 0.0;
        ...
        rJacobian[15][10] = -(mDt * (var_x100));
        rJacobian[15][11] = -(mDt * (var_x100 + 0.0027216000000000002 * var_x71));
        rJacobian[15][12] = 0.0;
        ...
        rJacobian[15][15] = 1.0 - (mDt * (-0.00014866038531735463 + 0.00033683398851862484 * var_x30 - 0.00014866038531735463 * var_x25 - 2.591030680912499e-8 * var_x54 - 1.3169385562319573e-8 * var_x110 + var_x76 * (-1.3650000000000002 - 1.3650000000000002 * var_x25) + (-54.600000000000009 - 54.600000000000009 * var_x25) * var_chaste_interface__NL_model__pCB + (-0.020080487777071866 - 0.020080487777071866 * var_x25) * var_chaste_interface__RyR_channel__p_open_RyR - 0.0056432648230274225 * var_x101 * var_x54 - 0.00039642769417961232 * var_x54 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = -(mDt * (3.9508156686958718e-8 * var_x112));
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = -(mDt * ((8.8224594685070574e-6 * var_x114 + 5.6460672083658019e-6 * var_x113) * mParameters[0]));
        rJacobian[15][20] = 0.0;
        rJacobian[15][21] = 0.0;
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = 0.0;
        rJacobian[16][0] = -(mDt * (1.8924369887248709e-6 * var_x17 - 4.5039176247922949e-6 * var_x121 * var_x80 + 1.710660339589889e-6 * (-26.712831923985377 * var_x116 + var_chaste_interface__membrane__Vm) * var_chaste_interface__ATP_production__ATPi / pow((0.010000000000000002 + var_x8), 2)));
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = 0.0;
        rJacobian[16][4] = -(mDt * (var_x123));
        rJacobian[16][5] = -(mDt * (var_x123));
        rJacobian[16][6] = 0.0;
        rJacobian[16][7] = -(mDt * (-var_x122 * var_x87));
        rJacobian[16][8] = 0.0;
        rJacobian[16][9] = 0.0;
        rJacobian[16][10] = 0.0;
        rJacobian[16][11] = 0.0;
        ...
        rJacobian[16][13] = 0.0;
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = -(mDt * (var_x121 * var_x125));
        rJacobian[16][16] = 1.0 - (mDt * (-1.0238719530354315e-7 * var_x35 - 1.2955153404562495e-6 * ((var_chaste_interface__membrane__Vm == (-3.0)) ? (5.3564032599450697e-5 * var_x126) : ((var_x44) ? (0.00011 * var_x127) : (4.1178711531977753e-6 * var_x126 * var_x127))) - 1.9950936243026244e-7 * var_x128 - var_x128 * var_x129 - 4.1195833208100184e-6 * var_x101 * var_x128 - 6.5293973158994975e-6 * var_x128 * var_x132 - 0.0022848291065246224 * var_x115 / (1.0 + 99.999999999999986 * var_x8) - 4.2752006235056235e-8 * var_x128 * var_x133 + var_x187 * (var_x162 + var_x168 - var_x166 - var_x169 + 0.22222222222222221 * var_x150 * var_x179 - 0.086816703752952459 * var_x153 * var_x182 - 5.823397359428812 * var_x177 * var_x186 + var_x163 * var_x179 * var_x184 + 10.257727458810384 * var_x139 * var_x170 * var_x176 * var_x186 + 0.42740531078376603 * var_x139 * var_x153 * var_x159 * var_x180 - 0.10017311971494516 * var_x115 * var_x143 * var_x182 / pow(var_x144, 3) - 0.20034623942989033 * var_x134 * var_x153 * var_x174 * var_x181 - 0.80138495771956131 * var_x154 * var_x177 * var_x183 * var_x185 - 4.8083097463173674 * var_x134 * var_x136 * var_x167 * var_x175 * var_x186 + var_x158 * var_x161 * var_x170 * var_x171 * var_x172 * var_x173) * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x128 * var_x130 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + 26.712831923985377 * var_x188 * (-4.477301016616798e-9 * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 - 6.7159515249251966e-9 * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 - 3.9659488542057145e-5 * var_x188 * var_x190 * var_chaste_interface__time_independent_potassium_current_y_gate__y));
        rJacobian[16][17] = -(mDt * (4.8450371904854522e-6 * var_x37));
        rJacobian[16][18] = -(mDt * (-5.8764575843095472e-6 * var_x121 * var_x131));
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        rJacobian[16][21] = -(mDt * (-var_x121 * var_x130));
        rJacobian[16][22] = 0.0;
        rJacobian[16][23] = -(mDt * ((2.1764657719664992e-6 * var_x39 + 2.0132308390690117e-5 * var_x40) * mParameters[0]));
        rJacobian[16][24] = -(mDt * (var_x187 * var_x190));
        rJacobian[17][0] = -(mDt * (-2.8386554830873062e-6 * var_x17 - 2.2828075632508891e-7 * var_x191 * var_x80));
        rJacobian[17][1] = 0.0;
        rJacobian[17][2] = 0.0;
        rJacobian[17][3] = 0.0;
        ...
        rJacobian[17][6] = 0.0;
        rJacobian[17][7] = -(mDt * (-var_x192 * var_x87));
        rJacobian[17][8] = 0.0;
        rJacobian[17][9] = 0.0;
        rJacobian[17][10] = 0.0;
        rJacobian[17][11] = 0.0;
        ...
        rJacobian[17][13] = 0.0;
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = -(mDt * (3.9508156686958718e-8 * var_x110 + var_x125 * var_x191));
        rJacobian[17][16] = -(mDt * (1.5358079295531472e-7 * var_x35));
        rJacobian[17][17] = 1.0 - (mDt * (-7.2675557857281787e-6 * var_x37 - 1.1852447006087616e-7 * var_x112 - 4.9877340607565601e-7 * var_x194 - var_x129 * var_x194 - 3.8476805611550606e-9 * var_x133 * var_x194 - 2.0880079845201463e-7 * var_x101 * var_x194 - 2.6117589263597991e-7 * var_x132 * var_x194 - var_x194 * var_x195 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na));
        rJacobian[17][18] = -(mDt * (-2.3505830337238192e-7 * var_x131 * var_x191));
        rJacobian[17][19] = -(mDt * ((-1.6938201625097406e-5 * var_x113 - 2.6467378405521174e-5 * var_x114) * mParameters[0]));
        rJacobian[17][20] = 0.0;
        ...
        rJacobian[19][13] = 0.0;
        rJacobian[19][14] = 0.0;
        rJacobian[19][15] = -(mDt * ((0.0014927113702623907 * var_x108 + 0.0055199999999999997 * var_x196 * var_x198 * var_x27) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        rJacobian[19][16] = 0.0;
        rJacobian[19][17] = -(mDt * ((-0.0044781341107871719 * var_x111 + 6.1798250728862972e-6 * var_x198 * var_x2 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 2)) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        rJacobian[19][18] = 0.0;
        rJacobian[19][19] = 1.0 - (mDt * (-0.20379327210477693 - var_x114 - 1.0 / var_x197 - 0.6399652192815608 * var_x113));
        rJacobian[19][20] = 0.0;
        rJacobian[19][21] = 0.0;
        rJacobian[19][22] = 0.0;
        rJacobian[19][23] = 0.0;
        ...
        rJacobian[20][18] = 0.0;
        rJacobian[20][19] = 0.0;
        rJacobian[20][20] = 1.0 - (mDt * (-8.7499999999999999e-5 + var_x202 - 1 / var_x204));
        ...
        rJacobian[21][21] = 1.0 - (mDt * (-var_x205 - var_x206));
        rJacobian[21][22] = -(mDt * (var_x208));
        rJacobian[21][23] = 0.0;
        rJacobian[21][24] = 0.0;
        rJacobian[22][0] = 0.0;
        rJacobian[22][1] = 0.0;
        ...
        rJacobian[22][18] = 0.0;
        rJacobian[22][19] = 0.0;
        rJacobian[22][20] = -(mDt * (var_x209));
        rJacobian[22][21] = -(mDt * (var_x206 + var_x209));
        rJacobian[22][22] = 1.0 - (mDt * (-0.01 - var_x208));
        rJacobian[22][23] = 0.0;
        rJacobian[22][24] = 0.0;
        ...
        rJacobian[23][14] = 0.0;
        rJacobian[23][15] = 0.0;
        rJacobian[23][16] = -(mDt * ((0.0018817147803989289 * var_x33 - 0.00022400328987130325 * var_x115 * var_x211 * var_x212) * var_chaste_interface__sodium_potassium_pump_y_gate__y));
        rJacobian[23][17] = -(mDt * ((-0.089044123788040511 * var_x36 + 4.8132665714837462e-5 * var_x210 * var_x212 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 0.060000000000000053)) * var_chaste_interface__sodium_potassium_pump_y_gate__y));
        rJacobian[23][18] = 0.0;
        rJacobian[23][19] = 0.0;
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = 0.0;
        rJacobian[23][23] = 1.0 - (mDt * (-0.37 * var_x40 - 0.01 / (1.0 + 49.999265664512095 * var_x211) - 0.040000000000000001 * var_x39 - 0.16500000000000001 / (1.0331690520373935 + 0.069365261764196454 * pow(var_x38, 1.0600000000000001))));
        rJacobian[23][24] = 0.0;
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        ...
        rJacobian[24][14] = 0.0;
        rJacobian[24][15] = 0.0;
        rJacobian[24][16] = -(mDt * (var_x166 * var_x218 + var_x169 * var_x218 - var_x162 * var_x218 - var_x168 * var_x218 + 1.5624999999999999e-8 * (1.0 - var_chaste_interface__time_independent_potassium_current_y_gate__y) * (-0.62329941155965873 * var_x115 * var_x213 - 25141.488869633296 * var_x115 * var_x214) / pow((var_x214 + 0.00087500000000000002 * var_x213), 2) - 24.999999999999996 * var_x141 * var_x164 * (0.010685132769594151 * var_x115 * var_x216 + 0.00041096664498439041 * var_x115 * var_x215) * var_chaste_interface__time_independent_potassium_current_y_gate__y / pow((var_x216 + 0.00069999999999999988 * var_x215), 2)));
        rJacobian[24][17] = 0.0;
        rJacobian[24][18] = 0.0;
        rJacobian[24][19] = 0.0;
        rJacobian[24][20] = 0.0;
        ...
        rJacobian[24][22] = 0.0;
        rJacobian[24][23] = 0.0;
        rJacobian[24][24] = 1.0 - (mDt * (-1 / (7.0 * var_x213 + 8000.0 * var_x214) - var_x189 * var_x217));
    }
