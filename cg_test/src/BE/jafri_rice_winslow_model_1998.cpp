...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        const double var_x30 = 1.8 * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x31 = 1.8 * var_chaste_interface__calcium_subsystem__P_O2;
        const double var_x32 = (-var_chaste_interface__calcium_subsystem__Ca_SS + var_chaste_interface__calcium_subsystem__Ca_JSR) * (var_chaste_interface__calcium_subsystem__P_O1 + var_chaste_interface__calcium_subsystem__P_O2);
        const double var_x33 = var_x29 * (1.8 * var_chaste_interface__calcium_subsystem__Ca_SS - 1.8 * var_chaste_interface__calcium_subsystem__Ca_JSR);
        const double var_x34 = pow(var_chaste_interface__calcium_subsystem__Cai, 2);
        const double var_x35 = 2.4999999999999999e-7 + var_x34;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = var_x36 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x38 = pow(var_chaste_interface__calcium_subsystem__Cai, 3);
        const double var_x39 = var_x38 / pow(var_x35, 2);
        const double var_x40 = 0.0023800000000000002 + var_chaste_interface__calcium_subsystem__Ca_SS;
        const double var_x41 = 1.0 + 0.00011900000000000002 / pow(var_x40, 2);
        const double var_x42 = 1 / var_x41;
        const double var_x43 = exp(0.075146605522028176 * var_chaste_interface__membrane__V);
        const double var_x44 = (-0.61380000000000001 + 0.001 * var_x43) * var_chaste_interface__membrane__V / (-1.0 + var_x43);
        const double var_x45 = 25.859308321022734 * var_x44 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x46 = -var_x42 * var_x45;
        const double var_x47 = 143.30816746739879 * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x48 = 143.30816746739879 * var_chaste_interface__calcium_subsystem__P_O2;
        const double var_x49 = var_chaste_interface__L_type_Ca_channel__O + var_chaste_interface__L_type_Ca_channel__O_Ca;
        const double var_x50 = var_x42 * (143.30816746739879 * var_chaste_interface__calcium_subsystem__Ca_JSR - 143.30816746739879 * var_chaste_interface__calcium_subsystem__Ca_SS);
        const double var_x51 = 0.0023800000000000002 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x52 = 1.0 + 0.00011900000000000002 / pow(var_x51, 2);
        const double var_x53 = 1 / var_x52;
        const double var_x54 = 20.0 * var_chaste_interface__calcium_subsystem__HTRPNCa;
        const double var_x55 = 40.0 * var_chaste_interface__calcium_subsystem__LTRPNCa;
        const double var_x56 = 0.00050000000000000001 + var_chaste_interface__calcium_subsystem__Cai;
        const double var_x57 = 3.5281248386597142e-5 / var_x56;
        const double var_x58 = 1 / var_chaste_interface__calcium_subsystem__Cai;
        const double var_x59 = exp(-0.024422646794659157 * var_chaste_interface__membrane__V);
        const double var_x60 = 1 / (1.0 + 0.10000000000000001 * var_x59);
        const double var_x61 = var_x59 * var_x60;
        const double var_x62 = exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        const double var_x63 = 20.0 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x64 = 40.0 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x65 = var_x60 * var_x62 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
        const double var_x66 = pow(var_chaste_interface__calcium_subsystem__Ca_SS, 3.0);
        const double var_x67 = 48600000000.0 * var_x66 * var_chaste_interface__calcium_subsystem__P_C1;
        const double var_x68 = 12150000000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 4.0);
        const double var_x69 = 121500000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 2.0) * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x70 = 40500000.0 * var_x66;
        const double var_x71 = 0.037573302761014088 * var_chaste_interface__membrane__V;
        const double var_x72 = exp(var_x71);
        const double var_x73 = 2.2327118354803037e-8 * var_chaste_interface__L_type_Ca_channel_y_gate__y * var_chaste_interface__membrane__V / ((1.0 - 107.25680748803607 * var_x44) * (-1.0 + var_x72));
        const double var_x74 = var_x73 * (-var_chaste_interface__ionic_concentrations__Ko + var_x72 * var_chaste_interface__ionic_concentrations__Ki);
        const double var_x75 = -var_x74;
        const double var_x76 = 1 / (var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai);
        const double var_x77 = 140.0 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x78 = log(var_x76 * var_x77);
        const double var_x79 = exp(var_x71 - 1.0 * var_x78);
        const double var_x80 = 0.75 * var_x79;
        const double var_x81 = var_x80 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x82 = var_x81 - 0.75 * var_chaste_interface__ionic_concentrations__Ko;
        const double var_x83 = -1.0 + var_x79;
        const double var_x84 = 1 / var_x83;
        const double var_x85 = -26.614641953637257 * var_x78 + var_chaste_interface__membrane__V;
        const double var_x86 = 1.0 + 1.7279999999999996e-9 / var_x38;
        const double var_x87 = 2.0255161771477306e-16 * var_x84 * var_x85 / (pow(var_x86, 2) * pow(var_chaste_interface__calcium_subsystem__Cai, 4));
        const double var_x88 = var_x82 * var_x87;
        const double var_x89 = 1 / var_chaste_interface__ionic_concentrations__Ki;
        const double var_x90 = 1.3521568226207399e-5 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V));
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = 1 / (0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki);
        const double var_x93 = sqrt(var_chaste_interface__ionic_concentrations__Ko);
        const double var_x94 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2) / (1.0 + exp(-1.7526479750778814 + 0.031152647975077882 * var_chaste_interface__membrane__V));
        const double var_x95 = 7.9270016169768288e-5 * var_x93 * var_x94;
        const double var_x96 = var_x92 * var_x95;
        const double var_x97 = 1 / var_x86;
        const double var_x98 = var_x84 * var_x97;
        const double var_x99 = 3.9072457120905308e-8 * var_x85;
        const double var_x100 = var_x98 * var_x99;
        const double var_x101 = var_x100 * (var_x80 + var_x76 * var_x81);
        const double var_x102 = log(var_x89 * var_chaste_interface__ionic_concentrations__Ko);
        const double var_x103 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3475921059424856 * var_x102);
        const double var_x104 = 1.0 + var_x103;
        const double var_x105 = 1 / var_x104;
        const double var_x106 = 0.0005376025032790136 * var_x105;
        const double var_x107 = exp(-2.4444678999999998 + 13.687910356755641 * var_x102 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x108 = 1.0 + var_x107;
        const double var_x109 = 1 / var_x108;
        const double var_x110 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x102);
        const double var_x111 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x102);
        const double var_x112 = var_x111 + 0.49124000000000001 * var_x110;
        const double var_x113 = var_x109 * var_x112;
        const double var_x114 = 1 / (var_x113 + 1.02 * var_x105);
        const double var_x115 = var_x114 * var_x89 * var_x93;
        const double var_x116 = var_x106 * var_x115;
        const double var_x117 = 1.0501178736126389 * var_x110;
        const double var_x118 = 1.6434541406371006 * var_x111;
        const double var_x119 = var_x103 / pow(var_x104, 2);
        const double var_x120 = 6.4745439480613349 * var_x119;
        const double var_x121 = 13.687910356755641 * var_x107 * var_x112 / pow(var_x108, 2);
        const double var_x122 = -26.614641953637257 * var_x102 + var_chaste_interface__membrane__V;
        const double var_x123 = var_x105 * var_x122;
        const double var_x124 = 1.9415130354461213e-5 * var_x123 * var_x93 / pow((var_x105 + 0.98039215686274506 * var_x113), 2);
        const double var_x125 = var_x124 * (var_x120 * var_x89 - var_x109 * (var_x117 * var_x89 + var_x118 * var_x89) - var_x121 * var_x89);
        const double var_x126 = 0.00012821819703204474 * var_x119 * var_x122;
        const double var_x127 = var_x115 * var_x126;
        const double var_x128 = var_x49 * var_x73;
        const double var_x129 = var_x128 * var_x72;
        const double var_x130 = 1.0398994565217392e-6 * var_x98;
        const double var_x131 = var_x76 * var_x82;
        const double var_x132 = var_x130 * var_x131;
        const double var_x133 = var_x79 * var_x97 * var_x99 / pow(var_x83, 2);
        const double var_x134 = var_x131 * var_x133;
        const double var_x135 = var_x134 - var_x132;
        const double var_x136 = 1 / var_chaste_interface__ionic_concentrations__Ko;
        const double var_x137 = var_x136 * var_x90;
        const double var_x138 = 1 / (1.5 + var_chaste_interface__ionic_concentrations__Ko);
        const double var_x139 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x140 = pow(var_x139, 1.5);
        const double var_x141 = 1 / (1.0 + 0.1245 * exp(-0.0037573302761014088 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x71));
        const double var_x142 = var_x141 / (1.0 + 31.622776601683793 * var_x140);
        const double var_x143 = var_x138 * var_x142;
        const double var_x144 = 0.00015953260140026533 * var_x143;
        const double var_x145 = 1 / var_x93;
        const double var_x146 = var_x114 * var_x145;
        const double var_x147 = var_x106 * var_x146;
        const double var_x148 = 1 / var_x77;
        const double var_x149 = var_x130 * var_x148;
        const double var_x150 = var_x149 * var_x82;
        const double var_x151 = 2.5661999999999998 + var_chaste_interface__ionic_concentrations__Ko;
        const double var_x152 = var_x95 / var_x151;
        const double var_x153 = 1.0099750810390723e-5 * var_x123 * var_x146;
        const double var_x154 = var_x100 * (-0.75 - var_x148 * var_x81);
        const double var_x155 = var_x142 * var_chaste_interface__ionic_concentrations__Ko / pow((1 + 0.66666666666666663 * var_chaste_interface__ionic_concentrations__Ko), 2);
        const double var_x156 = 7.090337840011793e-5 * var_x155;
        const double var_x157 = 1.4892181587085931e-6 * var_x145 * var_x94 * (-26.614641953637257 * log(var_x151 * var_x92) + var_chaste_interface__membrane__V);
        const double var_x158 = var_x126 * var_x146;
        const double var_x159 = var_x124 * (var_x121 * var_x136 - var_x109 * (-var_x117 * var_x136 - var_x118 * var_x136) - var_x120 * var_x136);
        const double var_x160 = var_x133 * var_x148;
        const double var_x161 = var_x160 * var_x82;
        const double var_x162 = 1.4530193963918526e-6 * var_x92 * var_x93 * var_x94;
        const double var_x163 = var_x138 * var_x139 * var_x140 * var_x141 * var_chaste_interface__ionic_concentrations__Ko / pow((0.031622776601683791 + var_x140), 2);
        const double var_x164 = 7.5672957221490862e-6 * var_x163;
        const double var_x165 = 2.9304342840678981e-8 * var_x79 * var_x85 * var_x98;
        const double var_x166 = var_x165 * var_x76;
        const double var_x167 = var_x166 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x168 = var_x132 - var_x134;
        const double var_x169 = var_x80 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x170 = -105.0 + var_x169;
        const double var_x171 = var_x170 * var_x76;
        const double var_x172 = var_x133 * var_x171 - var_x130 * var_x171;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (var_x29 * (-0.029002320185614851 - var_x30 - var_x31) + 0.16666666666666666 * (0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_NSR - 1.8 * var_x32 - 0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_JSR) / (pow(var_x27, 3) * pow((0.083333333333333329 + var_x28), 2))));
        rJacobian[12][13] = -(mDt * (0.029002320185614851 * var_x29));
        rJacobian[12][14] = -(mDt * (var_x29 * (var_x30 + var_x31)));
        rJacobian[12][15] = 0.0;
        rJacobian[12][16] = 0.0;
        rJacobian[12][17] = 0.0;
        rJacobian[12][18] = 0.0;
        ...
        rJacobian[13][14] = 0.0;
        rJacobian[13][15] = -(mDt * (0.00071604938271604935 + 0.044444444444444439 * var_x37 - 0.044444444444444439 * var_x39));
        rJacobian[13][16] = 0.0;
        rJacobian[13][17] = 0.0;
        rJacobian[13][18] = 0.0;
        rJacobian[13][19] = 0.0;
        ...
        rJacobian[14][8] = 0.0;
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = -(mDt * (var_x46));
        rJacobian[14][11] = -(mDt * (var_x46));
        rJacobian[14][12] = -(mDt * (var_x42 * (var_x47 + var_x48)));
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (var_x42 * (-5490.7343857240912 - var_x47 - var_x48) + 0.00023800000000000004 * (143.30816746739879 * var_x32 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x45 * var_x49) / (pow(var_x40, 3) * pow(var_x41, 2))));
        rJacobian[14][15] = -(mDt * (5490.7343857240912 * var_x42));
        rJacobian[14][16] = 0.0;
        rJacobian[14][17] = 0.0;
        rJacobian[14][18] = 0.0;
        rJacobian[14][19] = 0.0;
        rJacobian[14][20] = -(mDt * (var_x50));
        rJacobian[14][21] = -(mDt * (var_x50));
        rJacobian[14][22] = 0.0;
        rJacobian[14][23] = 0.0;
        rJacobian[14][24] = 0.0;
        rJacobian[15][0] = 0.0;
        ...
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = -(mDt * (5.8e-5 * var_x53));
        rJacobian[15][14] = -(mDt * (0.32000000000000001 * var_x53));
        rJacobian[15][15] = 1.0 - (mDt * (var_x53 * (-5.9200580000000009 + var_x54 + var_x55 - var_x57 + 0.0035999999999999999 * var_x39 - 0.0035999999999999999 * var_x37 - 0.077544234316921451 * var_x61 - 2.4626237783962268e-6 * var_x58 + 3.5281248386597142e-5 * var_chaste_interface__calcium_subsystem__Cai / pow(var_x56, 2)) + 0.00023800000000000004 * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(1.8 * var_x58) - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x57 * var_chaste_interface__calcium_subsystem__Cai - var_x63 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x64 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.8259560611122977e-8 * var_x60 * (1.8 * var_x62 * pow(var_chaste_interface__ionic_concentrations__Nai, 3) - 2744000.0 * var_x59 * var_chaste_interface__calcium_subsystem__Cai) - 0.0018 * var_x34 * var_x36) / (pow(var_x51, 3) * pow(var_x52, 2))));
        rJacobian[15][16] = -(mDt * (var_x53 * (6.6000000000000005e-5 + var_x63)));
        rJacobian[15][17] = -(mDt * (var_x53 * (0.040000000000000001 + var_x64)));
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        rJacobian[15][20] = 0.0;
        rJacobian[15][21] = 0.0;
        rJacobian[15][22] = 0.0;
        rJacobian[15][23] = 0.0;
        rJacobian[15][24] = -(mDt * (1.5260162730006407e-7 * var_x53 * var_x65));
        rJacobian[16][0] = 0.0;
        rJacobian[16][1] = 0.0;
        rJacobian[16][2] = 0.0;
        rJacobian[16][3] = 0.0;
        ...
        rJacobian[16][13] = 0.0;
        rJacobian[16][14] = 0.0;
        rJacobian[16][15] = -(mDt * (2.8000000000000003 - var_x54));
        rJacobian[16][16] = 1.0 - (mDt * (-6.6000000000000005e-5 - var_x63));
        rJacobian[16][17] = 0.0;
        rJacobian[16][18] = 0.0;
        rJacobian[16][19] = 0.0;
        rJacobian[16][20] = 0.0;
        ...
        rJacobian[17][13] = 0.0;
        rJacobian[17][14] = 0.0;
        rJacobian[17][15] = -(mDt * (2.8000000000000003 - var_x55));
        rJacobian[17][16] = 0.0;
        rJacobian[17][17] = 1.0 - (mDt * (-0.040000000000000001 - var_x64));
        rJacobian[17][18] = 0.0;
        rJacobian[17][19] = 0.0;
        rJacobian[17][20] = 0.0;
        rJacobian[17][21] = 0.0;
        ...
        rJacobian[18][12] = 0.0;
        rJacobian[18][13] = 0.0;
        rJacobian[18][14] = -(mDt * (-var_x67));
        rJacobian[18][15] = 0.0;
        rJacobian[18][16] = 0.0;
        rJacobian[18][17] = 0.0;
        rJacobian[18][18] = 1.0 - (mDt * (-var_x68));
        rJacobian[18][19] = 0.0;
        ...
        rJacobian[20][12] = 0.0;
        rJacobian[20][13] = 0.0;
        rJacobian[20][14] = -(mDt * (var_x67 - var_x69));
        rJacobian[20][15] = 0.0;
        rJacobian[20][16] = 0.0;
        rJacobian[20][17] = 0.0;
        rJacobian[20][18] = -(mDt * (var_x68));
        rJacobian[20][19] = -(mDt * (0.00080000000000000004));
        rJacobian[20][20] = 1.0 - (mDt * (-0.16049999999999998 - var_x70));
        ...
        rJacobian[21][12] = 0.0;
        rJacobian[21][13] = 0.0;
        rJacobian[21][14] = -(mDt * (var_x69));
        rJacobian[21][15] = 0.0;
        rJacobian[21][16] = 0.0;
        rJacobian[21][17] = 0.0;
        rJacobian[21][18] = 0.0;
        rJacobian[21][19] = 0.0;
        rJacobian[21][20] = -(mDt * (var_x70));
        ...
        rJacobian[22][8] = 0.0;
        rJacobian[22][9] = 0.0;
        rJacobian[22][10] = -(mDt * (var_x75));
        rJacobian[22][11] = -(mDt * (var_x75));
        rJacobian[22][12] = 0.0;
        rJacobian[22][13] = 0.0;
        rJacobian[22][14] = 0.0;
        rJacobian[22][15] = -(mDt * (-var_x88));
        rJacobian[22][16] = 0.0;
        rJacobian[22][17] = 0.0;
        rJacobian[22][18] = 0.0;
        rJacobian[22][19] = 0.0;
        rJacobian[22][20] = 0.0;
        rJacobian[22][21] = 0.0;
        rJacobian[22][22] = 1.0 - (mDt * (var_x127 + var_x135 - var_x101 - var_x116 - var_x125 - var_x129 - var_x91 - var_x96));
        rJacobian[22][23] = -(mDt * (var_x128 + var_x137 + var_x144 + var_x147 + var_x150 + var_x152 - var_x153 - var_x154 - var_x156 - var_x157 - var_x158 - var_x159 - var_x161));
        rJacobian[22][24] = -(mDt * (var_x135 + var_x164 - var_x162 - var_x167));
        rJacobian[23][0] = 0.0;
        rJacobian[23][1] = 0.0;
        rJacobian[23][2] = 0.0;
        rJacobian[23][3] = 0.0;
        ...
        rJacobian[23][8] = 0.0;
        rJacobian[23][9] = 0.0;
        rJacobian[23][10] = -(mDt * (var_x74));
        rJacobian[23][11] = -(mDt * (var_x74));
        rJacobian[23][12] = 0.0;
        rJacobian[23][13] = 0.0;
        rJacobian[23][14] = 0.0;
        rJacobian[23][15] = -(mDt * (var_x88));
        rJacobian[23][16] = 0.0;
        rJacobian[23][17] = 0.0;
        rJacobian[23][18] = 0.0;
        rJacobian[23][19] = 0.0;
        rJacobian[23][20] = 0.0;
        rJacobian[23][21] = 0.0;
        rJacobian[23][22] = -(mDt * (var_x101 + var_x116 + var_x125 + var_x129 + var_x168 + var_x91 + var_x96 - var_x127));
        rJacobian[23][23] = 1.0 - (mDt * (var_x153 + var_x154 + var_x156 + var_x157 + var_x158 + var_x159 + var_x161 - var_x128 - var_x137 - var_x144 - var_x147 - var_x150 - var_x152));
        rJacobian[23][24] = -(mDt * (var_x162 + var_x167 + var_x168 - var_x164));
        rJacobian[24][0] = 0.0;
        rJacobian[24][1] = 0.0;
        rJacobian[24][2] = 0.0;
        rJacobian[24][3] = 0.0;
        ...
        rJacobian[24][13] = 0.0;
        rJacobian[24][14] = 0.0;
        rJacobian[24][15] = -(mDt * (0.23263270295076435 * var_x61 - var_x170 * var_x87));
        rJacobian[24][16] = 0.0;
        rJacobian[24][17] = 0.0;
        rJacobian[24][18] = 0.0;
        rJacobian[24][19] = 0.0;
        rJacobian[24][20] = 0.0;
        rJacobian[24][21] = 0.0;
        rJacobian[24][22] = -(mDt * (var_x172 - var_x166 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[24][23] = -(mDt * (0.00010635506760017689 * var_x155 - 0.000239298902100398 * var_x143 + var_x149 * var_x170 - var_x160 * var_x170 + var_x148 * var_x165 * var_chaste_interface__ionic_concentrations__Nai));
        rJacobian[24][24] = 1.0 - (mDt * (var_x172 - 1.1350943583223629e-5 * var_x163 - 4.5780488190019227e-7 * var_x65 - 2.3025858935932891e-6 * var_x139 - var_x100 * (var_x80 + var_x169 * var_x76) - 0.020902907402832696 * var_x139 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
