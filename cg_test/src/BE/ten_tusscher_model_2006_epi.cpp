...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.011750408368292439 * var_x62 - 0.0016876848753885161 * var_x53 * var_x61 - 4.5587787568311439e-5 * var_x49 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x61 * var_x63 * var_x64 - 0.00091800065377284671 * var_x49 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.00047773503410627734 * var_x49 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x53 * var_x63 * (-var_x56 * (2.6713760659695653 * var_x49 * var_x58 + 0.01602825639581739 * var_x49 * var_x57) + 0.16028256395817389 * var_x49 * var_x64 - 13.356880329847826 * var_x49 * var_x54 * var_x59 / pow(var_x55, 2)) / pow(var_x60, 2)));
        ...
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (5.0371257222730904e-7 * var_x67 - 9.0551084895961074e-7 * var_x68 - 1.823319832565245e-7 * var_x39 - 0.00080594011556369446 * var_x66 - 0.046330930954698972 * var_x68 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[10] = (var_chaste_interface__L_type_Ca_current_f2_gate__f2 + ((0.33000000000000002 / (80.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V)) + 0.67000000000000004 / (80.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V) + 80.0 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V) * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (80.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V))) * mDt));
        rY[9] = (var_chaste_interface__L_type_Ca_current_f_gate__f + ((1.0 / (20.0 + 20.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) + 200.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 - 0.23999999999999999 * var_chaste_interface__membrane__V - 0.0044444444444444444 * pow(var_chaste_interface__membrane__V, 2)) + 200.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) * exp(-3.2400000000000002 - 0.23999999999999999 * var_chaste_interface__membrane__V - 0.0044444444444444444 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-1 / (20.0 + 200.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 - 0.23999999999999999 * var_chaste_interface__membrane__V - 0.0044444444444444444 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
        rY[6] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * exp(0.34849999999999998 * var_chaste_interface__membrane__V) / (1.0 + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)) + 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) / (1.0 + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)) + 0.057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) / (1.0 + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V))) : (1.0 / (0.16883116883116883 + 0.16883116883116883 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 0.16883116883116883 * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V) + 0.33766233766233766 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + 0.16883116883116883 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V) + 0.33766233766233766 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (-310000.0 * exp(0.34849999999999998 * var_chaste_interface__membrane__V) - 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) - 0.057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (-1 / (0.16883116883116883 + 0.16883116883116883 * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))))) * mDt));
        rY[7] = (var_chaste_interface__fast_sodium_current_j_gate__j + ((((var_chaste_interface__membrane__V < -40.0) ? (0.024240000000000001 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 1.0 * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) - 960669.84000000008 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.00026249543999999999 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 25428.0 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 6.9480000000000002e-6 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))) : (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) + 1.0 * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) + pow(exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V), 2) * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V) + 2.0 * exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V) * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (960669.84000000008 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 0.00026249543999999999 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.024240000000000001 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) + 25428.0 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 6.9480000000000002e-6 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))) : (-0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt));
        rY[5] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((1.0 / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 * pow(exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 * pow(exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)) + 0.20000000000000001 * exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.20000000000000001 * exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V))) + 1.0 * exp(-12.0 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 * pow(exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 * pow(exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)) + 0.20000000000000001 * exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.20000000000000001 * exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-1.0 / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V))) - 1.0 * exp(-12.0 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)))) * mDt));
        ...
        rY[13] = (var_chaste_interface__transient_outward_current_r_gate__r + ((1.0 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V) + 0.80000000000000004 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V) + 9.5 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V) * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V))) * mDt));
        rY[12] = (var_chaste_interface__transient_outward_current_s_gate__s + ((1.0 / (3.0 + 3.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-6.328125 - 0.28125 * var_chaste_interface__membrane__V - 0.0031250000000000002 * pow(var_chaste_interface__membrane__V, 2)) + 5.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-6.328125 - 0.28125 * var_chaste_interface__membrane__V - 0.0031250000000000002 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-1 / (3.0 + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-6.328125 - 0.28125 * var_chaste_interface__membrane__V - 0.0031250000000000002 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
