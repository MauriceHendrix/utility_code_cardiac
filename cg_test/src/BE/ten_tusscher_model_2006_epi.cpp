...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        const double var_x4 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x5 = pow(var_x4, (-2));
        const double var_x6 = 1 / (1.0 + 3.0 * var_x5);
        const double var_x7 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x8 = 1 / (1.0 + 2.25 * var_x7);
        const double var_x9 = 1 / (2.5 - 1.5 * var_x8);
        const double var_x10 = var_x0 * var_x9;
        const double var_x11 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x10);
        const double var_x12 = var_x11 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x13 = var_x10 * var_x12;
        const double var_x14 = 0.015299999999999998 * var_x13;
        const double var_x15 = 1 / (pow((0.44444444444444442 + var_x7), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x16 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x17 = var_x16 / pow((1 - 0.59999999999999998 * var_x8), 2);
        const double var_x18 = var_x0 * var_x12 * var_x15 * var_x17;
        const double var_x19 = var_x15 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x20 = var_x17 / pow((0.40000000000000002 + var_x10), 2);
        const double var_x21 = var_x19 * var_x20 * var_x9 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x22 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x23 = 1 / var_x22;
        const double var_x24 = 1 / (pow(var_x22, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x25 = var_x20 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3) * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x26 = var_x12 * var_x16 * var_x9 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x27 = var_x10 * var_x11 * var_x16;
        const double var_x28 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        ...
        const double var_x32 = 7.2352122917848019e-6 / var_x31;
        ...
        const double var_x39 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x40 = 1.0 + 0.0001 / pow(var_x39, 2);
        const double var_x41 = 1 / var_x40;
        const double var_x42 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x43 = (-15.0 + var_chaste_interface__membrane__V) * mParameters[0] * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_f_gate__f / (-1.0 + var_x42);
        const double var_x44 = 253.30174843481757 * var_x43 * (-2.0 + 0.25 * var_x42 * var_chaste_interface__calcium_dynamics__Ca_ss);
        const double var_x45 = 0.30611192392099484 * var_x13;
        const double var_x46 = -0.11249999999999999 + 0.067500000000000004 * var_x8;
        const double var_x47 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x48 = log(5.4000000000000004 * var_x47);
        const double var_x49 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * var_x48);
        const double var_x50 = 1.0 + var_x49;
        const double var_x51 = 1 / var_x50;
        const double var_x52 = exp(13.356880329847826 * var_x48 - 0.5 * var_chaste_interface__membrane__V);
        const double var_x53 = 1.0 + var_x52;
        const double var_x54 = 1 / var_x53;
        const double var_x55 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391299 * var_x48);
        const double var_x56 = exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 2.6713760659695653 * var_x48);
        const double var_x57 = var_x56 + 3.0 * var_x55;
        const double var_x58 = 0.10000000000000001 * var_x51 + var_x54 * var_x57;
        const double var_x59 = var_x47 / var_x58;
        const double var_x60 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (0.0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        const double var_x61 = -26.713760659695652 * var_x48 + var_chaste_interface__membrane__V;
        const double var_x62 = var_x49 / pow(var_x50, 2);
        const double var_x63 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x64 = var_x63 / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x65 = var_x63 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        ...
        rJacobian[0][6] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (var_x6 * (-0.00036000000000000002 - var_x14 + 0.021759999999999998 * var_x21 - 0.0032639999999999995 * var_x18) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x23 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x14 * var_x16) / (pow(var_x4, 3) * pow((0.33333333333333337 + var_x5), 2))));
        rJacobian[1][2] = -(mDt * (var_x6 * (0.00036000000000000002 + 7.96875e-10 * var_x24)));
        rJacobian[1][3] = -(mDt * (var_x6 * (var_x14 + 0.032639999999999995 * var_x25 - 0.030599999999999995 * var_x26)));
        rJacobian[1][4] = -(mDt * (-0.015299999999999998 * var_x27 * var_x6));
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = 0.0;
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = -(mDt * (2.40087783467447e-5 * var_x30));
        rJacobian[2][2] = 1.0 - (mDt * (var_x30 * (-0.0038240087783467445 - var_x32 - 0.069488744729986562 * var_x36 - 5.3144431236283834e-11 * var_x24 - 4.6212277808973232e-7 * var_x33 + 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x31, 2)) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x33) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x23 - var_x32 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x35 * (2.0 * var_x37 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3) - 6860000.0 * var_x34 * var_chaste_interface__calcium_dynamics__Ca_i)) / (pow(var_x28, 3) * pow(var_x29, 2))));
        rJacobian[2][3] = -(mDt * (0.0038 * var_x30));
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (6.0777327752174836e-8 * var_x30 * var_x38));
        rJacobian[3][0] = -(mDt * (-var_x41 * var_x44));
        rJacobian[3][1] = -(mDt * (var_x41 * (var_x45 + 0.065303877103145572 * var_x18 - 0.43535918068763713 * var_x21)));
        rJacobian[3][2] = -(mDt * (1.1399999999999999 * var_x41));
        rJacobian[3][3] = 1.0 - (mDt * (var_x41 * (-1.1399999999999999 - var_x45 + 0.61222384784198969 * var_x26 - 0.65303877103145569 * var_x25 - 63.325437108704392 * var_x42 * var_x43 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x16 * var_x45 - var_x44 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) / (pow(var_x39, 3) * pow(var_x40, 2))));
        rJacobian[3][4] = -(mDt * (0.30611192392099484 * var_x27 * var_x41));
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = 0.0;
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = -(mDt * (0.059999999999999998 * var_x19 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = -(mDt * (var_x46 * var_chaste_interface__calcium_dynamics__R_prime));
        rJacobian[4][4] = 1.0 - (mDt * (-0.0050000000000000001 + var_x46 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.011750408368292439 * var_x60 - 0.0016876848753885161 * var_x51 * var_x59 - 4.5587787568311439e-5 * var_x47 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x59 * var_x61 * var_x62 - 0.0031224512033090025 * var_x47 * mParameters[2] * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x51 * var_x61 * (-var_x54 * (2.6713760659695653 * var_x47 * var_x56 + 0.01602825639581739 * var_x47 * var_x55) + 0.16028256395817389 * var_x47 * var_x62 - 13.356880329847826 * var_x47 * var_x52 * var_x57 / pow(var_x53, 2)) / pow(var_x58, 2) - 0.0031224512033090025 * var_x47 * mParameters[3] * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s));
        rJacobian[5][6] = -(mDt * (0.00053729341037579627 * var_x64 - 0.00035251225104877316 * var_x60 - 3.3580838148487267e-7 * var_x65));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = -(mDt * (0.20846623418995969 * var_x36));
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (5.0371257222730904e-7 * var_x65 - 9.0551084895961074e-7 * var_x66 - 1.823319832565245e-7 * var_x38 - 0.00080594011556369446 * var_x64 - 0.0031224512033090025 * var_x66 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * mParameters[1] * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
    }
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        const double var_fast_sodium_current_h_gate__h_inf = pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), (-2));
        ...
        const double var_fast_sodium_current_j_gate__j_inf = pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), (-2));
        ...
        const double var_fast_sodium_current_m_gate__m_inf = pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V)), (-2));
