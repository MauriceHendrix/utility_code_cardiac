...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        double var_chaste_interface__transient_outward_current_r_gate__r = rY[13];
        // Units: dimensionless; Initial value: 2.42e-08
        double var_chaste_interface__L_type_Ca_current_fCass_gate__fCass = rCurrentGuess[0];double var_chaste_interface__calcium_dynamics__Ca_SR = rCurrentGuess[1];double var_chaste_interface__calcium_dynamics__Ca_i = rCurrentGuess[2];double var_chaste_interface__calcium_dynamics__Ca_ss = rCurrentGuess[3];double var_chaste_interface__calcium_dynamics__R_prime = rCurrentGuess[4];double var_chaste_interface__potassium_dynamics__K_i = rCurrentGuess[5];double var_chaste_interface__sodium_dynamics__Na_i = rCurrentGuess[6];

        const double var_x0 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 2.0);
        const double var_x1 = 1 / (1.0 + 399.99999999999994 * var_x0);
        const double var_x2 = 1 / (2.0 + 80.0 * var_x1);
        const double var_x3 = pow(var_chaste_interface__calcium_dynamics__Ca_ss, 1.0);
        const double var_x4 = var_x3 / pow((0.0025000000000000005 + var_x0), 2);
        const double var_x5 = 1 / var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x6 = pow(var_x5, 2.0);
        const double var_x7 = 1 / (1.0 + 2.25 * var_x6);
        const double var_x8 = 1 / (2.5 - 1.5 * var_x7);
        const double var_x9 = var_x0 * var_x8;
        const double var_x10 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x9);
        const double var_x11 = var_x10 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x12 = var_x11 * var_x9;
        const double var_x13 = 0.015299999999999998 * var_x12;
        const double var_x14 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x15 = var_x14 / pow((1 - 0.59999999999999998 * var_x7), 2);
        const double var_x16 = var_x5 * var_x6 / pow((0.44444444444444442 + var_x6), 2);
        const double var_x17 = var_x0 * var_x11 * var_x15 * var_x16;
        const double var_x18 = var_x15 * var_chaste_interface__calcium_dynamics__R_prime / pow((0.40000000000000002 + var_x9), 2);
        const double var_x19 = var_x16 * var_x18 * var_x8 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4.0);
        const double var_x20 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x21 = pow(var_x20, (-2.0));
        const double var_x22 = 1 / (1.0 + 3.0 * var_x21);
        const double var_x23 = 1.0 * var_x22;
        const double var_x24 = 1.0 + 6.2499999999999997e-8 * pow(var_chaste_interface__calcium_dynamics__Ca_i, (-2.0));
        const double var_x25 = 1 / var_x24;
        const double var_x26 = var_x10 * var_x14 * var_x9;
        const double var_x27 = var_x18 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3.0);
        const double var_x28 = var_x11 * var_x14 * var_x3 * var_x8;
        const double var_x29 = pow(var_chaste_interface__calcium_dynamics__Ca_i, (-3.0)) / pow(var_x24, 2);
        const double var_x30 = -0.11249999999999999 + 0.067500000000000004 * var_x7;
        const double var_x31 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x32 = 1.0 + 0.0001 * pow(var_x31, (-2.0));
        const double var_x33 = 1 / var_x32;
        const double var_x34 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x35 = (-15.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_f_gate__f / (-1.0 + var_x34);
        const double var_x36 = 0.010081409587705739 * var_x35 * (-2.0 + 0.25 * var_x34 * var_chaste_interface__calcium_dynamics__Ca_ss);
        const double var_x37 = 0.30611192392099484 * var_x12;
        const double var_x38 = 1.0 * var_x33;
        const double var_x39 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x40 = 1.0 + 0.00020000000000000001 * pow(var_x39, (-2.0));
        const double var_x41 = 1 / var_x40;
        const double var_x42 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x43 = 7.2352122917848019e-6 / var_x42;
        const double var_x44 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x45 = exp(-0.024332029034784559 * var_chaste_interface__membrane__V);
        const double var_x46 = 1 / (1.0 + 0.10000000000000001 * var_x45);
        const double var_x47 = var_x45 * var_x46;
        const double var_x48 = exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x49 = var_x46 * var_x48 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2.0);
        const double var_x50 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        ...
        const double var_x54 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2.0) * (0.0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        const double var_x55 = 1 / var_chaste_interface__potassium_dynamics__K_i;
        const double var_x56 = log(5.4000000000000004 * var_x55);
        const double var_x57 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__membrane__V - 1.6028256395817388 * var_x56);
        const double var_x58 = 1.0 + var_x57;
        const double var_x59 = 1 / var_x58;
        const double var_x60 = exp(13.356880329847826 * var_x56 - 0.5 * var_chaste_interface__membrane__V);
        const double var_x61 = 1.0 + var_x60;
        const double var_x62 = 1 / var_x61;
        const double var_x63 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391299 * var_x56);
        const double var_x64 = exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 2.6713760659695653 * var_x56);
        const double var_x65 = var_x64 + 3.0 * var_x63;
        const double var_x66 = 0.10000000000000001 * var_x59 + var_x62 * var_x65;
        const double var_x67 = var_x55 / var_x66;
        const double var_x68 = -26.713760659695652 * var_x56 + var_chaste_interface__membrane__V;
        const double var_x69 = var_x57 / pow(var_x58, 2);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-var_x2));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (-0.0030000000000000001 * var_x2 * var_x4 + 6.2500000000000001e-5 * var_x4 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x1) / pow((0.025000000000000001 + var_x1), 2)));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (var_x23 * (-0.00036000000000000002 - var_x13 + 0.021759999999999998 * var_x19 - 0.0032639999999999995 * var_x17) + 0.66666666666666674 * pow(var_x20, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x25 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x13 * var_x14) / pow((0.33333333333333337 + var_x21), 2)));
        rJacobian[1][2] = -(mDt * (-0.015299999999999998 * var_x22 * var_x26));
        rJacobian[1][3] = -(mDt * (var_x23 * (var_x13 + 0.032639999999999995 * var_x27 - 0.030599999999999995 * var_x28)));
        rJacobian[1][4] = -(mDt * (var_x23 * (0.00036000000000000002 + 7.96875e-10 * var_x29)));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0.059999999999999998 * var_x16 * var_chaste_interface__calcium_dynamics__Ca_ss * var_chaste_interface__calcium_dynamics__R_prime));
        rJacobian[2][2] = 1.0 -(mDt * (-0.0050000000000000001 + var_x30 * var_chaste_interface__calcium_dynamics__Ca_ss));
        rJacobian[2][3] = -(mDt * (var_x30 * var_chaste_interface__calcium_dynamics__R_prime));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (-var_x33 * var_x36));
        rJacobian[3][1] = -(mDt * (var_x38 * (var_x37 + 0.065303877103145572 * var_x17 - 0.43535918068763713 * var_x19)));
        rJacobian[3][2] = -(mDt * (0.30611192392099484 * var_x26 * var_x33));
        rJacobian[3][3] = 1.0 -(mDt * (var_x38 * (-1.1399999999999999 - var_x37 + 0.61222384784198969 * var_x28 - 0.65303877103145569 * var_x27 - 0.0025203523969264349 * var_x34 * var_x35 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) + 0.00020000000000000001 * pow(var_x31, (-3.0)) * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x14 * var_x37 - var_x36 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass) / pow(var_x32, 2)));
        rJacobian[3][4] = -(mDt * (1.1399999999999999 * var_x33));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (2.40087783467447e-5 * var_x41));
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0.0038 * var_x41));
        rJacobian[4][4] = 1.0 -(mDt * (1.0 * var_x41 * (-0.0038240087783467445 - var_x43 - 0.069488744729986562 * var_x47 - 5.3144431236283834e-11 * var_x29 - 4.6212277808973232e-7 * var_x44 + 7.2352122917848019e-6 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x42, 2)) + 0.00040000000000000002 * pow(var_x39, (-3.0)) * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x44) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x25 - var_x43 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x46 * (2.0 * var_x48 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0) - 6860000.0 * var_x45 * var_chaste_interface__calcium_dynamics__Ca_i)) / pow(var_x40, 2)));
        rJacobian[4][5] = -(mDt * (6.0777327752174836e-8 * var_x41 * var_x49));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0.20846623418995969 * var_x47));
        rJacobian[5][5] = 1.0 -(mDt * (5.0371257222730904e-7 * var_x53 - 9.0551084895961074e-7 * var_x50 - 1.823319832565245e-7 * var_x49 - 0.00080594011556369446 * var_x52 - 0.046330930954698972 * var_x50 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0.00053729341037579627 * var_x52 - 0.00035251225104877316 * var_x54 - 3.3580838148487267e-7 * var_x53));
        rJacobian[6][6] = 1.0 -(mDt * (-0.011750408368292439 * var_x54 - 0.0016876848753885161 * var_x59 * var_x67 - 4.5587787568311439e-5 * var_x55 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x67 * var_x68 * var_x69 - 0.00091800065377284671 * var_x55 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.00047773503410627734 * var_x55 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x59 * var_x68 * (-var_x62 * (2.6713760659695653 * var_x55 * var_x64 + 0.01602825639581739 * var_x55 * var_x63) + 0.16028256395817389 * var_x55 * var_x69 - 13.356880329847826 * var_x55 * var_x60 * var_x65 / pow(var_x61, 2)) / pow(var_x66, 2)));
    }
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[8] = (var_chaste_interface__L_type_Ca_current_d_gate__d + ((1.0 / (1.0 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.34999999999999998 / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 1.9599999999999997 / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V)) + 1.0 * exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.34999999999999998 * exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 1.9599999999999997 * exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-1 / (1.0 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.34999999999999998 / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 1.9599999999999997 / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V)))) * mDt));
        rY[10] = (var_chaste_interface__L_type_Ca_current_f2_gate__f2 + ((0.33000000000000002 / (80.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0))) + 0.67000000000000004 / (80.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)) + 80.0 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)) * exp(5.0 + 0.14285714285714285 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (80.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 31.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 562.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[9] = (var_chaste_interface__L_type_Ca_current_f_gate__f + ((1.0 / (20.0 + 20.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) + 200.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)) + 200.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)) * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (20.0 + 200.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 180.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1102.5 * exp(-3.2400000000000002 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[6] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((((var_chaste_interface__membrane__V < -40.0) ? (310000.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), (-2.0)) * exp(0.34849999999999998 * var_chaste_interface__membrane__V) + 2.7000000000000002 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), (-2.0)) * exp(0.079000000000000001 * var_chaste_interface__membrane__V) + 0.057000000000000002 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), (-2.0)) * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (1.0 / (0.16883116883116883 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + 0.16883116883116883 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (-310000.0 * exp(0.34849999999999998 * var_chaste_interface__membrane__V) - 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) - 0.057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (-1 / (0.16883116883116883 + 0.16883116883116883 * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))))) * mDt));
        rY[7] = (var_chaste_interface__fast_sodium_current_j_gate__j + ((((var_chaste_interface__membrane__V < -40.0) ? (0.024240000000000001 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) - 960669.84000000008 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.00026249543999999999 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 25428.0 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 6.9480000000000002e-6 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))) : (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V)), 2.0) * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (960669.84000000008 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 0.00026249543999999999 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.024240000000000001 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) + 25428.0 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 6.9480000000000002e-6 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))) : (-0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt));
        rY[5] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((1.0 / (0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V)), 2.0) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V)), 2.0) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V))) + 1.0 * exp(-12.0 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V)), 2.0) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V)), 2.0) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-1.0 / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V))) - 1.0 * exp(-12.0 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V)))) * mDt));
        rY[2] = (var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + ((0.00037037037037037035 / (1.0 + exp(-3.7142857142857144 - 0.14285714285714285 * var_chaste_interface__membrane__V)) + 0.00037037037037037035 * exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.7142857142857144 - 0.14285714285714285 * var_chaste_interface__membrane__V)) + 0.00037037037037037035 * exp(-4.5 - 0.10000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.7142857142857144 - 0.14285714285714285 * var_chaste_interface__membrane__V)) + 0.00037037037037037035 * exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.10000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.7142857142857144 - 0.14285714285714285 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.00037037037037037035 - 0.00037037037037037035 * exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V) - 0.00037037037037037035 * exp(-4.5 - 0.10000000000000001 * var_chaste_interface__membrane__V) - 0.00037037037037037035 * exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) * mDt));
        rY[3] = (var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + ((0.29761904761904762 / (1.0 + exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V)) + 0.29761904761904762 * exp(-3.0 + 0.050000000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V)) + 0.29761904761904762 * exp(-3.0 - 0.050000000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V)) + 0.29761904761904762 * exp(-3.0 + 0.050000000000000003 * var_chaste_interface__membrane__V) * exp(-3.0 - 0.050000000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.29761904761904762 - 0.29761904761904762 * exp(-3.0 + 0.050000000000000003 * var_chaste_interface__membrane__V) - 0.29761904761904762 * exp(-3.0 - 0.050000000000000003 * var_chaste_interface__membrane__V) - 0.29761904761904762 * exp(-3.0 + 0.050000000000000003 * var_chaste_interface__membrane__V) * exp(-3.0 - 0.050000000000000003 * var_chaste_interface__membrane__V)) * mDt));
        rY[4] = (var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + ((1.0 / (80.0 + 80.0 * exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V) + 1400.0 / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V)) + 1400.0 * exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V) / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-1 / (80.0 + 1400.0 / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V)))) * mDt));
        rY[13] = (var_chaste_interface__transient_outward_current_r_gate__r + ((1.0 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) + 0.80000000000000004 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V) + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[12] = (var_chaste_interface__transient_outward_current_s_gate__s + ((1.0 / (3.0 + 3.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)) + 5.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)) * exp(4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (3.0 + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
