...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.0073440052301827737 * var_x45 - 0.0016876848753885161 * var_x49 * var_x57 - 4.5587787568311439e-5 * var_x44 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x57 * var_x58 * var_x59 - 0.00029975531551766426 * var_x44 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 0.00022793893784155717 * var_x44 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 6.3176611368492499e-5 * var_x49 * var_x58 * (-var_x52 * (2.6713760659695653 * var_x44 * var_x54 + 0.01602825639581739 * var_x44 * var_x53) + 0.16028256395817389 * var_x44 * var_x59 - 13.356880329847826 * var_x44 * var_x50 * var_x55 / pow(var_x51, 2)) / pow(var_x56, 2)));
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[9] = (var_chaste_interface__L_type_Ca_current_f_gate__f + ((1.0 / (80.0 + 80.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) + 165.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V) + 165.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (80.0 + 165.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(-3.0375000000000001 - 0.0041666666666666666 * pow(var_chaste_interface__membrane__V, 2) - 0.22500000000000001 * var_chaste_interface__membrane__V))) * mDt));
        ...
        rY[12] = (var_chaste_interface__transient_outward_current_r_gate__r + ((1.0 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V) + 0.80000000000000004 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V) + 9.5 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V) * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 - 0.00055555555555555556 * pow(var_chaste_interface__membrane__V, 2) - 0.044444444444444446 * var_chaste_interface__membrane__V))) * mDt));
        rY[11] = (var_chaste_interface__transient_outward_current_s_gate__s + ((1.0 / (8.0 + 8.0 * exp(5.5999999999999996 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1000.0 * exp(-4.4889999999999999 - 0.001 * pow(var_chaste_interface__membrane__V, 2) - 0.13400000000000001 * var_chaste_interface__membrane__V) + 1000.0 * exp(5.5999999999999996 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-4.4889999999999999 - 0.001 * pow(var_chaste_interface__membrane__V, 2) - 0.13400000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (8.0 + 1000.0 * exp(-4.4889999999999999 - 0.001 * pow(var_chaste_interface__membrane__V, 2) - 0.13400000000000001 * var_chaste_interface__membrane__V))) * mDt));
