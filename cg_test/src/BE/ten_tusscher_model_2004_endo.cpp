...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        rJacobian[5][5] = 1.0 -(mDt * (-0.0073440052301827737 * var_x48 - 0.0016876848753885161 * var_x53 * var_x61 - 4.5587787568311439e-5 * var_x49 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x61 * var_x62 * var_x63 - 0.00029975531551766426 * var_x49 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 0.00022793893784155717 * var_x49 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 6.3176611368492499e-5 * var_x53 * var_x62 * (-var_x56 * (2.6713760659695653 * var_x49 * var_x58 + 0.01602825639581739 * var_x49 * var_x57) + 0.16028256395817389 * var_x49 * var_x63 - 13.356880329847826 * var_x49 * var_x54 * var_x59 / pow(var_x55, 2)) / pow(var_x60, 2)));
    }
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[11] = (var_chaste_interface__transient_outward_current_s_gate__s + ((1.0 / (8.0 + 8.0 * exp(5.5999999999999996 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1000.0 * exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2.0)) + 1000.0 * exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2.0)) * exp(5.5999999999999996 + 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (8.0 + 1000.0 * exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
