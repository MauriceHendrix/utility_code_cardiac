...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        double var_chaste_interface__IKr_Xr_gate__Xr = rY[10];
        // Units: dimensionless; Initial value: 0.000215523048438941
        double var_chaste_interface__Ionic_concentrations__Ca_JSR = rCurrentGuess[0];double var_chaste_interface__Ionic_concentrations__Ca_NSR = rCurrentGuess[1];double var_chaste_interface__Ionic_concentrations__Cai = rCurrentGuess[2];double var_chaste_interface__Ionic_concentrations__Ki = rCurrentGuess[3];double var_chaste_interface__Ionic_concentrations__Nai = rCurrentGuess[4];double var_chaste_interface__Irel__APtrack = rCurrentGuess[5];double var_chaste_interface__Irel__APtrack2 = rCurrentGuess[6];double var_chaste_interface__Irel__Cainfluxtrack = rCurrentGuess[8];

        const double var_x0 = (var_chaste_interface__Irel__APtrack > 0.17999999999999999) && (var_chaste_interface__Irel__APtrack < 0.20000000000000001);
        ...
        const double var_x4 = -var_chaste_interface__Ionic_concentrations__Cai + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x5 = var_x2 * var_x3 * var_x4;
        const double var_x6 = 22.0 * var_x5;
        const double var_x7 = var_x6 * var_chaste_interface__Irel__APtrack2;
        const double var_x8 = 1.0 - var_chaste_interface__Irel__APtrack2;
        const double var_x9 = 0.80000000000000004 + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x10 = pow(var_x9, (-2.0));
        const double var_x11 = 1 / (1.0 + 8.0 * var_x10);
        const double var_x12 = 1.0 * var_x11;
        const double var_x13 = var_chaste_interface__Irel__Cainfluxtrack > 5.0000000000000004e-6;
        const double var_x14 = var_x8 * var_chaste_interface__Irel__APtrack2;
        const double var_x15 = var_x14 * var_x2;
        const double var_x16 = 22.0 * var_x15;
        const double var_x17 = var_x16 * var_x3;
        const double var_x18 = 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x19 = 0.25 * pow(var_x9, (-3.0)) / pow((0.125 + var_x10), 2);
        const double var_x20 = 0.0055555555555555558 * var_x11;
        const double var_x21 = var_x14 * var_x3 * var_x4 / pow(var_x1, 2);
        const double var_x22 = var_chaste_interface__Irel__APtrack > 0.20000000000000001;
        const double var_x23 = 1 / M_PI;
        const double var_x24 = exp(-0.024321106718724127 * var_chaste_interface__cell__V);
        const double var_x25 = 1 / (1.0 + 0.10000000000000001 * var_x24);
        const double var_x26 = exp(0.013095980540851452 * var_chaste_interface__cell__V);
        const double var_x27 = var_x25 * var_x26 * pow(var_chaste_interface__Ionic_concentrations__Nai, 2.0);
        const double var_x28 = var_x23 * var_x27;
        const double var_x29 = var_x24 * var_x25;
        ...
        const double var_x32 = var_chaste_interface__ICa_d_gate__d * var_chaste_interface__ICa_f_gate__f;
        const double var_x33 = var_x32 / var_x31;
        const double var_x34 = log(2.0 * var_x30);
        const double var_x35 = 3.8399999999999998e-5 * var_chaste_interface__cell__V - 0.00051313454376613558 * var_x34;
        const double var_x36 = 0.011358446932323314 * var_x30 + 0.00051313454376613558 * var_x30 * var_x33 - var_x32 * var_x35 / pow(var_x31, 2);
        const double var_x37 = 9.661256841321762e-5 * var_x23;
        const double var_x38 = 1 / var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x39 = pow(var_x38, 1.5);
        const double var_x40 = 1 / (1.0 + 0.1245 * exp(-0.0037417087259575582 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.037417087259575585 * var_chaste_interface__cell__V));
        const double var_x41 = var_x38 * var_x39 * var_x40 / pow((0.031622776601683791 + var_x39), 2);
        const double var_x42 = pow(var_chaste_interface__INa_m_gate__m, 3.0) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j;
        const double var_x43 = 0.00019322513682643524 * var_x23;
        const double var_x44 = 0.00092000000000000003 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x45 = 1 / var_x44;
        const double var_x46 = var_chaste_interface__Ionic_concentrations__Cai / pow(var_x44, 2);
        const double var_x47 = 0.1552941176470588 * var_x5;
        const double var_x48 = 0.0023800000000000002 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x49 = 0.00050000000000000001 + var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x50 = 1.0 + 0.00011900000000000002 * pow(var_x48, (-2.0)) + 3.5000000000000004e-5 * pow(var_x49, (-2.0));
        const double var_x51 = 1 / var_x50;
        const double var_x52 = 1.0 * var_x51;
        const double var_x53 = 0.1552941176470588 * var_x15;
        const double var_x54 = var_x3 * var_x53;
        const double var_x55 = 0.00036529411764705876 * var_x45;
        const double var_x56 = -var_x55 + 0.00036529411764705876 * var_x46 - var_x37 * (var_x36 + 471.5206420294254 * var_x29);
        const double var_x57 = var_x25 * (2.0 * var_x26 * pow(var_chaste_interface__Ionic_concentrations__Nai, 3.0) - 2628072.0 * var_x24 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x58 = -0.011358446932323314 * var_x34 + var_x33 * var_x35;
        const double var_x59 = 2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR - var_x37 * (var_x58 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x57) - var_x55 * var_chaste_interface__Ionic_concentrations__Cai;
        const double var_x60 = 1.0 * (0.00023800000000000004 * pow(var_x48, (-3.0)) + 7.0000000000000007e-5 * pow(var_x49, (-3.0))) / pow(var_x50, 2);
        const double var_x61 = pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0);
        const double var_x62 = 1.0 * var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x63 = var_x62 + 0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai;
        const double var_x64 = var_x61 * (0.15315014533948793 * var_chaste_interface__Ionic_concentrations__Ki + 0.0028072421640728137 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x63, 2);
        const double var_x65 = var_x62 + 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai;
        ...
        const double var_x68 = 1 / var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x69 = log(4.0 * var_x68);
        const double var_x70 = exp(-12.0 + 0.059999999999999998 * var_chaste_interface__cell__V - 1.6035454492691736 * var_x69);
        const double var_x71 = 1.0 + var_x70;
        const double var_x72 = 1 / var_x71;
        const double var_x73 = exp(13.36287874390978 * var_x69 - 0.5 * var_chaste_interface__cell__V);
        const double var_x74 = 1.0 + var_x73;
        const double var_x75 = 1 / var_x74;
        const double var_x76 = exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 2.6725757487819561 * var_x69);
        const double var_x77 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.0053451514975639122 * var_x69);
        const double var_x78 = 1.0 * var_x76 + 3.0 * var_x77;
        const double var_x79 = 0.10000000000000001 * var_x72 + var_x75 * var_x78;
        const double var_x80 = 1 / var_x79;
        const double var_x81 = var_x72 * var_x80;
        const double var_x82 = var_chaste_interface__IKr_Xr_gate__Xr / (1.0 + exp(1.1304347826086956 + 0.043478260869565216 * var_chaste_interface__cell__V));
        const double var_x83 = var_x68 * var_x70 / pow(var_x71, 2);
        const double var_x84 = -26.725757487819561 * var_x69 + var_chaste_interface__cell__V;
        const double var_x85 = 0.25 * var_x84;
        const double var_x86 = log(138.0 * var_x38);
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (((var_x0) ? (-100.5) : (-0.5))));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (((var_x0) ? (-100.5) : (-0.01))));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        ...
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (((var_x13) ? (var_x12 * (var_x7 - var_x6 * var_x8)) : (0))));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (((var_x13) ? (var_x12 * (-0.0055555555555555558 - var_x17) + var_x19 * (var_x18 - var_x7 * var_x8)) : (-var_x20 + var_x18 * var_x19))));
        rJacobian[5][6] = -(mDt * (((var_x13) ? (var_x12 * (22.0 * var_x21 - var_x16 * var_x4)) : (0))));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (var_x20));
        rJacobian[5][9] = -(mDt * (((var_x13) ? (var_x11 * var_x17) : (0))));
        ...
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * ((((var_x22) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5))));
        rJacobian[6][7] = -(mDt * (((var_x22) ? (5.200179479821575e-8 * var_x28) : (0))));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (((var_x22) ? (-var_x37 * (var_x36 + 235.7603210147127 * var_x29)) : (0))));
        ...
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (-var_x43 * (0.026725757487819562 * var_x38 + 0.0016147524794848955 * var_x27 + 0.13454054045080013 * var_x41 + 427.61211980511297 * var_x38 * var_x42)));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0.13666446085893647 * var_x23 * var_x29));
        ...
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (0));
        rJacobian[8][5] = -(mDt * (0.00048309178743961351));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (-0.00074309178743961349));
        rJacobian[8][9] = -(mDt * (0.0044999999999999997 * var_x45 - 0.0044999999999999997 * var_x46));
        rJacobian[8][10] = -(mDt * (0));
        rJacobian[8][11] = -(mDt * (0));
        rJacobian[9][0] = -(mDt * (0));
        rJacobian[9][1] = -(mDt * (0));
        rJacobian[9][2] = -(mDt * (0));
        rJacobian[9][3] = -(mDt * (((var_x13) ? (var_x52 * (var_x47 * var_x8 - var_x47 * var_chaste_interface__Irel__APtrack2)) : (0))));
        rJacobian[9][4] = -(mDt * (0));
        rJacobian[9][5] = -(mDt * (((var_x13) ? (var_x51 * var_x54) : (0))));
        rJacobian[9][6] = -(mDt * (((var_x13) ? (var_x52 * (-0.1552941176470588 * var_x21 + var_x4 * var_x53)) : (0))));
        rJacobian[9][7] = -(mDt * (1.040035895964315e-7 * var_x28 * var_x51));
        rJacobian[9][8] = -(mDt * (2.1105882352941172e-5 * var_x51));
        rJacobian[9][9] = 1.0 -(mDt * (((var_x13) ? (var_x52 * (var_x56 - var_x54) + var_x60 * (var_x59 + var_x14 * var_x47)) : (var_x52 * var_x56 + var_x59 * var_x60))));
        ...
        rJacobian[10][7] = -(mDt * (-var_x43 * (3.4248684060035934 * var_x67 + 0.063974230473736557 * var_x64 - 0.089693693633866756 * var_x41)));
        rJacobian[10][8] = -(mDt * (0));
        rJacobian[10][9] = -(mDt * (0));
        rJacobian[10][10] = 1.0 -(mDt * (-var_x43 * (3.4901380509403466 * var_x64 + 79.648102465199855 * var_x67 + 6.681439371954891 * var_x68 * var_x81 + 0.40088636231729341 * var_x68 * var_x82 - 0.40088636231729341 * var_x80 * var_x83 * var_x84 + var_x72 * var_x85 * (0.16035454492691736 * var_x83 - var_x75 * (2.6725757487819561 * var_x68 * var_x76 + 0.016035454492691736 * var_x68 * var_x77) - 13.36287874390978 * var_x68 * var_x73 * var_x78 / pow(var_x74, 2)) / pow(var_x79, 2))));
        ...
        rJacobian[11][11] = 1.0 -(mDt * (((var_x58 + 0.0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x57 - 0.026725757487819562 * var_x86 + var_x81 * var_x85 + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() + 16.0 * var_x42 * (-26.725757487819561 * var_x86 + var_chaste_interface__cell__V) + 0.014999999999999999 * var_x82 * var_x84 + 0.29999999999999999 * var_x66 * (-26.725757487819561 * log(9.9339999999999993 / var_x65) + var_chaste_interface__cell__V) + 0.02 * var_x61 * (-26.725757487819561 * log(6.5295399999999999 / var_x63) + var_chaste_interface__cell__V) + 0.94545454545454544 * var_x40 / (1.0 + 31.622776601683793 * var_x39) < -150.0) ? (-100.5) : (-0.5))));
    }
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[5] = (var_chaste_interface__ICa_d_gate__d + ((0.63524014987941491 * exp(-0.89836705491478086 * pow((-1 + 0.044722719141323794 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI)) * mDt)) / (1.0 - ((-0.14710000000000001 + 0.25101580310038191 * exp(-0.08830693125184777 * pow((-1 + 0.15937778911130945 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI) - 0.63524014987941491 * exp(-0.89836705491478086 * pow((-1 + 0.044722719141323794 * var_chaste_interface__cell__V), 2.0)) / sqrt(M_PI)) * mDt));
        rY[6] = (var_chaste_interface__ICa_f_gate__f + ((0.0068719999999999996 / (1.0 + exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-0.00054739999999999997 - 0.0068719999999999996 / (1.0 + exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V)) - 0.0112 / (1.0 + exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V)) - 0.068699999999999997 * exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V) / (1.0 + exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V))) * mDt));
        rY[10] = (var_chaste_interface__IKr_Xr_gate__Xr + ((0.0050000000000000001 * exp(0.0021416822000000003 + 0.00052660000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-0.016 * exp(0.105056 + 0.0016000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(5.1411779999999991 + 0.078299999999999995 * var_chaste_interface__cell__V)) - 0.0050000000000000001 * exp(0.0021416822000000003 + 0.00052660000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V))) * mDt));
        rY[9] = (var_chaste_interface__IKs_Xs_gate__Xs + ((0.0030130000000000001 / (1.0 + exp(-0.17842998931347828 - 0.069846547135942336 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-0.0058700000000000002 / (1.0 + exp(1.0082174462705435 + 0.063211125158027806 * var_chaste_interface__cell__V)) - 0.0030130000000000001 / (1.0 + exp(-0.17842998931347828 - 0.069846547135942336 * var_chaste_interface__cell__V))) * mDt));
        rY[3] = (var_chaste_interface__INa_h_gate__h + ((((var_chaste_interface__cell__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__cell__V < -40.0) ? (-310000.0 * exp(0.34999999999999998 * var_chaste_interface__cell__V) - 0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V) - 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__cell__V)) : (-7.6923076923076916 / (1.0 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V))))) * mDt));
        rY[4] = (var_chaste_interface__INa_j_gate__j + ((((var_chaste_interface__cell__V < -40.0) ? (-4803349.2000000002 * exp(0.24399999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 0.0013124772000000001 * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 127140.0 * var_chaste_interface__cell__V * exp(0.24399999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 3.4740000000000003e-5 * var_chaste_interface__cell__V * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__cell__V < -40.0) ? (4803349.2000000002 * exp(0.24399999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) + 0.0013124772000000001 * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V)) + 127140.0 * var_chaste_interface__cell__V * exp(0.24399999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) + 3.4740000000000003e-5 * var_chaste_interface__cell__V * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (-0.29999999999999999 * exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V))))) * mDt));
        rY[2] = (var_chaste_interface__INa_m_gate__m + ((((fabs(47.130000000000003 + var_chaste_interface__cell__V) > 0.001) ? (-15.081600000000002 / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)) - 0.32000000000000001 * var_chaste_interface__cell__V / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V))) : (3.2000000000000002))) * mDt)) / (1.0 - ((((fabs(47.130000000000003 + var_chaste_interface__cell__V) > 0.001) ? (-0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__cell__V) - 15.081600000000002 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)) - 0.32000000000000001 * var_chaste_interface__cell__V / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V))) : (-3.2000000000000002 - 0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__cell__V)))) * mDt));
        rY[7] = (var_chaste_interface__Ito_r_gate__r + ((0.52659999999999996 * exp(0.70203392000000009 - 0.0166 * var_chaste_interface__cell__V) / (1.0 + exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-0.52659999999999996 * exp(0.70203392000000009 - 0.0166 * var_chaste_interface__cell__V) / (1.0 + exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__cell__V)) - 0.51490000000000002 * exp(0.67236288 - 0.13439999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(6.9907280000000006e-6 - 0.1348 * var_chaste_interface__cell__V)) - 5.1860000000000002e-5 * var_chaste_interface__cell__V / (1.0 + exp(6.9907280000000006e-6 - 0.1348 * var_chaste_interface__cell__V))) * mDt));
        rY[8] = (var_chaste_interface__Ito_t_gate__t + ((5.6119999999999998e-5 * var_chaste_interface__cell__V / (1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V)) + 0.072099999999999997 * exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-5.6119999999999998e-5 * var_chaste_interface__cell__V / (1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V)) - 0.072099999999999997 * exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V) / (1.0 + exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V)) - 0.0001215 * var_chaste_interface__cell__V / (1.0 + exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V)) - 0.076700000000000004 * exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__cell__V) / (1.0 + exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V))) * mDt));
