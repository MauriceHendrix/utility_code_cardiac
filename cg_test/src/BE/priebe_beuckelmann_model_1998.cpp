...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[5] = (var_chaste_interface__ICa_d_gate__d + ((0.63524014987941491 * exp(-0.89836705491478086 + 0.080354834965543909 * var_chaste_interface__cell__V - 0.0017968433579057224 * pow(var_chaste_interface__cell__V, 2)) / sqrt(M_PI)) * mDt)) / (1.0 - ((-0.14710000000000001 + 0.25101580310038191 * exp(-0.08830693125184777 + 0.028148326932247791 * var_chaste_interface__cell__V - 0.0022431090568219899 * pow(var_chaste_interface__cell__V, 2)) / sqrt(M_PI) - 0.63524014987941491 * exp(-0.89836705491478086 + 0.080354834965543909 * var_chaste_interface__cell__V - 0.0017968433579057224 * pow(var_chaste_interface__cell__V, 2)) / sqrt(M_PI)) * mDt));
