...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldokos_model_1996FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[9], double rJacobian[9][9])
    {
        ...
        double var_chaste_interface__hyperpolarising_activated_current_y_gate__y = rY[10];
        // Units: dimensionless; Initial value: 0.0287
        double var_chaste_interface__L_type_calcium_current_f2_gate__fL2 = rCurrentGuess[0];double var_chaste_interface__ion_concentrations__Cai = rCurrentGuess[1];double var_chaste_interface__ion_concentrations__Cao = rCurrentGuess[2];double var_chaste_interface__ion_concentrations__Carel = rCurrentGuess[3];double var_chaste_interface__ion_concentrations__Ki = rCurrentGuess[5];double var_chaste_interface__ion_concentrations__Ko = rCurrentGuess[6];double var_chaste_interface__ion_concentrations__Nai = rCurrentGuess[7];double var_chaste_interface__ion_concentrations__Nao = rCurrentGuess[8];

        const double var_x0 = pow(var_chaste_interface__ion_concentrations__Cai, 2.0);
        const double var_x1 = 9.9999999999999995e-7 + var_x0;
        const double var_x2 = 1 / var_x1;
        const double var_x3 = var_x0 * var_x2;
        const double var_x4 = 0.40000000000000002 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x5 = pow(var_chaste_interface__ion_concentrations__Cai, 3.0);
        const double var_x6 = var_x5 / pow(var_x1, 2);
        const double var_x7 = pow(var_chaste_interface__ion_concentrations__Cai, 1.0);
        const double var_x8 = var_x2 * var_x7;
        const double var_x9 = 2.4999999999999999e-7 + var_x0;
        const double var_x10 = var_x7 / var_x9;
        const double var_x11 = var_x5 / pow(var_x9, 2);
        const double var_x12 = 1 / var_chaste_interface__ion_concentrations__Cai;
        const double var_x13 = log(var_x12 * var_chaste_interface__ion_concentrations__Cao);
        const double var_x14 = var_chaste_interface__L_type_calcium_current_d_gate__dL * var_chaste_interface__L_type_calcium_current_f_gate__fL;
        const double var_x15 = 1 / (4.6630000000000003 + var_chaste_interface__ion_concentrations__Nao);
        const double var_x16 = var_x15 * var_chaste_interface__ion_concentrations__Nao;
        const double var_x17 = 0.0080763619450073352 * var_chaste_interface__membrane__E;
        const double var_x18 = exp(-var_x17);
        const double var_x19 = pow(var_chaste_interface__ion_concentrations__Nao, 2.0);
        const double var_x20 = 2.3464309350494594e-7 * pow(var_chaste_interface__ion_concentrations__Nao, 3.0) + 1.094140745013563e-6 * var_x19;
        const double var_x21 = 0.27300027300027302 * var_chaste_interface__ion_concentrations__Cao;
        const double var_x22 = exp(0);
        const double var_x23 = var_x21 * var_x22;
        const double var_x24 = 1.0 + var_x20 + var_x21 + var_x23 + 0.00061425061425061424 * var_chaste_interface__ion_concentrations__Nao;
        const double var_x25 = 1 / var_x24;
        const double var_x26 = var_x18 * var_x25;
        const double var_x27 = var_x20 * var_x26;
        const double var_x28 = var_x23 * var_x25;
        const double var_x29 = var_x27 + var_x28;
        const double var_x30 = var_x18 * var_x29;
        const double var_x31 = var_x16 * var_x30;
        const double var_x32 = exp(var_x17);
        const double var_x33 = 1 / (26.440000000000001 + var_chaste_interface__ion_concentrations__Nai);
        const double var_x34 = var_x33 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x35 = var_x18 + var_x34;
        const double var_x36 = var_x32 * var_x35;
        const double var_x37 = var_x31 + var_x28 * var_x36;
        const double var_x38 = 48.309178743961354 * var_chaste_interface__ion_concentrations__Cai;
        const double var_x39 = exp(-0.0051246996536338544 * var_chaste_interface__membrane__E);
        const double var_x40 = var_x38 * var_x39;
        const double var_x41 = 1.8271247633873431 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x42 = pow(var_chaste_interface__ion_concentrations__Nai, 2.0);
        const double var_x43 = pow(var_chaste_interface__ion_concentrations__Nai, 3.0);
        const double var_x44 = 0.0011051656880977081 * var_x42 + 4.1799004844845232e-5 * var_x43;
        const double var_x45 = 1 / (1.0 + var_x38 + var_x40 + var_x44 + 0.0025297242600556538 * var_chaste_interface__ion_concentrations__Nai + var_x41 * var_chaste_interface__ion_concentrations__Cai);
        const double var_x46 = 48.309178743961354 * var_x39;
        const double var_x47 = var_x45 * var_x46;
        const double var_x48 = var_x39 * var_chaste_interface__ion_concentrations__Cai;
        const double var_x49 = 0.037821482602117998 * var_chaste_interface__ion_concentrations__Nai;
        const double var_x50 = pow((0.0207 + var_x48 + 2.2876929743622558e-5 * var_x42 + 5.2365292183152033e-5 * var_chaste_interface__ion_concentrations__Nai + 8.6523940028829632e-7 * var_x43 + var_x49 * var_chaste_interface__ion_concentrations__Cai + var_chaste_interface__ion_concentrations__Cai), (-2));
        const double var_x51 = var_x50 * (-48.309178743961354 - var_x41 - var_x46);
        const double var_x52 = 0.0207 * var_x48;
        const double var_x53 = var_x51 * var_x52;
        const double var_x54 = 0.00042849000000000001 * var_x44;
        const double var_x55 = var_x32 * var_x54;
        const double var_x56 = var_x47 + var_x53 + var_x51 * var_x55;
        const double var_x57 = var_x32 * var_x34;
        const double var_x58 = var_x56 * var_x57;
        const double var_x59 = var_x16 + var_x32;
        const double var_x60 = var_x18 * var_x59;
        const double var_x61 = var_x47 * var_x60;
        const double var_x62 = var_x53 * var_x60;
        const double var_x63 = var_x28 * (var_x58 + var_x61 + var_x62) - var_x37 * var_x47 - var_x37 * var_x53;
        const double var_x64 = var_x32 * var_x45;
        const double var_x65 = var_x44 * var_x64;
        const double var_x66 = var_x40 * var_x45;
        const double var_x67 = var_x65 + var_x66;
        const double var_x68 = var_x27 * var_x67;
        const double var_x69 = var_x16 * var_x68;
        const double var_x70 = var_x29 * var_x65;
        const double var_x71 = var_x34 * var_x70;
        const double var_x72 = var_x59 * var_x65;
        const double var_x73 = var_x27 * var_x35;
        const double var_x74 = var_x32 * var_x67;
        const double var_x75 = var_x34 * var_x74;
        const double var_x76 = var_x75 + var_x60 * var_x66;
        const double var_x77 = 1 / (var_x37 + var_x69 + var_x71 + var_x76 + var_x28 * var_x72 + var_x66 * var_x73);
        const double var_x78 = 0.016582829838457897 * var_x77;
        const double var_x79 = 0.0024000000000000002 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x80 = var_x16 * var_x27;
        const double var_x81 = var_x29 * var_x54 * var_x57;
        const double var_x82 = var_x22 * var_chaste_interface__ion_concentrations__Cao;
        const double var_x83 = var_x25 * var_x82;
        const double var_x84 = 0.00011697788697788699 * var_x32 * var_x44 * var_x59 * var_x83;
        const double var_x85 = -var_x58 - var_x61 - var_x62 - var_x47 * var_x73 - var_x51 * var_x81 - var_x51 * var_x84 - var_x53 * var_x73 - var_x56 * var_x80;
        const double var_x86 = var_x45 * var_x48;
        const double var_x87 = 0.0056511056511056512 * var_x83;
        const double var_x88 = (var_x28 * var_x76 - var_x37 * var_x66) / pow((0.0207 * var_x31 + 0.0207 * var_x69 + 0.0207 * var_x71 + 0.0207 * var_x75 + var_x36 * var_x87 + var_x60 * var_x86 + var_x72 * var_x87 + var_x73 * var_x86), 2);
        const double var_x89 = 7.1055767574808238e-6 * var_x88;
        const double var_x90 = var_chaste_interface__T_type_calcium_current_d_gate__dT * var_chaste_interface__T_type_calcium_current_f_gate__fT;
        const double var_x91 = 0.0023533830328766889 * var_x90;
        const double var_x92 = var_x14 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        const double var_x93 = 0.011074743684125594 * var_x92;
        const double var_x94 = 0.27300027300027302 * var_x22;
        const double var_x95 = var_x25 * var_x94;
        const double var_x96 = pow(var_x24, (-2));
        const double var_x97 = var_x96 * (-0.27300027300027302 - var_x94);
        const double var_x98 = var_x18 * var_x20;
        const double var_x99 = var_x97 * var_x98;
        const double var_x100 = var_x23 * var_x97;
        const double var_x101 = var_x100 + var_x95 + var_x99;
        const double var_x102 = var_x16 * var_x18;
        const double var_x103 = var_x101 * var_x102;
        const double var_x104 = var_x36 * var_x95;
        const double var_x105 = var_x100 * var_x36;
        const double var_x106 = var_x100 * var_x76 + var_x76 * var_x95 - var_x66 * (var_x103 + var_x104 + var_x105);
        const double var_x107 = 1 / var_chaste_interface__ion_concentrations__Cao;
        const double var_x108 = var_x34 * var_x65;
        const double var_x109 = var_x16 * var_x67;
        const double var_x110 = var_x35 * var_x66;
        const double var_x111 = -var_x103 - var_x104 - var_x105 - var_x100 * var_x72 - var_x101 * var_x108 - var_x109 * var_x99 - var_x110 * var_x99 - var_x72 * var_x95;
        const double var_x112 = var_x33 * var_x74;
        const double var_x113 = 0.0022103313761954162 * pow(var_chaste_interface__ion_concentrations__Nai, 1.0);
        const double var_x114 = 0.0001253970145345357 * var_x42;
        const double var_x115 = var_x64 * (var_x113 + var_x114);
        const double var_x116 = var_x50 * (-0.0025297242600556538 - var_x113 - var_x114 - 1.8271247633873431 * var_chaste_interface__ion_concentrations__Cai);
        const double var_x117 = var_x116 * var_x52;
        const double var_x118 = var_x115 + var_x117 + var_x116 * var_x55;
        const double var_x119 = var_x118 * var_x57;
        const double var_x120 = 0.0014304645462223146 * var_chaste_interface__ion_concentrations__Nai / pow((1 + var_x49), 2);
        const double var_x121 = var_x120 * var_x74;
        const double var_x122 = var_x117 * var_x60;
        const double var_x123 = var_x33 - var_x120;
        const double var_x124 = var_x28 * (var_x112 + var_x119 + var_x122 - var_x121) - var_x117 * var_x37 - 13.188418985520435 * var_x123 * var_x48 * var_x64 * var_x83;
        const double var_x125 = var_x121 - var_x112 - var_x119 - var_x122 + var_x120 * var_x70 - var_x116 * var_x81 - var_x116 * var_x84 - var_x117 * var_x73 - var_x118 * var_x80 - var_x33 * var_x70 - var_x115 * var_x28 * var_x59 - var_x115 * var_x29 * var_x34 - var_x123 * var_x27 * var_x66 - var_x123 * var_x28 * var_x32;
        const double var_x126 = var_x15 * var_x30;
        const double var_x127 = 2.1882814900271261e-6 * pow(var_chaste_interface__ion_concentrations__Nao, 1.0);
        const double var_x128 = 7.0392928051483781e-7 * var_x19;
        const double var_x129 = var_x26 * (var_x127 + var_x128);
        const double var_x130 = var_x96 * (-0.00061425061425061424 - var_x127 - var_x128);
        const double var_x131 = var_x130 * var_x98;
        const double var_x132 = var_x130 * var_x23;
        const double var_x133 = var_x129 + var_x131 + var_x132;
        const double var_x134 = var_x102 * var_x133;
        const double var_x135 = 0.045990609913211578 * var_chaste_interface__ion_concentrations__Nao / pow((1 + 0.2144542140253056 * var_chaste_interface__ion_concentrations__Nao), 2);
        const double var_x136 = var_x135 * var_x30;
        const double var_x137 = var_x132 * var_x36;
        const double var_x138 = var_x15 - var_x135;
        const double var_x139 = var_x132 * var_x76 - var_x66 * (var_x126 + var_x134 + var_x137 - var_x136) + 13.188418985520435 * var_x138 * var_x26 * var_x82 * var_x86;
        const double var_x140 = var_x136 - var_x126 - var_x134 - var_x137 + var_x135 * var_x68 - var_x108 * var_x133 - var_x109 * var_x129 - var_x109 * var_x131 - var_x110 * var_x129 - var_x110 * var_x131 - var_x132 * var_x72 - var_x15 * var_x68 - var_x138 * var_x18 * var_x66 - var_x138 * var_x28 * var_x65;
        const double var_x141 = 0.082914149192289482 * var_x77;
        const double var_x142 = 0.011766915164383444 * var_x90;
        const double var_x143 = 3.5527883787404114e-5 * var_x88;
        const double var_x144 = 0.055373718420627965 * var_x92;
        const double var_x145 = pow(var_chaste_interface__ion_concentrations__Ko, 0.40999999999999998);
        const double var_x146 = 2.9019952217301315e-7 * var_x145;
        const double var_x147 = pow(var_chaste_interface__ion_concentrations__Ko, 0.58999999999999997) * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x148 = 1.0778839394997632e-6 * var_x147;
        const double var_x149 = 1 / var_chaste_interface__ion_concentrations__Ki;
        const double var_x150 = pow(var_chaste_interface__ion_concentrations__Ko, 1.8300000000000001);
        const double var_x151 = var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (71.36612580598495 + var_x150);
        const double var_x152 = var_x150 * var_x151;
        const double var_x153 = var_x149 * var_x152;
        const double var_x154 = exp(-0.037433890822745473 * var_chaste_interface__membrane__E);
        const double var_x155 = -var_x154 * var_chaste_interface__ion_concentrations__Ko + var_chaste_interface__ion_concentrations__Ki;
        const double var_x156 = var_x155 * pow(var_chaste_interface__ion_concentrations__Ko, (-0.59000000000000008));
        const double var_x157 = var_x151 * pow(var_chaste_interface__ion_concentrations__Ko, 0.83000000000000007);
        const double var_x158 = pow(var_chaste_interface__ion_concentrations__Ko, (-0.41000000000000003)) * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x;
        const double var_x159 = var_x155 * var_x158;
        const double var_x160 = -26.713760659695652 * log(var_x149 * var_chaste_interface__ion_concentrations__Ko) + var_chaste_interface__membrane__E;
        const double var_x161 = pow(var_chaste_interface__ion_concentrations__Ko, 2.6600000000000001) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.014012250051496243 * var_x150), 2);
        const double var_x162 = var_x160 * var_x161;
        const double var_x163 = 1.0 + var_chaste_interface__ion_concentrations__Ko;
        const double var_x164 = 1 / var_x163;
        const double var_x165 = 1 / (40.0 + var_chaste_interface__ion_concentrations__Nai);
        const double var_x166 = 1.0 - 0.035938096628557313 * pow((-1 + 0.025000000000000001 * var_chaste_interface__membrane__E), 2.0);
        const double var_x167 = var_x164 * var_x165 * var_x166;
        const double var_x168 = 0.0018738597717457425 * var_x167;
        const double var_x169 = var_x157 * var_x160;
        const double var_x170 = var_x166 * var_chaste_interface__ion_concentrations__Ko * var_chaste_interface__ion_concentrations__Nai;
        const double var_x171 = var_x165 * var_x170 / pow(var_x163, 2);
        const double var_x172 = var_x164 * var_x170 / pow((1 + 0.025000000000000001 * var_chaste_interface__ion_concentrations__Nai), 2);
        const double var_x173 = 1.4509976108650658e-6 * var_x145;
        const double var_x174 = 5.3894196974988154e-6 * var_x147;
        const double var_x175 = 0.0093692988587287113 * var_x167;
        const double var_x176 = 0.049748489515373688 * var_x77;
        const double var_x177 = 2.1316730272442473e-5 * var_x88;
        const double var_x178 = var_x158 * (-var_x154 * var_chaste_interface__ion_concentrations__Nao + var_chaste_interface__ion_concentrations__Nai);
        const double var_x179 = 1 / var_chaste_interface__ion_concentrations__Nai;
        const double var_x180 = -26.713760659695652 * log(var_x179 * var_chaste_interface__ion_concentrations__Nao) + var_chaste_interface__membrane__E;
        const double var_x181 = var_x161 * var_x180;
        const double var_x182 = 0.0028107896576186134 * var_x167;
        const double var_x183 = var_x157 * var_x180;
        const double var_x184 = 3.7725937882491718e-8 * var_x147;
        const double var_x185 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x186 = 0.027686859210313983 * var_x185;
        const double var_x187 = 0.00089705423841417295 * var_x152;
        const double var_x188 = 1 / var_chaste_interface__ion_concentrations__Nao;
        const double var_x189 = 0.24874244757686845 * var_x77;
        const double var_x190 = 0.00010658365136221236 * var_x88;
        const double var_x191 = 0.014053948288093067 * var_x167;
        const double var_x192 = 1.8862968941245856e-7 * var_x147;
        const double var_x193 = 0.1384342960515699 * var_x185;
        const double var_x194 = 0.0044852711920708652 * var_x152;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.0030000000000000001 - 40.0 * var_chaste_interface__ion_concentrations__Cai));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (-40.0 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        rJacobian[0][7] = -(mDt * (0));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-0.20000000000000001 * var_x3));
        rJacobian[1][2] = -(mDt * (0.0025000000000000001));
        rJacobian[1][3] = -(mDt * (var_x4 * var_x6 - var_x4 * var_x8));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (0));
        rJacobian[1][7] = -(mDt * (0));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.0010714285714285715));
        rJacobian[2][3] = -(mDt * (0.0062777855817019177 * var_x10 - 0.0062777855817019177 * var_x11));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (var_x14 * (-0.062185611894217119 + 0.011074743684125594 * var_x13 - 0.00082914149192289492 * var_chaste_interface__membrane__E)));
        rJacobian[3][1] = -(mDt * (0.0012000000000000001 * var_x3));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (8.7888998143826851e-5 * var_x11 - 8.7888998143826851e-5 * var_x10 + var_x63 * var_x78 + var_x79 * var_x8 + var_x85 * var_x89 - var_x12 * var_x91 - var_x12 * var_x93 - var_x6 * var_x79));
        rJacobian[3][4] = -(mDt * (var_x106 * var_x78 + var_x107 * var_x91 + var_x107 * var_x93 + var_x111 * var_x89));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (var_x124 * var_x78 + var_x125 * var_x89));
        rJacobian[3][8] = -(mDt * (var_x139 * var_x78 + var_x140 * var_x89));
        rJacobian[4][0] = -(mDt * (var_x14 * (0.31092805947108554 + 0.0041457074596144743 * var_chaste_interface__membrane__E - 0.055373718420627965 * var_x13)));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (var_x12 * var_x142 + var_x12 * var_x144 - var_x141 * var_x63 - var_x143 * var_x85));
        rJacobian[4][4] = 1.0 -(mDt * (-0.01 - var_x106 * var_x141 - var_x107 * var_x142 - var_x107 * var_x144 - var_x111 * var_x143));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (-var_x124 * var_x141 - var_x125 * var_x143));
        rJacobian[4][8] = -(mDt * (-var_x139 * var_x141 - var_x140 * var_x143));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-var_x146 - var_x148 - 0.001495090397356955 * var_x153));
        rJacobian[5][6] = -(mDt * (0.001495090397356955 * var_x157 + 2.0109407222017218e-8 * var_x162 - 1.189818040909354e-7 * var_x156 - 6.3595152430486023e-7 * var_x159 - 0.00010241970278977559 * var_x169 - 0.0018738597717457425 * var_x171 + var_x146 * var_x154 + var_x148 * var_x154 + var_x168 * var_chaste_interface__ion_concentrations__Nai));
        rJacobian[5][7] = -(mDt * (-1.171162357341089e-6 * var_x172 + var_x168 * var_chaste_interface__ion_concentrations__Ko));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (var_x173 + var_x174 + 0.0074754519867847747 * var_x153));
        rJacobian[6][6] = 1.0 -(mDt * (-0.01 + 5.9490902045467693e-7 * var_x156 + 0.0093692988587287113 * var_x171 + 0.00051209851394887792 * var_x169 + 3.179757621524301e-6 * var_x159 - 1.0054703611008608e-7 * var_x162 - 0.0074754519867847747 * var_x157 - var_x154 * var_x173 - var_x154 * var_x174 - var_x175 * var_chaste_interface__ion_concentrations__Nai));
        rJacobian[6][7] = -(mDt * (5.8558117867054447e-6 * var_x172 - var_x175 * var_chaste_interface__ion_concentrations__Ko));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[7][0] = -(mDt * (0));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (-var_x176 * var_x63 - var_x177 * var_x85));
        rJacobian[7][4] = -(mDt * (-var_x106 * var_x176 - var_x111 * var_x177));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (1.206564433321033e-8 * var_x181 + 0.0028107896576186134 * var_x171 - 2.2258303350670112e-8 * var_x178 - 6.1451821673865346e-5 * var_x183 - var_x182 * var_chaste_interface__ion_concentrations__Nai));
        rJacobian[7][7] = 1.0 -(mDt * (-var_x184 + 1.7567435360116334e-6 * var_x172 - 2.6579384841901423e-5 * var_x179 - var_x124 * var_x176 - var_x125 * var_x177 - var_x179 * var_x186 - var_x179 * var_x187 - var_x182 * var_chaste_interface__ion_concentrations__Ko));
        rJacobian[7][8] = -(mDt * (2.6579384841901423e-5 * var_x188 + var_x154 * var_x184 + var_x186 * var_x188 + var_x187 * var_x188 - var_x139 * var_x176 - var_x140 * var_x177));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (var_x189 * var_x63 + var_x190 * var_x85));
        rJacobian[8][4] = -(mDt * (var_x106 * var_x189 + var_x111 * var_x190));
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0.00030725910836932674 * var_x183 + 1.1129151675335055e-7 * var_x178 - 0.014053948288093067 * var_x171 - 6.0328221666051643e-8 * var_x181 + var_x191 * var_chaste_interface__ion_concentrations__Nai));
        rJacobian[8][7] = -(mDt * (var_x192 + 0.00013289692420950713 * var_x179 - 8.7837176800581675e-6 * var_x172 + var_x124 * var_x189 + var_x125 * var_x190 + var_x179 * var_x193 + var_x179 * var_x194 + var_x191 * var_chaste_interface__ion_concentrations__Ko));
        rJacobian[8][8] = 1.0 -(mDt * (-0.01 - 0.00013289692420950713 * var_x188 + var_x139 * var_x189 + var_x140 * var_x190 - var_x154 * var_x192 - var_x188 * var_x193 - var_x188 * var_x194));
    }
    ...
    void Celldokos_model_1996FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[2] = (var_chaste_interface__L_type_calcium_current_d_gate__dL + ((0.5 / (1.0 + exp(-1.0 - 0.15151515151515152 * var_chaste_interface__membrane__E))) * mDt)) / (1.0 - ((-0.5) * mDt));
        rY[3] = (var_chaste_interface__L_type_calcium_current_f_gate__fL + ((0.001 / (0.031 + 1.0 / (1.0 + exp(4.6419753086419755 + 0.1234567901234568 * var_chaste_interface__membrane__E)) + 0.031 * exp(4.166666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__E) + 1.0 * exp(4.166666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__E) / (1.0 + exp(4.6419753086419755 + 0.1234567901234568 * var_chaste_interface__membrane__E)))) * mDt)) / (1.0 - ((-0.001 / (0.031 + 1.0 / (1.0 + exp(4.6419753086419755 + 0.1234567901234568 * var_chaste_interface__membrane__E)))) * mDt));
        rY[5] = (var_chaste_interface__T_type_calcium_current_d_gate__dT + ((0.001 / (0.00059999999999999995 + 0.0054000000000000003 / (1.0 + exp(3.0 + 0.029999999999999999 * var_chaste_interface__membrane__E)) + 0.00059999999999999995 * exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__E) + 0.0054000000000000003 * exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__E) / (1.0 + exp(3.0 + 0.029999999999999999 * var_chaste_interface__membrane__E)))) * mDt)) / (1.0 - ((-0.001 / (0.00059999999999999995 + 0.0054000000000000003 / (1.0 + exp(3.0 + 0.029999999999999999 * var_chaste_interface__membrane__E)))) * mDt));
        rY[6] = (var_chaste_interface__T_type_calcium_current_f_gate__fT + ((0.001 / (0.001 + 0.001 * exp(11.363636363636365 + 0.15151515151515152 * var_chaste_interface__membrane__E) + 0.040000000000000001 / (1.0 + exp(5.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__E)) + 0.040000000000000001 * exp(11.363636363636365 + 0.15151515151515152 * var_chaste_interface__membrane__E) / (1.0 + exp(5.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__E)))) * mDt)) / (1.0 - ((-0.001 / (0.001 + 0.040000000000000001 / (1.0 + exp(5.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__E)))) * mDt));
        rY[9] = (var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x + ((0.017000000000000001 * exp(0.039800000000000002 * var_chaste_interface__membrane__E) / (1.0 + exp(-3.3918918918918921 - 0.13513513513513511 * var_chaste_interface__membrane__E)) + 0.00021100000000000001 * exp(-0.050999999999999997 * var_chaste_interface__membrane__E) / (1.0 + exp(-3.3918918918918921 - 0.13513513513513511 * var_chaste_interface__membrane__E))) * mDt)) / (1.0 - ((-0.017000000000000001 * exp(0.039800000000000002 * var_chaste_interface__membrane__E) - 0.00021100000000000001 * exp(-0.050999999999999997 * var_chaste_interface__membrane__E)) * mDt));
        rY[8] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((0.032399999999999998 * exp(-13.076000000000002 - 0.14000000000000001 * var_chaste_interface__membrane__E)) * mDt)) / (1.0 - ((-0.032399999999999998 * exp(-13.076000000000002 - 0.14000000000000001 * var_chaste_interface__membrane__E) - 0.70899999999999996 / (1.0 + 4.2000000000000002 * exp(-2.7239999999999998 - 0.059999999999999998 * var_chaste_interface__membrane__E))) * mDt));
        rY[7] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((-6.8599999999999994 / (-1.0 + exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E)) - 0.20000000000000001 * var_chaste_interface__membrane__E / (-1.0 + exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E))) * mDt)) / (1.0 - ((-8.0 * exp(-8.4299999999999997 - 0.14999999999999999 * var_chaste_interface__membrane__E) - 6.8599999999999994 / (1.0 - exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E)) - 0.20000000000000001 * var_chaste_interface__membrane__E / (1.0 - exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E))) * mDt));
        rY[10] = (var_chaste_interface__hyperpolarising_activated_current_y_gate__y + ((0.049608000000000006 / (-1.0 + exp(9.0948000000000011 + 0.066000000000000003 * var_chaste_interface__membrane__E)) + 0.00035999999999999997 * var_chaste_interface__membrane__E / (-1.0 + exp(9.0948000000000011 + 0.066000000000000003 * var_chaste_interface__membrane__E))) * mDt)) / (1.0 - ((-0.049608000000000006 / (-1.0 + exp(9.0948000000000011 + 0.066000000000000003 * var_chaste_interface__membrane__E)) - 0.0076300000000000005 / (1.0 - exp(-16.023 - 0.20999999999999999 * var_chaste_interface__membrane__E)) - 0.00035999999999999997 * var_chaste_interface__membrane__E / (-1.0 + exp(9.0948000000000011 + 0.066000000000000003 * var_chaste_interface__membrane__E)) - 0.0001 * var_chaste_interface__membrane__E / (1.0 - exp(-16.023 - 0.20999999999999999 * var_chaste_interface__membrane__E))) * mDt));
