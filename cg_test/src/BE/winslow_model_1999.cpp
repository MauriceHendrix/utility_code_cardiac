...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellwinslow_model_1999FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[25], double rJacobian[25][25])
    {
        ...
        double var_chaste_interface__L_type_Ca_current_y_gate__y = rY[20];
        // Units: dimensionless; Initial value: 0.798
        double var_chaste_interface__L_type_Ca_current__C0 = rCurrentGuess[0];double var_chaste_interface__L_type_Ca_current__C1 = rCurrentGuess[1];double var_chaste_interface__L_type_Ca_current__C2 = rCurrentGuess[2];double var_chaste_interface__L_type_Ca_current__C3 = rCurrentGuess[3];double var_chaste_interface__L_type_Ca_current__C4 = rCurrentGuess[4];double var_chaste_interface__L_type_Ca_current__O = rCurrentGuess[10];double var_chaste_interface__L_type_Ca_current__O_Ca = rCurrentGuess[11];double var_chaste_interface__RyR_channel__P_C1 = rCurrentGuess[12];double var_chaste_interface__RyR_channel__P_O1 = rCurrentGuess[14];double var_chaste_interface__RyR_channel__P_O2 = rCurrentGuess[15];double var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa = rCurrentGuess[17];double var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa = rCurrentGuess[18];double var_chaste_interface__intracellular_ion_concentrations__Ca_JSR = rCurrentGuess[19];double var_chaste_interface__intracellular_ion_concentrations__Ca_NSR = rCurrentGuess[20];double var_chaste_interface__intracellular_ion_concentrations__Ca_ss = rCurrentGuess[21];double var_chaste_interface__intracellular_ion_concentrations__Cai = rCurrentGuess[22];double var_chaste_interface__intracellular_ion_concentrations__Nai = rCurrentGuess[24];
        ...
        const double var_x2 = 48600000000.0 * var_x1 * var_chaste_interface__RyR_channel__P_C1;
        const double var_x3 = 4050000.0 * var_x1;
        const double var_x4 = 12150000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__RyR_channel__P_O1;
        const double var_x5 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 1.2);
        ...
        const double var_x8 = 2752.4498037978587 * var_x5 - 0.096656534954407292 * var_x6;
        const double var_x9 = var_x8 / pow((2.9537323401073989e-5 + var_x5 + 8.9779098483507565e-6 * var_x6), 2);
        const double var_x10 = pow(var_chaste_interface__intracellular_ion_concentrations__Cai, 0.19999999999999996);
        ...
        const double var_x18 = 1800.0 * var_chaste_interface__RyR_channel__P_O1;
        const double var_x19 = 1800.0 * var_chaste_interface__RyR_channel__P_O2;
        const double var_x20 = (-var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) * (var_chaste_interface__RyR_channel__P_O1 + var_chaste_interface__RyR_channel__P_O2);
        const double var_x21 = exp(0.20000000000000001 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x22 = 1.6000000000000001 * var_x21;
        const double var_x23 = -var_x22;
        const double var_x24 = 0.10375000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x25 = exp(-0.15384615384615385 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        const double var_x26 = 0.050000000000000003 * var_x25;
        const double var_x27 = 0.10375000000000001 * var_chaste_interface__L_type_Ca_current__C0;
        const double var_x28 = -var_x26;
        const double var_x29 = 1.2 * var_x21;
        const double var_x30 = 0.20750000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x31 = 0.10000000000000001 * var_x25;
        const double var_x32 = 0.20750000000000002 * var_chaste_interface__L_type_Ca_current__C1;
        const double var_x33 = -var_x31;
        const double var_x34 = 0.80000000000000004 * var_x21;
        const double var_x35 = -var_x34;
        const double var_x36 = 0.41500000000000004 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x37 = 0.14999999999999999 * var_x25;
        const double var_x38 = 0.41500000000000004 * var_chaste_interface__L_type_Ca_current__C2;
        const double var_x39 = 0.40000000000000002 * var_x21;
        const double var_x40 = 0.83000000000000007 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x41 = 0.20000000000000001 * var_x25;
        const double var_x42 = 0.83000000000000007 * var_chaste_interface__L_type_Ca_current__C3;
        const double var_x43 = 1.6600000000000001 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x44 = 1.6600000000000001 * var_chaste_interface__L_type_Ca_current__C4;
        const double var_x45 = 3.2000000000000002 * var_x21;
        const double var_x46 = 0.025000000000000001 * var_x25;
        const double var_x47 = 2.3999999999999999 * var_x21;
        const double var_x48 = 0.074999999999999997 * var_x25;
        const double var_x49 = -0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x50 = var_chaste_interface__membrane__V >= -90.0;
        const double var_x51 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x52 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x53 = 1.0 + 0.00011900000000000002 * pow(var_x52, (-2.0));
        ...
        const double var_x64 = 1.0 + 0.00011900000000000002 * pow(var_x63, (-2.0));
        ...
        const double var_x68 = 1 / (1.0 + 0.20000000000000001 * var_x67);
        const double var_x69 = exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x70 = 5.0000000000000002e-5 + var_chaste_interface__intracellular_ion_concentrations__Cai;
        const double var_x71 = 0.0015381954438488301 / var_x70;
        const double var_x72 = 1 / var_chaste_interface__intracellular_ion_concentrations__Cai;
        ...
        rJacobian[0][16] = -(mDt * (0.29999999999999999));
        ...
        rJacobian[1][21] = -(mDt * (0.0070000000000000001));
        ...
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0.10000000000000001));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-var_x0));
        rJacobian[3][4] = -(mDt * (0.57600000000000007));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        ...
        rJacobian[3][23] = -(mDt * (-var_x2));
        rJacobian[3][24] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (0.00080000000000000004));
        rJacobian[4][3] = -(mDt * (var_x0));
        rJacobian[4][4] = 1.0 -(mDt * (-0.67600000000000005 - var_x3));
        rJacobian[4][5] = -(mDt * (1.9299999999999999));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (0));
        ...
        rJacobian[4][23] = -(mDt * (var_x2 - var_x4));
        rJacobian[4][24] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (var_x3));
        ...
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * (-6.6000000000000005e-5 - 20.0 * var_chaste_interface__intracellular_ion_concentrations__Cai));
        rJacobian[6][7] = -(mDt * (0));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        ...
        rJacobian[6][24] = -(mDt * (20.0 - 20.0 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa));
        rJacobian[7][0] = -(mDt * (0));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (0));
        ...
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (-0.040000000000000001 - 40.0 * var_chaste_interface__intracellular_ion_concentrations__Cai));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        ...
        rJacobian[7][24] = -(mDt * (40.0 - 40.0 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (0));
        ...
        rJacobian[10][10] = 1.0 -(mDt * (-0.13257434520702313 - 0.0011893356491532786 * var_x7 - 3.2630189260961817e-12 * var_x9));
        rJacobian[10][11] = -(mDt * (0.13257434520702313));
        ...
        rJacobian[10][24] = -(mDt * (40.641887388649529 * var_x11 - 4.361396781050011e-7 * var_x12));
        rJacobian[11][0] = -(mDt * (0));
        rJacobian[11][1] = -(mDt * (0));
        rJacobian[11][2] = -(mDt * (0));
        rJacobian[11][3] = -(mDt * (0));
        rJacobian[11][4] = -(mDt * (var_x17));
        rJacobian[11][5] = -(mDt * (var_x17));
        rJacobian[11][6] = -(mDt * (0));
        rJacobian[11][7] = -(mDt * (0));
        rJacobian[11][8] = -(mDt * (0));
        rJacobian[11][9] = -(mDt * (0));
        rJacobian[11][10] = -(mDt * (1.7400382808421784 * var_x15));
        rJacobian[11][11] = 1.0 -(mDt * (var_x16 * (-1740.0382808421784 - var_x18 - var_x19) + 0.00016666666666666666 * pow(var_x13, (-3.0)) * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x20 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / pow((0.083333333333333329 + var_x14), 2)));
        ...
        rJacobian[11][23] = -(mDt * (var_x16 * (var_x18 + var_x19)));
        ...
        rJacobian[13][12] = -(mDt * (var_x22));
        rJacobian[13][13] = 1.0 -(mDt * (var_x28 - var_x29 - var_x30));
        rJacobian[13][14] = -(mDt * (var_x31));
        rJacobian[13][15] = -(mDt * (0));
        rJacobian[13][16] = -(mDt * (0));
        rJacobian[13][17] = -(mDt * (0));
        rJacobian[13][18] = -(mDt * (0.0050000000000000001));
        rJacobian[13][19] = -(mDt * (0));
        rJacobian[13][20] = -(mDt * (0));
        rJacobian[13][21] = -(mDt * (0));
        rJacobian[13][22] = -(mDt * (0));
        rJacobian[13][23] = -(mDt * (-var_x32));
        ...
        rJacobian[14][13] = -(mDt * (var_x29));
        rJacobian[14][14] = 1.0 -(mDt * (var_x33 + var_x35 - var_x36));
        rJacobian[14][15] = -(mDt * (var_x37));
        rJacobian[14][16] = -(mDt * (0));
        rJacobian[14][17] = -(mDt * (0));
        rJacobian[14][18] = -(mDt * (0));
        rJacobian[14][19] = -(mDt * (0.0025000000000000001));
        rJacobian[14][20] = -(mDt * (0));
        rJacobian[14][21] = -(mDt * (0));
        rJacobian[14][22] = -(mDt * (0));
        rJacobian[14][23] = -(mDt * (-var_x38));
        ...
        rJacobian[16][15] = -(mDt * (var_x39));
        rJacobian[16][16] = 1.0 -(mDt * (-0.29999999999999999 - var_x41 - var_x43));
        rJacobian[16][17] = -(mDt * (0));
        rJacobian[16][18] = -(mDt * (0));
        rJacobian[16][19] = -(mDt * (0));
        rJacobian[16][20] = -(mDt * (0));
        rJacobian[16][21] = -(mDt * (0.00062500000000000001));
        rJacobian[16][22] = -(mDt * (0));
        rJacobian[16][23] = -(mDt * (-var_x44));
        ...
        rJacobian[18][13] = -(mDt * (var_x30));
        rJacobian[18][14] = -(mDt * (0));
        rJacobian[18][15] = -(mDt * (0));
        rJacobian[18][16] = -(mDt * (0));
        rJacobian[18][17] = -(mDt * (var_x45));
        rJacobian[18][18] = 1.0 -(mDt * (-0.0050000000000000001 - var_x46 - var_x47));
        rJacobian[18][19] = -(mDt * (var_x26));
        rJacobian[18][20] = -(mDt * (0));
        rJacobian[18][21] = -(mDt * (0));
        rJacobian[18][22] = -(mDt * (0));
        rJacobian[18][23] = -(mDt * (var_x32));
        ...
        rJacobian[19][14] = -(mDt * (var_x36));
        rJacobian[19][15] = -(mDt * (0));
        rJacobian[19][16] = -(mDt * (0));
        rJacobian[19][17] = -(mDt * (0));
        rJacobian[19][18] = -(mDt * (var_x47));
        rJacobian[19][19] = 1.0 -(mDt * (-0.0025000000000000001 + var_x23 + var_x28));
        rJacobian[19][20] = -(mDt * (var_x48));
        rJacobian[19][21] = -(mDt * (0));
        rJacobian[19][22] = -(mDt * (0));
        rJacobian[19][23] = -(mDt * (var_x38));
        ...
        rJacobian[20][15] = -(mDt * (var_x40));
        rJacobian[20][16] = -(mDt * (0));
        rJacobian[20][17] = -(mDt * (0));
        rJacobian[20][18] = -(mDt * (0));
        rJacobian[20][19] = -(mDt * (var_x22));
        rJacobian[20][20] = 1.0 -(mDt * (-0.00125 + var_x35 - var_x48));
        rJacobian[20][21] = -(mDt * (var_x31));
        rJacobian[20][22] = -(mDt * (0));
        rJacobian[20][23] = -(mDt * (var_x42));
        rJacobian[20][24] = -(mDt * (0));
        rJacobian[21][0] = -(mDt * (0));
        rJacobian[21][1] = -(mDt * (7.0));
        ...
        rJacobian[21][16] = -(mDt * (var_x43));
        rJacobian[21][17] = -(mDt * (0));
        rJacobian[21][18] = -(mDt * (0));
        rJacobian[21][19] = -(mDt * (0));
        rJacobian[21][20] = -(mDt * (var_x34));
        rJacobian[21][21] = 1.0 -(mDt * (-0.0076249999999999998 + var_x33));
        rJacobian[21][22] = -(mDt * (0));
        rJacobian[21][23] = -(mDt * (var_x44));
        ...
        rJacobian[22][22] = 1.0 -(mDt * ((((var_x50) && (fabs(var_x51) < 1.0000000000000001e-5)) ? (var_x49 - 1.0 / (-0.13565000000000002 - 0.0050000000000000001 * var_chaste_interface__membrane__V)) : ((var_x50) ? (var_x49 - 0.32000000000000001 * var_x51 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (0)))));
        rJacobian[22][23] = -(mDt * (0));
        rJacobian[22][24] = -(mDt * (0));
        rJacobian[23][0] = -(mDt * (var_x57));
        rJacobian[23][1] = -(mDt * (var_x57));
        rJacobian[23][2] = -(mDt * (0));
        rJacobian[23][3] = -(mDt * (0));
        rJacobian[23][4] = -(mDt * (var_x59));
        rJacobian[23][5] = -(mDt * (var_x59));
        rJacobian[23][6] = -(mDt * (0));
        rJacobian[23][7] = -(mDt * (0));
        rJacobian[23][8] = -(mDt * (0));
        rJacobian[23][9] = -(mDt * (0));
        rJacobian[23][10] = -(mDt * (0));
        rJacobian[23][11] = -(mDt * (var_x58 * (var_x60 + var_x61)));
        ...
        rJacobian[23][23] = 1.0 -(mDt * (var_x58 * (-806491.88514357049 - var_x60 - var_x61) + 2.3800000000000004e-7 * pow(var_x52, (-3.0)) * (806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Cai + 240000.0 * var_x20 - 806491.88514357049 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 2990.8119021922685 * var_x56 * (var_chaste_interface__L_type_Ca_current__O + var_chaste_interface__L_type_Ca_current__O_Ca)) / pow(var_x53, 2)));
        rJacobian[23][24] = -(mDt * (806.49188514357047 * var_x54));
        ...
        rJacobian[24][6] = -(mDt * (var_x66 * (0.0092400000000000017 + var_x62)));
        rJacobian[24][7] = -(mDt * (var_x66 * (2.8000000000000003 + var_x62)));
        rJacobian[24][8] = -(mDt * (0));
        rJacobian[24][9] = -(mDt * (4.9676098137745351e-8 * var_x65 * var_x68 * var_x69 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 2.0)));
        rJacobian[24][10] = -(mDt * (var_x66 * (0.096656534954407292 * var_x7 + 2.651834266564234e-10 * var_x9)));
        ...
        rJacobian[24][23] = -(mDt * (0.037453183520599252 * var_x65));
        rJacobian[24][24] = 1.0 -(mDt * (var_x66 * (-5637.4531835205999 - var_x71 + 3.5444788081288787e-5 * var_x12 + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 2800.0000000000005 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa - 0.00015787156411954756 * var_x72 - 3302.9397645574304 * var_x11 + 0.0015381954438488301 * var_chaste_interface__intracellular_ion_concentrations__Cai / pow(var_x70, 2) - 21.758727097510118 * var_x67 * var_x68) + 2.3800000000000004e-7 * pow(var_x63, (-3.0)) * (2.8000000000000003 * var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss + 0.0092400000000000017 * var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa + 0.00015787156411954756 * log(2.0 * var_x72) - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Cai - 1.181949379053441e-5 * var_chaste_interface__membrane__V - var_x62 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__HTRPNCa) - var_x62 * (1.0 - var_chaste_interface__intracellular_Ca_fluxes__LTRPNCa) - var_x71 * var_chaste_interface__intracellular_ion_concentrations__Cai + 8.279349689624225e-6 * var_x68 * (2.0 * var_x69 * pow(var_chaste_interface__intracellular_ion_concentrations__Nai, 3.0) - 2628072.0 * var_x67 * var_chaste_interface__intracellular_ion_concentrations__Cai) - 1.0 * var_x7 * var_x8) / pow(var_x64, 2)));
    }
    ...
    void Cellwinslow_model_1999FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[20] = (var_chaste_interface__L_type_Ca_current_y_gate__y + ((0.00020000000000000001 / (0.02 + 0.59999999999999998 / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V))) + 0.00080000000000000004 / (0.02 + 0.59999999999999998 / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V)) + 0.02 * exp(2.5 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 0.59999999999999998 * exp(2.5 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.02 + 0.59999999999999998 / (1.0 + exp(2.1052631578947367 + 0.10526315789473684 * var_chaste_interface__membrane__V)))) * mDt));
        rY[2] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((((var_chaste_interface__membrane__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (-0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) - 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) - 310.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__V)) : (-7.6923076923076925 / (1.0 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))))) * mDt));
        ...
        rY[4] = (var_chaste_interface__rapid_activating_delayed_rectifiyer_K_current_X_kr_gate__X_kr + ((0.001 * exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V) / (0.027 * exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V) + 0.027 * exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V) + 0.001 * exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V) / (exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V) + exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V)) + 0.001 * exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V) / (exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V) + exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.027 + 0.001 / (exp(-7.6769999999999996 - 0.012800000000000001 * var_chaste_interface__membrane__V) + exp(-5.4950000000000001 + 0.1691 * var_chaste_interface__membrane__V)))) * mDt));
        rY[5] = (var_chaste_interface__slow_activating_delayed_rectifiyer_K_current_X_ks_gate__X_ks + ((0.00071900000000000002 / (-1.0 + 1.0 * exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V) + exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V) * exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V)) - 0.0013100000000000002 / (-1.0 + 1.0 * exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V) - 1.0 * exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V) + exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V) * exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 0.00013100000000000001 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V) - 1.0 * exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V) + exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V) * exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V)) - 7.1899999999999999e-5 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V) + exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V) * exp(1.8161764705882353 - 0.073529411764705885 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((0.0013100000000000002 / (-1.0 + exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V)) + 0.00071900000000000002 / (1.0 - exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V)) - 7.1899999999999999e-5 * var_chaste_interface__membrane__V / (1.0 - exp(1.48 - 0.14799999999999999 * var_chaste_interface__membrane__V)) - 0.00013100000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.68699999999999994 + 0.068699999999999997 * var_chaste_interface__membrane__V))) * mDt));
        rY[6] = (var_chaste_interface__transient_outward_potassium_current_X_to1_gate__X_to1 + ((0.045159999999999999 * exp(0.035770000000000003 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.045159999999999999 * exp(0.035770000000000003 * var_chaste_interface__membrane__V) - 0.098900000000000002 * exp(-0.062370000000000002 * var_chaste_interface__membrane__V)) * mDt));
        rY[7] = (var_chaste_interface__transient_outward_potassium_current_Y_to1_gate__Y_to1 + ((0.0054150000000000005 * exp(-6.7000000000000002 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + 0.051334999999999999 * exp(-6.7000000000000002 - 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0054150000000000005 * exp(6.7000000000000002 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + 0.051334999999999999 * exp(6.7000000000000002 + 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.0054150000000000005 * exp(-6.7000000000000002 - 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + 0.051334999999999999 * exp(-6.7000000000000002 - 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt));
