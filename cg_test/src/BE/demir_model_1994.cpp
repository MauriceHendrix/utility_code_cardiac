...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celldemir_model_1994FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rJacobian[16][16])
    {
        ...
        double var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i = rY[10];
        // Units: dimensionless; Initial value: 0.3777728
        double var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse = rCurrentGuess[0];double var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel = rCurrentGuess[1];double var_chaste_interface__SR_Ca_uptake_and_release__Ca_up = rCurrentGuess[2];double var_chaste_interface__SR_Ca_uptake_and_release__F1 = rCurrentGuess[3];double var_chaste_interface__SR_Ca_uptake_and_release__F2 = rCurrentGuess[4];double var_chaste_interface__cleft_space_equations__Ca_c = rCurrentGuess[6];double var_chaste_interface__cleft_space_equations__K_c = rCurrentGuess[7];double var_chaste_interface__cleft_space_equations__Na_c = rCurrentGuess[8];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod = rCurrentGuess[9];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop = rCurrentGuess[10];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop = rCurrentGuess[11];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i = rCurrentGuess[12];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__K_i = rCurrentGuess[13];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop = rCurrentGuess[14];double var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i = rCurrentGuess[15];

        const double var_x0 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x1 = 1 / var_x0;
        const double var_x2 = 0.23999999999999999 * pow((var_x1 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i), 4.0);
        const double var_x3 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x4 = var_x0 * var_x2 * var_x3 * (4.0 * var_x1 - 4.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / pow(var_x0, 2));
        const double var_x5 = var_x4 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x6 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x7 = 0.25 + var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x8 = 1 / var_x7;
        const double var_x9 = pow((var_x8 * var_chaste_interface__SR_Ca_uptake_and_release__F2), 2.0);
        const double var_x10 = 1.2294902345128229 * var_x9;
        const double var_x11 = var_x7 * (2.0 * var_x8 - 2.0 * var_chaste_interface__SR_Ca_uptake_and_release__F2 / pow(var_x7, 2)) * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel / var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x12 = 9.5000000000000005e-5 + 2.0454545454545457e-6 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_up + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x13 = 1 / var_x12;
        const double var_x14 = (0.080000000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i - 1.4727272727272728e-7 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_up) / pow(var_x12, 2);
        const double var_x15 = -var_x2;
        const double var_x16 = 0.23999999999999999 * exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x17 = var_x4 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x18 = 1 / var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x19 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 3.0);
        const double var_x20 = pow(var_chaste_interface__cleft_space_equations__Na_c, 3.0);
        const double var_x21 = var_x20 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x22 = var_x19 * var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x23 = 1.0 + 0.0001 * var_x21 + 0.0001 * var_x22;
        const double var_x24 = 0.018714999999999999 * var_chaste_interface__membrane__V;
        const double var_x25 = exp(var_x24);
        const double var_x26 = exp(-var_x24);
        const double var_x27 = (var_x22 * var_x25 - var_x21 * var_x26) / pow(var_x23, 2);
        const double var_x28 = 2.7196856284372237e-11 * var_x27;
        const double var_x29 = 1 / var_x23;
        const double var_x30 = 2.7196856284372236e-7 * var_x29;
        const double var_x31 = var_x19 * var_x25;
        const double var_x32 = 0.00040000000000000002 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x33 = 1 / var_x32;
        const double var_x34 = var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i / pow(var_x32, 2);
        const double var_x35 = var_x20 * var_x26;
        const double var_x36 = 8.1590568853116704e-7 * var_x29;
        const double var_x37 = pow(var_chaste_interface__cleft_space_equations__Na_c, 2.0) * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x38 = var_x26 * var_x37;
        const double var_x39 = 8.159056885311671e-11 * var_x27;
        const double var_x40 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i, 2.0) * var_chaste_interface__cleft_space_equations__Ca_c;
        const double var_x41 = var_x25 * var_x40;
        const double var_x42 = 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x43 = 0.0015934193439286187 * var_x9;
        const double var_x44 = 7.9543493648916641e-8 * var_x29;
        const double var_x45 = 7.9543493648916655e-12 * var_x27;
        const double var_x46 = 2.3863048094674991e-7 * var_x29;
        const double var_x47 = 2.3863048094674993e-11 * var_x27;
        const double var_x48 = 1 / var_chaste_interface__cleft_space_equations__K_c;
        const double var_x49 = var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        const double var_x50 = 0.010911506218902908 * var_x49;
        const double var_x51 = 0.621 + var_chaste_interface__cleft_space_equations__K_c;
        const double var_x52 = 1 / var_x51;
        const double var_x53 = 5.46 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i;
        const double var_x54 = 1 / var_x53;
        const double var_x55 = pow((var_x52 * var_chaste_interface__cleft_space_equations__K_c), 2.0) * pow((var_x54 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i), 3.0) / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V));
        const double var_x56 = 0.015286027942395882 * var_x55;
        const double var_x57 = var_x48 * var_x51 * (2.0 * var_x52 - 2.0 * var_chaste_interface__cleft_space_equations__K_c / pow(var_x51, 2));
        const double var_x58 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__K_i;
        const double var_x59 = 1 / var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i;
        const double var_x60 = var_x53 * var_x59 * (3.0 * var_x54 - 0.1006319687638369 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i / pow((1 + 0.18315018315018314 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Na_i), 2));
        const double var_x61 = 0.022929041913593823 * var_x55;
        const double var_x62 = 1 / var_chaste_interface__cleft_space_equations__Na_c;
        const double var_x63 = 2.4477170655935014e-10 * var_x27;
        const double var_x64 = 2.447717065593501e-6 * var_x29;
        const double var_x65 = 0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x66 = var_x59 * var_chaste_interface__cleft_space_equations__Na_c;
        const double var_x67 = exp(var_x65 - 1.0 * log(var_x66));
        const double var_x68 = pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * var_chaste_interface__membrane__V * var_chaste_interface__sodium_current_h_gate__h1 * var_chaste_interface__sodium_current_h_gate__h2 / (-1.0 + exp(var_x65));
        const double var_x69 = var_x68 * (-1.0 + var_x67);
        const double var_x70 = var_x67 * var_x68;
        const double var_x71 = 0.27076272189238759 * var_x70;
        const double var_x72 = 0.0031913222489694526 * var_x49;
        const double var_x73 = 0.0044707522584211609 * var_x55;
        const double var_x74 = 0.0067061283876317422 * var_x55;
        const double var_x75 = 7.1589144284024978e-7 * var_x29;
        const double var_x76 = 7.158914428402498e-11 * var_x27;
        const double var_x77 = 0.079190817585730572 * var_x70;
        ...
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0.77000000000000002 - 0.77000000000000002 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse));
        rJacobian[0][7] = -(mDt * (0));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[0][9] = -(mDt * (0));
        ...
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-0.00096000000000000002));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        ...
        rJacobian[1][7] = -(mDt * (0));
        rJacobian[1][8] = -(mDt * (0));
        rJacobian[1][9] = -(mDt * (0.040000000000000001 + var_x2));
        rJacobian[1][10] = -(mDt * (0));
        rJacobian[1][11] = -(mDt * (var_x5));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.307 + var_x6));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        ...
        rJacobian[2][11] = -(mDt * (129.0 - 129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.252 - 50.5 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        ...
        rJacobian[3][11] = -(mDt * (50.5 - 50.5 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-0.0042500000000000003 + var_x6));
        rJacobian[4][5] = -(mDt * (var_x6));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (0));
        rJacobian[4][10] = -(mDt * (0));
        rJacobian[4][11] = -(mDt * (129.0 - 129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop - 129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop));
        ...
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (-3.2250000000000001));
        rJacobian[5][5] = 1.0 -(mDt * (-3.6539999999999999));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0));
        ...
        rJacobian[6][0] = -(mDt * (7.3586800000000006 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * (-8.979782511378108 - var_x10 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse));
        rJacobian[6][7] = -(mDt * (0.14018251137810708));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (-var_x10 * var_x11));
        ...
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0.015581177937052042));
        rJacobian[7][7] = 1.0 -(mDt * (-0.015581177937052042 - 4.0251665946738841e-8 * var_x13 - 5.5905091592692838e-7 * var_x14));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (0.021865102489586532 * var_x13 - 0.27331378111983168 * var_x14));
        rJacobian[7][12] = -(mDt * (0));
        rJacobian[7][13] = -(mDt * (0));
        rJacobian[7][14] = -(mDt * (0));
        rJacobian[7][15] = -(mDt * (0));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0.00096000000000000002));
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (0));
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (var_x15 - var_x16));
        rJacobian[8][9] = -(mDt * (0));
        rJacobian[8][10] = -(mDt * (0));
        rJacobian[8][11] = -(mDt * (-var_x17));
        ...
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (var_x16 + var_x2));
        rJacobian[9][9] = 1.0 -(mDt * (-0.040000000000000001 + var_x15));
        rJacobian[9][10] = -(mDt * (0));
        rJacobian[9][11] = -(mDt * (var_x17 - var_x5));
        ...
        rJacobian[10][10] = 1.0 -(mDt * (-0.10000000000000001 - 5.2976168399354324e-6 * var_x18 + var_x19 * var_x28 - var_x30 * var_x31));
        rJacobian[10][11] = -(mDt * (0.00031261130080073693 * var_x33 + 5.2976168399354324e-6 * var_x3 - 0.00031261130080073693 * var_x34 + var_x20 * var_x28 + var_x30 * var_x35));
        rJacobian[10][12] = -(mDt * (0));
        rJacobian[10][13] = -(mDt * (var_x36 * var_x38 + var_x37 * var_x39));
        rJacobian[10][14] = -(mDt * (0));
        rJacobian[10][15] = -(mDt * (var_x39 * var_x40 - var_x36 * var_x41));
        rJacobian[11][0] = -(mDt * (0));
        rJacobian[11][1] = -(mDt * (0));
        rJacobian[11][2] = -(mDt * (0.027629999999999998 + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i));
        rJacobian[11][3] = -(mDt * (0.0078120000000000004 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i));
        rJacobian[11][4] = -(mDt * (0.00026350000000000001 + var_x42));
        rJacobian[11][5] = -(mDt * (var_x42));
        rJacobian[11][6] = -(mDt * (var_x43));
        rJacobian[11][7] = -(mDt * (4.6933442493897489e-10 * var_x13 + 6.5185336797079855e-9 * var_x14));
        rJacobian[11][8] = -(mDt * (0));
        rJacobian[11][9] = -(mDt * (var_x11 * var_x43));
        rJacobian[11][10] = -(mDt * (1.5494105166262771e-6 * var_x18 + var_x31 * var_x44 - var_x19 * var_x45));
        rJacobian[11][11] = 1.0 -(mDt * (-21.173500000000001 + 0.0031868386878572373 * var_x14 + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + 9.1430401954624137e-5 * var_x34 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop - 0.00025494709502857897 * var_x13 - 1.5494105166262771e-6 * var_x3 - 9.1430401954624137e-5 * var_x33 - var_x20 * var_x45 - var_x35 * var_x44));
        rJacobian[11][12] = -(mDt * (0));
        rJacobian[11][13] = -(mDt * (-var_x37 * var_x47 - var_x38 * var_x46));
        rJacobian[11][14] = -(mDt * (0));
        rJacobian[11][15] = -(mDt * (var_x41 * var_x46 - var_x40 * var_x47));
        ...
        rJacobian[12][12] = 1.0 -(mDt * (-0.10000000000000001 - 4.040160535071638e-5 * var_x48 - var_x48 * var_x50 - var_x56 * var_x57));
        rJacobian[12][13] = -(mDt * (0));
        rJacobian[12][14] = -(mDt * (4.040160535071638e-5 * var_x58 + var_x50 * var_x58));
        rJacobian[12][15] = -(mDt * (-var_x56 * var_x60));
        ...
        rJacobian[13][10] = -(mDt * (var_x31 * var_x36 - var_x19 * var_x39));
        rJacobian[13][11] = -(mDt * (-var_x20 * var_x39 - var_x35 * var_x36));
        rJacobian[13][12] = -(mDt * (var_x57 * var_x61));
        rJacobian[13][13] = 1.0 -(mDt * (-0.10000000000000001 - var_x71 + 0.27076272189238759 * var_x69 - 9.3144911471392233e-5 * var_x62 - var_x37 * var_x63 - var_x38 * var_x64));
        rJacobian[13][14] = -(mDt * (0));
        rJacobian[13][15] = -(mDt * (9.3144911471392233e-5 * var_x59 + var_x41 * var_x64 + var_x60 * var_x61 + var_x66 * var_x71 - var_x40 * var_x63));
        ...
        rJacobian[14][12] = -(mDt * (1.1816383500424576e-5 * var_x48 + var_x48 * var_x72 + var_x57 * var_x73));
        rJacobian[14][13] = -(mDt * (0));
        rJacobian[14][14] = 1.0 -(mDt * (-1.1816383500424576e-5 * var_x58 - var_x58 * var_x72));
        rJacobian[14][15] = -(mDt * (var_x60 * var_x73));
        ...
        rJacobian[15][10] = -(mDt * (var_x19 * var_x47 - var_x31 * var_x46));
        rJacobian[15][11] = -(mDt * (var_x20 * var_x47 + var_x35 * var_x46));
        rJacobian[15][12] = -(mDt * (-var_x57 * var_x74));
        rJacobian[15][13] = -(mDt * (var_x77 + 2.7242382709912566e-5 * var_x62 - 0.079190817585730572 * var_x69 + var_x37 * var_x76 + var_x38 * var_x75));
        rJacobian[15][14] = -(mDt * (0));
        rJacobian[15][15] = 1.0 -(mDt * (-2.7242382709912566e-5 * var_x59 + var_x40 * var_x76 - var_x41 * var_x75 - var_x60 * var_x74 - var_x66 * var_x77));
    }
    ...
    void Celldemir_model_1994FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[5] = (var_chaste_interface__L_type_Ca_channel_d_gate__d_L + ((-0.99365000000000003 / (-1.0 + 1.0 * exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V)) - 0.057149999999999999 / (-1.0 + 1.0 * exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V)) + 0.011429999999999999 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V)) - 0.028390000000000002 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V)) - 0.084900000000000003 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-0.20799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V) + exp(-0.20799999999999999 * var_chaste_interface__membrane__V) * exp(-2.3500000000000001 - 0.16666666666666666 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((0.99365000000000003 / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.057149999999999999 / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.028390000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(-14.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.084900000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(-0.20799999999999999 * var_chaste_interface__membrane__V)) - 0.011429999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(-2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V))) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_gate__f_L + ((0.029999999999999999 / (1.0 + 1.0 * exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-7.0 - 0.25 * var_chaste_interface__membrane__V) + exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-7.0 - 0.25 * var_chaste_interface__membrane__V)) + 0.105 / (-1.0 + 1.0 * exp(7.0 + 0.25 * var_chaste_interface__membrane__V) - 1.0 * exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(7.0 + 0.25 * var_chaste_interface__membrane__V)) + 0.0037499999999999999 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(7.0 + 0.25 * var_chaste_interface__membrane__V) - 1.0 * exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(7.0 + 0.25 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.029999999999999999 / (1.0 + exp(-7.0 - 0.25 * var_chaste_interface__membrane__V)) - 0.105 / (-1.0 + exp(7.0 + 0.25 * var_chaste_interface__membrane__V)) - 0.0037499999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(7.0 + 0.25 * var_chaste_interface__membrane__V))) * mDt));
        ...
        rY[8] = (var_chaste_interface__T_type_Ca_channel_f_gate__f_T + ((0.014999999999999999 * exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V) / (1.0 + exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V)) + 0.015300000000000001 * exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V) / (1.0 + exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.014999999999999999 * exp(4.0117035110533159 + 0.065019505851755519 * var_chaste_interface__membrane__V) - 0.015300000000000001 * exp(-0.74069627851140463 - 0.012004801920768308 * var_chaste_interface__membrane__V)) * mDt));
        rY[9] = (var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a + ((0.017000000000000001 * exp(0.039800000000000002 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V)) + 0.0021099999999999999 * exp(-0.050999999999999997 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.017000000000000001 * exp(0.039800000000000002 * var_chaste_interface__membrane__V) - 0.0021099999999999999 * exp(-0.050999999999999997 * var_chaste_interface__membrane__V)) * mDt));
        rY[10] = (var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i + ((0.10000000000000001 * exp(-0.0183 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.10000000000000001 * exp(-0.0183 * var_chaste_interface__membrane__V) - 0.65600000000000003 * exp(0.0094199999999999996 * var_chaste_interface__membrane__V)) * mDt));
        rY[11] = (var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + ((0.01401055 / (0.69999999999999996 + 1.0 * exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V) + 0.69999999999999996 * exp(8.0222222222222221 + 0.1111111111111111 * var_chaste_interface__membrane__V) + exp(8.0222222222222221 + 0.1111111111111111 * var_chaste_interface__membrane__V) * exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V)) + 0.0016483000000000001 * exp(-2.2219482120838472 - 0.041101520756267988 * var_chaste_interface__membrane__V) / (1.0 + exp(8.0222222222222221 + 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0016483000000000001 * exp(-2.2219482120838472 - 0.041101520756267988 * var_chaste_interface__membrane__V) - 0.01401055 / (0.69999999999999996 + exp(-10.909090909090908 - 0.18181818181818182 * var_chaste_interface__membrane__V))) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_h_gate__h1 + ((27.225000000000001 * pow(exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V), 2) / (165.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) + 12360.0 / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V))) + 2039.4000000000001 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) / (165.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) + 52800.0 * pow(exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V), 2) + 12360.0 / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V)) + 3955200.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.16500000000000001 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) - 12.359999999999999 / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V))) * mDt));
        rY[4] = (var_chaste_interface__sodium_current_h_gate__h2 + ((1.3612500000000001 * pow(exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V), 2) / (165.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) + 12360.0 / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V))) + 101.97 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) / (165.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) + 52800.0 * pow(exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V), 2) + 12360.0 / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V)) + 3955200.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.0082500000000000004 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V) - 0.61799999999999999 / (1.0 + 320.0 * exp(-8.0396825396825395 - 0.079365079365079361 * var_chaste_interface__membrane__V))) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_m_gate__m + ((-42.765599999999999 / (0.64148399999999994 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 0.49440000000000001 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.49440000000000001 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) + 32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) + 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) + 0.012359999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) / (42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) + 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.64148399999999994 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.012359999999999999 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.82400000000000007 * var_chaste_interface__membrane__V / (0.64148399999999994 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 0.49440000000000001 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.49440000000000001 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) + 32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) + 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) + 0.012359999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) / (42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) + 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.64148399999999994 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 32960.0 * pow(exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V), 2) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 42765.599999999999 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) + 824.0 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))) - 0.012359999999999999 * var_chaste_interface__membrane__V * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (1.5e-5 + 1.0 / (32960.0 * exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V) - 42765.599999999999 / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V)) - 824.0 * var_chaste_interface__membrane__V / (-1.0 + exp(-5.8314606741573032 - 0.11235955056179775 * var_chaste_interface__membrane__V))))) * mDt));
