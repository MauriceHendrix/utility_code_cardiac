...
#include "CardiacNewtonSolver.hpp"
    ...
    double CellShannon2004FromCellMLBackwardEuler::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_INaCa__Ka_SL = 1.0 / (1.0 + pow((var_INaCa__Kd_act / var_chaste_interface__Ca_buffer__Ca_SL), 3.0)); // dimensionless
        const double var_INaCa__Ka_jct = 1.0 / (1.0 + pow((var_INaCa__Kd_act / var_chaste_interface__Ca_buffer__Ca_jct), 3.0)); // dimensionless
        ...
        const double var_ICaL__temp = 0.45000000000000001 * pow(var_model_parameters__F, 2.0) * var_ICaL__Q_CaL * var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V / (var_model_parameters__R * var_model_parameters__T); // coulomb_per_mole
    ...
    void CellShannon2004FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rResidual[26])
    {
        ...
        const double var_model_parameters__Vol_Cell = 3.1415926540000002e-15 * pow(var_model_parameters__cell_radius, 2.0) * var_model_parameters__cell_length; // liter
    ...
    void CellShannon2004FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[26], double rJacobian[26][26])
    {
        ...
        double var_chaste_interface__ICaL_f_gate__f = rY[13];
        // Units: dimensionless; Initial value: 1.000681
        double var_chaste_interface__Ca_buffer__Ca_Calsequestrin = rCurrentGuess[0];double var_chaste_interface__Ca_buffer__Ca_SL = rCurrentGuess[1];double var_chaste_interface__Ca_buffer__Ca_SLB_SL = rCurrentGuess[2];double var_chaste_interface__Ca_buffer__Ca_SLB_jct = rCurrentGuess[3];double var_chaste_interface__Ca_buffer__Ca_SLHigh_SL = rCurrentGuess[4];double var_chaste_interface__Ca_buffer__Ca_SLHigh_jct = rCurrentGuess[5];double var_chaste_interface__Ca_buffer__Ca_SR = rCurrentGuess[6];double var_chaste_interface__Ca_buffer__Ca_jct = rCurrentGuess[7];double var_chaste_interface__Ca_buffer__Cai = rCurrentGuess[8];double var_chaste_interface__ICaL_fCa_gate__fCaB_SL = rCurrentGuess[9];double var_chaste_interface__ICaL_fCa_gate__fCaB_jct = rCurrentGuess[10];double var_chaste_interface__Jrel_SR__I = rCurrentGuess[11];double var_chaste_interface__Jrel_SR__O = rCurrentGuess[12];double var_chaste_interface__Jrel_SR__R = rCurrentGuess[13];double var_chaste_interface__Na_buffer__Na_SL = rCurrentGuess[14];double var_chaste_interface__Na_buffer__Na_SL_buf = rCurrentGuess[15];double var_chaste_interface__Na_buffer__Na_jct = rCurrentGuess[16];double var_chaste_interface__Na_buffer__Na_jct_buf = rCurrentGuess[17];double var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin = rCurrentGuess[19];double var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin = rCurrentGuess[20];double var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB = rCurrentGuess[21];double var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC = rCurrentGuess[22];double var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg = rCurrentGuess[23];double var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin = rCurrentGuess[24];double var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg = rCurrentGuess[25];

        const double var_x0 = 1 / var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x1 = pow(var_x0, 2.5);
        const double var_x2 = 1.0 + 0.13584112963311223 * var_x1;
        const double var_x3 = 1 / var_x2;
        const double var_x4 = 1 / (15.0 - 14.0 * var_x3);
        const double var_x5 = pow(var_chaste_interface__Ca_buffer__Ca_jct, 2.0);
        const double var_x6 = 10.0 * var_x4 * var_x5;
        const double var_x7 = -var_x6;
        const double var_x8 = 7.0 * var_x3;
        const double var_x9 = 7.5 - var_x8;
        const double var_x10 = var_x0 * var_x1 / pow(var_x2, 2);
        const double var_x11 = 2.3772197685794643 * var_x10 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x12 = var_x11 * var_chaste_interface__Jrel_SR__O;
        const double var_x13 = 1.0 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x14 = 0.21130842387373014 * var_x10 * var_x5 / pow((1 - 0.93333333333333335 * var_x3), 2);
        const double var_x15 = 20.0 * var_x4 * pow(var_chaste_interface__Ca_buffer__Ca_jct, 1.0);
        const double var_x16 = -7.5 + var_x8;
        const double var_x17 = var_x16 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x18 = var_x14 * var_chaste_interface__Jrel_SR__R;
        const double var_x19 = var_x15 * var_chaste_interface__Jrel_SR__R;
        const double var_x20 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL;
        const double var_x21 = 0.0001 * var_chaste_interface__Na_buffer__Na_SL_buf;
        const double var_x22 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct;
        const double var_x23 = 0.0001 * var_chaste_interface__Na_buffer__Na_jct_buf;
        const double var_x24 = 34.0 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x25 = 34.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Calmodulin;
        const double var_x26 = 13.800000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x27 = -var_x26;
        const double var_x28 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_Myosin;
        const double var_x29 = 13.800000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_Myosin;
        const double var_x30 = 100.0 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x31 = 100.0 * var_chaste_interface__cytosolic_Ca_buffer__Ca_SRB;
        const double var_x32 = 32.700000000000003 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x33 = 32.700000000000003 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC;
        const double var_x34 = 2.3700000000000001 * var_chaste_interface__Ca_buffer__Cai;
        const double var_x35 = -var_x34;
        const double var_x36 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Ca_TroponinC_Ca_Mg;
        const double var_x37 = 2.3700000000000001 * var_chaste_interface__cytosolic_Ca_buffer__Mg_TroponinC_Ca_Mg;
        const double var_x38 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SR;
        const double var_x39 = 100.0 * var_chaste_interface__Ca_buffer__Ca_Calsequestrin;
        const double var_x40 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x41 = -var_x40;
        const double var_x42 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_SL;
        const double var_x43 = 100.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x44 = -var_x43;
        const double var_x45 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLB_jct;
        const double var_x46 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_SL;
        const double var_x47 = 100.0 * var_chaste_interface__Ca_buffer__Ca_SLHigh_jct;
        const double var_x48 = 25.0 * var_chaste_interface__Jrel_SR__O;
        ...
        const double var_x53 = 1 / (1.0 + var_x50 + var_x52);
        const double var_x54 = pow(var_chaste_interface__Ca_buffer__Ca_SR, 0.78699999999999992);
        const double var_x55 = var_x53 * var_x54;
        const double var_x56 = (var_x52 - var_x50) / pow((3.5530476870814998e-7 + var_x51 + 1.3765399305573384e-7 * var_x49), 2);
        const double var_x57 = var_x54 * var_x56;
        const double var_x58 = pow(var_chaste_interface__Ca_buffer__Cai, 0.78699999999999992);
        const double var_x59 = var_x53 * var_x58;
        const double var_x60 = var_x56 * var_x58;
        const double var_x61 = exp(0.07486906546164343 * var_chaste_interface__cell__V);
        const double var_x62 = 0.34100000000000003 * var_x61;
        const double var_x63 = var_chaste_interface__ICaL_d_gate__d * var_chaste_interface__ICaL_f_gate__f * var_chaste_interface__cell__V;
        const double var_x64 = var_x63 / (-1.0 + var_x61);
        const double var_x65 = 1 / var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x66 = pow(var_x65, 1.6000000000000001);
        const double var_x67 = exp(-0.024332446275034118 * var_chaste_interface__cell__V);
        const double var_x68 = 1 / (1.0 + 0.27000000000000002 * var_x67);
        const double var_x69 = var_x67 * var_x68;
        const double var_x70 = pow(var_x65, 3.0);
        const double var_x71 = 1.0 + 1.6777215999999998e-11 * var_x70;
        const double var_x72 = 1 / var_x71;
        const double var_x73 = 2744000.0 * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x74 = pow(var_chaste_interface__Na_buffer__Na_SL, 3.0);
        const double var_x75 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_SL) * var_chaste_interface__Ca_buffer__Ca_SL;
        const double var_x76 = 1 / (9850.9599999999991 + var_x73 + 669921.875 * var_x75 + 8.4066800865219591 * var_x74);
        const double var_x77 = var_x72 * var_x76;
        const double var_x78 = var_x69 * var_x77;
        const double var_x79 = exp(0.013102086455787599 * var_chaste_interface__cell__V);
        const double var_x80 = 1.8 * var_x79;
        const double var_x81 = var_x68 * (var_x74 * var_x80 - var_x67 * var_x73);
        const double var_x82 = var_x72 * var_x81 / pow((0.0035899999999999999 + 0.244140625 * var_x75 + 3.0636589236596063e-6 * var_x74 + var_chaste_interface__Ca_buffer__Ca_SL), 2);
        const double var_x83 = var_x82 * (-3413921.875 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_SL);
        const double var_x84 = var_x65 * var_x70 * var_x76 * var_x81 / pow(var_x71, 2);
        const double var_x85 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_SL;
        const double var_x86 = var_x61 * var_x64;
        const double var_x87 = pow(var_chaste_interface__Na_buffer__Na_SL, 2.0);
        const double var_x88 = var_x68 * var_x79;
        const double var_x89 = var_x77 * var_x87 * var_x88;
        const double var_x90 = var_x82 * var_x87;
        const double var_x91 = 1623.3766233766235 * var_chaste_interface__Jrel_SR__O;
        const double var_x92 = 1 / var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x93 = pow(var_x92, 1.6000000000000001);
        const double var_x94 = pow(var_x92, 3.0);
        const double var_x95 = 1.0 + 1.6777215999999998e-11 * var_x94;
        const double var_x96 = 1 / var_x95;
        const double var_x97 = 2744000.0 * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x98 = pow(var_chaste_interface__Na_buffer__Na_jct, 3.0);
        const double var_x99 = (1.0 + 278.55153203342621 * var_chaste_interface__Ca_buffer__Ca_jct) * var_chaste_interface__Ca_buffer__Ca_jct;
        const double var_x100 = 1 / (9850.9599999999991 + var_x97 + 669921.875 * var_x99 + 8.4066800865219591 * var_x98);
        const double var_x101 = var_x100 * var_x96;
        const double var_x102 = var_x101 * var_x69;
        const double var_x103 = var_x68 * (var_x80 * var_x98 - var_x67 * var_x97);
        const double var_x104 = var_x103 * var_x96 / pow((0.0035899999999999999 + 0.244140625 * var_x99 + 3.0636589236596063e-6 * var_x98 + var_chaste_interface__Ca_buffer__Ca_jct), 2);
        const double var_x105 = var_x104 * (-3413921.875 - 373215529.24791086 * var_chaste_interface__Ca_buffer__Ca_jct);
        const double var_x106 = var_x100 * var_x103 * var_x92 * var_x94 / pow(var_x95, 2);
        const double var_x107 = 1.0 - var_chaste_interface__ICaL_fCa_gate__fCaB_jct;
        const double var_x108 = pow(var_chaste_interface__Na_buffer__Na_jct, 2.0);
        const double var_x109 = var_x101 * var_x108 * var_x88;
        const double var_x110 = var_x104 * var_x108;
        const double var_x111 = 0.037434532730821715 * var_chaste_interface__cell__V;
        const double var_x112 = exp(var_x111);
        const double var_x113 = 0.75 * var_x112;
        const double var_x114 = var_x63 / (-1.0 + var_x112);
        const double var_x115 = 1 / var_chaste_interface__Na_buffer__Na_SL;
        const double var_x116 = pow(var_x115, 4.0);
        const double var_x117 = 1 / (1.0 + 0.1245 * exp(-0.0037434532730821718 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-var_x111));
        const double var_x118 = pow(var_chaste_interface__INa_m_gate__m, 3.0) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j;
        const double var_x119 = var_x112 * var_x114;
        const double var_x120 = 1 / var_chaste_interface__Na_buffer__Na_jct;
        const double var_x121 = pow(var_x120, 4.0);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_SL));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        ...
        rJacobian[0][22] = -(mDt * (1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_SL));
        rJacobian[0][23] = -(mDt * (0));
        rJacobian[0][24] = -(mDt * (0));
        rJacobian[0][25] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-0.011900000000000001 - 1.7 * var_chaste_interface__Ca_buffer__Ca_jct));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        ...
        rJacobian[1][23] = -(mDt * (1.7 - 1.7 * var_chaste_interface__ICaL_fCa_gate__fCaB_jct));
        rJacobian[1][24] = -(mDt * (0));
        rJacobian[1][25] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.065000000000000002 + var_x7));
        rJacobian[2][3] = -(mDt * (var_x7 + var_x9 * var_chaste_interface__Ca_buffer__Ca_jct));
        rJacobian[2][4] = -(mDt * (var_x7));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        ...
        rJacobian[2][19] = -(mDt * (-var_x12 + var_x13 * var_x14));
        rJacobian[2][20] = -(mDt * (0));
        rJacobian[2][21] = -(mDt * (0));
        rJacobian[2][22] = -(mDt * (0));
        rJacobian[2][23] = -(mDt * (var_x13 * var_x15 + var_x9 * var_chaste_interface__Jrel_SR__O));
        rJacobian[2][24] = -(mDt * (0));
        rJacobian[2][25] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (0));
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0.0050000000000000001));
        rJacobian[3][3] = 1.0 -(mDt * (-0.059999999999999998 + var_x17));
        rJacobian[3][4] = -(mDt * (var_x6));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        ...
        rJacobian[3][19] = -(mDt * (var_x12 + var_x18));
        rJacobian[3][20] = -(mDt * (0));
        rJacobian[3][21] = -(mDt * (0));
        rJacobian[3][22] = -(mDt * (0));
        rJacobian[3][23] = -(mDt * (var_x19 + var_x16 * var_chaste_interface__Jrel_SR__O));
        rJacobian[3][24] = -(mDt * (0));
        rJacobian[3][25] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (-0.0050000000000000001));
        rJacobian[4][3] = -(mDt * (0.055));
        rJacobian[4][4] = 1.0 -(mDt * (-0.0050000000000000001 + var_x17 + var_x7));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        ...
        rJacobian[4][19] = -(mDt * (-var_x18 + var_x11 * var_chaste_interface__Jrel_SR__R));
        rJacobian[4][20] = -(mDt * (0));
        rJacobian[4][21] = -(mDt * (0));
        rJacobian[4][22] = -(mDt * (0));
        rJacobian[4][23] = -(mDt * (-var_x19 + var_x16 * var_chaste_interface__Jrel_SR__R));
        ...
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.001 - var_x20));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0));
        ...
        rJacobian[5][24] = -(mDt * (0.000165 - var_x21));
        ...
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * (-0.001 - var_x22));
        rJacobian[6][7] = -(mDt * (0));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        ...
        rJacobian[6][25] = -(mDt * (0.0007561 - var_x23));
        rJacobian[7][0] = -(mDt * (0));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (0));
        ...
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (-0.23799999999999999 - var_x24));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        ...
        rJacobian[7][20] = -(mDt * (0.81600000000000006 - var_x25));
        ...
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (-0.00046000000000000001 + var_x27));
        rJacobian[8][9] = -(mDt * (0));
        rJacobian[8][10] = -(mDt * (0));
        rJacobian[8][11] = -(mDt * (0));
        rJacobian[8][12] = -(mDt * (var_x27));
        ...
        rJacobian[8][20] = -(mDt * (1.9320000000000004 - var_x28 - var_x29));
        ...
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (0));
        rJacobian[9][9] = 1.0 -(mDt * (-0.059999999999999998 - var_x30));
        ...
        rJacobian[9][20] = -(mDt * (1.71 - var_x31));
        ...
        rJacobian[10][10] = 1.0 -(mDt * (-0.019599999999999999 - var_x32));
        ...
        rJacobian[10][20] = -(mDt * (2.2890000000000006 - var_x33));
        ...
        rJacobian[11][11] = 1.0 -(mDt * (-3.1999999999999999e-5 + var_x35));
        rJacobian[11][12] = -(mDt * (0));
        rJacobian[11][13] = -(mDt * (var_x35));
        ...
        rJacobian[11][20] = -(mDt * (0.33180000000000004 - var_x36 - var_x37));
        ...
        rJacobian[12][8] = -(mDt * (-0.015699999999999999));
        rJacobian[12][9] = -(mDt * (0));
        rJacobian[12][10] = -(mDt * (0));
        rJacobian[12][11] = -(mDt * (0));
        rJacobian[12][12] = 1.0 -(mDt * (-0.015757));
        ...
        rJacobian[13][11] = -(mDt * (-0.0030000000000000001));
        rJacobian[13][12] = -(mDt * (0));
        rJacobian[13][13] = 1.0 -(mDt * (-0.0063300000000000006));
        ...
        rJacobian[15][15] = 1.0 -(mDt * (-1.3 + var_x41));
        ...
        rJacobian[15][22] = -(mDt * (121.55000000000001 - var_x42));
        ...
        rJacobian[16][16] = 1.0 -(mDt * (-1.3 + var_x44));
        ...
        rJacobian[16][23] = -(mDt * (55.473098330241186 - var_x45));
        ...
        rJacobian[17][17] = 1.0 -(mDt * (-0.029999999999999999 + var_x41));
        rJacobian[17][18] = -(mDt * (0));
        rJacobian[17][19] = -(mDt * (0));
        rJacobian[17][20] = -(mDt * (0));
        rJacobian[17][21] = -(mDt * (0));
        rJacobian[17][22] = -(mDt * (43.550000000000004 - var_x46));
        ...
        rJacobian[18][18] = 1.0 -(mDt * (-0.029999999999999999 + var_x44));
        rJacobian[18][19] = -(mDt * (0));
        rJacobian[18][20] = -(mDt * (0));
        rJacobian[18][21] = -(mDt * (0));
        rJacobian[18][22] = -(mDt * (0));
        rJacobian[18][23] = -(mDt * (19.897959183673468 - var_x47));
        rJacobian[18][24] = -(mDt * (0));
        rJacobian[18][25] = -(mDt * (0));
        rJacobian[19][0] = -(mDt * (0));
        rJacobian[19][1] = -(mDt * (0));
        rJacobian[19][2] = -(mDt * (0));
        rJacobian[19][3] = -(mDt * (25.0 * var_chaste_interface__Ca_buffer__Ca_jct - 25.0 * var_chaste_interface__Ca_buffer__Ca_SR));
        ...
        rJacobian[19][14] = -(mDt * (65.0 + var_x38));
        rJacobian[19][15] = -(mDt * (0));
        rJacobian[19][16] = -(mDt * (0));
        rJacobian[19][17] = -(mDt * (0));
        rJacobian[19][18] = -(mDt * (0));
        rJacobian[19][19] = 1.0 -(mDt * (-260.00009932 + var_x39 - var_x48 - 4.6421953480341129e-16 * var_x57 - 0.0036772346118413473 * var_x55));
        rJacobian[19][20] = -(mDt * (26713.606559545973 * var_x59 - 3.3723651925989277e-9 * var_x60));
        rJacobian[19][21] = -(mDt * (0));
        rJacobian[19][22] = -(mDt * (0));
        rJacobian[19][23] = -(mDt * (9.9320000000000005e-5 + var_x48));
        ...
        rJacobian[20][7] = -(mDt * (0.23799999999999999 + var_x24));
        rJacobian[20][8] = -(mDt * (0.016159999999999997 + var_x26));
        rJacobian[20][9] = -(mDt * (0.059999999999999998 + var_x30));
        rJacobian[20][10] = -(mDt * (0.019599999999999999 + var_x32));
        rJacobian[20][11] = -(mDt * (0.003032 + var_x34));
        rJacobian[20][12] = -(mDt * (0.015757 + var_x26));
        rJacobian[20][13] = -(mDt * (0.0063300000000000006 + var_x34));
        rJacobian[20][14] = -(mDt * (0));
        rJacobian[20][15] = -(mDt * (0));
        rJacobian[20][16] = -(mDt * (0));
        rJacobian[20][17] = -(mDt * (0));
        rJacobian[20][18] = -(mDt * (0));
        rJacobian[20][19] = -(mDt * (2.4996436489414456e-17 * var_x57 + 0.00019800494063761101 * var_x55));
        rJacobian[20][20] = 1.0 -(mDt * (-7.2523935948689155 + var_x25 + var_x28 + var_x29 + var_x31 + var_x33 + var_x36 + var_x37 + 1.8158889498609611e-10 * var_x60 - 1438.4249685909372 * var_x59));
        rJacobian[20][21] = -(mDt * (0));
        rJacobian[20][22] = -(mDt * (0.17359359486891501));
        ...
        rJacobian[21][20] = -(mDt * (0));
        rJacobian[21][21] = 1.0 -(mDt * (-0.076376893524206985));
        rJacobian[21][22] = -(mDt * (0));
        rJacobian[21][23] = -(mDt * (0));
        rJacobian[21][24] = -(mDt * (0.076376893524206985));
        rJacobian[21][25] = -(mDt * (0));
        rJacobian[22][0] = -(mDt * (0.00038060524173864864 * var_x64 * (-0.61380000000000001 + var_x62 * var_chaste_interface__Ca_buffer__Ca_SL)));
        ...
        rJacobian[22][15] = -(mDt * (1.3 + var_x40));
        rJacobian[22][16] = -(mDt * (0));
        rJacobian[22][17] = -(mDt * (0.029999999999999999 + var_x40));
        rJacobian[22][18] = -(mDt * (0));
        rJacobian[22][19] = -(mDt * (0));
        rJacobian[22][20] = -(mDt * (5.6417918332397381));
        rJacobian[22][21] = -(mDt * (0));
        rJacobian[22][22] = 1.0 -(mDt * (-171.99023312516786 + var_x42 + var_x46 + 2.3065909313514399e-15 * var_x83 + 8.7413788910230311e-13 * var_x84 - 47656.583144202239 * var_x78 - 3.2385929460103637e-6 * var_x65 - 0.00012978638743287919 * var_x85 * var_x86 - 5.4319197230928918e-10 * var_x65 * var_x66 / pow((1.0 + 5.2281977629563632e-6 * var_x66), 2)));
        rJacobian[22][23] = -(mDt * (1.2484412919281114));
        rJacobian[22][24] = -(mDt * (0.093784821056374659 * var_x89 - 5.8172316151032879e-14 * var_x90));
        rJacobian[22][25] = -(mDt * (0));
        rJacobian[23][0] = -(mDt * (0));
        rJacobian[23][1] = -(mDt * (0.12710379130418692 * var_x64 * (-0.61380000000000001 + var_x62 * var_chaste_interface__Ca_buffer__Ca_jct)));
        rJacobian[23][2] = -(mDt * (0));
        rJacobian[23][3] = -(mDt * (1623.3766233766235 * var_chaste_interface__Ca_buffer__Ca_SR - 1623.3766233766235 * var_chaste_interface__Ca_buffer__Ca_jct));
        ...
        rJacobian[23][16] = -(mDt * (1.3 + var_x43));
        rJacobian[23][17] = -(mDt * (0));
        rJacobian[23][18] = -(mDt * (0.029999999999999999 + var_x43));
        rJacobian[23][19] = -(mDt * (0.0064493506493506492 + var_x91));
        rJacobian[23][20] = -(mDt * (0));
        rJacobian[23][21] = -(mDt * (0));
        rJacobian[23][22] = -(mDt * (46.324352205124718));
        rJacobian[23][23] = 1.0 -(mDt * (-121.70185906968872 + var_x45 + var_x47 - var_x91 + 4.0088873611662605e-12 * var_x106 + 1.0578266137819032e-14 * var_x105 - 1.4852524402707469e-5 * var_x92 - 218558.051567082 * var_x102 - 0.043342392834727739 * var_x107 * var_x86 - 2.4911349337733966e-9 * var_x92 * var_x93 / pow((1.0 + 5.2281977629563632e-6 * var_x93), 2)));
        rJacobian[23][24] = -(mDt * (0));
        rJacobian[23][25] = -(mDt * (0.43010695279236255 * var_x109 - 2.6678429787219845e-13 * var_x110));
        rJacobian[24][0] = -(mDt * (5.2861839130367859e-9 * var_x114 * (-105.0 + var_x113 * var_chaste_interface__Na_buffer__Na_SL)));
        rJacobian[24][1] = -(mDt * (0));
        rJacobian[24][2] = -(mDt * (0));
        rJacobian[24][3] = -(mDt * (0));
        rJacobian[24][4] = -(mDt * (0));
        rJacobian[24][5] = -(mDt * (0.001 + var_x20));
        ...
        rJacobian[24][21] = -(mDt * (2.4822490395367272));
        rJacobian[24][22] = -(mDt * (142969.74943260671 * var_x78 - 6.9197727940543202e-15 * var_x83 - 2.6224136673069093e-12 * var_x84));
        rJacobian[24][23] = -(mDt * (0));
        rJacobian[24][24] = 1.0 -(mDt * (-2.5101556644976917 + var_x21 + 1.7451694845309862e-13 * var_x90 - 1.5310180739595352e-5 * var_x115 - 0.28135446316912399 * var_x89 - 3.9646379347775894e-9 * var_x119 * var_x85 - 0.82479088159436242 * var_x115 * var_x118 - 2.3607251144114479e-6 * var_x115 * var_x116 * var_x117 / pow((6.8301345536507063e-5 + var_x116), 2)));
        rJacobian[24][25] = -(mDt * (0.02774162496096429));
        rJacobian[25][0] = -(mDt * (0));
        rJacobian[25][1] = -(mDt * (1.7653304347803737e-6 * var_x114 * (-105.0 + var_x113 * var_chaste_interface__Na_buffer__Na_jct)));
        rJacobian[25][2] = -(mDt * (0));
        rJacobian[25][3] = -(mDt * (0));
        rJacobian[25][4] = -(mDt * (0));
        rJacobian[25][5] = -(mDt * (0));
        rJacobian[25][6] = -(mDt * (0.001 + var_x22));
        ...
        rJacobian[25][23] = -(mDt * (655674.15470124607 * var_x102 - 1.2026662083498781e-11 * var_x106 - 3.1734798413457098e-14 * var_x105));
        rJacobian[25][24] = -(mDt * (1.0293738389968197));
        rJacobian[25][25] = 1.0 -(mDt * (-1.0301299389968197 + var_x23 + 8.0035289361659539e-13 * var_x110 - 7.0214082731462295e-5 * var_x120 - 1.2903208583770878 * var_x109 - 1.3239978260852802e-6 * var_x107 * var_x119 - 3.7825768474861841 * var_x118 * var_x120 - 1.0826531136947708e-5 * var_x117 * var_x120 * var_x121 / pow((6.8301345536507063e-5 + var_x121), 2)));
    }
    ...
    void CellShannon2004FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        //const double var_ICaL_f_gate__tau_f = 1.0 / (0.02 + 0.019699999999999999 * exp(-0.23877882250000002 * pow((1 + 0.068965517241379309 * var_chaste_interface__cell__V), 2.0))); // millisecond
        ...
        //const double var_Itof_X_gate__tau_X_tof = 1.5 + 3.5 * exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2.0)); // millisecond
