...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        double var_chaste_interface__transient_outward_current_r_gate__r = rY[12];
        // Units: dimensionless; Initial value: 2.01549207399881e-08
        double var_chaste_interface__L_type_Ca_current_fCa_gate__fCa = rCurrentGuess[0];double var_chaste_interface__calcium_dynamics__Ca_SR = rCurrentGuess[1];double var_chaste_interface__calcium_dynamics__Ca_i = rCurrentGuess[2];double var_chaste_interface__calcium_dynamics__g = rCurrentGuess[3];double var_chaste_interface__potassium_dynamics__K_i = rCurrentGuess[4];double var_chaste_interface__sodium_dynamics__Na_i = rCurrentGuess[5];
        ...
        const double var_x5 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 8.0);
        ...
        const double var_x7 = var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035;
        const double var_x8 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
        const double var_x9 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6.0);
        const double var_x10 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16.0);
        const double var_x11 = (((var_x0) || (var_x7))) && (((var_x0) || (var_x8))) && (((var_x7) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x9)))) && (((var_x8) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x10))));
        const double var_x12 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, 2.0);
        const double var_x13 = 0.0625 + var_x12;
        const double var_x14 = 1 / var_x13;
        const double var_x15 = 0.016463999999999999 * var_x12 * var_x14;
        const double var_x16 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x17 = pow(var_x16, (-2.0));
        const double var_x18 = 14.994515539305301 / (1.0 + 3.0 * var_x17);
        const double var_x19 = 0.032927999999999999 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3.0) / pow(var_x13, 2);
        const double var_x20 = 0.032927999999999999 * var_x14 * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 1.0);
        const double var_x21 = var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__calcium_dynamics__g;
        const double var_x22 = 8.0000000000000007e-5 * var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x23 = 1.0 + 6.2499999999999997e-8 * pow(var_chaste_interface__calcium_dynamics__Ca_i, (-2.0));
        const double var_x24 = 0.00042499999999999998 / var_x23;
        const double var_x25 = 8.0000000000000007e-5 * var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x26 = 0.0082319999999999997 + var_x15;
        const double var_x27 = var_x21 * var_x26;
        const double var_x28 = 5.3124999999999997e-11 * pow(var_chaste_interface__calcium_dynamics__Ca_i, (-3.0)) / pow(var_x23, 2);
        const double var_x29 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x30 = 1.0 + 0.00014999999999999999 * pow(var_x29, (-2.0));
        const double var_x31 = 1 / var_x30;
        const double var_x32 = exp(0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x33 = 0.00014775935325364359 * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_gate__f * var_chaste_interface__membrane__V / (-1.0 + var_x32);
        const double var_x34 = var_x33 * (-0.68200000000000005 + var_x32 * var_chaste_interface__calcium_dynamics__Ca_i);
        const double var_x35 = 1.0 * var_x31;
        const double var_x36 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x37 = 4.8215267695658011e-5 / var_x36;
        const double var_x38 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x39 = exp(-0.024332029034784559 * var_chaste_interface__membrane__V);
        const double var_x40 = 1 / (1.0 + 0.10000000000000001 * var_x39);
        const double var_x41 = var_x39 * var_x40;
        const double var_x42 = exp(0.013101861787960915 * var_chaste_interface__membrane__V);
        const double var_x43 = var_x40 * var_x42 * pow(var_chaste_interface__sodium_dynamics__Na_i, 2.0);
        const double var_x44 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x45 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__membrane__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane__V));
        const double var_x46 = var_x45 / (40.0 + var_chaste_interface__sodium_dynamics__Na_i);
        const double var_x47 = var_x45 * var_chaste_interface__sodium_dynamics__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__sodium_dynamics__Na_i), 2);
        const double var_x48 = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2.0) * (0.0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow((0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i), 2);
        ...
        const double var_x57 = exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 2.6713760659695653 * var_x50);
        const double var_x58 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__membrane__V - 0.0053427521319391299 * var_x50);
        const double var_x59 = 1.0 * var_x57 + 3.0 * var_x58;
        const double var_x60 = 0.10000000000000001 * var_x53 + var_x56 * var_x59;
        const double var_x61 = var_x49 / var_x60;
        const double var_x62 = -26.713760659695652 * var_x50 + var_chaste_interface__membrane__V;
        const double var_x63 = var_x51 / pow(var_x52, 2);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (((var_x6) ? (0) : (-0.5))));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (((var_x6) ? (0) : (-3.4101542475452148e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7.0) / pow((1.2447063003540035e-28 + var_x5), 2) - 85.61643835616438 * var_x3 / pow(var_x4, 2) - 342.46575342465752 * var_x1 / pow(var_x2, 2)))));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (((var_x11) ? (0) : (-0.5))));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (((var_x11) ? (0) : ((var_x8) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5.0) / pow((1.8382656249999998e-21 + var_x9), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15.0) / pow((5.0709427749024951e-56 + var_x10), 2))))));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (var_x18 * (-0.0082319999999999997 - var_x15) * var_chaste_interface__L_type_Ca_current_d_gate__d));
        rJacobian[2][2] = 1.0 -(mDt * (var_x18 * (-8.0000000000000007e-5 + var_x21 * (var_x19 - var_x20)) + 9.9963436928702016 * pow(var_x16, (-3.0)) * (var_x22 + var_x24 - var_x25 - var_x27) / pow((0.33333333333333337 + var_x17), 2)));
        rJacobian[2][3] = -(mDt * (var_x18 * (8.0000000000000007e-5 + var_x28)));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (-var_x31 * var_x34));
        rJacobian[3][1] = -(mDt * (var_x26 * var_x35 * var_chaste_interface__L_type_Ca_current_d_gate__d));
        rJacobian[3][2] = -(mDt * (var_x35 * (8.0000000000000007e-5 + var_x21 * (var_x20 - var_x19))));
        rJacobian[3][3] = 1.0 -(mDt * (var_x35 * (-8.0000000000000007e-5 - var_x28 - var_x37 - 0.069488744729986562 * var_x41 - 4.6212277808973232e-7 * var_x38 + 4.8215267695658011e-5 * var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x36, 2) - var_x32 * var_x33 * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa) + 0.00029999999999999997 * pow(var_x29, (-3.0)) * (var_x25 + var_x27 - var_x22 - var_x24 + 4.6212277808973232e-7 * log(2.0 * var_x38) - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - var_x34 * var_chaste_interface__L_type_Ca_current_fCa_gate__fCa - var_x37 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x40 * (2.0 * var_x42 * pow(var_chaste_interface__sodium_dynamics__Na_i, 3.0) - 6860000.0 * var_x39 * var_chaste_interface__calcium_dynamics__Ca_i)) / pow(var_x30, 2)));
        rJacobian[3][4] = -(mDt * (6.0777327752174836e-8 * var_x31 * var_x43));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0.20846623418995969 * var_x41));
        rJacobian[4][4] = 1.0 -(mDt * (2.5185628611365452e-7 * var_x47 - 9.0551084895961074e-7 * var_x44 - 1.823319832565245e-7 * var_x43 - 0.00040297005778184723 * var_x46 - 0.046330930954698972 * var_x44 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0.00026864670518789814 * var_x46 - 0.00022032015690548321 * var_x48 - 1.6790419074243634e-7 * var_x47));
        rJacobian[5][5] = 1.0 -(mDt * (-0.0073440052301827737 * var_x48 - 0.0016876848753885161 * var_x53 * var_x61 - 4.5587787568311439e-5 * var_x49 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__membrane__V)) + 0.00010126109252331096 * var_x61 * var_x62 * var_x63 - 0.00091800065377284671 * var_x49 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 0.00029975531551766426 * var_x49 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 - 6.3176611368492499e-5 * var_x53 * var_x62 * (-var_x56 * (2.6713760659695653 * var_x49 * var_x57 + 0.01602825639581739 * var_x49 * var_x58) + 0.16028256395817389 * var_x49 * var_x63 - 13.356880329847826 * var_x49 * var_x54 * var_x59 / pow(var_x55, 2)) / pow(var_x60, 2)));
    }
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[8] = (var_chaste_interface__L_type_Ca_current_d_gate__d + ((1.0 / (1.0 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.34999999999999998 / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 1.9599999999999997 / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V)) + 1.0 * exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.34999999999999998 * exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 1.9599999999999997 * exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-1 / (1.0 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.34999999999999998 / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 1.9599999999999997 / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V)))) * mDt));
        rY[9] = (var_chaste_interface__L_type_Ca_current_f_gate__f + ((1.0 / (80.0 + 80.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) + 165.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)) + 165.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)) * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (80.0 + 165.0 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__membrane__V)) + 1125.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        ...
        rY[4] = (var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + ((0.00090909090909090909 * sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__membrane__V)) / (1.0 + exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V)) + 0.00090909090909090909 * sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-3.0 + 0.050000000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.00090909090909090909 * sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__membrane__V)) - 0.00090909090909090909 * sqrt(1.0 + exp(-1.6666666666666667 - 0.16666666666666666 * var_chaste_interface__membrane__V)) * exp(-3.0 + 0.050000000000000003 * var_chaste_interface__membrane__V)) * mDt));
        rY[12] = (var_chaste_interface__transient_outward_current_r_gate__r + ((1.0 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) + 0.80000000000000004 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V) + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-1 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
