...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[17], double rJacobian[17][17])
    {
        ...
        double var_chaste_interface__iCaL_f2_gate__f2 = rY[19];
        // Units: dimensionless; Initial value: 0.9995
        double var_chaste_interface__Ca__Ca_SR = rCurrentGuess[0];double var_chaste_interface__Ca__Ca_i = rCurrentGuess[1];double var_chaste_interface__Ca__Ca_ss = rCurrentGuess[2];double var_chaste_interface__Irel__R_prime = rCurrentGuess[3];double var_chaste_interface__K__K_i = rCurrentGuess[4];double var_chaste_interface__Na__Na_i = rCurrentGuess[5];double var_chaste_interface__iCaL_fCass_gate__fCass = rCurrentGuess[6];double var_chaste_interface__iKr_Markov__Or4 = rCurrentGuess[16];

        const double var_x0 = 1 / var_chaste_interface__Ca__Ca_SR;
        const double var_x1 = pow(var_x0, 2.0);
        const double var_x2 = 1 / (1.0 + 2.25 * var_x1);
        const double var_x3 = 1 / (2.5 - 1.5 * var_x2);
        const double var_x4 = pow(var_chaste_interface__Ca__Ca_ss, 2.0);
        const double var_x5 = var_x3 * var_x4;
        const double var_x6 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x5);
        const double var_x7 = var_x6 * var_chaste_interface__Irel__R_prime;
        const double var_x8 = var_x5 * var_x7;
        const double var_x9 = 0.045899999999999996 * var_x8;
        const double var_x10 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_SR;
        const double var_x11 = var_x10 / pow((1 - 0.59999999999999998 * var_x2), 2);
        const double var_x12 = var_x0 * var_x1 / pow((0.44444444444444442 + var_x1), 2);
        const double var_x13 = var_x11 * var_x12 * var_x4 * var_x7;
        const double var_x14 = var_x11 * var_chaste_interface__Irel__R_prime / pow((0.40000000000000002 + var_x5), 2);
        const double var_x15 = var_x12 * var_x14 * var_x3 * pow(var_chaste_interface__Ca__Ca_ss, 4.0);
        const double var_x16 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_SR;
        const double var_x17 = pow(var_x16, (-2.0));
        const double var_x18 = 1 / (1.0 + 3.0 * var_x17);
        const double var_x19 = 1.0 * var_x18;
        const double var_x20 = 1.0 + 6.2499999999999997e-8 * pow(var_chaste_interface__Ca__Ca_i, (-2.0));
        const double var_x21 = 1 / var_x20;
        const double var_x22 = var_x10 * var_x5 * var_x6;
        const double var_x23 = var_x14 * pow(var_chaste_interface__Ca__Ca_ss, 3.0);
        const double var_x24 = pow(var_chaste_interface__Ca__Ca_ss, 1.0);
        const double var_x25 = var_x10 * var_x24 * var_x3 * var_x7;
        const double var_x26 = pow(var_chaste_interface__Ca__Ca_i, (-3.0)) / pow(var_x20, 2);
        const double var_x27 = -0.11249999999999999 + 0.067500000000000004 * var_x2;
        const double var_x28 = 1 / (1.0 + 399.99999999999994 * var_x4);
        const double var_x29 = 1 / (2.0 + 80.0 * var_x28);
        const double var_x30 = var_x24 / pow((0.0025000000000000005 + var_x4), 2);
        const double var_x31 = 0.91833577176298453 * var_x8;
        const double var_x32 = 0.00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x33 = 1.0 + 0.0001 * pow(var_x32, (-2.0));
        const double var_x34 = 1 / var_x33;
        const double var_x35 = 1.0 * var_x34;
        const double var_x36 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__cell__V);
        const double var_x37 = (-15.0 + var_chaste_interface__cell__V) * var_chaste_interface__iCaL_d_gate__d * var_chaste_interface__iCaL_f2_gate__f2 * var_chaste_interface__iCaL_f_gate__f / (-1.0 + var_x36);
        const double var_x38 = 0.0031491568724328674 * var_x37 * (-2.0 + 0.25 * var_x36 * var_chaste_interface__Ca__Ca_ss);
        const double var_x39 = 1.0 * exp(-1.5790000000000006 + 0.0112 * var_chaste_interface__cell__V);
        const double var_x40 = -var_x39;
        const double var_x41 = 1.0 * exp(-2.0190000000000001 - 0.060299999999999999 * var_chaste_interface__cell__V);
        const double var_x42 = 1.0 * exp(-3.1680000000000028);
        const double var_x43 = -var_x41 - var_x42;
        const double var_x44 = 1.0 * exp(-2.5140000000000011);
        const double var_x45 = 1.0 * exp(-3.8160000000000025 + 0.036499999999999998 * var_chaste_interface__cell__V);
        const double var_x46 = -var_x44 - var_x45;
        const double var_x47 = 1.0 * exp(-8.3940000000000019 - 0.039899999999999998 * var_chaste_interface__cell__V);
        const double var_x48 = 1.0 * exp(-3.1820000000000022 - 0.031199999999999999 * var_chaste_interface__cell__V);
        const double var_x49 = -var_x48;
        const double var_x50 = 1.0 * exp(-0.87200000000000344 + 0.0223 * var_chaste_interface__cell__V);
        const double var_x51 = -var_x47 - var_x50;
        const double var_x52 = 0.001 + var_chaste_interface__Ca__Ca_i;
        const double var_x53 = 1.0 + 0.00020000000000000001 * pow(var_x52, (-2.0));
        const double var_x54 = 1 / var_x53;
        const double var_x55 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x56 = 2.2487821987979791e-6 / var_x55;
        const double var_x57 = 1 / var_chaste_interface__Ca__Ca_i;
        const double var_x58 = exp(-0.024332029034784559 * var_chaste_interface__cell__V);
        const double var_x59 = 1 / (1.0 + 0.10000000000000001 * var_x58);
        const double var_x60 = var_x58 * var_x59;
        const double var_x61 = exp(0.013101861787960915 * var_chaste_interface__cell__V);
        const double var_x62 = var_x59 * var_x61 * pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x63 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x64 = 1 / (1.0 + 0.035299999999999998 * exp(-0.037433890822745473 * var_chaste_interface__cell__V) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__cell__V));
        const double var_x65 = var_x64 / (40.0 + var_chaste_interface__Na__Na_i);
        const double var_x66 = var_x64 * var_chaste_interface__Na__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__Na__Na_i), 2);
        const double var_x67 = 1 / var_chaste_interface__K__K_i;
        const double var_x68 = log(5.4000000000000004 * var_x67);
        const double var_x69 = pow(var_chaste_interface__iKs_Xs_gate__Xs, 2.0) * (0.0031249999999999997 * var_chaste_interface__Na__Na_i + 0.10416666666666667 * var_chaste_interface__K__K_i) / pow((0.029999999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i), 2);
        const double var_x70 = 1 / exp(3.1258035549938383 * var_x68 - 0.10989010989010989 * var_chaste_interface__cell__V);
        const double var_x71 = 1.0 + 0.036532500000000002 * var_x70;
        const double var_x72 = 1 / exp(1.4222406175221964 * var_x68 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x73 = 1.0 + 0.079111111111111104 * var_x72;
        const double var_x74 = pow(var_x73, 2);
        const double var_x75 = 1 / exp(-0.059333333333333335 + 5.9260025730091517 * var_x68 - 0.20833333333333334 * var_chaste_interface__cell__V);
        const double var_x76 = 1 / exp(0.15802673528024405 * var_x68 - 0.0055555555555555558 * var_chaste_interface__cell__V);
        const double var_x77 = pow(var_x73, 3);
        const double var_x78 = var_x67 * var_x72;
        const double var_x79 = 1 / (var_x77 + 2.0875714285714286 * var_x75 + 0.012714285714285714 * var_x76);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (var_x19 * (-0.00036000000000000002 - var_x9 + 0.065280000000000005 * var_x15 - 0.0097919999999999986 * var_x13) + 0.66666666666666674 * pow(var_x16, (-3.0)) * (0.00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0.0063749999999999996 * var_x21 - 0.00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x10 * var_x9) / pow((0.33333333333333337 + var_x17), 2)));
        rJacobian[0][1] = -(mDt * (-0.045899999999999996 * var_x18 * var_x22));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (var_x19 * (var_x9 + 0.097919999999999993 * var_x23 - 0.091799999999999993 * var_x25)));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        rJacobian[0][7] = -(mDt * (0));
        ...
        rJacobian[0][14] = -(mDt * (var_x19 * (0.00036000000000000002 + 7.96875e-10 * var_x26)));
        rJacobian[0][15] = -(mDt * (0));
        rJacobian[0][16] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0.059999999999999998 * var_x12 * var_chaste_interface__Ca__Ca_ss * var_chaste_interface__Irel__R_prime));
        rJacobian[1][1] = 1.0 -(mDt * (-0.0050000000000000001 + var_x27 * var_chaste_interface__Ca__Ca_ss));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (var_x27 * var_chaste_interface__Irel__R_prime));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (0));
        rJacobian[1][7] = -(mDt * (0));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-var_x29));
        rJacobian[2][3] = -(mDt * (-0.0020000000000000005 * var_x29 * var_x30 + 6.2500000000000001e-5 * var_x30 * (0.59999999999999998 - var_chaste_interface__iCaL_fCass_gate__fCass + 0.40000000000000002 * var_x28) / pow((0.025000000000000001 + var_x28), 2)));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        ...
        rJacobian[3][0] = -(mDt * (var_x35 * (var_x31 + 0.1959116313094367 * var_x13 - 1.3060775420629114 * var_x15)));
        rJacobian[3][1] = -(mDt * (0.91833577176298453 * var_x22 * var_x34));
        rJacobian[3][2] = -(mDt * (-var_x34 * var_x38));
        rJacobian[3][3] = 1.0 -(mDt * (var_x35 * (-1.1399999999999999 - var_x31 + 1.8366715435259691 * var_x25 - 1.9591163130943672 * var_x23 - 0.00078728921810821686 * var_x36 * var_x37 * var_chaste_interface__iCaL_fCass_gate__fCass) + 0.00020000000000000001 * pow(var_x32, (-3.0)) * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x10 * var_x31 - var_x38 * var_chaste_interface__iCaL_fCass_gate__fCass) / pow(var_x33, 2)));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        ...
        rJacobian[3][14] = -(mDt * (1.1399999999999999 * var_x34));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (var_x40));
        rJacobian[4][5] = -(mDt * (var_x41));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (0));
        ...
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (var_x39));
        rJacobian[5][5] = 1.0 -(mDt * (var_x43));
        ...
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (var_x42));
        rJacobian[6][6] = 1.0 -(mDt * (var_x46));
        rJacobian[6][7] = -(mDt * (0));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        rJacobian[6][10] = -(mDt * (0));
        rJacobian[6][11] = -(mDt * (0));
        rJacobian[6][12] = -(mDt * (var_x47));
        ...
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (var_x49));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (0));
        rJacobian[7][12] = -(mDt * (var_x50));
        ...
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (var_x40));
        rJacobian[8][9] = -(mDt * (var_x41));
        ...
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (var_x39));
        rJacobian[9][9] = 1.0 -(mDt * (var_x43));
        rJacobian[9][10] = -(mDt * (var_x44));
        ...
        rJacobian[10][10] = 1.0 -(mDt * (var_x46));
        rJacobian[10][11] = -(mDt * (0));
        rJacobian[10][12] = -(mDt * (0));
        rJacobian[10][13] = -(mDt * (var_x47));
        ...
        rJacobian[11][11] = 1.0 -(mDt * (var_x49));
        rJacobian[11][12] = -(mDt * (0));
        rJacobian[11][13] = -(mDt * (var_x50));
        ...
        rJacobian[12][6] = -(mDt * (var_x45));
        rJacobian[12][7] = -(mDt * (var_x48));
        rJacobian[12][8] = -(mDt * (0));
        rJacobian[12][9] = -(mDt * (0));
        rJacobian[12][10] = -(mDt * (0));
        rJacobian[12][11] = -(mDt * (0));
        rJacobian[12][12] = 1.0 -(mDt * (var_x51));
        rJacobian[12][13] = -(mDt * (0.00125));
        ...
        rJacobian[13][10] = -(mDt * (var_x45));
        rJacobian[13][11] = -(mDt * (var_x48));
        rJacobian[13][12] = -(mDt * (0));
        rJacobian[13][13] = 1.0 -(mDt * (-0.00125 + var_x51));
        rJacobian[13][14] = -(mDt * (0));
        rJacobian[13][15] = -(mDt * (0));
        rJacobian[13][16] = -(mDt * (0));
        rJacobian[14][0] = -(mDt * (2.40087783467447e-5 * var_x54));
        rJacobian[14][1] = -(mDt * (0));
        rJacobian[14][2] = -(mDt * (0));
        rJacobian[14][3] = -(mDt * (0.0038 * var_x54));
        ...
        rJacobian[14][14] = 1.0 -(mDt * (1.0 * var_x54 * (-0.0038240087783467445 - var_x56 - 0.0086391412367010315 * var_x60 - 5.3144431236283834e-11 * var_x26 - 2.298124085635426e-7 * var_x57 + 2.2487821987979791e-6 * var_chaste_interface__Ca__Ca_i / pow(var_x55, 2)) + 0.00040000000000000002 * pow(var_x52, (-3.0)) * (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 2.298124085635426e-7 * log(2.0 * var_x57) - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 * var_x21 - var_x56 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x59 * (2.0 * var_x61 * pow(var_chaste_interface__Na__Na_i, 3.0) - 6860000.0 * var_x58 * var_chaste_interface__Ca__Ca_i)) / pow(var_x53, 2)));
        rJacobian[14][15] = -(mDt * (7.5561002070271413e-9 * var_x54 * var_x62));
        ...
        rJacobian[15][14] = -(mDt * (0.025917423710103096 * var_x60));
        rJacobian[15][15] = 1.0 -(mDt * (1.4908768645188767e-7 * var_x66 - 5.6288512232624455e-7 * var_x63 - 2.2668300621081427e-8 * var_x62 - 0.00023854029832302029 * var_x65 - 0.021350814984788587 * var_x63 * pow(var_chaste_interface__iNa_m_gate__m, 3.0) * var_chaste_interface__iNa_h_gate__h * var_chaste_interface__iNa_j_gate__j));
        ...
        rJacobian[16][12] = -(mDt * (4.6583596330447822e-5 * var_x68 - 1.7438052591648303e-6 * var_chaste_interface__cell__V));
        rJacobian[16][13] = -(mDt * (0));
        rJacobian[16][14] = -(mDt * (0));
        rJacobian[16][15] = -(mDt * (0.00015902686554868019 * var_x65 - 9.9391790967925116e-8 * var_x66 - 2.1912923713842655e-5 * var_x69));
        rJacobian[16][16] = 1.0 -(mDt * (-0.00073043079046142181 * var_x69 + (-26.713760659695652 * var_x68 + var_chaste_interface__cell__V) * (6.576305692690868e-7 * var_x67 * var_x70 / pow(var_x71, 2) - 9.8566502268897146e-6 * var_x73 * var_x78 * var_x79 - 1.0050926558006126e-5 * var_x74 * (-12.370953657054676 * var_x67 * var_x75 - 0.33754510655860126 * var_x74 * var_x78 - 0.0020091970628488172 * var_x67 * var_x76) / pow((var_x75 + 0.0060904673920481765 * var_x76 + 0.47902552521727226 * var_x77), 2)) + 26.713760659695652 * var_x67 * (-5.7589183215629007e-6 / var_x71 - 4.3801480314950888e-5 * var_x74 * var_x79) - 4.6583596330447822e-5 * var_x67 * var_chaste_interface__iKr_Markov__Or4 - 1.8885766345635723e-5 * var_x67 / (1.0 + exp(4.1806020066889626 - 0.16722408026755853 * var_chaste_interface__cell__V)) - 0.00038819663608706523 * var_x67 * var_chaste_interface__ito_r_gate__r * var_chaste_interface__ito_s_gate__s));
    }
    ...
    void Cellfink_noble_giles_model_2008FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        rY[17] = (var_chaste_interface__iCaL_d_gate__d + ((1.0 / (1.0 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V)) + 0.34999999999999998 / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 1.9599999999999997 / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V)) + 1.0 * exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V) / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V)) + 0.34999999999999998 * exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V) / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 1.9599999999999997 * exp(0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__cell__V) / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V)))) * mDt)) / (1.0 - ((-1 / (1.0 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V)) + 0.34999999999999998 / (1.0 + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 1.9599999999999997 / (1.0 + 1.0 * exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V) + 1.0 * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V) + exp(1.0 + 0.20000000000000001 * var_chaste_interface__cell__V) * exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__cell__V)))) * mDt));
        rY[19] = (var_chaste_interface__iCaL_f2_gate__f2 + ((0.25 / (40.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 15.5 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 281.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0))) + 0.75 / (40.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 15.5 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 281.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)) + 40.0 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__cell__V) / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 15.5 * exp(5.0 + 0.14285714285714285 * var_chaste_interface__cell__V) / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 281.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)) * exp(5.0 + 0.14285714285714285 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-1 / (40.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 15.5 / (1.0 + exp(2.5 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 281.0 * exp(-3.0375000000000001 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)))) * mDt));
        rY[18] = (var_chaste_interface__iCaL_f_gate__f + ((1.0 / (5.0 + 5.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__cell__V) + 50.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 45.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 275.625 * exp(-3.2400000000000002 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)) + 50.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__cell__V) / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 45.0 * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__cell__V) / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 275.625 * exp(-3.2400000000000002 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)) * exp(2.8571428571428572 + 0.14285714285714285 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-1 / (5.0 + 50.0 / (1.0 + exp(1.3 - 0.10000000000000001 * var_chaste_interface__cell__V)) + 45.0 / (1.0 + exp(3.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 275.625 * exp(-3.2400000000000002 * pow((1 + 0.037037037037037035 * var_chaste_interface__cell__V), 2.0)))) * mDt));
        rY[11] = (var_chaste_interface__iKs_Xs_gate__Xs + ((1.0 / (80.0 + 80.0 * exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__cell__V) + 1400.0 / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__cell__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__cell__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__cell__V)) + 1400.0 * exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__cell__V) / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__cell__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__cell__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__cell__V)))) * mDt)) / (1.0 - ((-1 / (80.0 + 1400.0 / (1.0 * sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__cell__V)) + sqrt(1.0 + exp(0.83333333333333337 - 0.16666666666666666 * var_chaste_interface__cell__V)) * exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__cell__V)))) * mDt));
        rY[15] = (var_chaste_interface__iNa_h_gate__h + ((((var_chaste_interface__cell__V < -40.0) ? (310000.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), (-2.0)) * exp(0.34849999999999998 * var_chaste_interface__cell__V) + 2.7000000000000002 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), (-2.0)) * exp(0.079000000000000001 * var_chaste_interface__cell__V) + 0.057000000000000002 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), (-2.0)) * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (1.0 / (0.16883116883116883 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + 0.16883116883116883 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__cell__V < -40.0) ? (-310000.0 * exp(0.34849999999999998 * var_chaste_interface__cell__V) - 2.7000000000000002 * exp(0.079000000000000001 * var_chaste_interface__cell__V) - 0.057000000000000002 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (-1 / (0.16883116883116883 + 0.16883116883116883 * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V))))) * mDt));
        rY[16] = (var_chaste_interface__iNa_j_gate__j + ((((var_chaste_interface__cell__V < -40.0) ? (0.024240000000000001 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V)) - 960669.84000000008 * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 0.00026249543999999999 * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 25428.0 * var_chaste_interface__cell__V * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 6.9480000000000002e-6 * var_chaste_interface__cell__V * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__cell__V) / (1.0 * pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) + pow((1.0 + exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__cell__V)), 2.0) * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__cell__V < -40.0) ? (960669.84000000008 * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) + 0.00026249543999999999 * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 0.024240000000000001 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V)) + 25428.0 * var_chaste_interface__cell__V * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) + 6.9480000000000002e-6 * var_chaste_interface__cell__V * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (-0.59999999999999998 * exp(0.057000000000000002 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V))))) * mDt));
        rY[14] = (var_chaste_interface__iNa_m_gate__m + ((1.0 / (0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V)), 2.0) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V)), 2.0) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V))) + 1.0 * exp(-12.0 - 0.20000000000000001 * var_chaste_interface__cell__V) / (0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V)), 2.0) / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 0.10000000000000001 * pow((1.0 + exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__cell__V)), 2.0) / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V)))) * mDt)) / (1.0 - ((-1.0 / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V))) - 1.0 * exp(-12.0 - 0.20000000000000001 * var_chaste_interface__cell__V) / (0.10000000000000001 / (1.0 + exp(7.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 0.10000000000000001 / (1.0 + exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__cell__V)))) * mDt));
        rY[13] = (var_chaste_interface__ito_r_gate__r + ((1.0 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__cell__V), 2.0)) + 0.80000000000000004 * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__cell__V) + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__cell__V), 2.0)) * exp(3.3333333333333335 - 0.16666666666666666 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-1 / (0.80000000000000004 + 9.5 * exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__cell__V), 2.0)))) * mDt));
        rY[12] = (var_chaste_interface__ito_s_gate__s + ((1.0 / (3.0 + 3.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__cell__V) + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__cell__V), 2.0)) + 5.0 * exp(4.0 + 0.20000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__cell__V), 2.0)) * exp(4.0 + 0.20000000000000001 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-1 / (3.0 + 5.0 / (1.0 + exp(-4.0 + 0.20000000000000001 * var_chaste_interface__cell__V)) + 85.0 * exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__cell__V), 2.0)))) * mDt));
