...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        double var_chaste_interface__transient_outward_current_r_gate__r = rY[11];
        // Units: dimensionless; Initial value: 0.0
        double var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds = rCurrentGuess[1];double var_chaste_interface__calcium_release__ActFrac = rCurrentGuess[2];double var_chaste_interface__calcium_release__ProdFrac = rCurrentGuess[3];double var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod = rCurrentGuess[4];double var_chaste_interface__intracellular_calcium_concentration__Ca_Trop = rCurrentGuess[5];double var_chaste_interface__intracellular_calcium_concentration__Ca_ds = rCurrentGuess[6];double var_chaste_interface__intracellular_calcium_concentration__Ca_i = rCurrentGuess[7];double var_chaste_interface__intracellular_calcium_concentration__Ca_rel = rCurrentGuess[8];double var_chaste_interface__intracellular_calcium_concentration__Ca_up = rCurrentGuess[9];double var_chaste_interface__intracellular_potassium_concentration__K_i = rCurrentGuess[10];double var_chaste_interface__intracellular_sodium_concentration__Na_i = rCurrentGuess[11];
        ...
        const double var_x39 = 5.2033872358071781e-5 * var_x38 / (1.0 - var_x36);
        ...
        const double var_x50 = exp(var_x47);
        const double var_x51 = (2.0 * var_x50 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) - 2744000.0 * var_x48 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x52 = var_x46 * var_x50 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x53 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x54 = exp(1.8716945411372736);
        const double var_x55 = var_x38 / (1.0 - var_x53);
        const double var_x56 = 2.6016936179035892e-8 * var_x55;
        const double var_x57 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x58 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x59 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x60 = var_x54 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x61 = 5.2033872358071785e-9 * var_x55;
        const double var_x62 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0) * (0.12195121951219512 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0036585365853658534 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow((0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x63 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x64 = log(4.0 * var_x63);
        const double var_x65 = exp(-0.56150836234118207 + 0.056150836234118207 * var_chaste_interface__membrane__V - 1.5 * var_x64);
        ...
        rJacobian[7][0] = -(mDt * (-var_x39 * (-2.0 * var_x36 + var_x37 * var_chaste_interface__intracellular_calcium_concentration__Ca_i)));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (0));
        rJacobian[7][4] = -(mDt * (0));
        ...
        rJacobian[9][9] = 1.0 -(mDt * (-7.0000000000000009 + var_x8 + var_x9 + 0.00040000000000000002 * var_x44 - 0.20784009793819685 * var_x49 - 7.2e-9 * var_x43 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 5.2262998388249204e-10 * var_x51 - 0.00040000000000000002 * var_x41));
        rJacobian[9][10] = -(mDt * (4.5446085554999309e-7 * var_x52));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[10][0] = -(mDt * (-var_x56 * (-140.0 * var_x53 + var_x54 * var_chaste_interface__intracellular_sodium_concentration__Na_i)));
        ...
        rJacobian[10][9] = -(mDt * (0.62352029381459051 * var_x49 + 1.5678899516474762e-9 * var_x51));
        rJacobian[10][10] = 1.0 -(mDt * (6.634188331769168e-7 * var_x58 - 0.0010614701330830668 * var_x57 - 6.1697460156676094 * var_x59 - 1.0127092529498693e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 1.3633825666499794e-6 * var_x52 - var_x56 * var_x60));
        rJacobian[10][11] = -(mDt * (-0.74036952188011318 * var_x59));
        rJacobian[11][0] = -(mDt * (-var_x61 * (-4.0 * var_x53 + var_x54 * var_chaste_interface__intracellular_potassium_concentration__K_i)));
        ...
        rJacobian[11][10] = -(mDt * (0.00070764675538871125 * var_x57 - 1.3363974606332242e-5 * var_x62 - 4.4227922211794452e-7 * var_x58));
        rJacobian[11][11] = 1.0 -(mDt * (-0.00044546582021107476 * var_x62 - var_x60 * var_x61 - 0.00096448500280939937 * var_x63 / var_x66 - 8.4392437745822447e-5 * var_x63 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 1.3534516283556781e-5 * var_x63 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) + 5.4156639443013623e-5 * var_x63 * var_x65 * (-26.713760659695652 * var_x64 + var_chaste_interface__membrane__V) / pow(var_x66, 2)));
    }
    ...
    void Cellsakmann_model_2000_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[6] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.35999999999999999) : (-1.71 / (-1.0 + exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V)) - 0.089999999999999997 * var_chaste_interface__membrane__V / (-1.0 + exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.71999999999999997) : (-0.68400000000000005 / (-1.0 + exp(1.0555555555555556 + 0.055555555555555552 * var_chaste_interface__membrane__V)) - 1.71 / (1.0 - exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V)) - 0.036000000000000004 * var_chaste_interface__membrane__V / (-1.0 + exp(1.0555555555555556 + 0.055555555555555552 * var_chaste_interface__membrane__V)) - 0.089999999999999997 * var_chaste_interface__membrane__V / (1.0 - exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V))))) * mDt));
        rY[7] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.0074999999999999997) : (0.063750000000000001 / (-1.0 + exp(6.666666666666667 + 0.19607843137254904 * var_chaste_interface__membrane__V)) + 0.0018749999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(6.666666666666667 + 0.19607843137254904 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.0074999999999999997 - 0.0035999999999999999 / (1.0 + exp(-6.666666666666667 - 0.19607843137254904 * var_chaste_interface__membrane__V))) : (-0.063750000000000001 / (-1.0 + exp(6.666666666666667 + 0.19607843137254904 * var_chaste_interface__membrane__V)) - 0.0035999999999999999 / (1.0 + exp(-6.666666666666667 - 0.19607843137254904 * var_chaste_interface__membrane__V)) - 0.0018749999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(6.666666666666667 + 0.19607843137254904 * var_chaste_interface__membrane__V))))) * mDt));
        rY[5] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((0.02 * exp(-9.3737545557863378 - 0.125 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.02 * exp(-9.3737545557863378 - 0.125 * var_chaste_interface__membrane__V) - 2.0 / (1.0 + 320.0 * exp(-7.4990036446290711 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        ...
        rY[10] = (var_chaste_interface__transient_outward_current_s_gate__s + ((3.3000000000000003e-5 * exp(-0.058823529411764705 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.033000000000000002 / (1.0 + exp(-1.25 - 0.125 * var_chaste_interface__membrane__V)) - 3.3000000000000003e-5 * exp(-0.058823529411764705 * var_chaste_interface__membrane__V)) * mDt));
