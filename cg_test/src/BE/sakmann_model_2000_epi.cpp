...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x26 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x27 = -var_x26;
        const double var_x28 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x29 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x30 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x31 = exp(3.7433890822745473);
        const double var_x32 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x33 = 5.2033872358071781e-5 * var_x32 / (1.0 - var_x30);
        const double var_x34 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x35 = pow(var_x34, (-2));
        const double var_x36 = var_x35 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x37 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x38 = var_x37 / pow(var_x34, 3);
        ...
        const double var_x47 = var_x41 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x48 = exp(var_x44);
        const double var_x49 = (2.0 * var_x48 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) - 2744000.0 * var_x45 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x50 = var_x35 * var_x37;
        const double var_x51 = var_x43 * var_x48 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x52 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x53 = exp(1.8716945411372736);
        const double var_x54 = var_x32 / (1.0 - var_x52);
        const double var_x55 = 5.2033872358071785e-9 * var_x54;
        const double var_x56 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x57 = log(4.0 * var_x56);
        const double var_x58 = exp(-0.56150836234118207 + 0.056150836234118207 * var_chaste_interface__membrane__V - 1.5 * var_x57);
        const double var_x59 = 1.0 + var_x58;
        const double var_x60 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2) * (0.12195121951219512 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0036585365853658534 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow((0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x61 = var_x53 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        ...
        const double var_x64 = 2.6016936179035892e-8 * var_x54;
        const double var_x65 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        ...
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = -(mDt * (((var_x10) ? (-var_x17 + var_x13 * var_x16) : (-var_x19 + var_x13 * var_x18))));
        rJacobian[2][7] = -(mDt * (((var_x10) ? (-var_x23 + var_x13 * var_x22) : (-var_x25 + var_x13 * var_x24))));
        rJacobian[2][8] = 0.0;
        rJacobian[2][9] = 0.0;
        rJacobian[2][10] = 0.0;
        rJacobian[2][11] = 0.0;
        ...
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = 0.0;
        rJacobian[3][6] = -(mDt * (((var_x10) ? (var_x17) : (var_x19))));
        rJacobian[3][7] = -(mDt * (((var_x10) ? (var_x23) : (var_x25))));
        rJacobian[3][8] = 0.0;
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        ...
        rJacobian[4][2] = 0.0;
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.050000000000000003 + var_x27));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = -(mDt * (2.0 - var_x28));
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        rJacobian[4][10] = 0.0;
        rJacobian[4][11] = 0.0;
        ...
        rJacobian[5][3] = 0.0;
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.20000000000000001 + var_x27));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = -(mDt * (5.0 - var_x29));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = -(mDt * (-var_x33 * (-2.0 * var_x30 + var_x31 * var_chaste_interface__intracellular_calcium_concentration__Ca_i)));
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.01));
        rJacobian[6][7] = -(mDt * (-var_x31 * var_x33 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds));
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = -(mDt * ((0.10204081632653063 * var_x36 - 0.10204081632653063 * var_x38) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel));
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = -(mDt * (0.050000000000000003 + var_x26));
        rJacobian[7][5] = -(mDt * (0.20000000000000001 + var_x26));
        rJacobian[7][6] = -(mDt * (0.001));
        rJacobian[7][7] = 1.0 - (mDt * (-7.0000000000000009 + var_x28 + var_x29 + 0.00040000000000000002 * var_x42 - 0.20784009793819685 * var_x46 - 7.2e-9 * var_x47 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 5.2262998388249204e-10 * var_x49 - 0.00040000000000000002 * var_x40));
        rJacobian[7][8] = -(mDt * (1.0204081632653063e-5 + 0.051020408163265314 * var_x50));
        rJacobian[7][9] = -(mDt * (7.2e-9 * var_x40 + 9.5999999999999999e-8 * var_x42 - 1.7279999999999999e-12 * var_x47));
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = -(mDt * (4.5446085554999309e-7 * var_x51));
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = -(mDt * ((0.5 * var_x38 - 0.5 * var_x36) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel));
        rJacobian[8][3] = 0.0;
        rJacobian[8][4] = 0.0;
        rJacobian[8][5] = 0.0;
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-0.0050499999999999998 - 0.25 * var_x50));
        ...
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = 0.0;
        rJacobian[9][7] = -(mDt * (0.019599999999999999 * var_x40 + 3.5279999999999993e-7 * var_x47 - 0.019599999999999999 * var_x42));
        rJacobian[9][8] = -(mDt * (0.050000000000000003));
        rJacobian[9][9] = 1.0 - (mDt * (-0.050000000000000003 + 8.4671999999999982e-11 * var_x47 - 3.5279999999999993e-7 * var_x40 - 4.7040000000000002e-6 * var_x42));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = -(mDt * (-var_x55 * (-4.0 * var_x52 + var_x53 * var_chaste_interface__intracellular_potassium_concentration__K_i)));
        rJacobian[10][2] = 0.0;
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = 0.0;
        ...
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-0.00044546582021107476 * var_x60 - var_x55 * var_x61 - 0.00096448500280939937 * var_x56 / var_x59 - 8.4392437745822447e-5 * var_x56 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s - 1.3534516283556781e-5 * var_x56 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) + 5.4156639443013623e-5 * var_x56 * var_x58 * (-26.713760659695652 * var_x57 + var_chaste_interface__membrane__V) / pow(var_x59, 2)));
        rJacobian[10][11] = -(mDt * (0.00070764675538871125 * var_x62 - 1.3363974606332242e-5 * var_x60 - 4.4227922211794452e-7 * var_x63));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (-var_x64 * (-140.0 * var_x52 + var_x53 * var_chaste_interface__intracellular_sodium_concentration__Na_i)));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = -(mDt * (0.62352029381459051 * var_x46 + 1.5678899516474762e-9 * var_x49));
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = -(mDt * (-0.74036952188011318 * var_x65));
        rJacobian[11][11] = 1.0 - (mDt * (6.634188331769168e-7 * var_x63 - 0.0010614701330830668 * var_x62 - 6.1697460156676094 * var_x65 - 1.0127092529498693e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 1.3633825666499794e-6 * var_x51 - var_x61 * var_x64));
    }
