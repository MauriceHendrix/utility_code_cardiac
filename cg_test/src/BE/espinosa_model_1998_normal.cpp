...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        double var_chaste_interface__transient_outward_current_r_gate__r = rY[10];
        // Units: dimensionless; Initial value: 2.4223e-05
        double var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds = rCurrentGuess[1];double var_chaste_interface__calcium_release__ActFrac = rCurrentGuess[2];double var_chaste_interface__calcium_release__ProdFrac = rCurrentGuess[3];double var_chaste_interface__extracellular_potassium_concentration__K_o = rCurrentGuess[4];double var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod = rCurrentGuess[5];double var_chaste_interface__intracellular_calcium_concentration__Ca_Trop = rCurrentGuess[6];double var_chaste_interface__intracellular_calcium_concentration__Ca_ds = rCurrentGuess[7];double var_chaste_interface__intracellular_calcium_concentration__Ca_i = rCurrentGuess[8];double var_chaste_interface__intracellular_calcium_concentration__Ca_rel = rCurrentGuess[9];double var_chaste_interface__intracellular_calcium_concentration__Ca_up = rCurrentGuess[10];double var_chaste_interface__intracellular_potassium_concentration__K_i = rCurrentGuess[11];double var_chaste_interface__intracellular_sodium_concentration__Na_i = rCurrentGuess[12];

        const double var_x0 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x1 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x2 = 1 / var_x1;
        const double var_x3 = pow((var_x2 * var_chaste_interface__calcium_release__ActFrac), 2.0);
        const double var_x4 = 0.25 * var_x3;
        const double var_x5 = var_x1 * (2.0 * var_x2 - 2.0 * var_chaste_interface__calcium_release__ActFrac / pow(var_x1, 2)) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel / var_chaste_interface__calcium_release__ActFrac;
        const double var_x6 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x7 = -var_x6;
        const double var_x8 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod;
        const double var_x9 = 100.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_Trop;
        const double var_x10 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x11 = 1 / var_x10;
        const double var_x12 = var_x11 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x13 = 0.01 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x14 = 1 / var_x13;
        const double var_x15 = 1.0 - var_x12;
        const double var_x16 = var_x14 * var_x15;
        const double var_x17 = var_x12 + var_x16 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x18 = pow(var_x17, 2.0);
        const double var_x19 = var_chaste_interface__membrane__V < -50.0;
        const double var_x20 = 2.5 * var_x18;
        const double var_x21 = 0.5 * var_x18;
        const double var_x22 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x23 = pow(var_x17, 1.0);
        const double var_x24 = 2.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds;
        const double var_x25 = var_x23 * (2.0 * var_x16 - var_x15 * var_x24 / pow(var_x13, 2));
        const double var_x26 = 2.5 * var_x25;
        const double var_x27 = var_x26 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x28 = 0.5 * var_x25;
        const double var_x29 = var_x28 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x30 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x10, 2);
        const double var_x31 = var_x23 * (2.0 * var_x11 - 2.0 * var_x30 + var_x14 * var_x24 * (var_x30 - var_x11));
        const double var_x32 = 2.5 * var_x31;
        const double var_x33 = var_x32 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x34 = 0.5 * var_x31;
        const double var_x35 = var_x34 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x36 = exp(3.7433890822745473 - 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x37 = exp(3.7433890822745473);
        const double var_x38 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x39 = 2.8382112195311879e-5 * var_x38 / (1.0 - var_x36);
        const double var_x40 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x41 = 1 / var_x40;
        const double var_x42 = pow(var_x40, (-2));
        const double var_x43 = var_x42 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x44 = var_x42 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x45 = 0.051020408163265314 * var_x3;
        const double var_x46 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x47 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x48 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x49 = exp(var_x48);
        const double var_x50 = exp(-var_x48);
        const double var_x51 = 2.5 * var_x47 * var_x49 - 3274759.125 * var_x50 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x52 = var_x46 * var_x51 / pow((6.1073194200199382e-5 + 7.6341492750249225e-7 * var_x47 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x53 = 1 / (1.0 + 0.012500000000000001 * var_x47 + 16373.795625000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x54 = var_x46 * var_x53;
        const double var_x55 = var_x50 * var_x54;
        const double var_x56 = var_x51 * var_x53 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x57 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x58 = var_x49 * var_x54 * var_x57;
        const double var_x59 = var_x52 * var_x57;
        const double var_x60 = -0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x61 = exp(1.8716945411372736 + var_x60);
        const double var_x62 = exp(1.8716945411372736);
        const double var_x63 = var_x38 / (1.0 - var_x61);
        const double var_x64 = 1.4191056097655941e-8 * var_x63;
        const double var_x65 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x66 = 1 / var_x65;
        const double var_x67 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x68 = var_x66 * var_x67;
        const double var_x69 = 0.0013268376663538336 * var_x68;
        const double var_x70 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x71 = var_x70 / (1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x72 = var_chaste_interface__extracellular_potassium_concentration__K_o * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x73 = var_x66 * var_x72 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x74 = var_x62 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x75 = var_x67 * var_x72 / pow(var_x65, 2);
        const double var_x76 = var_x63 * (var_x62 * var_chaste_interface__intracellular_potassium_concentration__K_i - var_x61 * var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x77 = 0.001083584094188964 * var_x68;
        const double var_x78 = 1 / var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x79 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x80 = var_x79 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        const double var_x81 = log(var_x80);
        const double var_x82 = exp(0.6251459767398494 + 0.062514597673984929 * var_chaste_interface__membrane__V - 1.6699999999999999 * var_x81);
        const double var_x83 = 1.0 + var_x82;
        const double var_x84 = 1 / var_x83;
        const double var_x85 = 1 / (10.0 + var_chaste_interface__extracellular_potassium_concentration__K_o);
        const double var_x86 = var_x84 * var_x85;
        const double var_x87 = 0.0024811376697271795 * var_x86;
        const double var_x88 = exp(var_x60);
        const double var_x89 = 8.2927354147114596e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x90 = -26.713760659695652 * var_x81 + var_chaste_interface__membrane__V;
        const double var_x91 = var_x86 * var_x90;
        const double var_x92 = 26.713760659695652 * var_chaste_interface__transient_outward_current_r_gate__r;
        const double var_x93 = var_x92 * (9.2878636644768355e-6 + 5.2631227432035401e-5 * var_chaste_interface__transient_outward_current_s_gate__s);
        const double var_x94 = var_x82 * var_x85 * var_x90 / pow(var_x83, 2);
        const double var_x95 = 0.00015510732319676314 * var_x94;
        const double var_x96 = var_x84 * var_x90 * var_chaste_interface__extracellular_potassium_concentration__K_o / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__K_o), 2);
        const double var_x97 = 5.215213115888558e-9 * var_x63;
        const double var_x98 = var_x61 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x99 = 0.00088455844423588909 * var_x68;
        const double var_x100 = 6.7695799303767029e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x101 = 0.0020254185058997385 * var_x86;
        const double var_x102 = var_x92 * (-7.5819295220219063e-6 - 4.2964267291457472e-5 * var_chaste_interface__transient_outward_current_s_gate__s);
        const double var_x103 = 0.00012661822301776582 * var_x94;
        const double var_x104 = 4.2573168292967824e-9 * var_x63;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.02));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        rJacobian[0][7] = -(mDt * (-0.02 / var_x0 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x0, 2)));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[0][9] = -(mDt * (0));
        ...
        rJacobian[1][7] = -(mDt * (0));
        rJacobian[1][8] = -(mDt * (0));
        rJacobian[1][9] = -(mDt * (-0.001 / (100000.0 + var_chaste_interface__intracellular_calcium_concentration__Ca_i) + 1.0e-13 * var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow((1 + 1.0000000000000001e-5 * var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2)));
        rJacobian[1][10] = -(mDt * (0));
        rJacobian[1][11] = -(mDt * (0));
        rJacobian[1][12] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.0050499999999999998 - var_x4));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (-var_x4 * var_x5));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0.0050000000000000001));
        rJacobian[2][9] = -(mDt * (0));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.050000000000000003 + var_x7));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (2.0 - var_x8));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-0.20000000000000001 + var_x7));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (5.0 - var_x9));
        ...
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (((var_x19) ? (-0.29999999999999999 - 5.0 * var_x18) : (-0.059999999999999998 - 1.0 * var_x18))));
        rJacobian[5][6] = -(mDt * (((var_x19) ? (-var_x20) : (-var_x21))));
        rJacobian[5][7] = -(mDt * (((var_x19) ? (-var_x27 + var_x22 * var_x26) : (-var_x29 + var_x22 * var_x28))));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (((var_x19) ? (-var_x33 + var_x22 * var_x32) : (-var_x35 + var_x22 * var_x34))));
        ...
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (((var_x19) ? (0.29999999999999999 + var_x20) : (0.059999999999999998 + var_x21))));
        rJacobian[6][6] = 1.0 -(mDt * (((var_x19) ? (-0.0050000000000000001) : (-0.001))));
        rJacobian[6][7] = -(mDt * (((var_x19) ? (var_x27) : (var_x29))));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (((var_x19) ? (var_x33) : (var_x35))));
        rJacobian[6][10] = -(mDt * (0));
        rJacobian[6][11] = -(mDt * (0));
        rJacobian[6][12] = -(mDt * (0));
        rJacobian[7][0] = -(mDt * (-var_x39 * (-2.5 * var_x36 + var_x37 * var_chaste_interface__intracellular_calcium_concentration__Ca_i)));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (0));
        rJacobian[7][4] = -(mDt * (0));
        ...
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (-var_x37 * var_x39 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (0));
        rJacobian[7][12] = -(mDt * (0));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0.050000000000000003));
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (0));
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (-0.050000000000000003 + 8.4671999999999982e-11 * var_x43 - 3.5279999999999993e-7 * var_x41 - 4.7040000000000002e-6 * var_x44));
        rJacobian[8][9] = -(mDt * (0.019599999999999999 * var_x41 + 3.5279999999999993e-7 * var_x43 - 0.019599999999999999 * var_x44));
        rJacobian[8][10] = -(mDt * (0));
        rJacobian[8][11] = -(mDt * (0));
        rJacobian[8][12] = -(mDt * (0));
        rJacobian[9][0] = -(mDt * (0));
        rJacobian[9][1] = -(mDt * (0));
        rJacobian[9][2] = -(mDt * (1.0204081632653063e-5 + var_x45));
        rJacobian[9][3] = -(mDt * (0.050000000000000003 + var_x6));
        rJacobian[9][4] = -(mDt * (0.20000000000000001 + var_x6));
        rJacobian[9][5] = -(mDt * (var_x45 * var_x5));
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0.001));
        rJacobian[9][8] = -(mDt * (7.2e-9 * var_x41 + 9.5999999999999999e-8 * var_x44 - 1.7279999999999999e-12 * var_x43));
        rJacobian[9][9] = 1.0 -(mDt * (-7.0000000000000009 + var_x8 + var_x9 + 0.00040000000000000002 * var_x44 - 7.7098266909426358e-12 * var_x52 - 0.41340273157434637 * var_x55 - 7.2e-9 * var_x43 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 0.00040000000000000002 * var_x41 - 8.7104997313748684e-10 * var_x56));
        rJacobian[9][10] = -(mDt * (9.4679344906248566e-7 * var_x58 - 1.7657390352968255e-17 * var_x59));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[9][12] = -(mDt * (0));
        rJacobian[10][0] = -(mDt * (-var_x64 * (-148.5 * var_x61 + var_x62 * var_chaste_interface__intracellular_sodium_concentration__Na_i)));
        ...
        rJacobian[10][9] = -(mDt * (2.3129480072827907e-11 * var_x52 + 1.240208194723039 * var_x55 + 2.6131499194124605e-9 * var_x56));
        rJacobian[10][10] = 1.0 -(mDt * (8.2927354147114598e-7 * var_x73 + 5.2972171058904767e-17 * var_x59 - 1.687848754916449e-6 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 0.010127092529498692 * var_x71 - 2.8403803471874572e-6 * var_x58 - var_x64 * var_x74 - var_x69 * var_chaste_interface__extracellular_potassium_concentration__K_o));
        rJacobian[10][11] = -(mDt * (0.0013268376663538336 * var_x75 - var_x69 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.001215251103539843 * var_x70 / (148.5 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__K_o)));
        rJacobian[10][12] = -(mDt * (-0.001215251103539843 * var_x71));
        rJacobian[11][0] = -(mDt * (5.215213115888558e-9 * var_x76));
        ...
        rJacobian[11][10] = -(mDt * (6.7724005886810246e-7 * var_x73 - var_x77 * var_chaste_interface__extracellular_potassium_concentration__K_o));
        rJacobian[11][11] = 1.0 -(mDt * (-0.00069999999999999999 + var_x95 - var_x87 + 0.001083584094188964 * var_x75 + 9.2878636644768344e-5 * var_x91 - 8.2704588990905987e-5 * var_x78 - 9.2878636644768348e-7 * var_x96 - var_x77 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x78 * var_x93 - var_x88 * var_x89 - var_x97 * var_x98));
        rJacobian[11][12] = -(mDt * (var_x89 + 8.2704588990905987e-5 * var_x79 + var_x74 * var_x97 + var_x79 * var_x93 + var_x80 * var_x87 - var_x80 * var_x95));
        rJacobian[12][0] = -(mDt * (-4.2573168292967824e-9 * var_x76));
        ...
        rJacobian[12][10] = -(mDt * (-5.5284902764743069e-7 * var_x73 + var_x99 * var_chaste_interface__extracellular_potassium_concentration__K_o));
        rJacobian[12][11] = -(mDt * (var_x101 - var_x103 + 7.5819295220219063e-7 * var_x96 + 6.7513950196657958e-5 * var_x78 - 7.5819295220219067e-5 * var_x91 - 0.00088455844423588909 * var_x75 + var_x100 * var_x88 + var_x104 * var_x98 + var_x99 * var_chaste_interface__intracellular_sodium_concentration__Na_i - var_x102 * var_x78));
        rJacobian[12][12] = 1.0 -(mDt * (-var_x100 - 6.7513950196657958e-5 * var_x79 + var_x102 * var_x79 + var_x103 * var_x80 - var_x101 * var_x80 - var_x104 * var_x74));
    }
    ...
    void Cellespinosa_model_1998_normalFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[5] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((((fabs(4.0 + var_chaste_interface__membrane__V) < 0.0001) ? (1.2) : (-1.2 / (-1.0 + exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V)) - 0.29999999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(4.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-2.3999999999999999) : (-0.47999999999999998 / (-1.0 + exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V)) - 1.2 / (1.0 - exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V)) - 0.12 * var_chaste_interface__membrane__V / (-1.0 + exp(0.53333333333333333 + 0.13333333333333333 * var_chaste_interface__membrane__V)) - 0.29999999999999999 * var_chaste_interface__membrane__V / (1.0 - exp(-1.3333333333333333 - 0.33333333333333331 * var_chaste_interface__membrane__V))))) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((((fabs(24.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.050000000000000003) : (0.29999999999999999 / (-1.0 + exp(4.3636363636363633 + 0.18181818181818182 * var_chaste_interface__membrane__V)) + 0.012500000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(4.3636363636363633 + 0.18181818181818182 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(24.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.050000000000000003 - 0.024 / (1.0 + exp(-6.1818181818181817 - 0.18181818181818182 * var_chaste_interface__membrane__V))) : (-0.024 / (1.0 + exp(-6.1818181818181817 - 0.18181818181818182 * var_chaste_interface__membrane__V)) - 0.29999999999999999 / (-1.0 + exp(4.3636363636363633 + 0.18181818181818182 * var_chaste_interface__membrane__V)) - 0.012500000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(4.3636363636363633 + 0.18181818181818182 * var_chaste_interface__membrane__V))))) * mDt));
        rY[4] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V) - 2.0 / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        ...
        rY[2] = (var_chaste_interface__time_dependent_potassium_current_x_gate__x + ((((fabs(-18.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.0025000000000000001) : (0.027 / (-1.0 + exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.0015 * var_chaste_interface__membrane__V / (-1.0 + exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(-18.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.0050000000000000001) : (0.027 / (1.0 - exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.009611999999999999 / (-1.0 + exp(-1.2 + 0.066666666666666666 * var_chaste_interface__membrane__V)) - 0.0015 * var_chaste_interface__membrane__V / (1.0 - exp(3.6000000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.00053399999999999997 * var_chaste_interface__membrane__V / (-1.0 + exp(-1.2 + 0.066666666666666666 * var_chaste_interface__membrane__V))))) * mDt));
        ...
        rY[9] = (var_chaste_interface__transient_outward_current_s_gate__s + ((8.5800000000000009e-6 * exp(-0.067226890756302518 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.0085800000000000008 / (1.0 + exp(-1.4285714285714286 - 0.14285714285714285 * var_chaste_interface__membrane__V)) - 8.5800000000000009e-6 * exp(-0.067226890756302518 * var_chaste_interface__membrane__V)) * mDt));
