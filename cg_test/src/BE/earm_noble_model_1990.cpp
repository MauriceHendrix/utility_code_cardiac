...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellearm_noble_model_1990FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[10], double rJacobian[10][10])
    {
        ...
        const double var_x16 = 0.001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x17 = 1 / var_x16;
        const double var_x18 = var_x17 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x19 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x20 = 0.012 / (1.0 + exp(-8.5 - var_x19));
        const double var_x21 = var_x20 * (-1.0 - 119.0 * var_x18);
        const double var_x22 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x23 = 1.0 - var_chaste_interface__L_type_calcium_current_f_Ca_gate__f_Ca;
        const double var_x24 = var_chaste_interface__intracellular_calcium_concentration__Ca_i / pow(var_x16, 2);
        const double var_x25 = var_x23 * (var_x24 - var_x17);
        const double var_x26 = 120.0 * var_x23;
        const double var_x27 = -0.59999999999999998 * exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x28 = 0.051020408163265314 * var_x9;
        const double var_x29 = 0.074867781645490947 * var_chaste_interface__membrane__V;
        const double var_x30 = exp(3.7433890822745473 - var_x29);
        const double var_x31 = exp(3.7433890822745473);
        const double var_x32 = -2.0 * var_x30 + var_x31 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x33 = 1 / (1.0 - var_x30);
        const double var_x34 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_calcium_current_d_gate__d;
        const double var_x35 = var_x34 * (1.0 - var_x18);
        const double var_x36 = 3.1504144536796187e-6 * var_x33 * var_x35;
        ...
        const double var_x42 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x43 = 1 / (1.0 + 0.00020000000000000001 * var_x42 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        ...
        const double var_x47 = 2.0 * var_x42 * var_x45 - 2744000.0 * var_x46 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x48 = var_x43 * var_x47 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x49 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x50 = var_x47 * var_x49 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x42 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x51 = var_x43 * var_x49;
        const double var_x52 = var_x46 * var_x51;
        const double var_x53 = var_x25 * var_x34;
        const double var_x54 = pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x55 = var_x45 * var_x51 * var_x54;
        const double var_x56 = var_x50 * var_x54;
        ...
        const double var_x59 = var_x35 * var_x58;
        const double var_x60 = exp(1.8716945411372736);
        const double var_x61 = -2.2052901175757333e-6 * var_x57 + 1.5752072268398093e-8 * var_x60 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x62 = var_x53 * var_x58;
        const double var_x63 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x64 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x65 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x66 = var_x23 * var_x59 * var_x60;
        const double var_x67 = -1.2601657814718476e-8 * var_x57 + 3.1504144536796189e-9 * var_x60 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        const double var_x70 = exp(-0.74867781645490938 + var_x29 - 2.0 * var_x69);
        ...
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0.059999999999999998 + var_x3));
        rJacobian[0][6] = -(mDt * (var_x6));
        rJacobian[0][7] = -(mDt * (0));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[0][9] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0));
        ...
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (-var_x10 * var_x11));
        rJacobian[1][6] = -(mDt * (0));
        rJacobian[1][7] = -(mDt * (0.0050000000000000001));
        rJacobian[1][8] = -(mDt * (0));
        rJacobian[1][9] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        ...
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (15.0 - var_x15));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (((fabs(var_x22) < 0.0001) ? (-0.025000000000000001 + var_x21) : (var_x21 - 0.0062500000000000003 * var_x22 / (-1.0 + exp(8.5 + var_x19))))));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (var_x20 * (var_x25 + var_x17 * var_x26 - var_x24 * var_x26)));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (var_x27 - var_x3));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.059999999999999998 + var_x27 - 1.0 * var_x2));
        rJacobian[5][6] = -(mDt * (-var_x6 + var_x5 * (1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac)));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (var_x28));
        rJacobian[6][2] = -(mDt * (0.050000000000000003 + var_x12));
        rJacobian[6][3] = -(mDt * (0.20000000000000001 + var_x12));
        rJacobian[6][4] = -(mDt * (var_x32 * var_x36));
        rJacobian[6][5] = -(mDt * (var_x11 * var_x28));
        rJacobian[6][6] = 1.0 -(mDt * (-17.0 + var_x14 + var_x15 + 0.0030000000000000001 * var_x40 - 0.0030000000000000001 * var_x38 - 2.8102681769358871e-7 * var_x4 - 5.8069998209165779e-10 * var_x48 - 3.0670341725380159e-10 * var_x50 - 0.23093344215355205 * var_x52 - 5.5200000000000005e-8 * var_x41 - var_x23 * var_x31 * var_x36 - 3.1504144536796187e-6 * var_x32 * var_x33 * var_x53));
        rJacobian[6][7] = -(mDt * (7.1999999999999999e-7 * var_x40 + 5.5200000000000005e-8 * var_x38 - 1.3248e-11 * var_x41));
        rJacobian[6][8] = -(mDt * (5.0495650616665894e-7 * var_x55 - 6.7063429428673823e-16 * var_x56));
        rJacobian[6][9] = -(mDt * (0));
        rJacobian[7][0] = -(mDt * (0));
        rJacobian[7][1] = -(mDt * (0.050000000000000003));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (0));
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (2.7047999999999999e-6 * var_x41 + 0.14699999999999999 * var_x38 - 0.14699999999999999 * var_x40));
        rJacobian[7][7] = 1.0 -(mDt * (-0.050000000000000003 + 6.4915199999999999e-10 * var_x41 - 2.7047999999999999e-6 * var_x38 - 3.5279999999999994e-5 * var_x40));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (var_x59 * var_x61));
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (9.2011025176140482e-10 * var_x50 + 0.69280032646065615 * var_x52 + 1.7420999462749735e-9 * var_x48 - var_x61 * var_x62));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (1.7673477715833067e-7 * var_x64 + 2.0119028828602145e-15 * var_x56 - 1.5148695184999769e-6 * var_x55 - 1.5752072268398093e-8 * var_x66 - 0.00028277564345332906 * var_x63 - 2.6978574498584515e-6 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 1.5791458939838137 * var_x65));
        rJacobian[8][9] = -(mDt * (-0.18949750727805764 * var_x65));
        rJacobian[9][0] = -(mDt * (0));
        rJacobian[9][1] = -(mDt * (0));
        rJacobian[9][2] = -(mDt * (0));
        rJacobian[9][3] = -(mDt * (0));
        rJacobian[9][4] = -(mDt * (var_x59 * var_x67));
        rJacobian[9][5] = -(mDt * (0));
        rJacobian[9][6] = -(mDt * (-var_x62 * var_x67));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (0.0001885170956355527 * var_x63 - 1.1782318477222043e-7 * var_x64));
        rJacobian[9][9] = 1.0 -(mDt * (-3.1504144536796189e-9 * var_x66 - 3.8219647206328062e-5 * var_x68 - 0.0001091989920180802 * var_x68 / var_x71 - 0.00022482145415487099 * var_x68 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 8.1754862903173357e-6 * var_x68 * var_x70 * (-26.713760659695652 * var_x69 + var_chaste_interface__membrane__V) / pow(var_x71, 2)));
    }
