...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[7], double rJacobian[7][7])
    {
        ...
        double var_chaste_interface__intracellular_calcium_concentration__p = rY[12];
        // Units: dimensionless; Initial value: 0.785
        double var_chaste_interface__extracellular_potassium_concentration__Kc = rCurrentGuess[0];double var_chaste_interface__intracellular_calcium_concentration__Ca_rel = rCurrentGuess[1];double var_chaste_interface__intracellular_calcium_concentration__Ca_up = rCurrentGuess[2];double var_chaste_interface__intracellular_calcium_concentration__Cai = rCurrentGuess[3];double var_chaste_interface__intracellular_potassium_concentration__Ki = rCurrentGuess[4];double var_chaste_interface__intracellular_sodium_concentration__Nai = rCurrentGuess[5];double var_chaste_interface__second_inward_current_f2_gate__f2 = rCurrentGuess[6];
        ...
        const double var_x9 = 0.074867781645490947 * var_chaste_interface__membrane__V;
        const double var_x10 = exp(3.7433890822745473 - var_x9);
        const double var_x11 = exp(3.7433890822745473);
        const double var_x12 = (-50.0 + var_chaste_interface__membrane__V) * var_chaste_interface__second_inward_current_d_gate__d * var_chaste_interface__second_inward_current_f_gate__f;
        const double var_x13 = 4.0200601101640967e-6 * var_x12 / (1.0 - var_x10);
        const double var_x14 = 0.0040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x15 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x16 = pow(var_chaste_interface__intracellular_sodium_concentration__Nai, 3.0);
        ...
        const double var_x20 = 2.0 * var_x16 * var_x18 - 2744000.0 * var_x19 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        const double var_x21 = var_x15 * var_x20 / pow((0.0036443148688046646 + 7.2886297376093296e-7 * var_x16 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x22 = 1 / (1.0 + 0.00020000000000000001 * var_x16 + 274.40000000000003 * var_chaste_interface__intracellular_calcium_concentration__Cai);
        const double var_x23 = var_x20 * var_x22 / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Cai), 2);
        const double var_x24 = var_x15 * var_x22;
        ...
        const double var_x27 = var_x18 * var_x24 * var_x26;
        const double var_x28 = var_x21 * var_x26;
        const double var_x29 = -0.037433890822745473 * var_chaste_interface__membrane__V;
        const double var_x30 = exp(1.8716945411372736 + var_x29);
        const double var_x31 = exp(1.8716945411372736);
        const double var_x32 = var_x12 / (1.0 - var_x30);
        const double var_x33 = 2.0100300550820484e-8 * var_x32;
        const double var_x34 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x35 = 1.0 + var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x36 = 1 / var_x35;
        const double var_x37 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x38 = var_x36 * var_x37;
        const double var_x39 = 0.0010739092362051341 * var_x38;
        const double var_x40 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x41 = var_x40 / (1.0 * var_chaste_interface__intracellular_sodium_concentration__Nai + 0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki);
        const double var_x42 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x43 = var_x36 * var_x42 / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x44 = var_chaste_interface__hyperpolarising_activated_current_y_gate__y / (45.0 + var_chaste_interface__extracellular_potassium_concentration__Kc);
        const double var_x45 = 0.0011475261722488205 * var_x44;
        const double var_x46 = var_x31 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x47 = -var_x33 * var_x46;
        const double var_x48 = -26.713760659695652 * log(140.0 * var_x34) + var_chaste_interface__membrane__V;
        const double var_x49 = 4.2956369448205359e-5 * var_x44;
        const double var_x50 = var_chaste_interface__extracellular_potassium_concentration__Kc * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow((1 + 0.022222222222222223 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        const double var_x51 = 2.1213021949731043e-8 * var_x50;
        const double var_x52 = var_x37 * var_x42 / pow(var_x35, 2);
        const double var_x53 = var_x31 * var_chaste_interface__intracellular_potassium_concentration__Ki - var_x30 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        const double var_x54 = 1.8099220986453831e-7 * var_x32;
        const double var_x55 = 0.0064466434341209095 * var_x38;
        const double var_x56 = exp(var_x29);
        const double var_x57 = 9.2094906201727277e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x58 = var_chaste_interface__extracellular_potassium_concentration__Kc / var_chaste_interface__intracellular_potassium_concentration__Ki;
        const double var_x59 = log(var_x58);
        const double var_x60 = exp(0.74867781645490938 + var_x9 - 2.0 * var_x59);
        const double var_x61 = 1.0 + var_x60;
        const double var_x62 = 1 / var_x61;
        const double var_x63 = 1 / (10.0 + var_chaste_interface__extracellular_potassium_concentration__Kc);
        const double var_x64 = var_x62 * var_x63;
        const double var_x65 = 0.0012916056731812832 * var_x64;
        const double var_x66 = 0.010332845385450266 * var_x44;
        const double var_x67 = -26.713760659695652 * var_x59 + var_chaste_interface__membrane__V;
        const double var_x68 = var_x64 * var_x67;
        const double var_x69 = var_x60 * var_x63 * var_x67 / pow(var_x61, 2);
        const double var_x70 = 9.6699651511813646e-5 * var_x69;
        const double var_x71 = var_x62 * var_x67 * var_chaste_interface__extracellular_potassium_concentration__Kc / pow((1 + 0.10000000000000001 * var_chaste_interface__extracellular_potassium_concentration__Kc), 2);
        const double var_x72 = var_x30 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x73 = 0.00071593949080342272 * var_x38;
        const double var_x74 = 0.00014344077153110256 * var_x64;
        const double var_x75 = 1.0227707011477468e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        const double var_x76 = 1.073909236205134e-5 * var_x69;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-var_x0 - 0.10000000000000001 * var_x4));
        rJacobian[0][1] = -(mDt * (var_x0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (var_x5 * var_x6 - var_x5 * var_x7));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        ...
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (4.0 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Ca_up));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.01 - 20.0 * var_chaste_interface__intracellular_calcium_concentration__Cai));
        rJacobian[2][3] = -(mDt * (-20.0 * var_chaste_interface__second_inward_current_f2_gate__f2));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (0.002 * var_x4));
        rJacobian[3][1] = -(mDt * (0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai));
        rJacobian[3][2] = -(mDt * (-var_x13 * (-2.0 * var_x10 + var_x11 * var_chaste_interface__intracellular_calcium_concentration__Cai)));
        rJacobian[3][3] = 1.0 -(mDt * (-0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 5.2182178629987073e-11 * var_x21 - 9.8799649730872331e-11 * var_x23 - 4.7813590510367518e-7 / var_chaste_interface__intracellular_calcium_concentration__Cai - 0.039290759255291838 * var_x25 + var_x14 * var_x7 - var_x14 * var_x6 - var_x11 * var_x13 * var_chaste_interface__second_inward_current_f2_gate__f2));
        rJacobian[3][4] = -(mDt * (8.5912738896410719e-8 * var_x27 - 1.1410097368072975e-16 * var_x28));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (-var_x33 * (-140.0 * var_x30 + var_x31 * var_chaste_interface__intracellular_sodium_concentration__Nai)));
        rJacobian[4][3] = -(mDt * (1.5654653588996123e-10 * var_x21 + 0.11787227776587551 * var_x25 + 2.9639894919261698e-10 * var_x23));
        rJacobian[4][4] = 1.0 -(mDt * (var_x47 + 3.4230292104218926e-16 * var_x28 + 6.7119327262820874e-7 * var_x43 - 2.5773821668923216e-7 * var_x27 - 1.3387805342902908e-5 * var_x34 - 0.0002390679525518376 * var_x41 - var_x39 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x34 * var_x45 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        rJacobian[4][5] = -(mDt * (0.0010739092362051341 * var_x52 + var_x48 * var_x51 - var_x39 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x48 * var_x49 + 2.8688154306220512e-5 * var_x40 / (140.0 + 0.12 * var_chaste_interface__extracellular_potassium_concentration__Kc)));
        rJacobian[4][6] = -(mDt * (-2.8688154306220512e-5 * var_x41));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (var_x53 * var_x54));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (4.0291521463255683e-6 * var_x43 - var_x55 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        rJacobian[5][5] = 1.0 -(mDt * (-0.001 + var_x70 - var_x65 - var_x66 + 4.8349825755906823e-5 * var_x68 + 0.0064466434341209095 * var_x52 - 4.8349825755906825e-7 * var_x71 - var_x54 * var_x72 - var_x55 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x56 * var_x57 + 0.00038679860604725458 * var_x44 * var_x67 - 1.9101165730728621e-7 * var_x50 * var_x67));
        rJacobian[5][6] = -(mDt * (var_x57 + var_x46 * var_x54 + var_x58 * var_x65 + var_x58 * var_x66 - var_x58 * var_x70));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (-var_x33 * var_x53));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (-4.4746218175213919e-7 * var_x43 + var_x73 * var_chaste_interface__extracellular_potassium_concentration__Kc));
        rJacobian[6][5] = -(mDt * (var_x45 + var_x74 - var_x76 + 5.3695461810256699e-8 * var_x71 - 0.00071593949080342272 * var_x52 - 5.3695461810256699e-6 * var_x68 + var_x33 * var_x72 + var_x51 * var_x67 + var_x56 * var_x75 + var_x73 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x49 * var_x67));
        rJacobian[6][6] = 1.0 -(mDt * (var_x47 - var_x75 + var_x58 * var_x76 - var_x45 * var_x58 - var_x58 * var_x74));
    }
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[5] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V) - 2.0 / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        ...
        rY[2] = (var_chaste_interface__hyperpolarising_activated_current_y_gate__y + ((0.0001 * exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((((fabs(52.0 + var_chaste_interface__membrane__V) < 1.0000000000000001e-5) ? (-0.0050000000000000001 - 0.0001 * exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V)) : (-0.10400000000000001 / (1.0 - 1.0 * exp(-10.4 - 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.0001 * exp(-3.484 - 0.067000000000000004 * var_chaste_interface__membrane__V) - 0.002 * var_chaste_interface__membrane__V / (1.0 - 1.0 * exp(-10.4 - 0.20000000000000001 * var_chaste_interface__membrane__V))))) * mDt));
        rY[12] = (var_chaste_interface__intracellular_calcium_concentration__p + ((0.040000000000000001 / (-1.0 + exp(16.0 + 0.25 * var_chaste_interface__membrane__V)) + 0.00062500000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(16.0 + 0.25 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0050000000000000001 / (1.0 + exp(-16.0 - 0.25 * var_chaste_interface__membrane__V)) - 0.040000000000000001 / (-1.0 + exp(16.0 + 0.25 * var_chaste_interface__membrane__V)) - 0.00062500000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(16.0 + 0.25 * var_chaste_interface__membrane__V))) * mDt));
        rY[6] = (var_chaste_interface__second_inward_current_d_gate__d + ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.12) : (-0.57000000000000006 / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)) - 0.029999999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.23999999999999999) : (-0.22800000000000001 / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.57000000000000006 / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)) - 0.012 * var_chaste_interface__membrane__V / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.029999999999999999 * var_chaste_interface__membrane__V / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))) * mDt));
        rY[7] = (var_chaste_interface__second_inward_current_f_gate__f + ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.025000000000000001) : (0.21249999999999999 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)) + 0.0062500000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.025000000000000001 - 0.050000000000000003 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V))) : (-0.050000000000000003 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V)) - 0.21249999999999999 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)) - 0.0062500000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V))))) * mDt));
        rY[3] = (var_chaste_interface__time_dependent_potassium_current_x_gate__x + ((((fabs(22.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.0025000000000000001) : (-0.010999999999999999 / (-1.0 + exp(-4.4000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.00050000000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-4.4000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(22.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.0050000000000000001) : (-0.010999999999999999 / (1.0 - exp(-4.4000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.0039160000000000002 / (-1.0 + exp(1.4666666666666666 + 0.066666666666666666 * var_chaste_interface__membrane__V)) - 0.00050000000000000001 * var_chaste_interface__membrane__V / (1.0 - exp(-4.4000000000000004 - 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.00017799999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(1.4666666666666666 + 0.066666666666666666 * var_chaste_interface__membrane__V))))) * mDt));
