...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_SAN_model_1989FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[6], double rJacobian[6][6])
    {
        ...
        double var_chaste_interface__intracellular_calcium_concentration__p = rY[12];
        // Units: dimensionless; Initial value: 0.237
        double var_chaste_interface__intracellular_calcium_concentration__Ca_rel = rCurrentGuess[0];double var_chaste_interface__intracellular_calcium_concentration__Ca_up = rCurrentGuess[1];double var_chaste_interface__intracellular_calcium_concentration__Cai = rCurrentGuess[2];double var_chaste_interface__intracellular_potassium_concentration__Ki = rCurrentGuess[3];double var_chaste_interface__intracellular_sodium_concentration__Nai = rCurrentGuess[4];double var_chaste_interface__second_inward_current_f2_gate__f2 = rCurrentGuess[5];
        ...
        const double var_x13 = 1.1761547293737243e-5 * var_x12 / (1.0 - var_x10);
        ...
        const double var_x31 = 5.8807736468686214e-8 * var_x12 / (1.0 - var_x29);
        const double var_x32 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Nai);
        const double var_x33 = 1 / var_chaste_interface__intracellular_sodium_concentration__Nai;
        const double var_x34 = var_chaste_interface__intracellular_sodium_concentration__Nai / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Nai), 2);
        const double var_x35 = 0.00013114584825700806 * pow(var_chaste_interface__hyperpolarising_activated_current_y_gate__y, 2.0);
        const double var_x36 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (0.0008549444286121402 * var_chaste_interface__intracellular_potassium_concentration__Ki + 0.0071245369051011684 * var_chaste_interface__intracellular_sodium_concentration__Nai) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Nai + 0.12 * var_chaste_interface__intracellular_potassium_concentration__Ki), 2);
        const double var_x37 = -var_x30 * var_x31 * var_chaste_interface__second_inward_current_f2_gate__f2;
        const double var_x38 = 1 / var_chaste_interface__intracellular_potassium_concentration__Ki;
        const double var_x39 = log(3.0 * var_x38);
        const double var_x40 = exp(0.74867781645490938 + var_x9 - 2.0 * var_x39);
        ...
        rJacobian[3][3] = 1.0 -(mDt * (-0.20000000000000001 + 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_up - 9.5418840923404938e-11 * var_x21 - 1.8066221665073799e-10 * var_x23 - 8.7430565504672044e-7 / var_chaste_interface__intracellular_calcium_concentration__Cai - 0.071845959781105084 * var_x25 + var_x14 * var_x7 - var_x14 * var_x6 - var_x11 * var_x13 * var_chaste_interface__second_inward_current_f2_gate__f2));
        rJacobian[3][4] = -(mDt * (1.5709757969629391e-7 * var_x27 - 2.0864178044476298e-16 * var_x28));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (-var_x31 * (-140.0 * var_x29 + var_x30 * var_chaste_interface__intracellular_sodium_concentration__Nai)));
        rJacobian[4][3] = -(mDt * (0.21553787934331523 * var_x25 + 5.4198664995221396e-10 * var_x23 + 2.8625652277021485e-10 * var_x21));
        rJacobian[4][4] = 1.0 -(mDt * (var_x37 + 6.2592534133428895e-16 * var_x28 + 8.2844426792967482e-7 * var_x34 - 0.061358770871178837 * var_x36 - 0.0013255108286874798 * var_x32 - 2.4480558341308171e-5 * var_x33 - 4.7129273908888172e-7 * var_x27 - var_x33 * var_x35));
        rJacobian[4][5] = -(mDt * (-0.0073630525045414608 * var_x36));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (-var_x31 * (-3.0 * var_x29 + var_x30 * var_chaste_interface__intracellular_potassium_concentration__Ki)));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0.00088367388579165321 * var_x32 - 5.5229617861978321e-7 * var_x34));
        rJacobian[5][5] = 1.0 -(mDt * (var_x37 - 7.4808371283949473e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - var_x35 * var_x38 - 6.0528853041696024e-5 * var_x38 / var_x41 + 4.5316609527777084e-6 * var_x38 * var_x40 * (-26.713760659695652 * var_x39 + var_chaste_interface__membrane__V) / pow(var_x41, 2)));
    }
    ...
    void Cellnoble_SAN_model_1989FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[2] = (var_chaste_interface__hyperpolarising_activated_current_y_gate__y + ((2.8e-5 * exp(-0.0625 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.0195 * exp(0.052631578947368418 * var_chaste_interface__membrane__V) - 2.8e-5 * exp(-0.0625 * var_chaste_interface__membrane__V)) * mDt));
        ...
        rY[3] = (var_chaste_interface__time_dependent_potassium_current_x_gate__x + ((0.0021000000000000003 * exp(0.035714285714285712 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.0021000000000000003 * exp(0.035714285714285712 * var_chaste_interface__membrane__V) - 0.00096000000000000002 * exp(-0.041666666666666664 * var_chaste_interface__membrane__V)) * mDt));
