...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        rY[5] = (var_chaste_interface__ICaL__f + ((0.02 / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__cell__V)) + 0.012 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V)) + 0.019699999999999999 * exp(-0.113569 - 0.00113569 * pow(var_chaste_interface__cell__V, 2) - 0.022713800000000003 * var_chaste_interface__cell__V) / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__cell__V)) + 0.011819999999999999 * exp(-0.113569 - 0.00113569 * pow(var_chaste_interface__cell__V, 2) - 0.022713800000000003 * var_chaste_interface__cell__V) / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-0.02 - 0.019699999999999999 * exp(-0.113569 - 0.00113569 * pow(var_chaste_interface__cell__V, 2) - 0.022713800000000003 * var_chaste_interface__cell__V)) * mDt));
