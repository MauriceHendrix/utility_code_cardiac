...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[14], double rJacobian[14][14])
    {
        ...
        double var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i = rY[14];
        // Units: dimensionless; Initial value: 0.76898
        double var_chaste_interface__Ca_handling_by_the_SR__Ca_rel = rCurrentGuess[0];double var_chaste_interface__Ca_handling_by_the_SR__Ca_up = rCurrentGuess[1];double var_chaste_interface__Ca_handling_by_the_SR__F1 = rCurrentGuess[2];double var_chaste_interface__Ca_handling_by_the_SR__F2 = rCurrentGuess[3];double var_chaste_interface__Ca_handling_by_the_SR__O_Calse = rCurrentGuess[5];double var_chaste_interface__cleft_space_ion_concentrations__K_c = rCurrentGuess[6];double var_chaste_interface__intracellular_Ca_buffering__O_C = rCurrentGuess[7];double var_chaste_interface__intracellular_Ca_buffering__O_TC = rCurrentGuess[8];double var_chaste_interface__intracellular_Ca_buffering__O_TMgC = rCurrentGuess[9];double var_chaste_interface__intracellular_Ca_buffering__O_TMgMg = rCurrentGuess[10];double var_chaste_interface__intracellular_ion_concentrations__Ca_i = rCurrentGuess[11];double var_chaste_interface__intracellular_ion_concentrations__K_i = rCurrentGuess[12];double var_chaste_interface__intracellular_ion_concentrations__Na_i = rCurrentGuess[13];

        const double var_x0 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x1 = 1 / var_x0;
        const double var_x2 = pow((var_x1 * var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4.0);
        const double var_x3 = 0.33960000000000001 * var_x2;
        const double var_x4 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x5 = var_x0 * var_x4 * (4.0 * var_x1 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x0, 2));
        const double var_x6 = var_x3 * var_x5 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x7 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x8 = 0.25 + var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x9 = 1 / var_x8;
        const double var_x10 = pow((var_x9 * var_chaste_interface__Ca_handling_by_the_SR__F2), 2.0);
        const double var_x11 = 23.554751134632365 * var_x10;
        const double var_x12 = var_x8 * (-var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel) * (2.0 * var_x9 - 2.0 * var_chaste_interface__Ca_handling_by_the_SR__F2 / pow(var_x8, 2)) / var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x13 = 3333.3333333333335 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x14 = 1 / (1.3999999999999999 + var_x13 + 0.80000000000000004 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up);
        const double var_x15 = (var_x13 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x16 = 0.23999999999999999 * exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x17 = 0.20380000000000001 * var_x2;
        const double var_x18 = var_x17 * var_x5 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x19 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x20 = 0.17614021922566689 * var_x10;
        const double var_x21 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x22 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        const double var_x23 = 1 / (1.0 + 0.00074999999999999991 * var_x22 + 823.19999999999993 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        const double var_x24 = exp(-0.02072386508127427 * var_chaste_interface__membrane__V);
        const double var_x25 = var_x23 * var_x24;
        const double var_x26 = exp(0.016955889611951675 * var_chaste_interface__membrane__V);
        const double var_x27 = (2.5 * var_x22 * var_x26 - 2744000.0 * var_x24 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow((0.0012147716229348883 + 9.1107871720116623e-7 * var_x22 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x28 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        const double var_x29 = var_x23 * var_x26 * var_x28;
        const double var_x30 = var_x27 * var_x28;
        const double var_x31 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x32 = 0.00027505727103636083 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        ...
        const double var_x35 = pow((var_x34 * var_chaste_interface__cleft_space_ion_concentrations__K_c), 3.0);
        const double var_x36 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x37 = log(var_x36 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x38 = exp(0.18895643383558949 + 0.052487898287663745 * var_chaste_interface__membrane__V - 1.393 * var_x37);
        const double var_x39 = 1.0 + var_x38;
        const double var_x40 = var_x35 / var_x39;
        const double var_x41 = 0.0011178327494917705 * var_x40;
        const double var_x42 = var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        const double var_x43 = 0.00038508017945090519 * var_x42;
        const double var_x44 = pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 6.0);
        const double var_x45 = 26.53945091048535 * (0.58999999999999997 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 3.0) + 0.40999999999999998 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 3.0)) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x46 = var_x45 * (1.6583208100573134e-5 + 2.4874812150859699e-5 * var_x44);
        const double var_x47 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x48 = 1 / (36.4828726939094 + var_x47);
        const double var_x49 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x50 = 1 / (1.5 + exp(-1.5 - 0.025000000000000001 * var_chaste_interface__membrane__V));
        const double var_x51 = var_x50 / var_x49;
        const double var_x52 = var_x48 * var_x51;
        const double var_x53 = var_x47 * var_x52;
        const double var_x54 = -26.53945091048535 * var_x37 + var_chaste_interface__membrane__V;
        const double var_x55 = var_x31 * var_x54;
        const double var_x56 = var_x35 * var_x38 / pow(var_x39, 2);
        const double var_x57 = 5.8672691657943555e-5 * var_x56;
        const double var_x58 = var_x47 * var_x48 * var_x50 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x49, 2);
        const double var_x59 = var_x33 * var_x40 * var_x55 * (3.0 * var_x34 - 3.0 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x33, 2));
        const double var_x60 = var_x36 * var_x54;
        const double var_x61 = var_x28 * var_x51 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x47), 2);
        const double var_x62 = var_x52 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x63 = 5.4574855364357316e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x64 = 7.6404797510100245e-5 * var_x42;
        const double var_x65 = 0.00022179221220074814 * var_x40;
        const double var_x66 = var_x45 * (-3.290319067574035e-6 - 4.9354786013610522e-6 * var_x44);
        const double var_x67 = 1.1641407074988802e-5 * var_x56;
        const double var_x68 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x69 = 0.037679754693225945 * var_chaste_interface__membrane__V;
        ...
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0.47999999999999998 - 0.47999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse));
        rJacobian[0][7] = -(mDt * (0));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[0][9] = -(mDt * (0));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.00081499999999999997));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        rJacobian[2][9] = -(mDt * (0.033960000000000004 + var_x3));
        rJacobian[2][10] = -(mDt * (var_x6));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.47600000000000003 + var_x7));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (0));
        rJacobian[3][10] = -(mDt * (200.0 - 200.0 * var_chaste_interface__intracellular_Ca_buffering__O_C));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-0.39200000000000002 - 78.400000000000006 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (0));
        rJacobian[4][10] = -(mDt * (78.400000000000006 - 78.400000000000006 * var_chaste_interface__intracellular_Ca_buffering__O_TC));
        rJacobian[4][11] = -(mDt * (0));
        rJacobian[4][12] = -(mDt * (0));
        rJacobian[4][13] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (var_x7));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.0066 + var_x7));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0));
        rJacobian[5][10] = -(mDt * (200.0 - 200.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC - 200.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg));
        rJacobian[5][11] = -(mDt * (0));
        rJacobian[5][12] = -(mDt * (0));
        rJacobian[5][13] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (12.4 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__Ca_rel));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * (-14.98 - var_x11 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse));
        rJacobian[6][7] = -(mDt * (0.10000000000000001));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (-var_x11 * var_x12));
        rJacobian[6][10] = -(mDt * (var_x11));
        ...
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0.011085915847820609));
        rJacobian[7][7] = 1.0 -(mDt * (-0.011085915847820609 - 2.6321499680605046e-9 * var_x15 - 0.011698444302491135 * var_x14));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[7][10] = -(mDt * (121.85879481761599 * var_x14 - 1.0967291533585437e-5 * var_x15));
        rJacobian[7][11] = -(mDt * (0));
        rJacobian[7][12] = -(mDt * (0));
        rJacobian[7][13] = -(mDt * (0));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0.00081499999999999997));
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (0));
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (-var_x16 - var_x17));
        rJacobian[8][9] = -(mDt * (0));
        rJacobian[8][10] = -(mDt * (-var_x18));
        ...
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (var_x16 + var_x17));
        rJacobian[9][9] = 1.0 -(mDt * (-0.033960000000000004 - var_x3));
        rJacobian[9][10] = -(mDt * (var_x18 - var_x6));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[9][12] = -(mDt * (0));
        rJacobian[9][13] = -(mDt * (0));
        rJacobian[10][0] = -(mDt * (0));
        rJacobian[10][1] = -(mDt * (var_x19));
        rJacobian[10][2] = -(mDt * (0));
        rJacobian[10][3] = -(mDt * (0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[10][4] = -(mDt * (0.031359999999999999 + 6.2720000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[10][5] = -(mDt * (0.0010560000000000001 + var_x19));
        rJacobian[10][6] = -(mDt * (var_x20));
        rJacobian[10][7] = -(mDt * (0.00078910818213098765 * var_x14 + 1.7754934097947219e-10 * var_x15));
        rJacobian[10][8] = -(mDt * (0));
        rJacobian[10][9] = -(mDt * (var_x12 * var_x20));
        rJacobian[10][10] = 1.0 -(mDt * (-47.271999999999998 - var_x20 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 7.3978892074780085e-7 * var_x15 - 0.096665752311046002 * var_x25 - 2.3373323507508574e-7 * var_x4 - 8.2198768971977891 * var_x14 - 8.3745867230843319e-6 / var_x21 - 4.2794027994574083e-11 * var_x27 + 8.3745867230843319e-6 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x21, 2)));
        rJacobian[10][11] = -(mDt * (0));
        rJacobian[10][12] = -(mDt * (0));
        rJacobian[10][13] = -(mDt * (2.6421032883850034e-7 * var_x29 - 1.1696618438750204e-16 * var_x30));
        ...
        rJacobian[11][11] = 1.0 -(mDt * (4.2119663788904208e-5 * var_x59 + 0.00085446536839159674 * var_x58 - 0.00085446536839159674 * var_x53 + var_x55 * var_x57 - var_x31 * var_x32 - var_x31 * var_x41 - var_x31 * var_x43 - var_x31 * var_x46));
        rJacobian[11][12] = -(mDt * (var_x32 * var_x36 + var_x36 * var_x41 + var_x36 * var_x43 + var_x36 * var_x46 - var_x57 * var_x60));
        rJacobian[11][13] = -(mDt * (9.6295871719563877e-7 * var_x61 - 0.0012816980525873951 * var_x62));
        ...
        rJacobian[12][11] = -(mDt * (0.00016953677944277714 * var_x53 - 8.3570761485921043e-6 * var_x59 - 0.00016953677944277714 * var_x58 + var_x31 * var_x63 + var_x31 * var_x64 + var_x31 * var_x65 - var_x31 * var_x66 - var_x55 * var_x67));
        rJacobian[12][12] = 1.0 -(mDt * (var_x36 * var_x66 + var_x60 * var_x67 - var_x36 * var_x63 - var_x36 * var_x64 - var_x36 * var_x65));
        ...
        rJacobian[13][10] = -(mDt * (0.13542411585671302 * var_x25 + 5.9952395409541403e-11 * var_x27));
        rJacobian[13][11] = -(mDt * (0.00025430516916416572 * var_x58 - 0.00025430516916416572 * var_x53));
        rJacobian[13][12] = -(mDt * (0));
        rJacobian[13][13] = 1.0 -(mDt * (1.638640545085862e-16 * var_x30 + 2.8659485630822583e-7 * var_x61 - 0.00038145775374624855 * var_x62 - 4.3659884291485854e-7 * var_x68 - 3.701460892585086e-7 * var_x29 - 0.00058612951745018135 * var_x68 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * (0.36499999999999999 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.63500000000000001 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V * exp(var_x69 - 1.0 * log(140.0 * var_x68)) / (-1.0 + exp(var_x69))));
    }
    ...
    void Cellaslanidi_model_2009FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[8] = (var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + ((0.001 / (0.00040000000000000002 + 1.0 / (8.0109999999999992 * exp(-0.1388888888888889 * var_chaste_interface__membrane__V) + 386.60000000000002 * exp(0.083333333333333329 * var_chaste_interface__membrane__V)) + 0.00040000000000000002 * exp(-2.6628794603230959 - 0.17752529735487307 * var_chaste_interface__membrane__V) + 1.0 * exp(-2.6628794603230959 - 0.17752529735487307 * var_chaste_interface__membrane__V) / (8.0109999999999992 * exp(-0.1388888888888889 * var_chaste_interface__membrane__V) + 386.60000000000002 * exp(0.083333333333333329 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.00040000000000000002 + 1.0 / (8.0109999999999992 * exp(-0.1388888888888889 * var_chaste_interface__membrane__V) + 386.60000000000002 * exp(0.083333333333333329 * var_chaste_interface__membrane__V)))) * mDt));
        rY[9] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1 + ((0.001 / (0.020400000000000001 + 0.020400000000000001 * exp(4.0070821529745047 + 0.14164305949008499 * var_chaste_interface__membrane__V) + 0.54659999999999997 / (1.0 + exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V)) + 0.54659999999999997 * exp(4.0070821529745047 + 0.14164305949008499 * var_chaste_interface__membrane__V) / (1.0 + exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.020400000000000001 + 0.54659999999999997 / (1.0 + exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V)))) * mDt));
        rY[10] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2 + ((0.001 / (5.75 / (1.0 + exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V)) + 0.45000000000000001 / (1.0 + exp(0.96921975662133131 - 0.071581961345740866 * var_chaste_interface__membrane__V)) + 5.75 * exp(4.0070821529745047 + 0.14164305949008499 * var_chaste_interface__membrane__V) / (1.0 + exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V)) + 0.45000000000000001 * exp(4.0070821529745047 + 0.14164305949008499 * var_chaste_interface__membrane__V) / (1.0 + exp(0.96921975662133131 - 0.071581961345740866 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (5.75 / (1.0 + exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V)) + 0.45000000000000001 / (1.0 + exp(0.96921975662133131 - 0.071581961345740866 * var_chaste_interface__membrane__V)))) * mDt));
        rY[11] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3 + ((0.00060024009603841543 / (0.5 + 0.5 * exp(1.8506208911614319 + 0.036523009495982472 * var_chaste_interface__membrane__V) + 7.5 / (1.0 + exp(46.0 + 2.0 * var_chaste_interface__membrane__V)) + 7.5 * exp(1.8506208911614319 + 0.036523009495982472 * var_chaste_interface__membrane__V) / (1.0 + exp(46.0 + 2.0 * var_chaste_interface__membrane__V))) + 0.0003997599039615847 / (0.5 + 7.5 / (1.0 + exp(46.0 + 2.0 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.5 + 7.5 / (1.0 + exp(46.0 + 2.0 * var_chaste_interface__membrane__V)))) * mDt));
        rY[4] = (var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + ((0.022400000000000003 / (-1.0 + 1.0 * exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) + exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V)) - 0.75239999999999996 / (-1.0 + 1.0 * exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V)) - 0.5 / (-1.0 + 1.0 * exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V) - 1.0 * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) + exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) * exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)) + 0.0044800000000000005 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) + exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V)) - 0.050000000000000003 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V) - 1.0 * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) + exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) * exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)) - 0.016719999999999999 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) - 1.0 * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V) + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V) * exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((0.75239999999999996 / (-1.0 + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.5 / (-1.0 + exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)) - 0.022400000000000003 / (-1.0 + exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V)) + 0.050000000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(-2.0798668885191347 - 0.20798668885191349 * var_chaste_interface__membrane__V)) + 0.016719999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(-18.0 - 0.40000000000000002 * var_chaste_interface__membrane__V)) - 0.0044800000000000005 * var_chaste_interface__membrane__V / (-1.0 + exp(2.0 + 0.40000000000000002 * var_chaste_interface__membrane__V))) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L + ((10.379840039999999 / (-67.921999999999997 / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 152.81999999999999 / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 67.921999999999997 * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 8.4900000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 152.81999999999999 * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 8.4900000000000002 * var_chaste_interface__membrane__V * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V))) + 23.353952400000001 / (67.921999999999997 / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 135.84399999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 305.63999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 16.98 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V))) + 0.072080100000000008 * pow(var_chaste_interface__membrane__V, 2) / (67.921999999999997 / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 135.84399999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 305.63999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 16.98 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V))) + 0.57665778000000001 * var_chaste_interface__membrane__V / (-67.921999999999997 / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 152.81999999999999 / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 67.921999999999997 * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 8.4900000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 152.81999999999999 * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 8.4900000000000002 * var_chaste_interface__membrane__V * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) * exp(-4.5 - 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V))) + 2.5948836000000002 * var_chaste_interface__membrane__V / (67.921999999999997 / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 67.921999999999997 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 152.81999999999999 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 135.84399999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 305.63999999999999 * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) + 8.4900000000000002 * pow(exp(4.5 + 0.25 * var_chaste_interface__membrane__V), 2) * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 16.98 * var_chaste_interface__membrane__V * exp(4.5 + 0.25 * var_chaste_interface__membrane__V) / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.067921999999999996 / (1.0 + exp(-4.5 - 0.25 * var_chaste_interface__membrane__V)) - 0.15282000000000001 / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V)) - 0.008490000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(4.5 + 0.25 * var_chaste_interface__membrane__V))) * mDt));
        rY[6] = (var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T + ((0.67417300000000002 * exp(0.77666666666666673 + 0.033333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__V)) + 0.67417300000000002 * exp(-0.77666666666666673 - 0.033333333333333333 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.67417300000000002 * exp(0.77666666666666673 + 0.033333333333333333 * var_chaste_interface__membrane__V) - 0.67417300000000002 * exp(-0.77666666666666673 - 0.033333333333333333 * var_chaste_interface__membrane__V)) * mDt));
        rY[7] = (var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T + ((0.092871769000000007 * pow(exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V), 2) / (9.6370000000000005 * exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V) + 9.6370000000000005 * exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V)) + 0.092871769000000007 * exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V) * exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V) / (9.6370000000000005 * exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V) + 9.6370000000000005 * exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0096370000000000015 * exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V) - 0.0096370000000000015 * exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V)) * mDt));
        rY[13] = (var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a + ((0.0090000000000000011 * exp(0.03941508020968823 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V)) + 0.0013000000000000002 * exp(-0.076769537847382163 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0090000000000000011 * exp(0.03941508020968823 * var_chaste_interface__membrane__V) - 0.0013000000000000002 * exp(-0.076769537847382163 * var_chaste_interface__membrane__V)) * mDt));
        rY[14] = (var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i + ((0.10000000000000001 * exp(-0.018299935950224173 * var_chaste_interface__membrane__V) / (1.0 + exp(2.539728728905752 + 0.05358970648917756 * var_chaste_interface__membrane__V)) + 0.65600000000000003 * exp(0.009420009985210585 * var_chaste_interface__membrane__V) / (1.0 + exp(2.539728728905752 + 0.05358970648917756 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.10000000000000001 * exp(-0.018299935950224173 * var_chaste_interface__membrane__V) - 0.65600000000000003 * exp(0.009420009985210585 * var_chaste_interface__membrane__V)) * mDt));
        rY[12] = (var_chaste_interface__delayed_rectifier_K_current_z_gate__z + ((0.001 / (0.059999999999999998 + 1.0 / (0.29999999999999999 * exp(-0.045816915605241454 * var_chaste_interface__membrane__V) + 1.6599999999999999 * exp(0.014398433450440593 * var_chaste_interface__membrane__V)) + 0.059999999999999998 * exp(0.065217391304347824 - 0.072463768115942032 * var_chaste_interface__membrane__V) + 1.0 * exp(0.065217391304347824 - 0.072463768115942032 * var_chaste_interface__membrane__V) / (0.29999999999999999 * exp(-0.045816915605241454 * var_chaste_interface__membrane__V) + 1.6599999999999999 * exp(0.014398433450440593 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.059999999999999998 + 1.0 / (0.29999999999999999 * exp(-0.045816915605241454 * var_chaste_interface__membrane__V) + 1.6599999999999999 * exp(0.014398433450440593 * var_chaste_interface__membrane__V)))) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_h1_gate__h1 + ((0.044900000000000002 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V) / (44.729999999999997 / (1.0 + 1.0 * exp(6.666666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__V) + 323.30000000000001 * exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V) + 323.30000000000001 * exp(6.666666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__V) * exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V)) + 0.22364999999999999 / (1.0 + 323.30000000000001 * exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V)) + 0.0067349999999999988 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V) + 1.347 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V) / (1.0 + exp(6.666666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.00014999999999999999 + 0.029999999999999999 / (1.0 + exp(6.666666666666667 + 0.16666666666666666 * var_chaste_interface__membrane__V)))) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_h2_gate__h2 + ((0.044900000000000002 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V) / (178.91999999999999 / (1.0 + 1.0 * exp(30.0 + 0.5 * var_chaste_interface__membrane__V) + 323.30000000000001 * exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V) + 323.30000000000001 * exp(30.0 + 0.5 * var_chaste_interface__membrane__V) * exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V)) + 0.020204999999999997 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V) + 0.67094999999999994 / (1.0 + 323.30000000000001 * exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V)) + 5.3879999999999999 * exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V) / (1.0 + exp(30.0 + 0.5 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.00044999999999999999 + 0.12 / (1.0 + exp(30.0 + 0.5 * var_chaste_interface__membrane__V)))) * mDt));
        rY[1] = (var_chaste_interface__sodium_current_m_gate__m + ((-20.423999999999999 / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V)) - 0.46000000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((20.423999999999999 / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V)) - 18.400000000000002 * exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V) + 0.46000000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V))) * mDt));
