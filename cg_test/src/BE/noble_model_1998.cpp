...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x39 = 4.7303520325519803e-5 * var_x38 / (1.0 - var_x36);
        ...
        const double var_x46 = 0.018716945411372737 * var_chaste_interface__membrane__V;
        const double var_x47 = exp(var_x46);
        const double var_x48 = 2.0 * var_x47 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0);
        const double var_x49 = exp(-var_x46);
        const double var_x50 = 2744000.0 * var_x49;
        const double var_x51 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds);
        const double var_x52 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x53 = var_x49 * var_x52;
        const double var_x54 = (var_x48 - var_x50 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        const double var_x55 = var_x47 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x56 = var_x52 * var_x55;
        const double var_x57 = exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V);
        const double var_x58 = exp(1.8716945411372736);
        const double var_x59 = var_x38 / (1.0 - var_x57);
        const double var_x60 = 2.3651760162759904e-8 * var_x59;
        const double var_x61 = 1 / var_chaste_interface__intracellular_sodium_concentration__Na_i;
        const double var_x62 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x63 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x64 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x65 = var_x58 * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds;
        const double var_x66 = 4.7303520325519805e-9 * var_x59;
        const double var_x67 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0) * (0.12195121951219512 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0036585365853658534 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow((0.029999999999999999 * var_chaste_interface__intracellular_sodium_concentration__Na_i + var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x68 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x69 = log(4.0 * var_x68);
        const double var_x70 = exp(-0.46792363528431841 + 0.046792363528431836 * var_chaste_interface__membrane__V - 1.25 * var_x69);
        ...
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0.001 - 2.1798047375812983e-12 * (var_x48 - var_x50 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2) - 0.00086686727535117145 * var_x49 * var_x51));
        rJacobian[9][8] = -(mDt * (7.2e-9 * var_x41 + 9.5999999999999999e-8 * var_x44 - 1.7279999999999999e-12 * var_x43));
        rJacobian[9][9] = 1.0 -(mDt * (-7.0000000000000009 + var_x8 + var_x9 + 0.00040000000000000002 * var_x44 - 0.86600040807582024 * var_x53 - 7.2e-9 * var_x43 - 1.0549054718227806e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 2.1776249328437171e-9 * var_x54 - 0.00040000000000000002 * var_x41));
        rJacobian[9][10] = -(mDt * (1.8935868981249713e-6 * var_x56 + 1.8954823805054768e-9 * var_x51 * var_x55));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[10][0] = -(mDt * (-var_x60 * (-140.0 * var_x57 + var_x58 * var_chaste_interface__intracellular_sodium_concentration__Na_i)));
        ...
        rJacobian[10][9] = -(mDt * (6.5328747985311509e-9 * var_x54 + 2.5980012242274606 * var_x53));
        rJacobian[10][10] = 1.0 -(mDt * (6.634188331769168e-7 * var_x63 - 1.0127092529498693e-5 * var_x61 - 0.0010614701330830668 * var_x62 - 5.9277248272665686 * var_x64 - 5.6807606943749135e-6 * var_x56 - var_x60 * var_x65 - 6.7513950196657958e-5 * var_x61 / (1.0 + exp(-6.5 - 0.125 * var_chaste_interface__membrane__V))));
        rJacobian[10][11] = -(mDt * (-0.71132697927198818 * var_x64));
        rJacobian[11][0] = -(mDt * (-var_x66 * (-4.0 * var_x57 + var_x58 * var_chaste_interface__intracellular_potassium_concentration__K_i)));
        ...
        rJacobian[11][10] = -(mDt * (0.00070764675538871125 * var_x62 - 1.0795480636445605e-5 * var_x67 - 4.4227922211794452e-7 * var_x63));
        rJacobian[11][11] = 1.0 -(mDt * (-0.00035984935454818685 * var_x67 - var_x65 * var_x66 - 0.0024112125070234985 * var_x68 / var_x71 - 0.016878487549164489 * var_x68 * (0.0012999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 + 0.0020999999999999999 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1) / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V)) - 8.4392437745822447e-5 * var_x68 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 0.00011282633217294504 * var_x68 * var_x70 * (-26.713760659695652 * var_x69 + var_chaste_interface__membrane__V) / pow(var_x71, 2)));
    }
    ...
    void Cellnoble_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        //const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__beta_xr2 = 0.40000000000000002 * exp(-pow((1.0 + 0.033333333333333333 * var_chaste_interface__membrane__V), 3.0)); // per_second
        ...
        rY[7] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.35999999999999999) : (-1.71 / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)) - 0.089999999999999997 * var_chaste_interface__membrane__V / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.71999999999999997) : (-0.68400000000000005 / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 1.71 / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)) - 0.036000000000000004 * var_chaste_interface__membrane__V / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.089999999999999997 * var_chaste_interface__membrane__V / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))) * mDt));
        rY[8] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.0074999999999999997) : (0.063750000000000001 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)) + 0.0018749999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.0074999999999999997 - 0.0035999999999999999 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V))) : (-0.063750000000000001 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)) - 0.0035999999999999999 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V)) - 0.0018749999999999999 * var_chaste_interface__membrane__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V))))) * mDt));
        rY[6] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V)) * mDt)) / (1.0 - ((-0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane__V) - 2.0 / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        rY[5] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((((fabs(41.0 + var_chaste_interface__membrane__V) < 1.0000000000000001e-5) ? (2.0) : (-8.1999999999999993 / (-1.0 + exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.20000000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(41.0 + var_chaste_interface__membrane__V) < 1.0000000000000001e-5) ? (-2.0 - 8.0 * exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V)) : (-8.1999999999999993 / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 8.0 * exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V) - 0.20000000000000001 * var_chaste_interface__membrane__V / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt));
        rY[2] = (var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1 + ((0.050000000000000003 / (1.0 + exp(0.55555555555555558 - 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.050000000000000003 / (1.0 + exp(0.55555555555555558 - 0.1111111111111111 * var_chaste_interface__membrane__V)) - 5.0000000000000002e-5 * exp(1.3333333333333333 - 0.066666666666666666 * var_chaste_interface__membrane__V)) * mDt));
        rY[3] = (var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 + ((0.050000000000000003 / (1.0 + exp(0.55555555555555558 - 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.050000000000000003 / (1.0 + exp(0.55555555555555558 - 0.1111111111111111 * var_chaste_interface__membrane__V)) - 0.00040000000000000002 * exp(-pow((1.0 + 0.033333333333333333 * var_chaste_interface__membrane__V), 3.0))) * mDt));
        rY[4] = (var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + ((0.014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 * exp(-0.022222222222222223 * var_chaste_interface__membrane__V) - 0.014 / (1.0 + exp(4.4444444444444446 - 0.1111111111111111 * var_chaste_interface__membrane__V))) * mDt));
