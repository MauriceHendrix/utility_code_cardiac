...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellkurata_model_2002FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time)
    {
        ...
        rY[2] = (var_chaste_interface__L_type_calcium_channel_current_f_gate__f + ((1.0 / (44.299999999999997 + 257.10000000000002 * exp(-5.4668495419491743 - 0.33642151027379535 * var_chaste_interface__membrane__V - 0.005175715542673774 * pow(var_chaste_interface__membrane__V, 2)) + 44.299999999999997 * exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) + 257.10000000000002 * exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(-5.4668495419491743 - 0.33642151027379535 * var_chaste_interface__membrane__V - 0.005175715542673774 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-1 / (44.299999999999997 + 257.10000000000002 * exp(-5.4668495419491743 - 0.33642151027379535 * var_chaste_interface__membrane__V - 0.005175715542673774 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
