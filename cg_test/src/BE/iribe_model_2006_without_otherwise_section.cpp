...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        double var_chaste_interface__L_type_Ca_channel_f_gate__f = rY[8];
        // Units: dimensionless; Initial value: 1.0
        double var_chaste_interface__CaMKII_factor__F_CaMK = rCurrentGuess[0];double var_chaste_interface__Force__N_0 = rCurrentGuess[1];double var_chaste_interface__Force__P_0 = rCurrentGuess[2];double var_chaste_interface__Force__P_1 = rCurrentGuess[3];double var_chaste_interface__Force__P_2 = rCurrentGuess[4];double var_chaste_interface__Force__P_3 = rCurrentGuess[5];double var_chaste_interface__RyR__F_1 = rCurrentGuess[6];double var_chaste_interface__RyR__F_2 = rCurrentGuess[7];double var_chaste_interface__RyR__F_SRCa_RyR = rCurrentGuess[8];double var_chaste_interface__SR_calcium_concentration__Ca_SR = rCurrentGuess[9];double var_chaste_interface__calmodulin__Cmdn_Ca = rCurrentGuess[10];double var_chaste_interface__intracellular_calcium_concentration__Ca_i = rCurrentGuess[11];double var_chaste_interface__intracellular_potassium_concentration__K_i = rCurrentGuess[12];double var_chaste_interface__intracellular_sodium_concentration__Na_i = rCurrentGuess[13];double var_chaste_interface__troponin__Trpn_Ca = rCurrentGuess[14];

        const double var_x0 = -var_chaste_interface__intracellular_calcium_concentration__Ca_i + var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x1 = 0.25 + var_chaste_interface__RyR__F_2;
        const double var_x2 = 1 / var_x1;
        const double var_x3 = pow((var_x2 * var_chaste_interface__RyR__F_2), 2.0);
        const double var_x4 = 0.20000000000000001 + var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x5 = var_x3 / var_x4;
        const double var_x6 = 0.5 * var_x5;
        const double var_x7 = var_x0 * var_x6;
        const double var_x8 = var_x0 * var_x3 * var_chaste_interface__RyR__F_SRCa_RyR / pow(var_x4, 2);
        const double var_x9 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2.0);
        const double var_x10 = pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2.0);
        const double var_x11 = 1 / (1.0 + 17361111.111111112 * var_x9 + 0.37180249851279007 * var_x10);
        const double var_x12 = var_x11 * var_x9;
        const double var_x13 = pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 1.0);
        const double var_x14 = var_x11 * var_x13;
        const double var_x15 = var_x6 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x16 = (-0.14537477691850093 * var_x10 + 5069444.444444444 * var_x9 * var_chaste_interface__CaMKII_factor__F_CaMK) / pow((5.7600000000000006e-8 + var_x9 + 2.1415823914336707e-8 * var_x10), 2);
        const double var_x17 = var_x13 * var_x16;
        const double var_x18 = var_x1 * (2.0 * var_x2 - 2.0 * var_chaste_interface__RyR__F_2 / pow(var_x1, 2)) * var_chaste_interface__RyR__F_SRCa_RyR / var_chaste_interface__RyR__F_2;
        const double var_x19 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 1.0);
        const double var_x20 = var_x11 * var_x19 * var_chaste_interface__CaMKII_factor__F_CaMK;
        const double var_x21 = var_x16 * var_x19;
        const double var_x22 = 10.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x23 = 10.0 * var_chaste_interface__calmodulin__Cmdn_Ca;
        const double var_x24 = pow(var_chaste_interface__CaMKII_factor__F_CaMK, 2.0);
        const double var_x25 = 4.5454545454545459 * var_chaste_interface__RyR__F_SRCa_RyR;
        const double var_x26 = pow(var_x25, (2.0408163265306123 * var_x24));
        const double var_x27 = var_x26 * (1.0 - var_chaste_interface__RyR__F_1 - var_chaste_interface__RyR__F_2);
        const double var_x28 = 30625.0 * var_x9;
        const double var_x29 = -0.001885 * var_x26;
        const double var_x30 = -0.037433890822745473 * var_chaste_interface__membrane_potential__V;
        const double var_x31 = exp(1.8716945411372736 + var_x30);
        const double var_x32 = exp(1.8716945411372736);
        const double var_x33 = (-50.0 + var_chaste_interface__membrane_potential__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x34 = var_x33 / (1.0 - var_x31);
        const double var_x35 = 4.5856516257863203e-6 * var_x34;
        const double var_x36 = var_x35 * (-4.0 * var_x31 + var_x32 * var_chaste_interface__intracellular_potassium_concentration__K_i);
        const double var_x37 = 0.074867781645490947 * var_chaste_interface__membrane_potential__V;
        const double var_x38 = exp(3.7433890822745473 - var_x37);
        const double var_x39 = exp(3.7433890822745473);
        const double var_x40 = var_x33 / (1.0 - var_x38);
        const double var_x41 = 0.0091713032515726399 * var_x40;
        const double var_x42 = var_x41 * (-2.0 * var_x38 + var_x39 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x43 = 2.2928258128931602e-5 * var_x34;
        const double var_x44 = var_x43 * (-140.0 * var_x31 + var_x32 * var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x45 = var_x32 * var_chaste_interface__RyR__F_1;
        const double var_x46 = var_x43 * var_x45;
        const double var_x47 = var_x35 * var_x45;
        const double var_x48 = 61250.0 * var_x19;
        const double var_x49 = var_x39 * var_x41;
        const double var_x50 = 1.0 + 0.35999999999999999 / var_chaste_interface__SR_calcium_concentration__Ca_SR;
        const double var_x51 = 1 / (1.0 + 0.035299999999999998 * exp(var_x30) + 0.1245 * exp(-0.0037433890822745472 * var_chaste_interface__membrane_potential__V));
        const double var_x52 = var_x51 / (21.699999999999999 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x53 = var_x51 * var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.046082949308755762 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x54 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__intracellular_calcium_concentration__Ca_i);
        const double var_x55 = 0.018716945411372737 * var_chaste_interface__membrane_potential__V;
        const double var_x56 = exp(var_x55);
        const double var_x57 = var_x54 * var_x56 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x58 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x59 = var_x32 * var_x34;
        const double var_x60 = exp(-var_x55);
        const double var_x61 = var_x54 * var_x60;
        const double var_x62 = (2.0 * var_x56 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 3.0) - 2744000.0 * var_x60 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x65 = exp(-0.74867781645490938 + var_x37 - 2.0 * var_x64);
        const double var_x66 = 1.0 + var_x65;
        const double var_x67 = 12600800.629436173 * pow(var_chaste_interface__troponin__Trpn_Ca, 5.1071428571428568);
        const double var_x68 = -var_x67;
        const double var_x69 = 64354088.928906165 * pow(var_chaste_interface__troponin__Trpn_Ca, 4.1071428571428568);
        const double var_x70 = var_x69 * var_chaste_interface__Force__N_0;
        const double var_x71 = 0.080480480480480482 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x72 = 0.16096096096096096 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x73 = -var_x71;
        const double var_x74 = 0.080480480480480482 * var_chaste_interface__Force__P_2;
        const double var_x75 = 0.16096096096096096 * var_chaste_interface__Force__P_3;
        const double var_x76 = 80.0 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x77 = 0.080480480480480482 * var_chaste_interface__Force__N_0;
        const double var_x78 = 0.080480480480480482 * var_chaste_interface__Force__P_0;
        const double var_x79 = 80.0 * var_chaste_interface__troponin__Trpn_Ca;
        const double var_x80 = 0.10203913679590344 * var_x5;
        const double var_x81 = var_x0 * var_x80;
        const double var_x82 = var_x80 * var_chaste_interface__RyR__F_SRCa_RyR;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.15142857142857144));
        rJacobian[0][1] = -(mDt * (0.12214285714285715));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        ...
        rJacobian[0][12] = -(mDt * (0.10000000000000001));
        rJacobian[0][13] = -(mDt * (0));
        rJacobian[0][14] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0.070000000000000007));
        rJacobian[1][1] = 1.0 -(mDt * (-0.12214285714285715));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.02));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0.02));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.00125));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (24.999999999999996));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (0));
        ...
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (-var_x7 + 0.5 * var_x8));
        rJacobian[4][3] = -(mDt * (24840.686640579101 * var_x12));
        rJacobian[4][4] = 1.0 -(mDt * (-var_x15 - 0.001424696263447196 * var_x14 - 1.2089003260906828e-17 * var_x17));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (-var_x18 * var_x7));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (0));
        ...
        rJacobian[4][14] = -(mDt * (var_x15 + 49681.373281158201 * var_x20 - 5.6448929115512146e-10 * var_x21));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.5 - var_x22));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0));
        ...
        rJacobian[5][14] = -(mDt * (0.20000000000000001 - var_x23));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (0.0038469387755102045 * var_x24 * var_x27 / var_chaste_interface__RyR__F_SRCa_RyR));
        rJacobian[6][3] = -(mDt * (0.007693877551020409 * var_x27 * pow(var_chaste_interface__CaMKII_factor__F_CaMK, 1.0) * log(var_x25)));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * (-0.0018000000000000002 + var_x29 + var_x36 + var_x42 + var_x44 - var_x28));
        rJacobian[6][7] = -(mDt * (var_x29));
        rJacobian[6][8] = -(mDt * (var_x46));
        rJacobian[6][9] = -(mDt * (var_x47));
        rJacobian[6][10] = -(mDt * (0));
        rJacobian[6][11] = -(mDt * (0));
        rJacobian[6][12] = -(mDt * (0));
        rJacobian[6][13] = -(mDt * (0));
        rJacobian[6][14] = -(mDt * ((var_x49 - var_x48) * var_chaste_interface__RyR__F_1));
        rJacobian[7][0] = -(mDt * (0));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (0));
        rJacobian[7][4] = -(mDt * (-0.16200000000000001 * var_chaste_interface__RyR__F_2 / (pow(var_x50, 2) * pow(var_chaste_interface__SR_calcium_concentration__Ca_SR, 2))));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (var_x28 - var_x36 - var_x42 - var_x44));
        rJacobian[7][7] = 1.0 -(mDt * (-0.45000000000000001 / var_x50));
        rJacobian[7][8] = -(mDt * (-var_x46));
        rJacobian[7][9] = -(mDt * (-var_x47));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (0));
        rJacobian[7][12] = -(mDt * (0));
        rJacobian[7][13] = -(mDt * (0));
        rJacobian[7][14] = -(mDt * ((var_x48 - var_x49) * var_chaste_interface__RyR__F_1));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (0));
        ...
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (4.3794501115171722e-6 * var_x53 - 1.0126868767488654e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 5.9275938519033593 * var_x58 - 0.0020622392630123211 * var_x52 - 5.6863214972766202e-6 * var_x57 - 5.9128093920023211e-8 * var_x59));
        rJacobian[8][9] = -(mDt * (-0.71131126222840313 * var_x58));
        rJacobian[8][10] = -(mDt * (0));
        rJacobian[8][11] = -(mDt * (0));
        rJacobian[8][12] = -(mDt * (0));
        rJacobian[8][13] = -(mDt * (0));
        rJacobian[8][14] = -(mDt * (2.6005443647545077 * var_x61 + 6.5392697218681124e-9 * var_x62));
        rJacobian[9][0] = -(mDt * (0));
        rJacobian[9][1] = -(mDt * (0));
        rJacobian[9][2] = -(mDt * (0));
        rJacobian[9][3] = -(mDt * (0));
        ...
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (0.0013748261753415473 * var_x52 - 2.9196334076781144e-6 * var_x53));
        rJacobian[9][9] = 1.0 -(mDt * (-1.0126868767488654e-5 * var_x63 - 4.5129535692671587e-6 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x - 1.1825618784004642e-8 * var_x59 - 0.0048223184607088833 * var_x63 / var_x66 - 8.4390573062405468e-5 * var_x63 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 0.00036103628554137268 * var_x63 * var_x65 * (-26.713760659695652 * var_x64 + var_chaste_interface__membrane_potential__V) / pow(var_x66, 2)));
        rJacobian[9][10] = -(mDt * (0));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[9][12] = -(mDt * (0));
        rJacobian[9][13] = -(mDt * (0));
        rJacobian[9][14] = -(mDt * (0));
        rJacobian[10][0] = -(mDt * (-0.040714285714285717));
        rJacobian[10][1] = -(mDt * (-0.040714285714285717));
        ...
        rJacobian[10][10] = 1.0 -(mDt * (-0.040714285714285717 + var_x68));
        rJacobian[10][11] = -(mDt * (-0.00071428571428571494));
        rJacobian[10][12] = -(mDt * (-0.040714285714285717));
        rJacobian[10][13] = -(mDt * (-var_x70));
        ...
        rJacobian[11][11] = 1.0 -(mDt * (-0.070000000000000007));
        rJacobian[11][12] = -(mDt * (0.040714285714285717));
        rJacobian[11][13] = -(mDt * (var_x70));
        rJacobian[11][14] = -(mDt * (0));
        rJacobian[12][0] = -(mDt * (0.081428571428571433 + var_x68));
        rJacobian[12][1] = -(mDt * (var_x68));
        ...
        rJacobian[12][10] = -(mDt * (var_x68));
        rJacobian[12][11] = -(mDt * (0.029999999999999999 + var_x68));
        rJacobian[12][12] = 1.0 -(mDt * (-0.18071428571428572 + var_x68));
        rJacobian[12][13] = -(mDt * (var_x69 * (1.0 - var_chaste_interface__Force__N_0 - var_chaste_interface__Force__P_0 - var_chaste_interface__Force__P_1 - var_chaste_interface__Force__P_2 - var_chaste_interface__Force__P_3)));
        rJacobian[12][14] = -(mDt * (0));
        rJacobian[13][0] = -(mDt * (var_x71));
        rJacobian[13][1] = -(mDt * (var_x72));
        ...
        rJacobian[13][10] = -(mDt * (var_x73));
        rJacobian[13][11] = -(mDt * (var_x73));
        rJacobian[13][12] = -(mDt * (0));
        rJacobian[13][13] = 1.0 -(mDt * (-0.11951951951951952 + var_x74 + var_x75 - var_x76 - var_x77 - var_x78));
        rJacobian[13][14] = -(mDt * (5.6000000000000005 - var_x79));
        rJacobian[14][0] = -(mDt * (var_x73));
        rJacobian[14][1] = -(mDt * (-var_x72));
        rJacobian[14][2] = -(mDt * (var_x81 - 0.10203913679590344 * var_x8));
        rJacobian[14][3] = -(mDt * (-5069.4444444444443 * var_x12));
        rJacobian[14][4] = -(mDt * (var_x82 + 0.00029074955383700184 * var_x14 + 2.4671029149315891e-18 * var_x17));
        rJacobian[14][5] = -(mDt * (0.5 + var_x22));
        rJacobian[14][6] = -(mDt * (0));
        rJacobian[14][7] = -(mDt * (var_x18 * var_x81));
        rJacobian[14][8] = -(mDt * (1.8954404990922067e-6 * var_x57));
        rJacobian[14][9] = -(mDt * (0));
        rJacobian[14][10] = -(mDt * (var_x71));
        rJacobian[14][11] = -(mDt * (var_x71));
        rJacobian[14][12] = -(mDt * (0));
        rJacobian[14][13] = -(mDt * (0.11951951951951952 + var_x76 + var_x77 + var_x78 - var_x74 - var_x75));
        rJacobian[14][14] = 1.0 -(mDt * (-5.8000000000000007 + var_x23 + var_x79 - var_x82 + 1.1520000000000001e-10 * var_x21 - 1.0548821632800683e-6 / var_chaste_interface__intracellular_calcium_concentration__Ca_i - 0.86684812158483582 * var_x61 - 2.1797565739560378e-9 * var_x62 - 10138.888888888889 * var_x20 - 1.1825618784004641e-5 * var_x39 * var_x40));
    }
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[7] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((((fabs(19.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (0.35999999999999999) : (-1.71 / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane_potential__V)) - 0.089999999999999997 * var_chaste_interface__membrane_potential__V / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane_potential__V))))) * mDt)) / (1.0 - ((((fabs(19.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (-0.71999999999999997) : (0.68400000000000005 / (1.0 - exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V)) - 1.71 / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane_potential__V)) + 0.036000000000000004 * var_chaste_interface__membrane_potential__V / (1.0 - exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane_potential__V)) - 0.089999999999999997 * var_chaste_interface__membrane_potential__V / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane_potential__V))))) * mDt));
        rY[8] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((((fabs(34.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (0.012500000000000001) : (0.10625 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane_potential__V)) + 0.0031250000000000002 * var_chaste_interface__membrane_potential__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane_potential__V))))) * mDt)) / (1.0 - ((((fabs(34.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (-0.012500000000000001 - 0.025000000000000001 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane_potential__V))) : (-0.025000000000000001 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane_potential__V)) - 0.10625 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane_potential__V)) - 0.0031250000000000002 * var_chaste_interface__membrane_potential__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane_potential__V))))) * mDt));
        rY[3] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((0.40000000000000002 * pow(exp(-9.375 - 0.125 * var_chaste_interface__membrane_potential__V), 2) / (20.0 * exp(-9.375 - 0.125 * var_chaste_interface__membrane_potential__V) + 2000.0 / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V))) + 40.0 * exp(-9.375 - 0.125 * var_chaste_interface__membrane_potential__V) / (20.0 * exp(-9.375 - 0.125 * var_chaste_interface__membrane_potential__V) + 2000.0 / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V)) + 6400.0 * exp(-9.375 - 0.125 * var_chaste_interface__membrane_potential__V) * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V) + 640000.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V) / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V)))) * mDt)) / (1.0 - ((-0.02 * exp(-9.375 - 0.125 * var_chaste_interface__membrane_potential__V) - 2.0 / (1.0 + 320.0 * exp(-7.5 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V))) * mDt));
        rY[2] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((((fabs(41.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (2.0) : (-8.1999999999999993 / (-1.0 + exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V)) - 0.20000000000000001 * var_chaste_interface__membrane_potential__V / (-1.0 + exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V))))) * mDt)) / (1.0 - ((((fabs(41.0 + var_chaste_interface__membrane_potential__V) < 1.0000000000000001e-5) ? (-2.0 - 8.0 * exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane_potential__V)) : (-8.1999999999999993 / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V)) - 8.0 * exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane_potential__V) - 0.20000000000000001 * var_chaste_interface__membrane_potential__V / (1.0 - exp(-4.1000000000000005 - 0.10000000000000001 * var_chaste_interface__membrane_potential__V))))) * mDt));
        rY[4] = (var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x + ((0.00050000000000000001 * exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane_potential__V))) * mDt)) / (1.0 - ((-0.00050000000000000001 * exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane_potential__V)) - 0.0013000000000000002 * exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane_potential__V) / (1.0 + exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane_potential__V))) * mDt));
        ...
        rY[5] = (var_chaste_interface__transient_outward_current_s_gate__s + ((3.3000000000000003e-5 * exp(-0.058823529411764705 * var_chaste_interface__membrane_potential__V)) * mDt)) / (1.0 - ((-0.033000000000000002 / (1.0 + exp(-1.25 - 0.125 * var_chaste_interface__membrane_potential__V)) - 3.3000000000000003e-5 * exp(-0.058823529411764705 * var_chaste_interface__membrane_potential__V)) * mDt));
