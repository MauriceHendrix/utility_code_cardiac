...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliyer_model_2004FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rJacobian[65][65])
    {
        ...
        const double var_x3 = pow(var_x2, (-2.0));
        ...
        const double var_x19 = 1.0 + 0.00011900000000000002 * pow(var_x18, (-2.0));
        const double var_x20 = 1 / var_x19;
        const double var_x21 = 1.0 * var_x20;
        const double var_x22 = exp(0.074874401101778759 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x23 = (-0.68200000000000005 + 0.001 * var_x22) * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V / (-1.0 + var_x22);
        const double var_x24 = 16.54232713906077 * var_x23 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        const double var_x25 = var_x21 * (240.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR - 240.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS);
        const double var_x26 = 0.0023800000000000002 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x27 = 1.0 + 0.00011900000000000002 * pow(var_x26, (-2.0));
        const double var_x28 = 1 / var_x27;
        const double var_x29 = 1.0 * var_x28;
        const double var_x30 = 0.00050000000000000001 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x31 = 1.5379617895699322e-6 / var_x30;
        const double var_x32 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x33 = exp(-0.024334180358078095 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x34 = 1 / (1.0 + 0.20000000000000001 * var_x33);
        ...
        const double var_x37 = 2.8000000000000003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai;
        const double var_x38 = var_x34 * var_x36 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 2.0);
        const double var_x39 = exp(0.0076854803100000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x40 = 7.3600965821599997 * var_x39;
        const double var_x41 = exp(-0.077933781739999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x42 = 0.010817483399999999 * var_x41;
        const double var_x43 = 5.5200724366199996 * var_x39;
        const double var_x44 = 0.021634966799999999 * var_x41;
        const double var_x45 = 3.6800482910799999 * var_x39;
        const double var_x46 = 0.032452450199999996 * var_x41;
        const double var_x47 = 1.8400241455399999 * var_x39;
        const double var_x48 = 0.043269933599999998 * var_x41;
        const double var_x49 = 7.4298590445392074 * var_x39;
        const double var_x50 = 0.020618446856331008 * var_x41;
        const double var_x51 = 6.4033407827395079 * var_x39;
        const double var_x52 = 0.00064791916666788224 * var_x41;
        const double var_x53 = 2.0082338973371909 * var_x39;
        const double var_x54 = 0.00060572898292340319 * var_x41;
        const double var_x55 = 6.1053726595326019 * var_x39;
        const double var_x56 = 0.00074179401705723523 * var_x41;
        const double var_x57 = exp(0.028982999999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x58 = 2.1748319999999999 * var_x57;
        const double var_x59 = exp(5.3739999999999997e-8 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x60 = 0.00081948199999999996 * var_x59;
        const double var_x61 = exp(-0.046843700000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x62 = 0.080185000000000006 * var_x61;
        const double var_x63 = exp(-0.00037301599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x64 = 0.049842400000000002 * var_x63;
        const double var_x65 = 1.6311239999999998 * var_x57;
        const double var_x66 = 0.0015517711151999999 * var_x59;
        const double var_x67 = 0.16037000000000001 * var_x61;
        const double var_x68 = 0.0073584627104531205 * var_x63;
        const double var_x69 = 1.0874159999999999 * var_x57;
        const double var_x70 = 0.011656842546537791 * var_x59;
        const double var_x71 = 0.24055500000000002 * var_x61;
        const double var_x72 = 0.0031906751727717496 * var_x63;
        const double var_x73 = 0.54370799999999997 * var_x57;
        const double var_x74 = 0.12994884875097448 * var_x59;
        const double var_x75 = 0.0017334521172801731 * var_x63;
        const double var_x76 = 0.32074000000000003 * var_x61;
        const double var_x77 = 14.731181055359999 * var_x57;
        const double var_x78 = 0.042345268272074361 * var_x61;
        const double var_x79 = 3.7617634137599998 * var_x57;
        const double var_x80 = 0.021348622729620501 * var_x61;
        const double var_x81 = 2.0015500855706554 * var_x57;
        const double var_x82 = 0.021578581001175438 * var_x61;
        const double var_x83 = 9.9194413744637924 * var_x57;
        const double var_x84 = 0.35582999726621212 * var_x61;
        const double var_x85 = 9.5014602960251466e-5 * var_x63;
        const double var_x86 = 0.11713400800552819 * var_x59;
        const double var_x87 = 0.055397999999999996 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C0;
        const double var_x88 = 0.055397999999999996 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x89 = exp(-0.41999999999999998 + 0.012 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x90 = 7.9871999999999996 * var_x89;
        const double var_x91 = -var_x90;
        const double var_x92 = exp(1.4300000000000002 - 0.065000000000000002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x93 = 0.088200000000000001 * var_x92;
        const double var_x94 = 0.11079599999999999 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C1;
        const double var_x95 = 5.9903999999999993 * var_x89;
        const double var_x96 = 0.11079599999999999 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x97 = -var_x93;
        const double var_x98 = 0.1764 * var_x92;
        const double var_x99 = 0.22159199999999998 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C2;
        const double var_x100 = 0.22159199999999998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x101 = -var_x98;
        const double var_x102 = 3.9935999999999998 * var_x89;
        const double var_x103 = -var_x102;
        const double var_x104 = 0.2646 * var_x92;
        const double var_x105 = 0.44318399999999997 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C3;
        const double var_x106 = 0.44318399999999997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x107 = 1.9967999999999999 * var_x89;
        const double var_x108 = 0.3528 * var_x92;
        const double var_x109 = 0.88636799999999993 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__C4;
        const double var_x110 = 0.88636799999999993 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS;
        const double var_x111 = 15.974399999999999 * var_x89;
        const double var_x112 = 0.0441 * var_x92;
        const double var_x113 = 11.980799999999999 * var_x89;
        const double var_x114 = 0.1323 * var_x92;
        const double var_x115 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 3.0);
        const double var_x116 = 48600000000.0 * var_x115 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x117 = 12150000000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x118 = 12150000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 2.0) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
        const double var_x119 = 4050000.0 * var_x115;
        const double var_x120 = 0.091225454037165171 * exp(0.033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x121 = 0.21116826991639448 * exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x122 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x123 = 0.10945626585855089 * var_x122;
        const double var_x124 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x125 = 0.00042769471831999382 * var_x124;
        const double var_x126 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x127 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x128 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x129 = 1.6926962184371784e-6 * var_x124 * var_x127 * var_x128 / (var_x122 * var_x126);
        const double var_x130 = 0.0071483033566472664 * var_x128;
        const double var_x131 = 0.034388156021070745 * var_x127;
        const double var_x132 = 0.56744803744318484 * var_x126;
        const double var_x133 = 0.21625575895849999 * exp(-1.8891230210000001e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x134 = 0.0070080662892900002 * exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x135 = 0.00767254363063 * exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x136 = 0.0037973799836799999 * exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x137 = 8513540195.0827656 * exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x138 = 8513540195.0827656 * exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x139 = 8513540195.0827656 * exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x140 = 8513540195.0827656 * exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x141 = exp(0.03743720055088938 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x142 = var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V / (-1.0 + var_x141);
        const double var_x143 = 1.8494079065353104e-10 * var_x142;
        const double var_x144 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai;
        const double var_x145 = var_x141 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv1_4_CHANNEL_STATES__OKv14;
        const double var_x146 = pow(var_x144, 1.5);
        const double var_x147 = var_x144 * var_x146 / (pow((0.011180339887498949 + var_x146), 2) * (1.0 + 0.1245 * exp(-0.003743720055088938 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0505200594353643)) * exp(-0.049791476732682874 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V)));
        const double var_x148 = 0.092547526753060952 * log(138.0 * var_x144) - 0.0034647203195431429 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x149 = exp(-23.156677820503301);
        const double var_x150 = 8513540195.0827656 * var_x149;
        const double var_x151 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x152 = 34054160780.331062 * var_x151;
        const double var_x153 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x154 = 8513540195.0827656 * var_x153;
        const double var_x155 = exp(-24.35183300086069);
        const double var_x156 = 8513540195.0827656 * var_x155;
        const double var_x157 = 8513540195.0827656 * exp(-26.650781465416159);
        const double var_x158 = 8513540195.0827656 * exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x159 = 8513540195.0827656 * exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x160 = 8513540195.0827656 * exp(-22.779658962607588);
        const double var_x161 = 11922585210.267752 * var_x149;
        const double var_x162 = 25540620585.248295 * var_x151;
        const double var_x163 = 17027080390.165531 * var_x153;
        const double var_x164 = 6079249204.347868 * var_x155;
        const double var_x165 = 4340999166.2352047 * var_x155;
        const double var_x166 = 23845170420.535503 * var_x151;
        const double var_x167 = 12158498408.695736 * var_x153;
        const double var_x168 = 16696701353.239271 * var_x149;
        const double var_x169 = 18237747613.043602 * var_x153;
        const double var_x170 = 35767755630.803253 * var_x151;
        const double var_x171 = 17027080390.165531 * var_x151;
        const double var_x172 = 25540620585.248295 * var_x153;
        const double var_x173 = 11922585210.267752 * var_x151;
        const double var_x174 = 3099769910.3661275 * var_x155;
        const double var_x175 = 23382498943.197018 * var_x149;
        const double var_x176 = 24316996817.391472 * var_x153;
        const double var_x177 = 8513540195.0827656 * var_x151;
        const double var_x178 = 34054160780.331062 * var_x153;
        const double var_x179 = 2213447441.3051791 * var_x155;
        const double var_x180 = 32745465422.278648 * var_x149;
        const double var_x181 = 47690340841.071007 * var_x151;
        const double var_x182 = 6079249204.347868 * var_x153;
        const double var_x183 = 8513540195.0827656 * exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x184 = 8513540195.0827656 * exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x185 = var_x142 * (-4.0 + var_x141 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki);
        const double var_x186 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Ki;
        const double var_x187 = log(4.0 * var_x186);
        const double var_x188 = 7.1159095070575419e-7 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__yCa;
        const double var_x189 = var_x185 * var_x188;
        const double var_x190 = 24.975247492871414 * var_x23 >= 0.0;
        const double var_x191 = 1 / (1.0 - 94.246216954231741 * var_x23);
        const double var_x192 = 5.7513555333045694e-6 * var_x187 - 2.1531465053979051e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V;
        const double var_x193 = var_x141 * var_x142 * var_x188 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open;
        const double var_x194 = exp(0.047170872694120618 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - 1.26 * var_x187);
        const double var_x195 = 0.93999999999999995 + var_x194;
        const double var_x196 = -0.00012738562343605624 * var_x186 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_Kv4_3_CHANNEL_STATES__OKv43 - 3.0564346548418563e-5 * var_x186 * var_chaste_interface__IKr__OHerg - 9.2470395326765519e-9 * var_x142 * var_x145 - 5.7513555333045694e-6 * var_x186 * (var_chaste_interface__IKs__O1ks + var_chaste_interface__IKs__O2ks) - 0.00041181390311704753 * var_x186 / var_x195 + 1.9425621197603171e-5 * var_x186 * var_x194 * (-26.71139896373057 * var_x187 + var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V) / pow(var_x195, 2);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (var_x5 * (-1.7400382808421786 - var_x0 - var_x1) + 0.16666666666666666 * pow(var_x2, (-3.0)) * (1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaNSR - 1.8 * var_x6 - 1.7400382808421786 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR) / pow((0.083333333333333329 + var_x3), 2)));
        ...
        rJacobian[0][37] = -(mDt * (var_x7));
        rJacobian[0][38] = -(mDt * (var_x7));
        ...
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (var_x21 * (-806.49188514357058 - var_x16 - var_x17) + 0.00023800000000000004 * pow(var_x18, (-3.0)) * (806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai + 240.0 * var_x6 - 806.49188514357058 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - var_x24 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_LTYPE_CHANNEL_STATES__Open) / pow(var_x19, 2)));
        ...
        rJacobian[2][34] = -(mDt * (-var_x20 * var_x24));
        rJacobian[2][35] = -(mDt * (0));
        rJacobian[2][36] = -(mDt * (0));
        rJacobian[2][37] = -(mDt * (var_x25));
        rJacobian[2][38] = -(mDt * (var_x25));
        ...
        rJacobian[3][0] = -(mDt * (0));
        rJacobian[3][1] = -(mDt * (var_x29 * (3.1822011198770807e-10 * var_x12 + 0.00011598784194528874 * var_x10)));
        rJacobian[3][2] = -(mDt * (0.037453183520599252 * var_x28));
        rJacobian[3][3] = 1.0 -(mDt * (var_x29 * (-5.6374531835205994 - var_x31 + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 2.8000000000000003 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 4.2533745697546539e-5 * var_x15 - 0.03190795213912849 * var_x35 - 3.1566725655651652e-8 * var_x32 - 3.6466405075851775 * var_x14 + 1.5379617895699322e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai / pow(var_x30, 2)) + 0.00023800000000000004 * pow(var_x26, (-3.0)) * (0.0028000000000000004 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa + 9.2400000000000013e-6 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa + 3.1566725655651652e-8 * log(2.0 * var_x32) + 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS - 0.037453183520599252 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - 2.3635396782110715e-9 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V - var_x31 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai - var_x37 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa) - var_x37 * (1.0 - var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa) + 1.2141201663854144e-8 * var_x34 * (2.0 * var_x36 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai, 3.0) - 2628072.0 * var_x33 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai) - 1.2 * var_x10 * var_x11) / pow(var_x27, 2)));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        ...
        rJacobian[3][39] = -(mDt * (var_x29 * (9.2400000000000013e-6 + var_x37)));
        rJacobian[3][40] = -(mDt * (var_x29 * (0.0028000000000000004 + var_x37)));
        ...
        rJacobian[3][51] = -(mDt * (7.2847209983124865e-8 * var_x28 * var_x38));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-2.44936e-6 - var_x40));
        rJacobian[4][5] = -(mDt * (var_x42));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0.00305767916));
        rJacobian[4][9] = -(mDt * (0));
        ...
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (var_x40));
        rJacobian[5][5] = 1.0 -(mDt * (-1.2850585364284256e-6 - var_x42 - var_x43));
        rJacobian[5][6] = -(mDt * (var_x44));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0.0030289691634726814));
        ...
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (var_x43));
        rJacobian[6][6] = 1.0 -(mDt * (-4.290998044504021e-5 - var_x44 - var_x45));
        rJacobian[6][7] = -(mDt * (var_x46));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        rJacobian[6][10] = -(mDt * (0.0026111571690401588));
        ...
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (var_x45));
        rJacobian[7][7] = 1.0 -(mDt * (-0.0022989390350036006 - var_x46 - var_x47));
        rJacobian[7][8] = -(mDt * (0));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (0.0047848930796401661));
        rJacobian[7][12] = -(mDt * (0));
        rJacobian[7][13] = -(mDt * (var_x48));
        ...
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (2.44936e-6));
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0));
        rJacobian[8][8] = 1.0 -(mDt * (-0.00305767916 - var_x49));
        rJacobian[8][9] = -(mDt * (var_x50));
        ...
        rJacobian[9][3] = -(mDt * (0));
        rJacobian[9][4] = -(mDt * (0));
        rJacobian[9][5] = -(mDt * (1.2850585364284256e-6));
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (var_x49));
        rJacobian[9][9] = 1.0 -(mDt * (-0.0030289691634726814 - var_x50 - var_x51));
        rJacobian[9][10] = -(mDt * (var_x52));
        ...
        rJacobian[10][6] = -(mDt * (4.290998044504021e-5));
        rJacobian[10][7] = -(mDt * (0));
        rJacobian[10][8] = -(mDt * (0));
        rJacobian[10][9] = -(mDt * (var_x51));
        rJacobian[10][10] = 1.0 -(mDt * (-0.0026111571690401588 - var_x52 - var_x53));
        rJacobian[10][11] = -(mDt * (var_x54));
        ...
        rJacobian[11][7] = -(mDt * (0.0022989390350036006));
        rJacobian[11][8] = -(mDt * (0));
        rJacobian[11][9] = -(mDt * (0));
        rJacobian[11][10] = -(mDt * (var_x53));
        rJacobian[11][11] = 1.0 -(mDt * (-0.0047848930796401661 - var_x54 - var_x55));
        rJacobian[11][12] = -(mDt * (var_x56));
        ...
        rJacobian[12][11] = -(mDt * (var_x55));
        rJacobian[12][12] = 1.0 -(mDt * (-0.0014420608358145942 - var_x56));
        rJacobian[12][13] = -(mDt * (0.1341004876120194));
        ...
        rJacobian[13][7] = -(mDt * (var_x47));
        rJacobian[13][8] = -(mDt * (0));
        rJacobian[13][9] = -(mDt * (0));
        rJacobian[13][10] = -(mDt * (0));
        rJacobian[13][11] = -(mDt * (0));
        rJacobian[13][12] = -(mDt * (0.0014420608358145942));
        rJacobian[13][13] = 1.0 -(mDt * (-0.1341004876120194 - var_x48));
        ...
        rJacobian[14][14] = 1.0 -(mDt * (-var_x58 - var_x60));
        rJacobian[14][15] = -(mDt * (var_x62));
        rJacobian[14][16] = -(mDt * (0));
        rJacobian[14][17] = -(mDt * (0));
        rJacobian[14][18] = -(mDt * (var_x64));
        ...
        rJacobian[15][14] = -(mDt * (var_x58));
        rJacobian[15][15] = 1.0 -(mDt * (-var_x62 - var_x65 - var_x66));
        rJacobian[15][16] = -(mDt * (var_x67));
        rJacobian[15][17] = -(mDt * (0));
        rJacobian[15][18] = -(mDt * (0));
        rJacobian[15][19] = -(mDt * (var_x68));
        ...
        rJacobian[16][15] = -(mDt * (var_x65));
        rJacobian[16][16] = 1.0 -(mDt * (-var_x67 - var_x69 - var_x70));
        rJacobian[16][17] = -(mDt * (var_x71));
        rJacobian[16][18] = -(mDt * (0));
        rJacobian[16][19] = -(mDt * (0));
        rJacobian[16][20] = -(mDt * (var_x72));
        ...
        rJacobian[17][16] = -(mDt * (var_x69));
        rJacobian[17][17] = 1.0 -(mDt * (-var_x71 - var_x73 - var_x74));
        rJacobian[17][18] = -(mDt * (0));
        rJacobian[17][19] = -(mDt * (0));
        rJacobian[17][20] = -(mDt * (0));
        rJacobian[17][21] = -(mDt * (var_x75));
        rJacobian[17][22] = -(mDt * (0));
        rJacobian[17][23] = -(mDt * (var_x76));
        ...
        rJacobian[18][14] = -(mDt * (var_x60));
        rJacobian[18][15] = -(mDt * (0));
        rJacobian[18][16] = -(mDt * (0));
        rJacobian[18][17] = -(mDt * (0));
        rJacobian[18][18] = 1.0 -(mDt * (-var_x64 - var_x77));
        rJacobian[18][19] = -(mDt * (var_x78));
        ...
        rJacobian[19][15] = -(mDt * (var_x66));
        rJacobian[19][16] = -(mDt * (0));
        rJacobian[19][17] = -(mDt * (0));
        rJacobian[19][18] = -(mDt * (var_x77));
        rJacobian[19][19] = 1.0 -(mDt * (-var_x68 - var_x78 - var_x79));
        rJacobian[19][20] = -(mDt * (var_x80));
        ...
        rJacobian[20][16] = -(mDt * (var_x70));
        rJacobian[20][17] = -(mDt * (0));
        rJacobian[20][18] = -(mDt * (0));
        rJacobian[20][19] = -(mDt * (var_x79));
        rJacobian[20][20] = 1.0 -(mDt * (-var_x72 - var_x80 - var_x81));
        rJacobian[20][21] = -(mDt * (var_x82));
        ...
        rJacobian[21][17] = -(mDt * (var_x74));
        rJacobian[21][18] = -(mDt * (0));
        rJacobian[21][19] = -(mDt * (0));
        rJacobian[21][20] = -(mDt * (var_x81));
        rJacobian[21][21] = 1.0 -(mDt * (-var_x75 - var_x82 - var_x83));
        rJacobian[21][22] = -(mDt * (var_x84));
        ...
        rJacobian[22][21] = -(mDt * (var_x83));
        rJacobian[22][22] = 1.0 -(mDt * (-var_x84 - var_x85));
        rJacobian[22][23] = -(mDt * (var_x86));
        ...
        rJacobian[23][17] = -(mDt * (var_x73));
        rJacobian[23][18] = -(mDt * (0));
        rJacobian[23][19] = -(mDt * (0));
        rJacobian[23][20] = -(mDt * (0));
        rJacobian[23][21] = -(mDt * (0));
        rJacobian[23][22] = -(mDt * (var_x85));
        rJacobian[23][23] = 1.0 -(mDt * (-var_x76 - var_x86));
        ...
        rJacobian[24][24] = 1.0 -(mDt * (var_x91 - var_x88));
        rJacobian[24][25] = -(mDt * (var_x93));
        rJacobian[24][26] = -(mDt * (0));
        rJacobian[24][27] = -(mDt * (0));
        rJacobian[24][28] = -(mDt * (0));
        rJacobian[24][29] = -(mDt * (0.0025000000000000001));
        ...
        rJacobian[25][24] = -(mDt * (var_x90));
        rJacobian[25][25] = 1.0 -(mDt * (var_x97 - var_x95 - var_x96));
        rJacobian[25][26] = -(mDt * (var_x98));
        rJacobian[25][27] = -(mDt * (0));
        rJacobian[25][28] = -(mDt * (0));
        rJacobian[25][29] = -(mDt * (0));
        rJacobian[25][30] = -(mDt * (0.00125));
        ...
        rJacobian[26][25] = -(mDt * (var_x95));
        rJacobian[26][26] = 1.0 -(mDt * (var_x101 + var_x103 - var_x100));
        rJacobian[26][27] = -(mDt * (var_x104));
        rJacobian[26][28] = -(mDt * (0));
        rJacobian[26][29] = -(mDt * (0));
        rJacobian[26][30] = -(mDt * (0));
        rJacobian[26][31] = -(mDt * (0.00062500000000000001));
        ...
        rJacobian[27][26] = -(mDt * (var_x102));
        rJacobian[27][27] = 1.0 -(mDt * (-var_x104 - var_x106 - var_x107));
        rJacobian[27][28] = -(mDt * (var_x108));
        rJacobian[27][29] = -(mDt * (0));
        rJacobian[27][30] = -(mDt * (0));
        rJacobian[27][31] = -(mDt * (0));
        rJacobian[27][32] = -(mDt * (0.00031250000000000001));
        ...
        rJacobian[28][27] = -(mDt * (var_x107));
        rJacobian[28][28] = 1.0 -(mDt * (-0.29999999999999999 - var_x108 - var_x110));
        rJacobian[28][29] = -(mDt * (0));
        rJacobian[28][30] = -(mDt * (0));
        rJacobian[28][31] = -(mDt * (0));
        rJacobian[28][32] = -(mDt * (0));
        rJacobian[28][33] = -(mDt * (0.00015625));
        rJacobian[28][34] = -(mDt * (4.0));
        ...
        rJacobian[29][24] = -(mDt * (var_x88));
        rJacobian[29][25] = -(mDt * (0));
        rJacobian[29][26] = -(mDt * (0));
        rJacobian[29][27] = -(mDt * (0));
        rJacobian[29][28] = -(mDt * (0));
        rJacobian[29][29] = 1.0 -(mDt * (-0.0025000000000000001 - var_x111));
        rJacobian[29][30] = -(mDt * (var_x112));
        ...
        rJacobian[30][25] = -(mDt * (var_x96));
        rJacobian[30][26] = -(mDt * (0));
        rJacobian[30][27] = -(mDt * (0));
        rJacobian[30][28] = -(mDt * (0));
        rJacobian[30][29] = -(mDt * (var_x111));
        rJacobian[30][30] = 1.0 -(mDt * (-0.00125 - var_x112 - var_x113));
        rJacobian[30][31] = -(mDt * (var_x93));
        ...
        rJacobian[31][26] = -(mDt * (var_x100));
        rJacobian[31][27] = -(mDt * (0));
        rJacobian[31][28] = -(mDt * (0));
        rJacobian[31][29] = -(mDt * (0));
        rJacobian[31][30] = -(mDt * (var_x113));
        rJacobian[31][31] = 1.0 -(mDt * (-0.00062500000000000001 + var_x91 + var_x97));
        rJacobian[31][32] = -(mDt * (var_x114));
        ...
        rJacobian[32][27] = -(mDt * (var_x106));
        rJacobian[32][28] = -(mDt * (0));
        rJacobian[32][29] = -(mDt * (0));
        rJacobian[32][30] = -(mDt * (0));
        rJacobian[32][31] = -(mDt * (var_x90));
        rJacobian[32][32] = 1.0 -(mDt * (-0.00031250000000000001 + var_x103 - var_x114));
        rJacobian[32][33] = -(mDt * (var_x98));
        ...
        rJacobian[33][28] = -(mDt * (var_x110));
        rJacobian[33][29] = -(mDt * (0));
        rJacobian[33][30] = -(mDt * (0));
        rJacobian[33][31] = -(mDt * (0));
        rJacobian[33][32] = -(mDt * (var_x102));
        rJacobian[33][33] = 1.0 -(mDt * (-0.00015625 + var_x101));
        rJacobian[33][34] = -(mDt * (0));
        ...
        rJacobian[34][28] = -(mDt * (0.29999999999999999));
        rJacobian[34][29] = -(mDt * (0));
        rJacobian[34][30] = -(mDt * (0));
        rJacobian[34][31] = -(mDt * (0));
        rJacobian[34][32] = -(mDt * (0));
        rJacobian[34][33] = -(mDt * (0));
        rJacobian[34][34] = 1.0 -(mDt * (-4.0));
        rJacobian[34][35] = -(mDt * (0));
        ...
        rJacobian[35][34] = -(mDt * (0));
        rJacobian[35][35] = 1.0 -(mDt * (-var_x117));
        rJacobian[35][36] = -(mDt * (0));
        rJacobian[35][37] = -(mDt * (0.57599999999999996));
        ...
        rJacobian[36][35] = -(mDt * (0));
        rJacobian[36][36] = 1.0 -(mDt * (-0.00080000000000000004));
        rJacobian[36][37] = -(mDt * (0.10000000000000001));
        ...
        rJacobian[37][2] = -(mDt * (var_x116 - var_x118));
        ...
        rJacobian[37][35] = -(mDt * (var_x117));
        rJacobian[37][36] = -(mDt * (0.00080000000000000004));
        rJacobian[37][37] = 1.0 -(mDt * (-0.67599999999999993 - var_x119));
        rJacobian[37][38] = -(mDt * (1.9299999999999999));
        ...
        rJacobian[38][37] = -(mDt * (var_x119));
        rJacobian[38][38] = 1.0 -(mDt * (-1.9299999999999999));
        rJacobian[38][39] = -(mDt * (0));
        ...
        rJacobian[39][3] = -(mDt * (20.0 - 20.0 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__HTRPNCa));
        ...
        rJacobian[39][38] = -(mDt * (0));
        rJacobian[39][39] = 1.0 -(mDt * (-6.6000000000000005e-5 - 20.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai));
        rJacobian[39][40] = -(mDt * (0));
        ...
        rJacobian[40][3] = -(mDt * (40.0 - 40.0 * var_chaste_interface__COMPUTE_Jtrpn_and_BUFFER_SCALE_FACTORS__LTRPNCa));
        ...
        rJacobian[40][39] = -(mDt * (0));
        rJacobian[40][40] = 1.0 -(mDt * (-0.040000000000000001 - 40.0 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Cai));
        rJacobian[40][41] = -(mDt * (0));
        ...
        rJacobian[41][40] = -(mDt * (0));
        rJacobian[41][41] = 1.0 -(mDt * (-var_x120));
        rJacobian[41][42] = -(mDt * (var_x121));
        ...
        rJacobian[42][41] = -(mDt * (var_x120));
        rJacobian[42][42] = 1.0 -(mDt * (-0.13876486073161204 - var_x121));
        rJacobian[42][43] = -(mDt * (0.78911443677844384));
        rJacobian[42][44] = -(mDt * (0));
        rJacobian[42][45] = -(mDt * (0));
        rJacobian[42][46] = -(mDt * (0));
        rJacobian[42][47] = -(mDt * (0));
        rJacobian[42][48] = -(mDt * (0));
        rJacobian[42][49] = -(mDt * (0));
        rJacobian[42][50] = -(mDt * (0));
        rJacobian[42][51] = -(mDt * (0));
        ...
        rJacobian[43][42] = -(mDt * (0.13876486073161204));
        rJacobian[43][43] = 1.0 -(mDt * (-0.78911443677844384 - var_x123 - var_x125));
        rJacobian[43][44] = -(mDt * (var_x129));
        rJacobian[43][45] = -(mDt * (var_x130));
        ...
        rJacobian[44][43] = -(mDt * (var_x125));
        rJacobian[44][44] = 1.0 -(mDt * (-var_x129 - var_x131));
        rJacobian[44][45] = -(mDt * (var_x132));
        rJacobian[44][46] = -(mDt * (0));
        rJacobian[44][47] = -(mDt * (0));
        rJacobian[44][48] = -(mDt * (0));
        rJacobian[44][49] = -(mDt * (0));
        rJacobian[44][50] = -(mDt * (0));
        rJacobian[44][51] = -(mDt * (0));
        rJacobian[44][52] = -(mDt * (0));
        ...
        rJacobian[45][42] = -(mDt * (0));
        rJacobian[45][43] = -(mDt * (var_x123));
        rJacobian[45][44] = -(mDt * (var_x131));
        rJacobian[45][45] = 1.0 -(mDt * (-var_x130 - var_x132));
        ...
        rJacobian[45][54] = -(mDt * (0));
        rJacobian[45][55] = -(mDt * (0));
        ...
        rJacobian[46][44] = -(mDt * (0));
        rJacobian[46][45] = -(mDt * (0));
        rJacobian[46][46] = 1.0 -(mDt * (-0.0079560079800399999));
        rJacobian[46][47] = -(mDt * (var_x133));
        rJacobian[46][48] = -(mDt * (0));
        rJacobian[46][49] = -(mDt * (0));
        rJacobian[46][50] = -(mDt * (0));
        rJacobian[46][51] = -(mDt * (0));
        rJacobian[46][52] = -(mDt * (0));
        rJacobian[46][53] = -(mDt * (0));
        ...
        rJacobian[47][46] = -(mDt * (0.0079560079800399999));
        rJacobian[47][47] = 1.0 -(mDt * (-0.039667206760709998 - var_x133));
        rJacobian[47][48] = -(mDt * (var_x134));
        rJacobian[47][49] = -(mDt * (0));
        rJacobian[47][50] = -(mDt * (0));
        rJacobian[47][51] = -(mDt * (0));
        rJacobian[47][52] = -(mDt * (0));
        rJacobian[47][53] = -(mDt * (0));
        ...
        rJacobian[48][46] = -(mDt * (0));
        rJacobian[48][47] = -(mDt * (0.039667206760709998));
        rJacobian[48][48] = 1.0 -(mDt * (-var_x134 - var_x135));
        rJacobian[48][49] = -(mDt * (var_x136));
        rJacobian[48][50] = -(mDt * (0));
        ...
        rJacobian[49][47] = -(mDt * (0));
        rJacobian[49][48] = -(mDt * (var_x135));
        rJacobian[49][49] = 1.0 -(mDt * (-var_x136));
        rJacobian[49][50] = -(mDt * (0));
        rJacobian[49][51] = -(mDt * (0));
        ...
        rJacobian[50][48] = -(mDt * (0));
        rJacobian[50][49] = -(mDt * (0));
        rJacobian[50][50] = 1.0 -(mDt * (-var_x137 - var_x138));
        rJacobian[50][51] = -(mDt * (0));
        rJacobian[50][52] = -(mDt * (0));
        rJacobian[50][53] = -(mDt * (var_x139));
        rJacobian[50][54] = -(mDt * (0));
        rJacobian[50][55] = -(mDt * (0));
        rJacobian[50][56] = -(mDt * (0));
        rJacobian[50][57] = -(mDt * (0));
        rJacobian[50][58] = -(mDt * (0));
        rJacobian[50][59] = -(mDt * (var_x140));
        ...
        rJacobian[51][3] = -(mDt * (0.095723856417385469 * var_x35));
        ...
        rJacobian[51][13] = -(mDt * (-var_x143 * (-138.0 + var_x141 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__Nai)));
        ...
        rJacobian[51][49] = -(mDt * (0));
        rJacobian[51][50] = -(mDt * (0));
        rJacobian[51][51] = 1.0 -(mDt * (-5.3730734579697901e-6 * var_x147 - 1.6432444380870198e-6 * var_x144 - 2.1854162994937459e-7 * var_x38 - var_x143 * var_x145 - 0.092547526753060952 * var_x144 * (var_chaste_interface__INa__na6 + var_chaste_interface__INa__na7)));
        rJacobian[51][52] = -(mDt * (0));
        rJacobian[51][53] = -(mDt * (var_x148));
        rJacobian[51][54] = -(mDt * (0));
        ...
        rJacobian[52][52] = 1.0 -(mDt * (-var_x150 - var_x152));
        rJacobian[52][53] = -(mDt * (0));
        rJacobian[52][54] = -(mDt * (var_x154));
        rJacobian[52][55] = -(mDt * (0));
        rJacobian[52][56] = -(mDt * (0));
        rJacobian[52][57] = -(mDt * (0));
        rJacobian[52][58] = -(mDt * (0));
        rJacobian[52][59] = -(mDt * (0));
        rJacobian[52][60] = -(mDt * (var_x156));
        ...
        rJacobian[53][46] = -(mDt * (0));
        rJacobian[53][47] = -(mDt * (0));
        rJacobian[53][48] = -(mDt * (0));
        rJacobian[53][49] = -(mDt * (0));
        rJacobian[53][50] = -(mDt * (var_x138));
        rJacobian[53][51] = -(mDt * (0));
        rJacobian[53][52] = -(mDt * (0));
        rJacobian[53][53] = 1.0 -(mDt * (-var_x139 - var_x157 - var_x158));
        ...
        rJacobian[53][62] = -(mDt * (var_x159));
        rJacobian[53][63] = -(mDt * (var_x160));
        ...
        rJacobian[54][45] = -(mDt * (0));
        rJacobian[54][46] = -(mDt * (0));
        rJacobian[54][47] = -(mDt * (0));
        rJacobian[54][48] = -(mDt * (0));
        rJacobian[54][49] = -(mDt * (0));
        rJacobian[54][50] = -(mDt * (0));
        rJacobian[54][51] = -(mDt * (0));
        rJacobian[54][52] = -(mDt * (var_x152));
        rJacobian[54][53] = -(mDt * (0));
        rJacobian[54][54] = 1.0 -(mDt * (-var_x154 - var_x161 - var_x162));
        rJacobian[54][55] = -(mDt * (0));
        rJacobian[54][56] = -(mDt * (var_x163));
        rJacobian[54][57] = -(mDt * (0));
        rJacobian[54][58] = -(mDt * (0));
        rJacobian[54][59] = -(mDt * (0));
        rJacobian[54][60] = -(mDt * (0));
        rJacobian[54][61] = -(mDt * (var_x164));
        ...
        rJacobian[55][54] = -(mDt * (0));
        rJacobian[55][55] = 1.0 -(mDt * (-var_x165 - var_x166 - var_x167));
        rJacobian[55][56] = -(mDt * (var_x168));
        rJacobian[55][57] = -(mDt * (var_x169));
        rJacobian[55][58] = -(mDt * (0));
        rJacobian[55][59] = -(mDt * (0));
        rJacobian[55][60] = -(mDt * (0));
        rJacobian[55][61] = -(mDt * (var_x170));
        ...
        rJacobian[56][54] = -(mDt * (var_x162));
        rJacobian[56][55] = -(mDt * (var_x165));
        rJacobian[56][56] = 1.0 -(mDt * (-var_x163 - var_x168 - var_x171));
        rJacobian[56][57] = -(mDt * (0));
        rJacobian[56][58] = -(mDt * (var_x172));
        rJacobian[56][59] = -(mDt * (0));
        ...
        rJacobian[57][55] = -(mDt * (var_x166));
        rJacobian[57][56] = -(mDt * (0));
        rJacobian[57][57] = 1.0 -(mDt * (-var_x169 - var_x173 - var_x174));
        rJacobian[57][58] = -(mDt * (var_x175));
        rJacobian[57][59] = -(mDt * (var_x176));
        rJacobian[57][60] = -(mDt * (0));
        rJacobian[57][61] = -(mDt * (0));
        rJacobian[57][62] = -(mDt * (0));
        ...
        rJacobian[58][56] = -(mDt * (var_x171));
        rJacobian[58][57] = -(mDt * (var_x174));
        rJacobian[58][58] = 1.0 -(mDt * (-var_x172 - var_x175 - var_x177));
        rJacobian[58][59] = -(mDt * (0));
        rJacobian[58][60] = -(mDt * (0));
        rJacobian[58][61] = -(mDt * (0));
        rJacobian[58][62] = -(mDt * (var_x178));
        ...
        rJacobian[59][50] = -(mDt * (var_x137));
        rJacobian[59][51] = -(mDt * (0));
        rJacobian[59][52] = -(mDt * (0));
        rJacobian[59][53] = -(mDt * (0));
        rJacobian[59][54] = -(mDt * (0));
        rJacobian[59][55] = -(mDt * (0));
        rJacobian[59][56] = -(mDt * (0));
        rJacobian[59][57] = -(mDt * (var_x173));
        rJacobian[59][58] = -(mDt * (0));
        rJacobian[59][59] = 1.0 -(mDt * (-var_x140 - var_x176 - var_x179));
        rJacobian[59][60] = -(mDt * (0));
        rJacobian[59][61] = -(mDt * (0));
        rJacobian[59][62] = -(mDt * (var_x180));
        ...
        rJacobian[60][59] = -(mDt * (0));
        rJacobian[60][60] = 1.0 -(mDt * (-var_x156 - var_x181));
        rJacobian[60][61] = -(mDt * (var_x182));
        rJacobian[60][62] = -(mDt * (0));
        ...
        rJacobian[61][54] = -(mDt * (var_x161));
        rJacobian[61][55] = -(mDt * (var_x167));
        rJacobian[61][56] = -(mDt * (0));
        rJacobian[61][57] = -(mDt * (0));
        rJacobian[61][58] = -(mDt * (0));
        rJacobian[61][59] = -(mDt * (0));
        rJacobian[61][60] = -(mDt * (var_x181));
        rJacobian[61][61] = 1.0 -(mDt * (-var_x164 - var_x170 - var_x182));
        rJacobian[61][62] = -(mDt * (0));
        rJacobian[61][63] = -(mDt * (0));
        ...
        rJacobian[62][53] = -(mDt * (var_x158));
        rJacobian[62][54] = -(mDt * (0));
        rJacobian[62][55] = -(mDt * (0));
        rJacobian[62][56] = -(mDt * (0));
        rJacobian[62][57] = -(mDt * (0));
        rJacobian[62][58] = -(mDt * (var_x177));
        rJacobian[62][59] = -(mDt * (var_x179));
        rJacobian[62][60] = -(mDt * (0));
        rJacobian[62][61] = -(mDt * (0));
        rJacobian[62][62] = 1.0 -(mDt * (-var_x159 - var_x178 - var_x180 - var_x183));
        rJacobian[62][63] = -(mDt * (var_x184));
        ...
        rJacobian[63][31] = -(mDt * (0));
        rJacobian[63][32] = -(mDt * (0));
        ...
        rJacobian[63][61] = -(mDt * (0));
        rJacobian[63][62] = -(mDt * (var_x183));
        rJacobian[63][63] = 1.0 -(mDt * (-var_x160 - var_x184));
        ...
        rJacobian[64][9] = -(mDt * (0));
        rJacobian[64][10] = -(mDt * (0));
        rJacobian[64][11] = -(mDt * (0));
        rJacobian[64][12] = -(mDt * (0));
        rJacobian[64][13] = -(mDt * (-9.2470395326765519e-9 * var_x185));
        rJacobian[64][14] = -(mDt * (0));
        rJacobian[64][15] = -(mDt * (0));
        rJacobian[64][16] = -(mDt * (0));
        rJacobian[64][17] = -(mDt * (0));
        rJacobian[64][18] = -(mDt * (0));
        rJacobian[64][19] = -(mDt * (0));
        rJacobian[64][20] = -(mDt * (0));
        rJacobian[64][21] = -(mDt * (0));
        rJacobian[64][22] = -(mDt * (0));
        rJacobian[64][23] = -(mDt * (0.00012738562343605624 * var_x187 - 4.7689611318757119e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V));
        ...
        rJacobian[64][30] = -(mDt * (0));
        rJacobian[64][31] = -(mDt * (0));
        rJacobian[64][32] = -(mDt * (0));
        rJacobian[64][33] = -(mDt * (0));
        rJacobian[64][34] = -(mDt * (((var_x190) ? (-var_x189) : (-var_x189 * var_x191))));
        rJacobian[64][35] = -(mDt * (0));
        rJacobian[64][36] = -(mDt * (0));
        rJacobian[64][37] = -(mDt * (0));
        rJacobian[64][38] = -(mDt * (0));
        rJacobian[64][39] = -(mDt * (0));
        rJacobian[64][40] = -(mDt * (0));
        rJacobian[64][41] = -(mDt * (0));
        rJacobian[64][42] = -(mDt * (0));
        rJacobian[64][43] = -(mDt * (0));
        rJacobian[64][44] = -(mDt * (0));
        rJacobian[64][45] = -(mDt * (3.0564346548418563e-5 * var_x187 - 1.1442435714400293e-6 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V));
        rJacobian[64][46] = -(mDt * (0));
        rJacobian[64][47] = -(mDt * (0));
        rJacobian[64][48] = -(mDt * (var_x192));
        rJacobian[64][49] = -(mDt * (var_x192));
        rJacobian[64][50] = -(mDt * (0));
        rJacobian[64][51] = -(mDt * (3.58204897197986e-6 * var_x147));
        ...
        rJacobian[64][64] = 1.0 -(mDt * (((var_x190) ? (var_x196 - var_x193) : (var_x196 - var_x191 * var_x193))));
    }
