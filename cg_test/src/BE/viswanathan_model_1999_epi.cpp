...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        double var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 = rY[11];
        // Units: dimensionless; Initial value: 0.0631269
        double var_chaste_interface__calcium_dynamics__APtrack = rCurrentGuess[0];double var_chaste_interface__calcium_dynamics__APtrack2 = rCurrentGuess[1];double var_chaste_interface__calcium_dynamics__APtrack3 = rCurrentGuess[2];double var_chaste_interface__calcium_dynamics__Ca_JSR = rCurrentGuess[3];double var_chaste_interface__calcium_dynamics__Ca_NSR = rCurrentGuess[4];double var_chaste_interface__calcium_dynamics__Cai = rCurrentGuess[5];double var_chaste_interface__calcium_dynamics__Cainfluxtrack = rCurrentGuess[6];double var_chaste_interface__calcium_dynamics__OVRLDtrack = rCurrentGuess[7];double var_chaste_interface__calcium_dynamics__OVRLDtrack2 = rCurrentGuess[8];double var_chaste_interface__calcium_dynamics__OVRLDtrack3 = rCurrentGuess[9];double var_chaste_interface__ionic_concentrations__Ki = rCurrentGuess[10];double var_chaste_interface__ionic_concentrations__Nai = rCurrentGuess[11];

        const double var_x0 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x1 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x2 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x3 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x4 = 1 / var_x3;
        const double var_x5 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x6 = var_x2 * var_x4 * var_x5;
        const double var_x7 = 60000.0 * var_x6;
        const double var_x8 = var_x7 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x9 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x10 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x11 = pow(var_x10, (-2.0));
        const double var_x12 = 1 / (1.0 + 8.0 * var_x11);
        const double var_x13 = 0.001 * var_x12;
        const double var_x14 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x15 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x16 = -4000.0 + var_x15;
        const double var_x17 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0.0;
        const double var_x18 = var_x9 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x19 = var_x18 * var_x4;
        const double var_x20 = 60000.0 * var_x19;
        const double var_x21 = 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x22 = 0.00025000000000000001 * pow(var_x10, (-3.0)) / pow((0.125 + var_x11), 2);
        const double var_x23 = var_x2 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2);
        const double var_x24 = 0.0055555555555555558 * var_x12;
        const double var_x25 = var_x19 * var_x5;
        const double var_x26 = var_x18 * var_x2 * var_x5 / pow(var_x3, 2);
        const double var_x27 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x28 = 1 / var_x27;
        const double var_x29 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x27, 2);
        const double var_x30 = 423.5294117647058 * var_x6;
        const double var_x31 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x32 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x33 = 1.0 + 0.00011900000000000002 * pow(var_x31, (-2.0)) + 3.5000000000000004e-5 * pow(var_x32, (-2.0));
        const double var_x34 = 1 / var_x33;
        const double var_x35 = 0.001 * var_x34;
        const double var_x36 = 28.235294117647054 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x37 = 28.235294117647054 - var_x36;
        const double var_x38 = 423.5294117647058 * var_x19;
        const double var_x39 = 0.40588235294117642 * var_x28;
        const double var_x40 = 1 / var_x32;
        const double var_x41 = 1.1499999999999999 * var_x40;
        const double var_x42 = 1 / var_chaste_interface__calcium_dynamics__Cai;
        const double var_x43 = 0.018717941753901308 * var_chaste_interface__membrane__V;
        const double var_x44 = exp(-var_x43);
        const double var_x45 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x46 = pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        const double var_x47 = 1 / (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * var_x46);
        const double var_x48 = var_x45 * var_x47;
        const double var_x49 = var_x44 * var_x48;
        const double var_x50 = exp(var_x43);
        const double var_x51 = 1.8 * var_x46 * var_x50 - 2299968.0 * var_x44 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x52 = var_x47 * var_x51 / pow((0.0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x53 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x54 = var_x45 * var_x51 / pow((0.00043478865792915378 + 7.8261958427247687e-7 * var_x46 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x55 = exp(0.074871767015605231 * var_chaste_interface__membrane__V);
        const double var_x56 = 1 / (1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x57 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V;
        const double var_x58 = var_x57 / (-1.0 + var_x55);
        const double var_x59 = var_x56 * var_x58;
        const double var_x60 = 7.8019226357407252 * var_x59;
        const double var_x61 = pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), (-2));
        const double var_x62 = -0.61380000000000001 + 1.0 * var_x55 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x63 = var_x41 + 4599.9359999999997 * var_x49 + 0.040282206767891383 * var_x42 + 1.38e-5 * var_x52 + 8.6957731585830757e-7 * var_x54 + var_x55 * var_x60 + 0.6678084676374566 * var_x42 * var_x53 - 1.1499999999999999 * var_chaste_interface__calcium_dynamics__Cai / pow(var_x32, 2) - 0.0046811535814444347 * var_x58 * var_x61 * var_x62;
        const double var_x64 = 1 / M_PI;
        const double var_x65 = 0.090316078310111333 * var_x64;
        const double var_x66 = -var_x39 + 0.40588235294117642 * var_x29 - var_x63 * var_x65;
        const double var_x67 = log(1.8 * var_x42);
        const double var_x68 = var_x53 * (-13.356169352749133 * var_x67 + var_chaste_interface__membrane__V);
        const double var_x69 = var_x48 * var_x51;
        const double var_x70 = 0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x39 * var_chaste_interface__calcium_dynamics__Cai - var_x65 * (0.050000000000000003 * var_x68 + 0.003016 * var_chaste_interface__membrane__V - 0.002 * var_x69 - 0.040282206767891383 * var_x67 + var_x41 * var_chaste_interface__calcium_dynamics__Cai + var_x60 * var_x62);
        const double var_x71 = 0.001 * (0.00023800000000000004 * pow(var_x31, (-3.0)) + 7.0000000000000007e-5 * pow(var_x32, (-3.0))) / pow(var_x33, 2);
        const double var_x72 = pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x73 = var_x54 * var_x72;
        const double var_x74 = var_x48 * var_x50 * var_x72;
        const double var_x75 = 9.0316078310111333e-5 * var_x64;
        const double var_x76 = var_x75 * (2.0416447122894152e-12 * var_x73 - 0.010800000000000001 * var_x74);
        const double var_x77 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x78 = 0.037435883507802616 * var_chaste_interface__membrane__V;
        const double var_x79 = exp(var_x78);
        const double var_x80 = 0.75 * var_x79;
        const double var_x81 = -99.0 + var_x80 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x82 = var_x57 / (-1.0 + var_x79);
        const double var_x83 = var_x61 * var_x82;
        const double var_x84 = 0.00018063215662022267 * var_x64;
        const double var_x85 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x86 = pow(var_x85, 2.0);
        const double var_x87 = 1 / (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x78));
        const double var_x88 = var_x85 * var_x86 * var_x87 / pow((0.01 + var_x86), 2);
        const double var_x89 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x90 = var_x56 * var_x82;
        const double var_x91 = var_x79 * var_x90;
        const double var_x92 = -3.375 + var_x80 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x93 = pow(var_x42, 1.3999999999999999);
        const double var_x94 = 1.0 + 6.4818210260626455e-7 * var_x93;
        ...
        const double var_x96 = var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x97 = var_x96 * (-26.712338705498265 * log(6.9195599999999997 / var_x95) + var_chaste_interface__membrane__V);
        const double var_x98 = 0.25979999999999998 / var_x94;
        const double var_x99 = var_x96 * (-0.433 - var_x98) * (0.14451785951707913 * var_chaste_interface__ionic_concentrations__Ki + 0.0026490123649480601 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x95, 2);
        const double var_x100 = 1 / var_chaste_interface__ionic_concentrations__Ki;
        const double var_x101 = 1 / (1.0 + exp(1.2521739130434781 - 0.16722408026755853 * var_chaste_interface__membrane__V));
        const double var_x102 = log(4.5 * var_x100);
        const double var_x103 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x102);
        const double var_x104 = 1.0 + var_x103;
        const double var_x105 = 1 / var_x104;
        const double var_x106 = exp(-2.4444678999999998 + 13.738155796237757 * var_x102 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x107 = 1.0 + var_x106;
        const double var_x108 = 1 / var_x107;
        const double var_x109 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x102);
        const double var_x110 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x102);
        const double var_x111 = var_x110 + 0.49124000000000001 * var_x109;
        const double var_x112 = var_x108 * var_x111;
        const double var_x113 = 1 / (1000.0 * var_x112 + 1020.0 * var_x105);
        const double var_x114 = var_x105 * var_x113;
        const double var_x115 = var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V));
        const double var_x116 = -26.712338705498265 * var_x102 + var_chaste_interface__membrane__V;
        const double var_x117 = var_x100 * var_x103 / pow(var_x104, 2);
        const double var_x118 = log(132.0 * var_x85);
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (((var_x0) ? (-100.5) : (-0.5))));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        ...
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (((var_x0) ? (-100.5) : (-0.01))));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * ((((var_x1) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5))));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * ((((var_x1) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01))));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * ((((var_chaste_interface__calcium_dynamics__APtrack3 < 0.37) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.37) && (1.0 / (1.0 + 0.80000000000000004 / var_chaste_interface__calcium_dynamics__Ca_JSR) > 0.69999999999999996)) ? (-50.0) : (-0.5))));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        ...
        rJacobian[5][0] = -(mDt * (((var_x14) ? (var_x13 * (var_x8 - var_x7 * var_x9)) : (0))));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (((var_x14) ? (0) : ((var_x17) ? (var_x13 * (var_x16 * var_x2 + (4000.0 * var_chaste_interface__calcium_dynamics__Ca_JSR - 4000.0 * var_chaste_interface__calcium_dynamics__Cai) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)))));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (((var_x14) ? (var_x13 * (-5.5555555555555554 - var_x20 * var_x5) + var_x22 * (var_x21 - var_x8 * var_x9)) : ((var_x17) ? (var_x13 * (-5.5555555555555554 + var_x16 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) + var_x22 * (var_x21 - var_x15 * var_x23)) : (-var_x24 + var_x21 * var_x22)))));
        rJacobian[5][6] = -(mDt * (var_x24));
        rJacobian[5][7] = -(mDt * (((var_x14) ? (60.0 * var_x12 * var_x25) : ((var_x17) ? (var_x13 * (4000.0 - var_x15) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)))));
        rJacobian[5][8] = -(mDt * (((var_x14) ? (var_x13 * (60000.0 * var_x26 - var_x2 * var_x20)) : (0))));
        rJacobian[5][9] = -(mDt * (0));
        ...
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0.00048309178743961351));
        rJacobian[6][6] = 1.0 -(mDt * (-0.00081642512077294684));
        rJacobian[6][7] = -(mDt * (0.0050000000000000001 * var_x28 - 0.0050000000000000001 * var_x29));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        rJacobian[6][10] = -(mDt * (0));
        rJacobian[6][11] = -(mDt * (0));
        rJacobian[7][0] = -(mDt * (((var_x14) ? (var_x35 * (var_x30 * var_x9 - var_x30 * var_chaste_interface__calcium_dynamics__APtrack2)) : (0))));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (((var_x14) ? (0) : ((var_x17) ? (var_x35 * (var_x2 * var_x37 + (28.235294117647054 * var_chaste_interface__calcium_dynamics__Cai - 28.235294117647054 * var_chaste_interface__calcium_dynamics__Ca_JSR) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)))));
        rJacobian[7][3] = -(mDt * (0));
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (((var_x14) ? (0.42352941176470582 * var_x25 * var_x34) : ((var_x17) ? (var_x35 * var_x37 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)))));
        rJacobian[7][6] = -(mDt * (2.7058823529411762e-5 * var_x34));
        rJacobian[7][7] = 1.0 -(mDt * (((var_x14) ? (var_x35 * (var_x66 - var_x38 * var_x5) + var_x71 * (var_x70 + var_x18 * var_x30)) : ((var_x17) ? (var_x35 * (var_x66 + (-28.235294117647054 + var_x36) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) + var_x71 * (var_x70 + var_x23 * var_x36)) : (var_x35 * var_x66 + var_x70 * var_x71)))));
        rJacobian[7][8] = -(mDt * (((var_x14) ? (var_x35 * (-423.5294117647058 * var_x26 + var_x2 * var_x38)) : (0))));
        rJacobian[7][9] = -(mDt * (-var_x34 * var_x76));
        ...
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (((var_x77) ? (-var_x63 * var_x75) : (0))));
        rJacobian[8][8] = 1.0 -(mDt * ((((var_x77) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5))));
        rJacobian[8][9] = -(mDt * (((var_x77) ? (-var_x76) : (0))));
        ...
        rJacobian[9][5] = -(mDt * (0));
        rJacobian[9][6] = -(mDt * (0));
        rJacobian[9][7] = -(mDt * (var_x84 * (2.6087319475749228e-6 * var_x54 + 4.1400000000000003e-5 * var_x52 + 13799.808000000001 * var_x49 + 1.4628604942013857e-6 * var_x81 * var_x83)));
        rJacobian[9][8] = -(mDt * (0));
        rJacobian[9][9] = 1.0 -(mDt * (var_x84 * (6.124934136868245e-12 * var_x73 - 0.032399999999999998 * var_x74 - 0.10684935482199306 * var_x85 - 0.0018285756177517324 * var_x91 - 0.089999999999999997 * var_x88 - 427.39741928797224 * var_x85 * var_x89)));
        ...
        rJacobian[10][7] = -(mDt * (var_x84 * (4.1826974130498884e-7 * var_x83 * var_x92 - 2.3575679435995052e-7 * var_x42 * var_x93 * var_x97 / pow(var_x94, 2))));
        rJacobian[10][8] = -(mDt * (0));
        rJacobian[10][9] = -(mDt * (var_x84 * (3.3880737654706117 * var_x99 + 0.059999999999999998 * var_x88)));
        rJacobian[10][10] = 1.0 -(mDt * (var_x84 * (184.83763041301756 * var_x99 - 0.00052283717663123607 * var_x91 - 7.3656881518639831e-7 * var_x100 - 18654.461852717679 * var_x100 * var_x114 - 0.63742174226149029 * var_x100 * var_x115 - 0.14745210965435041 * var_x100 * var_x101 + 4449.089151873166 * var_x113 * var_x116 * var_x117 - 0.00067122862439358594 * var_x105 * var_x116 * (6498.310636886562 * var_x117 - 1000.0 * var_x108 * (1.053972635420138 * var_x100 * var_x109 + 1.6494869150645177 * var_x100 * var_x110) - 13738.155796237757 * var_x100 * var_x106 * var_x111 / pow(var_x107, 2)) / pow((var_x105 + 0.98039215686274506 * var_x112), 2))));
        ...
        rJacobian[11][11] = 1.0 -(mDt * (((2.0 * var_x69 + 50.0 * var_x68 + 7.0160275741043607 * var_chaste_interface__membrane__V - 106.84935482199306 * var_x118 - 40.282206767891381 * var_x67 - 0.00073656881518639836 * var_x102 + 698346.2608190868 * var_x114 * var_x116 + 7801.9226357407251 * var_x59 * var_x62 + 2.4381008236689765 * var_x81 * var_x90 + 0.6971162355083147 * var_x90 * var_x92 + 1150.0 * var_x40 * var_chaste_interface__calcium_dynamics__Cai + 5.5199999999999996 * var_x101 * var_x116 + 1500.0 * var_x87 / (1.0 + 100.0 * var_x86) + 23.862446088641736 * var_x115 * var_x116 + 1000.0 * var_x97 * (0.433 + var_x98) + 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16000.0 * var_x89 * (-26.712338705498265 * var_x118 + var_chaste_interface__membrane__V) < -150000.0) ? (-100.5) : (-0.5))));
    }
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[5] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((((fabs(10.0 + var_chaste_interface__membrane__V) < 1.0000000000000001e-5) ? (0.21840000000000004 / (1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V))) : (-0.35000000000000003 / (-1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) - 0.035000000000000003 * var_chaste_interface__membrane__V / (-1.0 + exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(10.0 + var_chaste_interface__membrane__V) < 1.0000000000000001e-5) ? (-0.21840000000000004) : (0.35000000000000003 / (1.0 - pow(exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V), 2)) - 0.70000000000000007 / (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) + 0.035000000000000003 * var_chaste_interface__membrane__V / (1.0 - pow(exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V), 2)) + 0.35000000000000003 * exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V) / (1.0 - pow(exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V), 2)) - 0.070000000000000007 * var_chaste_interface__membrane__V / (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) - 0.35000000000000003 * exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V) / (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V)) + 0.035000000000000003 * var_chaste_interface__membrane__V * exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V) / (1.0 - pow(exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V), 2)) - 0.035000000000000003 * var_chaste_interface__membrane__V * exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V) / (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V))))) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((0.02 / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__membrane__V)) + 0.012 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2.0)) / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__membrane__V)) + 0.011819999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2.0)) / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.02 - 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2.0))) * mDt));
        rY[7] = (var_chaste_interface__T_type_Ca_channel_b_gate__b + ((0.001 / (0.0037000000000000002 + 0.0037000000000000002 * exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V) + 0.0061000000000000004 / (1.0 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V)) + 0.0061000000000000004 * exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V) / (1.0 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.0037000000000000002 + 0.0061000000000000004 / (1.0 + exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V)))) * mDt));
        rY[8] = (var_chaste_interface__T_type_Ca_channel_g_gate__g + ((((var_chaste_interface__membrane__V <= 0.0) ? (0.001 / (0.012 + 0.012 * exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V) - 0.00087500000000000002 * var_chaste_interface__membrane__V - 0.00087500000000000002 * var_chaste_interface__membrane__V * exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V))) : (0.083333333333333329 / (1.0 + exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V <= 0.0) ? (0.001 / (-0.012 + 0.00087500000000000002 * var_chaste_interface__membrane__V)) : (-0.083333333333333329))) * mDt));
        rY[3] = (var_chaste_interface__fast_sodium_current_h_gate__h + ((((var_chaste_interface__membrane__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V)) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (-0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) - 310000.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__V) - 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V)) : (-7.6923076923076934 / (1.0 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))))) * mDt));
        rY[4] = (var_chaste_interface__fast_sodium_current_j_gate__j + ((((var_chaste_interface__membrane__V < -40.0) ? (-4803349.2000000002 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.0013124772000000001 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 3.4740000000000003e-5 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 127140.0 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V < -40.0) ? (4803349.2000000002 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 0.0013124772000000001 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.1212 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) + 3.4740000000000003e-5 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 127140.0 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))) : (-0.29999999999999999 * exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))))) * mDt));
        rY[2] = (var_chaste_interface__fast_sodium_current_m_gate__m + ((((fabs(47.130000000000003 + var_chaste_interface__membrane__V) >= 1.0000000000000001e-5) ? (-15.081600000000002 / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.32000000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (3.2000000000000002))) * mDt)) / (1.0 - ((((fabs(47.130000000000003 + var_chaste_interface__membrane__V) >= 1.0000000000000001e-5) ? (-0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__membrane__V) - 15.081600000000002 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.32000000000000001 * var_chaste_interface__membrane__V / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (-3.2000000000000002 - 0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__membrane__V)))) * mDt));
        rY[9] = (var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr + ((0.023728999999999997 / (-1.0 + 1.0 * exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V) * exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V)) - 0.019595999999999999 / (-1.0 + 1.0 * exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) + exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) * exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V)) + 0.00060999999999999997 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V) * exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V)) - 0.0013799999999999999 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V) - 1.0 * exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) + exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V) * exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.023728999999999997 / (-1.0 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V)) - 0.019595999999999999 / (1.0 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V)) - 0.00060999999999999997 * var_chaste_interface__membrane__V / (-1.0 + exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V)) - 0.0013799999999999999 * var_chaste_interface__membrane__V / (1.0 - exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V))) * mDt));
        rY[10] = (var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 + ((0.0039300000000000003 / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V)) - 0.0021570000000000001 / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V)) + 0.00013100000000000001 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V)) - 7.1899999999999999e-5 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.0039300000000000003 / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V)) - 0.0021570000000000001 / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V)) - 7.1899999999999999e-5 * var_chaste_interface__membrane__V / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V)) - 0.00013100000000000001 * var_chaste_interface__membrane__V / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V))) * mDt));
        rY[11] = (var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2 + ((0.00098250000000000008 / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V)) - 0.00053925000000000002 / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V)) + 3.2750000000000003e-5 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V)) - 1.7975e-5 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.00098250000000000008 / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V)) - 0.00053925000000000002 / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V)) - 1.7975e-5 * var_chaste_interface__membrane__V / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V)) - 3.2750000000000003e-5 * var_chaste_interface__membrane__V / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V))) * mDt));
        rY[13] = (var_chaste_interface__transient_outward_current_ydv_gate__ydv + ((0.22500000000000001 / (15.0 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 15.0 * pow(exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 30.0 * exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 100.0 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 100.0 * pow(exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V), 2) * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 200.0 * exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V))) + 1.5 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (15.0 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 15.0 * exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 15.0 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 100.0 * pow(exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 100.0 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 15.0 * exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 100.0 * pow(exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V), 2) * exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) + 100.0 * exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.014999999999999999 / (1.0 + exp(12.0 + 0.20000000000000001 * var_chaste_interface__membrane__V)) - 0.10000000000000001 * exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(5.0 + 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        rY[12] = (var_chaste_interface__transient_outward_current_zdv_gate__zdv + ((100000.0 * pow(exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2) / (10000.0 * pow(exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V), 3) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 20000.0 * pow(exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * pow(exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2) * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 20000.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V))) + 100000.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (10000.0 * pow(exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * pow(exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V), 2) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * pow(exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V), 2) * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * pow(exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V), 2) * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 10000.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-10.0 * exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-1.6000000000000001 + 0.040000000000000001 * var_chaste_interface__membrane__V)) - 10.0 * exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.6000000000000001 - 0.040000000000000001 * var_chaste_interface__membrane__V))) * mDt));
