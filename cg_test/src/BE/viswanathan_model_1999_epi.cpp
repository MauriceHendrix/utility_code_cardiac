...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x11 = 0.037435883507802616 * var_chaste_interface__membrane__V;
        const double var_x12 = 1 / (1.0 + 0.1245 * exp(-0.003743588350780262 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(1.961367013372957)) * exp(-var_x11));
        const double var_x13 = pow(var_chaste_interface__ionic_concentrations__Nai, 3.0);
        const double var_x14 = 0.018717941753901308 * var_chaste_interface__membrane__V;
        const double var_x15 = exp(var_x14);
        const double var_x16 = exp(-var_x14);
        const double var_x17 = 1.8 * var_x13 * var_x15 - 2299968.0 * var_x16 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x18 = 1 / (1.0 + 144.92753623188406 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x19 = 1 / (1.0 + 2299.9679999999998 * var_chaste_interface__calcium_dynamics__Cai + 0.0018000000000000002 * var_x13);
        const double var_x20 = var_x18 * var_x19;
        const double var_x21 = var_x17 * var_x20;
        const double var_x22 = pow(var_chaste_interface__T_type_Ca_channel_b_gate__b, 2) * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x23 = var_x22 * (-13.356169352749133 * var_x3 + var_chaste_interface__membrane__V);
        const double var_x24 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3708927812613361 * var_x5);
        const double var_x25 = 1.0 + var_x24;
        const double var_x26 = 1 / var_x25;
        const double var_x27 = exp(-2.4444678999999998 + 13.738155796237757 * var_x5 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x28 = 1.0 + var_x27;
        const double var_x29 = 1 / var_x28;
        const double var_x30 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1455350448256207 * var_x5);
        const double var_x31 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6494869150645177 * var_x5);
        ...
        const double var_x36 = var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr / (1.0 + exp(0.4017857142857143 + 0.044642857142857144 * var_chaste_interface__membrane__V));
        const double var_x37 = pow(var_x2, 1.3999999999999999);
        const double var_x38 = 1.0 + 6.4818210260626455e-7 * var_x37;
        const double var_x39 = 0.25979999999999998 / var_x38;
        const double var_x40 = 0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki;
        const double var_x41 = var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x42 = var_x41 * (-26.712338705498265 * log(6.9195599999999997 / var_x40) + var_chaste_interface__membrane__V);
        const double var_x43 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x44 = exp(0.074871767015605231 * var_chaste_interface__membrane__V);
        const double var_x45 = -0.61380000000000001 + 1.0 * var_x44 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x46 = 1 / (-1.0 + var_x44);
        const double var_x47 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__membrane__V;
        const double var_x48 = var_x47 / (1.0 + 1666.6666666666667 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x49 = var_x46 * var_x48;
        const double var_x50 = var_x45 * var_x49;
        const double var_x51 = exp(var_x11);
        const double var_x52 = 0.75 * var_x51;
        const double var_x53 = -99.0 + var_x52 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x54 = 1 / (-1.0 + var_x51);
        const double var_x55 = var_x48 * var_x54;
        const double var_x56 = -3.375 + var_x52 * var_chaste_interface__ionic_concentrations__Ki;
        ...
        const double var_x62 = var_x58 * var_x60 * var_x61;
        const double var_x63 = 60000.0 * var_x62;
        const double var_x64 = var_x63 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x65 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        ...
        const double var_x70 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x71 = var_x65 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x72 = var_x60 * var_x71;
        const double var_x73 = 60000.0 * var_x72;
        const double var_x74 = 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x75 = 0.00025000000000000001 / (pow(var_x66, 3) * pow((0.125 + var_x67), 2));
        const double var_x76 = 4000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x77 = -4000.0 + var_x76;
        const double var_x78 = var_x58 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2);
        const double var_x79 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0.0;
        const double var_x80 = 0.0055555555555555558 * var_x68;
        const double var_x81 = var_x61 * var_x72;
        const double var_x82 = var_x58 * var_x61 * var_x71 / pow(var_x59, 2);
        const double var_x83 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x84 = 1 / var_x83;
        const double var_x85 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x83, 2);
        const double var_x86 = 423.5294117647058 * var_x62;
        const double var_x87 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x88 = pow(var_x6, (-2));
        const double var_x89 = 1.0 + 0.00011900000000000002 / pow(var_x87, 2) + 3.5000000000000004e-5 * var_x88;
        const double var_x90 = 1 / var_x89;
        const double var_x91 = 0.001 * var_x90;
        const double var_x92 = 28.235294117647054 * var_chaste_interface__calcium_dynamics__OVRLDtrack2;
        const double var_x93 = 28.235294117647054 - var_x92;
        const double var_x94 = 423.5294117647058 * var_x72;
        const double var_x95 = 0.40588235294117642 * var_x84;
        const double var_x96 = 1.1499999999999999 * var_x7;
        const double var_x97 = var_x16 * var_x20;
        const double var_x98 = var_x17 * var_x19 / pow((0.0068999999999999999 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x99 = var_x17 * var_x18 / pow((0.00043478865792915378 + 7.8261958427247687e-7 * var_x13 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x100 = var_x47 / pow((0.00059999999999999995 + var_chaste_interface__calcium_dynamics__Cai), 2);
        const double var_x101 = var_x96 + 4599.9359999999997 * var_x97 + 0.040282206767891383 * var_x2 + 1.38e-5 * var_x98 + 8.6957731585830757e-7 * var_x99 + 7.8019226357407252 * var_x44 * var_x49 + 0.6678084676374566 * var_x2 * var_x22 - 1.1499999999999999 * var_x88 * var_chaste_interface__calcium_dynamics__Cai - 0.0046811535814444347 * var_x100 * var_x45 * var_x46;
        const double var_x102 = 1 / M_PI;
        const double var_x103 = 0.090316078310111333 * var_x102;
        const double var_x104 = -var_x95 + 0.40588235294117642 * var_x85 - var_x101 * var_x103;
        const double var_x105 = 0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR - var_x103 * (0.050000000000000003 * var_x23 + 0.003016 * var_chaste_interface__membrane__V + 7.8019226357407252 * var_x50 - 0.002 * var_x21 - 0.040282206767891383 * var_x3 + var_x96 * var_chaste_interface__calcium_dynamics__Cai) - var_x95 * var_chaste_interface__calcium_dynamics__Cai;
        const double var_x106 = 0.001 * (0.00023800000000000004 / pow(var_x87, 3) + 7.0000000000000007e-5 / pow(var_x6, 3)) / pow(var_x89, 2);
        const double var_x107 = pow(var_chaste_interface__ionic_concentrations__Nai, 2.0);
        const double var_x108 = var_x107 * var_x99;
        const double var_x109 = var_x107 * var_x15 * var_x20;
        const double var_x110 = 9.0316078310111333e-5 * var_x102;
        const double var_x111 = var_x110 * (2.0416447122894152e-12 * var_x108 - 0.010800000000000001 * var_x109);
        const double var_x112 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x113 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x114 = var_x100 * var_x54;
        const double var_x115 = 0.00018063215662022267 * var_x102;
        const double var_x116 = var_x24 * var_x4 / pow(var_x25, 2);
        const double var_x117 = var_x41 * (-0.433 - var_x39) * (0.14451785951707913 * var_chaste_interface__ionic_concentrations__Ki + 0.0026490123649480601 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x40, 2);
        const double var_x118 = var_x51 * var_x55;
        const double var_x119 = var_x12 / (pow((0.01 + var_x10), 2) * pow(var_chaste_interface__ionic_concentrations__Nai, 3));
        
        
        rJacobian[0][0] = 1.0 - (mDt * (((2.0 * var_x21 + 50.0 * var_x23 + 7801.9226357407251 * var_x50 + 7.0160275741043607 * var_chaste_interface__membrane__V - 106.84935482199306 * var_x1 - 40.282206767891381 * var_x3 - 0.00073656881518639836 * var_x5 + 698346.2608190868 * var_x35 * var_x9 + 2.4381008236689765 * var_x53 * var_x55 + 0.6971162355083147 * var_x55 * var_x56 + 1150.0 * var_x7 * var_chaste_interface__calcium_dynamics__Cai + 5.5199999999999996 * var_x8 * var_x9 + 1500.0 * var_x12 / (1.0 + 100.0 * var_x10) + 23.862446088641736 * var_x36 * var_x9 + 1000.0 * var_x42 * (0.433 + var_x39) + 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16000.0 * var_x43 * (-26.712338705498265 * var_x1 + var_chaste_interface__membrane__V) < -150000.0) ? (-100.5) : (-0.5))));
        rJacobian[0][1] = 0.0;
        rJacobian[0][2] = 0.0;
        rJacobian[0][3] = 0.0;
        rJacobian[0][4] = 0.0;
        ...
        rJacobian[0][11] = 0.0;
        rJacobian[1][0] = 0.0;
        rJacobian[1][1] = 1.0 - (mDt * (((var_x57) ? (-100.5) : (-0.5))));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = 0.0;
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        ...
        rJacobian[2][0] = 0.0;
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (((var_x57) ? (-100.5) : (-0.01))));
        rJacobian[2][3] = 0.0;
        rJacobian[2][4] = 0.0;
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        ...
        rJacobian[2][11] = 0.0;
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = -(mDt * (((var_x70) ? (var_x69 * (var_x64 - var_x63 * var_x65)) : (0))));
        rJacobian[3][2] = 0.0;
        rJacobian[3][3] = 1.0 - (mDt * (((var_x70) ? (var_x69 * (-5.5555555555555554 - var_x61 * var_x73) + var_x75 * (var_x74 - var_x64 * var_x65)) : ((var_x79) ? (var_x69 * (-5.5555555555555554 + var_x77 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) + var_x75 * (var_x74 - var_x76 * var_x78)) : (-var_x80 + var_x74 * var_x75)))));
        rJacobian[3][4] = -(mDt * (var_x80));
        rJacobian[3][5] = -(mDt * (((var_x70) ? (60.0 * var_x68 * var_x81) : ((var_x79) ? (var_x69 * (4000.0 - var_x76) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)))));
        rJacobian[3][6] = -(mDt * (((var_x70) ? (var_x69 * (60000.0 * var_x82 - var_x58 * var_x73)) : (0))));
        rJacobian[3][7] = 0.0;
        rJacobian[3][8] = -(mDt * (((var_x70) ? (0) : ((var_x79) ? (var_x69 * (var_x58 * var_x77 + (4000.0 * var_chaste_interface__calcium_dynamics__Ca_JSR - 4000.0 * var_chaste_interface__calcium_dynamics__Cai) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)))));
        rJacobian[3][9] = 0.0;
        rJacobian[3][10] = 0.0;
        rJacobian[3][11] = 0.0;
        rJacobian[4][0] = 0.0;
        ...
        rJacobian[4][5] = -(mDt * (0.0050000000000000001 * var_x84 - 0.0050000000000000001 * var_x85));
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        rJacobian[4][9] = 0.0;
        ...
        rJacobian[4][11] = 0.0;
        rJacobian[5][0] = 0.0;
        rJacobian[5][1] = -(mDt * (((var_x70) ? (var_x91 * (var_x65 * var_x86 - var_x86 * var_chaste_interface__calcium_dynamics__APtrack2)) : (0))));
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (((var_x70) ? (0.42352941176470582 * var_x81 * var_x90) : ((var_x79) ? (var_x91 * var_x93 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)))));
        rJacobian[5][4] = -(mDt * (2.7058823529411762e-5 * var_x90));
        rJacobian[5][5] = 1.0 - (mDt * (((var_x70) ? (var_x106 * (var_x105 + var_x71 * var_x86) + var_x91 * (var_x104 - var_x61 * var_x94)) : ((var_x79) ? (var_x106 * (var_x105 + var_x78 * var_x92) + var_x91 * (var_x104 + (-28.235294117647054 + var_x92) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (var_x104 * var_x91 + var_x105 * var_x106)))));
        rJacobian[5][6] = -(mDt * (((var_x70) ? (var_x91 * (-423.5294117647058 * var_x82 + var_x58 * var_x94)) : (0))));
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = -(mDt * (((var_x70) ? (0) : ((var_x79) ? (var_x91 * (var_x58 * var_x93 + (28.235294117647054 * var_chaste_interface__calcium_dynamics__Cai - 28.235294117647054 * var_chaste_interface__calcium_dynamics__Ca_JSR) * var_chaste_interface__calcium_dynamics__OVRLDtrack2)) : (0)))));
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = -(mDt * (-var_x111 * var_x90));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = -(mDt * (((var_x112) ? (-var_x101 * var_x110) : (0))));
        rJacobian[6][6] = 1.0 - (mDt * ((((var_x112) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-0.5))));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        rJacobian[6][11] = -(mDt * (((var_x112) ? (-var_x111) : (0))));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        ...
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = 0.0;
        rJacobian[7][7] = 1.0 - (mDt * ((((var_chaste_interface__calcium_dynamics__APtrack3 < 0.37) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.37) && (1.0 / (1.0 + 0.80000000000000004 / var_chaste_interface__calcium_dynamics__Ca_JSR) > 0.69999999999999996)) ? (-50.0) : (-0.5))));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * ((((var_x113) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50.0) : (-0.5))));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[9][0] = 0.0;
        ...
        rJacobian[9][7] = 0.0;
        rJacobian[9][8] = 0.0;
        rJacobian[9][9] = 1.0 - (mDt * ((((var_x113) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50.0) : (-0.01))));
        rJacobian[9][10] = 0.0;
        rJacobian[9][11] = 0.0;
        rJacobian[10][0] = 0.0;
        rJacobian[10][1] = 0.0;
        ...
        rJacobian[10][3] = 0.0;
        rJacobian[10][4] = 0.0;
        rJacobian[10][5] = -(mDt * (var_x115 * (4.1826974130498884e-7 * var_x114 * var_x56 - 2.3575679435995052e-7 * var_x2 * var_x37 * var_x42 / pow(var_x38, 2))));
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = 0.0;
        rJacobian[10][8] = 0.0;
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (var_x115 * (184.83763041301756 * var_x117 - 0.00052283717663123607 * var_x118 - 7.3656881518639831e-7 * var_x4 - 18654.461852717679 * var_x35 * var_x4 - 0.63742174226149029 * var_x36 * var_x4 - 0.14745210965435041 * var_x4 * var_x8 + 4449.089151873166 * var_x116 * var_x34 * var_x9 - 0.00067122862439358594 * var_x26 * var_x9 * (6498.310636886562 * var_x116 - 1000.0 * var_x29 * (1.053972635420138 * var_x30 * var_x4 + 1.6494869150645177 * var_x31 * var_x4) - 13738.155796237757 * var_x27 * var_x32 * var_x4 / pow(var_x28, 2)) / pow((var_x26 + 0.98039215686274506 * var_x33), 2))));
        rJacobian[10][11] = -(mDt * (var_x115 * (3.3880737654706117 * var_x117 + 0.059999999999999998 * var_x119)));
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = 0.0;
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = -(mDt * (var_x115 * (2.6087319475749228e-6 * var_x99 + 4.1400000000000003e-5 * var_x98 + 13799.808000000001 * var_x97 + 1.4628604942013857e-6 * var_x114 * var_x53)));
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = 0.0;
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = 0.0;
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (var_x115 * (6.124934136868245e-12 * var_x108 - 0.032399999999999998 * var_x109 - 0.10684935482199306 * var_x0 - 0.0018285756177517324 * var_x118 - 0.089999999999999997 * var_x119 - 427.39741928797224 * var_x0 * var_x43)));
    }
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((0.02 / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__membrane__V)) + 0.012 / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V)) + 0.019699999999999999 * exp(-0.113569 - 0.00113569 * pow(var_chaste_interface__membrane__V, 2) - 0.022713800000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(4.0 + 0.125 * var_chaste_interface__membrane__V)) + 0.011819999999999999 * exp(-0.113569 - 0.00113569 * pow(var_chaste_interface__membrane__V, 2) - 0.022713800000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.02 - 0.019699999999999999 * exp(-0.113569 - 0.00113569 * pow(var_chaste_interface__membrane__V, 2) - 0.022713800000000003 * var_chaste_interface__membrane__V)) * mDt));
