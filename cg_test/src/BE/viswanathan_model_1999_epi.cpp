...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[12], double rJacobian[12][12])
    {
        ...
        const double var_x70 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0.0;
        const double var_x71 = ((var_x63) ? (var_x62 * var_chaste_interface__calcium_dynamics__APtrack2) : ((var_x70) ? (4000.0 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0.0)));
        ...
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (7.0588235294117641e-6 * var_x71 * var_x82));
