...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[13], double rJacobian[13][13])
    {
        ...
        double var_chaste_interface__hyperpolarisation_activated_current_y_gate__y = rY[13];
        // Units: dimensionless; Initial value: 0.003578708
        double var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact = rCurrentGuess[0];double var_chaste_interface__SR_Ca_release_channel__P_C1 = rCurrentGuess[1];double var_chaste_interface__SR_Ca_release_channel__P_O1 = rCurrentGuess[3];double var_chaste_interface__SR_Ca_release_channel__P_O2 = rCurrentGuess[4];double var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa = rCurrentGuess[5];double var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa = rCurrentGuess[6];double var_chaste_interface__intracellular_ion_concentrations__Ca_JSR = rCurrentGuess[7];double var_chaste_interface__intracellular_ion_concentrations__Ca_NSR = rCurrentGuess[8];double var_chaste_interface__intracellular_ion_concentrations__Ca_i = rCurrentGuess[9];double var_chaste_interface__intracellular_ion_concentrations__Ca_ss = rCurrentGuess[10];double var_chaste_interface__intracellular_ion_concentrations__K_i = rCurrentGuess[11];double var_chaste_interface__intracellular_ion_concentrations__Na_i = rCurrentGuess[12];
        ...
        const double var_x5 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 1.2);
        const double var_x6 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1.0);
        const double var_x7 = 1 / (1.0 + 33855.471141425078 * var_x5 + 0.303951367781155 * var_x6);
        const double var_x8 = 1354.2188456570032 * var_x5 - 0.2735562310030395 * var_x6;
        const double var_x9 = var_x8 / pow((2.9537323401073989e-5 + var_x5 + 8.9779098483507565e-6 * var_x6), 2);
        const double var_x10 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 0.19999999999999996);
        const double var_x11 = var_x10 * var_x7;
        const double var_x12 = var_x10 * var_x9;
        const double var_x13 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
        const double var_x14 = pow(var_x13, (-2.0));
        const double var_x15 = 1 / (1.0 + 12.0 * var_x14);
        const double var_x16 = 0.001 * var_x15;
        const double var_x17 = var_x16 * (1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        const double var_x18 = 1800.0 * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x19 = 1800.0 * var_chaste_interface__SR_Ca_release_channel__P_O2;
        const double var_x20 = (-var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) * (var_chaste_interface__SR_Ca_release_channel__P_O1 + var_chaste_interface__SR_Ca_release_channel__P_O2);
        const double var_x21 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        const double var_x22 = 1.0 + 0.00011900000000000002 * pow(var_x21, (-2.0));
        const double var_x23 = 1 / var_x22;
        const double var_x24 = 0.001 * var_x23;
        const double var_x25 = var_x24 * (84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        const double var_x26 = 84000.0 * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x27 = 84000.0 * var_chaste_interface__SR_Ca_release_channel__P_O2;
        const double var_x28 = 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_Ca_inact_gate__Ca_inact;
        const double var_x29 = 200000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x30 = 0.00014999999999999999 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x31 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x32 = 1.0 + 0.0014999999999999998 * pow(var_x30, (-2.0)) + 0.00011900000000000002 * pow(var_x31, (-2.0));
        const double var_x33 = 1 / var_x32;
        const double var_x34 = 0.001 * var_x33;
        const double var_x35 = 40000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x36 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x37 = 0.00040000000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x38 = 0.0022145492519739826 / var_x37;
        const double var_x39 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        const double var_x40 = 0.018714999999999999 * var_chaste_interface__membrane__V;
        const double var_x41 = exp(var_x40);
        const double var_x42 = exp(-var_x40);
        const double var_x43 = 1.2 * var_x39 * var_x41 - 2744000.0 * var_x42 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x44 = var_x43 / pow((0.0036443148688046646 + 4.3731778425655972e-7 * var_x39 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x45 = 1 / (1.0 + 0.00012 * var_x39 + 274.40000000000003 * var_chaste_interface__intracellular_ion_concentrations__Ca_i);
        const double var_x46 = var_x42 * var_x45;
        const double var_x47 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        const double var_x48 = var_x41 * var_x45 * var_x47;
        const double var_x49 = var_x44 * var_x47;
        const double var_x50 = 1 / var_chaste_interface__intracellular_ion_concentrations__Na_i;
        const double var_x51 = pow(var_x50, 1.5);
        const double var_x52 = var_x50 * var_x51 / (pow((0.031622776601683791 + var_x51), 2) * (1.0 + 0.1245 * exp(-0.0039337852699643568 * var_chaste_interface__membrane__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0802377414561666)) * exp(-0.039337852699643565 * var_chaste_interface__membrane__V)));
        const double var_x53 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x54 = log(5.4000000000000004 * var_x53);
        const double var_x55 = exp(-0.10977188457982838 + 0.06345195640452507 * var_chaste_interface__membrane__V - 1.613 * var_x54);
        const double var_x56 = 1.0 + var_x55;
        const double var_x57 = var_x53 / (1.0 + exp(-35.49354838709678));
        const double var_x58 = exp(4.5158823529411762 + 1.4953416461467837 * var_x54 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x59 = 0.040000000000000001 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.00080000000000000004));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0.10000000000000001));
        rJacobian[0][6] = -(mDt * (0));
        rJacobian[0][7] = -(mDt * (0));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[0][9] = -(mDt * (0));
        ...
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-6.6000000000000005e-5 - 200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        ...
        rJacobian[1][8] = -(mDt * (0));
        rJacobian[1][9] = -(mDt * (0));
        rJacobian[1][10] = -(mDt * (28.000000000000004 - 200.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa));
        rJacobian[1][11] = -(mDt * (0));
        rJacobian[1][12] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.040000000000000001 - 40.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        ...
        rJacobian[2][8] = -(mDt * (0));
        rJacobian[2][9] = -(mDt * (0));
        rJacobian[2][10] = -(mDt * (2.8000000000000003 - 40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa));
        rJacobian[2][11] = -(mDt * (0));
        rJacobian[2][12] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (0));
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.11111111111111112));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (-0.0011111111111111113 / pow((0.01 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss), 2)));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-var_x0));
        rJacobian[4][5] = -(mDt * (0.57600000000000007));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[4][9] = -(mDt * (-var_x2));
        rJacobian[4][10] = -(mDt * (0));
        rJacobian[4][11] = -(mDt * (0));
        rJacobian[4][12] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (0.00080000000000000004));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (var_x0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.67600000000000005 - var_x3));
        rJacobian[5][6] = -(mDt * (1.9299999999999999));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (var_x2 - var_x4));
        ...
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (var_x3));
        rJacobian[6][6] = 1.0 -(mDt * (-1.9299999999999999));
        rJacobian[6][7] = -(mDt * (0));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (var_x4));
        ...
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (-0.19333758676024207 - 4.9248350664764349e-13 * var_x9 - 0.00050803300043421621 * var_x7));
        rJacobian[7][8] = -(mDt * (0.19333758676024207));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[7][10] = -(mDt * (3.0179734274641783 * var_x11 - 6.5826035008107738e-8 * var_x12));
        ...
        rJacobian[8][6] = -(mDt * (var_x17));
        rJacobian[8][7] = -(mDt * (1.7400382808421784 * var_x15));
        rJacobian[8][8] = 1.0 -(mDt * (var_x16 * (-1740.0382808421784 - var_x18 - var_x19) + 0.00016666666666666666 * pow(var_x13, (-3.0)) * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x20 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / pow((0.083333333333333329 + var_x14), 2)));
        rJacobian[8][9] = -(mDt * (var_x16 * (var_x18 + var_x19)));
        ...
        rJacobian[9][1] = -(mDt * (0));
        rJacobian[9][2] = -(mDt * (0));
        rJacobian[9][3] = -(mDt * (var_x24 * (870.15176483187713 - 13.386950228182727 * var_chaste_interface__membrane__V) * (0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11 - 0.10000000000000001 * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12) * var_chaste_interface__L_type_Ca_channel_d_gate__d));
        rJacobian[9][4] = -(mDt * (0));
        rJacobian[9][5] = -(mDt * (var_x25));
        rJacobian[9][6] = -(mDt * (var_x25));
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (var_x24 * (var_x26 + var_x27)));
        rJacobian[9][9] = 1.0 -(mDt * (var_x24 * (-29213.483146067414 - var_x26 - var_x27) + 2.3800000000000004e-7 * pow(var_x21, (-3.0)) * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x20 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * (-65.0 + var_chaste_interface__membrane__V) * ((0.10000000000000001 - var_x28) * var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12 + (0.90000000000000002 + var_x28) * var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / pow(var_x22, 2)));
        rJacobian[9][10] = -(mDt * (29.213483146067414 * var_x23));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[9][12] = -(mDt * (0));
        rJacobian[10][0] = -(mDt * (0));
        rJacobian[10][1] = -(mDt * (var_x34 * (0.066000000000000003 + var_x29)));
        rJacobian[10][2] = -(mDt * (var_x34 * (40.0 + var_x35)));
        rJacobian[10][3] = -(mDt * (0));
        rJacobian[10][4] = -(mDt * (0));
        rJacobian[10][5] = -(mDt * (0));
        rJacobian[10][6] = -(mDt * (0));
        rJacobian[10][7] = -(mDt * (var_x34 * (0.2735562310030395 * var_x7 + 2.651834266564234e-10 * var_x9)));
        rJacobian[10][8] = -(mDt * (0));
        rJacobian[10][9] = -(mDt * (0.037453183520599252 * var_x33));
        rJacobian[10][10] = 1.0 -(mDt * (var_x34 * (-30837.453183520603 - var_x38 + 40000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x12 - 4.0288009715211813e-8 * var_x44 - 0.00022799730679188537 * var_x36 - 30.33500195190371 * var_x46 - 1625.0626147884036 * var_x11 + 0.0022145492519739826 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x37, 2)) + 0.001 * (0.0029999999999999996 * pow(var_x30, (-3.0)) + 0.00023800000000000004 * pow(var_x31, (-3.0))) * (40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 0.066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 0.00022799730679188537 * log(1.2 * var_x36) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x29 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x35 * (0.070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x38 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.1055029865854122e-5 * var_x43 * var_x45 - 1.0 * var_x7 * var_x8) / pow(var_x32, 2)));
        rJacobian[10][11] = -(mDt * (var_x34 * (3.9798107517074834e-5 * var_x48 - 5.2855989422289547e-14 * var_x49)));
        ...
        rJacobian[11][10] = -(mDt * (1.2086402914563544e-10 * var_x44 + 0.091005005855711127 * var_x46));
        rJacobian[11][11] = 1.0 -(mDt * (1.5856796826686865e-16 * var_x49 - 9.8651233004461501e-6 * var_x52 - 1.193943225512245e-7 * var_x48 - 2.2560474246135324e-6 * var_x50 - 8.1628665394625614e-6 * var_x50 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.022518252522655345 * var_x50 * pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j));
        ...
        rJacobian[12][11] = -(mDt * (6.5767488669640998e-6 * var_x52));
        rJacobian[12][12] = 1.0 -(mDt * (-3.8843985601580465e-6 * var_x53 - 0.00067554757567966038 * var_x57 / var_x56 - 3.2651466157850246e-5 * var_x53 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 25.420807984495319 * var_x53 * (-3.433658615185661e-5 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s - 4.4180257576880966e-6 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r - 0.00019703470957323427 * var_x53 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss + 4.286481532120841e-5 * var_x55 * var_x57 * (-1.73 - 25.420807984495319 * var_x54 + var_chaste_interface__membrane__V) / pow(var_x56, 2) - 1.6557538619599519e-7 * var_x53 * var_x58 * (10.0 + 48.0 / (exp(1.48 + var_x59) + exp(-1.48 - var_x59))) / pow((1.0 + var_x58), 2)));
    }
    ...
    void Cellpandit_model_2001_epiFromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[8] = (var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + ((0.045159999999999999 * exp(1.7885000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__membrane__V)) + 0.098900000000000002 * exp(-3.8000000000000003 - 0.10000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.045159999999999999 * exp(1.7885000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V) - 0.098900000000000002 * exp(-3.8000000000000003 - 0.10000000000000001 * var_chaste_interface__membrane__V)) * mDt));
        rY[9] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + ((0.001 / (0.035000000000000003 + 0.035000000000000003 * exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V) + 0.34999999999999998 * exp(-21.777777777777779 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2.0)) + 0.34999999999999998 * exp(-21.777777777777779 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2.0)) * exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.035000000000000003 + 0.34999999999999998 * exp(-21.777777777777779 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[10] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow + ((0.001 / (0.035000000000000003 + 0.035000000000000003 * exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V) + 3.7000000000000002 * exp(-5.4444444444444446 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2.0)) + 3.7000000000000002 * exp(-5.4444444444444446 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2.0)) * exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.035000000000000003 + 3.7000000000000002 * exp(-5.4444444444444446 * pow((1 + 0.014285714285714285 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[4] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((0.001 / (0.00025000000000000001 + 0.00025000000000000001 * exp(-3.0600000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V) + 0.0010499999999999999 * exp(-0.64800000000000002 * pow((-1 + 0.055555555555555552 * var_chaste_interface__membrane__V), 2.0)) + 0.0030500000000000002 * exp(-0.22049999999999997 * pow((1 + 0.14285714285714285 * var_chaste_interface__membrane__V), 2.0)) + 0.0010499999999999999 * exp(-0.64800000000000002 * pow((-1 + 0.055555555555555552 * var_chaste_interface__membrane__V), 2.0)) * exp(-3.0600000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V) + 0.0030500000000000002 * exp(-0.22049999999999997 * pow((1 + 0.14285714285714285 * var_chaste_interface__membrane__V), 2.0)) * exp(-3.0600000000000001 - 0.20000000000000001 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.00025000000000000001 + 0.0010499999999999999 * exp(-0.64800000000000002 * pow((-1 + 0.055555555555555552 * var_chaste_interface__membrane__V), 2.0)) + 0.0030500000000000002 * exp(-0.22049999999999997 * pow((1 + 0.14285714285714285 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11 + ((0.001 / (0.0016999999999999999 + 0.014999999999999999 / (1.0 + exp(3.0 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.040000000000000001 / (1.0 + exp(1.0 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.105 * exp(-14.0625 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)) + 0.0016999999999999999 * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V) + 0.014999999999999999 * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V) / (1.0 + exp(3.0 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.040000000000000001 * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V) / (1.0 + exp(1.0 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.105 * exp(-14.0625 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)) * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.0016999999999999999 + 0.014999999999999999 / (1.0 + exp(3.0 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.040000000000000001 / (1.0 + exp(1.0 - 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.105 * exp(-14.0625 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12 + ((0.001 / (0.0016999999999999999 + 0.014999999999999999 / (1.0 + exp(3.0 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.080000000000000002 / (1.0 + exp(-11.0 - 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.041000000000000002 * exp(-15.340277777777779 * pow((1 + 0.021276595744680851 * var_chaste_interface__membrane__V), 2.0)) + 0.0016999999999999999 * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V) + 0.014999999999999999 * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V) / (1.0 + exp(3.0 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.080000000000000002 * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V) / (1.0 + exp(-11.0 - 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.041000000000000002 * exp(-15.340277777777779 * pow((1 + 0.021276595744680851 * var_chaste_interface__membrane__V), 2.0)) * exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.0016999999999999999 + 0.014999999999999999 / (1.0 + exp(3.0 + 0.040000000000000001 * var_chaste_interface__membrane__V)) + 0.080000000000000002 / (1.0 + exp(-11.0 - 0.20000000000000001 * var_chaste_interface__membrane__V)) + 0.041000000000000002 * exp(-15.340277777777779 * pow((1 + 0.021276595744680851 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[13] = (var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + ((0.00056230000000000006 * exp(-5.6377730796335452 - 0.070472163495419307 * var_chaste_interface__membrane__V) / (1.0 + exp(13.225190839694655 + 0.095419847328244267 * var_chaste_interface__membrane__V)) + 0.00011885 * exp(2.8198801550934083 + 0.035248501938667604 * var_chaste_interface__membrane__V) / (1.0 + exp(13.225190839694655 + 0.095419847328244267 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.00056230000000000006 * exp(-5.6377730796335452 - 0.070472163495419307 * var_chaste_interface__membrane__V) - 0.00011885 * exp(2.8198801550934083 + 0.035248501938667604 * var_chaste_interface__membrane__V)) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_h_gate__h + ((((var_chaste_interface__membrane__V >= -40.0) ? (0.001 / (0.00045370000000000002 + 0.00045370000000000002 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 0.00045370000000000002 * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V) + 0.00045370000000000002 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))) : (1.0200573065902578 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V)) + 0.038681948424068774 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) / (1.0 + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V)) + 88825.214899713465 * exp(0.34999999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V >= -40.0) ? (-0.001 / (0.00045370000000000002 + 0.00045370000000000002 * exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V))) : (-1.0200573065902578 * exp(0.079000000000000001 * var_chaste_interface__membrane__V) - 0.038681948424068774 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V) - 88825.214899713465 * exp(0.34999999999999998 * var_chaste_interface__membrane__V)))) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_j_gate__j + ((((var_chaste_interface__membrane__V >= -40.0) ? (0.085984522785898548 * exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 1.0 * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V) + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (0.034727793696275072 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 1.0 * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V) + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) - 1376317.8223495702 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.00037606796561604589 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 36429.7994269341 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 9.9541547277936979e-6 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + 1.0 * exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) + 1.0 * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V) + exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V) * exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((var_chaste_interface__membrane__V >= -40.0) ? (-0.085984522785898548 * exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__membrane__V))) : (1376317.8223495702 * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 0.00037606796561604589 * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) - 0.034727793696275072 * exp(-0.01052 * var_chaste_interface__membrane__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V)) + 36429.7994269341 * var_chaste_interface__membrane__V * exp(0.24440000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V)) + 9.9541547277936979e-6 * var_chaste_interface__membrane__V * exp(-0.043909999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V))))) * mDt));
        rY[1] = (var_chaste_interface__sodium_current_m_gate__m + ((-11.089411764705883 / (-1.0 + 1.0 * exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V) - 1.0 * exp(-6.9230769230769234 - 0.15384615384615385 * var_chaste_interface__membrane__V) + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V) * exp(-6.9230769230769234 - 0.15384615384615385 * var_chaste_interface__membrane__V)) + 0.058823529411764705 * exp(-0.090909090909090912 * var_chaste_interface__membrane__V) / (1.0 + exp(-6.9230769230769234 - 0.15384615384615385 * var_chaste_interface__membrane__V)) - 0.23529411764705882 * var_chaste_interface__membrane__V / (-1.0 + 1.0 * exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V) - 1.0 * exp(-6.9230769230769234 - 0.15384615384615385 * var_chaste_interface__membrane__V) + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V) * exp(-6.9230769230769234 - 0.15384615384615385 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-11.089411764705883 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.058823529411764705 * exp(-0.090909090909090912 * var_chaste_interface__membrane__V) - 0.23529411764705882 * var_chaste_interface__membrane__V / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__membrane__V))) * mDt));
        rY[11] = (var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss + ((0.004516 * exp(1.7885000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.97292724196277491 - 0.084602368866328256 * var_chaste_interface__membrane__V)) + 0.0098900000000000012 * exp(-3.8000000000000003 - 0.10000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.97292724196277491 - 0.084602368866328256 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.004516 * exp(1.7885000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V) - 0.0098900000000000012 * exp(-3.8000000000000003 - 0.10000000000000001 * var_chaste_interface__membrane__V)) * mDt));
        rY[12] = (var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss + ((0.00047619047619047619 / (1.0 + exp(8.4951456310679614 + 0.097087378640776698 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.00047619047619047619) * mDt));
