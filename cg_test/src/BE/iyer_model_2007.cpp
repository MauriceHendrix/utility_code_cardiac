...
#include "CardiacNewtonSolver.hpp"
    ...
    void Celliyer_model_2007FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time, const double rCurrentGuess[65], double rJacobian[65][65])
    {
        ...
        const double var_x49 = 7.1159095070575419e-7 * var_x45 / (1.0 - 3.773584905660377 * ((var_x48 >= 0.0) ? (0.0) : (var_x48)));
        ...
        const double var_x74 = 0.00074179401705723534 * var_x59;
        ...
        const double var_x133 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 4.0);
        const double var_x134 = 1 / var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaJSR;
        const double var_x135 = pow(var_x134, 2.5);
        const double var_x136 = 1.0 + 1.0 * var_x135;
        const double var_x137 = var_x134 * var_x135 / pow(var_x136, 2);
        const double var_x138 = 136687500000.0 * var_x133 * var_x137 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x139 = pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 3.0);
        const double var_x140 = 1 / var_x136;
        const double var_x141 = 0.5 + 4.5 * var_x140;
        const double var_x142 = 48600000000.0 * var_x139 * var_x141 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C1_RyR;
        const double var_x143 = 12150000000.0 * var_x133 * var_x141;
        const double var_x144 = 0.0090000000000000011 * var_x137 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__C2_RyR;
        const double var_x145 = 0.055555555555555559 * var_x137 * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR / pow((0.1111111111111111 + var_x140), 2);
        const double var_x146 = 0.0036000000000000003 * var_x140;
        const double var_x147 = 0.10000000000000001 / var_x141;
        const double var_x148 = 12150000.0 * pow(var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__CaSS, 2.0) * var_chaste_interface__COMPUTE_DERIVATIVES_OF_RyR_RECEPTOR_STATES__O1_RyR;
        const double var_x149 = 4050000.0 * var_x139;
        const double var_x150 = 0.091225454037165171 * exp(0.033046080388350003 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x151 = 0.21116826991639448 * exp(-0.043060541639799998 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x152 = exp(0.026174127151180001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x153 = 0.10945626585855089 * var_x152;
        const double var_x154 = exp(6.9808923999999997e-7 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x155 = 0.00042769471831999382 * var_x154;
        const double var_x156 = exp(0.0056890885971700002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x157 = exp(-0.045366429595429997 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x158 = exp(-0.026913854983990002 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x159 = 1.6926962184371784e-6 * var_x154 * var_x157 * var_x158 / (var_x152 * var_x156);
        const double var_x160 = 0.0071483033566472664 * var_x158;
        const double var_x161 = 0.034388156021070745 * var_x157;
        const double var_x162 = 0.56744803744318484 * var_x156;
        const double var_x163 = 0.21625575895849999 * exp(-1.8891230210000001e-5 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x164 = 0.0070080662892900002 * exp(-0.14999754700285001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x165 = 0.00767254363063 * exp(0.08662945914655 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x166 = 0.0037973799836799999 * exp(-0.014256681268810001 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x167 = exp(-23.156677820503301);
        const double var_x168 = 8513540195.0827656 * var_x167;
        const double var_x169 = exp(-19.657914992626967 + 0.011298360712115747 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x170 = 34054160780.331062 * var_x169;
        const double var_x171 = exp(-26.232056238852348 - 0.090161609404259865 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x172 = 8513540195.0827656 * var_x171;
        const double var_x173 = exp(-24.35183300086069);
        const double var_x174 = 8513540195.0827656 * var_x173;
        const double var_x175 = 4340999166.2352047 * var_x173;
        const double var_x176 = 23845170420.535503 * var_x169;
        const double var_x177 = 12158498408.695736 * var_x171;
        const double var_x178 = 18237747613.043602 * var_x171;
        const double var_x179 = 16696701353.239271 * var_x167;
        const double var_x180 = 35767755630.803253 * var_x169;
        const double var_x181 = 11922585210.267752 * var_x169;
        const double var_x182 = 3099769910.3661275 * var_x173;
        const double var_x183 = 24316996817.391472 * var_x171;
        const double var_x184 = 23382498943.197018 * var_x167;
        const double var_x185 = 2213447441.3051791 * var_x173;
        const double var_x186 = 8513540195.0827656 * exp(-21.949261959797553 + 0.030147161449011892 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x187 = 8513540195.0827656 * exp(-38.483942906307405 - 0.14399668707161886 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x188 = 32745465422.278648 * var_x167;
        const double var_x189 = 8513540195.0827656 * exp(-39.744904705650839 + 0.0027019947965296331 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x190 = 8513540195.0827656 * exp(-20.6726464954126 + 0.011394696340402199 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x191 = 11922585210.267752 * var_x167;
        const double var_x192 = 25540620585.248295 * var_x169;
        const double var_x193 = 17027080390.165531 * var_x171;
        const double var_x194 = 6079249204.347868 * var_x173;
        const double var_x195 = 17027080390.165531 * var_x169;
        const double var_x196 = 25540620585.248295 * var_x171;
        const double var_x197 = 8513540195.0827656 * var_x169;
        const double var_x198 = 34054160780.331062 * var_x171;
        const double var_x199 = 8513540195.0827656 * exp(-16.535928437145476 + 0.1097131992444229 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x200 = 8513540195.0827656 * exp(-19.672905196314268 + 0.084272054104636354 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x201 = 8513540195.0827656 * exp(-27.092641999412571 - 0.061469636400174388 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x202 = 8513540195.0827656 * exp(-26.358496255772213 - 0.068762962366201316 * var_chaste_interface__COMPUTE_CONCENTRATION_AND_VOLTAGE_DERIVATIVES__V);
        const double var_x203 = 8513540195.0827656 * exp(-26.650781465416159);
        const double var_x204 = 8513540195.0827656 * exp(-22.779658962607588);
        const double var_x205 = 47690340841.071007 * var_x169;
        const double var_x206 = 6079249204.347868 * var_x171;
        ...
        rJacobian[15][15] = 1.0 - (mDt * (-0.13410048761201937 - var_x66));
        rJacobian[15][16] = 0.0;
        rJacobian[15][17] = 0.0;
        rJacobian[15][18] = 0.0;
        rJacobian[15][19] = 0.0;
        ...
        rJacobian[36][63] = 0.0;
        rJacobian[36][64] = 0.0;
        rJacobian[37][0] = -(mDt * (-var_x138));
        rJacobian[37][1] = 0.0;
        rJacobian[37][2] = -(mDt * (-var_x142));
        rJacobian[37][3] = 0.0;
        rJacobian[37][4] = 0.0;
        rJacobian[37][5] = 0.0;
        rJacobian[37][6] = 0.0;
        ...
        rJacobian[37][35] = 0.0;
        rJacobian[37][36] = 0.0;
        rJacobian[37][37] = 1.0 - (mDt * (-var_x143));
        rJacobian[37][38] = 0.0;
        ...
        rJacobian[37][63] = 0.0;
        rJacobian[37][64] = 0.0;
        rJacobian[38][0] = -(mDt * (-var_x144 - var_x145));
        rJacobian[38][1] = 0.0;
        rJacobian[38][2] = 0.0;
        rJacobian[38][3] = 0.0;
        rJacobian[38][4] = 0.0;
        ...
        rJacobian[38][36] = 0.0;
        rJacobian[38][37] = 0.0;
        rJacobian[38][38] = 1.0 - (mDt * (-0.00040000000000000002 - var_x146));
        rJacobian[38][39] = -(mDt * (var_x147));
        rJacobian[38][40] = 0.0;
        rJacobian[38][41] = 0.0;
        rJacobian[38][42] = 0.0;
        rJacobian[38][43] = 0.0;
        ...
        rJacobian[38][63] = 0.0;
        rJacobian[38][64] = 0.0;
        rJacobian[39][0] = -(mDt * (var_x138 + var_x144 + var_x145));
        rJacobian[39][1] = 0.0;
        rJacobian[39][2] = -(mDt * (var_x142 - var_x148));
        rJacobian[39][3] = 0.0;
        rJacobian[39][4] = 0.0;
        rJacobian[39][5] = 0.0;
        rJacobian[39][6] = 0.0;
        ...
        rJacobian[39][35] = 0.0;
        rJacobian[39][36] = 0.0;
        rJacobian[39][37] = -(mDt * (var_x143));
        rJacobian[39][38] = -(mDt * (0.00040000000000000002 + var_x146));
        rJacobian[39][39] = 1.0 - (mDt * (-0.57599999999999996 - var_x147 - var_x149));
        ...
        rJacobian[43][41] = 0.0;
        rJacobian[43][42] = 0.0;
        rJacobian[43][43] = 1.0 - (mDt * (-var_x150));
        rJacobian[43][44] = -(mDt * (var_x151));
        rJacobian[43][45] = 0.0;
        rJacobian[43][46] = 0.0;
        rJacobian[43][47] = 0.0;
        rJacobian[43][48] = 0.0;
        ...
        rJacobian[44][41] = 0.0;
        rJacobian[44][42] = 0.0;
        rJacobian[44][43] = -(mDt * (var_x150));
        rJacobian[44][44] = 1.0 - (mDt * (-0.13876486073161204 - var_x151));
        ...
        rJacobian[45][45] = 1.0 - (mDt * (-0.78911443677844384 - var_x153 - var_x155));
        rJacobian[45][46] = -(mDt * (var_x159));
        rJacobian[45][47] = -(mDt * (var_x160));
        rJacobian[45][48] = 0.0;
        rJacobian[45][49] = 0.0;
        rJacobian[45][50] = 0.0;
        rJacobian[45][51] = 0.0;
        ...
        rJacobian[46][43] = 0.0;
        rJacobian[46][44] = 0.0;
        rJacobian[46][45] = -(mDt * (var_x155));
        rJacobian[46][46] = 1.0 - (mDt * (-var_x159 - var_x161));
        rJacobian[46][47] = -(mDt * (var_x162));
        rJacobian[46][48] = 0.0;
        rJacobian[46][49] = 0.0;
        rJacobian[46][50] = 0.0;
        rJacobian[46][51] = 0.0;
        ...
        rJacobian[47][43] = 0.0;
        rJacobian[47][44] = 0.0;
        rJacobian[47][45] = -(mDt * (var_x153));
        rJacobian[47][46] = -(mDt * (var_x161));
        rJacobian[47][47] = 1.0 - (mDt * (-var_x160 - var_x162));
        rJacobian[47][48] = 0.0;
        rJacobian[47][49] = 0.0;
        rJacobian[47][50] = 0.0;
        rJacobian[47][51] = 0.0;
        ...
        rJacobian[49][49] = 1.0 - (mDt * (-0.039667206760709998 - var_x163));
        rJacobian[49][50] = -(mDt * (var_x164));
        rJacobian[49][51] = 0.0;
        rJacobian[49][52] = 0.0;
        rJacobian[49][53] = 0.0;
        rJacobian[49][54] = 0.0;
        ...
        rJacobian[50][50] = 1.0 - (mDt * (-var_x164 - var_x165));
        rJacobian[50][51] = -(mDt * (var_x166));
        rJacobian[50][52] = 0.0;
        rJacobian[50][53] = 0.0;
        rJacobian[50][54] = 0.0;
        rJacobian[50][55] = 0.0;
        ...
        rJacobian[51][48] = 0.0;
        rJacobian[51][49] = 0.0;
        rJacobian[51][50] = -(mDt * (var_x165));
        rJacobian[51][51] = 1.0 - (mDt * (-var_x166));
        rJacobian[51][52] = 0.0;
        rJacobian[51][53] = 0.0;
        rJacobian[51][54] = 0.0;
        rJacobian[51][55] = 0.0;
        ...
        rJacobian[52][50] = 0.0;
        rJacobian[52][51] = 0.0;
        rJacobian[52][52] = 1.0 - (mDt * (-var_x168 - var_x170));
        rJacobian[52][53] = 0.0;
        rJacobian[52][54] = 0.0;
        rJacobian[52][55] = 0.0;
        rJacobian[52][56] = 0.0;
        rJacobian[52][57] = -(mDt * (var_x172));
        rJacobian[52][58] = 0.0;
        rJacobian[52][59] = 0.0;
        rJacobian[52][60] = 0.0;
        rJacobian[52][61] = 0.0;
        rJacobian[52][62] = 0.0;
        rJacobian[52][63] = -(mDt * (var_x174));
        rJacobian[52][64] = 0.0;
        rJacobian[53][0] = 0.0;
        rJacobian[53][1] = 0.0;
        rJacobian[53][2] = 0.0;
        ...
        rJacobian[53][51] = 0.0;
        rJacobian[53][52] = 0.0;
        rJacobian[53][53] = 1.0 - (mDt * (-var_x175 - var_x176 - var_x177));
        rJacobian[53][54] = -(mDt * (var_x178));
        rJacobian[53][55] = 0.0;
        rJacobian[53][56] = 0.0;
        rJacobian[53][57] = 0.0;
        rJacobian[53][58] = -(mDt * (var_x179));
        rJacobian[53][59] = 0.0;
        rJacobian[53][60] = 0.0;
        rJacobian[53][61] = 0.0;
        rJacobian[53][62] = 0.0;
        rJacobian[53][63] = 0.0;
        rJacobian[53][64] = -(mDt * (var_x180));
        rJacobian[54][0] = 0.0;
        rJacobian[54][1] = 0.0;
        rJacobian[54][2] = 0.0;
        rJacobian[54][3] = 0.0;
        ...
        rJacobian[54][51] = 0.0;
        rJacobian[54][52] = 0.0;
        rJacobian[54][53] = -(mDt * (var_x176));
        rJacobian[54][54] = 1.0 - (mDt * (-var_x178 - var_x181 - var_x182));
        rJacobian[54][55] = -(mDt * (var_x183));
        rJacobian[54][56] = 0.0;
        rJacobian[54][57] = 0.0;
        rJacobian[54][58] = 0.0;
        rJacobian[54][59] = -(mDt * (var_x184));
        rJacobian[54][60] = 0.0;
        rJacobian[54][61] = 0.0;
        rJacobian[54][62] = 0.0;
        rJacobian[54][63] = 0.0;
        ...
        rJacobian[55][52] = 0.0;
        rJacobian[55][53] = 0.0;
        rJacobian[55][54] = -(mDt * (var_x181));
        rJacobian[55][55] = 1.0 - (mDt * (-var_x183 - var_x185 - var_x186));
        rJacobian[55][56] = -(mDt * (var_x187));
        rJacobian[55][57] = 0.0;
        rJacobian[55][58] = 0.0;
        rJacobian[55][59] = 0.0;
        rJacobian[55][60] = -(mDt * (var_x188));
        rJacobian[55][61] = 0.0;
        rJacobian[55][62] = 0.0;
        rJacobian[55][63] = 0.0;
        rJacobian[55][64] = 0.0;
        ...
        rJacobian[56][53] = 0.0;
        rJacobian[56][54] = 0.0;
        rJacobian[56][55] = -(mDt * (var_x186));
        rJacobian[56][56] = 1.0 - (mDt * (-var_x187 - var_x189));
        rJacobian[56][57] = 0.0;
        rJacobian[56][58] = 0.0;
        rJacobian[56][59] = 0.0;
        rJacobian[56][60] = 0.0;
        rJacobian[56][61] = -(mDt * (var_x190));
        rJacobian[56][62] = 0.0;
        rJacobian[56][63] = 0.0;
        rJacobian[56][64] = 0.0;
        rJacobian[57][0] = 0.0;
        ...
        rJacobian[57][50] = 0.0;
        rJacobian[57][51] = 0.0;
        rJacobian[57][52] = -(mDt * (var_x170));
        rJacobian[57][53] = 0.0;
        rJacobian[57][54] = 0.0;
        rJacobian[57][55] = 0.0;
        rJacobian[57][56] = 0.0;
        rJacobian[57][57] = 1.0 - (mDt * (-var_x172 - var_x191 - var_x192));
        rJacobian[57][58] = -(mDt * (var_x193));
        rJacobian[57][59] = 0.0;
        rJacobian[57][60] = 0.0;
        rJacobian[57][61] = 0.0;
        rJacobian[57][62] = 0.0;
        rJacobian[57][63] = 0.0;
        rJacobian[57][64] = -(mDt * (var_x194));
        rJacobian[58][0] = 0.0;
        rJacobian[58][1] = 0.0;
        rJacobian[58][2] = 0.0;
        rJacobian[58][3] = 0.0;
        ...
        rJacobian[58][51] = 0.0;
        rJacobian[58][52] = 0.0;
        rJacobian[58][53] = -(mDt * (var_x175));
        rJacobian[58][54] = 0.0;
        rJacobian[58][55] = 0.0;
        rJacobian[58][56] = 0.0;
        rJacobian[58][57] = -(mDt * (var_x192));
        rJacobian[58][58] = 1.0 - (mDt * (-var_x179 - var_x193 - var_x195));
        rJacobian[58][59] = -(mDt * (var_x196));
        rJacobian[58][60] = 0.0;
        rJacobian[58][61] = 0.0;
        rJacobian[58][62] = 0.0;
        rJacobian[58][63] = 0.0;
        ...
        rJacobian[59][52] = 0.0;
        rJacobian[59][53] = 0.0;
        rJacobian[59][54] = -(mDt * (var_x182));
        rJacobian[59][55] = 0.0;
        rJacobian[59][56] = 0.0;
        rJacobian[59][57] = 0.0;
        rJacobian[59][58] = -(mDt * (var_x195));
        rJacobian[59][59] = 1.0 - (mDt * (-var_x184 - var_x196 - var_x197));
        rJacobian[59][60] = -(mDt * (var_x198));
        rJacobian[59][61] = 0.0;
        rJacobian[59][62] = 0.0;
        rJacobian[59][63] = 0.0;
        rJacobian[59][64] = 0.0;
        ...
        rJacobian[60][53] = 0.0;
        rJacobian[60][54] = 0.0;
        rJacobian[60][55] = -(mDt * (var_x185));
        rJacobian[60][56] = 0.0;
        rJacobian[60][57] = 0.0;
        rJacobian[60][58] = 0.0;
        rJacobian[60][59] = -(mDt * (var_x197));
        rJacobian[60][60] = 1.0 - (mDt * (-var_x188 - var_x198 - var_x199 - var_x200));
        rJacobian[60][61] = -(mDt * (var_x201));
        rJacobian[60][62] = -(mDt * (var_x202));
        rJacobian[60][63] = 0.0;
        rJacobian[60][64] = 0.0;
        rJacobian[61][0] = 0.0;
        rJacobian[61][1] = 0.0;
        ...
        rJacobian[61][54] = 0.0;
        rJacobian[61][55] = 0.0;
        rJacobian[61][56] = -(mDt * (var_x189));
        rJacobian[61][57] = 0.0;
        rJacobian[61][58] = 0.0;
        rJacobian[61][59] = 0.0;
        rJacobian[61][60] = -(mDt * (var_x199));
        rJacobian[61][61] = 1.0 - (mDt * (-var_x190 - var_x201 - var_x203));
        rJacobian[61][62] = -(mDt * (var_x204));
        rJacobian[61][63] = 0.0;
        rJacobian[61][64] = 0.0;
        rJacobian[62][0] = 0.0;
        rJacobian[62][1] = 0.0;
        ...
        rJacobian[62][58] = 0.0;
        rJacobian[62][59] = 0.0;
        rJacobian[62][60] = -(mDt * (var_x200));
        rJacobian[62][61] = -(mDt * (var_x203));
        rJacobian[62][62] = 1.0 - (mDt * (-var_x202 - var_x204));
        rJacobian[62][63] = 0.0;
        rJacobian[62][64] = 0.0;
        rJacobian[63][0] = 0.0;
        rJacobian[63][1] = 0.0;
        ...
        rJacobian[63][61] = 0.0;
        rJacobian[63][62] = 0.0;
        rJacobian[63][63] = 1.0 - (mDt * (-var_x174 - var_x205));
        rJacobian[63][64] = -(mDt * (var_x206));
        rJacobian[64][0] = 0.0;
        rJacobian[64][1] = 0.0;
        rJacobian[64][2] = 0.0;
        rJacobian[64][3] = 0.0;
        ...
        rJacobian[64][51] = 0.0;
        rJacobian[64][52] = 0.0;
        rJacobian[64][53] = -(mDt * (var_x177));
        rJacobian[64][54] = 0.0;
        rJacobian[64][55] = 0.0;
        rJacobian[64][56] = 0.0;
        rJacobian[64][57] = -(mDt * (var_x191));
        rJacobian[64][58] = 0.0;
        rJacobian[64][59] = 0.0;
        rJacobian[64][60] = 0.0;
        rJacobian[64][61] = 0.0;
        rJacobian[64][62] = 0.0;
        rJacobian[64][63] = -(mDt * (var_x205));
        rJacobian[64][64] = 1.0 - (mDt * (-var_x180 - var_x194 - var_x206));
    }
