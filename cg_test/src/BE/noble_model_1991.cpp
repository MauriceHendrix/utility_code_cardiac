...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnoble_model_1991FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[9], double rJacobian[9][9])
    {
        ...
        double var_chaste_interface__transient_outward_current_r_gate__r = rY[7];
        // Units: dimensionless; Initial value: 0.0
        double var_chaste_interface__calcium_release__ActFrac = rCurrentGuess[0];double var_chaste_interface__calcium_release__ProdFrac = rCurrentGuess[1];double var_chaste_interface__intracellular_calcium_concentration__Ca_Calmod = rCurrentGuess[2];double var_chaste_interface__intracellular_calcium_concentration__Ca_Trop = rCurrentGuess[3];double var_chaste_interface__intracellular_calcium_concentration__Ca_i = rCurrentGuess[4];double var_chaste_interface__intracellular_calcium_concentration__Ca_rel = rCurrentGuess[5];double var_chaste_interface__intracellular_calcium_concentration__Ca_up = rCurrentGuess[6];double var_chaste_interface__intracellular_potassium_concentration__K_i = rCurrentGuess[7];double var_chaste_interface__intracellular_sodium_concentration__Na_i = rCurrentGuess[8];
        ...
        const double var_x16 = 0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__intracellular_calcium_concentration__Ca_up + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x17 = 1 / var_x16;
        const double var_x18 = pow(var_x16, (-2));
        const double var_x19 = var_x18 * var_chaste_interface__intracellular_calcium_concentration__Ca_up;
        const double var_x20 = var_x18 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x21 = 0.051020408163265314 * var_x9;
        ...
        const double var_x28 = 0.074867781645490947 * var_chaste_interface__membrane__V;
        ...
        const double var_x30 = var_x22 * var_x26 * pow(var_chaste_interface__intracellular_sodium_concentration__Na_i, 2.0);
        const double var_x31 = 1 / (40.0 + var_chaste_interface__intracellular_sodium_concentration__Na_i);
        const double var_x32 = var_chaste_interface__intracellular_sodium_concentration__Na_i / pow((1 + 0.025000000000000001 * var_chaste_interface__intracellular_sodium_concentration__Na_i), 2);
        const double var_x33 = pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * (0.00085421412300683362 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0071184510250569474 * var_chaste_interface__intracellular_sodium_concentration__Na_i) * var_chaste_interface__fast_sodium_current_h_gate__h / pow((1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i), 2);
        const double var_x34 = var_x29 * exp(1.8716945411372736) / (1.0 - exp(1.8716945411372736 - 0.037433890822745473 * var_chaste_interface__membrane__V));
        const double var_x35 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x36 = log(4.0 * var_x35);
        const double var_x37 = exp(-0.74867781645490938 + var_x28 - 2.0 * var_x36);
        const double var_x38 = 1.0 + var_x37;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.059999999999999998 - 1.0 * var_x2));
        rJacobian[0][1] = -(mDt * (-var_x3));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (-var_x6 + var_x5 * (1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac)));
        rJacobian[0][7] = -(mDt * (0));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[1][0] = -(mDt * (0.059999999999999998 + var_x3));
        rJacobian[1][1] = 1.0 -(mDt * (-0.001));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (var_x6));
        rJacobian[1][7] = -(mDt * (0));
        rJacobian[1][8] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (-var_x10 * var_x11));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.0050000000000000001 - var_x10));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (0));
        rJacobian[2][5] = -(mDt * (0.0050000000000000001));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        rJacobian[3][0] = -(mDt * (0));
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.050000000000000003 + var_x13));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (2.0 - var_x14));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-0.20000000000000001 + var_x13));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (5.0 - var_x15));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        rJacobian[5][0] = -(mDt * (0));
        rJacobian[5][1] = -(mDt * (0));
        rJacobian[5][2] = -(mDt * (0.050000000000000003));
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.050000000000000003 + 8.4671999999999982e-11 * var_x19 - 3.5279999999999993e-7 * var_x17 - 4.7040000000000002e-6 * var_x20));
        rJacobian[5][6] = -(mDt * (0.019599999999999999 * var_x17 + 3.5279999999999993e-7 * var_x19 - 0.019599999999999999 * var_x20));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (var_x11 * var_x21));
        rJacobian[6][1] = -(mDt * (0));
        rJacobian[6][2] = -(mDt * (var_x21));
        rJacobian[6][3] = -(mDt * (0.050000000000000003 + var_x12));
        rJacobian[6][4] = -(mDt * (0.20000000000000001 + var_x12));
        rJacobian[6][5] = -(mDt * (7.2e-9 * var_x17 + 9.5999999999999999e-8 * var_x20 - 1.7279999999999999e-12 * var_x19));
        rJacobian[6][6] = 1.0 -(mDt * (-7.0000000000000009 + var_x14 + var_x15 + 0.00040000000000000002 * var_x20 - 0.86686727535117136 * var_x25 - 7.2e-9 * var_x19 - 1.0549054718227806e-6 * var_x4 - 2.1798047375812981e-9 * var_x27 - 0.00040000000000000002 * var_x17 - 1.1825880081379951e-5 * var_x29 * exp(3.7433890822745473) / (1.0 - exp(3.7433890822745473 - var_x28))));
        rJacobian[6][7] = -(mDt * (1.8954823805054768e-6 * var_x30));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[7][0] = -(mDt * (0));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        ...
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (6.5394142127438948e-9 * var_x27 + 2.6006018260535142 * var_x25));
        rJacobian[7][7] = 1.0 -(mDt * (6.634188331769168e-7 * var_x32 - 1.0127092529498693e-5 / var_chaste_interface__intracellular_sodium_concentration__Na_i - 5.9129400406899753e-8 * var_x34 - 0.0010614701330830668 * var_x31 - 5.9277248272665686 * var_x33 - 5.6864471415164302e-6 * var_x30));
        rJacobian[7][8] = -(mDt * (-0.71132697927198818 * var_x33));
        rJacobian[8][0] = -(mDt * (0));
        rJacobian[8][1] = -(mDt * (0));
        rJacobian[8][2] = -(mDt * (0));
        rJacobian[8][3] = -(mDt * (0));
        ...
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0.00070764675538871125 * var_x31 - 4.4227922211794452e-7 * var_x32));
        rJacobian[8][8] = 1.0 -(mDt * (-1.0127092529498693e-5 * var_x35 - 4.5130532869178019e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 1.1825880081379952e-8 * var_x34 - 0.004822425014046997 * var_x35 / var_x38 - 8.4392437745822447e-5 * var_x35 * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s + 0.00036104426295342415 * var_x35 * var_x37 * (-26.713760659695652 * var_x36 + var_chaste_interface__membrane__V) / pow(var_x38, 2)));
    }
    ...
    void Cellnoble_model_1991FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[4] = (var_chaste_interface__L_type_Ca_channel_d_gate__d + ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.35999999999999999) : (-1.71 / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)) - 0.089999999999999997 * var_chaste_interface__membrane__V / (-1.0 + exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(19.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.71999999999999997) : (-0.68400000000000005 / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 1.71 / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V)) - 0.036000000000000004 * var_chaste_interface__membrane__V / (-1.0 + exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V)) - 0.089999999999999997 * var_chaste_interface__membrane__V / (1.0 - exp(-4.75 - 0.25 * var_chaste_interface__membrane__V))))) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_f_gate__f + ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (0.012500000000000001) : (0.10625 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)) + 0.0031250000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V))))) * mDt)) / (1.0 - ((((fabs(34.0 + var_chaste_interface__membrane__V) < 0.0001) ? (-0.012500000000000001 - 0.025000000000000001 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V))) : (-0.025000000000000001 / (1.0 + exp(-8.5 - 0.25 * var_chaste_interface__membrane__V)) - 0.10625 / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V)) - 0.0031250000000000002 * var_chaste_interface__membrane__V / (-1.0 + exp(8.5 + 0.25 * var_chaste_interface__membrane__V))))) * mDt));
        ...
        rY[1] = (var_chaste_interface__time_dependent_potassium_current_x_gate__x + ((0.00050000000000000001 * exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane__V) / (1.0 + exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.00050000000000000001 * exp(4.1300000000000008 + 0.082600000000000007 * var_chaste_interface__membrane__V) / (1.0 + exp(2.8500000000000001 + 0.057000000000000002 * var_chaste_interface__membrane__V)) - 0.0013000000000000002 * exp(-1.2 - 0.059999999999999998 * var_chaste_interface__membrane__V) / (1.0 + exp(-0.80000000000000004 - 0.040000000000000001 * var_chaste_interface__membrane__V))) * mDt));
