...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rJacobian[16][16])
    {
        ...
        const double var_x40 = 1.4564283541541343e-6 * var_x37;
        const double var_x41 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 2) * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x42 = var_x34 * var_x41;
        const double var_x43 = 4.3692850624624026e-10 * var_x35;
        ...
        const double var_x48 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x51 = var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x48, 2);
        ...
        const double var_x55 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x56 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x57 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x58 = log(var_x57 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x59 = exp(0.20470020580033774 + 0.056861168277871597 * var_chaste_interface__membrane__V - 1.5 * var_x58);
        const double var_x60 = 1.0 + var_x59;
        const double var_x61 = 1 / var_x60;
        const double var_x62 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, (-0.55430000000000001));
        const double var_x63 = var_x61 * var_x62;
        const double var_x64 = -26.380041870925616 * var_x58 + var_chaste_interface__membrane__V;
        const double var_x65 = var_x63 * var_x64;
        const double var_x66 = var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        const double var_x67 = 0.00093956709451467277 * var_x66;
        const double var_x68 = var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        const double var_x69 = 0.0025624557123127439 * var_x68;
        const double var_x70 = var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a / (1.0 + exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V));
        const double var_x71 = 0.00017083038082084959 * var_x70;
        const double var_x72 = var_x59 * var_x64 / pow(var_x60, 2);
        const double var_x73 = var_x62 * var_x72;
        ...
        const double var_x83 = var_x57 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999);
        const double var_x84 = var_x61 * var_x83;
        ...
        const double var_x101 = 0.17614021922566689 * var_x3;
        const double var_x102 = 0.35228043845133378 * var_x5;
        const double var_x103 = 6.6024752054987431e-8 * var_x37;
        const double var_x104 = 1.9807425616496228e-11 * var_x35;
        const double var_x105 = 5.9422276849488674e-11 * var_x35;
        const double var_x106 = 1.9807425616496229e-7 * var_x37;
        ...
        const double var_x109 = 2.3232931791635546e-5 * var_x70;
        const double var_x110 = 0.00012778112485399551 * var_x66;
        const double var_x111 = 0.00034849397687453321 * var_x68;
        const double var_x112 = 1.9807425616496229e-7 * var_x37;
        const double var_x113 = 5.942227684948868e-7 * var_x37;
        const double var_x114 = 1.7826683054846605e-10 * var_x35;
        const double var_x115 = 1.0307938958145768e-5 * var_x97;
        const double var_x116 = var_x115 * var_x95;
        ...
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = -(mDt * (var_x40 * var_x42 + var_x41 * var_x43));
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        rJacobian[5][10] = 0.0;
        rJacobian[5][11] = 0.0;
        rJacobian[5][12] = -(mDt * (var_x47 * (-0.0026226760583233483 + 4.3711267638722472e-5 * var_chaste_interface__membrane__V)));
        rJacobian[5][13] = -(mDt * (2.5902973415539245e-5 * var_x49 + 6.7205525966826332e-6 * var_x50 - 2.5902973415539245e-5 * var_x51 + var_x29 * var_x36 + var_x38 * var_x52));
        rJacobian[5][14] = 0.0;
        rJacobian[5][15] = -(mDt * (var_x43 * var_x53 - var_x40 * var_x54));
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = 0.0;
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-0.0001 + 1.7317432876958762e-5 * var_x65 + 0.0018345858630475916 * var_x82 + 5.8281690184963299e-5 * var_x73 - 0.0010249822849250976 * var_x63 - 0.0018345858630475916 * var_x81 - var_x55 * var_x56 - var_x55 * var_x67 - var_x55 * var_x69 - var_x55 * var_x71));
        rJacobian[6][7] = 0.0;
        rJacobian[6][8] = 0.0;
        rJacobian[6][9] = 0.0;
        rJacobian[6][10] = 0.0;
        ...
        rJacobian[6][12] = 0.0;
        rJacobian[6][13] = 0.0;
        rJacobian[6][14] = -(mDt * (0.0010249822849250976 * var_x84 - 5.8281690184963299e-5 * var_x85 + var_x56 * var_x57 + var_x57 * var_x67 + var_x57 * var_x69 + var_x57 * var_x71));
        rJacobian[6][15] = -(mDt * (2.067527268648676e-6 * var_x86 - 0.0027518787945713876 * var_x87));
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = 0.0;
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = -(mDt * (var_x39 * var_x40 - var_x28 * var_x88));
        rJacobian[7][6] = -(mDt * (0.0027518787945713876 * var_x81 - 0.0027518787945713876 * var_x82));
        rJacobian[7][7] = 1.0 - (mDt * (-6.993006993006993e-5 - var_x99 - 2.0704300494725328e-5 * var_x89 + var_x96 * var_x98 - var_x41 * var_x91 - var_x42 * var_x90));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = 0.0;
        rJacobian[7][11] = 0.0;
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = -(mDt * (-var_x29 * var_x88 - var_x40 * var_x52));
        rJacobian[7][14] = 0.0;
        rJacobian[7][15] = -(mDt * (0.0041278181918570815 * var_x87 + 2.0704300494725328e-5 * var_x93 - 3.1012909029730135e-6 * var_x86 + var_x54 * var_x90 + var_x94 * var_x99 - var_x53 * var_x91));
        rJacobian[8][0] = 0.0;
        rJacobian[8][1] = 0.0;
        rJacobian[8][2] = 0.0;
        rJacobian[8][3] = 0.0;
        ...
        rJacobian[8][6] = 0.0;
        rJacobian[8][7] = 0.0;
        rJacobian[8][8] = 1.0 - (mDt * (-0.47600000000000003 + var_x100));
        rJacobian[8][9] = 0.0;
        rJacobian[8][10] = 0.0;
        rJacobian[8][11] = 0.0;
        rJacobian[8][12] = 0.0;
        ...
        rJacobian[12][10] = 0.0;
        rJacobian[12][11] = 0.0;
        rJacobian[12][12] = 1.0 - (mDt * (-0.10000000000000001 + var_x47 * (0.017834197196598772 - 0.00029723661994331287 * var_chaste_interface__membrane__V)));
        rJacobian[12][13] = -(mDt * (0.10000000000000001));
        rJacobian[12][14] = 0.0;
        rJacobian[12][15] = 0.0;
        rJacobian[13][0] = -(mDt * (var_x101));
        rJacobian[13][1] = -(mDt * (1.7754934097947219e-10 * var_x11 + 0.00078910818213098765 * var_x10));
        rJacobian[13][2] = 0.0;
        rJacobian[13][3] = -(mDt * (var_x102 * var_x8 - var_x102 * var_x7));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = -(mDt * (9.1399515314883825e-7 * var_x27 + var_x103 * var_x39 - var_x104 * var_x28));
        rJacobian[13][6] = 0.0;
        rJacobian[13][7] = -(mDt * (-var_x105 * var_x41 - var_x106 * var_x42));
        ...
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = -(mDt * (0.00013939759074981328 * var_x63 + 0.00024950367737447247 * var_x81 - 7.9263098651550091e-6 * var_x73 - 2.3551708712663917e-6 * var_x65 - 0.00024950367737447247 * var_x82 + var_x108 * var_x55 + var_x109 * var_x55 + var_x110 * var_x55 + var_x111 * var_x55));
        rJacobian[14][7] = 0.0;
        rJacobian[14][8] = 0.0;
        rJacobian[14][9] = 0.0;
        rJacobian[14][10] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (7.9263098651550091e-6 * var_x85 - 0.00013939759074981328 * var_x84 - var_x108 * var_x57 - var_x109 * var_x57 - var_x110 * var_x57 - var_x111 * var_x57));
        ...
        rJacobian[15][3] = 0.0;
        rJacobian[15][4] = 0.0;
        rJacobian[15][5] = -(mDt * (var_x105 * var_x28 - var_x112 * var_x39));
        rJacobian[15][6] = -(mDt * (0.00037425551606170871 * var_x82 - 0.00037425551606170871 * var_x81));
        rJacobian[15][7] = -(mDt * (var_x116 + 2.8157848672826448e-6 * var_x89 + var_x113 * var_x42 + var_x114 * var_x41 - var_x115 * var_x96));
        rJacobian[15][8] = 0.0;
        rJacobian[15][9] = 0.0;
        rJacobian[15][10] = 0.0;
        rJacobian[15][11] = 0.0;
        rJacobian[15][12] = 0.0;
        rJacobian[15][13] = -(mDt * (var_x105 * var_x29 + var_x112 * var_x52));
        rJacobian[15][14] = 0.0;
        rJacobian[15][15] = 1.0 - (mDt * (4.2177556280432989e-7 * var_x86 - 0.00056138327409256303 * var_x87 - 2.8157848672826448e-6 * var_x93 + var_x114 * var_x53 - var_x113 * var_x54 - var_x116 * var_x94));
    }
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        rY[8] = (var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + ((0.001 / (0.0015 + 0.0015 * exp(0.090909090909090912 - 0.090909090909090912 * var_chaste_interface__membrane__V) + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2)) + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2)) * exp(0.090909090909090912 - 0.090909090909090912 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.0015 + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
        rY[9] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + ((0.001 / (0.01414 + 0.01414 * exp(3.5217391304347827 + 0.086956521739130432 * var_chaste_interface__membrane__V) + 0.48120000000000002 * exp(-12.275731601256398 - 0.46809272073427638 * var_chaste_interface__membrane__V - 0.0044622756981341884 * pow(var_chaste_interface__membrane__V, 2)) + 0.48120000000000002 * exp(3.5217391304347827 + 0.086956521739130432 * var_chaste_interface__membrane__V) * exp(-12.275731601256398 - 0.46809272073427638 * var_chaste_interface__membrane__V - 0.0044622756981341884 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-0.001 / (0.01414 + 0.48120000000000002 * exp(-12.275731601256398 - 0.46809272073427638 * var_chaste_interface__membrane__V - 0.0044622756981341884 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + ((0.001 / (0.002 + 0.002 * exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V) + 0.0027000000000000001 * exp(-1.3611111111111112 - 0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2) - 0.077777777777777779 * var_chaste_interface__membrane__V) + 0.0027000000000000001 * exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V) * exp(-1.3611111111111112 - 0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2) - 0.077777777777777779 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.002 + 0.0027000000000000001 * exp(-1.3611111111111112 - 0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2) - 0.077777777777777779 * var_chaste_interface__membrane__V))) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1 + ((0.001 / (0.01 + 0.01 * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V) + 0.161 * exp(-7.716049382716049 - 0.0048225308641975306 * pow(var_chaste_interface__membrane__V, 2) - 0.38580246913580246 * var_chaste_interface__membrane__V) + 0.161 * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V) * exp(-7.716049382716049 - 0.0048225308641975306 * pow(var_chaste_interface__membrane__V, 2) - 0.38580246913580246 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.01 + 0.161 * exp(-7.716049382716049 - 0.0048225308641975306 * pow(var_chaste_interface__membrane__V, 2) - 0.38580246913580246 * var_chaste_interface__membrane__V))) * mDt));
        rY[7] = (var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2 + ((0.001 / (0.062600000000000003 + 1.3323 * exp(-7.9349335449315621 - 0.0049593334655822262 * pow(var_chaste_interface__membrane__V, 2) - 0.39674667724657808 * var_chaste_interface__membrane__V) + 0.062600000000000003 * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V) + 1.3323 * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V) * exp(-7.9349335449315621 - 0.0049593334655822262 * pow(var_chaste_interface__membrane__V, 2) - 0.39674667724657808 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.062600000000000003 + 1.3323 * exp(-7.9349335449315621 - 0.0049593334655822262 * pow(var_chaste_interface__membrane__V, 2) - 0.39674667724657808 * var_chaste_interface__membrane__V))) * mDt));
        rY[12] = (var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + ((0.001 / (0.69999999999999996 + 0.69999999999999996 * exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V) + 0.40000000000000002 * exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 0.0025000000000000001 * pow(var_chaste_interface__membrane__V, 2)) + 0.40000000000000002 * exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V) * exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 0.0025000000000000001 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-0.001 / (0.69999999999999996 + 0.40000000000000002 * exp(-1.0 + 0.10000000000000001 * var_chaste_interface__membrane__V - 0.0025000000000000001 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
        rY[13] = (var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a + ((0.001 / (0.031179999999999999 + 0.031179999999999999 * exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V) + 0.21718000000000001 * exp(-0.82285842787521646 - 0.081723584525982884 * var_chaste_interface__membrane__V - 0.0020291292042245077 * pow(var_chaste_interface__membrane__V, 2)) + 0.21718000000000001 * exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V) * exp(-0.82285842787521646 - 0.081723584525982884 * var_chaste_interface__membrane__V - 0.0020291292042245077 * pow(var_chaste_interface__membrane__V, 2)))) * mDt)) / (1.0 - ((-0.001 / (0.031179999999999999 + 0.21718000000000001 * exp(-0.82285842787521646 - 0.081723584525982884 * var_chaste_interface__membrane__V - 0.0020291292042245077 * pow(var_chaste_interface__membrane__V, 2)))) * mDt));
        ...
        rY[2] = (var_chaste_interface__sodium_current_m_gate__m + ((0.001 / (2.4000000000000001e-5 + 2.4000000000000001e-5 * exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V) + 4.1999999999999998e-5 * exp(-0.78827269000771605 - 0.0012056327160493826 * pow(var_chaste_interface__membrane__V, 2) - 0.061656057098765427 * var_chaste_interface__membrane__V) + 4.1999999999999998e-5 * exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V) * exp(-0.78827269000771605 - 0.0012056327160493826 * pow(var_chaste_interface__membrane__V, 2) - 0.061656057098765427 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (2.4000000000000001e-5 + 4.1999999999999998e-5 * exp(-0.78827269000771605 - 0.0012056327160493826 * pow(var_chaste_interface__membrane__V, 2) - 0.061656057098765427 * var_chaste_interface__membrane__V))) * mDt));
