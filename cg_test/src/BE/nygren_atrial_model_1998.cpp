...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeResidual(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rResidual[16])
    {
        ...
        const double var_Ca_handling_by_the_SR__r_act = 203.80000000000001 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_d / (var_Ca_handling_by_the_SR__k_rel_d + var_chaste_interface__intracellular_ion_concentrations__Ca_d)), 4.0) + 203.80000000000001 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_i / (var_Ca_handling_by_the_SR__k_rel_i + var_chaste_interface__intracellular_ion_concentrations__Ca_i)), 4.0); // per_second
        ...
        const double var_Ca_handling_by_the_SR__r_inact = 33.960000000000001 + 339.60000000000002 * pow((var_chaste_interface__intracellular_ion_concentrations__Ca_i / (var_Ca_handling_by_the_SR__k_rel_i + var_chaste_interface__intracellular_ion_concentrations__Ca_i)), 4.0); // per_second
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__environment__time_converted, const double rCurrentGuess[16], double rJacobian[16][16])
    {
        ...
        double var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a = rY[13];
        // Units: dimensionless; Initial value: 0.0001
        double var_chaste_interface__Ca_handling_by_the_SR__Ca_rel = rCurrentGuess[0];double var_chaste_interface__Ca_handling_by_the_SR__Ca_up = rCurrentGuess[1];double var_chaste_interface__Ca_handling_by_the_SR__F1 = rCurrentGuess[2];double var_chaste_interface__Ca_handling_by_the_SR__F2 = rCurrentGuess[3];double var_chaste_interface__Ca_handling_by_the_SR__O_Calse = rCurrentGuess[4];double var_chaste_interface__cleft_space_ion_concentrations__Ca_c = rCurrentGuess[5];double var_chaste_interface__cleft_space_ion_concentrations__K_c = rCurrentGuess[6];double var_chaste_interface__cleft_space_ion_concentrations__Na_c = rCurrentGuess[7];double var_chaste_interface__intracellular_Ca_buffering__O_C = rCurrentGuess[8];double var_chaste_interface__intracellular_Ca_buffering__O_TC = rCurrentGuess[9];double var_chaste_interface__intracellular_Ca_buffering__O_TMgC = rCurrentGuess[10];double var_chaste_interface__intracellular_Ca_buffering__O_TMgMg = rCurrentGuess[11];double var_chaste_interface__intracellular_ion_concentrations__Ca_d = rCurrentGuess[12];double var_chaste_interface__intracellular_ion_concentrations__Ca_i = rCurrentGuess[13];double var_chaste_interface__intracellular_ion_concentrations__K_i = rCurrentGuess[14];double var_chaste_interface__intracellular_ion_concentrations__Na_i = rCurrentGuess[15];

        const double var_x0 = 0.0030000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x1 = 1 / var_x0;
        const double var_x2 = 0.20380000000000001 * pow((var_x1 * var_chaste_interface__intracellular_ion_concentrations__Ca_d), 4.0);
        const double var_x3 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x4 = 1 / var_x3;
        const double var_x5 = pow((var_x4 * var_chaste_interface__intracellular_ion_concentrations__Ca_i), 4.0);
        const double var_x6 = 0.20380000000000001 * var_x5;
        const double var_x7 = var_x0 * var_x2 * (4.0 * var_x1 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_d / pow(var_x0, 2)) * var_chaste_interface__Ca_handling_by_the_SR__F1 / var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x8 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x9 = var_x3 * var_x8 * (4.0 * var_x4 - 4.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x3, 2));
        const double var_x10 = var_x6 * var_x9 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x11 = 0.33960000000000001 * var_x5;
        const double var_x12 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x13 = 0.25 + var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x14 = 1 / var_x13;
        const double var_x15 = pow((var_x14 * var_chaste_interface__Ca_handling_by_the_SR__F2), 2.0);
        const double var_x16 = 23.501339000540224 * var_x15;
        const double var_x17 = var_x13 * (-var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel) * (2.0 * var_x14 - 2.0 * var_chaste_interface__Ca_handling_by_the_SR__F2 / pow(var_x13, 2)) / var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x18 = 3333.3333333333335 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x19 = 1 / (1.3999999999999999 + var_x18 + 0.80000000000000004 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up);
        const double var_x20 = (var_x18 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        const double var_x21 = 0.025000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x22 = 1 / var_x21;
        const double var_x23 = var_chaste_interface__intracellular_ion_concentrations__Ca_d / pow(var_x21, 2);
        const double var_x24 = (var_x22 * var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1 + (var_x23 - var_x22) * var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2 - var_x23 * var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x25 = 1 / var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x26 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3.0);
        const double var_x27 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 3.0);
        const double var_x28 = var_x27 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x29 = var_x26 * var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x30 = 1.0 + 0.00029999999999999997 * var_x28 + 0.00029999999999999997 * var_x29;
        const double var_x31 = exp(0.017058350483361479 * var_chaste_interface__membrane__V);
        const double var_x32 = exp(-0.020849095035219586 * var_chaste_interface__membrane__V);
        const double var_x33 = (var_x29 * var_x31 - var_x28 * var_x32) / pow(var_x30, 2);
        const double var_x34 = 1.4564283541541343e-10 * var_x33;
        const double var_x35 = 1 / var_x30;
        const double var_x36 = 4.8547611805137808e-7 * var_x35;
        const double var_x37 = var_x26 * var_x31;
        const double var_x38 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x39 = 1 / var_x38;
        const double var_x40 = var_chaste_interface__intracellular_ion_concentrations__Ca_i / pow(var_x38, 2);
        const double var_x41 = var_x27 * var_x32;
        const double var_x42 = 1.4564283541541343e-6 * var_x35;
        const double var_x43 = pow(var_chaste_interface__cleft_space_ion_concentrations__Na_c, 2.0) * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x44 = var_x32 * var_x43;
        const double var_x45 = 4.3692850624624026e-10 * var_x33;
        const double var_x46 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0);
        const double var_x47 = var_x46 * var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x48 = var_x31 * var_x47;
        const double var_x49 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x50 = 0.17614021922566689 * var_x15;
        const double var_x51 = 6.6024752054987431e-8 * var_x35;
        const double var_x52 = 1.9807425616496228e-11 * var_x33;
        const double var_x53 = 5.9422276849488674e-11 * var_x33;
        const double var_x54 = 1.9807425616496229e-7 * var_x35;
        const double var_x55 = 4.3692850624624026e-10 * var_x33;
        const double var_x56 = 1 / var_chaste_interface__cleft_space_ion_concentrations__Na_c;
        const double var_x57 = 4.369285062462403e-6 * var_x35;
        const double var_x58 = 1.3107855187387207e-9 * var_x33;
        const double var_x59 = 0.037907445518581065 * var_chaste_interface__membrane__V;
        ...
        const double var_x62 = exp(var_x59 - 1.0 * log(var_x61));
        const double var_x63 = -1.0 + var_x62;
        const double var_x64 = pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * (0.10000000000000001 * var_chaste_interface__sodium_current_h2_gate__h2 + 0.90000000000000002 * var_chaste_interface__sodium_current_h1_gate__h1) * var_chaste_interface__membrane__V / (-1.0 + exp(var_x59));
        const double var_x65 = 7.5793668809895348e-5 * var_x64;
        const double var_x66 = var_x62 * var_x65;
        const double var_x67 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 1.5);
        const double var_x68 = 1 / (36.4828726939094 + var_x67);
        const double var_x69 = 1.0 + var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x70 = 1 / (200.0 + var_chaste_interface__membrane__V);
        const double var_x71 = 150.0 + var_chaste_interface__membrane__V;
        const double var_x72 = var_x70 * var_x71 / var_x69;
        const double var_x73 = var_x68 * var_x72;
        const double var_x74 = var_x73 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 0.5) * var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x75 = var_x46 * var_x72 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x67), 2);
        const double var_x76 = var_x67 * var_x73;
        const double var_x77 = var_x67 * var_x68 * var_x70 * var_x71 * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow(var_x69, 2);
        const double var_x78 = 1.9807425616496229e-7 * var_x35;
        const double var_x79 = 5.942227684948868e-7 * var_x35;
        const double var_x80 = 1.7826683054846605e-10 * var_x33;
        const double var_x81 = 1.0307938958145768e-5 * var_x64;
        const double var_x82 = var_x62 * var_x81;
        const double var_x83 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x84 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x85 = 1 / var_chaste_interface__intracellular_ion_concentrations__K_i;
        const double var_x86 = log(var_x85 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x87 = exp(0.20470020580033774 + 0.056861168277871597 * var_chaste_interface__membrane__V - 1.5 * var_x86);
        const double var_x88 = 1.0 + var_x87;
        const double var_x89 = 1 / var_x88;
        const double var_x90 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, (-0.55430000000000001));
        const double var_x91 = var_x89 * var_x90;
        const double var_x92 = -26.380041870925616 * var_x86 + var_chaste_interface__membrane__V;
        const double var_x93 = var_x91 * var_x92;
        const double var_x94 = var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        const double var_x95 = 0.00093956709451467277 * var_x94;
        const double var_x96 = var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        const double var_x97 = 0.0025624557123127439 * var_x96;
        const double var_x98 = var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a / (1.0 + exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V));
        const double var_x99 = 0.00017083038082084959 * var_x98;
        const double var_x100 = var_x87 * var_x92 / pow(var_x88, 2);
        const double var_x101 = var_x100 * var_x90;
        const double var_x102 = var_x85 * pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999);
        const double var_x103 = var_x102 * var_x89;
        const double var_x104 = var_x100 * var_x102;
        const double var_x105 = 4.6465863583271093e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x106 = 2.3232931791635546e-5 * var_x98;
        const double var_x107 = 0.00012778112485399551 * var_x94;
        const double var_x108 = 0.00034849397687453321 * var_x96;
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.40000000000000002 - 0.47999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_rel));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (0));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        rJacobian[0][7] = -(mDt * (0.47999999999999998 - 0.47999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse));
        rJacobian[0][8] = -(mDt * (0));
        rJacobian[0][9] = -(mDt * (0));
        ...
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-5.6660000000000004));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        rJacobian[1][6] = -(mDt * (-5.0));
        rJacobian[1][7] = -(mDt * (0));
        rJacobian[1][8] = -(mDt * (0));
        rJacobian[1][9] = -(mDt * (0));
        ...
        rJacobian[2][0] = -(mDt * (0));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (-0.00081499999999999997 - var_x2 - var_x6));
        ...
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        rJacobian[2][9] = -(mDt * (-var_x7));
        rJacobian[2][10] = -(mDt * (0));
        rJacobian[2][11] = -(mDt * (-var_x10));
        ...
        rJacobian[3][0] = -(mDt * (0));
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (var_x2 + var_x6));
        rJacobian[3][3] = 1.0 -(mDt * (-0.033960000000000004 - var_x11));
        rJacobian[3][4] = -(mDt * (0));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        rJacobian[3][9] = -(mDt * (var_x7));
        rJacobian[3][10] = -(mDt * (0));
        rJacobian[3][11] = -(mDt * (var_x10 - var_x11 * var_x9 * var_chaste_interface__Ca_handling_by_the_SR__F2));
        ...
        rJacobian[4][2] = -(mDt * (0));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (-0.47600000000000003 + var_x12));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        ...
        rJacobian[4][11] = -(mDt * (200.0 - 200.0 * var_chaste_interface__intracellular_Ca_buffering__O_C));
        ...
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-0.39200000000000002 - 78.400000000000006 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[5][6] = -(mDt * (0));
        rJacobian[5][7] = -(mDt * (0));
        rJacobian[5][8] = -(mDt * (0));
        rJacobian[5][9] = -(mDt * (0));
        rJacobian[5][10] = -(mDt * (0));
        rJacobian[5][11] = -(mDt * (78.400000000000006 - 78.400000000000006 * var_chaste_interface__intracellular_Ca_buffering__O_TC));
        rJacobian[5][12] = -(mDt * (0));
        rJacobian[5][13] = -(mDt * (0));
        rJacobian[5][14] = -(mDt * (0));
        rJacobian[5][15] = -(mDt * (0));
        rJacobian[6][0] = -(mDt * (0));
        rJacobian[6][1] = -(mDt * (var_x12));
        rJacobian[6][2] = -(mDt * (0));
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0));
        rJacobian[6][6] = 1.0 -(mDt * (-0.0066 + var_x12));
        rJacobian[6][7] = -(mDt * (0));
        rJacobian[6][8] = -(mDt * (0));
        rJacobian[6][9] = -(mDt * (0));
        rJacobian[6][10] = -(mDt * (0));
        rJacobian[6][11] = -(mDt * (200.0 - 200.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC - 200.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg));
        rJacobian[6][12] = -(mDt * (0));
        rJacobian[6][13] = -(mDt * (0));
        rJacobian[6][14] = -(mDt * (0));
        rJacobian[6][15] = -(mDt * (0));
        rJacobian[7][0] = -(mDt * (12.4 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__Ca_rel));
        rJacobian[7][1] = -(mDt * (0));
        rJacobian[7][2] = -(mDt * (0));
        rJacobian[7][3] = -(mDt * (-var_x16 * var_x17));
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (0));
        rJacobian[7][7] = 1.0 -(mDt * (-14.98 - var_x16 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse));
        rJacobian[7][8] = -(mDt * (0.10000000000000001));
        rJacobian[7][9] = -(mDt * (0));
        rJacobian[7][10] = -(mDt * (0));
        rJacobian[7][11] = -(mDt * (var_x16));
        ...
        rJacobian[8][5] = -(mDt * (0));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (0.011111111111111112));
        rJacobian[8][8] = 1.0 -(mDt * (-0.011111111111111112 - 2.632149968060505e-9 * var_x20 - 0.011698444302491135 * var_x19));
        rJacobian[8][9] = -(mDt * (0));
        rJacobian[8][10] = -(mDt * (0));
        rJacobian[8][11] = -(mDt * (121.858794817616 * var_x19 - 1.0967291533585438e-5 * var_x20));
        ...
        rJacobian[9][7] = -(mDt * (0));
        rJacobian[9][8] = -(mDt * (0));
        rJacobian[9][9] = 1.0 -(mDt * (-0.10000000000000001 + var_x24 * (0.017834197196598772 - 0.00029723661994331287 * var_chaste_interface__membrane__V)));
        rJacobian[9][10] = -(mDt * (0));
        rJacobian[9][11] = -(mDt * (0.10000000000000001));
        ...
        rJacobian[10][9] = -(mDt * (var_x24 * (-0.0026226760583233483 + 4.3711267638722472e-5 * var_chaste_interface__membrane__V)));
        rJacobian[10][10] = 1.0 -(mDt * (-4.048582995951417e-5 - 6.7205525966826332e-6 * var_x25 + var_x26 * var_x34 - var_x36 * var_x37));
        rJacobian[10][11] = -(mDt * (2.5902973415539245e-5 * var_x39 + 6.7205525966826332e-6 * var_x8 - 2.5902973415539245e-5 * var_x40 + var_x27 * var_x34 + var_x36 * var_x41));
        rJacobian[10][12] = -(mDt * (var_x42 * var_x44 + var_x43 * var_x45));
        rJacobian[10][13] = -(mDt * (var_x45 * var_x47 - var_x42 * var_x48));
        rJacobian[10][14] = -(mDt * (0));
        rJacobian[10][15] = -(mDt * (0));
        rJacobian[11][0] = -(mDt * (0));
        rJacobian[11][1] = -(mDt * (var_x49));
        rJacobian[11][2] = -(mDt * (0));
        rJacobian[11][3] = -(mDt * (var_x17 * var_x50));
        rJacobian[11][4] = -(mDt * (0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[11][5] = -(mDt * (0.031359999999999999 + 6.2720000000000002 * var_chaste_interface__intracellular_ion_concentrations__Ca_i));
        rJacobian[11][6] = -(mDt * (0.0010560000000000001 + var_x49));
        rJacobian[11][7] = -(mDt * (var_x50));
        rJacobian[11][8] = -(mDt * (1.7754934097947219e-10 * var_x20 + 0.00078910818213098765 * var_x19));
        rJacobian[11][9] = -(mDt * (0.002));
        rJacobian[11][10] = -(mDt * (9.1399515314883825e-7 * var_x25 + var_x37 * var_x51 - var_x26 * var_x52));
        rJacobian[11][11] = 1.0 -(mDt * (-47.274000000000001 - var_x50 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 7.3978892074780085e-7 * var_x20 + 3.5228043845133373e-6 * var_x40 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC - 3.5228043845133373e-6 * var_x39 - 8.2198768971977891 * var_x19 - 9.1399515314883825e-7 * var_x8 - var_x27 * var_x52 - var_x41 * var_x51));
        rJacobian[11][12] = -(mDt * (-var_x43 * var_x53 - var_x44 * var_x54));
        rJacobian[11][13] = -(mDt * (var_x48 * var_x54 - var_x47 * var_x53));
        ...
        rJacobian[12][10] = -(mDt * (var_x37 * var_x42 - var_x26 * var_x55));
        rJacobian[12][11] = -(mDt * (-var_x27 * var_x55 - var_x41 * var_x42));
        rJacobian[12][12] = 1.0 -(mDt * (-6.993006993006993e-5 - var_x66 - 2.0704300494725328e-5 * var_x56 + var_x63 * var_x65 - var_x43 * var_x58 - var_x44 * var_x57));
        rJacobian[12][13] = -(mDt * (0.0041278181918570815 * var_x74 + 2.0704300494725328e-5 * var_x60 - 3.1012909029730135e-6 * var_x75 + var_x48 * var_x57 + var_x61 * var_x66 - var_x47 * var_x58));
        rJacobian[12][14] = -(mDt * (0.0027518787945713876 * var_x76 - 0.0027518787945713876 * var_x77));
        ...
        rJacobian[13][10] = -(mDt * (var_x26 * var_x53 - var_x37 * var_x78));
        rJacobian[13][11] = -(mDt * (var_x27 * var_x53 + var_x41 * var_x78));
        rJacobian[13][12] = -(mDt * (var_x82 + 2.8157848672826448e-6 * var_x56 + var_x43 * var_x80 + var_x44 * var_x79 - var_x63 * var_x81));
        rJacobian[13][13] = 1.0 -(mDt * (4.2177556280432989e-7 * var_x75 - 0.00056138327409256303 * var_x74 - 2.8157848672826448e-6 * var_x60 + var_x47 * var_x80 - var_x48 * var_x79 - var_x61 * var_x82));
        rJacobian[13][14] = -(mDt * (0.00037425551606170871 * var_x77 - 0.00037425551606170871 * var_x76));
        ...
        rJacobian[14][13] = -(mDt * (2.067527268648676e-6 * var_x75 - 0.0027518787945713876 * var_x74));
        rJacobian[14][14] = 1.0 -(mDt * (-0.0001 + 1.7317432876958762e-5 * var_x93 + 0.0018345858630475916 * var_x77 + 5.8281690184963299e-5 * var_x101 - 0.0010249822849250976 * var_x91 - 0.0018345858630475916 * var_x76 - var_x83 * var_x84 - var_x83 * var_x95 - var_x83 * var_x97 - var_x83 * var_x99));
        rJacobian[14][15] = -(mDt * (0.0010249822849250976 * var_x103 - 5.8281690184963299e-5 * var_x104 + var_x84 * var_x85 + var_x85 * var_x95 + var_x85 * var_x97 + var_x85 * var_x99));
        ...
        rJacobian[15][13] = -(mDt * (0.00037425551606170871 * var_x74 - 2.8118370853621991e-7 * var_x75));
        rJacobian[15][14] = -(mDt * (0.00013939759074981328 * var_x91 + 0.00024950367737447247 * var_x76 - 7.9263098651550091e-6 * var_x101 - 2.3551708712663917e-6 * var_x93 - 0.00024950367737447247 * var_x77 + var_x105 * var_x83 + var_x106 * var_x83 + var_x107 * var_x83 + var_x108 * var_x83));
        rJacobian[15][15] = 1.0 -(mDt * (7.9263098651550091e-6 * var_x104 - 0.00013939759074981328 * var_x103 - var_x105 * var_x85 - var_x106 * var_x85 - var_x107 * var_x85 - var_x108 * var_x85));
    }
    ...
    void Cellnygren_atrial_model_1998FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__environment__time_converted)
    {
        ...
        //const double var_Ca_independent_transient_outward_K_current_r_gate__tau_r = 0.0015 + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2.0)); // second
        ...
        //const double var_Ca_independent_transient_outward_K_current_s_gate__tau_s = 0.01414 + 0.48120000000000002 * exp(-12.275731601256398 * pow((1 + 0.019065776930409912 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        //const double var_L_type_Ca_channel_d_L_gate__tau_d_L = 0.002 + 0.0027000000000000001 * exp(-1.3611111111111112 * pow((1 + 0.028571428571428571 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        //const double var_L_type_Ca_channel_f_L1_gate__tau_f_L1 = 0.01 + 0.161 * exp(-7.716049382716049 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        //const double var_L_type_Ca_channel_f_L2_gate__tau_f_L2 = 0.062600000000000003 + 1.3323 * exp(-7.9349335449315621 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        //const double var_delayed_rectifier_K_currents_n_gate__tau_n = 0.69999999999999996 + 0.40000000000000002 * exp(-pow((-1.0 + 0.050000000000000003 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        //const double var_delayed_rectifier_K_currents_pa_gate__tau_p_a = 0.031179999999999999 + 0.21718000000000001 * exp(-0.82285842787521646 * pow((1 + 0.049658350548228189 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        //const double var_sodium_current_m_gate__tau_m = 2.4000000000000001e-5 + 4.1999999999999998e-5 * exp(-0.78827269000771605 * pow((1 + 0.039108330074305829 * var_chaste_interface__membrane__V), 2.0)); // second
        ...
        rY[8] = (var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + ((0.001 / (0.0015 + 0.0015 * exp(0.090909090909090912 - 0.090909090909090912 * var_chaste_interface__membrane__V) + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2.0)) + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2.0)) * exp(0.090909090909090912 - 0.090909090909090912 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.0015 + 0.0035000000000000001 * exp(-0.0011111111111111111 * pow(var_chaste_interface__membrane__V, 2.0)))) * mDt));
        rY[9] = (var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + ((0.001 / (0.01414 + 0.01414 * exp(3.5217391304347827 + 0.086956521739130432 * var_chaste_interface__membrane__V) + 0.48120000000000002 * exp(-12.275731601256398 * pow((1 + 0.019065776930409912 * var_chaste_interface__membrane__V), 2.0)) + 0.48120000000000002 * exp(-12.275731601256398 * pow((1 + 0.019065776930409912 * var_chaste_interface__membrane__V), 2.0)) * exp(3.5217391304347827 + 0.086956521739130432 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.01414 + 0.48120000000000002 * exp(-12.275731601256398 * pow((1 + 0.019065776930409912 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[5] = (var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + ((0.001 / (0.002 + 0.002 * exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V) + 0.0027000000000000001 * exp(-1.3611111111111112 * pow((1 + 0.028571428571428571 * var_chaste_interface__membrane__V), 2.0)) + 0.0027000000000000001 * exp(-1.3611111111111112 * pow((1 + 0.028571428571428571 * var_chaste_interface__membrane__V), 2.0)) * exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.002 + 0.0027000000000000001 * exp(-1.3611111111111112 * pow((1 + 0.028571428571428571 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[6] = (var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1 + ((0.001 / (0.01 + 0.01 * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V) + 0.161 * exp(-7.716049382716049 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) + 0.161 * exp(-7.716049382716049 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.01 + 0.161 * exp(-7.716049382716049 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[7] = (var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2 + ((0.001 / (0.062600000000000003 + 1.3323 * exp(-7.9349335449315621 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) + 0.062600000000000003 * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V) + 1.3323 * exp(-7.9349335449315621 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)) * exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.062600000000000003 + 1.3323 * exp(-7.9349335449315621 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[12] = (var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + ((0.001 / (0.69999999999999996 + 0.69999999999999996 * exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V) + 0.40000000000000002 * exp(-pow((-1.0 + 0.050000000000000003 * var_chaste_interface__membrane__V), 2.0)) + 0.40000000000000002 * exp(-pow((-1.0 + 0.050000000000000003 * var_chaste_interface__membrane__V), 2.0)) * exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.69999999999999996 + 0.40000000000000002 * exp(-pow((-1.0 + 0.050000000000000003 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[13] = (var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a + ((0.001 / (0.031179999999999999 + 0.031179999999999999 * exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V) + 0.21718000000000001 * exp(-0.82285842787521646 * pow((1 + 0.049658350548228189 * var_chaste_interface__membrane__V), 2.0)) + 0.21718000000000001 * exp(-0.82285842787521646 * pow((1 + 0.049658350548228189 * var_chaste_interface__membrane__V), 2.0)) * exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (0.031179999999999999 + 0.21718000000000001 * exp(-0.82285842787521646 * pow((1 + 0.049658350548228189 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[3] = (var_chaste_interface__sodium_current_h1_gate__h1 + ((0.001 / (0.00029999999999999997 + 0.029999999999999999 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)) + 0.00029999999999999997 * exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V) + 0.029999999999999999 * exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V) / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.00029999999999999997 + 0.029999999999999999 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)))) * mDt));
        rY[4] = (var_chaste_interface__sodium_current_h2_gate__h2 + ((0.001 / (0.0030000000000000001 + 0.12 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)) + 0.0030000000000000001 * exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V) + 0.12 * exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V) / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.0030000000000000001 + 0.12 / (1.0 + exp(10.96875 + 0.3125 * var_chaste_interface__membrane__V)))) * mDt));
        rY[2] = (var_chaste_interface__sodium_current_m_gate__m + ((0.001 / (2.4000000000000001e-5 + 2.4000000000000001e-5 * exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V) + 4.1999999999999998e-5 * exp(-0.78827269000771605 * pow((1 + 0.039108330074305829 * var_chaste_interface__membrane__V), 2.0)) + 4.1999999999999998e-5 * exp(-0.78827269000771605 * pow((1 + 0.039108330074305829 * var_chaste_interface__membrane__V), 2.0)) * exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V))) * mDt)) / (1.0 - ((-0.001 / (2.4000000000000001e-5 + 4.1999999999999998e-5 * exp(-0.78827269000771605 * pow((1 + 0.039108330074305829 * var_chaste_interface__membrane__V), 2.0)))) * mDt));
        rY[10] = (var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus + ((0.001 / (0.00050000000000000001 + 0.00050000000000000001 * exp(-0.53749999999999998 - 0.125 * var_chaste_interface__membrane__V) + 0.0089999999999999993 / (1.0 + exp(0.41666666666666669 + 0.083333333333333329 * var_chaste_interface__membrane__V)) + 0.0089999999999999993 * exp(-0.53749999999999998 - 0.125 * var_chaste_interface__membrane__V) / (1.0 + exp(0.41666666666666669 + 0.083333333333333329 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.00050000000000000001 + 0.0089999999999999993 / (1.0 + exp(0.41666666666666669 + 0.083333333333333329 * var_chaste_interface__membrane__V)))) * mDt));
        rY[11] = (var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus + ((0.00059999999999999995 / (0.29999999999999999 + 0.047 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane__V))) + 0.00040000000000000002 / (0.29999999999999999 + 0.047 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)) + 0.29999999999999999 * exp(2.0 + 0.10000000000000001 * var_chaste_interface__membrane__V) + 0.047 * exp(2.0 + 0.10000000000000001 * var_chaste_interface__membrane__V) / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)))) * mDt)) / (1.0 - ((-0.001 / (0.29999999999999999 + 0.047 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__membrane__V)))) * mDt));
