...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmahajan_2008FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x36 = var_x21 * ((var_x22) ? (1) : ((var_x23) ? (11.300000000000001) : (0)));
        ...
        const double var_x71 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x72 = var_x20 * mParameters[3];
        const double var_x73 = 50.0 * var_x56;
        ...
        const double var_x90 = 1.0 + 0.00072525373756441506 * var_x78;
        ...
        const double var_x96 = 0.22637460951196098 * var_x80 / pow(var_x90, 2);
        ...
        const double var_x100 = 0.1111111111111111 * var_x82 * var_x88 * var_x99;
        const double var_x101 = 1.0 - var_x88;
        const double var_x102 = var_x101 * var_x97 * var_chaste_interface__ICaL__xi2ca;
        const double var_x103 = -var_x85;
        const double var_x104 = 1.0 + var_x103;
        const double var_x105 = 1 / (450.0 + var_x92 * (-440.0 + var_x93));
        const double var_x106 = var_x105 * var_x88;
        const double var_x107 = var_x89 * var_x99;
        const double var_x108 = var_x101 * var_x105;
        const double var_x109 = var_x101 * var_x99;
        ...
        rJacobian[3][3] = 1.0 - (mDt * (var_x56 * (-14.789 + var_x57 + 3.4019999999999997 * var_x70 - 0.0011233033614805057 * var_x66 - 105649.152 * var_x69 + var_x29 * (-50.0 + 50.0 * var_chaste_interface__ICaL__c1 + 50.0 * var_chaste_interface__ICaL__c2 + 50.0 * var_chaste_interface__ICaL__xi1ba + 50.0 * var_chaste_interface__ICaL__xi1ca + 50.0 * var_chaste_interface__ICaL__xi2ba + 50.0 * var_chaste_interface__ICaL__xi2ca) * mParameters[3]) + 0.0012574820180071425 * (9.0 / pow(var_x48, 3) + 56.399999999999999 / pow(var_x52, 3) + 0.97959183673469385 / pow(var_x54, 3) + 0.49704142011834318 / pow(var_x50, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x71 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x65 * var_x67 - 50.0 * var_x14 * var_x72) / pow((0.035460992907801421 + var_x53 + 0.15957446808510639 * var_x49 + 0.12158054711246201 * var_x55 + 0.11456628477905074 * var_x51), 2)));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x56 * (0.019599999999999999 + var_x71)));
        ...
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = -(mDt * (var_x73));
        rJacobian[3][14] = -(mDt * (var_x56 * (226.80000000000001 * var_x76 - 6.52262738373438e-6 * var_x77)));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        ...
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.019599999999999999 - var_x71));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[6][14] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (var_x102 + (-var_x100 - var_x98) * var_chaste_interface__ICaL__c2));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        ...
        rJacobian[10][14] = 0.0;
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (-var_x102 + var_x100 * var_chaste_interface__ICaL__c2 + var_x98 * var_chaste_interface__ICaL__c2));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (3.9135764302406278e-10 * var_x77 - 0.013608 * var_x76 - 0.00044021739130434783 * var_x124 / (12.0 + var_chaste_interface__Na__Na_i) + 3.0570652173913045e-6 * var_x124 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2) - 0.0033176767270912339 * pow(var_chaste_interface__INa__xm, 3) * mParameters[4] * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj / var_chaste_interface__Na__Na_i));
    }
