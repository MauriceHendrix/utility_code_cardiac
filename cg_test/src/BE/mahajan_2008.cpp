...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmahajan_2008FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        const double var_x14 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x15 = var_x14 / (1.0 + var_x14);
        const double var_x16 = 298.24222222222221 * var_x15;
        const double var_x17 = -50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x18 = 0.075353936071760372 * var_chaste_interface__cell__V;
        const double var_x19 = exp(var_x18);
        const double var_x20 = var_x19 * var_chaste_interface__Ca__Ca_submem;
        const double var_x21 = -0.063960518821716009 + 0.00010420416882000001 * var_x20;
        const double var_x22 = fabs(var_x21);
        const double var_x23 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x24 = var_x22 * var_x23;
        const double var_x25 = var_x17 * var_x24;
        const double var_x26 = var_chaste_interface__Irel__Ca_JSR > 50.0;
        const double var_x27 = var_chaste_interface__Irel__Ca_JSR < 90.0;
        const double var_x28 = fabs(var_x18) < 0.001;
        const double var_x29 = (var_x26) && (var_x27) && (var_x28);
        const double var_x30 = -977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x31 = var_x16 * var_x30;
        const double var_x32 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x33 = (var_x28) && (var_x32);
        const double var_x34 = var_chaste_interface__cell__V / (-1.0 + var_x19);
        const double var_x35 = var_x34 * (-0.61380000000000001 + 0.001 * var_x20);
        const double var_x36 = fabs(0.0078521942756732046 * var_x35);
        const double var_x37 = var_x23 * var_x36;
        const double var_x38 = var_x16 * var_x17;
        const double var_x39 = (var_x26) && (var_x27);
        const double var_x40 = var_x15 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x41 = var_x17 * var_x40;
        const double var_x42 = Signum(var_x21);
        const double var_x43 = var_x19 * var_x23;
        const double var_x44 = var_x42 * var_x43;
        const double var_x45 = 0.0310780828736964 * var_x44;
        const double var_x46 = var_x19 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca);
        const double var_x47 = 2.0 + 0.00010420416882000001 * var_x42 * var_x46;
        const double var_x48 = var_x30 * var_x40;
        const double var_x49 = Signum(var_x35);
        const double var_x50 = var_x34 * var_x43;
        const double var_x51 = var_x49 * var_x50;
        const double var_x52 = 0.0023418558700973894 * var_x51;
        const double var_x53 = 2.0 + 7.8521942756732062e-6 * var_x34 * var_x46 * var_x49;
        const double var_x54 = -9000.0 * var_x22;
        const double var_x55 = var_x22 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x56 = -9000.0 * var_x36;
        const double var_x57 = var_x36 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x58 = ((var_x29) ? (var_x54 - var_x38 * var_x55) : ((var_x33) ? (var_x54 - var_x31 * var_x55) : ((var_x28) ? (var_x54) : ((var_x39) ? (var_x56 - var_x38 * var_x57) : ((var_x32) ? (var_x56 - var_x31 * var_x57) : (var_x56))))));
        const double var_x59 = var_x24 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x60 = 3370.1371111111112 * var_x15;
        const double var_x61 = var_x37 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x62 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x63 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x64 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x65 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x66 = 1.0 + 0.00016799999999999999 / pow(var_x62, 2) + 0.00054599999999999994 / pow(var_x63, 2) + 4.4999999999999993e-6 / pow(var_x64, 2) + 2.8199999999999998e-5 / pow(var_x65, 2);
        const double var_x67 = 1 / var_x66;
        const double var_x68 = 0.001 * var_x67;
        const double var_x69 = 32.700000000000003 * var_chaste_interface__Ca__tropi;
        const double var_x70 = 32.700000000000003 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x71 = 400000.0 * var_x10 * var_x9;
        const double var_x72 = 2.069e-5 * var_x2 * var_x4;
        const double var_x73 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x74 = pow(var_x73, (-2));
        const double var_x75 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x76 = pow(var_x75, (-2));
        const double var_x77 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x78 = pow(var_x77, (-2));
        const double var_x79 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x80 = pow(var_x79, (-2));
        const double var_x81 = 1 / (1.0 + 4.5 * var_x74 + 3.2307692307692308 * var_x76 + 28.199999999999999 * var_x78 + 3.4285714285714284 * var_x80);
        const double var_x82 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x83 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x84 = exp(0.013186938812558063 * var_chaste_interface__cell__V);
        const double var_x85 = exp(-0.024490029223322121 * var_chaste_interface__cell__V);
        const double var_x86 = 1.8 * var_x83 * var_x84 - 2515.4560000000001 * var_x85 * var_chaste_interface__Ca__Ca_submem;
        const double var_x87 = 1 / (1.0 + 0.20000000000000001 * var_x85);
        const double var_x88 = 1.0 + 0.026999999999999996 / pow(var_chaste_interface__Ca__Ca_submem, 3);
        const double var_x89 = var_x87 / var_x88;
        const double var_x90 = var_x86 * var_x89;
        const double var_x91 = var_x90 / pow((1 + 0.0006421786632577935 * var_x83 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x92 = 1 / (12405.2022 + 7.9663561662386391 * var_x83 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem);
        const double var_x93 = var_x89 * var_x92;
        const double var_x94 = var_x85 * var_x93;
        const double var_x95 = var_x86 * var_x87 * var_x92 / (pow(var_x88, 2) * pow(var_chaste_interface__Ca__Ca_submem, 4));
        const double var_x96 = -14.789 + var_x82 + 3.4019999999999997 * var_x95 - 0.0011233033614805057 * var_x91 - 105649.152 * var_x94;
        const double var_x97 = 1.0 * var_x81;
        const double var_x98 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x99 = 50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x98 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x90 * var_x92;
        const double var_x100 = 0.0012574820180071425 * (9.0 / pow(var_x73, 3) + 56.399999999999999 / pow(var_x77, 3) + 0.97959183673469385 / pow(var_x79, 3) + 0.49704142011834318 / pow(var_x75, 3)) / pow((0.035460992907801421 + var_x78 + 0.15957446808510639 * var_x74 + 0.12158054711246201 * var_x80 + 0.11456628477905074 * var_x76), 2);
        const double var_x101 = 71.454967908626173 * var_x35;
        const double var_x102 = ((var_x28) ? (var_x97 * (-582.04072127761572 + 0.94825793626200006 * var_x20)) : (var_x101 * var_x81));
        const double var_x103 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x104 = var_x103 * var_x84 * var_x93;
        const double var_x105 = var_x103 * var_x91;
        const double var_x106 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
        const double var_x107 = 1 / var_x106;
        const double var_x108 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
        const double var_x109 = 1 / var_x108;
        const double var_x110 = var_x107 / pow((0.037037037037037035 + var_x109), 2);
        const double var_x111 = 0.002685333333333333 * var_x110 * var_chaste_interface__ICaL__c1;
        const double var_x112 = 1 / (1.0 + exp(-0.125 * var_chaste_interface__cell__V));
        const double var_x113 = 1.0 * var_x112;
        const double var_x114 = 1 / (1.0 + 27.0 * var_x109);
        const double var_x115 = 1.0 + exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
        const double var_x116 = 1 / var_x115;
        const double var_x117 = 1.0 + 0.00072525373756441506 * var_x106;
        const double var_x118 = 1 / var_x117;
        const double var_x119 = 1.0 - 1.0 / (1.0 + exp(-10.0 - 0.25 * var_chaste_interface__cell__V));
        const double var_x120 = 4954.0 * exp(0.064102564102564111 * var_chaste_interface__cell__V);
        const double var_x121 = 78.032899999999998 * var_x118;
        const double var_x122 = var_x119 * (9.9000000000000004 + var_x120 - var_x121);
        const double var_x123 = 0.22637460951196098 * var_x108 / pow(var_x117, 2);
        const double var_x124 = 0.00016422697956757767 * (var_x123 - var_x119 * var_x123) / pow((0.0012815107473898831 + var_x118 + 0.012815107473898831 * var_x122), 2);
        const double var_x125 = var_x114 * var_x116 * var_x124;
        const double var_x126 = 1 / (0.10000000000000001 + var_x121 + var_x122);
        const double var_x127 = 0.1111111111111111 * var_x110 * var_x116 * var_x126;
        const double var_x128 = 1.0 * var_x116;
        const double var_x129 = 1.0 - var_x128;
        const double var_x130 = var_x124 * var_x129 * var_chaste_interface__ICaL__xi2ca;
        const double var_x131 = -var_x113;
        const double var_x132 = 1.0 + var_x131;
        const double var_x133 = 1 / (450.0 + var_x119 * (-440.0 + var_x120));
        const double var_x134 = var_x128 * var_x133;
        const double var_x135 = var_x114 * var_x126 * var_x128;
        const double var_x136 = var_x129 * var_x133;
        const double var_x137 = var_x126 * var_x129;
        const double var_x138 = 0.33333333333333331 / (1.0 + exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V));
        const double var_x139 = 0.33333333333333331 - var_x138;
        const double var_x140 = var_x112 * var_x115 * var_x129 * var_x139 / var_x132;
        const double var_x141 = 1.8437500000000002 * var_x140;
        const double var_x142 = 41.377027474346242 + 1117.1797418073486 * var_x109;
        const double var_x143 = -0.018268800000000002 * var_x114;
        const double var_x144 = 233.2480818414322 * var_x140;
        const double var_x145 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x146 = var_x71 - var_x72 - var_chaste_interface__Irel__xir;
        const double var_x147 = (var_x145 * var_x7 - 1.0 * var_x146 / var_x0) * var_chaste_interface__Irel__xir;
        const double var_x148 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x149 = var_x148 / (1.0 + var_x148);
        const double var_x150 = 0.028675444444444444 * var_x149;
        const double var_x151 = var_x150 * var_x30;
        const double var_x152 = var_x150 * var_x17;
        const double var_x153 = var_x145 * var_chaste_interface__Irel__xir;
        const double var_x154 = var_x149 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x155 = var_x154 * var_x17;
        const double var_x156 = 2.9881008538774201e-6 * var_x44;
        const double var_x157 = var_x154 * var_x30;
        const double var_x158 = 2.2516516071905168e-7 * var_x51;
        const double var_x159 = ((var_x29) ? (-var_x152 * var_x55) : ((var_x33) ? (-var_x151 * var_x55) : ((var_x28) ? (0) : ((var_x39) ? (-var_x152 * var_x57) : ((var_x32) ? (-var_x151 * var_x57) : (0))))));
        const double var_x160 = 0.32403252222222223 * var_x149;
        const double var_x161 = 1 / (1.0 + 0.1245 * exp(-0.0037676968035880187 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0208023774145616)) * exp(-0.037676968035880186 * var_chaste_interface__cell__V));
        ...
        rJacobian[0][14] = 0.0;
        rJacobian[1][0] = -(mDt * (((var_x29) ? (var_x16 * var_x25) : ((var_x33) ? (var_x24 * var_x31) : ((var_x28) ? (0) : ((var_x39) ? (var_x37 * var_x38) : ((var_x32) ? (var_x31 * var_x37) : (0))))))));
        rJacobian[1][1] = 1.0 - (mDt * (-2.0));
        rJacobian[1][2] = 0.0;
        rJacobian[1][3] = -(mDt * (((var_x29) ? (var_x47 + var_x41 * var_x45) : ((var_x33) ? (var_x47 + var_x45 * var_x48) : ((var_x28) ? (var_x47) : ((var_x39) ? (var_x53 + var_x41 * var_x52) : ((var_x32) ? (var_x53 + var_x48 * var_x52) : (var_x53))))))));
        rJacobian[1][4] = 0.0;
        rJacobian[1][5] = 0.0;
        rJacobian[1][6] = -(mDt * (var_x58));
        rJacobian[1][7] = -(mDt * (var_x58));
        rJacobian[1][8] = -(mDt * (var_x58));
        rJacobian[1][9] = -(mDt * (var_x58));
        rJacobian[1][10] = -(mDt * (var_x58));
        rJacobian[1][11] = -(mDt * (var_x58));
        rJacobian[1][12] = -(mDt * (((var_x29) ? (var_x16 * var_x59) : ((var_x33) ? (var_x59 * var_x60) : ((var_x28) ? (0) : ((var_x39) ? (var_x16 * var_x61) : ((var_x32) ? (var_x60 * var_x61) : (0))))))));
        rJacobian[1][13] = 0.0;
        rJacobian[1][14] = 0.0;
        rJacobian[2][0] = -(mDt * (var_x68 * (var_x3 + var_x6 - var_x5)));
        rJacobian[2][1] = 0.0;
        rJacobian[2][2] = 1.0 - (mDt * (var_x68 * (-2539.0 + var_x12 + var_x69 - var_x11 - var_x8) + 0.001 * (0.00033599999999999998 / pow(var_x62, 3) + 0.0010919999999999999 / pow(var_x63, 3) + 8.9999999999999985e-6 / pow(var_x64, 3) + 5.6399999999999995e-5 / pow(var_x65, 3)) * (var_x72 - var_x71 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x70 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x66, 2)));
        rJacobian[2][3] = -(mDt * (0.00025000000000000001 * var_x67));
        rJacobian[2][4] = -(mDt * (var_x68 * (0.019599999999999999 + var_x70)));
        rJacobian[2][5] = 0.0;
        rJacobian[2][6] = 0.0;
        rJacobian[2][7] = 0.0;
        rJacobian[2][8] = 0.0;
        ...
        rJacobian[3][0] = 0.0;
        rJacobian[3][1] = 0.0;
        rJacobian[3][2] = -(mDt * (12500.0 * var_x81));
        rJacobian[3][3] = 1.0 - (mDt * (((var_x28) ? (var_x100 * (var_x99 - 9100.0 * var_x21 * var_x23) + var_x97 * (var_x96 - 0.94825793626200006 * var_x43)) : (var_x100 * (var_x99 - var_x101 * var_x23) + var_x97 * (var_x96 - 0.071454967908626169 * var_x50)))));
        rJacobian[3][4] = 0.0;
        rJacobian[3][5] = -(mDt * (var_x97 * (0.019599999999999999 + var_x98)));
        rJacobian[3][6] = -(mDt * (var_x102));
        rJacobian[3][7] = -(mDt * (var_x102));
        rJacobian[3][8] = -(mDt * (var_x102));
        rJacobian[3][9] = -(mDt * (var_x102));
        rJacobian[3][10] = -(mDt * (var_x102));
        rJacobian[3][11] = -(mDt * (var_x102));
        rJacobian[3][12] = 0.0;
        rJacobian[3][13] = -(mDt * (50.0 * var_x81));
        rJacobian[3][14] = -(mDt * (var_x97 * (226.80000000000001 * var_x104 - 6.52262738373438e-6 * var_x105)));
        rJacobian[4][0] = 0.0;
        rJacobian[4][1] = 0.0;
        rJacobian[4][2] = -(mDt * (2289.0 - var_x69));
        rJacobian[4][3] = 0.0;
        rJacobian[4][4] = 1.0 - (mDt * (-0.019599999999999999 - var_x70));
        rJacobian[4][5] = 0.0;
        rJacobian[4][6] = 0.0;
        rJacobian[4][7] = 0.0;
        rJacobian[4][8] = 0.0;
        ...
        rJacobian[5][1] = 0.0;
        rJacobian[5][2] = 0.0;
        rJacobian[5][3] = -(mDt * (2.2890000000000001 - var_x82));
        rJacobian[5][4] = 0.0;
        rJacobian[5][5] = 1.0 - (mDt * (-0.019599999999999999 - var_x98));
        rJacobian[5][6] = 0.0;
        rJacobian[5][7] = 0.0;
        rJacobian[5][8] = 0.0;
        rJacobian[5][9] = 0.0;
        ...
        rJacobian[5][14] = 0.0;
        rJacobian[6][0] = 0.0;
        rJacobian[6][1] = -(mDt * (-var_x111));
        rJacobian[6][2] = 0.0;
        rJacobian[6][3] = 0.0;
        rJacobian[6][4] = 0.0;
        rJacobian[6][5] = 0.0;
        rJacobian[6][6] = 1.0 - (mDt * (-4.3041299999999998 + var_x113 - 0.024167999999999999 * var_x114));
        rJacobian[6][7] = -(mDt * (-3.0 + var_x113));
        ...
        rJacobian[6][14] = 0.0;
        rJacobian[7][0] = 0.0;
        rJacobian[7][1] = -(mDt * (var_x130 + (-var_x125 - var_x127) * var_chaste_interface__ICaL__c2));
        rJacobian[7][2] = 0.0;
        rJacobian[7][3] = 0.0;
        rJacobian[7][4] = 0.0;
        rJacobian[7][5] = 0.0;
        rJacobian[7][6] = -(mDt * (var_x132));
        rJacobian[7][7] = 1.0 - (mDt * (var_x131 - var_x134 - var_x135));
        rJacobian[7][8] = 0.0;
        rJacobian[7][9] = 0.0;
        rJacobian[7][10] = -(mDt * (var_x136));
        rJacobian[7][11] = -(mDt * (var_x137));
        rJacobian[7][12] = 0.0;
        rJacobian[7][13] = 0.0;
        rJacobian[7][14] = 0.0;
        rJacobian[8][0] = 0.0;
        ...
        rJacobian[8][8] = 1.0 - (mDt * (-0.33762909604519775 + var_x138));
        rJacobian[8][9] = -(mDt * (-0.0019499999999999999));
        rJacobian[8][10] = -(mDt * (-0.0019499999999999999 + var_x141));
        rJacobian[8][11] = -(mDt * (-0.0019499999999999999));
        rJacobian[8][12] = 0.0;
        rJacobian[8][13] = 0.0;
        rJacobian[8][14] = 0.0;
        rJacobian[9][0] = 0.0;
        rJacobian[9][1] = -(mDt * (var_x111 + (0.00063442013684210537 * var_x107 * var_x114 - 2.1032463466666669e-8 * var_x110 * var_x142) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x110 * var_x23));
        rJacobian[9][2] = 0.0;
        rJacobian[9][3] = 0.0;
        rJacobian[9][4] = 0.0;
        rJacobian[9][5] = 0.0;
        rJacobian[9][6] = -(mDt * (0.0058991999999999968 * var_x114));
        rJacobian[9][7] = -(mDt * (var_x143));
        rJacobian[9][8] = -(mDt * (var_x143));
        rJacobian[9][9] = 1.0 - (mDt * (-0.33343694833333332 + var_x138 + var_x143 - 1.8929217120000003e-7 * var_x114 * var_x142));
        rJacobian[9][10] = -(mDt * (var_x143));
        rJacobian[9][11] = -(mDt * (var_x143 + var_x144));
        rJacobian[9][12] = 0.0;
        rJacobian[9][13] = 0.0;
        rJacobian[9][14] = 0.0;
        rJacobian[10][0] = 0.0;
        ...
        rJacobian[10][5] = 0.0;
        rJacobian[10][6] = 0.0;
        rJacobian[10][7] = -(mDt * (var_x134));
        rJacobian[10][8] = -(mDt * (var_x139));
        rJacobian[10][9] = 0.0;
        rJacobian[10][10] = 1.0 - (mDt * (-var_x136 - var_x141));
        rJacobian[10][11] = 0.0;
        rJacobian[10][12] = 0.0;
        rJacobian[10][13] = 0.0;
        rJacobian[10][14] = 0.0;
        rJacobian[11][0] = 0.0;
        rJacobian[11][1] = -(mDt * (-var_x130 + var_x125 * var_chaste_interface__ICaL__c2 + var_x127 * var_chaste_interface__ICaL__c2));
        rJacobian[11][2] = 0.0;
        rJacobian[11][3] = 0.0;
        rJacobian[11][4] = 0.0;
        rJacobian[11][5] = 0.0;
        rJacobian[11][6] = 0.0;
        rJacobian[11][7] = -(mDt * (var_x135));
        rJacobian[11][8] = 0.0;
        rJacobian[11][9] = -(mDt * (var_x139));
        rJacobian[11][10] = 0.0;
        rJacobian[11][11] = 1.0 - (mDt * (-var_x137 - var_x144));
        rJacobian[11][12] = 0.0;
        rJacobian[11][13] = 0.0;
        rJacobian[11][14] = 0.0;
        ...
        rJacobian[12][13] = 0.0;
        rJacobian[12][14] = 0.0;
        rJacobian[13][0] = -(mDt * (((var_x29) ? (var_x147 + var_x150 * var_x25) : ((var_x33) ? (var_x147 + var_x151 * var_x24) : ((var_x28) ? (var_x147) : ((var_x39) ? (var_x147 + var_x152 * var_x37) : ((var_x32) ? (var_x147 + var_x151 * var_x37) : (var_x147))))))));
        rJacobian[13][1] = 0.0;
        rJacobian[13][2] = -(mDt * (var_x13 * var_x153));
        rJacobian[13][3] = -(mDt * (((var_x29) ? (var_x155 * var_x156) : ((var_x33) ? (var_x156 * var_x157) : ((var_x28) ? (0) : ((var_x39) ? (var_x155 * var_x158) : ((var_x32) ? (var_x157 * var_x158) : (0))))))));
        rJacobian[13][4] = 0.0;
        rJacobian[13][5] = 0.0;
        rJacobian[13][6] = -(mDt * (var_x159));
        rJacobian[13][7] = -(mDt * (var_x159));
        rJacobian[13][8] = -(mDt * (var_x159));
        rJacobian[13][9] = -(mDt * (var_x159));
        rJacobian[13][10] = -(mDt * (var_x159));
        rJacobian[13][11] = -(mDt * (var_x159));
        rJacobian[13][12] = -(mDt * (((var_x29) ? (var_x150 * var_x59) : ((var_x33) ? (var_x160 * var_x59) : ((var_x28) ? (0) : ((var_x39) ? (var_x150 * var_x61) : ((var_x32) ? (var_x160 * var_x61) : (0))))))));
        rJacobian[13][13] = 1.0 - (mDt * (-0.033333333333333333 - var_x153 + var_x145 * var_x146));
        rJacobian[13][14] = 0.0;
        rJacobian[14][0] = 0.0;
        rJacobian[14][1] = 0.0;
        rJacobian[14][2] = 0.0;
        rJacobian[14][3] = -(mDt * (6.3389491199999997 * var_x94 + 6.7398201688830334e-8 * var_x91 - 0.00020411999999999996 * var_x95));
        rJacobian[14][4] = 0.0;
        rJacobian[14][5] = 0.0;
        rJacobian[14][6] = 0.0;
        rJacobian[14][7] = 0.0;
        ...
        rJacobian[14][12] = 0.0;
        rJacobian[14][13] = 0.0;
        rJacobian[14][14] = 1.0 - (mDt * (3.9135764302406278e-10 * var_x105 - 0.013608 * var_x104 - 0.00044021739130434783 * var_x161 / (12.0 + var_chaste_interface__Na__Na_i) + 3.0570652173913045e-6 * var_x161 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2) - 0.039812120725094803 * pow(var_chaste_interface__INa__xm, 3) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj / var_chaste_interface__Na__Na_i));
    }
