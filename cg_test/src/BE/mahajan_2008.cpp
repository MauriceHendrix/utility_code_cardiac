...
#include "CardiacNewtonSolver.hpp"
    ...
    void Cellmahajan_2008FromCellMLBackwardEuler::ComputeJacobian(double var_chaste_interface__Environment__time, const double rCurrentGuess[15], double rJacobian[15][15])
    {
        ...
        double var_chaste_interface__INa__xj = rY[4];
        // Units: dimensionless; Initial value: 0.993888937283
        double var_chaste_interface__Ca__Ca_NSR = rCurrentGuess[0];double var_chaste_interface__Ca__Ca_dyad = rCurrentGuess[1];double var_chaste_interface__Ca__Ca_i_converted = rCurrentGuess[2];double var_chaste_interface__Ca__Ca_submem = rCurrentGuess[3];double var_chaste_interface__Ca__tropi = rCurrentGuess[4];double var_chaste_interface__Ca__trops = rCurrentGuess[5];double var_chaste_interface__ICaL__c1 = rCurrentGuess[6];double var_chaste_interface__ICaL__c2 = rCurrentGuess[7];double var_chaste_interface__ICaL__xi1ba = rCurrentGuess[8];double var_chaste_interface__ICaL__xi1ca = rCurrentGuess[9];double var_chaste_interface__ICaL__xi2ba = rCurrentGuess[10];double var_chaste_interface__ICaL__xi2ca = rCurrentGuess[11];double var_chaste_interface__Irel__Ca_JSR = rCurrentGuess[12];double var_chaste_interface__Irel__xir = rCurrentGuess[13];double var_chaste_interface__Na__Na_i = rCurrentGuess[14];

        const double var_x0 = 32.700000000000003 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x1 = 32.700000000000003 * var_chaste_interface__Ca__tropi;
        const double var_x2 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        const double var_x3 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x4 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x5 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x6 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x7 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x8 = 1.0 + 0.00016799999999999999 / pow(var_x4, 2) + 0.00054599999999999994 / pow(var_x5, 2) + 4.4999999999999993e-6 / pow(var_x6, 2) + 2.8199999999999998e-5 / pow(var_x7, 2);
        const double var_x9 = 1 / var_x8;
        const double var_x10 = 0.001 * var_x9;
        const double var_x11 = pow(var_chaste_interface__Ca__Ca_i_converted, 2);
        const double var_x12 = 0.80000000000000004 * pow(var_chaste_interface__Ca__Ca_i_converted, 3) / pow((2.4999999999999999e-7 + var_x11), 2);
        const double var_x13 = pow(var_chaste_interface__Ca__Ca_NSR, 2);
        const double var_x14 = 1 / (2500.0 + var_x13);
        const double var_x15 = var_x13 * var_x14;
        const double var_x16 = 0.02069 * var_x15;
        const double var_x17 = 1 / (0.25 + 1000000.0 * var_x11);
        const double var_x18 = 800000.0 * var_x17 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x19 = 400000.0 * var_x11 * var_x17;
        const double var_x20 = 16.667000000000002 * var_chaste_interface__Ca__Ca_NSR - 1000.0 * var_chaste_interface__Ca__Ca_i_converted;
        const double var_x21 = 2.069e-5 * var_x15 * var_x20;
        const double var_x22 = 0.00034484023000000001 * var_x15;
        const double var_x23 = 4.138e-5 * var_x14 * var_x20 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x24 = 6.6208000000000002e-12 * var_x20 * pow(var_chaste_interface__Ca__Ca_NSR, 3) / pow((1 + 0.00040000000000000002 * var_x13), 2);
        const double var_x25 = var_x16 + var_x18 - var_x12;
        const double var_x26 = var_x24 - var_x22 - var_x23;
        const double var_x27 = 1 / (1.0 + exp(-0.125 * var_chaste_interface__cell__V));
        const double var_x28 = 1.0 * var_x27;
        const double var_x29 = 1 / var_chaste_interface__Ca__Ca_dyad;
        const double var_x30 = pow(var_x29, 3.0);
        const double var_x31 = 1 / (1.0 + 27.0 * var_x30);
        const double var_x32 = var_x29 * var_x30;
        const double var_x33 = var_x32 / pow((0.037037037037037035 + var_x30), 2);
        const double var_x34 = 0.002685333333333333 * var_x33 * var_chaste_interface__ICaL__c1;
        const double var_x35 = 0.33333333333333331 / (1.0 + exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V));
        const double var_x36 = 1.0 + exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
        const double var_x37 = 1 / var_x36;
        const double var_x38 = 1.0 * var_x37;
        const double var_x39 = 1.0 - var_x38;
        const double var_x40 = -var_x28;
        const double var_x41 = 1.0 + var_x40;
        const double var_x42 = 0.33333333333333331 - var_x35;
        const double var_x43 = var_x27 * var_x36 * var_x39 * var_x42 / var_x41;
        const double var_x44 = 1.8437500000000002 * var_x43;
        const double var_x45 = 1.0 - 1.0 / (1.0 + exp(-10.0 - 0.25 * var_chaste_interface__cell__V));
        const double var_x46 = 4954.0 * exp(0.064102564102564111 * var_chaste_interface__cell__V);
        const double var_x47 = 1 / (450.0 + var_x45 * (-440.0 + var_x46));
        const double var_x48 = var_x39 * var_x47;
        const double var_x49 = var_x38 * var_x47;
        const double var_x50 = 1.0 + 0.00072525373756441506 * pow(var_chaste_interface__Ca__Ca_dyad, 4.0);
        const double var_x51 = 1 / var_x50;
        const double var_x52 = 78.032899999999998 * var_x51;
        const double var_x53 = var_x45 * (9.9000000000000004 + var_x46 - var_x52);
        const double var_x54 = 1 / (0.10000000000000001 + var_x52 + var_x53);
        const double var_x55 = var_x31 * var_x38 * var_x54;
        const double var_x56 = var_x39 * var_x54;
        const double var_x57 = 0.22637460951196098 * pow(var_chaste_interface__Ca__Ca_dyad, 3.0) / pow(var_x50, 2);
        const double var_x58 = 0.00016422697956757767 * (var_x57 - var_x45 * var_x57) / pow((0.0012815107473898831 + var_x51 + 0.012815107473898831 * var_x53), 2);
        const double var_x59 = var_x31 * var_x37 * var_x58;
        const double var_x60 = 0.1111111111111111 * var_x33 * var_x37 * var_x54;
        const double var_x61 = var_x39 * var_x58 * var_chaste_interface__ICaL__xi2ca;
        const double var_x62 = -0.018268800000000002 * var_x31;
        const double var_x63 = 41.377027474346242 + 1117.1797418073486 * var_x30;
        const double var_x64 = 233.2480818414322 * var_x43;
        const double var_x65 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x66 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x67 = pow(var_x66, (-2));
        const double var_x68 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x69 = pow(var_x68, (-2));
        const double var_x70 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x71 = pow(var_x70, (-2));
        const double var_x72 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x73 = pow(var_x72, (-2));
        const double var_x74 = 1 / (1.0 + 4.5 * var_x67 + 3.2307692307692308 * var_x69 + 28.199999999999999 * var_x71 + 3.4285714285714284 * var_x73);
        const double var_x75 = 1.0 * var_x74;
        const double var_x76 = 0.075353936071760372 * var_chaste_interface__cell__V;
        const double var_x77 = exp(var_x76);
        const double var_x78 = var_x77 * var_chaste_interface__Ca__Ca_submem;
        const double var_x79 = fabs(var_x76) < 0.001;
        const double var_x80 = var_chaste_interface__cell__V / (-1.0 + var_x77);
        const double var_x81 = var_x80 * (-0.61380000000000001 + 0.001 * var_x78);
        const double var_x82 = 71.454967908626173 * var_x81;
        const double var_x83 = ((var_x79) ? (var_x75 * (-582.04072127761572 + 0.94825793626200006 * var_x78)) : (var_x74 * var_x82));
        const double var_x84 = var_x65 * var_x77;
        const double var_x85 = pow(var_chaste_interface__Na__Na_i, 3.0);
        const double var_x86 = exp(0.013186938812558063 * var_chaste_interface__cell__V);
        const double var_x87 = exp(-0.024490029223322121 * var_chaste_interface__cell__V);
        const double var_x88 = 1.8 * var_x85 * var_x86 - 2515.4560000000001 * var_x87 * var_chaste_interface__Ca__Ca_submem;
        const double var_x89 = 1 / (1.0 + 0.20000000000000001 * var_x87);
        const double var_x90 = 1 / var_chaste_interface__Ca__Ca_submem;
        const double var_x91 = pow(var_x90, 3.0);
        const double var_x92 = 1.0 + 0.026999999999999996 * var_x91;
        const double var_x93 = var_x89 / var_x92;
        const double var_x94 = var_x88 * var_x93;
        const double var_x95 = var_x94 / pow((1 + 0.0006421786632577935 * var_x85 + 0.33178107931203249 * var_chaste_interface__Ca__Ca_submem), 2);
        const double var_x96 = 1 / (12405.2022 + 4115.8113750000002 * var_chaste_interface__Ca__Ca_submem + 7.9663561662386391 * var_x85);
        const double var_x97 = var_x93 * var_x96;
        const double var_x98 = var_x87 * var_x97;
        const double var_x99 = var_x88 * var_x89 * var_x90 * var_x91 * var_x96 / pow(var_x92, 2);
        const double var_x100 = -14.789 + var_x3 + 3.4019999999999997 * var_x99 - 0.0011233033614805057 * var_x95 - 105649.152 * var_x98;
        const double var_x101 = -0.063960518821716009 + 0.00010420416882000001 * var_x78;
        const double var_x102 = 50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x2 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x94 * var_x96;
        const double var_x103 = 0.0012574820180071425 * (9.0 / pow(var_x66, 3) + 56.399999999999999 / pow(var_x70, 3) + 0.97959183673469385 / pow(var_x72, 3) + 0.49704142011834318 / pow(var_x68, 3)) / pow((0.035460992907801421 + var_x71 + 0.15957446808510639 * var_x67 + 0.12158054711246201 * var_x73 + 0.11456628477905074 * var_x69), 2);
        const double var_x104 = var_x80 * var_x84;
        const double var_x105 = pow(var_chaste_interface__Na__Na_i, 2.0);
        const double var_x106 = var_x105 * var_x86 * var_x97;
        const double var_x107 = var_x105 * var_x95;
        const double var_x108 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x109 = var_x108 * var_chaste_interface__Irel__xir;
        const double var_x110 = fabs(var_x101);
        const double var_x111 = var_x65 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x112 = var_x110 * var_x111;
        const double var_x113 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x114 = var_x113 / (1.0 + var_x113);
        const double var_x115 = 0.028675444444444444 * var_x114;
        const double var_x116 = var_chaste_interface__Irel__Ca_JSR > 50.0;
        const double var_x117 = var_chaste_interface__Irel__Ca_JSR < 90.0;
        const double var_x118 = (var_x116) && (var_x117) && (var_x79);
        const double var_x119 = 0.32403252222222223 * var_x114;
        const double var_x120 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x121 = (var_x120) && (var_x79);
        const double var_x122 = fabs(0.0078521942756732046 * var_x81);
        const double var_x123 = var_x111 * var_x122;
        const double var_x124 = (var_x116) && (var_x117);
        const double var_x125 = var_x19 - var_x21 - var_chaste_interface__Irel__xir;
        const double var_x126 = (var_x108 * var_x26 - 1.0 * var_x125 / var_x13) * var_chaste_interface__Irel__xir;
        const double var_x127 = var_x115 * var_x65;
        const double var_x128 = -50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x129 = var_x110 * var_x128;
        const double var_x130 = -977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR;
        const double var_x131 = var_x127 * var_x130;
        const double var_x132 = var_x122 * var_x128;
        const double var_x133 = var_x115 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x134 = var_x130 * var_x133;
        const double var_x135 = ((var_x118) ? (-var_x129 * var_x133) : ((var_x121) ? (-var_x110 * var_x134) : ((var_x79) ? (0) : ((var_x124) ? (-var_x132 * var_x133) : ((var_x120) ? (-var_x122 * var_x134) : (0))))));
        const double var_x136 = var_x114 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x137 = var_x128 * var_x136;
        const double var_x138 = Signum(var_x101);
        const double var_x139 = var_x138 * var_x84;
        const double var_x140 = 2.9881008538774201e-6 * var_x139;
        const double var_x141 = var_x130 * var_x136;
        const double var_x142 = Signum(var_x81);
        const double var_x143 = var_x104 * var_x142;
        const double var_x144 = 2.2516516071905168e-7 * var_x143;
        const double var_x145 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x146 = var_x145 / (1.0 + var_x145);
        const double var_x147 = var_x112 * var_x146;
        const double var_x148 = var_x123 * var_x146;
        const double var_x149 = 298.24222222222221 * var_x146;
        const double var_x150 = var_x149 * var_x65;
        const double var_x151 = var_x130 * var_x150;
        const double var_x152 = -9000.0 * var_x110;
        const double var_x153 = var_x149 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x154 = var_x130 * var_x153;
        const double var_x155 = -9000.0 * var_x122;
        const double var_x156 = ((var_x118) ? (var_x152 - var_x129 * var_x153) : ((var_x121) ? (var_x152 - var_x110 * var_x154) : ((var_x79) ? (var_x152) : ((var_x124) ? (var_x155 - var_x132 * var_x153) : ((var_x120) ? (var_x155 - var_x122 * var_x154) : (var_x155))))));
        const double var_x157 = var_x146 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x158 = var_x128 * var_x157;
        const double var_x159 = 0.0310780828736964 * var_x139;
        const double var_x160 = var_x77 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca);
        const double var_x161 = 2.0 + 0.00010420416882000001 * var_x138 * var_x160;
        const double var_x162 = var_x130 * var_x157;
        const double var_x163 = 0.0023418558700973894 * var_x143;
        const double var_x164 = 2.0 + 7.8521942756732062e-6 * var_x142 * var_x160 * var_x80;
        const double var_x165 = 1 / (1.0 + 0.1245 * exp(-0.0037676968035880187 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(2.0208023774145616)) * exp(-0.037676968035880186 * var_chaste_interface__cell__V));
        
        // Matrix entries
        rJacobian[0][0] = 1.0 -(mDt * (-0.019599999999999999 - var_x0));
        rJacobian[0][1] = -(mDt * (0));
        rJacobian[0][2] = -(mDt * (2289.0 - var_x1));
        rJacobian[0][3] = -(mDt * (0));
        rJacobian[0][4] = -(mDt * (0));
        rJacobian[0][5] = -(mDt * (0));
        rJacobian[0][6] = -(mDt * (0));
        ...
        rJacobian[1][0] = -(mDt * (0));
        rJacobian[1][1] = 1.0 -(mDt * (-0.019599999999999999 - var_x2));
        rJacobian[1][2] = -(mDt * (0));
        rJacobian[1][3] = -(mDt * (0));
        rJacobian[1][4] = -(mDt * (0));
        rJacobian[1][5] = -(mDt * (0));
        ...
        rJacobian[1][11] = -(mDt * (2.2890000000000001 - var_x3));
        rJacobian[1][12] = -(mDt * (0));
        rJacobian[1][13] = -(mDt * (0));
        rJacobian[1][14] = -(mDt * (0));
        rJacobian[2][0] = -(mDt * (var_x10 * (0.019599999999999999 + var_x0)));
        rJacobian[2][1] = -(mDt * (0));
        rJacobian[2][2] = 1.0 -(mDt * (var_x10 * (-2539.0 + var_x1 + var_x12 - var_x16 - var_x18) + 0.001 * (0.00033599999999999998 / pow(var_x4, 3) + 0.0010919999999999999 / pow(var_x5, 3) + 8.9999999999999985e-6 / pow(var_x6, 3) + 5.6399999999999995e-5 / pow(var_x7, 3)) * (var_x21 - var_x19 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x0 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x8, 2)));
        rJacobian[2][3] = -(mDt * (0));
        rJacobian[2][4] = -(mDt * (var_x10 * (var_x22 + var_x23 - var_x24)));
        rJacobian[2][5] = -(mDt * (0));
        rJacobian[2][6] = -(mDt * (0));
        rJacobian[2][7] = -(mDt * (0));
        rJacobian[2][8] = -(mDt * (0));
        ...
        rJacobian[2][11] = -(mDt * (0.00025000000000000001 * var_x9));
        ...
        rJacobian[3][1] = -(mDt * (0));
        rJacobian[3][2] = -(mDt * (0));
        rJacobian[3][3] = 1.0 -(mDt * (-0.01));
        rJacobian[3][4] = -(mDt * (0.01));
        rJacobian[3][5] = -(mDt * (0));
        rJacobian[3][6] = -(mDt * (0));
        rJacobian[3][7] = -(mDt * (0));
        rJacobian[3][8] = -(mDt * (0));
        ...
        rJacobian[4][0] = -(mDt * (0));
        rJacobian[4][1] = -(mDt * (0));
        rJacobian[4][2] = -(mDt * (var_x25));
        rJacobian[4][3] = -(mDt * (0));
        rJacobian[4][4] = 1.0 -(mDt * (var_x26));
        rJacobian[4][5] = -(mDt * (0));
        rJacobian[4][6] = -(mDt * (0));
        rJacobian[4][7] = -(mDt * (0));
        rJacobian[4][8] = -(mDt * (0));
        ...
        rJacobian[5][3] = -(mDt * (0));
        rJacobian[5][4] = -(mDt * (0));
        rJacobian[5][5] = 1.0 -(mDt * (-4.3041299999999998 + var_x28 - 0.024167999999999999 * var_x31));
        rJacobian[5][6] = -(mDt * (-2.99776));
        rJacobian[5][7] = -(mDt * (-3.0));
        rJacobian[5][8] = -(mDt * (-3.0 + var_x28));
        rJacobian[5][9] = -(mDt * (-2.999896385));
        rJacobian[5][10] = -(mDt * (-3.0));
        rJacobian[5][11] = -(mDt * (0));
        rJacobian[5][12] = -(mDt * (0));
        rJacobian[5][13] = -(mDt * (-var_x34));
        ...
        rJacobian[6][3] = -(mDt * (0));
        rJacobian[6][4] = -(mDt * (0));
        rJacobian[6][5] = -(mDt * (0.0021800000000000001));
        rJacobian[6][6] = 1.0 -(mDt * (-0.33762909604519775 + var_x35));
        rJacobian[6][7] = -(mDt * (-0.0019499999999999999 + var_x44));
        rJacobian[6][8] = -(mDt * (-0.0019499999999999999));
        rJacobian[6][9] = -(mDt * (-0.0019499999999999999));
        rJacobian[6][10] = -(mDt * (-0.0019499999999999999));
        ...
        rJacobian[7][4] = -(mDt * (0));
        rJacobian[7][5] = -(mDt * (0));
        rJacobian[7][6] = -(mDt * (var_x42));
        rJacobian[7][7] = 1.0 -(mDt * (-var_x44 - var_x48));
        rJacobian[7][8] = -(mDt * (var_x49));
        rJacobian[7][9] = -(mDt * (0));
        ...
        rJacobian[8][3] = -(mDt * (0));
        rJacobian[8][4] = -(mDt * (0));
        rJacobian[8][5] = -(mDt * (var_x41));
        rJacobian[8][6] = -(mDt * (0));
        rJacobian[8][7] = -(mDt * (var_x48));
        rJacobian[8][8] = 1.0 -(mDt * (var_x40 - var_x49 - var_x55));
        rJacobian[8][9] = -(mDt * (0));
        rJacobian[8][10] = -(mDt * (var_x56));
        rJacobian[8][11] = -(mDt * (0));
        rJacobian[8][12] = -(mDt * (0));
        rJacobian[8][13] = -(mDt * (var_x61 + (-var_x59 - var_x60) * var_chaste_interface__ICaL__c2));
        ...
        rJacobian[9][3] = -(mDt * (0));
        rJacobian[9][4] = -(mDt * (0));
        rJacobian[9][5] = -(mDt * (0.0058991999999999968 * var_x31));
        rJacobian[9][6] = -(mDt * (var_x62));
        rJacobian[9][7] = -(mDt * (var_x62));
        rJacobian[9][8] = -(mDt * (var_x62));
        rJacobian[9][9] = 1.0 -(mDt * (-0.33343694833333332 + var_x35 + var_x62 - 1.8929217120000003e-7 * var_x31 * var_x63));
        rJacobian[9][10] = -(mDt * (var_x62 + var_x64));
        rJacobian[9][11] = -(mDt * (0));
        rJacobian[9][12] = -(mDt * (0));
        rJacobian[9][13] = -(mDt * (var_x34 + (0.00063442013684210537 * var_x31 * var_x32 - 2.1032463466666669e-8 * var_x33 * var_x63) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x33 * var_x65));
        ...
        rJacobian[10][8] = -(mDt * (var_x55));
        rJacobian[10][9] = -(mDt * (var_x42));
        rJacobian[10][10] = 1.0 -(mDt * (-var_x56 - var_x64));
        rJacobian[10][11] = -(mDt * (0));
        rJacobian[10][12] = -(mDt * (0));
        rJacobian[10][13] = -(mDt * (-var_x61 + var_x59 * var_chaste_interface__ICaL__c2 + var_x60 * var_chaste_interface__ICaL__c2));
        rJacobian[10][14] = -(mDt * (0));
        rJacobian[11][0] = -(mDt * (0));
        rJacobian[11][1] = -(mDt * (var_x75 * (0.019599999999999999 + var_x2)));
        rJacobian[11][2] = -(mDt * (12500.0 * var_x74));
        rJacobian[11][3] = -(mDt * (0));
        rJacobian[11][4] = -(mDt * (0));
        rJacobian[11][5] = -(mDt * (var_x83));
        rJacobian[11][6] = -(mDt * (var_x83));
        rJacobian[11][7] = -(mDt * (var_x83));
        rJacobian[11][8] = -(mDt * (var_x83));
        rJacobian[11][9] = -(mDt * (var_x83));
        rJacobian[11][10] = -(mDt * (var_x83));
        rJacobian[11][11] = 1.0 -(mDt * (((var_x79) ? (var_x103 * (var_x102 - 9100.0 * var_x101 * var_x65) + var_x75 * (var_x100 - 0.94825793626200006 * var_x84)) : (var_x103 * (var_x102 - var_x65 * var_x82) + var_x75 * (var_x100 - 0.071454967908626169 * var_x104)))));
        rJacobian[11][12] = -(mDt * (50.0 * var_x74));
        rJacobian[11][13] = -(mDt * (0));
        rJacobian[11][14] = -(mDt * (var_x75 * (226.80000000000001 * var_x106 - 6.52262738373438e-6 * var_x107)));
        rJacobian[12][0] = -(mDt * (0));
        rJacobian[12][1] = -(mDt * (0));
        rJacobian[12][2] = -(mDt * (var_x109 * var_x25));
        rJacobian[12][3] = -(mDt * (((var_x118) ? (var_x112 * var_x115) : ((var_x121) ? (var_x112 * var_x119) : ((var_x79) ? (0) : ((var_x124) ? (var_x115 * var_x123) : ((var_x120) ? (var_x119 * var_x123) : (0))))))));
        rJacobian[12][4] = -(mDt * (((var_x118) ? (var_x126 + var_x127 * var_x129) : ((var_x121) ? (var_x126 + var_x110 * var_x131) : ((var_x79) ? (var_x126) : ((var_x124) ? (var_x126 + var_x127 * var_x132) : ((var_x120) ? (var_x126 + var_x122 * var_x131) : (var_x126))))))));
        rJacobian[12][5] = -(mDt * (var_x135));
        rJacobian[12][6] = -(mDt * (var_x135));
        rJacobian[12][7] = -(mDt * (var_x135));
        rJacobian[12][8] = -(mDt * (var_x135));
        rJacobian[12][9] = -(mDt * (var_x135));
        rJacobian[12][10] = -(mDt * (var_x135));
        rJacobian[12][11] = -(mDt * (((var_x118) ? (var_x137 * var_x140) : ((var_x121) ? (var_x140 * var_x141) : ((var_x79) ? (0) : ((var_x124) ? (var_x137 * var_x144) : ((var_x120) ? (var_x141 * var_x144) : (0))))))));
        rJacobian[12][12] = 1.0 -(mDt * (-0.033333333333333333 - var_x109 + var_x108 * var_x125));
        rJacobian[12][13] = -(mDt * (0));
        rJacobian[12][14] = -(mDt * (0));
        rJacobian[13][0] = -(mDt * (0));
        rJacobian[13][1] = -(mDt * (0));
        rJacobian[13][2] = -(mDt * (0));
        rJacobian[13][3] = -(mDt * (((var_x118) ? (298.24222222222221 * var_x147) : ((var_x121) ? (3370.1371111111112 * var_x147) : ((var_x79) ? (0) : ((var_x124) ? (298.24222222222221 * var_x148) : ((var_x120) ? (3370.1371111111112 * var_x148) : (0))))))));
        rJacobian[13][4] = -(mDt * (((var_x118) ? (var_x129 * var_x150) : ((var_x121) ? (var_x110 * var_x151) : ((var_x79) ? (0) : ((var_x124) ? (var_x132 * var_x150) : ((var_x120) ? (var_x122 * var_x151) : (0))))))));
        rJacobian[13][5] = -(mDt * (var_x156));
        rJacobian[13][6] = -(mDt * (var_x156));
        rJacobian[13][7] = -(mDt * (var_x156));
        rJacobian[13][8] = -(mDt * (var_x156));
        rJacobian[13][9] = -(mDt * (var_x156));
        rJacobian[13][10] = -(mDt * (var_x156));
        rJacobian[13][11] = -(mDt * (((var_x118) ? (var_x161 + var_x158 * var_x159) : ((var_x121) ? (var_x161 + var_x159 * var_x162) : ((var_x79) ? (var_x161) : ((var_x124) ? (var_x164 + var_x158 * var_x163) : ((var_x120) ? (var_x164 + var_x162 * var_x163) : (var_x164))))))));
        rJacobian[13][12] = -(mDt * (0));
        rJacobian[13][13] = 1.0 -(mDt * (-2.0));
        ...
        rJacobian[14][11] = -(mDt * (6.3389491199999997 * var_x98 + 6.7398201688830334e-8 * var_x95 - 0.00020411999999999996 * var_x99));
        rJacobian[14][12] = -(mDt * (0));
        rJacobian[14][13] = -(mDt * (0));
        rJacobian[14][14] = 1.0 -(mDt * (3.9135764302406278e-10 * var_x107 - 0.013608 * var_x106 - 0.00044021739130434783 * var_x165 / (12.0 + var_chaste_interface__Na__Na_i) + 3.0570652173913045e-6 * var_x165 * var_chaste_interface__Na__Na_i / pow((1 + 0.083333333333333329 * var_chaste_interface__Na__Na_i), 2) - 0.039812120725094803 * pow(var_chaste_interface__INa__xm, 3) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj / var_chaste_interface__Na__Na_i));
    }
    ...
    void Cellmahajan_2008FromCellMLBackwardEuler::ComputeOneStepExceptVoltage(double var_chaste_interface__Environment__time)
    {
        ...
        rY[11] = (var_chaste_interface__IKr__xr + (((((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) && (fabs(10.0 + var_chaste_interface__cell__V) > 0.001)) ? (0.0060999999999999995 / (-1.0 + 1.0 * exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) - 0.0096600000000000002 / (-1.0 + 1.0 * exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) + 0.00060999999999999997 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) - 0.0013799999999999999 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V))) : ((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) ? (0.0042068965517241376 / (1.0 + exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) - 0.0096600000000000002 / (-1.0 + 1.0 * exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) - 0.0013799999999999999 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V))) : ((fabs(10.0 + var_chaste_interface__cell__V) > 0.001) ? (0.0060999999999999995 / (-1.0 + 1.0 * exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) + 0.011219512195121951 / (1.0 + exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V)) + 0.00060999999999999997 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V) + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V) * exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V))) : (0.015426408746846089 / (1.0 + exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V))))))) * mDt)) / (1.0 - (((((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) && (fabs(10.0 + var_chaste_interface__cell__V) > 0.001)) ? (-0.0060999999999999995 / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)) - 0.0096600000000000002 / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V)) - 0.00060999999999999997 * var_chaste_interface__cell__V / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)) - 0.0013799999999999999 * var_chaste_interface__cell__V / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V))) : ((fabs(7.0 + var_chaste_interface__cell__V) > 0.001) ? (-0.0042068965517241376 - 0.0096600000000000002 / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V)) - 0.0013799999999999999 * var_chaste_interface__cell__V / (1.0 - exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V))) : ((fabs(10.0 + var_chaste_interface__cell__V) > 0.001) ? (-0.011219512195121951 - 0.0060999999999999995 / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V)) - 0.00060999999999999997 * var_chaste_interface__cell__V / (-1.0 + exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V))) : (-0.015426408746846089))))) * mDt));
        rY[12] = (var_chaste_interface__IKs__xs1 + ((((fabs(30.0 + var_chaste_interface__cell__V) < 0.014556040756914121) ? (0.0023926521499665608 / (1.0 + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V))) : (0.0039300000000000003 / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V)) - 0.0021570000000000001 / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V)) + 0.00013100000000000001 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V)) - 7.1899999999999999e-5 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))))) * mDt)) / (1.0 - ((((fabs(30.0 + var_chaste_interface__cell__V) < 0.014556040756914121) ? (-0.0023926521499665608) : (-0.0039300000000000003 / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) - 0.0021570000000000001 / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V)) - 0.00013100000000000001 * var_chaste_interface__cell__V / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) - 7.1899999999999999e-5 * var_chaste_interface__cell__V / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))))) * mDt));
        rY[13] = (var_chaste_interface__IKs__xs2 + ((((fabs(30.0 + var_chaste_interface__cell__V) < 0.014556040756914121) ? (0.00059816303749164019 / (1.0 + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V))) : (0.00098250000000000008 / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V)) - 0.00053925000000000002 / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V)) + 3.2750000000000003e-5 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V) * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V)) - 1.7975e-5 * var_chaste_interface__cell__V / (-1.0 + 1.0 * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V) - 1.0 * exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) + exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V) * exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))))) * mDt)) / (1.0 - ((((fabs(30.0 + var_chaste_interface__cell__V) < 0.014556040756914121) ? (-0.00059816303749164019) : (-0.00098250000000000008 / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) - 0.00053925000000000002 / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V)) - 3.2750000000000003e-5 * var_chaste_interface__cell__V / (-1.0 + exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V)) - 1.7975e-5 * var_chaste_interface__cell__V / (1.0 - exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V))))) * mDt));
        rY[3] = (var_chaste_interface__INa__xh + ((((var_chaste_interface__cell__V < -40.0) ? (0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V)) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__cell__V < -40.0) ? (-310000.0 * exp(0.34999999999999998 * var_chaste_interface__cell__V) - 0.13500000000000001 * exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V) - 3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__cell__V)) : (-7.6923076923076916 / (1.0 + exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V))))) * mDt));
        rY[4] = (var_chaste_interface__INa__xj + ((((var_chaste_interface__cell__V < -40.0) ? (-4803349.2000000002 * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 0.0013124772000000001 * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 127140.0 * var_chaste_interface__cell__V * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 3.4740000000000003e-5 * var_chaste_interface__cell__V * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (0))) * mDt)) / (1.0 - ((((var_chaste_interface__cell__V < -40.0) ? (4803349.2000000002 * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) + 0.0013124772000000001 * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) - 0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V)) + 127140.0 * var_chaste_interface__cell__V * exp(0.24440000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V)) + 3.4740000000000003e-5 * var_chaste_interface__cell__V * exp(-0.043909999999999998 * var_chaste_interface__cell__V) / (1.0 + exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V))) : (-0.29999999999999999 * exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V) / (1.0 + exp(-3.2000000000000002 - 0.10000000000000001 * var_chaste_interface__cell__V))))) * mDt));
        rY[2] = (var_chaste_interface__INa__xm + ((((fabs(47.130000000000003 + var_chaste_interface__cell__V) > 0.001) ? (-15.081600000000002 / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)) - 0.32000000000000001 * var_chaste_interface__cell__V / (-1.0 + exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V))) : (3.2000000000000002))) * mDt)) / (1.0 - ((((fabs(47.130000000000003 + var_chaste_interface__cell__V) > 0.001) ? (-0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__cell__V) - 15.081600000000002 / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V)) - 0.32000000000000001 * var_chaste_interface__cell__V / (1.0 - exp(-4.7130000000000001 - 0.10000000000000001 * var_chaste_interface__cell__V))) : (-3.2000000000000002 - 0.080000000000000002 * exp(-0.090909090909090912 * var_chaste_interface__cell__V)))) * mDt));
        rY[16] = (var_chaste_interface__Ito__xtof + ((1.0 / (1.5 + 1.5 * exp(-0.20000000000000001 - 0.066666666666666666 * var_chaste_interface__cell__V) + 3.5 * exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2)) + 3.5 * exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2)) * exp(-0.20000000000000001 - 0.066666666666666666 * var_chaste_interface__cell__V))) * mDt)) / (1.0 - ((-1 / (1.5 + 3.5 * exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2)))) * mDt));
        rY[14] = (var_chaste_interface__Ito__xtos + ((1.0 / (0.5 + 0.5 * exp(-0.20000000000000001 - 0.066666666666666666 * var_chaste_interface__cell__V) + 9.0 / (1.0 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__V)) + 9.0 * exp(-0.20000000000000001 - 0.066666666666666666 * var_chaste_interface__cell__V) / (1.0 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__V)))) * mDt)) / (1.0 - ((-1 / (0.5 + 9.0 / (1.0 + exp(0.20000000000000001 + 0.066666666666666666 * var_chaste_interface__cell__V)))) * mDt));
        rY[17] = (var_chaste_interface__Ito__ytof + ((1.0 / (20.0 + 20.0 / (1.0 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 20.0 * exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V) + 20.0 * exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)))) * mDt)) / (1.0 - ((-1 / (20.0 + 20.0 / (1.0 + exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V)))) * mDt));
        rY[15] = (var_chaste_interface__Ito__ytos + ((1.0 / (30.0 + 30.0 * exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V) + 3000.0 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__cell__V)) + 3000.0 * exp(3.3500000000000001 + 0.10000000000000001 * var_chaste_interface__cell__V) / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__cell__V)))) * mDt)) / (1.0 - ((-1 / (30.0 + 3000.0 / (1.0 + exp(6.0 + 0.10000000000000001 * var_chaste_interface__cell__V)))) * mDt));
