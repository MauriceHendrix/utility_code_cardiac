...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellmahajan_2008FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__cell__stim_amplitude = var_-15.0 * HeartConfig::Instance()->GetCapacitance(); // uA_per_uF
                ...
                pIntracellularStimulus)
    {
        ...
        this->mParameters[0] = 1.0; // (ar_IKr__ScaleFactorGkr) [dimensionless]
        this->mParameters[1] = 1.0; // (ar_IKs__ScaleFactorGks) [dimensionless]
        this->mParameters[2] = 1.0; // (ar_Ito__ScaleFactorIto) [dimensionless]
    }
    ...
    double Cellmahajan_2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_Ca__csm = var_chaste_interface__Ca__Ca_submem / 1000.0; // mM
        ...
        const double var_ICaL__po = -var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca + 1.0; // dimensionless
        ...
        const double var_IKs__gksx = 0.8 / (pow((0.001 * 0.5 / var_chaste_interface__Ca__Ca_i), 3.0) + 1.0) + 1.0; // dimensionless
        const double var_INa__gna = 12.0; // uS_per_nF
        const double var_INaCa__gNaCa = 0.84; // uM_per_ms
        const double var_INaCa__xkdna = 0.3; // uM
        const double var_INaCa__aloss = 1.0 / (pow((var_INaCa__xkdna / var_chaste_interface__Ca__Ca_submem), 3.0) + 1.0); // dimensionless
        ...
        const double var_INaCa__yz2 = pow(var_INaCa__xmnai, 3.0) * (var_Ca__csm / var_INaCa__xmcai + 1.0) * var_Environment__Ca_o; // mM4
        ...
        const double var_INaCa__yz3 = pow(var_Environment__Na_o, 3.0) * (pow((var_chaste_interface__Na__Na_i / var_INaCa__xmnai), 3.0) + 1.0) * var_INaCa__xmcai; // mM4
        ...
        const double var_ICaL__rxa = ((0.001 > fabs(var_ICaL__za)) ? ((var_Ca__csm * exp(var_ICaL__za) - 0.341 * var_Environment__Ca_o) * 4.0 * var_Environment__F * var_ICaL__pca / 2.0) : ((var_Ca__csm * exp(var_ICaL__za) - 0.341 * var_Environment__Ca_o) * 4.0 * var_Environment__F * var_Environment__FonRT * var_ICaL__pca * var_chaste_interface__cell__V / (-1.0 + exp(var_ICaL__za)))); // mA_per_cm2
        const double var_ICaL__jca = var_ICaL__gca * var_ICaL__po * var_ICaL__rxa; // uM_per_ms
        const double var_IKr__rg = 1.0 / (1.0 + exp((33.0 + var_chaste_interface__cell__V) / 22.4)); // dimensionless
        const double var_INaCa__zw3 = pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o * exp(0.35 * var_Environment__FonRT * var_chaste_interface__cell__V) - pow(var_Environment__Na_o, 3.0) * var_Ca__csm * exp((-1.0 + 0.35) * var_Environment__FonRT * var_chaste_interface__cell__V); // mM4
        const double var_INaCa__zw4 = 0.2 * exp((-1.0 + 0.35) * var_Environment__FonRT * var_chaste_interface__cell__V) + 1.0; // dimensionless
        ...
        const double var_Ito__rt2 = (33.5 + var_chaste_interface__cell__V) / 10.0; // dimensionless
        ...
        const double var_IK1__aki = 1.02 / (1.0 + exp((-59.215 - var_reversal_potentials__ek + var_chaste_interface__cell__V) * 0.2385)); // per_ms
        const double var_IK1__bki = (0.49124 * exp((-var_reversal_potentials__ek + 5.476 + var_chaste_interface__cell__V) * 0.08032) + 1.0 * exp((-594.31 - var_reversal_potentials__ek + var_chaste_interface__cell__V) * 0.06175)) / (1.0 + exp(-(-var_reversal_potentials__ek + 4.753 + var_chaste_interface__cell__V) * 0.5143)); // per_ms
        const double var_IK1__xkin = var_IK1__aki / (var_IK1__aki + var_IK1__bki); // dimensionless
        const double var_IK1__xik1 = sqrt(var_Environment__K_o / 5.4) * (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * var_IK1__gkix * var_IK1__xkin; // nA_per_nF
        const double var_IKr__xikr = sqrt(var_Environment__K_o / 5.4) * (-var_reversal_potentials__ek + var_chaste_interface__cell__V) * mParameters[0] * var_IKr__gkr * var_IKr__rg * var_chaste_interface__IKr__xr; // nA_per_nF
    ...
    void Cellmahajan_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_Ca__mempxi = 1e-06 * var_Ca__bmem * var_Ca__kmem / pow((0.001 * var_Ca__kmem + var_chaste_interface__Ca__Ca_i), 2); // dimensionless
        ...
        const double var_Ca__sarpxi = 1e-06 * var_Ca__bsar * var_Ca__ksar / pow((0.001 * var_Ca__ksar + var_chaste_interface__Ca__Ca_i), 2); // dimensionless
        ...
        const double var_Ca__spxi = 1e-06 * var_Ca__srkd * var_Ca__srmax / pow((0.001 * var_Ca__srkd + var_chaste_interface__Ca__Ca_i), 2); // dimensionless
        ...
        const double var_Ca__bpxi = 1e-06 * var_Ca__bcal * var_Ca__xkcal / pow((0.001 * var_Ca__xkcal + var_chaste_interface__Ca__Ca_i), 2); // dimensionless
        ...
        const double d_dt_chaste_interface_var_Ca__tropi = var_Ca__xbi; // uM / millisecond
        const double d_dt_chaste_interface_var_Ca__trops = var_Ca__xbs; // uM / millisecond
        const double var_Environment__Ca_o = 1.8; // mM
        const double var_Environment__F = 96.4853415; // coulomb_per_mmole
        const double var_Environment__K_o = 5.4; // mM
        const double var_Environment__Na_o = 136.0; // mM
        ...
        const double var_ICaL__fca = 1.0 / (pow((var_ICaL__cat / var_chaste_interface__Ca__Ca_dyad), 3.0) + 1.0); // dimensionless
        const double var_ICaL__gca = 182.0; // mmole_per_coulomb_cm
        ...
        const double var_ICaL__tau_ca = var_ICaL__tca / (pow((var_chaste_interface__Ca__Ca_dyad / var_ICaL__cpt), 4.0) + 1.0) + 0.1; // ms
        const double var_ICaL__vth = 0.0; // mV
        const double var_ICaL__vx = var_-40.0; // mV
        const double var_ICaL__vy = var_-40.0; // mV
        const double var_ICaL__vyr = var_-40.0; // mV
        const double var_ICaL__po = -var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca + 1.0; // dimensionless
        const double var_INa__gna = 12.0; // uS_per_nF
        const double var_INaCa__gNaCa = 0.84; // uM_per_ms
        const double var_INaCa__xkdna = 0.3; // uM
        ...
        const double var_Ileak_Iup_Ixfer__jleak = pow(var_chaste_interface__Ca__Ca_NSR, 2) * (-1000.0 * var_chaste_interface__Ca__Ca_i + 16.667 * var_chaste_interface__Ca__Ca_NSR) * var_Ileak_Iup_Ixfer__gleak / (pow(var_chaste_interface__Ca__Ca_NSR, 2) + pow(var_Ileak_Iup_Ixfer__kj, 2)); // uM_per_ms
        ...
        const double d_dt_chaste_interface_var_Ca__Ca_i = 0.001 * (-var_Ca__xbi - var_Ileak_Iup_Ixfer__jup + var_Ca__jd + var_Ileak_Iup_Ixfer__jleak) * var_Ca__dciib; // millimolar / millisecond
        ...
        const double var_Irel__bv = -50.0 + (-var_Irel__av + 1.0) * var_Irel__cstar; // uM_per_ms
        const double var_Irel__Qr0 = (((50.0 < var_chaste_interface__Irel__Ca_JSR) && (var_chaste_interface__Irel__Ca_JSR < var_Irel__cstar)) ? ((-50.0 + var_chaste_interface__Irel__Ca_JSR) / 1.0) : ((var_chaste_interface__Irel__Ca_JSR >= var_Irel__cstar) ? (var_chaste_interface__Irel__Ca_JSR * var_Irel__av + var_Irel__bv) : (0.0))); // uM_per_ms
        ...
        const double d_dt_chaste_interface_var_Irel__Ca_JSR = (-var_chaste_interface__Irel__Ca_JSR + var_chaste_interface__Ca__Ca_NSR) / var_Irel__taua; // uM / millisecond
        ...
        const double d_dt_chaste_interface_var_Ca__Ca_NSR = var_Ca__dCa_JSR; // uM / millisecond
        const double var_INaCa__yz1 = pow(var_INaCa__xmnao, 3.0) * var_Ca__csm + pow(var_chaste_interface__Na__Na_i, 3.0) * var_INaCa__xmcao; // mM4
        const double var_INaCa__yz3 = pow(var_Environment__Na_o, 3.0) * (pow((var_chaste_interface__Na__Na_i / var_INaCa__xmnai), 3.0) + 1.0) * var_INaCa__xmcai; // mM4
        const double var_INaCa__yz4 = pow(var_Environment__Na_o, 3.0) * var_Ca__csm + pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o; // mM4
        const double var_INaCa__zw8 = var_INaCa__yz1 + var_INaCa__yz2 + var_INaCa__yz3 + var_INaCa__yz4; // mM4
        const double var_ICaL__Pr = -1.0 / (1.0 + exp((-var_chaste_interface__cell__V + var_ICaL__vy) / var_ICaL__sy)) + 1.0; // dimensionless
        ...
        const double var_ICaL__k3 = (-var_ICaL__poi + 1.0) / var_ICaL__tau3; // per_ms
        ...
        const double var_ICaL__beta = (-var_ICaL__poinf + 1.0) / var_ICaL__taupo; // per_ms
        ...
        const double var_ICaL__recov = 4954.0 * exp(var_chaste_interface__cell__V / 15.6) + 10.0; // ms
        const double var_ICaL__tauba = (-450.0 + var_ICaL__recov) * var_ICaL__Pr + 450.0; // ms
        const double var_ICaL__k5t = (-var_ICaL__Ps + 1.0) / var_ICaL__tauba; // per_ms
        ...
        const double d_dt_chaste_interface_var_ICaL__xi1ba = var_chaste_interface__ICaL__c1 * var_ICaL__k1t + var_ICaL__k4t * var_chaste_interface__ICaL__xi2ba + var_ICaL__po * var_ICaL__s1t - (var_ICaL__k2t + var_ICaL__k3t + var_ICaL__s2t) * var_chaste_interface__ICaL__xi1ba; // 1 / millisecond
        const double d_dt_chaste_interface_var_ICaL__xi2ba = var_chaste_interface__ICaL__c2 * var_ICaL__k6t + var_ICaL__k3t * var_chaste_interface__ICaL__xi1ba - (var_ICaL__k4t + var_ICaL__k5t) * var_chaste_interface__ICaL__xi2ba; // 1 / millisecond
        const double var_ICaL__tauca = (-var_ICaL__tau_ca + var_ICaL__recov) * var_ICaL__Pr + var_ICaL__tau_ca; // ms
        const double var_ICaL__k5 = (-var_ICaL__Ps + 1.0) / var_ICaL__tauca; // per_ms
        const double var_ICaL__k6 = var_ICaL__Ps * var_ICaL__fca / var_ICaL__tauca; // per_ms
        const double d_dt_chaste_interface_var_ICaL__c2 = var_ICaL__beta * var_chaste_interface__ICaL__c1 + var_ICaL__k5 * var_chaste_interface__ICaL__xi2ca + var_ICaL__k5t * var_chaste_interface__ICaL__xi2ba - (var_ICaL__alpha + var_ICaL__k6 + var_ICaL__k6t) * var_chaste_interface__ICaL__c2; // 1 / millisecond
        ...
        const double d_dt_chaste_interface_var_ICaL__xi1ca = var_chaste_interface__ICaL__c1 * var_ICaL__k1 + var_ICaL__k4 * var_chaste_interface__ICaL__xi2ca + var_ICaL__po * var_ICaL__s1 - (var_ICaL__k2 + var_ICaL__k3 + var_ICaL__s2) * var_chaste_interface__ICaL__xi1ca; // 1 / millisecond
        const double d_dt_chaste_interface_var_ICaL__xi2ca = var_chaste_interface__ICaL__c2 * var_ICaL__k6 + var_ICaL__k3 * var_chaste_interface__ICaL__xi1ca - (var_ICaL__k4 + var_ICaL__k5) * var_chaste_interface__ICaL__xi2ca; // 1 / millisecond
        const double var_ICaL__za = 2.0 * var_Environment__FonRT * var_chaste_interface__cell__V; // dimensionless
        const double var_ICaL__rxa = ((0.001 > fabs(var_ICaL__za)) ? ((var_Ca__csm * exp(var_ICaL__za) - 0.341 * var_Environment__Ca_o) * 4.0 * var_Environment__F * var_ICaL__pca / 2.0) : ((var_Ca__csm * exp(var_ICaL__za) - 0.341 * var_Environment__Ca_o) * 4.0 * var_Environment__F * var_Environment__FonRT * var_ICaL__pca * var_chaste_interface__cell__V / (-1.0 + exp(var_ICaL__za)))); // mA_per_cm2
        const double var_ICaL__jca = var_ICaL__gca * var_ICaL__po * var_ICaL__rxa; // uM_per_ms
        const double var_IKr__xkrinf = 1.0 / (1.0 + exp((-50.0 - var_chaste_interface__cell__V) / 7.5)); // dimensionless
        const double var_IKr__xkrv1 = ((0.001 < fabs(7.0 + var_chaste_interface__cell__V)) ? ((7.0 + var_chaste_interface__cell__V) * 0.00138 * 1.0 / (-exp(-(7.0 + var_chaste_interface__cell__V) * 0.123) + 1.0)) : (0.00138 / 0.123)); // per_ms
        const double var_IKr__xkrv2 = ((0.001 < fabs(10.0 + var_chaste_interface__cell__V)) ? ((10.0 + var_chaste_interface__cell__V) * 0.00061 * 1.0 / (-1.0 + exp((10.0 + var_chaste_interface__cell__V) * 0.145))) : (0.00061 / 0.145)); // per_ms
        const double var_IKr__taukr = 1.0 / (var_IKr__xkrv1 + var_IKr__xkrv2); // ms
        const double d_dt_chaste_interface_var_IKr__xr = (-var_chaste_interface__IKr__xr + var_IKr__xkrinf) / var_IKr__taukr; // 1 / millisecond
        const double var_IKs__tauxs1 = ((fabs(30.0 + var_chaste_interface__cell__V) < 0.001 / 0.0687) ? (1.0 / (0.000131 / 0.0687 + 7.19e-05 / 0.148)) : (1.0 / ((30.0 + var_chaste_interface__cell__V) * 0.000131 / (-1.0 + exp((30.0 + var_chaste_interface__cell__V) * 0.0687)) + (30.0 + var_chaste_interface__cell__V) * 7.19e-05 / (-exp(-(30.0 + var_chaste_interface__cell__V) * 0.148) + 1.0)))); // ms
        const double var_IKs__tauxs2 = 4.0 * var_IKs__tauxs1; // ms
        const double var_IKs__xs1ss = 1.0 / (1.0 + exp((-var_chaste_interface__cell__V + 1.5) / 16.7)); // dimensionless
        const double d_dt_chaste_interface_var_IKs__xs1 = (-var_chaste_interface__IKs__xs1 + var_IKs__xs1ss) / var_IKs__tauxs1; // 1 / millisecond
        const double var_IKs__xs2ss = var_IKs__xs1ss; // dimensionless
        const double d_dt_chaste_interface_var_IKs__xs2 = (-var_chaste_interface__IKs__xs2 + var_IKs__xs2ss) / var_IKs__tauxs2; // 1 / millisecond
        const double var_INa__ah = ((40.0 < -var_chaste_interface__cell__V) ? (0.135 * exp(-(80.0 + var_chaste_interface__cell__V) / 6.8)) : (0.0)); // per_ms
        const double var_INa__aj = ((40.0 < -var_chaste_interface__cell__V) ? ((-127140.0 * exp(0.2444 * var_chaste_interface__cell__V) - 3.474e-05 * exp(-0.04391 * var_chaste_interface__cell__V)) * (37.78 + var_chaste_interface__cell__V) * 1.0 / (1.0 + exp((79.23 + var_chaste_interface__cell__V) * 0.311))) : (0.0)); // per_ms
        const double var_INa__am = ((0.001 < fabs(47.13 + var_chaste_interface__cell__V)) ? ((47.13 + var_chaste_interface__cell__V) * 0.32 * 1.0 / (-exp(-(47.13 + var_chaste_interface__cell__V) * 0.1) + 1.0)) : (3.2)); // per_ms
        const double var_INa__bh = ((40.0 < -var_chaste_interface__cell__V) ? (3.56 * exp(0.079 * var_chaste_interface__cell__V) + 310000.0 * exp(0.35 * var_chaste_interface__cell__V)) : (1.0 / ((1.0 + exp(-(10.66 + var_chaste_interface__cell__V) / 11.1)) * 0.13))); // per_ms
        const double d_dt_chaste_interface_var_INa__xh = (-var_chaste_interface__INa__xh + 1.0) * var_INa__ah - var_INa__bh * var_chaste_interface__INa__xh; // 1 / millisecond
        const double var_INa__bj = ((40.0 < -var_chaste_interface__cell__V) ? (0.1212 * exp(-0.01052 * var_chaste_interface__cell__V) / (1.0 + exp(-(40.14 + var_chaste_interface__cell__V) * 0.1378))) : (0.3 * exp(-2.535e-07 * var_chaste_interface__cell__V) / (1.0 + exp(-(32.0 + var_chaste_interface__cell__V) * 0.1)))); // per_ms
        const double d_dt_chaste_interface_var_INa__xj = (-var_chaste_interface__INa__xj + 1.0) * var_INa__aj - var_INa__bj * var_chaste_interface__INa__xj; // 1 / millisecond
        const double var_INa__bm = 0.08 * exp(-var_chaste_interface__cell__V / 11.0); // per_ms
        const double d_dt_chaste_interface_var_INa__xm = (-var_chaste_interface__INa__xm + 1.0) * var_INa__am - var_INa__bm * var_chaste_interface__INa__xm; // 1 / millisecond
        const double var_INaCa__zw3 = pow(var_chaste_interface__Na__Na_i, 3.0) * var_Environment__Ca_o * exp(0.35 * var_Environment__FonRT * var_chaste_interface__cell__V) - pow(var_Environment__Na_o, 3.0) * var_Ca__csm * exp((-1.0 + 0.35) * var_Environment__FonRT * var_chaste_interface__cell__V); // mM4
        const double var_INaCa__zw4 = 0.2 * exp((-1.0 + 0.35) * var_Environment__FonRT * var_chaste_interface__cell__V) + 1.0; // dimensionless
        const double var_INaCa__jNaCa = var_INaCa__aloss * var_INaCa__gNaCa * var_INaCa__zw3 / (var_INaCa__zw4 * var_INaCa__zw8); // uM_per_ms
        const double d_dt_chaste_interface_var_Ca__Ca_submem = (-var_Ca__xbs + (-var_Ca__jd - var_ICaL__jca + var_INaCa__jNaCa + var_chaste_interface__Irel__xir) * 50.0) * var_Ca__dcsib; // uM / millisecond
        const double var_INaK__fNaK = 1.0 / (0.1245 * exp(-0.1 * var_Environment__FonRT * var_chaste_interface__cell__V) + 0.0365 * var_INaK__sigma * exp(-var_Environment__FonRT * var_chaste_interface__cell__V) + 1.0); // dimensionless
        const double var_INaK__xiNaK = var_Environment__K_o * var_INaK__fNaK * var_INaK__gNaK * var_chaste_interface__Na__Na_i / ((var_Environment__K_o + var_INaK__xkmko) * (var_INaK__xkmnai + var_chaste_interface__Na__Na_i)); // nA_per_nF
        ...
        const double var_Irel__spark_rate = fabs(var_ICaL__rxa) * var_ICaL__po * var_Irel__gryr * var_Irel__sparkV / 1.0; // per_ms
        const double d_dt_chaste_interface_var_Irel__xir = var_Irel__Qr * var_Irel__spark_rate - (-var_Ca__dCa_JSR * var_Irel__taur / var_chaste_interface__Ca__Ca_NSR + 1.0) * var_chaste_interface__Irel__xir / var_Irel__taur; // uM_per_ms / millisecond
        const double var_Irel__xicap = fabs(var_ICaL__rxa) * var_ICaL__po * var_Irel__gdyad; // uM_per_ms
        const double var_Irel__xirp = fabs(var_ICaL__rxa) * var_ICaL__po * var_Irel__Qr * var_Irel__gbarsr * exp(-(30.0 + var_chaste_interface__cell__V) * var_Irel__ax) / ((1.0 + exp(-(30.0 + var_chaste_interface__cell__V) * var_Irel__ax)) * 1.0); // uM_per_ms
        const double var_Irel__xiryr = var_Irel__xicap + var_Irel__xirp; // uM_per_ms
        const double d_dt_chaste_interface_var_Ca__Ca_dyad = -(-var_chaste_interface__Ca__Ca_submem + var_chaste_interface__Ca__Ca_dyad) / var_Ca__taups + var_Irel__xiryr; // uM / millisecond
        const double var_Ito__rt1 = (-3.0 - var_chaste_interface__cell__V) / 15.0; // dimensionless
        const double var_Ito__rt2 = (33.5 + var_chaste_interface__cell__V) / 10.0; // dimensionless
        const double var_Ito__rt3 = (60.0 + var_chaste_interface__cell__V) / 10.0; // dimensionless
        const double var_Ito__rt4 = -pow(var_chaste_interface__cell__V, 2) / (30.0 * 30.0); // dimensionless
        const double var_Ito__rt5 = (33.5 + var_chaste_interface__cell__V) / 10.0; // dimensionless
        ...
        const double d_dt_chaste_interface_var_Ito__xtos = (-var_chaste_interface__Ito__xtos + var_Ito__xtos_inf) / var_Ito__txs; // 1 / millisecond
        const double var_Ito__xtof_inf = var_Ito__xtos_inf; // dimensionless
        const double d_dt_chaste_interface_var_Ito__xtof = (-var_chaste_interface__Ito__xtof + var_Ito__xtof_inf) / var_Ito__txf; // 1 / millisecond
        const double var_Ito__ytos_inf = 1.0 / (1.0 + exp(var_Ito__rt2)); // dimensionless
        const double d_dt_chaste_interface_var_Ito__ytos = (-var_chaste_interface__Ito__ytos + var_Ito__ytos_inf) / var_Ito__tys; // 1 / millisecond
        const double var_Ito__ytof_inf = var_Ito__ytos_inf; // dimensionless
        const double d_dt_chaste_interface_var_Ito__ytof = (-var_chaste_interface__Ito__ytof + var_Ito__ytof_inf) / var_Ito__tyf; // 1 / millisecond
        const double var_cell__wca = 8.0; // mV_per_uM
        const double var_INaCa__xiNaCa = var_INaCa__jNaCa * var_cell__wca; // nA_per_nF
        const double var_reversal_potentials__ena = 1.0 * log(var_Environment__Na_o / var_chaste_interface__Na__Na_i) / var_Environment__FonRT; // mV
        const double var_INa__xina = pow(var_chaste_interface__INa__xm, 3) * (-var_reversal_potentials__ena + var_chaste_interface__cell__V) * var_INa__gna * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
        const double d_dt_chaste_interface_var_Na__Na_i = (-var_INa__xina - 3.0 * var_INaK__xiNaK - 3.0 * var_INaCa__xiNaCa) / (1000.0 * var_cell__wca); // mM / millisecond
        ...
        else
        {
            ...
            const double var_IKs__xiks = (-var_reversal_potentials__eks + var_chaste_interface__cell__V) * mParameters[1] * var_IKs__gks * var_IKs__gksx * var_chaste_interface__IKs__xs1 * var_chaste_interface__IKs__xs2; // nA_per_nF
            const double var_cell__Itotal = -var_ICaL__xica - var_IK1__xik1 - var_IKr__xikr - var_IKs__xiks - var_INa__xina - var_INaCa__xiNaCa - var_INaK__xiNaK - var_Ito__xito - var_cell__i_Stim; // nA_per_nF
            d_dt_chaste_interface_var_cell__V = var_cell__Itotal; // millivolt / millisecond
        }
...
void OdeSystemInformation<Cellmahajan_2008FromCellML>::Initialise(void)
{
    ...
    // rY[21]:
    this->mVariableNames.push_back("ar_Ca__Ca_dyad");
    this->mVariableUnits.push_back("uM");
    this->mInitialConditions.push_back(1.716573130685);
    
    // rY[22]:
    this->mVariableNames.push_back("ar_Ca__Ca_submem");
    this->mVariableUnits.push_back("uM");
    ...
    // rY[24]:
    this->mVariableNames.push_back("ar_Ca__tropi");
    this->mVariableUnits.push_back("uM");
    this->mInitialConditions.push_back(22.171689894953);
    
    // rY[25]:
    this->mVariableNames.push_back("ar_Ca__trops");
    this->mVariableUnits.push_back("uM");
