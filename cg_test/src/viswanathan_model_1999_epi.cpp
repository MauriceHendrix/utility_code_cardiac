...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellviswanathan_model_1999_epiFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr = 0.43033148291193518 * sqrt(var_ionic_concentrations__Ko) * var_rapid_delayed_rectifier_potassium_current__g_Kr_max; // milliS_per_microF
        ...
        const double var_time_independent_potassium_current__g_K1 = 0.43033148291193518 * sqrt(var_ionic_concentrations__Ko) * var_time_independent_potassium_current__g_K1_max; // milliS_per_cm2
