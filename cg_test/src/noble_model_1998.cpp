...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellnoble_model_1998FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_persistent_sodium_current__i_p_Na = (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * 1.0 * var_persistent_sodium_current__g_pna / (1.0 + exp((-52.0 - var_chaste_interface__membrane__V) / 8.0)); // nanoA
    ...
    void Cellnoble_model_1998FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_Ca_channel_f2ds_gate__f2ds_orig_deriv = (-var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds - var_chaste_interface__intracellular_calcium_concentration__Ca_ds / (var_L_type_Ca_channel__Km_f2ds + var_chaste_interface__intracellular_calcium_concentration__Ca_ds) + 1.0) * var_L_type_Ca_channel__R_decay; // 1 / second
        ...
        const double var_L_type_Ca_channel_f2_gate__f2_orig_deriv = -(var_chaste_interface__intracellular_calcium_concentration__Ca_i / (var_L_type_Ca_channel__Km_f2 + var_chaste_interface__intracellular_calcium_concentration__Ca_i) + var_chaste_interface__L_type_Ca_channel_f2_gate__f2) * 1.0 + 1.0; // 1 / second
        ...
        const double var_L_type_Ca_channel_d_gate__d_orig_deriv = ((-var_chaste_interface__L_type_Ca_channel_d_gate__d + 1.0) * var_L_type_Ca_channel_d_gate__alpha_d - var_L_type_Ca_channel_d_gate__beta_d * var_chaste_interface__L_type_Ca_channel_d_gate__d) * var_L_type_Ca_channel_d_gate__speed_d; // 1 / second
        ...
        const double var_L_type_Ca_channel_f_gate__beta_f = 12.0 / (1.0 + exp(-(34.0 + var_chaste_interface__membrane__V) * 1.0 / 4.0)); // per_second
        const double var_L_type_Ca_channel_f_gate__f_orig_deriv = ((-var_chaste_interface__L_type_Ca_channel_f_gate__f + 1.0) * var_L_type_Ca_channel_f_gate__alpha_f - var_L_type_Ca_channel_f_gate__beta_f * var_chaste_interface__L_type_Ca_channel_f_gate__f) * var_L_type_Ca_channel_f_gate__speed_f; // 1 / second
        ...
        const double var_calcium_release__ProdFrac_orig_deriv = var_chaste_interface__calcium_release__ActFrac * var_calcium_release__InactRate * var_calcium_release__SpeedRel - 1.0 * var_chaste_interface__calcium_release__ProdFrac * var_calcium_release__SpeedRel; // 1 / second
        ...
        const double var_intracellular_calcium_concentration__Ca_ds_orig_deriv = -var_chaste_interface__intracellular_calcium_concentration__Ca_ds * var_intracellular_calcium_concentration__Kdecay - 1.0 * var_L_type_Ca_channel__i_Ca_L_Ca_ds / (1.0 * 2.0 * var_intracellular_calcium_concentration__V_ds_ratio * var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / second
        ...
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr1 = 0.0021; // microS
        const double var_rapid_delayed_rectifier_potassium_current__g_Kr2 = 0.0013; // microS
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__alpha_xr1 = 50.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 5.0) / 9.0)); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__beta_xr1 = 0.05 * exp((-var_chaste_interface__membrane__V + 20.0) / 15.0); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr1_gate__xr1_orig_deriv = (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1 + 1.0) * var_rapid_delayed_rectifier_potassium_current_xr1_gate__alpha_xr1 - var_rapid_delayed_rectifier_potassium_current_xr1_gate__beta_xr1 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1; // 1 / second
        ...
        const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__alpha_xr2 = 50.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 5.0) / 9.0)); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__beta_xr2 = 0.4 * exp(-pow(((30.0 + var_chaste_interface__membrane__V) / 30.0), 3.0)); // per_second
        const double var_rapid_delayed_rectifier_potassium_current_xr2_gate__xr2_orig_deriv = (-var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2 + 1.0) * var_rapid_delayed_rectifier_potassium_current_xr2_gate__alpha_xr2 - var_rapid_delayed_rectifier_potassium_current_xr2_gate__beta_xr2 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2; // 1 / second
        ...
        const double var_slow_delayed_rectifier_potassium_current__g_Ks = 0.0026; // microS
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__alpha_xs = 14.0 / (1.0 + exp((-var_chaste_interface__membrane__V + 40.0) / 9.0)); // per_second
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__beta_xs = 1.0 * exp(-var_chaste_interface__membrane__V / 45.0); // per_second
        const double var_slow_delayed_rectifier_potassium_current__i_Ks = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2.0) * (-var_reversal_potentials__E_Ks + var_chaste_interface__membrane__V) * var_slow_delayed_rectifier_potassium_current__g_Ks; // nanoA
        const double var_slow_delayed_rectifier_potassium_current_xs_gate__xs_orig_deriv = (-var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs + 1.0) * var_slow_delayed_rectifier_potassium_current_xs_gate__alpha_xs - var_slow_delayed_rectifier_potassium_current_xs_gate__beta_xs * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs; // 1 / second
