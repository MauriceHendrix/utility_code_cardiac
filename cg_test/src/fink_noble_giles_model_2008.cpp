...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellfink_noble_giles_model_2008FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__cell__stim_amplitude = -12.0 * HeartConfig::Instance()->GetCapacitance(); // uA_per_uF
    ...
    double Cellfink_noble_giles_model_2008FromCellML::GetIntracellularCalciumConcentration()
    {
    ...
    double Cellfink_noble_giles_model_2008FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_chaste_interface__i_ionic = (1000.0*var_cell__i_tot/var_cell__Cm) * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    void Cellfink_noble_giles_model_2008FromCellML::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_cell__i_Stim = 0.001 * GetIntracellularAreaStimulus(var_chaste_interface__Environment__time) * var_cell__Cm/ HeartConfig::Instance()->GetCapacitance(); // nanoA_per_nanoF
        ...
        const double var_iNa_h_gate__h_inf = 0.01 * var_INa__perc_reduced_inact_for_IpNa + 1.0 * pow((1.0 + 15212.593285654404 * exp(0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * var_INa__shift_INa_inact)), (-2.0)) * (1.0 - 0.01 * var_INa__perc_reduced_inact_for_IpNa); // dimensionless
        ...
        const double var_iNa_j_gate__j_inf = 0.01 * var_INa__perc_reduced_inact_for_IpNa + 1.0 * pow((1.0 + 15212.593285654404 * exp(0.13458950201884254 * var_chaste_interface__cell__V - 0.13458950201884254 * var_INa__shift_INa_inact)), (-2.0)) * (1.0 - 0.01 * var_INa__perc_reduced_inact_for_IpNa); // dimensionless
        ...
        const double d_dt_chaste_interface__Na__Na_i = -(3.0 * var_INaCa__i_NaCa + 3.0 * var_INaK__i_NaK + var_INa__i_Na + var_INab__i_b_Na) * var_Na__conc_clamp * var_cell__Cm / (var_Environment__F * var_cell__Vol_c); // millimolar / millisecond
        const double d_dt_chaste_interface__K__K_i = -(-2.0 * var_INaK__i_NaK + var_IK1__i_K1 + var_IKr__i_Kr + var_IKs__i_Ks + var_IpK__i_p_K + var_Ito__i_to + var_cell__i_Stim) * var_Na__conc_clamp * var_cell__Cm / (var_Environment__F * var_cell__Vol_c); // millimolar / millisecond
        ...
        rDY[2] = d_dt_chaste_interface__iKr_Markov__Cr1;
        rDY[3] = d_dt_chaste_interface__iKr_Markov__Cr2;
        rDY[4] = d_dt_chaste_interface__iKr_Markov__Cr3;
        rDY[5] = d_dt_chaste_interface__iKr_Markov__Or4;
        rDY[6] = d_dt_chaste_interface__iKr_Markov__Ir5;
        rDY[7] = d_dt_chaste_interface__iKr_Markov_Sotalol_block__BCr1;
        rDY[8] = d_dt_chaste_interface__iKr_Markov_Sotalol_block__BCr2;
        rDY[9] = d_dt_chaste_interface__iKr_Markov_Sotalol_block__BCr3;
        rDY[10] = d_dt_chaste_interface__iKr_Markov_Sotalol_block__BOr4;
        rDY[11] = d_dt_chaste_interface__iKr_Markov_Sotalol_block__BIr5;
        rDY[12] = d_dt_chaste_interface__iKs_Xs_gate__Xs;
        rDY[13] = d_dt_chaste_interface__ito_s_gate__s;
        rDY[14] = d_dt_chaste_interface__ito_r_gate__r;
        rDY[15] = d_dt_chaste_interface__iNa_m_gate__m;
        rDY[16] = d_dt_chaste_interface__iNa_h_gate__h;
        rDY[17] = d_dt_chaste_interface__iNa_j_gate__j;
        rDY[18] = d_dt_chaste_interface__iCaL_d_gate__d;
        rDY[19] = d_dt_chaste_interface__iCaL_f_gate__f;
        rDY[20] = d_dt_chaste_interface__iCaL_f2_gate__f2;
        rDY[21] = d_dt_chaste_interface__iCaL_fCass_gate__fCass;
