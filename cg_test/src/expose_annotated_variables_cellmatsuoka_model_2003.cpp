...
//! on 2019-12-17 09:45:28
//! 
//! <autogenerated>

#include "expose_annotated_variables_cellmatsuoka_model_2003.hpp"
#include <cmath>
#include <cassert>
#include <memory>
...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> cellmatsuoka_model_2003FromCellML::UseCellMLDefaultStimulus()
    {
        ...
        const double var_chaste_interface__membrane__stim_amplitude = var_-4000.0 / var_membrane__Cm * HeartConfig::Instance()->GetCapacitance(); // uA_per_cm2
    ...
    void cellmatsuoka_model_2003FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_RyR_channel__Diadid_Factor = var_-150.0; // per_picoA_millisecond
