...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x138 = var_x110 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2;
        const double var_x139 = var_x101 * var_x28;
        const double var_x140 = var_x110 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1;
        ...
        const double var_x347 = var_x339 * var_x344;
        ...
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x258 * var_x263 / pow(var_x259, 2) + 0.036429872495446262 * var_x260 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1.0 / var_x259) / (pow(var_x261, 2) * pow((0.60655737704918034 + var_x262), 2));
        IJth(rJacobian, 8, 0) = (0.001 / var_x265 - 0.001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x266) ? (6.0763888888888884 / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0.0001785714285714286 * var_x264 * var_x267 / pow(var_x265, 2);
        ...
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x206) ? (135.0 * var_x205) : (0.0)) - 0.001 * ((var_x206) ? (3560.0 * var_x207 + 310000000.0 * var_x208) : (7692.3076923076933 / var_x210));
        IJth(rJacobian, 23, 3) = -var_x126 * var_x340;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x127 * var_x128);
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x206) ? (121.2 * var_x223) : (300.0 * var_x227)) - 0.001 * ((var_x206) ? (var_x218 * var_x219) : (0.0));
        ...
        IJth(rJacobian, 24, 10) = var_x138 * var_x347;
