...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellviswanathan_model_1999_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x98 = -2.3575679435995052e-7 * var_x12 * var_x13 * var_x97 / pow(var_x14, 2);
        ...
        const double var_x108 = var_x107 * var_x74;
        const double var_x109 = var_x108 * var_x77;
        const double var_x110 = var_x108 * var_x79;
        ...
        const double var_x122 = var_x121 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2);
        const double var_x123 = var_x120 * var_x92;
        const double var_x124 = var_x62 * var_chaste_interface__membrane__V;
        const double var_x125 = var_x124 * var_x74;
        const double var_x126 = var_x106 * var_x61;
        const double var_x127 = var_x126 * var_x74;
        const double var_x128 = log(1.8 * var_x12);
        const double var_x129 = -13.356169352749133 * var_x128 + var_chaste_interface__membrane__V;
        const double var_x130 = var_x129 * var_chaste_interface__T_type_Ca_channel_b_gate__b * var_chaste_interface__T_type_Ca_channel_g_gate__g;
        const double var_x131 = var_x17 * var_x95;
        const double var_x132 = var_x16 * var_x96;
        ...
        const double var_x134 = 3.3880737654706117 * var_x133;
        ...
        const double var_x141 = 2.0416447122894152e-12 * var_x139 - 0.010800000000000001 * var_x140;
        ...
        const double var_x150 = 0.050000000000000003 * var_x104;
        const double var_x151 = 0.003016 + var_x11 + var_x150 + var_x71 + var_x89 - var_x83;
        const double var_x152 = 0.0023800000000000002 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x153 = 1.0 + 0.00011900000000000002 / pow(var_x152, 2) + 3.5000000000000004e-5 * var_x102;
        const double var_x154 = 1 / var_x153;
        const double var_x155 = 1 / M_PI;
        const double var_x156 = var_x154 * var_x155;
        const double var_x157 = 9.0316078310111333e-5 * var_x156;
        const double var_x158 = 0.00092000000000000003 + var_chaste_interface__calcium_dynamics__Cai;
        const double var_x159 = 1 / var_x158;
        const double var_x160 = 0.40588235294117642 * var_x159;
        const double var_x161 = 1.0 - var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x162 = 0.00062 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x163 = 1 / var_x162;
        const double var_x164 = -0.00018000000000000001 + var_chaste_interface__calcium_dynamics__Cainfluxtrack;
        const double var_x165 = 60000.0 * var_x163 * var_x164;
        const double var_x166 = var_x161 * var_x165;
        const double var_x167 = var_chaste_interface__calcium_dynamics__Cainfluxtrack > 0.00018000000000000001;
        const double var_x168 = var_chaste_interface__calcium_dynamics__OVRLDtrack2 > 0.0;
        const double var_x169 = ((var_x167) ? (var_x166 * var_chaste_interface__calcium_dynamics__APtrack2) : ((var_x168) ? (4000.0 * (1.0 - var_chaste_interface__calcium_dynamics__OVRLDtrack2) * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0.0)));
        const double var_x170 = 0.0070588235294117632 * var_x169;
        const double var_x171 = var_chaste_interface__calcium_dynamics__Cai / pow(var_x158, 2);
        const double var_x172 = 0.090316078310111333 * var_x155;
        const double var_x173 = -var_x172 * (var_x101 + var_x112 + var_x117 - var_x103 - var_x111 + 0.040282206767891383 * var_x12 + 0.6678084676374566 * var_x105);
        const double var_x174 = 0.001 * var_x154;
        const double var_x175 = -var_chaste_interface__calcium_dynamics__Cai + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x176 = var_x124 * var_x69;
        const double var_x177 = 0.00070463905573898956 * var_x156;
        const double var_x178 = var_x126 * var_x69;
        const double var_x179 = var_x129 * var_x40;
        const double var_x180 = ((var_x167) ? (var_x166 - var_x165 * var_chaste_interface__calcium_dynamics__APtrack2) : (0));
        const double var_x181 = var_x174 * (0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__calcium_dynamics__Cai);
        const double var_x182 = 60000.0 * var_x161 * var_chaste_interface__calcium_dynamics__APtrack2;
        const double var_x183 = ((var_x167) ? (var_x163 * var_x182 - var_x164 * var_x182 / pow(var_x162, 2)) : (0));
        const double var_x184 = ((var_x167) ? (0) : ((var_x168) ? (4000.0 - 8000.0 * var_chaste_interface__calcium_dynamics__OVRLDtrack2) : (0)));
        ...
        const double var_x188 = 320.0 / var_x187;
        const double var_x189 = 47.130000000000003 + var_chaste_interface__membrane__V;
        const double var_x190 = fabs(var_x189) >= 1.0000000000000001e-5;
        const double var_x191 = exp(-0.090909090909090912 * var_chaste_interface__membrane__V);
        const double var_x192 = 0.001 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x193 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x194 = var_chaste_interface__membrane__V < -40.0;
        const double var_x195 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x196 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        const double var_x197 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 0.001 * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x200 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x201 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x202 = -127140.0 * var_x200 - 3.4740000000000003e-5 * var_x201;
        const double var_x203 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V);
        const double var_x204 = 1.0 + var_x203;
        const double var_x205 = 1000.0 / var_x204;
        const double var_x206 = var_x202 * var_x205;
        const double var_x207 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x208 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x211 = var_x210 / var_x209;
        const double var_x212 = exp(-3.2000000000000002 + var_x185);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        const double var_x215 = var_x214 / var_x213;
        const double var_x216 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
        const double var_x217 = 1.0 + var_x216;
        const double var_x218 = 0.001 / var_x217;
        const double var_x219 = -0.001 + var_x218;
        const double var_x220 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x221 = fabs(var_x220) < 1.0000000000000001e-5;
        const double var_x222 = 1.0 - var_x216;
        const double var_x223 = 1 / var_x222;
        const double var_x224 = 35.0 * var_x217 * var_x223;
        const double var_x225 = 5.6089743589743595 * var_x216 * var_x220;
        const double var_x226 = ((var_x221) ? (0) : (var_x224 - var_x223 * var_x225 - var_x217 * var_x225 / pow(var_x222, 2)));
        const double var_x227 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x228 = ((var_x221) ? (218.40000000000003) : (var_x220 * var_x224));
        const double var_x229 = 0.00016025641025641026 * var_x216 * var_x228 / pow(var_x217, 2);
        const double var_x230 = exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x231 = 19.699999999999999 * var_x230;
        const double var_x232 = 0.001 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x233 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x234 = 1.0 + var_x233;
        const double var_x235 = 0.029999999999999999 * var_x233 / pow(var_x234, 2);
        const double var_x236 = exp(4.0 + 0.125 * var_chaste_interface__membrane__V);
        const double var_x237 = 1.0 + var_x236;
        const double var_x238 = 0.125 * var_x236 / pow(var_x237, 2);
        const double var_x239 = 0.019699999999999999 * var_x230;
        const double var_x240 = -0.02 - var_x239;
        const double var_x241 = 1.0 / var_x237;
        const double var_x242 = 0.59999999999999998 / var_x234;
        const double var_x243 = var_x241 + var_x242;
        const double var_x244 = -0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V;
        const double var_x245 = 1.0 - var_x241 - var_x242;
        const double var_x246 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__membrane__V);
        const double var_x247 = 1.0 + var_x246;
        const double var_x248 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__membrane__V);
        const double var_x249 = 1.0 + var_x248;
        const double var_x250 = 1 / var_x249;
        const double var_x251 = 1 / (0.0037000000000000002 + 0.0061000000000000004 * var_x250);
        const double var_x252 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        const double var_x253 = 1.0 + var_x252;
        const double var_x254 = var_chaste_interface__membrane__V <= 0.0;
        const double var_x255 = ((var_x254) ? (1 / (0.012 - 0.00087500000000000002 * var_chaste_interface__membrane__V)) : (83.333333333333329));
        const double var_x256 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x257 = 1.0 + var_x256;
        const double var_x258 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__membrane__V);
        const double var_x259 = -1.0 + var_x258;
        const double var_x260 = 1 / var_x259;
        const double var_x261 = 0.60999999999999999 * var_x260;
        const double var_x262 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__membrane__V);
        const double var_x263 = 1.0 - var_x262;
        const double var_x264 = 1 / var_x263;
        const double var_x265 = 1.3799999999999999 * var_x264;
        const double var_x266 = 14.199999999999999 + var_chaste_interface__membrane__V;
        const double var_x267 = 38.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x268 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        const double var_x269 = 1.0 + var_x268;
        const double var_x270 = 0.001 / var_x269;
        const double var_x271 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x272 = -1.0 + var_x271;
        const double var_x273 = 1 / var_x272;
        const double var_x274 = 0.13100000000000001 * var_x273;
        const double var_x275 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        const double var_x276 = 1.0 - var_x275;
        const double var_x277 = 1 / var_x276;
        const double var_x278 = 0.071899999999999992 * var_x277;
        const double var_x279 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x280 = var_x271 * var_x279 / pow(var_x272, 2);
        const double var_x281 = var_x275 * var_x279 / pow(var_x276, 2);
        const double var_x282 = 5.988023952095809e-5 * var_x268 / pow(var_x269, 2);
        const double var_x283 = var_x277 * var_x279;
        const double var_x284 = var_x273 * var_x279;
        const double var_x285 = 0.032750000000000001 * var_x273;
        const double var_x286 = 0.017974999999999998 * var_x277;
        const double var_x287 = 0.040000000000000001 * var_chaste_interface__membrane__V;
        const double var_x288 = exp(-1.6000000000000001 + var_x287);
        const double var_x289 = 1.0 + var_x288;
        const double var_x290 = var_x288 / var_x289;
        const double var_x291 = exp(-3.6000000000000001 - var_x287);
        const double var_x292 = 1.0 + var_x291;
        const double var_x293 = var_x291 / var_x292;
        const double var_x294 = 10000.0 * var_x290 + 10000.0 * var_x293;
        const double var_x295 = 1 / var_x294;
        const double var_x296 = 10.0 * var_x290;
        const double var_x297 = 400.0 * var_x290;
        const double var_x298 = 400.0 * pow(var_x291, 2) / pow(var_x292, 2);
        const double var_x299 = pow(var_x288, 2) / pow(var_x289, 2);
        const double var_x300 = 400.0 * var_x299;
        const double var_x301 = 400.0 * var_x293;
        const double var_x302 = 0.40000000000000002 * var_x295;
        const double var_x303 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x304 = exp(12.0 + var_x303);
        const double var_x305 = 1.0 + var_x304;
        const double var_x306 = 1 / var_x305;
        const double var_x307 = exp(5.0 + var_x303);
        const double var_x308 = 1.0 + var_x307;
        const double var_x309 = var_x307 / var_x308;
        const double var_x310 = 15.0 * var_x306 + 100.0 * var_x309;
        const double var_x311 = var_x304 / pow(var_x305, 2);
        const double var_x312 = 3.0 * var_x311;
        const double var_x313 = 20.0 * pow(var_x307, 2) / pow(var_x308, 2);
        const double var_x314 = 20.0 * var_x309;
        const double var_x315 = 1 / var_x310;
        const double var_x316 = 0.014999999999999999 * var_x306;
        const double var_x317 = 0.80000000000000004 + var_chaste_interface__calcium_dynamics__Ca_JSR;
        const double var_x318 = pow(var_x317, (-2));
        const double var_x319 = 1 / (1.0 + 8.0 * var_x318);
        const double var_x320 = 0.001 * var_x319;
        const double var_x321 = var_x320 * (-var_chaste_interface__calcium_dynamics__Ca_JSR + var_chaste_interface__calcium_dynamics__Cai);
        const double var_x322 = var_x75 * var_x77;
        const double var_x323 = var_x75 * var_x79;
        const double var_x324 = (var_chaste_interface__calcium_dynamics__APtrack > 0.17999999999999999) && (var_chaste_interface__calcium_dynamics__APtrack < 0.20000000000000001);
        const double var_x325 = var_chaste_interface__calcium_dynamics__APtrack > 0.20000000000000001;
        const double var_x326 = 0.70463905573898955 * var_x155;
        const double var_x327 = var_chaste_interface__calcium_dynamics__OVRLDtrack > 0.97999999999999998;
        const double var_x328 = 0.00018063215662022267 * var_x155;
        const double var_x329 = 0.0028901145059235626 * var_x120 * var_x155 * var_x91;
        const double var_x330 = var_x125 * var_x155;
        const double var_x331 = 4.4039940983686847e-7 * var_x77;
        const double var_x332 = var_x127 * var_x155;
        const double var_x333 = 0.00067122862439358594 * var_x59;
        const double var_x334 = 1.2592160903483795e-7 * var_x79;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070160275741043606 + var_x11 + var_x18 + var_x83 + var_x93 - var_x71 - var_x89 + 0.0010652877718143633 * var_x52 + 166.55558320535218 * var_x55 + 9.1272458415149417e-5 * var_x85 + 2.6097162183887167e-5 * var_x86 - 1.9572871637915374e-5 * var_x88 - 698.34626081908675 * var_x35 - 0.00092307692307692295 * var_x43 - 0.0055199999999999997 * var_x21 - 1.5 * var_x51 - var_x39 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x41 * var_chaste_interface__T_type_Ca_channel_g_gate__g - var_x58 * var_x60 - var_x75 * var_x78 - var_x75 * var_x80);
        IJth(rJacobian, 1, 0) = -var_x151 * var_x157;
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x190) ? (var_x188 - 32.0 * var_x186 * var_x189 / pow(var_x187, 2)) : (0)) + 0.0072727272727272727 * var_x191 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 3, 0) = (0.001 - var_x192) * ((var_x194) ? (-19.852941176470587 * var_x193) : (0)) - var_x192 * ((var_x194) ? (281.24000000000001 * var_x195 + 108500000.0 * var_x196) : (693.0006930006931 * var_x197 / pow(var_x198, 2)));
        IJth(rJacobian, 4, 0) = (0.001 - var_x199) * ((var_x194) ? (var_x206 + var_x205 * var_x207 * (1.5254334000000001e-6 * var_x201 - 31073.016 * var_x200) - 311.0 * var_x202 * var_x203 * var_x207 / pow(var_x204, 2)) : (0)) - var_x199 * ((var_x194) ? (-1.2750239999999999 * var_x211 + 16.701360000000001 * var_x208 * var_x210 / pow(var_x209, 2)) : (-7.6049999999999992e-5 * var_x215 + 30.0 * var_x212 * var_x214 / pow(var_x213, 2)));
        IJth(rJacobian, 5, 0) = var_x227 * var_x229 + var_x229 * var_chaste_interface__L_type_Ca_channel_d_gate__d + var_x218 * var_x226 * var_x227 + var_x219 * var_x226 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        IJth(rJacobian, 6, 0) = var_x232 * (20.0 + var_x231) * (var_x235 - var_x238) + var_x240 * (var_x238 - var_x235) * var_chaste_interface__L_type_Ca_channel_f_gate__f + var_x231 * var_x232 * var_x243 * var_x244 - var_x239 * var_x244 * var_x245 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = 9.2592592592592588e-5 * var_x246 * var_x251 / pow(var_x247, 2) + 0.036429872495446262 * var_x248 * (-var_chaste_interface__T_type_Ca_channel_b_gate__b + 1.0 / var_x247) / (pow(var_x249, 2) * pow((0.60655737704918034 + var_x250), 2));
        IJth(rJacobian, 8, 0) = (0.001 / var_x253 - 0.001 * var_chaste_interface__T_type_Ca_channel_g_gate__g) * ((var_x254) ? (6.0763888888888884 / pow((1 - 0.072916666666666671 * var_chaste_interface__membrane__V), 2)) : (0)) - 0.0001785714285714286 * var_x252 * var_x255 / pow(var_x253, 2);
        IJth(rJacobian, 9, 0) = (0.001 / var_x257 - 0.001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * (var_x261 + var_x265 - 0.16973999999999997 * var_x262 * var_x266 / pow(var_x263, 2) - 0.088449999999999987 * var_x258 * var_x267 / pow(var_x259, 2)) + 0.00013333333333333334 * var_x256 * (var_x261 * var_x267 + var_x265 * var_x266) / pow(var_x257, 2);
        IJth(rJacobian, 10, 0) = var_x282 * (var_x274 * var_x279 + var_x278 * var_x279) + (var_x270 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs1_gate__xs1) * (var_x274 + var_x278 - 0.0089997000000000011 * var_x280 - 0.0106412 * var_x281);
        IJth(rJacobian, 11, 0) = var_x282 * (var_x279 * var_x285 + var_x279 * var_x286) + (var_x270 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs2_gate__xs2) * (var_x285 + var_x286 - 0.0022499250000000003 * var_x280 - 0.0026603 * var_x281);
        IJth(rJacobian, 12, 0) = var_x294 * (var_x290 * var_x302 - var_x299 * var_x302 + 9.9999999999999995e-8 * var_x290 * (var_x300 + var_x301 - var_x297 - var_x298) / pow((var_x290 + var_x293), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_zdv_gate__zdv + var_x295 * var_x296) * (var_x297 + var_x298 - var_x300 - var_x301);
        IJth(rJacobian, 13, 0) = var_x310 * (-0.0030000000000000001 * var_x311 * var_x315 + 1.5e-6 * var_x306 * (var_x312 + var_x313 - var_x314) / pow((var_x309 + 0.14999999999999999 * var_x306), 2)) + (-0.001 * var_chaste_interface__transient_outward_current_ydv_gate__ydv + var_x315 * var_x316) * (var_x314 - var_x312 - var_x313);
        IJth(rJacobian, 19, 0) = 0.001 * ((var_x325) ? (-var_x151 * var_x172) : (0));
        IJth(rJacobian, 23, 0) = var_x328 * (-0.0040000000000000001 + var_x93 + 9.1272458415149417e-5 * var_x85 - 4.5 * var_x51 - 0.0024381008236689767 * var_x322 - 0.0060000000000000001 * var_x6 * var_x9);
        IJth(rJacobian, 24, 0) = var_x328 * (-2.7574104360798206e-8 + var_x18 + 3.0 * var_x51 + 2.6097162183887167e-5 * var_x86 + 0.0010652877718143633 * var_x52 + 166.55558320535218 * var_x55 - 0.0055199999999999997 * var_x21 - 0.00069711623550831479 * var_x323 - 1.9572871637915374e-5 * var_x88 - 698.34626081908675 * var_x35 - 0.023862446088641735 * var_x144 - 0.00092307692307692295 * var_x43 - var_x333 * var_x58);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x103 + var_x111 + var_x117 + var_x98 - var_x101 - var_x112 + 1.4628604942013857e-6 * var_x109 + 4.1826974130498884e-7 * var_x110 - 0.6678084676374566 * var_x105 - 0.040282206767891383 * var_x12);
        IJth(rJacobian, 1, 1) = var_x174 * (var_x173 - var_x160 - var_x170 + 0.40588235294117642 * var_x171) + 0.001 * (0.00023800000000000004 / pow(var_x152, 3) + 7.0000000000000007e-5 / pow(var_x99, 3)) * (0.027058823529411764 * var_chaste_interface__calcium_dynamics__Ca_NSR + var_x170 * var_x175 - var_x160 * var_chaste_interface__calcium_dynamics__Cai - var_x172 * (0.003016 * var_chaste_interface__membrane__V - 0.040282206767891383 * var_x128 + var_x101 * var_chaste_interface__calcium_dynamics__Cai + var_x129 * var_x150 + var_x71 * var_chaste_interface__membrane__V - var_x10 * var_x114)) / pow(var_x153, 2);
        IJth(rJacobian, 14, 1) = var_x169 * var_x320;
        IJth(rJacobian, 15, 1) = 0.0050000000000000001 * var_x159 - 0.0050000000000000001 * var_x171;
        IJth(rJacobian, 19, 1) = 0.001 * ((var_x325) ? (var_x173) : (0));
        IJth(rJacobian, 23, 1) = var_x328 * (1.4628604942013857e-6 * var_x109 + 2.6087319475749228e-6 * var_x116 + 4.1400000000000003e-5 * var_x115 + 13799.808000000001 * var_x113);
        IJth(rJacobian, 24, 1) = var_x328 * (var_x98 + 4.1826974130498884e-7 * var_x110);
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x122);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x190) ? (var_x188 * var_x189) : (3200.0)) - 0.080000000000000002 * var_x191;
        IJth(rJacobian, 23, 2) = -0.0086703435177706879 * var_x122 * var_x155;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_chaste_interface__fast_sodium_current_j_gate__j);
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x194) ? (135.0 * var_x193) : (0.0)) - 0.001 * ((var_x194) ? (3560.0 * var_x195 + 310000000.0 * var_x196) : (7692.3076923076933 / var_x198));
        IJth(rJacobian, 23, 3) = -var_x329 * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_chaste_interface__fast_sodium_current_h_gate__h);
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x194) ? (121.2 * var_x211) : (300.0 * var_x215)) - 0.001 * ((var_x194) ? (var_x206 * var_x207) : (0.0));
        IJth(rJacobian, 23, 4) = -var_x329 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x124 * var_x70 - var_x125 * var_x78 - var_x125 * var_x80);
        IJth(rJacobian, 1, 5) = -var_x176 * var_x177;
        IJth(rJacobian, 5, 5) = var_x219 * var_x228 - var_x218 * var_x228;
        IJth(rJacobian, 19, 5) = 0.001 * ((var_x325) ? (-var_x176 * var_x326) : (0));
        IJth(rJacobian, 23, 5) = -var_x330 * var_x331;
        IJth(rJacobian, 24, 5) = -var_x330 * var_x334;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x70 - var_x127 * var_x78 - var_x127 * var_x80);
        IJth(rJacobian, 1, 6) = -var_x177 * var_x178;
        IJth(rJacobian, 6, 6) = var_x240 * var_x243 + var_x240 * var_x245;
        IJth(rJacobian, 19, 6) = 0.001 * ((var_x325) ? (-var_x178 * var_x326) : (0));
        IJth(rJacobian, 23, 6) = -var_x331 * var_x332;
        IJth(rJacobian, 24, 6) = -var_x332 * var_x334;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10000000000000001 * var_x130);
        IJth(rJacobian, 1, 7) = -9.0316078310111336e-6 * var_x130 * var_x156;
        IJth(rJacobian, 7, 7) = -0.001 * var_x251;
        IJth(rJacobian, 19, 7) = 0.001 * ((var_x325) ? (-0.0090316078310111337 * var_x130 * var_x155) : (0));
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x129 * var_x41);
        IJth(rJacobian, 1, 8) = -4.5158039155055668e-6 * var_x156 * var_x179;
        IJth(rJacobian, 8, 8) = -0.001 * var_x255;
        IJth(rJacobian, 19, 8) = 0.001 * ((var_x325) ? (-0.0045158039155055668 * var_x155 * var_x179) : (0));
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x39 * var_x42);
        IJth(rJacobian, 9, 9) = -0.00060999999999999997 * var_x260 * var_x267 - 0.0013799999999999999 * var_x264 * var_x266;
        IJth(rJacobian, 24, 9) = -4.3103250992251538e-6 * var_x155 * var_x38 * var_x42;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x131);
        IJth(rJacobian, 10, 10) = -7.1899999999999999e-5 * var_x283 - 0.00013100000000000001 * var_x284;
        IJth(rJacobian, 24, 10) = var_x131 * var_x328;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x132);
        IJth(rJacobian, 11, 11) = -1.7975e-5 * var_x283 - 3.2750000000000003e-5 * var_x284;
        IJth(rJacobian, 24, 11) = var_x132 * var_x328;
        IJth(rJacobian, 12, 12) = -var_x296 - 10.0 * var_x293;
        IJth(rJacobian, 13, 13) = -var_x316 - 0.10000000000000001 * var_x309;
        IJth(rJacobian, 1, 14) = 7.0588235294117641e-6 * var_x154 * var_x169;
        IJth(rJacobian, 14, 14) = var_x320 * (-5.5555555555555554 - var_x169) + 0.00025000000000000001 * (5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_NSR - 5.5555555555555554 * var_chaste_interface__calcium_dynamics__Ca_JSR - var_x169 * var_x175) / (pow(var_x317, 3) * pow((0.125 + var_x318), 2));
        IJth(rJacobian, 15, 14) = 0.00048309178743961351;
        IJth(rJacobian, 1, 15) = 2.7058823529411762e-5 * var_x154;
        IJth(rJacobian, 14, 15) = 0.0055555555555555558 * var_x319;
        IJth(rJacobian, 15, 15) = -0.00081642512077294684;
        IJth(rJacobian, 16, 16) = 0.001 * ((7.0160275741043607 * var_chaste_interface__membrane__V - 106.84935482199306 * var_x119 - 40.282206767891381 * var_x128 - 0.00073656881518639836 * var_x23 + 2.0 * var_x114 * var_x9 + 50.0 * var_x104 * var_x129 + 698346.2608190868 * var_x35 * var_x42 + 7801.9226357407251 * var_x69 * var_x81 + 2.4381008236689765 * var_x322 * var_chaste_interface__membrane__V + 0.6971162355083147 * var_x323 * var_chaste_interface__membrane__V + 1150.0 * var_x100 * var_chaste_interface__calcium_dynamics__Cai + 5.5199999999999996 * var_x21 * var_x42 + 1500.0 * var_x136 * var_x45 + 23.862446088641736 * var_x144 * var_x42 + 1000.0 * var_x97 * (0.433 + var_x15) + 1000.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time_converted) / HeartConfig::Instance()->GetCapacitance() + 16000.0 * var_x121 * var_x91 < -150000.0) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 1, 17) = var_x180 * var_x181;
        IJth(rJacobian, 14, 17) = var_x180 * var_x321;
        IJth(rJacobian, 17, 17) = 0.001 * ((var_x324) ? (-100500.0) : (-500.0));
        IJth(rJacobian, 18, 18) = 0.001 * ((var_x324) ? (-100500.0) : (-10.0));
        IJth(rJacobian, 1, 19) = var_x181 * var_x183;
        IJth(rJacobian, 14, 19) = var_x183 * var_x321;
        IJth(rJacobian, 19, 19) = 0.001 * (((var_x325) || (var_chaste_interface__calcium_dynamics__APtrack2 > 0.01)) ? (0) : (-500.0));
        IJth(rJacobian, 20, 20) = 0.001 * (((var_chaste_interface__calcium_dynamics__APtrack3 < 0.37) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.37) && (1.0 / (1.0 + 0.80000000000000004 / var_chaste_interface__calcium_dynamics__Ca_JSR) > 0.69999999999999996)) ? (-50000.0) : (-500.0));
        IJth(rJacobian, 1, 21) = var_x181 * var_x184;
        IJth(rJacobian, 14, 21) = var_x184 * var_x321;
        IJth(rJacobian, 21, 21) = 0.001 * (((var_x327) && (var_chaste_interface__calcium_dynamics__OVRLDtrack2 < 0.97999999999999998)) ? (-50000.0) : (-500.0));
        IJth(rJacobian, 22, 22) = 0.001 * (((var_x327) && (var_chaste_interface__calcium_dynamics__OVRLDtrack3 < 0.97999999999999998)) ? (-50000.0) : (-10.0));
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (var_x134 + var_x135 + var_x141 - 0.0018285756177517324 * var_x87 - 0.10684935482199306 * var_x118 - 0.029999999999999999 * var_x137);
        IJth(rJacobian, 1, 23) = -var_x141 * var_x157;
        IJth(rJacobian, 19, 23) = 0.001 * ((var_x325) ? (-var_x141 * var_x172) : (0));
        IJth(rJacobian, 23, 23) = var_x328 * (var_x135 + 6.124934136868245e-12 * var_x139 - 0.032399999999999998 * var_x140 - 0.10684935482199306 * var_x118 - 0.0018285756177517324 * var_x87 - 0.089999999999999997 * var_x137);
        IJth(rJacobian, 24, 23) = var_x328 * (var_x134 + 0.059999999999999998 * var_x137);
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (var_x149 + 4449.089151873166 * var_x148 - 0.14745210965435041 * var_x142 - 7.3656881518639831e-7 * var_x22 - 18654.461852717679 * var_x143 - 0.63742174226149029 * var_x145 - var_x147 * var_x60);
        IJth(rJacobian, 24, 24) = var_x328 * (var_x149 + 4449.089151873166 * var_x148 - 18654.461852717679 * var_x143 - 0.63742174226149029 * var_x145 - 0.14745210965435041 * var_x142 - 7.3656881518639831e-7 * var_x22 - var_x147 * var_x333);
    }
