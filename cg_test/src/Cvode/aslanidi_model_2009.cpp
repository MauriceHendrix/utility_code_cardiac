...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x56 = var_x39 * var_x46 * pow(var_chaste_interface__sodium_current_m_gate__m, 2);
        const double var_x57 = var_x40 * var_chaste_interface__membrane__V;
        const double var_x58 = 4.5599999999999996 - 0.12 * var_chaste_interface__membrane__V;
        const double var_x59 = var_x42 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x60 = var_x15 * var_x59;
        const double var_x61 = 1.77 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1, 2);
        const double var_x62 = 1.23 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2, 2);
        const double var_x63 = var_x16 * var_x59 * pow(var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3, 5);
        const double var_x64 = 1.8577615637339746 * var_x23 - 0.069999999999999993 * var_chaste_interface__membrane__V;
        ...
        const double var_x81 = 1.3269725455242676 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x82 = 1.8577615637339746 * var_x12;
        const double var_x83 = 26.53945091048535 * var_x18;
        ...
        const double var_x89 = 0.60960000000000003 * var_x42;
        ...
        const double var_x95 = 1.0 - var_chaste_interface__sodium_current_m_gate__m;
        ...
        const double var_x99 = exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V);
        const double var_x100 = 1 / (1.0 + 323.30000000000001 * var_x99);
        const double var_x101 = exp(-12.010771992818672 - 0.17953321364452424 * var_chaste_interface__membrane__V);
        const double var_x102 = 44.899999999999999 * var_x101;
        const double var_x103 = 1 / (var_x102 + 1491.0 * var_x100);
        const double var_x104 = 8.0610412926391373 * var_x101;
        const double var_x105 = -var_x103 * var_x104 + 2.019719479407183e-5 * var_x101 * (var_x104 - 0.35750508923240704 * var_x99 / pow((0.0030931023816888337 + var_x99), 2)) / pow((var_x100 + 0.030114017437961098 * var_x101), 2);
        ...
        const double var_x110 = var_x102 * var_x103;
        ...
        const double var_x115 = exp(-1.6590909090909092 - 0.15151515151515152 * var_chaste_interface__membrane__V);
        ...
        const double var_x121 = 4.4800000000000004 * var_x120;
        ...
        const double var_x141 = 8.4900000000000002 * var_x140;
        const double var_x142 = 67.921999999999997 * var_x136 + var_x137 * var_x141;
        ...
        const double var_x146 = var_x137 * var_x140;
        const double var_x147 = 16.980499999999999 * var_x134 / pow(var_x135, 2);
        const double var_x148 = var_x137 * var_x138 / pow(var_x139, 2);
        const double var_x149 = 2.1225000000000001 * var_x148;
        const double var_x150 = exp(-3.7704918032786887 - 0.16393442622950821 * var_chaste_interface__membrane__V);
        ...
        const double var_x157 = 9.6370000000000005 * var_x155 + 9.6370000000000005 * var_x156;
        const double var_x158 = 1 / var_x157;
        const double var_x159 = 0.11569027611044419 * var_x156;
        const double var_x160 = 0.62659297789336799 * var_x155;
        const double var_x161 = 0.0096370000000000015 * var_x156;
        const double var_x162 = exp(-2.6628794603230959 - 0.17752529735487307 * var_chaste_interface__membrane__V);
        ...
        const double var_x172 = exp(4.0070821529745047 + 0.14164305949008499 * var_chaste_interface__membrane__V);
        const double var_x173 = 1.0 + var_x172;
        const double var_x174 = 0.000141643059490085 * var_x172 / pow(var_x173, 2);
        const double var_x175 = 1.0 / var_x173;
        const double var_x176 = var_x168 / pow(var_x169, 2);
        ...
        const double var_x185 = exp(1.8506208911614319 + 0.036523009495982472 * var_chaste_interface__membrane__V);
        const double var_x186 = 1.0 + var_x185;
        const double var_x187 = exp(0.065217391304347824 - 0.072463768115942032 * var_chaste_interface__membrane__V);
        ...
        const double var_x193 = exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V);
        ...
        const double var_x197 = exp(2.539728728905752 + 0.05358970648917756 * var_chaste_interface__membrane__V);
        ...
        const double var_x201 = 0.00031705239460620043 - 6.3410478921240086e-6 * var_chaste_interface__membrane__V;
        const double var_x202 = 0.00020079984991726025 - 5.2842065767700066e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x211 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x212 = -var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel;
        const double var_x213 = 0.35228043845133378 * var_x212;
        const double var_x214 = var_x207 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x215 = var_x208 / pow(var_x206, 3);
        ...
        const double var_x219 = var_x216 * var_x59;
        const double var_x220 = 7.6404797510100245e-5 * var_x23 - 2.8789140275661778e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x224 = 2.5071228445776315e-5 * var_x42;
        ...
        const double var_x229 = var_x226 * var_x59;
        const double var_x230 = 1.4509726698933535e-5 * var_chaste_interface__membrane__V - 0.00038508017945090519 * var_x23;
        ...
        const double var_x236 = 47.109502269264731 * var_x212;
        const double var_x237 = exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x238 = 0.019200000000000002 * var_x237 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        ...
        const double var_x241 = var_x240 / pow(var_x239, 5);
        const double var_x242 = 0.81520000000000004 * var_x241;
        const double var_x243 = pow(var_x239, (-4));
        const double var_x244 = var_x243 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x245 = 0.81520000000000004 * var_x244;
        ...
        const double var_x249 = 1.3584000000000001 * var_x241;
        const double var_x250 = 1.3584000000000001 * var_x244;
        const double var_x251 = 0.33960000000000001 * var_x247;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.028799999999999999 + var_x18 + 0.010665540932053272 * var_x44 - 0.14399999999999999 * var_x3 - 0.14399999999999999 * var_x4 - 0.022901333333333333 * var_x55 - 0.050000000000000003 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 0.00040000000000000002 * var_x11 - 0.069999999999999993 * var_x12 - 0.20320000000000002 * var_x30 - 14.251577445054343 * var_x41 - 0.12 * var_x13 + var_x19 * var_x20 + var_x45 * var_x48 - var_x45 * var_x47);
        IJth(rJacobian, 1, 0) = -var_x95 * var_x97 + 1.4519056261343013 * var_x94 * var_chaste_interface__sodium_current_m_gate__m - 0.036297640653357534 * var_x94 * var_x95 * var_x98 / pow(var_x96, 2);
        IJth(rJacobian, 2, 0) = var_x105 * var_x109 + 0.0055555555555555558 * var_x106 * (var_x110 - var_chaste_interface__sodium_current_h1_gate__h1) / (pow(var_x107, 2) * pow((0.0050000000000000001 + var_x108), 2));
        IJth(rJacobian, 3, 0) = var_x105 * var_x114 + 0.0041666666666666666 * var_x111 * (var_x110 - var_chaste_interface__sodium_current_h2_gate__h2) / (pow(var_x112, 2) * pow((0.0037499999999999999 + var_x113), 2));
        IJth(rJacobian, 4, 0) = (0.001 / var_x116 - 0.001 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L) * (var_x121 - var_x125 - var_x129 - 10.399334442595674 * var_x122 * var_x130 / pow(var_x123, 2) - 6.6879999999999997 * var_x126 * var_x131 / pow(var_x127, 2) - 1.7920000000000003 * var_x118 * var_x132 / pow(var_x119, 2)) + 0.00015151515151515152 * var_x115 * (var_x121 * var_x132 - var_x125 * var_x130 - var_x129 * var_x131) / pow(var_x116, 2);
        IJth(rJacobian, 5, 0) = var_x142 * (var_x145 - 0.0021225000000000003 * var_x143 * var_x148 + 1.8402920895651027e-6 * var_x146 * (var_x149 - var_x141 - var_x147) / pow((var_x136 + 0.1249963193074409 * var_x146), 2)) + (-0.001 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L + var_x137 * var_x145) * (var_x141 + var_x147 - var_x149);
        IJth(rJacobian, 6, 0) = (0.001 / var_x151 - 0.001 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T) * (22.472433333333335 * var_x153 - 22.472433333333335 * var_x154) + 0.0001639344262295082 * var_x150 * (674.173 * var_x153 + 674.173 * var_x154) / pow(var_x151, 2);
        IJth(rJacobian, 7, 0) = var_x157 * (-0.00011569027611044419 * var_x156 * var_x158 + 0.00010376673238559718 * var_x156 * (var_x159 - var_x160) / pow((var_x155 + var_x156), 2)) + (var_x160 - var_x159) * (-0.001 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T + var_x158 * var_x161);
        IJth(rJacobian, 8, 0) = 0.00017752529735487308 * var_x162 * var_x167 / pow(var_x163, 2) - 6.6907730760079843e-9 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x163) * (1.1126388888888887 * var_x164 - 32.216666666666669 * var_x165) / (pow(var_x166, 2) * pow((var_x165 + 0.020721676151060523 * var_x164), 2));
        IJth(rJacobian, 9, 0) = -var_x171 * var_x174 + 0.018294914013904134 * var_x176 * (var_x175 - var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1) / pow((0.037321624588364438 + var_x170), 2);
        IJth(rJacobian, 10, 0) = -var_x174 * var_x180 + 3.0245746691871456e-5 * (var_x175 - var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2) * (57.5 * var_x176 - 0.032211882605583393 * var_x177 / pow(var_x178, 2)) / pow((var_x170 + 0.078260869565217397 * var_x179), 2);
        IJth(rJacobian, 11, 0) = -2.1922574727480476e-5 * var_x184 * var_x185 / pow(var_x186, 2) + 0.00026666666666666668 * var_x181 * (0.39975990396158467 - var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3 + 0.60024009603841544 / var_x186) / (pow(var_x182, 2) * pow((0.066666666666666666 + var_x183), 2));
        IJth(rJacobian, 12, 0) = 7.2463768115942027e-5 * var_x187 * var_x192 / pow(var_x188, 2) - 0.00036289737262302227 * (-var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.0 / var_x188) * (0.013745074681572435 * var_x189 - 0.023901399527731383 * var_x190) / (pow(var_x191, 2) * pow((var_x190 + 0.18072289156626506 * var_x189), 2));
        IJth(rJacobian, 13, 0) = (0.001 / var_x194 - 0.001 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a) * (0.35473572188719404 * var_x195 - 0.099800399201596807 * var_x196) + 0.00013513513513513514 * var_x193 * (9.0 * var_x195 + 1.3 * var_x196) / pow(var_x194, 2);
        IJth(rJacobian, 14, 0) = (0.001 / var_x198 - 0.001 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i) * (6.1795265502981431 * var_x199 - 1.8299935950224173 * var_x200) - 5.3589706489177562e-5 * var_x197 * (100.0 * var_x200 + 656.0 * var_x199) / pow(var_x198, 2);
        IJth(rJacobian, 15, 0) = -1.6450937300378158e-8 - 0.00058612951745018135 * var_x41 - 2.2085216435981733e-5 * var_x74 - 2.8256129907129523e-6 * var_x55 - 4.9352811901134478e-8 * var_x11 + 2.2085216435981733e-5 * var_x36 * var_x48;
        IJth(rJacobian, 16, 0) = -1.7614021922566692e-8 + 3.5228043845133383e-8 * var_x11 - 6.3410478921240086e-6 * var_x3 - 6.3410478921240086e-6 * var_x4 - 5.2842065767700066e-6 * var_x13 + var_x20 * var_x201;
        IJth(rJacobian, 17, 0) = -1.151565611026471e-6 + var_x218 + 1.8837419938086349e-6 * var_x55 + 4.3864536286956306e-7 * var_x44 - 2.0563671625472697e-6 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z - 8.3570761485921043e-6 * var_x30 - 2.8789140275661778e-6 * var_x12;
        IJth(rJacobian, 22, 0) = 5.8038906795734136e-6 + var_x228 + 4.2119663788904208e-5 * var_x30 + 1.0364090499238238e-5 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.4509726698933535e-5 * var_x12 - 9.4940596487955185e-6 * var_x55 - 2.2107726288625975e-6 * var_x44;
        IJth(rJacobian, 26, 0) = -var_x238;
        IJth(rJacobian, 27, 0) = var_x238;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-42.754732335163027 * var_x56);
        IJth(rJacobian, 1, 1) = -18.400000000000002 * var_x94 + var_x97 * var_x98;
        IJth(rJacobian, 15, 1) = -0.0017583885523505443 * var_x56;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-9.0497516776095086 * var_x57);
        IJth(rJacobian, 2, 2) = -var_x109;
        IJth(rJacobian, 15, 2) = -0.0003721922435808652 * var_x57;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-5.2018257674448352 * var_x57);
        IJth(rJacobian, 3, 3) = -var_x114;
        IJth(rJacobian, 15, 3) = -0.0002139372738693162 * var_x57;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x19 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L);
        IJth(rJacobian, 4, 4) = 0.050000000000000003 * var_x124 * var_x130 + 0.016719999999999999 * var_x128 * var_x131 - 0.0044800000000000005 * var_x120 * var_x132;
        IJth(rJacobian, 16, 4) = var_x201 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x19 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L);
        IJth(rJacobian, 5, 5) = -0.067921999999999996 * var_x136 - var_x137 * var_x144;
        IJth(rJacobian, 16, 5) = var_x201 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T);
        IJth(rJacobian, 6, 6) = -0.67417300000000002 * var_x153 - 0.67417300000000002 * var_x154;
        IJth(rJacobian, 16, 6) = var_x202 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T);
        IJth(rJacobian, 7, 7) = -var_x161 - 0.0096370000000000015 * var_x155;
        IJth(rJacobian, 16, 7) = var_x202 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x17 * var_x42);
        IJth(rJacobian, 8, 8) = -0.001 * var_x167;
        IJth(rJacobian, 17, 8) = var_x217 * var_x42;
        IJth(rJacobian, 22, 8) = var_x227 * var_x42;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x60 * var_x61);
        IJth(rJacobian, 9, 9) = -0.001 * var_x171;
        IJth(rJacobian, 17, 9) = var_x219 * var_x61;
        IJth(rJacobian, 22, 9) = var_x229 * var_x61;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x60 * var_x62);
        IJth(rJacobian, 10, 10) = -0.001 * var_x180;
        IJth(rJacobian, 17, 10) = var_x219 * var_x62;
        IJth(rJacobian, 22, 10) = var_x229 * var_x62;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.72002879999999991 * var_x63);
        IJth(rJacobian, 11, 11) = -0.001 * var_x184;
        IJth(rJacobian, 17, 11) = -2.9612871608166312e-5 * var_x63;
        IJth(rJacobian, 22, 11) = 0.00014924887290515819 * var_x63;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (1.3269725455242676 * var_x23 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 12, 12) = -0.001 * var_x192;
        IJth(rJacobian, 17, 12) = 5.4574855364357316e-5 * var_x23 - 2.0563671625472697e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 12) = 1.0364090499238238e-5 * var_chaste_interface__membrane__V - 0.00027505727103636083 * var_x23;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i);
        IJth(rJacobian, 13, 13) = -0.0090000000000000011 * var_x195 - 0.0013000000000000002 * var_x196;
        IJth(rJacobian, 17, 13) = var_x220 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        IJth(rJacobian, 22, 13) = var_x230 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a);
        IJth(rJacobian, 14, 14) = -0.10000000000000001 * var_x200 - 0.65600000000000003 * var_x199;
        IJth(rJacobian, 17, 14) = var_x220 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        IJth(rJacobian, 22, 14) = var_x230 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.0023228249436513899 * var_x71 + 1.3281030862990763e-12 * var_x67 - 3.0916799999999998 * var_x73 - 0.01061578036419414 * var_x37 - 0.0030000000000000001 * var_x68 - 14.251577445054343 * var_x75);
        IJth(rJacobian, 15, 15) = 1.638640545085862e-16 * var_x67 + 2.8659485630822583e-7 * var_x71 - 0.00038145775374624855 * var_x73 - 4.3659884291485854e-7 * var_x37 - 0.00058612951745018135 * var_x75 - 3.701460892585086e-7 * var_x68;
        IJth(rJacobian, 16, 15) = 2.6421032883850034e-7 * var_x68 - 1.1696618438750204e-16 * var_x67;
        IJth(rJacobian, 17, 15) = 0.00025430516916416572 * var_x73 - 1.9106323753881723e-7 * var_x71;
        IJth(rJacobian, 22, 15) = 9.6295871719563877e-7 * var_x71 - 0.0012816980525873951 * var_x73;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.19017999999999999 * var_x79 + 4.8590864917395538e-7 * var_x66 + 1097.6000000000001 * var_x80 - 0.19017999999999999 * var_x77 - 0.0053078901820970701 * var_x78);
        IJth(rJacobian, 15, 16) = 0.13542411585671302 * var_x80 + 5.9952395409541403e-11 * var_x66;
        IJth(rJacobian, 16, 16) = -47.271999999999998 - var_x210 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 8.3745867230843319e-6 * var_x79 + 7.3978892074780085e-7 * var_x205 - 0.096665752311046002 * var_x80 - 2.3373323507508574e-7 * var_x78 - 8.2198768971977891 * var_x204 - 8.3745867230843319e-6 * var_x77 - 4.2794027994574083e-11 * var_x66;
        ...
        IJth(rJacobian, 23, 16) = var_x235;
        IJth(rJacobian, 24, 16) = 121.85879481761599 * var_x204 - 1.0967291533585437e-5 * var_x205;
        IJth(rJacobian, 26, 16) = (var_x242 - var_x245) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 27, 16) = (var_x245 - var_x242) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (var_x249 - var_x250) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 28, 16) = (var_x250 - var_x249) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.28305760000000002 * var_x85 - 5.392816425010623 * var_x84 + var_x22 * var_x83 - var_x22 * var_x81 - var_x22 * var_x82);
        IJth(rJacobian, 17, 17) = 1.1641407074988802e-5 * var_x85 - 0.00022179221220074814 * var_x84 + var_x22 * var_x223 - var_x22 * var_x221 - var_x22 * var_x222;
        IJth(rJacobian, 22, 17) = 0.0011178327494917705 * var_x84 - 5.8672691657943555e-5 * var_x85 + var_x22 * var_x231 + var_x22 * var_x232 + var_x22 * var_x233;
        IJth(rJacobian, 16, 18) = 0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 18, 18) = -0.47600000000000003 + var_x225;
        ...
        IJth(rJacobian, 16, 20) = 0.0010560000000000001 + var_x211;
        IJth(rJacobian, 20, 20) = -0.0066 + var_x225;
        IJth(rJacobian, 21, 20) = -5.0;
        IJth(rJacobian, 16, 21) = var_x211;
        IJth(rJacobian, 20, 21) = var_x225;
        IJth(rJacobian, 21, 21) = -5.6660000000000004;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (2.0611199999999998 * var_x92 + 5.392816425010623 * var_x88 - 2.0611199999999998 * var_x91 - 0.28305760000000002 * var_x93 + var_x81 * var_x86 + var_x82 * var_x86 + var_x89 * var_x90 - var_x83 * var_x86 - var_x88 * var_x89);
        IJth(rJacobian, 15, 22) = 0.00025430516916416572 * var_x92 - 0.00025430516916416572 * var_x91;
        IJth(rJacobian, 17, 22) = 0.00016953677944277714 * var_x91 + 0.00022179221220074814 * var_x88 - 1.1641407074988802e-5 * var_x93 - 0.00016953677944277714 * var_x92 + var_x221 * var_x86 + var_x222 * var_x86 + var_x224 * var_x90 - var_x223 * var_x86 - var_x224 * var_x88;
        IJth(rJacobian, 22, 22) = 5.8672691657943555e-5 * var_x93 + 0.00085446536839159674 * var_x92 - 0.0011178327494917705 * var_x88 - 0.00085446536839159674 * var_x91 + var_x234 * var_x88 - var_x231 * var_x86 - var_x232 * var_x86 - var_x233 * var_x86 - var_x234 * var_x90;
        IJth(rJacobian, 16, 23) = var_x210;
        IJth(rJacobian, 23, 23) = -14.98 - var_x235 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 16, 24) = 0.00078910818213098765 * var_x204 + 1.7754934097947219e-10 * var_x205;
        IJth(rJacobian, 23, 24) = 0.10000000000000001;
        IJth(rJacobian, 24, 24) = -0.011085915847820609 - 2.6321499680605046e-9 * var_x205 - 0.011698444302491135 * var_x204;
        ...
        IJth(rJacobian, 26, 26) = -var_x246 - var_x248;
        IJth(rJacobian, 27, 26) = var_x246 + var_x248;
        IJth(rJacobian, 16, 27) = var_x213 * var_x214 - var_x213 * var_x215;
        IJth(rJacobian, 23, 27) = var_x215 * var_x236 - var_x214 * var_x236;
        IJth(rJacobian, 27, 27) = -0.033960000000000004 - var_x251;
        IJth(rJacobian, 28, 27) = 0.033960000000000004 + var_x251;
