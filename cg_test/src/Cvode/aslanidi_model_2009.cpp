...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellaslanidi_model_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x62 = var_x57 * (-0.22800000000000001 + 0.0060000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x69 = var_x57 * (0.0035000000000000001 * var_chaste_interface__membrane__V - 0.092888078186698725 * var_x21);
        ...
        const double var_x72 = (2.5 * var_x8 - 2744000.0 * var_x10) / pow((0.0012147716229348883 + 9.1107871720116623e-7 * var_x5 + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        ...
        const double var_x78 = var_x75 * pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 2.0) * var_chaste_interface__cleft_space_ion_concentrations__K_c / pow((1 + 0.027410122234342148 * var_x51), 2);
        const double var_x79 = var_x36 * var_x44;
        const double var_x80 = var_x37 * var_x79;
        const double var_x81 = 0.00020000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        ...
        const double var_x86 = 0.066348627276213379 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x87 = 0.092888078186698725 * var_x12;
        ...
        const double var_x94 = 0.03048 * var_x45;
        ...
        const double var_x99 = exp(-3.5035114021936398 - 0.078907914463820727 * var_chaste_interface__membrane__V);
        ...
        const double var_x104 = exp(-7.333333333333333 - 0.077519379844961239 * var_chaste_interface__membrane__V);
        ...
        const double var_x110 = -var_x108 * var_x109 + 2.019719479407183e-5 * var_x106 * (var_x109 - 0.35750508923240704 * var_x104 / pow((0.0030931023816888337 + var_x104), 2)) / pow((var_x105 + 0.030114017437961098 * var_x106), 2);
        ...
        const double var_x114 = 0.001 / (0.00014999999999999999 + 0.029999999999999999 * var_x113);
        const double var_x115 = var_x107 * var_x108;
        const double var_x116 = exp(30.0 + 0.5 * var_chaste_interface__membrane__V);
        const double var_x117 = 1.0 + var_x116;
        const double var_x118 = 1 / var_x117;
        const double var_x119 = 0.001 / (0.00044999999999999999 + 0.12 * var_x118);
        ...
        const double var_x130 = 50.0 * var_x129;
        ...
        const double var_x135 = 10.0 + var_chaste_interface__membrane__V;
        ...
        const double var_x149 = 0.008490000000000001 * var_x145;
        ...
        const double var_x157 = 0.033333333333333333 * var_chaste_interface__membrane__V;
        const double var_x158 = exp(0.77666666666666673 + var_x157);
        const double var_x159 = exp(-0.77666666666666673 - var_x157);
        const double var_x160 = exp(4.876462938881664 + 0.065019505851755519 * var_chaste_interface__membrane__V);
        const double var_x161 = exp(-0.9003601440576231 - 0.012004801920768308 * var_chaste_interface__membrane__V);
        ...
        const double var_x166 = 0.0096370000000000015 * var_x161;
        ...
        const double var_x171 = 0.00040000000000000002 + 1.0 / (8.0109999999999992 * var_x169 + 386.60000000000002 * var_x170);
        const double var_x172 = 1 / var_x171;
        const double var_x173 = exp(327.99999999999994 + 10.0 * var_chaste_interface__membrane__V);
        const double var_x174 = 1.0 + var_x173;
        const double var_x175 = 1 / var_x174;
        const double var_x176 = 1 / (0.020400000000000001 + 0.54659999999999997 * var_x175);
        ...
        const double var_x179 = 0.000141643059490085 * var_x177 / pow(var_x178, 2);
        const double var_x180 = 1.0 / var_x178;
        const double var_x181 = var_x173 / pow(var_x174, 2);
        const double var_x182 = exp(0.96921975662133131 - 0.071581961345740866 * var_chaste_interface__membrane__V);
        ...
        const double var_x190 = exp(1.8506208911614319 + 0.036523009495982472 * var_chaste_interface__membrane__V);
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = exp(0.065217391304347824 - 0.072463768115942032 * var_chaste_interface__membrane__V);
        const double var_x193 = 1.0 + var_x192;
        const double var_x194 = exp(-0.045816915605241454 * var_chaste_interface__membrane__V);
        const double var_x195 = exp(0.014398433450440593 * var_chaste_interface__membrane__V);
        const double var_x196 = 0.059999999999999998 + 1.0 / (0.29999999999999999 * var_x194 + 1.6599999999999999 * var_x195);
        ...
        const double var_x200 = exp(0.03941508020968823 * var_chaste_interface__membrane__V);
        const double var_x201 = exp(-0.076769537847382163 * var_chaste_interface__membrane__V);
        const double var_x202 = exp(2.539728728905752 + 0.05358970648917756 * var_chaste_interface__membrane__V);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = exp(0.009420009985210585 * var_chaste_interface__membrane__V);
        const double var_x205 = exp(-0.018299935950224173 * var_chaste_interface__membrane__V);
        const double var_x206 = 0.00031705239460620043 - 6.3410478921240086e-6 * var_chaste_interface__membrane__V;
        const double var_x207 = 0.00020079984991726025 - 5.2842065767700066e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x210 = (var_x208 - 0.32000000000000006 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up) / pow((0.00041999999999999996 + 0.00023999999999999998 * var_chaste_interface__Ca_handling_by_the_SR__Ca_up + var_chaste_interface__intracellular_ion_concentrations__Ca_i), 2);
        ...
        const double var_x231 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        ...
        const double var_x235 = 1.4509726698933535e-5 * var_chaste_interface__membrane__V - 0.00038508017945090519 * var_x21;
        const double var_x236 = 0.00027505727103636083 * var_chaste_interface__delayed_rectifier_K_current_z_gate__z;
        const double var_x237 = 0.00038508017945090519 * var_x12;
        const double var_x238 = 26.53945091048535 * var_x233;
        const double var_x239 = 0.00012635899136671262 * var_x45;
        const double var_x240 = 23.554751134632365 * var_x214;
        const double var_x241 = 47.109502269264731 * var_x217;
        const double var_x242 = exp(-1.6000000000000001 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x243 = 0.019200000000000002 * var_x242 * var_chaste_interface__Ca_handling_by_the_SR__F1;
        const double var_x244 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        ...
        IJth(rJacobian, 1, 0) = -var_x100 * var_x102 + 1.4519056261343013 * var_x99 * var_chaste_interface__sodium_current_m_gate__m - 0.036297640653357534 * var_x100 * var_x103 * var_x99 / pow(var_x101, 2);
        IJth(rJacobian, 2, 0) = var_x110 * var_x114 + 0.0055555555555555558 * var_x111 * (var_x115 - var_chaste_interface__sodium_current_h1_gate__h1) / (pow(var_x112, 2) * pow((0.0050000000000000001 + var_x113), 2));
        IJth(rJacobian, 3, 0) = var_x110 * var_x119 + 0.0041666666666666666 * var_x116 * (var_x115 - var_chaste_interface__sodium_current_h2_gate__h2) / (pow(var_x117, 2) * pow((0.0037499999999999999 + var_x118), 2));
        IJth(rJacobian, 4, 0) = (0.001 / var_x121 - 0.001 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L) * (var_x126 - var_x130 - var_x134 - 10.399334442595674 * var_x127 * var_x135 / pow(var_x128, 2) - 6.6879999999999997 * var_x131 * var_x136 / pow(var_x132, 2) - 1.7920000000000003 * var_x123 * var_x137 / pow(var_x124, 2)) + 0.00015151515151515152 * var_x120 * (var_x126 * var_x137 - var_x130 * var_x135 - var_x134 * var_x136) / pow(var_x121, 2);
        IJth(rJacobian, 5, 0) = var_x147 * (var_x150 - 0.0021225000000000003 * var_x148 * var_x153 + 1.8402920895651027e-6 * var_x151 * (var_x154 - var_x146 - var_x152) / pow((var_x141 + 0.1249963193074409 * var_x151), 2)) + (-0.001 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L + var_x142 * var_x150) * (var_x146 + var_x152 - var_x154);
        IJth(rJacobian, 6, 0) = (0.001 / var_x156 - 0.001 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T) * (22.472433333333335 * var_x158 - 22.472433333333335 * var_x159) + 0.0001639344262295082 * var_x155 * (674.173 * var_x158 + 674.173 * var_x159) / pow(var_x156, 2);
        IJth(rJacobian, 7, 0) = var_x162 * (-0.00011569027611044419 * var_x161 * var_x163 + 0.00010376673238559718 * var_x161 * (var_x164 - var_x165) / pow((var_x160 + var_x161), 2)) + (var_x165 - var_x164) * (-0.001 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T + var_x163 * var_x166);
        IJth(rJacobian, 8, 0) = 0.00017752529735487308 * var_x167 * var_x172 / pow(var_x168, 2) - 6.6907730760079843e-9 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x168) * (1.1126388888888887 * var_x169 - 32.216666666666669 * var_x170) / (pow(var_x171, 2) * pow((var_x170 + 0.020721676151060523 * var_x169), 2));
        IJth(rJacobian, 9, 0) = -var_x176 * var_x179 + 0.018294914013904134 * var_x181 * (var_x180 - var_chaste_interface__Ca_independent_transient_outward_K_current_s1_gate__s1) / pow((0.037321624588364438 + var_x175), 2);
        IJth(rJacobian, 10, 0) = -var_x179 * var_x185 + 3.0245746691871456e-5 * (var_x180 - var_chaste_interface__Ca_independent_transient_outward_K_current_s2_gate__s2) * (57.5 * var_x181 - 0.032211882605583393 * var_x182 / pow(var_x183, 2)) / pow((var_x175 + 0.078260869565217397 * var_x184), 2);
        IJth(rJacobian, 11, 0) = -2.1922574727480476e-5 * var_x189 * var_x190 / pow(var_x191, 2) + 0.00026666666666666668 * var_x186 * (0.39975990396158467 - var_chaste_interface__Ca_independent_transient_outward_K_current_s3_gate__s3 + 0.60024009603841544 / var_x191) / (pow(var_x187, 2) * pow((0.066666666666666666 + var_x188), 2));
        IJth(rJacobian, 12, 0) = 7.2463768115942027e-5 * var_x192 * var_x197 / pow(var_x193, 2) - 0.00036289737262302227 * (-var_chaste_interface__delayed_rectifier_K_current_z_gate__z + 1.0 / var_x193) * (0.013745074681572435 * var_x194 - 0.023901399527731383 * var_x195) / (pow(var_x196, 2) * pow((var_x195 + 0.18072289156626506 * var_x194), 2));
        IJth(rJacobian, 13, 0) = (0.001 / var_x199 - 0.001 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a) * (0.35473572188719404 * var_x200 - 0.099800399201596807 * var_x201) + 0.00013513513513513514 * var_x198 * (9.0 * var_x200 + 1.3 * var_x201) / pow(var_x199, 2);
        IJth(rJacobian, 14, 0) = (0.001 / var_x203 - 0.001 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i) * (6.1795265502981431 * var_x204 - 1.8299935950224173 * var_x205) - 5.3589706489177562e-5 * var_x202 * (100.0 * var_x205 + 656.0 * var_x204) / pow(var_x203, 2);
        IJth(rJacobian, 15, 0) = -1.6450937300378158e-8 - 0.00058612951745018135 * var_x41 - 2.2085216435981733e-5 * var_x79 - 2.8256129907129523e-6 * var_x54 - 4.9352811901134478e-8 * var_x11 + 2.2085216435981733e-5 * var_x36 * var_x55;
        ...
        IJth(rJacobian, 15, 1) = -0.0017583885523505443 * var_x58;
        ...
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L);
        IJth(rJacobian, 4, 4) = 0.050000000000000003 * var_x129 * var_x135 + 0.016719999999999999 * var_x133 * var_x136 - 0.0044800000000000005 * var_x125 * var_x137;
        IJth(rJacobian, 16, 4) = var_x206 * var_chaste_interface__L_type_Ca_channel_f_L_gate__f_L;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L);
        IJth(rJacobian, 5, 5) = -0.067921999999999996 * var_x141 - var_x142 * var_x149;
        IJth(rJacobian, 16, 5) = var_x206 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_chaste_interface__T_type_Ca_channel_f_T_gate__f_T);
        ...
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T);
        IJth(rJacobian, 7, 7) = -var_x166 - 0.0096370000000000015 * var_x160;
        IJth(rJacobian, 16, 7) = var_x207 * var_chaste_interface__T_type_Ca_channel_d_T_gate__d_T;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x15 * var_x57 * var_x63);
        IJth(rJacobian, 8, 8) = -0.001 * var_x172;
        IJth(rJacobian, 17, 8) = var_x221 * var_x63;
        IJth(rJacobian, 22, 8) = var_x232 * var_x63;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0017699999999999999 * var_x64 * var_x66);
        IJth(rJacobian, 9, 9) = -0.001 * var_x176;
        IJth(rJacobian, 17, 9) = var_x223 * var_x224;
        IJth(rJacobian, 22, 9) = var_x224 * var_x234;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00123 * var_x66 * var_x67);
        IJth(rJacobian, 10, 10) = -0.001 * var_x185;
        IJth(rJacobian, 17, 10) = var_x223 * var_x225;
        IJth(rJacobian, 22, 10) = var_x225 * var_x234;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-3.600144e-5 * var_x56 * var_x68);
        IJth(rJacobian, 11, 11) = -0.001 * var_x189;
        IJth(rJacobian, 17, 11) = -2.9612871608166312e-5 * var_x68;
        IJth(rJacobian, 22, 11) = 0.00014924887290515819 * var_x68;
        ...
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_chaste_interface__delayed_rectifier_K_current_pi_gate__p_i);
        IJth(rJacobian, 13, 13) = -0.0090000000000000011 * var_x200 - 0.0013000000000000002 * var_x201;
        ...
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x69 * var_chaste_interface__delayed_rectifier_K_current_pa_gate__p_a);
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * (0.00015000000000000001 * var_x71 + 0.00053078901820970701 * var_x37 + 0.154584 * var_x77 + 0.71257887225271721 * var_x80 - 6.640515431495382e-14 * var_x73 - 0.0001161412471825695 * var_x78));
        IJth(rJacobian, 15, 15) = 1.638640545085862e-16 * var_x73 + 2.8659485630822583e-7 * var_x78 - 0.00038145775374624855 * var_x77 - 4.3659884291485854e-7 * var_x37 - 0.00058612951745018135 * var_x80 - 3.701460892585086e-7 * var_x71;
        IJth(rJacobian, 16, 15) = 2.6421032883850034e-7 * var_x71 - 1.1696618438750204e-16 * var_x73;
        IJth(rJacobian, 17, 15) = 0.00025430516916416572 * var_x77 - 1.9106323753881723e-7 * var_x78;
        IJth(rJacobian, 22, 15) = 9.6295871719563877e-7 * var_x78 - 0.0012816980525873951 * var_x77;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * (0.0095090000000000001 * var_x82 + 0.0002653945091048535 * var_x83 - 0.0095090000000000001 * var_x84 - 2.4295432458697768e-8 * var_x72 - 54.880000000000003 * var_x85));
        IJth(rJacobian, 15, 16) = 0.13542411585671302 * var_x85 + 5.9952395409541403e-11 * var_x72;
        IJth(rJacobian, 16, 16) = -47.271999999999998 - var_x215 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC + 8.3745867230843319e-6 * var_x84 + 7.3978892074780085e-7 * var_x210 - 0.096665752311046002 * var_x85 - 2.3373323507508574e-7 * var_x83 - 8.2198768971977891 * var_x209 - 8.3745867230843319e-6 * var_x82 - 4.2794027994574083e-11 * var_x72;
        ...
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * (0.26964082125053118 * var_x88 - 0.014152880000000001 * var_x90 + var_x20 * var_x86 + var_x20 * var_x87 + var_x20 * var_x89));
        IJth(rJacobian, 17, 17) = 1.1641407074988802e-5 * var_x90 - 0.00022179221220074814 * var_x88 + var_x20 * var_x229 - var_x20 * var_x227 - var_x20 * var_x228;
        IJth(rJacobian, 22, 17) = 0.0011178327494917705 * var_x88 - 5.8672691657943555e-5 * var_x90 + var_x20 * var_x236 + var_x20 * var_x237 + var_x20 * var_x238;
        ...
        IJth(rJacobian, 16, 20) = 0.0010560000000000001 + var_x216;
        IJth(rJacobian, 20, 20) = -0.0066 + var_x231;
        ...
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * (0.10305599999999999 * var_x95 + 0.014152880000000001 * var_x97 - 0.26964082125053118 * var_x93 - 0.10305599999999999 * var_x98 + var_x93 * var_x94 - var_x86 * var_x91 - var_x87 * var_x91 - var_x89 * var_x91 - var_x94 * var_x96));
        IJth(rJacobian, 15, 22) = 0.00025430516916416572 * var_x98 - 0.00025430516916416572 * var_x95;
        IJth(rJacobian, 17, 22) = 0.00016953677944277714 * var_x95 + 0.00022179221220074814 * var_x93 - 1.1641407074988802e-5 * var_x97 - 0.00016953677944277714 * var_x98 + var_x227 * var_x91 + var_x228 * var_x91 + var_x230 * var_x96 - var_x229 * var_x91 - var_x230 * var_x93;
        IJth(rJacobian, 22, 22) = 5.8672691657943555e-5 * var_x97 + 0.00085446536839159674 * var_x98 - 0.0011178327494917705 * var_x93 - 0.00085446536839159674 * var_x95 + var_x239 * var_x93 - var_x236 * var_x91 - var_x237 * var_x91 - var_x238 * var_x91 - var_x239 * var_x96;
        ...
        IJth(rJacobian, 16, 24) = 0.00078910818213098765 * var_x209 + 1.7754934097947219e-10 * var_x210;
        IJth(rJacobian, 23, 24) = 0.10000000000000001;
        IJth(rJacobian, 24, 24) = -0.011085915847820609 - 2.6321499680605046e-9 * var_x210 - 0.011698444302491135 * var_x209;
        ...
        IJth(rJacobian, 27, 27) = -0.033960000000000004 - var_x256;
        IJth(rJacobian, 28, 27) = 0.033960000000000004 + var_x256;
