...
#include "MathsCustomFunctions.hpp"
    ...
    void CellShannon2004FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x224 = 1.0 - var_chaste_interface__INa_m_gate__m;
        ...
        const double var_x230 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        ...
        const double var_x242 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x258 = exp(-0.20000000000000001 - var_x253);
        const double var_x259 = 1.0 + var_x258;
        const double var_x260 = 0.066666666666666666 * var_x258 / pow(var_x259, 2);
        ...
        const double var_x270 = 0.10000000000000001 * var_x269;
        const double var_x271 = 1 / var_x268;
        const double var_x272 = 1.0 * var_x271;
        const double var_x273 = var_x263 / pow(var_x264, 2);
        ...
        const double var_x283 = -var_chaste_interface__ICaL_d_gate__d + 1.0 * var_x282;
        const double var_x284 = var_x280 * var_x283;
        ...
        const double var_x288 = 0.0058333333333333336 * var_x278;
        const double var_x289 = var_x286 * var_x288;
        ...
        const double var_x291 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x292 = 1.0 + var_x291;
        const double var_x293 = exp(9.7388888888888889 + 0.27777777777777779 * var_chaste_interface__cell__V);
        ...
        const double var_x305 = var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__R;
        const double var_x306 = var_x295 * var_x296 / pow(var_x297, 2);
        const double var_x307 = 2.3772197685794643 * var_x306;
        const double var_x308 = 0.21130842387373014 * var_x171 * var_x306 / pow((1 - 0.93333333333333335 * var_x298), 2);
        const double var_x309 = var_x308 * var_chaste_interface__Jrel_SR__R;
        const double var_x310 = 20.0 * var_x302;
        const double var_x311 = var_x305 * var_x310;
        const double var_x312 = 7.5 - var_x299;
        const double var_x313 = var_x307 * var_chaste_interface__Ca_buffer__Ca_jct * var_chaste_interface__Jrel_SR__O;
        const double var_x314 = 1.0 - var_chaste_interface__Jrel_SR__I - var_chaste_interface__Jrel_SR__O - var_chaste_interface__Jrel_SR__R;
        const double var_x315 = 5.2861839130367859e-9 * var_x103;
        const double var_x316 = 0.030875661253127462 * var_x126;
        ...
        const double var_x319 = 1.7653304347803737e-6 * var_x94;
        const double var_x320 = 0.14159899680406998 * var_x124;
        ...
        const double var_x326 = 0.00038060524173864864 * var_x78;
        ...
        const double var_x330 = 0.12710379130418692 * var_x86;
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x202) ? (-0.019852941176470591 * var_x201) : (0)) - ((var_x202) ? (0.28123999999999999 * var_x203 + 108500.0 * var_x204) : (0.693000693000693 * var_x205 / pow(var_x206, 2))) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x202) ? (var_x213 + var_x212 * var_x214 * (1.5254334000000001e-6 * var_x208 - 31073.016 * var_x207) - 0.311 * var_x209 * var_x210 * var_x214 / pow(var_x211, 2)) : (0)) - ((var_x202) ? (-0.001275024 * var_x218 + 0.016701360000000002 * var_x215 * var_x217 / pow(var_x216, 2)) : (-7.6049999999999996e-8 * var_x223 + 0.029999999999999999 * var_x220 * var_x222 / pow(var_x221, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 4, 0) = var_x224 * var_x227 + 0.0072727272727272727 * var_x228 * var_chaste_interface__INa_m_gate__m - 0.032000000000000001 * var_x224 * var_x225 * var_x229 / pow(var_x226, 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__IKr_Xr_gate__Xr + 1.0 / var_x231) * (var_x234 + var_x237 - 0.00016973999999999998 * var_x235 * var_x238 / pow(var_x236, 2) - 8.8449999999999995e-5 * var_x232 * var_x239 / pow(var_x233, 2)) + 0.13333333333333333 * var_x230 * (var_x240 + var_x241) / pow(var_x231, 2);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKs_Xs_gate__Xs + 1.0 / var_x243) * (var_x246 + var_x249 - 8.9997000000000013e-6 * var_x244 * var_x250 / pow(var_x245, 2) - 1.0641199999999999e-5 * var_x247 * var_x250 / pow(var_x248, 2)) + 0.059880239520958084 * var_x242 * (var_x251 + var_x252) / pow(var_x243, 2);
        IJth(rJacobian, 7, 0) = var_x257 * var_x260 + 0.0074074074074074077 * var_x254 * (var_x261 - var_chaste_interface__Itos_X_gate__X_tos) / (pow(var_x255, 2) * pow((0.055555555555555552 + var_x256), 2));
        IJth(rJacobian, 8, 0) = -var_x266 * var_x270 + 3.3333333333333335e-5 * var_x273 * (var_x272 - var_chaste_interface__Itos_Y_gate__Y_tos) / pow((0.01 + var_x265), 2);
        IJth(rJacobian, 9, 0) = -var_x270 * var_x274 + 3.5714285714285717e-5 * var_x273 * (var_x272 - var_chaste_interface__Itos_R_gate__R_tos) / pow((0.07857142857142857 + var_x265), 2);
        IJth(rJacobian, 10, 0) = var_x260 * var_x276 + 0.00063492063492063492 * var_x275 * (var_x261 - var_chaste_interface__Itof_X_gate__X_tof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x275), 2);
        IJth(rJacobian, 11, 0) = -var_x270 * var_x277 + 0.0050000000000000001 * var_x269 * (var_x272 - var_chaste_interface__Itof_Y_gate__Y_tof) / pow((1 + var_x271), 2);
        IJth(rJacobian, 12, 0) = var_x284 * var_x285 - var_x284 * var_x289 + var_x282 * var_x287 * var_x288 - var_x281 * var_x283 * var_x289 / pow(var_x279, 2);
        IJth(rJacobian, 13, 0) = (0.02 + var_x290) * (0.029999999999999999 * var_x291 / pow(var_x292, 2) - 0.27777777777777779 * var_x293 / pow(var_x294, 2)) + var_x290 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL_f_gate__f + 1.0 / var_x294 + 0.59999999999999998 / var_x292);
        IJth(rJacobian, 19, 0) = -5.7312946201117851e-7 + 1.9788582471371878e-10 * var_x110 - 0.00034230211796518873 * var_x97 - 0.0086408441000245025 * var_x44 - 1.4841436853528909e-10 * var_x123 - 0.052102678364652592 * var_x69 - 0.030875661253127462 * var_x32 - var_x315 * var_x91;
        IJth(rJacobian, 20, 0) = -2.6284313781755491e-6 + 6.6084319941501622e-8 * var_x109 - 0.039627810594012845 * var_x41 - 4.9563239956126223e-8 * var_x115 - 0.2389483071068681 * var_x60 - 0.14159899680406998 * var_x32 - 0.0015698331482008195 * var_x83 - var_x319 * var_x91;
        IJth(rJacobian, 25, 0) = -2.4247042727846657e-7 + 2.8495558758775506e-5 * var_x112 + 0.00011410070598839625 * var_x97 + 0.017367559454884197 * var_x69 - 9.7169855367424485e-6 * var_x119 - var_x326 * var_x74;
        IJth(rJacobian, 26, 0) = -1.1119946217769619e-6 + 0.079649435702289356 * var_x60 + 0.00052327771606693984 * var_x83 + 0.0095161420715762363 * var_x113 - 0.0032450044464074966 * var_x121 - var_x330 * var_x74;
        ...
        IJth(rJacobian, 2, 2) = -((var_x202) ? (0.13500000000000001 * var_x201) : (0.0)) - ((var_x202) ? (310000.0 * var_x204 + 3.5600000000000001 * var_x203) : (7.6923076923076916 / var_x206));
        IJth(rJacobian, 19, 2) = -var_x31 * var_x316;
        IJth(rJacobian, 20, 2) = -var_x31 * var_x320;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 * var_x128 - var_x127 * var_x128);
        IJth(rJacobian, 3, 3) = -((var_x202) ? (0.1212 * var_x218) : (0.29999999999999999 * var_x223)) - ((var_x202) ? (var_x213 * var_x214) : (0.0));
        IJth(rJacobian, 19, 3) = -var_x128 * var_x316;
        IJth(rJacobian, 20, 3) = -var_x128 * var_x320;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-5.2800000000000002 * var_x130 - 42.719999999999999 * var_x131);
        IJth(rJacobian, 4, 4) = -0.080000000000000002 * var_x228 - var_x227 * var_x229;
        ...
        IJth(rJacobian, 12, 12) = -var_x285 * var_x287;
        IJth(rJacobian, 19, 12) = -var_x138 * var_x315;
        IJth(rJacobian, 20, 12) = -var_x138 * var_x319;
        IJth(rJacobian, 25, 12) = -var_x137 * var_x326;
        IJth(rJacobian, 26, 12) = -var_x137 * var_x330;
        ...
        IJth(rJacobian, 13, 13) = -0.02 - var_x290;
        IJth(rJacobian, 19, 13) = -var_x142 * var_x315;
        IJth(rJacobian, 20, 13) = -var_x142 * var_x319;
        IJth(rJacobian, 25, 13) = -var_x141 * var_x326;
        IJth(rJacobian, 26, 13) = -var_x141 * var_x330;
        ...
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x301 + var_x304;
        IJth(rJacobian, 17, 16) = var_x304;
        IJth(rJacobian, 18, 16) = var_x303;
        IJth(rJacobian, 16, 17) = -0.0050000000000000001;
        IJth(rJacobian, 17, 17) = -0.065000000000000002 + var_x304;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 16, 18) = 0.055;
        IJth(rJacobian, 17, 18) = var_x304 + var_x312 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 18) = -0.059999999999999998 + var_x301;
        ...
        IJth(rJacobian, 19, 19) = -2.5101556644976917 + var_x317 + 1.7451694845309862e-13 * var_x154 - 2.3607251144114479e-6 * var_x149 - 1.5310180739595352e-5 * var_x42 - 3.9646379347775894e-9 * var_x122 - 0.28135446316912399 * var_x155 - 0.82479088159436242 * var_x150;
        IJth(rJacobian, 20, 19) = 1.0293738389968197;
        IJth(rJacobian, 21, 19) = 0.000165 - var_x317;
        ...
        IJth(rJacobian, 20, 20) = -1.0301299389968197 + var_x321 + 8.0035289361659539e-13 * var_x161 - 7.0214082731462295e-5 * var_x33 - 1.3239978260852802e-6 * var_x114 - 3.7825768474861841 * var_x156 - 1.2903208583770878 * var_x162 - 1.0826531136947708e-5 * var_x157;
        IJth(rJacobian, 22, 20) = 0.0007561 - var_x321;
        IJth(rJacobian, 26, 20) = 0.43010695279236255 * var_x162 - 2.6678429787219845e-13 * var_x161;
        IJth(rJacobian, 19, 21) = 0.001 + var_x318;
        IJth(rJacobian, 21, 21) = -0.001 - var_x318;
        IJth(rJacobian, 20, 22) = 0.001 + var_x322;
        IJth(rJacobian, 22, 22) = -0.001 - var_x322;
        ...
        IJth(rJacobian, 16, 24) = -var_x309 + var_x305 * var_x307;
        IJth(rJacobian, 17, 24) = -var_x313 + var_x308 * var_x314;
        IJth(rJacobian, 18, 24) = var_x309 + var_x313;
        IJth(rJacobian, 24, 24) = -260.00009932 + var_x323 - var_x324 - 4.6421953480341129e-16 * var_x195 - 0.0036772346118413473 * var_x194;
        IJth(rJacobian, 26, 24) = 0.0064493506493506492 + var_x331;
        IJth(rJacobian, 31, 24) = 260.0 - var_x323;
        ...
        IJth(rJacobian, 25, 25) = -171.99023312516786 + var_x327 + var_x328 + 2.3065909313514399e-15 * var_x168 + 8.7413788910230311e-13 * var_x169 - 0.00012978638743287919 * var_x118 - 47656.583144202239 * var_x167 - 5.4319197230928918e-10 * var_x166 - 3.2385929460103637e-6 * var_x4;
        IJth(rJacobian, 26, 25) = 46.324352205124718;
        IJth(rJacobian, 27, 25) = 121.55000000000001 - var_x327;
        IJth(rJacobian, 29, 25) = 43.550000000000004 - var_x328;
        ...
        IJth(rJacobian, 16, 26) = -var_x311 + var_x300 * var_chaste_interface__Jrel_SR__R;
        IJth(rJacobian, 17, 26) = var_x312 * var_chaste_interface__Jrel_SR__O + var_x310 * var_x314 * var_chaste_interface__Ca_buffer__Ca_jct;
        IJth(rJacobian, 18, 26) = var_x311 + var_x300 * var_chaste_interface__Jrel_SR__O;
        IJth(rJacobian, 20, 26) = 655674.15470124607 * var_x174 - 1.2026662083498781e-11 * var_x176 - 3.1734798413457098e-14 * var_x175;
        IJth(rJacobian, 24, 26) = 9.9320000000000005e-5 + var_x324;
        IJth(rJacobian, 25, 26) = 1.2484412919281114;
        IJth(rJacobian, 26, 26) = -121.70185906968872 + var_x332 + var_x333 - var_x331 + 4.0088873611662605e-12 * var_x176 + 1.0578266137819032e-14 * var_x175 - 1.4852524402707469e-5 * var_x2 - 2.4911349337733966e-9 * var_x173 - 0.043342392834727739 * var_x120 - 218558.051567082 * var_x174;
        IJth(rJacobian, 28, 26) = 55.473098330241186 - var_x332;
        IJth(rJacobian, 30, 26) = 19.897959183673468 - var_x333;
        IJth(rJacobian, 25, 27) = 1.3 + var_x329;
        IJth(rJacobian, 27, 27) = -1.3 + var_x335;
        IJth(rJacobian, 26, 28) = 1.3 + var_x334;
        IJth(rJacobian, 28, 28) = -1.3 + var_x336;
        IJth(rJacobian, 25, 29) = 0.029999999999999999 + var_x329;
        IJth(rJacobian, 29, 29) = -0.029999999999999999 + var_x335;
        IJth(rJacobian, 26, 30) = 0.029999999999999999 + var_x334;
        IJth(rJacobian, 30, 30) = -0.029999999999999999 + var_x336;
        IJth(rJacobian, 24, 31) = 65.0 + var_x325;
        IJth(rJacobian, 31, 31) = -65.0 - var_x325;
        ...
        IJth(rJacobian, 36, 36) = -0.00046000000000000001 + var_x338;
        IJth(rJacobian, 37, 36) = -0.015699999999999999;
        IJth(rJacobian, 1, 37) = 0.015757 + var_x199;
        IJth(rJacobian, 36, 37) = var_x338;
