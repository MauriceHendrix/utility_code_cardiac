...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellluo_rudy_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x4 = log(5.4000000000000004 * var_x3);
        const double var_x5 = exp(-14.1227775 + 0.23849999999999999 * var_chaste_interface__membrane__V - 6.3475921059424856 * var_x4);
        const double var_x6 = 1.0 + var_x5;
        const double var_x7 = 1 / var_x6;
        const double var_x8 = exp(-2.4444678999999998 + 13.687910356755641 * var_x4 - 0.51429999999999998 * var_chaste_interface__membrane__V);
        const double var_x9 = 1.0 + var_x8;
        const double var_x10 = 1 / var_x9;
        const double var_x11 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__membrane__V - 2.1376880417161446 * var_x4);
        const double var_x12 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__membrane__V - 1.6434541406371006 * var_x4);
        ...
        const double var_x17 = exp(-1.7526479750778814 + 0.031152647975077882 * var_chaste_interface__membrane__V);
        const double var_x18 = 1.0 + var_x17;
        const double var_x19 = 1 / var_x18;
        const double var_x20 = pow(var_chaste_interface__time_dependent_potassium_current_X_gate__X, 2);
        const double var_x21 = var_x19 * var_x20;
        const double var_x22 = exp(-0.024422646794659157 * var_chaste_interface__membrane__V);
        const double var_x23 = 1.0 + 0.10000000000000001 * var_x22;
        const double var_x24 = 1 / var_x23;
        const double var_x25 = var_x22 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x26 = exp(0.013150655966354929 * var_chaste_interface__membrane__V);
        const double var_x27 = var_x26 * pow(var_chaste_interface__ionic_concentrations__Nai, 3);
        const double var_x28 = var_x24 * (67015.74280454473 * var_x25 + 0.023671180739438871 * var_x27);
        ...
        const double var_x32 = var_x22 * (1.8 * var_x27 - 2744000.0 * var_x25) / pow(var_x23, 2);
        const double var_x33 = 1 / var_chaste_interface__ionic_concentrations__Nai;
        const double var_x34 = pow(var_x33, 1.5);
        const double var_x35 = exp(-0.0037573302761014088 * var_chaste_interface__membrane__V);
        ...
        const double var_x40 = (0.00046778761937462537 * var_x35 + 0.037573302761014088 * var_x38 * (-0.0052142857142857138 + 0.0052142857142857138 * var_x36)) / (pow(var_x39, 2) * (1.0 + 31.622776601683793 * var_x34));
        const double var_x41 = var_chaste_interface__ionic_concentrations__Ki + var_chaste_interface__ionic_concentrations__Nai;
        const double var_x42 = log(145.40000000000001 / var_x41);
        const double var_x43 = exp(var_x37 - 1.0 * var_x42);
        const double var_x44 = 0.75 * var_x43;
        const double var_x45 = -105.0 + var_x44 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x46 = 1.0 + 1.7279999999999996e-9 / pow(var_chaste_interface__ionic_concentrations__Cai_converted, 3);
        const double var_x47 = 1 / var_x46;
        const double var_x48 = -1.0 + var_x43;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = var_x47 * var_x49;
        const double var_x51 = 0.00063678763853082152 * var_x50;
        const double var_x52 = -4.0500000000000007 + var_x44 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x53 = -26.614641953637257 * var_x4 + var_chaste_interface__membrane__V;
        const double var_x54 = var_x0 * var_x53 / pow(var_x1, 2);
        const double var_x55 = 0.018329999999999999 * var_chaste_interface__ionic_concentrations__Nai + var_chaste_interface__ionic_concentrations__Ki;
        const double var_x56 = -26.614641953637257 * log(7.9662000000000006 / var_x55) + var_chaste_interface__membrane__V;
        const double var_x57 = var_x17 * var_x20 * var_x56 / pow(var_x18, 2);
        const double var_x58 = var_x5 / pow(var_x6, 2);
        const double var_x59 = var_x15 * var_x53;
        const double var_x60 = var_x58 * var_x59;
        const double var_x61 = var_x13 * var_x8 / pow(var_x9, 2);
        const double var_x62 = 0.24326999999999999 * var_x58 - 0.51429999999999998 * var_x61 - var_x10 * (0.061749999999999999 * var_x12 + 0.039456396800000001 * var_x11);
        const double var_x63 = var_x53 * var_x7 / pow((var_x7 + 0.98039215686274506 * var_x14), 2);
        const double var_x64 = 0.73529411764705876 * var_x63;
        const double var_x65 = -26.614641953637257 * var_x42 + var_chaste_interface__membrane__V;
        const double var_x66 = var_x45 * var_x65;
        const double var_x67 = var_x43 * var_x47 / pow(var_x48, 2);
        const double var_x68 = 2.3926214736989757e-5 * var_x67;
        const double var_x69 = var_x52 * var_x65;
        const double var_x70 = var_x43 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x71 = var_x50 * var_x65;
        const double var_x72 = 1.7944661052742317e-5 * var_x71;
        const double var_x73 = var_x43 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x74 = exp(var_x37);
        const double var_x75 = -1.0 + var_x74;
        const double var_x76 = 1 / var_x75;
        const double var_x77 = pow(var_chaste_interface__ionic_concentrations__Cai_converted, 2);
        const double var_x78 = 1 / (1.0 + 2777777.7777777785 * var_x77);
        const double var_x79 = var_x78 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x80 = var_x79 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x81 = var_x76 * var_x80;
        const double var_x82 = 0.75 * var_x74;
        const double var_x83 = -105.0 + var_x82 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x84 = 0.0024561808914760263 * var_x83;
        const double var_x85 = -4.0500000000000007 + var_x82 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x86 = 0.00070228579563684902 * var_x85;
        const double var_x87 = exp(0.075146605522028176 * var_chaste_interface__membrane__V);
        const double var_x88 = -1.0 + var_x87;
        const double var_x89 = 1 / var_x88;
        const double var_x90 = var_x87 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x91 = -0.6120000000000001 + 1.0 * var_x90;
        const double var_x92 = var_x89 * var_x91;
        const double var_x93 = 7.8597788527232835 * var_x92;
        const double var_x94 = var_x80 * var_chaste_interface__membrane__V;
        const double var_x95 = var_x87 * var_x94;
        const double var_x96 = var_x91 * var_x95 / pow(var_x88, 2);
        const double var_x97 = var_x74 * var_x94 / pow(var_x75, 2);
        const double var_x98 = var_x83 * var_x97;
        const double var_x99 = var_x85 * var_x97;
        const double var_x100 = var_x74 * var_x81 * var_chaste_interface__membrane__V;
        const double var_x101 = var_x100 * var_chaste_interface__ionic_concentrations__Nai;
        const double var_x102 = var_x89 * var_x90 * var_x94;
        const double var_x103 = var_x100 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x104 = 1.0 * var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x105 = 0.00050000000000000001 + var_x104;
        const double var_x106 = 1 / var_x105;
        const double var_x107 = 1 / var_chaste_interface__ionic_concentrations__Cai_converted;
        const double var_x108 = var_chaste_interface__ionic_concentrations__Cai_converted / pow(var_x105, 2);
        const double var_x109 = var_x22 * var_x24;
        const double var_x110 = var_x49 / (pow(var_x46, 2) * pow(var_chaste_interface__ionic_concentrations__Cai_converted, 4));
        const double var_x111 = 3.301107118143778e-12 * var_x110;
        const double var_x112 = var_x89 * var_x95;
        const double var_x113 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__membrane__V;
        const double var_x114 = var_x113 * var_chaste_interface__L_type_Ca_channel_f_gate__f * var_chaste_interface__ionic_concentrations__Cai_converted / pow((3.5999999999999994e-7 + var_x77), 2);
        const double var_x115 = var_x114 * var_x76;
        const double var_x116 = var_x115 * var_x85;
        const double var_x117 = var_x114 * var_x92;
        const double var_x118 = var_x115 * var_x83;
        const double var_x119 = -26.614641953637257 * log(140.0 * var_x33) + var_chaste_interface__membrane__V;
        const double var_x120 = var_x119 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x121 = var_x120 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x122 = var_x120 * var_x29;
        const double var_x123 = var_x79 * var_chaste_interface__membrane__V;
        const double var_x124 = var_x123 * var_x76;
        const double var_x125 = var_x113 * var_x78;
        const double var_x126 = var_x125 * var_x76;
        const double var_x127 = var_x19 * var_x56 * var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        const double var_x128 = var_x24 * var_x26 * pow(var_chaste_interface__ionic_concentrations__Nai, 2);
        const double var_x129 = var_x21 * (0.12553036579548593 * var_chaste_interface__ionic_concentrations__Ki + 0.002300971605031257 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x55, 2);
        const double var_x130 = (0.0068775790921595595 * var_chaste_interface__ionic_concentrations__Ki + 0.0068775790921595595 * var_chaste_interface__ionic_concentrations__Nai) / pow(var_x41, 2);
        const double var_x131 = 109.05 * var_x130;
        const double var_x132 = var_x44 + var_x131 * var_x73;
        const double var_x133 = var_x51 * var_x65;
        const double var_x134 = var_x30 * var_x33 * var_chaste_interface__fast_sodium_current_h_gate__h;
        const double var_x135 = var_x33 * var_x34 / (var_x39 * pow((0.031622776601683791 + var_x34), 2));
        const double var_x136 = var_x130 * var_x71;
        const double var_x137 = 0.069441691981786097 * var_x136;
        const double var_x138 = var_x130 * var_x50;
        const double var_x139 = 2.4642210250000001 * var_x138;
        const double var_x140 = var_x130 * var_x67;
        const double var_x141 = 0.092588922642381458 * var_x140;
        const double var_x142 = var_x141 * var_x66 + var_x141 * var_x69 - var_x139 * var_x45 - var_x139 * var_x52;
        const double var_x143 = var_x2 * var_x3;
        const double var_x144 = var_x16 * var_x3;
        const double var_x145 = var_x44 + var_x131 * var_x70;
        const double var_x146 = var_x3 * var_x58;
        const double var_x147 = 6.4745439480613349 * var_x146 - var_x10 * (1.0501178736126389 * var_x11 * var_x3 + 1.6434541406371006 * var_x12 * var_x3) - 13.687910356755641 * var_x3 * var_x61;
        const double var_x148 = var_x146 * var_x59;
        const double var_x149 = 0.00011935049112322121 * var_x92;
        const double var_x150 = 0.00092000000000000003 + var_x104;
        ...
        const double var_x161 = var_chaste_interface__membrane__V < -40.0;
        const double var_x162 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x163 = exp(0.34999999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x169 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x170 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        const double var_x171 = -127140.0 * var_x169 - 3.4740000000000003e-5 * var_x170;
        const double var_x172 = var_x168 * var_x171;
        const double var_x173 = 37.780000000000001 + var_chaste_interface__membrane__V;
        ...
        const double var_x178 = exp(-3.2000000000000002 + var_x154);
        const double var_x179 = 1.0 + var_x178;
        const double var_x180 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__V);
        const double var_x181 = var_x180 / var_x179;
        const double var_x182 = 1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x183 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
        const double var_x184 = 1.0 - var_x183;
        const double var_x185 = 1 / var_x184;
        const double var_x186 = 0.035000000000000003 * var_x185;
        const double var_x187 = 1.0 + var_x183;
        const double var_x188 = 1 / var_x187;
        const double var_x189 = 1.0 - 1.0 * var_x188;
        const double var_x190 = var_x187 * var_x189;
        const double var_x191 = var_x190 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x192 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x193 = 0.005608974358974359 * var_x183 * var_x192;
        const double var_x194 = var_x193 / pow(var_x184, 2);
        const double var_x195 = var_x185 * var_x193 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x196 = var_x186 * var_x192;
        const double var_x197 = 1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x198 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x199 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__membrane__V);
        const double var_x200 = 1.0 + var_x199;
        const double var_x201 = 0.029999999999999999 * var_x199 / pow(var_x200, 2);
        const double var_x202 = exp(4.0767441860465121 + 0.11627906976744186 * var_chaste_interface__membrane__V);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = 0.11627906976744186 * var_x202 / pow(var_x203, 2);
        const double var_x205 = -0.02 - var_x198;
        const double var_x206 = 1.0 / var_x203;
        const double var_x207 = 0.59999999999999998 / var_x200;
        const double var_x208 = var_x206 + var_x207;
        const double var_x209 = var_x198 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V);
        const double var_x210 = 1.0 - var_x206 - var_x207;
        const double var_x211 = 1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X;
        const double var_x212 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__membrane__V);
        const double var_x213 = 1.0 - var_x212;
        const double var_x214 = 7.1899999999999999e-5 / var_x213;
        const double var_x215 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__membrane__V);
        const double var_x216 = -1.0 + var_x215;
        const double var_x217 = 0.00013100000000000001 / var_x216;
        const double var_x218 = 30.0 + var_chaste_interface__membrane__V;
        const double var_x219 = 0.00048591897908422494 * var_x30;
        const double var_x220 = 1.9339199950521953e-8 * var_x50;
        const double var_x221 = 7.2663761489674998e-10 * var_x67;
        const double var_x222 = 5.4497821117256254e-10 * var_x71;
        const double var_x223 = 7.4594056952013249e-8 * var_x83;
        const double var_x224 = 1.0025441254350579e-16 * var_x110;
        const double var_x225 = var_x220 * var_x65;
        const double var_x226 = 7.4838235294117636e-5 * var_x138;
        const double var_x227 = 2.8119196728058921e-6 * var_x140;
        const double var_x228 = var_x227 * var_x66 - var_x226 * var_x45;
        const double var_x229 = 2.1089397546044193e-6 * var_x136;
        const double var_x230 = 2.2330835435855923e-5 * var_x63;
        const double var_x231 = 2.1328374802575643e-8 * var_x85;
        const double var_x232 = var_x227 * var_x69 - var_x226 * var_x52;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0044260000000000002 + 0.0087850467289719621 * var_x57 + 0.59063570093597573 * var_x96 + 0.18245249999999999 * var_x60 + 9.2286828271246203e-5 * var_x98 + 2.6387196824222993e-5 * var_x99 - 4.4992696901614849e-7 * var_x32 - 1.1739130434782608 * var_x40 - 0.76500000000000001 * var_x16 - 0.28199999999999997 * var_x21 - 0.0183 * var_x2 - 0.00018422531054846207 * var_x28 - 6.9215121203434652e-5 * var_x101 - 0.59063570093597573 * var_x102 - 1.9790397618167245e-5 * var_x103 - 0.003060200668896321 * var_x54 + var_x66 * var_x68 + var_x68 * var_x69 - var_x31 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x45 * var_x51 - var_x51 * var_x52 - var_x62 * var_x64 - var_x70 * var_x72 - var_x72 * var_x73 - var_x80 * var_x93 - var_x81 * var_x84 - var_x81 * var_x86);
        IJth(rJacobian, 1, 0) = -4.5797863778688198e-8 + 2.7974554632244679e-9 * var_x28 + 6.8321266702120803e-12 * var_x32 + 8.9687842752970284e-6 * var_x96 - 8.9687842752970284e-6 * var_x102 - var_x149 * var_x80;
        ...
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h) * ((var_x161) ? (-0.019852941176470591 * var_x160) : (0)) - ((var_x161) ? (0.28123999999999999 * var_x162 + 108500.0 * var_x163) : (0.693000693000693 * var_x164 / pow(var_x165, 2))) * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j) * ((var_x161) ? (var_x172 + var_x168 * var_x173 * (1.5254334000000001e-6 * var_x170 - 31073.016 * var_x169) - 0.311 * var_x166 * var_x171 * var_x173 / pow(var_x167, 2)) : (0)) - ((var_x161) ? (-0.001275024 * var_x177 + 0.016701360000000002 * var_x174 * var_x176 / pow(var_x175, 2)) : (-7.6049999999999996e-8 * var_x181 + 0.029999999999999999 * var_x178 * var_x180 / pow(var_x179, 2))) * var_chaste_interface__fast_sodium_current_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x182 * var_x186 + var_x188 * var_x195 + var_x189 * var_x195 + var_x191 * var_x194 - var_x182 * var_x194 - var_x186 * var_x191;
        IJth(rJacobian, 6, 0) = var_x197 * var_x208 * var_x209 + var_x197 * (0.02 + var_x198) * (var_x201 - var_x204) + var_x205 * (var_x204 - var_x201) * var_chaste_interface__L_type_Ca_channel_f_gate__f - var_x209 * var_x210 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        IJth(rJacobian, 7, 0) = var_x211 * var_x214 - var_x217 * var_chaste_interface__time_dependent_potassium_current_X_gate__X + 8.9997000000000013e-6 * var_x215 * var_x218 * var_chaste_interface__time_dependent_potassium_current_X_gate__X / pow(var_x216, 2) - 1.0641199999999999e-5 * var_x211 * var_x212 * var_x218 / pow(var_x213, 2);
        IJth(rJacobian, 8, 0) = -4.2821610031797325e-8 + 2.8027450860303217e-9 * var_x98 - 2.1020588145227411e-9 * var_x101 - 1.6784732779346808e-8 * var_x28 - 4.0992760021272483e-11 * var_x32 - 0.00010695499267886472 * var_x40 + var_x221 * var_x66 - var_x219 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x220 * var_x45 - var_x222 * var_x73 - var_x223 * var_x81;
        IJth(rJacobian, 9, 0) = 7.1303328452576475e-5 * var_x40 + 5.5410707832102833e-6 * var_x60 + 2.668013086093291e-7 * var_x57 + 8.0137748385755867e-10 * var_x99 - 5.5576983232758224e-7 * var_x2 - 9.2938099051435146e-8 * var_x54 - 8.5643220063594646e-6 * var_x21 - 6.0103311289316898e-10 * var_x103 - 2.3233001187464504e-5 * var_x16 + var_x221 * var_x69 - var_x220 * var_x52 - var_x222 * var_x70 - var_x230 * var_x62 - var_x231 * var_x81;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (5.0564577285853114e-10 * var_x116 + 1.1499999999999999 * var_x108 + 5.6590407739607631e-6 * var_x117 + 1.7684502418627384e-9 * var_x118 + 505.51425214497993 * var_x109 - 1.1499999999999999 * var_x106 - 0.040134880066084982 * var_x107 - 7.8597788527232835 * var_x112 - var_x111 * var_x66 - var_x111 * var_x69);
        IJth(rJacobian, 1, 1) = 8.5932353608719255e-11 * var_x117 + 1.7462713310839333e-5 * var_x108 + 0.00040588235294117644 * var_x152 - 0.0076762177910879408 * var_x109 - 0.00011935049112322121 * var_x112 - 6.0944687335561951e-7 * var_x107 - 1.7462713310839333e-5 * var_x106 - 0.00040588235294117644 * var_x151;
        IJth(rJacobian, 8, 1) = 0.046057306746527645 * var_x109 + 5.3707721005449532e-14 * var_x118 - var_x224 * var_x66;
        IJth(rJacobian, 9, 1) = 1.5356429857854459e-14 * var_x116 - var_x224 * var_x69;
        ...
        IJth(rJacobian, 8, 2) = -0.0014577569372526747 * var_x121;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x119 * var_x31);
        IJth(rJacobian, 3, 3) = -((var_x161) ? (0.13500000000000001 * var_x160) : (0.0)) - ((var_x161) ? (310000.0 * var_x163 + 3.5600000000000001 * var_x162) : (7.6923076923076916 / var_x165));
        IJth(rJacobian, 8, 3) = -var_x119 * var_x219;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-16.0 * var_x122);
        IJth(rJacobian, 4, 4) = -((var_x161) ? (0.1212 * var_x177) : (0.29999999999999999 * var_x181)) - ((var_x161) ? (var_x172 * var_x173) : (0.0));
        IJth(rJacobian, 8, 4) = -0.00048591897908422494 * var_x122;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x123 * var_x93 - var_x124 * var_x84 - var_x124 * var_x86);
        IJth(rJacobian, 1, 5) = -var_x123 * var_x149;
        IJth(rJacobian, 5, 5) = -var_x196 - var_x190 * var_x196;
        IJth(rJacobian, 8, 5) = -var_x124 * var_x223;
        IJth(rJacobian, 9, 5) = -var_x124 * var_x231;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x125 * var_x93 - var_x126 * var_x84 - var_x126 * var_x86);
        IJth(rJacobian, 1, 6) = -var_x125 * var_x149;
        IJth(rJacobian, 6, 6) = var_x205 * var_x208 + var_x205 * var_x210;
        IJth(rJacobian, 8, 6) = -var_x126 * var_x223;
        IJth(rJacobian, 9, 6) = -var_x126 * var_x231;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-0.56399999999999995 * var_x127);
        IJth(rJacobian, 7, 7) = -var_x214 * var_x218 - var_x217 * var_x218;
        IJth(rJacobian, 9, 7) = -1.7128644012718929e-5 * var_x127;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142 - 0.00099481667696169518 * var_x128 - 1.0959314924725194 * var_x129 - 0.03752664515462853 * var_x33 - 0.0018421356686070195 * var_x100 - 425.83427125819611 * var_x134 - 0.055683584885573637 * var_x135 - var_x132 * var_x133 - var_x137 * var_x70);
        IJth(rJacobian, 1, 8) = 1.5106259501412128e-8 * var_x128;
        IJth(rJacobian, 8, 8) = var_x228 - 5.594554271400994e-8 * var_x100 - 5.073320759877697e-6 * var_x135 - 1.139681818874567e-6 * var_x33 - 9.0637557008472766e-8 * var_x128 - 0.012932559646803597 * var_x134 - var_x132 * var_x225;
        IJth(rJacobian, 9, 8) = var_x232 + 3.3822138399184648e-6 * var_x135 - 3.3283369498031096e-5 * var_x129 - var_x229 * var_x70;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142 + 4.8559079610460012 * var_x148 - 0.00052671434672763679 * var_x100 - 59.78895212616036 * var_x129 - 20.360201094532499 * var_x144 - 0.48704794775156179 * var_x143 - var_x133 * var_x145 - var_x137 * var_x73 - var_x147 * var_x64);
        IJth(rJacobian, 8, 9) = var_x228 - var_x229 * var_x73;
        IJth(rJacobian, 9, 9) = var_x232 + 0.00014747361493490206 * var_x148 - 1.5996281101931733e-8 * var_x100 - 0.001815786661103715 * var_x129 - 0.00061833800811279696 * var_x144 - 1.4791615096031613e-5 * var_x143 - var_x145 * var_x225 - var_x147 * var_x230;
