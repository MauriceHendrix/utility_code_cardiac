...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x213 = -var_chaste_interface__ICaL__d + 1.0 * var_x209 * var_x212;
        ...
        const double var_x274 = 1.0 + 1.0 * var_x273;
        ...
        IJth(rJacobian, 5, 0) = (0.02 + var_x219) * (0.029999999999999999 * var_x220 / pow(var_x221, 2) - 0.125 * var_x222 / pow(var_x223, 2)) + var_x219 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (-var_chaste_interface__ICaL__f + 1.0 / var_x223 + 0.59999999999999998 / var_x221);
        IJth(rJacobian, 6, 0) = (-var_chaste_interface__IKr__xr + 1.0 / var_x225) * (var_x228 + var_x231 - 0.00016973999999999998 * var_x229 * var_x232 / pow(var_x230, 2) - 8.8449999999999995e-5 * var_x226 * var_x233 / pow(var_x227, 2)) + 0.23529411764705882 * var_x224 * (var_x234 + var_x235) / pow(var_x225, 2);
        IJth(rJacobian, 7, 0) = 0.059880239520958084 * var_x251 + var_x248 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x238);
        IJth(rJacobian, 8, 0) = 0.014970059880239521 * var_x251 + var_x248 * (0.25 * var_x238 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 9, 0) = 0.092592592592592587 * var_x252 * var_x257 / pow(var_x253, 2) + 0.036429872495446269 * var_x254 * (-var_chaste_interface__ICaT__b + 1.0 / var_x253) / (pow(var_x255, 2) * pow((0.60655737704918045 + var_x256), 2));
        IJth(rJacobian, 10, 0) = 0.0069444444444444441 * (-var_chaste_interface__ICaT__g + 1.0 / var_x264) * (0.875 - 0.875 * var_x260 - 5000.0 * var_x265 + 416.66666666666669 * var_x261 * var_x265) / pow((var_x260 + 0.083333333333333329 * var_x262), 2) - 0.17857142857142858 * var_x263 * var_x266 / pow(var_x264, 2);
