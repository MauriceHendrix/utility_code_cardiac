...
#include "MathsCustomFunctions.hpp"
    ...
    void Celllivshitz_rudy_2007FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x13 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448256207 * var_x6);
        const double var_x14 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150645177 * var_x6);
        ...
        const double var_x75 = 0.24326999999999999 * var_x67 - 0.51429999999999998 * var_x74 - var_x12 * (0.061749999999999999 * var_x14 + 0.039456396800000001 * var_x13);
        ...
        const double var_x135 = 6.4983106368865622 * var_x134 - var_x12 * (1.053972635420138 * var_x13 * var_x5 + 1.6494869150645177 * var_x14 * var_x5) - 13.738155796237757 * var_x5 * var_x74;
        ...
        const double var_x194 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x198 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x199 = -127140.0 * var_x197 - 3.4740000000000003e-5 * var_x198;
        const double var_x200 = var_x165 * var_x196 * var_x199;
        const double var_x201 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x202 = var_x165 * var_x193 * var_x201;
        const double var_x203 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__cell__V);
        ...
        const double var_x208 = exp(-2500.0 + var_x161);
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = 1 / var_x209;
        const double var_x211 = -var_chaste_interface__ICaL__d + var_x207 * var_x210;
        const double var_x212 = var_x205 * var_x211;
        const double var_x213 = 0.035000000000000003 * var_x206;
        const double var_x214 = 10.0 + var_chaste_interface__cell__V;
        const double var_x215 = var_x205 * var_x213 * var_x214;
        const double var_x216 = 0.005608974358974359 * var_x203 * var_x214;
        const double var_x217 = 0.019699999999999999 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__cell__V), 2));
        const double var_x218 = exp(2.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x219 = 1.0 + var_x218;
        const double var_x220 = exp(4.0 + 0.125 * var_chaste_interface__cell__V);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__cell__V);
        const double var_x223 = 1.0 + var_x222;
        const double var_x224 = exp(5.6404999999999994 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x225 = -1.0 + var_x224;
        const double var_x226 = 0.00060999999999999997 / var_x225;
        const double var_x227 = exp(-1.7465999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x228 = 1.0 - var_x227;
        const double var_x229 = 0.0013799999999999999 / var_x228;
        const double var_x230 = 14.199999999999999 + var_chaste_interface__cell__V;
        const double var_x231 = 38.899999999999999 + var_chaste_interface__cell__V;
        const double var_x232 = var_x226 * var_x231;
        const double var_x233 = var_x229 * var_x230;
        const double var_x234 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x235 = 1.0 + var_x234;
        const double var_x236 = 1 / var_x235;
        const double var_x237 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x238 = -1.0 + var_x237;
        const double var_x239 = 1 / var_x238;
        const double var_x240 = 0.00013100000000000001 * var_x239;
        const double var_x241 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x242 = 1.0 - var_x241;
        const double var_x243 = 1 / var_x242;
        const double var_x244 = 7.1899999999999999e-5 * var_x243;
        const double var_x245 = 30.0 + var_chaste_interface__cell__V;
        const double var_x246 = var_x240 + var_x244 - 8.9997000000000013e-6 * var_x237 * var_x245 / pow(var_x238, 2) - 1.0641199999999999e-5 * var_x241 * var_x245 / pow(var_x242, 2);
        const double var_x247 = var_x240 * var_x245;
        const double var_x248 = var_x244 * var_x245;
        const double var_x249 = var_x234 * (var_x247 + var_x248) / pow(var_x235, 2);
        const double var_x250 = exp(-1.2962962962962963 - 0.092592592592592587 * var_chaste_interface__cell__V);
        const double var_x251 = 1.0 + var_x250;
        const double var_x252 = exp(5.5555555555555554 + 0.22222222222222221 * var_chaste_interface__cell__V);
        const double var_x253 = 1.0 + var_x252;
        const double var_x254 = 1 / var_x253;
        const double var_x255 = 1 / (3.7000000000000002 + 6.0999999999999996 * var_x254);
        const double var_x256 = exp(-416.66666666666669 * var_chaste_interface__cell__V);
        const double var_x257 = 1.0 + var_x256;
        const double var_x258 = 1 / var_x257;
        const double var_x259 = 12.0 - 0.875 * var_chaste_interface__cell__V;
        const double var_x260 = var_x259 * (1.0 - 1.0 * var_x258);
        const double var_x261 = exp(10.714285714285715 + 0.17857142857142858 * var_chaste_interface__cell__V);
        const double var_x262 = 1.0 + var_x261;
        const double var_x263 = var_x256 / pow(var_x257, 2);
        const double var_x264 = 1 / (var_x260 + 12.0 * var_x258);
        const double var_x265 = 0.092592592592592587 * var_chaste_interface__Ca__Ca_JSR_T;
        const double var_x266 = sqrt(pow((1 - var_x265), 2) + 0.027434842249657067 * var_chaste_interface__Ca__Ca_JSR_T);
        const double var_x267 = -5.4000000000000004 + 0.5 * var_chaste_interface__Ca__Ca_JSR_T + 5.4000000000000004 * var_x266;
        const double var_x268 = 1 / var_x267;
        const double var_x269 = 0.0025894736842105265 * var_x268;
        const double var_x270 = 0.21052631578947367 + var_x269;
        const double var_x271 = pow(var_x268, 9.0);
        const double var_x272 = 1.0 + 1.0 * var_x271;
        const double var_x273 = 1 / var_x272;
        const double var_x274 = var_x273 * var_x81;
        const double var_x275 = 4.6323915649710559 * var_x87;
        const double var_x276 = var_x274 * var_x275;
        const double var_x277 = var_x274 * var_chaste_interface__cell__V;
        const double var_x278 = 0.34683534197756777 * var_x277;
        const double var_x279 = var_x270 * var_x273 * var_x275;
        const double var_x280 = (-0.078875171467764058 + 0.0085733882030178329 * var_chaste_interface__Ca__Ca_JSR_T) / var_x266;
        const double var_x281 = (-0.5 - 5.4000000000000004 * var_x280) / pow((-1 + var_x265 + var_x266), 2);
        const double var_x282 = 4.6140557161776547e-8 * var_x70;
        const double var_x283 = 1.4999377389423053e-7 * var_x93;
        const double var_x284 = -2.663848166806566e-5 - 1.5983089000839395e-5 * var_x35;
        const double var_x285 = var_x284 * var_chaste_interface__IKs__xs2;
        const double var_x286 = var_x285 * var_chaste_interface__IKs__xs1;
        const double var_x287 = 5.6160497718581238e-5 * var_x60;
        const double var_x288 = 4.129448361660385e-5 * var_x76;
        const double var_x289 = 4.288710868383184e-8 * var_x95;
        const double var_x290 = var_x127 * var_x286;
        const double var_x291 = 1.5380185720592184e-6 * var_x3;
        const double var_x292 = 1.5380185720592182e-8 * var_x70;
        const double var_x293 = 0.00023999003823076885 * var_x87;
        const double var_x294 = 1.796847822848032e-5 * var_x100;
        const double var_x295 = var_x142 / (-0.040040000000000006 + var_x30);
        const double var_x296 = var_x149 / pow((-0.060060000000000002 + var_x144), 2);
        ...
        IJth(rJacobian, 3, 0) = var_x193 * var_x200 + (7.6049999999999996e-8 * var_x187 + 0.001275024 * var_x192 + 5.0499999999999998 * var_x169 * var_x191 - 12.5 * var_x169 * var_x186 - 0.016701360000000002 * var_x165 * var_x188 * var_x190 / pow(var_x189, 2) - 0.029999999999999999 * var_x164 * var_x183 * var_x185 / pow(var_x184, 2)) * var_chaste_interface__INa__J + var_x196 * var_x202 * (1.5254334000000001e-6 * var_x198 - 31073.016 * var_x197) - 0.311 * var_x194 * var_x199 * var_x202 / pow(var_x195, 2) - var_x170 * var_x193 * var_x196 * var_x199 * var_x201;
        IJth(rJacobian, 4, 0) = var_x212 * var_x213 + var_x215 * (0.16025641025641024 * var_x203 * var_x210 / pow(var_x206, 2) + 41.666666666666664 * var_x207 * var_x208 / pow(var_x209, 2)) - var_x212 * var_x216 - var_x206 * var_x211 * var_x216 / pow(var_x204, 2);
        IJth(rJacobian, 5, 0) = (0.02 + var_x217) * (0.029999999999999999 * var_x218 / pow(var_x219, 2) - 0.125 * var_x220 / pow(var_x221, 2)) + var_x217 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__cell__V) * (1 / var_x221 - var_chaste_interface__ICaL__f + 0.59999999999999998 / var_x219);
        IJth(rJacobian, 6, 0) = (1 / var_x223 - var_chaste_interface__IKr__xr) * (var_x226 + var_x229 - 0.00016973999999999998 * var_x227 * var_x230 / pow(var_x228, 2) - 8.8449999999999995e-5 * var_x224 * var_x231 / pow(var_x225, 2)) + 0.23529411764705882 * var_x222 * (var_x232 + var_x233) / pow(var_x223, 2);
        IJth(rJacobian, 7, 0) = 0.059880239520958084 * var_x249 + var_x246 * (var_x236 - var_chaste_interface__IKs__xs1);
        IJth(rJacobian, 8, 0) = 0.014970059880239521 * var_x249 + var_x246 * (0.25 * var_x236 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 9, 0) = 0.092592592592592587 * var_x250 * var_x255 / pow(var_x251, 2) + 0.036429872495446269 * var_x252 * (1 / var_x251 - var_chaste_interface__ICaT__b) / (pow(var_x253, 2) * pow((0.60655737704918045 + var_x254), 2));
        IJth(rJacobian, 10, 0) = 0.0069444444444444441 * (1 / var_x262 - var_chaste_interface__ICaT__g) * (0.875 - 0.875 * var_x258 - 5000.0 * var_x263 + 416.66666666666669 * var_x259 * var_x263) / pow((var_x258 + 0.083333333333333329 * var_x260), 2) - 0.17857142857142858 * var_x261 * var_x264 / pow(var_x262, 2);
        IJth(rJacobian, 11, 0) = var_x270 * (-var_x276 + var_x102 * var_x278 - var_x106 * var_x278);
        IJth(rJacobian, 12, 0) = -2.4608297152947492e-7 + 5.615149446400099e-9 * var_x103 + 1.4682156444593685e-9 * var_x50 - 0.00031144876084199171 * var_x57 - 4.2113620848000749e-9 * var_x105 - 3.1091625412080743e-9 * var_x73 - 6.1520742882368733e-5 * var_x66 - var_x282 * var_x72 - var_x283 * var_x91;
        IJth(rJacobian, 13, 0) = var_x286 + 1.6055168046743987e-9 * var_x99 + 2.5071650767223771e-6 * var_x78 + 1.0246623209999443e-5 * var_x69 + 0.00020763250722799446 * var_x57 - 4.296278075471465e-5 * var_x18 - 3.3959450071067536e-7 * var_x2 - 1.2041376035057991e-9 * var_x107 - 5.6788378045263436e-8 * var_x63 - var_x287 * var_chaste_interface__IKr__xr - var_x288 * var_x75 - var_x289 * var_x91;
        IJth(rJacobian, 14, 0) = -9.277328026661204e-8 + 1.0363875137360248e-9 * var_x73 - 4.8940521481978945e-10 * var_x50 + var_x102 * var_x294 + var_x292 * var_x72 - var_x106 * var_x294 - var_x291 * var_chaste_interface__ICaT__g - var_x293 * var_x81;
        ...
        IJth(rJacobian, 3, 3) = -0.1212 * var_x192 - 0.29999999999999999 * var_x187 - var_x200 * var_x201;
        ...
        IJth(rJacobian, 4, 4) = -var_x215;
        IJth(rJacobian, 11, 4) = -var_x114 * var_x279;
        IJth(rJacobian, 12, 4) = -var_x115 * var_x283;
        IJth(rJacobian, 13, 4) = -var_x115 * var_x289;
        IJth(rJacobian, 14, 4) = -var_x114 * var_x293;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x117 * var_x88 - var_x118 * var_x94 - var_x118 * var_x96);
        IJth(rJacobian, 5, 5) = -0.02 - var_x217;
        IJth(rJacobian, 11, 5) = -var_x117 * var_x279;
        IJth(rJacobian, 12, 5) = -var_x118 * var_x283;
        IJth(rJacobian, 13, 5) = -var_x118 * var_x289;
        IJth(rJacobian, 14, 5) = -var_x117 * var_x293;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_x62);
        IJth(rJacobian, 6, 6) = -var_x232 - var_x233;
        IJth(rJacobian, 13, 6) = -var_x287 * var_x62;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x120 * var_x37);
        IJth(rJacobian, 7, 7) = -var_x247 - var_x248;
        IJth(rJacobian, 13, 7) = var_x120 * var_x285;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x121 * var_x36);
        IJth(rJacobian, 8, 8) = -3.2750000000000003e-5 * var_x239 * var_x245 - 1.7975e-5 * var_x243 * var_x245;
        IJth(rJacobian, 13, 8) = var_x121 * var_x284;
        ...
        IJth(rJacobian, 14, 10) = -var_x122 * var_x291;
        IJth(rJacobian, 11, 11) = -0.21052631578947367 - var_x269;
        ...
        IJth(rJacobian, 13, 12) = 3.459874159855314 * var_x290 + 4.1526501445598893e-6 * var_x124;
        ...
        IJth(rJacobian, 13, 13) = 188.75472776079184 * var_x290 + 0.000273711269773125 * var_x137 - 0.0015001782369281045 * var_x136 - 9.0713633255081308e-6 * var_x132 - 3.2165331512873877e-8 * var_x104 - 0.0011476363512500001 * var_x133 - var_x135 * var_x288;
        ...
        IJth(rJacobian, 11, 14) = var_x270 * (-3.7522371676265542e-6 * var_x160 * var_x273 - 4.6323915649710559 * var_x157 * var_x277);
        IJth(rJacobian, 12, 14) = -1.214949568543267e-13 * var_x156 - 4.6140557161776547e-8 * var_x148 + var_x151 * var_x282;
        IJth(rJacobian, 13, 14) = 3.2633849539327485e-11 * var_x153 - 3.4738558033903784e-14 * var_x159;
        IJth(rJacobian, 14, 14) = 8.319524789019007e-5 * var_x152 + 1.5380185720592182e-8 * var_x148 + 5.0183373527362646e-6 * var_x147 - 0.0015981617647058825 * var_x296 - 0.00023999003823076885 * var_x158 - 3.5374427157362017e-5 * var_x143 - 1.9439193096692272e-10 * var_x160 - 7.9592461104064537e-5 * var_x150 - 0.00071029411764705886 * var_x295 - var_x151 * var_x292;
        IJth(rJacobian, 16, 14) = 0.0087500000000000008 * var_x295 + 0.0196875 * var_x296;
        IJth(rJacobian, 11, 15) = 8.8802252544942608e-5 * var_x281 * (-var_chaste_interface__Irel__Rel - var_x276 * var_chaste_interface__cell__V) + 1.4297504830157579 * var_x100 * var_x267 * var_x270 * var_x271 * var_x281 * var_x87 / pow(var_x272, 2);
        IJth(rJacobian, 15, 15) = -0.0041666666666666666 - 0.044999999999999998 * var_x280;
        IJth(rJacobian, 16, 15) = 0.0003623188405797101 + 0.003913043478260869 * var_x280;
