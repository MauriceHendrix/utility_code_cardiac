...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x195 = ((var_x0) ? (-140.0) : (var_x153 * var_x24));
        const double var_x196 = (-3 - 3 * var_x191) / (pow(var_x79, 4) * pow(var_x80, 2));
        const double var_x197 = 1.1519999999999998e-11 * var_x196;
        const double var_x198 = ((var_x0) ? (var_chaste_interface__internal_ion_concentrations__Ki) : (var_x15 * var_x153));
        ...
        const double var_x201 = -26.712831923985377 * var_x43 + var_chaste_interface__membrane__Vm;
        const double var_x202 = var_x201 * var_chaste_interface__ATP_production__ATPi / pow((0.010000000000000002 + var_x11), 2);
        ...
        const double var_x206 = var_x144 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x207 = var_x206 * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / (pow((0.36443148688046656 + var_x145), 2) * pow(var_chaste_interface__ATP_production__ATPi, 4));
        const double var_x208 = var_x195 * var_x207;
        const double var_x209 = ((var_x0) ? (-1.8) : (var_x1 * var_x8));
        const double var_x210 = var_x207 * var_x209;
        const double var_x211 = var_x198 * var_x207;
        const double var_x212 = 2.166666666666667 * var_x198;
        const double var_x213 = 21.666666666666668 * var_x195;
        const double var_x214 = 66.0 * var_x209;
        const double var_x215 = 0.02409 * var_x198;
        const double var_x216 = 0.0012209999999999999 * var_x195;
        const double var_x217 = var_x147 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x218 = -var_x214 * var_x217 - var_x215 * var_x217 - var_x216 * var_x217;
        const double var_x219 = var_x146 * var_x206;
        const double var_x220 = 4.6363636363636367 * var_x209;
        const double var_x221 = var_x123 * var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1;
        const double var_x222 = var_x198 * var_x221;
        const double var_x223 = var_x195 * var_x221;
        const double var_x224 = var_x122 * var_x198;
        const double var_x225 = var_x122 * var_x195;
        const double var_x226 = pow(var_chaste_interface__transient_outward_current_y1_gate__y1, 2) * var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x227 = var_x198 * var_x226;
        const double var_x228 = var_x195 * var_x226;
        const double var_x229 = var_x117 * var_x198;
        const double var_x230 = var_x117 * var_x195;
        ...
        const double var_x238 = 1.9700124473113906e-15 * var_x196;
        const double var_x239 = 0.0037051738737048732 * var_x195;
        const double var_x240 = 2.0880079845201463e-7 * var_x195;
        const double var_x241 = -var_x217 * var_x240;
        ...
        const double var_x250 = 0.00037051738737048736 * var_x198;
        const double var_x251 = 4.1195833208100184e-6 * var_x198;
        const double var_x252 = -var_x217 * var_x251;
        const double var_x253 = 0.00039642769417961232 * var_x133;
        const double var_x254 = var_x143 * var_x148;
        ...
        const double var_x269 = 0.0056432648230274225 * var_x209;
        const double var_x270 = -var_x217 * var_x269;
        const double var_x271 = 0.00039642769417961232 * var_x209;
        ...
        const double var_x279 = -0.069398700000000008 + 1.3650000000000002 * var_x5 + 1.3650000000000002 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        ...
        const double var_x283 = 0.0031249999999999997 * var_x282;
        ...
        const double var_x287 = (-1.5294117647058822 * var_x286 - 2.5000000000000001e-5 * var_x284) / pow((var_x286 + 0.00076923076923076923 * var_x284), 2);
        const double var_x288 = 0.0014792899408284023 * var_x287;
        ...
        const double var_x291 = 0.0128375 * var_x289;
        const double var_x292 = 0.0050000000000000001 * var_x290;
        const double var_x293 = 16.0 * (var_x291 + var_x292) / pow((var_x290 + 0.4108 * var_x289), 2);
        ...
        const double var_x302 = var_x281 * var_x294 * var_x297 * var_x301;
        const double var_x303 = var_x299 * var_x302;
        const double var_x304 = 1.0 + 7.0000000000000007e-5 * var_x303;
        const double var_x305 = 65.0 * var_x300;
        const double var_x306 = 5.0000000000000002e-5 * var_x284;
        const double var_x307 = var_x281 * var_x297 * var_x299;
        const double var_x308 = 7.0000000000000007e-5 * var_x294;
        const double var_x309 = (1.28375e-5 * var_x289 + 0.012500000000000001 * var_x281) / pow((var_x281 + 2.054e-5 * var_x289), 2);
        const double var_x310 = 0.01 * (1.7500000000000002e-7 * var_x303 - 2.8000000000000003e-6 * var_x302 * var_x309 - var_x307 * var_x308 * (var_x305 + var_x306) - 1.0355029585798818e-7 * var_x287 * var_x301 * var_x307 - var_x281 * var_x299 * var_x301 * var_x308 * (-var_x291 - var_x292)) / pow(var_x304, 2);
        const double var_x311 = 1.0 - var_chaste_interface__sodium_current_voltage_dependent_gate__p_AI_Na - var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na;
        const double var_x312 = -0.01 + 0.01 / var_x304;
        ...
        const double var_x323 = 0.04576271186440678 * var_x320;
        const double var_x324 = 0.023076923076923078 * var_x322;
        const double var_x325 = 0.44444444444444442 * (var_x323 + var_x324) / pow((var_x322 + 0.18000000000000002 * var_x320), 2);
        const double var_x326 = exp(var_x321);
        const double var_x327 = exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
        const double var_x328 = (-68.571428571428569 * var_x327 - 0.033846153846153852 * var_x326) / pow((var_x327 + 0.0045833333333333334 * var_x326), 2);
        const double var_x329 = 4.3402777777777778e-6 * var_x328 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        ...
        const double var_x337 = var_x330 * var_x332 * var_x336;
        const double var_x338 = exp(-var_x334);
        const double var_x339 = 1 / (2.0 * var_x319 + 0.0018 * var_x338);
        const double var_x340 = 0.25 * var_x339;
        const double var_x341 = 1.0 + var_x337 * var_x340;
        const double var_x342 = 297297.29729729728 * var_x335;
        const double var_x343 = 0.11 * var_x315;
        const double var_x344 = var_x330 * var_x340;
        const double var_x345 = (0.00024324324324324323 * var_x338 + 0.02 * var_x319) / pow((var_x319 + 0.00089999999999999998 * var_x338), 2);
        const double var_x346 = 0.040000000000000001 * (-0.0625 * var_x337 * var_x345 - var_x332 * var_x344 * (var_x342 + var_x343) - var_x336 * var_x344 * (-var_x323 - var_x324) - 1.0850694444444444e-6 * var_x328 * var_x332 * var_x336 * var_x339) / pow(var_x341, 2);
        const double var_x347 = 1.0 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x348 = var_x347 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AI_CaL - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL;
        const double var_x349 = -0.040000000000000001 + 0.040000000000000001 / var_x341;
        const double var_x350 = -1.0 * var_x339;
        const double var_x351 = 0.14102711999999998 * var_x143;
        const double var_x352 = var_x351 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x353 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x354 = var_x193 * (6.9539999999999997 - var_x353);
        const double var_x355 = (3.4769999999999999 + 3.4769999999999999 * var_x191 - 0.14102711999999998 * var_x194) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x356 = 0.14102711999999998 * var_x209;
        const double var_x357 = var_x356 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        ...
        const double var_x374 = 1.5624999999999999e-8 * (1.0 - var_chaste_interface__time_independent_potassium_current_y_gate__y) / pow((var_x373 + 0.00087500000000000002 * var_x372), 2);
        ...
        const double var_x379 = var_x378 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x380 = 24.999999999999996 * var_x61 * var_chaste_interface__time_independent_potassium_current_y_gate__y / pow((var_x377 + 0.00069999999999999988 * var_x375), 2);
        const double var_x381 = var_x187 * var_x378;
        ...
        const double var_x386 = pow((var_x385 + 0.80000000000000004 * var_x384), (-2));
        ...
        const double var_x401 = 1.0 - var_chaste_interface__transient_outward_current_y2_gate__y2;
        ...
        const double var_x408 = pow(var_x407, (-2));
        ...
        const double var_x412 = pow((0.020000293738509214 + var_x411), (-2));
        const double var_x413 = 10.139999999999999 * var_x254 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x414 = 70000.0 * var_x79 * (2 + 2 * var_x191);
        const double var_x415 = 10.139999999999999 * var_x266;
        const double var_x416 = 11.08600583090379 * var_x210 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x417 = 10.139999999999999 * var_x209;
        const double var_x418 = var_x417 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x419 = var_x148 * var_x418;
        const double var_x420 = var_x217 * var_x418;
        const double var_x421 = -var_x420;
        const double var_x422 = var_x219 * var_x418;
        ...
        const double var_x431 = 780.0 * var_x191;
        ...
        const double var_x435 = 0.074445868608802798 - 0.077759999999999996 * var_chaste_interface__NL_model__X;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x41 - 0.00030303030303030303 * var_x10 - 0.0018350576517438713 * var_x132 - 0.50016960905426577 * var_x12 - 0.0011666666666666668 * var_x23 - 0.081578771064078098 * var_x141 - 0.0029166666666666668 * var_x25 - 0.007575757575757576 * var_x39 + var_x114 * var_x116 + (-0.14324999999999999 * var_x69 - 1.1459999999999999 * var_x61 - 2.2919999999999998 * var_x76) * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x10 * var_x134 - var_x119 * var_x23 - var_x121 * var_x23 - var_x125 * var_x23 - var_x126 * var_x25 - var_x127 * var_x25 - var_x142 * var_x25 - var_x143 * var_x149 - var_x151 * var_x23 - var_x152 * var_x25 - var_x23 * var_x82 - var_x25 * var_x82 - var_x78 * (4.3581631433074284 - 4.3581631433074284 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y));
        IJth(rJacobian, 1, 0) = -4.9877340607565601e-7 * var_x25 - 4.1851873550156299e-5 * var_x141 - 9.414287540284996e-7 * var_x132 - var_x233 * var_x25 - var_x234 * var_x25 - var_x235 * var_x25 - var_x236 * var_x25 - var_x237 * var_x25 - var_x78 * (0.0022358426145128573 - 0.0022358426145128573 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y);
        IJth(rJacobian, 2, 0) = var_x243 + 6.276191693523331e-7 * var_x132 - 8.5533016979494439e-5 * var_x12 - 1.2955153404562495e-6 * var_x39 - 1.9950936243026244e-7 * var_x23 + var_x114 * var_x245 + (-2.4496899572687219e-5 * var_x69 - 0.00019597519658149775 * var_x61 - 0.0003919503931629955 * var_x76) * var_chaste_interface__time_independent_potassium_current_y_gate__y - var_x23 * var_x233 - var_x23 * var_x246 - var_x23 * var_x247 - var_x23 * var_x248 - var_x23 * var_x249;
        IJth(rJacobian, 3, 0) = 1.3950624516718767e-5 * var_x141 - 0.0056432648230274225 * var_x254 - 2.591030680912499e-8 * var_x10 - var_x10 * var_x253 - var_x78 * (-0.0007452808715042858 + 0.0007452808715042858 * var_chaste_interface__sodium_calcium_exchanger_y_gate__y);
        IJth(rJacobian, 4, 0) = -3.1380958467616655e-7 * var_x132;
        IJth(rJacobian, 5, 0) = var_x293 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na + (-var_x283 - var_x288) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        IJth(rJacobian, 6, 0) = var_x288 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + (-var_x293 - var_x310) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na - var_x310 * var_x311;
        IJth(rJacobian, 7, 0) = var_x283 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + 0.040000000000000001 * var_x309 * var_x311 - 5.917159763313609e-7 * (-var_x305 - var_x306) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AI_Na / pow((var_x300 + 3.0769230769230768e-5 * var_x284), 2);
        IJth(rJacobian, 8, 0) = 1.2345679012345679e-20 * (1.0 - var_chaste_interface__sodium_current_ultra_slow_gate__y) * (-80.0 * var_x315 - 1800000000.0 * var_x317) / pow((var_x317 + 8.8888888888888887e-7 * var_x315), 2) - 6.2499999999999997e-8 * (40.0 * var_x319 + 0.0028 * var_x318) * var_chaste_interface__sodium_current_ultra_slow_gate__y / pow((var_x319 + 3.4999999999999999e-6 * var_x318), 2);
        IJth(rJacobian, 9, 0) = -var_x329 + var_x325 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL;
        IJth(rJacobian, 10, 0) = var_x329 + (-var_x325 - var_x346) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL - var_x346 * var_x348;
        IJth(rJacobian, 11, 0) = 0.25 * var_x345 * var_x348 - 2.0661157024793388e-13 * (-var_x342 - var_x343) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AI_CaL / pow((var_x335 + 5.0000000000000004e-6 * var_x315), 2);
        IJth(rJacobian, 12, 0) = var_x352;
        IJth(rJacobian, 13, 0) = -var_x352;
        IJth(rJacobian, 14, 0) = var_x351 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        IJth(rJacobian, 15, 0) = 1.6e-11 * (1.0 - var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y) * (-27777.777777777777 * var_x361 - 0.89230769230769236 * var_x326) / pow((var_x361 + 0.000232 * var_x326), 2) - 3.0864197530864198e-7 * (1.0153846153846153 * var_x322 + 128.57142857142858 * var_x362) * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / pow((var_x362 + 0.036666666666666667 * var_x322), 2);
        IJth(rJacobian, 16, 0) = 1.4872099940511603 * (1.0 - var_chaste_interface__T_type_Ca_channel_y1_gate__y1) * (0.0033928571428571428 * var_x363 + 0.0032799999999999999 * var_x364) / pow((var_x364 + 0.023170731707317073 * var_x363), 2) - 0.00062500000000000001 * (-6.3492063492063497 * var_x366 - 0.00014999999999999999 * var_x365) * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 / pow((var_x366 + 0.037499999999999999 * var_x365), 2);
        IJth(rJacobian, 17, 0) = 2.6014568158168572e-10 * (1.0 - var_chaste_interface__T_type_Ca_channel_y2_gate__y2) * (-0.01 * var_x367 - 6138.6138613861385 * var_x368) / pow((var_x368 + 0.00048387096774193548 * var_x367), 2) - 0.69444444444444453 * (8.9552238805970142e-5 * var_x369 + 0.048000000000000001 * var_x370) * var_chaste_interface__T_type_Ca_channel_y2_gate__y2 / pow((var_x370 + 0.00050000000000000001 * var_x369), 2);
        IJth(rJacobian, 18, 0) = var_x374 * (-0.023333333333333334 * var_x372 - 941.17647058823525 * var_x373) + var_x379 * var_x83 + var_x379 * var_x98 - var_x379 * var_x92 - var_x379 * var_x96 - var_x380 * (0.00040000000000000002 * var_x377 + 1.5384615384615384e-5 * var_x375);
        IJth(rJacobian, 19, 0) = (2.0000000000000002e-5 * var_x382 - 2.5000000000000001e-5 * var_x386 * (-5.7142857142857144 * var_x384 - 0.20000000000000001 * var_x385)) * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1 + 0.0025000000000000001 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * (1.7391304347826086 * var_x388 + 0.016666666666666666 * var_x387) / pow((var_x388 + 0.25 * var_x387), 2);
        IJth(rJacobian, 20, 0) = (5.0000000000000004e-6 * var_x382 - 2.4999999999999999e-7 * var_x386 * (-2.0 * var_x385 - 57.142857142857146 * var_x384)) * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 2.5000000000000001e-5 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2) * (0.066666666666666666 * var_x387 + 15.384615384615385 * var_x389) / pow((var_x389 + 0.10000000000000001 * var_x387), 2);
        IJth(rJacobian, 21, 0) = 0.01 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3) * (-0.0083333333333333332 * var_x390 - 0.58823529411764708 * var_x286) / pow((var_x286 + 0.25 * var_x390), 2) - 0.25 * (0.020588235294117647 * var_x391 + 0.013333333333333334 * var_x392) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 / pow((var_x392 + 0.17499999999999999 * var_x391), 2);
        IJth(rJacobian, 22, 0) = 7.3046018991964936e-6 * (1.0 - var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1) * (8.0952380952380949 * var_x393 + 5.967741935483871 * var_x394) / pow((var_x394 + 0.22972972972972974 * var_x393), 2) - 4.7562425683709868e-7 * (-72.5 * var_x300 - 2.6000000000000001 * var_x315) * var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1 / pow((var_x300 + 0.1793103448275862 * var_x315), 2);
        IJth(rJacobian, 24, 0) = 0.0082644628099173556 * (1.0 - var_chaste_interface__transient_outward_current_y1_gate__y1) * (0.00050000000000000001 * var_x281 + 0.39285714285714285 * var_x395) / pow((var_x395 + 0.018181818181818184 * var_x281), 2) - 0.051652892561983466 * (-0.27500000000000002 * var_x397 - 0.00040000000000000002 * var_x396) * var_chaste_interface__transient_outward_current_y1_gate__y1 / pow((var_x397 + 0.045454545454545456 * var_x396), 2);
        IJth(rJacobian, 25, 0) = -0.00033628318584070794 * var_x401 * var_x405 - 0.00033628318584070794 * var_x404 * var_chaste_interface__transient_outward_current_y2_gate__y2 + 1.7263097345132742e-5 * var_x401 * pow(var_x399, 2) / pow(var_x400, 2) + 2.2558884955752213e-5 * pow(var_x402, 2) * var_chaste_interface__transient_outward_current_y2_gate__y2 / pow(var_x403, 2);
        IJth(rJacobian, 26, 0) = -0.011979261536575346 * var_x141 - 0.016290910314181915 * var_x77 * (1.0 - var_chaste_interface__sodium_calcium_exchanger_y_gate__y);
        IJth(rJacobian, 27, 0) = var_x128 * (-8.738369770208911e-5 * var_x131 + 0.00034888555005620854 * var_x409 / pow((1 + 0.067138346456864173 * var_x409), 2));
        IJth(rJacobian, 29, 0) = -var_x413;
        IJth(rJacobian, 30, 0) = var_x413;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-1.8699265995488508 * var_x166 - 0.0029166666666666668 * var_x154 - 0.030496093294460638 * var_x157 - var_x126 * var_x154 - var_x127 * var_x154 - var_x142 * var_x154 - var_x152 * var_x154 - var_x154 * var_x82);
        IJth(rJacobian, 1, 1) = -1.5645230048035654e-5 * var_x157 - 0.00095931736371611951 * var_x166 - 4.9877340607565601e-7 * var_x154 - var_x154 * var_x233 - var_x154 * var_x234 - var_x154 * var_x235 - var_x154 * var_x236 - var_x154 * var_x237;
        IJth(rJacobian, 2, 1) = 0.00063954490914407971 * var_x166;
        IJth(rJacobian, 3, 1) = 5.2150766826785515e-6 * var_x157;
        IJth(rJacobian, 4, 1) = -0.00031977245457203985 * var_x166;
        IJth(rJacobian, 26, 1) = (-0.0044781341107871719 * var_x156 + 6.1798250728862972e-6 * var_x259 * var_x408 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 2)) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        IJth(rJacobian, 27, 1) = (-0.089044123788040511 * var_x165 + 4.8132665714837462e-5 * var_x410 * var_x412 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 0.060000000000000053)) * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (0.039516010388377508 * var_x190 - 0.0011666666666666668 * var_x167 - 13.360946700152077 * var_x169 - 30.612905384887238 * var_x188 - 0.007575757575757576 * var_x168 + var_x116 * var_x183 + var_x184 * var_x41 - var_x119 * var_x167 - var_x121 * var_x167 - var_x125 * var_x167 - var_x151 * var_x167 - var_x167 * var_x82);
        IJth(rJacobian, 1, 2) = 2.0272664670101542e-5 * var_x190;
        IJth(rJacobian, 2, 2) = -0.005235052487551543 * var_x188 - 0.0022848291065246224 * var_x169 - 1.2955153404562495e-6 * var_x168 - 1.9950936243026244e-7 * var_x167 - 1.3515109780067695e-5 * var_x190 + var_x183 * var_x245 + var_x184 * var_x243 - var_x167 * var_x233 - var_x167 * var_x246 - var_x167 * var_x247 - var_x167 * var_x248 - var_x167 * var_x249;
        IJth(rJacobian, 4, 2) = 6.7575548900338474e-6 * var_x190;
        IJth(rJacobian, 18, 2) = var_x177 * var_x381 + var_x374 * (-0.62329941155965873 * var_x372 * var_x42 - 25141.488869633296 * var_x373 * var_x42) - var_x176 * var_x379 - var_x178 * var_x381 - var_x380 * (0.010685132769594151 * var_x377 * var_x42 + 0.00041096664498439041 * var_x375 * var_x42) + var_x180 * var_x381 * var_x50;
        IJth(rJacobian, 27, 2) = (0.0018817147803989289 * var_x189 - 0.00022400328987130325 * var_x411 * var_x412 * var_x42) * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (0.010165364431486881 * var_x200 - 0.00030303030303030303 * var_x194 + var_x195 * var_x197 + var_x197 * var_x198 - var_x134 * var_x194 - var_x149 * var_x194 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL);
        IJth(rJacobian, 1, 3) = 5.2150766826785515e-6 * var_x200 + var_x195 * var_x238;
        IJth(rJacobian, 2, 3) = var_x198 * var_x238;
        IJth(rJacobian, 3, 3) = -0.00014866038531735463 + 0.00033683398851862484 * var_x265 - 0.0056432648230274225 * var_x266 - 0.00014866038531735463 * var_x191 - 1.7383588942261838e-6 * var_x200 - 2.591030680912499e-8 * var_x194 + var_x255 * (-1.3650000000000002 - 1.3650000000000002 * var_x191) + (-54.600000000000009 - 54.600000000000009 * var_x191) * var_chaste_interface__NL_model__pCB + (-0.020080487777071866 - 0.020080487777071866 * var_x191) * var_chaste_interface__RyR_channel__p_open_RyR - var_x194 * var_x253;
        IJth(rJacobian, 4, 3) = 0.00016841699425931242 * var_x265;
        IJth(rJacobian, 12, 3) = (-var_x354 - var_x355) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        IJth(rJacobian, 13, 3) = (var_x354 + var_x355) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        IJth(rJacobian, 14, 3) = -var_x355 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        ...
        IJth(rJacobian, 26, 3) = (0.0014927113702623907 * var_x199 + 0.0055199999999999997 * var_x262 * var_x406 * var_x408) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        IJth(rJacobian, 28, 3) = var_x256 * (3.2000000000000005e-5 * var_x263 - 0.0032000000000000002 * var_x264);
        IJth(rJacobian, 29, 3) = (var_x414 - var_x415) * var_chaste_interface__RyR_channel__p_close_RyR;
        IJth(rJacobian, 30, 3) = (var_x415 - var_x414) * var_chaste_interface__RyR_channel__p_close_RyR;
        IJth(rJacobian, 31, 3) = (1.0040243888535934 + 1.0040243888535934 * var_x191) * var_chaste_interface__RyR_channel__p_open_RyR;
        IJth(rJacobian, 32, 3) = 0.0029732077063470926 + 0.0029732077063470926 * var_x191 - 0.0067366797703724973 * var_x265;
        IJth(rJacobian, 33, 3) = var_x255 * (19.5 + 19.5 * var_x191);
        IJth(rJacobian, 34, 3) = (780.0 + var_x431) * var_chaste_interface__NL_model__pCB;
        IJth(rJacobian, 35, 3) = (-780.0 - var_x431) * var_chaste_interface__NL_model__pCB;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (0.010003392181085318 * var_x202 - 0.001334912536443149 * var_x208 - 72.15743440233237 * var_x210 - 0.73038000000000003 * var_x205 - 0.026337463556851317 * var_x211);
        IJth(rJacobian, 1, 4) = -2.2828075632508891e-7 * var_x208 - 0.00037470252376752445 * var_x205;
        IJth(rJacobian, 2, 4) = 1.710660339589889e-6 * var_x202 + 0.00024980168251168298 * var_x205 - 4.5039176247922949e-6 * var_x211;
        IJth(rJacobian, 3, 4) = -0.010526062141207028 * var_x268 - 0.0061697501709483491 * var_x210;
        IJth(rJacobian, 4, 4) = -0.0030000000000000001 - 0.00012490084125584149 * var_x205 - 0.005263031070603514 * var_x268;
        IJth(rJacobian, 27, 4) = -0.034779999999999998 * var_x205;
        IJth(rJacobian, 28, 4) = 0.10000000000000001 * var_x268;
        IJth(rJacobian, 29, 4) = -var_x416;
        IJth(rJacobian, 30, 4) = var_x416;
        IJth(rJacobian, 32, 4) = 0.21052124282414053 * var_x268;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x212 * var_chaste_interface__sodium_current_ultra_slow_gate__y - var_x213 * var_chaste_interface__sodium_current_ultra_slow_gate__y);
        IJth(rJacobian, 1, 5) = -var_x239 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        IJth(rJacobian, 2, 5) = -var_x250 * var_chaste_interface__sodium_current_ultra_slow_gate__y;
        IJth(rJacobian, 5, 5) = -var_x295 - var_x296;
        IJth(rJacobian, 6, 5) = var_x295 + var_x312;
        IJth(rJacobian, 7, 5) = var_x296 + var_x313;
        IJth(rJacobian, 5, 6) = var_x298;
        IJth(rJacobian, 6, 6) = -0.01 - var_x298;
        IJth(rJacobian, 7, 6) = var_x313;
        IJth(rJacobian, 5, 7) = 8.7499999999999999e-5;
        IJth(rJacobian, 6, 7) = var_x312;
        IJth(rJacobian, 7, 7) = -8.7499999999999999e-5 + var_x313 - 1.0 / var_x301;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x212 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_x213 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na);
        IJth(rJacobian, 1, 8) = -var_x239 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        IJth(rJacobian, 2, 8) = -var_x250 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        IJth(rJacobian, 8, 8) = -1.0 / (4000.0 * var_x319 + 0.014 * var_x318) - 1.0 / (8000.0 * var_x315 + 9000000000.0 * var_x317);
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x148 * var_x214 - var_x148 * var_x215 - var_x148 * var_x216);
        IJth(rJacobian, 1, 9) = -var_x148 * var_x240;
        IJth(rJacobian, 2, 9) = -var_x148 * var_x251;
        IJth(rJacobian, 3, 9) = -var_x148 * var_x269;
        IJth(rJacobian, 9, 9) = -0.0040000000000000001 - var_x331;
        IJth(rJacobian, 10, 9) = var_x331 + var_x349;
        IJth(rJacobian, 11, 9) = 0.0040000000000000001 + var_x350;
        IJth(rJacobian, 12, 9) = var_x357;
        IJth(rJacobian, 13, 9) = -var_x357;
        IJth(rJacobian, 14, 9) = (0.18212526000000001 + var_x356 - 3.4769999999999999 * var_x5 - 3.4769999999999999 * var_chaste_interface__internal_ion_concentrations__Ca_Total) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        IJth(rJacobian, 29, 9) = -var_x419;
        IJth(rJacobian, 30, 9) = var_x419;
        IJth(rJacobian, 9, 10) = var_x333;
        IJth(rJacobian, 10, 10) = -0.040000000000000001 - var_x333;
        IJth(rJacobian, 11, 10) = var_x350;
        IJth(rJacobian, 9, 11) = 0.001;
        IJth(rJacobian, 10, 11) = var_x349;
        IJth(rJacobian, 11, 11) = -0.001 + var_x350 - 1.0 / var_x336;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x218);
        IJth(rJacobian, 1, 12) = var_x241;
        IJth(rJacobian, 2, 12) = var_x252;
        IJth(rJacobian, 3, 12) = var_x270;
        IJth(rJacobian, 12, 12) = -0.34999999999999998 + var_x360 - var_x358;
        IJth(rJacobian, 13, 12) = -0.00029999999999999997 + var_x358 + var_x359;
        IJth(rJacobian, 14, 12) = 0.3458;
        IJth(rJacobian, 29, 12) = var_x421;
        IJth(rJacobian, 30, 12) = var_x420;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x218);
        IJth(rJacobian, 1, 13) = var_x241;
        IJth(rJacobian, 2, 13) = var_x252;
        IJth(rJacobian, 3, 13) = var_x270;
        IJth(rJacobian, 12, 13) = 2.0019999999999998;
        IJth(rJacobian, 13, 13) = -2.3523000000000001;
        IJth(rJacobian, 14, 13) = -0.0041999999999999997;
        IJth(rJacobian, 29, 13) = var_x421;
        IJth(rJacobian, 30, 13) = var_x420;
        IJth(rJacobian, 12, 14) = 0.14299999999999999;
        IJth(rJacobian, 13, 14) = -0.00029999999999999997;
        IJth(rJacobian, 14, 14) = -0.1472 + var_x360;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x214 * var_x219 - var_x215 * var_x219 - var_x216 * var_x219);
        IJth(rJacobian, 1, 15) = -var_x219 * var_x240;
        IJth(rJacobian, 2, 15) = -var_x219 * var_x251;
        IJth(rJacobian, 3, 15) = -var_x219 * var_x269;
        IJth(rJacobian, 15, 15) = -1.0 / (58.0 * var_x326 + 250000.0 * var_x361) - 1.0 / (66.0 * var_x322 + 1800.0 * var_x362);
        IJth(rJacobian, 29, 15) = -var_x422;
        IJth(rJacobian, 30, 15) = var_x422;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x220 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2);
        IJth(rJacobian, 3, 16) = -var_x271 * var_chaste_interface__T_type_Ca_channel_y2_gate__y2;
        IJth(rJacobian, 16, 16) = -1.0 / (1.5 * var_x365 + 40.0 * var_x366) - 1.0 / (0.019 * var_x363 + 0.81999999999999995 * var_x364);
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x220 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1);
        IJth(rJacobian, 3, 17) = -var_x271 * var_chaste_interface__T_type_Ca_channel_y1_gate__y1;
        IJth(rJacobian, 17, 17) = -1.0 / (30.0 * var_x367 + 62000.0 * var_x368) - 1.0 / (1.2 * var_x370 + 0.00059999999999999995 * var_x369);
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x115 * var_x186);
        IJth(rJacobian, 2, 18) = var_x186 * var_x244;
        IJth(rJacobian, 18, 18) = -1.0 / (7.0 * var_x372 + 8000.0 * var_x373) - var_x185 * var_x378;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : ((0.1384793206939402 * var_x43 - 0.0051840000000000002 * var_chaste_interface__membrane__Vm) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3);
        IJth(rJacobian, 2, 19) = (2.3681075126934729e-5 * var_x43 - 8.8650560129012604e-7 * var_chaste_interface__membrane__Vm) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
        IJth(rJacobian, 19, 19) = -1.0 / (5.0 * var_x387 + 20.0 * var_x388) - 1.0 / (160.0 * var_x384 + 200.0 * var_x385) - 0.00040000000000000002 * var_x382;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : ((0.092319547129293467 * var_x43 - 0.0034560000000000003 * var_chaste_interface__membrane__Vm) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3);
        IJth(rJacobian, 2, 20) = (1.5787383417956489e-5 * var_x43 - 5.9100373419341736e-7 * var_chaste_interface__membrane__Vm) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3;
        IJth(rJacobian, 20, 20) = -1.0 / (20.0 * var_x387 + 200.0 * var_x389) - 1.0 / (1600.0 * var_x384 + 2000.0 * var_x385) - 0.0001 * var_x382;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x201 * var_x40);
        IJth(rJacobian, 2, 21) = var_x201 * var_x242;
        IJth(rJacobian, 21, 21) = -1.0 / (2.0 * var_x392 + 0.34999999999999998 * var_x391) - 1.0 / (2.5 * var_x390 + 10.0 * var_x286);
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-0.07636363636363637 * var_x222 - 0.0030545454545454548 * var_x223);
        IJth(rJacobian, 1, 22) = -5.2235178527195981e-7 * var_x223;
        IJth(rJacobian, 2, 22) = -1.3058794631798995e-5 * var_x222;
        IJth(rJacobian, 22, 22) = -1.0 / (260.0 * var_x315 + 1450.0 * var_x300) - 1.0 / (85.0 * var_x393 + 370.0 * var_x394);
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (-0.034363636363636367 * var_x224 - 0.0013745454545454547 * var_x225);
        IJth(rJacobian, 1, 23) = -2.3505830337238192e-7 * var_x225;
        IJth(rJacobian, 2, 23) = -5.8764575843095472e-6 * var_x224;
        IJth(rJacobian, 23, 23) = 0.092459000000000013 - 1.8500000000000001 * var_x5 - 1.8500000000000001 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00075000000000000002 * var_x227 - 6.7500000000000001e-5 * var_x228);
        IJth(rJacobian, 1, 24) = -1.1543041683465182e-8 * var_x228;
        IJth(rJacobian, 2, 24) = -1.2825601870516871e-7 * var_x227;
        IJth(rJacobian, 24, 24) = -1.0 / (11.0 * var_x395 + 0.20000000000000001 * var_x281) - 1.0 / (4.4000000000000004 * var_x397 + 0.20000000000000001 * var_x396);
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00025000000000000001 * var_x229 - 2.2500000000000001e-5 * var_x230);
        IJth(rJacobian, 1, 25) = -3.8476805611550606e-9 * var_x230;
        IJth(rJacobian, 2, 25) = -4.2752006235056235e-8 * var_x229;
        IJth(rJacobian, 25, 25) = -0.0038 * var_x404 - 0.0038 * var_x405;
        IJth(rJacobian, 0, 26) = mSetVoltageDerivativeToZero ? 0.0 : (-6.8099999999999996 * var_x140 - 4.3581631433074284 * var_x77);
        IJth(rJacobian, 1, 26) = -0.0022358426145128573 * var_x77 - 0.003493693949528795 * var_x140;
        IJth(rJacobian, 3, 26) = 0.0007452808715042858 * var_x77 + 0.0011645646498429317 * var_x140;
        IJth(rJacobian, 26, 26) = -0.20379327210477693 - 1.0 * var_x140 - 1.0 / var_x407 - 0.6399652192815608 * var_x77;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-0.83999999999999997 * var_x231 - 7.7699999999999996 * var_x232);
        IJth(rJacobian, 1, 27) = -0.0039861970613566432 * var_x232 - 0.00043094022284936683 * var_x231;
        IJth(rJacobian, 2, 27) = 0.0002872934818995779 * var_x231 + 0.0026574647075710955 * var_x232;
        IJth(rJacobian, 4, 27) = -0.00014364674094978895 * var_x231 - 0.0013287323537855477 * var_x232;
        IJth(rJacobian, 27, 27) = -0.37 * var_x232 - 0.01 / (1.0 + 49.999265664512095 * var_x411) - 0.040000000000000001 * var_x231 - 0.16500000000000001 / (1.0331690520373935 + 0.069365261764196454 * var_x409);
        IJth(rJacobian, 3, 28) = 0.0010526062141207027 * var_x273 + 0.10526062141207027 * var_x274;
        IJth(rJacobian, 4, 28) = 0.00052630310706035135 * var_x273 + 0.052630310706035133 * var_x274;
        IJth(rJacobian, 28, 28) = -1.01 + 0.01 * var_x267 + 0.98999999999999999 * var_x273 - 1.0 * var_x274;
        IJth(rJacobian, 32, 28) = -0.021052124282414052 * var_x273 - 2.1052124282414053 * var_x274;
        IJth(rJacobian, 3, 29) = -0.21581745204261313 + 0.020080487777071866 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 0.21686926799237616 * var_x276 - 0.020080487777071866 * var_x5 - 0.020080487777071866 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        IJth(rJacobian, 29, 29) = -0.080000000000000002 / var_x423;
        IJth(rJacobian, 30, 29) = var_x428;
        IJth(rJacobian, 31, 29) = 10.790872602130657 + 1.0040243888535934 * var_x5 + 1.0040243888535934 * var_chaste_interface__internal_ion_concentrations__Ca_Total - 1.0040243888535934 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total - 10.843463399618807 * var_x276;
        IJth(rJacobian, 29, 30) = var_x424 - var_x425;
        IJth(rJacobian, 30, 30) = -0.00084900000000000004 + var_x425 + var_x428 - var_x424;
        IJth(rJacobian, 3, 31) = (0.020080487777071866 + 0.21686926799237616 * var_x277) * var_chaste_interface__RyR_channel__p_open_RyR;
        IJth(rJacobian, 29, 31) = 0.00098765432098765434 * (-0.5 - 5.4000000000000004 * var_x277) * var_chaste_interface__RyR_channel__p_open_RyR / (pow(var_x423, 2) * var_x427);
        IJth(rJacobian, 30, 31) = 0.010993320000000001 * var_x426 * (0.18518518518518517 + 2 * var_x277) * (1.0 - var_chaste_interface__RyR_channel__p_close_RyR - var_chaste_interface__RyR_channel__p_open_RyR);
        IJth(rJacobian, 31, 31) = -0.0062508615177014034 - 0.067509304391175154 * var_x277 + (-1.0040243888535934 - 10.843463399618807 * var_x277) * var_chaste_interface__RyR_channel__p_open_RyR;
        IJth(rJacobian, 32, 31) = 0.0025003446070805614 + 0.027003721756470062 * var_x277;
        IJth(rJacobian, 3, 32) = 0.00029732077063470926 + 8.4208497129656211e-5 * var_x278;
        IJth(rJacobian, 4, 32) = 4.2104248564828106e-5 * var_x278;
        IJth(rJacobian, 28, 32) = 0.079200000000000007 * var_x278;
        IJth(rJacobian, 31, 32) = 0.012501723035402807;
        IJth(rJacobian, 32, 32) = -0.010947104626855308 - 0.0016841699425931243 * var_x278;
        IJth(rJacobian, 3, 33) = var_x279;
        IJth(rJacobian, 33, 33) = 0.99141000000000001 + var_x430 - var_x429;
        IJth(rJacobian, 34, 33) = var_x429;
        IJth(rJacobian, 3, 34) = var_x279 + 0.0027216000000000002 * var_x280;
        IJth(rJacobian, 4, 34) = -0.028000000000000004;
        IJth(rJacobian, 33, 34) = 1.0253100000000002 + var_x430;
        IJth(rJacobian, 34, 34) = -0.0339 + var_x432;
        IJth(rJacobian, 35, 34) = 0.029999999999999999;
        IJth(rJacobian, 3, 35) = 2.7884493000000004 - 53.235000000000007 * var_x5 - 53.235000000000007 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        IJth(rJacobian, 33, 35) = 1.0214100000000002 + var_x430;
        IJth(rJacobian, 34, 35) = -40.856400000000001 + var_x433 + var_x434;
        IJth(rJacobian, 35, 35) = 40.736400000000003 + var_x432 - var_x433 - var_x434;
        ...
        IJth(rJacobian, 34, 36) = var_x435 * var_chaste_interface__NL_model__pCaCB;
        IJth(rJacobian, 35, 36) = var_x435 * var_chaste_interface__NL_model__pCB;
