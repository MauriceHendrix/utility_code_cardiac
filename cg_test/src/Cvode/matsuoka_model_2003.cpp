...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmatsuoka_model_2003FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x290 = pow((var_x289 + 0.00076923076923076923 * var_x287), (-2));
        const double var_x291 = 0.0014792899408284023 * var_x290;
        const double var_x292 = -1.5294117647058822 * var_x289 - 2.5000000000000001e-5 * var_x287;
        const double var_x293 = exp(-0.125 * var_chaste_interface__membrane__Vm);
        const double var_x294 = 0.0128375 * var_x293;
        const double var_x295 = exp(-0.02 * var_chaste_interface__membrane__Vm);
        const double var_x296 = 0.0050000000000000001 * var_x295;
        const double var_x297 = var_x294 + var_x296;
        const double var_x298 = 16.0 / pow((var_x295 + 0.4108 * var_x293), 2);
        const double var_x299 = 1 / (26.0 * var_x289 + 0.02 * var_x287);
        const double var_x300 = 1.25 * var_x285;
        const double var_x301 = 0.25 * var_x295 + 0.1027 * var_x293;
        const double var_x302 = 1 / var_x301;
        const double var_x303 = 1 / (5.0 * var_x284 + 0.0001027 * var_x293);
        const double var_x304 = exp(0.050000000000000003 * var_chaste_interface__membrane__Vm);
        const double var_x305 = 1300.0 * var_x304 + 0.040000000000000001 * var_x287;
        const double var_x306 = var_x284 * var_x299 * var_x301 * var_x305;
        const double var_x307 = var_x303 * var_x306;
        const double var_x308 = 1.0 + 7.0000000000000007e-5 * var_x307;
        const double var_x309 = 65.0 * var_x304;
        const double var_x310 = 5.0000000000000002e-5 * var_x287;
        const double var_x311 = var_x284 * var_x301 * var_x303;
        const double var_x312 = 7.0000000000000007e-5 * var_x299;
        const double var_x313 = (1.28375e-5 * var_x293 + 0.012500000000000001 * var_x284) / pow((var_x284 + 2.054e-5 * var_x293), 2);
        const double var_x314 = 0.01 * (1.7500000000000002e-7 * var_x307 - 2.8000000000000003e-6 * var_x306 * var_x313 - var_x311 * var_x312 * (var_x309 + var_x310) - 1.0355029585798818e-7 * var_x290 * var_x292 * var_x305 * var_x311 - var_x284 * var_x303 * var_x305 * var_x312 * (-var_x294 - var_x296)) / pow(var_x308, 2);
        const double var_x315 = 1.0 - var_chaste_interface__sodium_current_voltage_dependent_gate__p_AI_Na - var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na - var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na;
        const double var_x316 = -0.01 + 0.01 / var_x308;
        const double var_x317 = -var_x303;
        const double var_x318 = 0.01 * var_chaste_interface__membrane__Vm;
        const double var_x319 = exp(var_x318);
        const double var_x320 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x321 = exp(var_x320);
        const double var_x322 = exp(-var_x320);
        const double var_x323 = exp(-var_x318);
        const double var_x324 = exp(-0.16949152542372881 * var_chaste_interface__membrane__Vm);
        const double var_x325 = 0.04576271186440678 * var_x324;
        const double var_x326 = 0.015384615384615385 * var_chaste_interface__membrane__Vm;
        const double var_x327 = exp(-var_x326);
        const double var_x328 = 0.023076923076923078 * var_x327;
        const double var_x329 = var_x325 + var_x328;
        const double var_x330 = 0.44444444444444442 / pow((var_x327 + 0.18000000000000002 * var_x324), 2);
        const double var_x331 = exp(var_x326);
        const double var_x332 = exp(0.14285714285714285 * var_chaste_interface__membrane__Vm);
        const double var_x333 = (-68.571428571428569 * var_x332 - 0.033846153846153852 * var_x331) / pow((var_x332 + 0.0045833333333333334 * var_x331), 2);
        const double var_x334 = 4.3402777777777778e-6 * var_x333 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x335 = 1 / (480.0 * var_x332 + 2.2000000000000002 * var_x331);
        const double var_x336 = 1.5 * var_x327 + 0.27000000000000002 * var_x324;
        const double var_x337 = 1 / var_x336;
        const double var_x338 = 0.13513513513513511 * var_chaste_interface__membrane__Vm;
        const double var_x339 = exp(var_x338);
        const double var_x340 = 11.0 * var_x319 + 2200000.0 * var_x339;
        const double var_x341 = var_x335 * var_x336 * var_x340;
        const double var_x342 = exp(-var_x338);
        const double var_x343 = 1 / (2.0 * var_x323 + 0.0018 * var_x342);
        const double var_x344 = 0.25 * var_x343;
        const double var_x345 = 1.0 + var_x341 * var_x344;
        const double var_x346 = 297297.29729729728 * var_x339;
        const double var_x347 = 0.11 * var_x319;
        const double var_x348 = var_x335 * var_x344;
        const double var_x349 = (0.00024324324324324323 * var_x342 + 0.02 * var_x323) / pow((var_x323 + 0.00089999999999999998 * var_x342), 2);
        const double var_x350 = 0.040000000000000001 * (-0.0625 * var_x341 * var_x349 - var_x336 * var_x348 * (var_x346 + var_x347) - var_x340 * var_x348 * (-var_x325 - var_x328) - 1.0850694444444444e-6 * var_x333 * var_x336 * var_x340 * var_x343) / pow(var_x345, 2);
        const double var_x351 = 1.0 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x352 = var_x351 - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AI_CaL - var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL;
        const double var_x353 = -0.040000000000000001 + 0.040000000000000001 / var_x345;
        const double var_x354 = -var_x343;
        const double var_x355 = 0.14102711999999998 * var_x144;
        const double var_x356 = var_x355 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x357 = 6.9539999999999997 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x358 = var_x195 * (6.9539999999999997 - var_x357);
        const double var_x359 = (3.4769999999999999 + 3.4769999999999999 * var_x193 - 0.14102711999999998 * var_x196) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AP_CaL;
        const double var_x360 = 0.14102711999999998 * var_x213;
        const double var_x361 = var_x360 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        const double var_x362 = 6.9539999999999997 * var_x31 * var_x351;
        const double var_x363 = var_x357 * (var_x31 - 0.020279999999999996 * var_x213);
        const double var_x364 = -var_x363;
        const double var_x365 = exp(0.1111111111111111 * var_chaste_interface__membrane__Vm);
        const double var_x366 = exp(-0.071428571428571425 * var_chaste_interface__membrane__Vm);
        const double var_x367 = exp(-0.17857142857142858 * var_chaste_interface__membrane__Vm);
        const double var_x368 = exp(-0.0040000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x369 = exp(0.0001 * var_chaste_interface__membrane__Vm);
        const double var_x370 = exp(0.15873015873015872 * var_chaste_interface__membrane__Vm);
        const double var_x371 = exp(0.00033333333333333332 * var_chaste_interface__membrane__Vm);
        const double var_x372 = exp(0.099009900990099015 * var_chaste_interface__membrane__Vm);
        const double var_x373 = exp(-0.14925373134328357 * var_chaste_interface__membrane__Vm);
        const double var_x374 = exp(-0.040000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x375 = 0.0033333333333333335 * var_chaste_interface__membrane__Vm;
        const double var_x376 = exp(-0.32333333333333331 + var_x375 - 0.08904277307995126 * var_x56);
        const double var_x377 = exp(-11.411764705882353 + 0.11764705882352941 * var_chaste_interface__membrane__Vm - 3.142686108704162 * var_x56);
        const double var_x378 = 1.5624999999999999e-8 * (1.0 - var_chaste_interface__time_independent_potassium_current_y_gate__y) / pow((var_x377 + 0.00087500000000000002 * var_x376), 2);
        const double var_x379 = exp(10.659340659340661 + 2.9354760356027887 * var_x56 - 0.10989010989010989 * var_chaste_interface__membrane__Vm);
        const double var_x380 = 0.002 * var_chaste_interface__membrane__Vm;
        const double var_x381 = exp(0.19400000000000001 - var_x380 + 0.053425663847970754 * var_x56);
        const double var_x382 = 1 / (0.00013999999999999999 * var_x379 + 0.20000000000000001 * var_x381);
        const double var_x383 = var_x382 * var_chaste_interface__time_independent_potassium_current_y_gate__y;
        const double var_x384 = 24.999999999999996 * var_x74 * var_chaste_interface__time_independent_potassium_current_y_gate__y / pow((var_x381 + 0.00069999999999999988 * var_x379), 2);
        const double var_x385 = 1 / var_x304;
        const double var_x386 = 0.035714285714285712 * var_chaste_interface__membrane__Vm;
        const double var_x387 = exp(var_x386);
        const double var_x388 = exp(0.001 * var_chaste_interface__membrane__Vm);
        const double var_x389 = pow((var_x388 + 0.80000000000000004 * var_x387), (-2));
        const double var_x390 = exp(-var_x375);
        const double var_x391 = exp(-0.086956521739130432 * var_chaste_interface__membrane__Vm);
        const double var_x392 = exp(var_x12);
        const double var_x393 = exp(var_x375);
        const double var_x394 = exp(-var_x288);
        const double var_x395 = exp(-0.0066666666666666671 * var_chaste_interface__membrane__Vm);
        const double var_x396 = exp(-0.095238095238095233 * var_chaste_interface__membrane__Vm);
        const double var_x397 = exp(-0.016129032258064516 * var_chaste_interface__membrane__Vm);
        const double var_x398 = exp(-var_x386);
        const double var_x399 = exp(var_x380);
        const double var_x400 = exp(0.0625 * var_chaste_interface__membrane__Vm);
        const double var_x401 = 0.088495575221238937 * var_chaste_interface__membrane__Vm;
        const double var_x402 = exp(-1.1946902654867255 - var_x401);
        const double var_x403 = 1.0 + 0.051334999999999999 * var_x402;
        const double var_x404 = 1.0 - var_chaste_interface__transient_outward_current_y2_gate__y2;
        const double var_x405 = exp(1.1946902654867255 + var_x401);
        const double var_x406 = 1.0 + 0.067083000000000004 * var_x405;
        const double var_x407 = var_x405 / var_x406;
        const double var_x408 = var_x402 / var_x403;
        const double var_x409 = 1.0 + 0.0014927113702623907 * var_x41;
        const double var_x410 = 1.0 + 0.0013799999999999999 * var_x262 * var_x409;
        const double var_x411 = pow(var_x410, (-2));
        const double var_x412 = pow(var_x140, 1.0600000000000001);
        const double var_x413 = pow(var_x55, 1.1200000000000001);
        const double var_x414 = var_x413 * (1.0 + 0.22703754152993499 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 1.0600000000000001));
        const double var_x415 = pow((0.020000293738509214 + var_x414), (-2));
        const double var_x416 = 10.139999999999999 * var_x257 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x417 = 70000.0 * var_x48 * (2 + 2 * var_x193);
        const double var_x418 = 10.139999999999999 * var_x269;
        const double var_x419 = 11.08600583090379 * var_x214 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x420 = 10.139999999999999 * var_x213;
        const double var_x421 = var_x420 * var_chaste_interface__RyR_channel__p_close_RyR;
        const double var_x422 = var_x149 * var_x421;
        const double var_x423 = var_x220 * var_x421;
        const double var_x424 = -var_x423;
        const double var_x425 = var_x222 * var_x421;
        const double var_x426 = 1.0 + 0.35999999999999999 / (-5.4000000000000004 + 0.5 * var_chaste_interface__Ca_concentrations_in_SR__Ca_Total + 5.4000000000000004 * var_x279);
        const double var_x427 = 70000.0 * var_x264;
        const double var_x428 = var_x151 * var_x420;
        const double var_x429 = -1 + var_x278 + var_x279;
        const double var_x430 = pow(var_x429, 2);
        const double var_x431 = -0.010993320000000001 * var_x430;
        const double var_x432 = 0.0038999999999999998 * exp(-0.86212130841993795);
        const double var_x433 = -19.5 * var_x30 - 19.5 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x434 = 780.0 * var_x193;
        const double var_x435 = -0.038879999999999998 * var_x283;
        const double var_x436 = 780.0 * var_x30;
        const double var_x437 = 780.0 * var_chaste_interface__internal_ion_concentrations__Ca_Total;
        const double var_x438 = 0.074445868608802798 - 0.077759999999999996 * var_chaste_interface__NL_model__X;
        ...
        IJth(rJacobian, 5, 0) = (-var_x286 - var_x291 * var_x292) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + var_x297 * var_x298 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na;
        IJth(rJacobian, 6, 0) = (-var_x314 - var_x297 * var_x298) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_RP_Na - var_x314 * var_x315 + var_x291 * var_x292 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na;
        IJth(rJacobian, 7, 0) = var_x286 * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AP_Na + 0.040000000000000001 * var_x313 * var_x315 - 5.917159763313609e-7 * (-var_x309 - var_x310) * var_chaste_interface__sodium_current_voltage_dependent_gate__p_AI_Na / pow((var_x304 + 3.0769230769230768e-5 * var_x287), 2);
        IJth(rJacobian, 8, 0) = 1.2345679012345679e-20 * (1.0 - var_chaste_interface__sodium_current_ultra_slow_gate__y) * (-80.0 * var_x319 - 1800000000.0 * var_x321) / pow((var_x321 + 8.8888888888888887e-7 * var_x319), 2) - 6.2499999999999997e-8 * (40.0 * var_x323 + 0.0028 * var_x322) * var_chaste_interface__sodium_current_ultra_slow_gate__y / pow((var_x323 + 3.4999999999999999e-6 * var_x322), 2);
        IJth(rJacobian, 9, 0) = -var_x334 + var_x329 * var_x330 * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL;
        IJth(rJacobian, 10, 0) = var_x334 + (-var_x350 - var_x329 * var_x330) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_RP_CaL - var_x350 * var_x352;
        IJth(rJacobian, 11, 0) = 0.25 * var_x349 * var_x352 - 2.0661157024793388e-13 * (-var_x346 - var_x347) * var_chaste_interface__L_type_Ca_channel_voltage_dependent_gate__p_AI_CaL / pow((var_x339 + 5.0000000000000004e-6 * var_x319), 2);
        IJth(rJacobian, 12, 0) = var_x356;
        IJth(rJacobian, 13, 0) = -var_x356;
        IJth(rJacobian, 14, 0) = var_x355 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        IJth(rJacobian, 15, 0) = 1.6e-11 * (1.0 - var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y) * (-27777.777777777777 * var_x365 - 0.89230769230769236 * var_x331) / pow((var_x365 + 0.000232 * var_x331), 2) - 3.0864197530864198e-7 * (1.0153846153846153 * var_x327 + 128.57142857142858 * var_x366) * var_chaste_interface__L_type_Ca_channel_ultra_slow_gate__y / pow((var_x366 + 0.036666666666666667 * var_x327), 2);
        IJth(rJacobian, 16, 0) = 1.4872099940511603 * (1.0 - var_chaste_interface__T_type_Ca_channel_y1_gate__y1) * (0.0033928571428571428 * var_x367 + 0.0032799999999999999 * var_x368) / pow((var_x368 + 0.023170731707317073 * var_x367), 2) - 0.00062500000000000001 * (-6.3492063492063497 * var_x370 - 0.00014999999999999999 * var_x369) * var_chaste_interface__T_type_Ca_channel_y1_gate__y1 / pow((var_x370 + 0.037499999999999999 * var_x369), 2);
        IJth(rJacobian, 17, 0) = 2.6014568158168572e-10 * (1.0 - var_chaste_interface__T_type_Ca_channel_y2_gate__y2) * (-0.01 * var_x371 - 6138.6138613861385 * var_x372) / pow((var_x372 + 0.00048387096774193548 * var_x371), 2) - 0.69444444444444453 * (8.9552238805970142e-5 * var_x373 + 0.048000000000000001 * var_x374) * var_chaste_interface__T_type_Ca_channel_y2_gate__y2 / pow((var_x374 + 0.00050000000000000001 * var_x373), 2);
        IJth(rJacobian, 18, 0) = var_x105 * var_x383 + var_x120 * var_x383 + var_x378 * (-0.023333333333333334 * var_x376 - 941.17647058823525 * var_x377) - var_x114 * var_x383 - var_x118 * var_x383 - var_x384 * (0.00040000000000000002 * var_x381 + 1.5384615384615384e-5 * var_x379);
        IJth(rJacobian, 19, 0) = (2.0000000000000002e-5 * var_x385 - 2.5000000000000001e-5 * var_x389 * (-5.7142857142857144 * var_x387 - 0.20000000000000001 * var_x388)) * var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1 + 0.0025000000000000001 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y1_gate__y1) * (1.7391304347826086 * var_x391 + 0.016666666666666666 * var_x390) / pow((var_x391 + 0.25 * var_x390), 2);
        IJth(rJacobian, 20, 0) = (5.0000000000000004e-6 * var_x385 - 2.4999999999999999e-7 * var_x389 * (-2.0 * var_x388 - 57.142857142857146 * var_x387)) * var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2 + 2.5000000000000001e-5 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y2_gate__y2) * (0.066666666666666666 * var_x390 + 15.384615384615385 * var_x392) / pow((var_x392 + 0.10000000000000001 * var_x390), 2);
        IJth(rJacobian, 21, 0) = 0.01 * (1.0 - var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3) * (-0.0083333333333333332 * var_x393 - 0.58823529411764708 * var_x289) / pow((var_x289 + 0.25 * var_x393), 2) - 0.25 * (0.020588235294117647 * var_x394 + 0.013333333333333334 * var_x395) * var_chaste_interface__rapid_time_dependent_potassium_current_y3_gate__y3 / pow((var_x395 + 0.17499999999999999 * var_x394), 2);
        IJth(rJacobian, 22, 0) = 7.3046018991964936e-6 * (1.0 - var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1) * (8.0952380952380949 * var_x396 + 5.967741935483871 * var_x397) / pow((var_x397 + 0.22972972972972974 * var_x396), 2) - 4.7562425683709868e-7 * (-72.5 * var_x304 - 2.6000000000000001 * var_x319) * var_chaste_interface__slow_time_dependent_potassium_current_y1_gate__y1 / pow((var_x304 + 0.1793103448275862 * var_x319), 2);
        IJth(rJacobian, 24, 0) = 0.0082644628099173556 * (1.0 - var_chaste_interface__transient_outward_current_y1_gate__y1) * (0.00050000000000000001 * var_x284 + 0.39285714285714285 * var_x398) / pow((var_x398 + 0.018181818181818184 * var_x284), 2) - 0.051652892561983466 * (-0.27500000000000002 * var_x400 - 0.00040000000000000002 * var_x399) * var_chaste_interface__transient_outward_current_y1_gate__y1 / pow((var_x400 + 0.045454545454545456 * var_x399), 2);
        IJth(rJacobian, 25, 0) = -0.00033628318584070794 * var_x404 * var_x408 - 0.00033628318584070794 * var_x407 * var_chaste_interface__transient_outward_current_y2_gate__y2 + 1.7263097345132742e-5 * var_x404 * pow(var_x402, 2) / pow(var_x403, 2) + 2.2558884955752213e-5 * pow(var_x405, 2) * var_chaste_interface__transient_outward_current_y2_gate__y2 / pow(var_x406, 2);
        ...
        IJth(rJacobian, 27, 0) = var_x139 * (-8.738369770208911e-5 * var_x142 + 0.00034888555005620854 * var_x412 / pow((1 + 0.067138346456864173 * var_x412), 2));
        IJth(rJacobian, 29, 0) = -var_x416;
        IJth(rJacobian, 30, 0) = var_x416;
        ...
        IJth(rJacobian, 26, 1) = (-0.0044781341107871719 * var_x157 + 6.1798250728862972e-6 * var_x262 * var_x411 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 2)) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        IJth(rJacobian, 27, 1) = (-0.089044123788040511 * var_x167 + 4.8132665714837462e-5 * var_x413 * var_x415 * pow(var_chaste_interface__internal_ion_concentrations__Nai, 0.060000000000000053)) * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        ...
        IJth(rJacobian, 18, 2) = var_x180 * var_x383 + var_x183 * var_x383 + var_x378 * (-0.62329941155965873 * var_x376 * var_x55 - 25141.488869633296 * var_x377 * var_x55) - var_x179 * var_x383 - var_x181 * var_x383 - var_x384 * (0.010685132769594151 * var_x381 * var_x55 + 0.00041096664498439041 * var_x379 * var_x55);
        IJth(rJacobian, 27, 2) = (0.0018817147803989289 * var_x191 - 0.00022400328987130325 * var_x414 * var_x415 * var_x55) * var_chaste_interface__sodium_potassium_pump_y_gate__y;
        ...
        IJth(rJacobian, 12, 3) = (-var_x358 - var_x359) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        IJth(rJacobian, 13, 3) = (var_x358 + var_x359) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_U;
        IJth(rJacobian, 14, 3) = -var_x359 * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        ...
        IJth(rJacobian, 26, 3) = (0.0014927113702623907 * var_x201 + 0.0055199999999999997 * var_x265 * var_x409 * var_x411) * var_chaste_interface__sodium_calcium_exchanger_y_gate__y;
        IJth(rJacobian, 28, 3) = var_x259 * (3.2000000000000005e-5 * var_x266 - 0.0032000000000000002 * var_x267);
        IJth(rJacobian, 29, 3) = (var_x417 - var_x418) * var_chaste_interface__RyR_channel__p_close_RyR;
        IJth(rJacobian, 30, 3) = (var_x418 - var_x417) * var_chaste_interface__RyR_channel__p_close_RyR;
        ...
        IJth(rJacobian, 34, 3) = (780.0 + var_x434) * var_chaste_interface__NL_model__pCB;
        IJth(rJacobian, 35, 3) = (-780.0 - var_x434) * var_chaste_interface__NL_model__pCB;
        ...
        IJth(rJacobian, 29, 4) = -var_x419;
        IJth(rJacobian, 30, 4) = var_x419;
        ...
        IJth(rJacobian, 5, 5) = -var_x299 - var_x300;
        IJth(rJacobian, 6, 5) = var_x299 + var_x316;
        IJth(rJacobian, 7, 5) = var_x300 + var_x317;
        IJth(rJacobian, 5, 6) = var_x302;
        IJth(rJacobian, 6, 6) = -0.01 - var_x302;
        IJth(rJacobian, 7, 6) = var_x317;
        IJth(rJacobian, 5, 7) = 8.7499999999999999e-5;
        IJth(rJacobian, 6, 7) = var_x316;
        IJth(rJacobian, 7, 7) = -8.7499999999999999e-5 + var_x317 - 1 / var_x305;
        ...
        IJth(rJacobian, 8, 8) = -1 / (4000.0 * var_x323 + 0.014 * var_x322) - 1 / (8000.0 * var_x319 + 9000000000.0 * var_x321);
        ...
        IJth(rJacobian, 9, 9) = -0.0040000000000000001 - var_x335;
        IJth(rJacobian, 10, 9) = var_x335 + var_x353;
        IJth(rJacobian, 11, 9) = 0.0040000000000000001 + var_x354;
        IJth(rJacobian, 12, 9) = var_x361;
        IJth(rJacobian, 13, 9) = -var_x361;
        IJth(rJacobian, 14, 9) = (0.18212526000000001 + var_x360 - 3.4769999999999999 * var_x30 - 3.4769999999999999 * var_chaste_interface__internal_ion_concentrations__Ca_Total) * var_chaste_interface__L_type_Ca_channel_Ca_dependent_gate__p_C;
        IJth(rJacobian, 29, 9) = -var_x422;
        IJth(rJacobian, 30, 9) = var_x422;
        IJth(rJacobian, 9, 10) = var_x337;
        IJth(rJacobian, 10, 10) = -0.040000000000000001 - var_x337;
        IJth(rJacobian, 11, 10) = var_x354;
        IJth(rJacobian, 9, 11) = 0.001;
        IJth(rJacobian, 10, 11) = var_x353;
        IJth(rJacobian, 11, 11) = -0.001 + var_x354 - 1 / var_x340;
        ...
        IJth(rJacobian, 12, 12) = -0.34999999999999998 + var_x364 - var_x362;
        IJth(rJacobian, 13, 12) = -0.00029999999999999997 + var_x362 + var_x363;
        IJth(rJacobian, 14, 12) = 0.3458;
        IJth(rJacobian, 29, 12) = var_x424;
        IJth(rJacobian, 30, 12) = var_x423;
        ...
        IJth(rJacobian, 29, 13) = var_x424;
        IJth(rJacobian, 30, 13) = var_x423;
        IJth(rJacobian, 12, 14) = 0.14299999999999999;
        IJth(rJacobian, 13, 14) = -0.00029999999999999997;
        IJth(rJacobian, 14, 14) = -0.1472 + var_x364;
        ...
        IJth(rJacobian, 15, 15) = -1 / (58.0 * var_x331 + 250000.0 * var_x365) - 1 / (66.0 * var_x327 + 1800.0 * var_x366);
        IJth(rJacobian, 29, 15) = -var_x425;
        IJth(rJacobian, 30, 15) = var_x425;
        ...
        IJth(rJacobian, 16, 16) = -1 / (1.5 * var_x369 + 40.0 * var_x370) - 1 / (0.019 * var_x367 + 0.81999999999999995 * var_x368);
        ...
        IJth(rJacobian, 17, 17) = -1 / (30.0 * var_x371 + 62000.0 * var_x372) - 1 / (1.2 * var_x374 + 0.00059999999999999995 * var_x373);
        ...
        IJth(rJacobian, 18, 18) = -1 / (7.0 * var_x376 + 8000.0 * var_x377) - var_x188 * var_x382;
        ...
        IJth(rJacobian, 19, 19) = -1 / (5.0 * var_x390 + 20.0 * var_x391) - 1 / (160.0 * var_x387 + 200.0 * var_x388) - 0.00040000000000000002 * var_x385;
        ...
        IJth(rJacobian, 20, 20) = -1 / (20.0 * var_x390 + 200.0 * var_x392) - 1 / (1600.0 * var_x387 + 2000.0 * var_x388) - 0.0001 * var_x385;
        ...
        IJth(rJacobian, 21, 21) = -1 / (2.0 * var_x395 + 0.34999999999999998 * var_x394) - 1 / (2.5 * var_x393 + 10.0 * var_x289);
        ...
        IJth(rJacobian, 22, 22) = -1 / (260.0 * var_x319 + 1450.0 * var_x304) - 1 / (85.0 * var_x396 + 370.0 * var_x397);
        ...
        IJth(rJacobian, 24, 24) = -1 / (11.0 * var_x398 + 0.20000000000000001 * var_x284) - 1 / (4.4000000000000004 * var_x400 + 0.20000000000000001 * var_x399);
        ...
        IJth(rJacobian, 25, 25) = -0.0038 * var_x407 - 0.0038 * var_x408;
        ...
        IJth(rJacobian, 26, 26) = -0.20379327210477693 - var_x46 - 1.0 / var_x410 - 0.6399652192815608 * var_x39;
        ...
        IJth(rJacobian, 27, 27) = -0.37 * var_x235 - 0.01 / (1.0 + 49.999265664512095 * var_x414) - 0.040000000000000001 * var_x234 - 0.16500000000000001 / (1.0331690520373935 + 0.069365261764196454 * var_x412);
        ...
        IJth(rJacobian, 28, 28) = -1.01 - var_x277 + 0.01 * var_x270 + 0.98999999999999999 * var_x276;
        ...
        IJth(rJacobian, 29, 29) = -0.080000000000000002 / var_x426;
        IJth(rJacobian, 30, 29) = var_x431;
        ...
        IJth(rJacobian, 29, 30) = var_x427 - var_x428;
        IJth(rJacobian, 30, 30) = -0.00084900000000000004 + var_x428 + var_x431 - var_x427;
        IJth(rJacobian, 3, 31) = (0.020080487777071866 + 0.21686926799237616 * var_x280) * var_chaste_interface__RyR_channel__p_open_RyR;
        IJth(rJacobian, 29, 31) = 0.00098765432098765434 * (-0.5 - 5.4000000000000004 * var_x280) * var_chaste_interface__RyR_channel__p_open_RyR / (pow(var_x426, 2) * var_x430);
        IJth(rJacobian, 30, 31) = 0.010993320000000001 * var_x429 * (0.18518518518518517 + 2 * var_x280) * (1.0 - var_chaste_interface__RyR_channel__p_close_RyR - var_chaste_interface__RyR_channel__p_open_RyR);
        ...
        IJth(rJacobian, 33, 33) = 0.99141000000000001 + var_x433 - var_x432;
        IJth(rJacobian, 34, 33) = var_x432;
        IJth(rJacobian, 3, 34) = var_x282 + 0.0027216000000000002 * var_x283;
        IJth(rJacobian, 4, 34) = -0.028000000000000004;
        IJth(rJacobian, 33, 34) = 1.0253100000000002 + var_x433;
        IJth(rJacobian, 34, 34) = -0.0339 + var_x435;
        ...
        IJth(rJacobian, 33, 35) = 1.0214100000000002 + var_x433;
        IJth(rJacobian, 34, 35) = -40.856400000000001 + var_x436 + var_x437;
        IJth(rJacobian, 35, 35) = 40.736400000000003 + var_x435 - var_x436 - var_x437;
        ...
        IJth(rJacobian, 34, 36) = var_x438 * var_chaste_interface__NL_model__pCaCB;
        IJth(rJacobian, 35, 36) = var_x438 * var_chaste_interface__NL_model__pCB;
