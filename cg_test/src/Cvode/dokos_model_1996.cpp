...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldokos_model_1996FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x219 = 0.0024000000000000002 * var_chaste_interface__ion_concentrations__Carel;
        ...
        const double var_x223 = var_x216 / pow(var_x220, 2);
        const double var_x224 = 0.0023533830328766889 * var_x78;
        const double var_x225 = 0.011074743684125594 * var_x82;
        const double var_x226 = -0.062185611894217119 + 0.011074743684125594 * var_x127 - 0.00082914149192289492 * var_chaste_interface__membrane__E;
        const double var_x227 = var_x226 * var_chaste_interface__L_type_calcium_current_f2_gate__fL2;
        const double var_x228 = -0.013214442527521138 + 0.0023533830328766889 * var_x127 - 0.00017619256703361517 * var_chaste_interface__membrane__E;
        ...
        const double var_x236 = 0.031 + 1.0 / var_x235;
        ...
        const double var_x250 = 1.0 - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x251 = exp(-3.0869999999999997 - 0.089999999999999997 * var_chaste_interface__membrane__E);
        const double var_x252 = 1.0 - var_x251;
        const double var_x253 = 0.20000000000000001 / var_x252;
        const double var_x254 = exp(-8.4299999999999997 - 0.14999999999999999 * var_chaste_interface__membrane__E);
        ...
        const double var_x258 = exp(-3.3918918918918921 - 0.13513513513513511 * var_chaste_interface__membrane__E);
        const double var_x259 = 1.0 + var_x258;
        const double var_x260 = exp(0.039800000000000002 * var_chaste_interface__membrane__E);
        const double var_x261 = exp(-0.050999999999999997 * var_chaste_interface__membrane__E);
        ...
        const double var_x273 = 0.011766915164383444 * var_x78;
        ...
        const double var_x277 = 0.066072212637605682 + 0.00088096283516807576 * var_chaste_interface__membrane__E - 0.011766915164383444 * var_x127;
        const double var_x278 = 0.40000000000000002 * var_chaste_interface__ion_concentrations__Carel;
        const double var_x279 = 0.049748489515373688 * var_x76;
        const double var_x280 = 2.1316730272442473e-5 * var_x97;
        const double var_x281 = 0.0028107896576186134 * var_x102;
        const double var_x282 = 3.7725937882491718e-8 * var_x99;
        ...
        const double var_x294 = 0.0044852711920708652 * var_x86;
        const double var_x295 = 0.0018738597717457425 * var_x102;
        const double var_x296 = 1.0778839394997632e-6 * var_x99;
        const double var_x297 = 0.0018738597717457425 * var_x178;
        ...
        const double var_x303 = 1.4509976108650658e-6 * var_x198;
        ...
        IJth(rJacobian, 1, 0) = -0.00017619256703361517 * var_x78 - 0.00082914149192289492 * var_x82 + var_x213 * var_x68 + var_x214 * var_x95;
        IJth(rJacobian, 2, 0) = 0.07575757575757576 * var_x231 / pow((1.0 + var_x231), 2);
        IJth(rJacobian, 3, 0) = -0.00016666666666666666 * var_x232 * var_x237 / pow(var_x233, 2) + 0.00012345679012345679 * var_x234 * (-var_chaste_interface__L_type_calcium_current_f_gate__fL + 1.0 / var_x233) / (pow(var_x235, 2) * pow(var_x236, 2));
        IJth(rJacobian, 5, 0) = 0.0001639344262295082 * var_x238 * var_x243 / pow(var_x239, 2) + 0.0055555555555555549 * var_x240 * (-var_chaste_interface__T_type_calcium_current_d_gate__dT + 1.0 / var_x239) / (pow(var_x241, 2) * pow((0.11111111111111109 + var_x242), 2));
        IJth(rJacobian, 6, 0) = -0.00015151515151515152 * var_x244 * var_x249 / pow(var_x245, 2) + 0.002 * var_x246 * (-var_chaste_interface__T_type_calcium_current_f_gate__fT + 1.0 / var_x245) / (pow(var_x247, 2) * pow((0.025000000000000001 + var_x248), 2));
        IJth(rJacobian, 7, 0) = var_x250 * var_x253 + 1.2 * var_x254 * var_chaste_interface__fast_sodium_current_m_gate__m - 0.017999999999999999 * var_x250 * var_x251 * var_x255 / pow(var_x252, 2);
        ...
        IJth(rJacobian, 9, 0) = (0.001 / var_x259 - 0.001 * var_chaste_interface__delayed_rectifying_potassium_current_x_gate__x) * (0.67660000000000009 * var_x260 - 0.010761 * var_x261) + 0.00013513513513513514 * var_x258 * (17.0 * var_x260 + 0.21099999999999999 * var_x261) / pow(var_x259, 2);
        IJth(rJacobian, 10, 0) = var_x262 * var_x265 - var_x268 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y + 2.1000000000000002e-5 * var_x266 * var_x269 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y / pow(var_x267, 2) - 2.376e-5 * var_x262 * var_x263 * var_x270 / pow(var_x264, 2);
        IJth(rJacobian, 11, 0) = 0.0041457074596144743 * var_x82 + 0.00088096283516807576 * var_x78 - var_x271 * var_x68 - var_x272 * var_x95;
        IJth(rJacobian, 14, 0) = -9.9496979030747391e-7 - 3.3580230422877238e-5 * var_x86 - 0.0010364268649036186 * var_x1 - 1.4122286398788724e-9 * var_x101 - var_x107 * var_x281 - var_x279 * var_x68 - var_x280 * var_x95;
        IJth(rJacobian, 15, 0) = 4.9748489515373691e-6 + 0.0001679011521143862 * var_x86 + 0.0051821343245180927 * var_x1 + 7.0611431993943612e-9 * var_x101 + var_x107 * var_x289 + var_x287 * var_x68 + var_x288 * var_x95;
        IJth(rJacobian, 16, 0) = -1.0863297229837478e-8 * var_x80 - 5.5967050704795398e-5 * var_x86 - 4.0349389710824922e-8 * var_x87 + var_x107 * var_x295;
        IJth(rJacobian, 17, 0) = 2.017469485541246e-7 * var_x87 + 5.4316486149187388e-8 * var_x80 + 0.00027983525352397697 * var_x86 - var_x107 * var_x300;
        ...
        IJth(rJacobian, 1, 1) = 8.7888998143826851e-5 * var_x217 - 8.7888998143826851e-5 * var_x218 + var_x120 * var_x213 + var_x125 * var_x214 + var_x219 * var_x222 - var_x121 * var_x224 - var_x121 * var_x225 - var_x219 * var_x223;
        ...
        IJth(rJacobian, 13, 1) = var_x223 * var_x278 - var_x222 * var_x278;
        ...
        IJth(rJacobian, 7, 7) = -8.0 * var_x254 - var_x253 * var_x255;
        IJth(rJacobian, 14, 7) = -0.0031092805947108555 * var_x133;
        IJth(rJacobian, 15, 7) = 0.015546402973554278 * var_x133;
        ...
        IJth(rJacobian, 9, 9) = -0.017000000000000001 * var_x260 - 0.00021100000000000001 * var_x261;
        ...
        IJth(rJacobian, 15, 10) = 0.0001679011521143862 * var_x139;
        ...
        IJth(rJacobian, 1, 11) = var_x155 * var_x213 + var_x159 * var_x214 + var_x160 * var_x224 + var_x160 * var_x225;
        ...
        IJth(rJacobian, 1, 13) = 0.0012000000000000001 * var_x229;
        IJth(rJacobian, 13, 13) = -0.20000000000000001 * var_x229;
        ...
        IJth(rJacobian, 15, 14) = var_x291 + 0.00013289692420950713 * var_x131 - 8.7837176800581675e-6 * var_x181 + var_x131 * var_x292 + var_x131 * var_x294 + var_x173 * var_x287 + var_x176 * var_x288 + var_x293 * var_chaste_interface__ion_concentrations__Ko;
        ...
        IJth(rJacobian, 15, 15) = -0.01 - 0.00013289692420950713 * var_x182 + var_x196 * var_x287 + var_x197 * var_x288 - var_x182 * var_x292 - var_x182 * var_x294 - var_x291 * var_x79;
        ...
        IJth(rJacobian, 14, 17) = 1.206564433321033e-8 * var_x211 - 2.2258303350670112e-8 * var_x204 - 6.1451821673865346e-5 * var_x208 + var_x212 * var_x281 - var_x285 * var_chaste_interface__ion_concentrations__Nai;
        IJth(rJacobian, 15, 17) = 0.00030725910836932674 * var_x208 + 1.1129151675335055e-7 * var_x204 - 6.0328221666051643e-8 * var_x211 + var_x293 * var_chaste_interface__ion_concentrations__Nai - var_x212 * var_x289;
        IJth(rJacobian, 16, 17) = 0.001495090397356955 * var_x206 + 2.0109407222017218e-8 * var_x210 - 1.189818040909354e-7 * var_x202 - 6.3595152430486023e-7 * var_x205 - 0.00010241970278977559 * var_x207 + var_x297 * var_chaste_interface__ion_concentrations__Nai + var_x298 * var_x79 + var_x299 * var_x79 - var_x212 * var_x295;
        IJth(rJacobian, 17, 17) = -0.01 + 5.9490902045467693e-7 * var_x202 + 0.00051209851394887792 * var_x207 + 3.179757621524301e-6 * var_x205 - 1.0054703611008608e-7 * var_x210 - 0.0074754519867847747 * var_x206 + var_x212 * var_x300 - var_x302 * var_chaste_interface__ion_concentrations__Nai - var_x303 * var_x79 - var_x304 * var_x79;
    }
