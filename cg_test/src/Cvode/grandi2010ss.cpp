...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellgrandi2010ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__cell__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x196 = 1.0 / pow(var_x195, 2);
        ...
        const double var_x203 = 1.0 * ((var_x197) ? (0.0) : (0.057000000000000002 * var_x198));
        const double var_x204 = 1.0 * ((var_x197) ? (5.9230769230769234 / var_x200) : (310000.0 * var_x201 + 2.7000000000000002 * var_x202));
        ...
        const double var_x222 = 1.0 * ((var_x197) ? (0.0) : (var_x212 * var_x213));
        const double var_x223 = 1.0 * ((var_x197) ? (0.59999999999999998 * var_x217) : (0.024240000000000001 * var_x221));
        ...
        const double var_x250 = 1.0 / var_x248;
        ...
        const double var_x259 = 1.0 / var_x257;
        ...
        IJth(rJacobian, 1, 0) = 59.906641489902128 * (-var_chaste_interface__cell__sm + 1.0 / pow(var_x190, 2)) * (-var_x191 * (-0.3792264410025028 - 0.0082818615637148471 * var_chaste_interface__cell__sVm) - var_x192 * (0.0036911829173615863 - 0.00076532923851577563 * var_chaste_interface__cell__sVm)) / pow((var_x188 + 0.5020897832817337 * var_x187), 2) + 0.22148394241417499 * var_x189 * var_x193 / pow(var_x190, 3);
        IJth(rJacobian, 2, 0) = (var_x196 - var_chaste_interface__cell__sh) * (1.0 * ((var_x197) ? (0) : (-0.008382352941176471 * var_x198)) + 1.0 * ((var_x197) ? (0.53361053361053368 * var_x199 / pow(var_x200, 2)) : (108035.0 * var_x201 + 0.21330000000000002 * var_x202))) - var_x205 * (var_x203 + var_x204);
        IJth(rJacobian, 3, 0) = (var_x196 - var_chaste_interface__cell__sj) * (1.0 * ((var_x197) ? (0) : (var_x212 + var_x208 * var_x213 * (3.0508668000000001e-7 * var_x210 - 6214.6032000000005 * var_x209) - 0.311 * var_x206 * var_x211 * var_x213 / pow(var_x207, 2))) + 1.0 * ((var_x197) ? (0.034200000000000001 * var_x217 + 0.059999999999999998 * var_x214 * var_x216 / pow(var_x215, 2)) : (-0.00025500480000000003 * var_x221 + 0.0033402720000000005 * var_x218 * var_x220 / pow(var_x219, 2)))) - var_x205 * (var_x222 + var_x223);
        ...
        IJth(rJacobian, 5, 0) = (0.02 + var_x236) * (0.029999999999999999 * var_x238 / pow(var_x239, 2) - 0.1111111111111111 * var_x241 / pow(var_x242, 2)) + var_x236 * (-0.032935010000000001 - 0.0022713799999999999 * var_chaste_interface__cell__sVm) * (-var_chaste_interface__cell__sf + 1.0 / var_x242 + 0.59999999999999998 / var_x239);
        ...
        IJth(rJacobian, 12, 0) = 9.1827364554637282e-8 * (-var_chaste_interface__cell__sxkr + 1.0 / var_x275) * (11.5 * var_x264 / pow(var_x265, 2) + 366.66666666666669 * var_x267 * var_x272 / pow(var_x268, 2) - 366.66666666666669 * var_x269 * var_x270 / pow(var_x271, 2)) / pow((var_x273 + 0.069696969696969702 * var_x266), 2) + 0.20000000000000001 * var_x274 * var_x276 / pow(var_x275, 2);
        IJth(rJacobian, 13, 0) = -7.1529673512819408e-5 * var_x279 * (-var_chaste_interface__cell__sxks + 1.0 / var_x278) + 0.070175438596491224 * var_x277 * (0.00100999899000101 + var_x280) / pow(var_x278, 2);
