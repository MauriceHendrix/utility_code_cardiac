...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 7.5743475924998857e-8 * var_x18;
        ...
        IJth(rJacobian, 3, 0) = (0.001 / var_x120 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) * (var_x124 + var_x128 - 0.0089997000000000011 * var_x121 * var_x129 / pow(var_x122, 2) - 0.0106412 * var_x125 * var_x129 / pow(var_x126, 2)) + 5.988023952095809e-5 * var_x119 * (var_x124 * var_x129 + var_x128 * var_x129) / pow(var_x120, 2);
        ...
        IJth(rJacobian, 14, 0) = -3.7909647610109532e-7 + 9.7391514846836631e-10 * var_x58 - 2.2723042777499654e-7 * var_x18 - 1.3634812078557129e-7 * var_x54 - 13.587275666108772 * var_x21 - 0.0031591373008424614 * var_x9 - 0.00044917495604311853 * var_x29 - var_x181 * var_x42;
        IJth(rJacobian, 15, 0) = 1.9478302969367326e-10 * var_x57 + 2.0272937282365629e-6 * var_x28 + 0.00018692798291666742 * var_x48 - 3.1591373008424612e-6 * var_x6 - 3.6104426295342415e-5 * var_x4 - 7.7913211877469303e-10 * var_x54 - 0.0041871868173333493 * var_x26 - 0.016806610440481894 * var_x5 - var_x182 * var_x42;
        ...
        IJth(rJacobian, 1, 1) = -7.0000000000000009 + var_x93 + var_x94 + 0.00040000000000000002 * var_x98 - 0.20784009793819685 * var_x61 - 7.2e-9 * var_x99 - 1.0549054718227806e-6 * var_x60 - 5.2262998388249204e-10 * var_x64 - 0.00040000000000000002 * var_x96;
        ...
        IJth(rJacobian, 14, 1) = 0.62352029381459051 * var_x61 + 1.5678899516474762e-9 * var_x64;
        ...
        IJth(rJacobian, 2, 2) = -0.00060999999999999997 * var_x111 * var_x118 - 0.0013799999999999999 * var_x115 * var_x117;
        ...
        IJth(rJacobian, 3, 3) = -7.1899999999999999e-5 * var_x127 * var_x129 - 0.00013100000000000001 * var_x123 * var_x129;
        ...
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x131) ? (2000.0) : (var_x130 * var_x135)) - 8.0 * var_x136;
        ...
        IJth(rJacobian, 14, 5) = -13.587275666108772 * var_x72 * NV_Ith_S(mParameters, 0);
        ...
        IJth(rJacobian, 7, 7) = -0.0035999999999999999 / var_x156 - 0.00029999999999999997 * ((var_x150) ? (25.0) : (var_x149 * var_x154));
        ...
        IJth(rJacobian, 14, 14) = 6.634188331769168e-7 * var_x83 - 0.0010614701330830668 * var_x81 - 2.6016936179035892e-8 * var_x88 - 1.0127092529498693e-5 * var_x82 - 1.3633825666499794e-6 * var_x85 - 50989.636493120743 * var_x87;
        ...
        IJth(rJacobian, 15, 15) = 5.4156639443013623e-5 * var_x92 - 8.4392437745822447e-5 * var_x90 - 5.2033872358071785e-9 * var_x88 - 0.11185550647567587 * var_x91 - 3.6815357042237582 * var_x86 - 0.00096448500280939937 * var_x89;
        ...
        IJth(rJacobian, 1, 17) = 7.2e-9 * var_x96 + 9.5999999999999999e-8 * var_x98 - 1.7279999999999999e-12 * var_x99;
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x99 - 3.5279999999999993e-7 * var_x96 - 4.7040000000000002e-6 * var_x98;
