...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellsakmann_model_2000_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x0 = exp(-8.2481800602855024 - 0.14218279019507479 * var_chaste_interface__membrane__V);
        const double var_x1 = 1.0 + var_x0;
        const double var_x2 = 1 / var_x1;
        const double var_x3 = pow(var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs, 2);
        const double var_x4 = 1 / var_chaste_interface__intracellular_potassium_concentration__K_i;
        const double var_x5 = log(4.0 * var_x4);
        const double var_x6 = exp(-0.56150836234118207 + 0.056150836234118207 * var_chaste_interface__membrane__V - 1.5 * var_x5);
        ...
        const double var_x21 = var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x27 = var_x0 * (-51.539700000000003 + var_chaste_interface__membrane__V) / pow(var_x1, 2);
        ...
        const double var_x58 = var_x13 * var_x18;
        const double var_x59 = 2.0 * var_x16;
        const double var_x60 = 2744000.0 * var_x18;
        const double var_x61 = (var_x59 - var_x60 * var_chaste_interface__intracellular_calcium_concentration__Ca_i) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_i), 2);
        ...
        const double var_x64 = (-26.713760659695652 * log(8.1999999999999993 / var_x63) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs;
        ...
        const double var_x67 = var_x66 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x81 = var_x3 * (0.12195121951219512 * var_chaste_interface__intracellular_potassium_concentration__K_i + 0.0036585365853658534 * var_chaste_interface__intracellular_sodium_concentration__Na_i) / pow(var_x63, 2);
        ...
        const double var_x85 = var_x11 * var_x4 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr;
        const double var_x86 = var_x21 * var_x4;
        ...
        const double var_x102 = exp(-2.8666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x107 = 0.60999999999999999 * var_x106;
        ...
        const double var_x111 = 1.3799999999999999 * var_x110;
        ...
        const double var_x114 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__membrane__V);
        ...
        const double var_x119 = 0.13100000000000001 * var_x118;
        ...
        const double var_x123 = 0.071899999999999992 * var_x122;
        ...
        const double var_x132 = -0.125 * var_chaste_interface__membrane__V;
        const double var_x133 = exp(-9.3737545557863378 + var_x132);
        const double var_x134 = exp(-7.4990036446290711 + var_x127);
        const double var_x135 = 0.0030000000000000001 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x136 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x137 = fabs(var_x136) < 0.0001;
        const double var_x138 = exp(-2.6388888888888888 - 0.1388888888888889 * var_chaste_interface__membrane__V);
        const double var_x139 = 1.0 - var_x138;
        const double var_x140 = 30.0 / var_x139;
        const double var_x141 = exp(1.0555555555555556 + 0.055555555555555552 * var_chaste_interface__membrane__V);
        const double var_x142 = -1.0 + var_x141;
        const double var_x143 = 12.0 / var_x142;
        const double var_x144 = 34.0 + var_chaste_interface__membrane__V;
        ...
        const double var_x150 = exp(-6.666666666666667 - var_x146);
        ...
        const double var_x154 = exp(-1.25 + var_x132);
        ...
        const double var_x176 = 0.0016440603555991614 * var_x23;
        const double var_x177 = 2.6016936179035892e-8 * var_x45;
        const double var_x178 = 5.0664960489733526e-7 * var_x11;
        const double var_x179 = 5.2033872358071785e-9 * var_x36;
        const double var_x180 = 8.4392437745822447e-5 * var_x5 - 3.1591373008424612e-6 * var_chaste_interface__membrane__V;
        const double var_x181 = 5.2033872358071781e-5 * var_x43;
        const double var_x182 = -var_x101;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0070247933884297516 + 0.00029585289450195546 * var_x28 + 0.010191244960939838 * var_x53 + 2.5478112402349594e-6 * var_x55 + 1.2739056201174797e-5 * var_x56 + 0.026517514160150277 * var_x26 - 0.0050000000000000001 * var_x2 - 0.0009907438016528926 * var_x20 - 0.020382489921879677 * var_x50 - 0.041322314049586778 * var_x21 - 0.00071091395097537394 * var_x27 - 0.026600000000000002 * var_x3 - 0.0017936591131254116 * var_x52 - 0.47225501770956319 * var_x8 - var_x12 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x24 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x33 * var_x44 - var_x34 * var_x37 - var_x34 * var_x46 - 9.9173553719008269e-7 * var_x22 * (var_x17 + var_x19 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds));
        IJth(rJacobian, 1, 0) = -7.8978432521061529e-8 + 7.5743475924998857e-8 * var_x20;
        IJth(rJacobian, 2, 0) = (0.001 / var_x103 - 0.001 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr) * (var_x107 + var_x111 - 0.16973999999999997 * var_x108 * var_x112 / pow(var_x109, 2) - 0.088449999999999987 * var_x104 * var_x113 / pow(var_x105, 2)) + 0.00013333333333333334 * var_x102 * (var_x107 * var_x113 + var_x111 * var_x112) / pow(var_x103, 2);
        IJth(rJacobian, 3, 0) = (0.001 / var_x115 - 0.001 * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs) * (var_x119 + var_x123 - 0.0089997000000000011 * var_x116 * var_x124 / pow(var_x117, 2) - 0.0106412 * var_x120 * var_x124 / pow(var_x121, 2)) + 5.988023952095809e-5 * var_x114 * (var_x119 * var_x124 + var_x123 * var_x124) / pow(var_x115, 2);
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x126) ? (0) : (var_x130 - 20.0 * var_x125 * var_x128 / pow(var_x129, 2))) + 0.44800000000000001 * var_x131 * var_chaste_interface__fast_sodium_current_m_gate__m;
        IJth(rJacobian, 5, 0) = -0.125 * var_x133 * (0.02 - 0.02 * var_chaste_interface__fast_sodium_current_h_gate__h) - 0.00062500000000000001 * var_x134 * var_chaste_interface__fast_sodium_current_h_gate__h / pow((0.0031250000000000002 + var_x134), 2);
        IJth(rJacobian, 6, 0) = (0.0030000000000000001 - var_x135) * ((var_x137) ? (0) : (var_x140 - 4.166666666666667 * var_x136 * var_x138 / pow(var_x139, 2))) - var_x135 * ((var_x137) ? (0) : (var_x143 - 0.66666666666666663 * var_x136 * var_x141 / pow(var_x142, 2)));
        IJth(rJacobian, 7, 0) = (0.00029999999999999997 - 0.00029999999999999997 * var_chaste_interface__L_type_Ca_channel_f_gate__f) * ((var_x145) ? (0) : (var_x149 - 1.2254901960784315 * var_x144 * var_x147 / pow(var_x148, 2))) - 0.00070588235294117652 * var_x150 * var_chaste_interface__L_type_Ca_channel_f_gate__f / pow(var_x151, 2);
        IJth(rJacobian, 10, 0) = -0.058823529411764705 * var_x153 * (3.3000000000000003e-5 - 3.3000000000000003e-5 * var_chaste_interface__transient_outward_current_s_gate__s) - 0.0041250000000000002 * var_x154 * var_chaste_interface__transient_outward_current_s_gate__s / pow(var_x155, 2);
        IJth(rJacobian, 11, 0) = 0.066600000000000006 * var_x156 / pow((1.0 + var_x156), 2);
        IJth(rJacobian, 14, 0) = -3.7909647610109532e-7 + 9.7391514846836631e-10 * var_x56 - 2.2723042777499654e-7 * var_x20 - 1.3634812078557129e-7 * var_x52 - 3.8225561340193784e-7 * var_x2 - 5.4350169681217345e-8 * var_x27 - var_x176 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x177 * var_x34;
        IJth(rJacobian, 15, 0) = 1.9478302969367326e-10 * var_x55 + 2.0272937282365629e-6 * var_x26 + 2.2618285932916757e-8 * var_x28 - 3.1591373008424612e-6 * var_x21 - 2.0335998632983093e-6 * var_x3 - 3.6104426295342415e-5 * var_x8 - 7.7913211877469303e-10 * var_x52 - var_x178 * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr_gate__xr - var_x179 * var_x34;
        IJth(rJacobian, 16, 0) = 3.8956605938734649e-6 * var_x53 - 7.7913211877469299e-6 * var_x50 - var_x181 * var_x33;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (2718.6009917355373 * var_x58 + 6.836132231404959e-6 * var_x61 - 0.027596860185636004 * var_x57 - 0.13612323935543807 * var_x62);
        IJth(rJacobian, 1, 1) = -7.0000000000000009 + var_x88 + var_x89 + 0.00040000000000000002 * var_x93 - 0.20784009793819685 * var_x58 - 7.2e-9 * var_x94 - 1.0549054718227806e-6 * var_x57 - 5.2262998388249204e-10 * var_x61 - 0.00040000000000000002 * var_x91;
        ...
        IJth(rJacobian, 12, 1) = -var_x171 + var_x157 * var_x170;
        IJth(rJacobian, 13, 1) = var_x171;
        IJth(rJacobian, 14, 1) = 0.62352029381459051 * var_x58 + 1.5678899516474762e-9 * var_x61;
        IJth(rJacobian, 16, 1) = -5.2033872358071781e-5 * var_x62;
        IJth(rJacobian, 17, 1) = 0.019599999999999999 * var_x91 + 3.5279999999999993e-7 * var_x94 - 0.019599999999999999 * var_x93;
        IJth(rJacobian, 19, 1) = 2.0 - var_x88;
        IJth(rJacobian, 20, 1) = 5.0 - var_x89;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x12 * var_x25);
        IJth(rJacobian, 2, 2) = -0.00060999999999999997 * var_x106 * var_x113 - 0.0013799999999999999 * var_x110 * var_x112;
        IJth(rJacobian, 15, 2) = -var_x178 * var_x25;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.053200000000000004 * var_x64);
        IJth(rJacobian, 3, 3) = -7.1899999999999999e-5 * var_x122 * var_x124 - 0.00013100000000000001 * var_x118 * var_x124;
        ...
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x126) ? (2000.0) : (var_x125 * var_x130)) - 8.0 * var_x131;
        IJth(rJacobian, 14, 4) = -0.0049321810667974841 * var_x67;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x24 * var_x66);
        IJth(rJacobian, 5, 5) = -0.02 * var_x133 - 2.0 / (1.0 + 320.0 * var_x134);
        IJth(rJacobian, 14, 5) = -var_x176 * var_x66;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x69 - var_x44 * var_x68 - var_x46 * var_x69);
        IJth(rJacobian, 6, 6) = -0.0030000000000000001 * ((var_x137) ? (120.0) : (var_x136 * var_x140)) - 0.0030000000000000001 * ((var_x137) ? (120.0) : (var_x136 * var_x143));
        IJth(rJacobian, 14, 6) = -var_x177 * var_x69;
        IJth(rJacobian, 15, 6) = -var_x179 * var_x69;
        IJth(rJacobian, 16, 6) = -var_x181 * var_x68;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x72 - var_x44 * var_x71 - var_x46 * var_x72);
        IJth(rJacobian, 7, 7) = -0.0035999999999999999 / var_x151 - 0.00029999999999999997 * ((var_x145) ? (25.0) : (var_x144 * var_x149));
        IJth(rJacobian, 14, 7) = -var_x177 * var_x72;
        IJth(rJacobian, 15, 7) = -var_x179 * var_x72;
        IJth(rJacobian, 16, 7) = -var_x181 * var_x71;
        ...
        IJth(rJacobian, 14, 9) = -var_x177 * var_x74;
        IJth(rJacobian, 15, 9) = -var_x179 * var_x74;
        IJth(rJacobian, 16, 9) = -var_x181 * var_x73;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 10, 10) = -0.033000000000000002 / var_x155 - 3.3000000000000003e-5 * var_x153;
        IJth(rJacobian, 15, 10) = var_x180 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 15, 11) = var_x180 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 12) = (0.10204081632653063 * var_x97 - 0.10204081632653063 * var_x99) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 12, 12) = var_x173 + var_x164 * (-0.059999999999999998 - var_x172);
        IJth(rJacobian, 13, 12) = var_x164 * (0.059999999999999998 + var_x172);
        IJth(rJacobian, 18, 12) = (0.5 * var_x99 - 0.5 * var_x97) * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        IJth(rJacobian, 12, 13) = var_x173;
        IJth(rJacobian, 13, 13) = -0.001 * var_x164;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (0.0028925619834710742 * var_x78 - 0.1324649288910528 * var_x76 - 4.6280991735537187 * var_x77 - 80701.836668389034 * var_x82 - 0.0059444628099173556 * var_x80 - 0.00034030809838859523 * var_x83 - 0.17480416425278444 * var_x81 - 5.9504132231404965e-6 * var_x22 * var_x79);
        IJth(rJacobian, 1, 14) = 4.5446085554999309e-7 * var_x80;
        IJth(rJacobian, 14, 14) = 6.634188331769168e-7 * var_x78 - 0.0010614701330830668 * var_x77 - 6.1697460156676094 * var_x82 - 2.6016936179035892e-8 * var_x83 - 1.0127092529498693e-5 * var_x76 - 1.3633825666499794e-6 * var_x80;
        IJth(rJacobian, 15, 14) = 0.00070764675538871125 * var_x77 - 1.3363974606332242e-5 * var_x81 - 4.4227922211794452e-7 * var_x78;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.70838252656434475 * var_x87 - 6.8061619677719048e-5 * var_x83 - 5.8268054750928151 * var_x81 - 12.615707513433602 * var_x84 - 0.17703489247815674 * var_x85 - 1.1038744074254401 * var_x86 - 9684.2204002066846 * var_x82);
        IJth(rJacobian, 14, 15) = -0.74036952188011318 * var_x82;
        IJth(rJacobian, 15, 15) = 5.4156639443013623e-5 * var_x87 - 8.4392437745822447e-5 * var_x86 - 5.2033872358071785e-9 * var_x83 - 1.3534516283556781e-5 * var_x85 - 0.00044546582021107476 * var_x81 - 0.00096448500280939937 * var_x84;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (2.721322314049587 * var_x18 * var_x22 + 6.8429752066115703e-9 * (var_x59 - var_x60 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds) / pow((0.0068999999999999999 + var_chaste_interface__intracellular_calcium_concentration__Ca_ds), 2));
        IJth(rJacobian, 1, 16) = 0.001;
        IJth(rJacobian, 9, 16) = -0.02 / var_x152 + 0.02 * var_chaste_interface__intracellular_calcium_concentration__Ca_ds / pow(var_x152, 2);
        IJth(rJacobian, 12, 16) = -var_x175 + var_x157 * var_x174;
        IJth(rJacobian, 13, 16) = var_x175;
        IJth(rJacobian, 16, 16) = -0.01;
        IJth(rJacobian, 1, 17) = 7.2e-9 * var_x91 + 9.5999999999999999e-8 * var_x93 - 1.7279999999999999e-12 * var_x94;
        IJth(rJacobian, 17, 17) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x94 - 3.5279999999999993e-7 * var_x91 - 4.7040000000000002e-6 * var_x93;
        IJth(rJacobian, 18, 17) = 0.0050000000000000001;
        IJth(rJacobian, 1, 18) = 1.0204081632653063e-5 + 0.051020408163265314 * var_x100;
        IJth(rJacobian, 17, 18) = 0.050000000000000003;
        IJth(rJacobian, 18, 18) = -0.0050499999999999998 - 0.25 * var_x100;
        IJth(rJacobian, 1, 19) = 0.050000000000000003 + var_x101;
        IJth(rJacobian, 19, 19) = -0.050000000000000003 + var_x182;
        IJth(rJacobian, 1, 20) = 0.20000000000000001 + var_x101;
        IJth(rJacobian, 20, 20) = -0.20000000000000001 + var_x182;
    }
