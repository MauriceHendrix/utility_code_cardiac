...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellespinosa_model_1998_normalFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x185 = 1.4191056097655941e-8 * var_x42;
        const double var_x186 = 0.0013268376663538336 * var_x92;
        const double var_x187 = 9.2878636644768355e-6 + 5.2631227432035401e-5 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        const double var_x190 = 5.215213115888558e-9 * var_x40;
        const double var_x191 = 0.001083584094188964 * var_x92;
        const double var_x192 = 0.0024811376697271795 * var_x11;
        ...
        const double var_x201 = 6.7695799303767029e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        IJth(rJacobian, 13, 0) = -6.3182746016849228e-8 + 5.3122644461910889e-10 * var_x63 - 3.7871737962499429e-7 * var_x31 - 7.8887127025937665e-8 * var_x56 - 0.00037909647610109533 * var_x3 - var_x185 * var_x37;
        ...
        IJth(rJacobian, 15, 0) = -2.5273098406739689e-6 + var_x197 + 1.5936793338573268e-10 * var_x62 + 4.7398127366170842e-6 * var_x53 - 1.5936793338573268e-10 * var_x60 - 2.5341171602957037e-7 * var_x16 - var_x198 * var_chaste_interface__extracellular_potassium_concentration__K_o - var_x199 * var_x37;
        ...
        IJth(rJacobian, 1, 1) = -7.0000000000000009 + var_x112 + var_x113 + 0.00040000000000000002 * var_x117 - 7.7098266909426358e-12 * var_x72 - 0.41340273157434637 * var_x74 - 7.2e-9 * var_x118 - 1.0549054718227806e-6 * var_x67 - 0.00040000000000000002 * var_x115 - 8.7104997313748684e-10 * var_x73;
        ...
        IJth(rJacobian, 15, 2) = 6.7695799303767029e-6 * var_x15 - 6.7695799303767029e-6 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        IJth(rJacobian, 14, 9) = (5.2631227432035401e-5 * var_chaste_interface__membrane__V - 0.0014059780128454018 * var_x6) * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 13, 13) = 8.2927354147114598e-7 * var_x102 + 5.2972171058904767e-17 * var_x98 - 1.687848754916449e-6 * var_x88 - 0.010127092529498692 * var_x94 - 2.8403803471874572e-6 * var_x97 - 1.4191056097655941e-8 * var_x103 - var_x186 * var_chaste_interface__extracellular_potassium_concentration__K_o;
        ...
        IJth(rJacobian, 14, 14) = -0.00069999999999999999 + var_x195 - var_x192 + 0.001083584094188964 * var_x110 - 8.2704588990905987e-5 * var_x104 - 5.215213115888558e-9 * var_x56 - 9.2878636644768348e-7 * var_x111 + var_x189 * var_x51 - var_x104 * var_x194 - var_x14 * var_x193 - var_x191 * var_chaste_interface__intracellular_sodium_concentration__Na_i;
        ...
        IJth(rJacobian, 14, 15) = var_x193 + 8.2704588990905987e-5 * var_x4 + 5.215213115888558e-9 * var_x103 + var_x192 * var_x5 + var_x194 * var_x4 - var_x195 * var_x5;
