...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x85 = 0.0072727272727272727 * var_x74;
        const double var_x86 = ((var_x76) ? (0) : (var_x81 - 0.032000000000000001 * var_x77 * var_x79 / pow(var_x80, 2)));
        ...
        const double var_x97 = ((var_x88) ? (-0.019852941176470591 * var_x87) : (0));
        const double var_x98 = ((var_x88) ? (0.28123999999999999 * var_x91 + 108500.0 * var_x90) : (0.693000693000693 * var_x92 / pow(var_x93, 2)));
        ...
        const double var_x119 = ((var_x88) ? (-0.001275024 * var_x102 + 0.016701360000000002 * var_x101 * var_x99 / pow(var_x100, 2)) : (-7.6049999999999996e-8 * var_x106 + 0.029999999999999999 * var_x103 * var_x105 / pow(var_x104, 2)));
        const double var_x120 = ((var_x88) ? (var_x115 + var_x108 * var_x111 * (1.5254334000000001e-6 * var_x113 - 31073.016 * var_x112) - 0.311 * var_x108 * var_x109 * var_x114 / pow(var_x110, 2)) : (0));
        ...
        const double var_x128 = 1.9500000000000002 * (0.016949152542372881 * var_x123 + 0.11764705882352941 * var_x124) / pow(var_x125, 2) - 0.018352941176470589 * var_x127 / pow((1 + 0.40000000000000002 * var_x127), 2);
        ...
        const double var_x133 = exp(8.1320754716981138 + 0.18867924528301888 * var_chaste_interface__membrane__V);
        ...
        const double var_x139 = exp(-3.15625 - 0.10416666666666667 * var_chaste_interface__membrane__V);
        const double var_x140 = 1.0 + var_x139;
        const double var_x141 = exp(-3.6189956331877728 + 0.036390101892285295 * var_chaste_interface__membrane__V);
        ...
        const double var_x147 = exp(-2.1692307692307691 - 0.15384615384615385 * var_chaste_interface__membrane__V);
        ...
        const double var_x162 = exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V);
        ...
        const double var_x175 = exp(-1.25 - 0.125 * var_chaste_interface__membrane__V);
        ...
        const double var_x184 = 0.005608974358974359 * var_x177 * var_x178;
        ...
        const double var_x187 = exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V);
        ...
        const double var_x191 = var_x190 - 2.7189219554066812e-7 * var_x46 - 0.00011173862339878819 * var_x19;
        ...
        const double var_x203 = 0.125 * var_x202;
        const double var_x204 = var_x32 * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x205 = -15.246234849736588 + 0.23455745922671672 * var_chaste_interface__membrane__V;
        const double var_x206 = var_x203 * var_x205;
        const double var_x207 = var_x32 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x208 = var_x31 * NV_Ith_S(mParameters, 0);
        ...
        const double var_x212 = 264667.15435259696 * var_x202;
        const double var_x213 = var_x194 * var_x209;
        const double var_x214 = var_x197 + 306.61078260627482 * var_x68;
        ...
        const double var_x222 = 0.47846889952153115 * var_x221;
        const double var_x223 = var_x205 * var_x220;
        const double var_x224 = var_x205 * var_x222;
        const double var_x225 = 1013080.0166606582 * var_x221;
        const double var_x226 = exp(2.3529411764705883 + var_x169);
        ...
        const double var_x235 = var_x228 * var_x230;
        const double var_x236 = ((var_x229) ? (1.0833333333333333) : (var_x228 * var_x234));
        const double var_x237 = 5.9145564270171174e-6 * var_x34;
        const double var_x238 = var_x237 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x242 = 4.2880534095874102e-10 * NV_Ith_S(mParameters, 0);
        const double var_x243 = 4.6918356272010785e-8 * var_x33;
        const double var_x244 = var_x241 * (3.0496931576807009e-6 - 4.6918356272010785e-8 * var_chaste_interface__membrane__V);
        const double var_x245 = 0.21176470588235291 * var_x241;
        ...
        const double var_x250 = 1.2526727201836255e-7 * var_x5;
        const double var_x251 = 2.2302249193675268e-8 * var_x10;
        ...
        IJth(rJacobian, 1, 0) = var_x83 * (var_x84 * var_x86 + var_x82 * (var_x85 - var_x86) / pow(var_x83, 2)) + (var_x86 - var_x85) * (-var_chaste_interface__fast_sodium_current_m_gate__m + var_x82 * var_x84);
        IJth(rJacobian, 2, 0) = var_x95 * (var_x96 * var_x97 + var_x89 * (-var_x97 - var_x98) / pow(var_x95, 2)) + (var_x97 + var_x98) * (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x89 * var_x96);
        IJth(rJacobian, 3, 0) = var_x117 * (var_x118 * var_x120 + var_x116 * (-var_x119 - var_x120) / pow(var_x117, 2)) + (var_x119 + var_x120) * (-var_chaste_interface__fast_sodium_current_j_gate__j + var_x116 * var_x118);
        IJth(rJacobian, 4, 0) = var_x128 * (1 / var_x122 - var_chaste_interface__transient_outward_K_current_oa_gate__oa) + 0.057012542759407071 * var_x121 * var_x131 / pow(var_x122, 2);
        IJth(rJacobian, 5, 0) = (1 / var_x134 - var_chaste_interface__transient_outward_K_current_oi_gate__oi) * (0.00031887818877678569 * var_x135 / pow((1 + 0.028121484814398197 * var_x135), 2) - 0.00079791438902835471 * var_x136 / pow((1 + 0.053966540744738258 * var_x136), 2)) - 0.18867924528301888 * var_x133 * (var_x137 + var_x138) / pow(var_x134, 2);
        IJth(rJacobian, 6, 0) = var_x128 * (1 / var_x140 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua) + 0.10416666666666667 * var_x131 * var_x139 / pow(var_x140, 2);
        IJth(rJacobian, 7, 0) = (1 / var_x142 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui) * (0.1875 * var_x143 + 0.00024295432458697764 * var_x144 / pow((1 + 0.047619047619047616 * var_x144), 2)) - 0.036390101892285295 * var_x141 * (var_x145 + var_x146) / pow(var_x142, 2);
        IJth(rJacobian, 8, 0) = (1 / var_x148 - var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr) * (((var_x150) ? (0) : (var_x154 - 5.9999999999999995e-5 * var_x149 * var_x152 / pow(var_x153, 2))) + ((var_x156) ? (0) : (var_x159 - 1.4422780412592461e-5 * var_x155 * var_x157 / pow(var_x158, 2)))) + 0.15384615384615385 * var_x147 * (var_x160 + var_x161) / pow(var_x148, 2);
        IJth(rJacobian, 9, 0) = (pow(var_x163, (-0.5)) - var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs) * (2.0 * ((var_x165) ? (0) : (var_x168 - 3.8888888888888887e-6 * var_x164 * var_x166 / pow(var_x167, 2))) + 2.0 * ((var_x165) ? (0) : (var_x172 - 2.3529411764705885e-6 * var_x164 * var_x170 / pow(var_x171, 2)))) + 0.03937007874015748 * var_x162 * pow(var_x163, (-1.5)) * (var_x173 + var_x174);
        IJth(rJacobian, 10, 0) = (1 / var_x176 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((var_x179) ? (-0.034998124100548214 * var_x177) : (var_x183 - var_x181 * var_x184 - var_x182 * var_x184 / pow(var_x180, 2))) + 0.125 * var_x175 * var_x185 / pow(var_x176, 2);
        IJth(rJacobian, 11, 0) = (0.0022222222222222222 + var_x186) * (-0.14492753623188406 * var_x189 + 0.14492753623188406 * pow(var_x187, 2) / pow(var_x188, 2)) + var_x186 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V) * (var_x189 - var_chaste_interface__L_type_Ca_channel_f_gate__f);
        IJth(rJacobian, 13, 0) = -var_x191 * var_x203;
        IJth(rJacobian, 14, 0) = var_x191 * var_x220 + var_x191 * var_x222;
        IJth(rJacobian, 15, 0) = (1.0 - 1 / var_x227 - var_chaste_interface__Ca_release_current_from_JSR_w_gate__w) * ((var_x229) ? (0) : (var_x234 - 0.01 * var_x232 * var_x235 - 0.033333333333333333 * var_x233 * var_x235 / pow(var_x231, 2))) - 0.058823529411764705 * var_x226 * var_x236 / pow(var_x227, 2);
        IJth(rJacobian, 16, 0) = -3.3526492139188636e-10 * var_x19 - 8.1579594228290865e-13 * var_x46 - 5.1141008336491763e-10 * NV_Ith_S(mParameters, 0) - 1.0670035173794672e-6 * var_x44 - var_x238 * var_x37;
        IJth(rJacobian, 17, 0) = var_x241 * (-var_x242 - var_x243 + 2.7193198076096957e-13 * var_x46 + 1.1175497379729545e-10 * var_x19);
        IJth(rJacobian, 18, 0) = 7.1133567825297815e-7 * var_x44 + 9.9563612471764592e-10 * var_x47 + 4.7771417295138258e-9 * var_x30 - 6.8244881850197507e-8 * var_x4 - 2.9164479423161327e-9 * var_x48 - 9.8129891902512382e-8 * var_x1 - 7.5827646500219453e-7 * var_x26 - var_x12 * var_x251 - var_x250 * var_x7;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-23.399999999999999 * var_x51);
        IJth(rJacobian, 1, 1) = -var_x75 - var_x82;
        ...
        IJth(rJacobian, 2, 2) = -var_x89 - var_x94;
        IJth(rJacobian, 16, 2) = -var_x237 * var_x50 * NV_Ith_S(mParameters, 0);
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x36 * var_x49);
        IJth(rJacobian, 3, 3) = -var_x107 - var_x116;
        IJth(rJacobian, 16, 3) = -var_x238 * var_x49 * NV_Ith_S(mParameters, 0);
        ...
        IJth(rJacobian, 5, 5) = -var_x137 - var_x138;
        IJth(rJacobian, 18, 5) = -var_x250 * var_x29;
        ...
        IJth(rJacobian, 8, 8) = -var_x160 - var_x161;
        IJth(rJacobian, 18, 8) = -var_x251 * var_x29;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.25882351999999997 * var_x55);
        IJth(rJacobian, 9, 9) = -var_x173 - var_x174;
        ...
        IJth(rJacobian, 10, 10) = -var_x185;
        IJth(rJacobian, 13, 10) = -var_x204 * var_x206;
        IJth(rJacobian, 14, 10) = var_x204 * var_x223 + var_x204 * var_x224;
        IJth(rJacobian, 17, 10) = var_x204 * var_x244;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x57 * var_chaste_interface__L_type_Ca_channel_d_gate__d);
        IJth(rJacobian, 11, 11) = -0.0022222222222222222 - var_x186;
        IJth(rJacobian, 13, 11) = -var_x206 * var_x207;
        IJth(rJacobian, 14, 11) = var_x207 * var_x223 + var_x207 * var_x224;
        IJth(rJacobian, 17, 11) = var_x207 * var_x244;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x31 * var_x56);
        IJth(rJacobian, 12, 12) = -0.5;
        IJth(rJacobian, 13, 12) = -var_x206 * var_x208;
        IJth(rJacobian, 14, 12) = var_x208 * var_x223 + var_x208 * var_x224;
        IJth(rJacobian, 17, 12) = var_x208 * var_x244;
        IJth(rJacobian, 13, 13) = -0.125 + 529334.30870519392 * var_x202 * var_x210;
        IJth(rJacobian, 14, 13) = -4234674.4696415514 * var_x210 * var_x220 - 2026160.0333213164 * var_x210 * var_x221;
        IJth(rJacobian, 17, 13) = 0.42352941176470582 * var_x210 * var_x241;
        IJth(rJacobian, 19, 13) = -60.0 * var_x210 * var_x254;
        IJth(rJacobian, 13, 14) = var_x211 * var_x212;
        IJth(rJacobian, 14, 14) = var_x216 * (-1 - 2117337.2348207757 * var_x211 * var_x219) - var_x211 * var_x225;
        IJth(rJacobian, 17, 14) = var_x211 * var_x245;
        IJth(rJacobian, 19, 14) = -var_x211 * var_x255;
        IJth(rJacobian, 13, 15) = var_x212 * var_x213;
        IJth(rJacobian, 14, 15) = -var_x213 * var_x225 - 2117337.2348207757 * var_x213 * var_x220;
        IJth(rJacobian, 15, 15) = -var_x236;
        IJth(rJacobian, 17, 15) = var_x213 * var_x245;
        IJth(rJacobian, 19, 15) = -var_x213 * var_x255;
        ...
        IJth(rJacobian, 13, 16) = 7.5423570794182034e-5 * var_x202 * var_x59;
        IJth(rJacobian, 14, 16) = -0.00028870266332701257 * var_x221 * var_x59 - 0.00060338856635345627 * var_x220 * var_x59;
        ...
        IJth(rJacobian, 17, 16) = 6.0347685850539541e-10 * var_x241 * var_x59;
        ...
        IJth(rJacobian, 13, 19) = var_x196 * var_x212;
        IJth(rJacobian, 14, 19) = -var_x196 * var_x225 - var_x197 * var_x220;
        IJth(rJacobian, 17, 19) = var_x241 * var_x249;
        IJth(rJacobian, 19, 19) = var_x254 * (-0.0055555555555555558 - var_x256) + 0.25 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x193 * var_x256) / (pow(var_x252, 3) * pow((0.125 + var_x253), 2));
        IJth(rJacobian, 20, 19) = 0.00048309178743961351;
        IJth(rJacobian, 17, 20) = 2.7058823529411762e-5 * var_x241;
        IJth(rJacobian, 19, 20) = 0.0055555555555555558 * var_x254;
