...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellcourtemanche_ramirez_nattel_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x75 = var_x67 + var_x74;
        const double var_x76 = 1 / var_x75;
        const double var_x77 = ((var_x68) ? (0) : (var_x73 - 0.032000000000000001 * var_x69 * var_x71 / pow(var_x72, 2)));
        const double var_x78 = 0.0072727272727272727 * var_x66;
        ...
        const double var_x88 = var_x82 + var_x87;
        const double var_x89 = 1 / var_x88;
        const double var_x90 = ((var_x81) ? (-0.019852941176470591 * var_x80) : (0));
        const double var_x91 = ((var_x81) ? (0.28123999999999999 * var_x84 + 108500.0 * var_x83) : (0.693000693000693 * var_x85 / pow(var_x86, 2)));
        ...
        const double var_x112 = var_x102 + var_x111;
        const double var_x113 = 1 / var_x112;
        const double var_x114 = ((var_x81) ? (-0.001275024 * var_x97 + 0.016701360000000002 * var_x94 * var_x96 / pow(var_x95, 2)) : (-7.6049999999999996e-8 * var_x101 + 0.029999999999999999 * var_x100 * var_x98 / pow(var_x99, 2)));
        const double var_x115 = ((var_x81) ? (var_x110 + var_x103 * var_x106 * (1.5254334000000001e-6 * var_x108 - 31073.016 * var_x107) - 0.311 * var_x103 * var_x104 * var_x109 / pow(var_x105, 2)) : (0));
        const double var_x116 = 1.0 * var_x102;
        const double var_x117 = 1.0 * var_x111;
        const double var_x118 = exp(-1.1670467502850628 - 0.057012542759407071 * var_chaste_interface__membrane__V);
        ...
        const double var_x125 = 1.9500000000000002 * (0.016949152542372881 * var_x120 + 0.11764705882352941 * var_x121) / pow(var_x122, 2) - 0.018352941176470589 * var_x124 / pow((1 + 0.40000000000000002 * var_x124), 2);
        ...
        const double var_x130 = exp(8.1320754716981138 + 0.18867924528301888 * var_chaste_interface__membrane__V);
        ...
        const double var_x144 = exp(-2.1692307692307691 - 0.15384615384615385 * var_chaste_interface__membrane__V);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = 14.1 + var_chaste_interface__membrane__V;
        const double var_x147 = fabs(var_x146) < 1.0e-10;
        const double var_x148 = -0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x149 = exp(-2.8199999999999998 + var_x148);
        const double var_x150 = 1.0 - var_x149;
        const double var_x151 = 0.00029999999999999997 / var_x150;
        const double var_x152 = -3.3328000000000002 + var_chaste_interface__membrane__V;
        const double var_x153 = fabs(var_x152) < 1.0e-10;
        const double var_x154 = exp(-0.65046743564221166 + 0.19517145812596365 * var_chaste_interface__membrane__V);
        const double var_x155 = -1.0 + var_x154;
        const double var_x156 = 7.3898000000000003e-5 / var_x155;
        const double var_x157 = ((var_x147) ? (0.0015) : (var_x146 * var_x151));
        const double var_x158 = ((var_x153) ? (0.00037836118) : (var_x152 * var_x156));
        const double var_x159 = exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V);
        const double var_x160 = 1.0 + var_x159;
        const double var_x161 = -19.899999999999999 + var_chaste_interface__membrane__V;
        const double var_x162 = fabs(var_x161) < 1.0e-10;
        const double var_x163 = exp(-2.2111111111111108 + 0.1111111111111111 * var_chaste_interface__membrane__V);
        const double var_x164 = -1.0 + var_x163;
        const double var_x165 = 3.4999999999999997e-5 / var_x164;
        const double var_x166 = -var_x123;
        const double var_x167 = exp(1.1705882352941175 + var_x166);
        const double var_x168 = 1.0 - var_x167;
        const double var_x169 = 4.0000000000000003e-5 / var_x168;
        const double var_x170 = 2.0 * ((var_x162) ? (0.00068000000000000005) : (var_x161 * var_x169));
        const double var_x171 = 2.0 * ((var_x162) ? (0.00031500000000000001) : (var_x161 * var_x165));
        const double var_x172 = exp(-1.25 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x173 = 1.0 + var_x172;
        const double var_x174 = exp(-1.6025641025641024 - 0.16025641025641024 * var_chaste_interface__membrane__V);
        const double var_x175 = 10.0 + var_chaste_interface__membrane__V;
        const double var_x176 = fabs(var_x175) < 1.0e-10;
        const double var_x177 = 1.0 - var_x174;
        const double var_x178 = 1 / var_x177;
        const double var_x179 = 1.0 + var_x174;
        const double var_x180 = 0.035000000000000003 * var_x178 * var_x179;
        const double var_x181 = 0.005608974358974359 * var_x174 * var_x175;
        const double var_x182 = ((var_x176) ? (0.21838829438742086 + 0.21838829438742086 * var_x174) : (var_x175 * var_x180));
        const double var_x183 = 0.0021888888888888887 * exp(-0.113569 * pow((1 + 0.10000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x184 = exp(-4.057971014492753 - 0.14492753623188406 * var_chaste_interface__membrane__V);
        const double var_x185 = 1.0 + var_x184;
        const double var_x186 = var_x184 / var_x185;
        const double var_x187 = 23.455745922671674 * var_x39;
        const double var_x188 = var_x187 - 2.7189219554066811e-5 * var_x27 - 0.011173862339878819 * var_x12;
        const double var_x189 = var_x26 * var_x8;
        const double var_x190 = -65.0 + var_chaste_interface__membrane__V;
        const double var_x191 = -var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__intracellular_ion_concentrations__Ca_rel;
        const double var_x192 = pow(var_chaste_interface__Ca_release_current_from_JSR_u_gate__u, 2);
        const double var_x193 = var_x192 * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w;
        const double var_x194 = var_x193 * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v;
        const double var_x195 = 2117337.2348207757 * var_x194;
        const double var_x196 = -0.011173862339878819 * var_x189 + var_x187 * var_x190 - var_x191 * var_x195;
        const double var_x197 = exp(250.0 + var_x196);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = var_x197 / pow(var_x198, 2);
        const double var_x200 = 0.125 * var_x199;
        const double var_x201 = var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca * var_chaste_interface__L_type_Ca_channel_f_gate__f;
        const double var_x202 = -1524.6234849736588 + 23.455745922671674 * var_chaste_interface__membrane__V;
        const double var_x203 = var_x200 * var_x202;
        const double var_x204 = var_chaste_interface__L_type_Ca_channel_d_gate__d * var_chaste_interface__L_type_Ca_channel_f_Ca_gate__f_Ca;
        const double var_x205 = var_x191 * var_chaste_interface__Ca_release_current_from_JSR_v_gate__v;
        const double var_x206 = var_x205 * var_chaste_interface__Ca_release_current_from_JSR_u_gate__u * var_chaste_interface__Ca_release_current_from_JSR_w_gate__w;
        const double var_x207 = var_x191 * var_x193;
        const double var_x208 = 264667.15435259696 * var_x199;
        const double var_x209 = var_x192 * var_x205;
        const double var_x210 = var_x199 * var_x52;
        const double var_x211 = var_x195 + 30661.078260627481 * var_x60;
        const double var_x212 = 1 / var_x198;
        const double var_x213 = 1 / (1.9099999999999999 + 2.0899999999999999 * var_x212);
        const double var_x214 = exp(50.0 + var_x196);
        const double var_x215 = 1.0 + var_x214;
        const double var_x216 = var_x214 / pow(var_x215, 2);
        const double var_x217 = var_x213 * var_x216;
        const double var_x218 = (1.0 - 1 / var_x215 - var_chaste_interface__Ca_release_current_from_JSR_v_gate__v) / pow((0.9138755980861244 + var_x212), 2);
        const double var_x219 = var_x199 * var_x218;
        const double var_x220 = 0.47846889952153115 * var_x219;
        const double var_x221 = var_x202 * var_x217;
        const double var_x222 = var_x202 * var_x220;
        const double var_x223 = 1013080.0166606582 * var_x219;
        const double var_x224 = exp(2.3529411764705883 + var_x166);
        const double var_x225 = 1.0 + var_x224;
        const double var_x226 = -7.9000000000000004 + var_chaste_interface__membrane__V;
        const double var_x227 = fabs(var_x226) < 1.0e-10;
        const double var_x228 = exp(1.5800000000000001 + var_x148);
        const double var_x229 = 1.0 - var_x228;
        const double var_x230 = 1 / var_x229;
        const double var_x231 = 1.0 + 0.29999999999999999 * var_x228;
        const double var_x232 = 0.16666666666666666 * var_x230 * var_x231;
        const double var_x233 = var_x226 * var_x228;
        const double var_x234 = ((var_x227) ? (1.0833333333333333) : (var_x226 * var_x232));
        const double var_x235 = 0.00059145564270171168 * var_x36;
        const double var_x236 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x237 = 1.0 + 0.00011900000000000002 / pow(var_x236, 2) + 3.5000000000000004e-5 * var_x58;
        const double var_x238 = 1 / var_x237;
        const double var_x239 = 4.6918356272010783e-6 * var_x39;
        const double var_x240 = var_x238 * (0.0003049693157680701 - 4.6918356272010783e-6 * var_chaste_interface__membrane__V);
        const double var_x241 = 0.21176470588235291 * var_x238;
        const double var_x242 = 1.0426301393780176e-5 * var_x56;
        const double var_x243 = 1.0 + 0.00092000000000000003 * var_x57;
        const double var_x244 = 1 / (pow(var_x243, 2) * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 2));
        const double var_x245 = 0.21176470588235291 * var_x194;
        const double var_x246 = 2.2302249193675269e-6 * var_x15;
        const double var_x247 = 1.2526727201836254e-5 * var_x4;
        const double var_x248 = 7.5827646500219452e-5 * var_x24;
        const double var_x249 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_rel;
        const double var_x250 = pow(var_x249, (-2));
        const double var_x251 = 1 / (1.0 + 8.0 * var_x250);
        const double var_x252 = 30.0 * var_x251;
        const double var_x253 = 30.0 * var_x194;
        ...
        IJth(rJacobian, 1, 0) = (var_x67 + var_x79) * (var_x76 * var_x77 + var_x74 * (var_x78 - var_x77) / pow(var_x75, 2)) + (-var_x78 + 1.0 * var_x77) * (-var_chaste_interface__fast_sodium_current_m_gate__m + var_x74 * var_x76);
        IJth(rJacobian, 2, 0) = (var_x92 + var_x93) * (var_x89 * var_x90 + var_x82 * (-var_x90 - var_x91) / pow(var_x88, 2)) + (-var_chaste_interface__fast_sodium_current_h_gate__h + var_x82 * var_x89) * (1.0 * var_x90 + 1.0 * var_x91);
        IJth(rJacobian, 3, 0) = (var_x116 + var_x117) * (var_x113 * var_x115 + var_x111 * (-var_x114 - var_x115) / pow(var_x112, 2)) + (-var_chaste_interface__fast_sodium_current_j_gate__j + var_x111 * var_x113) * (1.0 * var_x114 + 1.0 * var_x115);
        IJth(rJacobian, 4, 0) = var_x125 * (1 / var_x119 - var_chaste_interface__transient_outward_K_current_oa_gate__oa) + 0.057012542759407071 * var_x118 * var_x128 / pow(var_x119, 2);
        IJth(rJacobian, 5, 0) = (1 / var_x131 - var_chaste_interface__transient_outward_K_current_oi_gate__oi) * (0.00031887818877678569 * var_x132 / pow((1 + 0.028121484814398197 * var_x132), 2) - 0.00079791438902835471 * var_x133 / pow((1 + 0.053966540744738258 * var_x133), 2)) - 0.18867924528301888 * var_x130 * (var_x134 + var_x135) / pow(var_x131, 2);
        IJth(rJacobian, 6, 0) = var_x125 * (1 / var_x137 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ua_gate__ua) + 0.10416666666666667 * var_x128 * var_x136 / pow(var_x137, 2);
        IJth(rJacobian, 7, 0) = (1 / var_x139 - var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui) * (0.1875 * var_x140 + 0.00024295432458697764 * var_x141 / pow((1 + 0.047619047619047616 * var_x141), 2)) - 0.036390101892285295 * var_x138 * (var_x142 + var_x143) / pow(var_x139, 2);
        IJth(rJacobian, 8, 0) = (1 / var_x145 - var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr) * (((var_x147) ? (0) : (var_x151 - 5.9999999999999995e-5 * var_x146 * var_x149 / pow(var_x150, 2))) + ((var_x153) ? (0) : (var_x156 - 1.4422780412592461e-5 * var_x152 * var_x154 / pow(var_x155, 2)))) + 0.15384615384615385 * var_x144 * (var_x157 + var_x158) / pow(var_x145, 2);
        IJth(rJacobian, 9, 0) = (pow(var_x160, (-0.5)) - var_chaste_interface__slow_delayed_rectifier_K_current_xs_gate__xs) * (2.0 * ((var_x162) ? (0) : (var_x165 - 3.8888888888888887e-6 * var_x161 * var_x163 / pow(var_x164, 2))) + 2.0 * ((var_x162) ? (0) : (var_x169 - 2.3529411764705885e-6 * var_x161 * var_x167 / pow(var_x168, 2)))) + 0.03937007874015748 * var_x159 * pow(var_x160, (-1.5)) * (var_x170 + var_x171);
        IJth(rJacobian, 10, 0) = (1 / var_x173 - var_chaste_interface__L_type_Ca_channel_d_gate__d) * ((var_x176) ? (-0.034998124100548214 * var_x174) : (var_x180 - var_x178 * var_x181 - var_x179 * var_x181 / pow(var_x177, 2))) + 0.125 * var_x172 * var_x182 / pow(var_x173, 2);
        IJth(rJacobian, 11, 0) = (0.0022222222222222222 + var_x183) * (-0.14492753623188406 * var_x186 + 0.14492753623188406 * pow(var_x184, 2) / pow(var_x185, 2)) + var_x183 * (-0.022713800000000003 - 0.0022713799999999999 * var_chaste_interface__membrane__V) * (var_x186 - var_chaste_interface__L_type_Ca_channel_f_gate__f);
        IJth(rJacobian, 13, 0) = -var_x188 * var_x200;
        IJth(rJacobian, 14, 0) = var_x188 * var_x217 + var_x188 * var_x220;
        IJth(rJacobian, 15, 0) = (1.0 - 1 / var_x225 - var_chaste_interface__Ca_release_current_from_JSR_w_gate__w) * ((var_x227) ? (0) : (var_x232 - 0.01 * var_x230 * var_x233 - 0.033333333333333333 * var_x231 * var_x233 / pow(var_x229, 2))) - 0.058823529411764705 * var_x224 * var_x234 / pow(var_x225, 2);
        IJth(rJacobian, 16, 0) = -5.1141008336491756e-8 - 8.1579594228290866e-11 * var_x27 - 3.3526492139188633e-8 * var_x12 - 0.00010670035173794672 * var_x34 - var_x235 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 17, 0) = var_x238 * (-4.28805340958741e-8 - var_x239 + 1.1175497379729546e-8 * var_x12 + 2.7193198076096955e-11 * var_x27);
        IJth(rJacobian, 18, 0) = 9.9563612471764595e-8 * var_x40 + 7.1133567825297807e-5 * var_x34 + 4.7771417295138259e-7 * var_x19 - 2.9164479423161328e-7 * var_x42 - 9.8129891902512391e-6 * var_x0 - 6.8244881850197506e-6 * var_x3 - var_x246 * var_chaste_interface__rapid_delayed_rectifier_K_current_xr_gate__xr - var_x247 * var_chaste_interface__transient_outward_K_current_oi_gate__oi - var_x248 * var_chaste_interface__ultrarapid_delayed_rectifier_K_current_ui_gate__ui;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-23.399999999999999 * var_x45);
        IJth(rJacobian, 1, 1) = -var_x67 - var_x79;
        IJth(rJacobian, 16, 1) = -0.0017743669281051352 * var_x45;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x37 * var_x43);
        IJth(rJacobian, 2, 2) = -var_x92 - var_x93;
        IJth(rJacobian, 16, 2) = -var_x235 * var_x43;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-7.7999999999999998 * var_x46);
        IJth(rJacobian, 3, 3) = -var_x116 - var_x117;
        ...
        IJth(rJacobian, 5, 5) = -var_x134 - var_x135;
        IJth(rJacobian, 18, 5) = -var_x18 * var_x247;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-3.0 * var_x48);
        IJth(rJacobian, 6, 6) = var_x129;
        ...
        IJth(rJacobian, 18, 7) = -var_x18 * var_x248;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x16 * var_x18);
        IJth(rJacobian, 8, 8) = -var_x157 - var_x158;
        IJth(rJacobian, 18, 8) = -var_x18 * var_x246;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.25882351999999997 * var_x49);
        IJth(rJacobian, 9, 9) = -var_x170 - var_x171;
        ...
        IJth(rJacobian, 10, 10) = -var_x182;
        IJth(rJacobian, 13, 10) = -var_x201 * var_x203;
        IJth(rJacobian, 14, 10) = var_x201 * var_x221 + var_x201 * var_x222;
        IJth(rJacobian, 17, 10) = var_x201 * var_x240;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x51 * var_chaste_interface__L_type_Ca_channel_d_gate__d);
        IJth(rJacobian, 11, 11) = -0.0022222222222222222 - var_x183;
        IJth(rJacobian, 13, 11) = -var_x203 * var_x204;
        IJth(rJacobian, 14, 11) = var_x204 * var_x221 + var_x204 * var_x222;
        IJth(rJacobian, 17, 11) = var_x204 * var_x240;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x38 * var_x50);
        IJth(rJacobian, 12, 12) = -0.5;
        IJth(rJacobian, 13, 12) = -var_x203 * var_x38;
        IJth(rJacobian, 14, 12) = var_x221 * var_x38 + var_x222 * var_x38;
        IJth(rJacobian, 17, 12) = var_x240 * var_x38;
        IJth(rJacobian, 13, 13) = -0.125 + 529334.30870519392 * var_x199 * var_x206;
        IJth(rJacobian, 14, 13) = -4234674.4696415514 * var_x206 * var_x217 - 2026160.0333213164 * var_x206 * var_x219;
        IJth(rJacobian, 17, 13) = 0.42352941176470582 * var_x206 * var_x238;
        IJth(rJacobian, 19, 13) = -60.0 * var_x206 * var_x251;
        IJth(rJacobian, 13, 14) = var_x207 * var_x208;
        IJth(rJacobian, 14, 14) = var_x213 * (-1 - 2117337.2348207757 * var_x207 * var_x216) - var_x207 * var_x223;
        IJth(rJacobian, 17, 14) = var_x207 * var_x241;
        IJth(rJacobian, 19, 14) = -var_x207 * var_x252;
        IJth(rJacobian, 13, 15) = var_x208 * var_x209;
        IJth(rJacobian, 14, 15) = -var_x209 * var_x223 - 2117337.2348207757 * var_x209 * var_x217;
        IJth(rJacobian, 15, 15) = -var_x234;
        IJth(rJacobian, 17, 15) = var_x209 * var_x241;
        IJth(rJacobian, 19, 15) = -var_x209 * var_x252;
        ...
        IJth(rJacobian, 13, 16) = 0.0075423570794182033 * var_x210;
        IJth(rJacobian, 14, 16) = -0.060338856635345627 * var_x217 * var_x52 - 0.028870266332701258 * var_x210 * var_x218;
        ...
        IJth(rJacobian, 17, 16) = 6.0347685850539546e-8 * var_x238 * var_x52;
        ...
        IJth(rJacobian, 13, 17) = -var_x200 * var_x211;
        IJth(rJacobian, 14, 17) = var_x211 * var_x217 + var_x211 * var_x220;
        IJth(rJacobian, 16, 17) = 0.09199669442993362 * var_x60;
        IJth(rJacobian, 17, 17) = var_x238 * (-var_x242 - var_x245 + 1.0426301393780176e-5 * var_x59 - 3.7341176470588232e-7 * var_x244 - 0.030665564809977872 * var_x60 - 5.727302500569046e-7 * var_x57) + (0.00023800000000000004 / pow(var_x236, 3) + 7.0000000000000007e-5 / pow(var_x55, 3)) * (5.727302500569046e-7 * log(1.8 * var_x57) + 1.1175497379729546e-8 * var_x189 + 2.7058823529411762e-5 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.00040588235294117644 / var_x243 - 4.28805340958741e-8 * var_chaste_interface__membrane__V + var_x191 * var_x245 - var_x190 * var_x239 - var_x242 * var_chaste_interface__intracellular_ion_concentrations__Ca_i) / pow(var_x237, 2);
        IJth(rJacobian, 19, 17) = var_x251 * var_x253;
        IJth(rJacobian, 20, 17) = 4.6e-6 * var_x244;
        ...
        IJth(rJacobian, 13, 19) = var_x194 * var_x208;
        IJth(rJacobian, 14, 19) = -var_x194 * var_x223 - var_x195 * var_x217;
        IJth(rJacobian, 17, 19) = var_x238 * var_x245;
        IJth(rJacobian, 19, 19) = var_x251 * (-0.0055555555555555558 - var_x253) + 0.25 * (0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_up - 0.0055555555555555558 * var_chaste_interface__intracellular_ion_concentrations__Ca_rel - var_x191 * var_x253) / (pow(var_x249, 3) * pow((0.125 + var_x250), 2));
        IJth(rJacobian, 20, 19) = 0.00048309178743961351;
        IJth(rJacobian, 17, 20) = 2.7058823529411762e-5 * var_x238;
        IJth(rJacobian, 19, 20) = 0.0055555555555555558 * var_x251;
