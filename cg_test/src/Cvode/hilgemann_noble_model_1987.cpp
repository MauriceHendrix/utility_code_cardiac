...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x95 = 0.10204081632653063 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x96 = 0.25 + var_chaste_interface__calcium_release__ActFrac;
        const double var_x97 = pow(var_x96, (-2));
        const double var_x98 = var_x97 * var_chaste_interface__calcium_release__ActFrac;
        const double var_x99 = pow(var_chaste_interface__calcium_release__ActFrac, 2);
        const double var_x100 = var_x99 / pow(var_x96, 3);
        ...
        const double var_x105 = -0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x106 = exp(-4.1000000000000005 + var_x105);
        const double var_x107 = 1.0 - var_x106;
        const double var_x108 = 200.0 / var_x107;
        const double var_x109 = exp(-3.6960000000000002 - 0.056000000000000001 * var_chaste_interface__membrane__V);
        const double var_x110 = exp(-9.375 - 0.125 * var_chaste_interface__membrane__V);
        const double var_x111 = exp(-7.5 + var_x105);
        const double var_x112 = 0.001 * var_chaste_interface__second_inward_calcium_current_d_gate__d;
        const double var_x113 = 19.0 + var_chaste_interface__membrane__V;
        const double var_x114 = fabs(var_x113) < 0.0001;
        const double var_x115 = 0.25 * var_chaste_interface__membrane__V;
        const double var_x116 = -var_x115;
        const double var_x117 = exp(-4.75 + var_x116);
        const double var_x118 = 1.0 - var_x117;
        const double var_x119 = 30.0 / var_x118;
        const double var_x120 = exp(1.8999999999999999 + 0.10000000000000001 * var_chaste_interface__membrane__V);
        const double var_x121 = -1.0 + var_x120;
        const double var_x122 = 12.0 / var_x121;
        const double var_x123 = 34.0 + var_chaste_interface__membrane__V;
        const double var_x124 = fabs(var_x123) < 0.0001;
        const double var_x125 = exp(8.5 + var_x115);
        const double var_x126 = -1.0 + var_x125;
        const double var_x127 = 6.25 / var_x126;
        const double var_x128 = exp(-8.5 + var_x116);
        const double var_x129 = 1.0 + var_x128;
        const double var_x130 = 120.0 * var_x23;
        const double var_x131 = 0.012 / var_x129;
        const double var_x132 = 1.0 - var_chaste_interface__calcium_release__ActFrac - var_chaste_interface__calcium_release__ProdFrac;
        const double var_x133 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x134 = 0.00050000000000000001 + var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x135 = pow(var_chaste_interface__intracellular_calcium_concentration__Ca_i, 2);
        const double var_x136 = 1.0 * var_x135;
        const double var_x137 = var_x136 / pow(var_x134, 3);
        const double var_x138 = pow(var_x134, (-2));
        const double var_x139 = 1.0 * var_x138 * var_chaste_interface__intracellular_calcium_concentration__Ca_i;
        const double var_x140 = var_x139 - var_x137;
        const double var_x141 = -0.59999999999999998 * var_x133;
        const double var_x142 = 0.5 * var_x135 * var_x138;
        const double var_x143 = 0.00065749545073783716 * var_x6;
        const double var_x144 = 2.4612612919372021e-8 * var_x32;
        const double var_x145 = 6.0300901652461443e-6 * var_x42;
        const double var_x146 = 6.0300901652461443e-6 * var_x52;
        const double var_x147 = 4.922522583874404e-9 * var_x34;
        const double var_x148 = 0.5 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x149 = -var_x102;
        ...
        IJth(rJacobian, 2, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x104) ? (0) : (var_x108 - 20.0 * var_x103 * var_x106 / pow(var_x107, 2))) + 0.44800000000000001 * var_x109 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 4, 0) = (0.001 - var_x112) * ((var_x114) ? (0) : (var_x119 - 7.5 * var_x113 * var_x117 / pow(var_x118, 2))) - var_x112 * ((var_x114) ? (0) : (var_x122 - 1.2 * var_x113 * var_x120 / pow(var_x121, 2)));
        IJth(rJacobian, 5, 0) = -0.001 * ((var_x124) ? (0) : (var_x127 - 1.5625 * var_x123 * var_x125 / pow(var_x126, 2))) * var_chaste_interface__second_inward_calcium_current_f_Ca_gate__f_Ca + 0.0030000000000000001 * var_x128 * (var_x28 + var_x130 * var_x26) / pow(var_x129, 2);
        IJth(rJacobian, 6, 0) = 0.048000000000000001 * var_x132 * var_x133;
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626692e-10 * var_x51 - 1.2898842108407737e-7 * var_x46 - 3.9449727044270234e-7 * var_x19 - var_x143 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x144 * var_x30;
        IJth(rJacobian, 9, 0) = -4.0271596357692526e-8 + 4.5145947379427072e-7 * var_x50 - 4.5145947379427072e-7 * var_x53 - 8.0543192715385052e-8 * var_x19 - var_x145 * var_x29;
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 1.8426917297725339e-10 * var_x49 + 4.7818790814779921e-7 * var_x8 - 7.3707669190901358e-10 * var_x46 - 6.3870986643104186e-6 * var_x5 - var_x147 * var_x30;
        ...
        IJth(rJacobian, 5, 1) = var_x131 * (var_x60 + var_x130 * var_x25 - var_x130 * var_x59);
        IJth(rJacobian, 6, 1) = var_x132 * var_x140 + (var_x137 - var_x139) * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 7, 1) = var_x140 * var_chaste_interface__calcium_release__ActFrac;
        IJth(rJacobian, 8, 1) = 1.0825005100947751 * var_x55 + 2.7220311660546458e-9 * var_x58 + 1.4376722683771949e-9 * var_x57 - var_x144 * var_x63;
        IJth(rJacobian, 9, 1) = 2.9352475479367729e-10 * var_x57 + 5.5574802973615687e-10 * var_x58 + 0.22101052081101658 * var_x55 - 5.3790289324163455e-7 * var_x54 - var_x145 * var_x62 - var_x146 * var_x39;
        IJth(rJacobian, 10, 1) = -var_x147 * var_x63;
        ...
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x104) ? (2000.0) : (var_x103 * var_x108)) - 8.0 * var_x109;
        ...
        IJth(rJacobian, 8, 3) = -var_x143 * var_x66;
        ...
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x114) ? (120.0) : (var_x113 * var_x119)) - 0.001 * ((var_x114) ? (120.0) : (var_x113 * var_x122));
        IJth(rJacobian, 8, 4) = -var_x144 * var_x69;
        IJth(rJacobian, 9, 4) = -var_x145 * var_x68;
        IJth(rJacobian, 10, 4) = -var_x147 * var_x69;
        ...
        IJth(rJacobian, 5, 5) = -0.001 * ((var_x124) ? (25.0) : (var_x123 * var_x127)) + var_x131 * (-1.0 - 119.0 * var_x26);
        IJth(rJacobian, 8, 5) = var_x144 * var_x71;
        IJth(rJacobian, 9, 5) = var_x145 * var_x70;
        IJth(rJacobian, 10, 5) = var_x147 * var_x71;
        IJth(rJacobian, 1, 6) = var_x95 * var_x98 - var_x100 * var_x95;
        IJth(rJacobian, 6, 6) = -0.059999999999999998 + var_x141 - var_x136 * var_x138;
        IJth(rJacobian, 7, 6) = 0.059999999999999998 + var_x142;
        IJth(rJacobian, 12, 6) = var_x100 * var_x148 - var_x148 * var_x98;
        IJth(rJacobian, 6, 7) = var_x141 - var_x142;
        ...
        IJth(rJacobian, 9, 9) = -4.9999999999999998e-7 + 5.3790289324163455e-7 * var_x81 + 1.0696966282568414e-16 * var_x82 - 8.0543192715385052e-8 * var_x83 + var_x146 * var_x36;
        ...
        IJth(rJacobian, 1, 12) = 0.051020408163265314 * var_x101;
        IJth(rJacobian, 11, 12) = 0.050000000000000003;
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 - 0.25 * var_x101;
        IJth(rJacobian, 1, 13) = 0.050000000000000003 + var_x102;
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + var_x149;
        IJth(rJacobian, 1, 14) = 0.20000000000000001 + var_x102;
        IJth(rJacobian, 14, 14) = -0.20000000000000001 + var_x149;
    }
