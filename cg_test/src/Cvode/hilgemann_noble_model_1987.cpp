...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhilgemann_noble_model_1987FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 8, 0) = -1.5779890817708093e-7 + 9.2134586488626692e-10 * var_x49 - 1.2898842108407737e-7 * var_x46 - 0.00065749545073783716 * var_x7 - 3.9449727044270234e-7 * var_x19 - var_x146 * var_x30;
        ...
        IJth(rJacobian, 10, 0) = -2.2354845325086465e-6 + 1.8426917297725339e-10 * var_x51 + 4.7818790814779921e-7 * var_x8 - 7.3707669190901358e-10 * var_x46 - 6.3870986643104186e-6 * var_x5 - var_x149 * var_x30;
        ...
        IJth(rJacobian, 1, 1) = -17.0 + var_x90 + var_x91 + 0.0030000000000000001 * var_x95 - 0.0030000000000000001 * var_x93 - 9.0734372201821535e-10 * var_x60 - 4.3910440264623239e-7 * var_x56 - 4.7922408945906498e-10 * var_x58 - 0.36083350336492503 * var_x59 - 5.5200000000000005e-8 * var_x96 - var_x39 * var_x97 - var_x64 * var_x89;
        ...
        IJth(rJacobian, 8, 1) = 1.0825005100947751 * var_x59 + 2.7220311660546458e-9 * var_x60 + 1.4376722683771949e-9 * var_x58 - var_x146 * var_x65;
        IJth(rJacobian, 9, 1) = 2.9352475479367729e-10 * var_x58 + 5.5574802973615687e-10 * var_x60 + 0.22101052081101658 * var_x59 - 5.3790289324163455e-7 * var_x56 - var_x147 * var_x64 - var_x148 * var_x39;
        ...
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x107) ? (2000.0) : (var_x106 * var_x111)) - 8.0 * var_x112;
        ...
        IJth(rJacobian, 3, 3) = -0.02 * var_x113 - 2.0 / (1.0 + 320.0 * var_x114);
        ...
        IJth(rJacobian, 8, 8) = 2.7614808930989161e-7 * var_x77 + 1.5717991272345426e-15 * var_x80 - 0.00044183694289582661 * var_x76 - 4.215402265403831e-6 * var_x75 - 2.4612612919372021e-8 * var_x83 - 2.4674154593497089 * var_x78 - 1.1834918113281069e-6 * var_x82;
        IJth(rJacobian, 9, 8) = 3.2090898847705241e-16 * var_x80 - 2.4162957814615514e-7 * var_x82;
        IJth(rJacobian, 10, 8) = 0.00029455796193055109 * var_x76 - 1.840987262065944e-7 * var_x77;
        ...
        IJth(rJacobian, 1, 9) = 4.3910440264623239e-7 * var_x84 + 1.3149909014756745e-7 * var_x86 - 1.7464434747050473e-16 * var_x85 + var_x36 * var_x97;
        ...
        IJth(rJacobian, 10, 10) = 1.2774197328620837e-5 * var_x88 - 4.922522583874404e-9 * var_x83 - 5.9718198759887604e-5 * var_x1 - 0.00017062342502825029 * var_x87;
        IJth(rJacobian, 1, 11) = 7.1999999999999999e-7 * var_x95 + 5.5200000000000005e-8 * var_x93 - 1.3248e-11 * var_x96;
        IJth(rJacobian, 11, 11) = -0.050000000000000003 + 6.4915199999999999e-10 * var_x96 - 2.7047999999999999e-6 * var_x93 - 3.5279999999999994e-5 * var_x95;
