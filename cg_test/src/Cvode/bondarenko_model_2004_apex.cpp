...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbondarenko_model_2004_apexFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_fast_sodium_current__E_Na = var_membrane__R * var_membrane__T * log((0.1111111111111111 * var_membrane__Ko + var_membrane__Nao) / (0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki + var_chaste_interface__sodium_concentration__Nai)) / var_membrane__F; // millivolt
        ...
        const double var_rapid_delayed_rectifier_potassium_current__i_Kr = (-var_membrane__R * var_membrane__T * log((0.020408163265306124 * var_membrane__Nao + var_membrane__Ko) / (0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai + var_chaste_interface__potassium_concentration__Ki)) / var_membrane__F + var_chaste_interface__membrane__V) * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K * var_rapid_delayed_rectifier_potassium_current__g_Kr; // picoA_per_picoF
    ...
    void Cellbondarenko_model_2004_apexFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x42 = 0.1111111111111111 * var_chaste_interface__potassium_concentration__Ki + var_chaste_interface__sodium_concentration__Nai;
        ...
        const double var_x45 = 0.020408163265306124 * var_chaste_interface__sodium_concentration__Nai + var_chaste_interface__potassium_concentration__Ki;
        ...
        const double var_x191 = 1 / (0.25 * var_x182 + 0.1027 * var_x181);
        const double var_x192 = -0.12987012987012986 * var_chaste_interface__membrane__V;
        const double var_x193 = exp(-0.90909090909090906 + var_x192);
        const double var_x194 = 1 / (0.39395599999999997 + 0.188495 * var_x185);
        const double var_x195 = 1 / var_x179;
        const double var_x196 = var_x191 * var_x193 * var_x194 * var_x195;
        ...
        const double var_x201 = var_x190 * var_x193 * var_x195;
        const double var_x202 = 8.8508255294954831e-7 * var_x191 * var_x200 * var_x201;
        const double var_x203 = 0.00019355636363636362 * var_x183 * var_x194 * var_x201 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x204 = 0.22 * var_x179;
        const double var_x205 = 3.802 * var_x191;
        const double var_x206 = 1.2097272727272726e-5 * var_x197;
        const double var_x207 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x208 = -var_x207;
        const double var_x209 = exp(0.12315270935960591 + var_x178);
        const double var_x210 = 0.009852216748768473 * var_x209;
        const double var_x211 = var_x210 * var_chaste_interface__fast_sodium_current__C_Na1;
        const double var_x212 = 9.0909090909090901e-8 * var_x193;
        const double var_x213 = var_x212 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x214 = exp(-0.16666666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x215 = 71.871455576559541 * (0.0068466666666666667 * var_x214 + 0.0015333333333333334 * var_x182) / pow((var_x182 + 0.44652173913043475 * var_x214), 2);
        const double var_x216 = var_x215 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x217 = 0.20000000000000001 * var_x209;
        const double var_x218 = -var_x217;
        const double var_x219 = -0.008539999999999999 - var_x188;
        const double var_x220 = 3.802 / (0.1027 * var_x214 + 0.23000000000000001 * var_x182);
        const double var_x221 = 6.9999999999999997e-7 * var_x193;
        const double var_x222 = 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__C_Na2;
        const double var_x223 = -var_x222;
        const double var_x224 = exp(-0.12315270935960591 + var_x178);
        const double var_x225 = 0.0094433497536945809 * var_x224;
        const double var_x226 = var_x212 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x227 = exp(-0.14705882352941177 - 0.058823529411764705 * var_chaste_interface__membrane__V);
        const double var_x228 = 95.049999999999997 * (0.0013333333333333335 * var_x182 + 0.0060411764705882356 * var_x227) / pow((var_x182 + 0.51349999999999996 * var_x227), 2);
        const double var_x229 = 3.802 / (0.20000000000000001 * var_x182 + 0.1027 * var_x227);
        const double var_x230 = -var_x229;
        const double var_x231 = 0.19170000000000001 * var_x224;
        const double var_x232 = -var_x220 - var_x231;
        const double var_x233 = var_x219 + var_x230;
        const double var_x234 = var_x212 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x235 = 1.818181818181818e-9 * var_x193 * var_chaste_interface__fast_sodium_current__I2_Na;
        const double var_x236 = 7.3163809141391995e-5 * var_x200;
        const double var_x237 = 7.7014535938307356e-7 * var_x186 * var_chaste_interface__fast_sodium_current__I1_Na;
        const double var_x238 = -var_x221;
        const double var_x239 = 1.0526315789473684e-5 * var_x194;
        const double var_x240 = 1.4e-8 * var_x193;
        const double var_x241 = 0.001 * var_x194;
        const double var_x242 = var_x210 * var_chaste_interface__fast_sodium_current__IF_Na;
        const double var_x243 = var_x215 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x244 = var_x225 * var_chaste_interface__fast_sodium_current__IC_Na2;
        const double var_x245 = var_x228 * var_chaste_interface__fast_sodium_current__IC_Na3;
        const double var_x246 = 0.025019562392723654 * var_x8;
        const double var_x247 = 0.25271120029236765 * var_x2 - 0.0098429554532475649 * var_chaste_interface__membrane__V;
        const double var_x248 = 0.078972250091364882 * var_x2 - 0.003075923579139864 * var_chaste_interface__membrane__V;
        const double var_x249 = exp(1.0731000000000002 + 0.035770000000000003 * var_chaste_interface__membrane__V);
        const double var_x250 = exp(-1.8711 - 0.062370000000000002 * var_chaste_interface__membrane__V);
        const double var_x251 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x252 = exp(4.7857142857142856 + var_x251);
        const double var_x253 = 1.0 + 0.051334999999999999 * var_x252;
        const double var_x254 = var_x252 / var_x253;
        const double var_x255 = 1.0 - var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        const double var_x256 = -var_x251;
        const double var_x257 = exp(-4.7857142857142856 + var_x256);
        const double var_x258 = 1.0 + 0.0067083000000000004 * var_x257;
        const double var_x259 = exp(-1.9285714285714286 + var_x256);
        const double var_x260 = var_x259 / var_x258;
        const double var_x261 = exp(-2.9220779220779218 + var_x192);
        const double var_x262 = 1.0 + var_x261;
        const double var_x263 = 1 / var_x262;
        const double var_x264 = exp(-0.062899999999999998 * var_chaste_interface__membrane__V);
        const double var_x265 = 0.0073216139155926159 * var_x264 / pow((1 + 0.23955296404275997 * var_x264), 2);
        const double var_x266 = 1 / (2.0579999999999998 + 0.49299999999999999 * var_x264);
        const double var_x267 = 0.12987012987012986 * var_x261 / pow(var_x262, 2);
        const double var_x268 = var_x266 * var_x267;
        const double var_x269 = -var_x266;
        const double var_x270 = exp(7.9298245614035094 + 0.17543859649122806 * var_chaste_interface__membrane__V);
        const double var_x271 = 1.0 + var_x270;
        const double var_x272 = 1 / var_x271;
        const double var_x273 = 1 / (270.0 + 1050.0 * var_x272);
        const double var_x274 = var_x270 / pow(var_x271, 2);
        const double var_x275 = 0.17543859649122806 * var_x274;
        const double var_x276 = 1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs;
        const double var_x277 = exp(-3.3919999999999999 - 0.128 * var_chaste_interface__membrane__V);
        const double var_x278 = 1.0 - var_x277;
        const double var_x279 = 4.8133299999999997e-6 / var_x278;
        const double var_x280 = exp(-1.0069999999999999 - 0.037999999999999999 * var_chaste_interface__membrane__V);
        const double var_x281 = 26.5 + var_chaste_interface__membrane__V;
        const double var_x282 = 1 / (1200.0 - 170.0 * var_x272);
        const double var_x283 = exp(-0.086199999999999999 * var_chaste_interface__membrane__V);
        const double var_x284 = 1 / (13.17 + 39.299999999999997 * var_x283);
        const double var_x285 = exp(0.038198000000000003 * var_chaste_interface__membrane__V);
        const double var_x286 = 0.00052457313400000008 * var_x285 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2;
        const double var_x287 = exp(-0.041779999999999998 * var_chaste_interface__membrane__V);
        const double var_x288 = 2.8786419999999997e-6 * var_x287 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x289 = exp(0.11695499999999999 + 0.023390999999999999 * var_chaste_interface__membrane__V);
        const double var_x290 = 0.0021243940109999999 * var_x289 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K;
        const double var_x291 = exp(-0.16339999999999999 - 0.032680000000000001 * var_chaste_interface__membrane__V);
        const double var_x292 = 0.00021232196 * var_x291 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K;
        const double var_x293 = 6.8899999999999994e-5 * var_x287;
        const double var_x294 = 0.090820999999999999 * var_x289;
        const double var_x295 = 0.013733 * var_x285;
        const double var_x296 = 0.0064970000000000002 * var_x291;
        const double var_x297 = exp(0.01176 * var_chaste_interface__membrane__V);
        const double var_x298 = exp(-0.063100000000000003 * var_chaste_interface__membrane__V);
        const double var_x299 = -0.022348 * var_x297;
        ...
        IJth(rJacobian, 20, 0) = var_x208 + var_x211 + var_x216 - var_x180 - var_x184 - var_x213;
        IJth(rJacobian, 21, 0) = var_x223 - var_x211 - var_x216 - var_x226 + var_x225 * var_chaste_interface__fast_sodium_current__C_Na2 + var_x228 * (1.0 - var_chaste_interface__fast_sodium_current__C_Na1 - var_chaste_interface__fast_sodium_current__C_Na2 - var_chaste_interface__fast_sodium_current__I1_Na - var_chaste_interface__fast_sodium_current__I2_Na - var_chaste_interface__fast_sodium_current__IC_Na2 - var_chaste_interface__fast_sodium_current__IC_Na3 - var_chaste_interface__fast_sodium_current__IF_Na - var_chaste_interface__fast_sodium_current__O_Na);
        IJth(rJacobian, 22, 0) = var_x234 + var_x236 - var_x235 - var_x237;
        IJth(rJacobian, 23, 0) = var_x235 + var_x237;
        IJth(rJacobian, 24, 0) = var_x187 + var_x198 + var_x199 + var_x207 + var_x213 + var_x242 + var_x243 - var_x202 - var_x203 - var_x234 - var_x236;
        IJth(rJacobian, 25, 0) = var_x222 + var_x226 + var_x244 + var_x245 - var_x242 - var_x243;
        IJth(rJacobian, 26, 0) = 2.0000000000000002e-5 + var_x208 + var_x223 - var_x244 - var_x245 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I1_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__I2_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na2 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IC_Na3 - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__IF_Na - 2.0000000000000002e-5 * var_chaste_interface__fast_sodium_current__O_Na + var_x212 * var_chaste_interface__fast_sodium_current__IC_Na3;
        IJth(rJacobian, 27, 0) = 0.084735007814913818 * var_x33 + 0.0015588209597120041 * var_x18 - 0.0047984407834581883 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K - 0.017397555353928618 * var_x5 - 0.00035373121160108434 * var_x0 - 0.0098429554532475649 * var_x7 - 0.003075923579139864 * var_x6 - var_x246 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f;
        IJth(rJacobian, 28, 0) = 0.035770000000000003 * var_x249 * (0.18064 - 0.18064 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f) + 0.024673572000000001 * var_x250 * var_chaste_interface__fast_transient_outward_potassium_current__ato_f;
        IJth(rJacobian, 29, 0) = -0.00013571428571428572 * var_x254 * var_chaste_interface__fast_transient_outward_potassium_current__ito_f - 2.1714285714285715e-5 * var_x255 * var_x260 + 6.9668928571428572e-6 * pow(var_x252, 2) * var_chaste_interface__fast_transient_outward_potassium_current__ito_f / pow(var_x253, 2) + 1.4566594285714287e-7 * var_x255 * var_x257 * var_x259 / pow(var_x258, 2);
        IJth(rJacobian, 30, 0) = var_x268 + var_x265 * (var_x263 - var_chaste_interface__slow_transient_outward_potassium_current__ato_s);
        IJth(rJacobian, 31, 0) = -var_x273 * var_x275 + 0.00016708437761069341 * var_x274 * (var_x272 - var_chaste_interface__slow_transient_outward_potassium_current__ito_s) / pow((0.25714285714285712 + var_x272), 2);
        IJth(rJacobian, 32, 0) = var_x276 * var_x279 + 3.6226653999999999e-6 * var_x280 * var_chaste_interface__slow_delayed_rectifier_potassium_current__nKs - 6.1610624e-7 * var_x276 * var_x277 * var_x281 / pow(var_x278, 2);
        IJth(rJacobian, 33, 0) = var_x268 + var_x265 * (var_x263 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur);
        IJth(rJacobian, 34, 0) = -var_x275 * var_x282 - 2.0711500974658867e-5 * var_x274 * (var_x272 - var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur) / pow((1 - 0.14166666666666666 * var_x272), 2);
        IJth(rJacobian, 35, 0) = var_x267 * var_x284 + 0.0021933842239185751 * var_x283 * (var_x263 - var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss) / pow((0.33511450381679392 + var_x283), 2);
        IJth(rJacobian, 37, 0) = var_x286 + var_x288 - var_x290 - var_x292;
        IJth(rJacobian, 38, 0) = 0.01176 * var_x297 * (0.022348 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K2 - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__I_K - 0.022348 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__O_K) + 0.0029658262000000005 * var_x298 * var_chaste_interface__rapid_delayed_rectifier_potassium_current__C_K1;
        IJth(rJacobian, 39, 0) = -var_x286 - var_x288;
        IJth(rJacobian, 40, 0) = var_x290 + var_x292;
        ...
        IJth(rJacobian, 19, 19) = -var_x194 - var_x204;
        IJth(rJacobian, 20, 19) = var_x204;
        IJth(rJacobian, 21, 19) = var_x230;
        IJth(rJacobian, 24, 19) = var_x194;
        IJth(rJacobian, 26, 19) = var_x219;
        IJth(rJacobian, 19, 20) = var_x205;
        IJth(rJacobian, 20, 20) = var_x218 + var_x219 - var_x205;
        IJth(rJacobian, 21, 20) = var_x217 + var_x230;
        IJth(rJacobian, 24, 20) = var_x189;
        IJth(rJacobian, 26, 20) = var_x219;
        IJth(rJacobian, 20, 21) = var_x220;
        IJth(rJacobian, 21, 21) = var_x232 + var_x233;
        IJth(rJacobian, 25, 21) = var_x189;
        IJth(rJacobian, 26, 21) = var_x219;
        IJth(rJacobian, 21, 22) = var_x230;
        IJth(rJacobian, 22, 22) = var_x238 - var_x239;
        IJth(rJacobian, 23, 22) = var_x239;
        IJth(rJacobian, 24, 22) = var_x221;
        IJth(rJacobian, 26, 22) = var_x219;
        IJth(rJacobian, 21, 23) = var_x230;
        IJth(rJacobian, 22, 23) = var_x240;
        IJth(rJacobian, 23, 23) = -var_x240;
        IJth(rJacobian, 26, 23) = var_x219;
        IJth(rJacobian, 19, 24) = var_x206;
        IJth(rJacobian, 20, 24) = var_x221;
        IJth(rJacobian, 21, 24) = var_x230;
        IJth(rJacobian, 22, 24) = var_x241;
        IJth(rJacobian, 24, 24) = var_x218 + var_x238 - var_x206 - var_x241;
        IJth(rJacobian, 25, 24) = var_x217;
        IJth(rJacobian, 26, 24) = var_x219;
        IJth(rJacobian, 21, 25) = var_x221 + var_x230;
        IJth(rJacobian, 24, 25) = var_x220;
        IJth(rJacobian, 25, 25) = var_x232 + var_x238;
        IJth(rJacobian, 26, 25) = var_x219 + var_x231;
        IJth(rJacobian, 21, 26) = var_x230;
        IJth(rJacobian, 25, 26) = var_x229;
        IJth(rJacobian, 26, 26) = var_x233 + var_x238;
        ...
        IJth(rJacobian, 28, 28) = -0.18064 * var_x249 - 0.39560000000000001 * var_x250;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x17 * var_x9);
        IJth(rJacobian, 27, 29) = -var_x17 * var_x246;
        IJth(rJacobian, 29, 29) = -0.00015200000000000001 * var_x260 - 0.00095 * var_x254;
        IJth(rJacobian, 30, 30) = var_x269;
        IJth(rJacobian, 31, 31) = -var_x273;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0115 * var_x57);
        IJth(rJacobian, 27, 32) = -0.00070746242320216869 * var_x57;
        IJth(rJacobian, 32, 32) = -9.5333299999999997e-5 * var_x280 - var_x279 * var_x281;
        ...
        IJth(rJacobian, 27, 33) = var_x247 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__iur;
        IJth(rJacobian, 33, 33) = var_x269;
        ...
        IJth(rJacobian, 27, 34) = var_x247 * var_chaste_interface__ultra_rapidly_activating_delayed_rectifier_potassium_current__aur;
        IJth(rJacobian, 34, 34) = -var_x282;
        ...
        IJth(rJacobian, 27, 35) = var_x248 * var_chaste_interface__non_inactivating_steady_state_potassium_current__iKss;
        IJth(rJacobian, 35, 35) = -var_x284;
        ...
        IJth(rJacobian, 27, 36) = var_x248 * var_chaste_interface__non_inactivating_steady_state_potassium_current__aKss;
        ...
        IJth(rJacobian, 37, 37) = -var_x293 - var_x294;
        IJth(rJacobian, 38, 37) = var_x299;
        IJth(rJacobian, 39, 37) = var_x293;
        IJth(rJacobian, 40, 37) = var_x294;
        IJth(rJacobian, 38, 38) = -0.023761000000000001 + var_x299 - 0.047002000000000002 * var_x298;
        IJth(rJacobian, 39, 38) = 0.023761000000000001;
        IJth(rJacobian, 37, 39) = var_x295;
        IJth(rJacobian, 38, 39) = 0.036777999999999998 + var_x299;
        IJth(rJacobian, 39, 39) = -0.036777999999999998 - var_x295;
        IJth(rJacobian, 37, 40) = var_x296;
        IJth(rJacobian, 38, 40) = var_x299;
        IJth(rJacobian, 40, 40) = -var_x296;
    }
