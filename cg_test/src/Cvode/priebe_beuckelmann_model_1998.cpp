...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x115 = ((var_x114) ? (var_x113 * var_chaste_interface__Irel__APtrack2) : (0.0));
        ...
        const double var_x122 = 1.0 * var_x104;
        ...
        IJth(rJacobian, 1, 1) = var_x122 * (-var_x116 - var_x119 + 0.00036529411764705876 * var_x120 - var_x107 * (var_x121 + 471.5206420294254 * var_x63)) + 1.0 * (0.00023800000000000004 / pow(var_x101, 3) + 7.0000000000000007e-5 / pow(var_x102, 3)) * (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + var_x116 * var_x123 - var_x107 * (var_x125 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x124) - var_x119 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x103, 2);
        ...
        IJth(rJacobian, 3, 3) = -((var_x142) ? (0.13500000000000001 * var_x141) : (0.0)) - ((var_x142) ? (310000.0 * var_x144 + 3.5600000000000001 * var_x143) : (7.6923076923076916 / var_x146));
        IJth(rJacobian, 18, 3) = -var_x211 * var_x39;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_x75);
        IJth(rJacobian, 4, 4) = -((var_x142) ? (0.1212 * var_x158) : (0.29999999999999999 * var_x162)) - ((var_x142) ? (var_x153 * var_x154) : (0.0));
