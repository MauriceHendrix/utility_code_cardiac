...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x124 = 3.7099226270675565e-9 * var_x104 * var_x66;
        const double var_x125 = var_x124 * var_x31;
        const double var_x126 = var_x124 * var_x30 * var_chaste_interface__ICa_d_gate__d;
        const double var_x127 = ((var_x112) ? (var_x111 - var_x110 * var_chaste_interface__Irel__APtrack2) : (0));
        const double var_x128 = var_x120 * (0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x129 = 22.0 * var_x106 * var_chaste_interface__Irel__APtrack2;
        const double var_x130 = ((var_x112) ? (var_x108 * var_x129 - var_x109 * var_x129 / pow(var_x107, 2)) : (0));
        const double var_x131 = var_x104 * var_x84;
        ...
        const double var_x175 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        ...
        const double var_x184 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        ...
        const double var_x196 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        ...
        const double var_x207 = var_x36 * var_x42;
        const double var_x208 = 0.00019322513682643524 * var_x104;
        const double var_x209 = 0.0030916021892229638 * var_x104 * var_x26 * var_x71;
        const double var_x210 = var_x208 * (var_x78 - var_x77);
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa_m_gate__m) * ((var_x137) ? (var_x135 - 0.032000000000000001 * var_x133 * var_x136 / pow(var_x134, 2)) : (0)) + 0.0072727272727272727 * var_x138 * var_chaste_interface__INa_m_gate__m;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x140) ? (-0.019852941176470591 * var_x139) : (0)) - ((var_x140) ? (0.28123999999999999 * var_x141 + 108500.0 * var_x142) : (0.693000693000693 * var_x143 / pow(var_x144, 2))) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x140) ? (var_x151 + var_x147 * var_x152 * (1.5254334000000001e-6 * var_x149 - 31022.16 * var_x148) - 0.311 * var_x145 * var_x150 * var_x152 / pow(var_x146, 2)) : (0)) - ((var_x140) ? (-0.001275024 * var_x156 + 0.016701360000000002 * var_x153 * var_x155 / pow(var_x154, 2)) : (-7.6049999999999996e-8 * var_x160 + 0.029999999999999999 * var_x157 * var_x159 / pow(var_x158, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x162 * (0.028148326932247791 - 0.0044862181136439798 * var_chaste_interface__cell__V) * var_chaste_interface__ICa_d_gate__d + var_x163 * (1.0 - var_chaste_interface__ICa_d_gate__d) * (0.080354834965543909 - 0.0035936867158114449 * var_chaste_interface__cell__V);
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x166 * var_x167 - 0.27789999999999998 * var_x164 * var_x168 / pow(var_x165, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x169 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x170, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x175 * var_x179 - var_x173 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x174) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x175 * var_x176 * var_x178 / pow(var_x177, 2) - 0.1348 * var_x171 * var_x180 * var_chaste_interface__Ito_r_gate__r / pow(var_x172, 2);
        IJth(rJacobian, 8, 0) = var_x183 * var_x184 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x185) - var_x188 * (0.0001215 - 1.2732200000000002e-10 * var_x189) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x181 * var_x184 * var_x190 / pow(var_x182, 2) - 0.16039999999999999 * var_x186 * var_x191 * var_chaste_interface__Ito_t_gate__t / pow(var_x187, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x192 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x193, 2) + 0.00037104930467762328 * var_x194 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x195, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x196 * var_x200 - 2.5600000000000002e-5 * var_x204 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x201 * var_x203 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x202, 2) + 0.00063100000000000005 * var_x196 * var_x197 * var_x199 / pow(var_x198, 2);
        IJth(rJacobian, 14, 0) = ((var_x206) ? (-var_x105 * (var_x103 + var_x60)) : (0));
        IJth(rJacobian, 18, 0) = -var_x208 * (0.001 + var_x28 + 0.00026912541324748262 * var_x57 + 2.8363636363636364 * var_x207 + 6.545427896312757e-7 * var_x59);
        IJth(rJacobian, 19, 0) = -var_x208 * (var_x1 + var_x24 + var_x50 + var_x6 + var_x8 - var_x44 - var_x47 - 1.8909090909090909 * var_x207);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 + var_x68 - var_x62 - var_x69);
        IJth(rJacobian, 1, 1) = var_x120 * (-var_x114 - var_x117 + 0.00036529411764705876 * var_x118 - var_x105 * (var_x119 + 471.5206420294254 * var_x63)) + 1.0 * (0.00023800000000000004 / pow(var_x99, 3) + 7.0000000000000007e-5 / pow(var_x100, 3)) * (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + var_x114 * var_x121 - var_x105 * (var_x123 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x122) - var_x117 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x101, 2);
        IJth(rJacobian, 14, 1) = ((var_x206) ? (-var_x105 * (var_x119 + var_x64)) : (0));
        IJth(rJacobian, 18, 1) = 0.13666446085893647 * var_x104 * var_x63;
        IJth(rJacobian, 20, 1) = var_x113 * var_x214;
        IJth(rJacobian, 21, 1) = 0.0044999999999999997 * var_x116 - 0.0044999999999999997 * var_x118;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-48.0 * var_x72);
        IJth(rJacobian, 2, 2) = -((var_x137) ? (var_x135 * var_x136) : (3.2000000000000002)) - 0.080000000000000002 * var_x138;
        ...
        IJth(rJacobian, 3, 3) = -((var_x140) ? (0.13500000000000001 * var_x139) : (0.0)) - ((var_x140) ? (310000.0 * var_x142 + 3.5600000000000001 * var_x141) : (7.6923076923076916 / var_x144));
        IJth(rJacobian, 18, 3) = -var_x209 * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x73 * var_chaste_interface__INa_h_gate__h);
        IJth(rJacobian, 4, 4) = -((var_x140) ? (0.1212 * var_x156) : (0.29999999999999999 * var_x160)) - ((var_x140) ? (var_x151 * var_x152) : (0.0));
        IJth(rJacobian, 18, 4) = -var_x209 * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x66);
        IJth(rJacobian, 1, 5) = -var_x102 * var_x125;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + var_x162 - var_x163;
        IJth(rJacobian, 14, 5) = ((var_x206) ? (-var_x125) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x67);
        IJth(rJacobian, 1, 6) = -var_x102 * var_x126;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x170 - var_x166 * var_x168;
        IJth(rJacobian, 14, 6) = ((var_x206) ? (-var_x126) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x179 - var_x173 * var_x180;
        IJth(rJacobian, 19, 7) = -var_x210 * var_chaste_interface__Ito_t_gate__t;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x79 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x183 * var_x190 - var_x188 * var_x191;
        IJth(rJacobian, 19, 8) = -var_x210 * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040000000000000001 * var_x82);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x195 - 0.0030130000000000001 / var_x193;
        ...
        IJth(rJacobian, 10, 10) = -0.016 * var_x204 - 0.0050000000000000001 * var_x200;
        IJth(rJacobian, 19, 10) = -2.8983770523965286e-6 * var_x104 * var_x4 * var_x43;
        IJth(rJacobian, 11, 11) = ((var_x123 + 0.0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x122 - 0.026725757487819562 * var_x70 + var_x1 * var_x81 + var_x24 * var_x43 + var_x28 * var_x71 + var_x37 * var_x87 + var_x43 * var_x6 + var_x8 * (-26.725757487819561 * var_x76 + var_chaste_interface__cell__V) + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() < -150.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 12) = var_x127 * var_x128;
        IJth(rJacobian, 12, 12) = ((var_x205) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = var_x127 * var_x215;
        IJth(rJacobian, 13, 13) = ((var_x205) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = var_x128 * var_x130;
        IJth(rJacobian, 14, 14) = (((var_x206) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = var_x130 * var_x215;
        ...
        IJth(rJacobian, 1, 18) = 1.040035895964315e-7 * var_x102 * var_x131;
        IJth(rJacobian, 14, 18) = ((var_x206) ? (5.200179479821575e-8 * var_x131) : (0));
        IJth(rJacobian, 18, 18) = -var_x208 * (var_x83 + var_x91 + 0.0016147524794848955 * var_x84 + 0.13454054045080013 * var_x88);
        IJth(rJacobian, 19, 18) = -var_x208 * (var_x86 + var_x90 - 0.089693693633866756 * var_x88);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x98 - var_x92 - var_x93 - var_x94 - var_x96 - var_x97);
        IJth(rJacobian, 19, 19) = -var_x208 * (var_x92 + var_x93 + var_x94 + var_x96 + var_x97 - var_x98);
        IJth(rJacobian, 1, 20) = var_x102 * var_x114;
        IJth(rJacobian, 20, 20) = var_x214 * (-0.0055555555555555558 - var_x113) + 0.25 * (0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR - var_x113 * var_x121) / (pow(var_x211, 3) * pow((0.125 + var_x212), 2));
        IJth(rJacobian, 21, 20) = 0.00048309178743961351;
        IJth(rJacobian, 1, 21) = 2.1105882352941172e-5 * var_x102;
        IJth(rJacobian, 20, 21) = 0.0055555555555555558 * var_x213;
