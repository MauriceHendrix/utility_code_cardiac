...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellpriebe_beuckelmann_model_1998FromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_IK1_K1_gate__beta_K1 = (3.0 * exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.00020000000000000001 * var_IK1__E_K1) + exp(-1.0 + 0.10000000000000001 * var_chaste_interface__cell__V - 0.10000000000000001 * var_IK1__E_K1)) / (1.0 + exp(0.5 * var_IK1__E_K1 - 0.5 * var_chaste_interface__cell__V)); // per_ms
    ...
    void Cellpriebe_beuckelmann_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x12 = exp(0.02 + 0.00020000000000000001 * var_chaste_interface__cell__V - 0.0053451514975639122 * var_x5);
        const double var_x13 = 0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x14 = exp(-1.0 + var_x13 - 2.6725757487819561 * var_x5);
        ...
        const double var_x23 = var_x22 * var_chaste_interface__IKr_Xr_gate__Xr;
        ...
        const double var_x49 = var_x48 * (0.0060000000000000001 * var_x34 - 0.5 * var_x47 - var_x11 * (0.10000000000000001 * var_x14 + 0.00060000000000000006 * var_x12));
        ...
        const double var_x74 = 1.0 * var_x71;
        const double var_x75 = var_x38 * var_x72;
        const double var_x76 = 0.042999999999999997 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x77 = log(9.9339999999999993 / var_x76);
        const double var_x78 = 8.0177272463458689 * var_x77;
        const double var_x79 = 0.29999999999999999 * var_chaste_interface__cell__V;
        const double var_x80 = var_x78 - var_x79;
        const double var_x81 = 0.018329999999999999 * var_chaste_interface__Ionic_concentrations__Nai + var_chaste_interface__Ionic_concentrations__Ki;
        const double var_x82 = -26.725757487819561 * log(6.5295399999999999 / var_x81) + var_chaste_interface__cell__V;
        const double var_x83 = var_x82 * var_chaste_interface__IKs_Xs_gate__Xs;
        const double var_x84 = var_x22 * var_x35;
        ...
        const double var_x87 = var_x0 * (0.15315014533948793 * var_chaste_interface__Ionic_concentrations__Ki + 0.0028072421640728137 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x81, 2);
        ...
        const double var_x91 = var_x2 * (0.10066438494060802 * var_chaste_interface__Ionic_concentrations__Ki + 0.004328568552446144 * var_chaste_interface__Ionic_concentrations__Nai) / pow(var_x76, 2);
        ...
        const double var_x97 = var_x48 * (0.16035454492691736 * var_x96 - var_x11 * (2.6725757487819561 * var_x14 * var_x4 + 0.016035454492691736 * var_x12 * var_x4) - 13.36287874390978 * var_x4 * var_x47);
        const double var_x98 = 79.648102465199855 * var_x91;
        const double var_x99 = 26.725757487819561 * var_x23 * var_x4;
        ...
        const double var_x122 = -var_chaste_interface__Ionic_concentrations__Cai + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        ...
        const double var_x128 = ((var_x114) ? (var_x113 - var_x112 * var_chaste_interface__Irel__APtrack2) : (0));
        const double var_x129 = var_x104 * (0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Ca_JSR - 0.0070588235294117632 * var_chaste_interface__Ionic_concentrations__Cai);
        const double var_x130 = 22.0 * var_x108 * var_chaste_interface__Irel__APtrack2;
        const double var_x131 = ((var_x114) ? (var_x110 * var_x130 - var_x111 * var_x130 / pow(var_x109, 2)) : (0));
        const double var_x132 = var_x106 * var_x86;
        const double var_x133 = -var_x13;
        ...
        const double var_x137 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x138 = fabs(var_x137) > 0.001;
        const double var_x139 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x140 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x141 = var_chaste_interface__cell__V < -40.0;
        ...
        const double var_x144 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 1 / var_x147;
        const double var_x149 = exp(0.24399999999999999 * var_chaste_interface__cell__V);
        const double var_x150 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x151 = -127140.0 * var_x149 - 3.4740000000000003e-5 * var_x150;
        const double var_x152 = var_x148 * var_x151;
        const double var_x153 = 37.780000000000001 + var_chaste_interface__cell__V;
        const double var_x154 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x155 = 1.0 + var_x154;
        const double var_x156 = exp(-0.01052 * var_chaste_interface__cell__V);
        const double var_x157 = var_x156 / var_x155;
        const double var_x158 = exp(-3.2000000000000002 + var_x133);
        const double var_x159 = 1.0 + var_x158;
        const double var_x160 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x161 = var_x160 / var_x159;
        const double var_x162 = 1 / sqrt(M_PI);
        const double var_x163 = 0.25101580310038191 * var_x162 * exp(-0.08830693125184777 * pow((-1 + 0.15937778911130945 * var_chaste_interface__cell__V), 2));
        const double var_x164 = 0.63524014987941491 * var_x162 * exp(-0.89836705491478086 * pow((-1 + 0.044722719141323794 * var_chaste_interface__cell__V), 2));
        const double var_x165 = exp(-2.7305064499999996 - 0.27789999999999998 * var_chaste_interface__cell__V);
        const double var_x166 = 1.0 + var_x165;
        const double var_x167 = 1 / var_x166;
        const double var_x168 = exp(-1.06213655 - 0.1081 * var_chaste_interface__cell__V);
        const double var_x169 = 0.0112 + 0.068699999999999997 * var_x168;
        const double var_x170 = exp(-1.0052757950443461 + 0.16333730787449161 * var_chaste_interface__cell__V);
        const double var_x171 = 1.0 + var_x170;
        const double var_x172 = exp(6.9907280000000006e-6 - 0.1348 * var_chaste_interface__cell__V);
        const double var_x173 = 1.0 + var_x172;
        const double var_x174 = 1 / var_x173;
        const double var_x175 = exp(0.67236288 - 0.13439999999999999 * var_chaste_interface__cell__V);
        const double var_x176 = 1.0 - var_chaste_interface__Ito_r_gate__r;
        const double var_x177 = exp(3.9880601600000003 - 0.094299999999999995 * var_chaste_interface__cell__V);
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = exp(0.70203392000000009 - 0.0166 * var_chaste_interface__cell__V);
        const double var_x180 = var_x179 / var_x178;
        const double var_x181 = 0.51490000000000002 * var_x175 + 5.1860000000000002e-5 * var_chaste_interface__cell__V;
        const double var_x182 = exp(-5.9326369200000002 - 0.17319999999999999 * var_chaste_interface__cell__V);
        const double var_x183 = 1.0 + var_x182;
        const double var_x184 = 1 / var_x183;
        const double var_x185 = 1.0 - var_chaste_interface__Ito_t_gate__t;
        const double var_x186 = exp(-5.9257863000000004 - 0.17299999999999999 * var_chaste_interface__cell__V);
        const double var_x187 = exp(-5.4573693999999993 - 0.16039999999999999 * var_chaste_interface__cell__V);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = 1 / var_x188;
        const double var_x190 = exp(-5.6479010000000002e-8 - 1.6600000000000001e-9 * var_chaste_interface__cell__V);
        const double var_x191 = 5.6119999999999998e-5 * var_chaste_interface__cell__V + 0.072099999999999997 * var_x186;
        const double var_x192 = 0.0001215 * var_chaste_interface__cell__V + 0.076700000000000004 * var_x190;
        const double var_x193 = exp(-0.17842998931347828 - 0.069846547135942336 * var_chaste_interface__cell__V);
        const double var_x194 = 1.0 + var_x193;
        const double var_x195 = exp(1.0082174462705435 + 0.063211125158027806 * var_chaste_interface__cell__V);
        const double var_x196 = 1.0 + var_x195;
        const double var_x197 = 1.0 - var_chaste_interface__IKr_Xr_gate__Xr;
        const double var_x198 = exp(-0.51325540000000003 - 0.12620000000000001 * var_chaste_interface__cell__V);
        const double var_x199 = 1.0 + var_x198;
        const double var_x200 = exp(0.0021416822000000003 + 0.00052660000000000001 * var_chaste_interface__cell__V);
        const double var_x201 = var_x200 / var_x199;
        const double var_x202 = exp(5.1411779999999991 + 0.078299999999999995 * var_chaste_interface__cell__V);
        const double var_x203 = 1.0 + var_x202;
        const double var_x204 = exp(0.105056 + 0.0016000000000000001 * var_chaste_interface__cell__V);
        const double var_x205 = var_x204 / var_x203;
        const double var_x206 = (var_chaste_interface__Irel__APtrack > 0.17999999999999999) && (var_chaste_interface__Irel__APtrack < 0.20000000000000001);
        const double var_x207 = var_chaste_interface__Irel__APtrack > 0.20000000000000001;
        const double var_x208 = var_x27 * var_x33;
        const double var_x209 = 0.00019322513682643524 * var_x106;
        const double var_x210 = var_x209 * var_x71;
        const double var_x211 = var_x209 * (var_x79 - var_x78);
        const double var_x212 = 0.80000000000000004 + var_chaste_interface__Ionic_concentrations__Ca_JSR;
        const double var_x213 = pow(var_x212, (-2));
        const double var_x214 = 1 / (1.0 + 8.0 * var_x213);
        const double var_x215 = var_x214 * (-var_chaste_interface__Ionic_concentrations__Ca_JSR + var_chaste_interface__Ionic_concentrations__Cai);
        ...
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa_m_gate__m) * ((var_x138) ? (var_x136 - 0.032000000000000001 * var_x134 * var_x137 / pow(var_x135, 2)) : (0)) + 0.0072727272727272727 * var_x139 * var_chaste_interface__INa_m_gate__m;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x141) ? (-0.019852941176470591 * var_x140) : (0)) - ((var_x141) ? (0.28123999999999999 * var_x142 + 108500.0 * var_x143) : (0.693000693000693 * var_x144 / pow(var_x145, 2))) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x141) ? (var_x152 + var_x148 * var_x153 * (1.5254334000000001e-6 * var_x150 - 31022.16 * var_x149) - 0.311 * var_x146 * var_x151 * var_x153 / pow(var_x147, 2)) : (0)) - ((var_x141) ? (-0.001275024 * var_x157 + 0.016701360000000002 * var_x154 * var_x156 / pow(var_x155, 2)) : (-7.6049999999999996e-8 * var_x161 + 0.029999999999999999 * var_x158 * var_x160 / pow(var_x159, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 5, 0) = var_x163 * (0.028148326932247791 - 0.0044862181136439798 * var_chaste_interface__cell__V) * var_chaste_interface__ICa_d_gate__d + var_x164 * (1.0 - var_chaste_interface__ICa_d_gate__d) * (0.080354834965543909 - 0.0035936867158114449 * var_chaste_interface__cell__V);
        IJth(rJacobian, 6, 0) = (0.0074264700000000001 * var_x167 * var_x168 - 0.27789999999999998 * var_x165 * var_x169 / pow(var_x166, 2)) * var_chaste_interface__ICa_f_gate__f - 0.0011224539797135063 * var_x170 * (1.0 - var_chaste_interface__ICa_f_gate__f) / pow(var_x171, 2);
        IJth(rJacobian, 7, 0) = -0.0087415599999999989 * var_x176 * var_x180 - var_x174 * (5.1860000000000002e-5 - 0.069202559999999996 * var_x175) * var_chaste_interface__Ito_r_gate__r + 0.049658379999999995 * var_x176 * var_x177 * var_x179 / pow(var_x178, 2) - 0.1348 * var_x172 * var_x181 * var_chaste_interface__Ito_r_gate__r / pow(var_x173, 2);
        IJth(rJacobian, 8, 0) = var_x184 * var_x185 * (5.6119999999999998e-5 - 0.012473299999999998 * var_x186) - var_x189 * (0.0001215 - 1.2732200000000002e-10 * var_x190) * var_chaste_interface__Ito_t_gate__t + 0.17319999999999999 * var_x182 * var_x185 * var_x191 / pow(var_x183, 2) - 0.16039999999999999 * var_x187 * var_x192 * var_chaste_interface__Ito_t_gate__t / pow(var_x188, 2);
        IJth(rJacobian, 9, 0) = 0.00021044764652059425 * var_x193 * (1.0 - var_chaste_interface__IKs_Xs_gate__Xs) / pow(var_x194, 2) + 0.00037104930467762328 * var_x195 * var_chaste_interface__IKs_Xs_gate__Xs / pow(var_x196, 2);
        IJth(rJacobian, 10, 0) = 2.633e-6 * var_x197 * var_x201 - 2.5600000000000002e-5 * var_x205 * var_chaste_interface__IKr_Xr_gate__Xr + 0.0012527999999999999 * var_x202 * var_x204 * var_chaste_interface__IKr_Xr_gate__Xr / pow(var_x203, 2) + 0.00063100000000000005 * var_x197 * var_x198 * var_x200 / pow(var_x199, 2);
        IJth(rJacobian, 14, 0) = ((var_x207) ? (-var_x107 * (var_x105 + var_x60)) : (0));
        IJth(rJacobian, 18, 0) = -var_x209 * (0.001 + var_x40 + 0.00026912541324748262 * var_x57 + 2.8363636363636364 * var_x208 + 6.545427896312757e-7 * var_x59);
        IJth(rJacobian, 19, 0) = -var_x209 * (var_x1 + var_x19 + var_x23 + var_x3 + var_x49 - var_x37 - var_x50 - 1.8909090909090909 * var_x208);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64 + var_x68 - var_x62 - var_x69);
        IJth(rJacobian, 1, 1) = var_x104 * (-var_x116 - var_x119 + 0.00036529411764705876 * var_x120 - var_x107 * (var_x121 + 471.5206420294254 * var_x63)) + (0.00023800000000000004 / pow(var_x101, 3) + 7.0000000000000007e-5 / pow(var_x102, 3)) * (2.1105882352941172e-5 * var_chaste_interface__Ionic_concentrations__Ca_NSR + var_x116 * var_x122 - var_x107 * (var_x124 + 0.00084999999999999995 * var_chaste_interface__cell__V - 0.00017941694216498839 * var_x123) - var_x119 * var_chaste_interface__Ionic_concentrations__Cai) / pow(var_x103, 2);
        IJth(rJacobian, 14, 1) = ((var_x207) ? (-var_x107 * (var_x121 + var_x64)) : (0));
        IJth(rJacobian, 18, 1) = 0.13666446085893647 * var_x106 * var_x63;
        IJth(rJacobian, 20, 1) = var_x115 * var_x214;
        ...
        IJth(rJacobian, 2, 2) = -((var_x138) ? (var_x136 * var_x137) : (3.2000000000000002)) - 0.080000000000000002 * var_x139;
        ...
        IJth(rJacobian, 3, 3) = -((var_x141) ? (0.13500000000000001 * var_x140) : (0)) - ((var_x141) ? (310000.0 * var_x143 + 3.5600000000000001 * var_x142) : (7.6923076923076916 / var_x145));
        IJth(rJacobian, 18, 3) = -var_x210 * var_x39;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_x75);
        IJth(rJacobian, 4, 4) = -((var_x141) ? (0.1212 * var_x157) : (0.29999999999999999 * var_x161)) - ((var_x141) ? (var_x152 * var_x153) : (0));
        IJth(rJacobian, 18, 4) = -var_x210 * var_x75;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x45 * var_x66);
        IJth(rJacobian, 1, 5) = -var_x104 * var_x126;
        IJth(rJacobian, 5, 5) = -0.14710000000000001 + var_x163 - var_x164;
        IJth(rJacobian, 14, 5) = ((var_x207) ? (-var_x126) : (0));
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x43 * var_x67);
        IJth(rJacobian, 1, 6) = -var_x104 * var_x127;
        IJth(rJacobian, 6, 6) = -0.00054739999999999997 - 0.0068719999999999996 / var_x171 - var_x167 * var_x169;
        IJth(rJacobian, 14, 6) = ((var_x207) ? (-var_x127) : (0));
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80 * var_chaste_interface__Ito_t_gate__t);
        IJth(rJacobian, 7, 7) = -0.52659999999999996 * var_x180 - var_x174 * var_x181;
        IJth(rJacobian, 19, 7) = -var_x211 * var_chaste_interface__Ito_t_gate__t;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x80 * var_chaste_interface__Ito_r_gate__r);
        IJth(rJacobian, 8, 8) = -var_x184 * var_x191 - var_x189 * var_x192;
        IJth(rJacobian, 19, 8) = -var_x211 * var_chaste_interface__Ito_r_gate__r;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.040000000000000001 * var_x83);
        IJth(rJacobian, 9, 9) = -0.0058700000000000002 / var_x196 - 0.0030130000000000001 / var_x194;
        IJth(rJacobian, 19, 9) = -7.7290054730574101e-6 * var_x106 * var_x83;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-1.0 * var_x84);
        IJth(rJacobian, 10, 10) = -0.016 * var_x205 - 0.0050000000000000001 * var_x201;
        IJth(rJacobian, 19, 10) = -var_x209 * var_x84;
        IJth(rJacobian, 11, 11) = ((var_x124 + 0.0018500000000000001 * var_chaste_interface__cell__V + 8.9708471082494196e-5 * var_x123 - 0.026725757487819562 * var_x70 + var_x1 * var_x82 + var_x19 * var_x35 + var_x24 * var_x35 + var_x28 * var_x89 + var_x3 * (-26.725757487819561 * var_x77 + var_chaste_interface__cell__V) + var_x41 * var_x71 + 1.0 * GetIntracellularAreaStimulus(var_chaste_interface__environment__time) / HeartConfig::Instance()->GetCapacitance() < -150.0) ? (-100.5) : (-0.5));
        IJth(rJacobian, 1, 12) = var_x128 * var_x129;
        IJth(rJacobian, 12, 12) = ((var_x206) ? (-100.5) : (-0.5));
        IJth(rJacobian, 20, 12) = var_x128 * var_x215;
        IJth(rJacobian, 13, 13) = ((var_x206) ? (-100.5) : (-0.01));
        IJth(rJacobian, 1, 14) = var_x129 * var_x131;
        IJth(rJacobian, 14, 14) = (((var_x207) || (var_chaste_interface__Irel__APtrack2 > 0.01)) ? (0) : (-0.5));
        IJth(rJacobian, 20, 14) = var_x131 * var_x215;
        ...
        IJth(rJacobian, 14, 18) = ((var_x207) ? (5.200179479821575e-8 * var_x132) : (0));
        IJth(rJacobian, 18, 18) = -var_x209 * (var_x85 + var_x93 + 0.0016147524794848955 * var_x86 + 0.13454054045080013 * var_x90);
        IJth(rJacobian, 19, 18) = -var_x209 * (var_x88 + var_x92 - 0.089693693633866756 * var_x90);
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (var_x100 - var_x94 - var_x95 - var_x97 - var_x98 - var_x99);
        IJth(rJacobian, 19, 19) = -var_x209 * (var_x94 + var_x95 + var_x97 + var_x98 + var_x99 - var_x100);
        IJth(rJacobian, 1, 20) = var_x104 * var_x116;
        IJth(rJacobian, 20, 20) = var_x214 * (-0.0055555555555555558 - var_x115) + 0.25 * (0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_NSR - 0.0055555555555555558 * var_chaste_interface__Ionic_concentrations__Ca_JSR - var_x115 * var_x122) / (pow(var_x212, 3) * pow((0.125 + var_x213), 2));
        IJth(rJacobian, 21, 20) = 0.00048309178743961351;
        IJth(rJacobian, 1, 21) = 2.1105882352941172e-5 * var_x104;
        IJth(rJacobian, 20, 21) = 0.0055555555555555558 * var_x214;
