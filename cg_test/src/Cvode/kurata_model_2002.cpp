...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellkurata_model_2002FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x102 = 20.609999999999999 - 0.45800000000000002 * var_chaste_interface__membrane__V;
        const double var_x103 = 1 / var_chaste_interface__intracellular_ion_concentrations__Ki;
        const double var_x104 = log(5.4000000000000004 * var_x103);
        const double var_x105 = -26.726549826397882 * var_x104 + var_chaste_interface__membrane__V;
        ...
        const double var_x107 = (-26.726549826397882 * log(22.199999999999999 / var_x106) + var_chaste_interface__membrane__V) * var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n;
        const double var_x108 = 4.8107789687516185 * var_x104 - 0.17999999999999999 * var_chaste_interface__membrane__V;
        const double var_x109 = (-26.726549826397882 * var_x94 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x110 = var_x105 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        ...
        const double var_x171 = 0.00035 + var_chaste_interface__intracellular_ion_concentrations__Ca_sub;
        const double var_x172 = exp(-4.3833333333333337 + var_x147);
        ...
        const double var_x178 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        ...
        const double var_x184 = exp(-2.1886792452830188 - 0.094339622641509441 * var_chaste_interface__membrane__V);
        ...
        const double var_x191 = 0.094339622641509441 * var_x184 / pow(var_x185, 2);
        ...
        const double var_x196 = exp(1.672514619883041 + 0.058479532163742687 * var_chaste_interface__membrane__V);
        ...
        const double var_x210 = 2.2222222222222223e-5 * var_x202;
        const double var_x211 = 0.0015555555555555557 * var_x204 / pow(var_x205, 2);
        const double var_x212 = 0.076923076923076927 * var_chaste_interface__membrane__V;
        const double var_x213 = exp(3.7692307692307692 + var_x212);
        ...
        const double var_x219 = exp(1.2866666666666666 - 0.066666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x225 = exp(4.7407407407407405 + 0.07407407407407407 * var_chaste_interface__membrane__V);
        ...
        const double var_x232 = exp(-11.4 + var_x231);
        ...
        const double var_x249 = var_x245 + 1.0 * var_x241 + 0.00022900000000000001 * var_x248;
        const double var_x250 = 1 / var_x249;
        const double var_x251 = var_x246 / pow(var_x247, 2);
        const double var_x252 = (9.5 * var_x240 + 0.071428571428571425 * var_x237) / pow((var_x240 + 0.52631578947368418 * var_x237), 2);
        const double var_x253 = (-10.0 * var_x242 - 238.46153846153845 * var_x243) / pow((var_x243 + 0.22580645161290322 * var_x242), 2);
        const double var_x254 = 1.0405827263267429e-7 * var_x253;
        ...
        const double var_x259 = 14.1174 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        ...
        const double var_x266 = 0.12331568484884879 - 0.0027403485521966401 * var_chaste_interface__membrane__V;
        const double var_x267 = var_x266 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa;
        const double var_x268 = 0.097376868380642675 - 0.0021639304084587262 * var_chaste_interface__membrane__V;
        ...
        const double var_x272 = 0.00011495134018939525 - 3.0735652457057556e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x275 = 0.00098574953620847667 * var_x104 - 3.6882782948469069e-5 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 2, 0) = -0.20000000000000001 * var_x166 * var_x169 / pow(var_x167, 2) - 0.0038895371450797353 * var_x168 * (-0.33642151027379535 - 0.010351431085347548 * var_chaste_interface__membrane__V) * (-var_chaste_interface__L_type_calcium_channel_current_f_gate__f + 1.0 / var_x167) / pow((0.17230649552703226 + var_x168), 2);
        IJth(rJacobian, 4, 0) = (-var_chaste_interface__T_type_calcium_channel_current_d_gate__d + 1.0 / var_x173) * (0.0356 * var_x174 - 0.0356 * var_x175) + 0.16666666666666666 * var_x172 * (var_x176 + var_x177) / pow(var_x173, 2);
        IJth(rJacobian, 5, 0) = (-var_chaste_interface__T_type_calcium_channel_current_f_gate__f + 1.0 / var_x179) * (0.00097529258777633281 * var_x180 - 0.00018367346938775509 * var_x181) - 0.17857142857142858 * var_x178 * (var_x182 + var_x183) / pow(var_x179, 2);
        IJth(rJacobian, 6, 0) = var_x191 * (var_x189 + var_x190) + (var_x186 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paS) * (0.00029184075413518645 * var_x187 - 8.2031958007575546e-6 * var_x188);
        IJth(rJacobian, 7, 0) = var_x191 * (var_x194 + var_x195) + (var_x186 - var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pa_gate__paF) * (0.0027637030984589985 * var_x192 - 5.0400434999854427e-5 * var_x193);
        IJth(rJacobian, 8, 0) = (-var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy + 1.0 / var_x197) * (0.0061795265502981441 * var_x198 - 0.0018299935950224174 * var_x199) - 0.058479532163742687 * var_x196 * (var_x200 + var_x201) / pow(var_x197, 2);
        IJth(rJacobian, 9, 0) = var_x208 * (var_x209 * var_x211 + 71.428571428571431 * var_x206 * (var_x210 - var_x211) / pow((var_x206 + 0.071428571428571425 * var_x202), 2)) + (var_x211 - var_x210) * (-var_chaste_interface__slowly_activating_delayed_rectifier_potassium_current_n_gate__n + var_x207 * var_x209);
        IJth(rJacobian, 10, 0) = -0.076923076923076927 * var_x213 * var_x218 / pow(var_x214, 2) - 0.078713879440468384 * (-var_chaste_interface__AP_sensitive_currents_q_gate__q + 1.0 / var_x214) * (0.045599999999999995 * var_x216 - 0.0065000000000000006 * var_x215) / (pow((0.15497928494706154 + var_x217), 2) * pow((var_x216 + 0.11403508771929825 * var_x215), 2));
        IJth(rJacobian, 11, 0) = 0.066666666666666666 * var_x219 * var_x224 / pow(var_x220, 2) - 0.064554184748538135 * (-var_chaste_interface__AP_sensitive_currents_r_gate__r + 1.0 / var_x220) * (0.04428 * var_x222 - 0.093329999999999996 * var_x221) / (pow((0.19114817190506736 + var_x223), 2) * pow((var_x221 + 0.35583413693346194 * var_x222), 2));
        IJth(rJacobian, 12, 0) = (-var_chaste_interface__hyperpolarisation_activated_current_y_gate__y + 1.0 / var_x226) * (0.0725586626489447 * var_x227 - 0.030801634395873377 * var_x228) - 0.07407407407407407 * var_x225 * (var_x229 + var_x230) / pow(var_x226, 2);
        IJth(rJacobian, 13, 0) = (-var_chaste_interface__sustained_inward_current_qa_gate__qa + 1.0 / var_x233) * (0.00390625 * (-2.0 * var_x235 - 0.29999999999999999 * var_x234) / pow((var_x235 + 0.9375 * var_x234), 2) + 24.999999999999996 * (0.013636363636363636 * var_x236 + 0.00028571428571428574 * var_x237) / pow((var_x237 + 0.74999999999999989 * var_x236), 2)) + 0.20000000000000001 * var_x232 * (var_x238 + var_x239) / pow(var_x233, 2);
        IJth(rJacobian, 14, 0) = (-var_chaste_interface__sustained_inward_current_qi_gate__qi + var_x245 * var_x250) * (6.8872180451127816e-6 * var_x251 + 1.6662153999958345e-5 * var_x252 + 1.5647860546266811e-8 * var_x253) + (var_x250 * var_x254 + var_x245 * (-var_x254 - 4.5800000000000002e-5 * var_x251 - 0.00011080332409972299 * var_x252) / pow(var_x249, 2)) * (var_x255 + var_x256 + var_x257);
        IJth(rJacobian, 18, 0) = -0.0021639304084587262 * var_x81 - 0.0027403485521966401 * var_x83 + var_x264 * var_x66 + var_x265 * var_x89;
        IJth(rJacobian, 19, 0) = -1.1064834884540721e-6 - 6.1578240506668277e-5 * var_x99 - 3.0735652457057556e-6 * var_x79 - 2.9452438966975401e-5 * var_x0 - var_x270 * var_x66 - var_x271 * var_x89;
        IJth(rJacobian, 20, 0) = var_x274 + 4.1052160337778847e-5 * var_x99 - 9.0923504304507221e-8 * var_x2 - 4.0980869942743411e-6 * var_chaste_interface__AP_sensitive_currents_r_gate__r - 5.3070226575852715e-6 * var_x1 - 4.738669217566849e-5 * var_x0 - 3.6882782948469069e-5 * var_x80;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f);
        IJth(rJacobian, 1, 1) = var_x163 + var_x164 - var_x162;
        IJth(rJacobian, 18, 1) = var_x267 * var_chaste_interface__L_type_calcium_channel_current_f_gate__f;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x101 * var_chaste_interface__L_type_calcium_channel_current_d_gate__d);
        IJth(rJacobian, 2, 2) = -var_x169;
        IJth(rJacobian, 18, 2) = var_x267 * var_chaste_interface__L_type_calcium_channel_current_d_gate__d;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x100 * var_x82);
        IJth(rJacobian, 3, 3) = -0.021000000000000001 - var_x170;
        IJth(rJacobian, 18, 3) = var_x266 * var_x82;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_chaste_interface__T_type_calcium_channel_current_f_gate__f);
        IJth(rJacobian, 4, 4) = -var_x176 - var_x177;
        IJth(rJacobian, 18, 4) = var_x268 * var_chaste_interface__T_type_calcium_channel_current_f_gate__f;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x102 * var_chaste_interface__T_type_calcium_channel_current_d_gate__d);
        IJth(rJacobian, 5, 5) = -var_x182 - var_x183;
        IJth(rJacobian, 18, 5) = var_x268 * var_chaste_interface__T_type_calcium_channel_current_d_gate__d;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : ((0.72286170354868073 * var_x104 - 0.027046577588354045 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy);
        IJth(rJacobian, 6, 6) = -var_x189 - var_x190;
        IJth(rJacobian, 20, 6) = (0.00014811750729859212 * var_x104 - 5.5419613927232791e-6 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : ((1.0842925553230209 * var_x104 - 0.040569866382531065 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy);
        IJth(rJacobian, 7, 7) = -var_x194 - var_x195;
        IJth(rJacobian, 20, 7) = (0.00022217626094788817 * var_x104 - 8.3129420890849178e-6 * var_chaste_interface__membrane__V) * var_chaste_interface__rapidly_activating_delayed_rectifier_potassium_current_pi_gate__piy;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x105 * var_x3);
        IJth(rJacobian, 8, 8) = -var_x200 - var_x201;
        IJth(rJacobian, 20, 8) = var_x105 * var_x273;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-0.051799999999999999 * var_x107);
        IJth(rJacobian, 9, 9) = -var_x203 - var_x207;
        IJth(rJacobian, 20, 9) = -1.0614045315170543e-5 * var_x107;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x108 * var_chaste_interface__AP_sensitive_currents_r_gate__r);
        IJth(rJacobian, 10, 10) = -var_x218;
        IJth(rJacobian, 20, 10) = var_x275 * var_chaste_interface__AP_sensitive_currents_r_gate__r;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (0.53453099652795766 * var_x104 - 0.02 * var_chaste_interface__membrane__V + var_x108 * var_chaste_interface__AP_sensitive_currents_q_gate__q);
        IJth(rJacobian, 11, 11) = -var_x224;
        IJth(rJacobian, 20, 11) = 0.00010952772624538631 * var_x104 - 4.0980869942743411e-6 * var_chaste_interface__membrane__V + var_x275 * var_chaste_interface__AP_sensitive_currents_q_gate__q;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-0.28747499999999998 * var_x109 - 0.46252500000000002 * var_x110);
        IJth(rJacobian, 12, 12) = -var_x229 - var_x230;
        IJth(rJacobian, 19, 12) = -5.8904877933950802e-5 * var_x109;
        IJth(rJacobian, 20, 12) = -9.477338435133698e-5 * var_x110;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x111 * var_chaste_interface__sustained_inward_current_qi_gate__qi);
        IJth(rJacobian, 13, 13) = -var_x238 - var_x239;
        IJth(rJacobian, 19, 13) = var_x272 * var_chaste_interface__sustained_inward_current_qi_gate__qi;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x111 * var_chaste_interface__sustained_inward_current_qa_gate__qa);
        IJth(rJacobian, 14, 14) = -var_x255 - var_x256 - var_x257;
        IJth(rJacobian, 19, 14) = var_x272 * var_chaste_interface__sustained_inward_current_qa_gate__qa;
        IJth(rJacobian, 15, 15) = -27.670820618882221 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMi + 2.7527999999999997 * var_chaste_interface__calcium_buffering__fTC + 14.1174 * var_chaste_interface__calcium_buffering__fTMC + 14.1174 * var_chaste_interface__calcium_buffering__fTMM - 7.7327439216924522e-8 * var_x258;
        IJth(rJacobian, 16, 15) = 2.9999999999999997e-6 * var_x258;
        ...
        IJth(rJacobian, 17, 17) = -5.3566666666666674 - var_x262 + 5.3399999999999999 * var_chaste_interface__calcium_buffering__fCQ;
        IJth(rJacobian, 18, 17) = var_x269;
        IJth(rJacobian, 26, 17) = 0.53400000000000003 - 0.53400000000000003 * var_chaste_interface__calcium_buffering__fCQ;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x120 * var_x78 - var_x124 * var_x91);
        IJth(rJacobian, 3, 18) = 0.021000000000000001 / var_x171 - 60.0 * var_chaste_interface__L_type_calcium_channel_current_fCa_gate__fCa - 0.00035 * (0.021000000000000001 + var_x170) / pow(var_x171, 2);
        IJth(rJacobian, 15, 18) = 0.55412061888222286;
        IJth(rJacobian, 17, 18) = var_x262 - 1.4399999999999998e-6 * var_x263;
        IJth(rJacobian, 18, 18) = -35.246499999999997 - var_x269 + 10.246499999999999 * var_chaste_interface__calcium_buffering__fCMs + 1.7323243489657528e-7 * var_x263 + var_x120 * var_x264 + var_x124 * var_x265;
        IJth(rJacobian, 19, 18) = -var_x120 * var_x270 - var_x124 * var_x271;
        IJth(rJacobian, 23, 18) = 227.69999999999999 - 227.69999999999999 * var_chaste_interface__calcium_buffering__fCMs;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-1.8440677943018704 * var_x140 - 0.14432336906254858 * var_x92 - 0.12643083428112081 * var_x141 - 2.6773043380529855 * var_x142 - 3.8416074556718653 * var_x138 - var_x137 * var_x78 - var_x139 * var_x91);
        IJth(rJacobian, 18, 19) = var_x137 * var_x264 + var_x139 * var_x265;
        IJth(rJacobian, 19, 19) = -0.00078716207755981068 * var_x138 - 7.7718683646407365e-5 * var_x141 - 0.0016457739131233819 * var_x142 - 2.9572486086254304e-5 * var_x92 - var_x137 * var_x270 - var_x139 * var_x271;
        IJth(rJacobian, 20, 19) = 5.1812455764271576e-5 * var_x141 + 0.0010971826087489214 * var_x142 - 0.00037785751221943326 * var_x140;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0021962113249247841 - 15.367231619182254 * var_x140 - 6.1808487292273409 * var_x143 - 0.53453099652795766 * var_x144 - 4.8107789687516185 * var_x146 + var_x145 * var_x4);
        IJth(rJacobian, 20, 20) = -4.5001325336761377e-7 - 0.0012664827895411826 * var_x143 - 0.0031488126018286108 * var_x140 - 0.00010952772624538631 * var_x144 - 0.00098574953620847667 * var_x146 + var_x145 * var_x274;
        IJth(rJacobian, 15, 21) = var_x259;
        IJth(rJacobian, 21, 21) = -6.4435000000000002;
        IJth(rJacobian, 25, 21) = var_x276;
        IJth(rJacobian, 15, 22) = 0.024390000000000002 + 10.246499999999999 * var_chaste_interface__intracellular_ion_concentrations__Cai;
        IJth(rJacobian, 22, 22) = -0.54200000000000004 + var_x276;
        ...
        IJth(rJacobian, 15, 25) = 0.00046562000000000003 + var_x259;
        IJth(rJacobian, 21, 25) = -5.6925000000000008;
        IJth(rJacobian, 25, 25) = -0.0075100000000000002 + var_x276;
