...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x26 = NV_Ith_S(mParameters, 2) * var_chaste_interface__Ito__xtos;
        ...
        const double var_x30 = NV_Ith_S(mParameters, 0) * var_chaste_interface__IKr__xr;
        ...
        const double var_x37 = var_x36 * NV_Ith_S(mParameters, 1) * var_chaste_interface__IKs__xs2;
        ...
        const double var_x70 = var_x69 * var_chaste_interface__INa__xh;
        const double var_x71 = var_x70 * pow(var_chaste_interface__INa__xm, 2) * var_chaste_interface__INa__xj;
        const double var_x72 = var_x27 * var_x70;
        ...
        const double var_x75 = 2912.0 * var_x74;
        const double var_x76 = -3.4559505594389357 - 0.040000000000000001 * var_chaste_interface__cell__V;
        ...
        const double var_x142 = var_x140 / pow(var_x141, 2);
        const double var_x143 = 0.125 * var_x142;
        const double var_x144 = var_x143 * var_chaste_interface__ICaL__c1;
        ...
        const double var_x152 = var_x151 / pow((0.037037037037037035 + var_x148), 2);
        const double var_x153 = 0.002685333333333333 * var_x152 * var_chaste_interface__ICaL__c1;
        ...
        const double var_x164 = 0.088339222614840993 * var_x162 / pow(var_x163, 2);
        const double var_x165 = var_x161 * var_x164;
        const double var_x166 = 1 / var_x163;
        const double var_x167 = -317.5641025641026 * var_x156 * var_x157;
        const double var_x168 = 0.25 * var_x154 / pow(var_x155, 2);
        const double var_x169 = 4.9382716049382717e-6 * (var_x167 + var_x159 * var_x168) / pow((1 + 0.0022222222222222222 * var_x160), 2);
        ...
        const double var_x178 = var_x164 * var_x177;
        const double var_x179 = 0.00016422697956757767 / pow((0.0012815107473898831 + var_x172 + 0.012815107473898831 * var_x175), 2);
        const double var_x180 = var_x179 * (var_x167 + var_x168 * var_x174);
        const double var_x181 = var_x149 * var_x166;
        const double var_x182 = var_x180 * var_x181;
        const double var_x183 = 1.0 * var_x166;
        const double var_x184 = 1.0 - var_x183;
        const double var_x185 = var_x169 * var_x184;
        const double var_x186 = var_x180 * var_x184;
        const double var_x187 = var_x164 * var_x176;
        ...
        const double var_x194 = 0.22637460951196098 * var_x147 / pow(var_x171, 2);
        const double var_x195 = var_x179 * (var_x194 - var_x156 * var_x194);
        const double var_x196 = var_x181 * var_x195;
        const double var_x197 = 0.1111111111111111 * var_x152 * var_x166 * var_x176;
        const double var_x198 = var_x184 * var_chaste_interface__ICaL__xi2ca;
        ...
        const double var_x203 = 0.1111111111111111 * var_x202;
        const double var_x204 = var_x203 * var_chaste_interface__ICaL__xi1ca;
        ...
        const double var_x209 = var_x162 * var_x206 * var_x208;
        const double var_x210 = 20.604954226274931 * var_x209;
        const double var_x211 = var_x166 * var_x210;
        const double var_x212 = var_x142 * var_x207;
        const double var_x213 = var_x163 * var_x206;
        const double var_x214 = 29.156010230179024 * var_x198 * var_x213;
        const double var_x215 = var_x140 / (pow(var_x141, 3) * pow(var_x189, 2));
        ...
        const double var_x222 = var_x203 * var_chaste_interface__ICaL__xi1ba;
        const double var_x223 = 0.16287544169611309 * var_x209;
        const double var_x224 = var_x166 * var_x223;
        const double var_x225 = var_x184 * var_x223;
        const double var_x226 = 0.23046875000000003 * var_x218;
        const double var_x227 = var_x212 * var_x226;
        const double var_x228 = var_x215 * var_x226;
        const double var_x229 = var_x163 * var_x184 * var_x202 * var_x208;
        const double var_x230 = 0.20486111111111113 * var_x229;
        const double var_x231 = 1.8437500000000002 * var_x219;
        const double var_x232 = 29.156010230179024 * var_x218;
        const double var_x233 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        ...
        const double var_x247 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        ...
        const double var_x258 = ((var_x251) ? (0) : (var_x254 + var_x257 - 8.9997000000000013e-6 * var_x250 * var_x252 / pow(var_x253, 2) - 1.0641199999999999e-5 * var_x250 * var_x255 / pow(var_x256, 2)));
        const double var_x259 = ((var_x251) ? (0.0023926521499665608) : (var_x250 * var_x254 + var_x250 * var_x257));
        const double var_x260 = var_x247 * var_x259 / pow(var_x248, 2);
        ...
        const double var_x266 = exp(-0.20000000000000001 - var_x261);
        const double var_x267 = 1.0 + var_x266;
        const double var_x268 = 0.066666666666666666 * var_x266 / pow(var_x267, 2);
        const double var_x269 = 1.0 / var_x267;
        ...
        const double var_x274 = 0.10000000000000001 * var_x65;
        const double var_x275 = 1.0 * var_x25;
        ...
        const double var_x279 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x280 = 1.0 + var_x279;
        const double var_x281 = fabs(var_x74);
        const double var_x282 = (var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0);
        const double var_x283 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x284 = ((var_x282) ? (-50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR) : ((var_x283) ? (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) : (0.0)));
        const double var_x285 = var_x281 * var_x284;
        const double var_x286 = var_x285 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x287 = var_x221 * var_x286;
        const double var_x288 = 0.0014337722222222222 * var_x287;
        const double var_x289 = 1 / var_x280;
        const double var_x290 = 0.028675444444444444 * var_x279 * var_x289;
        const double var_x291 = var_x221 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x292 = var_x290 * var_x291;
        const double var_x293 = Signum(var_x74);
        const double var_x294 = var_x284 * var_x293;
        const double var_x295 = var_x292 * var_x294;
        const double var_x296 = var_x94 + var_x96 - var_x90;
        const double var_x297 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x298 = var_x297 * var_chaste_interface__Irel__xir;
        const double var_x299 = -var_x286 * var_x290;
        const double var_x300 = var_x281 * ((var_x282) ? (1.0) : ((var_x283) ? (11.300000000000001) : (0)));
        const double var_x301 = var_x105 - var_x107 - var_chaste_interface__Irel__xir;
        const double var_x302 = var_x110 - var_x108 - var_x109;
        const double var_x303 = var_x221 * var_x285;
        const double var_x304 = 0.0015 * var_x28;
        const double var_x305 = var_x293 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca);
        const double var_x306 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x307 = 1.0 + var_x306;
        const double var_x308 = 106.65141866666666 * var_x287;
        const double var_x309 = 1 / var_x307;
        const double var_x310 = 298.24222222222221 * var_x306 * var_x309;
        const double var_x311 = var_x291 * var_x310;
        const double var_x312 = var_x294 * var_x311;
        const double var_x313 = -9000.0 * var_x281 - var_x286 * var_x310;
        ...
        const double var_x326 = var_x323 * var_x325;
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x38 - 6.7199999999999998 * var_x53 - 1.173913043478261 * var_x59 - 0.032914599276144929 * var_x62 + var_x0 * var_x10 + var_x26 * (-0.055 * var_x25 - 0.11 * var_chaste_interface__Ito__ytos) - var_x29 * var_chaste_interface__INa__xh - var_x30 * var_x33 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x13 * var_x21 - 0.050000000000000003 * var_x64 * var_x65 + 0.07298099999999999 * var_x21 * var_x39 * var_x40 + 0.00055803571428571436 * var_x30 * var_x31 * var_x39 / pow(var_x32, 2) - 0.29411764705882354 * var_x13 * var_x39 * (0.24326999999999999 * var_x40 - var_x16 * (0.061749999999999999 * var_x17 + 0.039456396800000001 * var_x18) - 0.51429999999999998 * var_x14 * var_x19 / pow(var_x15, 2)) / pow((var_x13 + 0.98039215686274506 * var_x20), 2));
        IJth(rJacobian, 2, 0) = (1.0 - var_chaste_interface__INa__xm) * ((var_x116) ? (var_x114 - 0.032000000000000001 * var_x112 * var_x115 / pow(var_x113, 2)) : (0)) + 0.0072727272727272727 * var_x117 * var_chaste_interface__INa__xm;
        IJth(rJacobian, 3, 0) = (1.0 - var_chaste_interface__INa__xh) * ((var_x119) ? (-0.019852941176470591 * var_x118) : (0)) - ((var_x119) ? (0.28123999999999999 * var_x120 + 108500.0 * var_x121) : (0.693000693000693 * var_x122 / pow(var_x123, 2))) * var_chaste_interface__INa__xh;
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__xj) * ((var_x119) ? (var_x130 + var_x129 * var_x131 * (1.5254334000000001e-6 * var_x125 - 31073.016 * var_x124) - 0.311 * var_x126 * var_x127 * var_x131 / pow(var_x128, 2)) : (0)) - ((var_x119) ? (-0.001275024 * var_x135 + 0.016701360000000002 * var_x132 * var_x134 / pow(var_x133, 2)) : (-7.6049999999999996e-8 * var_x139 + 0.029999999999999999 * var_x136 * var_x138 / pow(var_x137, 2))) * var_chaste_interface__INa__xj;
        IJth(rJacobian, 5, 0) = var_x144 + var_x143 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 6, 0) = -var_x144 + var_x185 * var_chaste_interface__ICaL__xi2ba + var_x186 * var_chaste_interface__ICaL__xi2ca + (-var_x143 - var_x165 - var_x170 - var_x178 - var_x182) * var_chaste_interface__ICaL__c2 - var_x165 * var_chaste_interface__ICaL__xi2ba - var_x187 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x204 + var_x212 * var_x214 + var_x214 * var_x215 - var_x198 * var_x210 - var_x211 * var_chaste_interface__ICaL__xi2ca - 25.91645353793691 * var_x163 * var_x198 * var_x202 * var_x208;
        IJth(rJacobian, 8, 0) = var_x222 + var_x227 * var_chaste_interface__ICaL__xi2ba + var_x228 * var_chaste_interface__ICaL__xi2ba - var_x224 * var_chaste_interface__ICaL__xi2ba - var_x225 * var_chaste_interface__ICaL__xi2ba - var_x230 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x204 + var_x178 * var_chaste_interface__ICaL__c2 + var_x182 * var_chaste_interface__ICaL__c2 + (var_x187 + var_x211 - var_x186 + 25.91645353793691 * var_x229 + var_x184 * var_x210 - var_x212 * var_x232 - var_x215 * var_x232) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x222 + var_x165 * var_chaste_interface__ICaL__c2 + var_x170 * var_chaste_interface__ICaL__c2 + (var_x165 + var_x224 + var_x225 + var_x230 - var_x185 - var_x227 - var_x228) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1.0 / var_x234) * (1.0 * ((var_x239) ? (var_x237 - 8.8449999999999995e-5 * var_x235 * var_x238 / pow(var_x236, 2)) : (0)) + 1.0 * ((var_x244) ? (var_x242 - 0.00016973999999999998 * var_x240 * var_x243 / pow(var_x241, 2)) : (0))) + 0.13333333333333333 * var_x233 * (var_x245 + var_x246) / pow(var_x234, 2);
        IJth(rJacobian, 12, 0) = 0.059880239520958084 * var_x260 + var_x258 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x249);
        IJth(rJacobian, 13, 0) = 0.014970059880239521 * var_x260 + var_x258 * (0.25 * var_x249 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x265 * var_x268 + 0.0074074074074074077 * var_x262 * (var_x269 - var_chaste_interface__Ito__xtos) / (pow(var_x263, 2) * pow((0.055555555555555552 + var_x264), 2));
        IJth(rJacobian, 15, 0) = -var_x273 * var_x274 + 3.3333333333333335e-5 * var_x270 * (var_x275 - var_chaste_interface__Ito__ytos) / (pow(var_x271, 2) * pow((0.01 + var_x272), 2));
        IJth(rJacobian, 16, 0) = var_x268 * var_x277 + 0.00063492063492063492 * var_x276 * (var_x269 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x276), 2);
        IJth(rJacobian, 17, 0) = -var_x274 * var_x278 + 0.0050000000000000001 * var_x65 * (var_x275 - var_chaste_interface__Ito__ytof) / pow((1 + var_x25), 2);
        IJth(rJacobian, 19, 0) = var_x10 * var_x295 + var_x288 * pow(var_x279, 2) / pow(var_x280, 2) - var_x279 * var_x288 * var_x289;
        IJth(rJacobian, 20, 0) = -1.2342974728554348e-5 * var_x62 - 0.0025200000000000001 * var_x53 - 0.00044021739130434783 * var_x59 - var_x304 * var_chaste_interface__INa__xh;
        IJth(rJacobian, 21, 0) = var_x10 * var_x305 + var_x10 * var_x312 + var_x308 * pow(var_x306, 2) / pow(var_x307, 2) - var_x306 * var_x308 * var_x309;
        IJth(rJacobian, 22, 0) = var_x324 * (42.0 * var_x53 + 0.20571624547590581 * var_x62 + var_x10 * var_x314);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (-4.1580000000000007e-11 * var_x67 * var_chaste_interface__IKs__xs2 / (pow(var_x35, 2) * pow(var_chaste_interface__Ca__Ca_i_converted, 4)));
        IJth(rJacobian, 1, 1) = var_x103 * (-2539.0 + var_x88 + var_x90 - var_x94 - var_x96) + 0.001 * (0.00033599999999999998 / pow(var_x97, 3) + 0.0010919999999999999 / pow(var_x98, 3) + 8.9999999999999985e-6 / pow(var_x99, 3) + 5.6399999999999995e-5 / pow(var_x100, 3)) * (var_x107 - var_x105 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x104 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x101, 2);
        IJth(rJacobian, 19, 1) = var_x296 * var_x298;
        IJth(rJacobian, 22, 1) = 12500.0 * var_x323;
        IJth(rJacobian, 23, 1) = var_x296;
        IJth(rJacobian, 24, 1) = 2289.0 - var_x88;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-36.0 * var_x71);
        IJth(rJacobian, 2, 2) = -((var_x116) ? (var_x114 * var_x115) : (3.2000000000000002)) - 0.080000000000000002 * var_x117;
        IJth(rJacobian, 20, 2) = -0.0044999999999999997 * var_x71;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x29 * var_x69);
        IJth(rJacobian, 3, 3) = -((var_x119) ? (0.13500000000000001 * var_x118) : (0.0)) - ((var_x119) ? (310000.0 * var_x121 + 3.5600000000000001 * var_x120) : (7.6923076923076916 / var_x123));
        IJth(rJacobian, 20, 3) = -var_x304 * var_x69;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-12.0 * var_x72);
        IJth(rJacobian, 4, 4) = -((var_x119) ? (0.1212 * var_x135) : (0.29999999999999999 * var_x139)) - ((var_x119) ? (var_x130 * var_x131) : (0.0));
        IJth(rJacobian, 20, 4) = -0.0015 * var_x72;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75);
        IJth(rJacobian, 5, 5) = -4.3041299999999998 + var_x146 - 0.024167999999999999 * var_x149;
        IJth(rJacobian, 6, 5) = var_x189;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x149;
        IJth(rJacobian, 8, 5) = 0.0021800000000000001;
        IJth(rJacobian, 19, 5) = var_x299;
        IJth(rJacobian, 21, 5) = var_x313;
        IJth(rJacobian, 22, 5) = var_x326;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75);
        IJth(rJacobian, 5, 6) = -3.0 + var_x146;
        IJth(rJacobian, 6, 6) = var_x188 - var_x190 - var_x191;
        IJth(rJacobian, 7, 6) = var_x216;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x191;
        IJth(rJacobian, 10, 6) = var_x190;
        IJth(rJacobian, 19, 6) = var_x299;
        IJth(rJacobian, 21, 6) = var_x313;
        IJth(rJacobian, 22, 6) = var_x326;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x205 + var_x216 - 1.8929217120000003e-7 * var_x149 * var_x217;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x206;
        IJth(rJacobian, 19, 7) = var_x299;
        IJth(rJacobian, 21, 7) = var_x313;
        IJth(rJacobian, 22, 7) = var_x326;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x216;
        IJth(rJacobian, 8, 8) = -0.33762909604519775 + var_x205;
        IJth(rJacobian, 10, 8) = var_x206;
        IJth(rJacobian, 19, 8) = var_x299;
        IJth(rJacobian, 21, 8) = var_x313;
        IJth(rJacobian, 22, 8) = var_x326;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x192;
        IJth(rJacobian, 7, 9) = var_x216 + var_x220;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x192 - var_x220;
        IJth(rJacobian, 19, 9) = var_x299;
        IJth(rJacobian, 21, 9) = var_x313;
        IJth(rJacobian, 22, 9) = var_x326;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x193;
        IJth(rJacobian, 7, 10) = var_x216;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x231;
        IJth(rJacobian, 10, 10) = -var_x193 - var_x231;
        IJth(rJacobian, 19, 10) = var_x299;
        IJth(rJacobian, 21, 10) = var_x313;
        IJth(rJacobian, 22, 10) = var_x326;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x33 * var_x39 * NV_Ith_S(mParameters, 0));
        IJth(rJacobian, 11, 11) = -var_x245 - var_x246;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x37 * var_x66);
        IJth(rJacobian, 12, 12) = -var_x259;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x36 * var_x67);
        IJth(rJacobian, 13, 13) = -0.25 * var_x259;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x63 * (0.5 * var_x25 + var_chaste_interface__Ito__ytos) * NV_Ith_S(mParameters, 2));
        IJth(rJacobian, 14, 14) = -var_x265;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (var_x64);
        IJth(rJacobian, 15, 15) = -var_x273;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_chaste_interface__Ito__ytof);
        IJth(rJacobian, 16, 16) = -var_x277;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_chaste_interface__Ito__xtof);
        IJth(rJacobian, 17, 17) = -var_x278;
        IJth(rJacobian, 18, 18) = -0.01;
        IJth(rJacobian, 19, 18) = var_x292 * var_x300;
        IJth(rJacobian, 21, 18) = var_x300 * var_x311;
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x298 + var_x297 * var_x301;
        IJth(rJacobian, 22, 19) = 50.0 * var_x323;
        IJth(rJacobian, 23, 19) = -1;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (1.0436203813975009e-6 * var_x83 + 0.008152173913043478 * var_x79 - 1.173913043478261 * var_x78 - 318.49696580075846 * var_x80 - 36.287999999999997 * var_x84 + 0.00019591421434992582 * var_x38 * (17.737505194555091 + 0.0023223462158299631 * var_chaste_interface__Na__Na_i) / pow((1 + 0.00013092857142857142 * var_chaste_interface__Na__Na_i), 2));
        IJth(rJacobian, 20, 20) = 3.0570652173913045e-6 * var_x79 + 3.9135764302406278e-10 * var_x83 - 0.013608 * var_x84 - 0.00044021739130434783 * var_x78 - 0.039812120725094803 * var_x80;
        IJth(rJacobian, 22, 20) = var_x324 * (226.80000000000001 * var_x84 - 6.52262738373438e-6 * var_x83);
        IJth(rJacobian, 5, 21) = -var_x153;
        IJth(rJacobian, 6, 21) = var_x199 + (-var_x196 - var_x197) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x153 + (0.00063442013684210537 * var_x149 * var_x151 - 2.1032463466666669e-8 * var_x152 * var_x217) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x152 * var_x221;
        IJth(rJacobian, 9, 21) = -var_x199 + var_x196 * var_chaste_interface__ICaL__c2 + var_x197 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 21, 21) = -2.0;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (16903.864320000001 * var_x86 + 0.00017972853783688092 * var_x82 - 0.54431999999999992 * var_x87 + var_x0 * var_x85);
        IJth(rJacobian, 1, 22) = 0.00025000000000000001 * var_x102;
        IJth(rJacobian, 19, 22) = var_x295 * var_x85;
        IJth(rJacobian, 20, 22) = 6.3389491199999997 * var_x86 + 6.7398201688830334e-8 * var_x82 - 0.00020411999999999996 * var_x87;
        IJth(rJacobian, 21, 22) = 2.0 + var_x305 * var_x85 + var_x312 * var_x85;
        IJth(rJacobian, 22, 22) = var_x324 * (-14.789 + var_x327 + 3.4019999999999997 * var_x87 - 0.0011233033614805057 * var_x82 - 105649.152 * var_x86 + var_x314 * var_x85) + 0.0012574820180071425 * (9.0 / pow(var_x315, 3) + 56.399999999999999 / pow(var_x319, 3) + 0.97959183673469385 / pow(var_x321, 3) + 0.49704142011834318 / pow(var_x317, 3)) * (50.0 * var_chaste_interface__Irel__xir + 12500.0 * var_chaste_interface__Ca__Ca_i_converted + 0.019599999999999999 * var_chaste_interface__Ca__trops - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x221 * var_x325 - var_x328 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x52 * var_x60) / pow((0.035460992907801421 + var_x320 + 0.15957446808510639 * var_x316 + 0.12158054711246201 * var_x322 + 0.11456628477905074 * var_x318), 2);
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x327;
        IJth(rJacobian, 1, 23) = var_x103 * (var_x108 + var_x109 - var_x110);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = var_x290 * var_x303 + (var_x297 * var_x302 - 1.0 * var_x301 / var_x91) * var_chaste_interface__Irel__xir;
        IJth(rJacobian, 21, 23) = var_x303 * var_x310;
        IJth(rJacobian, 23, 23) = var_x302;
        IJth(rJacobian, 1, 24) = var_x103 * (0.019599999999999999 + var_x104);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x104;
        IJth(rJacobian, 22, 25) = var_x324 * (0.019599999999999999 + var_x328);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x328;
    }
