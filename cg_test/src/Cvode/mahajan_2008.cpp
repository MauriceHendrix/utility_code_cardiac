...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x90 = 32.700000000000003 * var_chaste_interface__Ca__tropi;
        ...
        const double var_x100 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        ...
        const double var_x103 = 1.0 + 0.00016799999999999999 / pow(var_x99, 2) + 0.00054599999999999994 / pow(var_x100, 2) + 4.4999999999999993e-6 / pow(var_x101, 2) + 2.8199999999999998e-5 / pow(var_x102, 2);
        ...
        const double var_x247 = 1.0 * ((var_x241) ? (var_x239 * var_x240) : (0.0042068965517241376));
        const double var_x248 = 1.0 * ((var_x246) ? (var_x244 * var_x245) : (0.011219512195121951));
        ...
        const double var_x271 = 1.0 / var_x269;
        ...
        const double var_x277 = 1.0 * var_x14;
        ...
        const double var_x286 = ((var_x284) ? (-50.0 + 1.0 * var_chaste_interface__Irel__Ca_JSR) : ((var_x285) ? (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) : (0.0)));
        ...
        const double var_x299 = 1.0 / var_chaste_interface__Ca__Ca_NSR;
        ...
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1.0 / var_x236) * (1.0 * ((var_x241) ? (var_x239 - 8.8449999999999995e-5 * var_x237 * var_x240 / pow(var_x238, 2)) : (0)) + 1.0 * ((var_x246) ? (var_x244 - 0.00016973999999999998 * var_x242 * var_x245 / pow(var_x243, 2)) : (0))) + 0.13333333333333333 * var_x235 * (var_x247 + var_x248) / pow(var_x236, 2);
        IJth(rJacobian, 12, 0) = 0.059880239520958084 * var_x262 + var_x260 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x251);
        ...
        IJth(rJacobian, 3, 3) = -((var_x121) ? (0.13500000000000001 * var_x120) : (0.0)) - ((var_x121) ? (310000.0 * var_x123 + 3.5600000000000001 * var_x122) : (7.6923076923076916 / var_x125));
        IJth(rJacobian, 20, 3) = -0.000125 * var_x72;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x73);
        IJth(rJacobian, 4, 4) = -((var_x121) ? (0.1212 * var_x137) : (0.29999999999999999 * var_x141)) - ((var_x121) ? (var_x132 * var_x133) : (0.0));
