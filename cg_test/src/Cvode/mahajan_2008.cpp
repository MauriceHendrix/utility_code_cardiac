...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellmahajan_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x6 = exp(7.3793810433533835 + 0.080320000000000003 * var_chaste_interface__cell__V);
        const double var_x7 = exp(-31.363518823866141 + 0.061749999999999999 * var_chaste_interface__cell__V);
        const double var_x8 = var_x7 + 0.49124000000000001 * var_x6;
        ...
        const double var_x126 = exp(24.640530000000002 + 0.311 * var_chaste_interface__cell__V);
        const double var_x127 = 1.0 + var_x126;
        const double var_x128 = 1 / var_x127;
        const double var_x129 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x130 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x131 = -127140.0 * var_x129 - 3.4740000000000003e-5 * var_x130;
        ...
        const double var_x185 = 1.0 - var_x168;
        const double var_x186 = var_x171 * var_x185;
        const double var_x187 = var_x182 * var_x185;
        const double var_x188 = var_x166 * var_x178;
        const double var_x189 = -var_x148;
        const double var_x190 = 1.0 + var_x189;
        const double var_x191 = var_x163 * var_x168;
        const double var_x192 = var_x168 * var_x179;
        const double var_x193 = var_x178 * var_x185;
        const double var_x194 = var_x163 * var_x185;
        const double var_x195 = 0.22637460951196098 * var_x149 / pow(var_x173, 2);
        const double var_x196 = var_x181 * (var_x195 - var_x158 * var_x195);
        const double var_x197 = var_x183 * var_x196;
        const double var_x198 = 0.1111111111111111 * var_x154 * var_x168 * var_x178;
        const double var_x199 = var_x185 * var_chaste_interface__ICaL__xi2ca;
        const double var_x200 = var_x196 * var_x199;
        const double var_x201 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
        const double var_x202 = 1.0 + var_x201;
        const double var_x203 = var_x201 / pow(var_x202, 2);
        const double var_x204 = 0.1111111111111111 * var_x203;
        const double var_x205 = var_x204 * var_chaste_interface__ICaL__xi1ca;
        const double var_x206 = 0.33333333333333331 / var_x202;
        const double var_x207 = 0.33333333333333331 - var_x206;
        const double var_x208 = 1 / var_x190;
        const double var_x209 = var_x147 * var_x208;
        const double var_x210 = var_x164 * var_x207 * var_x209;
        const double var_x211 = 20.604954226274931 * var_x210;
        const double var_x212 = var_x168 * var_x211;
        const double var_x213 = var_x144 * var_x208;
        const double var_x214 = var_x165 * var_x207;
        const double var_x215 = 29.156010230179024 * var_x199 * var_x214;
        const double var_x216 = var_x142 / (pow(var_x143, 3) * pow(var_x190, 2));
        const double var_x217 = -0.018268800000000002 * var_x151;
        const double var_x218 = 41.377027474346242 + 1117.1797418073486 * var_x150;
        const double var_x219 = var_x185 * var_x214;
        const double var_x220 = var_x209 * var_x219;
        const double var_x221 = 233.2480818414322 * var_x220;
        const double var_x222 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x223 = var_x204 * var_chaste_interface__ICaL__xi1ba;
        const double var_x224 = 0.16287544169611309 * var_x210;
        const double var_x225 = var_x168 * var_x224;
        const double var_x226 = var_x185 * var_x224;
        const double var_x227 = 0.23046875000000003 * var_x219;
        const double var_x228 = var_x213 * var_x227;
        const double var_x229 = var_x216 * var_x227;
        const double var_x230 = var_x165 * var_x185 * var_x203 * var_x209;
        const double var_x231 = 0.20486111111111113 * var_x230;
        const double var_x232 = 1.8437500000000002 * var_x220;
        const double var_x233 = 29.156010230179024 * var_x219;
        const double var_x234 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x235 = 1.0 + var_x234;
        const double var_x236 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x237 = -1.0 + var_x236;
        const double var_x238 = 0.00060999999999999997 / var_x237;
        const double var_x239 = 10.0 + var_chaste_interface__cell__V;
        const double var_x240 = fabs(var_x239) > 0.001;
        const double var_x241 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x242 = 1.0 - var_x241;
        const double var_x243 = 0.0013799999999999999 / var_x242;
        const double var_x244 = 7.0 + var_chaste_interface__cell__V;
        const double var_x245 = fabs(var_x244) > 0.001;
        const double var_x246 = ((var_x240) ? (var_x238 * var_x239) : (0.0042068965517241376));
        const double var_x247 = ((var_x245) ? (var_x243 * var_x244) : (0.011219512195121951));
        const double var_x248 = exp(0.089820359281437126 - 0.059880239520958084 * var_chaste_interface__cell__V);
        const double var_x249 = 1.0 + var_x248;
        const double var_x250 = 1 / var_x249;
        const double var_x251 = 30.0 + var_chaste_interface__cell__V;
        const double var_x252 = fabs(var_x251) < 0.014556040756914121;
        const double var_x253 = exp(2.0609999999999999 + 0.068699999999999997 * var_chaste_interface__cell__V);
        const double var_x254 = -1.0 + var_x253;
        const double var_x255 = 0.00013100000000000001 / var_x254;
        const double var_x256 = exp(-4.4399999999999995 - 0.14799999999999999 * var_chaste_interface__cell__V);
        const double var_x257 = 1.0 - var_x256;
        const double var_x258 = 7.1899999999999999e-5 / var_x257;
        const double var_x259 = ((var_x252) ? (0) : (var_x255 + var_x258 - 8.9997000000000013e-6 * var_x251 * var_x253 / pow(var_x254, 2) - 1.0641199999999999e-5 * var_x251 * var_x256 / pow(var_x257, 2)));
        const double var_x260 = ((var_x252) ? (0.0023926521499665608) : (var_x251 * var_x255 + var_x251 * var_x258));
        const double var_x261 = var_x248 * var_x260 / pow(var_x249, 2);
        const double var_x262 = 0.066666666666666666 * var_chaste_interface__cell__V;
        const double var_x263 = exp(0.20000000000000001 + var_x262);
        const double var_x264 = 1.0 + var_x263;
        const double var_x265 = 1 / var_x264;
        const double var_x266 = 1 / (0.5 + 9.0 * var_x265);
        const double var_x267 = exp(-0.20000000000000001 - var_x262);
        const double var_x268 = 1.0 + var_x267;
        const double var_x269 = 0.066666666666666666 * var_x267 / pow(var_x268, 2);
        const double var_x270 = 1 / var_x268;
        const double var_x271 = exp(6.0 + var_x11);
        const double var_x272 = 1.0 + var_x271;
        const double var_x273 = 1 / var_x272;
        const double var_x274 = 1 / (30.0 + 3000.0 * var_x273);
        const double var_x275 = 0.10000000000000001 * var_x65;
        ...
        const double var_x284 = ((var_x282) ? (-50.0 + var_chaste_interface__Irel__Ca_JSR) : ((var_x283) ? (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR) : (0)));
        const double var_x285 = var_x281 * var_x284;
        const double var_x286 = var_x285 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x287 = var_x222 * var_x286;
        ...
        const double var_x291 = var_x222 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x292 = var_x290 * var_x291;
        const double var_x293 = Signum(var_x75);
        const double var_x294 = var_x284 * var_x293;
        const double var_x295 = var_x292 * var_x294;
        const double var_x296 = var_x96 + var_x98 - var_x92;
        ...
        const double var_x300 = var_x281 * ((var_x282) ? (1) : ((var_x283) ? (11.300000000000001) : (0)));
        const double var_x301 = var_x107 - var_x109 - var_chaste_interface__Irel__xir;
        const double var_x302 = var_x112 - var_x110 - var_x111;
        const double var_x303 = var_x222 * var_x285;
        const double var_x304 = var_x293 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca);
        const double var_x305 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x306 = 1.0 + var_x305;
        const double var_x307 = 106.65141866666666 * var_x287;
        const double var_x308 = 1 / var_x306;
        const double var_x309 = 298.24222222222221 * var_x305 * var_x308;
        const double var_x310 = var_x291 * var_x309;
        const double var_x311 = var_x294 * var_x310;
        const double var_x312 = -9000.0 * var_x281 - var_x286 * var_x309;
        const double var_x313 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x314 = pow(var_x313, (-2));
        const double var_x315 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x316 = pow(var_x315, (-2));
        const double var_x317 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x318 = pow(var_x317, (-2));
        const double var_x319 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x320 = pow(var_x319, (-2));
        const double var_x321 = 1 / (1.0 + 4.5 * var_x314 + 3.2307692307692308 * var_x316 + 28.199999999999999 * var_x318 + 3.4285714285714284 * var_x320);
        const double var_x322 = (-50.0 + 50.0 * var_chaste_interface__ICaL__c1 + 50.0 * var_chaste_interface__ICaL__c2 + 50.0 * var_chaste_interface__ICaL__xi1ba + 50.0 * var_chaste_interface__ICaL__xi1ca + 50.0 * var_chaste_interface__ICaL__xi2ba + 50.0 * var_chaste_interface__ICaL__xi2ca) * NV_Ith_S(mParameters, 3);
        const double var_x323 = 50.0 * var_x321;
        const double var_x324 = var_x323 * var_x76;
        const double var_x325 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x326 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (var_x31 - var_x34 - 6.7199999999999998 * var_x49 - 1.173913043478261 * var_x55 - 0.032914599276144929 * var_x62 + var_x15 * (-0.055 * var_x14 - 0.11 * var_chaste_interface__Ito__ytos) + var_x25 * var_x26 - var_x56 * var_x59 - 0.040000000000000001 * var_chaste_interface__Ito__xtof * var_chaste_interface__Ito__ytof - 0.30599999999999999 * var_x10 * var_x2 - 0.050000000000000003 * var_x64 * var_x65 + 0.07298099999999999 * var_x10 * var_x35 * var_x36 + 0.044642857142857144 * var_x35 * var_x56 * var_x57 / pow(var_x58, 2) - 0.29411764705882354 * var_x2 * var_x35 * (0.24326999999999999 * var_x36 - var_x5 * (0.061749999999999999 * var_x7 + 0.039456396800000001 * var_x6) - 0.51429999999999998 * var_x3 * var_x8 / pow(var_x4, 2)) / pow((var_x2 + 0.98039215686274506 * var_x9), 2));
        ...
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__xj) * ((var_x121) ? (var_x132 + var_x128 * var_x133 * (1.5254334000000001e-6 * var_x130 - 31073.016 * var_x129) - 0.311 * var_x126 * var_x131 * var_x133 / pow(var_x127, 2)) : (0)) - ((var_x121) ? (-0.001275024 * var_x137 + 0.016701360000000002 * var_x134 * var_x136 / pow(var_x135, 2)) : (-7.6049999999999996e-8 * var_x141 + 0.029999999999999999 * var_x138 * var_x140 / pow(var_x139, 2))) * var_chaste_interface__INa__xj;
        IJth(rJacobian, 5, 0) = var_x146 + var_x145 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 6, 0) = -var_x146 + var_x186 * var_chaste_interface__ICaL__xi2ba + var_x187 * var_chaste_interface__ICaL__xi2ca + (-var_x145 - var_x167 - var_x172 - var_x180 - var_x184) * var_chaste_interface__ICaL__c2 - var_x167 * var_chaste_interface__ICaL__xi2ba - var_x188 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x205 + var_x213 * var_x215 + var_x215 * var_x216 - var_x199 * var_x211 - var_x212 * var_chaste_interface__ICaL__xi2ca - 25.91645353793691 * var_x165 * var_x199 * var_x203 * var_x209;
        IJth(rJacobian, 8, 0) = var_x223 + var_x228 * var_chaste_interface__ICaL__xi2ba + var_x229 * var_chaste_interface__ICaL__xi2ba - var_x225 * var_chaste_interface__ICaL__xi2ba - var_x226 * var_chaste_interface__ICaL__xi2ba - var_x231 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x205 + var_x180 * var_chaste_interface__ICaL__c2 + var_x184 * var_chaste_interface__ICaL__c2 + (var_x188 + var_x212 - var_x187 + 25.91645353793691 * var_x230 + var_x185 * var_x211 - var_x213 * var_x233 - var_x216 * var_x233) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x223 + var_x167 * var_chaste_interface__ICaL__c2 + var_x172 * var_chaste_interface__ICaL__c2 + (var_x167 + var_x225 + var_x226 + var_x231 - var_x186 - var_x228 - var_x229) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = (1 / var_x235 - var_chaste_interface__IKr__xr) * (((var_x240) ? (var_x238 - 8.8449999999999995e-5 * var_x236 * var_x239 / pow(var_x237, 2)) : (0)) + ((var_x245) ? (var_x243 - 0.00016973999999999998 * var_x241 * var_x244 / pow(var_x242, 2)) : (0))) + 0.13333333333333333 * var_x234 * (var_x246 + var_x247) / pow(var_x235, 2);
        IJth(rJacobian, 12, 0) = 0.059880239520958084 * var_x261 + var_x259 * (var_x250 - var_chaste_interface__IKs__xs1);
        IJth(rJacobian, 13, 0) = 0.014970059880239521 * var_x261 + var_x259 * (0.25 * var_x250 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x266 * var_x269 + 0.0074074074074074077 * var_x263 * (var_x270 - var_chaste_interface__Ito__xtos) / (pow(var_x264, 2) * pow((0.055555555555555552 + var_x265), 2));
        IJth(rJacobian, 15, 0) = -var_x274 * var_x275 + 3.3333333333333335e-5 * var_x271 * (var_x14 - var_chaste_interface__Ito__ytos) / (pow(var_x272, 2) * pow((0.01 + var_x273), 2));
        IJth(rJacobian, 16, 0) = var_x269 * var_x277 + 0.00063492063492063492 * var_x276 * (var_x270 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x276), 2);
        IJth(rJacobian, 17, 0) = -var_x275 * var_x278 + 0.0050000000000000001 * var_x65 * (var_x14 - var_chaste_interface__Ito__ytof) / pow((1 + var_x14), 2);
        IJth(rJacobian, 19, 0) = var_x25 * var_x295 + var_x288 * pow(var_x279, 2) / pow(var_x280, 2) - var_x279 * var_x288 * var_x289;
        ...
        IJth(rJacobian, 21, 0) = var_x25 * var_x304 + var_x25 * var_x311 + var_x307 * pow(var_x305, 2) / pow(var_x306, 2) - var_x305 * var_x307 * var_x308;
        IJth(rJacobian, 22, 0) = var_x321 * (42.0 * var_x49 + 0.20571624547590581 * var_x62 + var_x25 * var_x322);
        ...
        IJth(rJacobian, 22, 1) = 12500.0 * var_x321;
        ...
        IJth(rJacobian, 6, 5) = var_x190;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x151;
        IJth(rJacobian, 8, 5) = 0.0021800000000000001;
        IJth(rJacobian, 19, 5) = var_x299;
        IJth(rJacobian, 21, 5) = var_x312;
        IJth(rJacobian, 22, 5) = var_x324;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77);
        IJth(rJacobian, 5, 6) = -3.0 + var_x148;
        IJth(rJacobian, 6, 6) = var_x189 - var_x191 - var_x192;
        IJth(rJacobian, 7, 6) = var_x217;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x192;
        IJth(rJacobian, 10, 6) = var_x191;
        IJth(rJacobian, 19, 6) = var_x299;
        IJth(rJacobian, 21, 6) = var_x312;
        IJth(rJacobian, 22, 6) = var_x324;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x206 + var_x217 - 1.8929217120000003e-7 * var_x151 * var_x218;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x207;
        IJth(rJacobian, 19, 7) = var_x299;
        IJth(rJacobian, 21, 7) = var_x312;
        IJth(rJacobian, 22, 7) = var_x324;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x217;
        IJth(rJacobian, 8, 8) = -0.33762909604519775 + var_x206;
        IJth(rJacobian, 10, 8) = var_x207;
        IJth(rJacobian, 19, 8) = var_x299;
        IJth(rJacobian, 21, 8) = var_x312;
        IJth(rJacobian, 22, 8) = var_x324;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x193;
        IJth(rJacobian, 7, 9) = var_x217 + var_x221;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x193 - var_x221;
        IJth(rJacobian, 19, 9) = var_x299;
        IJth(rJacobian, 21, 9) = var_x312;
        IJth(rJacobian, 22, 9) = var_x324;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x194;
        IJth(rJacobian, 7, 10) = var_x217;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x232;
        IJth(rJacobian, 10, 10) = -var_x194 - var_x232;
        IJth(rJacobian, 19, 10) = var_x299;
        IJth(rJacobian, 21, 10) = var_x312;
        IJth(rJacobian, 22, 10) = var_x324;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x35 * var_x59 * NV_Ith_S(mParameters, 0) * NV_Ith_S(mParameters, 5));
        IJth(rJacobian, 11, 11) = -var_x246 - var_x247;
        ...
        IJth(rJacobian, 13, 13) = -0.25 * var_x260;
        ...
        IJth(rJacobian, 22, 20) = var_x321 * (226.80000000000001 * var_x86 - 6.52262738373438e-6 * var_x84);
        IJth(rJacobian, 5, 21) = -var_x155;
        IJth(rJacobian, 6, 21) = var_x200 + (-var_x197 - var_x198) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x155 + (0.00063442013684210537 * var_x151 * var_x153 - 2.1032463466666669e-8 * var_x154 * var_x218) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x154 * var_x222;
        IJth(rJacobian, 9, 21) = -var_x200 + var_x197 * var_chaste_interface__ICaL__c2 + var_x198 * var_chaste_interface__ICaL__c2;
        ...
        IJth(rJacobian, 19, 22) = var_x295 * var_x87;
        IJth(rJacobian, 20, 22) = 6.3389491199999997 * var_x88 + 6.7398201688830334e-8 * var_x83 - 0.00020411999999999996 * var_x89;
        IJth(rJacobian, 21, 22) = 2.0 + var_x304 * var_x87 + var_x311 * var_x87;
        IJth(rJacobian, 22, 22) = var_x321 * (-14.789 + var_x325 + 3.4019999999999997 * var_x89 - 0.0011233033614805057 * var_x83 - 105649.152 * var_x88 + var_x322 * var_x87) + 0.0012574820180071425 * (9.0 / pow(var_x313, 3) + 56.399999999999999 / pow(var_x317, 3) + 0.97959183673469385 / pow(var_x319, 3) + 0.49704142011834318 / pow(var_x315, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x326 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x48 * var_x60 - 50.0 * var_x222 * var_x76) / pow((0.035460992907801421 + var_x318 + 0.15957446808510639 * var_x314 + 0.12158054711246201 * var_x320 + 0.11456628477905074 * var_x316), 2);
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x325;
        IJth(rJacobian, 1, 23) = var_x105 * (var_x110 + var_x111 - var_x112);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = var_x290 * var_x303 + (var_x297 * var_x302 - 1.0 * var_x301 / var_x93) * var_chaste_interface__Irel__xir;
        IJth(rJacobian, 21, 23) = var_x303 * var_x309;
        ...
        IJth(rJacobian, 22, 25) = var_x321 * (0.019599999999999999 + var_x326);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x326;
    }
