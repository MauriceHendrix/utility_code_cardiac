...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_noble_SAN_model_1984FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x76 = var_x75 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x122 = 0.001 * var_chaste_interface__time_dependent_potassium_current_x_gate__x;
        ...
        const double var_x140 = 0.001 * var_chaste_interface__second_inward_current_d_gate__d;
        ...
        const double var_x158 = 8.9492436350427843e-6 * var_x0;
        const double var_x159 = -4.2956369448205359e-5 * var_x27;
        const double var_x160 = 2.0100300550820484e-8 * var_x34;
        const double var_x161 = 7.5243245632378463e-10 * var_x58;
        const double var_x162 = 4.2956369448205359e-5 * var_x69;
        const double var_x163 = var_x160 * var_x37;
        ...
        const double var_x167 = 2.1213021949731043e-8 * var_x102;
        const double var_x168 = 0.002 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x169 = 0.20000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Ca_rel;
        const double var_x170 = 0.0050000000000000001 * var_chaste_interface__intracellular_calcium_concentration__p;
        const double var_x171 = 1.0 - var_chaste_interface__intracellular_calcium_concentration__p;
        ...
        const double var_x181 = var_x179 * var_x42;
        ...
        const double var_x187 = 5.3695461810256699e-6 * var_x23;
        const double var_x188 = 4.2956369448205359e-5 * var_x28;
        const double var_x189 = var_x160 * var_x42;
        const double var_x190 = 0.00071593949080342272 * var_x87;
        ...
        IJth(rJacobian, 2, 0) = -0.002 * ((var_x117) ? (0) : (var_x120 - 0.20000000000000001 * var_x116 * var_x118 / pow(var_x119, 2))) * var_chaste_interface__hyperpolarising_activated_current_y_gate__y - 0.067000000000000004 * var_x121 * (0.0001 - 0.0001 * var_chaste_interface__hyperpolarising_activated_current_y_gate__y);
        IJth(rJacobian, 3, 0) = (0.001 - var_x122) * ((var_x124) ? (0) : (var_x127 - 0.10000000000000001 * var_x123 * var_x125 / pow(var_x126, 2))) - var_x122 * ((var_x124) ? (0) : (var_x130 - 0.011866666666666666 * var_x123 * var_x128 / pow(var_x129, 2)));
        IJth(rJacobian, 4, 0) = (0.001 - 0.001 * var_chaste_interface__fast_sodium_current_m_gate__m) * ((var_x132) ? (0) : (var_x136 - 20.0 * var_x131 * var_x134 / pow(var_x135, 2))) + 0.44800000000000001 * var_x137 * var_chaste_interface__fast_sodium_current_m_gate__m;
        ...
        IJth(rJacobian, 6, 0) = (0.001 - var_x140) * ((var_x142) ? (0) : (var_x147 - 7.5 * var_x141 * var_x145 / pow(var_x146, 2))) - var_x140 * ((var_x142) ? (0) : (var_x150 - 1.2 * var_x141 * var_x148 / pow(var_x149, 2)));
        IJth(rJacobian, 7, 0) = (0.001 - 0.001 * var_chaste_interface__second_inward_current_f_gate__f) * ((var_x152) ? (0) : (var_x155 - 1.5625 * var_x151 * var_x153 / pow(var_x154, 2))) - 0.012500000000000001 * var_x156 * var_chaste_interface__second_inward_current_f_gate__f / pow(var_x157, 2);
        IJth(rJacobian, 9, 0) = -5.0115764356239594e-7 + var_x159 - 4.2956369448205359e-8 * var_x15 - 1.0534054388532985e-7 * var_x56 + var_x161 * var_x40 - var_x158 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x160 * var_x40;
        IJth(rJacobian, 12, 0) = var_x171 * var_x174 - 0.00125 * var_x175 * var_chaste_interface__intracellular_calcium_concentration__p / pow(var_x176, 2) - 0.00015625 * var_x171 * var_x172 * var_x177 / pow(var_x173, 2);
        IJth(rJacobian, 13, 0) = 0.00038679860604725458 * var_x27 + 3.4474706640864439e-7 * var_x5 + 6.7752426238365633e-9 * var_x61 - 3.6198441972907663e-6 * var_x31 + var_x178 * var_chaste_interface__extracellular_potassium_concentration__Kc + var_x179 * var_x60 - 6.7752426238365633e-9 * var_x58 * var_x60;
        IJth(rJacobian, 14, 0) = var_x159 + 4.0200601101640964e-7 * var_x31 - 3.8286286763467583e-8 * var_x5 - 7.5243245632378463e-10 * var_x61 + var_x161 * var_x60 - var_x160 * var_x60 - var_x187 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        ...
        IJth(rJacobian, 11, 1) = var_x114 * var_x169 - var_x113 * var_x169;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x70 * var_x71 - var_x71 * var_x72);
        IJth(rJacobian, 2, 2) = -0.002 * ((var_x117) ? (2.5) : (var_x116 * var_x120)) - 0.0001 * var_x121;
        IJth(rJacobian, 9, 2) = -var_x162 * var_x71;
        IJth(rJacobian, 13, 2) = var_x180 * var_x71;
        IJth(rJacobian, 14, 2) = -var_x188 * var_x71;
        ...
        IJth(rJacobian, 3, 3) = -0.001 * ((var_x124) ? (2.5) : (var_x123 * var_x127)) - 0.001 * ((var_x124) ? (2.5) : (var_x123 * var_x130));
        ...
        IJth(rJacobian, 4, 4) = -0.001 * ((var_x132) ? (2000.0) : (var_x131 * var_x136)) - 8.0 * var_x137;
        IJth(rJacobian, 9, 4) = -2.6847730905128351e-5 * var_x76;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x1 * var_x75);
        IJth(rJacobian, 5, 5) = -0.02 * var_x138 - 2.0 / (1.0 + 320.0 * var_x139);
        IJth(rJacobian, 9, 5) = -var_x158 * var_x75;
        ...
        IJth(rJacobian, 6, 6) = -0.001 * ((var_x142) ? (120.0) : (var_x141 * var_x147)) - 0.001 * ((var_x142) ? (120.0) : (var_x141 * var_x150));
        IJth(rJacobian, 9, 6) = -var_x163 * var_x77;
        IJth(rJacobian, 13, 6) = var_x181 * var_x77;
        IJth(rJacobian, 14, 6) = -var_x189 * var_x77;
        ...
        IJth(rJacobian, 7, 7) = -0.001 * ((var_x152) ? (25.0) : (var_x151 * var_x155)) - 0.050000000000000003 / var_x157;
        IJth(rJacobian, 9, 7) = -var_x163 * var_x80;
        IJth(rJacobian, 13, 7) = var_x181 * var_x80;
        IJth(rJacobian, 14, 7) = -var_x189 * var_x80;
        ...
        IJth(rJacobian, 9, 8) = -var_x163 * var_x81;
        IJth(rJacobian, 13, 8) = var_x181 * var_x81;
        IJth(rJacobian, 14, 8) = -var_x189 * var_x81;
        ...
        IJth(rJacobian, 9, 9) = var_x166 + 3.4230292104218926e-16 * var_x90 + 6.7119327262820874e-7 * var_x92 - 2.5773821668923216e-7 * var_x93 - 1.3387805342902908e-5 * var_x68 - 0.0002390679525518376 * var_x83 - var_x164 * var_chaste_interface__extracellular_potassium_concentration__Kc - var_x165 * var_x95;
        IJth(rJacobian, 13, 9) = 4.0291521463255683e-6 * var_x92 - var_x182 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 14, 9) = -4.4746218175213919e-7 * var_x92 + var_x190 * var_chaste_interface__extracellular_potassium_concentration__Kc;
        IJth(rJacobian, 1, 10) = 0.040000000000000001 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 10, 10) = -var_x168 - 0.79999999999999993 * var_chaste_interface__intracellular_calcium_concentration__Cai;
        IJth(rJacobian, 11, 10) = var_x170;
        IJth(rJacobian, 1, 11) = 0.002 * var_x115;
        IJth(rJacobian, 10, 11) = var_x168;
        IJth(rJacobian, 11, 11) = -var_x170 - 0.10000000000000001 * var_x115;
        ...
        IJth(rJacobian, 12, 12) = -0.0050000000000000001 / var_x176 - var_x174 * var_x177;
        ...
        IJth(rJacobian, 9, 13) = 0.0010739092362051341 * var_x105 + 2.8688154306220512e-5 * var_x100 + var_x104 * var_x167 - var_x162 * var_x26 - var_x164 * var_chaste_interface__intracellular_sodium_concentration__Nai;
        IJth(rJacobian, 13, 13) = -0.001 + var_x186 - var_x184 - var_x185 + 0.0064466434341209095 * var_x105 - 4.8349825755906825e-7 * var_x101 + var_x178 * var_x28 + var_x180 * var_x26 - var_x179 * var_x55 - var_x182 * var_chaste_interface__intracellular_sodium_concentration__Nai - var_x183 * var_x3 - 1.9101165730728621e-7 * var_x102 * var_x29;
        IJth(rJacobian, 14, 13) = var_x165 + var_x191 - var_x193 + 5.3695461810256699e-8 * var_x101 - 0.00071593949080342272 * var_x105 + var_x160 * var_x55 + var_x167 * var_x29 + var_x190 * var_chaste_interface__intracellular_sodium_concentration__Nai + var_x192 * var_x3 - var_x187 * var_x28 - var_x188 * var_x26;
        ...
        IJth(rJacobian, 13, 14) = var_x183 + var_x17 * var_x184 + var_x17 * var_x185 + var_x179 * var_x96 - var_x17 * var_x186;
        IJth(rJacobian, 14, 14) = var_x166 - var_x192 + var_x17 * var_x193 - var_x165 * var_x17 - var_x17 * var_x191;
    }
