...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x51 = 26.711785007306684 * var_x20;
        const double var_x52 = -var_x51 + var_chaste_interface__membrane__Vm;
        const double var_x53 = var_x0 * var_x52 / pow(var_x1, 2);
        const double var_x54 = var_x33 * var_chaste_interface__membrane__Vm;
        const double var_x55 = var_x54 / pow(var_x34, 2);
        const double var_x56 = var_x37 * var_x55;
        const double var_x57 = var_x13 * var_chaste_interface__membrane__Vm;
        const double var_x58 = var_x17 * var_x57 / pow(var_x14, 2);
        const double var_x59 = var_x39 * var_x52 * var_chaste_interface__IKr_xr_gate__xr / pow(var_x40, 2);
        const double var_x60 = var_x21 / pow(var_x22, 2);
        const double var_x61 = var_x31 * var_x52;
        const double var_x62 = var_x60 * var_x61;
        const double var_x63 = exp(-0.027328761436209426 * var_chaste_interface__membrane__Vm);
        const double var_x64 = 1.0 + 0.32000000000000001 * var_x63;
        const double var_x65 = 1 / var_x64;
        const double var_x66 = 1.0 * var_x65;
        const double var_x67 = pow(var_chaste_interface__Na__Na_i, 3);
        const double var_x68 = exp(0.010107898065447322 * var_chaste_interface__membrane__Vm);
        const double var_x69 = var_x67 * var_x68;
        const double var_x70 = var_x63 * var_chaste_interface__Ca__Ca_i;
        const double var_x71 = 1.0 + 1.5624999999999999e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x72 = 1 / var_x71;
        const double var_x73 = 1 / (13227.9606 + 8.4084932990912282 * var_x67 + 4344355.375 * var_chaste_interface__Ca__Ca_i);
        const double var_x74 = var_x72 * var_x73;
        const double var_x75 = var_x74 * (0.065499179464098653 * var_x69 + 269964.43697145121 * var_x70);
        const double var_x76 = pow(var_chaste_interface__Na__Na_ss_sr, 3);
        const double var_x77 = var_x68 * var_x76;
        const double var_x78 = var_x63 * var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x79 = pow(var_chaste_interface__Ca__Ca_ss_sr, (-2));
        const double var_x80 = 1.0 + 1.5624999999999999e-8 * var_x79;
        const double var_x81 = 1 / var_x80;
        const double var_x82 = 1 / (13227.9606 + 8.4084932990912282 * var_x76 + 4344355.375 * var_chaste_interface__Ca__Ca_ss_sr);
        const double var_x83 = var_x81 * var_x82;
        const double var_x84 = var_x83 * (0.016374794866024663 * var_x77 + 67491.109242862804 * var_x78);
        const double var_x85 = pow(var_chaste_interface__Ito1_a_gate__a, 3);
        const double var_x86 = exp(0.0018181818181818182 * var_chaste_interface__membrane__Vm);
        const double var_x87 = var_x85 * var_x86 * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x88 = 0.4975 * var_x87;
        const double var_x89 = var_x35 * var_x54;
        const double var_x90 = var_x89 * var_chaste_interface__Ca__Ca_i;
        const double var_x91 = var_x15 * var_x16 * var_chaste_interface__membrane__Vm;
        const double var_x92 = var_x24 * var_x29 / pow(var_x25, 2);
        const double var_x93 = 0.24326999999999999 * var_x60 - 0.51429999999999998 * var_x92 - var_x26 * (0.061749999999999999 * var_x28 + 0.039456396800000001 * var_x27);
        const double var_x94 = var_x23 * var_x52 / pow((var_x23 + 0.98039215686274506 * var_x30), 2);
        const double var_x95 = 0.49019607843137253 * var_x94;
        const double var_x96 = 1 + 0.38461538461538458 * var_chaste_interface__Na__Na_i;
        const double var_x97 = pow(var_x96, (-3));
        const double var_x98 = exp(-3.4441726741524206 - var_x12);
        const double var_x99 = 1.0 + var_x98;
        const double var_x100 = var_x67 * var_x97 * var_x98 / pow(var_x99, 2);
        const double var_x101 = 1.0 - var_x13;
        const double var_x102 = 1 / var_x101;
        const double var_x103 = pow(var_chaste_interface__Irel__Irel, 2);
        const double var_x104 = 1.0 - 1.0 / (1.0 + 6.2499999999999991 * var_x103);
        const double var_x105 = -100.0 * var_x13 + var_chaste_interface__Cl__Cl_i;
        const double var_x106 = var_x102 * var_x104 * var_x105;
        const double var_x107 = 0.0032509358688027189 * var_x106;
        const double var_x108 = var_x104 * var_chaste_interface__Ito2_i2f_gate__i2f;
        const double var_x109 = var_x102 * var_x108;
        const double var_x110 = var_x109 * var_x57;
        const double var_x111 = var_x46 * var_x47 * var_x55;
        const double var_x112 = 0.16824385730132127 * var_x111;
        const double var_x113 = var_x46 * var_x89;
        const double var_x114 = var_x113 * var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x115 = 0.16824385730132127 * var_x114;
        const double var_x116 = var_x52 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x117 = var_x116 * var_x87;
        const double var_x118 = 6.4800000000000004 * var_x69 - 9878400.0 * var_x70;
        const double var_x119 = var_x118 * var_x74;
        const double var_x120 = var_x63 / pow(var_x64, 2);
        const double var_x121 = 0.0087452036595870152 * var_x120;
        const double var_x122 = 1.6200000000000001 * var_x77 - 2469600.0 * var_x78;
        const double var_x123 = var_x122 * var_x83;
        const double var_x124 = var_x105 * var_x108 * var_x57 / pow(var_x101, 2);
        ...
        const double var_x129 = var_x63 * var_x65;
        const double var_x130 = var_x129 * var_x74;
        const double var_x131 = 2.3018374734134173e-7 * var_x65;
        const double var_x132 = var_x118 * var_x72 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x67 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x133 = 3.1249999999999999e-8 * var_x65;
        const double var_x134 = var_x118 * var_x73 / (pow(var_x71, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        ...
        const double var_x139 = var_x49 * var_chaste_interface__membrane__Vm;
        const double var_x140 = -var_x139;
        const double var_x141 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x142 = log(140.0 * var_x141);
        const double var_x143 = -26.711785007306684 * var_x142 + var_chaste_interface__membrane__Vm;
        const double var_x144 = var_x143 * var_chaste_interface__INa_h_gate__h;
        const double var_x145 = var_x144 * pow(var_chaste_interface__INa_m_gate__m, 2) * var_chaste_interface__INa_j_gate__j;
        const double var_x146 = var_x144 * var_x43;
        const double var_x147 = var_x143 * pow(var_chaste_interface__INaL_mL_gate__mL, 2) * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x148 = var_x116 * var_x86;
        const double var_x149 = var_x148 * pow(var_chaste_interface__Ito1_a_gate__a, 2) * var_chaste_interface__Ito1_i1s_gate__i1s;
        const double var_x150 = var_x148 * var_x85;
        const double var_x151 = var_x102 * var_x105 * var_chaste_interface__Irel__Irel * var_chaste_interface__Ito2_i2f_gate__i2f * var_chaste_interface__membrane__Vm / pow((0.16000000000000003 + var_x103), 2);
        const double var_x152 = var_x129 * var_x83;
        const double var_x153 = var_x122 * var_x81 / pow((0.0030448615405916234 + 1.9354984970793804e-6 * var_x76 + var_chaste_interface__Ca__Ca_ss_sr), 2);
        const double var_x154 = var_x122 * var_x82 / (pow(var_x80, 2) * pow(var_chaste_interface__Ca__Ca_ss_sr, 3));
        const double var_x155 = 2.2470468725164396 * var_x113;
        const double var_x156 = 1 / var_x99;
        const double var_x157 = var_x156 * var_x67 / pow(var_x96, 4);
        const double var_x158 = pow(var_chaste_interface__Na__Na_i, 2);
        const double var_x159 = var_x156 * var_x158 * var_x97;
        const double var_x160 = var_x15 * var_x57;
        const double var_x161 = var_x10 * var_x141 * var_chaste_interface__INaL_hL_gate__hL;
        const double var_x162 = (0.12553036579548593 * var_chaste_interface__K__K_i + 0.002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x135, 2);
        const double var_x163 = var_x162 * var_x9;
        const double var_x164 = var_x141 * var_x44 * var_chaste_interface__INa_h_gate__h;
        const double var_x165 = var_x132 * var_x65;
        const double var_x166 = var_x158 * var_x165;
        const double var_x167 = var_x65 * var_x68;
        const double var_x168 = var_x158 * var_x167 * var_x74;
        const double var_x169 = pow(var_chaste_interface__Na__Na_ss_sr, 2);
        const double var_x170 = var_x153 * var_x65;
        const double var_x171 = var_x169 * var_x170;
        const double var_x172 = var_x167 * var_x169 * var_x83;
        const double var_x173 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x174 = var_x109 * var_chaste_interface__membrane__Vm;
        const double var_x175 = var_x19 * var_x2;
        const double var_x176 = var_x19 * var_x41 * var_chaste_interface__IKr_xr_gate__xr;
        const double var_x177 = var_x19 * var_x32;
        const double var_x178 = var_x19 * var_x60;
        const double var_x179 = 6.4981759387274964 * var_x178 - var_x26 * (1.0539507884845836 * var_x19 * var_x27 + 1.6494527242011876 * var_x19 * var_x28) - 13.737871029257827 * var_x19 * var_x92;
        const double var_x180 = var_x178 * var_x61;
        const double var_x181 = var_x19 * var_x87 * var_chaste_interface__Ito1_i1f_gate__i1f;
        const double var_x182 = 8.8930116629204303e-8 * var_x38;
        const double var_x183 = 6.1700941025231664e-5 * var_x65;
        const double var_x184 = var_x119 * var_x120;
        const double var_x185 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x186 = 1.0 + 0.00011900000000000002 / pow(var_x185, 2) + 3.5000000000000004e-5 * var_x127;
        const double var_x187 = 1 / var_x186;
        const double var_x188 = 1.0 * var_x187;
        const double var_x189 = 1.7739020544754105e-6 * var_x126;
        const double var_x190 = 1.0 - var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x191 = 1.0 + 0.0015 / var_chaste_interface__Ca__Ca_ss_sr;
        ...
        const double var_x195 = 0.14999999999999999 + var_x194 + 1.0 * var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x196 = 1 / var_x195;
        const double var_x197 = var_x194 + var_chaste_interface__CaMK_active__CaMK_trap;
        ...
        const double var_x207 = var_x134 * var_x65;
        const double var_x208 = var_x190 * var_x79 / pow(var_x191, 2);
        const double var_x209 = var_x196 * var_x208;
        const double var_x210 = var_x197 / pow(var_x195, 2);
        const double var_x211 = var_x208 * var_x210;
        const double var_x212 = 5.6250000000000005e-5 * var_x209 - 5.6250000000000005e-5 * var_x211;
        const double var_x213 = var_x200 * var_x204;
        const double var_x214 = 1.2750000000000002e-8 * var_x209 - 1.2750000000000002e-8 * var_x211;
        const double var_x215 = 1 - var_x193;
        const double var_x216 = var_x196 * var_x215;
        const double var_x217 = var_x210 * (-1.0 + var_x193);
        const double var_x218 = 0.75 * var_x216 + 0.75 * var_x217;
        const double var_x219 = 0.00017000000000000001 * var_x216 + 0.00017000000000000001 * var_x217;
        const double var_x220 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
        const double var_x221 = 6.6501243234553463e-5 * var_x220 * var_chaste_interface__IKs__C1;
        const double var_x222 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
        const double var_x223 = 0.00017437799625617966 * var_x222;
        const double var_x224 = 0.059456000000000002 * var_x220;
        const double var_x225 = 0.083986000000000005 * var_x222;
        const double var_x226 = 4.9875932425915097e-5 * var_x220;
        const double var_x227 = -var_x226;
        const double var_x228 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
        const double var_x229 = 0.0001337287885861198 * var_x228;
        const double var_x230 = var_x223 - var_x229;
        const double var_x231 = exp(-0.01595737611258119 * var_chaste_interface__membrane__Vm);
        const double var_x232 = 4.9743928555749341e-5 * var_x231;
        const double var_x233 = 0.00034875599251235932 * var_x222;
        const double var_x234 = 0.044592 * var_x220;
        const double var_x235 = -var_x234;
        const double var_x236 = 0.014600999999999999 * var_x228;
        const double var_x237 = -var_x225 - var_x236;
        const double var_x238 = 0.16797200000000001 * var_x222;
        const double var_x239 = 0.0031172999999999999 * var_x231;
        const double var_x240 = 3.3250621617276731e-5 * var_x220;
        const double var_x241 = -var_x240;
        const double var_x242 = 0.00026745757717223961 * var_x228;
        const double var_x243 = var_x233 - var_x242;
        const double var_x244 = 0.0005231339887685389 * var_x222;
        const double var_x245 = 0.029728000000000001 * var_x220;
        const double var_x246 = -var_x245;
        const double var_x247 = 0.029201999999999999 * var_x228;
        const double var_x248 = -var_x238 - var_x247;
        const double var_x249 = 0.25195800000000002 * var_x222;
        const double var_x250 = 1.6625310808638366e-5 * var_x220;
        const double var_x251 = -var_x250;
        const double var_x252 = 0.00040118636575835941 * var_x228;
        const double var_x253 = var_x244 - var_x252;
        const double var_x254 = 0.00069751198502471864 * var_x222;
        const double var_x255 = 0.014864 * var_x220;
        const double var_x256 = -var_x255;
        const double var_x257 = 0.043802999999999995 * var_x228;
        const double var_x258 = -var_x249 - var_x257;
        const double var_x259 = 0.33594400000000002 * var_x222;
        const double var_x260 = 0.00053491515434447921 * var_x228;
        const double var_x261 = 0.058403999999999998 * var_x228;
        const double var_x262 = -var_x239;
        const double var_x263 = 9.9487857111498683e-5 * var_x231;
        const double var_x264 = 0.0062345999999999999 * var_x231;
        const double var_x265 = -var_x264;
        const double var_x266 = 0.00014923178566724802 * var_x231;
        const double var_x267 = 0.0093518999999999998 * var_x231;
        const double var_x268 = -var_x267;
        const double var_x269 = 0.00019897571422299737 * var_x231 * var_chaste_interface__IKs__C15;
        const double var_x270 = 0.0124692 * var_x231;
        const double var_x271 = exp(-0.0024231252229042349 * var_chaste_interface__membrane__Vm);
        const double var_x272 = 0.00018735604223495543 * var_x271;
        const double var_x273 = 0.07732 * var_x271;
        const double var_x274 = exp(0.0105593841790373 * var_chaste_interface__membrane__Vm);
        const double var_x275 = 0.0061918116949038924 * var_x274;
        const double var_x276 = exp(-0.003001446738885828 * var_chaste_interface__membrane__Vm);
        const double var_x277 = 0.0023832987830122916 * var_x276 * var_chaste_interface__IKs__O2;
        const double var_x278 = 0.58638000000000001 * var_x274;
        const double var_x279 = 0.79405000000000003 * var_x276;
        const double var_x280 = exp(5.833333333333333 + 0.33333333333333331 * var_chaste_interface__membrane__Vm);
        const double var_x281 = 1.0 + var_x280;
        const double var_x282 = 1 / var_x281;
        const double var_x283 = 0.80000000000000004 * var_x282;
        const double var_x284 = exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm);
        const double var_x285 = 1.0 + var_x284;
        const double var_x286 = var_x284 / pow(var_x285, 2);
        const double var_x287 = exp(4.7444197507005512 + 0.096627693496956227 * var_chaste_interface__membrane__Vm);
        const double var_x288 = 1.0 + var_x287;
        const double var_x289 = -0.0038918839011179407 * var_x287 / pow(var_x288, 2);
        const double var_x290 = var_x289 + 0.0030285935177480471 * var_x286;
        const double var_x291 = 0.040277106492669565 / var_x288;
        const double var_x292 = 1 / var_x285;
        const double var_x293 = var_x291 + 0.032730010146303147 * var_x292;
        const double var_x294 = var_x280 / pow(var_x281, 2);
        const double var_x295 = 0.26666666666666666 * var_x293 * var_x294;
        const double var_x296 = -var_x295 + var_x290 * (-0.80000000000000004 + var_x283);
        const double var_x297 = exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm);
        const double var_x298 = 1.0 + var_x297;
        const double var_x299 = exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x300 = 1.0 + var_x299;
        const double var_x301 = exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x302 = var_x301 / var_x300;
        const double var_x303 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x302);
        const double var_x304 = 0.10582010582010583 * var_x297 * var_x303 / pow(var_x298, 2);
        const double var_x305 = 1 / var_x298;
        const double var_x306 = 1.5624999999999998 * (-0.041599999999999998 * var_x302 + 0.10560000000000001 * var_x299 * var_x301 / pow(var_x300, 2)) / pow((0.73749999999999993 + var_x302), 2);
        const double var_x307 = var_x305 * var_x306;
        const double var_x308 = -var_x304 - var_x307;
        const double var_x309 = 0.20000000000000001 + var_x283;
        const double var_x310 = var_x290 * var_x309;
        const double var_x311 = 1.0 * var_x305;
        const double var_x312 = 1.0 - var_x311;
        const double var_x313 = var_x306 * var_x312;
        const double var_x314 = var_x303 * var_x311;
        const double var_x315 = -var_x314;
        const double var_x316 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
        const double var_x317 = 1 / var_x316;
        const double var_x318 = 3.0 * var_x317;
        const double var_x319 = -var_x283;
        const double var_x320 = 0.80000000000000004 + var_x319;
        const double var_x321 = var_x293 * var_x320;
        const double var_x322 = -var_x318 - var_x321;
        const double var_x323 = var_x303 * var_x312;
        const double var_x324 = var_x293 * var_x309;
        const double var_x325 = 1 / (pow(var_x316, 2) * pow(var_chaste_interface__Ca__Ca_ss_CaL, 5));
        const double var_x326 = 9.7200000000000016e-10 * var_x325;
        const double var_x327 = var_x326 * var_chaste_interface__ICaL__C;
        const double var_x328 = var_x304 - var_x313;
        const double var_x329 = -var_x323;
        const double var_x330 = var_x326 * var_chaste_interface__ICaL__O;
        const double var_x331 = 0.99990000999900008 * var_x282;
        const double var_x332 = -0.99990000999900008 + var_x331;
        const double var_x333 = 1 / (25.0 - 17.5 * var_x317);
        const double var_x334 = var_x289 + 0.092532617747756077 * var_x286 * var_x333;
        const double var_x335 = var_x291 + 1.0 * var_x292 * var_x333;
        const double var_x336 = 0.33330000333300003 * var_x294 * var_x335;
        const double var_x337 = -var_x336 + var_x332 * var_x334;
        const double var_x338 = 9.9990000999900015e-5 + var_x331;
        const double var_x339 = var_x334 * var_x338;
        const double var_x340 = -var_x331;
        const double var_x341 = 0.99990000999900008 + var_x340;
        const double var_x342 = var_x335 * var_x341;
        const double var_x343 = -1.0 - var_x342;
        const double var_x344 = var_x335 * var_x338;
        const double var_x345 = 9.0720000000000001e-12 * var_x292 * var_x325 / pow((1 - 0.69999999999999996 * var_x317), 2);
        const double var_x346 = var_x338 * var_x345;
        const double var_x347 = var_x332 * var_x345;
        const double var_x348 = 1 / var_x320;
        const double var_x349 = 1 / var_x338;
        const double var_x350 = var_x317 * var_x341 * var_x348 * var_x349;
        const double var_x351 = 7.9999999999999996e-7 * var_x294 * var_x350;
        const double var_x352 = var_x309 * var_x348 * var_x349;
        const double var_x353 = var_x294 * var_x317;
        const double var_x354 = 9.9990000999900006e-7 * var_x352 * var_x353;
        const double var_x355 = var_x309 * var_x341 * var_x353;
        const double var_x356 = 1.2499999999999999e-6 * var_x349 * var_x355 / pow((1 - var_x282), 2);
        const double var_x357 = 1.0001e-6 * var_x348 * var_x355 / pow((0.0001 + var_x282), 2);
        const double var_x358 = var_x295 + var_x351 + var_x356 - var_x354 - var_x357 + var_x290 * (-0.20000000000000001 + var_x319);
        const double var_x359 = var_x290 * var_x320;
        const double var_x360 = 3.0000000000000001e-6 * var_x309 * var_x350;
        const double var_x361 = -var_x324 - var_x360;
        const double var_x362 = 9.7200000000000002e-16 * var_x325 * var_x341 * var_x352;
        const double var_x363 = var_x362 * var_chaste_interface__ICaL__CI;
        const double var_x364 = var_x362 * var_chaste_interface__ICaL__OI;
        const double var_x365 = -9.9990000999900015e-5 + var_x340;
        const double var_x366 = var_x336 + var_x334 * var_x365;
        const double var_x367 = var_x334 * var_x341;
        const double var_x368 = -9.9999999999999995e-7 - var_x344;
        const double var_x369 = var_x341 * var_x345;
        const double var_x370 = var_x345 * var_x365;
        const double var_x371 = 1.0 - var_chaste_interface__INa_m_gate__m;
        const double var_x372 = -0.10000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x373 = exp(-4.7130000000000001 + var_x372);
        const double var_x374 = 1.0 - var_x373;
        const double var_x375 = 0.32000000000000001 / var_x374;
        const double var_x376 = exp(-0.090909090909090912 * var_chaste_interface__membrane__Vm);
        const double var_x377 = 0.0072727272727272727 * var_x376;
        const double var_x378 = 47.130000000000003 + var_chaste_interface__membrane__Vm;
        const double var_x379 = 0.032000000000000001 * var_x373 * var_x378 / pow(var_x374, 2);
        const double var_x380 = -0.080000000000000002 * var_x376 - var_x375 * var_x378;
        const double var_x381 = var_chaste_interface__membrane__Vm >= -40.0;
        const double var_x382 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm);
        const double var_x383 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__Vm);
        const double var_x384 = 1.0 + var_x383;
        const double var_x385 = exp(0.079000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x386 = exp(0.34999999999999998 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x394 = 37.780000000000001 + var_chaste_interface__membrane__Vm;
        const double var_x395 = exp(-3.2000000000000002 + var_x372);
        const double var_x396 = 1.0 + var_x395;
        const double var_x397 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__Vm);
        const double var_x398 = var_x397 / var_x396;
        const double var_x399 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x400 = 1.0 + var_x399;
        const double var_x401 = exp(-0.01052 * var_chaste_interface__membrane__Vm);
        const double var_x402 = var_x401 / var_x400;
        const double var_x403 = 1.0 - var_chaste_interface__INaL_mL_gate__mL;
        const double var_x404 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__membrane__Vm);
        const double var_x405 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x417 = exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x429 = var_x427 / pow(var_x428, 2);
        const double var_x430 = 0.0050000000000000001 * var_x429;
        ...
        const double var_x433 = var_x431 / pow(var_x432, 2);
        const double var_x434 = 0.011343308638950427 * var_x433;
        ...
        const double var_x441 = 1 / var_chaste_interface__Ca__Ca_JSR;
        const double var_x442 = pow(var_x441, 8.0);
        const double var_x443 = 1.0 + 1.0 * var_x442;
        const double var_x444 = 1 / var_x443;
        const double var_x445 = 1 / var_x197;
        const double var_x446 = pow(var_x445, 10.0);
        const double var_x447 = 1.0 + 2.9619676669542428e-6 * var_x446;
        const double var_x448 = 1 / var_x447;
        const double var_x449 = 0.53437500000000004 + 0.53437500000000004 * var_x448;
        const double var_x450 = var_x444 * var_x449;
        const double var_x451 = var_x450 * var_x50;
        const double var_x452 = 1 / (4.75 + 4.75 * var_x448);
        const double var_x453 = 1.0 + 0.0123 * var_x441;
        const double var_x454 = var_x452 * var_x453;
        const double var_x455 = var_x450 * var_x454;
        const double var_x456 = -var_x139 * var_x455;
        const double var_x457 = -var_chaste_interface__Irel__Irel;
        const double var_x458 = var_x457 - var_x451 * var_chaste_interface__membrane__Vm;
        const double var_x459 = var_x454 * var_x46 * var_x48 * var_chaste_interface__membrane__Vm;
        const double var_x460 = var_x453 * var_x458 / pow((1 + var_x448), 2);
        const double var_x461 = var_x445 * var_x446 / pow(var_x447, 2);
        const double var_x462 = var_x208 * var_x461;
        const double var_x463 = var_x444 * var_x459;
        const double var_x464 = var_x461 * (-1 + var_x193);
        const double var_x465 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_JSR;
        const double var_x466 = pow(var_x465, (-2));
        const double var_x467 = 1 / (1.0 + 8.0 * var_x466);
        const double var_x468 = 0.040000000000000001 * var_x467;
        const double var_x469 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x470 = var_x205 * var_x469;
        const double var_x471 = var_x200 * var_x469;
        const double var_x472 = 0.0020916619007553534 * var_x65;
        const double var_x473 = var_x120 * var_x123;
        const double var_x474 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x475 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x476 = 1.0 + 0.0097788000000000007 / pow(var_x474, 2) + 4.0890000000000003e-5 / pow(var_x475, 2);
        const double var_x477 = 1 / var_x476;
        const double var_x478 = 1.0 * var_x477;
        const double var_x479 = var_x154 * var_x65;
        const double var_x480 = 0.023500311662270543 * var_x48;
        const double var_x481 = var_x46 * var_x480;
        const double var_x482 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x483 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x484 = 1.0 + 0.0097788000000000007 / pow(var_x482, 2) + 4.0890000000000003e-5 / pow(var_x483, 2);
        const double var_x485 = 1 / var_x484;
        const double var_x486 = 1.0 * var_x485;
        const double var_x487 = -var_x480 * var_x485 * var_chaste_interface__membrane__Vm;
        const double var_x488 = 4.0105611666400582e-7 * var_x10;
        const double var_x489 = 0.00055993603980397731 * var_x44;
        const double var_x490 = log(100.0 * var_x173);
        const double var_x491 = var_x142 + var_x490;
        ...
        const double var_x495 = var_x141 * var_x493 - var_x141 * var_x494;
        const double var_x496 = var_x173 * var_x493 - var_x173 * var_x494;
        const double var_x497 = var_x51 + 26.711785007306684 * var_x490;
        ...
        const double var_x500 = var_x173 * var_x499 - var_x173 * var_x498;
        const double var_x501 = var_x19 * var_x499 - var_x19 * var_x498;
        const double var_x502 = 6.799858698573652e-6 * var_x106;
        const double var_x503 = -5.0964977286841363e-6 - 3.0578986372104813e-6 * var_x6;
        const double var_x504 = var_x503 * var_x8;
        const double var_x505 = 8.5481717715176459e-7 * var_x41;
        const double var_x506 = 3.0696218160052752e-5 * var_x87;
        const double var_x507 = 3.0245559326093954e-5 * var_x94;
        const double var_x508 = var_x136 * var_x503;
        const double var_x509 = var_x162 * var_x504;
        const double var_x510 = 0.0025000000000000005 * var_x192;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x112 + var_x9 - var_x115 - var_x50 + 0.012170417918209005 * var_x110 + 0.00021583116499495196 * var_x56 + 4.3272597042520909e-7 * var_x58 + 0.00089962337662337659 * var_x59 + 0.12163499999999999 * var_x62 - 0.0027599999999999999 * var_x2 - 0.00012170417918209004 * var_x124 - 1.1558883089076335e-5 * var_x18 - 0.00021583116499495196 * var_x90 - 4.3272597042520909e-7 * var_x91 - 0.00090454545454545453 * var_x117 - 0.51000000000000001 * var_x32 - 0.00233372538501551 * var_x100 - 0.0028826178386108462 * var_x38 - 0.00046153846153846147 * var_x53 - var_x107 * var_chaste_interface__Ito2_i2f_gate__i2f - var_x11 * var_chaste_interface__INaL_hL_gate__hL - var_x119 * var_x121 - var_x121 * var_x123 - var_x42 * var_chaste_interface__IKr_xr_gate__xr - var_x45 * var_chaste_interface__INa_h_gate__h - var_x66 * var_x75 - var_x66 * var_x84 - var_x88 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x93 * var_x95);
        IJth(rJacobian, 1, 0) = var_x188 * (-var_x182 + 6.6584929913802883e-9 * var_x56 + 5.3958729525381867e-7 * var_x184 - 6.6584929913802883e-9 * var_x90 + var_x183 * var_x75);
        IJth(rJacobian, 2, 0) = -var_x221 - var_x223 * var_chaste_interface__IKs__C2;
        IJth(rJacobian, 3, 0) = var_x221 + (var_x227 + var_x230) * var_chaste_interface__IKs__C2 - var_x232 * var_chaste_interface__IKs__C6 - var_x233 * var_chaste_interface__IKs__C3;
        IJth(rJacobian, 4, 0) = var_x226 * var_chaste_interface__IKs__C2 + (var_x241 + var_x243) * var_chaste_interface__IKs__C3 - var_x232 * var_chaste_interface__IKs__C7 - var_x244 * var_chaste_interface__IKs__C4;
        IJth(rJacobian, 5, 0) = var_x240 * var_chaste_interface__IKs__C3 + (var_x251 + var_x253) * var_chaste_interface__IKs__C4 - var_x232 * var_chaste_interface__IKs__C8 - var_x254 * var_chaste_interface__IKs__C5;
        IJth(rJacobian, 6, 0) = var_x250 * var_chaste_interface__IKs__C4 + (var_x254 - var_x260) * var_chaste_interface__IKs__C5 - var_x232 * var_chaste_interface__IKs__C9;
        IJth(rJacobian, 7, 0) = var_x229 * var_chaste_interface__IKs__C2 + (var_x227 + var_x232) * var_chaste_interface__IKs__C6 - var_x223 * var_chaste_interface__IKs__C7;
        IJth(rJacobian, 8, 0) = var_x226 * var_chaste_interface__IKs__C6 + var_x242 * var_chaste_interface__IKs__C3 + (var_x230 + var_x232 + var_x241) * var_chaste_interface__IKs__C7 - var_x233 * var_chaste_interface__IKs__C8 - var_x263 * var_chaste_interface__IKs__C10;
        IJth(rJacobian, 9, 0) = var_x240 * var_chaste_interface__IKs__C7 + var_x252 * var_chaste_interface__IKs__C4 + (var_x232 + var_x243 + var_x251) * var_chaste_interface__IKs__C8 - var_x244 * var_chaste_interface__IKs__C9 - var_x263 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 10, 0) = var_x250 * var_chaste_interface__IKs__C8 + var_x260 * var_chaste_interface__IKs__C5 + (var_x232 + var_x253) * var_chaste_interface__IKs__C9 - var_x263 * var_chaste_interface__IKs__C12;
        IJth(rJacobian, 11, 0) = var_x229 * var_chaste_interface__IKs__C7 + (var_x241 + var_x263) * var_chaste_interface__IKs__C10 - var_x223 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 12, 0) = var_x240 * var_chaste_interface__IKs__C10 + var_x242 * var_chaste_interface__IKs__C8 + (var_x230 + var_x251 + var_x263) * var_chaste_interface__IKs__C11 - var_x233 * var_chaste_interface__IKs__C12 - var_x266 * var_chaste_interface__IKs__C13;
        IJth(rJacobian, 13, 0) = var_x250 * var_chaste_interface__IKs__C11 + var_x252 * var_chaste_interface__IKs__C9 + (var_x243 + var_x263) * var_chaste_interface__IKs__C12 - var_x266 * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 14, 0) = var_x229 * var_chaste_interface__IKs__C11 + (var_x251 + var_x266) * var_chaste_interface__IKs__C13 - var_x223 * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 15, 0) = -var_x269 + var_x242 * var_chaste_interface__IKs__C12 + var_x250 * var_chaste_interface__IKs__C13 + (var_x230 + var_x266) * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 16, 0) = var_x269 + var_x229 * var_chaste_interface__IKs__C14 - var_x272 * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 17, 0) = -var_x277 + (var_x272 - var_x275) * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 18, 0) = var_x277 + var_x275 * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 19, 0) = var_x310 * var_chaste_interface__ICaL__CI + var_x313 * var_chaste_interface__ICaL__O + (var_x296 + var_x308) * var_chaste_interface__ICaL__C - var_x295 * var_chaste_interface__ICaL__CI - var_x304 * var_chaste_interface__ICaL__O;
        IJth(rJacobian, 20, 0) = var_x304 * var_chaste_interface__ICaL__C + var_x307 * var_chaste_interface__ICaL__C + var_x310 * var_chaste_interface__ICaL__OI + (var_x296 + var_x328) * var_chaste_interface__ICaL__O - var_x295 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 21, 0) = var_x313 * var_chaste_interface__ICaL__O_star + var_x339 * var_chaste_interface__ICaL__CI_star + (var_x308 + var_x337) * var_chaste_interface__ICaL__C_star - var_x304 * var_chaste_interface__ICaL__O_star - var_x336 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 22, 0) = var_x304 * var_chaste_interface__ICaL__C_star + var_x307 * var_chaste_interface__ICaL__C_star + var_x339 * var_chaste_interface__ICaL__OI_star + (var_x328 + var_x337) * var_chaste_interface__ICaL__O_star - var_x336 * var_chaste_interface__ICaL__OI_star;
        IJth(rJacobian, 23, 0) = var_x295 * var_chaste_interface__ICaL__C + var_x313 * var_chaste_interface__ICaL__OI + var_x359 * var_chaste_interface__ICaL__C + (var_x308 + var_x358) * var_chaste_interface__ICaL__CI - var_x304 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 24, 0) = var_x295 * var_chaste_interface__ICaL__O + var_x304 * var_chaste_interface__ICaL__CI + var_x307 * var_chaste_interface__ICaL__CI + var_x359 * var_chaste_interface__ICaL__O + (var_x328 + var_x358) * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 25, 0) = var_x313 * var_chaste_interface__ICaL__OI_star + var_x336 * var_chaste_interface__ICaL__C_star + var_x354 * var_chaste_interface__ICaL__CI + var_x357 * var_chaste_interface__ICaL__CI + var_x367 * var_chaste_interface__ICaL__C_star + (var_x308 + var_x366) * var_chaste_interface__ICaL__CI_star - var_x304 * var_chaste_interface__ICaL__OI_star - var_x351 * var_chaste_interface__ICaL__CI - var_x356 * var_chaste_interface__ICaL__CI;
        IJth(rJacobian, 26, 0) = var_x304 * var_chaste_interface__ICaL__CI_star + var_x307 * var_chaste_interface__ICaL__CI_star + var_x336 * var_chaste_interface__ICaL__O_star + var_x354 * var_chaste_interface__ICaL__OI + var_x357 * var_chaste_interface__ICaL__OI + var_x367 * var_chaste_interface__ICaL__O_star + (var_x328 + var_x366) * var_chaste_interface__ICaL__OI_star - var_x351 * var_chaste_interface__ICaL__OI - var_x356 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 27, 0) = var_x371 * var_x375 + var_x377 * var_chaste_interface__INa_m_gate__m - var_x371 * var_x379;
        IJth(rJacobian, 28, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x381) ? (0) : (-0.019852941176470591 * var_x382)) - ((var_x381) ? (0.693000693000693 * var_x383 / pow(var_x384, 2)) : (0.28123999999999999 * var_x385 + 108500.0 * var_x386)) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 29, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x381) ? (0) : (var_x393 + var_x389 * var_x394 * (3.0508668000000001e-6 * var_x391 - 31073.016 * var_x390) - 0.311 * var_x387 * var_x392 * var_x394 / pow(var_x388, 2))) - ((var_x381) ? (-7.6049999999999996e-8 * var_x398 + 0.029999999999999999 * var_x395 * var_x397 / pow(var_x396, 2)) : (-0.001275024 * var_x402 + 0.016701360000000002 * var_x399 * var_x401 / pow(var_x400, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 30, 0) = var_x375 * var_x403 + var_x377 * var_chaste_interface__INaL_mL_gate__mL - var_x379 * var_x403;
        IJth(rJacobian, 31, 0) = -0.00027322404371584699 * var_x404 / pow((1.0 + var_x404), 2);
        IJth(rJacobian, 32, 0) = (-var_chaste_interface__IKr_xr_gate__xr + 1.0 / var_x406) * (var_x409 + var_x412 - 8.1600000000000005e-5 * var_x410 * var_x413 / pow(var_x411, 2) - 4.566e-5 * var_x407 * var_x414 / pow(var_x408, 2)) + 0.23529411764705882 * var_x405 * (var_x415 + var_x416) / pow(var_x406, 2);
        IJth(rJacobian, 33, 0) = (-var_chaste_interface__Ito1_a_gate__a + 1.0 / var_x418) * (0.028153807491391791 * var_x420 / pow(var_x421, 2) - 0.11912298256720238 * var_x422 / pow(var_x423, 2)) + 0.14019346698443852 * var_x417 * (var_x424 + var_x425) / pow(var_x418, 2);
        IJth(rJacobian, 34, 0) = -var_x430 * (1.0 - var_chaste_interface__Ito1_i1f_gate__i1f) - var_x434 * var_chaste_interface__Ito1_i1f_gate__i1f;
        IJth(rJacobian, 35, 0) = -var_x434 * var_chaste_interface__Ito1_i1s_gate__i1s - 0.00080000000000000004 * var_x439 * (1.0 - var_chaste_interface__Ito1_i1s_gate__i1s) / pow(var_x440, 2);
        IJth(rJacobian, 36, 0) = -0.00062500000000000001 * var_x429 / (var_x436 + 0.20000000000000001 * var_x437) + 0.078125 * var_x435 * (var_x430 - 0.022222222222222223 * var_x433) / pow((var_x437 + 0.125 * var_x435), 2);
        IJth(rJacobian, 37, 0) = var_x454 * (-var_x451 + var_x112 * var_x450 - var_x115 * var_x450);
        IJth(rJacobian, 40, 0) = var_x478 * (1.8292009309104452e-5 * var_x473 + var_x472 * var_x84);
        IJth(rJacobian, 41, 0) = var_x486 * (-var_x481 + 0.0017595463317664707 * var_x111 - 0.0017595463317664707 * var_x114);
        IJth(rJacobian, 42, 0) = 2.6699599581291967e-11 * var_x58 - 7.1319396379664657e-10 * var_x18 - 1.6187618857614559e-6 * var_x184 - 4.3197915704978414e-7 * var_x100 - 2.6699599581291967e-11 * var_x91 - var_x488 * var_chaste_interface__INaL_hL_gate__hL - var_x489 * var_chaste_interface__INa_h_gate__h - 0.00018510282307569501 * var_x65 * var_x75;
        IJth(rJacobian, 43, 0) = -5.4876027927313356e-5 * var_x473 - 0.0062749857022660607 * var_x65 * var_x84;
        IJth(rJacobian, 44, 0) = 1.3882711730677125e-8;
        IJth(rJacobian, 45, 0) = 2.5456399475788057e-7 * var_x124 - 2.5456399475788059e-5 * var_x110 + var_x502 * var_chaste_interface__Ito2_i2f_gate__i2f;
        IJth(rJacobian, 46, 0) = var_x504 + 5.5507608905958737e-8 * var_x59 + 7.5049939616040537e-6 * var_x62 + 2.8798610469985608e-7 * var_x100 - 2.8477357396260765e-8 * var_x53 - 3.1467479922868152e-5 * var_x32 - 1.7029459722963939e-7 * var_x2 - 5.5811305745550463e-8 * var_x117 - var_x505 * var_chaste_interface__IKr_xr_gate__xr - var_x506 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x507 * var_x93;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.057500000000000002 * var_x128 + 9878400.0 * var_x130 - 0.057500000000000002 * var_x126 - 0.0028826178386108462 * var_x89 - 4.4973467007233054e-8 * var_x137 + var_x131 * var_x132 - var_x133 * var_x134);
        IJth(rJacobian, 1, 1) = var_x188 * (-0.014749262536873154 + var_x206 - var_x189 - var_x203 + 1.9281544070384897e-12 * var_x207 + 1.7739020544754105e-6 * var_x128 - 609.50657582364852 * var_x130 - 1.4202553819674954e-11 * var_x165 - 8.8930116629204303e-8 * var_x89) + 1.0 * (0.00023800000000000004 / pow(var_x185, 3) + 7.0000000000000007e-5 / pow(var_x125, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i + var_x119 * var_x183 - var_x182 * var_chaste_interface__membrane__Vm - var_x189 * var_chaste_interface__Ca__Ca_i - var_x203 * var_chaste_interface__Ca__Ca_i) / pow(var_x186, 2);
        IJth(rJacobian, 39, 1) = -var_x470 + 0.0043750000000000004 * var_x202;
        IJth(rJacobian, 40, 1) = 5.0 * var_x477;
        IJth(rJacobian, 42, 1) = 4.2607661459024858e-11 * var_x165 + 1828.5197274709456 * var_x130 - 5.784463221115469e-12 * var_x207;
        IJth(rJacobian, 46, 1) = -2.774905235513489e-12 * var_x137;
        IJth(rJacobian, 2, 2) = -var_x224;
        IJth(rJacobian, 3, 2) = var_x224;
        IJth(rJacobian, 2, 3) = var_x225;
        IJth(rJacobian, 3, 3) = var_x235 + var_x237;
        IJth(rJacobian, 4, 3) = var_x234;
        IJth(rJacobian, 7, 3) = var_x236;
        IJth(rJacobian, 3, 4) = var_x238;
        IJth(rJacobian, 4, 4) = var_x246 + var_x248;
        IJth(rJacobian, 5, 4) = var_x245;
        IJth(rJacobian, 8, 4) = var_x247;
        IJth(rJacobian, 4, 5) = var_x249;
        IJth(rJacobian, 5, 5) = var_x256 + var_x258;
        IJth(rJacobian, 6, 5) = var_x255;
        IJth(rJacobian, 9, 5) = var_x257;
        IJth(rJacobian, 5, 6) = var_x259;
        IJth(rJacobian, 6, 6) = -var_x259 - var_x261;
        IJth(rJacobian, 10, 6) = var_x261;
        IJth(rJacobian, 3, 7) = var_x239;
        IJth(rJacobian, 7, 7) = var_x235 + var_x262;
        IJth(rJacobian, 8, 7) = var_x234;
        IJth(rJacobian, 4, 8) = var_x239;
        IJth(rJacobian, 7, 8) = var_x225;
        IJth(rJacobian, 8, 8) = var_x237 + var_x246 + var_x262;
        IJth(rJacobian, 9, 8) = var_x245;
        IJth(rJacobian, 11, 8) = var_x236;
        IJth(rJacobian, 5, 9) = var_x239;
        IJth(rJacobian, 8, 9) = var_x238;
        IJth(rJacobian, 9, 9) = var_x248 + var_x256 + var_x262;
        IJth(rJacobian, 10, 9) = var_x255;
        IJth(rJacobian, 12, 9) = var_x247;
        IJth(rJacobian, 6, 10) = var_x239;
        IJth(rJacobian, 9, 10) = var_x249;
        IJth(rJacobian, 10, 10) = var_x258 + var_x262;
        IJth(rJacobian, 13, 10) = var_x257;
        IJth(rJacobian, 8, 11) = var_x264;
        IJth(rJacobian, 11, 11) = var_x246 + var_x265;
        IJth(rJacobian, 12, 11) = var_x245;
        IJth(rJacobian, 9, 12) = var_x264;
        IJth(rJacobian, 11, 12) = var_x225;
        IJth(rJacobian, 12, 12) = var_x237 + var_x256 + var_x265;
        IJth(rJacobian, 13, 12) = var_x255;
        IJth(rJacobian, 14, 12) = var_x236;
        IJth(rJacobian, 10, 13) = var_x264;
        IJth(rJacobian, 12, 13) = var_x238;
        IJth(rJacobian, 13, 13) = var_x248 + var_x265;
        IJth(rJacobian, 15, 13) = var_x247;
        IJth(rJacobian, 12, 14) = var_x267;
        IJth(rJacobian, 14, 14) = var_x256 + var_x268;
        IJth(rJacobian, 15, 14) = var_x255;
        IJth(rJacobian, 13, 15) = var_x267;
        IJth(rJacobian, 14, 15) = var_x225;
        IJth(rJacobian, 15, 15) = var_x237 + var_x268;
        IJth(rJacobian, 16, 15) = var_x236;
        IJth(rJacobian, 15, 16) = var_x270;
        IJth(rJacobian, 16, 16) = -0.089538000000000006 - var_x270;
        IJth(rJacobian, 17, 16) = 0.089538000000000006;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138);
        IJth(rJacobian, 16, 17) = var_x273;
        IJth(rJacobian, 17, 17) = -var_x273 - var_x278;
        IJth(rJacobian, 18, 17) = var_x278;
        IJth(rJacobian, 46, 17) = var_x508;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138);
        IJth(rJacobian, 17, 18) = var_x279;
        IJth(rJacobian, 18, 18) = -var_x279;
        IJth(rJacobian, 46, 18) = var_x508;
        IJth(rJacobian, 19, 19) = var_x315 + var_x322;
        IJth(rJacobian, 20, 19) = var_x314;
        IJth(rJacobian, 21, 19) = var_x318;
        IJth(rJacobian, 23, 19) = var_x321;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x140);
        IJth(rJacobian, 19, 20) = var_x323;
        IJth(rJacobian, 20, 20) = var_x322 + var_x329;
        IJth(rJacobian, 22, 20) = var_x318;
        IJth(rJacobian, 24, 20) = var_x321;
        IJth(rJacobian, 37, 20) = var_x456;
        IJth(rJacobian, 41, 20) = var_x487;
        IJth(rJacobian, 19, 21) = 1.0;
        IJth(rJacobian, 21, 21) = var_x315 + var_x343;
        IJth(rJacobian, 22, 21) = var_x314;
        IJth(rJacobian, 25, 21) = var_x342;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (var_x140);
        IJth(rJacobian, 20, 22) = 1.0;
        IJth(rJacobian, 21, 22) = var_x323;
        IJth(rJacobian, 22, 22) = var_x329 + var_x343;
        IJth(rJacobian, 26, 22) = var_x342;
        IJth(rJacobian, 37, 22) = var_x456;
        IJth(rJacobian, 41, 22) = var_x487;
        IJth(rJacobian, 19, 23) = var_x324;
        IJth(rJacobian, 23, 23) = var_x315 + var_x361;
        IJth(rJacobian, 24, 23) = var_x314;
        IJth(rJacobian, 25, 23) = var_x360;
        IJth(rJacobian, 20, 24) = var_x324;
        IJth(rJacobian, 23, 24) = var_x323;
        IJth(rJacobian, 24, 24) = var_x329 + var_x361;
        IJth(rJacobian, 26, 24) = var_x360;
        IJth(rJacobian, 21, 25) = var_x344;
        IJth(rJacobian, 23, 25) = 9.9999999999999995e-7;
        IJth(rJacobian, 25, 25) = var_x315 + var_x368;
        IJth(rJacobian, 26, 25) = var_x314;
        IJth(rJacobian, 22, 26) = var_x344;
        IJth(rJacobian, 24, 26) = 9.9999999999999995e-7;
        IJth(rJacobian, 25, 26) = var_x323;
        IJth(rJacobian, 26, 26) = var_x329 + var_x368;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-27.224999999999998 * var_x145);
        IJth(rJacobian, 27, 27) = var_x380;
        IJth(rJacobian, 42, 27) = -0.001679808119411932 * var_x145;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x143 * var_x45);
        IJth(rJacobian, 28, 28) = -((var_x381) ? (0.0) : (0.13500000000000001 * var_x382)) - ((var_x381) ? (7.6923076923076916 / var_x384) : (310000.0 * var_x386 + 3.5600000000000001 * var_x385));
        IJth(rJacobian, 42, 28) = -var_x143 * var_x489;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-9.0749999999999993 * var_x146);
        IJth(rJacobian, 29, 29) = -((var_x381) ? (0.0) : (var_x393 * var_x394)) - ((var_x381) ? (0.29999999999999999 * var_x398) : (0.1212 * var_x402));
        IJth(rJacobian, 42, 29) = -0.00055993603980397731 * var_x146;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0195 * var_x147);
        IJth(rJacobian, 30, 30) = var_x380;
        IJth(rJacobian, 42, 30) = -1.2031683499920175e-6 * var_x147;
        IJth(rJacobian, 0, 31) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x11 * var_x143);
        IJth(rJacobian, 31, 31) = -0.0016666666666666668;
        IJth(rJacobian, 42, 31) = -var_x143 * var_x488;
        IJth(rJacobian, 0, 32) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x42 * var_x52);
        IJth(rJacobian, 32, 32) = -var_x415 - var_x416;
        IJth(rJacobian, 46, 32) = -var_x505 * var_x52;
        IJth(rJacobian, 0, 33) = mSetVoltageDerivativeToZero ? 0.0 : (-1.4924999999999999 * var_x149);
        IJth(rJacobian, 33, 33) = -var_x424 - var_x425;
        IJth(rJacobian, 46, 33) = -9.2088654480158264e-5 * var_x149;
        IJth(rJacobian, 0, 34) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x52 * var_x88);
        IJth(rJacobian, 34, 34) = var_x438 - var_x436;
        IJth(rJacobian, 46, 34) = -var_x506 * var_x52;
        IJth(rJacobian, 0, 35) = mSetVoltageDerivativeToZero ? 0.0 : (-0.4975 * var_x150);
        IJth(rJacobian, 35, 35) = var_x438 - 0.0040000000000000001 / var_x440;
        IJth(rJacobian, 46, 35) = -3.0696218160052752e-5 * var_x150;
        IJth(rJacobian, 0, 36) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x107 * var_chaste_interface__membrane__Vm);
        IJth(rJacobian, 36, 36) = -0.125;
        IJth(rJacobian, 45, 36) = var_x502 * var_chaste_interface__membrane__Vm;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0010402994780168702 * var_x151);
        IJth(rJacobian, 37, 37) = -var_x454;
        IJth(rJacobian, 38, 37) = -1.0 * var_x467;
        IJth(rJacobian, 40, 37) = 0.23999999999999996 * var_x477;
        IJth(rJacobian, 45, 37) = 2.175954783543569e-6 * var_x151;
        IJth(rJacobian, 37, 38) = -0.0123 * var_x452 * var_x458 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 17.976374980131517 * var_x441 * var_x442 * var_x449 * var_x459 / pow(var_x443, 2);
        IJth(rJacobian, 38, 38) = -var_x468 + 0.25 * (var_x457 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x465, 3) * pow((0.125 + var_x466), 2));
        IJth(rJacobian, 39, 38) = 0.0034782608695652171;
        IJth(rJacobian, 1, 39) = 2.3746312684365782e-5 * var_x187;
        IJth(rJacobian, 38, 39) = var_x468;
        IJth(rJacobian, 39, 39) = -0.0037699275362318837;
        IJth(rJacobian, 0, 40) = mSetVoltageDerivativeToZero ? 0.0 : (2469600.0 * var_x152 + var_x131 * var_x153 - var_x133 * var_x154);
        IJth(rJacobian, 1, 40) = var_x188 * (0.014749262536873154 - var_x206 * var_x214 - var_x212 * var_x213);
        IJth(rJacobian, 37, 40) = -4.6767910530856466e-10 * var_x460 * var_x462 - 2.667471823152336e-9 * var_x462 * var_x463;
        IJth(rJacobian, 39, 40) = var_x212 * var_x471 + var_x214 * var_x470;
        IJth(rJacobian, 40, 40) = var_x478 * (-5.5 + 6.53644343986048e-11 * var_x479 - 4.8146657448698097e-10 * var_x170 - 5165.5682301054212 * var_x152) + 1.0 * (0.019557600000000001 / pow(var_x474, 3) + 8.1780000000000006e-5 / pow(var_x475, 3)) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + var_x123 * var_x472) / pow(var_x476, 2);
        IJth(rJacobian, 41, 40) = 5.0 * var_x485;
        IJth(rJacobian, 43, 40) = 15496.704690316265 * var_x152 + 1.4443997234609428e-9 * var_x170 - 1.960933031958144e-10 * var_x479;
        IJth(rJacobian, 47, 40) = 3.7500000000000005e-6 * var_x197 * var_x208 + 1.8750000000000003e-7 * var_x79 * pow(var_x190, 2) / pow(var_x191, 3);
        IJth(rJacobian, 0, 41) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x155);
        IJth(rJacobian, 19, 41) = -var_x327;
        IJth(rJacobian, 20, 41) = -var_x330;
        IJth(rJacobian, 21, 41) = var_x327 + var_x346 * var_chaste_interface__ICaL__CI_star + var_x347 * var_chaste_interface__ICaL__C_star;
        IJth(rJacobian, 22, 41) = var_x330 + var_x346 * var_chaste_interface__ICaL__OI_star + var_x347 * var_chaste_interface__ICaL__O_star;
        IJth(rJacobian, 23, 41) = -var_x363;
        IJth(rJacobian, 24, 41) = -var_x364;
        IJth(rJacobian, 25, 41) = var_x363 + var_x369 * var_chaste_interface__ICaL__C_star + var_x370 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 26, 41) = var_x364 + var_x369 * var_chaste_interface__ICaL__O_star + var_x370 * var_chaste_interface__ICaL__OI_star;
        IJth(rJacobian, 37, 41) = -var_x155 * var_x455;
        IJth(rJacobian, 40, 41) = 0.5 * var_x477;
        IJth(rJacobian, 41, 41) = var_x486 * (-5.0 - 0.023500311662270543 * var_x113) + 1.0 * (0.019557600000000001 / pow(var_x482, 3) + 8.1780000000000006e-5 / pow(var_x483, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x481 * var_chaste_interface__membrane__Vm) / pow(var_x484, 2);
        IJth(rJacobian, 0, 42) = mSetVoltageDerivativeToZero ? 0.0 : (0.071928427789186525 * var_x157 + 1.3365608910938003e-12 * var_x166 + 3.900466760223035 * var_x163 - 242.40944894130814 * var_x164 - 19.440000000000001 * var_x168 - 0.18701391225188496 * var_x159 - 1.1558883089076335e-5 * var_x160 - 0.17362660254749343 * var_x161);
        IJth(rJacobian, 1, 42) = var_x188 * (0.0011994662935305037 * var_x168 - 8.2467064718009662e-17 * var_x166);
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x495 + 2.4740119415402899e-16 * var_x166 + 1.3314155043174696e-5 * var_x157 - 3.4616803112254212e-5 * var_x159 - 7.1319396379664657e-10 * var_x160 - 1.0712924764194231e-5 * var_x161 - 0.0035983988805915112 * var_x168 - 0.014956891113086561 * var_x164;
        IJth(rJacobian, 43, 42) = 5.0;
        IJth(rJacobian, 44, 42) = var_x495;
        IJth(rJacobian, 46, 42) = 2.3077868741502807e-5 * var_x159 + 3.900466760223035 * var_x509 - 8.8761033621164642e-6 * var_x157;
        IJth(rJacobian, 0, 43) = mSetVoltageDerivativeToZero ? 0.0 : (1.3365608910938003e-12 * var_x171 - 4.8600000000000003 * var_x172);
        IJth(rJacobian, 40, 43) = var_x478 * (0.010165476837671019 * var_x172 - 2.7956334939405277e-15 * var_x171);
        IJth(rJacobian, 42, 43) = 0.14749262536873156;
        IJth(rJacobian, 43, 43) = -5.0 + 8.386900481821583e-15 * var_x171 - 0.030496430513013057 * var_x172;
        IJth(rJacobian, 0, 44) = mSetVoltageDerivativeToZero ? 0.0 : (0.0060101516266440041 * var_x173 - 0.0032509358688027189 * var_x174);
        IJth(rJacobian, 42, 44) = var_x496;
        IJth(rJacobian, 44, 44) = -0.14749262536873156 + var_x496 + var_x500 - 3.7083201106826184e-7 * var_x173;
        IJth(rJacobian, 45, 44) = 5.0 + 6.799858698573652e-6 * var_x174;
        IJth(rJacobian, 46, 44) = var_x500;
        IJth(rJacobian, 44, 45) = 0.14749262536873156;
        IJth(rJacobian, 45, 45) = -5.0;
        IJth(rJacobian, 0, 46) = mSetVoltageDerivativeToZero ? 0.0 : (212.7914217252065 * var_x163 + 3.2490879693637482 * var_x180 - 13.289113041135074 * var_x181 - 0.073724526620166445 * var_x175 - 0.37007041184822825 * var_x176 - 13.623010353726409 * var_x177 - var_x179 * var_x95);
        IJth(rJacobian, 44, 46) = var_x501;
        IJth(rJacobian, 46, 46) = var_x501 + 212.7914217252065 * var_x509 + 0.00020047178518350236 * var_x180 - 4.5488726691040119e-6 * var_x175 - 2.2833692656630728e-5 * var_x176 - 0.00081995078002871237 * var_x181 - 0.0008405525584213936 * var_x177 - var_x179 * var_x507;
        IJth(rJacobian, 1, 47) = var_x188 * (-var_x206 * var_x219 - var_x213 * var_x218);
        IJth(rJacobian, 37, 47) = 3.5566290975364474e-5 * var_x463 * var_x464 + 6.2357214041141957e-6 * var_x460 * var_x464;
        IJth(rJacobian, 39, 47) = var_x218 * var_x471 + var_x219 * var_x470;
        IJth(rJacobian, 47, 47) = -0.00068000000000000005 - var_x197 * var_x510 + var_x190 * var_x215 * var_x510;
    }
