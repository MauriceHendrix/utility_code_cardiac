...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x446 = 1.0 + 1.0 * var_x445;
        ...
        IJth(rJacobian, 32, 0) = (-var_chaste_interface__IKr_xr_gate__xr + 1.0 / var_x409) * (var_x412 + var_x415 - 8.1600000000000005e-5 * var_x413 * var_x416 / pow(var_x414, 2) - 4.566e-5 * var_x410 * var_x417 / pow(var_x411, 2)) + 0.23529411764705882 * var_x408 * (var_x418 + var_x419) / pow(var_x409, 2);
        IJth(rJacobian, 33, 0) = (-var_chaste_interface__Ito1_a_gate__a + 1.0 / var_x421) * (0.028153807491391791 * var_x423 / pow(var_x424, 2) - 0.11912298256720238 * var_x425 / pow(var_x426, 2)) + 0.14019346698443852 * var_x420 * (var_x427 + var_x428) / pow(var_x421, 2);
        ...
        IJth(rJacobian, 28, 28) = -((var_x384) ? (0.0) : (0.13500000000000001 * var_x385)) - ((var_x384) ? (7.6923076923076916 / var_x387) : (310000.0 * var_x389 + 3.5600000000000001 * var_x388));
        IJth(rJacobian, 42, 28) = -6.1700941025231664e-5 * var_x148;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149);
        IJth(rJacobian, 29, 29) = -((var_x384) ? (0.0) : (var_x396 * var_x397)) - ((var_x384) ? (0.29999999999999999 * var_x401) : (0.1212 * var_x405));
        ...
        IJth(rJacobian, 41, 41) = var_x489 * (-5.0 - var_x483 * var_x88) + 1.0 * (0.019557600000000001 / pow(var_x485, 3) + 8.1780000000000006e-5 / pow(var_x486, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x139 * var_x483) / pow(var_x487, 2);
