...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_INaCa__num_ss = 0.20000000000000001 * (pow(var_chaste_interface__Na__Na_ss_sr, 3) * var_model_parameters__Ca_o * exp(var_INaCa__eta * var_chaste_interface__membrane__Vm * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T)) - pow(var_model_parameters__Na_o, 3) * var_chaste_interface__Ca__Ca_ss_sr * exp((-1.0 + var_INaCa__eta) * var_chaste_interface__membrane__Vm * var_model_parameters__F / (var_model_parameters__R * var_model_parameters__T))) * var_INaCa__Vmax; // mM4_uA_per_uF
        const double var_INaCa__INaCa_ss_sr = var_INaCa__num_ss / ((var_INaCa__denom_ss_3 + var_INaCa__denom_ss_4) * var_INaCa__denom_ss_1 * var_INaCa__denom_ss_2); // uA_per_uF
        const double d_dt_chaste_interface_var_Ca__Ca_ss_sr = (-var_Ca__Idiff - var_Ca__Idiff_ss + var_INaCa__INaCa_ss_sr * var_cell_geometry__AF / var_cell_geometry__Vss_sr + var_chaste_interface__Irel__Irel * var_cell_geometry__Vjsr / var_cell_geometry__Vss_sr) * var_Ca__bss_sr; // mM / ms
    ...
    void Celldecker_2009FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x188 = 8.8930116629204303e-8 * var_x38;
        const double var_x189 = 6.1700941025231664e-5 * var_x59;
        const double var_x190 = var_x114 * var_x115;
        const double var_x191 = 1.7739020544754105e-6 * var_x126;
        const double var_x192 = 1.0 - var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x193 = 1.0 + 0.0015 / var_chaste_interface__Ca__Ca_ss_sr;
        const double var_x194 = 1 / var_x193;
        const double var_x195 = 0.050000000000000003 * var_x194;
        const double var_x196 = var_x192 * var_x195 + var_chaste_interface__CaMK_active__CaMK_trap;
        const double var_x197 = 0.14999999999999999 + var_x196;
        const double var_x198 = 1 / var_x197;
        const double var_x199 = var_x196 * var_x198;
        const double var_x200 = 0.00092000000000000003 - 0.00017000000000000001 * var_x199 + var_chaste_interface__Ca__Ca_i;
        const double var_x201 = 1 / var_x200;
        const double var_x202 = 1.0 + 0.75 * var_x199;
        const double var_x203 = var_x201 * var_x202;
        const double var_x204 = 0.00035619469026548675 * var_x203;
        const double var_x205 = 0.00035619469026548675 * var_chaste_interface__Ca__Ca_i;
        const double var_x206 = var_x202 / pow(var_x200, 2);
        const double var_x207 = var_x205 * var_x206;
        const double var_x208 = var_x134 * var_x59;
        const double var_x209 = var_x192 * var_x73 / pow(var_x193, 2);
        const double var_x210 = var_x198 * var_x209;
        const double var_x211 = var_x196 / pow(var_x197, 2);
        ...
        const double var_x214 = var_x201 * var_x205;
        const double var_x215 = 1.2750000000000002e-8 * var_x210 - 1.2750000000000002e-8 * var_x212;
        const double var_x216 = 1 - var_x195;
        const double var_x217 = var_x198 * var_x216;
        const double var_x218 = -1 + var_x195;
        const double var_x219 = var_x211 * var_x218;
        const double var_x220 = 0.75 * var_x217 + 0.75 * var_x219;
        const double var_x221 = 0.00017000000000000001 * var_x217 + 0.00017000000000000001 * var_x219;
        const double var_x222 = exp(0.0011184950759309986 * var_chaste_interface__membrane__Vm);
        const double var_x223 = 6.6501243234553463e-5 * var_x222 * var_chaste_interface__IKs__C1;
        const double var_x224 = exp(-0.0020762745726213851 * var_chaste_interface__membrane__Vm);
        const double var_x225 = 0.00017437799625617966 * var_x224;
        const double var_x226 = 0.059456000000000002 * var_x222;
        const double var_x227 = 0.083986000000000005 * var_x224;
        const double var_x228 = 4.9875932425915097e-5 * var_x222;
        const double var_x229 = -var_x228;
        const double var_x230 = exp(0.0091588787470803235 * var_chaste_interface__membrane__Vm);
        const double var_x231 = 0.0001337287885861198 * var_x230;
        const double var_x232 = var_x225 - var_x231;
        ...
        const double var_x235 = 0.00034875599251235932 * var_x224;
        const double var_x236 = 0.044592 * var_x222;
        const double var_x237 = -var_x236;
        const double var_x238 = 0.014600999999999999 * var_x230;
        const double var_x239 = -var_x227 - var_x238;
        const double var_x240 = 0.16797200000000001 * var_x224;
        const double var_x241 = 0.0031172999999999999 * var_x233;
        const double var_x242 = 3.3250621617276731e-5 * var_x222;
        const double var_x243 = -var_x242;
        const double var_x244 = 0.00026745757717223961 * var_x230;
        const double var_x245 = var_x235 - var_x244;
        const double var_x246 = 0.0005231339887685389 * var_x224;
        const double var_x247 = 0.029728000000000001 * var_x222;
        const double var_x248 = -var_x247;
        const double var_x249 = 0.029201999999999999 * var_x230;
        const double var_x250 = -var_x240 - var_x249;
        const double var_x251 = 0.25195800000000002 * var_x224;
        const double var_x252 = 1.6625310808638366e-5 * var_x222;
        const double var_x253 = -var_x252;
        const double var_x254 = 0.00040118636575835941 * var_x230;
        const double var_x255 = var_x246 - var_x254;
        const double var_x256 = 0.00069751198502471864 * var_x224;
        const double var_x257 = 0.014864 * var_x222;
        const double var_x258 = -var_x257;
        const double var_x259 = 0.043802999999999995 * var_x230;
        const double var_x260 = -var_x251 - var_x259;
        const double var_x261 = 0.33594400000000002 * var_x224;
        const double var_x262 = 0.00053491515434447921 * var_x230;
        const double var_x263 = 0.058403999999999998 * var_x230;
        const double var_x264 = -var_x241;
        const double var_x265 = 9.9487857111498683e-5 * var_x233;
        const double var_x266 = 0.0062345999999999999 * var_x233;
        const double var_x267 = -var_x266;
        const double var_x268 = 0.00014923178566724802 * var_x233;
        const double var_x269 = 0.0093518999999999998 * var_x233;
        const double var_x270 = -var_x269;
        const double var_x271 = 0.00019897571422299737 * var_x233 * var_chaste_interface__IKs__C15;
        const double var_x272 = 0.0124692 * var_x233;
        const double var_x273 = exp(-0.0024231252229042349 * var_chaste_interface__membrane__Vm);
        const double var_x274 = 0.00018735604223495543 * var_x273;
        const double var_x275 = 0.07732 * var_x273;
        const double var_x276 = exp(0.0105593841790373 * var_chaste_interface__membrane__Vm);
        const double var_x277 = 0.0061918116949038924 * var_x276;
        const double var_x278 = exp(-0.003001446738885828 * var_chaste_interface__membrane__Vm);
        const double var_x279 = 0.0023832987830122916 * var_x278 * var_chaste_interface__IKs__O2;
        const double var_x280 = 0.58638000000000001 * var_x276;
        const double var_x281 = 0.79405000000000003 * var_x278;
        const double var_x282 = exp(5.833333333333333 + 0.33333333333333331 * var_chaste_interface__membrane__Vm);
        const double var_x283 = 1.0 + var_x282;
        const double var_x284 = 1 / var_x283;
        const double var_x285 = 0.80000000000000004 * var_x284;
        const double var_x286 = exp(-0.019709447580272044 - 0.092532617747756077 * var_chaste_interface__membrane__Vm);
        const double var_x287 = 1.0 + var_x286;
        const double var_x288 = var_x286 / pow(var_x287, 2);
        const double var_x289 = exp(4.7444197507005512 + 0.096627693496956227 * var_chaste_interface__membrane__Vm);
        const double var_x290 = 1.0 + var_x289;
        const double var_x291 = -0.0038918839011179407 * var_x289 / pow(var_x290, 2);
        const double var_x292 = var_x291 + 0.0030285935177480471 * var_x288;
        const double var_x293 = 0.040277106492669565 / var_x290;
        const double var_x294 = 1 / var_x287;
        const double var_x295 = var_x293 + 0.032730010146303147 * var_x294;
        const double var_x296 = var_x282 / pow(var_x283, 2);
        const double var_x297 = 0.26666666666666666 * var_x295 * var_x296;
        const double var_x298 = -var_x297 + var_x292 * (-0.80000000000000004 + var_x285);
        const double var_x299 = exp(1.4349206349206352 - 0.10582010582010583 * var_chaste_interface__membrane__Vm);
        const double var_x300 = 1.0 + var_x299;
        const double var_x301 = exp(1.7160000000000002 + 0.13200000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x302 = 1.0 + var_x301;
        const double var_x303 = exp(0.67599999999999993 + 0.051999999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x304 = var_x303 / var_x302;
        const double var_x305 = 1 / (0.58999999999999997 + 0.80000000000000004 * var_x304);
        const double var_x306 = 0.10582010582010583 * var_x299 * var_x305 / pow(var_x300, 2);
        const double var_x307 = 1 / var_x300;
        const double var_x308 = 1.5624999999999998 * (-0.041599999999999998 * var_x304 + 0.10560000000000001 * var_x301 * var_x303 / pow(var_x302, 2)) / pow((0.73749999999999993 + var_x304), 2);
        const double var_x309 = var_x307 * var_x308;
        const double var_x310 = -var_x306 - var_x309;
        const double var_x311 = 0.20000000000000001 + var_x285;
        const double var_x312 = var_x292 * var_x311;
        const double var_x313 = 1.0 - var_x307;
        const double var_x314 = var_x308 * var_x313;
        const double var_x315 = var_x305 * var_x307;
        const double var_x316 = -var_x315;
        const double var_x317 = 1.0 + 8.1000000000000005e-11 / pow(var_chaste_interface__Ca__Ca_ss_CaL, 4);
        const double var_x318 = 1 / var_x317;
        const double var_x319 = 3.0 * var_x318;
        const double var_x320 = -var_x285;
        const double var_x321 = 0.80000000000000004 + var_x320;
        const double var_x322 = var_x295 * var_x321;
        const double var_x323 = -var_x319 - var_x322;
        const double var_x324 = var_x305 * var_x313;
        const double var_x325 = var_x295 * var_x311;
        const double var_x326 = 1 / (pow(var_x317, 2) * pow(var_chaste_interface__Ca__Ca_ss_CaL, 5));
        const double var_x327 = 9.7200000000000016e-10 * var_x326;
        const double var_x328 = var_x327 * var_chaste_interface__ICaL__C;
        const double var_x329 = var_x306 - var_x314;
        const double var_x330 = -var_x324;
        const double var_x331 = var_x327 * var_chaste_interface__ICaL__O;
        const double var_x332 = 0.99990000999900008 * var_x284;
        const double var_x333 = -0.99990000999900008 + var_x332;
        const double var_x334 = 1 / (25.0 - 17.5 * var_x318);
        const double var_x335 = var_x291 + 0.092532617747756077 * var_x288 * var_x334;
        const double var_x336 = var_x293 + var_x294 * var_x334;
        const double var_x337 = 0.33330000333300003 * var_x296 * var_x336;
        const double var_x338 = -var_x337 + var_x333 * var_x335;
        const double var_x339 = 9.9990000999900015e-5 + var_x332;
        const double var_x340 = var_x335 * var_x339;
        const double var_x341 = -var_x332;
        const double var_x342 = 0.99990000999900008 + var_x341;
        const double var_x343 = var_x336 * var_x342;
        const double var_x344 = -1.0 - var_x343;
        const double var_x345 = var_x336 * var_x339;
        const double var_x346 = 9.0720000000000001e-12 * var_x294 * var_x326 / pow((1 - 0.69999999999999996 * var_x318), 2);
        const double var_x347 = var_x339 * var_x346;
        const double var_x348 = var_x333 * var_x346;
        const double var_x349 = 1 / var_x321;
        const double var_x350 = 1 / var_x339;
        const double var_x351 = var_x318 * var_x342 * var_x349 * var_x350;
        const double var_x352 = 7.9999999999999996e-7 * var_x296 * var_x351;
        const double var_x353 = var_x311 * var_x349 * var_x350;
        const double var_x354 = var_x296 * var_x318;
        const double var_x355 = 9.9990000999900006e-7 * var_x353 * var_x354;
        const double var_x356 = var_x311 * var_x342 * var_x354;
        const double var_x357 = 1.2499999999999999e-6 * var_x350 * var_x356 / pow((1 - var_x284), 2);
        const double var_x358 = 1.0001e-6 * var_x349 * var_x356 / pow((0.0001 + var_x284), 2);
        const double var_x359 = var_x297 + var_x352 + var_x357 - var_x355 - var_x358 + var_x292 * (-0.20000000000000001 + var_x320);
        const double var_x360 = var_x292 * var_x321;
        const double var_x361 = 3.0000000000000001e-6 * var_x311 * var_x351;
        const double var_x362 = -var_x325 - var_x361;
        const double var_x363 = 9.7200000000000002e-16 * var_x326 * var_x342 * var_x353;
        const double var_x364 = var_x363 * var_chaste_interface__ICaL__CI;
        const double var_x365 = var_x363 * var_chaste_interface__ICaL__OI;
        const double var_x366 = -9.9990000999900015e-5 + var_x341;
        const double var_x367 = var_x337 + var_x335 * var_x366;
        const double var_x368 = var_x335 * var_x342;
        const double var_x369 = -9.9999999999999995e-7 - var_x345;
        const double var_x370 = var_x342 * var_x346;
        const double var_x371 = var_x346 * var_x366;
        const double var_x372 = 1.0 - var_chaste_interface__INa_m_gate__m;
        const double var_x373 = -0.10000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x374 = exp(-4.7130000000000001 + var_x373);
        const double var_x375 = 1.0 - var_x374;
        const double var_x376 = 0.32000000000000001 / var_x375;
        const double var_x377 = exp(-0.090909090909090912 * var_chaste_interface__membrane__Vm);
        const double var_x378 = 0.0072727272727272727 * var_x377;
        const double var_x379 = 47.130000000000003 + var_chaste_interface__membrane__Vm;
        const double var_x380 = 0.032000000000000001 * var_x374 * var_x379 / pow(var_x375, 2);
        const double var_x381 = -0.080000000000000002 * var_x377 - var_x376 * var_x379;
        const double var_x382 = var_chaste_interface__membrane__Vm >= -40.0;
        const double var_x383 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__Vm);
        ...
        const double var_x386 = exp(0.079000000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x387 = exp(0.34999999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x388 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__Vm);
        const double var_x389 = 1.0 + var_x388;
        const double var_x390 = 1 / var_x389;
        const double var_x391 = exp(0.24440000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x392 = exp(-0.043909999999999998 * var_chaste_interface__membrane__Vm);
        const double var_x393 = -127140.0 * var_x391 - 6.9480000000000006e-5 * var_x392;
        const double var_x394 = var_x390 * var_x393;
        const double var_x395 = 37.780000000000001 + var_chaste_interface__membrane__Vm;
        const double var_x396 = exp(-3.2000000000000002 + var_x373);
        const double var_x397 = 1.0 + var_x396;
        const double var_x398 = exp(-2.5349999999999999e-7 * var_chaste_interface__membrane__Vm);
        const double var_x399 = var_x398 / var_x397;
        const double var_x400 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x401 = 1.0 + var_x400;
        const double var_x402 = exp(-0.01052 * var_chaste_interface__membrane__Vm);
        const double var_x403 = var_x402 / var_x401;
        const double var_x404 = 1.0 - var_chaste_interface__INaL_mL_gate__mL;
        const double var_x405 = exp(14.918032786885247 + 0.16393442622950821 * var_chaste_interface__membrane__Vm);
        const double var_x406 = exp(-2.3729411764705883 - 0.23529411764705882 * var_chaste_interface__membrane__Vm);
        const double var_x407 = 1.0 + var_x406;
        const double var_x408 = exp(5.8385137599999997 + 0.1522 * var_chaste_interface__membrane__Vm);
        const double var_x409 = -1.0 + var_x408;
        const double var_x410 = 0.00029999999999999997 / var_x409;
        const double var_x411 = exp(0.2364224 - 0.13600000000000001 * var_chaste_interface__membrane__Vm);
        const double var_x412 = 1.0 - var_x411;
        const double var_x413 = 0.00059999999999999995 / var_x412;
        const double var_x414 = -1.7383999999999999 + var_chaste_interface__membrane__Vm;
        const double var_x415 = 38.360799999999998 + var_chaste_interface__membrane__Vm;
        const double var_x416 = var_x410 * var_x415;
        const double var_x417 = var_x413 * var_x414;
        const double var_x418 = exp(-1.3230057479321462 - 0.14019346698443852 * var_chaste_interface__membrane__Vm);
        const double var_x419 = 1.0 + var_x418;
        const double var_x420 = 0.034035137876343539 * var_chaste_interface__membrane__Vm;
        const double var_x421 = exp(0.62658348478969694 - var_x420);
        const double var_x422 = 1.0 + var_x421;
        const double var_x423 = exp(3.403513787634354 + var_x420);
        const double var_x424 = 1.0 + var_x423;
        const double var_x425 = 3.5 / var_x424;
        const double var_x426 = 0.82719827942757873 / var_x422;
        const double var_x427 = 0.20000000000000001 * var_chaste_interface__membrane__Vm;
        const double var_x428 = exp(11.6 + var_x427);
        const double var_x429 = 1.0 + var_x428;
        const double var_x430 = var_x428 / pow(var_x429, 2);
        const double var_x431 = 0.0050000000000000001 * var_x430;
        const double var_x432 = exp(-2.1111111111111112 - 0.1111111111111111 * var_chaste_interface__membrane__Vm);
        const double var_x433 = 1.0 + var_x432;
        const double var_x434 = var_x432 / pow(var_x433, 2);
        const double var_x435 = 0.011343308638950427 * var_x434;
        const double var_x436 = 1 / var_x429;
        const double var_x437 = 0.025000000000000001 * var_x436;
        const double var_x438 = 1 / var_x433;
        const double var_x439 = -0.10208977775055385 * var_x438;
        const double var_x440 = exp(12.0 + var_x427);
        const double var_x441 = 1.0 + var_x440;
        const double var_x442 = 1 / var_chaste_interface__Ca__Ca_JSR;
        const double var_x443 = pow(var_x442, 8.0);
        const double var_x444 = 1.0 + 1.0 * var_x443;
        const double var_x445 = 1 / var_x444;
        const double var_x446 = 1 / var_x196;
        const double var_x447 = pow(var_x446, 10.0);
        const double var_x448 = 1.0 + 2.9619676669542428e-6 * var_x447;
        const double var_x449 = 1 / var_x448;
        const double var_x450 = 0.53437500000000004 + 0.53437500000000004 * var_x449;
        const double var_x451 = var_x445 * var_x450;
        const double var_x452 = var_x451 * var_x87;
        const double var_x453 = 1 / (4.75 + 4.75 * var_x449);
        const double var_x454 = 1.0 + 0.0123 * var_x442;
        const double var_x455 = var_x453 * var_x454;
        const double var_x456 = var_x451 * var_x455;
        const double var_x457 = -var_x141 * var_x456;
        const double var_x458 = -var_chaste_interface__Irel__Irel;
        const double var_x459 = var_x458 - var_x452 * var_chaste_interface__membrane__Vm;
        const double var_x460 = var_x139 * var_x455 * var_x83;
        const double var_x461 = var_x454 * var_x459 / pow((1 + var_x449), 2);
        const double var_x462 = var_x446 * var_x447 / pow(var_x448, 2);
        const double var_x463 = var_x209 * var_x462;
        const double var_x464 = var_x445 * var_x460;
        const double var_x465 = var_x218 * var_x462;
        ...
        const double var_x470 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x471 = var_x206 * var_x470;
        const double var_x472 = var_x201 * var_x470;
        ...
        const double var_x477 = 0.0020916619007553534 * var_x59;
        const double var_x478 = var_x115 * var_x118;
        const double var_x479 = var_x157 * var_x59;
        const double var_x480 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x481 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss_CaL;
        const double var_x482 = 1.0 + 0.0097788000000000007 / pow(var_x480, 2) + 4.0890000000000003e-5 / pow(var_x481, 2);
        const double var_x483 = 1 / var_x482;
        const double var_x484 = 151.10797107941448 * var_x83;
        const double var_x485 = 11.313955322572472 * var_x83;
        const double var_x486 = -151.10797107941448 * var_x140 * var_x483;
        const double var_x487 = 4.0105611666400582e-7 * var_x10;
        const double var_x488 = log(100.0 * var_x176);
        const double var_x489 = var_x144 + var_x488;
        const double var_x490 = pow(var_x489, 4);
        const double var_x491 = 7.2087469970547496e-9 * pow(var_x489, 7) / pow((1 + 0.0085573053764671191 * var_x490), 2);
        const double var_x492 = 50.118419258935766 * pow(var_x489, 3) / (59494197.640692554 + 509110.01733929582 * var_x490);
        const double var_x493 = var_x143 * var_x491 - var_x143 * var_x492;
        const double var_x494 = var_x176 * var_x491 - var_x176 * var_x492;
        const double var_x495 = var_x39 + 26.711785007306684 * var_x488;
        const double var_x496 = 0.00047279859462932828 / (87.825100000000006 + var_x495);
        const double var_x497 = 6.1296950776416711e-8 * var_x495 / pow((1 + 0.30414750461208334 * var_x20 + 0.30414750461208334 * var_x488), 2);
        const double var_x498 = var_x176 * var_x497 - var_x176 * var_x496;
        const double var_x499 = var_x19 * var_x497 - var_x19 * var_x496;
        const double var_x500 = 6.799858698573652e-6 * var_x105;
        const double var_x501 = -5.0964977286841363e-6 - 3.0578986372104813e-6 * var_x6;
        const double var_x502 = var_x501 * var_x8;
        const double var_x503 = 6.1700941025231664e-5 * var_x44;
        const double var_x504 = 3.0696218160052752e-5 * var_x81;
        const double var_x505 = 3.0245559326093954e-5 * var_x93;
        const double var_x506 = var_x136 * var_x501;
        const double var_x507 = var_x165 * var_x502;
        const double var_x508 = 0.0025000000000000005 * var_x194;
        ...
        IJth(rJacobian, 1, 0) = var_x187 * (-var_x188 + 6.6584929913802883e-9 * var_x51 + 5.3958729525381867e-7 * var_x190 - 6.6584929913802883e-9 * var_x89 + var_x189 * var_x69);
        IJth(rJacobian, 2, 0) = -var_x223 - var_x225 * var_chaste_interface__IKs__C2;
        IJth(rJacobian, 3, 0) = var_x223 + (var_x229 + var_x232) * var_chaste_interface__IKs__C2 - var_x234 * var_chaste_interface__IKs__C6 - var_x235 * var_chaste_interface__IKs__C3;
        IJth(rJacobian, 4, 0) = var_x228 * var_chaste_interface__IKs__C2 + (var_x243 + var_x245) * var_chaste_interface__IKs__C3 - var_x234 * var_chaste_interface__IKs__C7 - var_x246 * var_chaste_interface__IKs__C4;
        IJth(rJacobian, 5, 0) = var_x242 * var_chaste_interface__IKs__C3 + (var_x253 + var_x255) * var_chaste_interface__IKs__C4 - var_x234 * var_chaste_interface__IKs__C8 - var_x256 * var_chaste_interface__IKs__C5;
        IJth(rJacobian, 6, 0) = var_x252 * var_chaste_interface__IKs__C4 + (var_x256 - var_x262) * var_chaste_interface__IKs__C5 - var_x234 * var_chaste_interface__IKs__C9;
        IJth(rJacobian, 7, 0) = var_x231 * var_chaste_interface__IKs__C2 + (var_x229 + var_x234) * var_chaste_interface__IKs__C6 - var_x225 * var_chaste_interface__IKs__C7;
        IJth(rJacobian, 8, 0) = var_x228 * var_chaste_interface__IKs__C6 + var_x244 * var_chaste_interface__IKs__C3 + (var_x232 + var_x234 + var_x243) * var_chaste_interface__IKs__C7 - var_x235 * var_chaste_interface__IKs__C8 - var_x265 * var_chaste_interface__IKs__C10;
        IJth(rJacobian, 9, 0) = var_x242 * var_chaste_interface__IKs__C7 + var_x254 * var_chaste_interface__IKs__C4 + (var_x234 + var_x245 + var_x253) * var_chaste_interface__IKs__C8 - var_x246 * var_chaste_interface__IKs__C9 - var_x265 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 10, 0) = var_x252 * var_chaste_interface__IKs__C8 + var_x262 * var_chaste_interface__IKs__C5 + (var_x234 + var_x255) * var_chaste_interface__IKs__C9 - var_x265 * var_chaste_interface__IKs__C12;
        IJth(rJacobian, 11, 0) = var_x231 * var_chaste_interface__IKs__C7 + (var_x243 + var_x265) * var_chaste_interface__IKs__C10 - var_x225 * var_chaste_interface__IKs__C11;
        IJth(rJacobian, 12, 0) = var_x242 * var_chaste_interface__IKs__C10 + var_x244 * var_chaste_interface__IKs__C8 + (var_x232 + var_x253 + var_x265) * var_chaste_interface__IKs__C11 - var_x235 * var_chaste_interface__IKs__C12 - var_x268 * var_chaste_interface__IKs__C13;
        IJth(rJacobian, 13, 0) = var_x252 * var_chaste_interface__IKs__C11 + var_x254 * var_chaste_interface__IKs__C9 + (var_x245 + var_x265) * var_chaste_interface__IKs__C12 - var_x268 * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 14, 0) = var_x231 * var_chaste_interface__IKs__C11 + (var_x253 + var_x268) * var_chaste_interface__IKs__C13 - var_x225 * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 15, 0) = -var_x271 + var_x244 * var_chaste_interface__IKs__C12 + var_x252 * var_chaste_interface__IKs__C13 + (var_x232 + var_x268) * var_chaste_interface__IKs__C14;
        IJth(rJacobian, 16, 0) = var_x271 + var_x231 * var_chaste_interface__IKs__C14 - var_x274 * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 17, 0) = -var_x279 + (var_x274 - var_x277) * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 18, 0) = var_x279 + var_x277 * var_chaste_interface__IKs__O1;
        IJth(rJacobian, 19, 0) = var_x312 * var_chaste_interface__ICaL__CI + var_x314 * var_chaste_interface__ICaL__O + (var_x298 + var_x310) * var_chaste_interface__ICaL__C - var_x297 * var_chaste_interface__ICaL__CI - var_x306 * var_chaste_interface__ICaL__O;
        IJth(rJacobian, 20, 0) = var_x306 * var_chaste_interface__ICaL__C + var_x309 * var_chaste_interface__ICaL__C + var_x312 * var_chaste_interface__ICaL__OI + (var_x298 + var_x329) * var_chaste_interface__ICaL__O - var_x297 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 21, 0) = var_x314 * var_chaste_interface__ICaL__O_star + var_x340 * var_chaste_interface__ICaL__CI_star + (var_x310 + var_x338) * var_chaste_interface__ICaL__C_star - var_x306 * var_chaste_interface__ICaL__O_star - var_x337 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 22, 0) = var_x306 * var_chaste_interface__ICaL__C_star + var_x309 * var_chaste_interface__ICaL__C_star + var_x340 * var_chaste_interface__ICaL__OI_star + (var_x329 + var_x338) * var_chaste_interface__ICaL__O_star - var_x337 * var_chaste_interface__ICaL__OI_star;
        IJth(rJacobian, 23, 0) = var_x297 * var_chaste_interface__ICaL__C + var_x314 * var_chaste_interface__ICaL__OI + var_x360 * var_chaste_interface__ICaL__C + (var_x310 + var_x359) * var_chaste_interface__ICaL__CI - var_x306 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 24, 0) = var_x297 * var_chaste_interface__ICaL__O + var_x306 * var_chaste_interface__ICaL__CI + var_x309 * var_chaste_interface__ICaL__CI + var_x360 * var_chaste_interface__ICaL__O + (var_x329 + var_x359) * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 25, 0) = var_x314 * var_chaste_interface__ICaL__OI_star + var_x337 * var_chaste_interface__ICaL__C_star + var_x355 * var_chaste_interface__ICaL__CI + var_x358 * var_chaste_interface__ICaL__CI + var_x368 * var_chaste_interface__ICaL__C_star + (var_x310 + var_x367) * var_chaste_interface__ICaL__CI_star - var_x306 * var_chaste_interface__ICaL__OI_star - var_x352 * var_chaste_interface__ICaL__CI - var_x357 * var_chaste_interface__ICaL__CI;
        IJth(rJacobian, 26, 0) = var_x306 * var_chaste_interface__ICaL__CI_star + var_x309 * var_chaste_interface__ICaL__CI_star + var_x337 * var_chaste_interface__ICaL__O_star + var_x355 * var_chaste_interface__ICaL__OI + var_x358 * var_chaste_interface__ICaL__OI + var_x368 * var_chaste_interface__ICaL__O_star + (var_x329 + var_x367) * var_chaste_interface__ICaL__OI_star - var_x352 * var_chaste_interface__ICaL__OI - var_x357 * var_chaste_interface__ICaL__OI;
        IJth(rJacobian, 27, 0) = var_x372 * var_x376 + var_x378 * var_chaste_interface__INa_m_gate__m - var_x372 * var_x380;
        IJth(rJacobian, 28, 0) = (1.0 - var_chaste_interface__INa_h_gate__h) * ((var_x382) ? (0) : (-0.019852941176470591 * var_x383)) - ((var_x382) ? (0.693000693000693 * var_x384 / pow(var_x385, 2)) : (0.28123999999999999 * var_x386 + 108500.0 * var_x387)) * var_chaste_interface__INa_h_gate__h;
        IJth(rJacobian, 29, 0) = (1.0 - var_chaste_interface__INa_j_gate__j) * ((var_x382) ? (0) : (var_x394 + var_x390 * var_x395 * (3.0508668000000001e-6 * var_x392 - 31073.016 * var_x391) - 0.311 * var_x388 * var_x393 * var_x395 / pow(var_x389, 2))) - ((var_x382) ? (-7.6049999999999996e-8 * var_x399 + 0.029999999999999999 * var_x396 * var_x398 / pow(var_x397, 2)) : (-0.001275024 * var_x403 + 0.016701360000000002 * var_x400 * var_x402 / pow(var_x401, 2))) * var_chaste_interface__INa_j_gate__j;
        IJth(rJacobian, 30, 0) = var_x376 * var_x404 + var_x378 * var_chaste_interface__INaL_mL_gate__mL - var_x380 * var_x404;
        IJth(rJacobian, 31, 0) = -0.00027322404371584699 * var_x405 / pow((1.0 + var_x405), 2);
        IJth(rJacobian, 32, 0) = (1 / var_x407 - var_chaste_interface__IKr_xr_gate__xr) * (var_x410 + var_x413 - 8.1600000000000005e-5 * var_x411 * var_x414 / pow(var_x412, 2) - 4.566e-5 * var_x408 * var_x415 / pow(var_x409, 2)) + 0.23529411764705882 * var_x406 * (var_x416 + var_x417) / pow(var_x407, 2);
        IJth(rJacobian, 33, 0) = (1 / var_x419 - var_chaste_interface__Ito1_a_gate__a) * (0.028153807491391791 * var_x421 / pow(var_x422, 2) - 0.11912298256720238 * var_x423 / pow(var_x424, 2)) + 0.14019346698443852 * var_x418 * (var_x425 + var_x426) / pow(var_x419, 2);
        IJth(rJacobian, 34, 0) = -var_x431 * (1.0 - var_chaste_interface__Ito1_i1f_gate__i1f) - var_x435 * var_chaste_interface__Ito1_i1f_gate__i1f;
        IJth(rJacobian, 35, 0) = -var_x435 * var_chaste_interface__Ito1_i1s_gate__i1s - 0.00080000000000000004 * var_x440 * (1.0 - var_chaste_interface__Ito1_i1s_gate__i1s) / pow(var_x441, 2);
        IJth(rJacobian, 36, 0) = -0.00062500000000000001 * var_x430 / (var_x437 + 0.20000000000000001 * var_x438) + 0.078125 * var_x436 * (var_x431 - 0.022222222222222223 * var_x434) / pow((var_x438 + 0.125 * var_x436), 2);
        IJth(rJacobian, 37, 0) = var_x455 * (-var_x452 + var_x121 * var_x451 - var_x124 * var_x451);
        IJth(rJacobian, 40, 0) = var_x476 * (1.8292009309104452e-5 * var_x478 + var_x477 * var_x78);
        IJth(rJacobian, 41, 0) = var_x483 * (var_x120 * var_x485 - var_x123 * var_x485 - var_x484 * var_x86);
        IJth(rJacobian, 42, 0) = 2.6699599581291967e-11 * var_x53 - 7.1319396379664657e-10 * var_x18 - 6.1700941025231664e-5 * var_x48 - 1.6187618857614559e-6 * var_x190 - 4.3197915704978414e-7 * var_x99 - 2.6699599581291967e-11 * var_x90 - var_x487 * var_chaste_interface__INaL_hL_gate__hL - 0.00018510282307569501 * var_x59 * var_x69;
        IJth(rJacobian, 43, 0) = -5.4876027927313356e-5 * var_x478 - 0.0062749857022660607 * var_x59 * var_x78;
        IJth(rJacobian, 44, 0) = 1.3882711730677125e-8;
        IJth(rJacobian, 45, 0) = 2.5456399475788057e-7 * var_x122 - 2.5456399475788059e-5 * var_x109 + var_x500 * var_chaste_interface__Ito2_i2f_gate__i2f;
        IJth(rJacobian, 46, 0) = var_x502 + 7.5049939616040537e-6 * var_x56 + 4.00655461202803e-6 * var_x110 + 2.8798610469985608e-7 * var_x99 - 2.8477357396260765e-8 * var_x41 - 3.1467479922868152e-5 * var_x32 - 1.7029459722963939e-7 * var_x2 - 5.5811305745550463e-8 * var_x112 - var_x503 * var_chaste_interface__IKr_xr_gate__xr - var_x504 * var_chaste_interface__Ito1_i1f_gate__i1f - var_x505 * var_x92;
        ...
        IJth(rJacobian, 1, 1) = var_x187 * (-0.014749262536873154 + var_x207 - var_x191 - var_x204 + 1.9281544070384897e-12 * var_x208 + 1.7739020544754105e-6 * var_x128 - 609.50657582364852 * var_x130 - 1.4202553819674954e-11 * var_x167 - 8.8930116629204303e-8 * var_x88) + (0.00023800000000000004 / pow(var_x185, 3) + 7.0000000000000007e-5 / pow(var_x125, 3)) * (2.3746312684365782e-5 * var_chaste_interface__Ca__Ca_NSR + 0.014749262536873154 * var_chaste_interface__Ca__Ca_ss_sr - 0.014749262536873154 * var_chaste_interface__Ca__Ca_i + var_x114 * var_x189 - var_x188 * var_chaste_interface__membrane__Vm - var_x191 * var_chaste_interface__Ca__Ca_i - var_x204 * var_chaste_interface__Ca__Ca_i) / pow(var_x186, 2);
        IJth(rJacobian, 39, 1) = -var_x471 + 0.0043750000000000004 * var_x203;
        IJth(rJacobian, 40, 1) = 5.0 * var_x476;
        IJth(rJacobian, 42, 1) = 4.2607661459024858e-11 * var_x167 + 1828.5197274709456 * var_x130 - 5.784463221115469e-12 * var_x208;
        IJth(rJacobian, 46, 1) = -2.774905235513489e-12 * var_x137;
        IJth(rJacobian, 2, 2) = -var_x226;
        IJth(rJacobian, 3, 2) = var_x226;
        IJth(rJacobian, 2, 3) = var_x227;
        IJth(rJacobian, 3, 3) = var_x237 + var_x239;
        IJth(rJacobian, 4, 3) = var_x236;
        IJth(rJacobian, 7, 3) = var_x238;
        IJth(rJacobian, 3, 4) = var_x240;
        IJth(rJacobian, 4, 4) = var_x248 + var_x250;
        IJth(rJacobian, 5, 4) = var_x247;
        IJth(rJacobian, 8, 4) = var_x249;
        IJth(rJacobian, 4, 5) = var_x251;
        IJth(rJacobian, 5, 5) = var_x258 + var_x260;
        IJth(rJacobian, 6, 5) = var_x257;
        IJth(rJacobian, 9, 5) = var_x259;
        IJth(rJacobian, 5, 6) = var_x261;
        IJth(rJacobian, 6, 6) = -var_x261 - var_x263;
        IJth(rJacobian, 10, 6) = var_x263;
        IJth(rJacobian, 3, 7) = var_x241;
        IJth(rJacobian, 7, 7) = var_x237 + var_x264;
        IJth(rJacobian, 8, 7) = var_x236;
        IJth(rJacobian, 4, 8) = var_x241;
        IJth(rJacobian, 7, 8) = var_x227;
        IJth(rJacobian, 8, 8) = var_x239 + var_x248 + var_x264;
        IJth(rJacobian, 9, 8) = var_x247;
        IJth(rJacobian, 11, 8) = var_x238;
        IJth(rJacobian, 5, 9) = var_x241;
        IJth(rJacobian, 8, 9) = var_x240;
        IJth(rJacobian, 9, 9) = var_x250 + var_x258 + var_x264;
        IJth(rJacobian, 10, 9) = var_x257;
        IJth(rJacobian, 12, 9) = var_x249;
        IJth(rJacobian, 6, 10) = var_x241;
        IJth(rJacobian, 9, 10) = var_x251;
        IJth(rJacobian, 10, 10) = var_x260 + var_x264;
        IJth(rJacobian, 13, 10) = var_x259;
        IJth(rJacobian, 8, 11) = var_x266;
        IJth(rJacobian, 11, 11) = var_x248 + var_x267;
        IJth(rJacobian, 12, 11) = var_x247;
        IJth(rJacobian, 9, 12) = var_x266;
        IJth(rJacobian, 11, 12) = var_x227;
        IJth(rJacobian, 12, 12) = var_x239 + var_x258 + var_x267;
        IJth(rJacobian, 13, 12) = var_x257;
        IJth(rJacobian, 14, 12) = var_x238;
        IJth(rJacobian, 10, 13) = var_x266;
        IJth(rJacobian, 12, 13) = var_x240;
        IJth(rJacobian, 13, 13) = var_x250 + var_x267;
        IJth(rJacobian, 15, 13) = var_x249;
        IJth(rJacobian, 12, 14) = var_x269;
        IJth(rJacobian, 14, 14) = var_x258 + var_x270;
        IJth(rJacobian, 15, 14) = var_x257;
        IJth(rJacobian, 13, 15) = var_x269;
        IJth(rJacobian, 14, 15) = var_x227;
        IJth(rJacobian, 15, 15) = var_x239 + var_x270;
        IJth(rJacobian, 16, 15) = var_x238;
        IJth(rJacobian, 15, 16) = var_x272;
        IJth(rJacobian, 16, 16) = -0.089538000000000006 - var_x272;
        IJth(rJacobian, 17, 16) = 0.089538000000000006;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138);
        IJth(rJacobian, 16, 17) = var_x275;
        IJth(rJacobian, 17, 17) = -var_x275 - var_x280;
        IJth(rJacobian, 18, 17) = var_x280;
        IJth(rJacobian, 46, 17) = var_x506;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x138);
        IJth(rJacobian, 17, 18) = var_x281;
        IJth(rJacobian, 18, 18) = -var_x281;
        IJth(rJacobian, 46, 18) = var_x506;
        IJth(rJacobian, 19, 19) = var_x316 + var_x323;
        IJth(rJacobian, 20, 19) = var_x315;
        IJth(rJacobian, 21, 19) = var_x319;
        IJth(rJacobian, 23, 19) = var_x322;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142);
        IJth(rJacobian, 19, 20) = var_x324;
        IJth(rJacobian, 20, 20) = var_x323 + var_x330;
        IJth(rJacobian, 22, 20) = var_x319;
        IJth(rJacobian, 24, 20) = var_x322;
        IJth(rJacobian, 37, 20) = var_x457;
        IJth(rJacobian, 41, 20) = var_x486;
        IJth(rJacobian, 19, 21) = 1.0;
        IJth(rJacobian, 21, 21) = var_x316 + var_x344;
        IJth(rJacobian, 22, 21) = var_x315;
        IJth(rJacobian, 25, 21) = var_x343;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (var_x142);
        IJth(rJacobian, 20, 22) = 1.0;
        IJth(rJacobian, 21, 22) = var_x324;
        IJth(rJacobian, 22, 22) = var_x330 + var_x344;
        IJth(rJacobian, 26, 22) = var_x343;
        IJth(rJacobian, 37, 22) = var_x457;
        IJth(rJacobian, 41, 22) = var_x486;
        IJth(rJacobian, 19, 23) = var_x325;
        IJth(rJacobian, 23, 23) = var_x316 + var_x362;
        IJth(rJacobian, 24, 23) = var_x315;
        IJth(rJacobian, 25, 23) = var_x361;
        IJth(rJacobian, 20, 24) = var_x325;
        IJth(rJacobian, 23, 24) = var_x324;
        IJth(rJacobian, 24, 24) = var_x330 + var_x362;
        IJth(rJacobian, 26, 24) = var_x361;
        IJth(rJacobian, 21, 25) = var_x345;
        IJth(rJacobian, 23, 25) = 9.9999999999999995e-7;
        IJth(rJacobian, 25, 25) = var_x316 + var_x369;
        IJth(rJacobian, 26, 25) = var_x315;
        IJth(rJacobian, 22, 26) = var_x345;
        IJth(rJacobian, 24, 26) = 9.9999999999999995e-7;
        IJth(rJacobian, 25, 26) = var_x324;
        IJth(rJacobian, 26, 26) = var_x330 + var_x369;
        IJth(rJacobian, 0, 27) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x147);
        IJth(rJacobian, 27, 27) = var_x381;
        IJth(rJacobian, 42, 27) = -0.00018510282307569501 * var_x147;
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x148);
        IJth(rJacobian, 28, 28) = -((var_x382) ? (0) : (0.13500000000000001 * var_x383)) - ((var_x382) ? (7.6923076923076916 / var_x385) : (310000.0 * var_x387 + 3.5600000000000001 * var_x386));
        IJth(rJacobian, 42, 28) = -6.1700941025231664e-5 * var_x148;
        IJth(rJacobian, 0, 29) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x149);
        IJth(rJacobian, 29, 29) = -((var_x382) ? (0) : (var_x394 * var_x395)) - ((var_x382) ? (0.29999999999999999 * var_x399) : (0.1212 * var_x403));
        IJth(rJacobian, 42, 29) = -6.1700941025231664e-5 * var_x149;
        IJth(rJacobian, 0, 30) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0195 * var_x150);
        IJth(rJacobian, 30, 30) = var_x381;
        ...
        IJth(rJacobian, 45, 36) = var_x500 * var_chaste_interface__membrane__Vm;
        IJth(rJacobian, 0, 37) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0010402994780168702 * var_x154);
        IJth(rJacobian, 37, 37) = -var_x455;
        IJth(rJacobian, 38, 37) = -var_x468;
        IJth(rJacobian, 40, 37) = 0.23999999999999996 * var_x476;
        IJth(rJacobian, 45, 37) = 2.175954783543569e-6 * var_x154;
        IJth(rJacobian, 37, 38) = -0.0123 * var_x453 * var_x459 / pow(var_chaste_interface__Ca__Ca_JSR, 2) - 115588.83089076335 * var_x442 * var_x443 * var_x450 * var_x460 / pow(var_x444, 2);
        IJth(rJacobian, 38, 38) = -var_x469 + 0.25 * (var_x458 + 0.040000000000000001 * var_chaste_interface__Ca__Ca_NSR - 0.040000000000000001 * var_chaste_interface__Ca__Ca_JSR) / (pow(var_x466, 3) * pow((0.125 + var_x467), 2));
        IJth(rJacobian, 39, 38) = 0.0034782608695652171;
        IJth(rJacobian, 1, 39) = 2.3746312684365782e-5 * var_x187;
        IJth(rJacobian, 38, 39) = var_x469;
        ...
        IJth(rJacobian, 1, 40) = var_x187 * (0.014749262536873154 - var_x207 * var_x215 - var_x213 * var_x214);
        IJth(rJacobian, 37, 40) = -4.6767910530856466e-10 * var_x461 * var_x463 - 1.7151953595372529e-5 * var_x463 * var_x464;
        IJth(rJacobian, 39, 40) = var_x213 * var_x472 + var_x215 * var_x471;
        IJth(rJacobian, 40, 40) = var_x476 * (-5.5 + 6.53644343986048e-11 * var_x479 - 4.8146657448698097e-10 * var_x173 - 5165.5682301054212 * var_x155) + (0.019557600000000001 / pow(var_x473, 3) + 8.1780000000000006e-5 / pow(var_x474, 3)) * (0.5 * var_chaste_interface__Ca__Ca_ss_CaL + 0.23999999999999996 * var_chaste_interface__Irel__Irel + 5.0 * var_chaste_interface__Ca__Ca_i - 5.5 * var_chaste_interface__Ca__Ca_ss_sr + var_x118 * var_x477) / pow(var_x475, 2);
        IJth(rJacobian, 41, 40) = 5.0 * var_x483;
        IJth(rJacobian, 43, 40) = 15496.704690316265 * var_x155 + 1.4443997234609428e-9 * var_x173 - 1.960933031958144e-10 * var_x479;
        IJth(rJacobian, 47, 40) = 3.7500000000000005e-6 * var_x196 * var_x209 + 1.8750000000000003e-7 * var_x73 * pow(var_x192, 2) / pow(var_x193, 3);
        IJth(rJacobian, 0, 41) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x158);
        IJth(rJacobian, 19, 41) = -var_x328;
        IJth(rJacobian, 20, 41) = -var_x331;
        IJth(rJacobian, 21, 41) = var_x328 + var_x347 * var_chaste_interface__ICaL__CI_star + var_x348 * var_chaste_interface__ICaL__C_star;
        IJth(rJacobian, 22, 41) = var_x331 + var_x347 * var_chaste_interface__ICaL__OI_star + var_x348 * var_chaste_interface__ICaL__O_star;
        IJth(rJacobian, 23, 41) = -var_x364;
        IJth(rJacobian, 24, 41) = -var_x365;
        IJth(rJacobian, 25, 41) = var_x364 + var_x370 * var_chaste_interface__ICaL__C_star + var_x371 * var_chaste_interface__ICaL__CI_star;
        IJth(rJacobian, 26, 41) = var_x365 + var_x370 * var_chaste_interface__ICaL__O_star + var_x371 * var_chaste_interface__ICaL__OI_star;
        IJth(rJacobian, 37, 41) = -var_x158 * var_x456;
        IJth(rJacobian, 40, 41) = 0.5 * var_x476;
        IJth(rJacobian, 41, 41) = var_x483 * (-5.0 - var_x484 * var_x88) + (0.019557600000000001 / pow(var_x480, 3) + 8.1780000000000006e-5 / pow(var_x481, 3)) * (5.0 * var_chaste_interface__Ca__Ca_ss_sr - 5.0 * var_chaste_interface__Ca__Ca_ss_CaL - var_x139 * var_x484) / pow(var_x482, 2);
        ...
        IJth(rJacobian, 1, 42) = var_x187 * (0.0011994662935305037 * var_x171 - 8.2467064718009662e-17 * var_x168);
        IJth(rJacobian, 42, 42) = -0.14749262536873156 + var_x493 + 2.4740119415402899e-16 * var_x168 + 1.3314155043174696e-5 * var_x160 - 3.4616803112254212e-5 * var_x162 - 7.1319396379664657e-10 * var_x163 - 0.0016481422714144972 * var_x169 - 1.0712924764194231e-5 * var_x164 - 0.0035983988805915112 * var_x171;
        IJth(rJacobian, 43, 42) = 5.0;
        IJth(rJacobian, 44, 42) = var_x493;
        IJth(rJacobian, 46, 42) = 2.3077868741502807e-5 * var_x162 + 3.900466760223035 * var_x507 - 8.8761033621164642e-6 * var_x160;
        IJth(rJacobian, 0, 43) = mSetVoltageDerivativeToZero ? 0.0 : (1.3365608910938003e-12 * var_x174 - 4.8600000000000003 * var_x175);
        IJth(rJacobian, 40, 43) = var_x476 * (0.010165476837671019 * var_x175 - 2.7956334939405277e-15 * var_x174);
        ...
        IJth(rJacobian, 42, 44) = var_x494;
        IJth(rJacobian, 44, 44) = -0.14749262536873156 + var_x494 + var_x498 - 3.7083201106826184e-7 * var_x176;
        IJth(rJacobian, 45, 44) = 5.0 + 6.799858698573652e-6 * var_x177;
        IJth(rJacobian, 46, 44) = var_x498;
        ...
        IJth(rJacobian, 44, 46) = var_x499;
        IJth(rJacobian, 46, 46) = var_x499 + 212.7914217252065 * var_x507 + 0.00020047178518350236 * var_x183 - 4.5488726691040119e-6 * var_x178 - 0.00081995078002871237 * var_x184 - 0.0016481422714144972 * var_x182 - 0.0008405525584213936 * var_x179 - var_x181 * var_x505;
        IJth(rJacobian, 1, 47) = var_x187 * (-var_x207 * var_x221 - var_x214 * var_x220);
        IJth(rJacobian, 37, 47) = 0.22869271460496704 * var_x464 * var_x465 + 6.2357214041141957e-6 * var_x461 * var_x465;
        IJth(rJacobian, 39, 47) = var_x220 * var_x472 + var_x221 * var_x471;
        IJth(rJacobian, 47, 47) = -0.00068000000000000005 - var_x196 * var_x508 + var_x192 * var_x216 * var_x508;
    }
