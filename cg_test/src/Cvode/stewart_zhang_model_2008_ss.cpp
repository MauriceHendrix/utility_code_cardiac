...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellstewart_zhang_model_2008_ssFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x88 = exp(11.852941176470587 + var_x87);
        ...
        const double var_x98 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x99 = exp(-3.7142857142857144 - var_x98);
        const double var_x100 = 1.0 + var_x99;
        const double var_x101 = 1 / var_x100 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        const double var_x109 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x110 = 1.0 + var_x109;
        const double var_x111 = 1 / var_x110 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        const double var_x122 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        ...
        const double var_x133 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x134 = 1.0 + var_x133;
        const double var_x135 = pow(var_x134, (-2)) - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x136 = exp(-12.0 - var_x125);
        const double var_x137 = 1.0 + var_x136;
        const double var_x138 = var_x132 * var_x137;
        const double var_x139 = exp(-11.764705882352942 - var_x87 + 0.14705882352941177 * NV_Ith_S(mParameters, 3));
        const double var_x140 = var_chaste_interface__membrane__V < -40.0;
        const double var_x141 = exp(0.34849999999999998 * var_chaste_interface__membrane__V - 0.34849999999999998 * NV_Ith_S(mParameters, 3));
        const double var_x142 = exp(0.079000000000000001 * var_chaste_interface__membrane__V - 0.079000000000000001 * NV_Ith_S(mParameters, 3));
        const double var_x143 = exp(-0.96036036036036043 + 0.0900900900900901 * NV_Ith_S(mParameters, 3) - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x144 = 1.0 + var_x143;
        const double var_x145 = 0.01 * NV_Ith_S(mParameters, 2);
        const double var_x146 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V - 0.13458950201884254 * NV_Ith_S(mParameters, 3));
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 1.0 - var_x145;
        const double var_x149 = var_x145 + var_x148 / pow(var_x147, 2);
        ...
        const double var_x152 = 0.26917900403768508 * var_x146 * var_x148 / pow(var_x147, 3);
        const double var_x153 = exp(-5.5312920000000005 + 0.13780000000000001 * NV_Ith_S(mParameters, 3) - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x154 = 1.0 + var_x153;
        const double var_x155 = exp(0.01052 * NV_Ith_S(mParameters, 3) - 0.01052 * var_chaste_interface__membrane__V);
        const double var_x156 = var_x155 / var_x154;
        const double var_x157 = exp(-3.2000000000000002 - var_x0 + 0.10000000000000001 * NV_Ith_S(mParameters, 3));
        const double var_x158 = 1.0 + var_x157;
        const double var_x159 = exp(0.057000000000000002 * var_chaste_interface__membrane__V - 0.057000000000000002 * NV_Ith_S(mParameters, 3));
        const double var_x160 = var_x159 / var_x158;
        const double var_x161 = exp(24.640530000000002 + 0.311 * var_chaste_interface__membrane__V - 0.311 * NV_Ith_S(mParameters, 3));
        const double var_x162 = 1.0 + var_x161;
        const double var_x163 = 1 / var_x162;
        const double var_x164 = exp(0.24440000000000001 * var_chaste_interface__membrane__V - 0.24440000000000001 * NV_Ith_S(mParameters, 3));
        const double var_x165 = exp(0.043909999999999998 * NV_Ith_S(mParameters, 3) - 0.043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x183 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x194 = exp(2.8571428571428572 + var_x98);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = var_x186 / pow(var_x187, 2);
        ...
        const double var_x203 = exp(5.0 + var_x98);
        ...
        const double var_x210 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x207), 2);
        ...
        const double var_x249 = var_x246 * var_x247;
        const double var_x250 = var_x249 * var_x61;
        const double var_x251 = var_x249 * var_x63;
        ...
        const double var_x254 = 0.00011688549744401942 * var_x27;
        const double var_x255 = (0.0031224512033090025 * var_x13 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 4);
        const double var_x256 = 0.00025554140647880875 * var_x13 - 9.5659091108185493e-6 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 1, 0) = var_x82 * (-3.4598107243429746e-8 + 1.0129554625362472e-11 * var_x22 + 2.464726172537559e-14 * var_x30);
        IJth(rJacobian, 2, 0) = (1 / var_x89 - var_chaste_interface__hyperpolarization_activated_current_y_gate__y) * (2.7500000000000001e-5 * var_x90 - 1.0000000000000001e-5 * var_x91) - 0.14705882352941177 * var_x88 * (var_x92 + var_x93) / pow(var_x89, 2);
        IJth(rJacobian, 3, 0) = 3.2206119162640899e-5 * var_x101 * var_x102 * var_x97 + 0.14285714285714285 * var_x104 * var_x99 / pow(var_x100, 2) - 0.10000000000000001 * var_x101 * var_x103 * var_x96;
        IJth(rJacobian, 4, 0) = 0.01488095238095238 * var_x108 * var_x111 * var_x112 - 0.041666666666666664 * var_x109 * var_x114 / pow(var_x110, 2) - 0.050000000000000003 * var_x107 * var_x111 * var_x113;
        IJth(rJacobian, 5, 0) = 5.1020408163265302e-7 * (1 / var_x123 - var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs) * (93.333333333333329 * var_x117 * var_x118 / pow(var_x119, 2) - 116.66666666666667 * var_x115 * var_x120 / pow(var_x116, (3 / 2))) / pow((0.057142857142857141 + var_x121), 2) + 0.071428571428571425 * var_x122 * var_x124 / pow(var_x123, 2);
        IJth(rJacobian, 6, 0) = 0.22148394241417499 * var_x133 * var_x138 / pow(var_x134, 3) - 0.20000000000000001 * var_x132 * var_x135 * var_x136 + 99.999999999999986 * var_x135 * var_x137 * (0.02 * var_x126 / pow(var_x127, 2) + 0.00050000000000000001 * var_x129 / pow(var_x130, 2)) / pow((var_x128 + var_x131), 2);
        IJth(rJacobian, 7, 0) = (var_x149 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x140) ? (-0.008382352941176471 * var_x139) : (0)) + ((var_x140) ? (108035.0 * var_x141 + 0.21330000000000002 * var_x142) : (0.53361053361053368 * var_x143 / pow(var_x144, 2)))) - var_x152 * (var_x150 + var_x151);
        IJth(rJacobian, 8, 0) = (var_x149 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x140) ? (-0.00025500480000000003 * var_x156 + 0.0033402720000000005 * var_x153 * var_x155 / pow(var_x154, 2)) : (0.034200000000000001 * var_x160 + 0.059999999999999998 * var_x157 * var_x159 / pow(var_x158, 2))) + ((var_x140) ? (var_x167 + var_x163 * var_x168 * (3.0508668000000001e-7 * var_x165 - 6214.6032000000005 * var_x164) - 0.311 * var_x161 * var_x166 * var_x168 / pow(var_x162, 2)) : (0))) - var_x152 * (var_x169 + var_x170);
        IJth(rJacobian, 9, 0) = 0.51020408163265307 * (1 / var_x184 - var_chaste_interface__L_type_Ca_current_d_gate__d) * (-0.050000000000000003 * var_x171 / pow(var_x172, 2) + 0.27999999999999997 * var_x174 * var_x181 / pow(var_x175, 2) - 0.15076923076923074 * var_x176 * var_x179 / pow(var_x180, 2)) / pow((var_x182 + 0.7142857142857143 * var_x173), 2) + 0.13333333333333333 * var_x183 * var_x185 / pow(var_x184, 2);
        IJth(rJacobian, 10, 0) = 8.2270247479188195e-7 * (1 / var_x195 - var_chaste_interface__L_type_Ca_current_f_gate__f) * (18.0 * var_x196 - var_x197 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x189 / pow(var_x190, 2)) / pow((0.018140589569160998 + var_x193 + 0.16326530612244897 * var_x188 + 0.18140589569160998 * var_x191), 2) - 0.14285714285714285 * var_x194 * var_x198 / pow(var_x195, 2);
        IJth(rJacobian, 11, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x204) * (8.0 * var_x196 - var_x205 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x199 / pow(var_x200, 2)) / pow((var_x202 + 0.055160142348754451 * var_x201 + 0.14234875444839859 * var_x188), 2) - 0.095714285714285724 * var_x203 * var_x206 / pow(var_x204, 2);
        IJth(rJacobian, 13, 0) = 0.00013840830449826991 * (1 / var_x216 - var_chaste_interface__transient_outward_current_s_gate__s) * (-var_x217 * (-0.15625 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x211 / pow(var_x212, 2)) / pow((0.49411764705882355 + var_x214 + 0.058823529411764705 * var_x213), 2) - 0.076923076923076927 * var_x215 * var_x218 / pow(var_x216, 2);
        IJth(rJacobian, 14, 0) = 0.076923076923076927 * var_x219 * var_x222 / pow(var_x220, 2) - 0.09569377990430622 * var_x221 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (1 / var_x220 - var_chaste_interface__transient_outward_current_r_gate__r) / pow((0.69856459330143539 + var_x221), 2);
        IJth(rJacobian, 16, 0) = var_x246 * (-var_x248 + 18.964139992238998 * var_x45 - 4.7410349980597495 * var_x46);
        IJth(rJacobian, 18, 0) = -3.389679425876563e-8 - 1.7024840244711204e-6 * var_chaste_interface__hyperpolarization_activated_current_y_gate__y - 3.0388663876087416e-11 * var_x22 - 7.3941785176126764e-14 * var_x30 - 0.00080594011556369446 * var_x35 - var_x254 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        IJth(rJacobian, 3, 3) = -var_x104;
        IJth(rJacobian, 19, 3) = var_x255 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 18, 7) = -var_x254 * var_x57;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-1.0 * var_x60);
        IJth(rJacobian, 8, 8) = -var_x169 - var_x170;
        ...
        IJth(rJacobian, 9, 9) = -var_x185;
        IJth(rJacobian, 16, 9) = -var_x250 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x62 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 10, 10) = -var_x198;
        IJth(rJacobian, 16, 10) = -var_x250 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        ...
        IJth(rJacobian, 16, 11) = -var_x251 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 12, 12) = -var_x209;
        IJth(rJacobian, 16, 12) = -var_x251 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x65 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 13, 13) = -var_x218;
        IJth(rJacobian, 19, 13) = var_x256 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x65 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 14, 14) = -var_x222;
        IJth(rJacobian, 19, 14) = var_x256 * var_chaste_interface__transient_outward_current_s_gate__s;
        ...
        IJth(rJacobian, 16, 15) = var_x246 * (var_x252 + 0.065303877103145572 * var_x237 - 0.43535918068763713 * var_x240);
        ...
        IJth(rJacobian, 12, 16) = -0.0030000000000000001 * var_x209 * var_x210 + 6.2500000000000001e-5 * var_x210 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x208) / pow((0.025000000000000001 + var_x208), 2);
        IJth(rJacobian, 15, 16) = var_x225 * (var_x233 + 0.032639999999999995 * var_x241 - 0.030599999999999995 * var_x242);
        IJth(rJacobian, 16, 16) = var_x246 * (-1.1399999999999999 - var_x252 + 0.61222384784198969 * var_x242 - 0.65303877103145569 * var_x241 - 63.325437108704392 * var_x66) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x235 * var_x252 - var_x248 * var_x43) / (pow(var_x244, 3) * pow(var_x245, 2));
        IJth(rJacobian, 17, 16) = var_x253 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 15, 17) = -0.015299999999999998 * var_x225 * var_x243;
        IJth(rJacobian, 16, 17) = 0.30611192392099484 * var_x243 * var_x246;
        IJth(rJacobian, 17, 17) = -0.0050000000000000001 + var_x253 * var_chaste_interface__calcium_dynamics__Ca_ss;
    ...
    N_Vector Cellstewart_zhang_model_2008_ssFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 1) = var_L_type_Ca_current__i_CaL;
        NV_Ith_S(dqs, 2) = var_fast_sodium_current__i_Na;
        NV_Ith_S(dqs, 3) = var_rapid_time_dependent_potassium_current__i_Kr;
        NV_Ith_S(dqs, 4) = var_sodium_calcium_exchanger_current__i_NaCa;
        return dqs;
    }
