...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x109 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1.0 / var_x108;
        ...
        const double var_x119 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1.0 / var_x118;
        ...
        const double var_x144 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 / pow(var_x143, 2);
        ...
        const double var_x150 = 1.0 / pow(var_x149, 2);
        ...
        const double var_x157 = 1.0 * ((var_x152) ? (0.057000000000000002 * var_x151) : (0.0));
        const double var_x158 = 1.0 * ((var_x152) ? (310000.0 * var_x153 + 2.7000000000000002 * var_x154) : (5.9230769230769234 / var_x156));
        ...
        const double var_x176 = 1.0 * ((var_x152) ? (0.024240000000000001 * var_x163) : (0.59999999999999998 * var_x167));
        const double var_x177 = 1.0 * ((var_x152) ? (var_x174 * var_x175) : (0.0));
        ...
        const double var_x190 = 1 / (1.0 * var_x180 + 1.3999999999999999 * var_x187);
        ...
        IJth(rJacobian, 6, 0) = (var_x150 - var_chaste_interface__fast_sodium_current_h_gate__h) * (1.0 * ((var_x152) ? (-0.008382352941176471 * var_x151) : (0)) + 1.0 * ((var_x152) ? (108035.0 * var_x153 + 0.21330000000000002 * var_x154) : (0.53361053361053368 * var_x155 / pow(var_x156, 2)))) - var_x159 * (var_x157 + var_x158);
        IJth(rJacobian, 7, 0) = (var_x150 - var_chaste_interface__fast_sodium_current_j_gate__j) * (1.0 * ((var_x152) ? (-0.00025500480000000003 * var_x163 + 0.0033402720000000005 * var_x160 * var_x162 / pow(var_x161, 2)) : (0.034200000000000001 * var_x167 + 0.059999999999999998 * var_x164 * var_x166 / pow(var_x165, 2))) + 1.0 * ((var_x152) ? (var_x174 + var_x173 * var_x175 * (3.0508668000000001e-7 * var_x169 - 6214.6032000000005 * var_x168) - 0.311 * var_x170 * var_x171 * var_x175 / pow(var_x172, 2)) : (0))) - var_x159 * (var_x176 + var_x177);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x189) * (-0.050000000000000003 * var_x178 / pow(var_x179, 2) + 0.27999999999999997 * var_x181 * var_x186 / pow(var_x182, 2) - 0.15076923076923074 * var_x183 * var_x184 / pow(var_x185, 2)) / pow((var_x187 + 0.7142857142857143 * var_x180), 2) + 0.13333333333333333 * var_x188 * var_x190 / pow(var_x189, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x200) * (18.0 * var_x201 - var_x202 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x194 / pow(var_x195, 2)) / pow((0.018140589569160998 + var_x198 + 0.16326530612244897 * var_x193 + 0.18140589569160998 * var_x196), 2) - 0.14285714285714285 * var_x199 * var_x203 / pow(var_x200, 2);
        ...
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x221) * (-var_x222 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x216 / pow(var_x217, 2)) / pow((0.035294117647058823 + var_x219 + 0.058823529411764705 * var_x218), 2) - 0.20000000000000001 * var_x220 * var_x223 / pow(var_x221, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x224 * var_x227 / pow(var_x225, 2) - 0.10526315789473684 * var_x226 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x225) / pow((0.084210526315789472 + var_x226), 2);
