...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x47 = exp(-1.1230167246823641 + 0.074867781645490947 * var_chaste_interface__membrane__V);
        const double var_x48 = -1.0 + var_x47;
        const double var_x49 = 1 / var_x48;
        const double var_x50 = var_x49 * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x51 = var_x47 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x52 = -2.0 + 0.25 * var_x51;
        const double var_x53 = 0.57500202096124498 * var_x52;
        const double var_x54 = -15.0 + var_chaste_interface__membrane__V;
        const double var_x55 = var_x47 * var_x54;
        const double var_x56 = var_x52 * var_x55 * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass * var_chaste_interface__L_type_Ca_current_f_gate__f / pow(var_x48, 2);
        const double var_x57 = var_x50 * var_x51 * var_x54;
        const double var_x58 = 0.00050000000000000001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x59 = 1 / var_x58;
        const double var_x60 = 1 / var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x61 = var_chaste_interface__calcium_dynamics__Ca_i / pow(var_x58, 2);
        const double var_x62 = var_x5 * var_x7;
        const double var_x63 = 4.0872053809334341 * var_x13 - 0.153 * var_chaste_interface__membrane__V;
        const double var_x64 = 0.029999999999999999 * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i;
        const double var_x65 = (-26.713760659695652 * log(9.5999999999999996 / var_x64) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        const double var_x66 = 1 / var_chaste_interface__sodium_dynamics__Na_i;
        const double var_x67 = -26.713760659695652 * log(140.0 * var_x66) + var_chaste_interface__membrane__V;
        const double var_x68 = var_x67 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x70 = var_x28 * var_x68;
        const double var_x71 = var_x49 * var_x54 * var_chaste_interface__L_type_Ca_current_f2_gate__f2 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        const double var_x72 = var_x53 * var_x71;
        const double var_x73 = var_x49 * var_x54 * var_chaste_interface__L_type_Ca_current_d_gate__d * var_chaste_interface__L_type_Ca_current_f_gate__f;
        const double var_x74 = var_x53 * var_x73;
        const double var_x75 = 7.8538456339505203 * var_x13 - 0.29399999999999998 * var_chaste_interface__membrane__V;
        const double var_x76 = var_x50 * var_x55;
        ...
        const double var_x81 = var_x0 * (0.0031249999999999997 * var_chaste_interface__sodium_dynamics__Na_i + 0.10416666666666667 * var_chaste_interface__potassium_dynamics__K_i) / pow(var_x64, 2);
        const double var_x82 = var_x29 * var_x66 * var_chaste_interface__fast_sodium_current_h_gate__h;
        ...
        const double var_x90 = 0.001 + var_chaste_interface__calcium_dynamics__Ca_i;
        const double var_x91 = 1.0 + 0.00020000000000000001 / pow(var_x90, 2);
        const double var_x92 = 1 / var_x91;
        const double var_x93 = 1.0 * var_x92;
        const double var_x94 = 7.2352122917848019e-6 * var_x59;
        const double var_x95 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x96 = 1 / (pow(var_x95, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x97 = 1 / var_x95;
        const double var_x98 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x99 = -var_x98;
        const double var_x100 = exp(-4.5 + var_x99);
        const double var_x101 = 1.0 + var_x100;
        const double var_x102 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x103 = exp(-3.7142857142857144 - var_x102);
        const double var_x104 = 1.0 + var_x103;
        const double var_x105 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1 + 1.0 / var_x104;
        const double var_x106 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        const double var_x107 = 0.00037037037037037035 + 0.00037037037037037035 * var_x106;
        const double var_x108 = var_x101 * var_x107;
        const double var_x109 = 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x110 = -var_x109;
        const double var_x111 = exp(-3.0 + var_x110);
        const double var_x112 = 1.0 + var_x111;
        const double var_x113 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x114 = 1.0 + var_x113;
        const double var_x115 = -var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2 + 1.0 / var_x114;
        const double var_x116 = exp(-3.0 + var_x109);
        const double var_x117 = 0.29761904761904762 + 0.29761904761904762 * var_x116;
        const double var_x118 = var_x112 * var_x117;
        const double var_x119 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x120 = exp(0.83333333333333337 + var_x119);
        const double var_x121 = 1.0 + var_x120;
        const double var_x122 = 1 / sqrt(var_x121);
        const double var_x123 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = 1 / var_x124;
        const double var_x126 = var_x122 * var_x125;
        const double var_x127 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x128 = 1.0 + var_x127;
        const double var_x129 = 1 / (80.0 + 1400.0 * var_x126);
        const double var_x130 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x131 = exp(7.0 + var_x130);
        const double var_x132 = 1.0 + var_x131;
        const double var_x133 = 1 / var_x132;
        const double var_x134 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        const double var_x135 = 1.0 + var_x134;
        const double var_x136 = 1 / var_x135;
        const double var_x137 = 1 / (0.10000000000000001 * var_x133 + 0.10000000000000001 * var_x136);
        const double var_x138 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x139 = 1.0 + var_x138;
        const double var_x140 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 / pow(var_x139, 2);
        const double var_x141 = exp(-12.0 - var_x130);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = var_x137 * var_x142;
        const double var_x144 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = 1.0 / pow(var_x145, 2);
        const double var_x147 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x148 = var_chaste_interface__membrane__V < -40.0;
        const double var_x149 = exp(0.34849999999999998 * var_chaste_interface__membrane__V);
        const double var_x150 = exp(0.079000000000000001 * var_chaste_interface__membrane__V);
        const double var_x151 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x152 = 1.0 + var_x151;
        const double var_x153 = 1.0 * ((var_x148) ? (0.057000000000000002 * var_x147) : (0.0));
        const double var_x154 = 1.0 * ((var_x148) ? (310000.0 * var_x149 + 2.7000000000000002 * var_x150) : (5.9230769230769234 / var_x152));
        const double var_x155 = 0.26917900403768508 * var_x144 / pow(var_x145, 3);
        ...
        const double var_x158 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x159 = var_x158 / var_x157;
        const double var_x160 = exp(-3.2000000000000002 - var_x21);
        const double var_x161 = 1.0 + var_x160;
        const double var_x162 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
        const double var_x163 = var_x162 / var_x161;
        const double var_x164 = exp(0.24440000000000001 * var_chaste_interface__membrane__V);
        const double var_x165 = exp(-0.043909999999999998 * var_chaste_interface__membrane__V);
        ...
        const double var_x171 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x172 = 1.0 * ((var_x148) ? (0.024240000000000001 * var_x159) : (0.59999999999999998 * var_x163));
        const double var_x173 = 1.0 * ((var_x148) ? (var_x170 * var_x171) : (0.0));
        const double var_x174 = exp(2.5 + var_x110);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = 1 / var_x175;
        const double var_x177 = exp(1.0 + var_x130);
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = 1 / var_x178;
        const double var_x180 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        ...
        const double var_x186 = 1 / (1.0 * var_x176 + 1.3999999999999999 * var_x183);
        const double var_x187 = exp(3.0 + var_x98);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = 1 / var_x188;
        const double var_x190 = exp(1.3 + var_x99);
        ...
        const double var_x195 = exp(2.8571428571428572 + var_x102);
        ...
        const double var_x212 = exp(-4.0 + var_x130);
        ...
        const double var_x246 = 0.010081409587705739 * var_x52;
        const double var_x247 = var_x246 * var_x50;
        ...
        const double var_x253 = var_x252 * var_x71;
        const double var_x254 = var_x252 * var_x73;
        ...
        const double var_x257 = 0.00173434701107436 * var_x29;
        const double var_x258 = 6.3176611368492499e-5 * var_x40;
        const double var_x259 = 0.00047773503410627734 * var_x13 - 1.788348110893497e-5 * var_chaste_interface__membrane__V;
        const double var_x260 = 0.00091800065377284671 * var_x13 - 3.4364336248541711e-5 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.043049125751042493 * var_x56 + 0.03243 * var_x37 - 0.39200000000000002 * var_x0 - 0.29399999999999998 * var_x4 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 0.010762281437760623 * var_x57 - 8.6662202299424464e-5 * var_x11 - 0.54050000000000009 * var_x26 - 2.2983750000000001 * var_x46 - 0.153 * var_x27 - 2.1086672225679691e-7 * var_x34 - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x39 * var_x41 - var_x50 * var_x53);
        IJth(rJacobian, 1, 0) = var_x93 * (-3.4598107243429746e-8 + 2.464726172537559e-11 * var_x34 + 1.0129554625362472e-8 * var_x11);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x101 * var_x105 * var_x106 + 0.14285714285714285 * var_x103 * var_x108 / pow(var_x104, 2) - 0.10000000000000001 * var_x100 * var_x105 * var_x107;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x112 * var_x115 * var_x116 - 0.041666666666666664 * var_x113 * var_x118 / pow(var_x114, 2) - 0.050000000000000003 * var_x111 * var_x115 * var_x117;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (-var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs + 1.0 / var_x128) * (93.333333333333329 * var_x122 * var_x123 / pow(var_x124, 2) - 116.66666666666667 * var_x120 * var_x125 / pow(var_x121, (3 / 2))) / pow((0.057142857142857141 + var_x126), 2) + 0.071428571428571425 * var_x127 * var_x129 / pow(var_x128, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x138 * var_x143 / pow(var_x139, 3) - 0.20000000000000001 * var_x137 * var_x140 * var_x141 + 99.999999999999986 * var_x140 * var_x142 * (0.02 * var_x131 / pow(var_x132, 2) + 0.00050000000000000001 * var_x134 / pow(var_x135, 2)) / pow((var_x133 + var_x136), 2);
        IJth(rJacobian, 6, 0) = (var_x146 - var_chaste_interface__fast_sodium_current_h_gate__h) * (1.0 * ((var_x148) ? (-0.008382352941176471 * var_x147) : (0)) + 1.0 * ((var_x148) ? (108035.0 * var_x149 + 0.21330000000000002 * var_x150) : (0.53361053361053368 * var_x151 / pow(var_x152, 2)))) - var_x155 * (var_x153 + var_x154);
        IJth(rJacobian, 7, 0) = (var_x146 - var_chaste_interface__fast_sodium_current_j_gate__j) * (1.0 * ((var_x148) ? (-0.00025500480000000003 * var_x159 + 0.0033402720000000005 * var_x156 * var_x158 / pow(var_x157, 2)) : (0.034200000000000001 * var_x163 + 0.059999999999999998 * var_x160 * var_x162 / pow(var_x161, 2))) + 1.0 * ((var_x148) ? (var_x170 + var_x169 * var_x171 * (3.0508668000000001e-7 * var_x165 - 6214.6032000000005 * var_x164) - 0.311 * var_x166 * var_x167 * var_x171 / pow(var_x168, 2)) : (0))) - var_x155 * (var_x172 + var_x173);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x185) * (-0.050000000000000003 * var_x174 / pow(var_x175, 2) + 0.27999999999999997 * var_x177 * var_x182 / pow(var_x178, 2) - 0.15076923076923074 * var_x179 * var_x180 / pow(var_x181, 2)) / pow((var_x183 + 0.7142857142857143 * var_x176), 2) + 0.13333333333333333 * var_x184 * var_x186 / pow(var_x185, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x196) * (18.0 * var_x197 - var_x198 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x190 / pow(var_x191, 2)) / pow((0.018140589569160998 + var_x194 + 0.16326530612244897 * var_x189 + 0.18140589569160998 * var_x192), 2) - 0.14285714285714285 * var_x195 * var_x199 / pow(var_x196, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x205) * (8.0 * var_x197 - var_x206 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x200 / pow(var_x201, 2)) / pow((var_x203 + 0.055160142348754451 * var_x202 + 0.14234875444839859 * var_x189), 2) - 0.095714285714285724 * var_x204 * var_x207 / pow(var_x205, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x217) * (-var_x218 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x212 / pow(var_x213, 2)) / pow((0.035294117647058823 + var_x215 + 0.058823529411764705 * var_x214), 2) - 0.20000000000000001 * var_x216 * var_x219 / pow(var_x217, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x220 * var_x223 / pow(var_x221, 2) - 0.10526315789473684 * var_x222 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x221) / pow((0.084210526315789472 + var_x222), 2);
        IJth(rJacobian, 15, 0) = var_x251 * (-var_x247 + 0.00075477277169111218 * var_x56 - 0.00018869319292277804 * var_x57);
        IJth(rJacobian, 17, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x11 - 7.3941785176126768e-11 * var_x34 - 0.00080594011556369446 * var_x46 - var_x257 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x46 + 3.79059668210955e-6 * var_x37 - 3.4364336248541711e-5 * var_x4 - 1.788348110893497e-5 * var_x27 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 4.5819114998055616e-5 * var_x0 - 1.7065282626826835e-6 * var_x3 - var_x258 * var_x39;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.12379999999999999 * var_x61 + 594.50270777405183 * var_x62 - 0.12379999999999999 * var_x59 - 0.0079072731552699126 * var_x60);
        IJth(rJacobian, 1, 1) = var_x93 * (-0.0038240087783467445 - var_x94 + 7.2352122917848019e-6 * var_x61 - 0.069488744729986562 * var_x62 - 5.3144431236283834e-11 * var_x96 - 4.6212277808973232e-7 * var_x60) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x60) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x97 - var_x94 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x33 * var_x7) / (pow(var_x90, 3) * pow(var_x91, 2));
        IJth(rJacobian, 14, 1) = var_x227 * (0.00036000000000000002 + 7.96875e-10 * var_x96);
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x250;
        IJth(rJacobian, 17, 1) = 0.20846623418995969 * var_x62;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (var_x63 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2);
        IJth(rJacobian, 2, 2) = -var_x108;
        IJth(rJacobian, 18, 2) = var_x259 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (var_x63 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1);
        IJth(rJacobian, 3, 3) = -var_x118;
        IJth(rJacobian, 18, 3) = var_x259 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.78400000000000003 * var_x65);
        IJth(rJacobian, 4, 4) = -var_x129;
        IJth(rJacobian, 18, 4) = -9.1638229996111233e-5 * var_x65;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-44.513999999999996 * var_x69);
        IJth(rJacobian, 5, 5) = -1.0 * var_x143;
        IJth(rJacobian, 17, 5) = -0.0052030410332230799 * var_x69;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x30 * var_x67);
        IJth(rJacobian, 6, 6) = -var_x153 - var_x154;
        IJth(rJacobian, 17, 6) = -var_x257 * var_x67;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-14.837999999999999 * var_x70);
        IJth(rJacobian, 7, 7) = -var_x172 - var_x173;
        IJth(rJacobian, 17, 7) = -0.00173434701107436 * var_x70;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x72 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 8, 8) = -var_x186;
        IJth(rJacobian, 15, 8) = -var_x253 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x72 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 9, 9) = -var_x199;
        IJth(rJacobian, 15, 9) = -var_x253 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x207;
        IJth(rJacobian, 15, 10) = -var_x254 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x74 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x210;
        IJth(rJacobian, 15, 11) = -var_x254 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__transient_outward_current_r_gate__r);
        IJth(rJacobian, 12, 12) = -var_x219;
        IJth(rJacobian, 18, 12) = var_x260 * var_chaste_interface__transient_outward_current_r_gate__r;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_chaste_interface__transient_outward_current_s_gate__s);
        IJth(rJacobian, 13, 13) = -var_x223;
        IJth(rJacobian, 18, 13) = var_x260 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x92;
        IJth(rJacobian, 14, 14) = var_x227 * (-0.00036000000000000002 - var_x235 + 0.021759999999999998 * var_x242 - 0.0032639999999999995 * var_x239) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x97 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x235 * var_x237) / (pow(var_x224, 3) * pow((0.33333333333333337 + var_x225), 2));
        IJth(rJacobian, 15, 14) = var_x251 * (var_x255 + 0.065303877103145572 * var_x239 - 0.43535918068763713 * var_x242);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x240 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14375050524031124 * var_x76);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x92;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x210 * var_x211 + 6.2500000000000001e-5 * var_x211 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x209) / pow((0.025000000000000001 + var_x209), 2);
        IJth(rJacobian, 14, 15) = var_x227 * (var_x235 + 0.032639999999999995 * var_x243 - 0.030599999999999995 * var_x244);
        IJth(rJacobian, 15, 15) = var_x251 * (-1.1399999999999999 - var_x255 + 0.61222384784198969 * var_x244 - 0.65303877103145569 * var_x243 - 0.0025203523969264349 * var_x76) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x237 * var_x255 - var_x247 * var_x54) / (pow(var_x248, 3) * pow(var_x249, 2));
        IJth(rJacobian, 16, 15) = var_x256 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -0.015299999999999998 * var_x226 * var_x245;
        IJth(rJacobian, 15, 16) = 0.30611192392099484 * var_x245 * var_x250;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x256 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (0.001436484375 * var_x79 - 0.00051997321379654684 * var_x80 - 396.37878066856405 * var_x82 - 2.2983750000000001 * var_x78 - 3.0158767234370001 * var_x81 - 0.0077469905913117388 * var_x66);
        IJth(rJacobian, 1, 17) = 6.0777327752174836e-8 * var_x80 * var_x92;
        IJth(rJacobian, 17, 17) = 5.0371257222730904e-7 * var_x79 - 9.0551084895961074e-7 * var_x66 - 0.046330930954698972 * var_x82 - 1.823319832565245e-7 * var_x80 - 0.00080594011556369446 * var_x78;
        IJth(rJacobian, 18, 17) = 0.00053729341037579627 * var_x78 - 0.00035251225104877316 * var_x81 - 3.3580838148487267e-7 * var_x79;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819392997 * var_x89 - 100.52922411456667 * var_x81 - 14.4387876365655 * var_x84 - 4.0872053809334341 * var_x85 - 7.8538456339505203 * var_x86 - 0.3900209056315565 * var_x83 - var_x41 * var_x88);
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x89 - 0.00091800065377284671 * var_x86 - 0.0016876848753885161 * var_x84 - 0.00047773503410627734 * var_x85 - 4.5587787568311439e-5 * var_x83 - 0.011750408368292439 * var_x81 - var_x258 * var_x88;
    }
