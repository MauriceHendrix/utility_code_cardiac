...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2006_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x97 = 7.2352122917848019e-6 * var_x61;
        const double var_x98 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__calcium_dynamics__Ca_i, 2);
        const double var_x99 = 1 / (pow(var_x98, 2) * pow(var_chaste_interface__calcium_dynamics__Ca_i, 3));
        const double var_x100 = 1 / var_x98;
        const double var_x101 = 0.10000000000000001 * var_chaste_interface__membrane__V;
        const double var_x102 = -var_x101;
        const double var_x103 = exp(-4.5 + var_x102);
        const double var_x104 = 1.0 + var_x103;
        const double var_x105 = 0.14285714285714285 * var_chaste_interface__membrane__V;
        const double var_x106 = exp(-3.7142857142857144 - var_x105);
        const double var_x107 = 1.0 + var_x106;
        const double var_x108 = 1 / var_x107 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        const double var_x109 = exp(2.6086956521739131 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        const double var_x110 = 0.00037037037037037035 + 0.00037037037037037035 * var_x109;
        const double var_x111 = var_x104 * var_x110;
        const double var_x112 = 0.050000000000000003 * var_chaste_interface__membrane__V;
        const double var_x113 = -var_x112;
        const double var_x114 = exp(-3.0 + var_x113);
        const double var_x115 = 1.0 + var_x114;
        const double var_x116 = exp(3.6666666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        const double var_x117 = 1.0 + var_x116;
        const double var_x118 = 1 / var_x117 - var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        const double var_x119 = exp(-3.0 + var_x112);
        const double var_x120 = 0.29761904761904762 + 0.29761904761904762 * var_x119;
        const double var_x121 = var_x115 * var_x120;
        const double var_x122 = -0.16666666666666666 * var_chaste_interface__membrane__V;
        const double var_x123 = exp(0.83333333333333337 + var_x122);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = 1 / sqrt(var_x124);
        const double var_x126 = exp(-2.3333333333333335 + 0.066666666666666666 * var_chaste_interface__membrane__V);
        const double var_x127 = 1.0 + var_x126;
        const double var_x128 = 1 / var_x127;
        const double var_x129 = var_x125 * var_x128;
        const double var_x130 = exp(-0.35714285714285715 - 0.071428571428571425 * var_chaste_interface__membrane__V);
        const double var_x131 = 1.0 + var_x130;
        const double var_x132 = 1 / (80.0 + 1400.0 * var_x129);
        const double var_x133 = 0.20000000000000001 * var_chaste_interface__membrane__V;
        const double var_x134 = exp(7.0 + var_x133);
        const double var_x135 = 1.0 + var_x134;
        const double var_x136 = 1 / var_x135;
        const double var_x137 = exp(-0.25 + 0.0050000000000000001 * var_chaste_interface__membrane__V);
        const double var_x138 = 1.0 + var_x137;
        const double var_x139 = 1 / var_x138;
        const double var_x140 = 1 / (0.10000000000000001 * var_x136 + 0.10000000000000001 * var_x139);
        const double var_x141 = exp(-6.2967884828349945 - 0.11074197120708749 * var_chaste_interface__membrane__V);
        const double var_x142 = 1.0 + var_x141;
        const double var_x143 = pow(var_x142, (-2)) - var_chaste_interface__fast_sodium_current_m_gate__m;
        const double var_x144 = exp(-12.0 - var_x133);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = var_x140 * var_x145;
        const double var_x147 = exp(9.6298788694481825 + 0.13458950201884254 * var_chaste_interface__membrane__V);
        const double var_x148 = 1.0 + var_x147;
        const double var_x149 = pow(var_x148, (-2));
        const double var_x150 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__membrane__V);
        const double var_x151 = var_chaste_interface__membrane__V < -40.0;
        ...
        const double var_x154 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__membrane__V);
        const double var_x155 = 1.0 + var_x154;
        const double var_x156 = ((var_x151) ? (0.057000000000000002 * var_x150) : (0));
        const double var_x157 = ((var_x151) ? (310000.0 * var_x152 + 2.7000000000000002 * var_x153) : (5.9230769230769234 / var_x155));
        const double var_x158 = 0.26917900403768508 * var_x147 / pow(var_x148, 3);
        const double var_x159 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__membrane__V);
        const double var_x160 = 1.0 + var_x159;
        const double var_x161 = exp(-0.01052 * var_chaste_interface__membrane__V);
        const double var_x162 = var_x161 / var_x160;
        const double var_x163 = exp(-3.2000000000000002 - var_x20);
        const double var_x164 = 1.0 + var_x163;
        const double var_x165 = exp(0.057000000000000002 * var_chaste_interface__membrane__V);
        ...
        const double var_x174 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x175 = ((var_x151) ? (0.024240000000000001 * var_x162) : (0.59999999999999998 * var_x166));
        const double var_x176 = ((var_x151) ? (var_x173 * var_x174) : (0));
        const double var_x177 = exp(2.5 + var_x113);
        const double var_x178 = 1.0 + var_x177;
        const double var_x179 = 1 / var_x178;
        const double var_x180 = exp(1.0 + var_x133);
        const double var_x181 = 1.0 + var_x180;
        const double var_x182 = 1 / var_x181;
        const double var_x183 = exp(-2.6923076923076925 - 0.076923076923076927 * var_chaste_interface__membrane__V);
        ...
        const double var_x187 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x188 = 1.0 + var_x187;
        const double var_x189 = 1 / (var_x179 + 1.3999999999999999 * var_x186);
        const double var_x190 = exp(3.0 + var_x101);
        const double var_x191 = 1.0 + var_x190;
        const double var_x192 = 1 / var_x191;
        const double var_x193 = exp(1.3 + var_x102);
        ...
        const double var_x214 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x211), 2);
        const double var_x215 = exp(-4.0 + var_x133);
        const double var_x216 = 1.0 + var_x215;
        const double var_x217 = 1 / var_x216;
        const double var_x218 = exp(-6.328125 * pow((1 + 0.022222222222222223 * var_chaste_interface__membrane__V), 2));
        const double var_x219 = exp(4.0 + var_x133);
        const double var_x220 = 1.0 + var_x219;
        const double var_x221 = 85.0 * var_x218;
        const double var_x222 = 1 / (3.0 + var_x221 + 5.0 * var_x217);
        const double var_x223 = exp(3.3333333333333335 + var_x122);
        ...
        const double var_x230 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x231 = 1 / (1.0 + 2.25 * var_x230);
        const double var_x232 = 1 / (2.5 - 1.5 * var_x231);
        const double var_x233 = var_x211 * var_x232;
        const double var_x234 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x233);
        const double var_x235 = var_x234 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x236 = var_x233 * var_x235;
        const double var_x237 = 0.015299999999999998 * var_x236;
        const double var_x238 = 1 / (pow((0.44444444444444442 + var_x230), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x239 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x240 = var_x239 / pow((1 - 0.59999999999999998 * var_x231), 2);
        const double var_x241 = var_x211 * var_x235 * var_x238 * var_x240;
        const double var_x242 = var_x238 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x243 = var_x240 / pow((0.40000000000000002 + var_x233), 2);
        const double var_x244 = var_x232 * var_x242 * var_x243 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x245 = var_x243 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3) * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x246 = var_x232 * var_x235 * var_x239 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x247 = var_x233 * var_x234 * var_x239;
        ...
        const double var_x251 = 253.30174843481757 * var_x54;
        const double var_x252 = var_x251 * var_x52;
        const double var_x253 = var_x250 * var_x251;
        const double var_x254 = var_x253 * var_x74;
        const double var_x255 = var_x253 * var_x76;
        const double var_x256 = 0.30611192392099484 * var_x236;
        const double var_x257 = -0.11249999999999999 + 0.067500000000000004 * var_x231;
        const double var_x258 = 6.3176611368492499e-5 * var_x42;
        const double var_x259 = (0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2);
        const double var_x260 = 0.0031224512033090025 * var_x12 - 0.00011688549744401942 * var_chaste_interface__membrane__V;
        ...
        IJth(rJacobian, 1, 0) = var_x96 * (-3.4598107243429746e-8 + 2.464726172537559e-11 * var_x32 + 1.0129554625362472e-8 * var_x10);
        IJth(rJacobian, 2, 0) = 3.2206119162640899e-5 * var_x104 * var_x108 * var_x109 + 0.14285714285714285 * var_x106 * var_x111 / pow(var_x107, 2) - 0.10000000000000001 * var_x103 * var_x108 * var_x110;
        IJth(rJacobian, 3, 0) = 0.01488095238095238 * var_x115 * var_x118 * var_x119 - 0.041666666666666664 * var_x116 * var_x121 / pow(var_x117, 2) - 0.050000000000000003 * var_x114 * var_x118 * var_x120;
        IJth(rJacobian, 4, 0) = 5.1020408163265302e-7 * (1 / var_x131 - var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs) * (93.333333333333329 * var_x125 * var_x126 / pow(var_x127, 2) - 116.66666666666667 * var_x123 * var_x128 / pow(var_x124, (3 / 2))) / pow((0.057142857142857141 + var_x129), 2) + 0.071428571428571425 * var_x130 * var_x132 / pow(var_x131, 2);
        IJth(rJacobian, 5, 0) = 0.22148394241417499 * var_x141 * var_x146 / pow(var_x142, 3) - 0.20000000000000001 * var_x140 * var_x143 * var_x144 + 99.999999999999986 * var_x143 * var_x145 * (0.02 * var_x134 / pow(var_x135, 2) + 0.00050000000000000001 * var_x137 / pow(var_x138, 2)) / pow((var_x136 + var_x139), 2);
        IJth(rJacobian, 6, 0) = (var_x149 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x151) ? (-0.008382352941176471 * var_x150) : (0)) + ((var_x151) ? (108035.0 * var_x152 + 0.21330000000000002 * var_x153) : (0.53361053361053368 * var_x154 / pow(var_x155, 2)))) - var_x158 * (var_x156 + var_x157);
        IJth(rJacobian, 7, 0) = (var_x149 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x151) ? (-0.00025500480000000003 * var_x162 + 0.0033402720000000005 * var_x159 * var_x161 / pow(var_x160, 2)) : (0.034200000000000001 * var_x166 + 0.059999999999999998 * var_x163 * var_x165 / pow(var_x164, 2))) + ((var_x151) ? (var_x173 + var_x169 * var_x174 * (3.0508668000000001e-7 * var_x171 - 6214.6032000000005 * var_x170) - 0.311 * var_x167 * var_x172 * var_x174 / pow(var_x168, 2)) : (0))) - var_x158 * (var_x175 + var_x176);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (1 / var_x188 - var_chaste_interface__L_type_Ca_current_d_gate__d) * (-0.050000000000000003 * var_x177 / pow(var_x178, 2) + 0.27999999999999997 * var_x180 * var_x185 / pow(var_x181, 2) - 0.15076923076923074 * var_x182 * var_x183 / pow(var_x184, 2)) / pow((var_x186 + 0.7142857142857143 * var_x179), 2) + 0.13333333333333333 * var_x187 * var_x189 / pow(var_x188, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (1 / var_x199 - var_chaste_interface__L_type_Ca_current_f_gate__f) * (18.0 * var_x200 - var_x201 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x193 / pow(var_x194, 2)) / pow((0.018140589569160998 + var_x197 + 0.16326530612244897 * var_x192 + 0.18140589569160998 * var_x195), 2) - 0.14285714285714285 * var_x198 * var_x202 / pow(var_x199, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x208) * (8.0 * var_x200 - var_x209 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x203 / pow(var_x204, 2)) / pow((var_x206 + 0.055160142348754451 * var_x205 + 0.14234875444839859 * var_x192), 2) - 0.095714285714285724 * var_x207 * var_x210 / pow(var_x208, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (1 / var_x220 - var_chaste_interface__transient_outward_current_s_gate__s) * (-var_x221 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + 1.0 * var_x215 / pow(var_x216, 2)) / pow((0.035294117647058823 + var_x218 + 0.058823529411764705 * var_x217), 2) - 0.20000000000000001 * var_x219 * var_x222 / pow(var_x220, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x223 * var_x226 / pow(var_x224, 2) - 0.10526315789473684 * var_x225 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (1 / var_x224 - var_chaste_interface__transient_outward_current_r_gate__r) / pow((0.084210526315789472 + var_x225), 2);
        IJth(rJacobian, 15, 0) = var_x250 * (-var_x252 + 18.964139992238998 * var_x58 - 4.7410349980597495 * var_x59);
        ...
        IJth(rJacobian, 18, 0) = 0.00053729341037579627 * var_x48 + 3.79059668210955e-6 * var_x39 - 2.8537261917770623e-7 * var_x30 - 0.00011688549744401942 * var_x27 - 6.3176611368492499e-5 * var_x25 - 4.5819114998055616e-5 * var_x0 - 1.7065282626826835e-6 * var_x3 - 0.00011688549744401942 * var_x33 - var_x258 * var_x41;
        ...
        IJth(rJacobian, 1, 1) = var_x96 * (-0.0038240087783467445 - var_x97 + 7.2352122917848019e-6 * var_x63 - 0.069488744729986562 * var_x64 - 5.3144431236283834e-11 * var_x99 - 4.6212277808973232e-7 * var_x62) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__calcium_dynamics__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__calcium_dynamics__Ca_SR + 4.6212277808973232e-7 * log(2.0 * var_x62) - 0.0038240087783467445 * var_chaste_interface__calcium_dynamics__Ca_i - 3.4598107243429746e-8 * var_chaste_interface__membrane__V - 0.00042515544989027063 * var_x100 - var_x97 * var_chaste_interface__calcium_dynamics__Ca_i + 1.0129554625362472e-8 * var_x31 * var_x6) / (pow(var_x94, 3) * pow(var_x95, 2));
        IJth(rJacobian, 14, 1) = var_x229 * (0.00036000000000000002 + 7.96875e-10 * var_x99);
        ...
        IJth(rJacobian, 8, 8) = -var_x189;
        IJth(rJacobian, 15, 8) = -var_x254 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x75 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 9, 9) = -var_x202;
        IJth(rJacobian, 15, 9) = -var_x254 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x77 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass);
        IJth(rJacobian, 10, 10) = -var_x210;
        IJth(rJacobian, 15, 10) = -var_x255 * var_chaste_interface__L_type_Ca_current_fCass_gate__fCass;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x77 * var_chaste_interface__L_type_Ca_current_f2_gate__f2);
        IJth(rJacobian, 11, 11) = -var_x213;
        IJth(rJacobian, 15, 11) = -var_x255 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x26 * var_x78);
        IJth(rJacobian, 12, 12) = -var_x222;
        IJth(rJacobian, 18, 12) = var_x26 * var_x260;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x78 * var_x79);
        IJth(rJacobian, 13, 13) = -var_x226;
        IJth(rJacobian, 18, 13) = var_x260 * var_x79;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x96;
        IJth(rJacobian, 14, 14) = var_x229 * (-0.00036000000000000002 - var_x237 + 0.021759999999999998 * var_x244 - 0.0032639999999999995 * var_x241) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x100 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x237 * var_x239) / (pow(var_x227, 3) * pow((0.33333333333333337 + var_x228), 2));
        IJth(rJacobian, 15, 14) = var_x250 * (var_x256 + 0.065303877103145572 * var_x241 - 0.43535918068763713 * var_x244);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x242 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-3611.8217397063127 * var_x80);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x96;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x213 * var_x214 + 6.2500000000000001e-5 * var_x214 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x212) / pow((0.025000000000000001 + var_x212), 2);
        IJth(rJacobian, 14, 15) = var_x229 * (var_x237 + 0.032639999999999995 * var_x245 - 0.030599999999999995 * var_x246);
        IJth(rJacobian, 15, 15) = var_x250 * (-1.1399999999999999 - var_x256 + 0.61222384784198969 * var_x246 - 0.65303877103145569 * var_x245 - 63.325437108704392 * var_x80) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x239 * var_x256 - var_x252 * var_x56) / (pow(var_x248, 3) * pow(var_x249, 2));
        IJth(rJacobian, 16, 15) = var_x257 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -0.015299999999999998 * var_x229 * var_x247;
        IJth(rJacobian, 15, 16) = 0.30611192392099484 * var_x247 * var_x250;
        IJth(rJacobian, 16, 16) = -0.0050000000000000001 + var_x257 * var_chaste_interface__calcium_dynamics__Ca_ss;
        ...
        IJth(rJacobian, 18, 18) = 0.00010126109252331096 * var_x93 - 0.0031224512033090025 * var_x92 - 0.0016876848753885161 * var_x88 - 4.5587787568311439e-5 * var_x87 - 0.011750408368292439 * var_x85 - 0.0031224512033090025 * var_x89 - var_x258 * var_x91;
    }
