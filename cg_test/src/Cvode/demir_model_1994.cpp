...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x55 = var_x33 * var_x45 * pow(var_chaste_interface__sodium_current_m_gate__m, 2);
        ...
        const double var_x62 = (85.0 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        const double var_x63 = (-75.0 + var_chaste_interface__membrane__V) * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y;
        ...
        const double var_x73 = 225.90303244708574 * var_x43;
        const double var_x74 = 9.1036990845256476 * var_x5;
        ...
        const double var_x83 = 0.078351968220341614 * var_x82;
        const double var_x84 = var_x26 / pow(var_x24, 3);
        const double var_x85 = var_x25 * var_chaste_interface__cleft_space_equations__K_c;
        const double var_x86 = 0.0031274360147155781 - 6.7401638248180558e-5 * var_chaste_interface__membrane__V;
        ...
        const double var_x92 = 0.0036153091494396427 - 8.0340203320880944e-5 * var_chaste_interface__membrane__V;
        const double var_x93 = 2.3863048094674991e-7 * var_x13;
        const double var_x94 = 2.3863048094674993e-11 * var_x51;
        ...
        const double var_x100 = 0.0031868386878572373 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x101 = var_x97 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        const double var_x102 = var_x98 / pow(var_x96, 3);
        ...
        const double var_x110 = var_x104 * var_x106;
        const double var_x111 = 92.584269662921344 * var_x103 * var_x104 / pow(var_x105, 2);
        const double var_x112 = (var_x107 + var_x111 + 3703.370786516854 * var_x103) / pow((var_x103 - 0.025000000000000001 * var_x110), 2);
        ...
        const double var_x117 = 165.0 * var_x115 + 12360.0 * var_x116;
        const double var_x118 = 1 / var_x117;
        const double var_x119 = 13.095238095238095 * var_x115;
        const double var_x120 = var_x115 / pow((0.0031250000000000002 + var_x115), 2);
        const double var_x121 = 3.0654761904761907 * var_x120;
        const double var_x122 = -0.013095238095238096 * var_x115 * var_x118 + 1.0800578125490936e-9 * var_x115 * (var_x119 - var_x121) / pow((var_x116 + 0.013349514563106795 * var_x115), 2);
        const double var_x123 = 0.16500000000000001 * var_x115;
        const double var_x124 = var_x118 * var_x123;
        ...
        const double var_x128 = 11.43 * var_x127;
        ...
        const double var_x132 = 28.390000000000001 * var_x131;
        ...
        const double var_x136 = 84.900000000000006 * var_x135;
        const double var_x137 = 35.0 + var_chaste_interface__membrane__V;
        const double var_x138 = -5.0 + var_chaste_interface__membrane__V;
        const double var_x139 = exp(6.0 + 0.20000000000000001 * var_chaste_interface__membrane__V);
        ...
        const double var_x145 = 3.75 * var_x144;
        ...
        const double var_x150 = exp(-4.3833333333333337 + var_x0);
        ...
        const double var_x155 = exp(11.017857142857144 + 0.17857142857142858 * var_chaste_interface__membrane__V);
        ...
        const double var_x159 = exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V);
        ...
        const double var_x165 = exp(8.0222222222222221 + 0.1111111111111111 * var_chaste_interface__membrane__V);
        ...
        const double var_x171 = 0.079190817585730572 * var_x40;
        const double var_x172 = var_x171 * var_x56;
        ...
        const double var_x176 = 8.2399377586133985e-5 * var_x82;
        const double var_x177 = 0.0031913222489694526 * var_x60 - 0.00011946360864812104 * var_chaste_interface__membrane__V;
        const double var_x178 = 0.0031913222489694526 * var_x5;
        const double var_x179 = 5.493291839075599e-5 * var_x82;
        const double var_x180 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x181 = 0.27076272189238759 * var_x40;
        const double var_x182 = 8.1590568853116704e-7 * var_x13;
        const double var_x183 = 8.159056885311671e-11 * var_x51;
        const double var_x184 = var_x181 * var_x56;
        ...
        const double var_x188 = 0.00028173316601141397 * var_x82;
        const double var_x189 = -0.010693071667961351 + 0.00023045413077502912 * var_chaste_interface__membrane__V;
        const double var_x190 = 2.7196856284372236e-7 * var_x13;
        const double var_x191 = 2.7196856284372237e-11 * var_x51;
        const double var_x192 = -0.012361167312422308 + 0.00027469260694271792 * var_chaste_interface__membrane__V;
        const double var_x193 = 0.00040846013251011971 * var_chaste_interface__membrane__V - 0.010911506218902908 * var_x60;
        const double var_x194 = 0.010911506218902908 * var_x5;
        const double var_x195 = 0.00018782211067427598 * var_x82;
        const double var_x196 = 2.4589804690256458 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x197 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x198 = 0.019200000000000002 * var_x197 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        ...
        const double var_x201 = 0.95999999999999996 * var_x200 / pow(var_x199, 5);
        const double var_x202 = pow(var_x199, (-4));
        const double var_x203 = 0.95999999999999996 * var_x202 * pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 3);
        const double var_x204 = var_x201 - var_x203;
        ...
        const double var_x208 = var_x203 - var_x201;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0048327272727272733 + 8.4564294531513351 * var_x46 - 8.4564294531513351 * var_x44 - 0.036531818181818179 * var_x3 - 0.34078687761326099 * var_x5 - 0.0004352887123352312 * var_x29 - 0.35690727272727274 * var_x4 - 0.45836363636363636 * var_x6 - 0.38454545454545452 * var_x7 - 0.00022690909090909093 * var_x19 + var_x20 * var_x22 - var_x35 * var_x41);
        IJth(rJacobian, 1, 0) = -1.1600092823800342e-7 + 7.9543493648916641e-8 * var_x19 - 8.0340203320880944e-5 * var_x6 - 6.7401638248180558e-5 * var_x7 - 6.4031556335771533e-6 * var_x3 + var_x22 * var_x86;
        IJth(rJacobian, 2, 0) = var_x114 * (-var_x107 * var_x109 - var_x109 * var_x111 - 7.5849514563106801e-7 * var_x110 * var_x112) - 9.2050381751343198e-13 * var_x112 * (-var_chaste_interface__sodium_current_m_gate__m - var_x108 * var_x109) / pow(var_x113, 2);
        IJth(rJacobian, 3, 0) = var_x117 * var_x122 + (var_x121 - var_x119) * (var_x124 - 0.001 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 0) = var_x122 * (8.25 * var_x115 + 618.0 * var_x116) + (var_x124 - 0.001 * var_chaste_interface__sodium_current_h_gate__h2) * (0.15327380952380953 * var_x120 - 0.65476190476190477 * var_x115);
        IJth(rJacobian, 5, 0) = (0.001 * var_x3 - 0.001 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L) * (var_x128 - var_x132 - var_x136 - 11.356 * var_x129 * var_x137 / pow(var_x130, 2) - 17.659200000000002 * var_x133 * var_chaste_interface__membrane__V / pow(var_x134, 2) - 4.5720000000000001 * var_x125 * var_x138 / pow(var_x126, 2)) + 0.00016666666666666666 * var_x21 * (var_x128 * var_x138 - var_x132 * var_x137 - var_x136 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 6, 0) = (0.001 / var_x140 - 0.001 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L) * (var_x145 + 7.5 * var_x146 / pow(var_x147, 2) - 0.9375 * var_x142 * var_x148 / pow(var_x143, 2)) - 0.00020000000000000001 * var_x139 * (30.0 * var_x149 + var_x145 * var_x148) / pow(var_x140, 2);
        IJth(rJacobian, 7, 0) = (0.001 / var_x151 - 0.001 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T) * (35.600000000000001 * var_x153 - 35.600000000000001 * var_x154) + 0.00016666666666666666 * var_x150 * (1068.0 * var_x153 + 1068.0 * var_x154) / pow(var_x151, 2);
        IJth(rJacobian, 8, 0) = (0.001 / var_x156 - 0.001 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T) * (0.97529258777633288 * var_x157 - 0.18367346938775511 * var_x158) - 0.0001785714285714286 * var_x155 * (15.0 * var_x157 + 15.300000000000001 * var_x158) / pow(var_x156, 2);
        IJth(rJacobian, 9, 0) = (0.001 / var_x160 - 0.001 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a) * (0.67660000000000009 * var_x161 - 0.10760999999999998 * var_x162) + 0.00013513513513513514 * var_x159 * (17.0 * var_x161 + 2.1099999999999999 * var_x162) / pow(var_x160, 2);
        IJth(rJacobian, 10, 0) = -0.0183 * var_x163 * (0.10000000000000001 - 0.10000000000000001 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i) - 0.00617952 * var_x164 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 11, 0) = (0.001 / var_x166 - 0.001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (-0.067747636662556524 * var_x167 + 2.5473727272727271 * var_x168 / pow(var_x169, 2)) - 0.00011111111111111112 * var_x165 * (1.6483000000000001 * var_x167 + 14.01055 * var_x170) / pow(var_x166, 2);
        IJth(rJacobian, 12, 0) = -1.0197883801143159e-6 + 0.0029644204196681901 * var_x46 - 0.0029644204196681901 * var_x44 - 2.3863048094674991e-7 * var_x19 - 4.3008300195846133e-5 * var_x4 - 4.5777431992296659e-7 * var_x29 - var_x171 * var_x35;
        IJth(rJacobian, 13, 0) = -4.4233320987458456e-7 + 3.0518287994864439e-7 * var_x29 - 8.2106349321691435e-5 * var_x4 - 0.00011946360864812104 * var_x5;
        IJth(rJacobian, 18, 0) = 3.486776446714389e-6 + 0.010135702170189033 * var_x44 + 1.5651842556189666e-6 * var_x29 + 8.1590568853116704e-7 * var_x19 + 0.00014705043816962094 * var_x4 - 0.010135702170189033 * var_x46 + var_x181 * var_x35;
        IJth(rJacobian, 19, 0) = 3.9662082081376168e-7 + 0.00023045413077502912 * var_x7 + 0.00027469260694271792 * var_x6 + 2.1893142423627767e-5 * var_x3 - 2.7196856284372236e-7 * var_x19 + var_x189 * var_x22;
        IJth(rJacobian, 20, 0) = 1.5123892837623664e-6 + 0.00028073126790137144 * var_x4 + 0.00040846013251011971 * var_x5 - 1.0434561704126445e-6 * var_x29;
        IJth(rJacobian, 24, 0) = -var_x198;
        IJth(rJacobian, 25, 0) = var_x198;
        ...
        IJth(rJacobian, 18, 1) = -var_x182 * var_x54 - var_x183 * var_x8;
        IJth(rJacobian, 19, 1) = 0.00031261130080073693 * var_x48 + 5.2976168399354324e-6 * var_x49 - 0.00031261130080073693 * var_x50 + var_x190 * var_x54 + var_x191 * var_x8;
        IJth(rJacobian, 21, 1) = 0.021865102489586532 * var_x88 - 0.27331378111983168 * var_x89;
        IJth(rJacobian, 24, 1) = var_x204 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 25, 1) = var_x204 * var_chaste_interface__SR_Ca_uptake_and_release__F2 + var_x208 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 26, 1) = var_x208 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        ...
        IJth(rJacobian, 3, 3) = -var_x123 - 12.359999999999999 * var_x116;
        IJth(rJacobian, 12, 3) = -var_x172 * var_chaste_interface__sodium_current_h_gate__h2;
        IJth(rJacobian, 18, 3) = var_x184 * var_chaste_interface__sodium_current_h_gate__h2;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x57 * var_chaste_interface__sodium_current_h_gate__h1);
        IJth(rJacobian, 4, 4) = -0.0082500000000000004 * var_x115 - 0.61799999999999999 * var_x116;
        IJth(rJacobian, 12, 4) = -var_x172 * var_chaste_interface__sodium_current_h_gate__h1;
        IJth(rJacobian, 18, 4) = var_x184 * var_chaste_interface__sodium_current_h_gate__h1;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x20 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L);
        IJth(rJacobian, 1, 5) = var_x86 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        IJth(rJacobian, 5, 5) = 0.028390000000000002 * var_x131 * var_x137 + 0.084900000000000003 * var_x135 * var_chaste_interface__membrane__V - 0.011429999999999999 * var_x127 * var_x138;
        IJth(rJacobian, 19, 5) = var_x189 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x20 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L);
        IJth(rJacobian, 1, 6) = var_x86 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        IJth(rJacobian, 6, 6) = -0.029999999999999999 * var_x149 - 0.0037499999999999999 * var_x144 * var_x148;
        IJth(rJacobian, 19, 6) = var_x189 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T);
        IJth(rJacobian, 1, 7) = var_x92 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        IJth(rJacobian, 7, 7) = -1.0680000000000001 * var_x153 - 1.0680000000000001 * var_x154;
        IJth(rJacobian, 19, 7) = var_x192 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x58 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T);
        IJth(rJacobian, 1, 8) = var_x92 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        IJth(rJacobian, 8, 8) = -0.014999999999999999 * var_x157 - 0.015300000000000001 * var_x158;
        IJth(rJacobian, 19, 8) = var_x192 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        ...
        IJth(rJacobian, 9, 9) = -0.017000000000000001 * var_x161 - 0.0021099999999999999 * var_x162;
        IJth(rJacobian, 13, 9) = var_x177 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 20, 9) = var_x193 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        ...
        IJth(rJacobian, 10, 10) = -0.10000000000000001 * var_x163 - 0.65600000000000003 * var_x164;
        IJth(rJacobian, 13, 10) = var_x177 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 20, 10) = var_x193 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-0.46844000000000002 * var_x62 - 0.24537454545454546 * var_x63);
        IJth(rJacobian, 11, 11) = -0.0016483000000000001 * var_x167 - 0.01401055 * var_x170;
        IJth(rJacobian, 12, 11) = -8.6016600391692266e-5 * var_x63;
        IJth(rJacobian, 13, 11) = -0.00016421269864338287 * var_x62;
        IJth(rJacobian, 18, 11) = 0.00029410087633924189 * var_x63;
        IJth(rJacobian, 20, 11) = 0.00056146253580274287 * var_x62;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (0.021525265994599346 * var_x71 - 0.11752795233051241 * var_x72 - 0.077712758282750982 * var_x36 + var_x65 * var_x66 - var_x37 * var_x73 - var_x67 * var_x68);
        IJth(rJacobian, 1, 12) = var_x68 * var_x93 - var_x65 * var_x94;
        IJth(rJacobian, 12, 12) = 2.2637191644542304e-5 * var_x71 - 0.00012359906637920097 * var_x72 - 2.7242382709912566e-5 * var_x36 + var_x173 * var_x65 - var_x174 * var_x68 - var_x175 * var_x37;
        IJth(rJacobian, 13, 12) = 8.2399377586133985e-5 * var_x72 - 1.5091461096361535e-5 * var_x71;
        IJth(rJacobian, 18, 12) = 0.00042259974901712096 * var_x72 + 9.3144911471392233e-5 * var_x36 - 7.739922143170714e-5 * var_x71 + var_x185 * var_x68 + var_x187 * var_x37 - var_x186 * var_x65;
        IJth(rJacobian, 19, 12) = var_x183 * var_x65 - var_x182 * var_x68;
        IJth(rJacobian, 20, 12) = 5.1599480954471424e-5 * var_x71 - 0.00028173316601141397 * var_x72;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-0.03370790890514324 * var_x59 - var_x59 * var_x74);
        IJth(rJacobian, 13, 13) = -1.1816383500424576e-5 * var_x59 - var_x178 * var_x59;
        IJth(rJacobian, 20, 13) = 4.040160535071638e-5 * var_x59 + var_x194 * var_x59;
        ...
        IJth(rJacobian, 14, 14) = -0.307 + var_x180;
        ...
        IJth(rJacobian, 1, 16) = 0.00026350000000000001 + var_x95;
        IJth(rJacobian, 16, 16) = -0.0042500000000000003 + var_x180;
        IJth(rJacobian, 17, 16) = -3.2250000000000001;
        IJth(rJacobian, 1, 17) = var_x95;
        IJth(rJacobian, 16, 17) = var_x180;
        IJth(rJacobian, 17, 17) = -3.6539999999999999;
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (var_x73 + 0.077712758282750982 * var_x75 - 225.90303244708574 * var_x78 + var_x66 * var_x76 + var_x67 * var_x77);
        IJth(rJacobian, 1, 18) = -var_x76 * var_x94 - var_x77 * var_x93;
        IJth(rJacobian, 12, 18) = var_x175 + 2.7242382709912566e-5 * var_x75 - 0.079190817585730572 * var_x78 + var_x173 * var_x76 + var_x174 * var_x77;
        IJth(rJacobian, 18, 18) = -0.10000000000000001 - var_x187 + 0.27076272189238759 * var_x78 - 9.3144911471392233e-5 * var_x75 - var_x185 * var_x77 - var_x186 * var_x76;
        IJth(rJacobian, 19, 18) = var_x182 * var_x77 + var_x183 * var_x76;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (0.008839826254662923 * var_x79 + var_x10 * var_x52 - var_x53 * var_x80);
        IJth(rJacobian, 1, 19) = 1.5494105166262771e-6 * var_x79 + var_x80 * var_x90 - var_x10 * var_x91;
        IJth(rJacobian, 12, 19) = var_x10 * var_x94 - var_x80 * var_x93;
        IJth(rJacobian, 18, 19) = var_x182 * var_x80 - var_x10 * var_x183;
        IJth(rJacobian, 19, 19) = -0.10000000000000001 - 5.2976168399354324e-6 * var_x79 + var_x10 * var_x191 - var_x190 * var_x80;
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (0.03370790890514324 * var_x81 + var_x74 * var_x81 + var_x83 * var_x84 - var_x83 * var_x85);
        IJth(rJacobian, 12, 20) = var_x176 * var_x84 - var_x176 * var_x85;
        IJth(rJacobian, 13, 20) = 1.1816383500424576e-5 * var_x81 + var_x178 * var_x81 + var_x179 * var_x85 - var_x179 * var_x84;
        IJth(rJacobian, 18, 20) = var_x188 * var_x85 - var_x188 * var_x84;
        IJth(rJacobian, 20, 20) = -0.10000000000000001 - 4.040160535071638e-5 * var_x81 + var_x195 * var_x84 - var_x194 * var_x81 - var_x195 * var_x85;
        IJth(rJacobian, 1, 21) = 4.6933442493897489e-10 * var_x88 + 6.5185336797079855e-9 * var_x89;
        IJth(rJacobian, 21, 21) = -0.015581177937052042 - 4.0251665946738841e-8 * var_x88 - 5.5905091592692838e-7 * var_x89;
        IJth(rJacobian, 22, 21) = 0.14018251137810708;
        IJth(rJacobian, 1, 22) = 0.0015934193439286187 * var_x99;
        IJth(rJacobian, 21, 22) = 0.015581177937052042;
        IJth(rJacobian, 22, 22) = -8.979782511378108 + 8.8396000000000008 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_Calse - 1.2294902345128229 * var_x99;
        ...
        IJth(rJacobian, 24, 24) = var_x207 - var_x205;
        IJth(rJacobian, 25, 24) = var_x205 + var_x206;
        IJth(rJacobian, 1, 25) = var_x100 * var_x101 - var_x100 * var_x102;
        IJth(rJacobian, 22, 25) = var_x102 * var_x196 - var_x101 * var_x196;
        IJth(rJacobian, 25, 25) = -0.040000000000000001 + var_x207;
        IJth(rJacobian, 26, 25) = 0.040000000000000001 + var_x206;
