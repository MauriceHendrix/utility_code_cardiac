...
#include "MathsCustomFunctions.hpp"
    ...
    void Celldemir_model_1994FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x99 = 7.9543493648916641e-8 * var_x12;
        const double var_x100 = 7.9543493648916655e-12 * var_x56;
        ...
        const double var_x109 = 0.0031868386878572373 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        ...
        const double var_x122 = 1.5e-5 + 1.0 * var_x118;
        ...
        const double var_x168 = exp(-0.68918918918918914 - 0.13513513513513511 * var_chaste_interface__membrane__V);
        const double var_x169 = 1.0 + var_x168;
        const double var_x170 = exp(0.039800000000000002 * var_chaste_interface__membrane__V);
        const double var_x171 = exp(-0.050999999999999997 * var_chaste_interface__membrane__V);
        ...
        const double var_x181 = var_x46 * var_x59;
        const double var_x182 = var_x180 * var_x60;
        const double var_x183 = 7.158914428402498e-11 * var_x56;
        const double var_x184 = 7.1589144284024978e-7 * var_x12;
        const double var_x185 = 0.079190817585730572 * var_x43;
        const double var_x186 = var_x27 * var_x42;
        const double var_x187 = 8.2399377586133985e-5 * var_x91;
        const double var_x188 = 0.0031913222489694526 * var_x69 - 0.00011946360864812104 * var_chaste_interface__membrane__V;
        const double var_x189 = 0.0031913222489694526 * var_x19;
        const double var_x190 = 5.493291839075599e-5 * var_x91;
        const double var_x191 = -129.0 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x192 = 0.27076272189238759 * var_x28;
        const double var_x193 = 8.1590568853116704e-7 * var_x12;
        const double var_x194 = 8.159056885311671e-11 * var_x56;
        const double var_x195 = var_x192 * var_x60;
        const double var_x196 = 2.447717065593501e-6 * var_x12;
        const double var_x197 = 2.4477170655935014e-10 * var_x56;
        const double var_x198 = 0.27076272189238759 * var_x43;
        const double var_x199 = 0.00028173316601141397 * var_x91;
        const double var_x200 = -0.010693071667961351 + 0.00023045413077502912 * var_chaste_interface__membrane__V;
        const double var_x201 = 2.7196856284372236e-7 * var_x12;
        const double var_x202 = 2.7196856284372237e-11 * var_x56;
        const double var_x203 = -0.012361167312422308 + 0.00027469260694271792 * var_chaste_interface__membrane__V;
        const double var_x204 = 0.00040846013251011971 * var_chaste_interface__membrane__V - 0.010911506218902908 * var_x69;
        const double var_x205 = 0.010911506218902908 * var_x19;
        const double var_x206 = 0.00018782211067427598 * var_x91;
        const double var_x207 = 2.4589804690256458 * var_chaste_interface__SR_Ca_uptake_and_release__Ca_rel;
        const double var_x208 = exp(-3.2000000000000002 + 0.080000000000000002 * var_chaste_interface__membrane__V);
        const double var_x209 = 0.019200000000000002 * var_x208 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        const double var_x210 = 0.0040000000000000001 + var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i;
        const double var_x211 = pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 4);
        const double var_x212 = 0.95999999999999996 * var_x211 / pow(var_x210, 5);
        const double var_x213 = pow(var_x210, (-4));
        const double var_x214 = 0.95999999999999996 * var_x213 * pow(var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_i, 3);
        const double var_x215 = var_x212 - var_x214;
        const double var_x216 = 0.23999999999999999 * var_x208;
        const double var_x217 = 0.23999999999999999 * var_x211 * var_x213;
        const double var_x218 = -var_x217;
        const double var_x219 = var_x214 - var_x212;
        ...
        IJth(rJacobian, 1, 0) = -1.1600092823800342e-7 + 7.9543493648916641e-8 * var_x18 - 8.0340203320880944e-5 * var_x6 - 6.7401638248180558e-5 * var_x5 - 6.4031556335771533e-6 * var_x4 + var_x22 * var_x95;
        ...
        IJth(rJacobian, 8, 0) = (-var_x65 + 0.001 / var_x165) * (0.97529258777633288 * var_x166 - 0.18367346938775511 * var_x167) - 0.0001785714285714286 * var_x164 * (15.0 * var_x166 + 15.300000000000001 * var_x167) / pow(var_x165, 2);
        IJth(rJacobian, 9, 0) = (-var_x71 + 0.001 / var_x169) * (0.67660000000000009 * var_x170 - 0.10760999999999998 * var_x171) + 0.00013513513513513514 * var_x168 * (17.0 * var_x170 + 2.1099999999999999 * var_x171) / pow(var_x169, 2);
        ...
        IJth(rJacobian, 12, 0) = -1.0197883801143159e-6 + 0.0029644204196681901 * var_x47 - 0.0029644204196681901 * var_x44 - 2.3863048094674991e-7 * var_x18 - 4.3008300195846133e-5 * var_x0 - 4.5777431992296659e-7 * var_x41 - var_x180 * var_x33;
        IJth(rJacobian, 13, 0) = -4.4233320987458456e-7 + 3.0518287994864439e-7 * var_x41 - 8.2106349321691435e-5 * var_x0 - 0.00011946360864812104 * var_x19;
        IJth(rJacobian, 18, 0) = 3.486776446714389e-6 + 0.010135702170189033 * var_x44 + 1.5651842556189666e-6 * var_x41 + 8.1590568853116704e-7 * var_x18 + 0.00014705043816962094 * var_x0 - 0.010135702170189033 * var_x47 + var_x192 * var_x33;
        IJth(rJacobian, 19, 0) = 3.9662082081376168e-7 + 0.00023045413077502912 * var_x5 + 0.00027469260694271792 * var_x6 + 2.1893142423627767e-5 * var_x4 - 2.7196856284372236e-7 * var_x18 + var_x200 * var_x22;
        IJth(rJacobian, 20, 0) = 1.5123892837623664e-6 + 0.00028073126790137144 * var_x0 + 0.00040846013251011971 * var_x19 - 1.0434561704126445e-6 * var_x41;
        IJth(rJacobian, 24, 0) = -var_x209;
        IJth(rJacobian, 25, 0) = var_x209;
        ...
        IJth(rJacobian, 1, 1) = -21.173500000000001 + 0.0031868386878572373 * var_x98 + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Mg_Trop + 7.9980000000000002 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Mg_Mg_Trop + 11.609999999999999 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Calmod + 9.1430401954624137e-5 * var_x53 + 1.5655000000000001 * var_chaste_interface__intracellular_concentrations_and_buffer_equations__Ca_Trop - 0.00025494709502857897 * var_x97 - 1.5494105166262771e-6 * var_x52 - 9.1430401954624137e-5 * var_x51 - var_x100 * var_x7 - var_x55 * var_x99;
        IJth(rJacobian, 12, 1) = var_x102 * var_x55 + var_x103 * var_x7;
        ...
        IJth(rJacobian, 18, 1) = -var_x193 * var_x55 - var_x194 * var_x7;
        IJth(rJacobian, 19, 1) = 0.00031261130080073693 * var_x51 + 5.2976168399354324e-6 * var_x52 - 0.00031261130080073693 * var_x53 + var_x201 * var_x55 + var_x202 * var_x7;
        IJth(rJacobian, 21, 1) = 0.021865102489586532 * var_x97 - 0.27331378111983168 * var_x98;
        IJth(rJacobian, 24, 1) = var_x215 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 25, 1) = var_x215 * var_chaste_interface__SR_Ca_uptake_and_release__F2 + var_x219 * var_chaste_interface__SR_Ca_uptake_and_release__F1;
        IJth(rJacobian, 26, 1) = var_x219 * var_chaste_interface__SR_Ca_uptake_and_release__F2;
        ...
        IJth(rJacobian, 12, 2) = -0.23757245275719172 * var_x181;
        IJth(rJacobian, 18, 2) = 0.81228816567716278 * var_x181;
        ...
        IJth(rJacobian, 12, 3) = -var_x182 * var_chaste_interface__sodium_current_h_gate__h2;
        IJth(rJacobian, 18, 3) = var_x195 * var_chaste_interface__sodium_current_h_gate__h2;
        ...
        IJth(rJacobian, 4, 4) = -0.0082500000000000004 * var_x124 - 0.61799999999999999 * var_x125;
        IJth(rJacobian, 12, 4) = -var_x182 * var_chaste_interface__sodium_current_h_gate__h1;
        IJth(rJacobian, 18, 4) = var_x195 * var_chaste_interface__sodium_current_h_gate__h1;
        ...
        IJth(rJacobian, 19, 5) = var_x200 * var_chaste_interface__L_type_Ca_channel_f_gate__f_L;
        ...
        IJth(rJacobian, 19, 6) = var_x200 * var_chaste_interface__L_type_Ca_channel_d_gate__d_L;
        ...
        IJth(rJacobian, 19, 7) = var_x203 * var_chaste_interface__T_type_Ca_channel_f_gate__f_T;
        ...
        IJth(rJacobian, 8, 8) = -0.014999999999999999 * var_x166 - 0.015300000000000001 * var_x167;
        IJth(rJacobian, 19, 8) = var_x203 * var_chaste_interface__T_type_Ca_channel_d_gate__d_T;
        ...
        IJth(rJacobian, 9, 9) = -0.017000000000000001 * var_x170 - 0.0021099999999999999 * var_x171;
        IJth(rJacobian, 13, 9) = var_x188 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 20, 9) = var_x204 * var_chaste_interface__delayed_rectifying_potassium_current_P_i_gate__P_i;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x48 * var_x70 * var_x71);
        IJth(rJacobian, 10, 10) = -0.10000000000000001 * var_x172 - 0.65600000000000003 * var_x173;
        IJth(rJacobian, 13, 10) = var_x188 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        IJth(rJacobian, 20, 10) = var_x204 * var_chaste_interface__delayed_rectifying_potassium_current_P_a_gate__P_a;
        ...
        IJth(rJacobian, 12, 11) = -8.6016600391692266e-5 * var_x73;
        ...
        IJth(rJacobian, 12, 12) = 2.2637191644542304e-5 * var_x81 - 0.00012359906637920097 * var_x82 - 2.7242382709912566e-5 * var_x24 + var_x183 * var_x75 - var_x184 * var_x78 - var_x185 * var_x25;
        IJth(rJacobian, 13, 12) = 8.2399377586133985e-5 * var_x82 - 1.5091461096361535e-5 * var_x81;
        IJth(rJacobian, 18, 12) = 0.00042259974901712096 * var_x82 + 9.3144911471392233e-5 * var_x24 - 7.739922143170714e-5 * var_x81 + var_x196 * var_x78 + var_x198 * var_x25 - var_x197 * var_x75;
        IJth(rJacobian, 19, 12) = var_x194 * var_x75 - var_x193 * var_x78;
        ...
        IJth(rJacobian, 13, 13) = -1.1816383500424576e-5 * var_x68 - var_x189 * var_x68;
        IJth(rJacobian, 20, 13) = 4.040160535071638e-5 * var_x68 + var_x205 * var_x68;
        ...
        IJth(rJacobian, 14, 14) = -0.307 + var_x191;
        ...
        IJth(rJacobian, 16, 16) = -0.0042500000000000003 + var_x191;
        IJth(rJacobian, 17, 16) = -3.2250000000000001;
        IJth(rJacobian, 1, 17) = var_x104;
        IJth(rJacobian, 16, 17) = var_x191;
        ...
        IJth(rJacobian, 12, 18) = var_x185 + 2.7242382709912566e-5 * var_x85 - 0.079190817585730572 * var_x186 + var_x183 * var_x86 + var_x184 * var_x87;
        IJth(rJacobian, 18, 18) = -0.10000000000000001 - var_x198 + 0.27076272189238759 * var_x186 - 9.3144911471392233e-5 * var_x85 - var_x196 * var_x87 - var_x197 * var_x86;
        IJth(rJacobian, 19, 18) = var_x193 * var_x87 + var_x194 * var_x86;
        ...
        IJth(rJacobian, 1, 19) = 1.5494105166262771e-6 * var_x88 + var_x89 * var_x99 - var_x100 * var_x9;
        IJth(rJacobian, 12, 19) = var_x103 * var_x9 - var_x102 * var_x89;
        IJth(rJacobian, 18, 19) = var_x193 * var_x89 - var_x194 * var_x9;
        IJth(rJacobian, 19, 19) = -0.10000000000000001 - 5.2976168399354324e-6 * var_x88 + var_x202 * var_x9 - var_x201 * var_x89;
        ...
        IJth(rJacobian, 12, 20) = var_x187 * var_x93 - var_x187 * var_x94;
        IJth(rJacobian, 13, 20) = 1.1816383500424576e-5 * var_x90 + var_x189 * var_x90 + var_x190 * var_x94 - var_x190 * var_x93;
        IJth(rJacobian, 18, 20) = var_x199 * var_x94 - var_x199 * var_x93;
        IJth(rJacobian, 20, 20) = -0.10000000000000001 - 4.040160535071638e-5 * var_x90 + var_x206 * var_x93 - var_x205 * var_x90 - var_x206 * var_x94;
        ...
        IJth(rJacobian, 1, 22) = 0.0015934193439286187 * var_x108;
        ...
        IJth(rJacobian, 24, 24) = var_x218 - var_x216;
        IJth(rJacobian, 25, 24) = var_x216 + var_x217;
        IJth(rJacobian, 1, 25) = var_x109 * var_x110 - var_x109 * var_x111;
        IJth(rJacobian, 22, 25) = var_x111 * var_x207 - var_x110 * var_x207;
        IJth(rJacobian, 25, 25) = -0.040000000000000001 + var_x218;
        IJth(rJacobian, 26, 25) = 0.040000000000000001 + var_x217;
