...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x76 = 7.8538456339505203 * var_x13 - 0.29399999999999998 * var_chaste_interface__membrane__V;
        ...
        const double var_x227 = var_x226 * (-0.0082319999999999997 - var_x104);
        ...
        const double var_x233 = 0.00173434701107436 * var_x29;
        const double var_x234 = 6.3176611368492499e-5 * var_x40;
        const double var_x235 = 0.00029975531551766426 * var_x13 - 1.1221007754625865e-5 * var_chaste_interface__membrane__V;
        const double var_x236 = 0.00091800065377284671 * var_x13 - 3.4364336248541711e-5 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.18928635694553861 * var_x56 + 0.03243 * var_x37 - 0.245 * var_x0 - 0.29399999999999998 * var_x4 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 8.6662202299424464e-5 * var_x11 - 0.18928635694553861 * var_x59 - 0.54050000000000009 * var_x26 - 1.1491875 * var_x46 - 0.096000000000000002 * var_x27 - 2.1086672225679691e-7 * var_x34 - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x39 * var_x41 - var_x53 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        ...
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x220 * var_x223 / pow(var_x221, 2) - 0.10526315789473684 * var_x222 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x221) / pow((0.084210526315789472 + var_x222), 2);
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x11 - 7.3941785176126768e-11 * var_x34 - 0.00040297005778184723 * var_x46 - var_x233 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x46 + 3.79059668210955e-6 * var_x37 - 3.4364336248541711e-5 * var_x4 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 1.1221007754625865e-5 * var_x27 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - var_x234 * var_x39;
        ...
        IJth(rJacobian, 13, 1) = var_x226 * (8.0000000000000007e-5 + var_x97);
        ...
        IJth(rJacobian, 16, 2) = var_x235 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 16, 3) = var_x235 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 15, 6) = -var_x233 * var_x70;
        ...
        IJth(rJacobian, 16, 11) = var_x236 * var_chaste_interface__transient_outward_current_r_gate__r;
        ...
        IJth(rJacobian, 16, 12) = var_x236 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x94 * (8.0000000000000007e-5 + var_x111 * (var_x109 - var_x110));
        IJth(rJacobian, 13, 13) = var_x226 * (-8.0000000000000007e-5 + var_x111 * (var_x110 - var_x109)) + 9.9963436928702016 * (var_x100 + var_x99 - var_x107 - var_x98) / (pow(var_x224, 3) * pow((0.33333333333333337 + var_x225), 2));
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819392997 * var_x89 - 14.4387876365655 * var_x84 - 62.830765071604169 * var_x81 - 2.5645210233307822 * var_x85 - 7.8538456339505203 * var_x86 - 0.3900209056315565 * var_x83 - var_x41 * var_x88);
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 0.00091800065377284671 * var_x86 - 0.0073440052301827737 * var_x81 - 0.00029975531551766426 * var_x85 - 0.0016876848753885161 * var_x84 - 4.5587787568311439e-5 * var_x83 - var_x234 * var_x88;
    }
