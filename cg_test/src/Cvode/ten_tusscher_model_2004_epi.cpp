...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x167 = 1.0 * ((var_x162) ? (0.057000000000000002 * var_x161) : (0.0));
        const double var_x168 = 1.0 * ((var_x162) ? (310000.0 * var_x163 + 2.7000000000000002 * var_x164) : (5.9230769230769234 / var_x166));
        ...
        const double var_x186 = 1.0 * ((var_x162) ? (0.024240000000000001 * var_x173) : (0.59999999999999998 * var_x177));
        const double var_x187 = 1.0 * ((var_x162) ? (var_x184 * var_x185) : (0.0));
        ...
        const double var_x236 = (((var_x209) || (var_x232))) && (((var_x209) || (var_x233))) && (((var_x232) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x234)))) && (((var_x233) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x235))));
        ...
        IJth(rJacobian, 6, 0) = (var_x160 - var_chaste_interface__fast_sodium_current_h_gate__h) * (1.0 * ((var_x162) ? (-0.008382352941176471 * var_x161) : (0)) + 1.0 * ((var_x162) ? (108035.0 * var_x163 + 0.21330000000000002 * var_x164) : (0.53361053361053368 * var_x165 / pow(var_x166, 2)))) - var_x169 * (var_x167 + var_x168);
        IJth(rJacobian, 7, 0) = (var_x160 - var_chaste_interface__fast_sodium_current_j_gate__j) * (1.0 * ((var_x162) ? (-0.00025500480000000003 * var_x173 + 0.0033402720000000005 * var_x170 * var_x172 / pow(var_x171, 2)) : (0.034200000000000001 * var_x177 + 0.059999999999999998 * var_x174 * var_x176 / pow(var_x175, 2))) + 1.0 * ((var_x162) ? (var_x184 + var_x183 * var_x185 * (3.0508668000000001e-7 * var_x179 - 6214.6032000000005 * var_x178) - 0.311 * var_x180 * var_x181 * var_x185 / pow(var_x182, 2)) : (0))) - var_x169 * (var_x186 + var_x187);
        ...
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x206) * (-var_x207 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x201 / pow(var_x202, 2)) / pow((0.071111111111111111 + var_x204 + 0.14666666666666667 * var_x203), 2) - 0.14285714285714285 * var_x205 * var_x208 / pow(var_x206, 2);
        ...
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x224 * var_x227 / pow(var_x225, 2) - 0.10526315789473684 * var_x226 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x225) / pow((0.084210526315789472 + var_x226), 2);
