...
#include "MathsCustomFunctions.hpp"
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x59 = 1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        const double var_x120 = -0.125 * var_chaste_interface__membrane_potential__V;
        const double var_x121 = exp(-9.375 + var_x120 + 0.125 * NV_Ith_S(mParameters, 5));
        const double var_x122 = 0.02 * var_x121;
        const double var_x123 = exp(-7.5 + var_x115 + 0.10000000000000001 * NV_Ith_S(mParameters, 5));
        const double var_x124 = 1 / (1.0 + 320.0 * var_x123);
        const double var_x125 = 2.0 * var_x124;
        const double var_x126 = 2.5 * var_x121;
        const double var_x127 = 20.0 * var_x121;
        const double var_x128 = 0.01 * NV_Ith_S(mParameters, 4);
        const double var_x129 = 1.0 - var_x128;
        const double var_x130 = var_x129 / (var_x127 + 2000.0 * var_x124);
        const double var_x131 = var_x123 / pow((0.0031250000000000002 + var_x123), 2);
        ...
        const double var_x142 = exp(-1.25 + var_x120);
        ...
        const double var_x163 = 1.8342606503145281e-5 * var_x39;
        const double var_x164 = var_x163 * var_x37;
        const double var_x165 = 0.03668521300629056 * var_x32;
        const double var_x166 = var_x165 * var_x26;
        ...
        const double var_x172 = 3.4331756462166079e-6 * var_x52;
        const double var_x173 = 6.8663512924332162e-7 * var_x51;
        ...
        const double var_x176 = var_x163 * var_x65;
        const double var_x177 = var_x165 * var_x64;
        const double var_x178 = var_x167 * var_x65;
        const double var_x179 = var_x163 * var_x67;
        const double var_x180 = var_x165 * var_x66;
        ...
        const double var_x197 = 1.0 * var_x90;
        const double var_x198 = 2.3651237568009284e-7 * var_x41;
        const double var_x199 = 4.7302475136018567e-8 * var_x39;
        const double var_x200 = 8.4390573062405468e-5 * var_x2 - 3.1590674984870109e-6 * var_chaste_interface__membrane_potential__V;
        ...
        IJth(rJacobian, 3, 0) = (var_x122 + var_x125) * (-var_x126 * var_x130 + 5.0000000000000004e-6 * var_x121 * var_x129 * (var_x126 - 0.625 * var_x131) / pow((var_x124 + 0.01 * var_x121), 2)) + (0.00062500000000000001 * var_x131 - 0.0025000000000000001 * var_x121) * (var_x128 - var_chaste_interface__fast_sodium_current_h_gate__h + var_x127 * var_x130);
        IJth(rJacobian, 4, 0) = 7.7999999999999999e-5 * var_x135 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x + 4.1300000000000001e-5 * var_x136 * var_x140 - 5.2000000000000004e-5 * var_x132 * var_x134 * var_chaste_interface__time_dependent_rectifier_potassium_current_x_gate__x / pow(var_x133, 2) - 2.8500000000000002e-5 * var_x136 * var_x137 * var_x139 / pow(var_x138, 2);
        ...
        IJth(rJacobian, 16, 0) = -3.7908809981844127e-7 + 8.853578449436756e-9 * var_x52 - 0.00063181349969740222 * var_x15 - 1.2395009829211459e-6 * var_x48 - 0.0020622392630123211 * var_x24 - 0.0018954404990922066 * var_x13 - var_x198 * var_x37;
        IJth(rJacobian, 17, 0) = -3.7908809981844127e-7 + 1.7707156898873513e-9 * var_x51 + 0.0013748261753415473 * var_x24 + 1.3514992896005304e-5 * var_x20 - 6.7574964480026522e-7 * var_x19 - 3.1590674984870109e-6 * var_x6 - 7.0828627595494053e-9 * var_x48 - 0.00018051814277068634 * var_x5 - var_x199 * var_x37;
        ...
        IJth(rJacobian, 1, 1) = -5.8000000000000007 + var_x79 + var_x80 - var_x94 + 1.1520000000000001e-10 * var_x84 - 1.0548821632800683e-6 * var_x55 - 4.7302475136018565e-5 * var_x58 - 4.3595131479120748e-6 * var_x57 - 10138.888888888889 * var_x86 - 1733.6962431696716 * var_x56;
        ...
        IJth(rJacobian, 16, 1) = 5201.0887295090151 * var_x56 + 1.3078539443736226e-5 * var_x57;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0030000000000000001 * var_x53 * var_x61);
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x114) ? (2000.0) : (var_x113 * var_x118)) - 8.0 * var_x119;
        ...
        IJth(rJacobian, 4, 4) = -0.00050000000000000001 * var_x140 - 0.0013000000000000002 * var_x135;
        ...
        IJth(rJacobian, 1, 9) = -5069.4444444444443 * var_x95;
        ...
        IJth(rJacobian, 11, 11) = -0.0018000000000000002 + var_x187 + var_x188 + var_x189 + var_x190 - var_x186;
        ...
        IJth(rJacobian, 16, 16) = 4.3794501115171722e-6 * var_x71 - 0.011372642994553239 * var_x72 - 2.371037540761344 * var_x73 - 1.0126868767488654e-5 * var_x68 - 0.0020622392630123211 * var_x70 - 2.3651237568009284e-7 * var_x74;
        ...
        IJth(rJacobian, 17, 17) = 0.00036103628554137268 * var_x77 - 1.0126868767488654e-5 * var_x1 - 4.5129535692671587e-6 * var_x18 - 0.0048223184607088833 * var_x75 - 8.4390573062405468e-5 * var_x76 - 4.7302475136018567e-8 * var_x74;
