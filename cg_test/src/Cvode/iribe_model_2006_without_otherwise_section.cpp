...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::UseCellMLDefaultStimulus()
    {
        ...
        const double var_cell_parameters__Cm_converted = NV_Ith_S(mParameters, 1) / HeartConfig::Instance()->GetCapacitance(); // uA / uA_per_cm2
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const N_Vector rY, N_Vector rDY)
    {
        ...
        else
        {
            ...
            const double var_membrane_potential__i_Stim = 1000.0 * var_cell_parameters__Cm_converted * var_membrane_potential__i_Stim_converted; // nanoA
    ...
    void Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x59 = 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i + var_chaste_interface__intracellular_sodium_concentration__Na_i;
    ...
    N_Vector Celliribe_model_2006_without_otherwise_sectionFromCellMLCvode::ComputeDerivedQuantities(double var_chaste_interface__environment__time_converted, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 1) = var_L_type_Ca_channel__i_Ca_L;
        NV_Ith_S(dqs, 2) = var_cell_parameters__Cm_converted;
        NV_Ith_S(dqs, 3) = var_time_dependent_rectifier_potassium_current__i_K;
        NV_Ith_S(dqs, 4) = var_fast_sodium_current__i_Na;
        NV_Ith_S(dqs, 5) = var_sodium_calcium_exchanger__i_NaCa;
