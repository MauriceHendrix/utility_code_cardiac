...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x119 = 0.17614021922566689 * var_x118;
        const double var_x120 = 6.6024752054987431e-8 * var_x24;
        const double var_x121 = 1.9807425616496228e-11 * var_x71;
        const double var_x122 = 1.9807425616496229e-7 * var_x24;
        ...
        const double var_x126 = 0.35228043845133378 * var_x125;
        ...
        const double var_x140 = 1.0 / var_x138;
        ...
        const double var_x185 = 1.0307938958145768e-5 * var_x49;
        const double var_x186 = 0.00037425551606170871 * var_x41;
        ...
        const double var_x189 = 1.9807425616496229e-7 * var_x24;
        const double var_x190 = 1.7826683054846605e-10 * var_x71;
        const double var_x191 = 5.942227684948868e-7 * var_x24;
        const double var_x192 = var_x185 * var_chaste_interface__membrane__V;
        const double var_x193 = var_x192 * var_x53;
        const double var_x194 = 0.00024950367737447247 * var_x41;
        const double var_x195 = 0.00034849397687453321 * var_x11 - 1.3210516441925016e-5 * var_chaste_interface__membrane__V;
        const double var_x196 = 0.00012778112485399551 * var_x11 - 4.843856028705839e-6 * var_chaste_interface__membrane__V;
        const double var_x197 = 4.6465863583271093e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x198 = 2.3232931791635546e-5 * var_x9;
        const double var_x199 = 0.00012778112485399551 * var_x17;
        const double var_x200 = 0.00034849397687453321 * var_x18;
        const double var_x201 = 0.017834197196598772 - 0.00029723661994331287 * var_chaste_interface__membrane__V;
        const double var_x202 = var_x201 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x203 = -200.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x204 = 7.5793668809895348e-5 * var_x49;
        const double var_x205 = 0.0027518787945713876 * var_x41;
        const double var_x206 = 1.4564283541541343e-6 * var_x24;
        const double var_x207 = 4.3692850624624026e-10 * var_x71;
        const double var_x208 = 4.369285062462403e-6 * var_x24;
        const double var_x209 = 1.3107855187387207e-9 * var_x71;
        const double var_x210 = var_x204 * var_chaste_interface__membrane__V;
        const double var_x211 = var_x210 * var_x53;
        const double var_x212 = 1.4564283541541343e-10 * var_x71;
        const double var_x213 = 4.8547611805137808e-7 * var_x24;
        const double var_x214 = -0.0026226760583233483 + 4.3711267638722472e-5 * var_chaste_interface__membrane__V;
        const double var_x215 = var_x214 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x216 = 4.3692850624624026e-10 * var_x71;
        const double var_x217 = 0.0018345858630475916 * var_x41;
        const double var_x218 = 9.7136150308272163e-5 * var_chaste_interface__membrane__V - 0.0025624557123127439 * var_x11;
        const double var_x219 = 3.5616588446366462e-5 * var_chaste_interface__membrane__V - 0.00093956709451467277 * var_x11;
        const double var_x220 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x221 = 0.00093956709451467277 * var_x17;
        const double var_x222 = 0.0025624557123127439 * var_x18;
        const double var_x223 = 0.00017083038082084959 * var_x9;
        const double var_x224 = 23.501339000540224 * var_x118;
        const double var_x225 = 47.002678001080447 * var_x125;
        const double var_x226 = 0.00029999999999999997 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x227 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 4);
        const double var_x228 = var_x227 / pow(var_x226, 5);
        const double var_x229 = 0.81520000000000004 * var_x228;
        const double var_x230 = pow(var_x226, (-4));
        const double var_x231 = var_x230 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        const double var_x232 = 0.81520000000000004 * var_x231;
        const double var_x233 = 0.0030000000000000001 + var_chaste_interface__intracellular_ion_concentrations__Ca_d;
        const double var_x234 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_d, 4);
        const double var_x235 = 0.81520000000000004 * var_x234 / pow(var_x233, 5);
        const double var_x236 = pow(var_x233, (-4));
        const double var_x237 = 0.81520000000000004 * var_x236 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_d, 3);
        const double var_x238 = 0.20380000000000001 * var_x234 * var_x236;
        const double var_x239 = var_x227 * var_x230;
        const double var_x240 = 0.20380000000000001 * var_x239;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (0.13928000000000001 + 0.5 * var_x9 + 1.0 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 3.0 * var_x16 + 2.75 * var_x17 + 7.5 * var_x18 + 0.037484200000000002 * var_x29 - 0.0017706325 * var_x61 - 0.020833333333333332 * var_x32 - 0.17058350483361479 * var_x34 + var_x38 * var_x42 + var_x50 * var_x55 + var_x56 * var_x57 + (6.75 * var_x4 + 6.75 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L - var_x56 * var_x62));
        IJth(rJacobian, 1, 0) = -6.9294442944473474e-8 + 6.6024752054987431e-8 * var_x29;
        IJth(rJacobian, 2, 0) = 0.00012180267965895249 * var_x129 * var_x132 / pow(var_x130, 2) - 23.80952380952381 * var_x131 * (-0.061656057098765427 - 0.0024112654320987653 * var_chaste_interface__membrane__V) * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 / var_x130) / pow((0.57142857142857151 + var_x131), 2);
        ...
        IJth(rJacobian, 5, 0) = 0.00017241379310344829 * var_x143 * var_x146 / pow(var_x144, 2) - 0.37037037037037035 * var_x145 * (-0.077777777777777779 - 0.0022222222222222222 * var_chaste_interface__membrane__V) * (-var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + 1.0 / var_x144) / pow((0.7407407407407407 + var_x145), 2);
        ...
        IJth(rJacobian, 8, 0) = 9.0909090909090917e-5 * var_x156 * var_x159 / pow(var_x157, 2) + 0.00063492063492063492 * var_x158 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x157) * var_chaste_interface__membrane__V / pow((0.42857142857142855 + var_x158), 2);
        IJth(rJacobian, 9, 0) = -8.6956521739130441e-5 * var_x160 * var_x163 / pow(var_x161, 2) - 0.0020781379883624274 * var_x162 * (-0.46809272073427638 - 0.0089245513962683768 * var_chaste_interface__membrane__V) * (-var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 1.0 / var_x161) / pow((0.02938487115544472 + var_x162), 2);
        IJth(rJacobian, 10, 0) = 0.000125 * var_x164 * var_x169 / pow(var_x165, 2) + 0.0092592592592592605 * var_x166 * (-var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus + 1.0 / var_x165) / (pow(var_x167, 2) * pow((0.055555555555555559 + var_x168), 2));
        ...
        IJth(rJacobian, 12, 0) = 7.874015748031497e-5 * var_x177 * var_x180 / pow(var_x178, 2) - 0.00081632653061224504 * var_x179 * (0.10000000000000001 - var_x58) * (-var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 1.0 / var_x178) / pow((1 + 0.57142857142857151 * var_x179), 2);
        IJth(rJacobian, 13, 0) = 0.00016666666666666666 * var_x181 * var_x184 / pow(var_x182, 2) - 0.0046044755502348284 * var_x183 * (-0.081723584525982884 - 0.0040582584084490154 * var_chaste_interface__membrane__V) * (-var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a + 1.0 / var_x182) / pow((0.14356754765632193 + var_x183), 2);
        IJth(rJacobian, 14, 0) = -1.0673921144856187e-7 + 3.9074763446476996e-7 * var_x188 + 9.3563879015427174e-9 * var_x61 - 3.9074763446476996e-7 * var_x187 - 1.9807425616496229e-7 * var_x29 - var_x185 * var_x55 - var_x186 * var_x38;
        IJth(rJacobian, 15, 0) = 3.6695879005347264e-8 * var_x32 + 3.0046615937675515e-7 * var_x34 - 1.3210516441925016e-5 * var_x18 - 8.8070109612833433e-7 * var_x9 - 1.7614021922566687e-6 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 4.843856028705839e-6 * var_x17 - 5.2842065767700066e-6 * var_x16 - 6.2375919343618122e-9 * var_x61 + var_x194 * var_x38;
        ...
        IJth(rJacobian, 21, 0) = 7.848471430041313e-7 + 2.8731443710644848e-6 * var_x187 + 1.4564283541541343e-6 * var_x29 - 6.879696986428469e-8 * var_x61 - 2.8731443710644848e-6 * var_x188 + var_x204 * var_x55 + var_x205 * var_x38;
        IJth(rJacobian, 22, 0) = 5.0951796282701088e-7 - 4.8547611805137808e-7 * var_x29 + (4.3711267638722472e-5 * var_x4 + 4.3711267638722472e-5 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 23, 0) = 3.5616588446366462e-5 * var_x17 + 3.8854460123308864e-5 * var_x16 + 4.5864646576189789e-8 * var_x61 + 9.7136150308272163e-5 * var_x18 + 6.4757433538848112e-6 * var_x9 + 1.2951486707769622e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 2.6982263974520048e-7 * var_x32 - 2.2093099954173172e-6 * var_x34 - var_x217 * var_x38;
        ...
        IJth(rJacobian, 21, 1) = -var_x19 * var_x207 - var_x206 * var_x70;
        IJth(rJacobian, 22, 1) = 2.5902973415539245e-5 * var_x66 + 6.7205525966826332e-6 * var_x67 - 2.5902973415539245e-5 * var_x68 + var_x19 * var_x212 + var_x213 * var_x70;
        IJth(rJacobian, 24, 1) = var_x224;
        IJth(rJacobian, 25, 1) = 121.858794817616 * var_x113 - 1.0967291533585438e-5 * var_x114;
        IJth(rJacobian, 27, 1) = (var_x229 - var_x232) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 28, 1) = (var_x232 - var_x229) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (1.3584000000000001 * var_x228 - 1.3584000000000001 * var_x231) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        ...
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0052669090018819175 * var_x76);
        ...
        IJth(rJacobian, 16, 5) = var_x201 * var_x77;
        IJth(rJacobian, 22, 5) = var_x214 * var_x77;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x2 * var_x79);
        IJth(rJacobian, 6, 6) = -0.001 * var_x149;
        IJth(rJacobian, 16, 6) = var_x2 * var_x202;
        IJth(rJacobian, 22, 6) = var_x2 * var_x215;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x3 * var_x79);
        IJth(rJacobian, 7, 7) = -0.001 * var_x155;
        IJth(rJacobian, 16, 7) = var_x202 * var_x3;
        IJth(rJacobian, 22, 7) = var_x215 * var_x3;
        ...
        IJth(rJacobian, 15, 8) = var_x195 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        IJth(rJacobian, 23, 8) = var_x218 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        ...
        IJth(rJacobian, 15, 9) = var_x195 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 23, 9) = var_x218 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        ...
        IJth(rJacobian, 15, 10) = var_x196 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        IJth(rJacobian, 23, 10) = var_x219 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        ...
        IJth(rJacobian, 15, 11) = var_x196 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus;
        IJth(rJacobian, 23, 11) = var_x219 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (var_x30 + 1.0 * var_chaste_interface__membrane__V));
        ...
        IJth(rJacobian, 14, 14) = 4.2177556280432989e-7 * var_x89 - 0.00056138327409256303 * var_x88 - 2.8157848672826448e-6 * var_x51 + var_x190 * var_x84 - var_x191 * var_x85 - var_x193 * var_x52;
        IJth(rJacobian, 15, 14) = 0.00037425551606170871 * var_x88 - 2.8118370853621991e-7 * var_x89;
        IJth(rJacobian, 21, 14) = 0.0041278181918570815 * var_x88 + 2.0704300494725328e-5 * var_x51 - 3.1012909029730135e-6 * var_x89 + var_x208 * var_x85 + var_x211 * var_x52 - var_x209 * var_x84;
        IJth(rJacobian, 22, 14) = var_x216 * var_x84 - var_x206 * var_x85;
        IJth(rJacobian, 23, 14) = 2.067527268648676e-6 * var_x89 - 0.0027518787945713876 * var_x88;
        ...
        IJth(rJacobian, 15, 15) = 7.9263098651550091e-6 * var_x97 - 0.00013939759074981328 * var_x94 - var_x10 * var_x197 - var_x10 * var_x198 - var_x10 * var_x199 - var_x10 * var_x200;
        IJth(rJacobian, 23, 15) = 0.0010249822849250976 * var_x94 - 5.8281690184963299e-5 * var_x97 + var_x10 * var_x220 + var_x10 * var_x221 + var_x10 * var_x222 + var_x10 * var_x223;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x79 * var_x99);
        IJth(rJacobian, 1, 16) = 0.002;
        IJth(rJacobian, 16, 16) = -0.10000000000000001 + var_x202 * var_x99;
        IJth(rJacobian, 22, 16) = var_x215 * var_x99;
        IJth(rJacobian, 27, 16) = (var_x235 - var_x237) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 28, 16) = (var_x237 - var_x235) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 1, 17) = 0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 17, 17) = -0.47600000000000003 + var_x203;
        ...
        IJth(rJacobian, 1, 19) = 0.0010560000000000001 + var_x124;
        IJth(rJacobian, 19, 19) = -0.0066 + var_x203;
        IJth(rJacobian, 20, 19) = -5.0;
        IJth(rJacobian, 1, 20) = var_x124;
        IJth(rJacobian, 19, 20) = var_x203;
        ...
        IJth(rJacobian, 14, 21) = var_x193 + 2.8157848672826448e-6 * var_x100 + var_x101 * var_x190 + var_x102 * var_x191 - var_x192 * var_x54;
        IJth(rJacobian, 21, 21) = -6.993006993006993e-5 - var_x211 - 2.0704300494725328e-5 * var_x100 + var_x210 * var_x54 - var_x101 * var_x209 - var_x102 * var_x208;
        IJth(rJacobian, 22, 21) = var_x101 * var_x216 + var_x102 * var_x206;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x64 * (-1.0378040372231492 * var_x103 + var_x104 * var_x69 - var_x21 * var_x72));
        IJth(rJacobian, 1, 22) = 9.1399515314883825e-7 * var_x103 + var_x104 * var_x120 - var_x121 * var_x21;
        IJth(rJacobian, 14, 22) = var_x123 * var_x21 - var_x104 * var_x189;
        IJth(rJacobian, 21, 22) = var_x104 * var_x206 - var_x207 * var_x21;
        IJth(rJacobian, 22, 22) = -4.048582995951417e-5 - 6.7205525966826332e-6 * var_x103 + var_x21 * var_x212 - var_x104 * var_x213;
        ...
        IJth(rJacobian, 14, 23) = var_x111 * var_x186 - var_x110 * var_x186;
        IJth(rJacobian, 15, 23) = 0.00013939759074981328 * var_x106 - 7.9263098651550091e-6 * var_x109 - 2.3551708712663917e-6 * var_x108 + var_x107 * var_x197 + var_x107 * var_x198 + var_x107 * var_x199 + var_x107 * var_x200 + var_x110 * var_x194 - var_x111 * var_x194;
        IJth(rJacobian, 21, 23) = var_x110 * var_x205 - var_x111 * var_x205;
        IJth(rJacobian, 23, 23) = -0.0001 + 1.7317432876958762e-5 * var_x108 + 5.8281690184963299e-5 * var_x109 - 0.0010249822849250976 * var_x106 + var_x111 * var_x217 - var_x107 * var_x220 - var_x107 * var_x221 - var_x107 * var_x222 - var_x107 * var_x223 - var_x110 * var_x217;
        IJth(rJacobian, 1, 24) = var_x119;
        IJth(rJacobian, 24, 24) = -14.98 - var_x224 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 27, 27) = -0.00081499999999999997 - var_x238 - var_x240;
        IJth(rJacobian, 28, 27) = var_x238 + var_x240;
        IJth(rJacobian, 1, 28) = var_x126 * var_x127 - var_x126 * var_x128;
        IJth(rJacobian, 24, 28) = var_x128 * var_x225 - var_x127 * var_x225;
        IJth(rJacobian, 27, 28) = -0.00081499999999999997;
        IJth(rJacobian, 28, 28) = -0.033960000000000004 - 0.33960000000000001 * var_x239;
    }
