...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnygren_atrial_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x9 = pow(var_chaste_interface__intracellular_ion_concentrations__Na_i, 3);
        const double var_x10 = var_x9 * var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x11 = 1.0 + 0.00029999999999999997 * var_x10 + 0.00029999999999999997 * var_x8;
        const double var_x12 = 1 / var_x11;
        const double var_x13 = exp(0.017058350483361479 * var_chaste_interface__membrane__V);
        const double var_x14 = var_x10 * var_x13;
        const double var_x15 = exp(-0.020849095035219586 * var_chaste_interface__membrane__V);
        const double var_x16 = var_x15 * var_x8;
        const double var_x17 = var_x12 * (0.017058350483361479 * var_x14 + 0.020849095035219586 * var_x16);
        ...
        const double var_x19 = exp(2.2916666666666665 + 0.041666666666666664 * var_chaste_interface__membrane__V);
        ...
        const double var_x24 = log(var_x23 * var_chaste_interface__cleft_space_ion_concentrations__K_c);
        const double var_x25 = exp(0.20470020580033774 + 0.056861168277871597 * var_chaste_interface__membrane__V - 1.5 * var_x24);
        const double var_x26 = 1.0 + var_x25;
        const double var_x27 = 1 / var_x26;
        const double var_x28 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, 0.44569999999999999);
        const double var_x29 = var_x27 * var_x28;
        const double var_x30 = -26.380041870925616 * var_x24 + var_chaste_interface__membrane__V;
        const double var_x31 = var_x19 * var_x30 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a / pow(var_x20, 2);
        const double var_x32 = var_x25 * var_x30 / pow(var_x26, 2);
        ...
        const double var_x66 = 0.00074968400000000003 * var_x12;
        const double var_x67 = var_x15 * var_x7;
        const double var_x68 = (var_x14 - var_x16) / pow(var_x11, 2);
        const double var_x69 = 2.249052e-7 * var_x68;
        const double var_x70 = var_x47 * var_x50 * var_chaste_interface__membrane__V;
        const double var_x71 = var_x52 * var_x70 * pow(var_chaste_interface__sodium_current_m_gate__m, 2);
        const double var_x72 = var_x51 * var_x70;
        const double var_x73 = 8.0999999999999996 - 0.13500000000000001 * var_chaste_interface__membrane__V;
        const double var_x74 = var_x4 + var_x5;
        const double var_x75 = var_x73 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x76 = 3.9570062806388422 * var_x24 - 0.14999999999999999 * var_chaste_interface__membrane__V;
        const double var_x77 = 1.4509023029009087 * var_x24 - 0.055 * var_chaste_interface__membrane__V;
        ...
        const double var_x79 = 6.7471559999999992e-7 * var_x68;
        const double var_x80 = 0.0022490520000000001 * var_x12;
        const double var_x81 = var_x13 * var_x78;
        ...
        const double var_x85 = var_x54 * var_chaste_interface__membrane__V;
        const double var_x86 = var_x45 * var_x85;
        const double var_x87 = 0.52760083741851227 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x88 = 3.9570062806388422 * var_x18;
        const double var_x89 = var_x21 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a;
        const double var_x90 = 0.26380041870925613 * var_x89;
        const double var_x91 = 1.4509023029009087 * var_x6;
        const double var_x92 = var_x23 * var_x29;
        const double var_x93 = var_x23 * var_x33;
        ...
        const double var_x98 = var_x15 * var_x97;
        const double var_x99 = 1 / var_chaste_interface__cleft_space_ion_concentrations__Ca_c;
        const double var_x100 = var_x13 * var_x9;
        const double var_x101 = 1 / var_chaste_interface__cleft_space_ion_concentrations__K_c;
        const double var_x102 = pow(var_chaste_interface__cleft_space_ion_concentrations__K_c, (-0.55430000000000001));
        const double var_x103 = var_x102 * var_x27;
        const double var_x104 = var_x103 * var_x30;
        const double var_x105 = var_x102 * var_x32;
        ...
        const double var_x116 = 6.6024752054987431e-8 * var_x12;
        const double var_x117 = 1.9807425616496228e-11 * var_x68;
        const double var_x118 = 1.9807425616496229e-7 * var_x12;
        const double var_x119 = 5.9422276849488674e-11 * var_x68;
        const double var_x120 = 32.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x121 = -var_chaste_interface__intracellular_ion_concentrations__Ca_i + var_chaste_interface__Ca_handling_by_the_SR__Ca_rel;
        const double var_x122 = 0.35228043845133378 * var_x121;
        const double var_x123 = var_x112 * var_chaste_interface__Ca_handling_by_the_SR__F2;
        const double var_x124 = var_x113 / pow(var_x111, 3);
        const double var_x125 = exp(-3.3032886723507917 - 0.12180267965895249 * var_chaste_interface__membrane__V);
        ...
        const double var_x133 = exp(12.0 + 0.18867924528301888 * var_chaste_interface__membrane__V);
        const double var_x134 = 1.0 + var_x133;
        const double var_x135 = 0.00018867924528301889 * var_x133 / pow(var_x134, 2);
        const double var_x136 = 1.0 / var_x134;
        const double var_x137 = var_x129 / pow(var_x130, 2);
        const double var_x138 = 1 / (0.0030000000000000001 + 0.12 * var_x131);
        const double var_x139 = exp(-1.5517241379310345 - 0.17241379310344829 * var_chaste_interface__membrane__V);
        ...
        const double var_x146 = exp(3.859154929577465 + 0.14084507042253522 * var_chaste_interface__membrane__V);
        const double var_x147 = 1.0 + var_x146;
        const double var_x148 = 0.00014084507042253522 * var_x146 / pow(var_x147, 2);
        const double var_x149 = 1.0 / var_x147;
        const double var_x150 = exp(-7.9349335449315621 * var_x143);
        const double var_x151 = 1 / (0.062600000000000003 + 1.3323 * var_x150);
        const double var_x152 = exp(0.090909090909090912 - 0.090909090909090912 * var_chaste_interface__membrane__V);
        ...
        const double var_x156 = exp(3.5217391304347827 + 0.086956521739130432 * var_chaste_interface__membrane__V);
        ...
        const double var_x160 = exp(-0.53749999999999998 - 0.125 * var_chaste_interface__membrane__V);
        ...
        const double var_x167 = exp(2.0 + var_x166);
        ...
        const double var_x173 = exp(1.5669291338582676 - 0.07874015748031496 * var_chaste_interface__membrane__V);
        ...
        const double var_x177 = exp(-2.5 - 0.16666666666666666 * var_chaste_interface__membrane__V);
        ...
        const double var_x182 = 0.00037425551606170871 * var_x40;
        const double var_x183 = var_x60 * var_chaste_interface__membrane__V;
        const double var_x184 = var_x61 * var_chaste_interface__membrane__V;
        const double var_x185 = 1.9807425616496229e-7 * var_x12;
        const double var_x186 = 1.7826683054846605e-10 * var_x68;
        const double var_x187 = 5.942227684948868e-7 * var_x12;
        const double var_x188 = var_x181 * var_chaste_interface__membrane__V;
        const double var_x189 = var_x188 * var_x45;
        const double var_x190 = 8.8070109612833433e-7 * var_x21;
        const double var_x191 = 0.00024950367737447247 * var_x40;
        const double var_x192 = 0.00034849397687453321 * var_x24 - 1.3210516441925016e-5 * var_chaste_interface__membrane__V;
        const double var_x193 = 0.00012778112485399551 * var_x24 - 4.843856028705839e-6 * var_chaste_interface__membrane__V;
        const double var_x194 = 4.6465863583271093e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x195 = 2.3232931791635546e-5 * var_x89;
        const double var_x196 = 0.00012778112485399551 * var_x6;
        const double var_x197 = 0.00034849397687453321 * var_x18;
        ...
        const double var_x201 = 7.5793668809895348e-5 * var_x53;
        const double var_x202 = 0.0027518787945713876 * var_x40;
        const double var_x203 = 1.4564283541541343e-6 * var_x12;
        const double var_x204 = 4.3692850624624026e-10 * var_x68;
        const double var_x205 = 4.369285062462403e-6 * var_x12;
        const double var_x206 = 1.3107855187387207e-9 * var_x68;
        const double var_x207 = var_x201 * var_chaste_interface__membrane__V;
        const double var_x208 = var_x207 * var_x45;
        const double var_x209 = 1.4564283541541343e-10 * var_x68;
        const double var_x210 = 4.8547611805137808e-7 * var_x12;
        const double var_x211 = -0.0026226760583233483 + 4.3711267638722472e-5 * var_chaste_interface__membrane__V;
        const double var_x212 = var_x211 * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        const double var_x213 = 4.3692850624624026e-10 * var_x68;
        const double var_x214 = 6.4757433538848112e-6 * var_x21;
        const double var_x215 = 0.0018345858630475916 * var_x40;
        const double var_x216 = 9.7136150308272163e-5 * var_chaste_interface__membrane__V - 0.0025624557123127439 * var_x24;
        const double var_x217 = 3.5616588446366462e-5 * var_chaste_interface__membrane__V - 0.00093956709451467277 * var_x24;
        const double var_x218 = 0.00034166076164169918 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n;
        const double var_x219 = 0.00093956709451467277 * var_x6;
        const double var_x220 = 0.0025624557123127439 * var_x18;
        const double var_x221 = 0.00017083038082084959 * var_x89;
        const double var_x222 = 23.501339000540224 * var_x114;
        const double var_x223 = 47.002678001080447 * var_x121;
        ...
        const double var_x226 = var_x225 / pow(var_x224, 5);
        const double var_x227 = 0.81520000000000004 * var_x226;
        const double var_x228 = pow(var_x224, (-4));
        const double var_x229 = var_x228 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 3);
        ...
        const double var_x233 = 0.81520000000000004 * var_x232 / pow(var_x231, 5);
        const double var_x234 = pow(var_x231, (-4));
        const double var_x235 = 0.81520000000000004 * var_x234 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_d, 3);
        ...
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0027856000000000001 + 3.5412649999999997e-5 * var_x58 + 0.00041666666666666664 * var_x31 + 0.0034116700966722955 * var_x33 - 0.055 * var_x6 - 0.00074968400000000003 * var_x17 - 0.14999999999999999 * var_x18 - 0.02 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 0.059999999999999998 * var_x29 + var_x59 * var_x61 + (-0.13500000000000001 * var_x4 - 0.13500000000000001 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L - var_x22 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a - var_x37 * var_x41 - var_x47 * var_x54 - var_x59 * var_x60);
        IJth(rJacobian, 1, 0) = -6.9294442944473474e-8 + 6.6024752054987431e-8 * var_x17;
        IJth(rJacobian, 2, 0) = 0.00012180267965895249 * var_x125 * var_x128 / pow(var_x126, 2) - 23.80952380952381 * var_x127 * (-0.061656057098765427 - 0.0024112654320987653 * var_chaste_interface__membrane__V) * (-var_chaste_interface__sodium_current_m_gate__m + 1.0 / var_x126) / pow((0.57142857142857151 + var_x127), 2);
        IJth(rJacobian, 3, 0) = -var_x132 * var_x135 + 0.010416666666666666 * var_x137 * (var_x136 - var_chaste_interface__sodium_current_h1_gate__h1) / pow((0.01 + var_x131), 2);
        IJth(rJacobian, 4, 0) = -var_x135 * var_x138 + 0.0026041666666666665 * var_x137 * (var_x136 - var_chaste_interface__sodium_current_h2_gate__h2) / pow((0.025000000000000001 + var_x131), 2);
        IJth(rJacobian, 5, 0) = 0.00017241379310344829 * var_x139 * var_x142 / pow(var_x140, 2) - 0.37037037037037035 * var_x141 * (-0.077777777777777779 - 0.0022222222222222222 * var_chaste_interface__membrane__V) * (-var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L + 1.0 / var_x140) / pow((0.7407407407407407 + var_x141), 2);
        IJth(rJacobian, 6, 0) = -var_x145 * var_x148 - 0.0062111801242236021 * var_x144 * (-0.38580246913580246 - 0.0096450617283950612 * var_chaste_interface__membrane__V) * (var_x149 - var_chaste_interface__L_type_Ca_channel_f_L1_gate__f_L_1) / pow((0.062111801242236024 + var_x144), 2);
        IJth(rJacobian, 7, 0) = -var_x148 * var_x151 - 0.00075058170081813405 * var_x150 * (-0.39674667724657808 - 0.0099186669311644524 * var_chaste_interface__membrane__V) * (var_x149 - var_chaste_interface__L_type_Ca_channel_f_L2_gate__f_L_2) / pow((0.046986414471215196 + var_x150), 2);
        IJth(rJacobian, 8, 0) = 9.0909090909090917e-5 * var_x152 * var_x155 / pow(var_x153, 2) + 0.00063492063492063492 * var_x154 * (-var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r + 1.0 / var_x153) * var_chaste_interface__membrane__V / pow((0.42857142857142855 + var_x154), 2);
        IJth(rJacobian, 9, 0) = -8.6956521739130441e-5 * var_x156 * var_x159 / pow(var_x157, 2) - 0.0020781379883624274 * var_x158 * (-0.46809272073427638 - 0.0089245513962683768 * var_chaste_interface__membrane__V) * (-var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s + 1.0 / var_x157) / pow((0.02938487115544472 + var_x158), 2);
        IJth(rJacobian, 10, 0) = 0.000125 * var_x160 * var_x165 / pow(var_x161, 2) + 0.0092592592592592605 * var_x162 * (-var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus + 1.0 / var_x161) / (pow(var_x163, 2) * pow((0.055555555555555559 + var_x164), 2));
        IJth(rJacobian, 11, 0) = -4.0000000000000003e-5 * var_x167 * var_x172 / pow(var_x168, 2) + 5.2222222222222227e-5 * var_x169 * (0.59999999999999998 - var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus + 0.40000000000000002 / var_x168) / (pow(var_x170, 2) * pow((1 + 0.15666666666666668 * var_x171), 2));
        IJth(rJacobian, 12, 0) = 7.874015748031497e-5 * var_x173 * var_x176 / pow(var_x174, 2) - 0.00081632653061224504 * var_x175 * (0.10000000000000001 - var_x55) * (-var_chaste_interface__delayed_rectifier_K_currents_n_gate__n + 1.0 / var_x174) / pow((1 + 0.57142857142857151 * var_x175), 2);
        IJth(rJacobian, 13, 0) = 0.00016666666666666666 * var_x177 * var_x180 / pow(var_x178, 2) - 0.0046044755502348284 * var_x179 * (-0.081723584525982884 - 0.0040582584084490154 * var_chaste_interface__membrane__V) * (-var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a + 1.0 / var_x178) / pow((0.14356754765632193 + var_x179), 2);
        IJth(rJacobian, 14, 0) = -1.0673921144856187e-7 + 3.9074763446476996e-7 * var_x184 + 9.3563879015427174e-9 * var_x58 - 3.9074763446476996e-7 * var_x183 - 1.9807425616496229e-7 * var_x17 - var_x181 * var_x47 - var_x182 * var_x37;
        IJth(rJacobian, 15, 0) = 3.6695879005347264e-8 * var_x31 + 3.0046615937675515e-7 * var_x33 - 1.3210516441925016e-5 * var_x18 - 1.7614021922566687e-6 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 4.843856028705839e-6 * var_x6 - 5.2842065767700066e-6 * var_x29 - 6.2375919343618122e-9 * var_x58 + var_x191 * var_x37 - var_x190 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a;
        IJth(rJacobian, 16, 0) = (-0.00029723661994331287 * var_x4 - 0.00029723661994331287 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 21, 0) = 7.848471430041313e-7 + 2.8731443710644848e-6 * var_x183 + 1.4564283541541343e-6 * var_x17 - 6.879696986428469e-8 * var_x58 - 2.8731443710644848e-6 * var_x184 + var_x201 * var_x47 + var_x202 * var_x37;
        IJth(rJacobian, 22, 0) = 5.0951796282701088e-7 - 4.8547611805137808e-7 * var_x17 + (4.3711267638722472e-5 * var_x4 + 4.3711267638722472e-5 * var_x5) * var_chaste_interface__L_type_Ca_channel_d_L_gate__d_L;
        IJth(rJacobian, 23, 0) = 3.5616588446366462e-5 * var_x6 + 3.8854460123308864e-5 * var_x29 + 4.5864646576189789e-8 * var_x58 + 9.7136150308272163e-5 * var_x18 + 1.2951486707769622e-5 * var_chaste_interface__delayed_rectifier_K_currents_n_gate__n - 2.6982263974520048e-7 * var_x31 - 2.2093099954173172e-6 * var_x33 + var_x214 * var_chaste_interface__delayed_rectifier_K_currents_pa_gate__p_a - var_x215 * var_x37;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.080000000000000002 * var_x65 - 0.020756080744462984 * var_x62 - 0.080000000000000002 * var_x64 + var_x66 * var_x67 + var_x69 * var_x7);
        IJth(rJacobian, 1, 1) = -47.274000000000001 - var_x115 + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgC + 32.0 * var_chaste_interface__intracellular_Ca_buffering__O_TMgMg + 7.3978892074780085e-7 * var_x110 + 3.5228043845133373e-6 * var_x65 + 9.0 * var_chaste_interface__intracellular_Ca_buffering__O_C + 6.2720000000000002 * var_chaste_interface__intracellular_Ca_buffering__O_TC - 3.5228043845133373e-6 * var_x64 - 8.2198768971977891 * var_x109 - 9.1399515314883825e-7 * var_x62 - var_x116 * var_x67 - var_x117 * var_x7;
        IJth(rJacobian, 14, 1) = var_x119 * var_x7 + var_x185 * var_x67;
        IJth(rJacobian, 16, 1) = 0.10000000000000001;
        ...
        IJth(rJacobian, 21, 1) = -var_x203 * var_x67 - var_x204 * var_x7;
        IJth(rJacobian, 22, 1) = 2.5902973415539245e-5 * var_x64 + 6.7205525966826332e-6 * var_x62 - 2.5902973415539245e-5 * var_x65 + var_x209 * var_x7 + var_x210 * var_x67;
        IJth(rJacobian, 24, 1) = var_x222;
        IJth(rJacobian, 25, 1) = 121.858794817616 * var_x109 - 1.0967291533585438e-5 * var_x110;
        IJth(rJacobian, 27, 1) = (var_x227 - var_x230) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 28, 1) = (var_x230 - var_x227) * var_chaste_interface__Ca_handling_by_the_SR__F1 + (1.3584000000000001 * var_x226 - 1.3584000000000001 * var_x229) * var_chaste_interface__Ca_handling_by_the_SR__F2;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-0.3511272667921278 * var_x71);
        IJth(rJacobian, 2, 2) = -0.001 * var_x128;
        IJth(rJacobian, 14, 2) = -3.0923816874437303e-5 * var_x71;
        IJth(rJacobian, 21, 2) = 0.00022738100642968604 * var_x71;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-0.10533818003763834 * var_x72);
        IJth(rJacobian, 3, 3) = -0.001 * var_x132;
        IJth(rJacobian, 14, 3) = -9.2771450623311923e-6 * var_x72;
        IJth(rJacobian, 21, 3) = 6.8214301928905822e-5 * var_x72;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-0.01170424222640426 * var_x72);
        IJth(rJacobian, 4, 4) = -0.001 * var_x138;
        IJth(rJacobian, 14, 4) = -1.0307938958145769e-6 * var_x72;
        IJth(rJacobian, 21, 4) = 7.5793668809895352e-6 * var_x72;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x73 * var_x74);
        IJth(rJacobian, 5, 5) = -0.001 * var_x142;
        IJth(rJacobian, 16, 5) = var_x198 * var_x74;
        IJth(rJacobian, 22, 5) = var_x211 * var_x74;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x2 * var_x75);
        IJth(rJacobian, 6, 6) = -0.001 * var_x145;
        IJth(rJacobian, 16, 6) = var_x199 * var_x2;
        IJth(rJacobian, 22, 6) = var_x2 * var_x212;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x3 * var_x75);
        IJth(rJacobian, 7, 7) = -0.001 * var_x151;
        IJth(rJacobian, 16, 7) = var_x199 * var_x3;
        IJth(rJacobian, 22, 7) = var_x212 * var_x3;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s);
        IJth(rJacobian, 8, 8) = -0.001 * var_x155;
        IJth(rJacobian, 15, 8) = var_x192 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        IJth(rJacobian, 23, 8) = var_x216 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x76 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r);
        IJth(rJacobian, 9, 9) = -0.001 * var_x159;
        IJth(rJacobian, 15, 9) = var_x192 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 23, 9) = var_x216 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus);
        IJth(rJacobian, 10, 10) = -0.001 * var_x165;
        IJth(rJacobian, 15, 10) = var_x193 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        IJth(rJacobian, 23, 10) = var_x217 * var_chaste_interface__sustained_outward_K_current_s_sus_gate__s_sus;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (var_x77 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus);
        IJth(rJacobian, 11, 11) = -0.001 * var_x172;
        IJth(rJacobian, 15, 11) = var_x193 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus;
        IJth(rJacobian, 23, 11) = var_x217 * var_chaste_interface__sustained_outward_K_current_r_sus_gate__r_sus;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (0.52760083741851227 * var_x24 - 0.02 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 12, 12) = -0.001 * var_x176;
        IJth(rJacobian, 15, 12) = 4.6465863583271093e-5 * var_x24 - 1.7614021922566687e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 23, 12) = 1.2951486707769622e-5 * var_chaste_interface__membrane__V - 0.00034166076164169918 * var_x24;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x22 * var_x30);
        IJth(rJacobian, 13, 13) = -0.001 * var_x180;
        IJth(rJacobian, 15, 13) = -var_x190 * var_x30;
        IJth(rJacobian, 23, 13) = var_x214 * var_x30;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (0.0015963628850488355 * var_x83 - 2.1247590000000001 * var_x84 - 0.031972083146724423 * var_x43 + var_x78 * var_x79 - var_x44 * var_x86 - var_x80 * var_x81);
        IJth(rJacobian, 1, 14) = var_x118 * var_x81 - var_x119 * var_x78;
        IJth(rJacobian, 14, 14) = 4.2177556280432989e-7 * var_x83 - 0.00056138327409256303 * var_x84 - 2.8157848672826448e-6 * var_x43 + var_x186 * var_x78 - var_x187 * var_x81 - var_x189 * var_x44;
        IJth(rJacobian, 15, 14) = 0.00037425551606170871 * var_x84 - 2.8118370853621991e-7 * var_x83;
        IJth(rJacobian, 21, 14) = 0.0041278181918570815 * var_x84 + 2.0704300494725328e-5 * var_x43 - 3.1012909029730135e-6 * var_x83 + var_x205 * var_x81 + var_x208 * var_x44 - var_x206 * var_x78;
        IJth(rJacobian, 22, 14) = var_x213 * var_x78 - var_x203 * var_x81;
        IJth(rJacobian, 23, 14) = 2.067527268648676e-6 * var_x83 - 0.0027518787945713876 * var_x84;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.089999999999999997 * var_x93 - 1.5828025122555369 * var_x92 - var_x23 * var_x87 - var_x23 * var_x88 - var_x23 * var_x90 - var_x23 * var_x91);
        IJth(rJacobian, 15, 15) = 7.9263098651550091e-6 * var_x93 - 0.00013939759074981328 * var_x92 - var_x194 * var_x23 - var_x195 * var_x23 - var_x196 * var_x23 - var_x197 * var_x23;
        IJth(rJacobian, 23, 15) = 0.0010249822849250976 * var_x92 - 5.8281690184963299e-5 * var_x93 + var_x218 * var_x23 + var_x219 * var_x23 + var_x220 * var_x23 + var_x221 * var_x23;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x75 * var_x95);
        IJth(rJacobian, 1, 16) = 0.002;
        IJth(rJacobian, 16, 16) = -0.10000000000000001 + var_x199 * var_x95;
        IJth(rJacobian, 22, 16) = var_x212 * var_x95;
        IJth(rJacobian, 27, 16) = (var_x233 - var_x235) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 28, 16) = (var_x235 - var_x233) * var_chaste_interface__Ca_handling_by_the_SR__F1;
        IJth(rJacobian, 1, 17) = 0.021419999999999998 + 9.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 17, 17) = -0.47600000000000003 + var_x200;
        ...
        IJth(rJacobian, 1, 19) = 0.0010560000000000001 + var_x120;
        IJth(rJacobian, 19, 19) = -0.0066 + var_x200;
        IJth(rJacobian, 20, 19) = -5.0;
        IJth(rJacobian, 1, 20) = var_x120;
        IJth(rJacobian, 19, 20) = var_x200;
        IJth(rJacobian, 20, 20) = -5.6660000000000004;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86 + 0.031972083146724423 * var_x96 + var_x79 * var_x97 + var_x80 * var_x98 - var_x46 * var_x85);
        IJth(rJacobian, 1, 21) = -var_x118 * var_x98 - var_x119 * var_x97;
        IJth(rJacobian, 14, 21) = var_x189 + 2.8157848672826448e-6 * var_x96 + var_x186 * var_x97 + var_x187 * var_x98 - var_x188 * var_x46;
        IJth(rJacobian, 21, 21) = -6.993006993006993e-5 - var_x208 - 2.0704300494725328e-5 * var_x96 + var_x207 * var_x46 - var_x205 * var_x98 - var_x206 * var_x97;
        IJth(rJacobian, 22, 21) = var_x203 * var_x98 + var_x213 * var_x97;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.020756080744462984 * var_x99 + var_x69 * var_x9 - var_x100 * var_x66);
        IJth(rJacobian, 1, 22) = 9.1399515314883825e-7 * var_x99 + var_x100 * var_x116 - var_x117 * var_x9;
        IJth(rJacobian, 14, 22) = var_x119 * var_x9 - var_x100 * var_x185;
        IJth(rJacobian, 21, 22) = var_x100 * var_x203 - var_x204 * var_x9;
        IJth(rJacobian, 22, 22) = -4.048582995951417e-5 - 6.7205525966826332e-6 * var_x99 + var_x209 * var_x9 - var_x100 * var_x210;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (1.5828025122555369 * var_x103 - 0.026741999999999998 * var_x104 - 0.089999999999999997 * var_x105 + var_x101 * var_x87 + var_x101 * var_x88 + var_x101 * var_x90 + var_x101 * var_x91 + var_x107 * var_x41 - var_x106 * var_x41);
        IJth(rJacobian, 14, 23) = var_x107 * var_x182 - var_x106 * var_x182;
        IJth(rJacobian, 15, 23) = 0.00013939759074981328 * var_x103 - 7.9263098651550091e-6 * var_x105 - 2.3551708712663917e-6 * var_x104 + var_x101 * var_x194 + var_x101 * var_x195 + var_x101 * var_x196 + var_x101 * var_x197 + var_x106 * var_x191 - var_x107 * var_x191;
        IJth(rJacobian, 21, 23) = var_x106 * var_x202 - var_x107 * var_x202;
        IJth(rJacobian, 23, 23) = -0.0001 + 1.7317432876958762e-5 * var_x104 + 5.8281690184963299e-5 * var_x105 - 0.0010249822849250976 * var_x103 + var_x107 * var_x215 - var_x101 * var_x218 - var_x101 * var_x219 - var_x101 * var_x220 - var_x101 * var_x221 - var_x106 * var_x215;
        IJth(rJacobian, 1, 24) = var_x115;
        IJth(rJacobian, 24, 24) = -14.98 - var_x222 + 14.880000000000001 * var_chaste_interface__Ca_handling_by_the_SR__O_Calse;
        ...
        IJth(rJacobian, 1, 25) = 1.7754934097947219e-10 * var_x110 + 0.00078910818213098765 * var_x109;
        IJth(rJacobian, 24, 25) = 0.10000000000000001;
        IJth(rJacobian, 25, 25) = -0.011111111111111112 - 2.632149968060505e-9 * var_x110 - 0.011698444302491135 * var_x109;
        ...
        IJth(rJacobian, 27, 27) = -0.00081499999999999997 - var_x236 - var_x238;
        IJth(rJacobian, 28, 27) = var_x236 + var_x238;
        IJth(rJacobian, 1, 28) = var_x122 * var_x123 - var_x122 * var_x124;
        IJth(rJacobian, 24, 28) = var_x124 * var_x223 - var_x123 * var_x223;
        IJth(rJacobian, 27, 28) = -0.00081499999999999997;
        IJth(rJacobian, 28, 28) = -0.033960000000000004 - 0.33960000000000001 * var_x237;
    }
