...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellten_tusscher_model_2004_endoFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x66 = 2.5645210233307822 * var_x13 - 0.096000000000000002 * var_chaste_interface__membrane__V;
        ...
        const double var_x68 = (-26.713760659695652 * log(9.5999999999999996 / var_x67) + var_chaste_interface__membrane__V) * var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs;
        ...
        const double var_x72 = var_x71 * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 2) * var_chaste_interface__fast_sodium_current_j_gate__j;
        const double var_x73 = var_x28 * var_x71;
        const double var_x74 = 2.5282752177944188 * var_x51;
        const double var_x75 = var_x49 * var_x55;
        const double var_x76 = 1.9501045281577822 * var_x13 - 0.072999999999999995 * var_chaste_interface__membrane__V;
        ...
        const double var_x150 = -var_chaste_interface__fast_sodium_current_m_gate__m + 1.0 / pow(var_x149, 2);
        ...
        const double var_x156 = 1.0 / pow(var_x155, 2);
        ...
        const double var_x165 = 0.26917900403768508 * var_x154 / pow(var_x155, 3);
        ...
        const double var_x170 = exp(-3.2000000000000002 - var_x21);
        ...
        const double var_x194 = exp(-0.66666666666666663 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        ...
        const double var_x201 = exp(2.8571428571428572 + var_x115);
        ...
        const double var_x212 = exp(5.5999999999999996 + var_x140);
        const double var_x213 = 1.0 + var_x212;
        const double var_x214 = exp(-4.4889999999999999 * pow((1 + 0.014925373134328358 * var_chaste_interface__membrane__V), 2));
        const double var_x215 = 1 / (8.0 + 1000.0 * var_x214);
        const double var_x216 = exp(3.3333333333333335 + var_x132);
        const double var_x217 = 1.0 + var_x216;
        const double var_x218 = exp(-0.88888888888888884 * pow((1 + 0.025000000000000001 * var_chaste_interface__membrane__V), 2));
        const double var_x219 = 1 / (0.80000000000000004 + 9.5 * var_x218);
        const double var_x220 = 0.29999999999999999 + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x221 = pow(var_x220, (-2));
        const double var_x222 = 14.994515539305301 / (1.0 + 3.0 * var_x221);
        const double var_x223 = var_x222 * (-0.0082319999999999997 - var_x104);
        const double var_x224 = var_chaste_interface__calcium_dynamics__Ca_i >= 0.00035;
        const double var_x225 = var_chaste_interface__calcium_dynamics__Ca_i < 0.00035;
        const double var_x226 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 6);
        const double var_x227 = pow(var_chaste_interface__calcium_dynamics__Ca_i, 16);
        const double var_x228 = (((var_x205) || (var_x224))) && (((var_x205) || (var_x225))) && (((var_x224) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 5.439910241481016e+20 * var_x226)))) && (((var_x225) || (var_chaste_interface__calcium_dynamics__g < 1.0 / (1.0 + 1.9720198874049176e+55 * var_x227))));
        const double var_x229 = 0.00173434701107436 * var_x29;
        const double var_x230 = 6.3176611368492499e-5 * var_x40;
        const double var_x231 = 0.00029975531551766426 * var_x13 - 1.1221007754625865e-5 * var_chaste_interface__membrane__V;
        const double var_x232 = 0.00022793893784155717 * var_x13 - 8.5326413134134178e-6 * var_chaste_interface__membrane__V;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00088199999999999997 + 0.18928635694553861 * var_x56 + 0.03243 * var_x37 - 0.245 * var_x0 - 0.072999999999999995 * var_x4 - 0.0146 * var_x3 - 0.0024414715719063545 * var_x32 - 8.6662202299424464e-5 * var_x11 - 0.18928635694553861 * var_x59 - 0.54050000000000009 * var_x26 - 1.1491875 * var_x46 - 0.096000000000000002 * var_x27 - 2.1086672225679691e-7 * var_x34 - var_x30 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x39 * var_x41 - var_x53 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        IJth(rJacobian, 1, 0) = var_x94 * (-3.4598107243429746e-8 + 2.464726172537559e-11 * var_x34 + 1.0129554625362472e-8 * var_x11 + 1.106241499547275e-5 * var_x56 - 1.106241499547275e-5 * var_x59 - var_x90 * var_chaste_interface__L_type_Ca_current_d_gate__d);
        ...
        IJth(rJacobian, 6, 0) = (var_x156 - var_chaste_interface__fast_sodium_current_h_gate__h) * (1.0 * ((var_x158) ? (-0.008382352941176471 * var_x157) : (0)) + 1.0 * ((var_x158) ? (108035.0 * var_x159 + 0.21330000000000002 * var_x160) : (0.53361053361053368 * var_x161 / pow(var_x162, 2)))) - var_x165 * (var_x163 + var_x164);
        IJth(rJacobian, 7, 0) = (var_x156 - var_chaste_interface__fast_sodium_current_j_gate__j) * (1.0 * ((var_x158) ? (-0.00025500480000000003 * var_x169 + 0.0033402720000000005 * var_x166 * var_x168 / pow(var_x167, 2)) : (0.034200000000000001 * var_x173 + 0.059999999999999998 * var_x170 * var_x172 / pow(var_x171, 2))) + 1.0 * ((var_x158) ? (var_x180 + var_x179 * var_x181 * (3.0508668000000001e-7 * var_x175 - 6214.6032000000005 * var_x174) - 0.311 * var_x176 * var_x177 * var_x181 / pow(var_x178, 2)) : (0))) - var_x165 * (var_x182 + var_x183);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1.0 / var_x195) * (-0.050000000000000003 * var_x184 / pow(var_x185, 2) + 0.27999999999999997 * var_x187 * var_x192 / pow(var_x188, 2) - 0.15076923076923074 * var_x189 * var_x190 / pow(var_x191, 2)) / pow((var_x193 + 0.7142857142857143 * var_x186), 2) + 0.13333333333333333 * var_x194 * var_x196 / pow(var_x195, 2);
        IJth(rJacobian, 9, 0) = 7.9012345679012348e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1.0 / var_x202) * (-var_x203 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 16.5 * var_x197 / pow(var_x198, 2)) / pow((0.071111111111111111 + var_x200 + 0.14666666666666667 * var_x199), 2) - 0.14285714285714285 * var_x201 * var_x204 / pow(var_x202, 2);
        IJth(rJacobian, 11, 0) = -0.20000000000000001 * var_x212 * var_x215 / pow(var_x213, 2) - 0.001 * var_x214 * (-0.13400000000000001 - 0.002 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_s_gate__s + 1.0 / var_x213) / pow((0.0080000000000000002 + var_x214), 2);
        IJth(rJacobian, 12, 0) = 0.16666666666666666 * var_x216 * var_x219 / pow(var_x217, 2) - 0.10526315789473684 * var_x218 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / var_x217) / pow((0.084210526315789472 + var_x218), 2);
        IJth(rJacobian, 15, 0) = -3.389679425876563e-8 - 3.0388663876087418e-8 * var_x11 - 7.3941785176126768e-11 * var_x34 - 0.00040297005778184723 * var_x46 - var_x229 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 16, 0) = 0.00026864670518789814 * var_x46 + 3.79059668210955e-6 * var_x37 - 2.8537261917770623e-7 * var_x32 - 6.3176611368492499e-5 * var_x26 - 8.5326413134134178e-6 * var_x4 - 1.1221007754625865e-5 * var_x27 - 1.7065282626826835e-6 * var_x3 - 2.8636946873784758e-5 * var_x0 - var_x230 * var_x39;
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (0.82499999999999996 * var_x63 + 594.50270777405183 * var_x64 - 0.82499999999999996 * var_x61 - 0.0079072731552699126 * var_x62 - 2.5282752177944188 * var_x65);
        ...
        IJth(rJacobian, 10, 1) = ((var_x211) ? (0) : (-3.4101542475452148e-28 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 7) / pow((1.2447063003540035e-28 + var_x210), 2) - 85.61643835616438 * var_x208 / pow(var_x209, 2) - 342.46575342465752 * var_x206 / pow(var_x207, 2)));
        IJth(rJacobian, 13, 1) = var_x222 * (8.0000000000000007e-5 + var_x97);
        IJth(rJacobian, 14, 1) = ((var_x228) ? (0) : ((var_x225) ? (-5.5147968749999998e-21 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 5) / pow((1.8382656249999998e-21 + var_x226), 2)) : (-4.0567542199219961e-55 * pow(var_chaste_interface__calcium_dynamics__Ca_i, 15) / pow((5.0709427749024951e-56 + var_x227), 2))));
        ...
        IJth(rJacobian, 16, 2) = var_x231 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr2_gate__Xr2;
        ...
        IJth(rJacobian, 16, 3) = var_x231 * var_chaste_interface__rapid_time_dependent_potassium_current_Xr1_gate__Xr1;
        ...
        IJth(rJacobian, 6, 6) = -var_x163 - var_x164;
        IJth(rJacobian, 15, 6) = -var_x229 * var_x70;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-14.837999999999999 * var_x73);
        IJth(rJacobian, 7, 7) = -var_x182 - var_x183;
        IJth(rJacobian, 15, 7) = -0.00173434701107436 * var_x73;
        ...
        IJth(rJacobian, 16, 12) = var_x232 * var_chaste_interface__transient_outward_current_s_gate__s;
        IJth(rJacobian, 1, 13) = var_x94 * (8.0000000000000007e-5 + var_x111 * (var_x109 - var_x110));
        IJth(rJacobian, 13, 13) = var_x222 * (-8.0000000000000007e-5 + var_x111 * (var_x110 - var_x109)) + 9.9963436928702016 * (var_x100 + var_x99 - var_x107 - var_x98) / (pow(var_x220, 3) * pow((0.33333333333333337 + var_x221), 2));
        IJth(rJacobian, 1, 14) = var_x105 * var_x94 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 13, 14) = var_x223 * var_chaste_interface__L_type_Ca_current_d_gate__d;
        IJth(rJacobian, 14, 14) = ((var_x228) ? (0) : (-0.5));
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (0.00071824218750000002 * var_x79 - 0.00051997321379654684 * var_x80 - 396.37878066856405 * var_x82 - 1.884922952148125 * var_x81 - 1.1491875 * var_x78 - 0.0077469905913117388 * var_x69);
        IJth(rJacobian, 1, 15) = 6.0777327752174836e-8 * var_x80 * var_x93;
        IJth(rJacobian, 15, 15) = 2.5185628611365452e-7 * var_x79 - 9.0551084895961074e-7 * var_x69 - 0.046330930954698972 * var_x82 - 1.823319832565245e-7 * var_x80 - 0.00040297005778184723 * var_x78;
        IJth(rJacobian, 16, 15) = 0.00026864670518789814 * var_x78 - 0.00022032015690548321 * var_x81 - 1.6790419074243634e-7 * var_x79;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (0.86632725819392997 * var_x89 - 14.4387876365655 * var_x84 - 62.830765071604169 * var_x81 - 2.5645210233307822 * var_x85 - 0.3900209056315565 * var_x83 - 1.9501045281577822 * var_x86 - var_x41 * var_x88);
        IJth(rJacobian, 16, 16) = 0.00010126109252331096 * var_x89 - 0.0073440052301827737 * var_x81 - 0.00029975531551766426 * var_x85 - 0.0016876848753885161 * var_x84 - 4.5587787568311439e-5 * var_x83 - 0.00022793893784155717 * var_x86 - var_x230 * var_x88;
    }
