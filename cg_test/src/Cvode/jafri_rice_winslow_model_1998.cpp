...
#include "MathsCustomFunctions.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        IJth(rJacobian, 16, 0) = var_x242 * (0.016666666666666666 * var_x243 / pow(var_x244, 2) - 0.13333333333333333 * var_x245 / pow(var_x246, 2)) + 0.00017543859649122806 * var_x239 * (-var_chaste_interface__L_type_Ca_channel_y_gate__y + 1.0 / var_x246 + 0.10000000000000001 / var_x244) / (pow(var_x240, 2) * pow((0.033333333333333333 + var_x241), 2));
        ...
        IJth(rJacobian, 2, 2) = -((var_x176) ? (0.13500000000000001 * var_x175) : (0.0)) - ((var_x176) ? (310000.0 * var_x178 + 3.5600000000000001 * var_x177) : (7.6923076923076916 / var_x180));
        IJth(rJacobian, 28, 2) = -var_x113 * var_x292;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-12.800000000000001 * var_x116);
        IJth(rJacobian, 3, 3) = -((var_x176) ? (0.1212 * var_x192) : (0.29999999999999999 * var_x196)) - ((var_x176) ? (var_x187 * var_x188) : (0.0));
