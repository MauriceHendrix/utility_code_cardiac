...
#include "MathsCustomFunctions.hpp"
    ...
    void Celljafri_rice_winslow_model_1998FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x258 = 20.0 * var_chaste_interface__calcium_subsystem__HTRPNCa;
        const double var_x259 = 40.0 * var_chaste_interface__calcium_subsystem__LTRPNCa;
        const double var_x260 = 3.5281248386597142e-5 * var_x122;
        const double var_x261 = pow(var_chaste_interface__calcium_subsystem__Cai, 2);
        const double var_x262 = 2.4999999999999999e-7 + var_x261;
        const double var_x263 = var_x42 / pow(var_x262, 2);
        const double var_x264 = 1 / var_x262;
        const double var_x265 = var_x264 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x266 = 20.0 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x267 = 40.0 * var_chaste_interface__calcium_subsystem__Cai;
        const double var_x268 = 0.0023800000000000002 + var_chaste_interface__calcium_subsystem__Ca_SS;
        const double var_x269 = 1.0 + 0.00011900000000000002 / pow(var_x268, 2);
        ...
        const double var_x272 = -var_x270 * var_x271 * var_x92;
        const double var_x273 = 143.30816746739879 * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x274 = 143.30816746739879 * var_chaste_interface__calcium_subsystem__P_O2;
        const double var_x275 = (-var_chaste_interface__calcium_subsystem__Ca_SS + var_chaste_interface__calcium_subsystem__Ca_JSR) * (var_chaste_interface__calcium_subsystem__P_O1 + var_chaste_interface__calcium_subsystem__P_O2);
        const double var_x276 = var_x270 * (143.30816746739879 * var_chaste_interface__calcium_subsystem__Ca_JSR - 143.30816746739879 * var_chaste_interface__calcium_subsystem__Ca_SS);
        const double var_x277 = pow(var_chaste_interface__calcium_subsystem__Ca_SS, 3.0);
        const double var_x278 = 48600000000.0 * var_x277 * var_chaste_interface__calcium_subsystem__P_C1;
        const double var_x279 = 121500000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 2.0) * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x280 = 40500000.0 * var_x277;
        const double var_x281 = 12150000000.0 * pow(var_chaste_interface__calcium_subsystem__Ca_SS, 4.0);
        const double var_x282 = 0.80000000000000004 + var_chaste_interface__calcium_subsystem__Ca_JSR;
        const double var_x283 = pow(var_x282, (-2));
        const double var_x284 = 1 / (1.0 + 12.0 * var_x283);
        const double var_x285 = 1.8 * var_chaste_interface__calcium_subsystem__P_O1;
        const double var_x286 = 1.8 * var_chaste_interface__calcium_subsystem__P_O2;
        const double var_x287 = var_x284 * (1.8 * var_chaste_interface__calcium_subsystem__Ca_SS - 1.8 * var_chaste_interface__calcium_subsystem__Ca_JSR);
        const double var_x288 = 3.9072457120905308e-8 * var_x47;
        const double var_x289 = 0.00078539126843207548 * var_x54;
        const double var_x290 = 1.4680812610205159e-9 * var_x75;
        const double var_x291 = 1.101060945765387e-9 * var_x101;
        const double var_x292 = 2.0255161771477306e-16 * var_x126;
        const double var_x293 = var_x288 * var_x73;
        const double var_x294 = 1.0398994565217392e-6 * var_x47;
        const double var_x295 = 3.9072457120905308e-8 * var_x75;
        const double var_x296 = var_x138 * var_x295 - var_x138 * var_x294;
        const double var_x297 = 2.9304342840678981e-8 * var_x101;
        const double var_x298 = var_x297 * var_x35;
        const double var_x299 = 5.0804997676699878e-7 * var_x2;
        const double var_x300 = 2.0199501620781446e-5 * var_x25;
        const double var_x301 = 8.4958190094815849e-8 * var_x52;
        const double var_x302 = var_x288 * var_x50;
        const double var_x303 = 2.9784363174171862e-6 * var_x31;
        const double var_x304 = 0.00015953260140026533 * var_x90;
        const double var_x305 = var_x290 * var_x50;
        const double var_x306 = 4.8175811365563749e-6 * var_x67;
        const double var_x307 = 9.2786178112684927e-8 * var_x72;
        const double var_x308 = 2.2327118354803037e-8 * var_x99;
        const double var_x309 = var_x308 * var_x91;
        const double var_x310 = 1.9415130354461213e-5 * var_x79;
        const double var_x311 = var_x310 * var_x78;
        const double var_x312 = var_x291 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x313 = 8.3890357772600914e-10 * var_x109;
        const double var_x314 = 1.9408096485119751e-12 * var_x112;
        const double var_x315 = 8.3890357772600914e-10 * var_x111;
        const double var_x316 = var_x308 * var_chaste_interface__membrane__V;
        const double var_x317 = var_x316 * var_chaste_interface__L_type_Ca_channel_y_gate__y;
        const double var_x318 = -var_x317;
        const double var_x319 = var_x316 * var_x57;
        const double var_x320 = 5.9568726348343725e-6 * var_x120;
        const double var_x321 = var_x292 * var_x50;
        const double var_x322 = 1.4530193963918526e-6 * var_x132;
        const double var_x323 = 7.5672957221490862e-6 * var_x136;
        const double var_x324 = var_x298 * var_chaste_interface__ionic_concentrations__Ki;
        const double var_x325 = var_x294 * var_x50;
        const double var_x326 = var_x325 * var_x35;
        const double var_x327 = var_x295 * var_x50;
        const double var_x328 = var_x327 * var_x35;
        const double var_x329 = var_x328 - var_x326;
        const double var_x330 = 1.3521568226207399e-5 * var_x2;
        const double var_x331 = var_x11 * var_x330;
        const double var_x332 = 7.9270016169768288e-5 * var_x132;
        const double var_x333 = var_x144 * var_x293;
        const double var_x334 = 0.0005376025032790136 * var_x145;
        const double var_x335 = var_x150 * var_x310;
        const double var_x336 = 0.00012821819703204474 * var_x151;
        const double var_x337 = 2.2327118354803037e-8 * var_x110;
        const double var_x338 = var_x337 * var_x94;
        const double var_x339 = var_x153 * var_x330;
        const double var_x340 = 0.00015953260140026533 * var_x157;
        const double var_x341 = 0.0005376025032790136 * var_x155;
        const double var_x342 = var_x160 * var_x325;
        const double var_x343 = 7.9270016169768288e-5 * var_x158;
        const double var_x344 = 1.0099750810390723e-5 * var_x162;
        const double var_x345 = var_x164 * var_x293;
        const double var_x346 = 7.090337840011793e-5 * var_x159;
        const double var_x347 = 1.4892181587085931e-6 * var_x163;
        const double var_x348 = 0.00012821819703204474 * var_x165;
        const double var_x349 = var_x166 * var_x310;
        const double var_x350 = var_x160 * var_x327;
        const double var_x351 = var_x326 - var_x328;
        ...
        IJth(rJacobian, 16, 0) = var_x242 * (0.016666666666666666 * var_x243 / pow(var_x244, 2) - 0.13333333333333333 * var_x245 / pow(var_x246, 2)) + 0.00017543859649122806 * var_x239 * (1 / var_x246 - var_chaste_interface__L_type_Ca_channel_y_gate__y + 0.10000000000000001 / var_x244) / (pow(var_x240, 2) * pow((0.033333333333333333 + var_x241), 2));
        ...
        IJth(rJacobian, 18, 0) = var_x257 * (-1.8505781762430779e-7 + 6.901732673777188e-11 * var_x33 + 2.8259560611122977e-8 * var_x9);
        IJth(rJacobian, 19, 0) = var_x270 * (1.943239241472396 * var_x107 - 0.0019432392414723959 * var_x105 - var_x271 * var_x63);
        IJth(rJacobian, 28, 0) = -8.6515756913220823e-8 - 8.4778681833368931e-8 * var_x9 - 0.000239298902100398 * var_x90 - 2.0705198021331564e-10 * var_x33 + var_x290 * var_x41 - var_x288 * var_x41 - var_x289 * var_chaste_interface__fast_sodium_current_h_gate__h - var_x291 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 29, 0) = var_x304 + var_x305 + var_x306 + var_x307 + var_x313 - var_x299 - var_x300 - var_x301 - var_x302 - var_x303 - var_x309 - var_x311 - var_x312 - var_x314 - var_x315;
        IJth(rJacobian, 30, 0) = var_x299 + var_x300 + var_x301 + var_x302 + var_x303 + var_x309 + var_x311 + var_x312 + var_x314 + var_x315 - var_x304 - var_x305 - var_x306 - var_x307 - var_x313;
        ...
        IJth(rJacobian, 28, 2) = -var_x113 * var_x289;
        ...
        IJth(rJacobian, 19, 4) = var_x272;
        IJth(rJacobian, 29, 4) = var_x318;
        IJth(rJacobian, 30, 4) = var_x317;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x118);
        IJth(rJacobian, 19, 5) = var_x272;
        IJth(rJacobian, 29, 5) = var_x318;
        IJth(rJacobian, 30, 5) = var_x317;
        ...
        IJth(rJacobian, 19, 16) = -25.859308321022734 * var_x119 * var_x270;
        IJth(rJacobian, 29, 16) = -var_x319;
        IJth(rJacobian, 30, 16) = var_x319;
        ...
        IJth(rJacobian, 29, 17) = -var_x320;
        IJth(rJacobian, 30, 17) = var_x320;
        ...
        IJth(rJacobian, 18, 18) = var_x257 * (-5.9200580000000009 + var_x258 + var_x259 - var_x260 + 0.0035999999999999999 * var_x263 + 3.5281248386597142e-5 * var_x124 - 0.0035999999999999999 * var_x265 - 0.077544234316921451 * var_x125 - 2.4626237783962268e-6 * var_x123) + 0.00023800000000000004 * (5.8e-5 * var_chaste_interface__calcium_subsystem__Ca_NSR + 6.6000000000000005e-5 * var_chaste_interface__calcium_subsystem__HTRPNCa + 0.040000000000000001 * var_chaste_interface__calcium_subsystem__LTRPNCa + 0.32000000000000001 * var_chaste_interface__calcium_subsystem__Ca_SS + 2.4626237783962268e-6 * log(1.8 * var_x123) - 0.32005800000000001 * var_chaste_interface__calcium_subsystem__Cai - 1.8505781762430779e-7 * var_chaste_interface__membrane__V - var_x260 * var_chaste_interface__calcium_subsystem__Cai - var_x266 * (0.14000000000000001 - var_chaste_interface__calcium_subsystem__HTRPNCa) - var_x267 * (0.070000000000000007 - var_chaste_interface__calcium_subsystem__LTRPNCa) + 2.8259560611122977e-8 * var_x32 * var_x5 - 0.0018 * var_x261 * var_x264) / (pow(var_x255, 3) * pow(var_x256, 2));
        IJth(rJacobian, 19, 18) = 5490.7343857240912 * var_x270;
        IJth(rJacobian, 25, 18) = 0.00071604938271604935 + 0.044444444444444439 * var_x265 - 0.044444444444444439 * var_x263;
        IJth(rJacobian, 26, 18) = 2.8000000000000003 - var_x258;
        IJth(rJacobian, 27, 18) = 2.8000000000000003 - var_x259;
        IJth(rJacobian, 28, 18) = 0.23263270295076435 * var_x125 - var_x292 * var_x41;
        IJth(rJacobian, 29, 18) = -var_x321;
        IJth(rJacobian, 30, 18) = var_x321;
        ...
        IJth(rJacobian, 19, 19) = var_x270 * (-5490.7343857240912 - var_x273 - var_x274) + 0.00023800000000000004 * (143.30816746739879 * var_x275 + 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Cai - 5490.7343857240912 * var_chaste_interface__calcium_subsystem__Ca_SS - var_x119 * var_x271) / (pow(var_x268, 3) * pow(var_x269, 2));
        IJth(rJacobian, 20, 19) = var_x278 - var_x279;
        IJth(rJacobian, 21, 19) = var_x279;
        IJth(rJacobian, 22, 19) = -var_x278;
        IJth(rJacobian, 24, 19) = var_x284 * (var_x285 + var_x286);
        IJth(rJacobian, 19, 20) = var_x276;
        IJth(rJacobian, 20, 20) = -0.16049999999999998 - var_x280;
        IJth(rJacobian, 21, 20) = var_x280;
        IJth(rJacobian, 22, 20) = 0.14249999999999999;
        IJth(rJacobian, 23, 20) = 0.017999999999999999;
        IJth(rJacobian, 24, 20) = var_x287;
        IJth(rJacobian, 19, 21) = var_x276;
        IJth(rJacobian, 20, 21) = 1.9299999999999999;
        IJth(rJacobian, 21, 21) = -1.9299999999999999;
        IJth(rJacobian, 24, 21) = var_x287;
        IJth(rJacobian, 20, 22) = var_x281;
        IJth(rJacobian, 22, 22) = -var_x281;
        IJth(rJacobian, 20, 23) = 0.00080000000000000004;
        IJth(rJacobian, 23, 23) = -0.00080000000000000004;
        IJth(rJacobian, 19, 24) = var_x270 * (var_x273 + var_x274);
        IJth(rJacobian, 24, 24) = var_x284 * (-0.029002320185614851 - var_x285 - var_x286) + 0.16666666666666666 * (0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_NSR - 1.8 * var_x275 - 0.029002320185614851 * var_chaste_interface__calcium_subsystem__Ca_JSR) / (pow(var_x282, 3) * pow((0.083333333333333329 + var_x283), 2));
        IJth(rJacobian, 25, 24) = 0.0016613674772994187;
        IJth(rJacobian, 18, 25) = 5.8e-5 * var_x257;
        IJth(rJacobian, 24, 25) = 0.029002320185614851 * var_x284;
        IJth(rJacobian, 25, 25) = -0.0023774168600154679;
        IJth(rJacobian, 18, 26) = var_x257 * (6.6000000000000005e-5 + var_x266);
        IJth(rJacobian, 26, 26) = -6.6000000000000005e-5 - var_x266;
        IJth(rJacobian, 18, 27) = var_x257 * (0.040000000000000001 + var_x267);
        IJth(rJacobian, 27, 27) = -0.040000000000000001 - var_x267;
        ...
        IJth(rJacobian, 28, 28) = var_x296 - 0.020902907402832696 * var_x129 - 1.1350943583223629e-5 * var_x136 - 4.5780488190019227e-7 * var_x128 - 2.3025858935932891e-6 * var_x81 - var_x130 * var_x293;
        IJth(rJacobian, 29, 28) = var_x323 + var_x329 - var_x322 - var_x324;
        IJth(rJacobian, 30, 28) = var_x322 + var_x324 + var_x351 - var_x323;
        ...
        IJth(rJacobian, 28, 29) = var_x296 - var_x298 * var_chaste_interface__ionic_concentrations__Nai;
        IJth(rJacobian, 29, 29) = var_x329 + var_x336 - var_x331 - var_x332 - var_x333 - var_x334 - var_x335 - var_x338;
        IJth(rJacobian, 30, 29) = var_x331 + var_x332 + var_x333 + var_x334 + var_x335 + var_x338 + var_x351 - var_x336;
        ...
        IJth(rJacobian, 28, 30) = 0.00010635506760017689 * var_x159 - 0.000239298902100398 * var_x157 + var_x161 * var_x294 + var_x167 * var_x297 - var_x161 * var_x295;
        IJth(rJacobian, 29, 30) = var_x337 + var_x339 + var_x340 + var_x341 + var_x342 + var_x343 - var_x344 - var_x345 - var_x346 - var_x347 - var_x348 - var_x349 - var_x350;
        IJth(rJacobian, 30, 30) = var_x344 + var_x345 + var_x346 + var_x347 + var_x348 + var_x349 + var_x350 - var_x337 - var_x339 - var_x340 - var_x341 - var_x342 - var_x343;
    }
