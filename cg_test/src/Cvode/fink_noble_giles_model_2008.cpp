...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellfink_noble_giles_model_2008FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x154 = pow(var_x153, (-2)) - var_chaste_interface__iNa_m_gate__m;
        ...
        const double var_x160 = pow(var_x159, (-2));
        ...
        const double var_x181 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x182 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x183 = -25428.0 * var_x181 - 6.9480000000000002e-6 * var_x182;
        ...
        const double var_x232 = 2.2487821987979791e-6 * var_x69;
        const double var_x233 = 1.0 + 6.2499999999999997e-8 / pow(var_chaste_interface__Ca__Ca_i, 2);
        const double var_x234 = 1 / (pow(var_x233, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x235 = 1 / var_x233;
        const double var_x236 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_SR;
        const double var_x237 = pow(var_x236, (-2));
        const double var_x238 = 1 / (1.0 + 3.0 * var_x237);
        const double var_x239 = pow(var_chaste_interface__Ca__Ca_SR, (-2));
        const double var_x240 = 1 / (1.0 + 2.25 * var_x239);
        const double var_x241 = 1 / (2.5 - 1.5 * var_x240);
        const double var_x242 = var_x225 * var_x241;
        const double var_x243 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x242);
        const double var_x244 = var_x243 * var_chaste_interface__Irel__R_prime;
        const double var_x245 = var_x242 * var_x244;
        const double var_x246 = 0.045899999999999996 * var_x245;
        const double var_x247 = 1 / (pow((0.44444444444444442 + var_x239), 2) * pow(var_chaste_interface__Ca__Ca_SR, 3));
        const double var_x248 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_SR;
        const double var_x249 = var_x248 / pow((1 - 0.59999999999999998 * var_x240), 2);
        const double var_x250 = var_x225 * var_x244 * var_x247 * var_x249;
        const double var_x251 = var_x247 * var_chaste_interface__Irel__R_prime;
        const double var_x252 = var_x249 / pow((0.40000000000000002 + var_x242), 2);
        const double var_x253 = var_x241 * var_x251 * var_x252 * pow(var_chaste_interface__Ca__Ca_ss, 4);
        const double var_x254 = var_x252 * pow(var_chaste_interface__Ca__Ca_ss, 3) * var_chaste_interface__Irel__R_prime;
        const double var_x255 = var_x241 * var_x244 * var_x248 * var_chaste_interface__Ca__Ca_ss;
        const double var_x256 = var_x242 * var_x243 * var_x248;
        const double var_x257 = 0.00025000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x258 = 1.0 + 0.0001 / pow(var_x257, 2);
        const double var_x259 = 1 / var_x258;
        const double var_x260 = 0.0031491568724328674 * var_x47;
        const double var_x261 = var_x260 * var_x45;
        const double var_x262 = var_x259 * var_x260;
        const double var_x263 = var_x262 * var_x64;
        const double var_x264 = var_x262 * var_x66;
        const double var_x265 = 0.91833577176298453 * var_x245;
        const double var_x266 = -0.11249999999999999 + 0.067500000000000004 * var_x240;
        const double var_x267 = 0.00079924407711721393 * var_x32;
        const double var_x268 = 1.0050926558006126e-5 * var_x21;
        const double var_x269 = -4.3801480314950888e-5 * var_x54 - 5.7589183215629007e-6 * var_x53;
        const double var_x270 = 0.00038819663608706523 * var_x5 - 1.4531710493040254e-5 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 11, 0) = 5.1020408163265302e-7 * (1 / var_x130 - var_chaste_interface__iKs_Xs_gate__Xs) * (93.333333333333329 * var_x124 * var_x125 / pow(var_x126, 2) - 116.66666666666667 * var_x122 * var_x127 / pow(var_x123, (3 / 2))) / pow((0.057142857142857141 + var_x128), 2) + 0.071428571428571425 * var_x129 * var_x131 / pow(var_x130, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (1 / var_x138 - var_chaste_interface__ito_s_gate__s) * (-var_x139 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__cell__V) + 1.0 * var_x133 / pow(var_x134, 2)) / pow((0.035294117647058823 + var_x136 + 0.058823529411764705 * var_x135), 2) - 0.20000000000000001 * var_x137 * var_x140 / pow(var_x138, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x141 * var_x144 / pow(var_x142, 2) - 0.10526315789473684 * var_x143 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__cell__V) * (1 / var_x142 - var_chaste_interface__ito_r_gate__r) / pow((0.084210526315789472 + var_x143), 2);
        ...
        IJth(rJacobian, 21, 0) = var_x231 * (-1.7205545223759661e-8 + 3.0642541604521007e-12 * var_x35 + 1.2593500345045236e-9 * var_x30);
        IJth(rJacobian, 23, 0) = var_x259 * (-var_x261 + 0.00023577038909270109 * var_x51 - 5.8942597273175273e-5 * var_x52);
        IJth(rJacobian, 25, 0) = -2.1070980214908366e-8 - 9.1927624813563017e-12 * var_x35 - 3.7780501035135707e-9 * var_x30 - 0.00023854029832302029 * var_x41 - var_x267 * var_chaste_interface__iNa_h_gate__h;
        IJth(rJacobian, 26, 0) = var_x269 + 0.00015902686554868019 * var_x41 - 1.7438052591648303e-6 * var_chaste_interface__iKr_Markov__Or4 - 1.4531710493040254e-5 * var_x23 - 1.1822202600107163e-7 * var_x36 - 7.0696771548640841e-7 * var_x3 - 2.8482152566358896e-6 * var_x0 + var_x6 * (2.3119525668406228e-8 * var_x9 - 3.4651837760272254e-7 * var_x17 - var_x20 * var_x268);
        ...
        IJth(rJacobian, 26, 12) = var_x270 * var_chaste_interface__ito_r_gate__r;
        ...
        IJth(rJacobian, 26, 13) = var_x270 * var_chaste_interface__ito_s_gate__s;
        ...
        IJth(rJacobian, 25, 15) = -var_x267 * var_x60;
        ...
        IJth(rJacobian, 23, 17) = -var_x263 * var_chaste_interface__iCaL_f_gate__f;
        ...
        IJth(rJacobian, 23, 18) = -var_x263 * var_chaste_interface__iCaL_d_gate__d;
        ...
        IJth(rJacobian, 23, 19) = -var_x264 * var_chaste_interface__iCaL_fCass_gate__fCass;
        ...
        IJth(rJacobian, 23, 20) = -var_x264 * var_chaste_interface__iCaL_f2_gate__f2;
        ...
        IJth(rJacobian, 21, 21) = var_x231 * (-0.0038240087783467445 - var_x232 + 2.2487821987979791e-6 * var_x71 - 0.0086391412367010315 * var_x72 - 5.3144431236283834e-11 * var_x234 - 2.298124085635426e-7 * var_x70) + 0.00040000000000000002 * (0.0038 * var_chaste_interface__Ca__Ca_ss + 2.40087783467447e-5 * var_chaste_interface__Ca__Ca_SR + 2.298124085635426e-7 * log(2.0 * var_x70) - 0.0038240087783467445 * var_chaste_interface__Ca__Ca_i - 1.7205545223759661e-8 * var_chaste_interface__cell__V - 0.00042515544989027063 * var_x235 - var_x232 * var_chaste_interface__Ca__Ca_i + 1.2593500345045236e-9 * var_x26 * var_x34) / (pow(var_x229, 3) * pow(var_x230, 2));
        IJth(rJacobian, 22, 21) = var_x238 * (0.00036000000000000002 + 7.96875e-10 * var_x234);
        IJth(rJacobian, 23, 21) = 1.1399999999999999 * var_x259;
        IJth(rJacobian, 25, 21) = 0.025917423710103096 * var_x72;
        IJth(rJacobian, 21, 22) = 2.40087783467447e-5 * var_x231;
        IJth(rJacobian, 22, 22) = var_x238 * (-0.00036000000000000002 - var_x246 + 0.065280000000000005 * var_x253 - 0.0097919999999999986 * var_x250) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__Ca__Ca_i + 0.0063749999999999996 * var_x235 - 0.00036000000000000002 * var_chaste_interface__Ca__Ca_SR - var_x246 * var_x248) / (pow(var_x236, 3) * pow((0.33333333333333337 + var_x237), 2));
        IJth(rJacobian, 23, 22) = var_x259 * (var_x265 + 0.1959116313094367 * var_x250 - 1.3060775420629114 * var_x253);
        IJth(rJacobian, 24, 22) = 0.059999999999999998 * var_x251 * var_chaste_interface__Ca__Ca_ss;
        ...
        IJth(rJacobian, 22, 23) = var_x238 * (var_x246 + 0.097919999999999993 * var_x254 - 0.091799999999999993 * var_x255);
        IJth(rJacobian, 23, 23) = var_x259 * (-1.1399999999999999 - var_x265 + 1.8366715435259691 * var_x255 - 0.00078728921810821686 * var_x73 - 1.9591163130943672 * var_x254) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__Ca__Ca_i - 1.1399999999999999 * var_chaste_interface__Ca__Ca_ss + var_x248 * var_x265 - var_x261 * var_x49) / (pow(var_x257, 3) * pow(var_x258, 2));
        IJth(rJacobian, 24, 23) = var_x266 * var_chaste_interface__Irel__R_prime;
        IJth(rJacobian, 22, 24) = -0.045899999999999996 * var_x238 * var_x256;
        IJth(rJacobian, 23, 24) = 0.91833577176298453 * var_x256 * var_x259;
        IJth(rJacobian, 24, 24) = -0.0050000000000000001 + var_x266 * var_chaste_interface__Ca__Ca_ss;
        ...
        IJth(rJacobian, 26, 26) = -4.6583596330447822e-5 * var_x84 - 1.8885766345635723e-5 * var_x85 - 0.00038819663608706523 * var_x86 - 0.00073043079046142181 * var_x78 + var_x269 * var_x83 + var_x6 * (6.576305692690868e-7 * var_x80 - 9.8566502268897146e-6 * var_x82 - var_x268 * var_x81);
    }
