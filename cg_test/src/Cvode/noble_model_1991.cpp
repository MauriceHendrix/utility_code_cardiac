...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellnoble_model_1991FromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x49 = 1.0 * var_chaste_interface__intracellular_sodium_concentration__Na_i + 0.12 * var_chaste_interface__intracellular_potassium_concentration__K_i;
        ...
        const double var_x121 = 1.1825880081379952e-8 * var_x33;
        ...
        IJth(rJacobian, 1, 0) = 7.7999999999999999e-5 * var_x74 * var_chaste_interface__time_dependent_potassium_current_x_gate__x + 4.1300000000000001e-5 * var_x75 * var_x79 - 5.2000000000000004e-5 * var_x71 * var_x73 * var_chaste_interface__time_dependent_potassium_current_x_gate__x / pow(var_x72, 2) - 2.8500000000000002e-5 * var_x75 * var_x76 * var_x78 / pow(var_x77, 2);
        ...
        IJth(rJacobian, 10, 0) = -3.7909647610109532e-7 + 2.2134435192462872e-9 * var_x46 - 9.477411902527384e-7 * var_x14 - 3.0988209269448018e-7 * var_x42 - 0.0015795686504212307 * var_x7 - var_x120 * var_x31;
        IJth(rJacobian, 11, 0) = -3.7909647610109532e-7 + 1.3515291521577086e-5 * var_x19 + 4.4268870384925742e-10 * var_x45 - 6.7576457607885431e-7 * var_x18 - 3.1591373008424612e-6 * var_x15 - 0.00018052213147671208 * var_x5 - 1.7707548153970297e-9 * var_x42 - var_x121 * var_x31;
        ...
        IJth(rJacobian, 1, 1) = -0.00050000000000000001 * var_x79 - 0.0013000000000000002 * var_x74;
        ...
        IJth(rJacobian, 2, 2) = -0.001 * ((var_x81) ? (2000.0) : (var_x80 * var_x85)) - 8.0 * var_x86;
        ...
        IJth(rJacobian, 10, 3) = -0.0015795686504212307 * var_x52;
        ...
        IJth(rJacobian, 10, 10) = 6.634188331769168e-7 * var_x60 - 1.0127092529498693e-5 * var_x59 - 5.9129400406899753e-8 * var_x63 - 0.0010614701330830668 * var_x58 - 5.9277248272665686 * var_x62 - 5.6864471415164302e-6 * var_x61;
        ...
        IJth(rJacobian, 11, 11) = 0.00036104426295342415 * var_x66 - 0.004822425014046997 * var_x64 - 1.0127092529498693e-5 * var_x1 - 4.5130532869178019e-6 * var_chaste_interface__time_dependent_potassium_current_x_gate__x - 8.4392437745822447e-5 * var_x65 - 1.1825880081379952e-8 * var_x63;
        ...
        IJth(rJacobian, 12, 12) = -7.0000000000000009 + var_x130 + var_x131 + 0.00040000000000000002 * var_x135 - 0.86686727535117136 * var_x68 - 1.1825880081379951e-5 * var_x70 - 7.2e-9 * var_x136 - 1.0549054718227806e-6 * var_x67 - 2.1798047375812981e-9 * var_x69 - 0.00040000000000000002 * var_x133;
        ...
        IJth(rJacobian, 12, 13) = 7.2e-9 * var_x133 + 9.5999999999999999e-8 * var_x135 - 1.7279999999999999e-12 * var_x136;
        IJth(rJacobian, 13, 13) = -0.050000000000000003 + 8.4671999999999982e-11 * var_x136 - 3.5279999999999993e-7 * var_x133 - 4.7040000000000002e-6 * var_x135;
