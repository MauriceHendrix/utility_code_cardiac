...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x20 = exp(0.43983232 + 0.080320000000000003 * var_chaste_interface__cell__V - 2.1455350448257708 * var_x13);
        const double var_x21 = exp(-36.698642499999998 + 0.061749999999999999 * var_chaste_interface__cell__V - 1.6494869150646332 * var_x13);
        const double var_x22 = var_x21 + 0.49124000000000001 * var_x20;
        ...
        const double var_x84 = 0.24326999999999999 * var_x59 - 0.51429999999999998 * var_x83 - var_x19 * (0.061749999999999999 * var_x21 + 0.039456396800000001 * var_x20);
        ...
        const double var_x100 = var_x99 * NV_Ith_S(mParameters, 0);
        const double var_x101 = var_x100 * var_x97;
        const double var_x102 = var_x101 * var_x94 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca2;
        const double var_x103 = 3.5108651860830804 * var_chaste_interface__ICaL__fca;
        const double var_x104 = var_x102 * var_x103;
        const double var_x105 = pow(var_x98, 2);
        const double var_x106 = var_x95 * var_x97 * NV_Ith_S(mParameters, 0) / var_x105;
        const double var_x107 = -15.0 + var_chaste_interface__cell__V;
        const double var_x108 = var_x107 * var_x94 * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__fca2;
        const double var_x109 = var_x108 * var_chaste_interface__ICaL__fca;
        const double var_x110 = var_x109 * var_chaste_interface__ICaL__f2;
        const double var_x111 = 0.26286468023559356 * var_x110;
        const double var_x112 = var_x100 * var_x96;
        const double var_x113 = 0.00050000000000000001 + var_chaste_interface__Ca__Ca_i;
        const double var_x114 = 1 / var_x113;
        const double var_x115 = pow(var_x113, (-2));
        const double var_x116 = var_x115 * var_chaste_interface__Ca__Ca_i;
        const double var_x117 = var_x54 * var_x8;
        const double var_x118 = var_x65 * var_x73;
        const double var_x119 = var_x72 * var_x91 / pow((0.0020299076937277489 + 1.2903323313862536e-6 * var_x62 + var_chaste_interface__Ca__Ca_i), 2);
        const double var_x120 = var_x69 * var_x92 / (pow(var_x70, 2) * pow(var_chaste_interface__Ca__Ca_i, 3));
        const double var_x121 = 0.018329999999999999 * var_chaste_interface__Na__Na_i + var_chaste_interface__K__K_i;
        const double var_x122 = -26.712338705500134 * log(7.9662000000000006 / var_x121) + var_chaste_interface__cell__V;
        const double var_x123 = var_x122 * var_chaste_interface__IKs__xs1;
        const double var_x124 = var_x123 * var_x26 * var_x27 * var_chaste_interface__IKs__xs2 / pow(var_x28, 2);
        const double var_x125 = 1 / var_chaste_interface__Na__Na_i;
        const double var_x126 = log(140.0 * var_x125);
        const double var_x127 = -26.712338705500134 * var_x126 + var_chaste_interface__cell__V;
        const double var_x128 = var_x127 * NV_Ith_S(mParameters, 1) * var_chaste_interface__INa__H;
        const double var_x129 = var_x128 * pow(var_chaste_interface__INa__m, 2) * var_chaste_interface__INa__J;
        const double var_x130 = var_x128 * var_x75;
        const double var_x131 = var_x104 * var_x107;
        const double var_x132 = var_chaste_interface__ICaL__dp / var_chaste_interface__ICaL__d;
        const double var_x133 = log(var_chaste_interface__ICaL__d);
        const double var_x134 = var_x101 * var_x107 * var_x94 * var_chaste_interface__ICaL__f2;
        const double var_x135 = var_x103 * var_x134;
        const double var_x136 = var_x102 * var_x107;
        const double var_x137 = var_x103 * var_x108;
        const double var_x138 = var_x79 * var_x89;
        const double var_x139 = var_x138 * pow(var_chaste_interface__Ito__ydv, 2) * var_chaste_interface__Ito__zdv;
        const double var_x140 = var_x138 * var_x78;
        const double var_x141 = var_x127 * pow(var_chaste_interface__INal__mL, 2) * var_chaste_interface__INal__hL;
        const double var_x142 = 1 / (var_x49 * var_x62 * pow((0.01 + var_x45), 2));
        const double var_x143 = var_x125 * var_x3 * var_chaste_interface__INal__hL;
        const double var_x144 = var_x119 * var_x44;
        const double var_x145 = (0.12553036579548593 * var_chaste_interface__K__K_i + 0.002300971605031257 * var_chaste_interface__Na__Na_i) / pow(var_x121, 2);
        const double var_x146 = var_x145 * var_x32;
        const double var_x147 = var_x44 * var_x63 * var_x73;
        const double var_x148 = var_x125 * var_x76 * var_chaste_interface__INa__H;
        const double var_x149 = var_x12 * var_x2;
        const double var_x150 = var_x12 * var_x25;
        const double var_x151 = var_x12 * var_x35 * var_chaste_interface__IKr__xr;
        const double var_x152 = var_x12 * var_x59;
        const double var_x153 = 6.4983106368870169 * var_x152 - var_x19 * (1.6494869150646332 * var_x12 * var_x21 + 1.0539726354202117 * var_x12 * var_x20) - 13.738155796238718 * var_x12 * var_x83;
        const double var_x154 = var_x152 * var_x60;
        const double var_x155 = var_x12 * var_x80 * var_chaste_interface__Ito__ydv2;
        const double var_x156 = 1 / var_chaste_interface__Cl__Cl_i;
        const double var_x157 = var_x100 * var_x95;
        const double var_x158 = var_x157 * var_chaste_interface__ICaL__f2;
        const double var_x159 = 0.0023800000000000002 + var_chaste_interface__Ca__Ca_i;
        const double var_x160 = 1.0 + 0.00011900000000000002 / pow(var_x159, 2) + 3.5000000000000004e-5 * var_x115;
        const double var_x161 = 1 / var_x160;
        const double var_x162 = 8.8666719524733664e-8 * var_x11;
        const double var_x163 = 1.768721357868101e-6 * var_x114;
        ...
        const double var_x213 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x214 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x215 = -127140.0 * var_x213 - 3.4740000000000003e-5 * var_x214;
        ...
        const double var_x239 = var_x102 * var_chaste_interface__ICaL__fca;
        const double var_x240 = 5.2572936047118706 * var_x110;
        const double var_x241 = 1 / (1.0 + 333.33333333333331 * var_chaste_interface__Ca__Ca_ss);
        const double var_x242 = 10.0 * var_x172;
        const double var_x243 = 1 / (0.5 + var_x241 + var_x242);
        const double var_x244 = var_x136 * var_chaste_interface__ICaL__fca;
        ...
        const double var_x249 = var_x132 * var_x244;
        const double var_x250 = var_x133 * var_x244;
        const double var_x251 = var_x134 * var_chaste_interface__ICaL__fca;
        ...
        const double var_x255 = var_x101 * var_x109;
        ...
        const double var_x259 = var_x109 * var_x158;
        const double var_x260 = 0.00075000000000000002 * var_x191 - 0.00075000000000000002 * var_x190;
        const double var_x261 = exp(-4.375 - 87.77162965207701 * var_x244);
        const double var_x262 = 1.0 + var_x261;
        const double var_x263 = 1 / var_x262;
        const double var_x264 = 1 / (125.0 + 300.0 * var_x263);
        const double var_x265 = 26.286468023559355 * var_x110;
        const double var_x266 = pow((0.0028483007663294996 + var_x245), (-2));
        const double var_x267 = 8.1128172554732154e-6 * var_x266;
        const double var_x268 = 6.5716170058898387 * var_x110;
        const double var_x269 = var_x261 * (1 / (1.0 - 351.08651860830804 * var_x244) - var_chaste_interface__ICaL__fca2) / (pow(var_x262, 2) * pow((0.41666666666666669 + var_x263), 2));
        const double var_x270 = 0.0028483007663294996 * var_x264 * var_x266;
        ...
        const double var_x310 = 1.0 * var_chaste_interface__Ito__ydv;
        ...
        const double var_x333 = var_x105 * var_x326 * var_x327 * var_x328 * var_x329 * var_x330 * var_x331 * var_x332;
        ...
        const double var_x337 = var_x105 * var_x327 * var_x328 * var_x330 * var_x332 * var_x334;
        ...
        const double var_x349 = var_x105 * var_x347;
        ...
        const double var_x366 = 17.524312015706236 * var_x110;
        const double var_x367 = var_x354 / pow(var_x355, 2);
        const double var_x368 = var_x367 * (234.05767907220539 * var_x239 + var_x112 * var_x366 - var_x106 * var_x366);
        const double var_x369 = (1 / var_x358 - var_chaste_interface__Irel__ri) / pow((0.29999999999999999 + var_x172 + 0.10000000000000001 * var_x363), 2);
        ...
        const double var_x381 = log(100.0 * var_x156);
        const double var_x382 = var_x126 + var_x381;
        ...
        const double var_x386 = var_x125 * var_x384 - var_x125 * var_x385;
        const double var_x387 = var_x156 * var_x384 - var_x156 * var_x385;
        ...
        const double var_x394 = var_x145 * var_x390;
        ...
        const double var_x399 = var_x156 * var_x397 - var_x156 * var_x396;
        ...
        const double var_x405 = 0.70217303721661617 * var_x101;
        const double var_x406 = 0.052572936047118712 * var_x107;
        const double var_x407 = exp(2.6000000000000001 + var_x107 * var_x405);
        ...
        const double var_x412 = var_x411 * (var_x405 + var_x112 * var_x406 - var_x106 * var_x406);
        ...
        const double var_x419 = var_x107 * var_x157 * var_x411;
        const double var_x420 = 0.0043750000000000004 * var_chaste_interface__Ca__Ca_i;
        const double var_x421 = var_x179 * var_x420;
        const double var_x422 = var_x174 * var_x420;
        const double var_x423 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x424 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x425 = 1.0 + 0.0097788000000000007 / pow(var_x423, 2) + 4.0890000000000003e-5 / pow(var_x424, 2);
        const double var_x426 = 1 / var_x425;
        const double var_x427 = 0.0002749177168957104 * var_x110;
        const double var_x428 = 0.0036718475849305066 * var_x426;
        const double var_x429 = 719.99999999999989 * var_x426;
        const double var_x430 = 719.99999999999989 * var_x417;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x32 - var_x104 + 0.00021581774391076088 * var_x55 + 0.00089962337662337659 * var_x87 + 0.005408738276452542 * var_x58 + 0.12163499999999999 * var_x61 - 4.5 * var_x74 - 0.0027599999999999999 * var_x2 - 0.00021581774391076088 * var_x82 - 5.4087382764525417e-5 * var_x88 - 0.0028824983370005666 * var_x11 - 0.48423913043478262 * var_x50 - 0.51000000000000001 * var_x25 - 0.0006333333333333333 * var_x90 - 0.00046153846153846147 * var_x53 - 0.029564989000285053 * var_x93 + var_x106 * var_x111 - var_x111 * var_x112 - var_x36 * var_chaste_interface__IKr__xr - var_x4 * var_chaste_interface__INal__hL - var_x43 * var_chaste_interface__Ito2__AA - var_x77 * var_chaste_interface__INa__H - var_x81 * var_chaste_interface__Ito__ydv2 - var_x84 * var_x86);
        IJth(rJacobian, 1, 0) = var_x161 * (-var_x162 + 1.8188600866065964e-6 * var_x93 + 6.6386339662934098e-9 * var_x55 + 0.00027684334297065928 * var_x74 - 6.6386339662934098e-9 * var_x82);
        ...
        IJth(rJacobian, 4, 0) = (1.0 - var_chaste_interface__INa__J) * ((var_x194) ? (0) : (var_x216 + var_x212 * var_x217 * (1.5254334000000001e-6 * var_x214 - 31073.016 * var_x213) - 0.311 * var_x210 * var_x215 * var_x217 / pow(var_x211, 2))) - ((var_x194) ? (-7.6049999999999996e-8 * var_x221 + 0.029999999999999999 * var_x218 * var_x220 / pow(var_x219, 2)) : (-0.001275024 * var_x225 + 0.016701360000000002 * var_x222 * var_x224 / pow(var_x223, 2))) * var_chaste_interface__INa__J;
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (1 / var_x231 - var_chaste_interface__ICaL__d) * (-0.041599999999999998 * var_x229 + 0.10560000000000001 * var_x226 * var_x228 / pow(var_x227, 2)) / pow((0.73749999999999993 + var_x229), 2) + 0.14836795252225518 * var_x230 * var_x232 / pow(var_x231, 2);
        ...
        IJth(rJacobian, 8, 0) = 6.0846129416049119e-5 * var_x247 * (70.217303721661608 * var_x239 + var_x112 * var_x240 - var_x106 * var_x240);
        IJth(rJacobian, 9, 0) = 0.0033333333333333335 * var_x269 * (-87.77162965207701 * var_x239 + var_x106 * var_x268 - var_x112 * var_x268) + var_x264 * var_x267 * (351.08651860830804 * var_x239 + var_x112 * var_x265 - var_x106 * var_x265);
        ...
        IJth(rJacobian, 11, 0) = (1 / var_x274 - var_chaste_interface__IKr__xr) * (var_x277 + var_x280 - 8.1600000000000005e-5 * var_x278 * var_x281 / pow(var_x279, 2) - 4.566e-5 * var_x275 * var_x282 / pow(var_x276, 2)) + 0.23529411764705882 * var_x273 * (var_x283 + var_x284) / pow(var_x274, 2);
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x301 + var_x298 * (var_x287 - var_chaste_interface__IKs__xs1);
        ...
        IJth(rJacobian, 28, 0) = var_x426 * (-719.99999999999989 * var_x412 - 0.0036718475849305066 * var_x239 + var_x106 * var_x427 - var_x112 * var_x427);
        IJth(rJacobian, 0, 1) = mSetVoltageDerivativeToZero ? 0.0 : (18522000.0 * var_x118 + 0.057500000000000002 * var_x116 + 6.9055124202402519e-7 * var_x119 - 0.057500000000000002 * var_x114 - 1.3556015675697155e-8 * var_x124 - 0.0028824983370005666 * var_x117 - 6.2499999999999997e-8 * var_x120);
        IJth(rJacobian, 1, 1) = var_x161 * (-0.14705882352941174 + var_x180 - var_x163 - var_x177 + 3.8450464301480458e-12 * var_x120 + 1.768721357868101e-6 * var_x116 - 4.2483225407660435e-11 * var_x119 - 1139.4871996672337 * var_x118 - 8.8666719524733664e-8 * var_x117) + (0.00023800000000000004 / pow(var_x159, 3) + 7.0000000000000007e-5 / pow(var_x113, 3)) * (0.14705882352941174 * var_chaste_interface__Ca__Ca_ss + 2.3676470588235295e-5 * var_chaste_interface__Ca__Ca_nsr - 0.14705882352941174 * var_chaste_interface__Ca__Ca_i - var_x162 * var_chaste_interface__cell__V - var_x163 * var_chaste_interface__Ca__Ca_i - var_x177 * var_chaste_interface__Ca__Ca_i + 0.00027684334297065928 * var_x73 * var_x91) / pow(var_x160, 2);
        IJth(rJacobian, 23, 1) = 1.274496762229813e-10 * var_x119 + 3418.461599001701 * var_x118 - 1.1535139290444137e-11 * var_x120;
        IJth(rJacobian, 24, 1) = -8.3397615489392458e-13 * var_x124;
        IJth(rJacobian, 27, 1) = -var_x421 + 0.0043750000000000004 * var_x176;
        IJth(rJacobian, 28, 1) = 5.0 * var_x426;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x127 * var_x77);
        ...
        IJth(rJacobian, 23, 2) = -var_x127 * var_x380;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-24.75 * var_x129);
        IJth(rJacobian, 3, 3) = var_x209;
        IJth(rJacobian, 23, 3) = -0.001522638386338626 * var_x129;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-8.25 * var_x130);
        IJth(rJacobian, 4, 4) = -((var_x194) ? (0) : (var_x216 * var_x217)) - ((var_x194) ? (0.29999999999999999 * var_x221) : (0.1212 * var_x225));
        IJth(rJacobian, 23, 4) = -0.00050754612877954204 * var_x130;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x131 * var_x132);
        IJth(rJacobian, 5, 5) = -var_x232;
        IJth(rJacobian, 8, 5) = var_x248 * var_x249;
        IJth(rJacobian, 9, 5) = var_x249 * var_x270 - var_x249 * var_x271;
        IJth(rJacobian, 21, 5) = var_x132 * var_x348;
        IJth(rJacobian, 22, 5) = var_x249 * var_x373 - var_x249 * var_x375;
        IJth(rJacobian, 28, 5) = -var_x249 * var_x428;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x131 * var_x133);
        ...
        IJth(rJacobian, 21, 6) = var_x133 * var_x348;
        IJth(rJacobian, 22, 6) = var_x250 * var_x373 - var_x250 * var_x375;
        IJth(rJacobian, 28, 6) = -var_x250 * var_x428;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x135 * var_chaste_interface__ICaL__fca2);
        ...
        IJth(rJacobian, 28, 7) = -var_x252 * var_x428;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-3.5108651860830804 * var_x136);
        IJth(rJacobian, 8, 8) = var_x243 * (-1 + var_x136 * var_x253);
        IJth(rJacobian, 9, 8) = var_x136 * var_x270 - var_x136 * var_x271;
        IJth(rJacobian, 21, 8) = var_x337 * var_x347 * var_x350 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x136 * var_x373 - var_x136 * var_x375;
        IJth(rJacobian, 28, 8) = -var_x136 * var_x428;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x135 * var_chaste_interface__ICaL__f);
        IJth(rJacobian, 8, 9) = var_x248 * var_x254;
        IJth(rJacobian, 9, 9) = var_x264 * (-1 + 351.08651860830804 * var_x107 * var_x267 * var_x94 * var_x97 * var_x99 * NV_Ith_S(mParameters, 0) * var_chaste_interface__ICaL__f * var_chaste_interface__ICaL__f2 * var_chaste_interface__ICaL__fca) - var_x254 * var_x271;
        ...
        IJth(rJacobian, 28, 9) = -var_x254 * var_x428;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x101 * var_x137);
        ...
        IJth(rJacobian, 28, 10) = -var_x255 * var_x428;
        ...
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x122 * var_x31);
        IJth(rJacobian, 12, 12) = -var_x299 - var_x300;
        IJth(rJacobian, 24, 12) = var_x122 * var_x389;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x123 * var_x30);
        IJth(rJacobian, 13, 13) = -3.8050000000000003e-5 * var_x290 * var_x297 - 0.00018000000000000001 * var_x294 * var_x296;
        IJth(rJacobian, 24, 13) = var_x123 * var_x388;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (-0.57000000000000006 * var_x139);
        IJth(rJacobian, 14, 14) = -25.0 * var_x305 - 25.0 * var_x309;
        IJth(rJacobian, 24, 14) = -3.5066823442950178e-5 * var_x139;
        ...
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (-0.19 * var_x140);
        IJth(rJacobian, 16, 16) = -0.10000000000000001 * var_x316 - 0.0022499999999999998 * var_x320;
        IJth(rJacobian, 24, 16) = -1.1688941147650058e-5 * var_x140;
        ...
        IJth(rJacobian, 0, 18) = mSetVoltageDerivativeToZero ? 0.0 : (-0.0195 * var_x141);
        IJth(rJacobian, 18, 18) = var_x209;
        IJth(rJacobian, 23, 18) = -1.1996544862061903e-6 * var_x141;
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x127 * var_x4);
        IJth(rJacobian, 19, 19) = -0.0016666666666666668;
        IJth(rJacobian, 23, 19) = -var_x127 * var_x379;
        IJth(rJacobian, 1, 20) = var_x161 * (-var_x180 * var_x187 - var_x185 * var_x186);
        ...
        IJth(rJacobian, 27, 20) = var_x185 * var_x422 + var_x187 * var_x421;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = -var_x404 * var_x415;
        IJth(rJacobian, 28, 21) = var_x415 * var_x429;
        IJth(rJacobian, 22, 22) = -var_x364;
        IJth(rJacobian, 26, 22) = -var_x404 * var_x416;
        IJth(rJacobian, 28, 22) = var_x416 * var_x429;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (2.6731217821876006e-12 * var_x144 + 3.9005476114801918 * var_x146 - 24.300000000000001 * var_x147 - 220.37679432037609 * var_x148 - 0.0096847826086956523 * var_x142 - 0.17363020158575085 * var_x143);
        IJth(rJacobian, 1, 23) = var_x161 * (0.0014949540520415602 * var_x147 - 1.6445243785522266e-16 * var_x144);
        IJth(rJacobian, 23, 23) = var_x386 + 4.9335731356566794e-16 * var_x144 - 1.7874450622236046e-6 * var_x142 - 1.068185898837083e-5 * var_x143 - 0.013557744100624516 * var_x148 - 0.0044848621561246801 * var_x147;
        IJth(rJacobian, 24, 23) = 3.9005476114801918 * var_x394 + 1.191630041482403e-6 * var_x142;
        IJth(rJacobian, 25, 23) = var_x386;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (3.2491553184435085 * var_x154 + 212.79583259575517 * var_x146 - 0.37007808289373995 * var_x151 - 0.073726054827180365 * var_x149 - 5.0753443540450256 * var_x155 - 13.623292739805068 * var_x150 - var_x153 * var_x86);
        IJth(rJacobian, 24, 24) = var_x398 + 212.79583259575517 * var_x394 + 0.00019989044893084398 * var_x154 - 4.535681662754383e-6 * var_x149 - 0.00031223895504468581 * var_x155 - 2.2767478584105716e-5 * var_x151 - 0.0008381150898567882 * var_x150 - var_x153 * var_x393;
        IJth(rJacobian, 25, 24) = var_x398;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00601027620873753 * var_x156 - 0.001444800488100033 * var_x57);
        IJth(rJacobian, 23, 25) = var_x387;
        IJth(rJacobian, 24, 25) = var_x399;
        IJth(rJacobian, 25, 25) = var_x387 + var_x399 + 8.8885199344722979e-8 * var_x57 - 3.6975665728975948e-7 * var_x156;
        ...
        IJth(rJacobian, 26, 26) = var_x403 * (-0.0083333333333333332 - var_x418) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x409 * var_x418) / (pow(var_x401, 3) * pow((0.125 + var_x402), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x426 * var_x430;
        ...
        IJth(rJacobian, 0, 28) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x137 * var_x158);
        IJth(rJacobian, 1, 28) = var_x161 * (0.14705882352941174 - var_x180 * var_x193 - var_x186 * var_x192);
        ...
        IJth(rJacobian, 22, 28) = var_x377 * (var_x260 + var_x370 * (5000.0 - 3510.8651860830805 * var_x378) - var_x260 * var_x361) - var_x365 * (40000.0 - 18724.614325776431 * var_x378);
        IJth(rJacobian, 26, 28) = var_x403 * (var_x418 + 2106.5191116498486 * var_x419);
        IJth(rJacobian, 27, 28) = var_x192 * var_x422 + var_x193 * var_x421;
        IJth(rJacobian, 28, 28) = var_x426 * (-5.0 - var_x430 - 0.0036718475849305066 * var_x259 - 505.56458679596358 * var_x419) + (0.019557600000000001 / pow(var_x423, 3) + 8.1780000000000006e-5 / pow(var_x424, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x244 + var_x409 * var_x430) / pow(var_x425, 2);
    }
