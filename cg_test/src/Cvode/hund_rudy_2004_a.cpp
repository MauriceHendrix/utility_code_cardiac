...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellhund_rudy_2004_aFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x71 = 1 / (13227.9606 + 8.4084932990912282 * var_x66 + 6516533.0625 * var_chaste_interface__Ca__Ca_i);
        ...
        const double var_x123 = var_x122 * var_x30 * var_x31 * var_chaste_interface__IKs__xs2 / pow(var_x32, 2);
        ...
        const double var_x127 = var_x126 * var_chaste_interface__INa__H;
        const double var_x128 = var_x127 * pow(var_chaste_interface__INa__m, 2) * var_chaste_interface__INa__J;
        const double var_x129 = var_x127 * var_x37;
        ...
        const double var_x137 = var_x80 * var_x89;
        ...
        const double var_x326 = pow(var_x99, (-2));
        const double var_x327 = pow(var_chaste_interface__ICaL__d, (-2 * var_chaste_interface__ICaL__dp));
        const double var_x328 = pow(var_chaste_interface__ICaL__f, (-2));
        const double var_x329 = pow(var_chaste_interface__ICaL__f2, (-2));
        const double var_x330 = pow(var_chaste_interface__ICaL__fca, (-2));
        const double var_x331 = pow(var_chaste_interface__ICaL__fca2, (-2));
        const double var_x332 = var_x104 * var_x326 * var_x327 * var_x328 * var_x329 * var_x330 * var_x331;
        const double var_x333 = pow(var_x325, (-2));
        const double var_x334 = var_x326 * var_x327 * var_x329 * var_x330 * var_x331 * var_x333;
        const double var_x335 = 5.399297452372711e-5 * var_x328;
        const double var_x336 = var_x104 * var_x327 * var_x329 * var_x331 * var_x333;
        const double var_x337 = var_x330 * var_x336 / pow(var_x99, 3);
        const double var_x338 = pow(var_chaste_interface__Ca__Ca_jsr, 1.8999999999999999);
        const double var_x339 = 0.0028 + var_chaste_interface__Ca__Ca_ss;
        const double var_x340 = 1 / var_x339;
        const double var_x341 = pow((var_x340 * var_chaste_interface__Ca__Ca_ss), 1.8999999999999999);
        const double var_x342 = 1 / (var_x338 + 1644.6531773416521 * var_x341);
        const double var_x343 = var_x332 * var_x333;
        const double var_x344 = 1.0 + 0.00036056965579880955 * var_x343;
        const double var_x345 = var_x338 * var_x342 / pow(var_x344, 2);
        const double var_x346 = 0.00024037977053253972 * var_x345;
        const double var_x347 = var_x343 * var_x346;
        const double var_x348 = var_x104 * var_x346;
        const double var_x349 = var_x326 * var_x328;
        const double var_x350 = var_x327 * var_x330 * var_x333 * var_x348 * var_x349;
        const double var_x351 = 1 / var_x344;
        const double var_x352 = var_x351 / pow((var_x341 + 0.00060803092942449902 * var_x338), 2);
        const double var_x353 = exp(3.3333333333333335 + 234.05767907220539 * var_x244);
        const double var_x354 = 1.0 + var_x353;
        const double var_x355 = 1 / var_x354;
        const double var_x356 = exp(-16.0 + 80.0 * var_x355 + 40000.0 * var_chaste_interface__Ca__Ca_ss);
        const double var_x357 = 1.0 + var_x356;
        const double var_x358 = exp(-15.0 + 5000.0 * var_chaste_interface__Ca__Ca_ss + 15.0 * var_x355);
        const double var_x359 = 1.0 + var_x358;
        const double var_x360 = 1 / var_x359;
        const double var_x361 = 350.0 - var_x242;
        const double var_x362 = var_x360 * var_x361;
        const double var_x363 = 1 / (3.0 + var_x242 + var_x362);
        const double var_x364 = var_x356 * var_x363 / pow(var_x357, 2);
        const double var_x365 = 17.524312015706236 * var_x109;
        const double var_x366 = var_x353 / pow(var_x354, 2);
        const double var_x367 = var_x366 * (234.05767907220539 * var_x239 + var_x111 * var_x365 - var_x105 * var_x365);
        const double var_x368 = (-var_chaste_interface__Irel__ri + 1.0 / var_x357) / pow((0.29999999999999999 + var_x172 + 0.10000000000000001 * var_x362), 2);
        const double var_x369 = var_x358 * var_x361 / pow(var_x359, 2);
        const double var_x370 = var_x368 * var_x369;
        const double var_x371 = 18724.614325776431 * var_x364;
        const double var_x372 = var_x366 * var_x371;
        const double var_x373 = 35.108651860830804 * var_x370;
        const double var_x374 = var_x366 * var_x373;
        const double var_x375 = var_x252 * var_x366;
        const double var_x376 = 0.01 * var_x368;
        const double var_x377 = var_x259 * var_x366;
        const double var_x378 = 3.998848287353967e-7 * var_x7;
        const double var_x379 = 0.00050754612877954204 * var_x38;
        const double var_x380 = log(100.0 * var_x155);
        const double var_x381 = var_x125 + var_x380;
        const double var_x382 = pow(var_x381, 4);
        const double var_x383 = 2.8839711417381356e-9 * pow(var_x381, 7) / pow((1 + 0.008558014922736952 * var_x382), 2);
        const double var_x384 = 20.048989239405216 * pow(var_x381, 3) / (59494197.640692554 + 509152.23122530844 * var_x382);
        const double var_x385 = var_x124 * var_x383 - var_x124 * var_x384;
        const double var_x386 = var_x155 * var_x383 - var_x155 * var_x384;
        const double var_x387 = 8.5232067604091287e-7 * var_x5;
        const double var_x388 = -1.5317126959137754e-6 - 9.1902761754826519e-7 * var_x33;
        ...
        const double var_x391 = 1.1688941147650058e-5 * var_x81;
        const double var_x392 = 3.0157226903121925e-5 * var_x86;
        const double var_x393 = var_x145 * var_x390;
        const double var_x394 = var_x54 + 26.712338705500134 * var_x380;
        const double var_x395 = 0.00018900582374463672 / (87.825100000000006 + var_x394);
        const double var_x396 = 2.4504050574883893e-8 * var_x394 / pow((1 + 0.30415380916731244 * var_x17 + 0.30415380916731244 * var_x380), 2);
        const double var_x397 = var_x16 * var_x396 - var_x16 * var_x395;
        const double var_x398 = var_x155 * var_x396 - var_x155 * var_x395;
        const double var_x399 = 8.8885199344722979e-8 * var_x45;
        const double var_x400 = 0.80000000000000004 + var_chaste_interface__Ca__Ca_jsr;
        const double var_x401 = pow(var_x400, (-2));
        const double var_x402 = 1 / (1.0 + 8.0 * var_x401);
        const double var_x403 = 3000.0 * var_x402;
        const double var_x404 = 0.70217303721661617 * var_x100;
        const double var_x405 = 0.052572936047118712 * var_x106;
        const double var_x406 = exp(2.6000000000000001 + var_x106 * var_x404);
        const double var_x407 = 1.0 + var_x406;
        const double var_x408 = -var_chaste_interface__Ca__Ca_ss + var_chaste_interface__Ca__Ca_jsr;
        const double var_x409 = var_x408 * var_chaste_interface__Irel__ro;
        const double var_x410 = var_x406 * var_x409 * var_chaste_interface__Irel__ri / pow(var_x407, 2);
        const double var_x411 = var_x410 * (var_x404 + var_x111 * var_x405 - var_x105 * var_x405);
        const double var_x412 = 1 / var_x407;
        const double var_x413 = var_x412 * var_chaste_interface__Irel__ri;
        const double var_x414 = var_x408 * var_x413;
        const double var_x415 = var_x409 * var_x412;
        const double var_x416 = var_x413 * var_chaste_interface__Irel__ro;
        const double var_x417 = 3000.0 * var_x416;
        const double var_x418 = 1.0 * var_x402;
        const double var_x419 = var_x106 * var_x156 * var_x410;
        ...
        const double var_x423 = 0.0002749177168957104 * var_x109;
        const double var_x424 = 0.0086999999999999994 + var_chaste_interface__Ca__Ca_ss;
        const double var_x425 = 0.00087000000000000001 + var_chaste_interface__Ca__Ca_ss;
        const double var_x426 = 1.0 + 0.0097788000000000007 / pow(var_x424, 2) + 4.0890000000000003e-5 / pow(var_x425, 2);
        const double var_x427 = 1 / var_x426;
        const double var_x428 = 1.0 * var_x427;
        const double var_x429 = 0.0036718475849305066 * var_x427;
        const double var_x430 = 719.99999999999989 * var_x427;
        const double var_x431 = 719.99999999999989 * var_x416;
        
        // Matrix entries
        IJth(rJacobian, 0, 0) = mSetVoltageDerivativeToZero ? 0.0 : (-0.00022499999999999999 + var_x36 - var_x103 + 0.00021581774391076088 * var_x58 + 0.00089962337662337659 * var_x59 + 0.005408738276452542 * var_x62 + 0.12163499999999999 * var_x65 - 4.5 * var_x78 - 0.0027599999999999999 * var_x2 - 0.00021581774391076088 * var_x83 - 5.4087382764525417e-5 * var_x88 - 0.0028824983370005666 * var_x15 - 0.48423913043478262 * var_x53 - 0.51000000000000001 * var_x29 - 0.0006333333333333333 * var_x90 - 0.00046153846153846147 * var_x56 - 0.029564989000285053 * var_x93 + var_x105 * var_x110 - var_x110 * var_x111 - var_x39 * var_chaste_interface__INa__H - var_x46 * var_chaste_interface__Ito2__AA - var_x6 * var_chaste_interface__IKr__xr - var_x8 * var_chaste_interface__INal__hL - var_x82 * var_chaste_interface__Ito__ydv2 - var_x85 * var_x87);
        IJth(rJacobian, 1, 0) = var_x162 * (-var_x158 + 1.8188600866065964e-6 * var_x93 + 6.6386339662934098e-9 * var_x58 + 0.00027684334297065928 * var_x78 - 6.6386339662934098e-9 * var_x83);
        ...
        IJth(rJacobian, 5, 0) = 1.5624999999999998 * (-var_chaste_interface__ICaL__d + 1.0 / var_x231) * (-0.041599999999999998 * var_x229 + 0.10560000000000001 * var_x226 * var_x228 / pow(var_x227, 2)) / pow((0.73749999999999993 + var_x229), 2) + 0.14836795252225518 * var_x230 * var_x232 / pow(var_x231, 2);
        ...
        IJth(rJacobian, 11, 0) = (-var_chaste_interface__IKr__xr + 1.0 / var_x274) * (var_x277 + var_x280 - 8.1600000000000005e-5 * var_x278 * var_x281 / pow(var_x279, 2) - 4.566e-5 * var_x275 * var_x282 / pow(var_x276, 2)) + 0.23529411764705882 * var_x273 * (var_x283 + var_x284) / pow(var_x274, 2);
        IJth(rJacobian, 12, 0) = 0.04048582995951417 * var_x301 + var_x298 * (-var_chaste_interface__IKs__xs1 + 1.0 * var_x287);
        ...
        IJth(rJacobian, 21, 0) = 0.33333333333333331 * var_x345 * (4.8075954106507941e-5 * var_x332 / pow(var_x325, 3) + var_x335 * var_x337 * var_x98 - var_x334 * var_x335 * var_x95 * var_x96);
        IJth(rJacobian, 22, 0) = 80.0 * var_x364 * var_x367 - 0.14999999999999999 * var_x367 * var_x370;
        IJth(rJacobian, 23, 0) = -8.9372253111180233e-5 * var_x53 - 5.456580259819789e-6 * var_x93 - 0.00083053002891197785 * var_x78 - var_x378 * var_chaste_interface__INal__hL - var_x379 * var_chaste_interface__INa__H;
        IJth(rJacobian, 24, 0) = var_x390 + 5.5345498444215123e-8 * var_x59 + 5.9581502074120151e-5 * var_x53 + 7.4830755604969202e-6 * var_x65 - 1.6979725035533768e-7 * var_x2 - 3.137557887000805e-5 * var_x29 - 3.8963137158833531e-8 * var_x90 - 2.8394189022631718e-8 * var_x56 - var_x387 * var_chaste_interface__IKr__xr - var_x391 * var_chaste_interface__Ito__ydv2 - var_x392 * var_x85;
        IJth(rJacobian, 25, 0) = 1.3842167148532964e-8 + 3.3274959682366304e-9 * var_x88 - 3.3274959682366302e-7 * var_x62 + var_x399 * var_chaste_interface__Ito2__AA;
        IJth(rJacobian, 26, 0) = var_x403 * var_x411;
        IJth(rJacobian, 28, 0) = var_x428 * (-719.99999999999989 * var_x411 - 0.0036718475849305066 * var_x239 + var_x105 * var_x423 - var_x111 * var_x423);
        ...
        IJth(rJacobian, 28, 1) = 5.0 * var_x427;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x39);
        IJth(rJacobian, 2, 2) = -((var_x194) ? (0.0) : (0.13500000000000001 * var_x195)) - ((var_x194) ? (7.6923076923076916 / var_x197) : (310000.0 * var_x199 + 3.5600000000000001 * var_x198));
        IJth(rJacobian, 23, 2) = -var_x126 * var_x379;
        ...
        IJth(rJacobian, 4, 4) = -((var_x194) ? (0.0) : (var_x216 * var_x217)) - ((var_x194) ? (0.29999999999999999 * var_x221) : (0.1212 * var_x225));
        ...
        IJth(rJacobian, 21, 5) = var_x131 * var_x347;
        IJth(rJacobian, 22, 5) = var_x249 * var_x372 - var_x249 * var_x374;
        IJth(rJacobian, 28, 5) = -var_x249 * var_x429;
        ...
        IJth(rJacobian, 21, 6) = var_x132 * var_x347;
        IJth(rJacobian, 22, 6) = var_x250 * var_x372 - var_x250 * var_x374;
        IJth(rJacobian, 28, 6) = -var_x250 * var_x429;
        ...
        IJth(rJacobian, 21, 7) = var_x334 * var_x348 / pow(var_chaste_interface__ICaL__f, 3);
        IJth(rJacobian, 22, 7) = var_x371 * var_x375 - var_x373 * var_x375;
        IJth(rJacobian, 28, 7) = -var_x252 * var_x429;
        ...
        IJth(rJacobian, 21, 8) = var_x336 * var_x346 * var_x349 / pow(var_chaste_interface__ICaL__fca, 3);
        IJth(rJacobian, 22, 8) = var_x135 * var_x372 - var_x135 * var_x374;
        IJth(rJacobian, 28, 8) = -var_x135 * var_x429;
        ...
        IJth(rJacobian, 21, 9) = var_x329 * var_x350 / pow(var_chaste_interface__ICaL__fca2, 3);
        IJth(rJacobian, 22, 9) = var_x254 * var_x372 - var_x254 * var_x374;
        IJth(rJacobian, 28, 9) = -var_x254 * var_x429;
        ...
        IJth(rJacobian, 21, 10) = var_x331 * var_x350 / pow(var_chaste_interface__ICaL__f2, 3);
        IJth(rJacobian, 22, 10) = var_x255 * var_x372 - var_x255 * var_x374;
        IJth(rJacobian, 28, 10) = -var_x255 * var_x429;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x6);
        IJth(rJacobian, 11, 11) = -var_x283 - var_x284;
        IJth(rJacobian, 24, 11) = -var_x387 * var_x55;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x121 * var_x35);
        IJth(rJacobian, 12, 12) = -var_x299 - var_x300;
        IJth(rJacobian, 24, 12) = var_x121 * var_x389;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x122 * var_x34);
        ...
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x55 * var_x82);
        IJth(rJacobian, 15, 15) = -0.029999999999999999 * var_x320 - 0.20000000000000001 * var_x316;
        IJth(rJacobian, 24, 15) = -var_x391 * var_x55;
        ...
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x46 * var_chaste_interface__cell__V);
        IJth(rJacobian, 17, 17) = -1.0;
        IJth(rJacobian, 25, 17) = var_x399 * var_chaste_interface__cell__V;
        ...
        IJth(rJacobian, 0, 19) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x126 * var_x8);
        IJth(rJacobian, 19, 19) = -0.0016666666666666668;
        IJth(rJacobian, 23, 19) = -var_x126 * var_x378;
        ...
        IJth(rJacobian, 22, 20) = var_x376 * (var_x256 - var_x256 * var_x360);
        IJth(rJacobian, 27, 20) = var_x185 * var_x422 + var_x187 * var_x421;
        IJth(rJacobian, 21, 21) = -0.33333333333333331;
        IJth(rJacobian, 26, 21) = -var_x403 * var_x414;
        IJth(rJacobian, 28, 21) = var_x414 * var_x430;
        IJth(rJacobian, 22, 22) = -var_x363;
        IJth(rJacobian, 26, 22) = -var_x403 * var_x415;
        IJth(rJacobian, 28, 22) = var_x415 * var_x430;
        IJth(rJacobian, 0, 23) = mSetVoltageDerivativeToZero ? 0.0 : (2.6731217821876006e-12 * var_x144 + 3.9005476114801918 * var_x146 - 24.300000000000001 * var_x147 - 220.37679432037609 * var_x143 - 0.0096847826086956523 * var_x141 - 0.17363020158575085 * var_x142);
        IJth(rJacobian, 1, 23) = var_x162 * (0.0014949540520415602 * var_x147 - 1.6445243785522266e-16 * var_x144);
        IJth(rJacobian, 23, 23) = var_x385 + 4.9335731356566794e-16 * var_x144 - 1.7874450622236046e-6 * var_x141 - 1.068185898837083e-5 * var_x142 - 0.013557744100624516 * var_x143 - 0.0044848621561246801 * var_x147;
        IJth(rJacobian, 24, 23) = 3.9005476114801918 * var_x393 + 1.191630041482403e-6 * var_x141;
        IJth(rJacobian, 25, 23) = var_x385;
        IJth(rJacobian, 0, 24) = mSetVoltageDerivativeToZero ? 0.0 : (3.2491553184435085 * var_x153 + 212.79583259575517 * var_x146 - 0.37007808289373995 * var_x149 - 0.073726054827180365 * var_x148 - 5.0753443540450256 * var_x154 - 13.623292739805068 * var_x150 - var_x152 * var_x87);
        IJth(rJacobian, 24, 24) = var_x397 + 212.79583259575517 * var_x393 + 0.00019989044893084398 * var_x153 - 4.535681662754383e-6 * var_x148 - 0.00031223895504468581 * var_x154 - 2.2767478584105716e-5 * var_x149 - 0.0008381150898567882 * var_x150 - var_x152 * var_x392;
        IJth(rJacobian, 25, 24) = var_x397;
        IJth(rJacobian, 0, 25) = mSetVoltageDerivativeToZero ? 0.0 : (0.00601027620873753 * var_x155 - 0.001444800488100033 * var_x61);
        IJth(rJacobian, 23, 25) = var_x386;
        IJth(rJacobian, 24, 25) = var_x398;
        IJth(rJacobian, 25, 25) = var_x386 + var_x398 + 8.8885199344722979e-8 * var_x61 - 3.6975665728975948e-7 * var_x155;
        IJth(rJacobian, 21, 26) = -2.3414435371998602e-7 * var_x352 * pow(var_chaste_interface__Ca__Ca_jsr, 2.7999999999999998) + 0.6333333333333333 * var_x342 * var_x351 * pow(var_chaste_interface__Ca__Ca_jsr, 0.89999999999999991);
        IJth(rJacobian, 26, 26) = var_x418 * (-0.0083333333333333332 - var_x417) + 0.25 * (0.0083333333333333332 * var_chaste_interface__Ca__Ca_nsr - 0.0083333333333333332 * var_chaste_interface__Ca__Ca_jsr - var_x408 * var_x417) / (pow(var_x400, 3) * pow((0.125 + var_x401), 2));
        IJth(rJacobian, 27, 26) = 0.00072463768115942019;
        IJth(rJacobian, 28, 26) = var_x427 * var_x431;
        IJth(rJacobian, 1, 27) = 2.3676470588235295e-5 * var_x161;
        IJth(rJacobian, 26, 27) = 0.0083333333333333332 * var_x402;
        ...
        IJth(rJacobian, 21, 28) = var_x328 * var_x337 * var_x346 * var_x95 - 0.00020267697647483301 * var_x165 * var_x338 * var_x339 * var_x341 * var_x352 * (1.8999999999999999 * var_x340 - 1.8999999999999999 * var_chaste_interface__Ca__Ca_ss / pow(var_x339, 2));
        IJth(rJacobian, 22, 28) = var_x376 * (var_x260 + var_x369 * (5000.0 - 3510.8651860830805 * var_x377) - var_x260 * var_x360) - 1.0 * var_x364 * (40000.0 - 18724.614325776431 * var_x377);
        IJth(rJacobian, 26, 28) = var_x418 * (var_x417 + 2106.5191116498486 * var_x419);
        IJth(rJacobian, 27, 28) = var_x192 * var_x422 + var_x193 * var_x421;
        IJth(rJacobian, 28, 28) = var_x428 * (-5.0 - var_x431 - 0.0036718475849305066 * var_x259 - 505.56458679596358 * var_x419) + 1.0 * (0.019557600000000001 / pow(var_x424, 3) + 8.1780000000000006e-5 / pow(var_x425, 3)) * (5.0 * var_chaste_interface__Ca__Ca_i - 5.0 * var_chaste_interface__Ca__Ca_ss - 0.0036718475849305066 * var_x244 + var_x408 * var_x431) / pow(var_x426, 2);
    }
