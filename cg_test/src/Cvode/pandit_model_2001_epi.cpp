...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x168 = 0.00088581970078959317 * var_x46;
        const double var_x169 = 0.00014999999999999999 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x170 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x171 = 1.0 + 0.0014999999999999998 / pow(var_x169, 2) + 0.00011900000000000002 / pow(var_x170, 2);
        const double var_x172 = 1 / var_x171;
        const double var_x173 = 0.001 * var_x172;
        const double var_x174 = 200000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x175 = 40000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        const double var_x176 = 0.0022145492519739826 * var_x68;
        const double var_x177 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 1.2);
        const double var_x178 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_NSR, 1.0);
        const double var_x179 = 1 / (1.0 + 33855.471141425078 * var_x177 + 0.303951367781155 * var_x178);
        const double var_x180 = pow(var_chaste_interface__intracellular_ion_concentrations__Ca_i, 0.19999999999999996);
        const double var_x181 = var_x179 * var_x180;
        const double var_x182 = 1354.2188456570032 * var_x177 - 0.2735562310030395 * var_x178;
        const double var_x183 = var_x182 / pow((2.9537323401073989e-5 + var_x177 + 8.9779098483507565e-6 * var_x178), 2);
        const double var_x184 = var_x180 * var_x183;
        const double var_x185 = -3.433658615185661e-5 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s - 4.4180257576880966e-6 * var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow;
        const double var_x186 = var_x185 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        const double var_x187 = 0.00019703470957323427 * var_x9 - 7.7509223819089404e-6 * var_chaste_interface__membrane__V;
        const double var_x188 = 0.0023800000000000002 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss;
        ...
        const double var_x192 = var_x191 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x193 = 870.15176483187713 - 13.386950228182727 * var_chaste_interface__membrane__V;
        const double var_x194 = var_x192 * var_x193;
        const double var_x195 = var_x191 * (84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        const double var_x196 = 84000.0 * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x197 = 84000.0 * var_chaste_interface__SR_Ca_release_channel__P_O2;
        const double var_x198 = (-var_chaste_interface__intracellular_ion_concentrations__Ca_ss + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) * (var_chaste_interface__SR_Ca_release_channel__P_O1 + var_chaste_interface__SR_Ca_release_channel__P_O2);
        const double var_x199 = 0.80000000000000004 + var_chaste_interface__intracellular_ion_concentrations__Ca_JSR;
        const double var_x200 = pow(var_x199, (-2));
        const double var_x201 = 1 / (1.0 + 12.0 * var_x200);
        const double var_x202 = 0.001 * var_x201;
        const double var_x203 = var_x202 * (1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        const double var_x204 = 1800.0 * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x205 = 1800.0 * var_chaste_interface__SR_Ca_release_channel__P_O2;
        ...
        IJth(rJacobian, 4, 0) = 107.49798441279225 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d + 1.0 / var_x118) * (-var_x119 * (0.072000000000000008 - 0.0040000000000000001 * var_chaste_interface__membrane__V) - var_x120 * (-0.063 - 0.0089999999999999993 * var_chaste_interface__membrane__V)) / pow((0.081967213114754092 + var_x115 + 0.34426229508196715 * var_x114), 2) + 0.00020000000000000001 * var_x117 * var_x121 / pow(var_x118, 2);
        ...
        IJth(rJacobian, 9, 0) = -var_x149 * var_x152 - 0.0028571428571428576 * var_x148 * (-0.62222222222222223 - 0.0088888888888888889 * var_chaste_interface__membrane__V) * (var_x153 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.10000000000000002 + var_x148), 2);
        ...
        IJth(rJacobian, 20, 0) = -8.8748061272857362e-8 - 3.2110964153622751e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 0.00088581970078959317 * var_x24 - 3.3165089597562367e-8 * var_x20 - 0.00020797506018538275 * var_x40;
        IJth(rJacobian, 21, 0) = var_x173 * (-1.7937848940989261e-5 + 1.1055029865854122e-5 * var_x20);
        IJth(rJacobian, 22, 0) = -1.528038983862048e-7 + var_x186 + 0.00013865004012358849 * var_x40 + 1.6862097911031213e-6 * var_x42 - 5.3149182047375591e-6 * var_x32 - 7.7509223819089404e-6 * var_x21 - 1.2844385661449098e-6 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 2.6574591023687795e-5 * var_x12 - 6.5133801528646552e-9 * var_x33;
        IJth(rJacobian, 23, 0) = var_x192 * (-13.386950228182727 * var_x4 - 13.386950228182727 * var_x6);
        ...
        IJth(rJacobian, 22, 8) = var_x185 * var_x41;
        ...
        IJth(rJacobian, 22, 9) = (0.00087286376340942788 * var_x9 - 3.433658615185661e-5 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        ...
        IJth(rJacobian, 22, 10) = (0.00011230978445674354 * var_x9 - 4.4180257576880966e-6 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        ...
        IJth(rJacobian, 11, 11) = -0.004516 * var_x145 - 0.0098900000000000012 * var_x146;
        IJth(rJacobian, 22, 11) = var_x187 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x43 * var_x57 * var_x58);
        IJth(rJacobian, 12, 12) = -0.00047619047619047619;
        IJth(rJacobian, 22, 12) = var_x187 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        ...
        IJth(rJacobian, 23, 14) = var_x195;
        IJth(rJacobian, 24, 14) = var_x203;
        IJth(rJacobian, 14, 15) = 1.9299999999999999;
        IJth(rJacobian, 15, 15) = -1.9299999999999999;
        IJth(rJacobian, 23, 15) = var_x195;
        IJth(rJacobian, 24, 15) = var_x203;
        ...
        IJth(rJacobian, 20, 20) = 1.5856796826686865e-16 * var_x63 - 8.1628665394625614e-6 * var_x59 - 9.8651233004461501e-6 * var_x65 - 1.193943225512245e-7 * var_x64 - 2.2560474246135324e-6 * var_x34 - 0.022518252522655345 * var_x66;
        IJth(rJacobian, 21, 20) = var_x173 * (3.9798107517074834e-5 * var_x64 - 5.2855989422289547e-14 * var_x63);
        ...
        IJth(rJacobian, 21, 21) = var_x173 * (-30837.453183520603 - var_x176 + 40000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x184 + 0.0022145492519739826 * var_x70 - 4.0288009715211813e-8 * var_x62 - 0.00022799730679188537 * var_x69 - 30.33500195190371 * var_x71 - 1625.0626147884036 * var_x181) + 0.001 * (0.0029999999999999996 / pow(var_x169, 3) + 0.00023800000000000004 / pow(var_x170, 3)) * (40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 0.066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 0.00022799730679188537 * log(1.2 * var_x69) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x174 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x175 * (0.070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x176 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.1055029865854122e-5 * var_x14 * var_x61 - 1.0 * var_x179 * var_x182) / pow(var_x171, 2);
        IJth(rJacobian, 23, 21) = 29.213483146067414 * var_x190;
        IJth(rJacobian, 25, 21) = 3.0179734274641783 * var_x181 - 6.5826035008107738e-8 * var_x184;
        ...
        IJth(rJacobian, 22, 22) = 4.286481532120841e-5 * var_x77 - 0.00067554757567966038 * var_x75 - 3.8843985601580465e-6 * var_x8 - 3.2651466157850246e-5 * var_x72 - 1.6557538619599519e-7 * var_x76 - 0.00019703470957323427 * var_x74 + var_x186 * var_x73;
        ...
        IJth(rJacobian, 21, 23) = 0.037453183520599252 * var_x172;
        IJth(rJacobian, 23, 23) = var_x191 * (-29213.483146067414 - var_x196 - var_x197) + 2.3800000000000004e-7 * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x198 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x51 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / (pow(var_x188, 3) * pow(var_x189, 2));
        IJth(rJacobian, 24, 23) = var_x202 * (var_x204 + var_x205);
        IJth(rJacobian, 23, 24) = var_x191 * (var_x196 + var_x197);
        IJth(rJacobian, 24, 24) = var_x202 * (-1740.0382808421784 - var_x204 - var_x205) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x198 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x199, 3) * pow((0.083333333333333329 + var_x200), 2));
        IJth(rJacobian, 25, 24) = 0.19333758676024207;
        IJth(rJacobian, 21, 25) = var_x173 * (0.2735562310030395 * var_x179 + 2.651834266564234e-10 * var_x183);
        IJth(rJacobian, 24, 25) = 1.7400382808421784 * var_x201;
        IJth(rJacobian, 25, 25) = -0.19333758676024207 - 4.9248350664764349e-13 * var_x183 - 0.00050803300043421621 * var_x179;
    }
