...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellpandit_model_2001_epiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time_converted, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        ...
        const double var_x43 = log(140.0 * var_x34);
        const double var_x44 = -25.420807984495319 * var_x43 + var_chaste_interface__membrane__V;
        const double var_x45 = var_x44 * var_chaste_interface__sodium_current_h_gate__h;
        const double var_x46 = var_x45 * pow(var_chaste_interface__sodium_current_m_gate__m, 2) * var_chaste_interface__sodium_current_j_gate__j;
        const double var_x47 = var_x30 * var_x45;
        ...
        const double var_x52 = 1.7794565589146725 * var_x18 - 0.069999999999999993 * var_chaste_interface__membrane__V;
        ...
        const double var_x81 = exp(12.537067545304776 + 0.16474464579901152 * var_chaste_interface__membrane__V);
        ...
        const double var_x90 = 0.00016474464579901152 * var_x81 / pow(var_x82, 2);
        ...
        const double var_x111 = exp(-3.0600000000000001 + var_x110);
        ...
        const double var_x123 = exp(4.9444444444444438 + 0.18518518518518517 * var_chaste_interface__membrane__V);
        const double var_x124 = 1.0 + var_x123;
        const double var_x125 = 1.0 / var_x124;
        const double var_x126 = 0.00059999999999999995 * var_x119 / pow(var_x120, 2);
        ...
        const double var_x130 = 0.00018518518518518518 * var_x123 / pow(var_x124, 2);
        ...
        const double var_x137 = exp(-0.92819614711033271 - 0.087565674255691769 * var_chaste_interface__membrane__V);
        ...
        const double var_x144 = exp(6.5803808776746413 + 0.14526227103034528 * var_chaste_interface__membrane__V);
        const double var_x145 = 1.0 + var_x144;
        const double var_x146 = 0.00014526227103034528 * var_x144 / pow(var_x145, 2);
        const double var_x147 = 1.0 / var_x145;
        ...
        const double var_x150 = exp(-0.97292724196277491 - 0.084602368866328256 * var_chaste_interface__membrane__V);
        const double var_x151 = 1.0 + var_x150;
        const double var_x152 = exp(8.4951456310679614 + 0.097087378640776698 * var_chaste_interface__membrane__V);
        const double var_x153 = exp(13.225190839694655 + 0.095419847328244267 * var_chaste_interface__membrane__V);
        ...
        const double var_x160 = 48600000000.0 * var_x157 * var_chaste_interface__SR_Ca_release_channel__P_C1;
        const double var_x161 = 12150000.0 * pow(var_chaste_interface__intracellular_ion_concentrations__Ca_ss, 2.0) * var_chaste_interface__SR_Ca_release_channel__P_O1;
        const double var_x162 = 0.00088581970078959317 * var_x31;
        ...
        const double var_x181 = 0.00019703470957323427 * var_x18 - 7.7509223819089404e-6 * var_chaste_interface__membrane__V;
        ...
        const double var_x186 = var_x185 * var_chaste_interface__L_type_Ca_channel_d_gate__d;
        const double var_x187 = 870.15176483187713 - 13.386950228182727 * var_chaste_interface__membrane__V;
        const double var_x188 = var_x186 * var_x187;
        const double var_x189 = var_x185 * (84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR - 84000.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss);
        ...
        const double var_x197 = var_x196 * (1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 1800.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR);
        ...
        IJth(rJacobian, 2, 0) = (var_x83 - 0.001 * var_chaste_interface__sodium_current_h_gate__h) * ((var_x85) ? (198.5675338110868 * var_x84 / pow((1 + var_x84), 2)) : (80.584527220630378 * var_x86 + 31088825.214899711 * var_x87 - 5.6885218270689366 * var_x88)) - var_x89 * var_x90;
        IJth(rJacobian, 3, 0) = (var_x83 - 0.001 * var_chaste_interface__sodium_current_j_gate__j) * ((var_x85) ? (-2.1797076526225279e-5 * var_x94 + 8.5984522785898552 * var_x91 * var_x93 / pow(var_x92, 2)) : (var_x101 - 0.36533638968481374 * var_x105 + var_x100 * var_x106 * (1.5254334000000001e-6 * var_x96 - 31073.016 * var_x95) + 4.7854899713467054 * var_x102 * var_x104 / pow(var_x103, 2) - 89.11174785100286 * var_x106 * var_x97 * var_x98 / pow(var_x99, 2))) - var_x107 * var_x90;
        IJth(rJacobian, 4, 0) = 107.49798441279225 * (-var_chaste_interface__L_type_Ca_channel_d_gate__d + 1.0 / var_x112) * (-var_x113 * (0.072000000000000008 - 0.0040000000000000001 * var_chaste_interface__membrane__V) - var_x114 * (-0.063 - 0.0089999999999999993 * var_chaste_interface__membrane__V)) / pow((0.081967213114754092 + var_x109 + 0.34426229508196715 * var_x108), 2) + 0.00020000000000000001 * var_x111 * var_x115 / pow(var_x112, 2);
        IJth(rJacobian, 5, 0) = -var_x129 * var_x130 + 0.090702947845805001 * (var_x125 - var_chaste_interface__L_type_Ca_channel_f_11_gate__f_11) * (var_x126 - var_x127 * (-0.625 - 0.013888888888888888 * var_chaste_interface__membrane__V) - 0.0016000000000000001 * var_x116 / pow(var_x117, 2)) / pow((0.016190476190476189 + var_x122 + 0.38095238095238099 * var_x118 + 0.14285714285714285 * var_x121), 2);
        IJth(rJacobian, 6, 0) = -var_x130 * var_x136 + 0.15625 * (var_x125 - var_chaste_interface__L_type_Ca_channel_f_12_gate__f_12) * (var_x126 - var_x135 * (-0.65277777777777779 - 0.013888888888888888 * var_chaste_interface__membrane__V) - 0.016 * var_x131 / pow(var_x132, 2)) / pow((0.021249999999999998 + var_x133 + 0.51249999999999996 * var_x134 + 0.1875 * var_x121), 2);
        IJth(rJacobian, 8, 0) = (0.001 / var_x138 - 0.001 * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r) * (1.6153732000000001 * var_x139 - 9.8900000000000006 * var_x140) + 8.7565674255691772e-5 * var_x137 * (45.159999999999997 * var_x139 + 98.900000000000006 * var_x140) / pow(var_x138, 2);
        IJth(rJacobian, 9, 0) = -var_x143 * var_x146 - 0.0028571428571428576 * var_x142 * (-0.62222222222222223 - 0.0088888888888888889 * var_chaste_interface__membrane__V) * (var_x147 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_gate__s) / pow((0.10000000000000002 + var_x142), 2);
        IJth(rJacobian, 10, 0) = -var_x146 * var_x149 - 0.00027027027027027027 * var_x148 * (-0.15555555555555556 - 0.0022222222222222222 * var_chaste_interface__membrane__V) * (var_x147 - var_chaste_interface__Ca_independent_transient_outward_K_current_s_slow_gate__s_slow) / pow((0.00945945945945946 + var_x148), 2);
        IJth(rJacobian, 11, 0) = (0.001 / var_x151 - 0.001 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss) * (0.16153732000000001 * var_x139 - 0.9890000000000001 * var_x140) + 8.4602368866328257e-5 * var_x150 * (9.8900000000000006 * var_x140 + 4.516 * var_x139) / pow(var_x151, 2);
        IJth(rJacobian, 12, 0) = -4.6232085067036518e-5 * var_x152 / pow((1.0 + var_x152), 2);
        IJth(rJacobian, 13, 0) = (0.001 / var_x154 - 0.001 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y) * (0.0041892844554106447 * var_x155 - 0.039626497533474282 * var_x156) - 9.5419847328244274e-5 * var_x153 * (0.56230000000000002 * var_x156 + 0.11885 * var_x155) / pow(var_x154, 2);
        IJth(rJacobian, 20, 0) = -8.8748061272857362e-8 - 3.2110964153622751e-7 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 3.3165089597562367e-8 * var_x14 - 0.00020797506018538275 * var_x40 - var_x162 * var_chaste_interface__sodium_current_h_gate__h;
        IJth(rJacobian, 21, 0) = var_x167 * (-1.7937848940989261e-5 + 1.1055029865854122e-5 * var_x14);
        IJth(rJacobian, 22, 0) = -1.528038983862048e-7 + var_x180 + 0.00013865004012358849 * var_x40 + 1.6862097911031213e-6 * var_x42 - 5.3149182047375591e-6 * var_x29 - 7.7509223819089404e-6 * var_x15 - 1.2844385661449098e-6 * var_chaste_interface__hyperpolarisation_activated_current_y_gate__y - 2.6574591023687795e-5 * var_x21 - 6.5133801528646552e-9 * var_x33;
        IJth(rJacobian, 23, 0) = var_x186 * (-13.386950228182727 * var_x4 - 13.386950228182727 * var_x6);
        ...
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x32 * var_x44);
        IJth(rJacobian, 2, 2) = -0.001 * var_x89;
        IJth(rJacobian, 20, 2) = -var_x162 * var_x44;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-8.0 * var_x47);
        IJth(rJacobian, 3, 3) = -0.001 * var_x107;
        IJth(rJacobian, 20, 3) = -0.00088581970078959317 * var_x47;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (var_x48 * var_x49);
        IJth(rJacobian, 4, 4) = -0.001 * var_x115;
        IJth(rJacobian, 23, 4) = var_x185 * var_x187 * var_x49;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x5 * var_x50);
        IJth(rJacobian, 5, 5) = -0.001 * var_x129;
        IJth(rJacobian, 23, 5) = var_x188 * var_x5;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x3 * var_x50);
        IJth(rJacobian, 6, 6) = -0.001 * var_x136;
        IJth(rJacobian, 23, 6) = var_x188 * var_x3;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x50 * var_x51);
        IJth(rJacobian, 7, 7) = -0.11111111111111112;
        IJth(rJacobian, 23, 7) = var_x188 * var_x51;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x0 * var_x41);
        IJth(rJacobian, 8, 8) = -0.045159999999999999 * var_x139 - 0.098900000000000002 * var_x140;
        IJth(rJacobian, 22, 8) = var_x179 * var_x41;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : ((7.8829925559919998 * var_x18 - 0.31010000000000004 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r);
        IJth(rJacobian, 9, 9) = -0.001 * var_x143;
        IJth(rJacobian, 22, 9) = (0.00087286376340942788 * var_x18 - 3.433658615185661e-5 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : ((1.0142902385813635 * var_x18 - 0.039900000000000005 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r);
        IJth(rJacobian, 10, 10) = -0.001 * var_x149;
        IJth(rJacobian, 22, 10) = (0.00011230978445674354 * var_x18 - 4.4180257576880966e-6 * var_chaste_interface__membrane__V) * var_chaste_interface__Ca_independent_transient_outward_K_current_r_gate__r;
        ...
        IJth(rJacobian, 11, 11) = -0.004516 * var_x139 - 0.0098900000000000012 * var_x140;
        IJth(rJacobian, 22, 11) = var_x181 * var_chaste_interface__steady_state_outward_K_current_s_ss_gate__s_ss;
        ...
        IJth(rJacobian, 22, 12) = var_x181 * var_chaste_interface__steady_state_outward_K_current_r_ss_gate__r_ss;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (0.29488137262014569 * var_x18 + 0.073720343155036422 * var_x43 - 0.014499999999999999 * var_chaste_interface__membrane__V);
        IJth(rJacobian, 13, 13) = -0.00056230000000000006 * var_x156 - 0.00011885 * var_x155;
        IJth(rJacobian, 20, 13) = 8.1628665394625614e-6 * var_x43 - 3.2110964153622751e-7 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 22, 13) = 3.2651466157850246e-5 * var_x18 - 1.2844385661449098e-6 * var_chaste_interface__membrane__V;
        IJth(rJacobian, 14, 14) = -0.67600000000000005 - var_x158;
        IJth(rJacobian, 15, 14) = var_x158;
        IJth(rJacobian, 16, 14) = 0.57600000000000007;
        IJth(rJacobian, 17, 14) = 0.10000000000000001;
        IJth(rJacobian, 23, 14) = var_x189;
        IJth(rJacobian, 24, 14) = var_x197;
        IJth(rJacobian, 14, 15) = 1.9299999999999999;
        IJth(rJacobian, 15, 15) = -1.9299999999999999;
        IJth(rJacobian, 23, 15) = var_x189;
        IJth(rJacobian, 24, 15) = var_x197;
        IJth(rJacobian, 14, 16) = var_x159;
        IJth(rJacobian, 16, 16) = -var_x159;
        ...
        IJth(rJacobian, 21, 18) = var_x167 * (0.066000000000000003 + var_x168);
        IJth(rJacobian, 19, 19) = -0.040000000000000001 - 40.0 * var_chaste_interface__intracellular_ion_concentrations__Ca_i;
        IJth(rJacobian, 21, 19) = var_x167 * (40.0 + var_x169);
        IJth(rJacobian, 0, 20) = mSetVoltageDerivativeToZero ? 0.0 : (4.7735212368995906e-13 * var_x57 - 203.36646387596258 * var_x59 - 0.073720343155036422 * var_x53 - 0.020374777599572999 * var_x34 - 0.00035942399999999995 * var_x58 - 0.029697911938972605 * var_x60);
        IJth(rJacobian, 20, 20) = 1.5856796826686865e-16 * var_x57 - 8.1628665394625614e-6 * var_x53 - 9.8651233004461501e-6 * var_x60 - 1.193943225512245e-7 * var_x58 - 2.2560474246135324e-6 * var_x34 - 0.022518252522655345 * var_x59;
        IJth(rJacobian, 21, 20) = var_x167 * (3.9798107517074834e-5 * var_x58 - 5.2855989422289547e-14 * var_x57);
        IJth(rJacobian, 22, 20) = 6.5767488669640998e-6 * var_x60;
        IJth(rJacobian, 0, 21) = mSetVoltageDerivativeToZero ? 0.0 : (0.040000000000000001 * var_x64 + 3.6384839650145766e-7 * var_x56 + 273.96096 * var_x65 - 0.0041181708934882417 * var_x61 - 0.040000000000000001 * var_x63);
        IJth(rJacobian, 18, 21) = 28.000000000000004 - 200.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa;
        IJth(rJacobian, 19, 21) = 2.8000000000000003 - 40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa;
        IJth(rJacobian, 20, 21) = 1.2086402914563544e-10 * var_x56 + 0.091005005855711127 * var_x65;
        IJth(rJacobian, 21, 21) = var_x167 * (-30837.453183520603 - var_x170 + 40000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 200000.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 3.5444788081288787e-5 * var_x178 + 0.0022145492519739826 * var_x64 - 4.0288009715211813e-8 * var_x56 - 0.00022799730679188537 * var_x61 - 30.33500195190371 * var_x65 - 1625.0626147884036 * var_x175) + 0.001 * (0.0029999999999999996 / pow(var_x163, 3) + 0.00023800000000000004 / pow(var_x164, 3)) * (40.0 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa + 0.066000000000000003 * var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa + 0.00022799730679188537 * log(1.2 * var_x61) + 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 37.453183520599246 * var_chaste_interface__intracellular_ion_concentrations__Ca_i - 1.7937848940989261e-5 * var_chaste_interface__membrane__V - var_x168 * (0.14000000000000001 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__HTRPNCa) - var_x169 * (0.070000000000000007 - var_chaste_interface__intracellular_and_SR_Ca_fluxes__LTRPNCa) - var_x170 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 1.1055029865854122e-5 * var_x55 * var_x8 - 1.0 * var_x173 * var_x176) / pow(var_x165, 2);
        IJth(rJacobian, 23, 21) = 29.213483146067414 * var_x184;
        IJth(rJacobian, 25, 21) = 3.0179734274641783 * var_x175 - 6.5826035008107738e-8 * var_x178;
        IJth(rJacobian, 0, 22) = mSetVoltageDerivativeToZero ? 0.0 : (0.38712000000000002 * var_x71 - 0.29488137262014569 * var_x66 - 0.0014953416461467835 * var_x70 - 0.035080715018603541 * var_x17 - 6.1009939162788767 * var_x68 - 1.7794565589146725 * var_x69 + var_x1 * var_x67);
        IJth(rJacobian, 22, 22) = 4.286481532120841e-5 * var_x71 - 0.00067554757567966038 * var_x68 - 3.8843985601580465e-6 * var_x17 - 3.2651466157850246e-5 * var_x66 - 1.6557538619599519e-7 * var_x70 - 0.00019703470957323427 * var_x69 + var_x180 * var_x67;
        IJth(rJacobian, 7, 23) = -0.0011111111111111113 / pow((0.01 + var_chaste_interface__intracellular_ion_concentrations__Ca_ss), 2);
        IJth(rJacobian, 14, 23) = var_x160 - var_x161;
        IJth(rJacobian, 15, 23) = var_x161;
        IJth(rJacobian, 16, 23) = -var_x160;
        IJth(rJacobian, 21, 23) = 0.037453183520599252 * var_x166;
        IJth(rJacobian, 23, 23) = var_x185 * (-29213.483146067414 - var_x190 - var_x191) + 2.3800000000000004e-7 * (29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_i + 84000.0 * var_x192 - 29213.483146067414 * var_chaste_interface__intracellular_ion_concentrations__Ca_ss - 13.386950228182727 * var_x49 * (-65.0 + var_chaste_interface__membrane__V) * var_chaste_interface__L_type_Ca_channel_d_gate__d) / (pow(var_x182, 3) * pow(var_x183, 2));
        IJth(rJacobian, 24, 23) = var_x196 * (var_x198 + var_x199);
        IJth(rJacobian, 23, 24) = var_x185 * (var_x190 + var_x191);
        IJth(rJacobian, 24, 24) = var_x196 * (-1740.0382808421784 - var_x198 - var_x199) + 0.00016666666666666666 * (1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_NSR - 1800.0 * var_x192 - 1740.0382808421784 * var_chaste_interface__intracellular_ion_concentrations__Ca_JSR) / (pow(var_x193, 3) * pow((0.083333333333333329 + var_x194), 2));
        IJth(rJacobian, 25, 24) = 0.19333758676024207;
        IJth(rJacobian, 21, 25) = var_x167 * (0.2735562310030395 * var_x173 + 2.651834266564234e-10 * var_x177);
        IJth(rJacobian, 24, 25) = 1.7400382808421784 * var_x195;
        IJth(rJacobian, 25, 25) = -0.19333758676024207 - 4.9248350664764349e-13 * var_x177 - 0.00050803300043421621 * var_x173;
    }
