...
#include "MathsCustomFunctions.hpp"
    ...
    void Cellearm_noble_model_1990FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time_converted, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double var_L_type_calcium_current_d_gate__d_orig_deriv = (-var_chaste_interface__L_type_calcium_current_d_gate__d + 1.0) * var_L_type_calcium_current_d_gate__alpha_d - var_L_type_calcium_current_d_gate__beta_d * var_chaste_interface__L_type_calcium_current_d_gate__d; // 1 / second
        ...
        const double var_intracellular_calcium_concentration__Ca_i_orig_deriv = -var_intracellular_calcium_concentration__Ca_Calmod_orig_deriv - var_intracellular_calcium_concentration__Ca_Trop_orig_deriv - var_sarcoplasmic_reticulum_calcium_pump__i_up + var_calcium_release__i_rel * var_intracellular_calcium_concentration__V_rel_ratio / var_intracellular_calcium_concentration__V_i_ratio - (-2.0 * var_Na_Ca_exchanger__i_NaCa + var_L_type_calcium_current__i_Ca_L_Ca + var_calcium_background_current__i_b_Ca) * 1.0 / (1.0 * 2.0 * var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / second
        ...
        const double var_sodium_potassium_pump__i_NaK_max = 0.14; // nanoA
        const double var_sodium_potassium_pump__i_NaK = var_extracellular_potassium_concentration__K_c * var_chaste_interface__intracellular_sodium_concentration__Na_i * var_sodium_potassium_pump__i_NaK_max / ((var_extracellular_potassium_concentration__K_c + var_sodium_potassium_pump__K_mK) * (var_chaste_interface__intracellular_sodium_concentration__Na_i + var_sodium_potassium_pump__K_mNa)); // nanoA
        const double var_intracellular_sodium_concentration__Na_i_orig_deriv = -(3.0 * var_sodium_potassium_pump__i_NaK + 3.0 * var_Na_Ca_exchanger__i_NaCa + var_L_type_calcium_current__i_Ca_L_Na + var_fast_sodium_current__i_Na + var_sodium_background_current__i_b_Na) * 1.0 * var_intracellular_sodium_concentration__conc_clamp / (1.0 * var_intracellular_calcium_concentration__V_i * var_membrane__F); // millimolar / second
        ...
        const double var_transient_outward_current__g_to = 0.01; // microS
        const double var_transient_outward_current__g_to_s = 0.0; // dimensionless
        const double var_transient_outward_current_r_gate__r_orig_deriv = (-var_chaste_interface__transient_outward_current_r_gate__r + 1.0 / (1.0 + exp((-4.0 - var_chaste_interface__membrane__V) / 5.0))) * 333.0; // 1 / second
