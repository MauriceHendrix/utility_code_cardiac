...
#include "MathsCustomFunctions.hpp"
    ...
    void Dynamicbeeler_reuter_model_1977FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
		...
		const double var_slow_inward_current__i_s = 1.0 * (-var_slow_inward_current__E_s + var_chaste_interface__membrane__V) * var_slow_inward_current__g_s * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_mm2
		...
		const double d_dt_chaste_interface__slow_inward_current_d_gate__d = 1.0 * (1.0 - var_chaste_interface__slow_inward_current_d_gate__d) * var_slow_inward_current_d_gate__alpha_d - 1.0 * var_slow_inward_current_d_gate__beta_d * var_chaste_interface__slow_inward_current_d_gate__d; // 1 / millisecond
		const double d_dt_chaste_interface__slow_inward_current_f_gate__f = 1.0 * (1.0 - var_chaste_interface__slow_inward_current_f_gate__f) * var_slow_inward_current_f_gate__alpha_f - 1.0 * var_slow_inward_current_f_gate__beta_f * var_chaste_interface__slow_inward_current_f_gate__f; // 1 / millisecond
		...
		const double d_dt_chaste_interface__sodium_current_h_gate__h = 1.0 * (1.0 - var_chaste_interface__sodium_current_h_gate__h) * var_sodium_current_h_gate__alpha_h - 1.0 * var_sodium_current_h_gate__beta_h * var_chaste_interface__sodium_current_h_gate__h; // 1 / millisecond
		const double d_dt_chaste_interface__sodium_current_j_gate__j = 1.0 * (1.0 - var_chaste_interface__sodium_current_j_gate__j) * var_sodium_current_j_gate__alpha_j - 1.0 * var_sodium_current_j_gate__beta_j * var_chaste_interface__sodium_current_j_gate__j; // 1 / millisecond
		const double d_dt_chaste_interface__sodium_current_m_gate__m = 1.0 * (1.0 - var_chaste_interface__sodium_current_m_gate__m) * var_sodium_current_m_gate__alpha_m - 1.0 * var_sodium_current_m_gate__beta_m * var_chaste_interface__sodium_current_m_gate__m; // 1 / millisecond
		const double d_dt_chaste_interface__time_dependent_outward_current_x1_gate__x1 = 1.0 * (1.0 - var_chaste_interface__time_dependent_outward_current_x1_gate__x1) * var_time_dependent_outward_current_x1_gate__alpha_x1 - 1.0 * var_time_dependent_outward_current_x1_gate__beta_x1 * var_chaste_interface__time_dependent_outward_current_x1_gate__x1; // 1 / millisecond
        ...
        else
        {
			...
			const double var_sodium_current__g_Na = 0.04; // mS_per_mm2
			const double var_sodium_current__g_Nac = 3e-05; // mS_per_mm2
			const double var_sodium_current__i_Na = 1.0 * (-var_sodium_current__E_Na + var_chaste_interface__membrane__V) * (pow(var_chaste_interface__sodium_current_m_gate__m, 3.0) * var_sodium_current__g_Na * var_chaste_interface__sodium_current_h_gate__h * var_chaste_interface__sodium_current_j_gate__j + var_sodium_current__g_Nac); // uA_per_mm2
			...
			const double var_time_dependent_outward_current__i_x1 = 0.0019727757115328517 * (-1.0 + 21.75840239619708 * exp(0.04 * var_chaste_interface__membrane__V)) * var_chaste_interface__time_dependent_outward_current_x1_gate__x1 * exp(-0.04 * var_chaste_interface__membrane__V); // uA_per_mm2
			const double var_time_independent_outward_current__i_K1 = 0.0007000000000000001 * (23.0 + var_chaste_interface__membrane__V) / (1.0 - 0.39851904108451414 * exp(-0.04 * var_chaste_interface__membrane__V)) + 0.014 * (-1.0 + 29.96410004739701 * exp(0.04 * var_chaste_interface__membrane__V)) / (8.331137487687693 * exp(0.04 * var_chaste_interface__membrane__V) + 69.4078518387552 * exp(0.08 * var_chaste_interface__membrane__V)); // uA_per_mm2
			d_dt_chaste_interface__membrane__V = 1.0 * (-var_slow_inward_current__i_s - var_sodium_current__i_Na - var_time_dependent_outward_current__i_x1 - var_time_independent_outward_current__i_K1 + var_stimulus_protocol__Istim) / var_membrane__C; // millivolt / millisecond
        }
