...
#include "MathsCustomFunctions.hpp"
    ...
    double Cellbeeler_reuter_model_1977FromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_slow_inward_current__E_s = -82.3 - 13.0287 * log(0.001 * var_slow_inward_current__Cai); // mV
    ...
    void Cellbeeler_reuter_model_1977FromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        ...
        const double d_dt_chaste_interface_var_slow_inward_current_d_gate__d = (-var_chaste_interface__slow_inward_current_d_gate__d + 1.0) * var_slow_inward_current_d_gate__alpha_d - var_slow_inward_current_d_gate__beta_d * var_chaste_interface__slow_inward_current_d_gate__d; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_slow_inward_current_f_gate__f = (-var_chaste_interface__slow_inward_current_f_gate__f + 1.0) * var_slow_inward_current_f_gate__alpha_f - var_slow_inward_current_f_gate__beta_f * var_chaste_interface__slow_inward_current_f_gate__f; // 1 / ms
        const double var_slow_inward_current__i_s = (-var_slow_inward_current__E_s + var_chaste_interface__membrane__V) * var_slow_inward_current__g_s * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f; // uA_per_mm2
        const double var_slow_inward_current__Cai_orig_deriv = (-var_slow_inward_current__Cai + 0.0001) * 0.07 - 0.01 * var_slow_inward_current__i_s / 1.0; // concentration_units / ms
        ...
        const double d_dt_chaste_interface_var_sodium_current_h_gate__h = (-var_chaste_interface__sodium_current_h_gate__h + 1.0) * var_sodium_current_h_gate__alpha_h - var_sodium_current_h_gate__beta_h * var_chaste_interface__sodium_current_h_gate__h; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_sodium_current_j_gate__j = (-var_chaste_interface__sodium_current_j_gate__j + 1.0) * var_sodium_current_j_gate__alpha_j - var_sodium_current_j_gate__beta_j * var_chaste_interface__sodium_current_j_gate__j; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_sodium_current_m_gate__m = (-var_chaste_interface__sodium_current_m_gate__m + 1.0) * var_sodium_current_m_gate__alpha_m - var_sodium_current_m_gate__beta_m * var_chaste_interface__sodium_current_m_gate__m; // 1 / ms
        ...
        const double d_dt_chaste_interface_var_time_dependent_outward_current_x1_gate__x1 = (-var_chaste_interface__time_dependent_outward_current_x1_gate__x1 + 1.0) * var_time_dependent_outward_current_x1_gate__alpha_x1 - var_time_dependent_outward_current_x1_gate__beta_x1 * var_chaste_interface__time_dependent_outward_current_x1_gate__x1; // 1 / ms
        ...
        else
        {
            ...
            const double var_stimulus_protocol__Istim = 0.01 * var_stimulus_protocol__Istim_converter; // uA_per_mm2
            const double var_time_dependent_outward_current__i_x1 = (-1.0 + exp((77.0 + var_chaste_interface__membrane__V) * 0.04)) * 0.008 * var_chaste_interface__time_dependent_outward_current_x1_gate__x1 * exp(-(35.0 + var_chaste_interface__membrane__V) * 0.04); // uA_per_mm2
            const double var_time_independent_outward_current__i_K1 = ((23.0 + var_chaste_interface__membrane__V) * 0.2 / (-exp(-(23.0 + var_chaste_interface__membrane__V) * 0.04) + 1.0) + (-1.0 + exp((85.0 + var_chaste_interface__membrane__V) * 0.04)) * 4.0 / (exp((53.0 + var_chaste_interface__membrane__V) * 0.08) + exp((53.0 + var_chaste_interface__membrane__V) * 0.04))) * 0.0035; // uA_per_mm2
