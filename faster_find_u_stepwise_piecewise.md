...
*U*: 2.0 * Environment__FonRT * cell__V
*V for 1e-07 range* 
...
singularity processing time: 42.18343740000002
...
singularity processing time: 52.856734200000034
# Model: bueno_2007(bueno_2007_endo.cellml)
load time: 0.3424665999999661

singularity processing time: 3.610394900000017
# Model: bueno_2007(bueno_2007_epi.cellml)
load time: 0.34379820000003747

singularity processing time: 3.6231771999999864
# Model: Carro_Rodriguez_Laguna_Pueyo_CinC2010_EPI(carro_2011_endo.cellml)
load time: 3.6214686000000142
...
singularity processing time: 76.6472913
...
singularity processing time: 21.77940239999998
...
singularity processing time: 38.92712930000005
# Model: difrancesco_noble_model_1985(difrancesco_noble_model_1985.cellml)
load time: 2.238200699999993
...
5.0000002500517279*_intracellular_calcium_concentration$Cai*_transient_outward_current$g_to*_transient_outward_current_s_gate$s*(_extracellular_potassium_concentration$Kc/(_extracellular_potassium_concentration$Kc + _transient_outward_current$Km_to) + 0.20000000000000001)*(-_extracellular_potassium_concentration$Kc*exp(4.99999975/_membrane$RTONF) + _intracellular_potassium_concentration$Ki*exp(-4.99999975/_membrane$RTONF))/(_intracellular_calcium_concentration$Cai + _transient_outward_current$Km_Ca) + (-999999.99999899991*_membrane$V - 9999999.4999899991)*(-5.0000002500517279*_intracellular_calcium_concentration$Cai*_transient_outward_current$g_to*_transient_outward_current_s_gate$s*(_extracellular_potassium_concentration$Kc/(_extracellular_potassium_concentration$Kc + _transient_outward_current$Km_to) + 0.20000000000000001)*(-_extracellular_potassium_concentration$Kc*exp(4.99999975/_membrane$RTONF) + _intracellular_potassium_concentration$Ki*exp(-4.99999975/_membrane$RTONF))/(_intracellular_calcium_concentration$Cai + _transient_outward_current$Km_Ca) + 4.9999997499743179*_intracellular_calcium_concentration$Cai*_transient_outward_current$g_to*_transient_outward_current_s_gate$s*(_extracellular_potassium_concentration$Kc/(_extracellular_potassium_concentration$Kc + _transient_outward_current$Km_to) + 0.20000000000000001)*(-_extracellular_potassium_concentration$Kc*exp(5.00000025/_membrane$RTONF) + _intracellular_potassium_concentration$Ki*exp(-5.00000025/_membrane$RTONF))/(_intracellular_calcium_concentration$Cai + _transient_outward_current$Km_Ca))
## Equation 5:
```
...
singularity processing time: 69.52814149999995
# Model: earm_noble_model_1990(earm_noble_model_1990.cellml)
load time: 2.228879400000096
...
singularity processing time: 25.082355699999994
# Model: espinosa_model_1998(espinosa_model_1998_normal.cellml)
load time: 3.945194400000105
...
singularity processing time: 36.05036669999993
...
singularity processing time: 41.539569400000005
# Model: fink_noble_giles_model_2008(fink_noble_giles_model_2008.cellml)
load time: 2.6810727000000725
...
singularity processing time: 33.44440559999998
# Model: fox_model_2001(fox_mcharg_gilmour_2002.cellml)
load time: 1.968894299999988
...
*U*: 2.0 * membrane__F * membrane__V / (membrane__R * membrane__T)
*V for 1e-07 range* 
`-4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F - 4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F`
10000000.0*_membrane$F*(_membrane$V + 4.9999999999999998e-8*_membrane$R*_membrane$T/_membrane$F)*(-2.0000001000013437*_L_type_Ca_current$P_Ca*_membrane$F*(0.999999900000005*_calcium_dynamics$Ca_i - 0.34100000000000003*_standard_ionic_concentrations$Ca_o)/_L_type_Ca_current$C_sc + 1.9999998999877269*_L_type_Ca_current$P_Ca*_membrane$F*(1.000000100000005*_calcium_dynamics$Ca_i - 0.34100000000000003*_standard_ionic_concentrations$Ca_o)/_L_type_Ca_current$C_sc)/(_membrane$R*_membrane$T) + 2.0000001000013437*_L_type_Ca_current$P_Ca*_membrane$F*(0.999999900000005*_calcium_dynamics$Ca_i - 0.34100000000000003*_standard_ionic_concentrations$Ca_o)/_L_type_Ca_current$C_sc
found! 
## Equation 3:
```
...
## New Eq:
```
L_type_Ca_current__i_Ca_max = ((fabs(membrane__V) < 4.9999999999999998e-8 * fabs(membrane__R * membrane__T / membrane__F)) ? (2.0000001000013437 * (0.99999990000000505 * calcium_dynamics__Ca_i - 0.34100000000000003 * standard_ionic_concentrations__Ca_o) * L_type_Ca_current__P_Ca * membrane__F / L_type_Ca_current__C_sc + 10000000.0 * (4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F + membrane__V) * (1.9999998999877269 * (1.0000001000000049 * calcium_dynamics__Ca_i - 0.34100000000000003 * standard_ionic_concentrations__Ca_o) * L_type_Ca_current__P_Ca * membrane__F / L_type_Ca_current__C_sc - 2.0000001000013437 * (0.99999990000000505 * calcium_dynamics__Ca_i - 0.34100000000000003 * standard_ionic_concentrations__Ca_o) * L_type_Ca_current__P_Ca * membrane__F / L_type_Ca_current__C_sc) * membrane__F / (membrane__R * membrane__T)) : (4.0 * pow(membrane__F, 2) * (-0.34100000000000003 * standard_ionic_concentrations__Ca_o + calcium_dynamics__Ca_i * exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T))) * L_type_Ca_current__P_Ca * membrane__V / ((-1.0 + exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T))) * L_type_Ca_current__C_sc * membrane__R * membrane__T)))
...
singularity processing time: 20.43887940000002
# Model: grandi_pasqualini_bers_2010(grandi_pasqualini_bers_2010_ss.cellml)
load time: 3.7899542999999767

*U*: -0.83333333333333337 - 0.16666666666666666 * membrane_potential__V_m
*V for 1e-07 range* 
`-4.9999994000000001 - -5.0000005999999999`
4.7609898827516428e-7*_I_Ca$dss*(-833333.33332864499*_membrane_potential$V_m - 4166666.1666432249) + 4.7619045238208482*_I_Ca$dss
## Equation 1:
```
...
## New Eq:
```
I_Ca__taud = ((fabs(5.0 + membrane_potential__V_m) < 6.0000000000337561e-7) ? (4.7619045238208484 * I_Ca__dss + 4.7609898827516428e-7 * (-4166666.1666432251 - 833333.33332864498 * membrane_potential__V_m) * I_Ca__dss) : (28.571428571428569 * (1.0 - exp(-0.83333333333333337 - 0.16666666666666666 * membrane_potential__V_m)) * I_Ca__dss / (5.0 + membrane_potential__V_m)))

```

*U*: 2.0 * membrane_potential__V_m * parameters__FoRT
*V for 1e-07 range* 
`-4.9999999999999998e-8 / parameters__FoRT - 4.9999999999999998e-8 / parameters__FoRT`
10000000.0*_parameters$FoRT*(_membrane_potential$V_m + 4.9999999999999998e-8/_parameters$FoRT)*(-2.0000001000013437*_parameters$Frdy*_parameters$pCa*(0.34099996590000173*_Ca_Concentrations$Ca_j - 0.34100000000000003*_parameters$Cao) + 1.9999998999877269*_parameters$Frdy*_parameters$pCa*(0.34100003410000173*_Ca_Concentrations$Ca_j - 0.34100000000000003*_parameters$Cao)) + 2.0000001000013437*_parameters$Frdy*_parameters$pCa*(0.34099996590000173*_Ca_Concentrations$Ca_j - 0.34100000000000003*_parameters$Cao)
## Equation 2:
```
...
## New Eq:
```
I_Ca__ibarca_j = ((fabs(membrane_potential__V_m) < 4.9999999999999998e-8 / fabs(parameters__FoRT)) ? (2.0000001000013437 * (0.34099996590000176 * Ca_Concentrations__Ca_j - 0.34100000000000003 * parameters__Cao) * parameters__Frdy * parameters__pCa + 10000000.0 * (4.9999999999999998e-8 / parameters__FoRT + membrane_potential__V_m) * (1.9999998999877269 * (0.34100003410000174 * Ca_Concentrations__Ca_j - 0.34100000000000003 * parameters__Cao) * parameters__Frdy * parameters__pCa - 2.0000001000013437 * (0.34099996590000176 * Ca_Concentrations__Ca_j - 0.34100000000000003 * parameters__Cao) * parameters__Frdy * parameters__pCa) * parameters__FoRT) : (4.0 * (-0.34100000000000003 * parameters__Cao + 0.34100000000000003 * Ca_Concentrations__Ca_j * exp(2.0 * membrane_potential__V_m * parameters__FoRT)) * membrane_potential__V_m * parameters__FoRT * parameters__Frdy * parameters__pCa / (-1.0 + exp(2.0 * membrane_potential__V_m * parameters__FoRT))))
...
*V for 1e-07 range* 
`-4.9999999999999998e-8 / parameters__FoRT - 4.9999999999999998e-8 / parameters__FoRT`
10000000.0*_parameters$FoRT*(_membrane_potential$V_m + 4.9999999999999998e-8/_parameters$FoRT)*(-2.0000001000013437*_parameters$Frdy*_parameters$pCa*(0.34099996590000173*_Ca_Concentrations$Ca_sl - 0.34100000000000003*_parameters$Cao) + 1.9999998999877269*_parameters$Frdy*_parameters$pCa*(0.34100003410000173*_Ca_Concentrations$Ca_sl - 0.34100000000000003*_parameters$Cao)) + 2.0000001000013437*_parameters$Frdy*_parameters$pCa*(0.34099996590000173*_Ca_Concentrations$Ca_sl - 0.34100000000000003*_parameters$Cao)
## Equation 3:
```
...
## New Eq:
```
I_Ca__ibarca_sl = ((fabs(membrane_potential__V_m) < 4.9999999999999998e-8 / fabs(parameters__FoRT)) ? (2.0000001000013437 * (0.34099996590000176 * Ca_Concentrations__Ca_sl - 0.34100000000000003 * parameters__Cao) * parameters__Frdy * parameters__pCa + 10000000.0 * (4.9999999999999998e-8 / parameters__FoRT + membrane_potential__V_m) * (1.9999998999877269 * (0.34100003410000174 * Ca_Concentrations__Ca_sl - 0.34100000000000003 * parameters__Cao) * parameters__Frdy * parameters__pCa - 2.0000001000013437 * (0.34099996590000176 * Ca_Concentrations__Ca_sl - 0.34100000000000003 * parameters__Cao) * parameters__Frdy * parameters__pCa) * parameters__FoRT) : (4.0 * (-0.34100000000000003 * parameters__Cao + 0.34100000000000003 * Ca_Concentrations__Ca_sl * exp(2.0 * membrane_potential__V_m * parameters__FoRT)) * membrane_potential__V_m * parameters__FoRT * parameters__Frdy * parameters__pCa / (-1.0 + exp(2.0 * membrane_potential__V_m * parameters__FoRT))))

```

*U*: membrane_potential__V_m * parameters__FoRT
*V for 1e-07 range* 
`-9.9999999999999995e-8 / parameters__FoRT - 9.9999999999999995e-8 / parameters__FoRT`
5000000.0*_parameters$FoRT*(_membrane_potential$V_m + 1.0e-7/_parameters$FoRT)*(-1.0000000504863945*_parameters$Frdy*_parameters$pK*(0.74999992500000379*_K_Concentration$K_i - 0.75*_parameters$Ko) + 0.99999995056632214*_parameters$Frdy*_parameters$pK*(0.75000007500000371*_K_Concentration$K_i - 0.75*_parameters$Ko)) + 1.0000000504863945*_parameters$Frdy*_parameters$pK*(0.74999992500000379*_K_Concentration$K_i - 0.75*_parameters$Ko)
## Equation 4:
```
...
*V for 1e-07 range* 
`-9.9999999999999995e-8 / parameters__FoRT - 9.9999999999999995e-8 / parameters__FoRT`
5000000.0*_parameters$FoRT*(_membrane_potential$V_m + 1.0e-7/_parameters$FoRT)*(-1.0000000504863945*_parameters$Frdy*_parameters$pNa*(0.74999992500000379*_Na_Concentrations$Na_j - 0.75*_parameters$Nao) + 0.99999995056632214*_parameters$Frdy*_parameters$pNa*(0.75000007500000371*_Na_Concentrations$Na_j - 0.75*_parameters$Nao)) + 1.0000000504863945*_parameters$Frdy*_parameters$pNa*(0.74999992500000379*_Na_Concentrations$Na_j - 0.75*_parameters$Nao)
## Equation 5:
```
...
singularity processing time: 85.99534779999999
# Model: hilgemann_noble_model_1987(hilgemann_noble_model_1987.cellml)
load time: 2.092018000000053
...
singularity processing time: 43.00477069999988
# Model: iribe_model_2006(iribe_model_2006.cellml)
load time: 5.19658789999994
...
singularity processing time: 36.195007199999964
# Model: IyerMazhariWinslow2004(iyer_2004.cellml)
load time: 3.5221292000001085
...
singularity processing time: 85.17106680000006
# Model: iyer_model_2007(iyer_model_2007.cellml)
load time: 3.5836009000001923
...
singularity processing time: 86.71019679999995
# Model: jafri_rice_winslow_1998(jafri_rice_winslow_model_1998.cellml)
load time: 2.919430899999952

*U*: 2.0 * membrane__F * membrane__V / (membrane__R * membrane__T)
*V for 1e-07 range* 
`-4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F - 4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F`
2.0000001000013437*_L_type_Ca_channel$P_Ca*_membrane$F*(0.00099999990000000502 - 0.34100000000000003*_ionic_concentrations$Cao) + 10000000.0*_membrane$F*(_membrane$V + 4.9999999999999998e-8*_membrane$R*_membrane$T/_membrane$F)*(-2.0000001000013437*_L_type_Ca_channel$P_Ca*_membrane$F*(0.00099999990000000502 - 0.34100000000000003*_ionic_concentrations$Cao) + 1.9999998999877269*_L_type_Ca_channel$P_Ca*_membrane$F*(0.001000000100000005 - 0.34100000000000003*_ionic_concentrations$Cao))/(_membrane$R*_membrane$T)
found! 
## Equation 1:
```
...
## New Eq:
```
L_type_Ca_channel__i_Ca_L_Ca_max = ((fabs(membrane__V) < 4.9999999999999998e-8 * fabs(membrane__R * membrane__T / membrane__F)) ? (2.0000001000013437 * (0.00099999990000000497 - 0.34100000000000003 * ionic_concentrations__Cao) * L_type_Ca_channel__P_Ca * membrane__F + 10000000.0 * (4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F + membrane__V) * (1.9999998999877269 * (0.001000000100000005 - 0.34100000000000003 * ionic_concentrations__Cao) * L_type_Ca_channel__P_Ca * membrane__F - 2.0000001000013437 * (0.00099999990000000497 - 0.34100000000000003 * ionic_concentrations__Cao) * L_type_Ca_channel__P_Ca * membrane__F) * membrane__F / (membrane__R * membrane__T)) : (4.0 * pow(membrane__F, 2) * (0.001 * exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T)) - 0.34100000000000003 * ionic_concentrations__Cao) * L_type_Ca_channel__P_Ca * membrane__V / ((-1.0 + exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T))) * membrane__R * membrane__T)))
...
singularity processing time: 36.634250300000076
# Model: kurata_model_2002(kurata_model_2002.cellml)
load time: 3.765527999999904
...
singularity processing time: 39.88691229999995
# Model: lindblad_atrial_model_1996(lindblad_model_1996.cellml)
load time: 3.3270926000000145

*U*: -0.20798668885191349 * membrane__V
*V for 1e-07 range* 
`4.8079999999999991e-7 - -4.8079999999999991e-7`
-16.719999999999999*_L_type_Ca_channel_d_L_gate$E0_alpha_d_L/(-1.0 + exp(-0.4*_L_type_Ca_channel_d_L_gate$E0_alpha_d_L)) + 25.001702097053911*_membrane$V + 240.39999999934313
## Equation 1:
```
...
## New Eq:
```
L_type_Ca_channel_d_L_gate__alpha_d_L = ((fabs(membrane__V) < 4.8079999999999991e-7) ? (240.39999999934312 + 25.001702097053911 * membrane__V - 16.719999999999999 * L_type_Ca_channel_d_L_gate__E0_alpha_d_L / (-1.0 + exp(-0.40000000000000002 * L_type_Ca_channel_d_L_gate__E0_alpha_d_L))) : (-50.0 * membrane__V / (-1.0 + exp(-0.20798668885191349 * membrane__V)) - 16.719999999999999 * L_type_Ca_channel_d_L_gate__E0_alpha_d_L / (-1.0 + exp(-0.40000000000000002 * L_type_Ca_channel_d_L_gate__E0_alpha_d_L))))
...
singularity processing time: 33.822992800000065
# Model: LivshitzRudy2007(livshitz_rudy_2007.cellml)
load time: 2.391113599999926

*U*: 2.0 * Environment__FonRT * cell__V
*V for 1e-07 range* 
`-4.9999999999999998e-8 / Environment__FonRT - 4.9999999999999998e-8 / Environment__FonRT`
2.0000001000013437*_Environment$F*_ICaL$pca*(0.999999900000005*_Ca$Ca_i*_ICaL$gacai - _Environment$Ca_o*_ICaL$gacao) + 10000000.0*_Environment$FonRT*(_cell$V + 4.9999999999999998e-8/_Environment$FonRT)*(-2.0000001000013437*_Environment$F*_ICaL$pca*(0.999999900000005*_Ca$Ca_i*_ICaL$gacai - _Environment$Ca_o*_ICaL$gacao) + 1.9999998999877269*_Environment$F*_ICaL$pca*(1.000000100000005*_Ca$Ca_i*_ICaL$gacai - _Environment$Ca_o*_ICaL$gacao))
## Equation 1:
```
...
## New Eq:
```
ICaL__ibarca = ((fabs(cell__V) < 4.9999999999999998e-8 / fabs(Environment__FonRT)) ? (2.0000001000013437 * (-Environment__Ca_o * ICaL__gacao + 0.99999990000000505 * Ca__Ca_i * ICaL__gacai) * Environment__F * ICaL__pca + 10000000.0 * (4.9999999999999998e-8 / Environment__FonRT + cell__V) * (1.9999998999877269 * (-Environment__Ca_o * ICaL__gacao + 1.0000001000000049 * Ca__Ca_i * ICaL__gacai) * Environment__F * ICaL__pca - 2.0000001000013437 * (-Environment__Ca_o * ICaL__gacao + 0.99999990000000505 * Ca__Ca_i * ICaL__gacai) * Environment__F * ICaL__pca) * Environment__FonRT) : (4.0 * (-Environment__Ca_o * ICaL__gacao + Ca__Ca_i * ICaL__gacai * exp(2.0 * Environment__FonRT * cell__V)) * Environment__F * Environment__FonRT * ICaL__pca * cell__V / (-1.0 + exp(2.0 * Environment__FonRT * cell__V))))
...
*V for 1e-07 range* 
`-9.9999999999999995e-8 / Environment__FonRT - 9.9999999999999995e-8 / Environment__FonRT`
1.0000000504863945*_Environment$F*_ICaL$pk*(-_Environment$K_o*_ICaL$gako + 0.999999900000005*_ICaL$gaki*_K$K_i) + 5000000.0*_Environment$FonRT*(_cell$V + 1.0e-7/_Environment$FonRT)*(-1.0000000504863945*_Environment$F*_ICaL$pk*(-_Environment$K_o*_ICaL$gako + 0.999999900000005*_ICaL$gaki*_K$K_i) + 0.99999995056632214*_Environment$F*_ICaL$pk*(-_Environment$K_o*_ICaL$gako + 1.0000001*_ICaL$gaki*_K$K_i))
## Equation 2:
```
...
## New Eq:
```
ICaL__ibark = ((fabs(cell__V) < 9.9999999999999995e-8 / fabs(Environment__FonRT)) ? (5000000.0 * (9.9999999999999995e-8 / Environment__FonRT + cell__V) * (0.99999995056632218 * (-Environment__K_o * ICaL__gako + 1.0000001000000049 * ICaL__gaki * K__K_i) * Environment__F * ICaL__pk - 1.0000000504863944 * (-Environment__K_o * ICaL__gako + 0.99999990000000505 * ICaL__gaki * K__K_i) * Environment__F * ICaL__pk) * Environment__FonRT + 1.0000000504863944 * (-Environment__K_o * ICaL__gako + 0.99999990000000505 * ICaL__gaki * K__K_i) * Environment__F * ICaL__pk) : ((-Environment__K_o * ICaL__gako + ICaL__gaki * K__K_i * exp(Environment__FonRT * cell__V)) * Environment__F * Environment__FonRT * ICaL__pk * cell__V / (-1.0 + exp(Environment__FonRT * cell__V))))
...
*V for 1e-07 range* 
`-9.9999999999999995e-8 / Environment__FonRT - 9.9999999999999995e-8 / Environment__FonRT`
1.0000000504863945*_Environment$F*_ICaL$pna*(-_Environment$Na_o*_ICaL$ganao + 0.999999900000005*_ICaL$ganai*_Na$Na_i) + 5000000.0*_Environment$FonRT*(_cell$V + 1.0e-7/_Environment$FonRT)*(-1.0000000504863945*_Environment$F*_ICaL$pna*(-_Environment$Na_o*_ICaL$ganao + 0.999999900000005*_ICaL$ganai*_Na$Na_i) + 0.99999995056632214*_Environment$F*_ICaL$pna*(-_Environment$Na_o*_ICaL$ganao + 1.0000001*_ICaL$ganai*_Na$Na_i))
## Equation 3:
```
...
## New Eq:
```
ICaL__ibarna = ((fabs(cell__V) < 9.9999999999999995e-8 / fabs(Environment__FonRT)) ? (5000000.0 * (9.9999999999999995e-8 / Environment__FonRT + cell__V) * (0.99999995056632218 * (-Environment__Na_o * ICaL__ganao + 1.0000001000000049 * ICaL__ganai * Na__Na_i) * Environment__F * ICaL__pna - 1.0000000504863944 * (-Environment__Na_o * ICaL__ganao + 0.99999990000000505 * ICaL__ganai * Na__Na_i) * Environment__F * ICaL__pna) * Environment__FonRT + 1.0000000504863944 * (-Environment__Na_o * ICaL__ganao + 0.99999990000000505 * ICaL__ganai * Na__Na_i) * Environment__F * ICaL__pna) : ((-Environment__Na_o * ICaL__ganao + ICaL__ganai * Na__Na_i * exp(Environment__FonRT * cell__V)) * Environment__F * Environment__FonRT * ICaL__pna * cell__V / (-1.0 + exp(Environment__FonRT * cell__V))))
...
4.579463461912292e-7*_ICaL$dss0*(-801282.05129393816*_cell$V - 8012820.0129393816) + 4.5787543497625664*_ICaL$dss0
## Equation 4:
```
...
## New Eq:
```
ICaL__taud = ((fabs(10.0 + cell__V) < 6.2399999999074307e-7) ? (4.5787543497625665 * ICaL__dss0 + 4.579463461912292e-7 * (-8012820.0129393814 - 801282.05129393819 * cell__V) * ICaL__dss0) : (28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * cell__V)) * ICaL__dss0 / (10.0 + cell__V)))
...
singularity processing time: 60.305409900000086
# Model: Li_Mouse_2010(li_mouse_2010.cellml)
load time: 2.790564800000084
...
singularity processing time: 36.09290280000005
# Model: luo_rudy_1991(luo_rudy_1991.cellml)
load time: 1.7084861999999248

singularity processing time: 10.119192299999895
# Model: luo_rudy_1994(luo_rudy_1994.cellml)
load time: 2.148309500000096
...
*V for 1e-07 range* 
`-9.9999993759999999 - -10.000000624`
4.579463461912292e-7*_L_type_Ca_channel_d_gate$d_infinity*(-801282.05129393816*_membrane$V - 8012820.0129393816) + 4.5787543497625664*_L_type_Ca_channel_d_gate$d_infinity
## Equation 4:
```
...
## New Eq:
```
L_type_Ca_channel_d_gate__tau_d = ((fabs(10.0 + membrane__V) < 6.2399999999074307e-7) ? (4.5787543497625665 * L_type_Ca_channel_d_gate__d_infinity + 4.579463461912292e-7 * (-8012820.0129393814 - 801282.05129393819 * membrane__V) * L_type_Ca_channel_d_gate__d_infinity) : (28.571428571428569 * (1.0 - exp(-1.6025641025641024 - 0.16025641025641024 * membrane__V)) * L_type_Ca_channel_d_gate__d_infinity / (10.0 + membrane__V)))
...
singularity processing time: 28.03743170000007
# Model: MahajanShiferaw2008_units(mahajan_shiferaw_2008.cellml)
load time: 2.5979389999999967

singularity processing time: 41.75622790000011
# Model: Maleckar(maleckar_model_2009.cellml)
load time: 2.366706000000022
...
singularity processing time: 39.85180270000001
# Model: maltsev_2009(maltsev_2009.cellml)
load time: 4.110709600000064

singularity processing time: 33.82875119999994
# Model: matsuoka_model_2003(matsuoka_model_2003.cellml)
load time: 3.543851899999936

singularity processing time: 117.78955410000003
# Model: mcallister_noble_tsien_1975_modelB(mcallister_noble_tsien_1975_b.cellml)
load time: 0.609772699999894
...
*U*: 0.040000000000000001 * membrane__V - 0.040000000000000001 * pacemaker_potassium_current__E_K
*V for 1e-07 range* 
`-2.4999999999999998e-6 + pacemaker_potassium_current__E_K - 2.4999999999999998e-6 + pacemaker_potassium_current__E_K`
(2.800000140017189e-7/(11.023177482959295*exp(0.04*_pacemaker_potassium_current$E_K) + 121.51044182082082*exp(0.08*_pacemaker_potassium_current$E_K)) + 2.7999998599981256e-7/(11.023175278324019*exp(0.04*_pacemaker_potassium_current$E_K) + 121.51039321665381*exp(0.08*_pacemaker_potassium_current$E_K)))*(200000.00000000001*_membrane$V - 200000.00000000001*_pacemaker_potassium_current$E_K + 0.5) - 2.7999998599981256e-7/(11.023175278324019*exp(0.04*_pacemaker_potassium_current$E_K) + 121.51039321665381*exp(0.08*_pacemaker_potassium_current$E_K))
## Equation 2:
```
...
### Partially evaluated to: 
```
pacemaker_potassium_current__I_K2 = 2.7999999999999998 * (-1.0 + exp(0.040000000000000001 * membrane__V - 0.040000000000000001 * pacemaker_potassium_current__E_K)) / (11.023176380641601 * exp(0.040000000000000001 * membrane__V) + 121.51041751873488 * exp(0.080000000000000002 * membrane__V))
```
## New Eq:
```
pacemaker_potassium_current__I_K2 = ((fabs(-pacemaker_potassium_current__E_K + membrane__V) < 2.4999999999999998e-6) ? (-2.7999998599981256e-7 / (11.023175278324018 * exp(0.040000000000000001 * pacemaker_potassium_current__E_K) + 121.51039321665381 * exp(0.080000000000000002 * pacemaker_potassium_current__E_K)) + (2.7999998599981256e-7 / (11.023175278324018 * exp(0.040000000000000001 * pacemaker_potassium_current__E_K) + 121.51039321665381 * exp(0.080000000000000002 * pacemaker_potassium_current__E_K)) + 2.8000001400171891e-7 / (121.51044182082082 * exp(0.080000000000000002 * pacemaker_potassium_current__E_K) + 11.023177482959294 * exp(0.040000000000000001 * pacemaker_potassium_current__E_K))) * (0.5 + 200000.0 * membrane__V - 200000.0 * pacemaker_potassium_current__E_K)) : (2.7999999999999998 * (-1.0 + exp(0.040000000000000001 * membrane__V - 0.040000000000000001 * pacemaker_potassium_current__E_K)) / (exp(2.3999999999999999 + 0.040000000000000001 * membrane__V) + exp(4.7999999999999998 + 0.080000000000000002 * membrane__V))))

```

*U*: 0.20000000000000001 * pacemaker_potassium_current_s_gate__E_s - 0.20000000000000001 * membrane__V
*V for 1e-07 range* 
...
0.0005000340419503147*_membrane$V - 0.0005000340419503147*_pacemaker_potassium_current_s_gate$E_s + 0.004999999999986338
## Equation 3:
```
...
## New Eq:
```
pacemaker_potassium_current_s_gate__alpha_s = ((fabs(-pacemaker_potassium_current_s_gate__E_s + membrane__V) < 4.9999999999999998e-7) ? (0.0049999999999863383 + 0.00050003404195031464 * membrane__V - 0.00050003404195031464 * pacemaker_potassium_current_s_gate__E_s) : (0.001 * (-pacemaker_potassium_current_s_gate__E_s + membrane__V) / (1.0 - exp(0.20000000000000001 * pacemaker_potassium_current_s_gate__E_s - 0.20000000000000001 * membrane__V))))
...
*U*: 0.040000000000000001 * time_independent_outward_current__E_K1 - 0.040000000000000001 * membrane__V
*V for 1e-07 range* 
...
0.10000680838867515*_membrane$V + 0.35714285714285717*_pacemaker_potassium_current$I_K2 - 0.10000680838867515*_time_independent_outward_current$E_K1 + 4.9999999999863385
## Equation 5:
```
...
## New Eq:
```
time_independent_outward_current__i_K1 = ((fabs(-time_independent_outward_current__E_K1 + membrane__V) < 2.4999999999999998e-6) ? (4.999999999986338 + 0.35714285714285715 * pacemaker_potassium_current__I_K2 + 0.10000680838867515 * membrane__V - 0.10000680838867515 * time_independent_outward_current__E_K1) : (0.35714285714285715 * pacemaker_potassium_current__I_K2 + 0.20000000000000001 * (-time_independent_outward_current__E_K1 + membrane__V) / (1.0 - exp(0.040000000000000001 * time_independent_outward_current__E_K1 - 0.040000000000000001 * membrane__V))))
...
singularity processing time: 8.72193970000012
# Model: noble_model_1962(noble_model_1962.cellml)
load time: 0.2593054999999822
...
singularity processing time: 3.5696523999999954
# Model: noble_model_1991(noble_model_1991.cellml)
load time: 2.8305522999999084
...
singularity processing time: 28.78909449999992
# Model: noble_model_1998(noble_model_1998.cellml)
load time: 3.98032239999975
...
singularity processing time: 36.312758999999915
# Model: noble_model_2001(noble_model_2001.cellml)
load time: 4.251958700000159
...
singularity processing time: 39.04954390000012
# Model: NN_SAN_model_1984(noble_noble_SAN_model_1984.cellml)
load time: 1.890606299999945
...
singularity processing time: 25.973984599999767
# Model: Noble_SAN_model_1989(noble_SAN_model_1989.cellml)
load time: 1.8310757999997804
...
singularity processing time: 23.241282299999966
# Model: nygren_atrial_model_1998(nygren_atrial_model_1998.cellml)
load time: 3.214882900000248
...
singularity processing time: 34.66210319999982
# Model: ohara_rudy_2011_endo(ohara_rudy_2011_endo.cellml)
load time: 5.5171369999998205
...
singularity processing time: 494.40862460000017
# Model: ohara_rudy_2011_epi(ohara_rudy_2011_epi.cellml)
load time: 5.516554100000121
...
singularity processing time: 37.36370369999986
# Model: pasek_simurda_christe_2006(pasek_simurda_christe_2006.cellml)
load time: 5.13607809999985
...
singularity processing time: 72.3765115000001
# Model: pasek_model_2008(pasek_simurda_orchard_christe_2008.cellml)
load time: 7.8620568000001185
...
singularity processing time: 141.8734889000002
# Model: priebe_beuckelmann_1998(priebe_beuckelmann_1998.cellml)
load time: 4.582733399999597

singularity processing time: 31.401119000000108
# Model: ramirez_2000(ramirez_nattel_courtemanche_2000.cellml)
load time: 2.5275643999993918
...
singularity processing time: 25.679408300000432
# Model: sachse_model_2007(sachse_moreno_abildskov_2008_b.cellml)
load time: 0.46182300000054965

*U*: -membrane__Vm * model_parameters__F / (model_parameters__R * model_parameters__T)
*V for 1e-07 range* 
...
1.0000000504863945*_I_Shkr$OShkr*_I_Shkr$PShkr*_model_parameters$F*(_model_parameters$Ki - 0.999999900000005*_model_parameters$Ko) - 5000000.0*_model_parameters$F*(_membrane$Vm - 1.0e-7*_model_parameters$R*_model_parameters$T/_model_parameters$F)*(0.99999995056632214*_I_Shkr$OShkr*_I_Shkr$PShkr*_model_parameters$F*(_model_parameters$Ki - 1.0000001*_model_parameters$Ko) - 1.0000000504863945*_I_Shkr$OShkr*_I_Shkr$PShkr*_model_parameters$F*(_model_parameters$Ki - 0.999999900000005*_model_parameters$Ko))/(_model_parameters$R*_model_parameters$T)
## Equation 1:
```
...
## New Eq:
```
I_Shkr__I_Shkr = ((fabs(membrane__Vm) < 9.9999999999999995e-8 * fabs(model_parameters__R * model_parameters__T / model_parameters__F)) ? (1.0000000504863944 * (-0.99999990000000505 * model_parameters__Ko + model_parameters__Ki) * I_Shkr__OShkr * I_Shkr__PShkr * model_parameters__F - 5000000.0 * (-9.9999999999999995e-8 * model_parameters__R * model_parameters__T / model_parameters__F + membrane__Vm) * (0.99999995056632218 * (-1.0000001000000049 * model_parameters__Ko + model_parameters__Ki) * I_Shkr__OShkr * I_Shkr__PShkr * model_parameters__F - 1.0000000504863944 * (-0.99999990000000505 * model_parameters__Ko + model_parameters__Ki) * I_Shkr__OShkr * I_Shkr__PShkr * model_parameters__F) * model_parameters__F / (model_parameters__R * model_parameters__T)) : (pow(model_parameters__F, 2) * (-model_parameters__Ko * exp(-membrane__Vm * model_parameters__F / (model_parameters__R * model_parameters__T)) + model_parameters__Ki) * I_Shkr__OShkr * I_Shkr__PShkr * membrane__Vm / ((1.0 - exp(-membrane__Vm * model_parameters__F / (model_parameters__R * model_parameters__T))) * model_parameters__R * model_parameters__T)))

```

singularity processing time: 6.750723200000721
# Model: sakmann_model_2000_epi(sakmann_model_2000_epi.cellml)
load time: 4.168489899999258
...
singularity processing time: 34.789758599999914
# Model: shannon_wang_puglisi_weber_bers_2004_model_updated(shannon_wang_puglisi_weber_bers_2004.cellml)
load time: 4.778082499999982

*U*: -2.4166666666666665 - 0.16666666666666666 * cell__V
*V for 1e-07 range* 
`-14.4999994 - -14.5000006`
4.7615405886908269e-7*_ICaL_d_gate$d_infinity*(-833333.33333828234*_cell$V - 12083332.833405094) + 4.7619045238483835*_ICaL_d_gate$d_infinity
## Equation 1:
```
...
## New Eq:
```
ICaL_d_gate__tau_d = ((fabs(14.5 + cell__V) < 5.9999999999643672e-7) ? (4.7619045238483837 * ICaL_d_gate__d_infinity + 4.7615405886908269e-7 * (-12083332.833405094 - 833333.3333382823 * cell__V) * ICaL_d_gate__d_infinity) : (28.571428571428569 * (1.0 - exp(-2.4166666666666665 - 0.16666666666666666 * cell__V)) * ICaL_d_gate__d_infinity / (14.5 + cell__V)))
...
4.0*_ICaL$Fx_ICaL_SL*_ICaL$PCa*_ICaL$temp*_ICaL_fCa_gate$fCa_SL*(_Ca_buffer$Ca_SL*_ICaL$gamma_Cai*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Cao*_model_parameters$Cao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))) + (374351.92301797956*_cell$V + 0.5)*(4.0*_ICaL$Fx_ICaL_SL*_ICaL$PCa*_ICaL$temp*_ICaL_fCa_gate$fCa_SL*(_Ca_buffer$Ca_SL*_ICaL$gamma_Cai*exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Cao*_model_parameters$Cao)/(exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - 1.0) - 4.0*_ICaL$Fx_ICaL_SL*_ICaL$PCa*_ICaL$temp*_ICaL_fCa_gate$fCa_SL*(_Ca_buffer$Ca_SL*_ICaL$gamma_Cai*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Cao*_model_parameters$Cao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))))
found! 
## Equation 5:
```
...
*V for 1e-07 range* 
`-1.3356415961992688e-6 - 1.3356415961992688e-6`
4.0*_ICaL$Fx_ICaL_jct*_ICaL$PCa*_ICaL$temp*_ICaL_fCa_gate$fCa_jct*(_Ca_buffer$Ca_jct*_ICaL$gamma_Cai*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Cao*_model_parameters$Cao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))) + (374351.92301797956*_cell$V + 0.5)*(4.0*_ICaL$Fx_ICaL_jct*_ICaL$PCa*_ICaL$temp*_ICaL_fCa_gate$fCa_jct*(_Ca_buffer$Ca_jct*_ICaL$gamma_Cai*exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Cao*_model_parameters$Cao)/(exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - 1.0) - 4.0*_ICaL$Fx_ICaL_jct*_ICaL$PCa*_ICaL$temp*_ICaL_fCa_gate$fCa_jct*(_Ca_buffer$Ca_jct*_ICaL$gamma_Cai*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Cao*_model_parameters$Cao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))))
found! 
## Equation 6:
```
...
_ICaL$PK*_ICaL$temp*(_ICaL$Fx_ICaL_SL*_ICaL_fCa_gate$fCa_SL + _ICaL$Fx_ICaL_jct*_ICaL_fCa_gate$fCa_jct)*(_ICaL$gamma_Ki*_model_parameters$Ki*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Ko*_model_parameters$Ko)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))) + (187175.96150898978*_cell$V + 0.5)*(_ICaL$PK*_ICaL$temp*(_ICaL$Fx_ICaL_SL*_ICaL_fCa_gate$fCa_SL + _ICaL$Fx_ICaL_jct*_ICaL_fCa_gate$fCa_jct)*(_ICaL$gamma_Ki*_model_parameters$Ki*exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Ko*_model_parameters$Ko)/(exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - 1.0) - _ICaL$PK*_ICaL$temp*(_ICaL$Fx_ICaL_SL*_ICaL_fCa_gate$fCa_SL + _ICaL$Fx_ICaL_jct*_ICaL_fCa_gate$fCa_jct)*(_ICaL$gamma_Ki*_model_parameters$Ki*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Ko*_model_parameters$Ko)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))))
found! 
## Equation 7:
```
...
*V for 1e-07 range* 
`-2.6712831923985376e-6 - 2.6712831923985376e-6`
_ICaL$Fx_ICaL_SL*_ICaL$PNa*_ICaL$temp*_ICaL_fCa_gate$fCa_SL*(_ICaL$gamma_Nai*_Na_buffer$Na_SL*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Nao*_model_parameters$Nao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))) + (187175.96150898978*_cell$V + 0.5)*(_ICaL$Fx_ICaL_SL*_ICaL$PNa*_ICaL$temp*_ICaL_fCa_gate$fCa_SL*(_ICaL$gamma_Nai*_Na_buffer$Na_SL*exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Nao*_model_parameters$Nao)/(exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - 1.0) - _ICaL$Fx_ICaL_SL*_ICaL$PNa*_ICaL$temp*_ICaL_fCa_gate$fCa_SL*(_ICaL$gamma_Nai*_Na_buffer$Na_SL*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Nao*_model_parameters$Nao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))))
found! 
## Equation 8:
```
...
*V for 1e-07 range* 
`-2.6712831923985376e-6 - 2.6712831923985376e-6`
_ICaL$Fx_ICaL_jct*_ICaL$PNa*_ICaL$temp*_ICaL_fCa_gate$fCa_jct*(_ICaL$gamma_Nai*_Na_buffer$Na_jct*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Nao*_model_parameters$Nao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))) + (187175.96150898978*_cell$V + 0.5)*(_ICaL$Fx_ICaL_jct*_ICaL$PNa*_ICaL$temp*_ICaL_fCa_gate$fCa_jct*(_ICaL$gamma_Nai*_Na_buffer$Na_jct*exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Nao*_model_parameters$Nao)/(exp(2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - 1.0) - _ICaL$Fx_ICaL_jct*_ICaL$PNa*_ICaL$temp*_ICaL_fCa_gate$fCa_jct*(_ICaL$gamma_Nai*_Na_buffer$Na_jct*exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T)) - _ICaL$gamma_Nao*_model_parameters$Nao)/(-1.0 + exp(-2.6712831923985376e-6*_model_parameters$F/(_model_parameters$R*_model_parameters$T))))
found! 
## Equation 9:
```
...
singularity processing time: 62.138115700000526
# Model: stewart_zhang_model_2008(stewart_zhang_model_2008_ss.cellml)
load time: 3.018545500000073
...
singularity processing time: 26.602408799999466
# Model: tentusscher_model_2004_endo(ten_tusscher_model_2004_endo.cellml)
load time: 2.4850759000000835

*U*: 2.0 * membrane__F * membrane__V / (membrane__R * membrane__T)
*V for 1e-07 range* 
`-4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F - 4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F`
2.0000001000013437*_L_type_Ca_current$g_CaL*_L_type_Ca_current_d_gate$d*_L_type_Ca_current_fCa_gate$fCa*_L_type_Ca_current_f_gate$f*_membrane$F*(0.999999900000005*_calcium_dynamics$Ca_i - 0.34100000000000003*_calcium_dynamics$Ca_o) + 10000000.0*_membrane$F*(_membrane$V + 4.9999999999999998e-8*_membrane$R*_membrane$T/_membrane$F)*(-2.0000001000013437*_L_type_Ca_current$g_CaL*_L_type_Ca_current_d_gate$d*_L_type_Ca_current_fCa_gate$fCa*_L_type_Ca_current_f_gate$f*_membrane$F*(0.999999900000005*_calcium_dynamics$Ca_i - 0.34100000000000003*_calcium_dynamics$Ca_o) + 1.9999998999877269*_L_type_Ca_current$g_CaL*_L_type_Ca_current_d_gate$d*_L_type_Ca_current_fCa_gate$fCa*_L_type_Ca_current_f_gate$f*_membrane$F*(1.000000100000005*_calcium_dynamics$Ca_i - 0.34100000000000003*_calcium_dynamics$Ca_o))/(_membrane$R*_membrane$T)
found! 
## Equation 1:
```
...
## New Eq:
```
L_type_Ca_current__i_CaL = ((fabs(membrane__V) < 4.9999999999999998e-8 * fabs(membrane__R * membrane__T / membrane__F)) ? (10000000.0 * (4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F + membrane__V) * (1.9999998999877269 * (1.0000001000000049 * calcium_dynamics__Ca_i - 0.34100000000000003 * calcium_dynamics__Ca_o) * L_type_Ca_current__g_CaL * L_type_Ca_current_d_gate__d * L_type_Ca_current_fCa_gate__fCa * L_type_Ca_current_f_gate__f * membrane__F - 2.0000001000013437 * (0.99999990000000505 * calcium_dynamics__Ca_i - 0.34100000000000003 * calcium_dynamics__Ca_o) * L_type_Ca_current__g_CaL * L_type_Ca_current_d_gate__d * L_type_Ca_current_fCa_gate__fCa * L_type_Ca_current_f_gate__f * membrane__F) * membrane__F / (membrane__R * membrane__T) + 2.0000001000013437 * (0.99999990000000505 * calcium_dynamics__Ca_i - 0.34100000000000003 * calcium_dynamics__Ca_o) * L_type_Ca_current__g_CaL * L_type_Ca_current_d_gate__d * L_type_Ca_current_fCa_gate__fCa * L_type_Ca_current_f_gate__f * membrane__F) : (4.0 * pow(membrane__F, 2) * (-0.34100000000000003 * calcium_dynamics__Ca_o + calcium_dynamics__Ca_i * exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T))) * L_type_Ca_current__g_CaL * L_type_Ca_current_d_gate__d * L_type_Ca_current_fCa_gate__fCa * L_type_Ca_current_f_gate__f * membrane__V / ((-1.0 + exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T))) * membrane__R * membrane__T)))

```

singularity processing time: 26.562639199999467
# Model: tentusscher_model_2004_epi(ten_tusscher_model_2004_epi.cellml)
load time: 2.8607436000002053

singularity processing time: 25.593058100000235
# Model: tentusscher_model_2004_M(ten_tusscher_model_2004_M.cellml)
load time: 2.414832999999817
...
singularity processing time: 26.68391799999972
# Model: tentusscher_model_2006_endo(ten_tusscher_model_2006_endo.cellml)
load time: 2.7302350999998453

singularity processing time: 26.624072699999488
# Model: tentusscher_model_2006_epi(ten_tusscher_model_2006_epi.cellml)
load time: 3.2619211999999607

singularity processing time: 28.463928600000145
# Model: tentusscher_model_2006_M(ten_tusscher_model_2006_M.cellml)
load time: 3.1864924999999857

singularity processing time: 28.095183100000213
# Model: Tomek_model13endo(ToRORd_fkatp_endo.cellml)
load time: 6.289549799999804
...
singularity processing time: 566.9189779999997
# Model: Tomek_model13epi(ToRORd_fkatp_epi.cellml)
load time: 6.005489899999702
...
singularity processing time: 547.9190004000002
# Model: Trovato2020(Trovato2020.cellml)
load time: 5.27197200000046
...
singularity processing time: 509.6127550000001
# Model: viswanathan_model_1999_epi(viswanathan_model_1999_epi.cellml)
load time: 5.853348900000128
...
singularity processing time: 45.45668990000013
# Model: wang_model_2008(wang_sobie_2008.cellml)
load time: 2.7619752000000517
...
singularity processing time: 41.91379169999982
# Model: winslow_model_1999(winslow_model_1999.cellml)
load time: 3.4121470000000045
...
*V for 1e-07 range* 
`-4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F - 4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F`
2000.0001000013437*_L_type_Ca_current$P_Ca*_membrane$F*(0.00099999990000000502 - 0.34100000000000003*_standard_ionic_concentrations$Cao) + 10000000.0*_membrane$F*(_membrane$V + 4.9999999999999998e-8*_membrane$R*_membrane$T/_membrane$F)*(-2000.0001000013437*_L_type_Ca_current$P_Ca*_membrane$F*(0.00099999990000000502 - 0.34100000000000003*_standard_ionic_concentrations$Cao) + 1999.9998999877269*_L_type_Ca_current$P_Ca*_membrane$F*(0.001000000100000005 - 0.34100000000000003*_standard_ionic_concentrations$Cao))/(_membrane$R*_membrane$T)
found! 
## Equation 2:
```
...
## New Eq:
```
L_type_Ca_current__i_Ca_max = ((fabs(membrane__V) < 4.9999999999999998e-8 * fabs(membrane__R * membrane__T / membrane__F)) ? (2000.0001000013438 * (0.00099999990000000497 - 0.34100000000000003 * standard_ionic_concentrations__Cao) * L_type_Ca_current__P_Ca * membrane__F + 10000000.0 * (4.9999999999999998e-8 * membrane__R * membrane__T / membrane__F + membrane__V) * (1999.9998999877268 * (0.001000000100000005 - 0.34100000000000003 * standard_ionic_concentrations__Cao) * L_type_Ca_current__P_Ca * membrane__F - 2000.0001000013438 * (0.00099999990000000497 - 0.34100000000000003 * standard_ionic_concentrations__Cao) * L_type_Ca_current__P_Ca * membrane__F) * membrane__F / (membrane__R * membrane__T)) : (4000.0 * pow(membrane__F, 2) * (0.001 * exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T)) - 0.34100000000000003 * standard_ionic_concentrations__Cao) * L_type_Ca_current__P_Ca * membrane__V / ((-1.0 + exp(2.0 * membrane__F * membrane__V / (membrane__R * membrane__T))) * membrane__R * membrane__T)))

```

*U*: membrane__F * membrane__V / (membrane__R * membrane__T)
*V for 1e-07 range* 
`-9.9999999999999995e-8 * membrane__R * membrane__T / membrane__F - 9.9999999999999995e-8 * membrane__R * membrane__T / membrane__F`
1.0000000504863945*_L_type_Ca_current$p_prime_k*_L_type_Ca_current_y_gate$y*_membrane$F*(0.999999900000005*_intracellular_ion_concentrations$Ki - _standard_ionic_concentrations$Ko)*(_L_type_Ca_current$O + _L_type_Ca_current$O_Ca) + 5000000.0*_membrane$F*(_membrane$V + 1.0e-7*_membrane$R*_membrane$T/_membrane$F)*(-1.0000000504863945*_L_type_Ca_current$p_prime_k*_L_type_Ca_current_y_gate$y*_membrane$F*(0.999999900000005*_intracellular_ion_concentrations$Ki - _standard_ionic_concentrations$Ko)*(_L_type_Ca_current$O + _L_type_Ca_current$O_Ca) + 0.99999995056632214*_L_type_Ca_current$p_prime_k*_L_type_Ca_current_y_gate$y*_membrane$F*(1.0000001*_intracellular_ion_concentrations$Ki - _standard_ionic_concentrations$Ko)*(_L_type_Ca_current$O + _L_type_Ca_current$O_Ca))/(_membrane$R*_membrane$T)
found! 
## Equation 3:
```
...
## New Eq:
```
L_type_Ca_current__i_Ca_K = ((fabs(membrane__V) < 9.9999999999999995e-8 * fabs(membrane__R * membrane__T / membrane__F)) ? (5000000.0 * (9.9999999999999995e-8 * membrane__R * membrane__T / membrane__F + membrane__V) * (0.99999995056632218 * (-standard_ionic_concentrations__Ko + 1.0000001000000049 * intracellular_ion_concentrations__Ki) * (L_type_Ca_current__O + L_type_Ca_current__O_Ca) * L_type_Ca_current__p_prime_k * L_type_Ca_current_y_gate__y * membrane__F - 1.0000000504863944 * (-standard_ionic_concentrations__Ko + 0.99999990000000505 * intracellular_ion_concentrations__Ki) * (L_type_Ca_current__O + L_type_Ca_current__O_Ca) * L_type_Ca_current__p_prime_k * L_type_Ca_current_y_gate__y * membrane__F) * membrane__F / (membrane__R * membrane__T) + 1.0000000504863944 * (-standard_ionic_concentrations__Ko + 0.99999990000000505 * intracellular_ion_concentrations__Ki) * (L_type_Ca_current__O + L_type_Ca_current__O_Ca) * L_type_Ca_current__p_prime_k * L_type_Ca_current_y_gate__y * membrane__F) : (pow(membrane__F, 2) * (-standard_ionic_concentrations__Ko + intracellular_ion_concentrations__Ki * exp(membrane__F * membrane__V / (membrane__R * membrane__T))) * (L_type_Ca_current__O + L_type_Ca_current__O_Ca) * L_type_Ca_current__p_prime_k * L_type_Ca_current_y_gate__y * membrane__V / ((-1.0 + exp(membrane__F * membrane__V / (membrane__R * membrane__T))) * membrane__R * membrane__T)))

```

singularity processing time: 46.92144819999976
# Model: zhang_SAN_model_2000_0D_capable(zhang_SAN_model_2000_0D_capable.cellml)
load time: 3.758252999999968
...
singularity processing time: 26.425068600000486
