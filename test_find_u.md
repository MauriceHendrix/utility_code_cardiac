...
`-9.7272922774119528e-16 * membrane__V / (-1.0 + exp(0.037575562401545783 * membrane__V)) - 9.7428438442027996e-19 * membrane__V / (exp(0.063060000000000005 * membrane__V) + 9.8477927855808596e-7 * exp(-0.16203999999999999 * membrane__V) - exp(0.10063556240154578 * membrane__V) - 9.8477927855808596e-7 * exp(-0.12446443759845421 * membrane__V)) + 5.5584527299496869e-17 * membrane__V * exp(0.037575562401545783 * membrane__V) / (-1.0 + exp(0.037575562401545783 * membrane__V))`
`-5.5673393395444565e-20 * membrane__V * exp(0.037575562401545783 * membrane__V) / (exp(0.10063556240154578 * membrane__V) + 9.8477927855808596e-7 * exp(-0.12446443759845421 * membrane__V) - exp(0.063060000000000005 * membrane__V) - 9.8477927855808596e-7 * exp(-0.16203999999999999 * membrane__V))`

####A + B:

`-9.7272922774119528e-16 * membrane__V / (-1.0 + exp(0.037575562401545783 * membrane__V)) + 5.5584527299496869e-17 * membrane__V * exp(0.037575562401545783 * membrane__V) / (-1.0 + exp(0.037575562401545783 * membrane__V))`
`-9.7428438442027996e-19 * membrane__V / (exp(0.063060000000000005 * membrane__V) + 9.8477927855808596e-7 * exp(-0.16203999999999999 * membrane__V) - exp(0.10063556240154578 * membrane__V) - 9.8477927855808596e-7 * exp(-0.12446443759845421 * membrane__V))`
