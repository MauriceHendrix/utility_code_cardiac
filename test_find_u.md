...
*V for 1e-7 range*-4.7000000000000002 - 0.10000000000000001 * membrane__V
`-47.000001000000005`
...
*V for 1e-7 range*-2.0 + 0.40000000000000002 * membrane__V
`5.0000002500000003`
...
*V for 1e-7 range*7.0 + 0.25 * membrane__V
`-28.0`
...
*V for 1e-7 range*-5.8314606741573032 - 0.11235955056179775 * membrane__V
`-51.900000889999994`
...
*V for 1e-7 range*8.5 + 0.25 * membrane__V
`-34.0`
...
*V for 1e-7 range*9.0948000000000011 + 0.066000000000000003 * membrane__E
`-137.79999848484852`
...
potassium_channel_n_gate__alpha_n = -0.01 * (65.0 + membrane__V) / (-1.0 + 0.0015034391929775724 * exp(-0.10000000000000001 * membrane__V))
```
*U*-6.5 - 0.10000000000000001 * membrane__V
`-6.5 - 0.10000000000000001 * membrane__V`

*V for 1e-7 range*-6.5 - 0.10000000000000001 * membrane__V
`-65.0`
...
*V for 1e-7 range*-5.0 - 0.10000000000000001 * membrane__V
`-50.0`
...
*V for 1e-7 range*2.0609999999999999 + 0.068699999999999997 * membrane__V
`-29.999998544395925`
